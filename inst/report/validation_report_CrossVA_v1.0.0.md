# Validation Report - CrossVA@1.0.0
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jason Thomas <jarathomas@gmail.com>                  |
...
Overall the package has 4 exported objects. 4 are documented:
         ...
         odk2openVA odk2openVA_2014 odk2openVA_v141 odk2openVA_v151 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:25:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd647706be0_1739766296
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3uiSKP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CrossVA_v1.0.0-tikzDictionary"
