...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Cole Tanigawa-Lau <coletl@stanford.edu>              |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | collapse (\>= 1.7.6) | Imports |
| 2   | dplyr (\>= 1.0.6)    | Imports |
| 3   | ggplot2 (\>= 3.2.0)  | Imports |
| 4   | ks (\>= 1.13.4)      | Imports |
| 5   | mgcv (\>= 1.8.39)    | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
     ...
     vb_continuous  vb_difference    vb_discrete        vb_plot     vb_summary 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    vb_uncertainty           vbdf      wtd_table 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-15 04:24:17 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd10ac63bf_1739593452
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuFUSj8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blocs_v0.1.1-tikzDictionary"
