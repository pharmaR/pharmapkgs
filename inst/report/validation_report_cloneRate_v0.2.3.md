# Validation Report - cloneRate@0.2.3
...
| export_help          | 9                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Brian Johnson <brian.d.johnson97@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/bdj34/cloneRate          |
...
| 4   | Rmpfr (\>= 0.8)           | Imports   |
| 5   | rstan (\>= 2.18.1)        | Imports   |
| 6   | rstantools (\>= 2.3.1)    | Imports   |
...
Overall the package has 9 exported objects. 9 are documented:
     ...
     birthDeathMCMC    coal_to_tree internalLengths   maxLikelihood      sharedMuts 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             simMut        simUltra   siteFrequency       ultra2mut 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-16 04:34:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32df61494_1739680484
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGksvrR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cloneRate_v0.2.3-tikzDictionary"
