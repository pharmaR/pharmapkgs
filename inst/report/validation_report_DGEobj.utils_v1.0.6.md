# Validation Report - DGEobj.utils@1.0.6
...
Overall the package has 15 exported objects. 15 are documented:
         ...
         convertCounts         extractCol       lowIntFilter            rsqCalc 
                  TRUE               TRUE               TRUE               TRUE 
          runContrasts       runEdgeRNorm             runIHW           runPower 
                  TRUE               TRUE               TRUE               TRUE 
             runQvalue             runSVA            runVoom summarizeSigCounts 
                  TRUE               TRUE               TRUE               TRUE 
        topTable.merge         tpm.direct      tpm.on.subset 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 03:56:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bb437689218_1739850955
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHTLsS7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DGEobj.utils_v1.0.6-tikzDictionary"
