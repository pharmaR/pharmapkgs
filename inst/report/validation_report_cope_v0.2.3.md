...
| export_help | 12 |
| has_website | FALSE |
| has_maintainer | Max Sommerfeld <max.sommerfeld@mathematik.uni-goettingen.de> |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | abind (\>= 1.4-3)   | Imports |
| 2   | fields (\>= 7.1)    | Imports |
| 3   | MASS (\>= 7.3-34)   | Imports |
| 4   | Matrix (\>= 1.2-3)  | Imports |
| 5   | mvtnorm (\>= 1.0-0) | Imports |
| 6   | nlme (\>= 3.1-122)  | Imports |
| 7   | maps (\>= 2.3-7)    | Depends |
...
Overall the package has 12 exported objects. 12 are documented:
            ...
            ARCoeffMap        ComputeCope        DrawContour           PlotCope 
                  TRUE               TRUE               TRUE               TRUE 
             ToyNoise1 ToyNoise1Presmooth          ToyNoise2          ToyNoise3 
                  TRUE               TRUE               TRUE               TRUE 
           ToyNoiseMap          ToySignal        ToySignalDC           ToySlope 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 03:53:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bd627607620_1739764417
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpsn54T6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cope_v0.2.3-tikzDictionary"
