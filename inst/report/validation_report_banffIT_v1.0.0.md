...
| size_codebase | 1016 |
| has_source_control | https://github.com/PersonalizedTransplantCare/banffIT |
...
Overall the package has 10 exported objects. 10 are documented:
             ...
             add_diagnoses banff_dataset_evaluate         banff_launcher 
                      TRUE                   TRUE                   TRUE 
           banffIT_website     calculate_adequacy  dataset_cat_as_labels 
                      TRUE                   TRUE                   TRUE 
         dataset_summarize   get_banff_dictionary      get_banff_example 
                      TRUE                   TRUE                   TRUE 
        get_banff_template 
                      TRUE 
...
| Execution Time | 2025-02-14 07:42:02 UTC |
...
running this report
    ...
    PROCESSX_PS1c0974426ad3_1739518919
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9sHdNm
