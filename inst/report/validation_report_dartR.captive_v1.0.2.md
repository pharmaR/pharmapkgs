# Validation Report - dartR.captive@1.0.2
...
Overall the package has 15 exported objects. 15 are documented:
                 ...
                 gl.assign.grm      gl.assign.mahalanobis 
                          TRUE                       TRUE 
                  gl.assign.pa              gl.assign.pca 
                          TRUE                       TRUE 
    gl.filter.parent.offspring                     gl.grm 
                          TRUE                       TRUE 
                gl.grm.network            gl.plot.network 
                          TRUE                       TRUE 
    gl.report.parent.offspring              gl.run.EMIBD9 
                          TRUE                       TRUE 
            gl.sim.relatedness           utils.assignment 
                          TRUE                       TRUE 
            utils.assignment_2         utils.assignment_3 
                          TRUE                       TRUE 
            utils.assignment_4 
                          TRUE 
...
| Execution Time | 2025-02-19 03:30:26 UTC |
...
running this report
    ...
    PROCESSX_PS1d4539a081f1_1739935820
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHDH1Sd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dartR.captive_v1.0.2-tikzDictionary"
