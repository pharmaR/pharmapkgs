# Validation Report - esmprep@0.2.0
...
| export_help          | 32                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Marcel Miché <esmprep@gmail.com>                     |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/mmiche/esmprep                    |
...
Overall the package has 32 exported objects. 32 are documented:
        ...
        computeDuration  computeTimeBetween      computeTimeLag        convertChars 
                   TRUE                TRUE                TRUE                TRUE 
        dateTimeFormats    dateTimeFormats2            esAssign          esComplete 
                   TRUE                TRUE                TRUE                TRUE 
                esFinal         esIdentical             esItems              esList 
                   TRUE                TRUE                TRUE                TRUE 
                esMerge         esPlausible expectedPromptIndex           findChars 
                   TRUE                TRUE                TRUE                TRUE 
            genDateTime              genKey         intolerable           makeShift 
                   TRUE                TRUE                TRUE                TRUE 
     missingEndDateTime      printRmInvalid printSuggestedShift randomMultSelection 
                   TRUE                TRUE                TRUE                TRUE 
           refPlausible        relevantESVN       relevantREFVN           rmInvalid 
                   TRUE                TRUE                TRUE                TRUE 
                  setES              setREF       splitDateTime        suggestShift 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:30:30 UTC |
...
running this report
    ...
    PROCESSX_PS1d4543c31491_1739939424
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0cwY1E
...
These are the options set to generate the report:
    ...
    [1] "validation_report_esmprep_v0.2.0-tikzDictionary"
