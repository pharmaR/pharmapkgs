# Validation Report - EnsembleBase@1.0.4
...
EnsembleCV, EnsemblePCReg, EnsemblePenReg

## Namespace

Overall the package has 11 exported objects. 15 are documented:

       extract.baselearner.name          generate.partition 
                           TRUE                        TRUE 
            generate.partitions                 load.object 
                           TRUE                        TRUE 
                   make.configs              make.instances 
                           TRUE                        TRUE 
           Regression.Batch.Fit     Regression.CV.Batch.Fit 
                           TRUE                        TRUE 
              Regression.CV.Fit regression.extract.response 
                           TRUE                        TRUE 
                     rmse.error 
                           TRUE 
...
There are 12 help pages with examples, from 21 (57.14 %).
...
| Execution Time | 2025-02-19 04:09:21 UTC |
...
running this report
    ...
    PROCESSX_PS1d4575bb626c_1739938155
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTjyYyC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EnsembleBase_v1.0.4-tikzDictionary"
