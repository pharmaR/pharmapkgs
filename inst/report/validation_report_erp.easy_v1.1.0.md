# Validation Report - erp.easy@1.1.0
...
| export_help          | 0                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Travis Moore <travis.m.moore@vanderbilt.edu>         |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/mooretm/erp.easy                  |
...
| 2   | signal (\>= 0.7-6) | Imports |
| 3   | gtools (\>= 3.5.0) | Imports |
...
| Execution Time | 2025-02-19 04:27:22 UTC |
...
running this report
    ...
    PROCESSX_PS1d455aa99792_1739939236
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuzD3c4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_erp.easy_v1.1.0-tikzDictionary"
