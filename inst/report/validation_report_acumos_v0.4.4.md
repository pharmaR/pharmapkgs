...
| export_help | 5 |
| has_website | TRUE |
| has_maintainer | Alassane Samba <alassane.samba@orange.com> |
| bugs_status | scraping bug reports fromm BugReports host ‘acumos’ not implemented |
| has_source_control | https://www.acumos.org (Acumos project website) |
...
\| \|has_bug_reports_url \|1 \| \|downloads_1yr \|10021 \|
\|reverse_dependencies \|0 \| \|has_examples \|1 \| \|dependencies \|6
...
Overall the package has 5 exported objects. 5 are documented:
                 ...
                 auth           compose composeFromSource              push 
                 TRUE              TRUE              TRUE              TRUE 
       pushFromSource 
                 TRUE 
...
| Execution Time | 2025-02-21 13:07:21 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a7b6cc3ef_1740143237
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUwsFt9
