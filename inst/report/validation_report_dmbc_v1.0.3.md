...
| export_help          | 37                                             |
| has_website          | FALSE                                          |
| has_maintainer       | Sergio Venturini <sergio.venturini@unicatt.it> |
...
|:----|:------------------------|:----------|
| 1   | abind                   | Imports   |
| 2   | bayesplot (\>= 1.7.0)   | Imports   |
| 3   | coda (\>= 0.19-3)       | Imports   |
| 4   | ggplot2 (\>= 3.2.1)     | Imports   |
| 5   | ggrepel (\>= 0.8.1)     | Imports   |
| 6   | graphics                | Imports   |
| 7   | modeltools (\>= 0.2-22) | Imports   |
| 8   | parallel (\>= 3.6.1)    | Imports   |
| 9   | robustbase (\>= 0.93-5) | Imports   |
| 10  | robustX (\>= 1.2-5)     | Imports   |
| 11  | stats4 (\>= 3.6.0)      | Imports   |
| 12  | tools                   | Imports   |
| 13  | methods                 | Depends   |
| 14  | stats                   | Depends   |
| 15  | utils                   | Depends   |
...
Overall the package has 30 exported objects. 29 are documented:

                      adjust_x                       bmds 
                          TRUE                       TRUE 
               bmds_get_x_mode              check_control 
                          TRUE                       TRUE 
                 check_list_na                check_prior 
                          TRUE                       TRUE 
                      comp_ssr               control_dmbc 
                          TRUE                       TRUE 
                          dmbc          dmbc_check_groups 
                          TRUE                       TRUE 
                  dmbc_control                   dmbc_fit 
                          TRUE                       TRUE 
         dmbc_fit_list_to_list dmbc_fit_list_to_mcmc.list 
                          TRUE                       TRUE 
              dmbc_fit_to_mcmc     dmbc_get_configuration 
                          TRUE                       TRUE 
                  dmbc_get_map                dmbc_get_ml 
                          TRUE                       TRUE 
             dmbc_get_postmean        dmbc_get_postmedian 
                          TRUE                       TRUE 
                       dmbc_IC                  dmbc_init 
                          TRUE                       TRUE 
                   dmbc_logLik          dmbc_logLik_rbmds 
                          TRUE                       TRUE 
             dmbc_match_groups                 dmbc_prior 
                          TRUE                       TRUE 
                         mdsic                 prior_dmbc 
                          TRUE                       TRUE 
                        subset               update_prior 
...
| Execution Time | 2025-02-18 04:26:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4453165b2_1739852807
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkNKzKL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dmbc_v1.0.3-tikzDictionary"
