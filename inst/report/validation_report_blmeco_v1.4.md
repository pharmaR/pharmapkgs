...
Overall the package has 9 exported objects. 9 are documented:
                      ...
                      AICweights                compareqqnorm 
                            TRUE                         TRUE 
                      crosspoint             dispersion_glmer 
                            TRUE                         TRUE 
                     historyplot                       loo.cv 
                            TRUE                         TRUE 
                             ocv triplot.normal.knownvariance 
                            TRUE                         TRUE 
                            WAIC 
                            TRUE 
...
| Execution Time | 2025-02-15 04:22:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd155bd723_1739593363
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWdI10E
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blmeco_v1.4-tikzDictionary"
