# Validation Report - designmatch@0.5.4
...
| export_help | 12 |
| has_website | FALSE |
| has_maintainer | Jose R. Zubizarreta <zubizarreta@hcp.med.harvard.edu> |
...
Overall the package has 12 exported objects. 12 are documented:
    ...
    absstddif    bmatch cardmatch   distmat distmatch  ecdfplot   finetab  loveplot 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
      meantab    nmatch pairsplot profmatch 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-18 03:48:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45023b049_1739850495
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpx6XeWz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_designmatch_v0.5.4-tikzDictionary"
