...
| export_help          | 14                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Onur Karakaslar <eonurkara@gmail.com> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/eonurk/cinaR/      |
...
|     | package                            | type    |
|:----|:-----------------------------------|:--------|
| 1   | ChIPseeker                         | Imports |
| 2   | DESeq2                             | Imports |
| 3   | dplyr                              | Imports |
| 4   | edgeR                              | Imports |
| 5   | fgsea                              | Imports |
| 6   | GenomicRanges                      | Imports |
| 7   | TxDb.Hsapiens.UCSC.hg38.knownGene  | Imports |
| 8   | TxDb.Hsapiens.UCSC.hg19.knownGene  | Imports |
| 9   | TxDb.Mmusculus.UCSC.mm10.knownGene | Imports |
| 10  | ggplot2                            | Imports |
| 11  | ggrepel                            | Imports |
...
| 14  | utils                              | Imports |
| 15  | pheatmap                           | Imports |
| 16  | preprocessCore                     | Imports |
| 17  | RColorBrewer                       | Imports |
| 18  | sva                                | Imports |
| 19  | writexl                            | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
                   ...
                   cinaR         color_values             dot_plot 
                    TRUE                 TRUE                 TRUE 
         filterConsensus                 GSEA heatmap_differential 
                    TRUE                 TRUE                 TRUE 
       heatmap_var_peaks                 HPEA   normalizeConsensus 
                    TRUE                 TRUE                 TRUE 
                pca_plot       run_enrichment           scale_rows 
                    TRUE                 TRUE                 TRUE 
        show_comparisons            verboseFn 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:19:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3638dbd62_1739679551
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpofjZCF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cinaR_v0.2.3-tikzDictionary"
