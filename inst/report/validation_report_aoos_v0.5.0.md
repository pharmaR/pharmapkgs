...
Overall the package has 19 exported objects. 16 are documented:

      .genericTest            %g%            %m%         %type%          asEnv 
              TRUE          FALSE          FALSE          FALSE           TRUE 
       defineClass defineRefClass        envCopy       envMerge       funNames 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        parser_%g%     parser_%m%  parser_%type%        private         public 
             FALSE          FALSE          FALSE           TRUE           TRUE 
    publicFunction    publicValue        retList      stripSelf 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-14 06:57:58 UTC |
...
running this report
    ...
    PROCESSX_PS726d499873f0_1739516276
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplRFaJB
