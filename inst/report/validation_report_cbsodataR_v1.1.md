# Validation Report - cbsodataR@1.1
...
| has_source_control   | https://github.com/edwindj/cbsodataR   |
...
Overall the package has 31 exported objects. 31 are documented:
                ...
                cache_clear     cbs_add_date_column   cbs_add_label_columns 
                       TRUE                    TRUE                    TRUE 
    cbs_add_statcode_column     cbs_add_unit_column       cbs_download_data 
                       TRUE                    TRUE                    TRUE 
          cbs_download_meta      cbs_download_table        cbs_get_catalogs 
                       TRUE                    TRUE                    TRUE 
               cbs_get_data  cbs_get_data_from_link        cbs_get_datasets 
                       TRUE                    TRUE                    TRUE 
               cbs_get_maps            cbs_get_meta   cbs_get_meta_from_dir 
                       TRUE                    TRUE                    TRUE 
                 cbs_get_sf   cbs_get_tables_themes          cbs_get_themes 
                       TRUE                    TRUE                    TRUE 
                cbs_get_toc   cbs_join_sf_with_data              cbs_search 
                       TRUE                    TRUE                    TRUE 
              download_meta          download_table                      eq 
                       TRUE                    TRUE                    TRUE 
                   get_data                get_meta       get_meta_from_dir 
                       TRUE                    TRUE                    TRUE 
             get_table_list       get_tables_themes              get_themes 
                       TRUE                    TRUE                    TRUE 
              has_substring 
                       TRUE 
...
| Execution Time | 2025-02-16 03:52:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3138328b8_1739677936
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpn0AbMj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cbsodataR_v1.1-tikzDictionary"
