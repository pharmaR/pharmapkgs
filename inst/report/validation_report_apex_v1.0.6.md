...
| export_help          | 35                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Klaus Schliep <klaus.schliep@gmail.com> |
| bugs_status          | 0.8666667                               |
| size_codebase        | 582                                     |
| has_source_control   | https://github.com/thibautjombart/apex  |
...
Overall the package has 21 exported objects. 31 are documented:

                 add.gaps           concatenate         dist.multidna 
                     TRUE                  TRUE                  TRUE 
            getLocusNames             getNumInd            getNumLoci 
                     TRUE                  TRUE                  TRUE 
          getNumSequences      getSequenceNames          getSequences 
                     TRUE                  TRUE                  TRUE 
                  getTree    multidna2alignment       multidna2genind 
                     TRUE                  TRUE                  TRUE 
     multidna2multiphyDat multiphyDat2alignment    multiphyDat2genind 
                     TRUE                  TRUE                  TRUE 
     multiphyDat2multidna         read.multidna       read.multiFASTA 
                     TRUE                  TRUE                  TRUE 
         read.multiphyDat               rm.gaps       setLocusNames<- 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-14 07:17:48 UTC |
...
running this report
    ...
    PROCESSX_PS1c09436c8cc3_1739517465
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnJ5H9p
