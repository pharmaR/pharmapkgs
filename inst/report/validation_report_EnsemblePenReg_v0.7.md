# Validation Report - EnsemblePenReg@0.7
...
Overall the package has 6 exported objects. 6 are documented:
                        ...
                        epenreg epenreg.baselearner.control 
                           TRUE                        TRUE 
     epenreg.integrator.control                epenreg.load 
                           TRUE                        TRUE 
                   epenreg.save     Regression.Sweep.CV.Fit 
                           TRUE                        TRUE 

### Examples

There are 6 help pages with examples, from 11 (54.55 %).
...
| Execution Time | 2025-02-19 04:09:56 UTC |
...
running this report
    ...
    PROCESSX_PS1d454ee0b2c_1739938190
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRDEw6g
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EnsemblePenReg_v0.7-tikzDictionary"
