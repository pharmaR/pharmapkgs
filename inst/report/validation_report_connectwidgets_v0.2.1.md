# Validation Report - connectwidgets@0.2.1
...
| export_help          | 21                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Brian Smith <brian@rstudio.com>           |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/rstudio/connectwidgets |
...
Overall the package has 21 exported objects. 20 are documented:
                ...
                %>%        by_owner       by_owners          by_tag         by_tags 
              FALSE            TRUE            TRUE            TRUE            TRUE 
            connect         content   renderRsccard renderRscfilter   renderRscgrid 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    renderRscsearch        rsc_card        rsc_cols      rsc_filter        rsc_grid 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         rsc_search       rsc_table   rsccardOutput rscfilterOutput   rscgridOutput 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    rscsearchOutput 
               TRUE 
...
| Execution Time | 2025-02-17 03:46:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bd611335ae9_1739763970
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpf6lLkc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_connectwidgets_v0.2.1-tikzDictionary"
