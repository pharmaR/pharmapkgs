# Validation Report - collidr@0.1.3
...
| export_help          | 10                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Steve Condylios <steve.condylios@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/collidrpackage/collidr   |
...
Overall the package has 10 exported objects. 10 are documented:
                ...
                CRAN_collisions    CRAN_function_collisions 
                           TRUE                        TRUE 
                 CRAN_functions     CRAN_package_collisions 
                           TRUE                        TRUE 
                  CRAN_packages CRAN_packages_and_functions 
                           TRUE                        TRUE 
                          CRANf                       CRANp 
                           TRUE                        TRUE 
                         CRANpf                     getCRAN 
...
| Execution Time | 2025-02-16 04:57:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35d7cdb8e_1739681841
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdWczbg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_collidr_v0.1.3-tikzDictionary"
