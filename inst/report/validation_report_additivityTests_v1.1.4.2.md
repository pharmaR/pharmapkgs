...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Petr Simecek <simecek@gmail.com>                     |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 173                                                  |
| has_source_control   | https://github.com/simecek/additivityTests           |
...
Overall the package has 7 exported objects. 7 are documented:
          ...
          critical.values johnson.graybill.test              lbi.test 
                     TRUE                  TRUE                  TRUE 
              mandel.test           mtukey.test            tukey.test 
                     TRUE                  TRUE                  TRUE 
              tusell.test 
                     TRUE 
...
| Execution Time | 2025-02-14 06:36:07 UTC |
...
running this report
    ...
    PROCESSX_PS726d4a3c2162_1739514964
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYZAkdI
