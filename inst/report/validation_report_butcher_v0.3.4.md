# Validation Report - butcher@0.3.4
...
| export_help          | 9                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Julia Silge <julia.silge@posit.co>    |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/tidymodels/butcher |
...
|:----|:-------------------|:--------|
| 1   | cli (\>= 3.3.0)    | Imports |
| 2   | lobstr (\>= 1.1.2) | Imports |
| 3   | methods            | Imports |
| 4   | purrr (\>= 0.3.4)  | Imports |
| 5   | rlang (\>= 1.0.2)  | Imports |
| 6   | tibble (\>= 3.1.7) | Imports |
| 7   | utils              | Imports |
| 8   | vctrs (\>= 0.4.1)  | Imports |
...
baguette, bestNormalize, bundle, mixvlmc, probably, stacks, vetiver,
workflows
...
Overall the package has 9 exported objects. 9 are documented:
             ...
             axe_call          axe_ctrl          axe_data           axe_env 
                 TRUE              TRUE              TRUE              TRUE 
           axe_fitted           butcher            locate new_model_butcher 
                 TRUE              TRUE              TRUE              TRUE 
                weigh 
                 TRUE 
...
| Execution Time | 2025-02-15 04:56:46 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd131c2e1b_1739595401
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpzwbl8N
...
These are the options set to generate the report:
    ...
    [1] "validation_report_butcher_v0.3.4-tikzDictionary"
