# Validation Report - ed50simulation@0.1.1
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Fengru Wang <wangfr@whu.edu.cn>                      |
...
Overall the package has 7 exported objects. 7 are documented:
                 ...
                 bootBC.ci bootIsotonicRegression   bootIsotonicResample 
                      TRUE                   TRUE                   TRUE 
                   compare               estimate           generateData 
                      TRUE                   TRUE                   TRUE 
               preparePava 
                      TRUE 
...
| Execution Time | 2025-02-19 03:39:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d454bad3166_1739936366
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3ReBqR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ed50simulation_v0.1.1-tikzDictionary"
