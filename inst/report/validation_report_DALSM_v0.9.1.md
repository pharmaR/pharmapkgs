...
| export_help          | 9                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Philippe Lambert <p.lambert@uliege.be>    |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | <https://github.com/plambertULiege/DALSM> |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    centeredBasis.gen             DALSM    DALSM_additive            Dens1d 
                 TRUE              TRUE              TRUE              TRUE 
           densityLPS        logDet.fun          Pcal.fun        plotRegion 
                 TRUE              TRUE              TRUE              TRUE 
                    s 
                 TRUE 
...
| Execution Time | 2025-02-17 04:52:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6144f459d_1739767928
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGUDX73
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DALSM_v0.9.1-tikzDictionary"
