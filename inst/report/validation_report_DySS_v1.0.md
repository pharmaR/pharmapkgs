...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Lu You <Lu.You@epi.usf.edu>                          |
...
Overall the package has 13 exported objects. 13 are documented:
                        ...
                        calculate_ATS            calculate_signal_times 
                                 TRUE                              TRUE 
             estimate_pattern_long_1d          estimate_pattern_long_md 
                                 TRUE                              TRUE 
           estimate_pattern_long_surv  evaluate_control_chart_one_group 
                                 TRUE                              TRUE 
    evaluate_control_chart_two_groups                   monitor_long_1d 
                                 TRUE                              TRUE 
                      monitor_long_md                 monitor_long_surv 
                                 TRUE                              TRUE 
                      plot_evaluation                        plot_PMROC 
                                 TRUE                              TRUE 
                            search_CL 
                                 TRUE 
...
| Execution Time | 2025-02-18 05:08:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bb456fbc595_1739855283
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEnJHsj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DySS_v1.0-tikzDictionary"
