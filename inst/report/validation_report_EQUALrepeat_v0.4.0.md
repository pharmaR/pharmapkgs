# Validation Report - EQUALrepeat@0.4.0
...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Kurinchi Gurusamy <k.gurusamy@ucl.ac.uk>             |
...
Overall the package has 6 exported objects. 6 are documented:
                 ...
                 function.Measurement_Error function.rbind_different_column_numbers 
                                       TRUE                                    TRUE 
                         function.read_data              function.Repeated_Measures 
                                       TRUE                                    TRUE 
                       function.Time_Series                              round_near 
                                       TRUE                                    TRUE 
...
| Execution Time | 2025-02-19 04:23:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d4531e2ba95_1739938979
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2YuCh2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EQUALrepeat_v0.4.0-tikzDictionary"
