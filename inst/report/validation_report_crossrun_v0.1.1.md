# Validation Report - crossrun@0.1.1
...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Tore Wentzel-Larsen <tore.wentzellarsen@gmail.com>   |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/ToreWentzel-Larsen/crossrun       |
...
Overall the package has 13 exported objects. 13 are documented:
          ...
          boxprobt        clshift   crossrunauto    crossrunbin crossrunchange 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        crossrunem  crossrunshift   crossrunsymm        cumsumm     cumsummcol 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          exactbin       simclbin        simclem 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 04:24:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6415b5071_1739766260
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptJkaT1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crossrun_v0.1.1-tikzDictionary"
