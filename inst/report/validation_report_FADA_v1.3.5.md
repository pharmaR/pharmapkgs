...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | David Causeur <david.causeur@agrocampus-ouest.fr>    |
...
Overall the package has 3 exported objects. 3 are documented:
     ...
     decorrelate.test decorrelate.train              FADA 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 05:06:59 UTC |
...
running this report
    ...
    PROCESSX_PS1d45783fa9bb_1739941612
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1QoPn3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FADA_v1.3.5-tikzDictionary"
