...
| export_help          | 50                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Pierre-Alexandre Balland <p.balland@uu.nl> |
| bugs_status          | 0.6                                        |
| has_source_control   | https://github.com/PABalland/EconGeo       |
...
Overall the package has 50 exported objects. 50 are documented:
                  ...
                  co_occurrence                   diversity 
                           TRUE                        TRUE 
             ease_recombination                     entropy 
                           TRUE                        TRUE 
                     entry_list                   entry_mat 
                           TRUE                        TRUE 
                      exit_list                    exit_mat 
                           TRUE                        TRUE 
                           expy                    get_list 
                     ...
                     get_matrix                        gini 
                           TRUE                        TRUE 
                     growth_ind                 growth_list 
                           TRUE                        TRUE 
                growth_list_ind             growth_list_reg 
                           TRUE                        TRUE 
                     growth_mat                  growth_reg 
                           TRUE                        TRUE 
                        hachman                  herfindahl 
                           TRUE                        TRUE 
                   hoover_curve                 hoover_gini 
                           TRUE                        TRUE 
                   hoover_index           inv_norm_ubiquity 
                           TRUE                        TRUE 
                            kci               krugman_index 
                           TRUE                        TRUE 
              location_quotient       location_quotient_avg 
                           TRUE                        TRUE 
                locational_gini       locational_gini_curve 
                           TRUE                        TRUE 
                   lorenz_curve                   match_mat 
                           TRUE                        TRUE 
             modular_complexity      modular_complexity_avg 
                           TRUE                        TRUE 
                           morc                        mort 
                           TRUE                        TRUE 
                  norm_ubiquity                       prody 
                           TRUE                        TRUE 
                            rca                 relatedness 
                           TRUE                        TRUE 
            relatedness_density     relatedness_density_ext 
                           TRUE                        TRUE 
    relatedness_density_ext_avg     relatedness_density_int 
                           TRUE                        TRUE 
    relatedness_density_int_avg                  spec_coeff 
                           TRUE                        TRUE 
                            tci                    ubiquity 
                           TRUE                        TRUE 
                   weighted_avg                     z_score 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-19 03:35:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d456ba301d8_1739936146
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUlA44P
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EconGeo_v2.0-tikzDictionary"
