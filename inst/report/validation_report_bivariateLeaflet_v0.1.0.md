# Validation Report - bivariateLeaflet@0.1.0
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Michael Duprey <mduprey@rti.org>                     |
...
Overall the package has 6 exported objects. 6 are documented:
                  ...
                  assign_colors    calculate_tertile_breaks 
                           TRUE                        TRUE 
             calculate_tertiles        create_bivariate_map 
                           TRUE                        TRUE 
    create_default_color_matrix        generate_legend_html 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-15 04:19:12 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdd6a42a_1739593147
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIo4aAT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bivariateLeaflet_v0.1.0-tikzDictionary"
