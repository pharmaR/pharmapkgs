# Validation Report - calendar@0.2.0
...
| export_help          | 20                                |
| has_website          | TRUE                              |
| has_maintainer       | Robin Lovelace <rob00x@gmail.com> |
...
Overall the package has 20 exported objects. 20 are documented:
    ...
    ic_attributes_vec      ic_bind_list      ic_char_date  ic_char_datetime 
                 TRUE              TRUE              TRUE              TRUE 
        ic_char_event      ic_character      ic_dataframe           ic_date 
                 TRUE              TRUE              TRUE              TRUE 
          ic_datetime          ic_event        ic_extract    ic_extract_raw 
                 TRUE              TRUE              TRUE              TRUE 
              ic_find           ic_guid           ic_list           ic_read 
                 TRUE              TRUE              TRUE              TRUE 
              ic_spec         ic_vector          ic_write              ical 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 03:34:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bc358965e38_1739676859
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUr6azy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_calendar_v0.2.0-tikzDictionary"
