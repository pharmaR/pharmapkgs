...
Overall the package has 16 exported objects. 16 are documented:
              ...
              amelia   amelia.default    amelia.molist       ameliabind 
                TRUE             TRUE             TRUE             TRUE 
          AmeliaView  compare.density         disperse       mi.combine 
                TRUE             TRUE             TRUE             TRUE 
             mi.meld          missmap           moPrep       overimpute 
                TRUE             TRUE             TRUE             TRUE 
    transform.amelia         tscsPlot      with.amelia     write.amelia 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-14 06:51:49 UTC |
...
running this report
    ...
    PROCESSX_PS726d44e1dd10_1739515906
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwA2Sev
