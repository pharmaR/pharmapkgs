# Validation Report - clikcorr@1.0
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yanming Li <liyanmin@umich.edu>                      |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            clikcorr clikcorr.default              est              lrt 
                TRUE             TRUE             TRUE             TRUE 
       plot.clikcorr   print.clikcorr            splot           splot2 
                TRUE             TRUE             TRUE             TRUE 
    summary.clikcorr               sv 
                TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:30:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34d8258e8_1739680243
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpu4wBks
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clikcorr_v1.0-tikzDictionary"
