# Validation Report - CFAcoop@1.0.0
...
| export_help          | 5                                                   |
| has_website          | TRUE                                                |
| has_maintainer       | Daniel Samaga <daniel.samaga@helmholtz-muenchen.de> |
| has_source_control   | https://github.com/ZytoHMGU/CFAcoop                 |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    analyze_survival     calculate_sf        export_sf          plot_sf 
                TRUE             TRUE             TRUE             TRUE 
             pwr_reg 
                TRUE 
...
| Execution Time | 2025-02-16 04:03:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3675ec023_1739678629
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYsSS4x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CFAcoop_v1.0.0-tikzDictionary"
