# Validation Report - EValue@4.1.3
...
| export_help          | 35                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Maya B. Mathur <mmathur@stanford.edu>                |
...
| 1   | stats               | Imports |
| 2   | graphics            | Imports |
| 3   | ggplot2 (\>= 2.2.1) | Imports |
| 4   | metafor             | Imports |
| 5   | metadat             | Imports |
| 6   | methods             | Imports |
| 7   | boot                | Imports |
| 8   | MetaUtility         | Imports |
| 9   | dplyr               | Imports |
...
Overall the package has 35 exported objects. 35 are documented:
              ...
              bias_plot     confounded_meta         confounding              evalue 
                   TRUE                TRUE                TRUE                TRUE 
             evalues.HR          evalues.IC          evalues.MD         evalues.OLS 
                   TRUE                TRUE                TRUE                TRUE 
             evalues.OR          evalues.RD          evalues.RR                  HR 
                   TRUE                TRUE                TRUE                TRUE 
                     MD   misclassification          multi_bias         multi_bound 
                   TRUE                TRUE                TRUE                TRUE 
           multi_evalue    multi_evalues.HR    multi_evalues.OR    multi_evalues.RR 
                   TRUE                TRUE                TRUE                TRUE 
                    OLS                  OR                  RD                  RR 
                   TRUE                TRUE                TRUE                TRUE 
              selection    selection_evalue           sens_plot          svalues.HR 
                   TRUE                TRUE                TRUE                TRUE 
             svalues.OR          svalues.RR           threshold threshold_selection 
                   TRUE                TRUE                TRUE                TRUE 
                   toMD                toRR           twoXtwoRR 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:38:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d45343c324b_1739939899
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2SjGgI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EValue_v4.1.3-tikzDictionary"
