# Validation Report - clustur@0.1.1
...
| export_help          | 13                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Patrick Schloss <pschloss@umich.edu>  |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/SchlossLab/clustur |
...
| 1   | Matrix            | Imports   |
| 2   | methods           | Imports   |
| 3   | Rcpp (\>= 1.0.12) | Imports   |
| 4   | utils             | Imports   |
| 5   | Rcpp              | LinkingTo |
| 6   | testthat          | LinkingTo |
...
Overall the package has 13 exported objects. 13 are documented:
                   ...
                   cluster   create_sparse_matrix           example_path 
                      TRUE                   TRUE                   TRUE 
             get_abundance               get_bins        get_count_table 
                      TRUE                   TRUE                   TRUE 
                get_cutoff        get_distance_df            get_metrics 
                      TRUE                   TRUE                   TRUE 
                read_count              read_dist split_clusters_to_list 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:42:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34fe45464_1739680921
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdCOfyW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clustur_v0.1.1-tikzDictionary"
