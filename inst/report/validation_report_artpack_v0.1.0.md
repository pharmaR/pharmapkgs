...
| export_help          | 8                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Meghan Harris <meghanha01@gmail.com> |
...
| 6   | rlang               | Imports |
| 7   | stringr (\>= 1.5.0) | Imports |
| 8   | tibble (\>= 3.1.6)  | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         art_pals   circle_data    grid_maker group_numbers        packer 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          rotator   square_data     wave_data 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-14 07:25:45 UTC |
...
running this report
    ...
    PROCESSX_PS1c094268037c_1739517942
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7azw8K
