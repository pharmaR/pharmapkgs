# Validation Report - benford.analysis@0.1.5
...
| export_help          | 16                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Carlos Cinelli <carloscinelli@hotmail.com>       |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | http://github.com/carloscinelli/benford.analysis |
...
Overall the package has 16 exported objects. 16 are documented:
              ...
              benford             chisq           dfactor   duplicatesTable 
                 TRUE              TRUE              TRUE              TRUE 
       extract.digits            getBfd           getData         getDigits 
                 TRUE              TRUE              TRUE              TRUE 
        getDuplicates       getSuspects               MAD          mantissa 
                 TRUE              TRUE              TRUE              TRUE 
                 marc    p.these.digits p.this.digit.at.n     suspectsTable 
                 TRUE              TRUE              TRUE              TRUE 

### Examples

There are 19 help pages with examples, from 25 (76.00 %).
...
| Execution Time | 2025-02-15 03:53:17 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd53a30393_1739591592
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpfq3NOV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_benford.analysis_v0.1.5-tikzDictionary"
