# Validation Report - bmggum@0.1.0
...
| has_source_control   | https://github.com/Naidantu/bmggum |
...
| 9   | loo                       | Imports   |
| 10  | stats                     | Imports   |
| 11  | BH (\>= 1.66.0)           | LinkingTo |
| 12  | Rcpp (\>= 0.12.0)         | LinkingTo |
| 13  | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 14  | RcppParallel (\>= 5.0.1)  | LinkingTo |
| 15  | rstan (\>= 2.18.1)        | LinkingTo |
| 16  | StanHeaders (\>= 2.18.0)  | LinkingTo |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    bayesplot    bmggum   extract  itemplot    modfit 
...
| Execution Time | 2025-02-15 04:26:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccddbec798_1739593598
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpe1mwE0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bmggum_v0.1.0-tikzDictionary"
