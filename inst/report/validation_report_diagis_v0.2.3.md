# Validation Report - diagis@0.2.3
...
| has_source_control   | https://github.com/helske/diagis/  |
...
Overall the package has 11 exported objects. 11 are documented:
                      ...
                      ess           running_ess          running_mean 
                     TRUE                  TRUE                  TRUE 
              running_var running_weighted_mean  running_weighted_var 
                     TRUE                  TRUE                  TRUE 
              weight_plot         weighted_mean     weighted_quantile 
                     TRUE                  TRUE                  TRUE 
              weighted_se          weighted_var 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-18 03:58:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4a70cd45_1739851077
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjUxWyy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diagis_v0.2.3-tikzDictionary"
