# Validation Report - contoureR@1.0.5
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Nicholas Hamilton <n.hamilton@unsw.edu.au>           |
...
Overall the package has 5 exported objects. 5 are documented:
      ...
      contourLinesR getContourLines   getConvexHull getDelaunayMesh     orderPoints 
...
| Execution Time | 2025-02-17 03:49:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6593267de_1739764170
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZWFhtg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_contoureR_v1.0.5-tikzDictionary"
