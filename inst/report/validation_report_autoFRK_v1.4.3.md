...
|:----|:----------------------|:----------|
| 1   | spam                  | Depends   |
| 2   | fields (\>= 6.9.1)    | Imports   |
| 3   | filehashSQLite        | Imports   |
| 4   | filehash              | Imports   |
| 5   | MASS                  | Imports   |
| 6   | mgcv                  | Imports   |
| 7   | LatticeKrig (\>= 5.4) | Imports   |
| 8   | FNN                   | Imports   |
| 9   | filematrix            | Imports   |
| 10  | Rcpp                  | Imports   |
| 11  | methods               | Imports   |
| 12  | Rcpp                  | LinkingTo |
| 13  | RSpectra              | LinkingTo |
...
There are 3 help pages with examples, from 38 (7.89 %).
...
| Execution Time | 2025-02-14 07:33:21 UTC |
...
running this report
    ...
    PROCESSX_PS1c095d23c2b_1739518398
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWsY6AJ
