...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Kaveh Vakili <vakili.kaveh.email@gmail.com>          |
...
| 2   | MASS                    | Imports   |
| 3   | pcaPP                   | Imports   |
| 4   | Rcpp (\>= 0.10.5)       | LinkingTo |
| 5   | RcppEigen (\>= 0.3.2.2) | LinkingTo |
...
Overall the package has 6 exported objects. 6 are documented:
      ...
      DetLTS    DetMM     inQn   inUMCD OGKCStep    quanf 
...
| Execution Time | 2025-02-18 03:50:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45efa718d_1739850642
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7D792N
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DetR_v0.0.5-tikzDictionary"
