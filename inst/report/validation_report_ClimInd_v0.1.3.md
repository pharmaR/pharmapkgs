# Validation Report - ClimInd@0.1.3
...
| export_help          | 128                                                  |
| has_website          | TRUE                                                 |
| has_maintainer       | Fergus Reig-Gracia <fergusrg@gmail.com>              |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://gitlab.com/indecis-eu/indecis                |
...
Overall the package has 128 exported objects. 128 are documented:
                   ...
                   bio19                bio20                 bio4 
                    ...
                    bio5                 bio6                 bio7 
                    TRUE                 TRUE                 TRUE 
                    bio8                 bio9        calculate_all 
                    TRUE                 TRUE                 TRUE 
    calculate_all_scales                   cc                  cdd 
                    TRUE                 TRUE                 TRUE 
                     cfd          ClimIndNews                  cmd 
                    TRUE                 TRUE                 TRUE 
                     csd                 csdi                  cwd 
...
There are 166 help pages with examples, from 166 (100.00 %).
...
| Execution Time | 2025-02-16 04:31:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3150ce33c_1739680306
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTrb0as
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClimInd_v0.1.3-tikzDictionary"
