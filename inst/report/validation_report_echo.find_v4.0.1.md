# Validation Report - echo.find@4.0.1
...
| export_help          | 1                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Jennifer Hurley <hurlej2@rpi.edu>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/delosh653/ECHO                    |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | minpack.lm (\>= 1.2.1) | Imports |
| 2   | boot (\>= 1.3-22)      | Imports |
...
| Execution Time | 2025-02-19 03:32:19 UTC |
...
running this report
    ...
    PROCESSX_PS1d4562c3dba4_1739935933
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeZ0XxI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_echo.find_v4.0.1-tikzDictionary"
