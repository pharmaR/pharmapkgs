...
| export_help          | 24                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Krzysztof Drachal <kdrachal@wne.uw.edu.pl>           |
...
Overall the package has 24 exported objects. 24 are documented:
             ...
             altf         altf2         altf3         altf4      archtest 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         descstat        dmtest          fDMA    gNormalize      grid.DMA 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    grid.roll.reg      grid.tvp     hit.ratio      hmdmtest       mdmtest 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        normalize        onevar       rec.reg   reduce.size      roll.reg 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              rvi   standardize         stest           tvp 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-27 03:23:24 UTC |
...
running this report
    ...
    PROCESSX_PS1c6267a47f3e_1740626600
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdKS5OR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fDMA_v2.2.8-tikzDictionary"
