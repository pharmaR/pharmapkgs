...
| export_help          | 27                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Juan Carlos Aledo <caledo@uma.es>                    |
...
Overall the package has 27 exported objects. 27 are documented:
           ...
           aa.at      aa.comp          aaf      cos2dis     d.phy2df     df2fasta 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
     env.extract    env.fasta env.matrices       env.sp    envfascpp        envnj 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       fastaconc      metrics    msa.merge     msa.tree          ncd        ncdnj 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           ngram   ngraMatrix    otu.space   otu.vector      svdgram         vcos 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
            vdis    vect2tree        vtree 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-19 04:12:34 UTC |
...
running this report
    ...
    PROCESSX_PS1d457d7b241c_1739938348
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT6I66R
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EnvNJ_v0.1.3-tikzDictionary"
