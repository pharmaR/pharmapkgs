...
| has_source_control   | https://github.com/bcallaway11/did/                  |
...
cdid, did2s, etwfe, fastdid, modelsummary, optic, parameters, ptetools

## Namespace

Overall the package has 23 exported objects. 23 are documented:

                      aggte                AGGTEobj                  att_gt 
                       TRUE                    TRUE                    TRUE 
          build_sim_dataset           compute.aggte          compute.att_gt 
                       TRUE                    TRUE                    TRUE 
    conditional_did_pretest               DIDparams                   ggdid 
                       TRUE                    TRUE                    TRUE 
                     glance                   gplot               indicator 
                       TRUE                    TRUE                    TRUE 
                      mboot                      MP                 MP.TEST 
                       TRUE                    TRUE                    TRUE 
            pre_process_did           process_attgt               reset.sim 
                       TRUE                    TRUE                    TRUE 
                        sim                   splot              test.mboot 
                       TRUE                    TRUE                    TRUE 
                       tidy                 trimmer 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-18 04:01:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bb426c71514_1739851271
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprDJ7hx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_did_v2.1.2-tikzDictionary"
