...
| size_codebase        | 876                                    |
| has_source_control   | https://github.com/dynverse/anndata    |
...
Overall the package has 19 exported objects. 19 are documented:
            ...
            AnnData       AnnDataR6          concat install_anndata          Layers 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           LayersR6             Raw           RawR6        read_csv      read_excel 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          read_h5ad        read_hdf       read_loom        read_mtx       read_text 
               TRUE            TRUE            TRUE            TRUE            TRUE 
     read_umi_tools      write_csvs      write_h5ad      write_loom 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 06:55:20 UTC |
...
running this report
    ...
    PROCESSX_PS726d7ae3bea3_1739516117
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQNkQeP
