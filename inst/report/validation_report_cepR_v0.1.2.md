...
| export_help | 6 |
| has_website | TRUE |
| has_maintainer | Robert Myles McDonnell <robertmylesmcdonnell@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/RobertMyles/cepR |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | httr(\>= 1.2.1)    | Imports |
| 2   | tibble(\>= 1.3.3)  | Imports |
| 3   | magrittr (\>= 1.5) | Imports |
| 4   | dplyr (\>= 1.0.0)  | Imports |
| 5   | purrr (\>= 0.3.0)  | Imports |
...
Overall the package has 6 exported objects. 5 are documented:
              ...
              %>%     busca_cep busca_cidades  busca_estado  busca_latlon 
...
| Execution Time | 2025-02-16 04:01:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3e12438a_1739678503
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpudh33g
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cepR_v0.1.2-tikzDictionary"
