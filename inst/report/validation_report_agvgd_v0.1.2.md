...
| export_help          | 16                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Ramiro Magno <ramiro.magno@gmail.com> |
| bugs_status          | subscript out of bounds               |
| size_codebase        | 659                                   |
| has_source_control   | https://github.com/maialab/agvgd      |
...
Overall the package has 16 exported objects. 15 are documented:
                      ...
                      %>%                 agvgd        alignment_file 
                    FALSE                  TRUE                  TRUE 
              amino_acids            cpv_ranges                   dev 
                     TRUE                  TRUE                  TRUE 
                       gd                    gv            poi_to_res 
                     TRUE                  TRUE                  TRUE 
     profile_to_alignment read_agvgdweb_results        read_alignment 
                     TRUE                  TRUE                  TRUE 
       read_substitutions            res_to_poi       write_alignment 
                     TRUE                  TRUE                  TRUE 
      write_substitutions 
                     TRUE 
...
| Execution Time | 2025-02-14 06:43:57 UTC |
...
running this report
    ...
    PROCESSX_PS726da984933_1739515434
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPQ3Cgn
