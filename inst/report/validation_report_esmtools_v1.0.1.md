# Validation Report - esmtools@1.0.1
...
| export_help | 16 |
| has_website | TRUE |
| has_maintainer | Jordan Revol <jordan.revol@kuleuven.be> |
| bugs_status | scraping bug reports fromm BugReports host ‘kuleuven’ not implemented |
...
| 7   | grDevices              | Imports |
| 8   | htmltools              | Imports |
| 9   | jsonlite (\>= 1.8.0)   | Imports |
| 10  | kableExtra (\>= 1.3.0) | Imports |
| 11  | knitr (\>= 1.43)       | Imports |
| 12  | lubridate (\>= 1.9.0)  | Imports |
| 13  | stats                  | Imports |
| 14  | stringr (\>= 1.5.0)    | Imports |
| 15  | tidyr (\>= 1.3.0)      | Imports |
| 16  | tools                  | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
    ...
    add_script_to_rmd            button     calendar_plot    codebook_table 
                 TRUE              TRUE              TRUE              TRUE 
             controws          dataInfo         endbutton           folrows 
                 TRUE              TRUE              TRUE              TRUE 
       getEsmtoolsEnv heatcalendar_plot        longstring participants_book 
                 TRUE              TRUE              TRUE              TRUE 
             randrows               txt      use_template      vars_consist 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 04:30:37 UTC |
...
running this report
    ...
    PROCESSX_PS1d4547b4fec8_1739939431
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphSPVrw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_esmtools_v1.0.1-tikzDictionary"
