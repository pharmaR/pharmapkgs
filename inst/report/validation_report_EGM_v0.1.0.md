...
| export_help          | 33                               |
| has_website          | TRUE                             |
| has_maintainer       | Anish S. Shah <ashah282@uic.edu> |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | vctrs (\>= 0.5.0)       | Depends |
| 2   | data.table (\>= 1.15.0) | Depends |
| 3   | stats                   | Imports |
| 4   | fs                      | Imports |
| 5   | ggplot2                 | Imports |
| 6   | lifecycle               | Imports |
...
Overall the package has 33 exported objects. 33 are documented:
             ...
             add_colors       annotate_wfdb    annotation_table     center_sequence 
                   TRUE                TRUE                TRUE                TRUE 
         color_channels                 egm      extract_signal   find_wfdb_command 
                   TRUE                TRUE                TRUE                TRUE 
     find_wfdb_software                 ggm        header_table is_annotation_table 
                   TRUE                TRUE                TRUE                TRUE 
                 is_egm     is_header_table     is_signal_table        pad_sequence 
                   TRUE                TRUE                TRUE                TRUE 
        read_annotation         read_header          read_lspro   read_lspro_header 
                   TRUE                TRUE                TRUE                TRUE 
      read_lspro_signal           read_muse         read_signal           read_wfdb 
                   TRUE                TRUE                TRUE                TRUE 
       segment_by_sinus        segmentation       set_wfdb_path        signal_table 
                   TRUE                TRUE                TRUE                TRUE 
              theme_egm      theme_egm_dark     theme_egm_light    write_annotation 
                   TRUE                TRUE                TRUE                TRUE 
             write_wfdb 
                   TRUE 
...
There are 15 help pages with examples, from 17 (88.24 %).
...
| Execution Time | 2025-02-19 03:49:04 UTC |
...
running this report
    ...
    PROCESSX_PS1d453c2b188b_1739936938
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpv8Gqqc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EGM_v0.1.0-tikzDictionary"
