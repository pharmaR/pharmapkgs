# Validation Report - CalibrationCurves@2.0.4
...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | De Cock Bavo <bavo.decock@kuleuven.be>               |
...
Overall the package has 6 exported objects. 4 are documented:
             ...
             %{}%          %<=%   genCalCurve      LibraryM val.prob.ci.2 
...
| Execution Time | 2025-02-16 03:35:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc365e8401e_1739676917
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4Z83pw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CalibrationCurves_v2.0.4-tikzDictionary"
