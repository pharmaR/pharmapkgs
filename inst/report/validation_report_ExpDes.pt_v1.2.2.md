# Validation Report - ExpDes.pt@1.2.2
...
| export_help | 41 |
| has_website | FALSE |
| has_maintainer | Eric Batista Ferreira <eric.ferreira@unifal-mg.edu.br> |
...
Overall the package has 41 exported objects. 41 are documented:
     ...
     anscombetukey       bartlett         ccboot            ccF            dbc 
              TRUE           TRUE           TRUE           TRUE           TRUE 
               dic            dql         duncan         faixas    fat2.ad.dbc 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       fat2.ad.dic   fat2.ad2.dbc   fat2.ad2.dic       fat2.dbc       fat2.dic 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       fat3.ad.dbc    fat3.ad.dic       fat3.dbc       fat3.dic           ginv 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          graficos            han          lastC         layard         levene 
              TRUE           TRUE           TRUE           TRUE           TRUE 
               lsd           lsdb      oneilldbc  oneillmathews    order.group 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    order.stat.SNK        plotres      psub2.dbc      psub2.dic         reg.nl 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          reg.poly      samiuddin     scottknott            snk    tapply.stat 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             tukey 
              TRUE 
...
| Execution Time | 2025-02-19 04:51:37 UTC |
...
running this report
    ...
    PROCESSX_PS1d45364d8296_1739940690
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKHQZkL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ExpDes.pt_v1.2.2-tikzDictionary"
