...
| export_help | 41 |
| has_website | FALSE |
| has_maintainer | Santos J. González-Rojí <santosjose.gonzalez@ehu.eus> |
...
Overall the package has 41 exported objects. 41 are documented:
                  ...
                  adiabatic_ascent               AnyAdiabaticDown 
                              TRUE                           TRUE 
                        boltonTLCL      bruntVaisallaOmegaSquared 
                              TRUE                           TRUE 
                               C2K                       CAPE_CIN 
                              TRUE                           TRUE 
                        densityDry                    densityH2Ov 
                              TRUE                           TRUE 
                   densityMoistAir          dewpointdepression2rh 
                              TRUE                           TRUE 
                               e2w equivalentPotentialTemperature 
                              TRUE                           TRUE 
                  export_constants                   export_lines 
                              TRUE                           TRUE 
                          find_lcl                gamma_saturated 
                              TRUE                           TRUE 
                               K2C                         Kindex 
                              TRUE                           TRUE 
                   latent_heat_H2O                        LIindex 
                              TRUE                           TRUE 
           moistAdiabaticLapseRate                        moistCp 
                              TRUE                           TRUE 
                           moistCv                    parcelState 
                              TRUE                           TRUE 
                          PT2Theta                       PTheta2T 
                              ...
                              TRUE                           TRUE 
                               q2w                        rh2shum 
                              TRUE                           TRUE 
                              rh2w        saturation_mixing_ratio 
                              TRUE                           TRUE 
           saturation_pressure_H2O                         Sindex 
                              TRUE                           TRUE 
                     stuve_diagram                        TTdP2rh 
                              TRUE                           TRUE 
                          TTheta2P                        TTindex 
                              TRUE                           TRUE 
               virtual_temperature                            w2q 
                              TRUE                           TRUE 
                              w2Td 
                              TRUE 
...
| Execution Time | 2025-02-14 06:46:29 UTC |
...
running this report
    ...
    PROCESSX_PS726d535ca132_1739515587
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6qUewI
