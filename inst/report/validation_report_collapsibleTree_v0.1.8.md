# Validation Report - collapsibleTree@0.1.8
...
| export_help          | 5                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Adeel Khan <AdeelK@gwu.edu>                 |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/AdeelK93/collapsibleTree |
...
covid19.analytics, directotree, phecodemap, shinyMixR, whippr

## Namespace

Overall the package has 5 exported objects. 5 are documented:

           collapsibleTree collapsibleTreeNetwork  collapsibleTreeOutput 
                      TRUE                   TRUE                   TRUE 
    collapsibleTreeSummary  renderCollapsibleTree 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:56:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bc325ff7941_1739681806
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgFPLga
...
These are the options set to generate the report:
    ...
    [1] "validation_report_collapsibleTree_v0.1.8-tikzDictionary"
