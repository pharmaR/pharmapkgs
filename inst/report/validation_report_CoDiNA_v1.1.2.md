# Validation Report - CoDiNA@1.1.2
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Deisy Morselli Gysi <deisy.ccnr@gmail.com>           |
...
Overall the package has 6 exported objects. 6 are documented:
       ...
       as.igraph ClusterNodes  MakeDiffNet    normalize   OrderNames  plot.CoDiNA 
...
| Execution Time | 2025-02-16 04:52:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32d4fa7f6_1739681566
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQesYtk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CoDiNA_v1.1.2-tikzDictionary"
