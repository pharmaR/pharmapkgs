# Validation Report - BiTrinA@1.3.1
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Hans Kestler <hans.kestler@uni-ulm.de>               |
...
Overall the package has 6 exported objects. 7 are documented:

       binarize.BASC  binarize.kMeans   binarizeMatrix             TASC 
                TRUE             TRUE             TRUE             TRUE 
    trinarize.kMeans  trinarizeMatrix 
                TRUE             TRUE 

### Examples

There are 11 help pages with examples, from 15 (73.33 %).
...
| Execution Time | 2025-02-15 04:18:50 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd47cf0adb_1739593125
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3UueLJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BiTrinA_v1.3.1-tikzDictionary"
