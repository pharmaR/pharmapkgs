# Validation Report - CLONETv2@2.2.1
...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yari Ciani <yari.ciani@unitn.it>                     |
...
Overall the package has 18 exported objects. 18 are documented:
                         ...
                         adm_table_toy      allele_specific_cna_table_toy 
                                  TRUE                               TRUE 
                                bt_toy         check_ploidy_and_admixture 
                                  TRUE                               TRUE 
    compute_allele_specific_scna_table                 compute_beta_table 
                                  TRUE                               TRUE 
                 compute_dna_admixture                     compute_ploidy 
                                  TRUE                               TRUE 
          compute_scna_clonality_table              compute_snv_clonality 
                                  TRUE                               TRUE 
                           error_table                  pileup_normal_toy 
                                  TRUE                               TRUE 
                      pileup_tumor_toy                       pl_table_toy 
                                  TRUE                               TRUE 
              scna_clonality_table_toy                         seg_tb_toy 
                                  TRUE                               TRUE 
               snv_clonality_table_toy                      snv_reads_toy 
                                  TRUE                               TRUE 
...
| Execution Time | 2025-02-16 04:35:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bc334fbf6df_1739680495
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmqTRKy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CLONETv2_v2.2.1-tikzDictionary"
