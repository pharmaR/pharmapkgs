# Validation Report - cointReg@0.2.0
...
| export_help | 11 |
| has_website | TRUE |
| has_maintainer | Philipp Aschersleben <aschersleben@statistik.tu-dortmund.de> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/aschersleben/cointReg |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | checkmate (\>= 1.6.0)    | Imports |
| 2   | MASS                     | Imports |
| 3   | matrixStats (\>= 0.14.1) | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
      ...
      checkDoptions     checkObject       checkVars        cointReg       cointRegD 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         cointRegFM      cointRegIM    getBandwidth getBandwidthAnd  getBandwidthNW 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      getLongRunVar 
               TRUE 
...
| Execution Time | 2025-02-16 04:56:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bc343e66f8d_1739681777
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIhFt2q
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cointReg_v0.2.0-tikzDictionary"
