# Validation Report - CompAREdesign@2.3.1
...
| export_help | 26 |
| has_website | FALSE |
| has_maintainer | Marta Bofill Roig <marta.bofillroig@meduniwien.ac.at> |
...
Overall the package has 26 exported objects. 26 are documented:
               ...
               ARE_cbe            ARE_tte    CopulaSelection           dClayton 
                  TRUE               TRUE               TRUE               TRUE 
                  dFGM             dFrank            dGumbel            dNormal 
                  TRUE               TRUE               TRUE               TRUE 
        effectsize_cbe     effectsize_tte              f_sim   freedman_formula 
                  TRUE               TRUE               TRUE               TRUE 
             get_prob1         lower_corr MarginalsSelection           plot_tte 
                  TRUE               TRUE               TRUE               TRUE 
              prob_cbe     samplesize_cbe     samplesize_tte schoenfeld_formula 
                  TRUE               TRUE               TRUE               TRUE 
            simula_cbe         simula_tte              Sstar    Sstar_func_perc 
                  TRUE               TRUE               TRUE               TRUE 
              surv_tte         upper_corr 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-17 03:34:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67d75c3e8_1739763245
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpxu1fpn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CompAREdesign_v2.3.1-tikzDictionary"
