...
| size_codebase        | 315                                   |
| has_source_control   | https://github.com/r-lib/archive      |
...
Overall the package has 8 exported objects. 8 are documented:
                ...
                archive     archive_extract        archive_read       archive_write 
                   TRUE                TRUE                TRUE                TRUE 
      archive_write_dir archive_write_files           file_read          file_write 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-14 07:21:41 UTC |
...
running this report
    ...
    PROCESSX_PS1c097304a6fc_1739517698
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7Gk7EZ
