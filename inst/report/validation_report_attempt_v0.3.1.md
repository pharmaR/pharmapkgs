...
| export_help          | 37                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Colin Fay <contact@colinfay.me>                      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 253                                                  |
| has_source_control   | https://github.com/ColinFay/attempt                  |
...
Overall the package has 37 exported objects. 37 are documented:
             ...
             attempt       discreetly        discretly           if_all 
                TRUE             TRUE             TRUE             TRUE 
              if_any          if_else          if_none           if_not 
                TRUE             TRUE             TRUE             TRUE 
             if_then     is_try_error    map_try_catch map_try_catch_df 
                TRUE             TRUE             TRUE             TRUE 
          message_if   message_if_all   message_if_any  message_if_none 
                TRUE             TRUE             TRUE             TRUE 
      message_if_not         on_error   silent_attempt         silently 
                TRUE             TRUE             TRUE             TRUE 
             stop_if      stop_if_all      stop_if_any     stop_if_none 
                TRUE             TRUE             TRUE             TRUE 
         stop_if_not           surely        try_catch     try_catch_df 
                TRUE             TRUE             TRUE             TRUE 
             warn_if      warn_if_all      warn_if_any     warn_if_none 
                TRUE             TRUE             TRUE             TRUE 
         warn_if_not     with_message     with_warning  without_message 
                TRUE             TRUE             TRUE             TRUE 
     without_warning 
                TRUE 
...
| Execution Time | 2025-02-14 07:31:30 UTC |
...
running this report
    ...
    PROCESSX_PS1c0944c7b8_1739518287
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxbtMJj
