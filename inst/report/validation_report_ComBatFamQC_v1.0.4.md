# Validation Report - ComBatFamQC@1.0.4
...
| export_help          | 23                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Zheng Ren <zren1422@gmail.com>          |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/Zheng206/ComBatFamQC |
...
| 15  | mgcv           | Imports |
| 16  | bslib          | Imports |
| 17  | shinydashboard | Imports |
| 18  | methods        | Imports |
| 19  | gamlss.dist    | Imports |
| 20  | invgamma       | Imports |
| 21  | openxlsx       | Imports |
...
Overall the package has 23 exported objects. 23 are documented:
         ...
         .biweight_midvar          age_list_gen              age_save 
                     TRUE                  TRUE                  TRUE 
                age_shiny         age_table_gen        age_trend_plot 
                     TRUE                  TRUE                  TRUE 
              combat_harm       combat_plot_gen      combat_table_gen 
                     TRUE                  TRUE                  TRUE 
                   comfam          comfam_shiny                covfam 
                     TRUE                  TRUE                  TRUE 
           cus_result_gen  customize_percentile             data_prep 
                     TRUE                  TRUE                  TRUE 
                diag_save              eb_check              form_gen 
                     TRUE                  TRUE                  TRUE 
    getQuantileRefactored       interaction_gen             model_gen 
                     TRUE                  TRUE                  TRUE 
             residual_gen           visual_prep 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-16 05:02:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33326e9ec_1739682142
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpToPHMz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ComBatFamQC_v1.0.4-tikzDictionary"
