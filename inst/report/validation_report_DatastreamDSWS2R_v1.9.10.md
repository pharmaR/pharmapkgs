# Validation Report - DatastreamDSWS2R@1.9.10
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Charles Cara <charles.cara@absolute-strategy.com>    |
...
Overall the package has 11 exported objects. 11 are documented:
              ...
              cbindRobust                  dsws         getDataStream 
                     TRUE                  TRUE                  TRUE 
              listRequest  staticListRequestSet         staticRequest 
                     TRUE                  TRUE                  TRUE 
         staticRequestSet timeSeriesListRequest     timeSeriesRequest 
                     TRUE                  TRUE                  TRUE 
               UCTSAppend            UCTSUpload 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-17 05:01:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63ea4830d_1739768513
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGmGIAK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DatastreamDSWS2R_v1.9.10-tikzDictionary"
