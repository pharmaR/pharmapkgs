...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Wajid Jawaid <wajid.jawaid@gmail.com>                |
...
celda, DEP, GEOexplorer, Seurat, singleCellTK, SlideCNA, TDbasedUFEadv

## Namespace

Overall the package has 6 exported objects. 6 are documented:

             enrichr   listEnrichrDbs listEnrichrSites       plotEnrich 
                TRUE             TRUE             TRUE             TRUE 
         printEnrich   setEnrichrSite 
                TRUE             TRUE 
...
| Execution Time | 2025-02-19 04:09:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d45100a161b_1739938135
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfnvAca
...
These are the options set to generate the report:
    ...
    [1] "validation_report_enrichR_v3.4-tikzDictionary"
