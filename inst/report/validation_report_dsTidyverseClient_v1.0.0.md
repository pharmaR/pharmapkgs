# Validation Report - dsTidyverseClient@1.0.0
...
Overall the package has 15 exported objects. 15 are documented:
       ...
       ds.arrange  ds.as_tibble  ds.bind_cols  ds.bind_rows  ds.case_when 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      ds.distinct     ds.filter   ds.group_by ds.group_keys    ds.if_else 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        ds.mutate     ds.rename     ds.select      ds.slice    ds.ungroup 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 04:53:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bb412ffb622_1739854433
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAFvCUe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsTidyverseClient_v1.0.0-tikzDictionary"
