...
| export_help          | 15                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Collin Nolte <collin-nolte@uiowa.edu> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/collinn/bdots      |
...
Overall the package has 15 exported objects. 15 are documented:
       ...
       ar1Solver    bdotsBoot    bdotsCorr     bdotsFit   bdotsRefit     bdRemove 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
    coefWriteout  doubleGauss doubleGauss2     expCurve       linear     logistic 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        p_adjust   polynomial     writeCSV 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-15 03:48:30 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3d106532_1739591305
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpo7UAIQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bdots_v1.2.5-tikzDictionary"
