# Validation Report - dynparam@1.0.2
...
| has_source_control   | https://github.com/dynverse/dynparam   |
...
Overall the package has 25 exported objects. 25 are documented:
      ...
      as_descriptive_tibble         as_distribution            as_parameter 
                       TRUE                    TRUE                    TRUE 
           as_parameter_set          as_paramhelper     character_parameter 
                       TRUE                    TRUE                    TRUE 
      distribution_function expuniform_distribution            get_defaults 
                       TRUE                    TRUE                    TRUE 
            get_description       integer_parameter integer_range_parameter 
                       TRUE                    TRUE                    TRUE 
            is_distribution            is_parameter        is_parameter_set 
                       TRUE                    TRUE                    TRUE 
          logical_parameter     normal_distribution       numeric_parameter 
                       TRUE                    TRUE                    TRUE 
    numeric_range_parameter               parameter           parameter_set 
                       TRUE                    TRUE                    TRUE 
          quantile_function                     sip        subset_parameter 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-18 05:06:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42e2e86d6_1739855184
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTYbCaq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dynparam_v1.0.2-tikzDictionary"
