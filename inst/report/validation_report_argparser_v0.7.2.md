...
| export_help | 7 |
| has_website | TRUE |
| has_maintainer | David J. H. Shih <djh.shih@gmail.com> |
| bugs_status | scraping bug reports fromm BugReports host ‘bitbucket’ not implemented |
| size_codebase | 392 |
| has_source_control | https://bitbucket.org/djhshih/argparser |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    add_argument add.argument   arg_parser   arg.parser      include   parse_args 
...
| Execution Time | 2025-02-14 07:23:28 UTC |
...
running this report
    ...
    PROCESSX_PS1c091813500b_1739517805
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpO2one8
