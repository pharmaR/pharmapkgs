# Validation Report - detectRUNS@0.9.6
...
| export_help | 17 |
| has_website | TRUE |
| has_maintainer | Filippo Biscarini <filippo.biscarini@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/bioinformatics-ptp/detectRUNS/tree/master/detectRUNS |
...
Overall the package has 17 exported objects. 17 are documented:
      ...
      consecutiveRUNS.run       Froh_inbreeding  Froh_inbreedingClass 
                     TRUE                  TRUE                  TRUE 
    plot_DistributionRuns    plot_InbreedingChr    plot_manhattanRuns 
                     TRUE                  TRUE                  TRUE 
         plot_PatternRuns             plot_Runs       plot_SnpsInRuns 
                     TRUE                  TRUE                  TRUE 
         plot_StackedRuns       plot_ViolinRuns      readExternalRuns 
                     TRUE                  TRUE                  TRUE 
                reorderDF       slidingRUNS.run         snpInsideRuns 
                     TRUE                  TRUE                  TRUE 
              summaryRuns             tableRuns 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-18 03:50:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bb446091e11_1739850604
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5EGJQi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_detectRUNS_v0.9.6-tikzDictionary"
