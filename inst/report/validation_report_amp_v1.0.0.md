...
| export_help          | 18                              |
| has_website          | FALSE                           |
| has_maintainer       | Adam Elder <shmelder@gmail.com> |
...
Overall the package has 18 exported objects. 18 are documented:
       ...
       add_oth_pvals    calc_gam_star         find_mag  gen_boot_sample 
                TRUE             TRUE             TRUE             TRUE 
       ic.data.examp       ic.pearson       ic.proj.rr ic.proj.rr.nolas 
                TRUE             TRUE             TRUE             TRUE 
            l_p_norm          look_IC      mag_for_pow        make_data 
                TRUE             TRUE             TRUE             TRUE 
          mv_pn_test     pval_for_mag        rr.msm.ic     rr.msm.jn.ic 
                TRUE             TRUE             TRUE             TRUE 
        test.control               ZL 
                TRUE             TRUE 
...
| Execution Time | 2025-02-14 06:52:43 UTC |
...
running this report
    ...
    PROCESSX_PS726d658de482_1739515960
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDfwWjS
