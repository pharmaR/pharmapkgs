# Validation Report - contingency@0.0.10
...
| export_help          | 23                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Robin Evans <evans@stats.ox.ac.uk>   |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/rje42/contingency |
...
Overall the package has 23 exported objects. 23 are documented:
         ...
         as_tables         capply        checkCI    conditional   conditional2 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           entropy interactionInf   intervention             kl         margin 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           margin2       multiInf      mutualInf        ntables       perm_dim 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      rcondProbMat      repTables       rprobMat         tables           tdim 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            tdim<-      tdimnames    tdimnames<- 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 03:49:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6558aaadc_1739764158
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLjWBhn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_contingency_v0.0.10-tikzDictionary"
