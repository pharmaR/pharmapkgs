# Validation Report - economiccomplexity@2.0.0
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          balassa_index complexity_measures  complexity_outlook             density 
                   TRUE                TRUE                TRUE                TRUE 
               distance productivity_levels         projections           proximity 
                   TRUE                TRUE                TRUE                TRUE 
                    rca 
                   TRUE 
...
| Execution Time | 2025-02-19 03:35:58 UTC |
...
running this report
    ...
    PROCESSX_PS1d4548d60442_1739936152
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIFZV0L
...
These are the options set to generate the report:
    ...
    [1] "validation_report_economiccomplexity_v2.0.0-tikzDictionary"
