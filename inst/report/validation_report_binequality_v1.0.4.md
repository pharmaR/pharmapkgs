# Validation Report - binequality@1.0.4
...
| export_help          | 0                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Samuel V. Scarpino <s.scarpino@northeastern.edu>     |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | gamlss (\>= 4.2.7)      | Depends |
| 2   | gamlss.cens (\>= 4.2.7) | Depends |
| 3   | gamlss.dist (\>= 4.3.0) | Depends |
| 4   | survival (\>= 2.37-7)   | Imports |
| 5   | ineq (\>= 0.2-11)       | Imports |
...
| Execution Time | 2025-02-15 04:08:20 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd732934c6_1739592495
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpg3ysPY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binequality_v1.0.4-tikzDictionary"
