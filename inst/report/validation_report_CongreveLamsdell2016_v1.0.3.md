# Validation Report - CongreveLamsdell2016@1.0.3
...
| export_help          | 10                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Martin R. Smith <martin.smith@durham.ac.uk>   |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/ms609/CongreveLamsdell2016 |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       clInitializeTernaryQuarts    clInitializeTernarySplits 
                            TRUE                         TRUE 
           clPlotAverageQuartets          clPlotAverageSplits 
                            TRUE                         TRUE 
         clPlotBestAverageSplits               clPlotQuartets 
                            TRUE                         TRUE 
                    clPlotSplits   clPlotTheseAverageQuartets 
                            TRUE                         TRUE 
        clPlotTheseAverageSplits clPlotTheseBestAverageSplits 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-17 03:44:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67a6b478c_1739763888
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNvixUM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CongreveLamsdell2016_v1.0.3-tikzDictionary"
