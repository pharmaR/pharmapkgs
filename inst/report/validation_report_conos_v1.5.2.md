...
| export_help          | 40                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Evan Biederstedt <evan.biederstedt@gmail.com> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/kharchenkolab/conos        |
...
| 3   | abind              | Imports   |
| 4   | cowplot            | Imports   |
| 5   | ComplexHeatmap     | Imports   |
| 6   | dendextend         | Imports   |
| 7   | dplyr              | Imports   |
| 8   | ggplot2            | Imports   |
| 9   | ggrepel            | Imports   |
| 10  | gridExtra          | Imports   |
| 11  | irlba              | Imports   |
| 12  | leidenAlg          | Imports   |
| 13  | magrittr           | Imports   |
| 14  | methods            | Imports   |
| 15  | N2R                | Imports   |
| 16  | parallel           | Imports   |
...
| 19  | rlang              | Imports   |
| 20  | Rtsne              | Imports   |
| 21  | sccore (\>= 1.0.0) | Imports   |
| 22  | stats              | Imports   |
| 23  | tools              | Imports   |
| 24  | utils              | Imports   |
| 25  | Rcpp               | LinkingTo |
| 26  | RcppArmadillo      | LinkingTo |
| 27  | RcppEigen          | LinkingTo |
| 28  | RcppProgress       | LinkingTo |
...
Overall the package has 40 exported objects. 40 are documented:
                  ...
                  basicSeuratProc         bestClusterThresholds 
                             TRUE                          TRUE 
        bestClusterTreeThresholds                buildWijMatrix 
                             TRUE                          TRUE 
                            Conos              convertToPagoda2 
                             TRUE                          TRUE 
                          edgeMat                     edgeMat<- 
                             TRUE                          TRUE 
                    embeddingPlot  estimateWeightEntropyPerCell 
                             TRUE                          TRUE 
               findSubcommunities getBetweenCellTypeCorrectedDE 
                             TRUE                          TRUE 
             getBetweenCellTypeDE                  getCellNames 
                             TRUE                          TRUE 
                    getClustering                getCountMatrix 
                             TRUE                          TRUE 
                     getEmbedding             getGeneExpression 
                             TRUE                          TRUE 
                         getGenes         getOverdispersedGenes 
                             TRUE                          TRUE 
                           getPca              getPerCellTypeDE 
                             TRUE                          TRUE 
                getRawCountMatrix          getSampleNamePerCell 
                             TRUE                          TRUE 
              greedyModularityCut              leiden.community 
                             TRUE                          TRUE 
                      p2app4conos           plotClusterBarplots 
                             TRUE                          TRUE 
     plotClusterBoxPlotsByAppType         plotComponentVariance 
                             TRUE                          TRUE 
                    plotDEheatmap                   projectKNNs 
                             TRUE                          TRUE 
       rawMatricesWithCommonGenes            saveConosForScanPy 
                             TRUE                          TRUE 
                      saveDEasCSV                  saveDEasJSON 
                             TRUE                          TRUE 
                  scanKModularity                    sgdBatches 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-17 03:46:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6403461f1_1739763988
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMIb3yg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conos_v1.5.2-tikzDictionary"
