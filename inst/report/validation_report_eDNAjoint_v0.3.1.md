# Validation Report - eDNAjoint@0.3.1
...
| export_help          | 7                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Abigail G. Keller <agkeller@berkeley.edu> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/ropensci/eDNAjoint     |
...
| 9   | rlist                     | Imports   |
| 10  | rstan (\>= 2.26.23)       | Imports   |
| 11  | rstantools (\>= 2.3.1.1)  | Imports   |
| 12  | tidyr                     | Imports   |
| 13  | scales                    | Imports   |
...
| 18  | rstan (\>= 2.26.23)       | LinkingTo |
| 19  | StanHeaders (\>= 2.26.22) | LinkingTo |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    detection_calculate      detection_plot         joint_model        joint_select 
                   TRUE                TRUE                TRUE                TRUE 
        joint_summarize         mu_critical   traditional_model 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 03:42:53 UTC |
...
running this report
    ...
    PROCESSX_PS1d455ae2cd50_1739936567
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGCupyW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eDNAjoint_v0.3.1-tikzDictionary"
