# Validation Report - datazoom.amazonia@1.1.0
...
| export_help          | 23                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Igor Rigolon Veiga <igor.rilave@hotmail.com>         |
...
Overall the package has 23 exported objects. 23 are documented:
         ...
         load_aneel       load_baci   load_br_trade     load_cempre  load_censoagro 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       load_climate    load_datasus     load_degrad      load_deter        load_epe 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         load_ibama       load_iema     load_imazon        load_ips  load_mapbiomas 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           load_pam       load_pevs   load_pibmunic load_population        load_ppm 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        load_prodes       load_seeg    load_sigmine 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 05:02:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63223c8d5_1739768570
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgsYwmx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datazoom.amazonia_v1.1.0-tikzDictionary"
