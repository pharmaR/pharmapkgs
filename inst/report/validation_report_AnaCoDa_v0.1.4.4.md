...
| export_help          | 35                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Cedric Landerer <cedric.landerer@gmail.com>          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 2642                                                 |
| has_source_control   | https://github.com/clandere/AnaCoDa                  |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 4000                                                 |
| reverse_dependencies | 0                                                    |
| has_examples         | 0.5542169                                            |
| dependencies         | 5                                                    |
| license              | GPL (\>= 2)                                          |
...
Overall the package has 35 exported objects. 35 are documented:
                         ...
                         AAToCodon                         acfCSP 
                              TRUE                           TRUE 
                           acfMCMC    addObservedSynthesisRateSet 
                              TRUE                           TRUE 
                        aminoAcids calculateMarginalLogLikelihood 
                              TRUE                           TRUE 
                     calculateSCUO                         codons 
                              TRUE                           TRUE 
                         codonToAA               convergence.test 
                              TRUE                           TRUE 
                  findOptimalCodon                       geomMean 
                              TRUE                           TRUE 
                            getCAI                  getCAIweights 
                              TRUE                           TRUE 
                    getCodonCounts            getCodonCountsForAA 
                              TRUE                           TRUE 
                   getCSPEstimates         getExpressionEstimates 
                              TRUE                           TRUE 
      getMixtureAssignmentEstimate                       getNames 
                              TRUE                           TRUE 
                             getNc                        getNcAA 
                              TRUE                           TRUE 
       getObservedSynthesisRateSet       getSelectionCoefficients 
                              TRUE                           TRUE 
                          getTrace         initializeGenomeObject 
                              TRUE                           TRUE 
              initializeMCMCObject          initializeModelObject 
                              TRUE                           TRUE 
         initializeParameterObject                 loadMCMCObject 
                              TRUE                           TRUE 
               loadParameterObject                        runMCMC 
                              TRUE                           TRUE 
                setRestartSettings                writeMCMCObject 
                              TRUE                           TRUE 
...
There are 46 help pages with examples, from 83 (55.42 %).
...
| Execution Time | 2025-02-14 06:53:28 UTC |
...
running this report
    ...
    PROCESSX_PS726d347461a2_1739516005
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpbbcmy1
