...
| export_help          | 10                                   |
| has_website          | TRUE                                 |
| has_maintainer       | David Benatia <david.benatia@hec.ca> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/joelcuerrier/cdid |
...
Overall the package has 10 exported objects. 10 are documented:
                 ...
                 att_gt_cdid                DIDparams  fonction_simu_attrition 
                        TRUE                     TRUE                     TRUE 
                          gg    gmm_compute_delta_att gmm_convert_delta_to_att 
                        TRUE                     TRUE                     TRUE 
          gmm_convert_result                       MP         pre_process_cdid 
                        TRUE                     TRUE                     TRUE 
           process_attgt_gmm 
                        TRUE 
...
| Execution Time | 2025-02-16 03:56:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bc377718b0b_1739678190
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb1y1XS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cdid_v0.1.1-tikzDictionary"
