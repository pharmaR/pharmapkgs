# Validation Report - collUtils@1.0.5
...
| export_help | 7 |
| has_website | TRUE |
| has_maintainer | Kaiyin Zhong <kindlychung@gmail.com> |
| bugs_status | scraping bug reports fromm BugReports host ‘bitbucket’ not implemented |
| has_source_control | https://bitbucket.org/kindlychung/collutils |
...
Overall the package has 7 exported objects. 7 are documented:
           ...
           countlines         getJArray             ncols              rBed 
                 TRUE              TRUE              TRUE              TRUE 
              readcol          readcols truncateEndOfFile 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:57:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bc358e0a8bb_1739681871
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphnBHci
...
These are the options set to generate the report:
    ...
    [1] "validation_report_collUtils_v1.0.5-tikzDictionary"
