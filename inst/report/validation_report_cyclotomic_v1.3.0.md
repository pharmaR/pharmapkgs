# Validation Report - cyclotomic@1.3.0
...
| has_source_control   | https://github.com/stla/cyclotomic         |
...
Overall the package has 18 exported objects. 19 are documented:
             ...
             asComplex          conjugate             cosDeg             cosRev 
                  TRUE               TRUE               TRUE               TRUE 
               cycSqrt          from_just      imaginaryPart isGaussianRational 
                  TRUE               TRUE               TRUE               TRUE 
            isRational             isReal      maybeRational           polarDeg 
                  TRUE               TRUE               TRUE               TRUE 
              polarRev     quadraticRoots           realPart             sinDeg 
                  TRUE               TRUE               TRUE               TRUE 
                sinRev               zeta 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:46:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6219e3069_1739767584
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpy3xIKw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cyclotomic_v1.3.0-tikzDictionary"
