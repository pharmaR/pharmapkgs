# Validation Report - errors@0.4.3
...
| export_help          | 14                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Iñaki Ucar <iucar@fedoraproject.org>   |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/r-quantities/errors |
...
Overall the package has 14 exported objects. 14 are documented:
      ...
      as.errors      correl    correl<-       covar     covar<- drop_errors 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
         errors  errors_max  errors_min    errors<- geom_errors  set_correl 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
      set_covar  set_errors 
           TRUE        TRUE 
...
| Execution Time | 2025-02-19 04:27:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d451d03ac3c_1739939271
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphjcYV8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_errors_v0.4.3-tikzDictionary"
