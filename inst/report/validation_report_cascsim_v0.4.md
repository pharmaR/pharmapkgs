...
Overall the package has 65 exported objects. 134 are documented:

          dempirical          dpareto           dtbeta      dtempirical 
                TRUE             TRUE             TRUE             TRUE 
               dtexp          dtgamma           dtgeom          dtlnorm 
                TRUE             TRUE             TRUE             TRUE 
            dtnbinom           dtnorm         dtpareto           dtpois 
                TRUE             TRUE             TRUE             TRUE 
           dtweibull      expectZeros          mpareto          nloglik 
                TRUE             TRUE             TRUE             TRUE 
             PDFPlot       pempirical         plotText          ppareto 
                TRUE             TRUE             TRUE             TRUE 
              ptbeta      ptempirical            ptexp          ptgamma 
                TRUE             TRUE             TRUE             TRUE 
              ptgeom          ptlnorm         ptnbinom           ptnorm 
                TRUE             TRUE             TRUE             TRUE 
            ptpareto           ptpois        ptweibull       qempirical 
                TRUE             TRUE             TRUE             TRUE 
             qpareto           qtbeta      qtempirical            qtexp 
                TRUE             TRUE             TRUE             TRUE 
             qtgamma           qtgeom          qtlnorm         qtnbinom 
                TRUE             TRUE             TRUE             TRUE 
              qtnorm         qtpareto           qtpois        qtweibull 
                TRUE             TRUE             TRUE             TRUE 
            Quantile       rempirical          rpareto          rreopen 
                TRUE             TRUE             TRUE             TRUE 
              rtbeta      rtempirical            rtexp          rtgamma 
                TRUE             TRUE             TRUE             TRUE 
              rtgeom          rtlnorm         rtnbinom           rtnorm 
                TRUE             TRUE             TRUE             TRUE 
            rtpareto           rtpois        rtweibull setObservation<- 
                TRUE             TRUE             TRUE             TRUE 
               simP0            TMean           toDate         truncate 
                TRUE             TRUE             TRUE             TRUE 
          ultiDevFac 
                TRUE 
...
There are 99 help pages with examples, from 107 (92.52 %).
...
| Execution Time | 2025-02-16 03:44:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3381dc866_1739677468
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwMiOG4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cascsim_v0.4-tikzDictionary"
