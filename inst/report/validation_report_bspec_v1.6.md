...
oceanwaves, psd, sazedR

## Namespace

Overall the package has 52 exported objects. 52 are documented:

                     acf            acf.bspec          acf.default 
                    TRUE                 TRUE                 TRUE 
                   bspec        bspec.default         cosinewindow 
                    TRUE                 TRUE                 TRUE 
              dposterior     dposterior.bspec               dprior 
                    TRUE                 TRUE                 TRUE 
            dprior.bspec    empiricalSpectrum          expectation 
                    TRUE                 TRUE                 TRUE 
       expectation.bspec expectation.bspecACF        hammingwindow 
                    TRUE                 TRUE                 TRUE 
              hannwindow             is.bspec          is.bspecACF 
                    TRUE                 TRUE                 TRUE 
            kaiserwindow           likelihood     likelihood.bspec 
                    TRUE                 TRUE                 TRUE 
          marglikelihood marglikelihood.bspec        matchedfilter 
                    TRUE                 TRUE                 TRUE 
               one.sided      one.sided.bspec           plot.bspec 
                    TRUE                 TRUE                 TRUE 
           plot.bspecACF             ppsample       ppsample.bspec 
                    TRUE                 TRUE                 TRUE 
             print.bspec       print.bspecACF       quantile.bspec 
                    TRUE                 TRUE                 TRUE 
                  sample         sample.bspec       sample.default 
                    TRUE                 TRUE                 TRUE 
                     snr         squarewindow       studenttfilter 
                    TRUE                 TRUE                 TRUE 
                  temper         temper.bspec          temperature 
                    TRUE                 TRUE                 TRUE 
       temperature.bspec       trianglewindow          tukeywindow 
                    TRUE                 TRUE                 TRUE 
               two.sided      two.sided.bspec             variance 
                    TRUE                 TRUE                 TRUE 
          variance.bspec    variance.bspecACF             welchPSD 
                    TRUE                 TRUE                 TRUE 
             welchwindow 
                    TRUE 
...
| Execution Time | 2025-02-15 04:50:01 UTC |
...
running this report
    ...
    PROCESSX_PS1ccda1e88b2_1739594996
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmplxpkkh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bspec_v1.6-tikzDictionary"
