...
| size_codebase        | 33774                                               |
| has_source_control   | https://github.com/HenrikBengtsson/aroma.affymetrix |
| has_bug_reports_url  | 1                                                   |
| downloads_1yr        | 10001                                               |
| reverse_dependencies | 3                                                   |
| has_examples         | 0.9969512                                           |
| dependencies         | 14                                                  |
| license              | LGPL (\>= 2.1)                                      |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | R.utils (\>= 2.9.0)      | Depends |
| 2   | aroma.core (\>= 3.2.0)   | Depends |
| 3   | methods                  | Imports |
| 4   | R.methodsS3 (\>= 1.7.1)  | Imports |
| 5   | R.oo (\>= 1.23.0)        | Imports |
| 6   | R.cache (\>= 0.14.0)     | Imports |
| 7   | R.devices (\>= 2.16.1)   | Imports |
| 8   | R.filesets (\>= 2.13.0)  | Imports |
| 9   | aroma.apd (\>= 0.6.0)    | Imports |
| 10  | MASS                     | Imports |
| 11  | splines                  | Imports |
| 12  | matrixStats (\>= 0.55.0) | Imports |
| 13  | listenv                  | Imports |
| 14  | future                   | Imports |
...
There are 327 help pages with examples, from 328 (99.70 %).
...
| Execution Time | 2025-02-14 07:24:23 UTC |
...
running this report
    ...
    PROCESSX_PS1c09e0d4999_1739517860
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwE8BQx
