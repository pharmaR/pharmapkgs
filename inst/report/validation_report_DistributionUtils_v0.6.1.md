# Validation Report - DistributionUtils@0.6.1
...
GeneralizedHyperbolic, NormalLaplace, SkewHyperbolic, trelliscopejs,
VarianceGamma, ztpln
...
Overall the package has 28 exported objects. 28 are documented:
            ...
            besselRatio       distCalcRange     distIneqMassart distIneqMassartPlot 
                   TRUE                TRUE                TRUE                TRUE 
               distMode        distStepSize   gammaTailPlotLine   incompleteBesselK 
                   TRUE                TRUE                TRUE                TRUE 
     incompleteBesselKR       integrateDens     inversionTestpq     inversionTestqp 
                   TRUE                TRUE                TRUE                TRUE 
         is.wholenumber            kurtosis             logHist      momChangeAbout 
                   TRUE                TRUE                TRUE                TRUE 
          momIntegrated               momSE           moranTest    normTailPlotLine 
                   TRUE                TRUE                TRUE                TRUE 
                  pDist               qDist       safeIntegrate            skewness 
                   TRUE                TRUE                TRUE                TRUE 
               tailPlot        tailPlotLine           tsHessian       tTailPlotLine 
                   TRUE                TRUE                TRUE                TRUE 

### Examples

There are 20 help pages with examples, from 21 (95.24 %).
...
| Execution Time | 2025-02-18 04:20:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bb462dd3867_1739852435
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOQp5qA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DistributionUtils_v0.6.1-tikzDictionary"
