# Validation Report - concatenate@1.0.0
...
| export_help          | 15                                         |
| has_website          | TRUE                                       |
| has_maintainer       | James Dunham <james@jamesdunham.io>        |
| bugs_status          | 0                                          |
| has_source_control   | https://github.com/jamesdunham/concatenate |
...
gwasrapidd, quincunx, rENA

## Namespace

Overall the package has 11 exported objects. 10 are documented:

     % + %    %,%    %+%  %and%   %or%     cc cc_and  cc_or     cn cn_and  cn_or 
...
| Execution Time | 2025-02-17 03:39:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65c11b79_1739763539
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpR0Fqrq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_concatenate_v1.0.0-tikzDictionary"
