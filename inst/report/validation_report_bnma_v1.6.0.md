...
| export_help          | 29                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Michael Seo <swj8874@gmail.com>                      |
...
Overall the package has 29 exported objects. 29 are documented:
       ...
       calculate.contrast.deviance             calculate.deviance 
                              TRUE                           TRUE 
             contrast.network.data contrast.network.deviance.plot 
                              TRUE                           TRUE 
    contrast.network.leverage.plot           contrast.network.run 
                              TRUE                           TRUE 
                draw.network.graph          network.autocorr.diag 
                              TRUE                           TRUE 
             network.autocorr.plot         network.covariate.plot 
                              TRUE                           TRUE 
           network.cumrank.tx.plot                   network.data 
                              TRUE                           TRUE 
             network.deviance.plot            network.forest.plot 
                              TRUE                           TRUE 
               network.gelman.diag            network.gelman.plot 
                              TRUE                           TRUE 
        network.inconsistency.plot          network.leverage.plot 
                              TRUE                           TRUE 
              network.rank.tx.plot                    network.run 
                              TRUE                           TRUE 
            nodesplit.network.data          nodesplit.network.run 
                              TRUE                           TRUE 
                           rank.tx               relative.effects 
                              TRUE                           TRUE 
            relative.effects.table                          sucra 
                              TRUE                           TRUE 
                  ume.network.data                ume.network.run 
                              TRUE                           TRUE 
               variance.tx.effects 
                              TRUE 
...
| Execution Time | 2025-02-15 04:28:18 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd57a34d1_1739593693
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3b4s00
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bnma_v1.6.0-tikzDictionary"
