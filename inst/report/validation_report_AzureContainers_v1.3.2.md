...
| size_codebase                   | 1061                                     |
| has_source_control              | https://github.com/Azure/AzureContainers |
...
Overall the package has 21 exported objects. 21 are documented:
                         ...
                         aci                aci_creds                aci_ports 
                        TRUE                     TRUE                     TRUE 
                         acr               agent_pool                      aks 
                        TRUE                     TRUE                     TRUE 
                   aks_pools              call_docker      call_docker_compose 
                        TRUE                     TRUE                     TRUE 
                   call_helm             call_kubectl          docker_registry 
                        TRUE                     TRUE                     TRUE 
              DockerRegistry get_aci_credentials_list                   is_aci 
                        TRUE                     TRUE                     TRUE 
                      is_acr                   is_aks       is_docker_registry 
                        TRUE                     TRUE                     TRUE 
       is_kubernetes_cluster       kubernetes_cluster        KubernetesCluster 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-14 07:37:41 UTC |
...
running this report
    ...
    PROCESSX_PS1c093e4d7af0_1739518658
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp04UGel
