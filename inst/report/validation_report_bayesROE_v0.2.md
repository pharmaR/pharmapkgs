# Validation Report - bayesROE@0.2
...
| export_help          | 4                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Robert Miller <robert.miller@tu-dresden.de> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/waidschrat/bayesROE      |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | colourpicker       | Imports |
| 2   | config (\>= 0.3.1) | Imports |
| 3   | ggplot2            | Imports |
| 4   | golem (\>= 0.3.3)  | Imports |
| 5   | grDevices          | Imports |
| 6   | scales             | Imports |
| 7   | shiny (\>= 1.7.2)  | Imports |
| 8   | shinyBS            | Imports |
| 9   | stats              | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    rasterROE ribbonROE   run_app  shinyROE 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-15 03:40:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5eaa1ebd_1739590838
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9C4GZo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesROE_v0.2-tikzDictionary"
