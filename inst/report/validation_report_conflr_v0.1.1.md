# Validation Report - conflr@0.1.1
...
| export_help          | 16                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Hiroaki Yutani <hiroaki.yutani@linecorp.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/line/conflr               |
...
Overall the package has 16 exported objects. 16 are documented:
           ...
           confl_contentbody_convert       confl_create_post_from_Rmd 
                                TRUE                             TRUE 
                   confl_delete_page           confl_get_current_user 
                                TRUE                             TRUE 
                      confl_get_page                  confl_get_space 
                                TRUE                             TRUE 
                      confl_get_user           confl_list_attachments 
                                TRUE                             TRUE 
                    confl_list_pages                confl_list_spaces 
                                TRUE                             TRUE 
               confl_post_attachment                  confl_post_page 
                                TRUE                             TRUE 
        confl_update_attachment_data confl_update_attachment_metadata 
                                TRUE                             TRUE 
                   confl_update_page              confluence_document 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-17 03:43:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bd647120e00_1739763807
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOFJ4zI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conflr_v0.1.1-tikzDictionary"
