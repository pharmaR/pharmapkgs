...
| export_help          | 29                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Felipe Campelo <fcampelo@ufmg.br>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | http://github.com/fcampelo/ExpDE                     |
...
Overall the package has 29 exported objects. 29 are documented:
           ...
           check_stop_criteria          create_population 
                          TRUE                       TRUE 
           evaluate_population                      ExpDE 
                          TRUE                       TRUE 
                 mutation_best  mutation_current_to_pbest 
                          TRUE                       TRUE 
                 mutation_mean              mutation_none 
                          TRUE                       TRUE 
            mutation_operators              mutation_rand 
                          TRUE                       TRUE 
                  mutation_wgi             print_progress 
                          TRUE                       TRUE 
           recombination_arith          recombination_bin 
                          TRUE                       TRUE 
    recombination_blxAlphaBeta        recombination_eigen 
                          TRUE                       TRUE 
             recombination_exp          recombination_geo 
                          TRUE                       TRUE 
            recombination_lbga       recombination_linear 
                          TRUE                       TRUE 
            recombination_mmax         recombination_none 
                          TRUE                       TRUE 
          recombination_npoint     recombination_onepoint 
                          TRUE                       TRUE 
       recombination_operators        recombination_pbest 
                          TRUE                       TRUE 
             recombination_sbx       recombination_wright 
                          TRUE                       TRUE 
            selection_standard 
                          TRUE 
...
| Execution Time | 2025-02-19 04:51:22 UTC |
...
running this report
    ...
    PROCESSX_PS1d454daf3b52_1739940676
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOLfzWm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ExpDE_v0.1.4-tikzDictionary"
