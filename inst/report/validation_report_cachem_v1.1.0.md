# Validation Report - cachem@1.1.0
...
| has_source_control   | https://github.com/r-lib/cachem                      |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 10364405                                             |
...
aquodom, bigergm, bslib, comtradr, epidatr, epiparameter, f1dataR,
ffscrapr, filecacher, ggpath, ginmappeR, icesSAG, memoise, meteospain,
neonstore, nflplotR, nflreadr, rgoogleads, shiny, shinyCLT, slackr,
sooty, spatialHeatmap, theft, theftdlc, togglr, UNCOVER, updateme

## Namespace

Overall the package has 5 exported objects. 5 are documented:

        cache_disk  cache_layered      cache_mem is.key_missing    key_missing 
              TRUE           TRUE           TRUE           TRUE           TRUE 

### Examples

There are 3 help pages with examples, from 4 (75.00 %).
...
| Execution Time | 2025-02-16 03:32:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bc355444dc7_1739676754
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpk8bXQ5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cachem_v1.1.0-tikzDictionary"
