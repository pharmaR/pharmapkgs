# Validation Report - disordR@0.9.8.4
...
| has_source_control   | https://github.com/RobinHankin/disordR      |
...
clifford, evitaicossa, frab, freealg, hyper2, mvp, spray, stokes, weyl

## Namespace

Overall the package has 6 exported objects. 3 are documented:

       %~%   %in% lapply  match unlist  which 
...
| Execution Time | 2025-02-18 04:15:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bb468700b2_1739852134
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3N0JIy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_disordR_v0.9.8.4-tikzDictionary"
