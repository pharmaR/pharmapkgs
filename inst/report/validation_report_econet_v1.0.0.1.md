# Validation Report - econet@1.0.0.1
...
| export_help | 4 |
| has_website | FALSE |
| has_maintainer | Valerio Leone Sciabolazza <valerio.leonesciabolazza@uniroma1.it> |
...
| 1   | bbmle          | Imports |
| 2   | igraph         | Imports |
| 3   | intergraph     | Imports |
| 4   | formula.tools  | Imports |
| 5   | Matrix         | Imports |
| 6   | MASS           | Imports |
| 7   | minpack.lm     | Imports |
| 8   | sna            | Imports |
| 9   | spatstat.utils | Imports |
| 10  | stats          | Imports |
| 11  | utils          | Imports |
| 12  | plyr           | Imports |
| 13  | dplyr          | Imports |
| 14  | parallel       | Imports |
| 15  | doParallel     | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
          ...
          boot horse_race    net_dep   quantify 
          TRUE       TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-19 03:35:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d453c1c833c_1739936126
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVTEyJx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_econet_v1.0.0.1-tikzDictionary"
