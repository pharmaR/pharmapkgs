...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Fernando Colchero <fernando_colchero@eva.mpg.de>     |
...
Overall the package has 15 exported objects. 15 are documented:
                     ...
                     basta          basta.default       CensusToCaptHist 
                      TRUE                   TRUE                   TRUE 
           coef.multibasta              DataCheck             FixCMRdata 
                      TRUE                   TRUE                   TRUE 
                multibasta            print.basta   print.bastaCheckCens 
                      TRUE                   TRUE                   TRUE 
       print.bastaCheckCMR       print.multibasta          summary.basta 
                      TRUE                   TRUE                   TRUE 
    summary.bastaCheckCens  summary.bastaCheckCMR     summary.multibasta 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 03:29:22 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd11a9c06f_1739590158
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFMc9Vx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BaSTA_v2.0.1-tikzDictionary"
