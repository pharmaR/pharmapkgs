# Validation Report - bigutilsr@0.3.4
...
| has_source_control   | https://github.com/privefl/bigutilsr       |
...
|:----|:-------------------------|:----------|
| 1   | Rcpp                     | LinkingTo |
| 2   | bigassertr (\>= 0.1.1)   | Imports   |
| 3   | bigparallelr (\>= 0.2.3) | Imports   |
| 4   | nabor                    | Imports   |
| 5   | Rcpp                     | Imports   |
...
bigsnpr, pcadapt, performance

## Namespace

Overall the package has 18 exported objects. 18 are documented:

     as_model_matrix           covRob       covrob_ogk         dist_ogk 
                TRUE             TRUE             TRUE             TRUE 
    geometric_median         hist_out     knn_parallel              LOF 
                TRUE             TRUE             TRUE             TRUE 
          maha_trans  nclass.scottRob       pca_nspike    pca_OADP_proj 
                TRUE             TRUE             TRUE             TRUE 
      pca_OADP_proj2        prob_dist       procrustes         rollmean 
                TRUE             TRUE             TRUE             TRUE 
                svds      tukey_mc_up 
                TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:06:21 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7f213077_1739592376
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZQMyLh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigutilsr_v0.3.4-tikzDictionary"
