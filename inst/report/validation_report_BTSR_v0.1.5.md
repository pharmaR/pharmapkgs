...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Taiane Schaedler Prass <taianeprass@gmail.com>       |
...
Overall the package has 21 exported objects. 21 are documented:
        ...
        BARC.extract         BARC.fit         BARC.sim  BARFIMA.extract 
                TRUE             TRUE             TRUE             TRUE 
         BARFIMA.fit      BARFIMA.sim     btsr.extract         btsr.fit 
                TRUE             TRUE             TRUE             TRUE 
            btsr.sim      coefs.start      fit.control  GARFIMA.extract 
                TRUE             TRUE             TRUE             TRUE 
         GARFIMA.fit      GARFIMA.sim  KARFIMA.extract      KARFIMA.fit 
                TRUE             TRUE             TRUE             TRUE 
         KARFIMA.sim        link.btsr UWARFIMA.extract     UWARFIMA.fit 
                TRUE             TRUE             TRUE             TRUE 
        UWARFIMA.sim 
                TRUE 
...
| Execution Time | 2025-02-15 04:52:54 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd256a9b68_1739595169
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmphhh82Z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BTSR_v0.1.5-tikzDictionary"
