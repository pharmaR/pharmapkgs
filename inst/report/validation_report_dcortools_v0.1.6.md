# Validation Report - dcortools@0.1.6
...
| export_help | 11 |
| has_website | FALSE |
| has_maintainer | Dominic Edelmann <dominic.edelmann@dkfz-heidelberg.de> |
...
Overall the package has 11 exported objects. 11 are documented:
           ...
           dcmatrix dcorgaussianbiv           dcsis         distcor         distcov 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       distcov.test          distsd          hsplot       ipcw.dcor       ipcw.dcov 
               TRUE            TRUE            TRUE            TRUE            TRUE 
     ipcw.dcov.test 
               TRUE 
...
| Execution Time | 2025-02-17 05:11:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bd619f893f3_1739769072
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcY8KgJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dcortools_v0.1.6-tikzDictionary"
