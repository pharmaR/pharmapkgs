# Validation Report - easyPubMed@2.13
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Damiano Fantini <damiano.fantini@gmail.com>          |
...
Moonlight2R, PubMedMining

## Namespace

Overall the package has 10 exported objects. 10 are documented:

                  article_to_df            articles_to_list 
                           TRUE                        TRUE 
          batch_pubmed_download                 custom_grep 
                           TRUE                        TRUE 
           fetch_all_pubmed_ids           fetch_pubmed_data 
                           TRUE                        TRUE 
                 get_pubmed_ids get_pubmed_ids_by_fulltitle 
                           TRUE                        TRUE 
          table_articles_byAuth                trim_address 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-18 05:12:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb436eea315_1739855551
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwYQFL3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easyPubMed_v2.13-tikzDictionary"
