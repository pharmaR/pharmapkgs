# Validation Report - cultevo@1.0.2
...
| export_help          | 23                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Kevin Stadler <a00425926@unet.univie.ac.at> |
...
Overall the package has 23 exported objects. 23 are documented:
              ...
              binaryfeaturematrix                    check.dist 
                             TRUE                          TRUE 
      count.substring.occurrences enumerate.meaningcombinations 
                             TRUE                          TRUE 
             enumerate.substrings                  hammingdists 
                             TRUE                          TRUE 
                      mantel.test    normalisedlevenshteindists 
                             TRUE                          TRUE 
            orderinsensitivedists            page.compute.exact 
                             TRUE                          TRUE 
                           page.L                     page.test 
                             TRUE                          TRUE 
                        read.dist                     repmatrix 
                             TRUE                          TRUE 
                   segment.counts                segment.string 
                             TRUE                          TRUE 
                shuffle.locations           sm.compositionality 
                             TRUE                          TRUE 
                  sm.segmentation          ssm.compositionality 
                             TRUE                          TRUE 
                 ssm.segmentation            temperature.colors 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-17 04:38:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61932c03_1739767106
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpho5lmh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cultevo_v1.0.2-tikzDictionary"
