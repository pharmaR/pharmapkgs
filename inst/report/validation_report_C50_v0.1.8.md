...
baguette, bsnsing, butcher, condvis2, ebmc, fastml, flowml, fmf,
fscaret, imbalance, MachineShop, MetabolomicsBasics, MLPUGS, mlr,
ModTools, noisemodel, parsnip, pdp, pheble, Pigengene, plotmo, rules,
ssc, SSLR, StratifiedRF, tidyrules, tune, utiml

## Namespace

Overall the package has 7 exported objects. 7 are documented:

    as.party.C5.0          C5.0  C5.0.default  C5.0.formula   C5.0Control 
...
| Execution Time | 2025-02-16 03:32:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33e76b986_1739676717
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyzvmCb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_C50_v0.1.8-tikzDictionary"
