# Validation Report - cgmanalysis@3.0.2
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Tim Vigers <timothy.vigers@cuanschutz.edu>           |
...
Overall the package has 3 exported objects. 3 are documented:
       ...
       cgmreport cgmvariables    cleandata 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:06:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33599d50f_1739678766
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2eEerI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cgmanalysis_v3.0.2-tikzDictionary"
