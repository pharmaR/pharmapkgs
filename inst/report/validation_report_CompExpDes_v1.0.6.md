# Validation Report - CompExpDes@1.0.6
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ashutosh Dalal <ashutosh.dalal97@gmail.com>          |
...
Overall the package has 14 exported objects. 14 are documented:
              ...
              Best_Model Discrete_Discrepancy               LHDs_I 
                    TRUE                 TRUE                 TRUE 
                 LHDs_II                  MAC       Maxpro_Measure 
                    TRUE                 TRUE                 TRUE 
          Meeting_Number               NOLHDs             OLHDs_2F 
                    TRUE                 TRUE                 TRUE 
             PhipMeasure                SLHDs           UDesigns_I 
                    TRUE                 TRUE                 TRUE 
             UDesigns_II         UDesigns_III 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-17 03:35:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67293f55b_1739763331
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHZume0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CompExpDes_v1.0.6-tikzDictionary"
