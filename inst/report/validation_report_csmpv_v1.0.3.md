...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Aixiang Jiang <aijiang@bccrc.ca>                     |
...
Overall the package has 16 exported objects. 16 are documented:
               ...
               confirmVars         csmpvModelling             LASSO_plus 
                      TRUE                   TRUE                   TRUE 
    LASSO_plus_XGBtraining                 LASSO2         LASSO2_predict 
                      TRUE                   TRUE                   TRUE 
                LASSO2_reg     LASSO2_XGBtraining             LASSO2plus 
                      TRUE                   TRUE                   TRUE 
    LASSO2plus_XGBtraining              rms_model             validation 
                      TRUE                   TRUE                   TRUE 
               XGBtraining    XGBtraining_predict                 XGpred 
                      TRUE                   TRUE                   TRUE 
            XGpred_predict 
                      TRUE 
...
| Execution Time | 2025-02-17 04:31:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6548c7257_1739766663
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIW1o00
...
These are the options set to generate the report:
    ...
    [1] "validation_report_csmpv_v1.0.3-tikzDictionary"
