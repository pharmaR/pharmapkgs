# Validation Report - Bolstad@0.2.42
...
Overall the package has 26 exported objects. 26 are documented:
      ...
      bayes.lin.reg        bayes.lm    bayes.t.test          binobp          binodp 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            binogcp        binomixp Bolstad.control             cdf     createPrior 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             decomp             IQR         mvnmvnp          normdp         normgcp 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           normmixp          normnp         nvaricp          poisdp        poisgamp 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            poisgcp              sd       sintegral       sscsample             var 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            xdesign 
               TRUE 
...
| Execution Time | 2025-02-15 04:31:07 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd10f08c6b_1739593862
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaFwN8I
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Bolstad_v0.2.42-tikzDictionary"
