...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Megan M. Morbitzer <mmm308@case.edu>                 |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | MASS (\>= 0.5-3.0)      | Imports |
| 2   | segmented (\>= 0.5-3.0) | Imports |
| 3   | qpdf (\>= 1.1)          | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    IVExtractResult       IVfeature         IVsteps     IVuncertain 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 03:29:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4121e7280_1739849334
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJR7ODU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ddiv_v0.1.1-tikzDictionary"
