...
| has_source_control   | https://github.com/mountainMath/cmhc     |
...
Overall the package has 12 exported objects. 12 are documented:
     ...
     cmhc_quality_labels             get_cmhc   get_cmhc_geography 
                    TRUE                 TRUE                 TRUE 
    list_cmhc_breakdowns list_cmhc_dimensions    list_cmhc_filters 
                    TRUE                 TRUE                 TRUE 
        list_cmhc_series    list_cmhc_surveys     list_cmhc_tables 
                    TRUE                 TRUE                 TRUE 
       select_cmhc_table  set_cmhc_cache_path show_cmhc_cache_path 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:44:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bc351070d74_1739681054
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmppee9hD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmhc_v0.2.10-tikzDictionary"
