# Validation Report - ConfusionTableR@1.0.4
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Gary Hutson <hutsons-hacks@outlook.com>              |
...
Overall the package has 4 exported objects. 4 are documented:
      ...
      binary_class_cm binary_visualiseR     dummy_encoder    multi_class_cm 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-17 03:44:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd662852823_1739763865
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmptt7vkT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ConfusionTableR_v1.0.4-tikzDictionary"
