...
| export_help          | 1                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jared S. Murray <jared.murray@mccombs.utexas.edu>    |
...
| 3   | RcppParallel      | LinkingTo |
| 4   | Rcpp              | Imports   |
| 5   | RcppParallel      | Imports   |
| 6   | coda (\>= 0.19.3) | Imports   |
| 7   | Hmisc             | Imports   |
| 8   | parallel          | Imports   |
...
| Execution Time | 2025-02-15 03:45:59 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3698affc_1739591154
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoHgAYG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bcf_v2.0.2-tikzDictionary"
