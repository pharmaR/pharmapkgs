# Validation Report - blackmarbler@0.2.4
...
| export_help          | 3                                   |
| has_website          | TRUE                                |
| has_maintainer       | Robert Marty <rmarty@worldbank.org> |
...
Overall the package has 3 exported objects. 3 are documented:
        ...
        bm_extract      bm_raster get_nasa_token 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-15 04:20:57 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd68cee97f_1739593252
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpufHknO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blackmarbler_v0.2.4-tikzDictionary"
