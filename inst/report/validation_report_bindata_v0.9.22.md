# Validation Report - bindata@0.9.22
...
bigsnpr, cases, CovSel, EMJMCMC, fastcmh, GBJ, simcausal, SIMICO,
UtilityFrailtyPH12
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    bincorr2commonprob   check.commonprob   commonprob2sigma           condprob 
                  TRUE               TRUE               TRUE               TRUE 
                 ra2ba             rmvbin   simul.commonprob          SimulVals 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-22 03:16:26 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb425144c6_1740194182
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSEkIo2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bindata_v0.9.22-tikzDictionary"
