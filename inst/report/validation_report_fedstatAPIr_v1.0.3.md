# Validation Report - fedstatAPIr@1.0.3
...
| export_help          | 7                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Denis Krylov <deniskrylovvit@gmail.com>     |
| bugs_status          | 1                                           |
| has_source_control   | https://github.com/DenchPokepon/fedstatAPIr |
...
Overall the package has 7 exported objects. 6 are documented:
                             ...
                             FALSE                           TRUE 
    fedstat_data_load_with_filters           fedstat_get_data_ids 
                              TRUE                           TRUE 
            fedstat_indicator_info    fedstat_parse_sdmx_to_table 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-27 03:25:49 UTC |
...
running this report
    ...
    PROCESSX_PS1c6244864981_1740626746
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4ol8vc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fedstatAPIr_v1.0.3-tikzDictionary"
