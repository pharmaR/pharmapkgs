# Validation Report - dynamac@0.1.12
...
| export_help          | 8                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Soren Jordan <sorenjordanpols@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/andyphilips/dynamac/  |
...
Overall the package has 8 exported objects. 8 are documented:
                     ...
                     dshift                 dynardl       dynardl.all.plots 
                       TRUE                    TRUE                    TRUE 
    dynardl.auto.correlated dynardl.simulation.plot                 ldshift 
                       TRUE                    TRUE                    TRUE 
                     lshift               pssbounds 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-18 05:03:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46f937a6c_1739855009
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbLjvBd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dynamac_v0.1.12-tikzDictionary"
