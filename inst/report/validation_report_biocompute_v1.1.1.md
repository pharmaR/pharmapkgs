# Validation Report - biocompute@1.1.1
...
| export_help          | 42                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Soner Koc <soner.koc@sevenbridges.com> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/sbg/biocompute      |
           ...
           compose_description compose_description_v1.4.2 
            ...
            compose_provenance  compose_provenance_v1.4.2 
             ...
             compose_usability   compose_usability_v1.4.2 
                          TRUE                       TRUE 
                compose_v1.4.2               convert_json 
                          TRUE                       TRUE 
                  convert_yaml                export_html 
                          TRUE                       TRUE 
                   export_json                 export_pdf 
                          TRUE                       TRUE 
           export_sevenbridges                export_word 
                          TRUE                       TRUE 
              generate_example                generate_id 
                          TRUE                       TRUE 
                        is_bco                  is_domain 
                          TRUE                       TRUE 
                      read_bco          validate_checksum 
                          TRUE                       TRUE 
      validate_checksum_v1.4.2            validate_schema 
                          TRUE                       TRUE 
        validate_schema_v1.4.2                   versions 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-15 04:11:52 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4134f26f_1739592708
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSTldGO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biocompute_v1.1.1-tikzDictionary"
