# Validation Report - BHMSMAfMRI@2.2
...
| export_help          | 11                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Nilotpal Sanyal <nilotpal.sanyal@gmail.com> |
...
|     | package          | type      |
|:----|:-----------------|:----------|
| 1   | Rcpp (\>= 1.0.9) | Imports   |
| 2   | oro.nifti        | Imports   |
| 3   | wavethresh       | Imports   |
| 4   | Rcpp             | LinkingTo |
...
Overall the package has 11 exported objects. 11 are documented:
                   ...
                   BHMSMA               glmcoef         hyperparamest 
                     TRUE                  TRUE                  TRUE 
              postglmcoef      postgroupglmcoef           postmixprob 
                     TRUE                  TRUE                  TRUE 
              postsamples       postwaveletcoef          readfmridata 
                     TRUE                  TRUE                  TRUE 
    substituteWaveletCoef           waveletcoef 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-15 04:00:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7fc736b9_1739592009
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp03SX9U
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BHMSMAfMRI_v2.2-tikzDictionary"
