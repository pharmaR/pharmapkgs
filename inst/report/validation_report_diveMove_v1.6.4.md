# Validation Report - diveMove@1.6.4
...
| export_help          | 59                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Sebastian P. Luque <spluque@gmail.com> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/spluque/diveMove    |
| has_bug_reports_url  | 1                                      |
| downloads_1yr        | 12799                                  |
| reverse_dependencies | 0                                      |
| has_examples         | 0.9268293                              |
| dependencies         | 7                                      |
| license              | GPL-3                                  |
...
Overall the package has 27 exported objects. 56 are documented:

        austFilter           bec2           bec3      boutfreqs      bouts.mle 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         bouts2.ll      bouts2.LL  bouts2.mleFUN     bouts2.nls  bouts2.nlsFUN 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        bouts3.nls  bouts3.nlsFUN calibrateDepth calibrateSpeed      createTDR 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         distSpeed      diveStats grpSpeedFilter          logit   oneDiveStats 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          readLocs        readTDR        rmixexp  rmsDistFilter         rqPlot 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         stampDive        unLogit 
              TRUE           TRUE 
...
There are 38 help pages with examples, from 41 (92.68 %).
...
| Execution Time | 2025-02-18 04:22:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43341c3cd_1739852544
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpckf7m3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diveMove_v1.6.4-tikzDictionary"
