# Validation Report - dexter@1.5.0
...
| export_help          | 45                                |
| has_website          | TRUE                              |
| has_maintainer       | Jesse Koops <jesse.koops@cito.nl> |
...
|     | package                        | type      |
|:----|:-------------------------------|:----------|
| 1   | RSQLite (\>= 2.2.7)            | Imports   |
| 2   | DBI (\>= 1.0.0)                | Imports   |
| 3   | MASS (\>= 7.3)                 | Imports   |
| 4   | tidyr (\>= 1.2.0)              | Imports   |
| 5   | rlang (\>= 1.0.0)              | Imports   |
| 6   | dplyr (\>= 1.1.0)              | Imports   |
| 7   | Rcpp (\>= 1.0.1)               | Imports   |
| 8   | RcppArmadillo (\>= 0.12.6.6.0) | Imports   |
| 9   | graphics                       | Imports   |
| 10  | grDevices                      | Imports   |
| 11  | methods                        | Imports   |
| 12  | utils                          | Imports   |
| 13  | Rcpp                           | LinkingTo |
| 14  | RcppArmadillo (\>= 0.12.6.6.0) | LinkingTo |
| 15  | dqrng                          | LinkingTo |
| 16  | BH                             | LinkingTo |
| 17  | sitmo                          | LinkingTo |
...
Overall the package has 45 exported objects. 45 are documented:
                        ...
                        ability              ability_tables 
                           TRUE                        TRUE 
                    add_booklet         add_item_properties 
                           TRUE                        TRUE 
          add_person_properties           add_response_data 
                           TRUE                        TRUE 
                  close_project                 design_info 
                           TRUE                        TRUE 
                            DIF             distractor_plot 
                           TRUE                        TRUE 
                 expected_score                 fit_domains 
                           TRUE                        TRUE 
                      fit_enorm                   fit_inter 
                           TRUE                        TRUE 
                   get_booklets                  get_design 
                           TRUE                        TRUE 
                      get_items                 get_persons 
                           TRUE                        TRUE 
                  get_resp_data             get_resp_matrix 
                           TRUE                        TRUE 
                  get_responses                   get_rules 
                           TRUE                        TRUE 
                 get_testscores               get_variables 
                           TRUE                        TRUE 
         individual_differences                 information 
                           TRUE                        TRUE 
                  keys_to_rules                  latent_cor 
                           TRUE                        TRUE 
                   open_project                     p_score 
                           TRUE                        TRUE 
               plausible_scores            plausible_values 
                           TRUE                        TRUE 
            probability_to_pass                profile_plot 
                           TRUE                        TRUE 
                 profile_tables                    profiles 
                           TRUE                        TRUE 
                        r_score                  r_score_IM 
                           TRUE                        TRUE 
                  read_oplm_par               standards_3dc 
                           TRUE                        TRUE 
                   standards_db           start_new_project 
                           TRUE                        TRUE 
    start_new_project_from_oplm                  tia_tables 
                           TRUE                        TRUE 
                    touch_rules 
                           TRUE 
...
There are 44 help pages with examples, from 50 (88.00 %).
...
| Execution Time | 2025-02-18 03:52:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bb450f3ca2_1739850731
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaKFakk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dexter_v1.5.0-tikzDictionary"
