...
| export_help          | 31                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Luis Osorio-Olvera <luismurao@gmail.com> |
| bugs_status          | 1                                        |
| size_codebase        | 1733                                     |
| has_bug_reports_url  | 1                                        |
| downloads_1yr        | 3221                                     |
| reverse_dependencies | 0                                        |
| has_examples         | 0.7142857                                |
| dependencies         | 23                                       |
| license              | GPL (\>= 3)                              |
...
|     | package               | type      |
|:----|:----------------------|:----------|
| 1   | animation (\>= 2.3)   | Imports   |
| 2   | crosstalk             | Imports   |
| 3   | dplyr (\>= 0.8.0)     | Imports   |
| 4   | furrr (\>= 0.1.0)     | Imports   |
| 5   | future (\>= 1.18.0)   | Imports   |
| 6   | graphics              | Imports   |
| 7   | grDevices             | Imports   |
| 8   | igraph (\>= 1.2)      | Imports   |
| 9   | leaflet (\>= 2.0)     | Imports   |
| 10  | magrittr (\>= 1.2)    | Imports   |
| 11  | Matrix (\>= 1.2.14)   | Imports   |
| 12  | methods (\>= 3.3)     | Imports   |
| 13  | plotly                | Imports   |
| 14  | purrr (\>= 0.2)       | Imports   |
| 15  | raster (\>= 3.4-13)   | Imports   |
| 16  | Rcpp (\>= 0.12.18)    | Imports   |
| 17  | Rdpack (\>= 0.11.0)   | Imports   |
| 18  | RSpectra (\>= 0.13.1) | Imports   |
| 19  | sp (\>= 1.3.0)        | Imports   |
| 20  | stats                 | Imports   |
| 21  | utils                 | Imports   |
| 22  | Rcpp                  | LinkingTo |
...
Overall the package has 28 exported objects. 29 are documented:

                               adj_mat                       bam_clusters 
                                  TRUE                               TRUE 
                               bam_sim                           bam_ssim 
                                  TRUE                               TRUE 
                              bioindex                    bioindex_sparse 
                                  TRUE                               TRUE 
                         community_sim                                csd 
                                  TRUE                               TRUE 
                          csd_estimate                           csim2pam 
                                  TRUE                               TRUE 
                       diversity_range           diversity_range_analysis 
                                  TRUE                               TRUE 
                             eigen_bam                             g_area 
                                  TRUE                               TRUE 
                               jaccard                       model2sparse 
                                  TRUE                               TRUE 
                            models2pam null_dispersion_field_distribution 
                                  TRUE                               TRUE 
                           occs2sparse                                pam 
                                  TRUE                               TRUE 
                          pam2bioindex                       pam2richness 
                                  TRUE                               TRUE 
                           permute_pam                            sdm_sim 
                                  TRUE                               TRUE 
                                  setA                         shape2Grid 
                                  TRUE                               TRUE 
                         sim2Animation                         sim2Raster 
                                  TRUE                               TRUE 

### Examples

There are 25 help pages with examples, from 35 (71.43 %).
...
| Execution Time | 2025-02-14 07:41:30 UTC |
...
running this report
    ...
    PROCESSX_PS1c091aef6a2e_1739518887
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7z2Nf2
