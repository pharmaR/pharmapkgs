...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jeremy Beaulieu <jmbeauli@uark.edu>                  |
...
Overall the package has 15 exported objects. 15 are documented:
                          ...
                          ancRECON ConvertPhangornReconstructions 
                              TRUE                           TRUE 
                           corDISC                         corHMM 
                              TRUE                           TRUE 
                       dev.raydisc               dropStateMatPars 
                              TRUE                           TRUE 
                equateStateMatPars             fitCorrelationTest 
                              TRUE                           TRUE 
                        getFullMat                  getRateCatMat 
                              TRUE                           TRUE 
                   getStateMat4Dat                     makeSimmap 
                              TRUE                           TRUE 
                       plotMKmodel                      plotRECON 
                              TRUE                           TRUE 
                           rayDISC 
                              TRUE 
...
| Execution Time | 2025-02-17 03:57:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64db8d4d8_1739764654
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpv89WhH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corHMM_v2.8-tikzDictionary"
