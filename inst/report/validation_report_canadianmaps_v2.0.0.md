# Validation Report - canadianmaps@2.0.0
...
| export_help          | 15                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Joelle Cayen <joelle.cayen@phac-aspc.gc.ca> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/joellecayen/canadianmaps |
...
Overall the package has 15 exported objects. 15 are documented:
    ...
    coord_transform       crs_coord         geom_cd        geom_csd        geom_fsa 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            geom_hr       geom_prov        geom_reg      label_prov       label_reg 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    scale_color_map  scale_fill_map       text_prov       theme_map    theme_wallis 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-16 03:37:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bc357d9510f_1739677043
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUZVJTV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_canadianmaps_v2.0.0-tikzDictionary"
