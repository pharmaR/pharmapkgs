# Validation Report - DiscreteFDR@2.1.0
...
| has_source_control   | https://github.com/DISOhda/DiscreteFDR |
...
| 2   | DiscreteTests (\>= 0.2.1) | Imports   |
| 3   | lifecycle                 | Imports   |
| 4   | checkmate                 | Imports   |
| 5   | DiscreteDatasets          | Imports   |
| 6   | Rcpp                      | LinkingTo |
...
Overall the package has 9 exported objects. 9 are documented:
                      ...
                      ADBH                    DBH                    DBR 
                      TRUE                   TRUE                   TRUE 
                       DBY     direct.discrete.BH            discrete.BH 
                      TRUE                   TRUE                   TRUE 
             fast.Discrete fisher.pvalues.support       generate.pvalues 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:13:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44c3c23e0_1739851988
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVVpvs3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiscreteFDR_v2.1.0-tikzDictionary"
