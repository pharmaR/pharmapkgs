# Validation Report - costsensitive@0.1.2.10
...
| has_source_control   | https://github.com/david-cortes/costsensitive        |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    cost.proportionate.classifier        regression.one.vs.rest 
                             TRUE                          TRUE 
               weighted.all.pairs          weighted.one.vs.rest 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-17 04:03:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd653c7e78c_1739764999
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpwhw1rR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_costsensitive_v0.1.2.10-tikzDictionary"
