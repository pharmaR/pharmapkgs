# Validation Report - cophescan@1.4.1
...
| export_help          | 15                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Ichcha Manipur <im504@cam.ac.uk>      |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/ichcha-m/cophescan |
...
Overall the package has 15 exported objects. 15 are documented:
        ...
        adjust_priors        combine.bf     cophe_heatmap        cophe_plot 
                 TRUE              TRUE              TRUE              TRUE 
    cophe.hyp.predict  cophe.multitrait      cophe.single  cophe.single.lbf 
                 TRUE              TRUE              TRUE              TRUE 
          cophe.susie   cophe.susie.lbf     Hc.cutoff.fdr hypothesis.priors 
                 TRUE              TRUE              TRUE              TRUE 
       per.snp.priors plot_trait_manhat run_metrop_priors 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-17 03:54:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66849c6a_1739764441
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXOi5yO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cophescan_v1.4.1-tikzDictionary"
