...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Hassan Pazira <hassan.pazira@radboudumc.nl>          |
...
Overall the package has 14 exported objects. 14 are documented:
          ...
          A.l.maker          b.diag             bfi     hazards.fun         i.basis 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      inv.prior.cov     lambda.poly  MAP.estimation     model.maker           n.par 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    negloglik.theta  optim.survival          ql.LRT   surv.simulate 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 03:57:29 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd51b364af_1739591844
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdalrwK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BFI_v2.0.1-tikzDictionary"
