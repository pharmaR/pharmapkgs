# Validation Report - cicerone@1.0.4
...
| export_help          | 4                              |
| has_website          | TRUE                           |
| has_maintainer       | John Coene <jcoenep@gmail.com> |
...
designer, sendigR, systemPipeShiny, tidyCDISC, toxSummary

## Namespace

Overall the package has 4 exported objects. 4 are documented:

        Cicerone    highlight   initialise use_cicerone 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:18:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35545806e_1739679484
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRmIfEy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cicerone_v1.0.4-tikzDictionary"
