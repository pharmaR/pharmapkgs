# Validation Report - ergm.multi@0.2.1.1
...
|     | package                    | type      |
|:----|:---------------------------|:----------|
| 1   | ergm (\>= 4.6.0)           | Depends   |
| 2   | network (\>= 1.18.2)       | Depends   |
| 3   | statnet.common (\>= 4.9.0) | Imports   |
| 4   | rlang (\>= 1.1.3)          | Imports   |
| 5   | purrr (\>= 1.0.2)          | Imports   |
| 6   | tibble (\>= 3.2.1)         | Imports   |
| 7   | glue (\>= 1.7.0)           | Imports   |
| 8   | rle (\>= 0.9.2)            | Imports   |
| 9   | Rdpack (\>= 2.6)           | Imports   |
| 10  | Matrix                     | Imports   |
| 11  | methods                    | Imports   |
| 12  | parallel                   | Imports   |
| 13  | ergm                       | LinkingTo |
...
Overall the package has 15 exported objects. 15 are documented:
              ...
              combine_ergmlhs          combine_networks              control.gofN 
                         TRUE                      TRUE                      TRUE 
            control.gofN.ergm ergm_block_diag_samp_info           ergm_LayerLogic 
                         TRUE                      TRUE                      TRUE 
                         gofN                     Layer                   lm.gofN 
                         TRUE                      TRUE                      TRUE 
                marg_cond_sim              network_view                  Networks 
                         TRUE                      TRUE                      TRUE 
                       snctrl      subnetwork_templates         uncombine_network 
                         TRUE                      TRUE                      TRUE 

### Examples

There are 42 help pages with examples, from 45 (93.33 %).
...
| Execution Time | 2025-02-19 04:26:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d455aa5ae3_1739939160
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3jxK6r
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ergm.multi_v0.2.1.1-tikzDictionary"
