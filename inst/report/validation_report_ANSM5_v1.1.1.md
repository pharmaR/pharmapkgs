...
| export_help          | 54                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Neil Spencer <neilhspencer@gmail.com>                |
...
Overall the package has 54 exported objects. 54 are documented:
             ...
             ansari.bradley                   binom               blomqvist 
                       TRUE                    TRUE                    TRUE 
                     bowker             breslow.day                      bs 
                       TRUE                    TRUE                    TRUE 
             chisqtest.ANSM               cochran.q             cohen.kappa 
                       TRUE                    TRUE                    TRUE 
                    conover          control.median              cox.stuart 
                       TRUE                    TRUE                    TRUE 
           cramer.von.mises         fishertest.ANSM                friedman 
                       TRUE                    TRUE                    TRUE 
               friedman.lsd          gehan.wilcoxon   hettmansperger.elmore 
                       TRUE                    TRUE                    TRUE 
                hodges.ajne     jonckheere.terpstra     kendall.concordance 
                       TRUE                    TRUE                    TRUE 
                kendall.tau          kruskal.wallis      kruskal.wallis.lsd 
                       TRUE                    TRUE                    TRUE 
         kruskal.wallis.vdW             kstest.ANSM               lik.ratio 
                       TRUE                    TRUE                    TRUE 
                 lilliefors        linear.by.linear        logoddsratio.2x2 
                       TRUE                    TRUE                    TRUE 
                    logrank         mantel.haenszel                med.test 
                       TRUE                    TRUE                    TRUE 
                       mood moses.extreme.reactions                 noether 
                       TRUE                    TRUE                    TRUE 
         normal.scores.test       oddsratio.2x2diff                 pearson 
                       TRUE                    TRUE                    TRUE 
               pearson.beta           peto.wilcoxon                  pitman 
                       TRUE                    TRUE                    TRUE 
                   rng.test               runs.2cat               runs.ncat 
                       TRUE                    TRUE                    TRUE 
                   sgn.test        shapirotest.ANSM            siegel.tukey 
                       TRUE                    TRUE                    TRUE 
                   spearman           spearman.beta           theil.kendall 
                       TRUE                    TRUE                    TRUE 
      wilcoxon.mann.whitney     wilcoxon.signedrank                   zelen 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 06:56:36 UTC |
...
running this report
    ...
    PROCESSX_PS726d2d9a1a5f_1739516193
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbizNCa
