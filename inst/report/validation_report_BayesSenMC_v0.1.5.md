# Validation Report - BayesSenMC@0.1.5
...
| export_help          | 9                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Jinhui Yang <james.yangjinhui@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/formidify/BayesSenMC  |
...
| 7   | ggplot2                   | Imports   |
| 8   | lme4                      | Imports   |
| 9   | BH (\>= 1.66.0)           | LinkingTo |
| 10  | Rcpp (\>= 0.12.0)         | LinkingTo |
| 11  | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 12  | RcppParallel (\>= 5.0.1)  | LinkingTo |
| 13  | rstan (\>= 2.18.1)        | LinkingTo |
| 14  | StanHeaders (\>= 2.18.0)  | LinkingTo |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    correctedOR     crudeOR      diffOR fixedCorrOR     logitOR   nlmeNDiff 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
       paramEst      plotOR  randCorrOR 
           TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-15 03:41:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd136a7a9_1739590869
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6fFnGP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesSenMC_v0.1.5-tikzDictionary"
