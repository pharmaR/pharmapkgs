# Validation Report - ecoval@1.2.9
...
| export_help          | 35                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Nele Schuwirth <nele.schuwirth@eawag.ch>             |
                 ...
                 lake.morphol.2016.read.attrib 
                       ...
                       msk.diatoms.2007.create 
                          ...
                          msk.fish.2004.create 
                                          TRUE 
                     msk.hydrol.2011.aggregate 
                                          TRUE 
                        msk.hydrol.2011.create 
                                          TRUE 
                 msk.invertebrates.2010.create 
                                          TRUE 
         msk.macrophytes.2017.addminbonusmalus 
                                          TRUE 
...
| Execution Time | 2025-02-19 03:38:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d454bccdeeb_1739936286
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUnuLx5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecoval_v1.2.9-tikzDictionary"
