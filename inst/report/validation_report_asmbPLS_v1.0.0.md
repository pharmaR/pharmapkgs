...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Runzhi Zhang <runzhi.zhang@ufl.edu>                  |
...
Overall the package has 15 exported objects. 15 are documented:
                ...
                asmbPLS.cv            asmbPLS.fit        asmbPLS.predict 
                      TRUE                   TRUE                   TRUE 
              asmbPLSDA.cv          asmbPLSDA.fit      asmbPLSDA.predict 
                      TRUE                   TRUE                   TRUE 
        asmbPLSDA.vote.fit asmbPLSDA.vote.predict              mbPLS.fit 
                      TRUE                   TRUE                   TRUE 
                   meanimp                plotCor                plotPLS 
                      TRUE                   TRUE                   TRUE 
             plotRelevance           quantileComb         to.categorical 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-14 07:27:36 UTC |
...
running this report
    ...
    PROCESSX_PS1c096207d780_1739518053
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmRzsQ3
