# Validation Report - checkhelper@0.1.1
...
| export_help          | 10                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Sebastien Rochette <sebastien@thinkr.fr>   |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/ThinkR-open/checkhelper |
...
| 8   | pkgbuild          | Imports |
| 9   | purrr             | Imports |
| 10  | rcmdcheck         | Imports |
| 11  | roxygen2          | Imports |
| 12  | stringr           | Imports |
| 13  | tools             | Imports |
| 14  | utils             | Imports |
| 15  | whisker (\>= 0.4) | Imports |
| 16  | withr             | Imports |
...
Overall the package has 10 exported objects. 9 are documented:
                      ...
                      %>%         check_as_cran check_clean_userspace 
                    FALSE                  TRUE                  TRUE 
       create_example_pkg     find_missing_tags         get_data_info 
                     TRUE                  TRUE                  TRUE 
           get_no_visible             get_notes         print_globals 
                     TRUE                  TRUE                  TRUE 
             use_data_doc 
                     TRUE 
...
| Execution Time | 2025-02-16 04:10:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3a5d553e_1739679015
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpluhe1y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_checkhelper_v0.1.1-tikzDictionary"
