# Validation Report - bayesplay@0.9.3
...
| export_help          | 8                                             |
| has_website          | TRUE                                          |
| has_maintainer       | Lincoln John Colling <lincoln@colling.net.nz> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/bayesplay/bayesplay        |
...
Overall the package has 7 exported objects. 7 are documented:
      ...
      extract_posterior extract_predictions            integral          likelihood 
                   TRUE                TRUE                TRUE                TRUE 
                  prior            sd_ratio      visual_compare 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 03:39:15 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6f2af59c_1739590750
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1cfm80
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesplay_v0.9.3-tikzDictionary"
