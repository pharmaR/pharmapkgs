# Validation Report - eddington@4.2.0
...
| export_help          | 9                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Paul Egeler <paulegeler@gmail.com>    |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/pegeler/eddington2 |
...
Overall the package has 9 exported objects. 9 are documented:
                     ...
                     E_cum                 E_next                  E_num 
                      TRUE                   TRUE                   TRUE 
                     E_req                  E_sat              Eddington 
                      TRUE                   TRUE                   TRUE 
           EddingtonModule get_haversine_distance               read_gpx 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-19 03:39:59 UTC |
...
running this report
    ...
    PROCESSX_PS1d4515f3e6ff_1739936393
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2AAtfz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eddington_v4.2.0-tikzDictionary"
