# Validation Report - conrad@1.0.0.1
...
| export_help          | 14                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Howard Baek <howardbaek.fh@gmail.com> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/fhdsl/conrad       |
...
Overall the package has 14 exported objects. 13 are documented:
                 ...
                 %>%  ms_choose_voice   ms_create_ssml     ms_exist_key 
               FALSE             TRUE             TRUE             TRUE 
        ms_fetch_key     ms_get_token    ms_list_voice        ms_region 
                TRUE             TRUE             TRUE             TRUE 
          ms_set_key    ms_synthesize ms_token_expired     ms_use_voice 
                TRUE             TRUE             TRUE             TRUE 
        ms_valid_key       play_audio 
                TRUE             TRUE 
...
| Execution Time | 2025-02-17 03:46:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bd640adecff_1739764012
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7HG8QC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conrad_v1.0.0.1-tikzDictionary"
