# Validation Report - dirmult@0.1.3.5
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Torben Tvedebrink <tvede@math.aau.dk>                |
...
CausalQueries, censcyt, CorrBin, GUniFrac, HMP, HMPTrees, iccmult,
malan, MarZIC, MICSQTL, simstudy, treeclimbR

## Namespace

Overall the package has 10 exported objects. 10 are documented:

       adapGridProf         dirmult dirmult.summary      equalTheta   estProfLogLik 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           gridProf        nullTest      rdirichlet          simPop         weirMoM 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:10:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41f89dbd1_1739851818
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpA69dcE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dirmult_v0.1.3.5-tikzDictionary"
