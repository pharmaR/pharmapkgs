# Validation Report - comtradr@1.0.3
...
| export_help          | 15                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Paul Bochtler <paulbochtler.gh@gmail.com> |
| bugs_status          | 1                                         |
| has_source_control   | https://github.com/ropensci/comtradr      |
...
Overall the package has 15 exported objects. 15 are documented:
               ...
               ct_commodity_db_type             ct_commodity_lookup 
                               TRUE                            TRUE 
                  ct_country_lookup                     ct_get_bulk 
                               TRUE                            TRUE 
                        ct_get_data                ct_get_ref_table 
                               TRUE                            TRUE 
    ct_get_remaining_hourly_queries               ct_get_reset_time 
                               TRUE                            TRUE 
                   ct_migrate_cache               ct_register_token 
                               TRUE                            TRUE 
                          ct_search             ct_update_databases 
                               TRUE                            TRUE 
                 ct_use_pretty_cols        get_primary_comtrade_key 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-17 03:38:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6ad95d7_1739763516
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpgx2IT7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comtradr_v1.0.3-tikzDictionary"
