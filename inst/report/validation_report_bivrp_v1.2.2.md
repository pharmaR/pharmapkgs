...
Overall the package has 7 exported objects. 7 are documented:
              ...
              bivrp  get_newpolygon get_reduced_bag is_point_inside      plot.bivrp 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       polygon_area     print.bivrp 
               TRUE            TRUE 
...
| Execution Time | 2025-02-22 03:17:38 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb7339c648_1740194254
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprqnEO7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bivrp_v1.2.2-tikzDictionary"
