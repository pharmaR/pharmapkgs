# Validation Report - bioclim@0.4.0
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Roberto Serrano-Notivoli <roberto.serrano@unizar.es> |
...
Overall the package has 17 exported objects. 17 are documented:
            ...
            biobal   biobalRaster bioclim_report         bioint   biointRaster 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           biotype  biotypeRaster            ith      ithRaster     plotBiobal 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        plotWatbal         plotWL        postemp       thermind   thornthwaite 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            watbal   watbalRaster 
              TRUE           TRUE 
...
| Execution Time | 2025-02-15 04:11:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6caa8b_1739592697
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppDcTms
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bioclim_v0.4.0-tikzDictionary"
