# Validation Report - Certara.VPCResults@3.0.2
...
| 1   | shinyAce          | Imports |
| 2   | shinymeta         | Imports |
| 3   | bslib (\>= 0.7.0) | Imports |
| 4   | colourpicker      | Imports |
...
| 9   | ggplot2           | Imports |
| 10  | plotly            | Imports |
| 11  | shiny (\>= 1.7.0) | Imports |
| 12  | shinycssloaders   | Imports |
| 13  | shinyjs           | Imports |
| 14  | shinyWidgets      | Imports |
| 15  | shinyjqui         | Imports |
| 16  | sortable          | Imports |
| 17  | tidyvpc           | Imports |
| 18  | htmltools         | Imports |
| 19  | rlang             | Imports |
| 20  | scales            | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    theme_certara  vpcResultsUI    write_code 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-16 04:03:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32a5a32e3_1739678590
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLgUT7s
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Certara.VPCResults_v3.0.2-tikzDictionary"
