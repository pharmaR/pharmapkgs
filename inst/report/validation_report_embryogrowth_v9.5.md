# Validation Report - embryogrowth@9.5
...
| export_help          | 39                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Marc Girondot <marc.girondot@gmail.com>              |
...
Overall the package has 39 exported objects. 39 are documented:
         ...
         calibrate.datalogger                 ChangeSSM       DatabaseTSD.version 
                         TRUE                      TRUE                      TRUE 
             dydt.exponential             dydt.Gompertz               dydt.linear 
                         TRUE                      TRUE                      TRUE 
                  FormatNests Generate_hatchling_metric            GenerateAnchor 
                         TRUE                      TRUE                      TRUE 
             GenerateConstInc              GRTRN_MHmcmc       HatchingSuccess.fit 
                         TRUE                      TRUE                      TRUE 
          HatchingSuccess.lnL    HatchingSuccess.MHmcmc  HatchingSuccess.MHmcmc_p 
                         TRUE                      TRUE                      TRUE 
        HatchingSuccess.model                info.nests      integral.exponential 
                         TRUE                      TRUE                      TRUE 
            integral.Gompertz           integral.linear               likelihoodR 
                         TRUE                      TRUE                      TRUE 
                     movement          MovingIncubation                     P_TRT 
                         TRUE                      TRUE                      TRUE 
              plot_transition                     plotR             ROSIE.version 
                         TRUE                      TRUE                      TRUE 
                      searchR                      STRN               STRN_MHmcmc 
                         TRUE                      TRUE                      TRUE 
            switch.transition             test.parallel              TRN_MHmcmc_p 
                         TRUE                      TRUE                      TRUE 
                          tsd                tsd_MHmcmc              tsd_MHmcmc_p 
                         TRUE                      TRUE                      TRUE 
       uncertainty.datalogger                   web.tsd          weightmaxentropy 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-19 04:00:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d45ff6da10_1739937608
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgT6H87
...
These are the options set to generate the report:
    ...
    [1] "validation_report_embryogrowth_v9.5-tikzDictionary"
