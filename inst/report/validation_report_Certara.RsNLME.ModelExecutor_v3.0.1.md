# Validation Report - Certara.RsNLME.ModelExecutor@3.0.1
...
| 2   | Certara.NLME8     | Imports |
| 3   | shinyAce          | Imports |
| 4   | shinymeta         | Imports |
| 5   | bslib (\>= 0.7.0) | Imports |
| 6   | htmltools         | Imports |
| 7   | magrittr          | Imports |
| 8   | dplyr             | Imports |
| 9   | shiny (\>= 1.7.4) | Imports |
| 10  | shinyFiles        | Imports |
| 11  | shinyjs           | Imports |
| 12  | shinyWidgets      | Imports |
| 13  | stringr           | Imports |
| 14  | tools             | Imports |
| 15  | fs                | Imports |
| 16  | ggplot2           | Imports |
...
Overall the package has 2 exported objects. 2 are documented:
    ...
    execute_mmdlModel   modelExecutorUI 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:03:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35cb8cb56_1739678585
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp84O8VB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Certara.RsNLME.ModelExecutor_v3.0.1-tikzDictionary"
