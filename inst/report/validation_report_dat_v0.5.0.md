...
| export_help          | 24                                    |
| has_website          | FALSE                                 |
| has_maintainer       | Sebastian Warnholz <wahani@gmail.com> |
...
Overall the package has 18 exported objects. 23 are documented:

              %>%  as.DataFrame      bindRows     DataFrame       extract 
            FALSE          TRUE          TRUE          TRUE          TRUE 
         extract2        filtar            FL       flatmap  makeFormulas 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              map         mutar       replace           sac         sumar 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     verboseApply          vmap withReference 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 04:55:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64a7dd41a_1739768129
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp95XmSJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dat_v0.5.0-tikzDictionary"
