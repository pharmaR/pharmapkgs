# Validation Report - bubbleHeatmap@0.1.1
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ruth Boxall <ruth.boxall@ndph.ox.ac.uk>              |
...
Overall the package has 13 exported objects. 13 are documented:
         ...
         arrangePanels      bubbleHeatmap  bubbleHeatmapList    bubbleHMLegends 
                  TRUE               TRUE               TRUE               TRUE 
         combinePanels         formatData     getLayoutSizes matchLayoutHeights 
                  TRUE               TRUE               TRUE               TRUE 
     matchLayoutWidths     merge_template        metabFigure    metabFigurePlot 
                  TRUE               TRUE               TRUE               TRUE 
        multiPlotInput 
                  TRUE 
...
| Execution Time | 2025-02-15 04:53:23 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1b5acc88_1739595198
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSpnSeo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bubbleHeatmap_v0.1.1-tikzDictionary"
