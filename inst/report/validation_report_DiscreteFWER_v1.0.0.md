# Validation Report - DiscreteFWER@1.0.0
...
| has_source_control   | https://github.com/DISOhda/DiscreteFWER |
...
|     | package                 | type      |
|:----|:------------------------|:----------|
| 1   | Rcpp (\>= 1.0.13)       | Imports   |
| 2   | checkmate               | Imports   |
| 3   | DiscreteFDR (\>= 2.0.0) | Imports   |
| 4   | Rcpp                    | LinkingTo |
...
Overall the package has 6 exported objects. 6 are documented:
             ...
             DBonferroni            DHochberg                DHolm 
                    TRUE                 TRUE                 TRUE 
    direct_discrete_FWER        discrete_FWER               DSidak 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-18 04:13:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4517d686b_1739852001
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfzeM9k
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiscreteFWER_v1.0.0-tikzDictionary"
