# Validation Report - ContourFunctions@0.1.2
...
| has_source_control   | https://github.com/CollinErickson/ContourFunctions   |
...
comparer, GauPro, mixopt, TestFunctions
...
Overall the package has 15 exported objects. 15 are documented:
                           ...
                           cf                   cf_4dim                   cf_data 
                         TRUE                      TRUE                      TRUE 
                      cf_func                   cf_grid                cf_highdim 
                         TRUE                      TRUE                      TRUE 
             cm.colors.strong                       csa eval_over_grid_with_batch 
                         TRUE                      TRUE                      TRUE 
                          gcf                  gcf_data                  gcf_func 
                         TRUE                      TRUE                      TRUE 
                     gcf_grid          multicolor.title                 text_plot 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-17 03:49:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bd630e65f95_1739764175
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWwdrJU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ContourFunctions_v0.1.2-tikzDictionary"
