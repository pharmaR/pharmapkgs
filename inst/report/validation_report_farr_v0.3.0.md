...
| export_help          | 24                             |
| has_website          | TRUE                           |
| has_maintainer       | Ian Gow <iandgow@gmail.com>    |
| bugs_status          | subscript out of bounds        |
| has_source_control   | https://github.com/iangow/farr |
...
Overall the package has 24 exported objects. 23 are documented:
                       ...
                       %>%                    auc        confusion_stats 
                     FALSE                   TRUE                   TRUE 
              form_deciles         get_annc_dates     get_event_cum_rets 
                      TRUE                   TRUE                   TRUE 
    get_event_cum_rets_mth        get_event_dates         get_event_rets 
                      TRUE                   TRUE                   TRUE 
                get_ff_ind           get_got_data        get_idd_periods 
                      TRUE                   TRUE                   TRUE 
        get_me_breakpoints  get_size_rets_monthly        get_test_scores 
                      TRUE                   TRUE                   TRUE 
         get_trading_dates           load_parquet                   ndcg 
                      TRUE                   TRUE                   TRUE 
             pg_to_parquet                    roc               rusboost 
                      TRUE                   TRUE                   TRUE 
               system_time               truncate              winsorize 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-19 05:13:00 UTC |
...
running this report
    ...
    PROCESSX_PS1d45217c057c_1739941973
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpF7j92V
...
These are the options set to generate the report:
    ...
    [1] "validation_report_farr_v0.3.0-tikzDictionary"
