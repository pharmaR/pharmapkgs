...
| has_source_control   | https://github.com/edwindj/daff                      |
...
Overall the package has 8 exported objects. 8 are documented:
          ...
          diff_data    differs_from      merge_data      patch_data       read_diff 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        render_diff which_conflicts      write_diff 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:50:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6625a17ac_1739767828
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwsJg5v
...
These are the options set to generate the report:
    ...
    [1] "validation_report_daff_v1.1.1-tikzDictionary"
