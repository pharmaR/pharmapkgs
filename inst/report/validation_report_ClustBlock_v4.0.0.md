# Validation Report - ClustBlock@4.0.0
...
| export_help          | 24                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Fabien Llobell <fabienllobellresearch@gmail.com>     |
...
Overall the package has 24 exported objects. 24 are documented:
                      ...
                      catatis               catatis_jar              catatis_rata 
                         TRUE                      TRUE                      TRUE 
           change_cata_format       change_cata_format2                  cluscata 
                         TRUE                      TRUE                      TRUE 
                 cluscata_jar           cluscata_kmeans       cluscata_kmeans_jar 
                         TRUE                      TRUE                      TRUE 
                cluscata_rata                    ClusMB                 clustatis 
                         TRUE                      TRUE                      TRUE 
           clustatis_FreeSort clustatis_FreeSort_kmeans          clustatis_kmeans 
                         TRUE                      TRUE                      TRUE 
        clustRowsOnStatisAxes          consistency_cata    consistency_cata_panel 
                         TRUE                      TRUE                      TRUE 
              indicesClusters       preprocess_FreeSort            preprocess_JAR 
                         TRUE                      TRUE                      TRUE 
            simil_groups_cata                    statis           statis_FreeSort 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-16 04:37:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3516dedab_1739680662
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdAvLz7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClustBlock_v4.0.0-tikzDictionary"
