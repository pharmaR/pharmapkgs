...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Edoardo Ciscato <edoardo.ciscato@kuleuven.be>        |
...
Overall the package has 10 exported objects. 10 are documented:
               ...
               estimate.affinity.matrix    estimate.affinity.matrix.lowrank 
                                   TRUE                                TRUE 
    estimate.affinity.matrix.unipartite                        export.table 
                                   TRUE                                TRUE 
                   show.affinity.matrix                   show.correlations 
                                   TRUE                                TRUE 
                  show.cross.validation                       show.diagonal 
                                   TRUE                                TRUE 
                          show.saliency                           show.test 
                                   TRUE                                TRUE 
...
| Execution Time | 2025-02-14 06:41:22 UTC |
...
running this report
    ...
    PROCESSX_PS726d5d4745c0_1739515279
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQGidqm
