# Validation Report - blockcluster@4.5.5
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Serge Iovleff <Serge.Iovleff@stkpp.org>              |
...
|     | package             | type      |
|:----|:--------------------|:----------|
| 1   | rtkore (\>= 1.6.10) | Depends   |
| 2   | methods             | Imports   |
| 3   | Rcpp                | LinkingTo |
| 4   | rtkore (\>= 1.6.10) | LinkingTo |
...
Overall the package has 6 exported objects. 8 are documented:
               ...
               cocluster      coclusterBinary coclusterCategorical 
                    TRUE                 TRUE                 TRUE 
    coclusterContingency  coclusterContinuous    coclusterStrategy 
                    TRUE                 TRUE                 TRUE 

### Examples

There are 14 help pages with examples, from 20 (70.00 %).
...
| Execution Time | 2025-02-15 04:23:05 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2b40a7ee_1739593380
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplJ3FuP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blockcluster_v4.5.5-tikzDictionary"
