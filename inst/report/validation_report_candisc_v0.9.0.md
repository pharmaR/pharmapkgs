# Validation Report - candisc@0.9.0
...
| export_help          | 12                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Michael Friendly <friendly@yorku.ca> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/friendly/candisc/ |
...
Guerry, heplots, KnowBR, MorphoTools2, MultivariateAnalysis, SurveyCC

## Namespace

Overall the package has 12 exported objects. 12 are documented:

             can_lm          cancor         candisc     candiscList       dataIndex 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    predictor.names      redundancy          scores        varOrder        vecscale 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            vectors           Wilks 
               TRUE            TRUE 
...
| Execution Time | 2025-02-16 03:38:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3df1a683_1739677086
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFc41lm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_candisc_v0.9.0-tikzDictionary"
