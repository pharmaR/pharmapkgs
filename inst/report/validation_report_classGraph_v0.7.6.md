# Validation Report - classGraph@0.7.6
...
Overall the package has 10 exported objects. 9 are documented:
     ...
     .optRagargs       bGraph  class2Graph    classTree     mRagraph  numOutEdges 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
            plot      plotRag   subClasses superClasses 
...
| Execution Time | 2025-02-23 03:22:07 UTC |
...
running this report
    ...
    PROCESSX_PS1d2537ea4f60_1740280924
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpmx6YKB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_classGraph_v0.7.6-tikzDictionary"
