# Validation Report - eclust@0.1.0
...
| export_help          | 15                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Sahir Rai Bhatnagar <sahir.bhatnagar@gmail.com> |
| bugs_status          | 1                                               |
| has_source_control   | https://github.com/sahirbhatnagar/eclust/       |
...
Overall the package has 15 exported objects. 15 are documented:
              ...
              r_cluster_data           r_prepare_data          s_generate_data 
                        TRUE                     TRUE                     TRUE 
        s_generate_data_mars             s_mars_clust          s_mars_separate 
                        TRUE                     TRUE                     TRUE 
                   s_modules              s_pen_clust           s_pen_separate 
                        TRUE                     TRUE                     TRUE 
                  s_response          s_response_mars     u_cluster_similarity 
                        TRUE                     TRUE                     TRUE 
    u_extract_selected_earth        u_extract_summary                u_fisherZ 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-19 03:33:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d452744777f_1739935986
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbMv8xD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eclust_v0.1.0-tikzDictionary"
