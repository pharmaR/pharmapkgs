...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Muhlis Ozdemir <muhlisozdemir@gazi.edu.tr>           |
...
Overall the package has 9 exported objects. 9 are documented:
              ...
              calculate_generalMean calculate_group_averages_matrix 
                               TRUE                            TRUE 
    calculate_obs_and_group_weights      calculate_variance_and_std 
                               TRUE                            TRUE 
       calculate_varianceComponents calculate_weights_of_obs_matrix 
                               TRUE                            TRUE 
               estimate_credibility                      save_names 
                               TRUE                            TRUE 
                           set_data 
                               TRUE 
...
| Execution Time | 2025-02-16 03:53:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bc325c77cc9_1739677979
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyVuFBP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cccm_v0.1.0-tikzDictionary"
