# Validation Report - DisimForMixed@0.2
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Hasanthi A. Pathberiya <hasanthi@sjp.ac.lk>          |
...
Overall the package has 6 exported objects. 6 are documented:
         ...
         calcCondProb     calcDissimMat   discretizeQuant      distBetPairs 
                 TRUE              TRUE              TRUE              TRUE 
              findMax signifOfQuantVars 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:15:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45e1bec25_1739852107
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSMhYQj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DisimForMixed_v0.2-tikzDictionary"
