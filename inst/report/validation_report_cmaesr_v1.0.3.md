# Validation Report - cmaesr@1.0.3
...
| has_source_control   | https://github.com/jakobbossek/cmaesr |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | ParamHelpers (\>= 1.8) | Depends |
| 2   | BBmisc (\>= 1.6)       | Depends |
| 3   | checkmate (\>= 1.1)    | Depends |
| 4   | smoof (\>= 1.4)        | Depends |
| 5   | ggplot2                | Imports |
...
Overall the package has 15 exported objects. 15 are documented:
                           ...
                           cmaes getDefaultStoppingConditions 
                            TRUE                         TRUE 
                     makeMonitor            makeSimpleMonitor 
                            TRUE                         TRUE 
           makeStoppingCondition       makeVisualizingMonitor 
                            TRUE                         TRUE 
                   stopOnCondCov               stopOnMaxEvals 
                            TRUE                         TRUE 
                  stopOnMaxIters           stopOnNoEffectAxis 
                            TRUE                         TRUE 
             stopOnNoEffectCoord               stopOnOptParam 
                            TRUE                         TRUE 
                  stopOnOptValue             stopOnTimeBudget 
                            TRUE                         TRUE 
                      stopOnTolX 
                            TRUE 
...
| Execution Time | 2025-02-16 04:42:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3518669c_1739680967
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMspWht
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmaesr_v1.0.3-tikzDictionary"
