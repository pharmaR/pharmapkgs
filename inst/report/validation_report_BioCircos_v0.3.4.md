# Validation Report - BioCircos@0.3.4
...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Loan Vulliard <lvulliard@cemm.at>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/lvulliard/BioCircos.R             |
...
Overall the package has 13 exported objects. 13 are documented:
                   ...
                   BioCircos        BioCircosArcTrack BioCircosBackgroundTrack 
                        TRUE                     TRUE                     TRUE 
           BioCircosBarTrack        BioCircosCNVTrack    BioCircosHeatmapTrack 
                        TRUE                     TRUE                     TRUE 
          BioCircosLineTrack       BioCircosLinkTrack          BioCircosOutput 
                        TRUE                     TRUE                     TRUE 
           BioCircosSNPTrack       BioCircosTextTrack       BioCircosTracklist 
                        TRUE                     TRUE                     TRUE 
             renderBioCircos 
                        TRUE 
...
| Execution Time | 2025-02-15 04:11:36 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd58ae2fa8_1739592691
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpih8mN4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BioCircos_v0.3.4-tikzDictionary"
