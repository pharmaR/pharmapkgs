...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Joshua Ray Tanzer <jtanzer@lifespan.org>             |
...
|:----|:--------------|:--------|
| 1   | MCMCpack      | Depends |
| 2   | GPArotation   | Depends |
| 3   | TeachingDemos | Depends |
| 4   | blavaan       | Depends |
| 5   | blme          | Depends |
| 6   | MASS          | Imports |
| 7   | rstan         | Imports |
...
Overall the package has 15 exported objects. 15 are documented:
                ...
                bcor             bcov           bomega   bomega_general 
                TRUE             TRUE             TRUE             TRUE 
            brxx_Cor brxx_Cor_general     brxx_general         brxx_ICC 
                TRUE             TRUE             TRUE             TRUE 
    brxx_ICC_general             prep          process            scree 
                TRUE             TRUE             TRUE             TRUE 
         standardize        summarize           unpack 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:47:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd109046_1739594858
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZECWIc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brxx_v0.1.2-tikzDictionary"
