# Validation Report - BioCro@3.1.3
...
| export_help          | 22                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Justin M. McGrath <jmcgrath@illinois.edu>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/biocro/biocro                     |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 2436                                                 |
| reverse_dependencies | 0                                                    |
| has_examples         | 0.8214286                                            |
| dependencies         | 1                                                    |
...
Overall the package has 22 exported objects. 22 are documented:
                         ...
                         add_csv_row         add_time_to_weather_data 
                                TRUE                             TRUE 
                                case                   cases_from_csv 
                                TRUE                             TRUE 
                     evaluate_module                  get_all_modules 
                                TRUE                             TRUE 
                 get_all_ode_solvers               get_all_quantities 
                                TRUE                             TRUE 
          get_growing_season_climate                   initialize_csv 
                                TRUE                             TRUE 
                         module_info                     module_paste 
                                TRUE                             TRUE 
               module_response_curve          partial_evaluate_module 
                                TRUE                             TRUE 
                  partial_run_biocro         quantity_list_from_names 
                                TRUE                             TRUE 
                          run_biocro               system_derivatives 
                                TRUE                             TRUE 
                         test_module              test_module_library 
                                TRUE                             TRUE 
                    update_csv_cases validate_dynamical_system_inputs 
                                TRUE                             TRUE 

### Examples

There are 23 help pages with examples, from 28 (82.14 %).
...
| Execution Time | 2025-02-15 04:11:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5a9b2c4b_1739592713
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprLFrBS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BioCro_v3.1.3-tikzDictionary"
