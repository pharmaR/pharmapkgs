# Validation Report - bayesnec@2.1.3.0
...
| export_help          | 28                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Rebecca Fisher <r.fisher@aims.gov.au> |
| bugs_status          | subscript out of bounds               |
| has_bug_reports_url  | 1                                     |
| downloads_1yr        | 5425                                  |
| reverse_dependencies | 0                                     |
| has_examples         | 0.8269231                             |
| dependencies         | 12                                    |
| license              | GPL-2                                 |
...
Overall the package has 28 exported objects. 28 are documented:
                ...
                amend average_estimates   bayesnecformula              bnec 
                 TRUE              TRUE              TRUE              TRUE 
         bnec_newdata               bnf      check_chains     check_formula 
                 TRUE              TRUE              TRUE              TRUE 
         check_priors compare_estimates    compare_fitted compare_posterior 
                 TRUE              TRUE              TRUE              TRUE 
           dispersion               ecx      expand_manec        expand_nec 
                 TRUE              TRUE              TRUE              TRUE 
          ggbnec_data   is_manecsummary  make_brmsformula            models 
                 TRUE              TRUE              TRUE              TRUE 
                  nec              nsec      pull_brmsfit          pull_out 
                 TRUE              TRUE              TRUE              TRUE 
           pull_prior     sample_priors       show_params              step 
                 TRUE              TRUE              TRUE              TRUE 

### Examples

There are 43 help pages with examples, from 52 (82.69 %).
...
| Execution Time | 2025-02-15 03:38:49 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd38c53f45_1739590725
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRRQ1ZH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesnec_v2.1.3.0-tikzDictionary"
