# Validation Report - colorist@0.1.3
...
| has_source_control   | https://github.com/mstrimas/colorist        |
...
Overall the package has 11 exported objects. 10 are documented:
                  ...
                  %>%        legend_set  legend_timecycle   legend_timeline 
                FALSE              TRUE              TRUE              TRUE 
        map_multiples        map_single   metrics_distill      metrics_pull 
                 TRUE              TRUE              TRUE              TRUE 
          palette_set palette_timecycle  palette_timeline 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:59:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bc365702a98_1739681971
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvqxkQD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colorist_v0.1.3-tikzDictionary"
