...
BGGE, BWGS, GEmetrics, GROAN, MoBPS, PopVar, predhy, predhy.GUI
...
Overall the package has 15 exported objects. 15 are documented:
                    ...
                    BFDR                 BGLR                  BLR 
                    TRUE                 TRUE                 TRUE 
                BLRCross                BLRXy            getGCovar 
                    TRUE                 TRUE                 TRUE 
            getVariances           Multitrait             read_bed 
                    TRUE                 TRUE                 TRUE 
                read_ped           readBinMat readBinMatMultitrait 
                    TRUE                 TRUE                 TRUE 
                    vech            write_bed                 xpnd 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 03:58:49 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd16cd73e1_1739591924
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgajF8k
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BGLR_v1.1.3-tikzDictionary"
