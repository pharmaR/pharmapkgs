# Validation Report - brmsmargins@0.2.0
...
| has_source_control   | https://github.com/JWiley/brmsmargins    |
...
| 4   | extraoperators (\>= 0.1.1) | Imports   |
| 5   | brms                       | Imports   |
| 6   | bayestestR                 | Imports   |
| 7   | Rcpp                       | Imports   |
| 8   | posterior                  | Imports   |
...
Overall the package has 9 exported objects. 9 are documented:
     ...
     brmsmargins     bsummary integratemvn  integratere        lmcpp marginalcoef 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      prediction rowBootMeans      tab2mat 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-15 04:45:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5fd3a896_1739594737
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfBp6ir
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brmsmargins_v0.2.0-tikzDictionary"
