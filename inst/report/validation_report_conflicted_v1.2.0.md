# Validation Report - conflicted@1.2.0
...
| has_source_control   | https://github.com/r-lib/conflicted |
| has_bug_reports_url  | 1                                   |
| downloads_1yr        | 5469007                             |
...
boxr, cheem, destiny, DGEobj, DGEobj.utils, DOPE, duckplyr, eat, here,
marginaleffects, NMRphasing, public.ctn0094data, roundwork, rUM, SCDB,
shinyTempSignal, tidymodels, tidyverse, usedthese, vegawidget, vembedr,
votesmart, xpose.xtras

## Namespace

Overall the package has 5 exported objects. 5 are documented:

             conflict_prefer      conflict_prefer_all conflict_prefer_matching 
                        TRUE                     TRUE                     TRUE 
              conflict_scout         conflicts_prefer 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-17 03:43:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bd645810a43_1739763801
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWZZLp3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conflicted_v1.2.0-tikzDictionary"
