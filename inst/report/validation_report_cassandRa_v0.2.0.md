# Validation Report - cassandRa@0.2.0
...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Chris Terry <christerry3@btinternet.com>             |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | bipartite (\>= 2.11) | Imports |
| 2   | reshape2 (\>= 1.4.3) | Imports |
| 3   | magrittr (\>= 1.5)   | Imports |
| 4   | vegan (\>= 2.5-3)    | Imports |
| 5   | purrr (\>= 0.2.5)    | Imports |
| 6   | dplyr                | Imports |
| 7   | tidyr (\>= 0.8)      | Imports |
| 8   | ggplot2 (\>= 3.1.0)  | Imports |
| 9   | boot                 | Imports |
| 10  | stats                | Imports |
| 11  | rlang                | Imports |
...
Overall the package has 20 exported objects. 19 are documented:

                         %>%    CalcHostLevelCoverage                ComputeCI 
                       FALSE                     TRUE                     TRUE 
           CoverageEstimator         CreateListObject             FitAllModels 
                        TRUE                     TRUE                     TRUE 
                FitBothMandC            FitCentrality              FitMatching 
                        TRUE                     TRUE                     TRUE 
                      FitSBM make_true_and_sample_web             Optimise_SBM 
                        TRUE                     TRUE                     TRUE 
                   Optimiser                  PlotFit          PlotRarefaction 
                        TRUE                     TRUE                     TRUE 
                PredictLinks            RarefyNetwork     SortResponseCategory 
                        TRUE                     TRUE                     TRUE 
               TestAllModels                  TestAUC 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-16 03:45:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3212e62d4_1739677516
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6oFewm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cassandRa_v0.2.0-tikzDictionary"
