...
Overall the package has 8 exported objects. 23 are documented:
              ...
              C_piBTL ClassDataPairComp     ClassifPaired       DataSimulH0 
                 TRUE              TRUE              TRUE              TRUE 
         EstimBradley        ImportData            Piplot  ResSimulLvrRatio 
                 TRUE              TRUE              TRUE              TRUE 

### Examples

There are 29 help pages with examples, from 45 (64.44 %).
...
| Execution Time | 2025-02-17 03:38:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6606e1ed_1739763475
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoFdjFX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CompR_v1.0-tikzDictionary"
