...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Nathan Wycoff <nathan.wycoff@georgetown.edu>         |
...
| 2   | hetGP (\>= 1.1.1)  | Imports   |
| 3   | lhs                | Imports   |
| 4   | numDeriv           | Imports   |
| 5   | methods            | Imports   |
| 6   | MASS               | Imports   |
| 7   | RcppProgress       | Imports   |
| 8   | Rcpp               | LinkingTo |
...
Overall the package has 19 exported objects. 19 are documented:
                 ...
                 C_GP           C_GP_ci          C_GP_cpp               C_Q 
                 TRUE              TRUE              TRUE              TRUE 
                 C_tr             C_var            C_var2       domain_to_R 
                 TRUE              TRUE              TRUE              TRUE 
       domain_to_unit grad_est_subspace     logLikHessian             Lt_GP 
                 TRUE              TRUE              TRUE              TRUE 
             n11_2_01           quick_C     subspace_dist         update_C2 
                 TRUE              TRUE              TRUE              TRUE 
           W_kappa_ij     W_kappa_ij_up        W_kappa_lk 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-14 06:33:14 UTC |
...
running this report
    ...
    PROCESSX_PS726d231041d_1739514791
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiRsHnC
