# Validation Report - ChestVolume@1.0.1
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Wai-Hang Kwong <wai-hang.kwong@polyu.edu.hk>         |
...
Overall the package has 7 exported objects. 7 are documented:
                ...
                adj_position        calculate_volumes           plot_2d_volume 
                        TRUE                     TRUE                     TRUE 
               plot_chest_3d      process_marker_data read_segment_definitions 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-16 04:12:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37415e94c_1739679154
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAS4zUU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ChestVolume_v1.0.1-tikzDictionary"
