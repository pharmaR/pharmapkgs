...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jiaxin Hu <jhu267@wisc.edu>                          |
...
Overall the package has 12 exported objects. 12 are documented:
    ...
    angle_iteration       as.tensor            dtbm            fold  kronecker_list 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        rand_tensor        select_r        sim_dTBM             ttl             ttm 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             unfold         wkmeans 
               TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:55:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4359d2cef_1739854496
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0OxbR8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dTBM_v3.0-tikzDictionary"
