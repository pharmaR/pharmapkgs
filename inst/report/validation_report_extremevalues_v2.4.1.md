# Validation Report - extremevalues@2.4.1
...
| export_help          | 25                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mark van der Loo <mark.vanderloo@gmail.com>          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/markvanderloo/extremevalues       |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 133831                                               |
...
ImputeRobust, referenceIntervals

## Namespace

Overall the package has 25 exported objects. 25 are documented:

                dpareto      fitExponential        fitLognormal           fitNormal 
                   TRUE                TRUE                TRUE                TRUE 
              fitPareto          fitWeibull getExponentialLimit   getLognormalLimit 
                   TRUE                TRUE                TRUE                TRUE 
         getNormalLimit         getOutliers        getOutliersI       getOutliersII 
                   TRUE                TRUE                TRUE                TRUE 
         getParetoLimit     getWeibullLimit              invErf         outlierPlot 
                   TRUE                TRUE                TRUE                TRUE 
           plotMethodII             qpareto  qqExponentialLimit           qqFitPlot 
                   TRUE                TRUE                TRUE                TRUE 
       qqLognormalLimit       qqNormalLimit       qqParetoLimit      qqWeibullLimit 
                   TRUE                TRUE                TRUE                TRUE 
                rpareto 
                   TRUE 
...
| Execution Time | 2025-02-19 04:58:15 UTC |
...
running this report
    ...
    PROCESSX_PS1d4568be0271_1739941089
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphCYDGR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extremevalues_v2.4.1-tikzDictionary"
