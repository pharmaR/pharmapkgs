# Validation Report - bayesm@3.1.6
...
BGVAR, BTYDplus, ChoiceModelR, compositions, echoice2, idefix, MCMCglmm,
mvProbit, RGremlinsConjoint, rrMixture, telescope, VisCov

## Namespace

Overall the package has 59 exported objects. 59 are documented:

                   breg               cgetC          clusterMix             condMom 
                   TRUE                TRUE                TRUE                TRUE 
                createX         eMixMargDen              ghkvec               llmnl 
                   TRUE                TRUE                TRUE                TRUE 
                  llmnp           llnhlogit           lndIChisq         lndIWishart 
                   TRUE                TRUE                TRUE                TRUE 
                 lndMvn             lndMvst        logMargDenNR              mixDen 
                   TRUE                TRUE                TRUE                TRUE 
               mixDenBi             mnlHess             mnpProb              momMix 
                   TRUE                TRUE                TRUE                TRUE 
                   nmat              numEff   plot.bayesm.hcoef     plot.bayesm.mat 
                   TRUE                TRUE                TRUE                TRUE 
       plot.bayesm.nmix           rbayesBLP        rbiNormGibbs       rbprobitGibbs 
                   TRUE                TRUE                TRUE                TRUE 
             rdirichlet            rDPGibbs       rhierBinLogit  rhierLinearMixture 
                   TRUE                TRUE                TRUE                TRUE 
       rhierLinearModel          rhierMnlDP   rhierMnlRwMixture       rhierNegbinRw 
                   TRUE                TRUE                TRUE                TRUE 
                  rivDP            rivGibbs            rivGibbs           rmixGibbs 
                   TRUE                TRUE                TRUE                TRUE 
               rmixture     rmnlIndepMetrop           rmnpGibbs           rmultireg 
                   TRUE                TRUE                TRUE                TRUE 
              rmvpGibbs               rmvst           rnegbinRw          rnmixGibbs 
                   TRUE                TRUE                TRUE                TRUE 
        rordprobitGibbs         rscaleUsage           rsurGibbs               rtrun 
                   TRUE                TRUE                TRUE                TRUE 
                runireg        runiregGibbs            rwishart          simnhlogit 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 03:37:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd68ab60a4_1739590653
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6SDF1O
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesm_v3.1.6-tikzDictionary"
