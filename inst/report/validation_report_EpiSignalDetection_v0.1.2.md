# Validation Report - EpiSignalDetection@0.1.2
...
| has_source_control   | https://github.com/EU-ECDC/EpiSignalDetection        |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       aggAtlasExport            algoSD  cleanAtlasExport filterAtlasExport 
                 TRUE              TRUE              TRUE              TRUE 
    importAtlasExport            plotSD       runEpiSDApp    runEpiSDReport 
                 TRUE              TRUE              TRUE              TRUE 
                stsSD       studyPeriod 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-19 04:19:16 UTC |
...
running this report
    ...
    PROCESSX_PS1d45316b621e_1739938750
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfWLslx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EpiSignalDetection_v0.1.2-tikzDictionary"
