# Validation Report - centiserve@1.0.0
...
| export_help | 33 |
| has_website | TRUE |
| has_maintainer | Mahdi Jalili <m_jalili@farabi.tums.ac.ir> |
| bugs_status | scraping bug reports fromm BugReports host ‘centiserver’ not implemented |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | igraph (\>= 0.7.1) | Depends |
| 2   | Matrix (\>= 1.1-4) | Depends |
...
Overall the package has 33 exported objects. 33 are documented:
               ...
               averagedis            barycenter            bottleneck 
                     TRUE                  TRUE                  TRUE 
                 centroid closeness.currentflow     closeness.freeman 
                     TRUE                  TRUE                  TRUE 
         closeness.latora    closeness.residual    closeness.vitality 
                     TRUE                  TRUE                  TRUE 
              clusterrank            communibet         communitycent 
                     TRUE                  TRUE                  TRUE 
              crossclique                 decay      diffusion.degree 
                     TRUE                  TRUE                  TRUE 
                     dmnc               entropy                   epc 
                     TRUE                  TRUE                  TRUE 
                 geokpath               hubbell              katzcent 
                     TRUE                  TRUE                  TRUE 
                laplacian            leaderrank              leverage 
                     TRUE                  TRUE                  TRUE 
                  lincent                 lobby            markovcent 
                     TRUE                  TRUE                  TRUE 
                      mnc           pairwisedis             radiality 
                     TRUE                  TRUE                  TRUE 
                    salsa             semilocal       topocoefficient 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:01:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35594bb05_1739678459
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdDC9Dj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_centiserve_v1.0.0-tikzDictionary"
