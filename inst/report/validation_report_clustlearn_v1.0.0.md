# Validation Report - clustlearn@1.0.0
...
| export_help          | 5                                                 |
| has_website          | TRUE                                              |
| has_maintainer       | Eduardo Ruiz Sabajanes <eduardo.ruizs@edu.uah.es> |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/Ediu3095/clustlearn            |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    agglomerative_clustering                   dbscan      divisive_clustering 
                        TRUE                     TRUE                     TRUE 
            gaussian_mixture                   kmeans 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-16 04:40:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3332b4dc9_1739680840
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTaDi1Y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clustlearn_v1.0.0-tikzDictionary"
