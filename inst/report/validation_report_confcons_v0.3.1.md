# Validation Report - confcons@0.3.1
...
| export_help          | 4                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Ákos Bede-Fazekas <bfakos@ecolres.hu> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/bfakos/confcons    |
...
Overall the package has 4 exported objects. 4 are documented:
     ...
     confidence consistency    measures  thresholds 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 03:42:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bd615648fc9_1739763737
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeP3wc3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_confcons_v0.3.1-tikzDictionary"
