# Validation Report - CLVTools@0.11.2
...
| export_help          | 21                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Patrick Bachmann <pbachma@ethz.ch>          |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/bachmannpatrick/CLVTools |
| has_bug_reports_url  | 1                                           |
| downloads_1yr        | 6972                                        |
| reverse_dependencies | 0                                           |
| has_examples         | 0.6818182                                   |
| dependencies         | 17                                          |
| license              | GPL-3                                       |
...
|:----|:-------------------------------|:----------|
| 1   | methods                        | Depends   |
| 2   | data.table (\>= 1.12.0)        | Imports   |
| 3   | digest (\>= 0.6.0)             | Imports   |
| 4   | Formula (\>= 1.2-4)            | Imports   |
| 5   | ggplot2 (\>= 3.2.0)            | Imports   |
| 6   | lubridate (\>= 1.7.8)          | Imports   |
| 7   | numDeriv (\>= 2016.8-1.1)      | Imports   |
| 8   | Matrix (\>= 1.2-17)            | Imports   |
| 9   | MASS                           | Imports   |
| 10  | optimx (\>= 2019-12.02)        | Imports   |
| 11  | Rcpp(\>= 0.12.12)              | Imports   |
| 12  | stats                          | Imports   |
| 13  | utils                          | Imports   |
| 14  | Rcpp                           | LinkingTo |
| 15  | RcppArmadillo (\>= 0.11.4.0.1) | LinkingTo |
| 16  | RcppGSL (\>= 0.3.7)            | LinkingTo |
| 17  | testthat                       | LinkingTo |
...
Overall the package has 11 exported objects. 20 are documented:

               as.clv.data clv.bootstrapped.apply                clvdata 
                      TRUE                   TRUE                   TRUE 
           latentAttrition            newcustomer    newcustomer.dynamic 
                      TRUE                   TRUE                   TRUE 
      newcustomer.spending     newcustomer.static   SetDynamicCovariates 
                      TRUE                   TRUE                   TRUE 
       SetStaticCovariates               spending 
                      TRUE                   TRUE 

### Examples

There are 60 help pages with examples, from 88 (68.18 %).
...
| Execution Time | 2025-02-16 04:42:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35d6437d6_1739680956
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJUpF68
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CLVTools_v0.11.2-tikzDictionary"
