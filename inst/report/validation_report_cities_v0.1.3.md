# Validation Report - cities@0.1.3
...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Ahmad Hakeem Abdul Wahab <hakeemwahab00@gmail.com>   |
...
Overall the package has 14 exported objects. 14 are documented:
                    ...
                    colSD        data_generator   data_generator_loop 
                     TRUE                  TRUE                  TRUE 
          line_parameters          p_ae_poisson     p_loe_ee_function 
                     TRUE                  TRUE                  TRUE 
          pacf_vec_to_acf               plot_dc        plot_estimates 
                     TRUE                  TRUE                  TRUE 
              plot_loe_ee            plot_means               rep_col 
                     TRUE                  TRUE                  TRUE 
                  rep_row simulated_data_output 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:23:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bc370027b5c_1739679794
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpe8y6ap
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cities_v0.1.3-tikzDictionary"
