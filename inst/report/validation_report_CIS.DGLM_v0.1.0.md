# Validation Report - CIS.DGLM@0.1.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yishi Wang <wangy@uncw.edu>                          |
...
Overall the package has 8 exported objects. 8 are documented:
                   ...
                   bootstrap          draw.crossplots         draw.squareplots 
                        TRUE                     TRUE                     TRUE 
            forward.sel.dglm    forward.sel.dglm.real              mean_stress 
                        TRUE                     TRUE                     TRUE 
                   sd.stress simu.inter.dat.interboth 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-16 04:22:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34bbb477d_1739679754
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpj94LmF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CIS.DGLM_v0.1.0-tikzDictionary"
