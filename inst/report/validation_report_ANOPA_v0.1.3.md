...
| export_help          | 26                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Denis Cousineau <denis.cousineau@uottawa.ca> |
| size_codebase        | 1083                                         |
...
Overall the package has 26 exported objects. 26 are documented:
                      ...
                      A               anopa        anopaN2Power           anopaPlot 
                   TRUE                TRUE                TRUE                TRUE 
           anopaPower2N       anopaProp2fsq              Atrans           CI.Atrans 
                   TRUE                TRUE                TRUE                TRUE 
                CI.prop contrastProportions           corrected       emProportions 
                   TRUE                TRUE                TRUE                TRUE 
                explain                 GRP  posthocProportions                prop 
                   TRUE                TRUE                TRUE                TRUE 
             rBernoulli           SE.Atrans           summarize          toCompiled 
                   TRUE                TRUE                TRUE                TRUE 
                 toLong              toWide         uncorrected        unitaryAlpha 
                   TRUE                TRUE                TRUE                TRUE 
             var.Atrans                varA 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-14 06:56:16 UTC |
...
running this report
    ...
    PROCESSX_PS726d74384cdd_1739516173
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUnRk5T
