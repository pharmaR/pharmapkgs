# Validation Report - cpmBigData@0.0.1
...
| export_help          | 1                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Chun Li <cli77199@usc.edu>                           |
...
|:----|:------------------------|:--------|
| 1   | rms (\>= 6.2-0)         | Imports |
| 2   | Hmisc (\>= 4.3-0)       | Imports |
| 3   | doParallel (\>= 1.0.11) | Imports |
| 4   | parallel (\>= 3.5.2)    | Imports |
| 5   | foreach (\>= 1.2.0)     | Imports |
| 6   | iterators (\>= 1.0.0)   | Imports |
| 7   | SparseM (\>= 1.77)      | Imports |
| 8   | benchmarkme (\>= 1.0.4) | Imports |
...
| Execution Time | 2025-02-17 04:13:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61dda8752_1739765629
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphyPtNU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cpmBigData_v0.0.1-tikzDictionary"
