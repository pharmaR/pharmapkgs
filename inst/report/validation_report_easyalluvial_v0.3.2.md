# Validation Report - easyalluvial@0.3.2
...
| export_help          | 23                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Bjoern Koneswarakantha <datistics@gmail.com>         |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/erblast/easyalluvial/             |
...
| 1   | R(\>= 3.5)             | Depends |
| 2   | purrr                  | Imports |
| 3   | tidyr (\>= 1.0.0)      | Imports |
| 4   | dplyr                  | Imports |
| 5   | forcats                | Imports |
| 6   | ggalluvial (\>= 0.9.1) | Imports |
| 7   | ggplot2 (\>= 3.2.0)    | Imports |
| 8   | ggridges               | Imports |
| 9   | RColorBrewer           | Imports |
| 10  | recipes (\>= 0.1.5)    | Imports |
| 11  | rlang                  | Imports |
| 12  | stringr                | Imports |
| 13  | magrittr               | Imports |
| 14  | tibble                 | Imports |
| 15  | gridExtra              | Imports |
| 16  | randomForest           | Imports |
| 17  | progressr              | Imports |
| 18  | progress               | Imports |
...
Overall the package has 23 exported objects. 22 are documented:
                                ...
                                %>%                    add_imp_plot 
                              FALSE                            TRUE 
            add_marginal_histograms                   alluvial_long 
                               TRUE                            TRUE 
            alluvial_model_response   alluvial_model_response_caret 
                               TRUE                            TRUE 
    alluvial_model_response_parsnip                   alluvial_wide 
                               TRUE                            TRUE 
                check_pkg_installed                  get_data_space 
                               TRUE                            TRUE 
                get_pdp_predictions              manip_bin_numerics 
                               TRUE                            TRUE 
             manip_factor_2_numeric                  palette_filter 
                               TRUE                            TRUE 
            palette_increase_length          palette_plot_intensity 
                               TRUE                            TRUE 
                   palette_plot_rgp             palette_qualitative 
                               TRUE                            TRUE 
                     plot_all_hists               plot_condensation 
                               TRUE                            TRUE 
                          plot_hist                        plot_imp 
                               TRUE                            TRUE 
                           tidy_imp 
...
| Execution Time | 2025-02-18 05:10:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bb49675cbe_1739855421
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGaZEUe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easyalluvial_v0.3.2-tikzDictionary"
