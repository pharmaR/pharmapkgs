...
| has_source_control   | https://github.com/cienciadedatos/datos |
...
| 2   | dplyr                 | Imports |
| 3   | forcats               | Imports |
| 4   | fueleconomy           | Imports |
| 5   | gapminder             | Imports |
| 6   | ggplot2               | Imports |
| 7   | Lahman                | Imports |
| 8   | nasaweather           | Imports |
| 9   | nycflights13          | Imports |
| 10  | palmerpenguins        | Imports |
| 11  | modeldata (\>= 1.0.0) | Imports |
| 12  | rlang                 | Imports |
| 13  | tibble                | Imports |
| 14  | tidyr                 | Imports |
| 15  | yaml                  | Imports |
...
There are 19 help pages with examples, from 38 (50.00 %).
...
| Execution Time | 2025-02-17 05:04:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64963e4f7_1739768646
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprxFDMs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datos_v0.5.1-tikzDictionary"
