...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ken Kelley <kkelley@nd.edu>                          |
...
Overall the package has 11 exported objects. 11 are documented:
             ...
             ss.power.ba  ss.power.ba.general          ss.power.dt 
                    TRUE                 TRUE                 TRUE 
             ss.power.it     ss.power.reg.all   ss.power.reg.joint 
                    TRUE                 TRUE                 TRUE 
           ss.power.reg1         ss.power.spa ss.power.spa.general 
                    TRUE                 TRUE                 TRUE 
             ss.power.wa  ss.power.wa.general 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:53:34 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6fcd4aab_1739595209
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5B8hKm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BUCSS_v1.2.1-tikzDictionary"
