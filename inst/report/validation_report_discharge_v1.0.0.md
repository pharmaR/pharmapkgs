# Validation Report - discharge@1.0.0
...
| export_help          | 30                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Samarth Shah <sbshah10@asu.edu>                      |
...
Overall the package has 30 exported objects. 30 are documented:
             ...
             allstats    annualExtremes       annualnoise      asStreamflow 
                 TRUE              TRUE              TRUE              TRUE 
               circ.s   compare.periods   compare.periods       fft_metrics 
                 TRUE              TRUE              TRUE              TRUE 
           fftmetrics    filterBaseline   fourierAnalysis          getFPExt 
                 TRUE              TRUE              TRUE              TRUE 
              getHSAF           getHSAM            getIDI            getIFI 
                 TRUE              TRUE              TRUE              TRUE 
              getLSAF           getLSAM            getNAA    getSignalParts 
                 TRUE              TRUE              TRUE              TRUE 
        getTimingHSAM     getTimingLSAM getTransitionTime independentEvents 
                 TRUE              TRUE              TRUE              TRUE 
            lp3Events   parameters.list   prepareBaseline residplot.extreme 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:11:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bb432e883c5_1739851897
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXcOmhm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_discharge_v1.0.0-tikzDictionary"
