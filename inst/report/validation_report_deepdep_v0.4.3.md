# Validation Report - deepdep@0.4.3
...
| export_help          | 8                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Dominik Rafacz <dominikrafacz@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/DominikRafacz/deepdep |
...
Overall the package has 8 exported objects. 8 are documented:
                   ...
                   deepdep          deepdep_shiny get_available_packages 
                      TRUE                   TRUE                   TRUE 
          get_dependencies        get_description          get_downloads 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 03:34:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4e977e0c_1739849674
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcLZdqZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deepdep_v0.4.3-tikzDictionary"
