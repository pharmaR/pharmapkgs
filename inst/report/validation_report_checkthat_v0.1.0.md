# Validation Report - checkthat@0.1.0
...
| export_help          | 17                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Ian Cero <ian_cero@urmc.rochester.edu> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/iancero/checkthat   |
...
Overall the package has 17 exported objects. 17 are documented:
                ...
                at_least              at_most           check_that 
                    TRUE                 TRUE                 TRUE 
           exactly_equal             for_case             is_count 
                    TRUE                 TRUE                 TRUE 
          is_integerlike       is_logical_vec        is_proportion 
                    TRUE                 TRUE                 TRUE 
               less_than            more_than                 prop 
                    TRUE                 TRUE                 TRUE 
                 some_of       validate_count validate_logical_vec 
                    TRUE                 TRUE                 TRUE 
     validate_proportion             whenever 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:10:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bc375080045_1739679037
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAAicfs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_checkthat_v0.1.0-tikzDictionary"
