...
| export_help          | 11                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Christophe Dervieux <cderv@posit.co> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/rstudio/distill   |
...
|:----|:-----------------------|:--------|
| 1   | base64enc              | Imports |
| 2   | bookdown (\>= 0.8)     | Imports |
| 3   | digest                 | Imports |
| 4   | downlit (\>= 0.4.1)    | Imports |
| 5   | htmltools              | Imports |
| 6   | jsonlite (\>= 1.3)     | Imports |
| 7   | knitr (\>= 1.15.6)     | Imports |
| 8   | lubridate (\>= 1.7.10) | Imports |
| 9   | mime                   | Imports |
| 10  | openssl                | Imports |
| 11  | png                    | Imports |
| 12  | rmarkdown (\>= 2.11)   | Imports |
| 13  | rprojroot              | Imports |
| 14  | rstudioapi             | Imports |
| 15  | stats                  | Imports |
| 16  | stringr                | Imports |
| 17  | tools                  | Imports |
| 18  | utils                  | Imports |
| 19  | whisker                | Imports |
| 20  | xfun (\>= 0.18)        | Imports |
| 21  | xml2                   | Imports |
| 22  | yaml                   | Imports |
...
easyreporting, memoiR, nuts, rjtools

## Namespace

Overall the package has 11 exported objects. 11 are documented:

     create_article     create_blog     create_post    create_theme  create_website 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    distill_article distill_website     import_post publish_website rename_post_dir 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        update_post 
               TRUE 
...
| Execution Time | 2025-02-18 04:18:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44578b4a4_1739852302
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpK4gsVW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distill_v1.6-tikzDictionary"
