# Validation Report - disclapmix@1.7.4
...
| 3   | Rcpp (\>= 0.11)      | Imports   |
| 4   | disclap (\>= 1.4)    | Imports   |
| 5   | cluster (\>= 1.14.4) | Imports   |
| 6   | MASS                 | Imports   |
| 7   | stats                | Imports   |
| 8   | graphics             | Imports   |
| 9   | methods              | Imports   |
...
Overall the package has 9 exported objects. 9 are documented:
               ...
               clusterdist            clusterprob      contributor_pairs 
                      TRUE                   TRUE                   TRUE 
                disclapmix    disclapmix_adaptive      disclapmix_robust 
                      TRUE                   TRUE                   TRUE 
          generate_mixture               get_rank rank_contributor_pairs 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:11:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47412c4ed_1739851910
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnuSahy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_disclapmix_v1.7.4-tikzDictionary"
