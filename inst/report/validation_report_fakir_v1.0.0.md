...
| has_source_control   | https://github.com/Thinkr-open/fakir |
...
Overall the package has 10 exported objects. 9 are documented:
                     ...
                     %>%    fake_base_clients        fake_products 
                   FALSE                 TRUE                 TRUE 
    fake_sondage_answers  fake_sondage_people  fake_survey_answers 
                    TRUE                 TRUE                 TRUE 
      fake_survey_people   fake_ticket_client   fake_user_feedback 
                    TRUE                 TRUE                 TRUE 
             fake_visits 
                    TRUE 
...
| Execution Time | 2025-02-19 05:08:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d4576d9ab32_1739941727
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpG8TxXn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fakir_v1.0.0-tikzDictionary"
