# Validation Report - cpp11armadillo@0.4.1
...
| has_source_control | https://github.com/pachadotdev/cpp11armadillo |
...
economiccomplexity, lotri

## Namespace

Overall the package has 3 exported objects. 3 are documented:

    armadillo_version        cpp_vendor      pkg_template 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:14:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63f7263ab_1739765683
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5LndZn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cpp11armadillo_v0.4.1-tikzDictionary"
