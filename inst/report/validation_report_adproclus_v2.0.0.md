...
| export_help          | 15                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Henry Heppe <heppe.henry@gmail.com>      |
| bugs_status          | subscript out of bounds                  |
| size_codebase        | 1286                                     |
| has_source_control   | https://github.com/henry-heppe/adproclus |
...
Overall the package has 15 exported objects. 15 are documented:
                           ...
                           adpc                   adproclus 
                           TRUE                        TRUE 
              adproclus_low_dim               cluster_means 
                           TRUE                        TRUE 
                     get_random                get_rational 
                           TRUE                        TRUE 
                 get_semirandom           mselect_adproclus 
                           TRUE                        TRUE 
      mselect_adproclus_low_dim        plot_cluster_network 
                           TRUE                        TRUE 
                  plot_profiles             plot_scree_adpc 
                           TRUE                        TRUE 
    plot_scree_adpc_preselected           plot_vars_by_comp 
                           TRUE                        TRUE 
                select_by_CHull 
                           TRUE 
...
| Execution Time | 2025-02-14 06:39:31 UTC |
...
running this report
    ...
    PROCESSX_PS726d6b3bf69f_1739515169
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8fMItU
