# Validation Report - easySdcTable@1.0.7
...
| export_help          | 12                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Øyvind Langsrud <oyl@ssb.no>                     |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/statisticsnorway/easySdcTable |
...
Overall the package has 12 exported objects. 12 are documented:
            ...
            EasyData       IncDefault     ProtectTable    ProtectTable1 
                TRUE             TRUE             TRUE             TRUE 
    ProtectTableData            PTgui         PTguiApp       PTguiAppNO 
                TRUE             TRUE             TRUE             TRUE 
             PTguiNO           PTwrap            PTxyz   ReplaceDimList 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 05:12:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bb411e88a80_1739855571
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmjhmjX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easySdcTable_v1.0.7-tikzDictionary"
