# Validation Report - competitiontoolbox@0.7.1
...
| export_help | 3 |
| has_website | TRUE |
| has_maintainer | Charles Taragin <ctaragin+competitiontoolbox@gmail.com> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/luciu5/competitiontoolbox |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | antitrust (\>= 0.99.11) | Depends |
| 2   | trade (\>= 0.5.4)       | Depends |
| 3   | shiny                   | Depends |
| 4   | rhandsontable           | Depends |
| 5   | ggplot2                 | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    antitrust_shiny        ct_shiny     trade_shiny 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 03:35:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6384cc9f9_1739763325
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIUocNZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_competitiontoolbox_v0.7.1-tikzDictionary"
