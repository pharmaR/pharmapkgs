...
Overall the package has 15 exported objects. 15 are documented:
             ...
             AICc       AncCond         CalcD      CalcPopD          Even 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       FuzzyMatch          Mode   PPSDiscrete   ReorderData        ResSel 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      SampleTrees SlidingWindow   SuperMatrix       ViewEvo      WinCalcD 
             TRUE          TRUE          TRUE          TRUE          TRUE 

### Examples

There are 14 help pages with examples, from 22 (63.64 %).
...
| Execution Time | 2025-02-19 04:42:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d455fb4eaaf_1739940152
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwvApcS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evobiR_v1.1-tikzDictionary"
