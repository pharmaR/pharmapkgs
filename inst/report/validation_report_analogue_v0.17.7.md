...
| export_help          | 52                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Gavin L. Simpson <ucfagls@gmail.com>     |
| bugs_status          | 0.7142857                                |
| has_source_control   | https://github.com/gavinsimpson/analogue |
...
Overall the package has 52 exported objects. 50 are documented:

              analog           bayesF        bootstrap      caterpillar 
                TRUE             TRUE             TRUE             TRUE 
     caterpillarPlot        ChiSquare       chooseTaxa              cma 
                TRUE             TRUE             TRUE             TRUE 
             compare         crossval      densityplot         deshrink 
                TRUE             TRUE            FALSE             TRUE 
              dissim  dissimilarities         distance          dotplot 
                TRUE             TRUE             TRUE             TRUE 
          evenSample             fuse             getK     gradientDist 
                TRUE             TRUE             TRUE             TRUE 
           Hellinger        histogram             join         logitreg 
                TRUE            FALSE             TRUE             TRUE 
                 mat           mcarlo            minDC               n2 
                TRUE             TRUE             TRUE             TRUE 
         oldDistance           optima      panel.Loess panel.Stratiplot 
                TRUE             TRUE             TRUE             TRUE 
                 pcr      performance          prcurve           rankDC 
                TRUE             TRUE             TRUE             TRUE 
           reconPlot         residLen            RMSEP              roc 
                TRUE             TRUE             TRUE             TRUE 
              setK<-        smoothGAM     smoothSpline      splitSample 
                TRUE             TRUE             TRUE             TRUE 
         sppResponse         stdError       Stratiplot        timetrack 
                TRUE             TRUE             TRUE             TRUE 
                tran          varExpl               wa      weightedCor 
                TRUE             TRUE             TRUE             TRUE 

### Examples

There are 78 help pages with examples, from 80 (97.50 %).
...
| Execution Time | 2025-02-21 13:09:16 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a400166d3_1740143352
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJaarIx
