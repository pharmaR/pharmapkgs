...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Andreas Muehling <andreas.muehling@tum.de>           |
...
Overall the package has 23 exported objects. 23 are documented:
    ...
    analyze.graph.measures     analyze.similarity      analyze.subgraphs 
                      TRUE                   TRUE                   TRUE 
                clustering         concept.vector             conceptmap 
                      TRUE                   TRUE                   TRUE 
               conceptmaps            edge.vector   get.unified.concepts 
                      TRUE                   TRUE                   TRUE 
             Hopkins.index              landscape            MBM.cluster 
                      TRUE                   TRUE                   TRUE 
           modify.concepts            PAM.cluster             pathfinder 
                      TRUE                   TRUE                   TRUE 
           read.folder.tgf        read.folder.yEd               read.tgf 
                      TRUE                   TRUE                   TRUE 
                  read.yEd                 splice         unify.concepts 
                      TRUE                   TRUE                   TRUE 
                 write.tgf       write.tgf.folder 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 05:02:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bc333717ec6_1739682124
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEbDOxs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comato_v1.1-tikzDictionary"
