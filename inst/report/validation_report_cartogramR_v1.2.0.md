# Validation Report - cartogramR@1.2.0
...
| export_help | 14 |
| has_website | FALSE |
| has_maintainer | Pierre-Andre Cornillon <pierre-andre.cornillon@univ-rennes2.fr> |
...
Overall the package has 14 exported objects. 14 are documented:
                    ...
                    as.sf                as.sfc     as.sfmultipolygon 
                     TRUE                  TRUE                  TRUE 
               cartogramR    cartogramR_options        check_ring_dir 
                     TRUE                  TRUE                  TRUE 
    dist_between_vertices    from_coord_polygon       geom_cartogramR 
                     TRUE                  TRUE                  TRUE 
            grid_analysis            make_layer         precartogramR 
                     TRUE                  TRUE                  TRUE 
         to_coord_polygon         warp_features 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-16 03:43:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bc344b0e1d5_1739677420
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpr6D7bc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cartogramR_v1.2.0-tikzDictionary"
