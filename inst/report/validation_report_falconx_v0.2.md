...
Overall the package has 3 exported objects. 2 are documented:
            ...
            getASCN.x getChangepoints.x              view 
                 TRUE              TRUE             FALSE 

### Examples

There are 3 help pages with examples, from 7 (42.86 %).
...
| Execution Time | 2025-02-19 05:09:16 UTC |
...
running this report
    ...
    PROCESSX_PS1d455ebfe92_1739941749
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1pauai
...
These are the options set to generate the report:
    ...
    [1] "validation_report_falconx_v0.2-tikzDictionary"
