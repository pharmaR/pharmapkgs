# Validation Report - ELISAtools@0.1.5
...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Feng Feng <ffeng@BU.edu>                             |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | R2HTML (\>= 2.3.2)     | Depends |
| 2   | stringi (\>= 1.1.7)    | Depends |
| 3   | minpack.lm (\>= 1.2-1) | Depends |
| 4   | methods                | Depends |
...
Overall the package has 21 exported objects. 21 are documented:
           ...
           avoidZero      combineData      elisa_batch      elisa_plate 
                TRUE             TRUE             TRUE             TRUE 
           elisa_run             f5pl         inv.f5pl         load.ODs 
                TRUE             TRUE             TRUE             TRUE 
            loadData           loadDB    plotAlignData    plotBatchData 
                TRUE             TRUE             TRUE             TRUE 
          predictAll  prepareRegInput          rangeOD read.annotations 
                TRUE             TRUE             TRUE             TRUE 
         read.plates       reportHtml           runFit     saveDataText 
                TRUE             TRUE             TRUE             TRUE 
              saveDB 
                TRUE 
...
| Execution Time | 2025-02-19 03:56:03 UTC |
...
running this report
    ...
    PROCESSX_PS1d4516314ff7_1739937357
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiNEokv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ELISAtools_v0.1.5-tikzDictionary"
