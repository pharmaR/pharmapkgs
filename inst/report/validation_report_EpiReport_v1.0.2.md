# Validation Report - EpiReport@1.0.2
...
Overall the package has 28 exported objects. 28 are documented:
    ...
    body_replace_gg_at_bkm         cleanECDCTable       cleanMeasureCode 
                      TRUE                   TRUE                   TRUE 
                EcdcColors          filterDisease                 getAER 
                      TRUE                   TRUE                   TRUE 
              getAgeGender                 getMap              getSeason 
                      TRUE                   TRUE                   TRUE 
              getTableByMS            getTemplate               getTrend 
                      TRUE                   TRUE                   TRUE 
                includeMap          orderQuasinum                plotAge 
                      TRUE                   TRUE                   TRUE 
             plotAgeGender                plotBar         plotBarGrouped 
                      TRUE                   TRUE                   TRUE 
           plotBarGroupedH               plotBarH                plotPie 
                      TRUE                   TRUE                   TRUE 
           plotSeasonality                 plotTS           plotTS12MAvg 
                      TRUE                   TRUE                   TRUE 
             plotTSGrouped             previewMap     shapeECDCFlexTable 
                      TRUE                   TRUE                   TRUE 
                toCapTitle 
                      TRUE 
...
| Execution Time | 2025-02-19 04:18:48 UTC |
...
running this report
    ...
    PROCESSX_PS1d45428eab62_1739938722
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRpyRAL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EpiReport_v1.0.2-tikzDictionary"
