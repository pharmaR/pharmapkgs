# Validation Report - cryptowatchR@0.2.0
...
| export_help          | 12                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Lorenz Brachtendorf <lorenz.brachtendorf@gmx.de> |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/lorenzbr/cryptowatchR         |
...
Overall the package has 12 exported objects. 12 are documented:
                  ...
                  get_assets        get_current_price            get_exchanges 
                        TRUE                     TRUE                     TRUE 
                 get_markets                 get_ohlc            get_orderbook 
                        TRUE                     TRUE                     TRUE 
    get_orderbook_calculator  get_orderbook_liquidity                get_pairs 
                        TRUE                     TRUE                     TRUE 
                 get_summary               get_trades                  markets 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-17 04:29:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bd656df1220_1739766534
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUL0jai
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cryptowatchR_v0.2.0-tikzDictionary"
