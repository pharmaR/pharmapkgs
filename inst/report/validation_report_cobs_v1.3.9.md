...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | SparseM (\>= 1.6)   | Imports |
| 2   | quantreg (\>= 4.65) | Imports |
| 3   | grDevices           | Imports |
| 4   | graphics            | Imports |
| 5   | splines             | Imports |
| 6   | stats               | Imports |
...
biospear, combi, demography, DPQ, EventPointer, joineRML, L2E,
logcondiscr, mev, RPPASPACE, rTwig, schumaker, simest, vital

## Namespace

Overall the package has 12 exported objects. 11 are documented:

               cobs          conreg        drqssbc2 interpSplineCon    isIsplineCon 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         l1.design2     loo.design2    mk.pt.constr       plot.cobs     plot.conreg 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             qbsks2            shat 
               TRUE           FALSE 
...
| Execution Time | 2025-02-23 03:24:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d2530a0a4dc_1740281042
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdX4I0w
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cobs_v1.3.9-tikzDictionary"
