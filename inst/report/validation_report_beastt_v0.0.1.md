# Validation Report - beastt@0.0.1
...
Overall the package has 13 exported objects. 13 are documented:
           ...
           calc_post_beta        calc_post_norm calc_power_prior_beta 
                     TRUE                  TRUE                  TRUE 
    calc_power_prior_norm         calc_prop_scr                glance 
                     TRUE                  TRUE                  TRUE 
              is_prop_scr             plot_dist         prop_scr_dens 
                     TRUE                  TRUE                  TRUE 
            prop_scr_hist         prop_scr_love        robustify_norm 
                     TRUE                  TRUE                  TRUE 
                     tidy 
                     TRUE 
...
| Execution Time | 2025-02-15 03:50:35 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd70ae85ed_1739591430
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8HiDWC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beastt_v0.0.1-tikzDictionary"
