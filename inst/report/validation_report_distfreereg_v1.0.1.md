# Validation Report - distfreereg@1.0.1
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jesse Miller <mill9116@umn.edu>                      |
...
Overall the package has 8 exported objects. 8 are documented:
                 ...
                 compare          distfreereg  distfreereg.default 
                    TRUE                 TRUE                 TRUE 
     distfreereg.formula distfreereg.function       distfreereg.lm 
                    TRUE                 TRUE                 TRUE 
         distfreereg.nls            rejection 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-18 04:18:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45ec54e59_1739852289
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpk7zMs6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distfreereg_v1.0.1-tikzDictionary"
