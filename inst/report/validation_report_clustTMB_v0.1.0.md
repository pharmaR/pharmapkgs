# Validation Report - clustTMB@0.1.0
...
| export_help          | 10                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Andrea M. Havron <andrea.havron@noaa.gov> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/Andrea-Havron/clustTMB |
...
|:----|:----------------|:----------|
| 1   | cluster         | Imports   |
| 2   | clustMixType    | Imports   |
| 3   | fmesher         | Imports   |
| 4   | lme4            | Imports   |
| 5   | Matrix          | Imports   |
| 6   | mclust          | Imports   |
| 7   | methods         | Imports   |
| 8   | reformulas      | Imports   |
| 9   | MoEClust        | Imports   |
| 10  | sf              | Imports   |
| 11  | stats           | Imports   |
| 12  | TMB (\>= 1.9.0) | Imports   |
...
Overall the package has 10 exported objects. 10 are documented:
           ...
           clustTMB fixStruct.names    init.options       lognormal     mkInitClass 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        parm.lookup     run.options        skewness       splitForm         tweedie 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-16 04:42:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31efda333_1739680915
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBCbqOU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clustTMB_v0.1.0-tikzDictionary"
