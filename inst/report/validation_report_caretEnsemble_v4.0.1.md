# Validation Report - caretEnsemble@4.0.1
...
| export_help          | 13                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Zachary A. Deane-Mayer <zach.mayer@gmail.com> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/zachmayer/caretEnsemble    |
| has_bug_reports_url  | 1                                             |
| downloads_1yr        | 28485                                         |
| reverse_dependencies | 1                                             |
| has_examples         | 0.9016393                                     |
| dependencies         | 8                                             |
...
Overall the package has 13 exported objects. 13 are documented:
             ...
             as.caretList         caretEnsemble             caretList 
                     TRUE                  TRUE                  TRUE 
           caretModelSpec            caretStack        defaultControl 
                     TRUE                  TRUE                  TRUE 
            defaultMetric         extractMetric             greedyMSE 
                     TRUE                  TRUE                  TRUE 
          greedyMSE_caret permutationImportance             tuneCheck 
                     TRUE                  TRUE                  TRUE 
                   wtd.sd 
                     TRUE 
...
There are 55 help pages with examples, from 61 (90.16 %).
...
| Execution Time | 2025-02-16 03:42:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32a078b38_1739677324
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmplu3CVk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_caretEnsemble_v4.0.1-tikzDictionary"
