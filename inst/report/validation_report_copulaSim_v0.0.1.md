# Validation Report - copulaSim@0.0.1
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Pei-Shan Yen <peishan0824@gmail.com>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/psyen0824/copulaSim               |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    compare.copula.sim         copula.sim           ecdf.inv   extract.data.sim 
                  TRUE               TRUE               TRUE               TRUE 
    new.arm.copula.sim 
                  TRUE 
...
| Execution Time | 2025-02-17 03:55:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6425748f2_1739764535
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGRyLNu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_copulaSim_v0.0.1-tikzDictionary"
