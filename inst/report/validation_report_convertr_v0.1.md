# Validation Report - convertr@0.1
...
| export_help          | 4                                        |
| has_website          | FALSE                                    |
| has_maintainer       | Gordon Shotwell <g.e.shotwell@gmail.com> |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | shiny(\>= 0.13.2)   | Imports |
| 2   | miniUI(\>= 0.1.1)   | Imports |
| 3   | DT(\>= 0.1)         | Imports |
| 4   | rstudioapi(\>= 0.5) | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
                 ...
                 convert       convert_gadget        explore_units 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-17 03:51:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61dfe8ce7_1739764299
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiFOixL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_convertr_v0.1-tikzDictionary"
