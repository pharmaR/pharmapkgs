# Validation Report - DanielBiostatistics10th@0.2.6
...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tingting Zhan <tingtingzhan@gmail.com>               |
...
Overall the package has 19 exported objects. 19 are documented:
          ...
          addProbs   aggregated_t aggregated_var   aggregated_z         binTab 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    binTab.formula  binTab.matrix   binTab.table   Gosset_Welch            npv 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           power_z            ppv    print_freqs       print_OE    print_stats 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      print.binTab       prop_CLT    rmd_.binTab      sampleRow 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 04:53:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62858a086_1739768016
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIsUI9w
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DanielBiostatistics10th_v0.2.6-tikzDictionary"
