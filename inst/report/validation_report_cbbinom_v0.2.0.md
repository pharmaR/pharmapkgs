# Validation Report - cbbinom@0.2.0
...
| export_help          | 4                                  |
| has_website          | TRUE                               |
| has_maintainer       | Xiurui Zhu <zxr6@163.com>          |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/zhuxr11/cbbinom |
...
|:----|:----------------------|:----------|
| 1   | BH                    | LinkingTo |
| 2   | hypergeo2             | LinkingTo |
| 3   | Rcpp                  | LinkingTo |
| 4   | hypergeo2 (\>= 0.2.0) | Imports   |
| 5   | Rcpp                  | Imports   |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    dcbbinom pcbbinom qcbbinom rcbbinom 
        TRUE     TRUE     TRUE     TRUE 
...
| Execution Time | 2025-02-16 03:51:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34aba781a_1739677876
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbD78uW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cbbinom_v0.2.0-tikzDictionary"
