# Validation Report - eudract@1.0.3
...
| export_help          | 11                               |
| has_website          | TRUE                             |
| has_maintainer       | Simon Bond <simon.bond7@nhs.net> |
...
Overall the package has 11 exported objects. 11 are documented:
    ...
    clintrials_gov_convert  clintrials_gov_upload  create.safety_summary 
                      TRUE                   TRUE                   TRUE 
                  dot_plot        eudract_convert        incidence_table 
                      TRUE                   TRUE                   TRUE 
              order_filter          relative_risk    relative_risk_table 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-19 04:35:37 UTC |
...
running this report
    ...
    PROCESSX_PS1d45177f53f0_1739939731
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWpElsY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eudract_v1.0.3-tikzDictionary"
