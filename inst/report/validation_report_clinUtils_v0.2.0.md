# Validation Report - clinUtils@0.2.0
...
| has_source_control   | https://github.com/openanalytics/clinUtils       |
...
| 3   | DT          | Imports |
| 4   | haven       | Imports |
| 5   | htmlwidgets | Imports |
| 6   | knitr       | Imports |
| 7   | plyr        | Imports |
| 8   | tools       | Imports |
| 9   | utils       | Imports |
| 10  | viridisLite | Imports |
...
clinDataReview, inTextSummaryTable, patientProfilesVis

## Namespace

Overall the package has 30 exported objects. 30 are documented:

               clinColors         clinLinetypes            clinShapes 
                     TRUE                  TRUE                  TRUE 
           clinShapesText           compareDiff         compareTables 
                     TRUE                  TRUE                  TRUE 
        convertToDateTime        exportDiffData           formatLabel 
                     TRUE                  TRUE                  TRUE 
         formatLabelChunk       formatLongLabel      formatTableLabel 
                     TRUE                  TRUE                  TRUE 
    formatVarForPlotLabel             getClinDT      getClinDTButtons 
                     TRUE                  TRUE                  TRUE 
          getColorPalette       getLabelParamcd           getLabelVar 
                     TRUE                  TRUE                  TRUE 
             getLabelVars    getLinetypePalette       getPaletteCDISC 
                     TRUE                  TRUE                  TRUE 
          getShapePalette  knitPrintListObjects    knitPrintListPlots 
                     TRUE                  TRUE                  TRUE 
         loadDataADaMSDTM     mergeDiffWithData        reorderColumns 
                     TRUE                  TRUE                  TRUE 
              roundHalfUp roundHalfUpTextFormat             simpleCap 
                     TRUE                  TRUE                  TRUE 

### Examples

There are 38 help pages with examples, from 42 (90.48 %).
...
| Execution Time | 2025-02-16 04:33:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bc310e7d3_1739680415
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprWkDp5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clinUtils_v0.2.0-tikzDictionary"
