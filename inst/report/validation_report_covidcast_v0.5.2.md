# Validation Report - covidcast@0.5.2
...
| export_help          | 19                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Alex Reinhart <areinhar@stat.cmu.edu>   |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/cmu-delphi/covidcast |
...
Overall the package has 19 exported objects. 19 are documented:
           ...
           abbr_to_fips        abbr_to_name   aggregate_signals as.covidcast_signal 
                   TRUE                TRUE                TRUE                TRUE 
           cbsa_to_name county_fips_to_name       covidcast_cor    covidcast_longer 
                   TRUE                TRUE                TRUE                TRUE 
         covidcast_meta    covidcast_signal   covidcast_signals     covidcast_wider 
                   TRUE                TRUE                TRUE                TRUE 
         earliest_issue        fips_to_abbr        latest_issue        name_to_abbr 
                   TRUE                TRUE                TRUE                TRUE 
           name_to_cbsa        name_to_fips  state_fips_to_name 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:08:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63c709e45_1739765310
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphILWDX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covidcast_v0.5.2-tikzDictionary"
