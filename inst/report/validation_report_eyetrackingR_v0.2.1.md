# Validation Report - eyetrackingR@0.2.1
...
| export_help          | 18                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Samuel Forbes <samuel.h.forbes@gmail.com> |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | dplyr (\>= 0.7.4)     | Depends |
| 2   | broom (\>= 0.3.7)     | Imports |
| 3   | broom.mixed           | Imports |
| 4   | ggplot2 (\>= 2.0)     | Imports |
| 5   | lazyeval (\>= 0.1.10) | Imports |
| 6   | rlang                 | Imports |
| 7   | zoo (\>= 1.7-12)      | Imports |
| 8   | tidyr (\>= 0.3.1)     | Imports |
| 9   | purrr (\>= 0.2.4)     | Imports |
...
Overall the package has 18 exported objects. 18 are documented:
                       ...
                       add_aoi       analyze_boot_splines 
                          TRUE                       TRUE 
             analyze_time_bins      analyze_time_clusters 
                          TRUE                       TRUE 
            clean_by_trackloss              describe_data 
                          TRUE                       TRUE 
             get_time_clusters     make_boot_splines_data 
                          TRUE                       TRUE 
        make_eyetrackingr_data            make_onset_data 
                          TRUE                       TRUE 
              make_switch_data     make_time_cluster_data 
                          TRUE                       TRUE 
       make_time_sequence_data      make_time_window_data 
                          TRUE                       TRUE 
                       reclass simulate_eyetrackingr_data 
                          TRUE                       TRUE 
              subset_by_window         trackloss_analysis 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-19 04:59:41 UTC |
...
running this report
    ...
    PROCESSX_PS1d4579f2e6a7_1739941174
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBiN0bJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eyetrackingR_v0.2.1-tikzDictionary"
