# Validation Report - explainer@1.0.2
...
| export_help | 13 |
| has_website | TRUE |
| has_maintainer | Ramtin Zargari Marandi <ramtin.zargari.marandi@regionh.dk> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/PERSIMUNE/explainer |
...
Overall the package has 13 exported objects. 13 are documented:
                 ...
                 eCM_plot        eDecisionCurve             eFairness 
                     TRUE                  TRUE                  TRUE 
             ePerformance             eROC_plot            eSHAP_plot 
                     TRUE                  TRUE                  TRUE 
    eSHAP_plot_multiclass        eSHAP_plot_reg               range01 
                     TRUE                  TRUE                  TRUE 
          regressmdl_eval             SHAPclust       ShapFeaturePlot 
                     TRUE                  TRUE                  TRUE 
          ShapPartialPlot 
                     TRUE 
...
| Execution Time | 2025-02-19 04:52:48 UTC |
...
running this report
    ...
    PROCESSX_PS1d453562bf58_1739940761
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpr7oDyz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_explainer_v1.0.2-tikzDictionary"
