...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Pankaj Bhatlawande <pbhatlawande@merkleinc.com>      |
...
Overall the package has 8 exported objects. 8 are documented:
      ...
      create_query  get_adh_links  get_customers      get_query    google_auth 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      list_queries    start_query validate_query 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-14 06:39:41 UTC |
...
running this report
    ...
    PROCESSX_PS726d76c9d8f6_1739515178
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8Ld72k
