# Validation Report - condensr@1.0.0
...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Michael Lydeamore <michael.lydeamore@monash.edu>     |
...
Overall the package has 9 exported objects. 9 are documented:
              ...
              create_staff_member_page                     create_website 
                                  TRUE                               TRUE 
          generate_markdown_for_member     generate_markdown_for_projects 
                                  TRUE                               TRUE 
    generate_markdown_for_publications                            project 
                                  TRUE                               TRUE 
                           publication                  sort_list_by_date 
                                  TRUE                               TRUE 
                          staff_member 
                                  TRUE 
...
| Execution Time | 2025-02-17 03:40:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67e2a38e7_1739763620
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdbFGnA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_condensr_v1.0.0-tikzDictionary"
