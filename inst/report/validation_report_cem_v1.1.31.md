...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Stefano M. Iacus <siacus@iq.harvard.edu>             |
...
Overall the package has 16 exported objects. 16 are documented:
                    ...
                    att                 cem            cemspace combine.spacegraphs 
                   TRUE                TRUE                TRUE                TRUE 
              imbalance            imbspace                 k2k             L1.meas 
                   TRUE                TRUE                TRUE                TRUE 
             L1.profile                pair        pscoreSelect           relax.cem 
                   TRUE                TRUE                TRUE                TRUE 
             relax.plot        search.match           shift.cem          spacegraph 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 03:59:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3586af75f_1739678355
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwEKhcL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cem_v1.1.31-tikzDictionary"
