# Validation Report - CaseCohortCoxSurvival@0.0.36
...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Lola Etievant <lola.etievant@gmail.com>              |
...
Overall the package has 20 exported objects. 20 are documented:
          ...
          auxiliary.construction                  calibration 
                            TRUE                         TRUE 
           caseCohortCoxSurvival             estimatePureRisk 
                            TRUE                         TRUE 
                      estimation             estimation.CumBH 
                            TRUE                         TRUE 
                   estimation.PR    estimation.weights.phase3 
                            TRUE                         TRUE 
                      influences             influences.CumBH 
                            TRUE                         TRUE 
    influences.CumBH.missingdata       influences.missingdata 
                            TRUE                         TRUE 
                   influences.PR    influences.PR.missingdata 
                            TRUE                         TRUE 
                   influences.RH    influences.RH.missingdata 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-16 03:44:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bc338b50bf7_1739677484
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMX5XU2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CaseCohortCoxSurvival_v0.0.36-tikzDictionary"
