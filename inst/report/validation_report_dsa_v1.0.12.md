...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel Ollech <daniel.ollech@bundesbank.de>          |
...
| 5   | grid        | Imports |
| 6   | tools       | Imports |
| 7   | tsoutliers  | Imports |
| 8   | htmlwidgets | Imports |
| 9   | forecast    | Imports |
| 10  | rJava       | Imports |
| 11  | timeDate    | Imports |
| 12  | dygraphs    | Imports |
...
Overall the package has 20 exported objects. 20 are documented:
        ...
        daily_sim     del_names      Descaler           dsa      freq_xts 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     get_original        get_sa     get_trend      make_cal    make_dummy 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     make_holiday  multi_xts2ts        output plot_spectrum        Scaler 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        to_weekly        ts_sum        ts2xts        xts2ts       xtsplot 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 04:49:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bb462e9eac7_1739854169
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpW9R8Lz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsa_v1.0.12-tikzDictionary"
