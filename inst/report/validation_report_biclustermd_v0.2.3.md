# Validation Report - biclustermd@0.2.3
...
| export_help          | 9                                       |
| has_website          | TRUE                                    |
| has_maintainer       | John Reisner <johntreisner@gmail.com>   |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/jreisner/biclustermd |
...
| 2   | tidyr (\>= 0.8.1)        | Depends |
| 3   | biclust (\>= 2.0.1)      | Imports |
| 4   | doParallel (\>= 1.0.14)  | Imports |
| 5   | dplyr (\>= 0.7.6)        | Imports |
| 6   | foreach (\>= 1.4.4)      | Imports |
| 7   | magrittr (\>= 1.5)       | Imports |
| 8   | nycflights13 (\>= 1.0.0) | Imports |
| 9   | phyclust (\>= 0.1-24)    | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
            ...
            as.Biclust        biclustermd       cell_heatmap           cell_mse 
                  TRUE               TRUE               TRUE               TRUE 
             col.names compare_biclusters        mse_heatmap    rep_biclustermd 
                  TRUE               TRUE               TRUE               TRUE 
      tune_biclustermd 
                  TRUE 
...
| Execution Time | 2025-02-15 04:01:56 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3952e54e_1739592112
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFcmmE3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biclustermd_v0.2.3-tikzDictionary"
