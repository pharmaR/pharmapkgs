# Validation Report - FastStepGraph@0.1.1
...
| export_help          | 3                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Juan G. Colonna <juancolonna@icomp.ufam.edu.br>      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/juancolonna/FastStepGraph         |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | doParallel (\>= 1.0) | Imports |
| 2   | foreach (\>= 1.5)    | Imports |
| 3   | MASS (\>= 7.3)       | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    cv.FastStepGraph    FastStepGraph          SigmaAR 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 05:22:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d455f15913b_1739942525
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb5T4rA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FastStepGraph_v0.1.1-tikzDictionary"
