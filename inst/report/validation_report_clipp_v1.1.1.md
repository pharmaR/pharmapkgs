...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | James Dowty <jgdowty@gmail.com>                      |
...
Overall the package has 9 exported objects. 9 are documented:
              ...
              combine_loci    geno_freq_monogenic       geno_freq_phased 
                      TRUE                   TRUE                   TRUE 
       geno_freq_polygenic genotype_probabilities pedigree_loglikelihood 
                      TRUE                   TRUE                   TRUE 
           trans_monogenic           trans_phased        trans_polygenic 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:33:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37891f5f2_1739680426
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqN7AuM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clipp_v1.1.1-tikzDictionary"
