# Validation Report - ExpDes@1.2.2
...
Overall the package has 41 exported objects. 41 are documented:
     ...
     anscombetukey       bartlett         ccboot            ccF            crd 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            duncan    fat2.ad.crd    fat2.ad.rbd   fat2.ad2.crd   fat2.ad2.rbd 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          fat2.crd       fat2.rbd    fat3.ad.crd    fat3.ad.rbd       fat3.crd 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          fat3.rbd           ginv       graphics            han          lastC 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             latsd         layard         levene            lsd           lsdb 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         oneilldbc  oneillmathews    order.group order.stat.SNK        plotres 
              TRUE           TRUE           TRUE           TRUE           TRUE 
               rbd         reg.nl       reg.poly      samiuddin     scottknott 
              TRUE           TRUE           TRUE           TRUE           TRUE 
               snk     split2.crd     split2.rbd          strip    tapply.stat 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             tukey 
              TRUE 
...
| Execution Time | 2025-02-19 04:51:29 UTC |
...
running this report
    ...
    PROCESSX_PS1d457467535_1739940683
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7Gg09j
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ExpDes_v1.2.2-tikzDictionary"
