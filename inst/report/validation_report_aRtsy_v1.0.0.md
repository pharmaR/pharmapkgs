...
| export_help          | 37                                  |
| has_website          | TRUE                                |
| has_maintainer       | Koen Derks <koen-derks@hotmail.com> |
| bugs_status          | subscript out of bounds             |
| size_codebase        | 1819                                |
| has_source_control   | https://github.com/koenderks/aRtsy  |
...
| 1   | ambient             | Imports   |
| 2   | e1071               | Imports   |
| 3   | ggplot2 (\>= 3.4.0) | Imports   |
| 4   | kknn                | Imports   |
| 5   | randomForest        | Imports   |
| 6   | Rcpp                | Imports   |
| 7   | scales              | Imports   |
| 8   | stats               | Imports   |
| 9   | Rcpp                | LinkingTo |
...
Overall the package has 37 exported objects. 37 are documented:
            ...
            canvas_ant  canvas_blacklight     canvas_chladni   canvas_circlemap 
                  TRUE               TRUE               TRUE               TRUE 
         canvas_cobweb     canvas_collatz    canvas_diamonds       canvas_flame 
                  TRUE               TRUE               TRUE               TRUE 
           canvas_flow      canvas_forest    canvas_function    canvas_gemstone 
                  TRUE               TRUE               TRUE               TRUE 
      canvas_lissajous  canvas_mandelbrot        canvas_maze        canvas_mesh 
                  TRUE               TRUE               TRUE               TRUE 
         canvas_mosaic      canvas_nebula       canvas_petri canvas_phyllotaxis 
                  TRUE               TRUE               TRUE               TRUE 
         canvas_planet   canvas_polylines     canvas_recaman     canvas_ribbons 
                  TRUE               TRUE               TRUE               TRUE 
       canvas_segments       canvas_smoke      canvas_splits     canvas_squares 
                  TRUE               TRUE               TRUE               TRUE 
        canvas_stripes     canvas_strokes      canvas_swirls       canvas_tiles 
                  TRUE               TRUE               TRUE               TRUE 
        canvas_turmite canvas_watercolors       colorPalette         saveCanvas 
                  TRUE               TRUE               TRUE               TRUE 
          theme_canvas 
                  TRUE 
...
| Execution Time | 2025-02-14 07:25:48 UTC |
...
running this report
    ...
    PROCESSX_PS1c096f2dd86b_1739517945
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpprxdfP
