# Validation Report - DesignLibrary@0.1.10
...
| export_help          | 21                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Jasper Cooper <jjc2247@columbia.edu>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/DeclareDesign/DesignLibrary       |
...
|     | package                    | type    |
|:----|:---------------------------|:--------|
| 1   | DeclareDesign (\>= 0.17.0) | Depends |
| 2   | randomizr (\>= 0.16.1)     | Depends |
| 3   | fabricatr (\>= 0.8.0)      | Depends |
| 4   | estimatr (\>= 0.16.0)      | Depends |
| 5   | generics                   | Imports |
| 6   | rlang                      | Imports |
| 7   | glue                       | Imports |
...
Overall the package has 21 exported objects. 21 are documented:
                   ...
                   binary_iv_designer    block_cluster_two_arm_designer 
                                 TRUE                              TRUE 
            cluster_sampling_designer                factorial_designer 
                                 TRUE                              TRUE 
                      get_design_code               match.call.defaults 
                                 TRUE                              TRUE 
          mediation_analysis_designer                multi_arm_designer 
                                 TRUE                              TRUE 
            pretest_posttest_designer          process_tracing_designer 
                                 TRUE                              TRUE 
         randomized_response_designer regression_discontinuity_designer 
                                 TRUE                              TRUE 
            simple_factorial_designer                simple_iv_designer 
                                 TRUE                              TRUE 
            simple_spillover_designer           simple_two_arm_designer 
                                 TRUE                              TRUE 
                   spillover_designer        two_arm_attrition_designer 
                                 TRUE                              TRUE 
           two_arm_covariate_designer                  two_arm_designer 
                                 TRUE                              TRUE 
                  two_by_two_designer 
                                 TRUE 
...
| Execution Time | 2025-02-18 03:48:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41f4e0378_1739850488
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZNG72i
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DesignLibrary_v0.1.10-tikzDictionary"
