# Validation Report - datacleanr@1.0.3
...
| export_help          | 3                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Alexander Hurley <agl.hurley@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/the-Hull/datacleanr  |
...
| 2   | htmltools (\>= 0.5)      | Imports |
| 3   | summarytools (\>= 0.9.6) | Imports |
| 4   | dplyr (\>= 1.0.2)        | Imports |
| 5   | rlang (\>= 0.4.9)        | Imports |
| 6   | DT (\>= 0.16)            | Imports |
| 7   | magrittr (\>= 2.0.1)     | Imports |
| 8   | plotly (\>= 4.9.2.1)     | Imports |
| 9   | grDevices                | Imports |
| 10  | stats                    | Imports |
| 11  | purrr (\>= 0.3.4)        | Imports |
| 12  | glue (\>= 1.4.2)         | Imports |
| 13  | formatR (\>= 1.7)        | Imports |
| 14  | RColorBrewer (\>= 1.1.2) | Imports |
| 15  | clipr (\>= 0.7.1)        | Imports |
| 16  | rstudioapi (\>= 0.13)    | Imports |
| 17  | utils                    | Imports |
| 18  | lubridate (\>= 1.7.9.2)  | Imports |
| 19  | shinyWidgets (\>= 0.5.4) | Imports |
| 20  | htmlwidgets (\>= 1.5.3)  | Imports |
| 21  | tools                    | Imports |
| 22  | fs (\>= 1.5.0)           | Imports |
| 23  | shinyFiles (\>= 0.8.0)   | Imports |
| 24  | bslib                    | Imports |
...
| Execution Time | 2025-02-17 04:56:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bd672c5c18_1739768198
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpunXabK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datacleanr_v1.0.3-tikzDictionary"
