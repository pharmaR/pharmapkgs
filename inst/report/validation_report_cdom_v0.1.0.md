...
| export_help          | 3                                   |
| has_website          | TRUE                                |
| has_maintainer       | Philippe Massicotte <pm@bios.au.dk> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/PMassicotte/cdom |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    cdom_fit_exponential     cdom_slope_ratio  cdom_spectral_curve 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-16 03:57:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31acba582_1739678223
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNBM8Z6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cdom_v0.1.0-tikzDictionary"
