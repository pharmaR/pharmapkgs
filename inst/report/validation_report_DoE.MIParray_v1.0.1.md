# Validation Report - DoE.MIParray@1.0.1
...
Overall the package has 23 exported objects. 23 are documented:
            ...
            contr.XuWu      countToDmixed     create_ILPlist           dToCount 
                  TRUE               TRUE               TRUE               TRUE 
                    ff    gurobi_MIParray gurobi_MIPcontinue   gurobi_MIPsearch 
                  TRUE               TRUE               TRUE               TRUE 
                  GWLP              ICFTs            length2            length3 
                  TRUE               TRUE               TRUE               TRUE 
               length4            length5      lowerbound_AR     mosek_MIParray 
                  TRUE               TRUE               TRUE               TRUE 
     mosek_MIPcontinue    mosek_MIPsearch        oa_feasible           print.oa 
                  TRUE               TRUE               TRUE               TRUE 
                 SCFTs   write_MPSILPlist      write_MPSMIQP 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-25 03:22:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d2850916eb_1740453769
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9XBJko
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DoE.MIParray_v1.0.1-tikzDictionary"
