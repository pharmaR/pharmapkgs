# Validation Report - connections@0.2.0
...
| export_help          | 9                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Edgar Ruiz <edgar@posit.co>            |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/rstudio/connections |
...
Overall the package has 7 exported objects. 7 are documented:
        ...
        connection_close      connection_code      connection_open 
                    TRUE                 TRUE                 TRUE 
     connection_pin_read connection_pin_write    connection_update 
                    TRUE                 TRUE                 TRUE 
         connection_view 
                    TRUE 
...
| Execution Time | 2025-02-17 03:46:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bd665377145_1739763959
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmporOra5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_connections_v0.2.0-tikzDictionary"
