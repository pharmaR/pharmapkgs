# Validation Report - attachment@0.4.4
...
| export_help          | 23                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Vincent Guyader <vincent@thinkr.fr>       |
| bugs_status          | subscript out of bounds                   |
| size_codebase        | 932                                       |
| has_source_control   | https://github.com/ThinkR-open/attachment |
...
Overall the package has 23 exported objects. 22 are documented:
                         ...
                         %>%           att_amend_desc            att_from_data 
                       FALSE                     TRUE                     TRUE 
        att_from_description        att_from_examples       att_from_namespace 
                        TRUE                     TRUE                     TRUE 
                att_from_qmd            att_from_qmds             att_from_rmd 
                        TRUE                     TRUE                     TRUE 
               att_from_rmds         att_from_rscript        att_from_rscripts 
                        TRUE                     TRUE                     TRUE 
         att_to_desc_from_is     att_to_desc_from_pkg       att_to_description 
                        TRUE                     TRUE                     TRUE 
      complete_remote_branch create_dependencies_file      create_renv_for_dev 
                        TRUE                     TRUE                     TRUE 
        create_renv_for_prod             find_remotes install_from_description 
                        TRUE                     TRUE                     TRUE 
          install_if_missing      set_remotes_to_desc 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-14 07:31:27 UTC |
...
running this report
    ...
    PROCESSX_PS1c09576980e_1739518284
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpX7gxP6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_attachment_v0.4.4-tikzDictionary"
