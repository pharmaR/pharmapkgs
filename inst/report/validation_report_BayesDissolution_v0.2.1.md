# Validation Report - BayesDissolution@0.2.1
...
Overall the package has 13 exported objects. 13 are documented:
                ...
                bmn        dissplot         f2bayes           f2bca          f2boot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             f2calc           f2gpq           f2pbs      ggdissplot             hgp 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      make_dis_data process_results      runExample 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 03:33:47 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4eac1520_1739590422
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpc5HnZz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesDissolution_v0.2.1-tikzDictionary"
