# Validation Report - colouR@0.1.1
...
Overall the package has 13 exported objects. 13 are documented:
                 ...
                 avgHex          colPalette         excludeCols        getExtension 
                   TRUE                TRUE                TRUE                TRUE 
              getTopCol           groupCols             img2pal         plotPalette 
                   TRUE                TRUE                TRUE                TRUE 
     radiohead_palettes read_image_from_url          scaleColor           scaleFill 
                   TRUE                TRUE                TRUE                TRUE 
        taylor_palettes 
                   TRUE 
...
| Execution Time | 2025-02-16 05:01:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36fd995db_1739682065
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEXfMph
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colouR_v0.1.1-tikzDictionary"
