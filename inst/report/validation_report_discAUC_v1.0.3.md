# Validation Report - discAUC@1.0.3
...
| export_help          | 7                                                  |
| has_website          | TRUE                                               |
| has_maintainer       | Jonathan E. Friedel <jfriedel@georgiasouthern.edu> |
| bugs_status          | subscript out of bounds                            |
| has_source_control   | https://github.com/jefriedel/discAUC               |
...
Overall the package has 7 exported objects. 7 are documented:
                  ...
                  AUC         AUC_zeros          prep_AUC      prep_log_AUC 
                 TRUE              TRUE              TRUE              TRUE 
    prep_odds_against      prep_ordinal  prep_ordinal_all 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:11:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bb429012bb_1739851871
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAZNkTk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_discAUC_v1.0.3-tikzDictionary"
