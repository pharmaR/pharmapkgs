...
| 5   | rstantools (\>= 2.0.0)    | Imports   |
| 6   | BH (\>= 1.66.0)           | LinkingTo |
| 7   | Rcpp (\>= 0.12.0)         | LinkingTo |
| 8   | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 9   | rstan (\>= 2.18.1)        | LinkingTo |
| 10  | StanHeaders (\>= 2.18.0)  | LinkingTo |
...
Overall the package has 10 exported objects. 10 are documented:
               ...
               cbq           dald           pald  plot_coef.cbq plot_trace.cbq 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    print_coef.cbq print_mcmc.cbq print_text.cbq           qald           rald 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 03:52:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3285f098f_1739677925
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbSapzS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cbq_v0.2.0.3-tikzDictionary"
