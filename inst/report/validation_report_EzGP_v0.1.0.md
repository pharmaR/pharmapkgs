...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jiayi Li <jiayili0123@outlook.com>                   |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | stats (\>= 4.2.0)   | Depends |
| 2   | methods (\>= 4.2.0) | Imports |
| 3   | nloptr (\>= 2.0.3)  | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
            ...
            cov_m     EEzGP_fit EEzGP_predict      EzGP_fit  EzGP_predict 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        LEzGP_fit LLF_gradients 
             TRUE          TRUE 
...
| Execution Time | 2025-02-19 05:00:45 UTC |
...
running this report
    ...
    PROCESSX_PS1d457492fa64_1739941238
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpt6KkzD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EzGP_v0.1.0-tikzDictionary"
