# Validation Report - citrus@1.0.2
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Dom Clarke <dom.clarke@peak.ai>                      |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | ggplot2 (\>= 3.3.0)       | Imports |
| 2   | GGally (\>= 2.0.0)        | Imports |
| 3   | clustMixType (\>= 0.1-16) | Imports |
| 4   | treeClust (\>= 1.1-7)     | Imports |
| 5   | rpart (\>= 4.1-15)        | Imports |
| 6   | tibble (\>= 3.0.0)        | Imports |
| 7   | rpart.plot (\>= 3.0.7)    | Imports |
| 8   | stringr (\>= 1.3.0)       | Imports |
| 9   | dplyr (\>= 1.0.6)         | Imports |
| 10  | RColorBrewer (\>= 1.1-2)  | Imports |
| 11  | rlang (\>= 0.4.9)         | Imports |
| 12  | methods                   | Imports |
...
Overall the package has 15 exported objects. 15 are documented:
         ...
         citrus_pair_plot            k_clusters      model_management 
                     TRUE                  TRUE                  TRUE 
             output_table            preprocess           rpart.lists 
                     TRUE                  TRUE                  TRUE 
        rpart.plot_pretty           rpart.rules     rpart.rules.table 
                     TRUE                  TRUE                  TRUE 
     rpart.subrules.table               segment         tree_abstract 
                     TRUE                  TRUE                  TRUE 
             tree_segment tree_segment_prettify              validate 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:23:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36991503c_1739679822
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1DuphY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_citrus_v1.0.2-tikzDictionary"
