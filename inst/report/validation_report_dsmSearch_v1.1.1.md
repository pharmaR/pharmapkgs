# Validation Report - dsmSearch@1.1.1
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Xiaohao Yang <xiaohaoy@umich.edu>                    |
...
Overall the package has 3 exported objects. 3 are documented:
      ...
      get_dsm_30    get_lidar lidar_search 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-18 04:52:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4156c97af_1739854327
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaiAvvG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsmSearch_v1.1.1-tikzDictionary"
