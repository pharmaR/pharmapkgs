# Validation Report - ccpsyc@0.2.6
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Johannes Karl <johannes.a.karl@gmail.com>            |
...
Overall the package has 14 exported objects. 13 are documented:
                    ...
                    %>%        boot_inv_eff         clearing_fa               dMACS 
                  FALSE                TRUE                TRUE                TRUE 
                equival format_boot_inv_eff      invariance_eff  lavTestScore.clean 
                   TRUE                TRUE                TRUE                TRUE 
           mg_rel_table     multi_group_eff         pancultural               prost 
                   TRUE                TRUE                TRUE                TRUE 
     release_bonferroni          splitgroup 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 03:54:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35db8b023_1739678077
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpG2ERuG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ccpsyc_v0.2.6-tikzDictionary"
