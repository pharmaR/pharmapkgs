# Validation Report - bnpsd@1.3.13
...
| export_help          | 20                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Alejandro Ochoa <alejandro.ochoa@duke.edu> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/StoreyLab/bnpsd/        |
...
ggmix, popkin, simfam, simtrait

## Namespace

Overall the package has 20 exported objects. 20 are documented:

      admix_prop_1d_circular     admix_prop_1d_linear admix_prop_indep_subpops 
                        TRUE                     TRUE                     TRUE 
                 coanc_admix         coanc_to_kinship               coanc_tree 
                        TRUE                     TRUE                     TRUE 
              draw_all_admix     draw_genotypes_admix               draw_p_anc 
                        TRUE                     TRUE                     TRUE 
              draw_p_subpops      draw_p_subpops_tree                 fit_tree 
                        TRUE                     TRUE                     TRUE 
                  fixed_loci                fst_admix         make_p_ind_admix 
                        TRUE                     TRUE                     TRUE 
                  scale_tree            tree_additive        tree_reindex_tips 
                        TRUE                     TRUE                     TRUE 
                tree_reorder                undiff_af 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-15 04:28:57 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4003dc0b_1739593732
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZx685k
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bnpsd_v1.3.13-tikzDictionary"
