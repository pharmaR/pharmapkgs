# Validation Report - dataSDA@0.1.0
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Han-Ming Wu <wuhm@g.nccu.edu.tw>                     |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         clean_colnames          iGAP_to_MM         RSDA_format set_variable_format 
                   TRUE                TRUE                TRUE                TRUE 
        write_csv_table 
                   TRUE 
...
| Execution Time | 2025-02-17 05:00:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bd673ebe13_1739768437
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVjR6dd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dataSDA_v0.1.0-tikzDictionary"
