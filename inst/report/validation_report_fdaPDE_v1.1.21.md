# Validation Report - fdaPDE@1.1.21
...
Overall the package has 39 exported objects. 39 are documented:
                         ...
                         covs.test               create.FEM.basis 
                              TRUE                           TRUE 
                  create.mesh.1.5D               create.mesh.2.5D 
                              TRUE                           TRUE 
                    create.mesh.2D                 create.MESH.2D 
                              TRUE                           TRUE 
                    create.mesh.3D                         DE.FEM 
                              TRUE                           TRUE 
                       DE.FEM.time                    DE.heat.FEM 
                              TRUE                           TRUE 
                  DE.heat.FEM.time                       eval.FEM 
                              TRUE                           TRUE 
                     eval.FEM.time                            FEM 
                              TRUE                           TRUE 
                          FEM.time                       FPCA.FEM 
                           ...
                           fs.test                     fs.test.3D 
                              TRUE                           TRUE 
        inferenceDataObjectBuilder inferenceDataObjectTimeBuilder 
                              TRUE                           TRUE 
            projection.points.1.5D         projection.points.2.5D 
                              TRUE                           TRUE 
                        R_eval.FEM               R_eval.FEM.basis 
                              TRUE                           TRUE 
                            R_mass             R_smooth.FEM.basis 
                              TRUE                           TRUE 
                           R_stiff  refine.by.splitting.mesh.1.5D 
                              TRUE                           TRUE 
     refine.by.splitting.mesh.2.5D    refine.by.splitting.mesh.2D 
                              TRUE                           TRUE 
       refine.by.splitting.mesh.3D               refine.mesh.1.5D 
                              TRUE                           TRUE 
                    refine.mesh.2D                 refine.MESH.2D 
                              TRUE                           TRUE 
                        smooth.FEM               smooth.FEM.basis 
                              TRUE                           TRUE 
...
There are 38 help pages with examples, from 46 (82.61 %).
...
| Execution Time | 2025-02-27 03:22:34 UTC |
...
running this report
    ...
    PROCESSX_PS1c62ced62e1_1740626550
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYgocq3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fdaPDE_v1.1.21-tikzDictionary"
