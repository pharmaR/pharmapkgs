...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Cord Hockemeyer <cord.hockemeyer@uni-graz.at>        |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | readODS (\>= 2.0.0)  | Imports |
| 2   | openxlsx (\>= 4.2.0) | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
         ...
         binary_matrix_product cdss_circular_requirements 
                          TRUE                       TRUE 
                  cdss_csma2sf           cdss_missing_los 
                          TRUE                       TRUE 
          cdss_nonteaching_los         cdss_sa_compliance 
                          TRUE                       TRUE 
          cdss_sa_describes_sr           cdss_sa2ar_skill 
                          TRUE                       TRUE 
                   cdss_sa2sma              cdss_sma2csma 
                          TRUE                       TRUE 
                cdss_tables2sa                   close_ar 
                          TRUE                       TRUE 
     read_skill_assignment_csv  read_skill_assignment_ods 
                          TRUE                       TRUE 
    read_skill_assignment_xlsx                  reduce_sf 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-23 03:20:09 UTC |
...
running this report
    ...
    PROCESSX_PS1d2542607bb0_1740280805
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpt5Bp1O
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CDSS_v0.2.0-tikzDictionary"
