# Validation Report - crm12Comb@0.1.9
...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Junying Wang <junying.wang@stonybrook.edu>           |
...
Overall the package has 20 exported objects. 20 are documented:
                          ...
                          doseComb_to_mat                          efficacy_est 
                                     TRUE                                  TRUE 
             empiric_GammaPriorLikelihood         empiric_NormalPriorLikelihood 
                                     TRUE                                  TRUE 
                      enroll_patient_plot                          get_ordering 
                                     TRUE                                  TRUE 
     logisticOnePara_GammaPriorLikelihood logisticOnePara_NormalPriorLikelihood 
                                     TRUE                                  TRUE 
     logisticTwoPara_GammaPriorLikelihood logisticTwoPara_NormalPriorLikelihood 
                                     TRUE                                  TRUE 
                       maximization_phase                              ODC_plot 
                                     TRUE                                  TRUE 
                  patient_allocation_plot                        priorSkeletons 
                                     TRUE                                  TRUE 
                      randomization_phase                             rBin2Corr 
                                     TRUE                                  TRUE 
                              sample_plot                        SIM_phase_I_II 
                                     TRUE                                  TRUE 
                  tanh_ExpPriorLikelihood                          toxicity_est 
                                     TRUE                                  TRUE 
...
| Execution Time | 2025-02-17 04:21:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bd678c0a348_1739766077
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9wrPI4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crm12Comb_v0.1.9-tikzDictionary"
