# Validation Report - bnstruct@1.0.15
...
| export_help          | 97                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alberto Franzin <afranzin@ulb.ac.be>                 |
...
BoltzMM, DExMA, NIMAA, TGS

## Namespace

Overall the package has 11 exported objects. 97 are documented:

               asia   asia_2_layers              BN       BNDataset           child 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       dag.to.cpdag  edge.dir.wpdag InferenceEngine      knn.impute             shd 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    tune.knn.impute 
               TRUE 
...
| Execution Time | 2025-02-15 04:29:31 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd29ae52c9_1739593766
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphaMNsi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bnstruct_v1.0.15-tikzDictionary"
