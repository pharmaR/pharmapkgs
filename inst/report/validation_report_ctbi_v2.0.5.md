...
| export_help          | 17                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Francois Ritter <ritter.francois@gmail.com>          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/fritte2/ctbi                      |
...
| 2   | stats (\>= 4.1.0)       | Imports |
| 3   | utils (\>= 4.1.0)       | Imports |
...
Overall the package has 17 exported objects. 17 are documented:
                     ...
                     ctbi            ctbi.cycle        ctbi.long.term 
                     TRUE                  TRUE                  TRUE 
             ctbi.outlier             ctbi.plot       ctbi.timeseries 
                     TRUE                  TRUE                  TRUE 
    hidd.check.bin.period         hidd.count.NA       hidd.count.noNA 
                     TRUE                  TRUE                  TRUE 
                 hidd.mad             hidd.mean           hidd.median 
                     TRUE                  TRUE                  TRUE 
            hidd.rel.time          hidd.replace               hidd.sd 
                     TRUE                  TRUE                  TRUE 
                 hidd.seq              hidd.sum 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-17 04:33:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd629bbb532_1739766798
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmXjwb5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ctbi_v2.0.5-tikzDictionary"
