# Validation Report - ConformalSmallest@1.0
...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Yachong Yang <yachong@wharton.upenn.edu>             |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/Elsa-Yang98/ConformalSmallest     |
...
Overall the package has 13 exported objects. 13 are documented:
        ...
        conf_CQR_conditional             conf_CQR_reg conf_CQR_reg_conditional 
                        TRUE                     TRUE                     TRUE 
                      cv.fun                 efcp_cqr               efcp_ridge 
                        TRUE                     TRUE                     TRUE 
                    efcp.fun             ginverse.fun                naive.fun 
                        TRUE                     TRUE                     TRUE 
                    star.fun                 vfcp_cqr               vfcp_ridge 
                        TRUE                     TRUE                     TRUE 
                    vfcp.fun 
                        TRUE 
...
| Execution Time | 2025-02-17 03:44:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63c7e4814_1739763848
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcJscZN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ConformalSmallest_v1.0-tikzDictionary"
