# Validation Report - causalPAF@1.2.5
...
| export_help          | 17                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Maurice O’Connell <maurice.oconnell2@gmail.com> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/MauriceOConnell/causalPAF    |
...
Overall the package has 17 exported objects. 17 are documented:
                   ...
                   addInSplinesTo_in_out                        causalPAFplot 
                                    TRUE                                 TRUE 
                          checkMarkovDAG                               do_sim 
                                    TRUE                                 TRUE 
                    do_sim_sequentialPAF                        eval_make_DAG 
                                    TRUE                                 TRUE 
                       eval_make_formula indirect_PAF_Sjolander_onesimulation 
                                    TRUE                                 TRUE 
                                make_DAG       make_DAG_AdjustmentSets_in_out 
                                    TRUE                                 TRUE 
                            make_formula                       overall_direct 
                                    TRUE                                 TRUE 
             path_specific_onesimulation                        pointEstimate 
                                    TRUE                                 TRUE 
                          sequential_PAF                          sim_outnode 
                                    TRUE                                 TRUE 
                           sim_outnode_2 
                                    TRUE 
...
| Execution Time | 2025-02-16 03:50:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36f86f8c6_1739677806
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWekDWH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causalPAF_v1.2.5-tikzDictionary"
