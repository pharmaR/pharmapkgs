# Validation Report - eatRep@0.15.1
...
| has_source_control | https://github.com/weirichs/eatRep |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | survey (\>= 4.1-1)   | Depends |
| 2   | BIFIEsurvey          | Depends |
| 3   | progress             | Depends |
| 4   | lavaan (\>= 0.6-7)   | Depends |
| 5   | parallel             | Depends |
| 6   | Hmisc                | Imports |
| 7   | fmsb                 | Imports |
| 8   | mice (\>= 2.46)      | Imports |
...
| 14  | miceadds             | Imports |
| 15  | tidyr                | Imports |
| 16  | EffectLiteR          | Imports |
| 17  | estimatr             | Imports |
| 18  | eatTools (\>= 0.7.8) | Imports |
| 19  | eatGADS (\>= 0.20.0) | Imports |
| 20  | janitor              | Imports |
| 21  | msm                  | Imports |
| 22  | lme4                 | Imports |
| 23  | utils                | Imports |
| 24  | methods              | Imports |
| 25  | checkmate            | Imports |
| 26  | lifecycle            | Imports |
| 27  | dplyr (\>= 1.0.0)    | Imports |
| 28  | future               | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
                  ...
                  checkLEs generateRandomJk1Zones                jk2.glm 
                      TRUE                   TRUE                   TRUE 
                  jk2.mean           jk2.quantile              jk2.table 
                      TRUE                   TRUE                   TRUE 
                   pool.R2                 repGlm                repLmer 
                      TRUE                   TRUE                   TRUE 
                   repMean                 report                report2 
                      TRUE                   TRUE                   TRUE 
               repQuantile               repTable 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-18 05:14:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46e4bd436_1739855645
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5AwJ3n
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eatRep_v0.15.1-tikzDictionary"
