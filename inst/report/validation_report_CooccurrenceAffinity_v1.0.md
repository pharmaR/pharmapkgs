# Validation Report - CooccurrenceAffinity@1.0
...
| export_help          | 18                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Kumar Mainali <kpmainali@gmail.com>               |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/kpmainali/CooccurrenceAffinity |
...
Overall the package has 18 exported objects. 18 are documented:
          ...
          AcceptAffCI       AcceptAffin          affinity      affinity2by2 
                 TRUE              TRUE              TRUE              TRUE 
             AlphInts            Bisect             Covrg         CovrgPlot 
                 TRUE              TRUE              TRUE              TRUE 
             dataprep          EHypMidP         EHypQuInt      logLikExtHyp 
                 TRUE              TRUE              TRUE              TRUE 
             MaxX.Int         midP.EHyp minmaxAlpha.pFNCH          MinX.Int 
                 TRUE              TRUE              TRUE              TRUE 
             ML.Alpha            plotgg 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-17 03:52:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65cc4da7c_1739764334
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7nNlD6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CooccurrenceAffinity_v1.0-tikzDictionary"
