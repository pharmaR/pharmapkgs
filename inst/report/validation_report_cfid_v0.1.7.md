...
| has_source_control   | https://github.com/santikka/cfid                     |
...
Overall the package has 11 exported objects. 11 are documented:
                 ...
                 causal_effect                         cf 
                          ...
                          TRUE                       TRUE 
       counterfactual_variable                        dag 
                          TRUE                       TRUE 
                  export_graph                 functional 
                          TRUE                       TRUE 
                  identifiable               import_graph 
                          TRUE                       TRUE 
                   probability 
                          TRUE 
...
| Execution Time | 2025-02-16 04:04:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36a5a543a_1739678667
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpa0iE0a
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cfid_v0.1.7-tikzDictionary"
