...
| export_help          | 0                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Barry Grant <bjgrant@ucsd.edu>                       |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://bitbucket.org/Grantlab/bio3d/                |
...
aLFQ, AlphaMissenseR, AntibodyForests, Bios2cor, compas, EnvNJ, factR,
orthGS, ptm, r3dmol, rPDBapi, SOMMD
...
There are 185 help pages with examples, from 185 (100.00 %).
...
| Execution Time | 2025-02-15 04:11:09 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3cfb8ba3_1739592664
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpauyUmq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bio3d_v2.4.5-tikzDictionary"
