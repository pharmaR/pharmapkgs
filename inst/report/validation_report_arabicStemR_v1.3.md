...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Rich Nielsen <rnielsen@mit.edu>                      |
...
Overall the package has 18 exported objects. 18 are documented:
               ...
               cleanChars       cleanLatinChars            doStemming 
                     TRUE                  TRUE                  TRUE 
                 fixAlifs   removeArabicNumbers      removeDiacritics 
                     TRUE                  TRUE                  TRUE 
     removeEnglishNumbers    removeFarsiNumbers    removeNewlineChars 
                     TRUE                  TRUE                  TRUE 
            removeNumbers        removePrefixes     removePunctuation 
                     TRUE                  TRUE                  TRUE 
          removeStopWords        removeSuffixes reverse.transliterate 
                     TRUE                  TRUE                  TRUE 
                     stem            stemArabic         transliterate 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-14 07:20:36 UTC |
...
running this report
    ...
    PROCESSX_PS1c0912530901_1739517633
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpllaOs9
