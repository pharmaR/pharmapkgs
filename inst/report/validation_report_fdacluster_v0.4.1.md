# Validation Report - fdacluster@0.4.1
...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Aymeric Stamm <aymeric.stamm@cnrs.fr>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/astamm/fdacluster                 |
...
Overall the package has 9 exported objects. 9 are documented:
            ...
            as_caps    compare_caps diagnostic_plot       fdadbscan         fdadist 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          fdahclust       fdakmeans         is_caps              lp 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-27 03:21:53 UTC |
...
running this report
    ...
    PROCESSX_PS1c6243f3ed71_1740626510
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3sYu2A
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fdacluster_v0.4.1-tikzDictionary"
