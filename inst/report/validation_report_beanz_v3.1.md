...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Chenguang Wang <cwang68@jhmi.edu>                    |
...
| 2   | methods                   | Depends   |
| 3   | rstan (\>= 2.18.1)        | Imports   |
| 4   | rstantools (\>= 1.5.0)    | Imports   |
| 5   | survival                  | Imports   |
| 6   | loo                       | Imports   |
| 7   | RcppParallel (\>= 5.0.1)  | Imports   |
| 8   | StanHeaders (\>= 2.18.0)  | LinkingTo |
| 9   | rstan (\>= 2.18.1)        | LinkingTo |
| 10  | BH (\>= 1.66.0)           | LinkingTo |
| 11  | Rcpp (\>= 0.12.0)         | LinkingTo |
| 12  | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 13  | RcppParallel (\>= 5.0.1)  | LinkingTo |
...
Overall the package has 13 exported objects. 13 are documented:
        ...
        bzCallStan       bzForest   bzForestComp    bzGailSimon    bzGetSubgrp 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    bzGetSubgrpRaw         bzPlot     bzPlotComp   bzPredSubgrp       bzRptTbl 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           bzShiny      bzSummary  bzSummaryComp 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-15 03:50:08 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4c7b84ed_1739591404
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJL7vfb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beanz_v3.1-tikzDictionary"
