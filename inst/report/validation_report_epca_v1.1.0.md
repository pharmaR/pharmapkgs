...
| export_help          | 12                               |
| has_website          | TRUE                             |
| has_maintainer       | Fan Chen <fan.chen@wisc.edu>     |
| bugs_status          | subscript out of bounds          |
| has_source_control   | https://github.com/fchen365/epca |
...
Overall the package has 12 exported objects. 12 are documented:
                ...
                cpve      dist.matrix            inner     misClustRate 
                TRUE             TRUE             TRUE             TRUE 
               polar              pve         rotation              sca 
                TRUE             TRUE             TRUE             TRUE 
           shrinkage              sma varimax.criteria       vgQ.absmin 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 04:14:03 UTC |
...
running this report
    ...
    PROCESSX_PS1d4568581f74_1739938437
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTziEdQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epca_v1.1.0-tikzDictionary"
