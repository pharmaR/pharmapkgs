# Validation Report - cpp11qpdf@1.3.5
...
Overall the package has 7 exported objects. 7 are documented:
          ...
          pdf_combine      pdf_compress        pdf_length pdf_overlay_stamp 
                 TRUE              TRUE              TRUE              TRUE 
     pdf_rotate_pages         pdf_split        pdf_subset 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:15:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bd628c8501_1739765701
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJ5rfUf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cpp11qpdf_v1.3.5-tikzDictionary"
