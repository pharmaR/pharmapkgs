# Validation Report - cuperdec@1.1.0
...
| export_help          | 8                                         |
| has_website          | TRUE                                      |
| has_maintainer       | James A. Fellows Yates <jfy133@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/jfy133/cuperdec        |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    adaptive_burnin_filter        calculate_curve     hard_burnin_filter 
                      TRUE                   TRUE                   TRUE 
             load_database               load_map        load_taxa_table 
                      TRUE                   TRUE                   TRUE 
             plot_cuperdec          simple_filter 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-17 04:39:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6ab05c84_1739767150
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYLF2wz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cuperdec_v1.1.0-tikzDictionary"
