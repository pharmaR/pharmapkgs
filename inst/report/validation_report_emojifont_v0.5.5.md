# Validation Report - emojifont@0.5.5
...
| has_source_control   | https://github.com/GuangchuangYu/emojifont |
...
abstractr, carbonr, ggtree, mazing, normfluodbf, seqcombo, superb

## Namespace

Overall the package has 11 exported objects. 11 are documented:

                 emoji        fontawesome         geom_emoji   geom_fontawesome 
                  TRUE               TRUE               TRUE               TRUE 
       list.emojifonts     load.emojifont   load.fontawesome       sample_emoji 
                  TRUE               TRUE               TRUE               TRUE 
    sample_fontawesome       search_emoji search_fontawesome 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:03:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d4518ac8a0d_1739937813
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2zhd3P
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emojifont_v0.5.5-tikzDictionary"
