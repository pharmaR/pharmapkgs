# Validation Report - categoryEncodings@1.4.3
...
| export_help          | 12                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Juraj Szitas <szitas.juraj13@gmail.com>      |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/JSzitas/categoryEncodings |
...
Overall the package has 12 exported objects. 12 are documented:
         ...
         encode_categories       encode_deviation      encode_difference 
                      TRUE                   TRUE                   TRUE 
              encode_dummy         encode_helmert         encode_lowrank 
                      TRUE                   TRUE                   TRUE 
               encode_mean          encode_median             encode_mnl 
                      TRUE                   TRUE                   TRUE 
    encode_repeated_effect   encode_simple_effect            encode_SPCA 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-16 03:46:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bc347b6ab89_1739677602
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbUluGC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_categoryEncodings_v1.4.3-tikzDictionary"
