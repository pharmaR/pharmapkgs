...
| size_codebase        | 529                                   |
| has_source_control   | https://github.com/OHDSI/Andromeda    |
...
Overall the package has 17 exported objects. 17 are documented:
                    ...
                    andromeda             appendToTable                batchApply 
                         TRUE                      TRUE                      TRUE 
                    batchTest             copyAndromeda               createIndex 
                         TRUE                      TRUE                      TRUE 
    getAndromedaTempDiskSpace                groupApply               isAndromeda 
                         TRUE                      TRUE                      TRUE 
             isAndromedaTable          isValidAndromeda               listIndices 
                         TRUE                      TRUE                      TRUE 
                loadAndromeda               removeIndex               restoreDate 
                         TRUE                      TRUE                      TRUE 
               restorePosixct             saveAndromeda 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-14 06:54:09 UTC |
...
running this report
    ...
    PROCESSX_PS726d6820a1be_1739516046
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoxXZV4
