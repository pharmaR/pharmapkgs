# Validation Report - FAOSTAT@2.4.0
...
| export_help          | 34                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Paul Rougieux <paul.rougieux@gmail.com>        |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://gitlab.com/paulrougieux/faostatpackage |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | RJSONIO (\>= 0.96-0)   | Imports |
| 2   | plyr (\>= 1.7.1)       | Imports |
| 3   | data.table (\>= 1.8.2) | Imports |
| 4   | MASS (\>= 7.3-22)      | Imports |
| 5   | classInt (\>= 0.1-19)  | Imports |
| 6   | labeling (\>= 0.1)     | Imports |
| 7   | httr (\>= 1.0)         | Imports |
...
Overall the package has 34 exported objects. 34 are documented:
                ...
                Aggregation             change_case             chConstruct 
                       TRUE                    TRUE                    TRUE 
      check_country_overlap                    chgr                    CHMT 
                       TRUE                    TRUE                    TRUE 
               constructSYB   download_faostat_bulk                   ebind 
                       TRUE                    TRUE                    TRUE 
                  FAOsearch         fillCountryCode                   geogr 
                       TRUE                    TRUE                    TRUE 
           get_faostat_bulk                  getFAO                  getWDI 
                       TRUE                    TRUE                    TRUE 
             getWDImetaData             getWDItoSYB             grConstruct 
                       TRUE                    TRUE                    TRUE 
               indConstruct                    lsgr                mergeSYB 
                       TRUE                    TRUE                    TRUE 
                    overlap                printLab      read_bulk_metadata 
                       TRUE                    TRUE                    TRUE 
     read_dataset_dimension read_dimension_metadata                read_fao 
                       TRUE                    TRUE                    TRUE 
          read_faostat_bulk               scaleUnit          search_dataset 
                       TRUE                    TRUE                    TRUE 
                shConstruct  translate_countrycodes    translateCountryCode 
                       TRUE                    TRUE                    TRUE 
              translateUnit 
                       TRUE 
...
| Execution Time | 2025-02-19 05:11:55 UTC |
...
running this report
    ...
    PROCESSX_PS1d45347520ec_1739941908
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKBzHVS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FAOSTAT_v2.4.0-tikzDictionary"
