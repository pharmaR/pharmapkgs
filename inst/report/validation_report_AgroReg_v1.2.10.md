...
Overall the package has 58 exported objects. 58 are documented:
           ...
           adjust_scale      adjust_scale_x      adjust_scale_y                  AM 
                   TRUE                TRUE                TRUE                TRUE 
             asymptotic        asymptotic_i     asymptotic_ineg      asymptotic_neg 
                   TRUE                TRUE                TRUE                TRUE 
                     BC            beta_reg       biexponential                  CD 
                   TRUE                TRUE                TRUE                TRUE 
      coloredit_arrange   comparative_model         correlation       extract.model 
                   TRUE                TRUE                TRUE                TRUE 
            gaussianreg                  GP                hill interval.confidence 
                   TRUE                TRUE                TRUE                TRUE 
          linear.linear      linear.plateau                  LL                  LM 
                   TRUE                TRUE                TRUE                TRUE 
                   LM_i                LM13               LM13i                LM23 
                   TRUE                TRUE                TRUE                TRUE 
                  LM23i               LM2i3            loessreg                 LOG 
                   TRUE                TRUE                TRUE                TRUE 
                   LOG2            logistic             lorentz             midilli 
                   TRUE                TRUE                TRUE                TRUE 
               midillim        mitscherlich                  MM              newton 
                   TRUE                TRUE                TRUE                TRUE 
                   Nreg                PAGE               peleg      plateau.linear 
                   TRUE                TRUE                TRUE                TRUE 
      plateau.quadratic        plot_arrange         plquadratic           potential 
                   TRUE                TRUE                TRUE                TRUE 
      quadratic.plateau          regression                  SH          stat_param 
                   TRUE                TRUE                TRUE                TRUE 
               thompson              valcam                  VB                  VG 
                   TRUE                TRUE                TRUE                TRUE 
                weibull           yieldloss 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-14 06:43:37 UTC |
...
running this report
    ...
    PROCESSX_PS726d7a7d4903_1739515414
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1PWhYz
