# Validation Report - ellipsis@0.3.2
...
| has_source_control   | https://github.com/r-lib/ellipsis   |
| has_bug_reports_url  | 1                                   |
| downloads_1yr        | 3157320                             |
| reverse_dependencies | 28                                  |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | rlang (\>= 0.3.0) | Imports |

**Package dependencies**

## Reverse dependencies

Overall the package has 28 reverse dependencies:

ale, beaver, brisk, cliff, cuda.ml, dann, devtools, dreamer, EDOIF,
epocakir, fastadi, fastRG, gggenomes, learnr, luz, mase, plumber, quid,
r3js, Racmacs, sortable, stickyr, tclust, tidyseurat,
tidySingleCellExperiment, tidySummarizedExperiment, tsibble, vetiver

## Namespace

Overall the package has 4 exported objects. 4 are documented:

      check_dots_empty check_dots_unnamed    check_dots_used        safe_median 
                  TRUE               TRUE               TRUE               TRUE 

### Examples

There are 4 help pages with examples, from 6 (66.67 %).
...
| Execution Time | 2025-02-19 03:56:50 UTC |
...
running this report
    ...
    PROCESSX_PS1d451103b49_1739937404
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqUEfg0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ellipsis_v0.3.2-tikzDictionary"
