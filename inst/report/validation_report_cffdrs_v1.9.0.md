# Validation Report - cffdrs@1.9.0
...
Overall the package has 14 exported objects. 14 are documented:
                         ...
                         fbp                fbpRaster              fire_season 
                        TRUE                     TRUE                     TRUE 
                         fwi                fwiRaster                     gfmc 
                        TRUE                     TRUE                     TRUE 
                  gfmcRaster grass_fuel_moisture_code                    hffmc 
                        TRUE                     TRUE                     TRUE 
                 hffmcRaster                     lros  overwinter_drought_code 
                        TRUE                     TRUE                     TRUE 
                        pros                     sdmc 
                        TRUE                     TRUE 
...
There are 15 help pages with examples, from 29 (51.72 %).
...
| Execution Time | 2025-02-16 04:04:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3c10dbfa_1739678656
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpW4pvYe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cffdrs_v1.9.0-tikzDictionary"
