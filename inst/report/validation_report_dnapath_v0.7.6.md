# Validation Report - dnapath@0.7.6
...
| export_help          | 30                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tyler Grimes <tylerlukegrimes@gmail.com>             |
...
Overall the package has 30 exported objects. 30 are documented:
                 ...
                 d_edgesC              d_genesC            d_pathwayC 
                     TRUE                  TRUE                  TRUE 
                  dnapath      entrez_to_symbol       filter_pathways 
                     TRUE                  TRUE                  TRUE 
      format_species_name   get_biomart_mapping             get_genes 
                     TRUE                  TRUE                  TRUE 
            get_min_alpha          get_networks get_reactome_pathways 
                     TRUE                  TRUE                  TRUE 
                init_mart             plot_pair          rename_genes 
                     TRUE                  TRUE                  TRUE 
               run_aracne            run_bc3net             run_c3net 
                     TRUE                  TRUE                  TRUE 
                  run_clr              run_corr            run_genie3 
                     TRUE                  TRUE                  TRUE 
               run_glasso             run_mrnet              run_pcor 
                     TRUE                  TRUE                  TRUE 
             run_pcor_fdr          run_silencer       summarize_edges 
                     TRUE                  TRUE                  TRUE 
          summarize_genes    summarize_pathways      symbol_to_entrez 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-25 03:22:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d284f4df7d9_1740453755
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTQ1kCb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dnapath_v0.7.6-tikzDictionary"
