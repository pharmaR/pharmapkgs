# Validation Report - binancer@1.2.0
...
| export_help          | 26                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Gergely Daróczi <daroczig@rapporter.net>             |
...
Overall the package has 26 exported objects. 26 are documented:
              ...
              binance_account        binance_all_orders         binance_avg_price 
                         TRUE                      TRUE                      TRUE 
             binance_balances      binance_cancel_order             binance_coins 
                         TRUE                      TRUE                      TRUE 
         binance_coins_prices       binance_credentials             binance_depth 
                         TRUE                      TRUE                      TRUE 
        binance_exchange_info           binance_filters            binance_klines 
                         TRUE                      TRUE                      TRUE 
             binance_mytrades         binance_new_order       binance_open_orders 
                         TRUE                      TRUE                      TRUE 
                 binance_ping       binance_query_order           binance_symbols 
                         TRUE                      TRUE                      TRUE 
          binance_ticker_24hr  binance_ticker_all_books binance_ticker_all_prices 
                         TRUE                      TRUE                      TRUE 
          binance_ticker_book      binance_ticker_price             binance_ticks 
                         TRUE                      TRUE                      TRUE 
                 binance_time            binance_trades 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-15 04:07:09 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2255ad02_1739592424
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpko1gup
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binancer_v1.2.0-tikzDictionary"
