# Validation Report - elec@0.1.2.2
...
| export_help          | 46                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Luke Mirarix <lmiratrix@g.harvard.edu>               |
...
Overall the package has 46 exported objects. 46 are documented:
          ...
          audit.totals.to.OS   calc.overstatement.e_p        calc.pairwise.e_p 
                        TRUE                     TRUE                     TRUE 
                  CAST.audit        CAST.calc.opt.cut         CAST.calc.sample 
                        TRUE                     TRUE                     TRUE 
                 CAST.sample     compute.audit.errors          compute.stark.t 
                        TRUE                     TRUE                     TRUE 
                  countVotes                 do.audit                elec.data 
                        TRUE                     TRUE                     TRUE 
                      find.q         find.stark.SRS.p      find.stratification 
                        TRUE                     TRUE                     TRUE 
        fractionOfVotesBound            is.audit.plan        is.audit.plan.tri 
                        TRUE                     TRUE                     TRUE 
                is.elec.data                 KM.audit           KM.calc.sample 
                        TRUE                     TRUE                     TRUE 
                  make.audit        make.audit.from.Z             make.cartoon 
                        TRUE                     TRUE                     TRUE 
               make.ok.truth      make.opt.packed.bad        make.random.truth 
                        TRUE                     TRUE                     TRUE 
                 make.sample  make.sample.from.totals        make.truth.ex.bad 
                        TRUE                     TRUE                     TRUE 
          make.truth.opt.bad make.truth.opt.bad.strat       maximumMarginBound 
                        TRUE                     TRUE                     TRUE 
             opt.sample.size                 sim.race               simulateIt 
                        TRUE                     TRUE                     TRUE 
                  stark.test             stark.test.Z            tri.audit.sim 
                        TRUE                     TRUE                     TRUE 
             tri.calc.sample               tri.sample         tri.sample.stats 
                        TRUE                     TRUE                     TRUE 
             trinomial.audit          trinomial.bound             truth.looker 
                        TRUE                     TRUE                     TRUE 
             weight.function 
                        TRUE 
...
| Execution Time | 2025-02-19 03:54:28 UTC |
...
running this report
    ...
    PROCESSX_PS1d4556a075a7_1739937262
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwBwOpO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_elec_v0.1.2.2-tikzDictionary"
