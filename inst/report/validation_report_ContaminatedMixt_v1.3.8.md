# Validation Report - ContaminatedMixt@1.3.8
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Angelo Mazza <a.mazza@unict.it>                      |
...
Overall the package has 17 exported objects. 17 are documented:
           ...
           agree       CNmixt     CNmixtCV    CNpredict          dCN getBestModel 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      getCluster        getCV getDetection        getIC       getPar getPosterior 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
         getSize       m.step          rCN    whichBest  whichBestCV 
...
| Execution Time | 2025-02-17 03:48:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bd625356652_1739764129
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeJBDyz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ContaminatedMixt_v1.3.8-tikzDictionary"
