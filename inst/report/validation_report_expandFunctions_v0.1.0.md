# Validation Report - expandFunctions@0.1.0
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Scott Miller <sam3CRAN@gmail.com>                    |
...
Overall the package has 19 exported objects. 19 are documented:
          ...
          coefPlot        distMat      easyLASSO          eDiff           eLag 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      eMatrixOuter         eOuter           ePow          eQuad       eReplace 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             eTrim   freemanTukey       lagshift    polywrapper           rapt 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          raptMake reset.warnings   Ydiagnostics      yyHatPlot 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:50:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d4545aec5b_1739940648
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2y7OxL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_expandFunctions_v0.1.0-tikzDictionary"
