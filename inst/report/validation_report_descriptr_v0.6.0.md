# Validation Report - descriptr@0.6.0
...
| has_source_control   | https://github.com/rsquaredacademy/descriptr |
...
Overall the package has 42 exported objects. 42 are documented:
          ...
          ds_auto_cross_table        ds_auto_freq_table     ds_auto_group_summary 
                         TRUE                      TRUE                      TRUE 
        ds_auto_summary_stats            ds_cross_table                    ds_css 
                         TRUE                      TRUE                      TRUE 
                      ds_cvar            ds_extreme_obs              ds_freq_cont 
                         TRUE                      TRUE                      TRUE 
                ds_freq_table                  ds_gmean          ds_group_summary 
                         TRUE                      TRUE                      TRUE 
    ds_group_summary_interact                  ds_hmean               ds_kurtosis 
                         TRUE                      TRUE                      TRUE 
          ds_launch_shiny_app                   ds_mdev      ds_measures_location 
                         TRUE                      TRUE                      TRUE 
         ds_measures_symmetry     ds_measures_variation                   ds_mode 
                         TRUE                      TRUE                      TRUE 
               ds_multi_stats            ds_oway_tables            ds_percentiles 
                         TRUE                      TRUE                      TRUE 
                  ds_plot_bar       ds_plot_bar_grouped       ds_plot_bar_stacked 
                         TRUE                      TRUE                      TRUE 
            ds_plot_box_group        ds_plot_box_single           ds_plot_density 
                         TRUE                      TRUE                      TRUE 
            ds_plot_histogram           ds_plot_scatter                  ds_range 
                         TRUE                      TRUE                      TRUE 
                    ds_rindex               ds_screener               ds_skewness 
                         TRUE                      TRUE                      TRUE 
                 ds_std_error          ds_summary_stats                ds_tailobs 
                         TRUE                      TRUE                      TRUE 
                ds_tidy_stats            ds_tway_tables           ds_twoway_table 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-18 03:46:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bb472ffef32_1739850411
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvDwGUX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_descriptr_v0.6.0-tikzDictionary"
