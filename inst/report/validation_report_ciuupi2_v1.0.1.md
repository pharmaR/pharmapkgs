# Validation Report - ciuupi2@1.0.1
...
|     | package     | type    |
|:----|:------------|:--------|
| 1   | functional  | Imports |
| 2   | nloptr      | Imports |
| 3   | pracma      | Imports |
| 4   | PreciseSums | Imports |
| 5   | statmod     | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
      ...
      bsciuupi2   bsspline2 cistandard2     ciuupi2   cpciuupi2    find_rho 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
    sel1ciuupi2 sel2ciuupi2 
           TRUE        TRUE 
...
| Execution Time | 2025-02-16 04:24:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37018ec6_1739679839
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5nigKo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ciuupi2_v1.0.1-tikzDictionary"
