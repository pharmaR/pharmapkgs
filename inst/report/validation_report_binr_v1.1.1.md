...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Sergei Izrailev <sizrailev@jabiruventures.com>       |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/jabiru/binr                       |
...
cTRAP, NetSci, pkr, Rprofet

## Namespace

Overall the package has 11 exported objects. 11 are documented:

                bins     bins.getvals      bins.greedy bins.greedy.impl 
                TRUE             TRUE             TRUE             TRUE 
          bins.merge  bins.merge.iter        bins.merr        bins.move 
                TRUE             TRUE             TRUE             TRUE 
      bins.quantiles       bins.split  bins.split.iter 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:10:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd15aa7ebd_1739592609
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpG6hr5S
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binr_v1.1.1-tikzDictionary"
