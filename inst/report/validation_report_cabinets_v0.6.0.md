# Validation Report - cabinets@0.6.0
...
| export_help          | 7                                             |
| has_website          | TRUE                                          |
| has_maintainer       | Nick Williams <ntwilliams.personal@gmail.com> |
| bugs_status          | 0.8333333                                     |
| has_source_control   | https://github.com/nt-williams/cabinets       |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    cabinets_options_set       create_cabinet       delete_cabinet 
                    TRUE                 TRUE                 TRUE 
          edit_r_profile          FileCabinet         get_cabinets 
                    TRUE                 TRUE                 TRUE 
        new_cabinet_proj 
                    TRUE 
...
| Execution Time | 2025-02-16 03:32:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37bfdb9ca_1739676733
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpduQYHV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cabinets_v0.6.0-tikzDictionary"
