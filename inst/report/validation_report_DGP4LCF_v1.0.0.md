# Validation Report - DGP4LCF@1.0.0
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jiachen Cai <jiachen.cai@mrc-bsu.cam.ac.uk>          |
...
Overall the package has 13 exported objects. 13 are documented:
                    ...
                    factor_loading_heatmap                factor_score_trajectory 
                                      TRUE                                   TRUE 
                gibbs_after_mcem_algorithm        gibbs_after_mcem_combine_chains 
                                      TRUE                                   TRUE 
            gibbs_after_mcem_diff_initials           gibbs_after_mcem_load_chains 
                                      TRUE                                   TRUE 
                            mcem_algorithm                          mcem_cov_plot 
                                      TRUE                                   TRUE 
                      mcem_parameter_setup numerics_summary_do_not_need_alignment 
                                      TRUE                                   TRUE 
           numerics_summary_need_alignment               subject_specific_objects 
                                      TRUE                                   TRUE 
                           table_generator 
                                      TRUE 
...
| Execution Time | 2025-02-18 03:56:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bb416e623d8_1739851000
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2Do4rx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DGP4LCF_v1.0.0-tikzDictionary"
