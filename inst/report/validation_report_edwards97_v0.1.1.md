# Validation Report - edwards97@0.1.1
...
| export_help          | 10                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Dewey Dunnington <dewey@fishandwhistle.net> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/paleolimbot/edwards97    |
...
Overall the package has 10 exported objects. 10 are documented:
                      ...
                      coagulate              coagulate_base 
                           TRUE                        TRUE 
                 coagulate_grid          dose_for_criterion 
                           TRUE                        TRUE 
    dose_of_diminishing_returns               edwards_coefs 
                           TRUE                        TRUE 
                   edwards_data                 fit_edwards 
                           TRUE                        TRUE 
              fit_edwards_coefs           fit_edwards_optim 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-19 03:43:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d4525bc581b_1739936628
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5Ps3J0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_edwards97_v0.1.1-tikzDictionary"
