...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Daphne van Ginneken <daphne.v.ginneken@gmail.com>    |
...
Overall the package has 23 exported objects. 23 are documented:
               ...
               Af_add_node_feature                       Af_build 
                              TRUE                           TRUE 
                Af_cluster_metrics       Af_cluster_node_features 
                              TRUE                           TRUE 
     Af_compare_across_repertoires             Af_compare_methods 
                              TRUE                           TRUE 
     Af_compare_within_repertoires            Af_distance_boxplot 
                              TRUE                           TRUE 
           Af_distance_scatterplot                   Af_edge_RMSD 
                              TRUE                           TRUE 
                  Af_get_sequences                     Af_metrics 
                              TRUE                           TRUE 
                  Af_PLM_dataframe                    Af_plot_PLM 
                              TRUE                           TRUE 
                      Af_plot_tree                  Af_sync_nodes 
                              TRUE                           TRUE 
                      Af_to_newick                 calculate_GBLD 
                              TRUE                           TRUE 
                   igraph_to_phylo              VDJ_3d_properties 
                              TRUE                           TRUE 
    VDJ_import_IgBLAST_annotations             VDJ_integrate_bulk 
                              TRUE                           TRUE 
                       VDJ_to_AIRR 
                              TRUE 
...
| Execution Time | 2025-02-14 06:57:07 UTC |
...
running this report
    ...
    PROCESSX_PS726d3f4e69ce_1739516224
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2M5f5F
