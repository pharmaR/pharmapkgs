# Validation Report - downlit@0.4.4
...
| has_source_control   | https://github.com/r-lib/downlit |
| has_bug_reports_url  | 1                                |
| downloads_1yr        | 1719632                          |
...
altdoc, bookdown, DBI, distill, esquisse, link, pkgdown, rgl, rmarkdown,
rosetta
...
Overall the package has 14 exported objects. 14 are documented:
                  ...
                  autolink           autolink_url         classes_chroma 
                      TRUE                   TRUE                   TRUE 
            classes_pandoc      downlit_html_node      downlit_html_path 
                      TRUE                   TRUE                   TRUE 
           downlit_md_path      downlit_md_string evaluate_and_highlight 
                      TRUE                   TRUE                   TRUE 
                 highlight           href_article           href_package 
                      TRUE                   TRUE                   TRUE 
                href_topic          is_low_change 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:38:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bb412322381_1739853521
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbHAmqY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_downlit_v0.4.4-tikzDictionary"
