...
| export_help          | 51                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Matt Heaphy <mattrmattrs@gmail.com>   |
| bugs_status          | 0.9666667                             |
| size_codebase        | 2816                                  |
| has_source_control   | https://github.com/mattheaphy/actxps/ |
...
Overall the package has 51 exported objects. 51 are documented:
            ...
            add_predictions        add_transactions               anti_join 
                       TRUE                    TRUE                    TRUE 
                    arrange               as_exp_df           as_exposed_df 
                       TRUE                    TRUE                    TRUE 
                  as_trx_df                autoplot               autotable 
                       TRUE                    TRUE                    TRUE 
                       bake               exp_shiny               exp_stats 
                       TRUE                    TRUE                    TRUE 
                     expose               expose_cm               expose_cq 
                       TRUE                    TRUE                    TRUE 
                  expose_cw               expose_cy               expose_pm 
                       TRUE                    TRUE                    TRUE 
                  expose_pq               expose_pw               expose_py 
                       TRUE                    TRUE                    TRUE 
               expose_split                  filter               full_join 
                       TRUE                    TRUE                    TRUE 
                   group_by                  groups              inner_join 
                       TRUE                    TRUE                    TRUE 
                  is_exp_df           is_exposed_df     is_split_exposed_df 
                       TRUE                    TRUE                    TRUE 
                  is_trx_df               left_join                  mutate 
                       TRUE                    TRUE                    TRUE 
    plot_actual_to_expected  plot_termination_rates  plot_utilization_rates 
                       TRUE                    TRUE                    TRUE 
                    pol_mth                 pol_qtr                  pol_wk 
                       TRUE                    TRUE                    TRUE 
                     pol_yr                    prep                relocate 
                       TRUE                    TRUE                    TRUE 
                     rename              right_join                  select 
                       TRUE                    TRUE                    TRUE 
                  semi_join                   slice             step_expose 
                       TRUE                    TRUE                    TRUE 
                       tidy               trx_stats                 ungroup 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 06:33:49 UTC |
...
running this report
    ...
    PROCESSX_PS726d2e6a6ae8_1739514826
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpptBekQ
