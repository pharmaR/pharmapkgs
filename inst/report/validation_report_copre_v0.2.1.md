...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Blake Moya <blakemoya@utexas.edu>                    |
...
Overall the package has 13 exported objects. 13 are documented:
       ...
       antimodes        copre   functional     G_normls     gibbsmix     grideval 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           modes       moment      n_modes        seqre Sq_dirichlet   Sq_gnedin0 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
    Sq_pitmanyor 
            TRUE 
...
| Execution Time | 2025-02-17 03:54:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bd674285256_1739764453
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5GPSup
...
These are the options set to generate the report:
    ...
    [1] "validation_report_copre_v0.2.1-tikzDictionary"
