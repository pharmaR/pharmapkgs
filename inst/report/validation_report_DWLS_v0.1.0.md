...
| export_help          | 17                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Adriana Sistig <adriana.sistig@icahn.mssm.edu> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/sistia01/DWLS               |
...
| 9   | e1071                | Imports |
| 10  | MAST                 | Imports |
| 11  | SummarizedExperiment | Imports |
...
Overall the package has 17 exported objects. 17 are documented:
           ...
           buildSignatureMatrixMAST buildSignatureMatrixUsingSeurat 
                               TRUE                            TRUE 
                     DEAnalysisMAST                DEAnalysisSeurat 
                               TRUE                            TRUE 
             DEAnalysisSeuratIdents           findDampeningConstant 
                               TRUE                            TRUE 
                              m.auc      MASTSignatureMatrixGivenDE 
                               TRUE                            TRUE 
                  Mean.in.log2space                solveDampenedWLS 
                               TRUE                            TRUE 
                  solveDampenedWLSj                        solveOLS 
                               TRUE                            TRUE 
                   solveOLSInternal                        solveSVR 
                               TRUE                            TRUE 
                          stat.log2                        trimData 
                               TRUE                            TRUE 
                              v.auc 
...
| Execution Time | 2025-02-18 05:02:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41e8af3eb_1739854919
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpteO3T4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DWLS_v0.1.0-tikzDictionary"
