...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Erol Taymaz <etaymaz@metu.edu.tr>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/etaymaz/CBRT                      |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    getAllCategoriesInfo     getAllGroupsInfo     getAllSeriesInfo 
                    TRUE                 TRUE                 TRUE 
            getDataGroup        getDataSeries           searchCBRT 
                    TRUE                 TRUE                 TRUE 
           showGroupInfo      showSeriesNames 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-16 03:52:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bc375cf9ed9_1739677930
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAtacwO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CBRT_v0.1.1-tikzDictionary"
