...
| has_source_control   | https://github.com/mcanigueral/evsim/     |
...
Overall the package has 15 exported objects. 15 are documented:
            ...
            adapt_charging_features     add_charging_infrastructure 
                               TRUE                            TRUE 
                    expand_sessions get_charging_rates_distribution 
                               TRUE                            TRUE 
                get_custom_ev_model                      get_demand 
                               TRUE                            TRUE 
             get_evmodel_parameters             get_evmodel_summary 
                               TRUE                            TRUE 
                      get_occupancy  get_user_profiles_distribution 
                               TRUE                            TRUE 
      plot_occupancy_duration_curve                         plot_ts 
                               TRUE                            TRUE 
                      read_ev_model                   save_ev_model 
                               TRUE                            TRUE 
                  simulate_sessions 
                               TRUE 
...
| Execution Time | 2025-02-19 04:44:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d4512f0b7f9_1739940244
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplT0Ajr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evsim_v1.6.0-tikzDictionary"
