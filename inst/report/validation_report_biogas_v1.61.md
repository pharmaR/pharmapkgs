...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Sasha D. Hafner <sasha.hafner@bce.au.dk>             |
...
Overall the package has 16 exported objects. 16 are documented:
      ...
      calcBgGD calcBgGrav  calcBgMan  calcBgVol    calcCOD      cumBg     fitFOM 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
        interp   mass2vol    molMass    planBMP     predBg     stdVol     summBg 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
      vol2mass    vol2mol 
          TRUE       TRUE 
...
| Execution Time | 2025-02-15 04:12:25 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6280ad50_1739592740
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSkfq9Z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biogas_v1.61-tikzDictionary"
