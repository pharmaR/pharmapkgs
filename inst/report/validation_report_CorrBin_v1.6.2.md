# Validation Report - CorrBin@1.6.2
...
| export_help          | 26                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Aniko Szabo <aszabo@mcw.edu>                         |
...
Overall the package has 26 exported objects. 26 are documented:
       ...
       betabin.pdf         CBData         CMData GEE.trend.test     jointprobs 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            mc.est  mc.test.chisq     mg.DirMult   mg.LogitNorm     mg.MixMult 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       mg.Resample     multi.corr       NOSTASOT     qpower.pdf     ran.CBData 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        ran.CMData    read.CBData    read.CMData  RS.trend.test         SO.LRT 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         SO.mc.est  SO.trend.test      soControl     trend.test       uniprobs 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            unwrap 
              TRUE 
...
| Execution Time | 2025-02-17 03:59:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6ecbb081_1739764767
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIQG8eb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CorrBin_v1.6.2-tikzDictionary"
