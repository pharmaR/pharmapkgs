# Validation Report - CaPO4Sim@0.2.1
...
| 1   | shiny           | Imports |
| 2   | shinyjs         | Imports |
| 3   | shinyWidgets    | Imports |
| 4   | shinyjqui       | Imports |
| 5   | plotly          | Imports |
| 6   | rintrojs        | Imports |
| 7   | shinycssloaders | Imports |
| 8   | visNetwork      | Imports |
| 9   | purrr           | Imports |
| 10  | DT              | Imports |
| 11  | magrittr        | Imports |
| 12  | utils           | Imports |
...
Overall the package has 36 exported objects. 35 are documented:
                      ...
                      %>%        arrow_lighting         diseaseSelect 
                    FALSE                  TRUE                  TRUE 
          diseaseSelectUi   extract_running_sim            fullScreen 
                     TRUE                  TRUE                  TRUE 
             fullScreenUI        generate_edges      generate_network 
                     TRUE                  TRUE                  TRUE 
           generate_nodes generate_notification   generate_userFields 
                     TRUE                  TRUE                  TRUE 
            glossaryCaPO4       glossaryCaPO4Ui             helpCaPO4 
                     TRUE                  TRUE                  TRUE 
              helpCaPO4Ui                 infos               infosUi 
                     TRUE                  TRUE                  TRUE 
                 is_empty      make_plot_hypoD3    make_plot_hypopara 
                     TRUE                  TRUE                  TRUE 
           make_plot_php1            myCarousel          networkCaPO4 
                     TRUE                  TRUE                  TRUE 
           networkCaPO4Ui        networkOptions      networkOptionsUi 
                     TRUE                  TRUE                  TRUE 
                  plotBox             plotBoxUi          run_CaPO4Sim 
                     TRUE                  TRUE                  TRUE 
               skinSelect          skinSelectUi              userInfo 
                     TRUE                  TRUE                  TRUE 
               userInfoUi                 video               videoUi 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 03:39:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bc367c27d93_1739677176
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaXgbNb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CaPO4Sim_v0.2.1-tikzDictionary"
