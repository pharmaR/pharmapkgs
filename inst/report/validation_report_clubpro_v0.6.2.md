# Validation Report - clubpro@0.6.2
...
| export_help          | 13                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Timothy Beechey <tim.beechey@proton.me> |
...
Overall the package has 13 exported objects. 13 are documented:
              ...
              accuracy               club            compare                csi 
                  TRUE               TRUE               TRUE               TRUE 
                  cval individual_results         median_csi        n_ambiguous 
                  TRUE               TRUE               TRUE               TRUE 
             n_correct        n_incorrect                pcc     pcc_replicates 
                  TRUE               TRUE               TRUE               TRUE 
             threshold 
                  TRUE 
...
| Execution Time | 2025-02-16 04:36:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3287514b1_1739680570
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpapDDsJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clubpro_v0.6.2-tikzDictionary"
