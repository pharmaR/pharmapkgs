...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Jens Hainmueller <jhain@stanford.edu>                |
...
cobalt, hbal, jointCalib, missDiag, rbw

## Namespace

Overall the package has 7 exported objects. 7 are documented:

    baltest.collect              eb        ebalance   ebalance.trim      getsquares 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      line.searcher     matrixmaker 
               TRUE            TRUE 
...
| Execution Time | 2025-02-25 03:25:02 UTC |
...
running this report
    ...
    PROCESSX_PS1d286322f83a_1740453899
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBmH54e
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ebal_v0.1.8-tikzDictionary"
