# Validation Report - ChillModels@1.0.2
...
| export_help | 18 |
| has_website | FALSE |
| has_maintainer | Rafael Henrique Pertille <henriquepertille@gmail.com> |
...
Overall the package has 18 exported objects. 18 are documented:
        ...
        cherry_model    count_between       count_down         count_up 
                TRUE             TRUE             TRUE             TRUE 
       dynamic_model       gala_model       gdha_model       gdhr_model 
                TRUE             TRUE             TRUE             TRUE 
    heat_restriction      jones_model  landsberg_model   lowchill_model 
                TRUE             TRUE             TRUE             TRUE 
      north_carolina        pcu_model       q10_bidabe     taiwan_model 
                TRUE             TRUE             TRUE             TRUE 
       unified_model       utah_model 
                TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:13:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34ccb7205_1739679204
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpewutk8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ChillModels_v1.0.2-tikzDictionary"
