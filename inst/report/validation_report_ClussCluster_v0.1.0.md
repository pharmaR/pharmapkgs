# Validation Report - ClussCluster@0.1.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Li Jun <jun.li@nd.edu>                               |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | stats (\>= 3.5.0)    | Imports |
| 2   | utils (\>= 3.5.0)    | Imports |
| 3   | VennDiagram          | Imports |
| 4   | scales (\>= 1.0.0)   | Imports |
| 5   | reshape2 (\>= 1.4.3) | Imports |
| 6   | ggplot2 (\>= 3.1.0)  | Imports |
| 7   | rlang (\>= 0.3.4)    | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
              ...
              ClussCluster       ClussCluster_Gap            filter_gene 
                      TRUE                   TRUE                   TRUE 
         plot_ClussCluster  plot_ClussCluster_Gap     print_ClussCluster 
                      TRUE                   TRUE                   TRUE 
    print_ClussCluster_Gap               top.m.hm 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:37:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34a443718_1739680639
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHWlgsn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClussCluster_v0.1.0-tikzDictionary"
