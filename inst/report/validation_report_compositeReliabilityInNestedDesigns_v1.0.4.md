# Validation Report - compositeReliabilityInNestedDesigns@1.0.4
...
| export_help | 9 |
| has_website | TRUE |
| has_maintainer | Joyce Moonen - van Loon <j.moonen@maastrichtuniversity.nl> |
| has_source_control | https://github.com/jmoonen/compositeReliabilityInNestedDesigns |
...
Overall the package has 9 exported objects. 8 are documented:
                             ...
                             FALSE                           TRUE 
                   calculateVarCov                  checkDatasets 
                              TRUE                           TRUE 
       computeCompositeReliability computeMaxCompositeReliability 
                              TRUE                           TRUE 
                            DStudy                         GStudy 
                              TRUE                           TRUE 
                     GStudyPerType 
...
| Execution Time | 2025-02-17 03:37:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67d5ee3c5_1739763423
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpD7AncM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_compositeReliabilityInNestedDesigns_v1.0.4-tikzDictionary"
