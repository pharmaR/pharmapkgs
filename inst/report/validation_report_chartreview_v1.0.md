# Validation Report - chartreview@1.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Georg Hahn <ghahn@bwh.harvard.edu>                   |
...
Overall the package has 8 exported objects. 8 are documented:
     ...
     credibleinterval           fullrun               lai          makeplot 
                 TRUE              TRUE              TRUE              TRUE 
             normalci stoppingcriterion           stratum    subsetInterval 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:09:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3236b8416_1739678948
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpq4WpjN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chartreview_v1.0-tikzDictionary"
