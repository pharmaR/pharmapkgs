# Validation Report - compare@0.2.6
...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Paul Murrell <p.murrell@auckland.ac.nz>              |
...
acebayes, DynNom, emuR, HyRiM, MonoInc, processcheckR, relatable, wrassp

## Namespace

Overall the package has 23 exported objects. 23 are documented:

         commentQuestions              comments               compare 
                     TRUE                  TRUE                  TRUE 
            compareCoerce          compareEqual           compareFile 
                     TRUE                  TRUE                  TRUE 
             compareFiles      compareIdentical    compareIgnoreAttrs 
                     TRUE                  TRUE                  TRUE 
    compareIgnoreNameCase    compareIgnoreNames    compareIgnoreOrder 
                     TRUE                  TRUE                  TRUE 
              compareName        compareShorten                isTRUE 
                     TRUE                  TRUE                  TRUE 
            markQuestions      questionComments         questionMarks 
                     TRUE                  TRUE                  TRUE 
                     rule            sourceFile      transformComment 
                     TRUE                  TRUE                  TRUE 
            transformRule            transforms 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-23 03:25:33 UTC |
...
running this report
    ...
    PROCESSX_PS1d257f9822f5_1740281130
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpO1XhLH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_compare_v0.2.6-tikzDictionary"
