# Validation Report - CFtime@1.5.0
...
| export_help          | 26                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Patrick Van Laake <patrick@vanlaake.net> |
| bugs_status          | 0.8181818                                |
| has_source_control   | https://github.com/pvanlaake/CFtime      |
...
dacc, ncdfCF, ncmeta, tidync

## Namespace

Overall the package has 26 exported objects. 26 are documented:

         as_timestamp            bounds          bounds<-          calendar 
                 TRUE              TRUE              TRUE              TRUE 
           CFcomplete          CFfactor CFfactor_coverage    CFfactor_units 
                 TRUE              TRUE              TRUE              TRUE 
         CFmonth_days           CFparse          CFsubset            CFtime 
                 TRUE              TRUE              TRUE              TRUE 
               CFTime       CFtimestamp        definition           indexOf 
                 TRUE              TRUE              TRUE              TRUE 
          is_complete        month_days           offsets            origin 
                 TRUE              TRUE              TRUE              TRUE 
     parse_timestamps        resolution              slab             slice 
                 TRUE              TRUE              TRUE              TRUE 
             timezone              unit 
                 TRUE              TRUE 
...
There are 20 help pages with examples, from 30 (66.67 %).
...
| Execution Time | 2025-02-16 04:05:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bc336f427e8_1739678711
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFsQPl3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CFtime_v1.5.0-tikzDictionary"
