# Validation Report - CensSpatial@3.6
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alejandro Ordonez <ordonezjosealejandro@gmail.com>   |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | geoR (\>= 1.8-1)        | Imports |
| 2   | Rcpp                    | Imports |
| 3   | stats                   | Imports |
| 4   | graphics                | Imports |
| 5   | mvtnorm                 | Imports |
| 6   | optimx (\>= 2021.10-12) | Imports |
| 7   | tmvtnorm (\>= 1.4-10)   | Imports |
| 8   | msm                     | Imports |
| 9   | psych                   | Imports |
| 10  | numDeriv (\>= 2.11.1)   | Imports |
| 11  | raster                  | Imports |
| 12  | moments (\>= 0.14)      | Imports |
| 13  | lattice                 | Imports |
| 14  | tlrmvnmvt (\>= 1.1.0)   | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
        ...
        algnaive12 derivcormatrix      derivQfun     distmatrix   localinfmeas 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      predgraphics        predSCL       rspacens        SAEMSCL      Seminaive 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:00:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32bd68614_1739678431
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWGCpF3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CensSpatial_v3.6-tikzDictionary"
