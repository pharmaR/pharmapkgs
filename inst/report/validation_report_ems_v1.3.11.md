...
| export_help          | 34                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Lunna Borges <lunna.borges@epimedsolutions.com>      |
...
Overall the package has 34 exported objects. 34 are documented:
           ...
           cal.Slope         calcurve changePropFunnel changeRateFunnel 
                TRUE             TRUE             TRUE             TRUE 
              cut_in       date.table    dummy.columns           f.date 
                TRUE             TRUE             TRUE             TRUE 
               f.num     factor.table       forest.SMR           funnel 
                TRUE             TRUE             TRUE             TRUE 
      funnelEstimate   mortality_rate        num.table       propFunnel 
                TRUE             TRUE             TRUE             TRUE 
                R2pm             R2sh       rateFunnel          reclass 
                TRUE             TRUE             TRUE             TRUE 
           remove.na rm.dummy.columns      rm.unwanted              SMR 
                TRUE             TRUE             TRUE             TRUE 
           SMR.table              SRU          SRUcalc           t_date 
                TRUE             TRUE             TRUE             TRUE 
            t_factor            t_num          tab2tex       tableStack 
                TRUE             TRUE             TRUE             TRUE 
           trunc_num      winsorising 
                TRUE             TRUE 
...
| Execution Time | 2025-02-19 04:04:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d451c2dd921_1739937888
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpby8wYL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ems_v1.3.11-tikzDictionary"
