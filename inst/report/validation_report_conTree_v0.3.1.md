# Validation Report - conTree@0.3.1
...
| export_help          | 16                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Balasubramanian Narasimhan <naras@stanford.edu> |
...
Overall the package has 16 exported objects. 16 are documented:
                 ...
                 bootcri             contrast             getnodes 
                    TRUE                 TRUE                 TRUE 
                lofcurve             modtrast            nodeplots 
                    TRUE                 TRUE                 TRUE 
                 nodesum onesample_parameters            predtrast 
                    TRUE                 TRUE                 TRUE 
                   prune            prune.seq            save_rfun 
                    TRUE                 TRUE                 TRUE 
                 treesum twosample_parameters                 xval 
                    TRUE                 TRUE                 TRUE 
                   ydist 
                    TRUE 
...
| Execution Time | 2025-02-17 03:50:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bd621e88a64_1739764199
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpd0PXHr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conTree_v0.3.1-tikzDictionary"
