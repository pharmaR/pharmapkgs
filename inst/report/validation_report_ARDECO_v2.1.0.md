...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Carmelo Attardo <carmelo.attardo@ec.europa.eu>       |
...
Overall the package has 4 exported objects. 4 are documented:
     ...
     ardeco_get_dataset_data  ardeco_get_dataset_list   ardeco_get_tercet_list 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-14 07:22:18 UTC |
...
running this report
    ...
    PROCESSX_PS1c0938513a45_1739517735
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqeBcpx
