...
| export_help          | 23                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | W. E. Wansouwé <ericwansouwe@gmail.com>              |
...
Overall the package has 23 exported objects. 23 are documented:
               ...
               dke.fun    dke.fun.default           hbay.fun   hbay.fun.default 
                  TRUE               TRUE               TRUE               TRUE 
              hcvc.fun   hcvc.fun.default           hcvd.fun   hcvd.fun.default 
                  TRUE               TRUE               TRUE               TRUE 
            hcvreg.fun hcvreg.fun.default                kef           kern.fun 
                  TRUE               TRUE               TRUE               TRUE 
      kern.fun.default          kpmfe.fun  kpmfe.fun.default       plot.dke.fun 
                  TRUE               TRUE               TRUE               TRUE 
         plot.hcvc.fun      plot.kern.fun     plot.kpmfe.fun       plot.reg.fun 
                  TRUE               TRUE               TRUE               TRUE 
         print.reg.fun            reg.fun    reg.fun.default 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-14 06:46:53 UTC |
...
running this report
    ...
    PROCESSX_PS726d4942feed_1739515610
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9YPpzC
