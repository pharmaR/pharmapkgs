...
| export_help          | 29                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Pieter Schoonees <schoonees@gmail.com>               |
...
Overall the package has 29 exported objects. 29 are documented:
                       ...
                       addbounds                  approxloads 
                            TRUE                         TRUE 
                 calc.wt.bubbles                          cds 
                            TRUE                         TRUE 
                         cds.sim             cl_class_ids.cds 
                            TRUE                         TRUE 
            cl_class_ids.cdsdata                 clean.scales 
                            TRUE                         TRUE 
                      create.ind                    create.rs 
                            TRUE                         TRUE 
                   createcdsdata                       datsim 
                            TRUE                         TRUE 
                         G.start                      gen.cop 
                            TRUE                         TRUE 
                          genPCA                    group.ALS 
                            TRUE                         TRUE 
                          indmat     is.cl_hard_partition.cds 
                            TRUE                         TRUE 
    is.cl_hard_partition.cdsdata          is.cl_partition.cds 
                            TRUE                         TRUE 
         is.cl_partition.cdsdata                      ispline 
                            TRUE                         TRUE 
                       orthprocr                      rcormat 
                            TRUE                         TRUE 
                         rcovmat                       simpca 
...
| Execution Time | 2025-02-16 03:57:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34ec20569_1739678240
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1QjACE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cds_v1.0.3-tikzDictionary"
