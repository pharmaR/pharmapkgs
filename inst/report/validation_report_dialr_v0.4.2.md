...
| export_help          | 26                             |
| has_website          | TRUE                           |
| has_maintainer       | Danny Smith <danny@gorcha.org> |
...
Overall the package has 26 exported objects. 26 are documented:
                        ...
                        check_cc                  get_carrier 
                            TRUE                         TRUE 
                          get_cc                  get_example 
                            TRUE                         TRUE 
                     get_geocode                   get_region 
                            TRUE                         TRUE 
     get_region_for_calling_code get_regions_for_calling_code 
                            TRUE                         TRUE 
           get_supported_regions          get_supported_types 
                            TRUE                         TRUE 
                    get_timezone                     get_type 
                            TRUE                         TRUE 
            get_types_for_region                     is_match 
                            TRUE                         TRUE 
                       is_parsed                  is_possible 
                            TRUE                         TRUE 
                        is_valid                     is.phone 
                            TRUE                         TRUE 
                      ph_example                    ph_format 
                            TRUE                         TRUE 
                     ph_possible                    ph_region 
                            TRUE                         TRUE 
                         ph_type                     ph_valid 
                            TRUE                         TRUE 
                           phone                phone_reparse 
...
| Execution Time | 2025-02-18 03:58:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bb469d11804_1739851128
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLWcvqB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dialr_v0.4.2-tikzDictionary"
