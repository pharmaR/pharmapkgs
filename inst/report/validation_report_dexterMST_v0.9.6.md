# Validation Report - dexterMST@0.9.6
...
| export_help          | 28                                 |
| has_website          | TRUE                               |
| has_maintainer       | Timo Bechger <tmbechger@gmail.com> |
...
|:----|:-------------------------------|:----------|
| 1   | Rcpp                           | Imports   |
| 2   | RcppArmadillo                  | Imports   |
| 3   | dexter (\>= 1.2.2)             | Imports   |
| 4   | dplyr                          | Imports   |
| 5   | RSQLite                        | Imports   |
| 6   | rlang                          | Imports   |
| 7   | igraph (\>= 1.2.1)             | Imports   |
| 8   | tidyr                          | Imports   |
| 9   | DBI                            | Imports   |
| 10  | crayon                         | Imports   |
| 11  | graphics                       | Imports   |
...
| 14  | utils                          | Imports   |
| 15  | Rcpp                           | LinkingTo |
| 16  | RcppArmadillo (\>= 0.12.6.6.0) | LinkingTo |
...
Overall the package has 28 exported objects. 28 are documented:
                      ...
                      ability            ability_tables           add_booklet_mst 
                         TRUE                      TRUE                      TRUE 
      add_item_properties_mst add_person_properties_mst     add_response_data_mst 
                         TRUE                      TRUE                      TRUE 
        add_scoring_rules_mst   alter_scoring_rules_mst         close_mst_project 
                         TRUE                      TRUE                      TRUE 
           create_mst_project           create_mst_test               design_plot 
                         TRUE                      TRUE                      TRUE 
                      DIF_mst             fit_enorm_mst             fit_inter_mst 
                         TRUE                      TRUE                      TRUE 
             get_booklets_mst            get_design_mst             get_items_mst 
                         TRUE                      TRUE                      TRUE 
              get_persons_mst         get_responses_mst     get_routing_rules_mst 
                         TRUE                      TRUE                      TRUE 
        get_scoring_rules_mst        import_from_dexter                 mst_rules 
                         TRUE                      TRUE                      TRUE 
             open_mst_project          plausible_values        profile_tables_mst 
                         TRUE                      TRUE                      TRUE 
                      sim_mst 
                         TRUE 
...
| Execution Time | 2025-02-18 03:52:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47530f65_1739850744
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcQirlV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dexterMST_v0.9.6-tikzDictionary"
