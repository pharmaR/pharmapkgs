...
Overall the package has 23 exported objects. 23 are documented:
        ...
        Calculate2StageSampleSize           CalculateGlobalSens 
                             TRUE                          TRUE 
               CalculateLocalSens            CalculatePopChange 
                             TRUE                          TRUE 
        CalculateSimpleSampleSize CalculateStratifiedSampleSize 
                             TRUE                          TRUE 
                     DesignSurvey                       FreqTab 
                             TRUE                          TRUE 
                      GetDataIASA                     MapkmlPSU 
                             TRUE                          TRUE 
                   PlotGlobalSens                PlotHHxSpecies 
                             TRUE                          TRUE 
              PlotImmigrationFlow                 PlotLocalSens 
                             TRUE                          TRUE 
                       PlotModels                PlotPopPyramid 
                             TRUE                          TRUE 
                        SamplePPS              SampleSystematic 
                             TRUE                          TRUE 
                        SetRanges                     SolveIASA 
                             TRUE                          TRUE 
                          SolveSI                       SolveTC 
...
| Execution Time | 2025-02-16 03:39:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bc318387297_1739677165
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSGW22d
...
These are the options set to generate the report:
    ...
    [1] "validation_report_capm_v0.14.0-tikzDictionary"
