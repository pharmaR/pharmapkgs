...
| export_help          | 35                                 |
| has_website          | TRUE                               |
| has_maintainer       | Qiushi Yan <qiushi.yann@gmail.com> |
| bugs_status          | subscript out of bounds            |
| size_codebase        | 2188                               |
| has_source_control   | https://github.com/tidymodels/agua |
...
| 3   | dials                | Imports |
| 4   | dplyr                | Imports |
| 5   | generics (\>= 0.1.3) | Imports |
| 6   | ggplot2              | Imports |
| 7   | glue                 | Imports |
| 8   | h2o (\>= 3.38.0.1)   | Imports |
| 9   | hardhat (\>= 1.1.0)  | Imports |
| 10  | methods              | Imports |
| 11  | pkgconfig            | Imports |
| 12  | purrr                | Imports |
| 13  | rlang                | Imports |
| 14  | rsample              | Imports |
| 15  | stats                | Imports |
| 16  | tibble               | Imports |
| 17  | tidyr                | Imports |
| 18  | tune (\>= 1.2.0)     | Imports |
| 19  | vctrs                | Imports |
| 20  | workflows            | Imports |
...
Overall the package has 35 exported objects. 34 are documented:

                           %>%       agua_backend_options 
                         FALSE                       TRUE 
                        as_h2o                  as_tibble 
                          TRUE                       TRUE 
                      autoplot            collect_metrics 
                          TRUE                       TRUE 
            extract_fit_engine        extract_fit_parsnip 
                          TRUE                       TRUE 
               get_leaderboard             h2o_activation 
                          TRUE                       TRUE 
                       h2o_end              h2o_get_frame 
                          TRUE                       TRUE 
                 h2o_get_model                h2o_predict 
                          TRUE                       TRUE 
    h2o_predict_classification     h2o_predict_regression 
                          TRUE                       TRUE 
                    h2o_remove             h2o_remove_all 
                          TRUE                       TRUE 
                   h2o_running                  h2o_split 
                          TRUE                       TRUE 
                     h2o_start                  h2o_train 
                          TRUE                       TRUE 
                h2o_train_auto              h2o_train_gbm 
                          TRUE                       TRUE 
                 h2o_train_glm              h2o_train_mlp 
                          TRUE                       TRUE 
                  h2o_train_nb               h2o_train_rf 
                          TRUE                       TRUE 
                h2o_train_rule          h2o_train_xgboost 
                          TRUE                       TRUE 
         h2o_xgboost_available             member_weights 
                          TRUE                       TRUE 
                  rank_results                      refit 
                          TRUE                       TRUE 
                          tidy 
...
| Execution Time | 2025-02-14 06:43:53 UTC |
...
running this report
    ...
    PROCESSX_PS726d3beb30a7_1739515431
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCLaoEJ
