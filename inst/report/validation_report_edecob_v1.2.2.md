# Validation Report - edecob@1.2.2
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Zheng Chen Man <zheng.chen.man@alumni.ethz.ch>       |
...
| 4   | utils (\>= 3.5.0)    | Imports |
| 5   | graphics (\>= 3.5.0) | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
       ...
       bt_smoother      conf_band   detect_event         edecob        mov_med 
...
| Execution Time | 2025-02-19 03:40:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d45259ff614_1739936406
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpV93igD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_edecob_v1.2.2-tikzDictionary"
