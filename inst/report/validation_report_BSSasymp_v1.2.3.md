# Validation Report - BSSasymp@1.2.3
...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Klaus Nordhausen <klaus.k.nordhausen@jyu.fi>         |
...
Overall the package has 21 exported objects. 21 are documented:
                   ...
                   alphas     ASCOV_FastICAdefl ASCOV_FastICAdefl_est 
                     TRUE                  TRUE                  TRUE 
         ASCOV_FastICAsym  ASCOV_FastICAsym_est     ASCOV_FastICAsym2 
                     TRUE                  TRUE                  TRUE 
    ASCOV_FastICAsym2_est            ASCOV_FOBI        ASCOV_FOBI_est 
                     TRUE                  TRUE                  TRUE 
               ASCOV_JADE        ASCOV_JADE_est            ASCOV_SOBI 
                     TRUE                  TRUE                  TRUE 
           ASCOV_SOBI_est       ASCOV_SOBI_estN        ASCOV_SOBIdefl 
                     TRUE                  TRUE                  TRUE 
       ASCOV_SOBIdefl_est   ASCOV_SOBIdefl_estN                 aSOBI 
                     TRUE                  TRUE                  TRUE 
                      CRB                 eSOBI              taus_def 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-15 04:50:47 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd796a186c_1739595042
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQRBUof
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BSSasymp_v1.2.3-tikzDictionary"
