# Validation Report - dbplot@0.3.3
...
| export_help          | 11                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Edgar Ruiz <edgararuiz@gmail.com>    |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/edgararuiz/dbplot |
...
Overall the package has 11 exported objects. 10 are documented:
                   ...
                   %>%             db_bin    db_compute_bins db_compute_boxplot 
                 FALSE               TRUE               TRUE               TRUE 
      db_compute_count  db_compute_raster db_compute_raster2         dbplot_bar 
                  TRUE               TRUE               TRUE               TRUE 
      dbplot_histogram        dbplot_line      dbplot_raster 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 05:07:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63189e9ba_1739768868
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwfPixp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dbplot_v0.3.3-tikzDictionary"
