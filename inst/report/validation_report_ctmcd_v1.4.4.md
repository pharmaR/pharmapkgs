...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Marius Pfeuffer <marius.pfeuffer@fau.de>             |
...
Overall the package has 23 exported objects. 23 are documented:
             ...
             ciEMBS         ciEMoFI         ciEMSdR            ciGS     ctmcdlogLik 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                 gm      gm.default            gmci    gmci.default            gmDA 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               gmEM            gmGS            gmQO            gmWA         plot.gm 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          plot.gmci           plotM        print.gm      print.gmci rNijTRiT_ModRej 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      rNijTRiT_Unif      summary.gm            tmci 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:34:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66c20b816_1739766853
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmprw8LRi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ctmcd_v1.4.4-tikzDictionary"
