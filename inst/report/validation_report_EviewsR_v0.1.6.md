# Validation Report - EviewsR@0.1.6
...
| export_help          | 19                                 |
| has_website          | TRUE                               |
| has_maintainer       | Sagiru Mati <sagirumati@gmail.com> |
...
Overall the package has 19 exported objects. 19 are documented:
       ...
       create_object       eng_eviews     eviews_graph    eviews_import 
                TRUE             TRUE             TRUE             TRUE 
     eviews_pagesave  eviews_wfcreate    eviews_wfsave    exec_commands 
                TRUE             TRUE             TRUE             TRUE 
              export export_dataframe           import  import_equation 
                TRUE             TRUE             TRUE             TRUE 
        import_graph     import_kable    import_series     import_table 
                TRUE             TRUE             TRUE             TRUE 
     import_workfile            rwalk  set_eviews_path 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 04:41:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d45359f98d0_1739940110
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjZmpoS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EviewsR_v0.1.6-tikzDictionary"
