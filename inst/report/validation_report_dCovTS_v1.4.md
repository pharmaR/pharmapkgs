...
Overall the package has 11 exported objects. 10 are documented:
    ...
    .onAttach      ADCF  ADCFplot      ADCV kernelFun     mADCF mADCFplot mADCFtest 
        FALSE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
        mADCV mADCVtest  UnivTest 
         TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-17 05:11:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6385510bb_1739769091
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpng2vRX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dCovTS_v1.4-tikzDictionary"
