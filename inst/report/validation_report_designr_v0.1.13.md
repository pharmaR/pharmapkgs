# Validation Report - designr@0.1.13
...
| export_help          | 25                                                  |
| has_website          | TRUE                                                |
| has_maintainer       | Maximilian M. Rabe <maximilian.rabe@uni-potsdam.de> |
...
Overall the package has 21 exported objects. 22 are documented:

          contrast.names         design.codes     design.contrasts 
                    TRUE                 TRUE                 TRUE 
          design.formula         design.units        factor.design 
                    TRUE                 TRUE                 TRUE 
            fixed.factor        fixed.factors      is.designFactor 
                    TRUE                 TRUE                 TRUE 
         is.factorDesign       is.fixedFactor      is.randomFactor 
                    TRUE                 TRUE                 TRUE 
           output.design        random.factor       random.factors 
                    TRUE                 TRUE                 TRUE 
    show.factorContainer               simLMM         write.design 
                    TRUE                 TRUE                 TRUE 
        write.design.csv    write.design.json    write.design.xlsx 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-18 03:48:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bb430237dbb_1739850501
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpgayjxp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_designr_v0.1.13-tikzDictionary"
