# Validation Report - cyclomort@1.0.2
...
| export_help          | 17                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Eliezer Gurarie <egurarie@umd.edu>      |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/EliGurarie/cyclomort |
...
Overall the package has 17 exported objects. 17 are documented:
            ...
            censor_cycloSurv         create_cycloSurv               DeltaToRho 
                        TRUE                     TRUE                     TRUE 
         factorfit_cyclomort                findDelta                  findRho 
                        TRUE                     TRUE                     TRUE 
               fit_cyclomort guess_initial_parameters                     imwc 
                        TRUE                     TRUE                     TRUE 
                         iwc                  loglike            loglike_optim 
                        TRUE                     TRUE                     TRUE 
                         mwc           select_seasons       simulate_cycloSurv 
                        TRUE                     TRUE                     TRUE 
              trim_cycloSurv                       wc 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-17 04:46:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67f3626ba_1739767572
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsozZET
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cyclomort_v1.0.2-tikzDictionary"
