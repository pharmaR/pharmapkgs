# Validation Report - biosensors.usc@1.0
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Juan C. Vidal <juan.vidal@usc.es>                    |
...
| 6   | energy        | Imports   |
| 7   | fda.usc       | Imports   |
| 8   | parallelDist  | Imports   |
| 9   | osqp          | Imports   |
| 10  | truncnorm     | Imports   |
| 11  | Rcpp          | LinkingTo |
...
Overall the package has 10 exported objects. 10 are documented:
               ...
               clustering clustering_prediction         generate_data 
                     TRUE                  TRUE                  TRUE 
       hypothesis_testing             load_data   nadayara_prediction 
                     TRUE                  TRUE                  TRUE 
      nadayara_regression     regmod_prediction     regmod_regression 
                     TRUE                  TRUE                  TRUE 
         ridge_regression 
                     TRUE 
...
| Execution Time | 2025-02-15 04:14:59 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdf8fba0d_1739592894
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDDTRN6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biosensors.usc_v1.0-tikzDictionary"
