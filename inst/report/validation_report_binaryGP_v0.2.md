# Validation Report - binaryGP@0.2
...
| export_help          | 2                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Chih-Li Sung <iamdfchile@gmail.com>                  |
...
| 2   | lhs (\>= 0.10)         | Imports   |
| 3   | logitnorm (\>= 0.8.29) | Imports   |
| 4   | nloptr (\>= 1.0.4)     | Imports   |
| 5   | GPfit (\>= 1.0-0)      | Imports   |
| 6   | stats                  | Imports   |
| 7   | graphics               | Imports   |
| 8   | utils                  | Imports   |
| 9   | methods                | Imports   |
...
| Execution Time | 2025-02-15 04:07:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd67c9daf_1739592457
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpboqkNc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binaryGP_v0.2-tikzDictionary"
