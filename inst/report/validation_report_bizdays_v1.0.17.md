# Validation Report - bizdays@1.0.17
...
| export_help          | 27                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Wilson Freitas <wilson.freitas@gmail.com>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/wilsonfreitas/R-bizdays           |
...
Overall the package has 27 exported objects. 27 are documented:
                ...
                add.bizdays             adjust.next             adjust.none 
                       TRUE                    TRUE                    TRUE 
            adjust.previous                 bizdays         bizdays.options 
                       TRUE                    TRUE                    TRUE 
                   bizdayse                 bizdiff                  bizseq 
                       TRUE                    TRUE                    TRUE 
                  calendars         create.calendar               following 
                       TRUE                    TRUE                    TRUE 
                 getbizdays                 getdate           has_calendars 
                       TRUE                    TRUE                    TRUE 
                   holidays               is.bizday  load_builtin_calendars 
                       TRUE                    TRUE                    TRUE 
              load_calendar load_quantlib_calendars load_rmetrics_calendars 
                       TRUE                    TRUE                    TRUE 
         modified.following      modified.preceding                  offset 
                       TRUE                    TRUE                    TRUE 
                  preceding        remove_calendars           save_calendar 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-15 04:20:13 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd35b9551f_1739593208
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKAdSMt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bizdays_v1.0.17-tikzDictionary"
