...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ai-bing ZHANG <Zhangab2008@mail.cnu.edu.cn>          |
...
Overall the package has 18 exported objects. 18 are documented:
              ...
              barcodes.eval           barcoding.gap  barcoding.spe.identify 
                       TRUE                    TRUE                    TRUE 
    barcoding.spe.identify2                   bbsik          char2NumVector 
                       TRUE                    TRUE                    TRUE 
      compare2delimitations      consensus.identify            digitize.DNA 
                       TRUE                    TRUE                    TRUE 
      DNAbin2kmerFreqMatrix                     FMF              FMFtheta12 
                       TRUE                    TRUE                    TRUE 
                      NAMES           optimize.kmer              sample.ref 
                       TRUE                    TRUE                    TRUE 
                   save.ids           summarize.ref                    TDR2 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 07:42:48 UTC |
...
running this report
    ...
    PROCESSX_PS1c0953e6df2c_1739518965
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsTnshC
