# Validation Report - cmfrec@3.5.1.3
...
| export_help          | 18                                           |
| has_website          | TRUE                                         |
| has_maintainer       | David Cortes <david.cortes.rivera@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/david-cortes/cmfrec       |
...
Overall the package has 18 exported objects. 18 are documented:
                           ...
                           CMF               CMF_implicit 
                          TRUE                       TRUE 
       CMF.from.model.matrices               ContentBased 
                          TRUE                       TRUE 
    drop.nonessential.matrices                    factors 
                          TRUE                       TRUE 
                factors_single                    imputeX 
                          TRUE                       TRUE 
                  item_factors                MostPopular 
                          TRUE                       TRUE 
                  OMF_explicit               OMF_implicit 
                          TRUE                       TRUE 
    precompute.for.predictions                predict_new 
                          TRUE                       TRUE 
             predict_new_items       swap.users.and.items 
                          TRUE                       TRUE 
                          topN                   topN_new 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-16 04:44:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3616e516b_1739681037
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppWdEln
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmfrec_v3.5.1.3-tikzDictionary"
