# Validation Report - distrDoc@2.8.5
...
|:----|:----------------------|:--------|
| 1   | R(\>= 3.4)            | Depends |
| 2   | distr(\>= 2.2.0)      | Imports |
| 3   | distrEx(\>= 2.2.0)    | Imports |
| 4   | distrSim(\>= 2.2.0)   | Imports |
| 5   | distrTEst(\>= 2.2.0)  | Imports |
| 6   | distrTeach(\>= 2.2.0) | Imports |
| 7   | RandVar(\>= 0.7)      | Imports |
| 8   | distrMod(\>= 2.2.0)   | Imports |
| 9   | MASS                  | Imports |
| 10  | methods               | Imports |
| 11  | startupmsg(\>= 1.0.0) | Imports |
...
| Execution Time | 2025-02-18 04:19:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bb459eead57_1739852361
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsIoyFE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distrDoc_v2.8.5-tikzDictionary"
