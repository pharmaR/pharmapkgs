# Validation Report - DirectEffects@0.3
...
Overall the package has 19 exported objects. 19 are documented:
          ...
          balance_table      balance.tmatch             boots_g            boots_tm 
                   TRUE                TRUE                TRUE                TRUE 
               cde_aipw        cde_did_aipw             cde_ipw      cde_reg_impute 
                   TRUE                TRUE                TRUE                TRUE 
    cde_telescope_match             cdesens            estimate              glance 
                   TRUE                TRUE                TRUE                TRUE 
           outreg_model     plotDiag.tmatch        sequential_g       set_treatment 
                   TRUE                TRUE                TRUE                TRUE 
        telescope_match                tidy         treat_model 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 04:09:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46d4d8159_1739851753
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpInpuKt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DirectEffects_v0.3-tikzDictionary"
