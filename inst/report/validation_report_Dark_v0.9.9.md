...
| export_help          | 14                                  |
| has_website          | TRUE                                |
| has_maintainer       | Jeremiah MF Kelly <emkayoh@mac.com> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/emkayoh/Dark     |
...
Overall the package has 14 exported objects. 14 are documented:
           ...
           AICc     BestFit    BootDark   Declutter     GetData           H 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
    ModelSelect  MultiStart          P3         P5c         P6c         P7c 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
          Start    TestData 
           TRUE        TRUE 
...
| Execution Time | 2025-02-17 04:54:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bd620ac8d37_1739768054
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwRUD4F
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Dark_v0.9.9-tikzDictionary"
