# Validation Report - drugsens@0.1.0
...
| export_help | 8 |
| has_website | TRUE |
| has_maintainer | Flavio Lombardo <flavio.lombardo@unibas.ch> |
| bugs_status | scraping bug reports fromm BugReports host ‘unibas’ not implemented |
...
Overall the package has 8 exported objects. 8 are documented:
       ...
       change_data_format_to_longer                    data_binding 
                               TRUE                            TRUE 
             generate_qupath_script                    get_QC_plots 
                               TRUE                            TRUE 
    get_QC_plots_parsed_merged_data            make_count_dataframe 
                               TRUE                            TRUE 
                    make_run_config                  string_parsing 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-18 04:48:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41cfa1e97_1739854123
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZiYSDt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drugsens_v0.1.0-tikzDictionary"
