...
| export_help          | 46                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Thomas Hegghammer <hegghammer@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/Hegghammer/daiR       |
...
Overall the package has 46 exported objects. 46 are documented:
                   ...
                   .onAttach           build_block_df           build_token_df 
                        TRUE                     TRUE                     TRUE 
            create_processor                dai_async            dai_async_tab 
                        TRUE                     TRUE                     TRUE 
                    dai_auth               dai_notify               dai_status 
                        TRUE                     TRUE                     TRUE 
                    dai_sync             dai_sync_tab                dai_token 
                        TRUE                     TRUE                     TRUE 
                    dai_user         delete_processor        disable_processor 
                        TRUE                     TRUE                     TRUE 
                 draw_blocks            draw_entities               draw_lines 
                        TRUE                     TRUE                     TRUE 
             draw_paragraphs              draw_tokens         enable_processor 
                        TRUE                     TRUE                     TRUE 
                from_labelme             get_entities       get_processor_info 
                        TRUE                     TRUE                     TRUE 
      get_processor_versions           get_processors           get_project_id 
                        TRUE                     TRUE                     TRUE 
                  get_tables                 get_text             image_to_pdf 
                        TRUE                     TRUE                     TRUE 
              img_to_binbase                is_colour                  is_json 
                        TRUE                     TRUE                     TRUE 
                      is_pdf     list_processor_types                make_hocr 
                        TRUE                     TRUE                     TRUE 
                merge_shards           pdf_to_binbase          reassign_tokens 
                        TRUE                     TRUE                     TRUE 
            reassign_tokens2            redraw_blocks              split_block 
                        TRUE                     TRUE                     TRUE 
        tables_from_dai_file tables_from_dai_response       text_from_dai_file 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-17 04:51:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61d14e5d3_1739767890
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpx6XtgJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_daiR_v1.0.1-tikzDictionary"
