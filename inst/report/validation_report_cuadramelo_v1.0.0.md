# Validation Report - cuadramelo@1.0.0
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Miguel Serrano <miguel.serrano.martin@ine.es>        |
...
Overall the package has 7 exported objects. 7 are documented:
       ...
       apply_by_block balance_by_blocks    balance_matrix make_non_negative 
                 TRUE              TRUE              TRUE              TRUE 
      round_by_blocks      round_matrix      round_vector 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:37:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64b96b887_1739767020
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZXPGtD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cuadramelo_v1.0.0-tikzDictionary"
