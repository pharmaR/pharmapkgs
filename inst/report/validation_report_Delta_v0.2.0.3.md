# Validation Report - Delta@0.2.0.3
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Antonio Rodriguez <tonirodriguezcontesti@gmail.com>  |
...
Overall the package has 16 exported objects. 16 are documented:
             ...
             CheckInput      CheckInputData       CheckSampling               Delta 
                   TRUE                TRUE                TRUE                TRUE 
     GetAsinDeltaParams                GetB       GetCovariance      GetDeltaParams 
                   TRUE                TRUE                TRUE                TRUE 
      GetDeltaParamsVar          GetDeltaPi GetDeltaProblemType         GetGoodness 
                   TRUE                TRUE                TRUE                TRUE 
               GetKappa GetKappaProblemType               GetM1               GetMx 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 03:38:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46b7c13de_1739849904
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpk1qPb4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Delta_v0.2.0.3-tikzDictionary"
