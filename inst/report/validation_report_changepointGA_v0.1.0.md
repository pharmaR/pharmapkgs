# Validation Report - changepointGA@0.1.0
...
| export_help          | 16                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Mo Li <mo.li@louisiana.edu>             |
| has_source_control   | https://github.com/mli171/changepointGA |
...
Overall the package has 16 exported objects. 16 are documented:
           ...
           AMOCcrossover         AMOCmutation       AMOCpopulation 
                    TRUE                 TRUE                 TRUE 
           AMOCselection      ARIMA.BIC.Order        BinSearch.BIC 
                    TRUE                 TRUE                 TRUE 
                 cptDist                   GA             IslandGA 
                    TRUE                 TRUE                 TRUE 
                mutation    random_population selection_linearrank 
                    TRUE                 TRUE                 TRUE 
               selectTau               ts.sim          TsPlotCheck 
                    TRUE                 TRUE                 TRUE 
        uniformcrossover 
                    TRUE 
...
| Execution Time | 2025-02-18 03:28:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47b81159a_1739849291
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFRMIQW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_changepointGA_v0.1.0-tikzDictionary"
