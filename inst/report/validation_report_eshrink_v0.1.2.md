# Validation Report - eshrink@0.1.2
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Joshua Keller <joshua.keller@colostate.edu>          |
...
Overall the package has 11 exported objects. 11 are documented:
          ...
          biasRidge   check_CIbound        estRidge       festLASSO       festRidge 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         invertTest        mseRidge samplePosterior        simLASSO        varRidge 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      vcovfestRidge 
               TRUE 
...
| Execution Time | 2025-02-19 04:30:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d45744b621_1739939403
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHhScr5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eshrink_v0.1.2-tikzDictionary"
