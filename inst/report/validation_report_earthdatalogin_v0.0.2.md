# Validation Report - earthdatalogin@0.0.2
...
| has_source_control   | https://github.com/boettiger-lab/earthdatalogin |
...
Overall the package has 13 exported objects. 13 are documented:
              ...
              edl_as_s3        edl_download           edl_netrc    edl_revoke_token 
                   TRUE                TRUE                TRUE                TRUE 
           edl_s3_token       edl_set_token     edl_unset_netrc        edl_unset_s3 
                   TRUE                TRUE                TRUE                TRUE 
        edl_unset_token   gdal_cloud_config gdal_cloud_unconfig  lpdacc_example_url 
                   TRUE                TRUE                TRUE                TRUE 
         with_gdalcubes 
                   TRUE 
...
| Execution Time | 2025-02-18 05:09:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42dd841db_1739855365
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpgk1iEJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_earthdatalogin_v0.0.2-tikzDictionary"
