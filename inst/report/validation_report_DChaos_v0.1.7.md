# Validation Report - DChaos@0.1.7
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Julio E. Sandubete <jsandube@ucm.es>                 |
...
Overall the package has 11 exported objects. 11 are documented:
        ...
        embedding     gauss.sim     henon.sim  jacobian.net  logistic.sim 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         lyapunov  lyapunov.max lyapunov.spec        netfit   rossler.sim 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           w0.net 
             TRUE 
...
| Execution Time | 2025-02-17 05:09:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61e423194_1739768989
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeEeChD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DChaos_v0.1.7-tikzDictionary"
