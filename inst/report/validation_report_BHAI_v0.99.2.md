...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Benedikt Zacher <ZacherB@rki.de>                     |
...
Overall the package has 7 exported objects. 7 are documented:
                ...
                bhai     bhai.barplot  bhai.circleplot bhai.prettyTable 
                TRUE             TRUE             TRUE             TRUE 
     bhai.strataplot              PPS       sample.pps 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 03:59:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd70e74b9d_1739591983
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgpnRYJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BHAI_v0.99.2-tikzDictionary"
