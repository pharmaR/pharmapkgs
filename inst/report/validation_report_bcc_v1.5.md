...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel Cerqueira <danielcerqueira@live.com>          |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    apply_shewhart_rules                  bcc     calculate_limits 
                    TRUE                 TRUE                 TRUE 
      plot_control_chart 
                    TRUE 
...
| Execution Time | 2025-02-15 03:45:07 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd21873731_1739591102
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprWV8ZA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bcc_v1.5-tikzDictionary"
