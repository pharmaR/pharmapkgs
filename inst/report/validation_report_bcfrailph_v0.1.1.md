# Validation Report - bcfrailph@0.1.1
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Mesfin Tsegaye <mesfin.tsegaye@ddu.edu.et>           |
...
Overall the package has 7 exported objects. 7 are documented:
            ...
            bcfrailph bcfrailph.control   fitbccv.gammasp    fitbccv.lognsp 
                 TRUE              TRUE              TRUE              TRUE 
             shrgamsp      simbcfrailph        simstdybcf 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 03:46:04 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4f33faa0_1739591159
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbQwyBy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bcfrailph_v0.1.1-tikzDictionary"
