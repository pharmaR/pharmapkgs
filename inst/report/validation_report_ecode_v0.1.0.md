...
| export_help          | 25                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Haoran Wu <haoran.wu@wolfson.ox.ac.uk> |
| bugs_status          | 0.5                                    |
| has_source_control   | https://github.com/HaoranPopEvo/ecode  |
...
Overall the package has 25 exported objects. 25 are documented:
                     ...
                     eode       eode_get_cripoi       eode_get_sysmat 
                     TRUE                  TRUE                  TRUE 
        eode_get_velocity       eode_gridSearch        eode_is_centre 
                     TRUE                  TRUE                  TRUE 
           eode_is_saddle        eode_is_stafoc        eode_is_stanod 
                     TRUE                  TRUE                  TRUE 
           eode_is_stapoi        eode_is_unsfoc        eode_is_unsnod 
                     TRUE                  TRUE                  TRUE 
         eode_is_validval            eode_lossf             eode_proj 
                     TRUE                  TRUE                  TRUE 
    eode_sensitivity_proj   eode_set_constraint    eode_set_parameter 
                     TRUE                  TRUE                  TRUE 
       eode_simuAnnealing   eode_stability_type         pc_calculator 
                     TRUE                  TRUE                  TRUE 
                  pc_plot                 pdata                 pdist 
                     TRUE                  TRUE                  TRUE 
                       pp 
...
| Execution Time | 2025-02-19 03:33:59 UTC |
...
running this report
    ...
    PROCESSX_PS1d457c3cd37c_1739936033
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaxGaHl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecode_v0.1.0-tikzDictionary"
