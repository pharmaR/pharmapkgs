...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alex Hubbard <hubbard.alex@gmail.com>                |
...
Overall the package has 12 exported objects. 12 are documented:
         ...
         stsm_detect_anomalies         stsm_detect_breaks 
                          TRUE                       TRUE 
             stsm_detect_cycle      stsm_detect_frequency 
                          TRUE                       TRUE 
    stsm_detect_multiplicative    stsm_detect_seasonality 
                          TRUE                       TRUE 
             stsm_detect_trend              stsm_estimate 
                          TRUE                       TRUE 
                   stsm_filter              stsm_forecast 
                          TRUE                       TRUE 
                    stsm_prior                   stsm_ssm 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-14 07:35:00 UTC |
...
running this report
    ...
    PROCESSX_PS1c09188545cd_1739518496
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6XZQAh
