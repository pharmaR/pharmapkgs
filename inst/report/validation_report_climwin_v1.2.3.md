# Validation Report - climwin@1.2.3
...
| export_help          | 20                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Liam D. Bailey <liam.bailey@liamdbailey.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/LiamDBailey/climwin       |
| has_bug_reports_url  | 1                                            |
| downloads_1yr        | 3970                                         |
| reverse_dependencies | 0                                            |
| has_examples         | 0.6451613                                    |
| dependencies         | 11                                           |
| license              | GPL-2                                        |
...
Overall the package has 20 exported objects. 20 are documented:
          ...
          autowin      crosswin       explore        medwin merge_results 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          plotall      plotbest     plotbetas       plotcor     plotdelta 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         plothist   plotweights       plotwin        pvalue       randwin 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        singlewin    slidingwin     weightwin         wgdev        wgmean 
             TRUE          TRUE          TRUE          TRUE          TRUE 

### Examples

There are 20 help pages with examples, from 31 (64.52 %).
...
| Execution Time | 2025-02-16 04:32:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3336fd85e_1739680323
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaU85Cl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_climwin_v1.2.3-tikzDictionary"
