# Validation Report - eeptools@1.2.5
...
| export_help          | 25                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Jared E. Knowles <jared@civilytics.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/jknowles/eeptools    |
...
Overall the package has 25 exported objects. 25 are documented:
            ...
            age_calc         cleanTex     crosstabplot        crosstabs 
                TRUE             TRUE             TRUE             TRUE 
              cutoff          decomma            defac        gelmansim 
                TRUE             TRUE             TRUE             TRUE 
                isid         lag_data     leading_zero          makenum 
                TRUE             TRUE             TRUE             TRUE 
             max_mis       moves_calc          nth_max         profpoly 
                TRUE             TRUE             TRUE             TRUE 
       profpoly.data      remove_char    retained_calc        statamode 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 03:45:21 UTC |
...
running this report
    ...
    PROCESSX_PS1d4563daf6c7_1739936715
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpsfzj05
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eeptools_v1.2.5-tikzDictionary"
