# Validation Report - diseasemapping@2.0.6
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Patrick Brown <patrick.brown@utoronto.ca>            |
...
Overall the package has 10 exported objects. 10 are documented:
                 ...
                 bym      cancerRates      formatCases formatPopulation 
                TRUE             TRUE             TRUE             TRUE 
           getBreaks         getRates           getSMR       getStdRate 
                TRUE             TRUE             TRUE             TRUE 
         inla.models    nbToInlaGraph 
                TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:14:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4779c3a55_1739852087
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCbRAnd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diseasemapping_v2.0.6-tikzDictionary"
