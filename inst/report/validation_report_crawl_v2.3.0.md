...
Overall the package has 22 exported objects. 21 are documented:
                 ...
                 %>%          aic.crw    argosDiag2Cov          as.flat 
               FALSE             TRUE             TRUE             TRUE 
           crw_as_sf    crw_as_tibble           crwMLE          crwN2ll 
                TRUE             TRUE             TRUE             TRUE 
           crwPostIS       crwPredict   crwPredictPlot     crwSamplePar 
                TRUE             TRUE             TRUE             TRUE 
        crwSimulator detect_timescale       displayPar       expandPred 
                TRUE             TRUE             TRUE             TRUE 
            fillCols         fix_path          flatten       intToPOSIX 
                TRUE             TRUE             TRUE             TRUE 
      mergeTrackStop      tidy_crwFit 
                TRUE             TRUE 

### Examples

There are 23 help pages with examples, from 27 (85.19 %).
...
| Execution Time | 2025-02-17 04:18:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65b8b838a_1739765877
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFlTjSN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crawl_v2.3.0-tikzDictionary"
