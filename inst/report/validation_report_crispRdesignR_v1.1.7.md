# Validation Report - crispRdesignR@1.1.7
...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Dylan Beeber <dylan.beeber@gmail.com>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | <https://github.com/dylanbeeber/crispRdesignR>       |
...
| 4   | BiocGenerics  | Imports |
| 5   | IRanges       | Imports |
| 6   | GenomeInfoDb  | Imports |
| 7   | S4Vectors     | Imports |
| 8   | rtracklayer   | Imports |
| 9   | stringr       | Imports |
| 10  | vtreat        | Imports |
| 11  | shiny         | Imports |
| 12  | DT            | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
           ...
           crispRdesignRUI Doench_2016_processing       getofftargetdata 
                      TRUE                   TRUE                   TRUE 
              getsgRNAdata           sgRNA_design  sgRNA_design_function 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-17 04:20:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bd679888a9a_1739766053
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplMhIWW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crispRdesignR_v1.1.7-tikzDictionary"
