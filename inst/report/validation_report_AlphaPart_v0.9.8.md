...
| export_help          | 27                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Gregor Gorjanc <highlander.research.lab@gmail.com>   |
...
|     | package                | type      |
|:----|:-----------------------|:----------|
| 1   | directlabels (\>= 1.1) | Imports   |
| 2   | ggplot2 (\>= 0.8.9)    | Imports   |
| 3   | pedigree (\>= 1.3.1)   | Imports   |
| 4   | Rcpp (\>= 0.9.4)       | Imports   |
| 5   | methods (\>= 3.6.2)    | Imports   |
| 6   | reshape                | Imports   |
| 7   | dplyr                  | Imports   |
| 8   | magrittr               | Imports   |
| 9   | tibble (\>= 3.1.7)     | Imports   |
| 10  | Rcpp                   | LinkingTo |
...
Overall the package has 27 exported objects. 27 are documented:
        ...
        .checkLevelsMap .checkListLevelsMap     .isCharacterMap        .unknownList 
                   TRUE                TRUE                TRUE                TRUE 
       .unlistLevelsMap           AlphaPart     AlphaPartSubset        AlphaPartSum 
                   TRUE                TRUE                TRUE                TRUE 
           as.levelsMap    as.listLevelsMap     as.object_sizes           centerPop 
                   TRUE                TRUE                TRUE                TRUE 
               getScale        is.levelsMap    is.listLevelsMap     is.object_sizes 
                   TRUE                TRUE                TRUE                TRUE 
              isUnknown           mapLevels         mapLevels<-         NAToUnknown 
                   TRUE                TRUE                TRUE                TRUE 
            object.size     pedFixBirthYear          pedSetBase            savePlot 
                   TRUE                TRUE                TRUE                TRUE 
                   sEBV         unknownToNA           write.csv 
                   TRUE                TRUE                TRUE 

### Examples

There are 16 help pages with examples, from 19 (84.21 %).
...
| Execution Time | 2025-02-14 06:49:58 UTC |
...
running this report
    ...
    PROCESSX_PS726d3af73615_1739515795
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLBhRpe
