...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Nicolas Schmidt <nschmidt@cienciassociales.edu.uy>   |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/Nicolas-Schmidt/esaps             |
...
| 4   | readODS (\>= 1.6.4) | Imports |
| 5   | readxl (\>= 1.0.0)  | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    convert_esaps        dispro           enp        evolat          psns 
...
| Execution Time | 2025-02-19 04:28:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d451db1a24e_1739939313
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppnINxf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_esaps_v0.2.2-tikzDictionary"
