# Validation Report - emdbook@1.3.13
...
airpart, apeglm, bbmle, BEDASSLE, epiphy, fitteR, landmulti, metaGE,
methylKit, scShapes, SNSequate, spikes

## Namespace

Overall the package has 31 exported objects. 31 are documented:

                 apply2d         as.mcmc.bugs          axis.scinot 
                    TRUE                 TRUE                 TRUE 
               calcslice            contour3d              curve3d 
                    TRUE                 TRUE                 TRUE 
              dbetabinom            dchibarsq          deltamethod 
                    TRUE                 TRUE                 TRUE 
                deltavar              dmvnorm            dzinbinom 
                    TRUE                 TRUE                 TRUE 
    get.emdbook.packages         gridsearch2d        HPDregionplot 
                    TRUE                 TRUE                 TRUE 
                lambertW        lambertW_base                 lseq 
                    TRUE                 TRUE                 TRUE 
          lump.mcmc.list              lWasymp             metropSB 
                    TRUE                 TRUE                 TRUE 
                ncredint            pchibarsq       perturb.params 
                    TRUE                 TRUE                 TRUE 
               qchibarsq           rbetabinom            rchibarsq 
                    TRUE                 TRUE                 TRUE 
               rzinbinom               scinot             tcredint 
                    TRUE                 TRUE                 TRUE 
                  trcoef 
                    TRUE 
...
There are 28 help pages with examples, from 30 (93.33 %).
...
| Execution Time | 2025-02-19 04:00:48 UTC |
...
running this report
    ...
    PROCESSX_PS1d456f3ed9f4_1739937642
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBqNO4B
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emdbook_v1.3.13-tikzDictionary"
