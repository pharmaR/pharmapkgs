# Validation Report - CalcThemAll.PRM@1.1.1
...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alexander Bezzina <alex.h.bezzina@gmail.com>         |
...
Overall the package has 22 exported objects. 21 are documented:
                                ...
                                FALSE                              TRUE 
                Burr_Type_III_Formula       calculate_daily_average_PRM 
                                 TRUE                              TRUE 
     calculate_wet_season_average_PRM                find_Sampling_Year 
                                 TRUE                              TRUE 
                          find_season               find_wet_season_end 
                                 TRUE                              TRUE 
                        Gamma_Formula                   imputation_beta 
                                 TRUE                              TRUE 
                    imputation_kernel           Inverse_Weibull_Formula 
                                 TRUE                              TRUE 
                   Log_Gumbel_Formula              Log_Logistic_Formula 
                                 TRUE                              TRUE 
    Log_Logistic_Log_Logistic_Formula                Log_Normal_Formula 
                                 TRUE                              TRUE 
        Log_Normal_Log_Normal_Formula                    plot_daily_PRM 
                                 TRUE                              TRUE 
               plot_wet_season_window                            PRM_DT 
                                 TRUE                              TRUE 
                           treat_LORs               treat_LORs_all_data 
                                 TRUE                              TRUE 
...
| Execution Time | 2025-02-16 03:34:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3582b4bb1_1739676838
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0BU7vx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CalcThemAll.PRM_v1.1.1-tikzDictionary"
