...
| has_source_control   | https://github.com/r-lib/brio         |
| has_bug_reports_url  | 1                                     |
| downloads_1yr        | 4874077                               |
...
bigrquery, cpp11, dm, downlit, duckplyr, faers, fledge, naryn, osfr,
pikchr, rdhs, rextendr, roxygen2md, roxyglobals, shinylive, terrainr,
testthat, tibble, typetracer, xmpdf

## Namespace

Overall the package has 9 exported objects. 9 are documented:

    file_line_endings         read_file     read_file_raw        read_lines 
                 TRUE              TRUE              TRUE              TRUE 
            readLines        write_file    write_file_raw       write_lines 
                 TRUE              TRUE              TRUE              TRUE 
           writeLines 
                 TRUE 
...
| Execution Time | 2025-02-15 04:44:51 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7f89f147_1739594686
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpo7tdcr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brio_v1.1.5-tikzDictionary"
