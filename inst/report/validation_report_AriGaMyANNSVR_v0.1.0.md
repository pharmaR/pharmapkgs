...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Mr. Sandip Garai <sandipnicksandy@gmail.com>         |
...
|     | package    | type    |
|:----|:-----------|:--------|
| 1   | AllMetrics | Imports |
| 2   | DescribeDF | Imports |
| 3   | stats      | Imports |
| 4   | dplyr      | Imports |
| 5   | psych      | Imports |
| 6   | FinTS      | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
                  ...
                  ariga              my_ann              my_svr     series_descstat 
                   TRUE                TRUE                TRUE                TRUE 
    series_nonlinearity series_stationarity 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-14 07:23:49 UTC |
...
running this report
    ...
    PROCESSX_PS1c0961e45543_1739517826
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDWXTXE
