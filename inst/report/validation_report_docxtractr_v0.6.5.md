# Validation Report - docxtractr@0.6.5
...
| export_help          | 14                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Bob Rudis <bob@rud.is>                |
| bugs_status          | 0.6875                                |
| has_source_control   | http://gitlab.com/hrbrmstr/docxtractr |
...
Overall the package has 14 exported objects. 13 are documented:
                       ...
                       %>%        assign_colnames         convert_to_pdf 
                     FALSE                   TRUE                   TRUE 
           docx_cmnt_count    docx_describe_cmnts     docx_describe_tbls 
                      TRUE                   TRUE                   TRUE 
          docx_extract_all docx_extract_all_cmnts  docx_extract_all_tbls 
                      TRUE                   TRUE                   TRUE 
          docx_extract_tbl         docx_tbl_count                   mcga 
                      TRUE                   TRUE                   TRUE 
                 read_docx   set_libreoffice_path 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:32:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42785e2f5_1739853125
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5786LF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_docxtractr_v0.6.5-tikzDictionary"
