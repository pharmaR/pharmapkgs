# Validation Report - EWSmethods@1.3.1
...
| export_help          | 23                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Duncan O’Brien <duncan.a.obrien@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/duncanobrien/EWSmethods |
...
Overall the package has 23 exported objects. 23 are documented:
             ...
             conda_clean default_weights_path          deseason_ts 
                    TRUE                 TRUE                 TRUE 
              detrend_ts             embed_ts      ewsnet_finetune 
                    TRUE                 TRUE                 TRUE 
             ewsnet_init       ewsnet_predict         ewsnet_reset 
                    TRUE                 TRUE                 TRUE 
                      FI                   II       imbalance_gain 
                    TRUE                 TRUE                 TRUE 
     multi_smap_jacobian              multiAR             multiEWS 
                    TRUE                 TRUE                 TRUE 
                 multiJI                  mvi         perm_rollEWS 
                    TRUE                 TRUE                 TRUE 
                  tuneII    uni_smap_jacobian                uniAR 
                    TRUE                 TRUE                 TRUE 
                  uniEWS                uniJI 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:45:21 UTC |
...
running this report
    ...
    PROCESSX_PS1d457f396336_1739940314
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpc9Ykeh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EWSmethods_v1.3.1-tikzDictionary"
