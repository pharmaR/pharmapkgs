# Validation Report - Bestie@0.1.5
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jack Kuipers <jack.kuipers@bsse.ethz.ch>             |
...
|     | package             | type      |
|:----|:--------------------|:----------|
| 1   | BiDAG (\>= 2.0.0)   | Imports   |
| 2   | Rcpp (\>= 1.0.3)    | Imports   |
| 3   | mvtnorm (\>= 1.1.0) | Imports   |
| 4   | Rcpp                | LinkingTo |
...
Overall the package has 3 exported objects. 3 are documented:
      ...
      DAGintervention DAGinterventionMC     DAGparameters 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 03:54:35 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2af03210_1739591671
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8aA9vW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Bestie_v0.1.5-tikzDictionary"
