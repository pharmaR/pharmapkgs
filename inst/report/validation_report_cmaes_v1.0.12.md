# Validation Report - cmaes@1.0.12
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Olaf Mersmann <olafm@statistik.tu-dortmund.de>       |
...
calibrar, cops, foreSIGHT, mlr, MSCMT, stops

## Namespace

Overall the package has 10 exported objects. 10 are documented:

         bias_function             cma_es              cmaES extract_population 
                  TRUE               TRUE               TRUE               TRUE 
                f_rand        f_rastrigin       f_rosenbrock           f_sphere 
                  TRUE               TRUE               TRUE               TRUE 
       rotate_function     shift_function 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-23 03:23:17 UTC |
...
running this report
    ...
    PROCESSX_PS1d251aa47c30_1740280993
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnLcSAM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmaes_v1.0.12-tikzDictionary"
