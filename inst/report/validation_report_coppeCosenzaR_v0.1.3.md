# Validation Report - coppeCosenzaR@0.1.3
...
| export_help          | 30                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Pier Taranti <ptaranti@gmail.com>         |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/ptaranti/coppeCosenzaR |
...
Overall the package has 23 exported objects. 30 are documented:

                     Aggregate            AggregateMatrix 
                          TRUE                       TRUE 
                 as.data.frame                     Factor 
                          TRUE                       TRUE 
           Factors.of.interest  getFactorsOfInterestNames 
                          TRUE                       TRUE 
         getOptionFactorsNames  getOptionPortfolioFactors 
                          TRUE                       TRUE 
       getOptionPortfolioNames     getProjectFactorsNames 
                          TRUE                       TRUE 
     getProjectFactorsSpecific getProjectPortfolioFactors 
                          TRUE                       TRUE 
      getProjectPortfolioNames                     Option 
                          TRUE                       TRUE 
    Option.factor.availability           Option.portfolio 
                          TRUE                       TRUE 
              Option.resources                    Project 
                          TRUE                       TRUE 
              Project.criteria          Project.criterion 
                          TRUE                       TRUE 
             Project.portfolio                       show 
                          TRUE                       TRUE 
                       summary 
                          TRUE 
...
There are 24 help pages with examples, from 38 (63.16 %).
...
| Execution Time | 2025-02-17 03:54:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6585598c6_1739764447
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmputHfmY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coppeCosenzaR_v0.1.3-tikzDictionary"
