# Validation Report - DirStats@0.1.10
...
| has_source_control   | https://github.com/egarpor/DirStats                  |
...
HDiR, pgKDEsphere, polykde, ridgetorus

## Namespace

Overall the package has 23 exported objects. 23 are documented:

             b_L  bic_vmf_mix   bw_dir_ami   bw_dir_emi   bw_dir_lcv  bw_dir_lscv 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      bw_dir_rot          c_h          d_L     d_mixvmf      int_cir   int_hypsph 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
         int_sph     kappa_ml      kde_dir     lambda_L        mu_ml        norm2 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       normalize R_Psi_mixvmf       to_cir       to_rad       to_sph 
...
| Execution Time | 2025-02-18 04:10:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4554e9548_1739851825
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpv9qsqo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DirStats_v0.1.10-tikzDictionary"
