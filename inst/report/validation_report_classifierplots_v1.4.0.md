# Validation Report - classifierplots@1.4.0
...
| export_help          | 13                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Aaron Defazio <aaron.defazio@gmail.com>     |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/adefazio/classifierplots |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | ggplot2 (\>= 2.2)     | Depends |
| 2   | data.table (\>= 1.10) | Depends |
| 3   | Rcpp (\>= 0.12)       | Imports |
| 4   | grid                  | Imports |
| 5   | ROCR                  | Imports |
| 6   | caret                 | Imports |
| 7   | gridExtra (\>= 2.2)   | Imports |
| 8   | stats                 | Imports |
| 9   | utils                 | Imports |
| 10  | png                   | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
             ...
             accuracy_plot       calibration_plot        classifierplots 
                      TRUE                   TRUE                   TRUE 
    classifierplots_folder           density_plot              lift_plot 
                      TRUE                   TRUE                   TRUE 
         notation_key_plot         positives_plot         precision_plot 
                      TRUE                   TRUE                   TRUE 
           propensity_plot            recall_plot               roc_plot 
                      TRUE                   TRUE                   TRUE 
                   sigmoid 
                      TRUE 
...
| Execution Time | 2025-02-16 04:26:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bc377239262_1739680009
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFZZj1O
...
These are the options set to generate the report:
    ...
    [1] "validation_report_classifierplots_v1.4.0-tikzDictionary"
