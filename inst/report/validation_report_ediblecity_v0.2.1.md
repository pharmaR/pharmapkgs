# Validation Report - ediblecity@0.2.1
...
| export_help          | 9                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Josep Pueyo-Ros <josep.pueyo@udg.edu> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/icra/ediblecity    |
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          edible_jobs edible_volunteers   food_production      green_capita 
                 TRUE              TRUE              TRUE              TRUE 
       green_distance           no2_seq       runoff_prev      set_scenario 
                 TRUE              TRUE              TRUE              TRUE 
                  UHI 
                 TRUE 
...
| Execution Time | 2025-02-19 03:41:33 UTC |
...
running this report
    ...
    PROCESSX_PS1d45a5661b6_1739936487
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpk6c8tG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ediblecity_v0.2.1-tikzDictionary"
