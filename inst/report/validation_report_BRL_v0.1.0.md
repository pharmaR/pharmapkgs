...
| export_help          | 4                                  |
| has_website          | TRUE                               |
| has_maintainer       | Mauricio Sadinle <msadinle@uw.edu> |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/msadinle/BRL    |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    bipartiteGibbs            BRL compareRecords    linkRecords 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-15 04:45:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd354c07fe_1739594709
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgtvQAG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BRL_v0.1.0-tikzDictionary"
