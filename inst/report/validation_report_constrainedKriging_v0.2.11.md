# Validation Report - constrainedKriging@0.2.11
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Andreas Papritz <papritz@retired.ethz.ch>            |
...
| 5   | parallel                     | Imports |
| 6   | sf(\>= 1.0-14)               | Imports |
| 7   | spatialCovariance(\>= 0.6-4) | Imports |
| 8   | stats                        | Imports |
...
Overall the package has 9 exported objects. 10 are documented:
            ...
            ck.colors            CKrige          covmodel      covmodellist 
                 TRUE              TRUE              TRUE              TRUE 
    f.point.block.cov                 K         preCKrige   preCKrigePoints 
                 TRUE              TRUE              TRUE              TRUE 
    preCKrigePolygons 
                 TRUE 
...
| Execution Time | 2025-02-17 03:48:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6477d6596_1739764099
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFCNxEO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_constrainedKriging_v0.2.11-tikzDictionary"
