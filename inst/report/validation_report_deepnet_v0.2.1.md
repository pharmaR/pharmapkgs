# Validation Report - deepnet@0.2.1
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Xiao Rong <runxiao@gmail.com>                        |
...
kgschart, mlr, qeML, ubair

## Namespace

Overall the package has 9 exported objects. 9 are documented:

    dbn.dnn.train    load.mnist    nn.predict       nn.test      nn.train 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         rbm.down     rbm.train        rbm.up sae.dnn.train 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 03:35:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb468f52810_1739849718
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppVNFhF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deepnet_v0.2.1-tikzDictionary"
