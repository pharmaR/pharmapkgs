...
| export_help          | 60                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Rosaria Simone <rosaria.simone@unina.it>             |
...
Overall the package has 60 exported objects. 60 are documented:
       ...
       betabinomial betabinomialcsi           betar          bitcsi         bitgama 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            chi2cub          cormat      cubevisual    cubshevisual       cubvisual 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          deltaprob          dissim         ellecub        expcub00         expcube 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                GEM            gini         inibest     inibestcube  inibestcubecov 
               TRUE            TRUE            TRUE            TRUE            TRUE 
     inibestcubecsi     inibestgama         inigrid          iniihg          laakso 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              logis       loglikCUB      loglikCUBE     loglikcuben      loglikCUSH 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          loglikIHG        logscore        makeplot        multicub       multicube 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      plotloglikihg         probbit       probcub00       probcub0q        probcube 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          probcubp0       probcubpq     probcubshe1     probcubshe2     probcubshe3 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           probcush       probgecub         probihg     probihgcovn          simcub 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            simcube       simcubshe         simcush          simihg     varcovcub00 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        varcovcub0q        varcub00         varcube       varmatCUB      varmatCUBE 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:37:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6717d98d_1739767026
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbfG6QS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CUB_v1.1.5-tikzDictionary"
