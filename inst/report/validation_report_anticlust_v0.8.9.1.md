...
| export_help          | 22                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Martin Papenberg <martin.papenberg@hhu.de> |
| bugs_status          | 0.7333333                                  |
| size_codebase        | 2882                                       |
| has_source_control   | https://github.com/m-Py/anticlust          |
...
Overall the package has 22 exported objects. 22 are documented:
                       ...
                       anticlustering               balanced_clustering 
                                 TRUE                              TRUE 
           bicriterion_anticlustering              categorical_sampling 
                                 TRUE                              TRUE 
                 categories_to_binary              dispersion_objective 
                                 TRUE                              TRUE 
                  diversity_objective               fast_anticlustering 
                                 TRUE                              TRUE 
           generate_exchange_partners               generate_partitions 
                                 TRUE                              TRUE 
                 kplus_anticlustering            kplus_moment_variables 
                                 TRUE                              TRUE 
                             matching                       mean_sd_tab 
                                 TRUE                              TRUE 
                         n_partitions            optimal_anticlustering 
                                 TRUE                              TRUE 
                   optimal_dispersion                     plot_clusters 
                                 TRUE                              TRUE 
                      plot_similarity three_phase_search_anticlustering 
                                 TRUE                              TRUE 
                   variance_objective                               wce 
                                 TRUE                              TRUE 
...
| Execution Time | 2025-02-14 06:57:14 UTC |
...
running this report
    ...
    PROCESSX_PS726d357ab6b4_1739516231
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmppm4la3
