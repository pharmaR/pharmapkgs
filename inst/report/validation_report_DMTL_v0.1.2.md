...
| export_help          | 12                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Saugato Rahman Dhruba <dhruba018@gmail.com>          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/dhruba018/DMTL                    |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | caret (\>= 6.0-86)        | Imports |
| 2   | glmnet (\>= 4.1)          | Imports |
| 3   | kernlab (\>= 0.9-29)      | Imports |
| 4   | ks (\>= 1.11.7)           | Imports |
| 5   | randomForest (\>= 4.6-14) | Imports |
...
Overall the package has 12 exported objects. 12 are documented:
        ...
        confined   dist_match         DMTL   EN_predict estimate_cdf   match_func 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       norm_data       norm01  performance   RF_predict  SVM_predict       zscore 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-18 04:28:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bb476819128_1739852894
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpn1U7yh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DMTL_v0.1.2-tikzDictionary"
