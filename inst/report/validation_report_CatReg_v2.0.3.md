# Validation Report - CatReg@2.0.3
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    CorrelatedDesignMatrix                  scope         scope.logistic 
                      TRUE                   TRUE                   TRUE 
       UniformDesignMatrix 
                      TRUE 
...
| Execution Time | 2025-02-16 03:47:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3779373af_1739677661
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEN2E13
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CatReg_v2.0.3-tikzDictionary"
