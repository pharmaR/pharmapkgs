# Validation Report - BayesPPDSurv@1.0.3
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yueqi Shen <ys137@live.unc.edu>                      |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    approximate.prior.beta           phm.fixed.a0          phm.random.a0 
                      TRUE                   TRUE                   TRUE 
        power.phm.fixed.a0    power.phm.random.a0 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-15 03:39:51 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3288dcd8_1739590787
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEyLQ1G
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesPPDSurv_v1.0.3-tikzDictionary"
