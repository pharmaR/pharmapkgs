# Validation Report - Brobdingnag@1.2.9
...
| has_source_control   | https://github.com/RobinHankin/Brobdingnag           |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 217655                                               |
...
BGPhazard, BMTAR, bridgesampling, eBsc, EMC2, funpca, gmvarkit,
momentuHMM, MPTinR, multibridge, multimark, uGMAR, untb

## Namespace

Overall the package has 10 exported objects. 10 are documented:

      max   max   min   min  prod  prod range   sum   sum   sum 
...
| Execution Time | 2025-02-22 03:19:25 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb3f5482d2_1740194361
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3WxatB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Brobdingnag_v1.2.9-tikzDictionary"
