...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ian Taylor <ian.taylor@colostate.edu>                |
...
Overall the package has 11 exported objects. 11 are documented:
        ...
        alllinks  bipartiteRL extractlinks fromentities     islinked  multifileRL 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      PPRBupdate    precision       recall  SMCMCupdate  thinsamples 
...
| Execution Time | 2025-02-15 04:51:27 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd37ae034e_1739595082
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPZTiIV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bstrl_v1.0.2-tikzDictionary"
