# Validation Report - epocakir@0.9.9
...
| export_help          | 26                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Alwin Wang <alwin.wang@austin.org.au> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/alwinw/epocakir    |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | dplyr (\>= 1.0.1)     | Imports |
| 2   | tidyr (\>= 1.1.1)     | Imports |
| 3   | tibble (\>= 3.0.1)    | Imports |
| 4   | ellipsis              | Imports |
| 5   | rlang (\>= 0.4.0)     | Imports |
| 6   | units (\>= 0.7)       | Imports |
| 7   | lubridate (\>= 1.7.0) | Imports |
...
Overall the package has 26 exported objects. 25 are documented:
                      ...
                      .data                     %>%                 aki_bCr 
                       TRUE                   FALSE                    TRUE 
                    aki_SCr              aki_stages             aki_staging 
                       TRUE                    TRUE                    TRUE 
                     aki_UO      Albuminuria_stages Albuminuria_staging_ACR 
                       TRUE                    TRUE                    TRUE 
    Albuminuria_staging_AER                  anemia               as_metric 
                       TRUE                    TRUE                    TRUE 
              binary2factor  combine_date_time_cols           combn_changes 
                       TRUE                    TRUE                    TRUE 
         conversion_factors                 dob2age                    eGFR 
                       TRUE                    TRUE                    TRUE 
             eGFR_adult_SCr    eGFR_adult_SCr_SCysC        eGFR_adult_SCysC 
                       TRUE                    TRUE                    TRUE 
             eGFR_child_SCr      eGFR_child_SCr_BUN        eGFR_child_SCysC 
                       TRUE                    TRUE                    TRUE 
                 GFR_stages             GFR_staging 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-19 04:21:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d45230a0a45_1739938868
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1Fsyha
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epocakir_v0.9.9-tikzDictionary"
