...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Andrew Robinson <apro@unimelb.edu.au>                |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    generate.log.vols    get.col.report    get.row.report       ht.fvs.ni.m 
                 TRUE              TRUE              TRUE              TRUE 
    show.cols.with.na         sp.sums.2      SSallometric     vol.fvs.ni.m3 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 05:24:53 UTC |
...
running this report
    ...
    PROCESSX_PS1d452168ca71_1739942686
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXQzRQG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FAwR_v1.1.2-tikzDictionary"
