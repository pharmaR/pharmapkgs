# Validation Report - exhaustiveRasch@0.3.7
...
| export_help          | 30                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Christian Grebe <grebe@hepcos.com>          |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/chrgrebe/exhaustiveRasch |
...
| 7   | tictoc       | Imports |
| 8   | methods      | Imports |
| 9   | psychotools  | Imports |
| 10  | pairwise     | Imports |
| 11  | arrangements | Imports |
| 12  | pbapply      | Imports |
...
Overall the package has 29 exported objects. 29 are documented:
               ...
               add_ICs      all_rawscores  apply_combo_rules  check_combo_rules 
                  TRUE               TRUE               TRUE               TRUE 
    estimation_control   exhaustive_tests           expscore       expscore.psy 
                  TRUE               TRUE               TRUE               TRUE 
             fit_rasch    itemfit_control         LRtest.psy          mloef.psy 
                  TRUE               TRUE               TRUE               TRUE 
               no_test   parallized_tests           ppar.psy                pvx 
                  TRUE               TRUE               TRUE               TRUE 
            pvx.matrix          pvx.super     remove_subsets       test_DIFtree 
                  TRUE               TRUE               TRUE               TRUE 
          test_itemfit            test_LR         test_mloef  test_personsItems 
                  TRUE               TRUE               TRUE               TRUE 
              test_PSI        test_respca      test_waldtest    threshold_order 
                  TRUE               TRUE               TRUE               TRUE 
          waldtest.psy 
                  TRUE 
...
| Execution Time | 2025-02-19 04:49:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d45e5472d4_1739940591
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeWXFbO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exhaustiveRasch_v0.3.7-tikzDictionary"
