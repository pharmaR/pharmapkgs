# Validation Report - biotic@0.1.2
...
| export_help          | 13                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Dr Rob Briers <r.briers@napier.ac.uk> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/robbriers/biotic   |
...
Overall the package has 13 exported objects. 13 are documented:
         ...
         calcAWIC      calcBMWP     calcindex      calcLIFE      calcPool 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          calcPSI    calcRiffle  calcRiffPool   calcWhalley      calcWHPT 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      calcWHPT_AB     checktaxa transposedata 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-15 04:15:53 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2a05398f_1739592949
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1vzpqo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biotic_v0.1.2-tikzDictionary"
