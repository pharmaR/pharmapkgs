# Validation Report - BCClong@1.0.3
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Zhiwen Tan <21zt9@queensu.ca>                        |
...
| 12  | mvtnorm          | Imports   |
| 13  | nnet             | Imports   |
| 14  | Rcpp (\>= 1.0.9) | Imports   |
| 15  | Rmpfr            | Imports   |
| 16  | stats            | Imports   |
| 17  | truncdist        | Imports   |
| 18  | abind            | Imports   |
| 19  | gridExtra        | Imports   |
| 20  | Rcpp             | LinkingTo |
...
Overall the package has 5 exported objects. 5 are documented:
                      ...
                      BayesT                BCC.multi model.selection.criteria 
                        TRUE                     TRUE                     TRUE 
                   traceplot                 trajplot 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-15 03:45:17 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1fe0f22a_1739591113
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeGZnnr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BCClong_v1.0.3-tikzDictionary"
