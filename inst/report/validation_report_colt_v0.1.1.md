...
| has_source_control   | https://github.com/s-fleck/colt         |
...
Overall the package has 27 exported objects. 27 are documented:
            ...
            clt_bg  clt_bg_accent  clt_bg_subtle        clt_chr clt_chr_accent 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    clt_chr_subtle    clt_default       clt_emph      clt_emph2      clt_error 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         clt_false         clt_h1         clt_h2        clt_inf       clt_info 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         clt_maybe    clt_message         clt_na        clt_nan       clt_null 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           clt_num clt_num_accent clt_num_subtle       clt_true    clt_warning 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        colt_theme      set_theme 
              TRUE           TRUE 

### Examples

There are 3 help pages with examples, from 5 (60.00 %).
...
| Execution Time | 2025-02-16 05:01:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34cc12911_1739682112
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxET2l7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colt_v0.1.1-tikzDictionary"
