# Validation Report - fastGHQuad@1.0.1
...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Alexander W Blocker <ablocker@gmail.com>             |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/awblocker/fastGHQuad              |
...
irtreliability, lamle, lavacreg, metaplus, mixAK, mlr3mbo, modsem,
randomLCA, robmixglm, robustlmm, rstpm2, semicmprskcoxmsm, sfaR, SIMICO

## Namespace

Overall the package has 6 exported objects. 6 are documented:

             aghQuad  evalHermitePoly    findPolyRoots gaussHermiteData 
                TRUE             TRUE             TRUE             TRUE 
              ghQuad  hermitePolyCoef 
                TRUE             TRUE 
...
| Execution Time | 2025-02-19 05:16:37 UTC |
...
running this report
    ...
    PROCESSX_PS1d4515913435_1739942191
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRUZphL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastGHQuad_v1.0.1-tikzDictionary"
