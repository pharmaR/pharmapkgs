# Validation Report - driveR@0.4.1
...
| export_help          | 3                                   |
| has_website          | TRUE                                |
| has_maintainer       | Ege Ulgen <egeulgen@gmail.com>      |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/egeulgen/driveR/ |
...
| 3   | GenomicRanges                     | Imports |
| 4   | GenomeInfoDb                      | Imports |
| 5   | GenomicFeatures                   | Imports |
| 6   | TxDb.Hsapiens.UCSC.hg19.knownGene | Imports |
| 7   | TxDb.Hsapiens.UCSC.hg38.knownGene | Imports |
| 8   | S4Vectors                         | Imports |
| 9   | org.Hs.eg.db                      | Imports |
| 10  | rlang                             | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
         ...
         create_features_df   predict_coding_impact prioritize_driver_genes 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-18 04:46:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4629b8c57_1739854011
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpO4jfrm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_driveR_v0.4.1-tikzDictionary"
