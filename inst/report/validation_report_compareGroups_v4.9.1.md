# Validation Report - compareGroups@4.9.1
...
| export_help          | 30                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Isaac Subirana <isubirana@imim.es>                   |
...
CEOdata, GNOSIS, ImportExport

## Namespace

Overall the package has 30 exported objects. 30 are documented:

                        cGroupsGUI                     cGroupsWUI 
                              TRUE                           TRUE 
                     compareGroups                    compareSNPs 
                              TRUE                           TRUE 
                       createTable                     descrTable 
                              TRUE                           TRUE 
                        export2csv                    export2html 
                              TRUE                           TRUE 
                      export2latex export2latex.cbind.createTable 
                              TRUE                           TRUE 
          export2latex.createTable                      export2md 
                              TRUE                           TRUE 
                        export2pdf                    export2word 
                              TRUE                           TRUE 
                        export2xls                     getResults 
                              TRUE                           TRUE 
                      missingTable           padjustCompareGroups 
                              TRUE                           TRUE 
                 print.compareSNPs              print.createTable 
                              TRUE                           TRUE 
       print.summary.compareGroups      print.summary.createTable 
                              TRUE                           TRUE 
                        printTable                     radiograph 
                              TRUE                           TRUE 
                            report                    strataTable 
                              TRUE                           TRUE 
             summary.compareGroups            summary.createTable 
                              TRUE                           TRUE 
                           varinfo          varinfo.compareGroups 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-17 03:34:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bd621ae51a6_1739763256
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQ2GQyg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_compareGroups_v4.9.1-tikzDictionary"
