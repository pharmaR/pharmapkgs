# Validation Report - cloudos@0.4.0
...
| export_help          | 15                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Sangram Keshari Sahu <sangram@lifebit.ai> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/lifebit-ai/cloudos     |
...
Overall the package has 15 exported objects. 15 are documented:
                    ...
                    cb_apply_query               cb_create_cohort 
                              TRUE                           TRUE 
            cb_get_genotypic_table      cb_get_participants_table 
                              TRUE                           TRUE 
    cb_get_participants_table_long      cb_get_phenotype_metadata 
                              TRUE                           TRUE 
       cb_get_phenotype_statistics                cb_list_cohorts 
                              TRUE                           TRUE 
                    cb_load_cohort           cb_participant_count 
                              TRUE                           TRUE 
              cb_search_phenotypes                 cb_set_columns 
                              TRUE                           TRUE 
                 cloudos_configure                 cloudos_whoami 
                              TRUE                           TRUE 
                         phenotype 
                              TRUE 
...
| Execution Time | 2025-02-16 04:35:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bc353159d67_1739680524
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5YWF6H
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cloudos_v0.4.0-tikzDictionary"
