# Validation Report - cauphy@1.0.3
...
| export_help          | 10                                  |
| has_website          | TRUE                                |
| has_maintainer       | Paul Bastide <paul.bastide@cnrs.fr> |
...
| 1   | ape (\>= 5.5)       | Depends |
| 2   | methods             | Imports |
| 3   | robustbase          | Imports |
| 4   | phylolm (\>= 2.6.5) | Imports |
| 5   | nloptr              | Imports |
| 6   | pracma              | Imports |
| 7   | foreach             | Imports |
| 8   | doParallel          | Imports |
| 9   | HDInterval          | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
                    ...
                    ancestral                  cauphylm              compute_vcov 
                         TRUE                      TRUE                      TRUE 
                    fitCauchy                 increment      logDensityTipsCauchy 
                         TRUE                      TRUE                      TRUE 
                     plot_asr posteriorDensityAncestral posteriorDensityIncrement 
                         TRUE                      TRUE                      TRUE 
                 rTraitCauchy 
                         TRUE 
...
| Execution Time | 2025-02-16 03:48:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37f0727d6_1739677709
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpY9Ssl4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cauphy_v1.0.3-tikzDictionary"
