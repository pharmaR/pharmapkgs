...
| bugs_status          | 0.5238095                                     |
| has_source_control   | https://github.com/insightsengineering/crane  |
...
|:----|:----------------------|:--------|
| 1   | cli (\>= 3.6.4)       | Imports |
| 2   | dplyr (\>= 1.1.4)     | Imports |
| 3   | flextable (\>= 0.9.7) | Imports |
| 4   | gt (\>= 0.11.1)       | Imports |
| 5   | gtsummary (\>= 2.1.0) | Imports |
| 6   | rlang (\>= 1.1.5)     | Imports |
...
Overall the package has 8 exported objects. 7 are documented:
                      ...
                      %>%         add_blank_row       all_categorical 
                    FALSE                  TRUE                  TRUE 
           all_continuous    label_roche_pvalue          roche_pvalue 
                     TRUE                  TRUE                  TRUE 
         tbl_demographics theme_gtsummary_roche 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-25 03:21:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d28558095ef_1740453661
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppPmnEJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crane_v0.1.0-tikzDictionary"
