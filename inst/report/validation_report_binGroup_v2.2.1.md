# Validation Report - binGroup@2.2.1
...
| export_help | 56 |
| has_website | FALSE |
| has_maintainer | Frank Schaarschmidt <schaarschmidt@biostat.uni-hannover.de> |
...
Overall the package has 56 exported objects. 56 are documented:
                ...
                accuracy.dorf            Array.Measures                 beta.dist 
                         TRUE                      TRUE                      TRUE 
                        bgtCI                  bgtPower                   bgtTest 
                         TRUE                      TRUE                      TRUE 
                        bgtvs                  bgtWidth                     binAC 
                         TRUE                      TRUE                      TRUE 
                    binBlaker                     binCI                     binCP 
                         TRUE                      TRUE                      TRUE 
                    binDesign                  binPower                    binSOC 
                         TRUE                      TRUE                      TRUE 
                      binTest                   binWald                  binWidth 
                         TRUE                      TRUE                      TRUE 
                    binWilson      characteristics.pool                        EM 
                         TRUE                      TRUE                      TRUE 
                   EM.halving                     EM.mp                    EM.ret 
                         TRUE                      TRUE                      TRUE 
                    estDesign                gt.control                     gtreg 
                         TRUE                      TRUE                      TRUE 
                    gtreg.fit             gtreg.halving                  gtreg.mp 
                         TRUE                      TRUE                      TRUE 
           hierarchical.desc2                 Inf.Array                    Inf.D3 
                         TRUE                      TRUE                      TRUE 
                     Inf.Dorf         inf.dorf.measures    Informative.array.prob 
                         TRUE                      TRUE                      TRUE 
    MasterPool.Array.Measures                   nDesign                    NI.A2M 
                         TRUE                      TRUE                      TRUE 
                     NI.Array                     NI.D3                   NI.Dorf 
                         TRUE                      TRUE                      TRUE 
                opt.info.dorf             opt.pool.size                       OTC 
                         TRUE                      TRUE                      TRUE 
                   p.vec.func        pool.specific.dorf                 pooledBin 
                         TRUE                      TRUE                      TRUE 
                pooledBinDiff                predict.gt              residuals.gt 
                         TRUE                      TRUE                      TRUE 
                      sDesign                    sim.gt               sim.halving 
                         TRUE                      TRUE                      TRUE 
                       sim.mp           thresh.val.dorf 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-15 04:08:47 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd58165cb4_1739592522
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLbCrDA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binGroup_v2.2.1-tikzDictionary"
