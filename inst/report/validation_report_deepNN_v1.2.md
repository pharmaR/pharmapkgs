...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Benjamin Taylor <benjamin.taylor.software@gmail.com> |
...
Overall the package has 22 exported objects. 22 are documented:
          ...
          download_mnist         dropoutProbs               hyptan 
                    TRUE                 TRUE                 TRUE 
                   ident    L1_regularisation    L2_regularisation 
                    TRUE                 TRUE                 TRUE 
                logistic          multinomial             nbiaspar 
                    TRUE                 TRUE                 TRUE 
                 network              nnetpar          NNgrad_test 
                    TRUE                 TRUE                 TRUE 
               NNpredict NNpredict.regression    no_regularisation 
                    TRUE                 TRUE                 TRUE 
                   Qloss                 ReLU           smoothReLU 
                    TRUE                 TRUE                 TRUE 
                 softmax                train         wmultinomial 
                    TRUE                 TRUE                 TRUE 
                  wQloss 
                    TRUE 
...
| Execution Time | 2025-02-18 03:35:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bb412971cf8_1739849724
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprpcS5i
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deepNN_v1.2-tikzDictionary"
