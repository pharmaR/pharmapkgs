# Validation Report - expstudy@2.0.0
...
| export_help          | 22                                  |
| has_website          | TRUE                                |
| has_maintainer       | Cody Buehler <cb12991@me.com>       |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/cb12991/expstudy |
...
Overall the package has 22 exported objects. 22 are documented:
       ...
       add_credibility        add_metrics    add_proportions           ae_ratio 
                  TRUE               TRUE               TRUE               TRUE 
          ae_ratio_vec          aggregate       avg_expected   avg_expected_vec 
                  TRUE               TRUE               TRUE               TRUE 
          avg_observed   avg_observed_vec            ci_fctr        ci_fctr_vec 
                  TRUE               TRUE               TRUE               TRUE 
       compile_results   compute_fct_adjs        credibility    credibility_vec 
                  TRUE               TRUE               TRUE               TRUE 
              expstudy     format_metrics guess_measure_sets    mutate_expecvar 
                  TRUE               TRUE               TRUE               TRUE 
        mutate_metrics summarise_measures 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:54:48 UTC |
...
running this report
    ...
    PROCESSX_PS1d45263417b4_1739940882
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdhONI9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_expstudy_v2.0.0-tikzDictionary"
