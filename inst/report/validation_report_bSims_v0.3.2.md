...
| bugs_status          | 1                                  |
| has_source_control   | https://github.com/psolymos/bSims  |
...
Overall the package has 23 exported objects. 23 are documented:
          ...
          .bsims_all     acceptreject        bsims_all    bsims_animate 
                TRUE             TRUE             TRUE             TRUE 
        bsims_detect       bsims_init   bsims_populate bsims_transcribe 
                TRUE             TRUE             TRUE             TRUE 
             col2hex        dist_fun2         estimate           events 
                TRUE             TRUE             TRUE             TRUE 
         expand_list    get_abundance      get_density   get_detections 
                TRUE             TRUE             TRUE             TRUE 
          get_events        get_nests        get_table          rlnorm2 
                TRUE             TRUE             TRUE             TRUE 
                rmvn          run_app      timetoevent 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-22 03:19:40 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb4e1a643c_1740194376
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUpmcNW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bSims_v0.3.2-tikzDictionary"
