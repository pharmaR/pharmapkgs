# Validation Report - equate@2.0.8
...
| export_help          | 21                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Anthony Albano <tony.d.albano@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/talbano/equate        |
...
PROsetta, SGP, SNSequate

## Namespace

Overall the package has 21 exported objects. 21 are documented:

        as.freqtab      bootstrap      composite    cor.freqtab    cov.freqtab 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            equate        freqavg       freqbump        freqtab             fx 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      kurt.freqtab      loglinear         margin        margins   presmoothing 
              TRUE           TRUE           TRUE           TRUE           TRUE 
                px sample.freqtab         scales     sd.freqtab   skew.freqtab 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       var.freqtab 
              TRUE 
...
| Execution Time | 2025-02-19 04:23:34 UTC |
...
running this report
    ...
    PROCESSX_PS1d4577e392d0_1739939007
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz5RUKg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_equate_v2.0.8-tikzDictionary"
