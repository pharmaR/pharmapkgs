...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | George Rosenberger <gr2578@cumc.columbia.edu>        |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 862                                                  |
| has_source_control   | https://github.com/aLFQ                              |
...
Overall the package has 11 exported objects. 11 are documented:
    ...
    AbsoluteQuantification                    ALF                   APEX 
                      TRUE                   TRUE                   TRUE 
              apexFeatures                   cval                 export 
                      TRUE                   TRUE                   TRUE 
                    import       PeptideInference                  pivot 
                      TRUE                   TRUE                   TRUE 
          ProteinInference            proteotypic 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-14 06:47:53 UTC |
...
running this report
    ...
    PROCESSX_PS726d6d98592f_1739515671
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxDzumB
