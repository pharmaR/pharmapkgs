# Validation Report - FastRet@1.1.4
...
| export_help          | 27                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Tobias Schmidt <tobias.schmidt331@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/spang-lab/FastRet/        |
...
| 12  | rcdk              | Imports |
| 13  | readxl            | Imports |
| 14  | shiny (\>= 1.8.1) | Imports |
| 15  | shinybusy         | Imports |
| 16  | shinyhelper       | Imports |
| 17  | shinyjs           | Imports |
| 18  | xgboost           | Imports |
| 19  | xlsx              | Imports |
...
Overall the package has 27 exported objects. 27 are documented:
                 ...
                 adjust_frm          analyzeCDNames                    catf 
                       TRUE                    TRUE                    TRUE 
                 CDFeatures                 CDNames                 collect 
                       TRUE                    TRUE                    TRUE 
                fastret_app           get_cache_dir          get_predictors 
                       TRUE                    TRUE                    TRUE 
                     getCDs      getCDsFor1Molecule            init_log_dir 
                       TRUE                    TRUE                    TRUE 
                        now                pkg_file         preprocess_data 
                       TRUE                    TRUE                    TRUE 
                  ram_cache   read_retip_hilic_data read_rp_lasso_model_rds 
                       TRUE                    TRUE                    TRUE 
               read_rp_xlsx         read_rpadj_xlsx     selective_measuring 
                       TRUE                    TRUE                    TRUE 
                  start_gui               train_frm             withLineEnd 
                       TRUE                    TRUE                    TRUE 
                   withSink         withStopMessage             withTimeout 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-19 05:21:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d451c696991_1739942467
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbLhCs0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FastRet_v1.1.4-tikzDictionary"
