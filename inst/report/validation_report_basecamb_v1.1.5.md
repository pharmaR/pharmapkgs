# Validation Report - basecamb@1.1.5
...
| export_help          | 17                                        |
| has_website          | TRUE                                      |
| has_maintainer       | J. Peter Marquardt <peter@kmarquardt.de>  |
| bugs_status          | subscript out of bounds                   |
| size_codebase        | 609                                       |
| has_source_control   | https://github.com/codeblue-team/basecamb |
...
Overall the package has 17 exported objects. 17 are documented:
             ...
             apply_data_dictionary apply_function_to_imputed_data 
                              TRUE                           TRUE 
           assign_factorial_levels             assign_types_names 
                              TRUE                           TRUE 
               build_model_formula                   cox.zph.mids 
                              TRUE                           TRUE 
               deconstruct_formula               filter_nth_entry 
                              TRUE                           TRUE 
       fit_mult_impute_obs_outcome               or_model_summary 
                              TRUE                           TRUE 
                parse_date_columns                 quantile_group 
                              TRUE                           TRUE 
                 remove_duplicates       remove_missing_from_mids 
                              TRUE                           TRUE 
       scale_continuous_predictors                  setduplicates 
                              TRUE                           TRUE 
                 stratified_boxcox 
                              TRUE 
...
| Execution Time | 2025-02-14 07:44:00 UTC |
...
running this report
    ...
    PROCESSX_PS1c09e383587_1739519037
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyBYZKj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_basecamb_v1.1.5-tikzDictionary"
