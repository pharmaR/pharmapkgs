# Validation Report - DeepLearningCausal@0.0.104
...
| export_help          | 12                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Nguyen K. Huynh <khoinguyen.huynh@r.hit-u.ac.jp> |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/hknd23/DeepLearningCausal     |
...
Overall the package has 12 exported objects. 12 are documented:
                       ...
                       complier_mod                complier_predict 
                               TRUE                            TRUE 
             metalearner_deepneural            metalearner_ensemble 
                               TRUE                            TRUE 
             neuralnet_complier_mod neuralnet_pattc_counterfactuals 
                               TRUE                            TRUE 
                  neuralnet_predict        neuralnet_response_model 
                               TRUE                            TRUE 
              pattc_counterfactuals                pattc_deepneural 
                               TRUE                            TRUE 
                     pattc_ensemble                  response_model 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-18 03:35:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43ff15fe5_1739849699
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpggWgy5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DeepLearningCausal_v0.0.104-tikzDictionary"
