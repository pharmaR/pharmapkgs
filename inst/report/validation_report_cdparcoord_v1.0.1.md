# Validation Report - cdparcoord@1.0.1
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Norm Matloff <normmatloff@gmail.com>                 |
...
Overall the package has 7 exported objects. 3 are documented:

    clsTupleFreqs  discparcoord    discretize    makeFactor       reOrder 
             TRUE          TRUE         FALSE         FALSE         FALSE 
       showCounts    tupleFreqs 
            FALSE          TRUE 
...
| Execution Time | 2025-02-16 03:57:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32cff6e40_1739678229
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoLWhzt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cdparcoord_v1.0.1-tikzDictionary"
