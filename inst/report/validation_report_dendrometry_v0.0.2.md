# Validation Report - dendrometry@0.0.2
...
| export_help          | 30                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Narcisse Yehouenou <narcisstar211@gmail.com>         |
...
Overall the package has 30 exported objects. 30 are documented:
       ...
       angle2slope          basal        basal_i      basal2dbh       blackman 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            circum            dbh       decrease decreaseMetric            deg 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       densityTree   diameterMean      distanceH      factorise      factorize 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         fibonacci       fiboRate          green         height    loreyHeight 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          makedata      principal            rad     reducecoef     sampleSize 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             shape       skewness    slope2angle       stacking         volume 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 03:41:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb426465003_1739850064
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRFsrri
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dendrometry_v0.0.2-tikzDictionary"
