# Validation Report - ClimProjDiags@0.3.3
...
CSIndicators, CSTools, s2dv, startR

## Namespace

Overall the package has 17 exported objects. 17 are documented:

          AnoAgree    ArrayToList        Climdex CombineIndices       DailyAno 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      DTRIndicator         DTRRef       Extremes      Lon2Index   SeasonSelect 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            SelBox       ShiftLon         Subset      Threshold   WaveDuration 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     WeightedCells   WeightedMean 
              TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:32:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31e5d740d_1739680318
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnJjnxa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClimProjDiags_v0.3.3-tikzDictionary"
