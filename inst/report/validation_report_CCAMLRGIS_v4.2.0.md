# Validation Report - CCAMLRGIS@4.2.0
...
| export_help | 34 |
| has_website | TRUE |
| has_maintainer | Stephane Thanassekos <stephane.thanassekos@ccamlr.org> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/ccamlr/CCAMLRGIS#ccamlrgis-r-package |
...
Overall the package has 34 exported objects. 34 are documented:
                 ...
                 add_col           add_Cscale           add_labels 
                    TRUE                 TRUE                 TRUE 
              add_Legend        add_PieLegend          add_RefGrid 
                    TRUE                 TRUE                 TRUE 
            assign_areas           Clip2Coast         create_Arrow 
                    TRUE                 TRUE                 TRUE 
    create_CircularArrow       create_Ellipse        create_Hashes 
                    TRUE                 TRUE                 TRUE 
            create_Lines          create_Pies        create_Points 
                    TRUE                 TRUE                 TRUE 
        create_PolyGrids         create_Polys      create_Stations 
                    TRUE                 TRUE                 TRUE 
      get_C_intersection           get_depths        get_iso_polys 
                    TRUE                 TRUE                 TRUE 
               load_ASDs           load_Bathy       load_Coastline 
                    TRUE                 TRUE                 TRUE 
               load_EEZs             load_MAs            load_MPAs 
                    TRUE                 TRUE                 TRUE 
                load_RBs           load_SSMUs           load_SSRUs 
                    TRUE                 TRUE                 TRUE 
            project_data           Rotate_obj          seabed_area 
                    TRUE                 TRUE                 TRUE 
              SmallBathy 
                    TRUE 
...
| Execution Time | 2025-02-16 03:52:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34559d5e4_1739677963
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoKVCfj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CCAMLRGIS_v4.2.0-tikzDictionary"
