# Validation Report - expSBM@1.3.5
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Riccardo Rastelli <riccardoras@gmail.com>            |
...
Overall the package has 4 exported objects. 4 are documented:
      ...
      expSBM_ELBO     expSBM_EM   expSBM_init expSBM_select 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 04:54:27 UTC |
...
running this report
    ...
    PROCESSX_PS1d4567819bce_1739940861
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCAl5wi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_expSBM_v1.3.5-tikzDictionary"
