# Validation Report - centerline@0.1
...
| export_help          | 3                                             |
| has_website          | TRUE                                          |
| has_maintainer       | Anatoly Tsyplenkov <atsyplenkov@fastmail.com> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/atsyplenkov/centerline     |
...
| 1   | wk (\>= 0.9)         | Imports |
| 2   | sf (\>= 1.0)         | Imports |
| 3   | geos (\>= 0.2.4)     | Imports |
| 4   | sfnetworks (\>= 0.6) | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
          ...
          cnt_path cnt_path_guess   cnt_skeleton 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:00:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33b666381_1739678453
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJOpybS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_centerline_v0.1-tikzDictionary"
