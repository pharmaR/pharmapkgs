# Validation Report - excursions@2.5.8
...
| export_help          | 21                                       |
| has_website          | TRUE                                     |
| has_maintainer       | David Bolin <davidbolin@gmail.com>       |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/davidbolin/excursions |
...
BayesfMRI, templateICAr

## Namespace

Overall the package has 21 exported objects. 21 are documented:

              continuous           contourmap    contourmap.colors 
                    TRUE                 TRUE                 TRUE 
         contourmap.inla        contourmap.mc        exc_safe_inla 
                    TRUE                 TRUE                 TRUE 
              excursions      excursions.inla        excursions.mc 
                    TRUE                 TRUE                 TRUE 
    excursions.variances             gaussint  local_exc_safe_inla 
                    TRUE                 TRUE                 TRUE 
      require.nowarnings              simconf         simconf.inla 
                    TRUE                 TRUE                 TRUE 
              simconf.mc      simconf.mixture         submesh.grid 
                    TRUE                 TRUE                 TRUE 
            submesh.mesh           tricontour        tricontourmap 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:49:22 UTC |
...
running this report
    ...
    PROCESSX_PS1d45759c3be2_1739940555
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEHWplh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_excursions_v2.5.8-tikzDictionary"
