...
AgroReg, baycn, CellBarcode, Certara.Xpose.NLME, coveffectsplot,
EWSmethods, explainer, frailtyEM, GABB, ggcleveland, ggrisk, gridExtra,
heatmaply, IDMIR, mobr, plotGrouper, rifi, rifiComparative, RTNsurvival,
ShapleyOutlier, simRestore, tidyvpc, topr, Unico, visualpred

## Namespace

Overall the package has 12 exported objects. 10 are documented:

         .dummy_ggplot      .dummy_gtable      expose_layout        geom_custom 
                 FALSE              FALSE               TRUE               TRUE 
             ggarrange       gtable_frame     set_panel_size    symmetric_range 
                  TRUE               TRUE               TRUE               TRUE 
             tag_facet  tag_facet_outside      theme_article theme_presentation 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 03:48:43 UTC |
...
running this report
    ...
    PROCESSX_PS1d452fa42bc1_1739936917
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxOom8a
...
These are the options set to generate the report:
    ...
    [1] "validation_report_egg_v0.4.5-tikzDictionary"
