# Validation Report - brainR@1.6.0
...
Overall the package has 6 exported objects. 6 are documented:
            ...
            makeScene           scene4d           write4D      write4D.file 
                 TRUE              TRUE              TRUE              TRUE 
    writeTrianglesSTL  writeWebGL_split 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:40:57 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4b27a0e9_1739594452
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptqFXQJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brainR_v1.6.0-tikzDictionary"
