# Validation Report - earlygating@1.1
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Elias Laurin Meyer <elias.meyer@meduniwien.ac.at>    |
...
Overall the package has 8 exported objects. 8 are documented:
        ...
        avg_oc_wr_ne avg_oc_wr_ne_rct     avg_oc_wr_ph         beta_par 
                TRUE             TRUE             TRUE             TRUE 
                  oc           oc_rct         req_resp     req_resp_rct 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 05:09:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4120ffc20_1739855338
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeHMq96
...
These are the options set to generate the report:
    ...
    [1] "validation_report_earlygating_v1.1-tikzDictionary"
