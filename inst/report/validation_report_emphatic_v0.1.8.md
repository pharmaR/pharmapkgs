# Validation Report - emphatic@0.1.8
...
| has_source_control   | https://github.com/coolbutuseless/emphatic |
...
Overall the package has 16 exported objects. 16 are documented:
            ...
            as_emphatic             as_html            as_latex              as_svg 
                   TRUE                TRUE                TRUE                TRUE 
            as_svg_anim        as_svg_group            as_typst                  hl 
                   TRUE                TRUE                TRUE                TRUE 
              hl_adjust             hl_diff             hl_grep             hl_opts 
                   TRUE                TRUE                TRUE                TRUE 
            is_emphatic knit_print.emphatic           show_html          write_xlsx 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:04:13 UTC |
...
running this report
    ...
    PROCESSX_PS1d45222dde80_1739937847
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTM3K2V
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emphatic_v0.1.8-tikzDictionary"
