# Validation Report - defineOptions@0.9
...
| export_help          | 8                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Toshihiro Umehara <toshi@niceume.com>    |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/niceume/defineOptions |
...
Overall the package has 6 exported objects. 8 are documented:

                    define_option                new_parser_def 
                             TRUE                          TRUE 
    opt_optional_input_disallowed   opt_optional_input_required 
                             TRUE                          TRUE 
      opt_required_input_required               parse_with_defs 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-18 03:36:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4171c04a1_1739849786
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpL75yDn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_defineOptions_v0.9-tikzDictionary"
