# Validation Report - clarifai@0.4.2
...
| has_source_control   | http://github.com/soodoku/clarifai |
...
Overall the package has 10 exported objects. 10 are documented:
          ...
          feedback      get_color get_color_urls       get_info      get_langs 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         get_token      get_usage      secret_id tag_image_urls     tag_images 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:26:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bc326aaca2d_1739679964
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSOTL47
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clarifai_v0.4.2-tikzDictionary"
