...
Overall the package has 8 exported objects. 8 are documented:
        ...
        calculate_CFC       create_bpmn        create_xml        print_bpmn 
                 TRUE              TRUE              TRUE              TRUE 
          render_bpmn render_bpmnOutput renderRender_bpmn        write_bpmn 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:38:52 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd57cf630f_1739594327
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKhDyPW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bpmnR_v0.1.1-tikzDictionary"
