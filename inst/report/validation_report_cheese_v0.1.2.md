# Validation Report - cheese@0.1.2
...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Alex Zajichek <alexzajichek@gmail.com>               |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/zajichek/cheese/                  |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | dplyr (\>= 0.8.2)      | Imports |
| 2   | forcats (\>= 0.3.0)    | Imports |
| 3   | kableExtra (\>= 1.0.1) | Imports |
| 4   | knitr (\>= 1.20)       | Imports |
| 5   | magrittr (\>= 1.5)     | Imports |
| 6   | methods (\>= 3.4.1)    | Imports |
| 7   | purrr (\>= 0.3.2)      | Imports |
| 8   | rlang (\>= 0.4.3)      | Imports |
| 9   | stringr (\>= 1.3.1)    | Imports |
| 10  | tibble (\>= 2.1.3)     | Imports |
| 11  | tidyr (\>= 0.8.1)      | Imports |
| 12  | tidyselect (\>= 1.0.0) | Imports |
...
Overall the package has 16 exported objects. 15 are documented:

                        %>%                  absorb                  depths 
                      FALSE                    TRUE                    TRUE 
              depths_string            descriptives                    dish 
                       TRUE                    TRUE                    TRUE 
                     divide                  fasten                  grable 
                       TRUE                    TRUE                    TRUE 
                     muddle               some_type               stratiply 
                       TRUE                    TRUE                    TRUE 
                    stretch                   typly univariate_associations 
                       TRUE                    TRUE                    TRUE 
           univariate_table 
                       TRUE 
...
| Execution Time | 2025-02-16 04:10:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34350db18_1739679054
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7OX9ec
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cheese_v0.1.2-tikzDictionary"
