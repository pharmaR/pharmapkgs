...
| size_codebase        | 1365                                             |
| has_source_control   | https://github.com/ropensci/babette              |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | beautier (\>= 2.6.12) | Depends |
| 2   | beastier (\>= 2.5)    | Depends |
| 3   | mauricer (\>= 2.5.2)  | Depends |
| 4   | tracerer              | Depends |
| 5   | phangorn              | Imports |
| 6   | rlang (\>= 1.1.0)     | Imports |
| 7   | stringr               | Imports |
| 8   | xml2                  | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
                  ...
                  bbt_continue      bbt_delete_temp_files 
                          TRUE                       TRUE 
                       bbt_run         bbt_run_from_model 
                          TRUE                       TRUE 
                 bbt_self_test          check_beast2_pkgs 
                          TRUE                       TRUE 
    create_test_bbt_run_output      create_test_ns_output 
                          TRUE                       TRUE 
    get_alignment_ids_from_xml           get_babette_path 
                          TRUE                       TRUE 
             get_babette_paths        parse_beast2_output 
                          TRUE                       TRUE 
     parse_beast2_output_to_ns             plot_densitree 
                          TRUE                       TRUE 
         prepare_file_creation             update_babette 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-14 07:38:46 UTC |
...
running this report
    ...
    PROCESSX_PS1c0953b26ace_1739518723
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzNl7wE
