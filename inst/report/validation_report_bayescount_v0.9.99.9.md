# Validation Report - bayescount@0.9.99.9
...
| export_help          | 33                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Matthew Denwood <md@sund.ku.dk>                      |
...
Overall the package has 33 exported objects. 29 are documented:

             bayescount   bayescount.single      count.analysis         count.model 
                   TRUE               FALSE               FALSE                TRUE 
            count.power     count.precision        fec.analysis        FEC.analysis 
                   TRUE                TRUE               FALSE               FALSE 
              fec.model           FEC.model           fec.power           FEC.power 
                   TRUE                TRUE                TRUE                TRUE 
       fec.power.limits    FEC.power.limits       fec.precision       FEC.precision 
                   TRUE                TRUE                TRUE                TRUE 
                  fecrt               FECRT      fecrt.analysis      FECRT.analysis 
                   TRUE                TRUE                TRUE                TRUE 
            fecrt.model         FECRT.model         fecrt.power         FECRT.power 
                   TRUE                TRUE                TRUE                TRUE 
     fecrt.power.limits  FECRT.power.limits     fecrt.precision     FECRT.precision 
                   TRUE                TRUE                TRUE                TRUE 
             likelihood      lnormal.params maximise.likelihood       normal.params 
                   TRUE                TRUE                TRUE                TRUE 
              run.model 
                   TRUE 
...
| Execution Time | 2025-02-15 03:32:46 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7aacb41a_1739590361
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpiw0cbU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayescount_v0.9.99.9-tikzDictionary"
