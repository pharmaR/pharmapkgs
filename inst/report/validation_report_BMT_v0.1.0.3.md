...
| export_help          | 36                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Camilo Jose Torres-Jimenez <cjtorresj@gmail.com>     |
...
|     | package      | type    |
|:----|:-------------|:--------|
| 1   | partitions   | Depends |
| 2   | fitdistrplus | Depends |
...
Overall the package has 36 exported objects. 36 are documented:
         ...
         BMTasymm BMTchangepars        BMTchf        BMTfit    BMTfit.mge 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       BMTfit.mle    BMTfit.mme   BMTfit.mpse   BMTfit.mqde    BMTfit.qme 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           BMTiqr       BMTkurt       BMTmean     BMTmedian        BMTmgf 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          BMTmode     BMTmoment         BMTsd       BMTskew      BMTsteep 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           BMTvar          dBMT      dBMT.Phi      dBMT.Psi          mBMT 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         mpsedist      mqdedist          pBMT      pBMT.Phi      pBMT.Psi 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             qBMT      qBMT.Phi      qBMT.Psi          rBMT      rBMT.Phi 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         rBMT.Psi 
             TRUE 
...
| Execution Time | 2025-02-15 04:27:44 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd469f607f_1739593659
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp954xSM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BMT_v0.1.0.3-tikzDictionary"
