# Validation Report - BGPhazard@2.1.1
...
| export_help | 21 |
| has_website | TRUE |
| has_maintainer | Emilio Akira Morones Ishikawa <emiliomorones@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/EAMI91/BGPhazard |
...
Overall the package has 21 exported objects. 21 are documented:
         ...
         BeMRes  BePlotDiag     BePloth      BSBHaz     BSBInit BSBPlotDiag 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
    BSBPlotSumm     BSBSumm     CCuMRes CCuPlotDiag    CCuPloth     CGaMRes 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
    CGaPlotDiag    CGaPloth         cpo      CuMRes  CuPlotDiag     CuPloth 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
         GaMRes  GaPlotDiag     GaPloth 
           TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-15 03:59:15 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd48526503_1739591951
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB1IuSS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BGPhazard_v2.1.1-tikzDictionary"
