# Validation Report - factorstochvol@1.1.0
...
| export_help          | 37                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Gregor Kastner <gregor.kastner@aau.at>               |
...
|     | package                     | type      |
|:----|:----------------------------|:----------|
| 1   | GIGrvg (\>= 0.4)            | Imports   |
| 2   | Rcpp (\>= 1.0.0)            | Imports   |
| 3   | corrplot                    | Imports   |
| 4   | methods                     | Imports   |
| 5   | grDevices                   | Imports   |
| 6   | graphics                    | Imports   |
| 7   | stats                       | Imports   |
| 8   | utils                       | Imports   |
| 9   | stochvol (\>= 3.0.2)        | Imports   |
| 10  | Rcpp                        | LinkingTo |
| 11  | RcppArmadillo (\>= 0.9.900) | LinkingTo |
| 12  | stochvol                    | LinkingTo |
...
Overall the package has 37 exported objects. 37 are documented:
         ...
         comtimeplot       corelement     corimageplot           cormat 
                TRUE             TRUE             TRUE             TRUE 
             corplot      cortimeplot       covelement           covmat 
                TRUE             TRUE             TRUE             TRUE 
         covtimeplot           evdiag     expweightcov  facloadcredplot 
                TRUE             TRUE             TRUE             TRUE 
     facloaddensplot  facloadpairplot facloadpointplot facloadtraceplot 
                TRUE             TRUE             TRUE             TRUE 
        findrestrict        fsvsample           fsvsim        ledermann 
                TRUE             TRUE             TRUE             TRUE 
              logret   logvartimeplot       orderident    paratraceplot 
                TRUE             TRUE             TRUE             TRUE 
            plotalot         predcond          predcor          predcov 
                TRUE             TRUE             TRUE             TRUE 
               predh       predloglik     predloglikWB       predprecWB 
                TRUE             TRUE             TRUE             TRUE 
            preorder    runningcormat    runningcovmat        signident 
                TRUE             TRUE             TRUE             TRUE 
         voltimeplot 
                TRUE 
...
| Execution Time | 2025-02-19 05:06:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d456ac25025_1739941555
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3KCaM8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_factorstochvol_v1.1.0-tikzDictionary"
