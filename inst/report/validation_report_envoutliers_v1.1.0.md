# Validation Report - envoutliers@1.1.0
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Martina Campulova <martina.campulova@mendelu.cz>     |
...
Overall the package has 7 exported objects. 7 are documented:
     ...
     KRDetect.outliers.changepoint KRDetect.outliers.controlchart 
                              TRUE                           TRUE 
              KRDetect.outliers.EV         KRDetect.outliers.plot 
                              TRUE                           TRUE 
                          MRL.plot                      smoothing 
                              TRUE                           TRUE 
                    stability.plot 
...
| Execution Time | 2025-02-19 04:12:41 UTC |
...
running this report
    ...
    PROCESSX_PS1d455119c39c_1739938354
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHE4PLG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_envoutliers_v1.1.0-tikzDictionary"
