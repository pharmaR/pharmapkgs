# Validation Report - dynetNLAResistance@0.1.0
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jiaqi Tang <1107967177@qq.com>                       |
...
Overall the package has 6 exported objects. 6 are documented:
                   ...
                   anonymization               anonymize2node 
                            TRUE                         TRUE 
                            cost                   draw.graph 
                            TRUE                         TRUE 
                     lw.grouping make.virtual.dynamic.network 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-18 05:05:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44f559aee_1739855134
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpbf1q3B
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dynetNLAResistance_v0.1.0-tikzDictionary"
