# Validation Report - bitops@1.0.9
...
| has_source_control   | https://github.com/mmaechler/R-bitops        |
| has_bug_reports_url  | 1                                            |
| downloads_1yr        | 3574844                                      |
...
apng, bnstruct, caTools, cherry, CINdex, CorrectOverloadedPeaks, gDNAx,
GENEAread, geozoo, gepaf, GGIRread, ggmap, gt, gtExtras, IgorR, mapsapi,
multiCA, oro.nifti, osrmr, pkgload, R4CouchDB, rattle, RCurl, Rsamtools,
ryandexdirect, sysid, XML

## Namespace

Overall the package has 12 exported objects. 7 are documented:

          %&%       %^%      %<<%      %>>%       %|%    bitAnd   bitFlip     bitOr 
        FALSE     FALSE     FALSE     FALSE     FALSE      TRUE      TRUE      TRUE 
    bitShiftL bitShiftR    bitXor     cksum 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-15 04:18:44 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1151b327_1739593119
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0STG6R
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bitops_v1.0.9-tikzDictionary"
