# Validation Report - boxcoxmix@0.46
...
| export_help          | 7                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Iago Giné-Vázquez <iago.gin-vaz@protonmail.com> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://gitlab.com/iagogv/boxcoxmix             |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | statmod(\>= 1.4.27) | Imports |
| 2   | qicharts(\>= 0.5.4) | Imports |
| 3   | npmlreg(\>= 0.46-1) | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
          ...
          binomial    boxcoxpower     boxcoxtype   Kfind.boxcox   np.boxcoxmix 
...
| Execution Time | 2025-02-15 04:37:21 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2923fb4_1739594236
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0r8lFg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_boxcoxmix_v0.46-tikzDictionary"
