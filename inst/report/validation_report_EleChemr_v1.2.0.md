# Validation Report - EleChemr@1.2.0
...
| export_help | 13 |
| has_website | FALSE |
| has_maintainer | Federico Maria Vivaldi <federico-vivaldi@virgilio.it> |
...
Overall the package has 13 exported objects. 13 are documented:
      ...
      ChronAmp CottrCheck         CV       CVEC       CVEE       Derv     Gen_CV 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
        invMat     LinSwp     OneMat    ParCall    PotStep    ZeroMat 
...
| Execution Time | 2025-02-19 03:54:35 UTC |
...
running this report
    ...
    PROCESSX_PS1d451b23112f_1739937269
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRKYehs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EleChemr_v1.2.0-tikzDictionary"
