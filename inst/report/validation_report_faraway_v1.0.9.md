# Validation Report - faraway@1.0.9
...
| export_help          | 12                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Julian Faraway <jjf23@bath.ac.uk>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/julianfaraway/faraway             |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 134937                                               |
...
aglm, assessor, BAS, BayesVarSel, fastR2, mcen, nonnest2, parameters,
PAsso, QTOCen, RegrCoeffsExplorer, smallstuff, stripless

## Namespace

Overall the package has 11 exported objects. 12 are documented:

        Cpplot     fround   halfnorm     ilogit      logit    maxadjr    pfround 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
        prplot    qqnorml VarCorrmat        vif 
          TRUE       TRUE       TRUE       TRUE 

### Examples

There are 56 help pages with examples, from 154 (36.36 %).
...
| Execution Time | 2025-02-19 05:12:24 UTC |
...
running this report
    ...
    PROCESSX_PS1d4576f6f4fb_1739941937
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz53Fkg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_faraway_v1.0.9-tikzDictionary"
