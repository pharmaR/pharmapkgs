...
| export_help          | 20                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Akiru Kato <paithiov909@gmail.com>     |
| bugs_status          | subscript out of bounds                |
| size_codebase        | 759                                    |
| has_source_control   | https://github.com/paithiov909/audubon |
...
Overall the package has 20 exported objects. 20 are documented:
                ...
                bind_lr        bind_tf_idf2     collapse_tokens   get_dict_features 
                   TRUE                TRUE                TRUE                TRUE 
            lex_density         mute_tokens     ngram_tokenizer                pack 
                   TRUE                TRUE                TRUE                TRUE 
               prettify    read_rewrite_def strj_fill_iter_mark     strj_hiraganize 
                   TRUE                TRUE                TRUE                TRUE 
        strj_katakanize      strj_normalize strj_rewrite_as_def       strj_romanize 
                   TRUE                TRUE                TRUE                TRUE 
           strj_segment        strj_tinyseg       strj_tokenize strj_transcribe_num 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-14 07:32:11 UTC |
...
running this report
    ...
    PROCESSX_PS1c091d5066f7_1739518328
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpR9EVkD
