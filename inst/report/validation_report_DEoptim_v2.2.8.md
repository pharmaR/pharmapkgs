# Validation Report - DEoptim@2.2.8
...
| export_help          | 2                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Katharine Mullen <mullenkate@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/ArdiaD/DEoptim       |
| has_bug_reports_url  | 1                                       |
| downloads_1yr        | 130369                                  |
...
airGR, BayesianTools, BBEST, bgev, calibrar, carfima, CEGO, ConsReg,
ctsem, DDD, DMCfun, DMQ, dRiftDM, DstarM, EstimationTools, fungible,
FuzzyStatProb, galts, IDE, KSPM, Luminescence, micEconCES, mrf, MSCMT,
npsp, openEBGM, OSLdecomposition, phenex, phytools, PortfolioAnalytics,
prodest, quickpsy, RcppDE, Riemann, ROI.plugin.deoptim, rrscale,
selectMeta, SpaDES.tools, spsh, svars, TOU, trawl
...
| Execution Time | 2025-02-18 03:43:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4579b09cf_1739850193
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHjegbf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DEoptim_v2.2.8-tikzDictionary"
