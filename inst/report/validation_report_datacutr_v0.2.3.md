# Validation Report - datacutr@0.2.3
...
| export_help          | 10                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Tim Barnett <timothy.barnett@roche.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/pharmaverse/datacutr |
...
Overall the package has 10 exported objects. 10 are documented:
         ...
         apply_cut    create_dcut       date_cut drop_temp_vars impute_dcutdtc 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       impute_sdtm    process_cut         pt_cut       read_out special_dm_cut 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 04:57:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6377839a9_1739768223
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpl5venH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datacutr_v0.2.3-tikzDictionary"
