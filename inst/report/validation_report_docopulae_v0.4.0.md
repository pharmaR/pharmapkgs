# Validation Report - docopulae@0.4.0
...
| export_help | 41 |
| has_website | TRUE |
| has_maintainer | Andreas Rappold <arappold@gmx.at> |
| bugs_status | subscript out of bounds |
| has_source_control | http://www.tandfonline.com/doi/full/10.1080/02331888.2015.1111892 |
...
Overall the package has 41 exported objects. 41 are documented:
                            ...
                            buildf                    Defficiency 
                              TRUE                           TRUE 
                        Deriv2Logf                      DerivLogf 
                              TRUE                           TRUE 
                            design                   Dsensitivity 
                              TRUE                           TRUE 
                           fisherI                           getM 
                              TRUE                           TRUE 
                         grow.grid                     integrateA 
                              TRUE                           TRUE 
                  nint_expandSpace                   nint_funcDim 
                              TRUE                           TRUE 
                      nint_gridDim                 nint_integrate 
                              TRUE                           TRUE 
               nint_integrateNCube   nint_integrateNCube_cubature 
                              TRUE                           TRUE 
     nint_integrateNCube_integrate nint_integrateNCube_SparseGrid 
                              TRUE                           TRUE 
               nint_integrateNFunc  nint_integrateNFunc_recursive 
                              TRUE                           TRUE 
                      nint_intvDim                   nint_scatDim 
                              TRUE                           TRUE 
                        nint_space              nint_tanTransform 
                              TRUE                           TRUE 
                    nint_transform             nint_TYPE_FUNC_DIM 
                              TRUE                           TRUE 
                nint_TYPE_GRID_DIM             nint_TYPE_INTV_DIM 
                              TRUE                           TRUE 
                nint_TYPE_SCAT_DIM             nint_validateSpace 
                              TRUE                           TRUE 
                     numDeriv2Logf                   numDerivLogf 
                              TRUE                           TRUE 
                             param                         reduce 
                              TRUE                           TRUE 
                          rowmatch                       roworder 
...
| Execution Time | 2025-02-18 04:31:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4e20d8d_1739853079
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUavFrq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_docopulae_v0.4.0-tikzDictionary"
