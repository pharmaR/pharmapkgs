# Validation Report - fExtremes@4032.84
...
| export_help | 67 |
| has_website | TRUE |
| has_maintainer | Paul J. Northrop <p.northrop@ucl.ac.uk> |
...
AssocTests, CompDist, extremeStat, fitteR, lax

## Namespace

Overall the package has 67 exported objects. 59 are documented:

           .gevmleFit        .gevpwmFit     .gevrlevelLLH        .gummleFit 
                 TRUE             FALSE             FALSE             FALSE 
           .gumpwmFit       blockMaxima        blockTheta      clusterTheta 
                 TRUE              TRUE              TRUE              TRUE 
                 CVaR         deCluster              dgev              dgpd 
                 TRUE              TRUE              TRUE              TRUE 
              emdPlot     exindexesPlot       exindexPlot  ferrosegersTheta 
                 TRUE              TRUE              TRUE              TRUE 
        findThreshold            gevFit        gevMoments     gevrlevelPlot 
                 TRUE              TRUE              TRUE              TRUE 
               gevSim         gevSlider   ghMeanExcessFit  ghtMeanExcessFit 
                 TRUE              TRUE             FALSE             FALSE 
               gpdFit        gpdMoments          gpdQPlot      gpdQuantPlot 
                 TRUE              TRUE              TRUE              TRUE 
      gpdRiskMeasures      gpdSfallPlot      gpdShapePlot            gpdSim 
                 TRUE              TRUE              TRUE              TRUE 
            gpdSlider       gpdTailPlot         gumbelFit         gumbelSim 
                 TRUE              TRUE              TRUE              TRUE 
             hillPlot  hypMeanExcessFit           lilPlot            mePlot 
                 TRUE             FALSE              TRUE              TRUE 
              mrlPlot       msratioPlot           mxfPlot  nigMeanExcessFit 
                 TRUE              TRUE              TRUE             FALSE 
    normMeanExcessFit              pgev              pgpd      pointProcess 
                FALSE              TRUE              TRUE              TRUE 
                 qgev              qgpd      qqparetoPlot       recordsPlot 
                 TRUE              TRUE              TRUE              TRUE 
                 rgev              rgpd          runTheta     shaparmDEHaan 
                 TRUE              TRUE              TRUE              TRUE 
          shaparmHill   shaparmPickands       shaparmPlot          sllnPlot 
                 TRUE              TRUE              TRUE              TRUE 
        ssrecordsPlot          tailPlot          tailRisk        tailSlider 
                 TRUE              TRUE              TRUE              TRUE 
             thetaSim               VaR          xacfPlot 
                 TRUE              TRUE              TRUE 

### Examples

There are 12 help pages with examples, from 14 (85.71 %).
...
| Execution Time | 2025-02-27 03:27:25 UTC |
...
running this report
    ...
    PROCESSX_PS1c626d2b6116_1740626841
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqjaGzZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fExtremes_v4032.84-tikzDictionary"
