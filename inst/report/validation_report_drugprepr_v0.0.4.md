# Validation Report - drugprepr@0.0.4
...
Overall the package has 12 exported objects. 12 are documented:
      ...
      clean_duration close_small_gaps      compute_ndd        drug_prep 
                TRUE             TRUE             TRUE             TRUE 
     example_therapy           impute  impute_duration       impute_ndd 
                TRUE             TRUE             TRUE             TRUE 
          impute_qty isolate_overlaps   make_decisions   shift_interval 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:48:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43ffc3962_1739854116
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5pIrTw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drugprepr_v0.0.4-tikzDictionary"
