...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ehouarn Le Faou <ehouarnlefaou@orange.fr>            |
...
| 3   | RcppProgress (\>= 0.1) | Imports   |
| 4   | stats                  | Imports   |
| 5   | Rcpp                   | LinkingTo |
| 6   | RcppProgress           | LinkingTo |
...
Overall the package has 13 exported objects. 13 are documented:
           ...
           getCustomOutput             getRecords             getResults 
                      TRUE                   TRUE                   TRUE 
                  mutation               outFunct              setGenome 
                      TRUE                   TRUE                   TRUE 
         setMetapopulation      setMutationMatrix          setPopulation 
                      TRUE                   TRUE                   TRUE 
          setSelectNeutral     setSelectOnGametes setSelectOnGametesProd 
                      TRUE                   TRUE                   TRUE 
           setSelectOnInds 
                      TRUE 
...
There are 60 help pages with examples, from 65 (92.31 %).
...
| Execution Time | 2025-02-18 05:09:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47dc7ee11_1739855386
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3pvHvm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Ease_v0.1.2-tikzDictionary"
