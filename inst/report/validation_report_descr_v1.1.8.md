...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Jakson Aquino <jalvesaq@gmail.com>                   |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/jalvesaq/descr                    |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 104875                                               |
...
lulab.utils, pander, poliscidata, rattle, RCPA3, saebnocov

## Namespace

Overall the package has 14 exported objects. 14 are documented:

         compmeans       crosstab     CrossTable data.frame2txt          descr 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         file.head    forODFTable           freq       fromUTF8        fwf2csv 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          histkdnc       labels2R       LogRegR2         toUTF8 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 03:45:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bb48efef56_1739850353
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYy3fJi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_descr_v1.1.8-tikzDictionary"
