# Validation Report - bayesmix@0.7.6
...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Bettina Gruen <Bettina.Gruen@R-project.org>          |
...
Overall the package has 13 exported objects. 13 are documented:
              ...
              BMMdiag          BMMmodel     BMMposteriori         BMMpriors 
                 TRUE              TRUE              TRUE              TRUE 
              initsFS          JAGScall       JAGScontrol           JAGSrun 
                 TRUE              TRUE              TRUE              TRUE 
           priorsFish     priorsRaftery   priorsUncertain randomPermutation 
                 TRUE              TRUE              TRUE              TRUE 
                 Sort 
                 TRUE 
...
| Execution Time | 2025-02-15 03:38:08 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd29598ffd_1739590683
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyR4X1T
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesmix_v0.7.6-tikzDictionary"
