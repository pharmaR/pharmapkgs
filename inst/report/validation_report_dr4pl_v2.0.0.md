...
| export_help | 13 |
| has_website | TRUE |
| has_maintainer | Justin T. Landis <jtlandis314@gmail.com> |
| bugs_status | scraping bug reports fromm BugReports host ‘bitbucket’ not implemented |
| has_source_control | https://bitbucket.org/dittmerlab/dr4pl |
...
Overall the package has 13 exported objects. 13 are documented:
              ...
              augment         calculate             dr4pl       dr4pl_theta 
                 TRUE              TRUE              TRUE              TRUE 
       FindHillBounds  FindInitialParms FindLogisticGrids               gof 
                 TRUE              TRUE              TRUE              TRUE 
                   IC         LogToParm      MeanResponse  OutlierDetection 
                 TRUE              TRUE              TRUE              TRUE 
            ParmToLog 
                 TRUE 
...
| Execution Time | 2025-02-18 04:42:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4e22c13c_1739853746
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9MJGio
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dr4pl_v2.0.0-tikzDictionary"
