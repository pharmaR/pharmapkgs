# Validation Report - epiCleanr@0.2.0
...
| export_help          | 9                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Mohamed A. Yusuf <mohamedayusuf87@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/truenomad/epiCleanr       |
...
Overall the package has 9 exported objects. 9 are documented:
      ...
      clean_admin_names clean_names_strings   consistency_check         create_test 
                   TRUE                TRUE                TRUE                TRUE 
                 export     get_admin_names     handle_outliers              import 
                   TRUE                TRUE                TRUE                TRUE 
           missing_plot 
                   TRUE 
...
| Execution Time | 2025-02-19 04:14:59 UTC |
...
running this report
    ...
    PROCESSX_PS1d455bb32be_1739938493
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPLUD8I
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epiCleanr_v0.2.0-tikzDictionary"
