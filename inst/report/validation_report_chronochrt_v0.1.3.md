# Validation Report - chronochrt@0.1.3
...
| export_help          | 15                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Thomas Rose <thomas.rose@daad-alumni.de>    |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://gitlab.com/archaeothommy/chronochrt |
...
Overall the package has 15 exported objects. 14 are documented:
                     ...
                     %>%            add_chron      add_label_image 
                   FALSE                 TRUE                 TRUE 
          add_label_text      arrange_regions     convert_to_chron 
                    TRUE                 TRUE                 TRUE 
               corr_xmax      geom_chronochRt geom_chronochRtImage 
                    TRUE                 TRUE                 TRUE 
            import_chron     import_chron_csv   import_chron_delim 
                    TRUE                 TRUE                 TRUE 
      import_chron_excel      plot_chronochrt     theme_chronochrt 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:17:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36e2d3507_1739679417
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpu7KpLR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chronochrt_v0.1.3-tikzDictionary"
