...
| export_help | 40 |
| has_website | TRUE |
| has_maintainer | Philippe Verley <philippe.verley@ird.fr> |
| bugs_status | scraping bug reports fromm BugReports host ‘ird’ not implemented |
| size_codebase | 1269 |
...
Overall the package has 33 exported objects. 33 are documented:
          ...
          aboveCanopy       aboveGround       belowCanopy       belowGround 
                 TRUE              TRUE              TRUE              TRUE 
            butterfly            canopy      canopyHeight             clear 
                 TRUE              TRUE              TRUE              TRUE 
             computeG              crop            fillNA  getLocalVersions 
                 TRUE              TRUE              TRUE              TRUE 
         getMaxCorner      getMinCorner      getParameter       getPosition 
                 TRUE              TRUE              TRUE              TRUE 
    getRemoteVersions      getVoxelSize            ground   groundElevation 
                 TRUE              TRUE              TRUE              TRUE 
         groundEnergy               gui    installVersion     is.VoxelSpace 
                 TRUE              TRUE              TRUE              TRUE 
     plantAreaDensity    plantAreaIndex              plot             plotG 
                 TRUE              TRUE              TRUE              TRUE 
       readVoxelSpace     removeVersion               run          toRaster 
                 TRUE              TRUE              TRUE              TRUE 
      writeVoxelSpace 
                 TRUE 
...
| Execution Time | 2025-02-14 06:51:19 UTC |
...
running this report
    ...
    PROCESSX_PS726d7696dd02_1739515876
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7ghVie
