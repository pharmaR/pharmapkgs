...
Overall the package has 17 exported objects. 17 are documented:
     ...
     AOppvnpv    BDtest    CIlnpv  CIlnpvak    CIlppv  CIlppvak    CIpvBI   CIpvBII 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
    CombCInpv CombCIppv      nNPV      nPPV       nPV   plotnPV  plotnPV2     simPV 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
     simPVmat 
         TRUE 
...
| Execution Time | 2025-02-15 03:48:45 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5a1ecf37_1739591321
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp23gvKg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bdpv_v1.3-tikzDictionary"
