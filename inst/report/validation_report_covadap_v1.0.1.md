# Validation Report - covadap@1.0.1
...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Rosamarie Frieri <rosamarie.frieri2@unibo.it>        |
...
Overall the package has 23 exported objects. 23 are documented:
                    ...
                    BSD             BSD.sim               CABCD           CABCD.sim 
                   TRUE                TRUE                TRUE                TRUE 
                  DABCD           DABCD.sim        data_preproc               ECADE 
                   TRUE                TRUE                TRUE                TRUE 
              ECADE.sim                HuHu            HuHu.sim               Imb.m 
                   TRUE                TRUE                TRUE                TRUE 
              Imb.m.sim                 KER             KER.sim           p.inverse 
                   TRUE                TRUE                TRUE                TRUE 
                 PocSim          PocSim.sim       print_covadap print_mixed.covadap 
                   TRUE                TRUE                TRUE                TRUE 
        print_mixed.sim           print_sim     summary_covadap 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:06:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65c237b5e_1739765160
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZRLqq3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covadap_v1.0.1-tikzDictionary"
