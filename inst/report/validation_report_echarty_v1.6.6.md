# Validation Report - echarty@1.6.6
...
| export_help          | 16                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Larry Helgason <larry@helgasoft.com> |
| bugs_status          | 1                                    |
...
Overall the package has 16 exported objects. 16 are documented:
        ...
        ec.clmn     ec.data ec.fromJson     ec.init  ec.inspect    ec.paxis 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
      ec.plugjs    ec.theme      ec.upd     ec.util    ecr.band   ecr.ebars 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
       ecs.exec  ecs.output   ecs.proxy  ecs.render 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-19 03:31:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d4525b2cb24_1739935906
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp94Qen5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_echarty_v1.6.6-tikzDictionary"
