...
| export_help          | 48                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Isaac Ray <null@stat.tamu.edu>                       |
...
Overall the package has 48 exported objects. 47 are documented:

                ACV.lambda                bigGram                  cosso 
                      TRUE                   TRUE                   TRUE 
            cosso.Binomial              cosso.Cox     cosso.Cox.Parallel 
                      TRUE                   TRUE                   TRUE 
      cosso.Cox.Sequential         cosso.Gaussian               cosso.qr 
                      TRUE                   TRUE                   TRUE 
         cosso.qr.Parallel    cosso.qr.Sequential         cvlam.Gaussian 
                      TRUE                   TRUE                   TRUE 
            cvlam.logistic              cvsplitID            garrote.Cox 
                      TRUE                   TRUE                   TRUE 
          garrote.Logistic    garrote.Logistic.GH             garrote.qr 
                      TRUE                   TRUE                   TRUE 
                      genK               genK.cat     gradient.Hessian.C 
                      TRUE                   TRUE                   TRUE 
    gradient.Hessian.Theta                    kqr               My_solve 
                      TRUE                   TRUE                   TRUE 
               My_solve.QP             PartialLik             plot.cosso 
                      TRUE                   TRUE                   TRUE 
             predict.cosso                rescale                    rho 
                      TRUE                   TRUE                   TRUE 
                   RiskSet              SSANOVAwt     SSANOVAwt.Binomial 
                      TRUE                  FALSE                   TRUE 
             SSANOVAwt.Cox     SSANOVAwt.Gaussian           SSANOVAwt.qr 
                      TRUE                   TRUE                   TRUE 
                   sspline       sspline.Binomial            sspline.Cox 
                      TRUE                   TRUE                   TRUE 
                tune.cosso    tune.cosso.Binomial         tune.cosso.Cox 
                      TRUE                   TRUE                   TRUE 
       tune.cosso.Gaussian       twostep.Binomial            twostep.Cox 
                      TRUE                   TRUE                   TRUE 
          twostep.Gaussian             twostep.qr                 wsGram 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-24 03:22:02 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a7d636852_1740367318
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpvp1XBA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cosso_v2.1.2-tikzDictionary"
