...
| export_help          | 30                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Johannes B. Gruber <JohannesB.Gruber@gmail.com> |
| bugs_status          | subscript out of bounds                         |
| size_codebase        | 3399                                            |
| has_source_control   | https://github.com/JBGruber/atrrr               |
...
Overall the package has 30 exported objects. 30 are documented:
                      ...
                      auth     convert_at_to_http     convert_http_to_at 
                      TRUE                   TRUE                   TRUE 
               delete_post           delete_skeet                 follow 
                      TRUE                   TRUE                   TRUE 
           get_actor_likes               get_feed         get_feed_likes 
                      TRUE                   TRUE                   TRUE 
      get_feeds_created_by          get_followers            get_follows 
                      TRUE                   TRUE                   TRUE 
                 get_likes               get_list       get_own_timeline 
                      TRUE                   TRUE                   TRUE 
               get_replies            get_reposts get_skeets_authored_by 
                      TRUE                   TRUE                   TRUE 
          get_starter_pack             get_thread          get_user_info 
                      TRUE                   TRUE                   TRUE 
                      post             post_skeet            post_thread 
                      TRUE                   TRUE                   TRUE 
               search_feed            search_post           search_skeet 
                      TRUE                   TRUE                   TRUE 
               search_user             skeet_shot               unfollow 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-14 07:31:20 UTC |
...
running this report
    ...
    PROCESSX_PS1c093cfff4f2_1739518277
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdjZGib
