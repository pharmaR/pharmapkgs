# Validation Report - doconv@0.3.2
...
| export_help          | 12                                  |
| has_website          | FALSE                               |
| has_maintainer       | David Gohel <david.gohel@ardata.fr> |
...
flextable, mschart, officedown, officer

## Namespace

Overall the package has 12 exported objects. 12 are documented:

    check_libreoffice_export              docx_update                 docx2pdf 
                        TRUE                     TRUE                     TRUE 
         expect_snapshot_doc     expect_snapshot_html   init_working_directory 
                        TRUE                     TRUE                     TRUE 
          msoffice_available                 pptx2pdf     rm_working_directory 
                        TRUE                     TRUE                     TRUE 
                to_miniature                   to_pdf        working_directory 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-18 04:31:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41dbffdf4_1739853065
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpN3kJW2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doconv_v0.3.2-tikzDictionary"
