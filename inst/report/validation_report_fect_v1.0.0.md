...
| export_help          | 3                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Ziyi Liu <zyliu2020@uchicago.edu>                    |
...
| 3   | GGally (\>= 1.0.1)      | Imports   |
| 4   | doParallel (\>= 1.0.10) | Imports   |
| 5   | foreach (\>= 1.4.3)     | Imports   |
| 6   | abind (\>= 1.4-0)       | Imports   |
| 7   | MASS                    | Imports   |
| 8   | gridExtra               | Imports   |
| 9   | grid                    | Imports   |
| 10  | fixest                  | Imports   |
...
Overall the package has 3 exported objects. 3 are documented:
          ...
          fect get.cohort    interFE 
          TRUE       TRUE       TRUE 

### Examples

There are 6 help pages with examples, from 10 (60.00 %).
...
| Execution Time | 2025-02-27 03:25:27 UTC |
...
running this report
    ...
    PROCESSX_PS1c62be55947_1740626723
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpl8jX9H
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fect_v1.0.0-tikzDictionary"
