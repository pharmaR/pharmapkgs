# Validation Report - bootcluster@0.4.1
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tianmou Liu <tianmouliu@outlook.com>                 |
...
Overall the package has 13 exported objects. 13 are documented:
      ...
      ensemble.cluster.multi          esmbl.stability                 k.select 
                        TRUE                     TRUE                     TRUE 
                k.select_ref            min_agreement        network.stability 
                        TRUE                     TRUE                     TRUE 
    network.stability.output             ob.stability                 ref_dist 
                        TRUE                     TRUE                     TRUE 
                ref_dist_bin             ref_dist_pca                stability 
                        TRUE                     TRUE                     TRUE 
            threshold.select 
                        TRUE 
...
| Execution Time | 2025-02-15 04:33:18 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7fe84d80_1739593992
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOCjoEO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bootcluster_v0.4.1-tikzDictionary"
