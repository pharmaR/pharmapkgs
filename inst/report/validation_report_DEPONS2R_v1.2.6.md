# Validation Report - DEPONS2R@1.2.6
...
| export_help          | 39                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jacob Nabe-Nielsen <jnn@ecos.au.dk>                  |
...
Overall the package has 20 exported objects. 36 are documented:

       ais.to.DeponsShips              calib_01     check.DeponsShips 
                     TRUE                  TRUE                  TRUE 
           get.latest.sim           get.simtime  interpolate.ais.data 
                     TRUE                  TRUE                  TRUE 
           make.DeponsDyn make.stationary.ships        make.windfarms 
                     TRUE                  TRUE                  TRUE 
      read.DeponsBlockdyn        read.DeponsDyn   read.DeponsDynBatch 
                     TRUE                  TRUE                  TRUE 
         read.DeponsParam     read.DeponsRaster      read.DeponsShips 
                     TRUE                  TRUE                  TRUE 
         read.DeponsTrack read.DeponsTrackBatch          tick.to.time 
                     TRUE                  TRUE                  TRUE 
             time.to.tick                 write 
                     TRUE                 FALSE 
...
There are 42 help pages with examples, from 50 (84.00 %).
...
| Execution Time | 2025-02-18 03:44:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43e7566ab_1739850270
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMYNi7j
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DEPONS2R_v1.2.6-tikzDictionary"
