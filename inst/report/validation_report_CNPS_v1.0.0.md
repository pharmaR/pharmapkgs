...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | JiaSheng Zhang <zhangjiasheng0509@outlook.com>       |
...
Overall the package has 10 exported objects. 10 are documented:
                ...
                cip       corr_test           emcdf    ksample_test MultiDimen_test 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      pairwise_test     permu_table        RMD_test    siegel_tukey  twosample_test 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-16 04:47:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34dadb6e7_1739681268
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprahkZ3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CNPS_v1.0.0-tikzDictionary"
