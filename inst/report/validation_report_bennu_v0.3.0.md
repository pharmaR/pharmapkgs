...
| export_help          | 7                                  |
| has_website          | TRUE                               |
| has_maintainer       | Mike Irvine <mike.irvine@bccdc.ca> |
...
| 18  | RcppParallel (\>= 5.0.1)  | LinkingTo |
...
Overall the package has 7 exported objects. 6 are documented:

                       %>%           est_naloxone       est_naloxone_vec 
                     FALSE                   TRUE                   TRUE 
       generate_model_data      kit_summary_table model_random_walk_data 
                      TRUE                   TRUE                   TRUE 
              plot_kit_use 
                      TRUE 
...
| Execution Time | 2025-02-15 03:53:27 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6fffa219_1739591603
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpF71isj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bennu_v0.3.0-tikzDictionary"
