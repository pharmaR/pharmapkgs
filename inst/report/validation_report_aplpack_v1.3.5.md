...
Overall the package has 19 exported objects. 18 are documented:

               bagplot      bagplot.pairs          boxplot2D    compute.bagplot 
                  TRUE               TRUE               TRUE               TRUE 
                 faces            gslider             hdepth           iconplot 
                  TRUE               TRUE               TRUE               TRUE 
          plot.bagplot         plot.faces         plot.faces          plothulls 
                  TRUE               TRUE               TRUE               TRUE 
           plotsummary            puticon       skyline.hist             slider 
                 FALSE               TRUE               TRUE               TRUE 
                spin3R          stem.leaf stem.leaf.backback 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-14 07:18:24 UTC |
...
running this report
    ...
    PROCESSX_PS1c093db1c627_1739517502
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOJC86y
