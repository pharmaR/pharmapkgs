# Validation Report - declared@0.25
...
| bugs_status          | 1                                     |
| has_source_control   | https://github.com/dusadrian/declared |
...
Overall the package has 38 exported objects. 38 are documented:
       ...
       anyNAdeclared       anyNAempty       anyTagged_      as.declared 
                TRUE             TRUE             TRUE             TRUE 
            as.haven         declared          drop_na  format_declared 
                TRUE             TRUE             TRUE             TRUE 
             getTag_          hasTag_      is.declared         is.empty 
                TRUE             TRUE             TRUE             TRUE 
               label          label<-         labels<-         makeTag_ 
                TRUE             TRUE             TRUE             TRUE 
         measurement    measurement<-    missing_range  missing_range<- 
                TRUE             TRUE             TRUE             TRUE 
      missing_values missing_values<-     names_values   order_declared 
                TRUE             TRUE             TRUE             TRUE 
           undeclare     value_labels   variable_label        w_fivenum 
                TRUE             TRUE             TRUE             TRUE 
               w_IQR           w_mean         w_median           w_mode 
                TRUE             TRUE             TRUE             TRUE 
          w_quantile             w_sd    w_standardize        w_summary 
                TRUE             TRUE             TRUE             TRUE 
             w_table            w_var 
                TRUE             TRUE 
...
| Execution Time | 2025-02-18 03:32:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41e1bcc58_1739849551
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWjvtYO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_declared_v0.25-tikzDictionary"
