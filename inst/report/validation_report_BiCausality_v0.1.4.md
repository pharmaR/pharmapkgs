# Validation Report - BiCausality@0.1.4
...
| export_help          | 20                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Chainarong Amornbunchornvej <grandca@gmail.com> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/DarkEyes/BiCausality         |
...
Overall the package has 20 exported objects. 20 are documented:
                     ...
                     adjustmentProb                   assocSignTest 
                               TRUE                            TRUE 
                            bin2dec                       bIndpTest 
                               TRUE                            TRUE 
                bSCMCausalGraphFunc      bSCMdeConfoundingGraphFunc 
                               TRUE                            TRUE 
          bSCMDepndentGraphFastFunc           bSCMDepndentGraphFunc 
                               TRUE                            TRUE 
           CausalGraphInferMainFunc comparePredAdjMatrix2TrueAdjMat 
                               TRUE                            TRUE 
                           CondProb                     confNetFunc 
                               TRUE                            TRUE 
                  getReachableNodes         getTransitiveClosureMat 
                               TRUE                            TRUE 
                           indpFunc                        num2Bits 
                               TRUE                            TRUE 
                        oddDiffFunc                    oddRatioFunc 
                               TRUE                            TRUE 
                               supp                    VecAlignment 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-15 04:01:40 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6a33dc45_1739592095
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwJykAM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BiCausality_v0.1.4-tikzDictionary"
