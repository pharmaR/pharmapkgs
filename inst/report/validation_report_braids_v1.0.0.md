# Validation Report - braids@1.0.0
...
| has_source_control   | https://github.com/stla/braids             |
...
Overall the package has 20 exported objects. 20 are documented:
            ...
            allBraidWords allPositiveBraidWords            braidASCII 
                     TRUE                  TRUE                  TRUE 
         braidPermutation   bronfmanPolynomials     composeManyBraids 
                     TRUE                  TRUE                  TRUE 
         composeTwoBraids           doubleSigma   freeReduceBraidWord 
                     TRUE                  TRUE                  TRUE 
                halfTwist          inverseBraid    isPermutationBraid 
                     TRUE                  TRUE                  TRUE 
      isPositiveBraidWord           isPureBraid         linkingMatrix 
                     TRUE                  TRUE                  TRUE 
                  mkBraid       numberOfStrands      permutationBraid 
                     TRUE                  TRUE                  TRUE 
            strandLinking                   tau 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-15 04:40:29 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd32b894b2_1739594424
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoZTznU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_braids_v1.0.0-tikzDictionary"
