# Validation Report - codecountR@0.0.4.7
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Philippe Cohard <p.cohard@laposte.net>               |
...
Overall the package has 14 exported objects. 14 are documented:
     ...
     analysCodesList        bootStrap        BoxAndCox     BoxMullerGen 
                TRUE             TRUE             TRUE             TRUE 
           codeCount        congruGen             cooc        loadCodes 
                TRUE             TRUE             TRUE             TRUE 
          normMinMax       robustScal subCalcBoxAndCox        testPairs 
                TRUE             TRUE             TRUE             TRUE 
        tokenization           zScore 
                TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:51:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3439b1e6_1739681490
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0gqjXD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_codecountR_v0.0.4.7-tikzDictionary"
