# Validation Report - fdapaceShiny@1.0.5
...
| export_help          | 1                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Camden Possinger <cpossinger@ucdavis.edu>  |
| bugs_status          | 1                                          |
| has_source_control   | https://github.com/cpossinger/fdapaceShiny |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | config (\>= 0.3.1) | Imports |
| 2   | dplyr              | Imports |
| 3   | DT                 | Imports |
| 4   | fdapace            | Imports |
| 5   | ggplot2            | Imports |
| 6   | golem (\>= 0.3.1)  | Imports |
| 7   | htmltools          | Imports |
| 8   | magrittr           | Imports |
...
| Execution Time | 2025-02-27 03:22:29 UTC |
...
running this report
    ...
    PROCESSX_PS1c625988e269_1740626546
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUJDfmK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fdapaceShiny_v1.0.5-tikzDictionary"
