...
| export_help          | 17                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Carlos Prieto <cprietos@usal.es>                     |
...
Overall the package has 17 exported objects. 17 are documented:
             ...
             createAssembly       gbk2genomebrowser           genome_addGFF 
                       TRUE                    TRUE                    TRUE 
         genome_addSequence         genome_addTrack           genome_addVCF 
                       TRUE                    TRUE                    TRUE 
     genome_createLocalMode genome_createServerMode           genomebrowser 
                       TRUE                    TRUE                    TRUE 
                  genomemap    getAssemblyFromFasta                  GRCh37 
                       TRUE                    TRUE                    TRUE 
               GRCh37.bands                  GRCh38            GRCh38.bands 
                       TRUE                    TRUE                    TRUE 
                     NCBI36            segmentation 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-17 04:48:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65a11d82_1739767678
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5FohVf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_D3GB_v2.0-tikzDictionary"
