# Validation Report - broom.mixed@0.2.9.6
...
| has_source_control   | https://github.com/bbolker/broom.mixed |
| has_bug_reports_url  | 1                                      |
| downloads_1yr        | 306509                                 |
...
autostats, broom.helpers, card, cardx, CellaRepertorium, censcyt,
equatiomatic, eyetrackingR, faux, flextable, gglm, ggpmisc, glmmfields,
glmmTMB, gtsummary, huxtable, interactions, jlme, jlmerclusterperm,
jtools, konfound, merTools, mice, micemd, midasHLA, mmiCATs,
modelsummary, mtscr, nlmixr2est, panelr, parameters, rdss, scdtb,
sfislands, specr, StroupGLMM, swaprinc, TidyConsultant, webSDM

## Namespace

Overall the package has 8 exported objects. 8 are documented:

               augment        get_methods             glance paramNamesMCMCglmm 
                  TRUE               TRUE               TRUE               TRUE 
           ranefLevels           stdranef               tidy           tidyMCMC 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:46:34 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd702bd00a_1739594789
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQy05ey
...
These are the options set to generate the report:
    ...
    [1] "validation_report_broom.mixed_v0.2.9.6-tikzDictionary"
