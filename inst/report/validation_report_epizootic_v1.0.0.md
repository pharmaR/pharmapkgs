# Validation Report - epizootic@1.0.0
...
| export_help          | 11                                          |
| has_website          | TRUE                                        |
| has_maintainer       | July Pilowsky <pilowskyj@caryinstitute.org> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/viralemergence/epizootic |
...
|     | package                 | type      |
|:----|:------------------------|:----------|
| 1   | purrr (\>= 1.0.0)       | Imports   |
| 2   | dplyr (\>= 1.1.3)       | Imports   |
| 3   | tibble (\>= 3.2.1)      | Imports   |
| 4   | R6 (\>= 2.5.1)          | Imports   |
| 5   | cli (\>= 3.6.1)         | Imports   |
| 6   | raster (\>= 3.6)        | Imports   |
| 7   | qs (\>= 0.25.7)         | Imports   |
| 8   | poems (\>= 1.1.0)       | Imports   |
| 9   | doParallel (\>= 1.0.16) | Imports   |
| 10  | foreach (\>= 1.5.1)     | Imports   |
| 11  | Rcpp                    | Imports   |
| 12  | Rcpp                    | LinkingTo |
...
Overall the package has 11 exported objects. 11 are documented:
             ...
             aspatial_siri check_simulator_inputs      disease_dispersal 
                      TRUE                   TRUE                   TRUE 
           disease_results      disease_simulator disease_transformation 
                      TRUE                   TRUE                   TRUE 
       disease_transitions           DiseaseModel      SimulationHandler 
                      TRUE                   TRUE                   TRUE 
         siri_model_summer      siri_model_winter 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-19 04:20:26 UTC |
...
running this report
    ...
    PROCESSX_PS1d453df5e3bf_1739938819
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAOSTIp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epizootic_v1.0.0-tikzDictionary"
