...
| export_help          | 25                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Almut E. D. Veraart <a.veraart@imperial.ac.uk>       |
...
Overall the package has 25 exported objects. 25 are documented:
                          ...
                          acf_Exp                        acf_LM 
                             TRUE                          TRUE 
                        acf_supIG                AddSlices_Rcpp 
                             TRUE                          TRUE 
           AddWeightedSlices_Rcpp           asymptotic_variance 
                             TRUE                          TRUE 
          asymptotic_variance_est                         c4est 
                             TRUE                          TRUE 
                         LebA_est                LebA_slice_est 
                             TRUE                          TRUE 
    LebA_slice_ratio_est_acfbased                        my_mae 
                             TRUE                          TRUE 
                           my_mse                    my_results 
                             TRUE                          TRUE 
                  nonpar_trawlest                            rq 
                             TRUE                          TRUE 
               sim_weighted_trawl        sim_weighted_trawl_gen 
                             TRUE                          TRUE 
                    test_asymnorm             test_asymnorm_est 
                             TRUE                          TRUE 
                      trawl_deriv               trawl_deriv_mod 
                             TRUE                          TRUE 
                        trawl_Exp                      trawl_LM 
                             TRUE                          TRUE 
                      trawl_supIG 
...
| Execution Time | 2025-02-14 06:51:39 UTC |
...
running this report
    ...
    PROCESSX_PS726d65688477_1739515896
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmppjdvfz
