# Validation Report - csmGmm@0.3.0
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ryan Sun <ryansun.work@gmail.com>                    |
...
Overall the package has 14 exported objects. 14 are documented:
                   ...
                   calc_dens_cor             calc_dens_ind_2d 
                            TRUE                         TRUE 
                calc_dens_ind_3d       calc_dens_ind_multiple 
                            TRUE                         TRUE 
               check_incongruous                      find_2d 
                            TRUE                         TRUE 
                         find_3d               find_max_means 
                            TRUE                         TRUE 
                 symm_fit_cor_EM      symm_fit_cor_EM_fulllik 
                            TRUE                         TRUE 
    symm_fit_cor_EM_noAssumption          symm_fit_cor_EM_rho 
                            TRUE                         TRUE 
                 symm_fit_ind_EM symm_fit_ind_EM_noAssumption 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-17 04:31:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bd672440363_1739766657
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLoTsng
...
These are the options set to generate the report:
    ...
    [1] "validation_report_csmGmm_v0.3.0-tikzDictionary"
