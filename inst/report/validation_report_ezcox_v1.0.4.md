...
| export_help          | 19                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Shixiang Wang <w_shixiang@163.com>    |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/ShixiangWang/ezcox |
...
ggpolar, UCSCXenaShiny

## Namespace

Overall the package has 19 exported objects. 18 are documented:

                 :=           .data             %>%        as_label         as_name 
               TRUE            TRUE           FALSE            TRUE            TRUE 
    clean_model_dir           enquo          enquos            expr           ezcox 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        ezcox_group  ezcox_parallel    filter_ezcox        forester      get_models 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        show_forest     show_models             sym            syms 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 05:00:09 UTC |
...
running this report
    ...
    PROCESSX_PS1d451aa562af_1739941203
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpoe1R7y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ezcox_v1.0.4-tikzDictionary"
