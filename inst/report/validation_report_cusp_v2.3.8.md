...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Raoul P. P. P. Grasman <rgrasman@uva.nl>             |
...
Overall the package has 14 exported objects. 14 are documented:
                   ...
                   cusp         cusp.bifset        cusp.extrema         cusp.logist 
                   TRUE                TRUE                TRUE                TRUE 
                 cusp3d      cusp3d.surface               dcusp    draw.cusp.bifset 
                   TRUE                TRUE                TRUE                TRUE 
                  pcusp plotCuspBifurcation   plotCuspDensities plotCuspResidfitted 
                   TRUE                TRUE                TRUE                TRUE 
                  qcusp               rcusp 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:41:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bd651fbd842_1739767273
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDIF3g8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cusp_v2.3.8-tikzDictionary"
