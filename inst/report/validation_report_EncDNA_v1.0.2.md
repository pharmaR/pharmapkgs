# Validation Report - EncDNA@1.0.2
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Prabina Kumar Meher <meherprabin@yahoo.com>          |
...
Overall the package has 15 exported objects. 15 are documented:
           ...
           APR.Feature      Bayes.Feature    Density.Feature    Maldoss.Feature 
                  TRUE               TRUE               TRUE               TRUE 
           MM1.Feature        MM2.Feature    MN.Fdtf.Feature    PN.Fdtf.Feature 
                  TRUE               TRUE               TRUE               TRUE 
           POS.Feature    Predoss.Feature        SAE.Feature     Sparse.Feature 
                  TRUE               TRUE               TRUE               TRUE 
    Trint.Dist.Feature        WAM.Feature        WMM.Feature 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:05:56 UTC |
...
running this report
    ...
    PROCESSX_PS1d4511533f11_1739937950
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb4a0A9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EncDNA_v1.0.2-tikzDictionary"
