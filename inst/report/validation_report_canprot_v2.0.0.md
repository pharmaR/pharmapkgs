# Validation Report - canprot@2.0.0
...
| has_source_control   | https://github.com/jedick/canprot                    |
...
Overall the package has 41 exported objects. 41 are documented:
             ...
             add_cld         add_hull          B20Cost     calc_metrics 
                TRUE             TRUE             TRUE             TRUE 
             canprot             CLES             Cost         count_aa 
                TRUE             TRUE             TRUE             TRUE 
               cplab          Density FermentativeCost            GRAVY 
                TRUE             TRUE             TRUE             TRUE 
             H11Cost               HC         human_aa               MW 
                TRUE             TRUE             TRUE             TRUE 
                  nC               NC             nH2O            nH2Og 
                TRUE             TRUE             TRUE             TRUE 
                 nO2             nO2g               OC               pI 
             ...
             plength              pMW              pnC              pS0 
                TRUE             TRUE             TRUE             TRUE 
                 pV0       read_fasta  RespiratoryCost               S0 
                TRUE             TRUE             TRUE             TRUE 
                 S0g               SC           sum_aa               SV 
                TRUE             TRUE             TRUE             TRUE 
                  V0              V0g          Y20Cost               Zc 
...
| Execution Time | 2025-02-16 03:38:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32f0faf95_1739677101
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpilfwTJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_canprot_v2.0.0-tikzDictionary"
