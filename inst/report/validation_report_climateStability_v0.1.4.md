# Validation Report - climateStability@0.1.4
...
| export_help          | 5                                                |
| has_website          | TRUE                                             |
| has_maintainer       | Hannah Owens <hannah.owens@gmail.com>            |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/hannahlowens/climateStability |
...
Overall the package has 5 exported objects. 5 are documented:
      ...
      absLatitudinalMean deviationThroughTime      latitudinalMean 
                    TRUE                 TRUE                 TRUE 
             rescale0to1        stabilityCalc 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:31:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34ceebec7_1739680260
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmps2J8Wc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_climateStability_v0.1.4-tikzDictionary"
