...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Matteo Quartagno <m.quartagno@ucl.ac.uk>             |
...
Overall the package has 4 exported objects. 4 are documented:
         ...
         figure.modify.margin            sample.size.NI simulations.modify.margin 
                         TRUE                      TRUE                      TRUE 
                      test.NI 
                         TRUE 
...
| Execution Time | 2025-02-17 04:53:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64d246da9_1739768009
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptJu1gE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dani_v0.1.1-tikzDictionary"
