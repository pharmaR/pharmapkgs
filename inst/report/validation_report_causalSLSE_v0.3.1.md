# Validation Report - causalSLSE@0.3.1
...
| export_help          | 32                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Pierre Chausse Developer <pchausse@uwaterloo.ca>     |
...
Overall the package has 32 exported objects. 31 are documented:

                  as.model             causalSLSE             causalSLSE 
                      TRUE                   TRUE                   TRUE 
       causalSLSE.cslseFit  causalSLSE.cslseModel     causalSLSE.formula 
                      TRUE                   TRUE                   TRUE 
                cslseModel                estSLSE     estSLSE.cslseModel 
                      TRUE                   TRUE                   TRUE 
                   extract              llSplines   llSplines.cslseModel 
                     FALSE                   TRUE                   TRUE 
       llSplines.slseModel          plot.cslseFit           plot.slseFit 
                      TRUE                   TRUE                   TRUE 
          predict.cslseFit        predict.slseFit            print.cslse 
                      TRUE                   TRUE                   TRUE 
            print.cslseFit       print.cslseModel          print.slseFit 
                      TRUE                   TRUE                   TRUE 
           print.slseKnots    print.summary.cslse print.summary.cslseFit 
                      TRUE                   TRUE                   TRUE 
     print.summary.slseFit                selSLSE     selSLSE.cslseModel 
                      TRUE                   TRUE                   TRUE 
                 slseKnots              slseModel          summary.cslse 
                      TRUE                   TRUE                   TRUE 
          summary.cslseFit        summary.slseFit 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-22 03:21:33 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb6b8545af_1740194489
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5OsvOH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causalSLSE_v0.3.1-tikzDictionary"
