...
| export_help          | 2                                                 |
| has_website          | FALSE                                             |
| has_maintainer       | Raphael Bonnet <raphael.bonnet@univ-cotedazur.fr> |
...
| 2   | limma         | Imports |
| 3   | utils         | Imports |
| 4   | org.Hs.eg.db  | Imports |
| 5   | AnnotationDbi | Imports |
| 6   | parallel      | Imports |
| 7   | foreach       | Imports |
| 8   | readr         | Imports |
| 9   | RCurl         | Imports |
...
Overall the package has 2 exported objects. 2 are documented:
    ...
    convert_symbols  update_symbols 
               TRUE            TRUE 
...
| Execution Time | 2025-02-14 06:48:17 UTC |
...
running this report
    ...
    PROCESSX_PS726d5106e9c_1739515694
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQPXeDJ
