# Validation Report - Ckmeans.1d.dp@4.3.5
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Joe Song <joemsong@cs.nmsu.edu>                      |
...
autostats, bakR, CellBarcode, clusterHD, DiffXTables, FunChisq,
GenomicOZone, GridOnClusters, Harman, kcmeans, mapsf, OptCirClust,
SILFS, SPECK, STREAK, TidyConsultant, weitrix, xgboost

## Namespace

Overall the package has 13 exported objects. 13 are documented:

                        ahist             Ckmeans.1d.dp            Ckmedian.1d.dp 
                         TRUE                      TRUE                      TRUE 
                 Cksegs.1d.dp          MultiChannel.WUC        plot.Ckmeans.1d.dp 
                         TRUE                      TRUE                      TRUE 
          plot.Ckmedian.1d.dp         plot.Cksegs.1d.dp plot.MultiChannelClusters 
                         TRUE                      TRUE                      TRUE 
                      plotBIC       print.Ckmeans.1d.dp      print.Ckmedian.1d.dp 
                         TRUE                      TRUE                      TRUE 
           print.Cksegs.1d.dp 
                         TRUE 
...
| Execution Time | 2025-02-16 04:25:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34650c523_1739679907
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeAl3On
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Ckmeans.1d.dp_v4.3.5-tikzDictionary"
