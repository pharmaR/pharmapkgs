# Validation Report - DBItest@1.8.2
...
| has_source_control   | https://github.com/r-dbi/DBItest  |
...
| 8   | methods              | Imports |
| 9   | nanoarrow            | Imports |
| 10  | palmerpenguins       | Imports |
| 11  | rlang (\>= 0.2.0)    | Imports |
| 12  | testthat (\>= 2.0.0) | Imports |
| 13  | utils                | Imports |
| 14  | withr                | Imports |
...
adbi, DatabaseConnector, DBI, duckdb, odbc, RGreenplum, RMariaDB,
RPostgres, RSQLite, sergeant

## Namespace

Overall the package has 16 exported objects. 16 are documented:

     get_default_context         make_context  set_default_context 
                    TRUE                 TRUE                 TRUE 
                test_all           test_arrow      test_compliance 
                    TRUE                 TRUE                 TRUE 
         test_connection          test_driver test_getting_started 
                    TRUE                 TRUE                 TRUE 
               test_meta          test_result            test_some 
                    TRUE                 TRUE                 TRUE 
                test_sql          test_stress     test_transaction 
                    TRUE                 TRUE                 TRUE 
                  tweaks 
                    TRUE 
...
There are 15 help pages with examples, from 60 (25.00 %).
...
| Execution Time | 2025-02-17 05:06:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62c7cafba_1739768798
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyiltI1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DBItest_v1.8.2-tikzDictionary"
