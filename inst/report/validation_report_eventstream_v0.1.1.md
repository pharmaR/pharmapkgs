# Validation Report - eventstream@0.1.1
...
Overall the package has 13 exported objects. 13 are documented:
    ...
    extract_event_ftrs         gen_stream       get_clusters    get_clusters_3d 
                  TRUE               TRUE               TRUE               TRUE 
          get_features    get_features_3d        predict_tdl       spline_stats 
                  TRUE               TRUE               TRUE               TRUE 
              stats_3d  stream_from_files        td_logistic     tune_cpdbee_2D 
                  TRUE               TRUE               TRUE               TRUE 
        tune_cpdbee_3D 
                  TRUE 
...
| Execution Time | 2025-02-19 04:40:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d4540cc793e_1739940026
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkxoTwm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eventstream_v0.1.1-tikzDictionary"
