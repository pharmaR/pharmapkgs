# Validation Report - eimpute@0.2.4
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Zhe Gao <gaozh8@mail.ustc.edu.cn>                    |
...
Overall the package has 5 exported objects. 5 are documented:
                 ...
                 biscale      biscale.control              eimpute 
                    TRUE                 TRUE                 TRUE 
    incomplete.generator             r.search 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-19 03:52:13 UTC |
...
running this report
    ...
    PROCESSX_PS1d4571927b86_1739937127
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3q04Po
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eimpute_v0.2.4-tikzDictionary"
