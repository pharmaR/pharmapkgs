# Validation Report - besthr@0.3.2
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Dan MacLean <dan.maclean@tsl.ac.uk>                  |
...
Overall the package has 5 exported objects. 4 are documented:
           ...
           %>%   estimate  make_data make_data2 make_data3 
...
| Execution Time | 2025-02-15 03:54:30 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7e4bef3d_1739591666
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoVk5yb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_besthr_v0.3.2-tikzDictionary"
