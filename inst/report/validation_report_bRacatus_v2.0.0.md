# Validation Report - bRacatus@2.0.0
...
| export_help          | 16                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Eduardo Arlé <eduardoarle@tauex.tau.ac.il> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/EduardoArle/bRacatus    |
...
| 5   | jsonlite      | Imports |
| 6   | methods       | Imports |
| 7   | plotfunctions | Imports |
| 8   | raster        | Imports |
| 9   | rgbif         | Imports |
| 10  | rnaturalearth | Imports |
| 11  | sf            | Imports |
| 12  | sp            | Imports |
| 13  | stats         | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
              ...
              accuracy availableCountries       biogeoStatus   countryChecklist 
                  TRUE               TRUE               TRUE               TRUE 
                getOcc        giftRegions            giveOcc        giveRegions 
                  TRUE               TRUE               TRUE               TRUE 
         glonafRegions   occSpatialPoints       plotAccuracy   plotBiogeoStatus 
                  TRUE               TRUE               TRUE               TRUE 
               plotOcc         plotRefReg          rangeMaps  signalCalculation 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:39:38 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1b53db3f_1739594373
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvOYWzT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bRacatus_v2.0.0-tikzDictionary"
