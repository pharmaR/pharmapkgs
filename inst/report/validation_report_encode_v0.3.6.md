# Validation Report - encode@0.3.6
...
metaplot, nonmemica, spec, yamlet

## Namespace

Overall the package has 6 exported objects. 6 are documented:

    as_factor     codes    decode   decodes    encode   encoded 
...
| Execution Time | 2025-02-19 04:06:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d45423660e3_1739937963
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpyacu8T
...
These are the options set to generate the report:
    ...
    [1] "validation_report_encode_v0.3.6-tikzDictionary"
