# Validation Report - envnames@0.4.1
...
| export_help          | 13                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Daniel Mastropietro <mastropi@uwalumni.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/mastropi/envnames        |
...
Overall the package has 13 exported objects. 13 are documented:
                  ...
                  address      environment_name          get_env_name 
                     TRUE                  TRUE                  TRUE 
            get_env_names       get_fun_calling get_fun_calling_chain 
                     TRUE                  TRUE                  TRUE 
              get_fun_env          get_fun_name       get_obj_address 
                     TRUE                  TRUE                  TRUE 
             get_obj_name         get_obj_value              obj_find 
                     TRUE                  TRUE                  TRUE 
                  testenv 
                     TRUE 
...
| Execution Time | 2025-02-19 04:12:20 UTC |
...
running this report
    ...
    PROCESSX_PS1d456917db5b_1739938334
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUasydK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_envnames_v0.4.1-tikzDictionary"
