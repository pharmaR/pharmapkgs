...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Trevor Olsen <trevor@numerious.com>                  |
...
Overall the package has 4 exported objects. 4 are documented:
         ...
         create_tree        eval_text        eval_tree find_parenthesis 
                TRUE             TRUE             TRUE             TRUE 

### Examples

There are 4 help pages with examples, from 12 (33.33 %).
...
| Execution Time | 2025-02-19 04:37:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d4531c93dea_1739939871
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbTflah
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evalR_v0.0.1-tikzDictionary"
