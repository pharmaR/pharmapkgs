...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jeff Gill <jgill5402@mac.com>                        |
...
Overall the package has 21 exported objects. 21 are documented:
                         ...
                         bcp            biv.norm.post               china.wars 
                        TRUE                     TRUE                     TRUE 
                  dmultinorm            durations.hpd               expo.gibbs 
                        TRUE                     TRUE                     TRUE 
                 expo.metrop                  hit.run       logit.posterior.ll 
                        TRUE                     TRUE                     TRUE 
                  metropolis           norm.known.var      normal.posterior.ll 
                        TRUE                     TRUE                     TRUE 
    normal.posterior.summary              plot_walk_G             plot_walk_MH 
                        TRUE                     TRUE                     TRUE 
         probit.posterior.ll               rmultinorm                   romney 
                        TRUE                     TRUE                     TRUE 
                         sir               t_ci_table           t_posterior.ll 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-14 07:41:08 UTC |
...
running this report
    ...
    PROCESSX_PS1c091f62965c_1739518865
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4fnfWz
