# Validation Report - ClassDiscovery@3.4.5
...
| export_help          | 27                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Kevin R. Coombes <krc@silicovore.com>                |
...
GenAlgo, Mercator, Modeler, parameters, PCDimension, plasma,
rnaCrosslinkOO, RPointCloud, Thresher

## Namespace

Overall the package has 17 exported objects. 17 are documented:

              aspectHeatmap    BootstrapClusterTest                cluster3 
                       TRUE                    TRUE                    TRUE 
                  cutHclust               cutKmeans                  cutPam 
                       TRUE                    TRUE                    TRUE 
          cutRepeatedKmeans          distanceMatrix                 GenePCA 
                       TRUE                    TRUE                    TRUE 
              mahalanobisQC                  Mosaic                 PCanova 
                       TRUE                    TRUE                    TRUE 
                        pcc PerturbationClusterTest     plotColoredClusters 
                       TRUE                    TRUE                    TRUE 
             repeatedKmeans               SamplePCA 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-16 04:26:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35a286e08_1739679992
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1vKMCa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClassDiscovery_v3.4.5-tikzDictionary"
