# Validation Report - extraoperators@0.3.0
...
| export_help          | 66                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Joshua F. Wiley <jwiley.psych@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/JWiley/extraoperators |
...
brmsmargins, JWileymisc, multilevelcoda, multilevelTools

## Namespace

Overall the package has 66 exported objects. 0 are documented:

     %!grepl%     %!in%     %?!=% %?!grepl%    %?!in%     %?==%      %?c%      %?e% 
        FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE 
         %?g%     %?ge%    %?gel%   %?gele%     %?gl%    %?gle%  %?grepl%     %?in% 
        FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE 
         %?l%     %?le%    %?nin%     %a!=% %a!grepl%    %a!in%     %a==%      %ac% 
        FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE 
         %ae%      %ag%     %age%    %agel%   %agele%     %agl%    %agle%  %agrepl% 
        FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE 
        %ain%      %al%     %ale%    %anin%       %c%       %e%  %flipIn%       %g% 
        FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE 
         %ge%     %gel%    %gele%      %gl%     %gle%   %grepl%       %l%      %le% 
        FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE 
        %nin%     %s!=% %s!grepl%    %s!in%     %s==%      %sc%      %se%      %sg% 
        FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE 
        %sge%    %sgel%   %sgele%     %sgl%    %sgle%  %sgrepl%     %sin%      %sl% 
        FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE     FALSE 
        %sle%    %snin% 
        FALSE     FALSE 
...
| Execution Time | 2025-02-19 04:56:35 UTC |
...
running this report
    ...
    PROCESSX_PS1d45afe7223_1739940989
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUkmwxm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extraoperators_v0.3.0-tikzDictionary"
