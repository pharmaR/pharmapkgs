# Validation Report - CPBayes@1.1.0
...
| export_help          | 7                                              |
| has_website          | TRUE                                           |
| has_maintainer       | Arunabha Majumdar <statgen.arunabha@gmail.com> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/ArunabhaCodes/CPBayes       |
...
Overall the package has 7 exported objects. 7 are documented:
      ...
      analytic_locFDR_BF_cor analytic_locFDR_BF_uncor              cpbayes_cor 
                        TRUE                     TRUE                     TRUE 
               cpbayes_uncor           estimate_corln           forest_cpbayes 
                        TRUE                     TRUE                     TRUE 
              post_summaries 
                        TRUE 
...
| Execution Time | 2025-02-17 04:12:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6165f3422_1739765545
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplCzWK8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CPBayes_v1.1.0-tikzDictionary"
