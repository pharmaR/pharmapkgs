# Validation Report - ehymet@0.1.1
...
| export_help          | 13                                 |
| has_website          | TRUE                               |
| has_maintainer       | Belen Pulido <bpulidob4@gmail.com> |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/bpulidob/ehymet |
...
Overall the package has 13 exported objects. 13 are documented:
    ...
    clustering_validation     clustInd_hierarch      clustInd_kkmeans 
                     TRUE                  TRUE                  TRUE 
          clustInd_kmeans          clustInd_spc               EHyClus 
                     TRUE                  TRUE                  TRUE 
                       EI      generate_indices                    HI 
                     TRUE                  TRUE                  TRUE 
                      MEI                   MHI         sim_model_ex1 
                     TRUE                  TRUE                  TRUE 
            sim_model_ex2 
                     TRUE 
...
| Execution Time | 2025-02-19 03:50:45 UTC |
...
running this report
    ...
    PROCESSX_PS1d45591264e5_1739937039
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpgf3KwC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ehymet_v0.1.1-tikzDictionary"
