# Validation Report - crimeutils@0.5.1
...
| export_help          | 22                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Jacob Kaplan <jkkaplan6@gmail.com>      |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/jacobkap/crimeutils/ |
...
Overall the package has 22 exported objects. 21 are documented:
                                     ...
                                     %>%                     capitalize_words 
                                   FALSE                                 TRUE 
                       indicate_outliers                   make_average_graph 
                                    TRUE                                 TRUE 
                           make_barplots                make_desc_stats_table 
                                    TRUE                                 TRUE 
                       make_latex_tables make_mean_median_mode_table_by_group 
                                    TRUE                                 TRUE 
        make_mean_std_dev_by_group_table             make_n_and_percent_table 
                                    TRUE                                 TRUE 
                   make_regression_graph                make_regression_table 
                                    TRUE                                 TRUE 
                   make_stat_count_plots                       make_state_abb 
                                    TRUE                                 TRUE 
                            pad_decimals                     scale_color_crim 
                                    TRUE                                 TRUE 
                         scale_fill_crim                  scale_linetype_crim 
                                    TRUE                                 TRUE 
                  scatterplot_data_graph                           theme_crim 
                                    TRUE                                 TRUE 
                  time_series_data_graph           ucr_constant_reporter_oris 
                                    TRUE                                 TRUE 
...
| Execution Time | 2025-02-17 04:20:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6583b6e33_1739766041
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdaRo9p
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crimeutils_v0.5.1-tikzDictionary"
