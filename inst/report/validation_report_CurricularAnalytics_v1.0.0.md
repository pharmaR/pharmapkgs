# Validation Report - CurricularAnalytics@1.0.0
...
| export_help          | 7                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Daniel Krasnov <danielkrasnovdk@hotmail.com>    |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/Danyulll/CurricularAnalytics |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | dplyr (\>= 1.1.4)      | Imports |
| 2   | igraph (\>= 2.0.3)     | Imports |
| 3   | stats (\>= 4.4.0)      | Imports |
| 4   | tools (\>= 4.4.0)      | Imports |
| 5   | utils (\>= 4.4.0)      | Imports |
| 6   | visNetwork (\>= 2.1.2) | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
               ...
               blocking_factor          centrality_factor 
                          TRUE                       TRUE 
     curriculum_graph_from_csv curriculum_graph_from_list 
                          TRUE                       TRUE 
                  delay_factor      plot_curriculum_graph 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-17 04:40:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61ca1b2db_1739767212
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjeEHR6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CurricularAnalytics_v1.0.0-tikzDictionary"
