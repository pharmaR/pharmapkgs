# Validation Report - doudpackage@2.1.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Edouard Baudouin <edouardpierre.baudouin@aphp.fr>    |
...
Overall the package has 4 exported objects. 6 are documented:

        descTab  ft_ana_biv ft_desc_tab    ft_parse 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-18 04:38:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bb449ef9592_1739853495
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzzTu7x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doudpackage_v2.1.0-tikzDictionary"
