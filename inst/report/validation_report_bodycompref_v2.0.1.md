# Validation Report - bodycompref@2.0.1
...
| has_source_control   | https://github.com/p-mq/bodycompref                  |
...
Overall the package has 5 exported objects. 5 are documented:
       ...
       bodycomp_reference     percent_predicted reference_percentiles 
                     TRUE                  TRUE                  TRUE 
         reference_values    reference_z_scores 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-15 04:30:16 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6e58c3bc_1739593811
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFYh0Ik
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bodycompref_v2.0.1-tikzDictionary"
