...
| export_help          | 20                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Sanford Weisberg <sandy@umn.edu>                     |
...
controlfunctionIV, CovSel, LDRTools, LPCM, orthoDr, quantdr, tsBSS

## Namespace

Overall the package has 20 exported objects. 20 are documented:

        coord.hyp.basis                  dr            dr.basis          dr.compute 
                   TRUE                TRUE                TRUE                TRUE 
     dr.coordinate.test        dr.direction       dr.directions       dr.joint.test 
                   TRUE                TRUE                TRUE                TRUE 
    dr.permutation.test           dr.pvalue           dr.slices       dr.slices.arc 
                   TRUE                TRUE                TRUE                TRUE 
                dr.step             dr.test          dr.weights                dr.x 
                   TRUE                TRUE                TRUE                TRUE 
                   dr.y                dr.z            drop1.dr             plot.dr 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 04:42:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42abb2abc_1739853733
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpdg1hte
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dr_v3.0.10-tikzDictionary"
