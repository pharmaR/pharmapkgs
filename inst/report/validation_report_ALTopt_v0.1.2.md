...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Kangwon Seo <seoka@missouri.edu>                     |
...
Overall the package has 14 exported objects. 14 are documented:
              ...
              alteval.ic           alteval.rc            altopt.ic 
                    TRUE                 TRUE                 TRUE 
               altopt.rc          compare.fus         compare.vdus 
                    TRUE                 TRUE                 TRUE 
    convert.stress.level          design.plot        pv.contour.ic 
                    TRUE                 TRUE                 TRUE 
           pv.contour.rc            pv.fus.ic            pv.fus.rc 
                    TRUE                 TRUE                 TRUE 
              pv.vdus.ic           pv.vdus.rc 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-14 06:50:48 UTC |
...
running this report
    ...
    PROCESSX_PS726d43f89f75_1739515845
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEgqmPp
