...
| export_help | 12 |
| has_website | TRUE |
| has_maintainer | Dominique-Laurent Couturier <dominique.couturier@mrc-bsu.cam.ac.uk> |
...
Overall the package has 12 exported objects. 12 are documented:
       ...
       alloc.balanced      alloc.simple     batss.combine         batss.glm 
                 TRUE              TRUE              TRUE              TRUE 
    eff.arm.infofract    eff.arm.simple     eff.trial.all     eff.trial.any 
                 TRUE              TRUE              TRUE              TRUE 
       fut.arm.simple     fut.trial.all       RAR.optimal        RAR.trippa 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 03:30:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdaba936e_1739590239
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQ2GF1S
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BATSS_v1.0.0-tikzDictionary"
