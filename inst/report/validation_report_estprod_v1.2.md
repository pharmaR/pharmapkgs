...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Rodrigo R Remédio <rremedio@hotmail.com>             |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    combination_with_repetition            levinsohn_petrin 
                           TRUE                        TRUE 
                    olley_pakes                   panel_lag 
                           TRUE                        TRUE 
                  poly_elements                  wooldridge 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-19 04:33:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d45440d9677_1739939585
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptUZ8RP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_estprod_v1.2-tikzDictionary"
