# Validation Report - EngrEcon@1.0.0
...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Liya Abera <liya.eshetu.abera@gmail.com>             |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | GitHub (<https://github.com/USACE-WRISES>)           |
...
Overall the package has 13 exported objects. 13 are documented:
                ...
                annual_to_future            annual_to_present 
                            TRUE                         TRUE 
                        cashflow                  effective_i 
                            TRUE                         TRUE 
                future_to_annual            future_to_present 
                            TRUE                         TRUE 
              gradient_to_annual           gradient_to_future 
                            TRUE                         TRUE 
             gradient_to_present interest_during_construction 
                            TRUE                         TRUE 
                   om_distribute            present_to_annual 
                            TRUE                         TRUE 
               present_to_future 
                            TRUE 
...
| Execution Time | 2025-02-19 04:07:59 UTC |
...
running this report
    ...
    PROCESSX_PS1d4525208251_1739938073
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxTC8f1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EngrEcon_v1.0.0-tikzDictionary"
