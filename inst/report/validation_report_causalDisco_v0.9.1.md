# Validation Report - causalDisco@0.9.1
...
| export_help          | 34                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Anne Helby Petersen <ahpe@sund.ku.dk>     |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/annennenne/causalDisco |
...
Overall the package has 34 exported objects. 34 are documented:
     ...
     adj_confusion    as.graphNEL average_degree        compare      confusion 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           corTest  dir_confusion          edges  essgraph2amat       evaluate 
              TRUE           TRUE           TRUE           TRUE           TRUE 
                F1            FDR            FOR             G1   gausCorScore 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        graph2amat       is_cpdag        is_pdag       maketikz      maxnedges 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             nDAGs         nedges            NPV  plotTempoMech      precision 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      probmat2amat         recall        regTest            shd         simDAG 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    simGausFromDAG    specificity          tamat            tpc 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 03:49:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bc350d5f8bc_1739677741
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFJxrAt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causalDisco_v0.9.1-tikzDictionary"
