...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Debin Qiu <debinqiu@uga.edu>                         |
...
Overall the package has 18 exported objects. 18 are documented:
           ...
           accurate        adf.test       arch.test      coint.test             ecm 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           estimate       expsmooth        forecast            Holt        identify 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          kpss.test              MA         pp.test stationary.test          stepar 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         trend.test         ts.diag         Winters 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 07:31:23 UTC |
...
running this report
    ...
    PROCESSX_PS1c0958eae959_1739518280
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIAJuBw
