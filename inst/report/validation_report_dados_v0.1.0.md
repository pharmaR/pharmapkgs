...
| export_help          | 0                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Riva Quiroga <riva.quiroga@uc.cl>       |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/cienciadedatos/dados |
...
|     | package        | type    |
|:----|:---------------|:--------|
| 1   | AmesHousing    | Imports |
| 2   | babynames      | Imports |
| 3   | dplyr          | Imports |
| 4   | forcats        | Imports |
| 5   | fueleconomy    | Imports |
| 6   | gapminder      | Imports |
| 7   | ggplot2        | Imports |
| 8   | Lahman         | Imports |
| 9   | palmerpenguins | Imports |
| 10  | nasaweather    | Imports |
| 11  | nycflights13   | Imports |
| 12  | rlang          | Imports |
| 13  | tibble         | Imports |
| 14  | tidyr          | Imports |
| 15  | yaml           | Imports |
| 16  | pixarfilms     | Imports |
...
There are 24 help pages with examples, from 40 (60.00 %).
...
| Execution Time | 2025-02-17 04:50:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6277b82e9_1739767809
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkW8UZk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dados_v0.1.0-tikzDictionary"
