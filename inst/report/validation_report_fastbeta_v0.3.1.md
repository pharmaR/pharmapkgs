# Validation Report - fastbeta@0.3.1
...
| has_source_control   | https://github.com/davidearn/fastbeta |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            deconvolve           fastbeta fastbeta.bootstrap    fastbeta.matrix 
                  TRUE               TRUE               TRUE               TRUE 
                  ptpi               seir            seir.ee      seir.jacobian 
                  TRUE               TRUE               TRUE               TRUE 
               seir.R0                sir 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-19 05:14:56 UTC |
...
running this report
    ...
    PROCESSX_PS1d4583c88b9_1739942089
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1YRMxC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastbeta_v0.3.1-tikzDictionary"
