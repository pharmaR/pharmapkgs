# Validation Report - comclim@0.9.6
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Benjamin Blonder <benjamin.blonder@berkeley.edu>     |
...
Overall the package has 9 exported objects. 9 are documented:
                     ...
                     climatedeviations                  climatestatistics 
                                  TRUE                               TRUE 
                      communityclimate                   generatedemodata 
                                  TRUE                               TRUE 
                    inputcommunitydata         plot.CommunityClimateInput 
                                  TRUE                               TRUE 
       plot.CommunityClimateStatistics      summary.CommunityClimateInput 
                                  TRUE                               TRUE 
    summary.CommunityClimateStatistics 
                                  TRUE 
...
| Execution Time | 2025-02-16 05:03:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34567a030_1739682207
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp11nWOU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comclim_v0.9.6-tikzDictionary"
