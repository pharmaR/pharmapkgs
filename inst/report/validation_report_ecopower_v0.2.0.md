# Validation Report - ecopower@0.2.0
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Michelle Lim <michelle.lim@unsw.edu.au>              |
...
Overall the package has 5 exported objects. 5 are documented:
     ...
     effect_alt effect_null   equivtest      extend    powersim 
...
| Execution Time | 2025-02-19 03:36:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d4520f54162_1739936166
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVKbWVz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecopower_v0.2.0-tikzDictionary"
