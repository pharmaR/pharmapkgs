...
| export_help          | 24                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Satoshi Kakihara <skakihara@gmail.com> |
...
Overall the package has 24 exported objects. 24 are documented:
       ...
       cdf_expmodel  cdf_gaussmodel     databinning       datastats        estimate 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          eval_poly         exp_est        expmodel            func       gauss_est 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         gaussmodel        histmean          igamma         igammac   mix2gauss_fun 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      mix2gauss_gen   mix3gauss_fun   mix3gauss_gen mixexpgamma_fun mixexpgamma_gen 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       pdf_expmodel  pdf_gaussmodel         polyaxb          printf 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:50:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46af0fb4_1739854229
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXS1o9x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsdp_v0.1.1-tikzDictionary"
