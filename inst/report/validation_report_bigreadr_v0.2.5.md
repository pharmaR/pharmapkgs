# Validation Report - bigreadr@0.2.5
...
| has_source_control   | https://github.com/privefl/bigreadr        |
...
bigsnpr, bigstatsr, Directional, disk.frame, pchc, RapidoPGS

## Namespace

Overall the package has 9 exported objects. 9 are documented:

         big_fread1      big_fread2        cbind_df          fread2         fwrite2 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    get_split_files          nlines        rbind_df      split_file 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:05:05 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1299cd2c_1739592300
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3Da6sh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigreadr_v0.2.5-tikzDictionary"
