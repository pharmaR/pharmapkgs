# Validation Report - DatastreamR@2.0.4
...
Overall the package has 19 exported objects. 19 are documented:
                         ...
                         DataClient      DSTimeSeriesCarryIndicator 
                               TRUE                            TRUE 
              DSTimeSeriesDataInput       DSTimeSeriesDateAlignment 
                               TRUE                            TRUE 
               DSTimeSeriesDateInfo           DSTimeSeriesDateRange 
                               TRUE                            TRUE 
      DSTimeSeriesDateRangeResponse DSTimeSeriesFrequencyConversion 
                               TRUE                            TRUE 
          DSTimeSeriesRequestObject      DSTimeSeriesResponseObject 
                               TRUE                            TRUE 
         DSTimeSeriesUserObjectBase        DSUserObjectAccessRights 
                               TRUE                            TRUE 
                   DSUserObjectBase           DSUserObjectFrequency 
                               TRUE                            TRUE 
         DSUserObjectGetAllResponse            DSUserObjectResponse 
                               TRUE                            TRUE 
         DSUserObjectResponseStatus          DSUserObjectShareTypes 
                               TRUE                            TRUE 
                   TimeSeriesClient 
                               TRUE 
...
There are 10 help pages with examples, from 21 (47.62 %).
...
| Execution Time | 2025-02-17 05:02:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62545cb03_1739768520
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXL5yKp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DatastreamR_v2.0.4-tikzDictionary"
