...
| export_help          | 22                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Rolf Turner <r.turner@auckland.ac.nz>                |
...
Overall the package has 22 exported objects. 22 are documented:
                 ...
                 a2sf            buildS               cev       findSolType 
                 TRUE              TRUE              TRUE              TRUE 
        getPossPrices              getS              i2qj             initx 
                 TRUE              TRUE              TRUE              TRUE 
    plot.AssetPricing         plot.flap           progRep           putAway 
                 TRUE              TRUE              TRUE              TRUE 
                 qj2i              scrF              scrG           turnPts 
                 TRUE              TRUE              TRUE              TRUE 
               vsolve           vupdate            xsolve       xsolve.cont 
                 TRUE              TRUE              TRUE              TRUE 
          xsolve.disc        xsolve.pwl 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-14 07:28:35 UTC |
...
running this report
    ...
    PROCESSX_PS1c0969fa4af4_1739518112
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4ezC0a
