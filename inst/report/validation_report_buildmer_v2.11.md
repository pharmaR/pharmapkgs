# Validation Report - buildmer@2.11
...
| export_help          | 24                                  |
| has_website          | FALSE                               |
| has_maintainer       | Cesko C. Voeten <cvoeten@gmail.com> |
...
Overall the package has 23 exported objects. 23 are documented:
            ...
            add.terms     build.formula          buildbam         buildclmm 
                 TRUE              TRUE              TRUE              TRUE 
          buildcustom          buildgam         buildgamm        buildgamm4 
                 TRUE              TRUE              TRUE              TRUE 
    buildGLMMadaptive      buildglmmTMB          buildgls          buildlme 
                 TRUE              TRUE              TRUE              TRUE 
             buildmer       buildmer.nb   buildmerControl      buildmertree 
                 TRUE              TRUE              TRUE              TRUE 
        buildmultinom         converged          LRTalpha        mkBuildmer 
                 TRUE              TRUE              TRUE              TRUE 
              re2mgcv      remove.terms  tabulate.formula 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:53:46 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd76c61865_1739595221
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpV4spLM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_buildmer_v2.11-tikzDictionary"
