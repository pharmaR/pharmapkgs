# Validation Report - ctsfeatures@1.2.2
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Angel Lopez-Oriona <oriona38@hotmail.com>            |
...
Overall the package has 16 exported objects. 16 are documented:
                 ...
                 binarization        calculate_features          calculate_motifs 
                         TRUE                      TRUE                      TRUE 
        calculate_subfeatures conditional_probabilities       joint_probabilities 
                         TRUE                      TRUE                      TRUE 
       marginal_probabilities                  plot_ccc                plot_cohen 
                         TRUE                      TRUE                      TRUE 
                  plot_cramer                  plot_cts                plot_ifsct 
                         TRUE                      TRUE                      TRUE 
                     plot_mcc                   plot_ph                  plot_reg 
                         TRUE                      TRUE                      TRUE 
                      plot_se 
                         TRUE 
...
| Execution Time | 2025-02-17 04:35:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bd673557f11_1739766952
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpASdDop
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ctsfeatures_v1.2.2-tikzDictionary"
