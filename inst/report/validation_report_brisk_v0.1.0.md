...
| export_help          | 9                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Richard Payne <paynestatistics@gmail.com> |
...
|:----|:--------------------|:--------|
| 1   | dplyr (\>= 1.0)     | Imports |
| 2   | ellipsis (\>= 0.3)  | Imports |
| 3   | ggplot2 (\>= 3.3)   | Imports |
| 4   | hitandrun (\>= 0.5) | Imports |
| 5   | purrr (\>= 0.3)     | Imports |
| 6   | rlang (\>= 1.0)     | Imports |
| 7   | tidyr (\>= 1.1)     | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
         ...
         benefit           br     br_group         mcda       pbrisk plot_utility 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
          qbrisk         risk  sim_weights 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-15 04:45:08 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd79ba2cea_1739594703
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiaWdpR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brisk_v0.1.0-tikzDictionary"
