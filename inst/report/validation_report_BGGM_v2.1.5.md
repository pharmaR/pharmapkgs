...
| export_help          | 33                                |
| has_website          | TRUE                              |
| has_maintainer       | Philippe Rast <rast.ph@gmail.com> |
...
|     | package              | type      |
|:----|:---------------------|:----------|
| 1   | BFpack (\>= 1.2.3)   | Imports   |
| 2   | GGally (\>= 1.4.0)   | Imports   |
| 3   | ggplot2 (\>= 3.2.1)  | Imports   |
| 4   | ggridges (\>= 0.5.1) | Imports   |
| 5   | grDevices            | Imports   |
| 6   | MASS (\>= 7.3-51.5)  | Imports   |
| 7   | methods              | Imports   |
| 8   | mvnfast (\>= 0.2.5)  | Imports   |
| 9   | network (\>= 1.15)   | Imports   |
| 10  | reshape (\>= 0.8.8)  | Imports   |
| 11  | Rcpp (\>= 1.0.4.6)   | Imports   |
| 12  | Rdpack (\>= 0.11-1)  | Imports   |
| 13  | sna (\>= 2.5)        | Imports   |
| 14  | stats                | Imports   |
| 15  | utils                | Imports   |
| 16  | Rcpp                 | LinkingTo |
| 17  | RcppArmadillo        | LinkingTo |
| 18  | RcppDist             | LinkingTo |
| 19  | RcppProgress         | LinkingTo |
...
Overall the package has 33 exported objects. 33 are documented:
             ...
             bggm_missing               confirm constrained_posterior 
                     TRUE                  TRUE                  TRUE 
              convergence              estimate               explore 
                     TRUE                  TRUE                  TRUE 
            fisher_r_to_z         fisher_z_to_r               gen_net 
                     TRUE                  TRUE                  TRUE 
              gen_ordinal   ggm_compare_confirm  ggm_compare_estimate 
                     TRUE                  TRUE                  TRUE 
      ggm_compare_explore       ggm_compare_ppc           impute_data 
                     TRUE                  TRUE                  TRUE 
                      map              pcor_mat              pcor_sum 
                     TRUE                  TRUE                  TRUE 
              pcor_to_cor            plot_prior     posterior_predict 
                     TRUE                  TRUE                  TRUE 
        posterior_samples             precision        predictability 
                     TRUE                  TRUE                  TRUE 
    predicted_probability      prior_belief_ggm      prior_belief_var 
                     TRUE                  TRUE                  TRUE 
       regression_summary         roll_your_own                select 
                     TRUE                  TRUE                  TRUE 
             var_estimate      weighted_adj_mat       zero_order_cors 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-15 03:58:38 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd660f8615_1739591913
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp21vWb4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BGGM_v2.1.5-tikzDictionary"
