# Validation Report - circumplex@1.0.0
...
| export_help          | 22                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Jeffrey Girard <me@jmgirard.com>       |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/jmgirard/circumplex |
...
|     | package                  | type      |
|:----|:-------------------------|:----------|
| 1   | boot (\>= 1.3-18)        | Imports   |
| 2   | ggforce (\>= 0.3.0)      | Imports   |
| 3   | ggplot2 (\>= 3.3.0)      | Imports   |
| 4   | htmlTable (\>= 1.13.3)   | Imports   |
| 5   | Rcpp                     | Imports   |
| 6   | rlang                    | Imports   |
| 7   | stats                    | Imports   |
| 8   | Rcpp                     | LinkingTo |
| 9   | RcppArmadillo (\>= 0.11) | LinkingTo |
...
Overall the package has 22 exported objects. 22 are documented:
              ...
              anchors            ggsave       html_render        instrument 
                 TRUE              TRUE              TRUE              TRUE 
          instruments          ipsatize             items  norm_standardize 
                 TRUE              TRUE              TRUE              TRUE 
                norms           octants              PANO             poles 
                 TRUE              TRUE              TRUE              TRUE 
            quadrants            scales             score       ssm_analyze 
                 TRUE              TRUE              TRUE              TRUE 
       ssm_parameters   ssm_plot_circle ssm_plot_contrast    ssm_plot_curve 
                 TRUE              TRUE              TRUE              TRUE 
            ssm_score         ssm_table 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:22:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bc313bb2fd2_1739679737
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjjmjUM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_circumplex_v1.0.0-tikzDictionary"
