# Validation Report - discoverableresearch@0.0.1
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Neal Haddaway <nealhaddaway@gmail.com>               |
...
Overall the package has 13 exported objects. 13 are documented:
          ...
          check_fields     check_keywords        check_title check_title_length 
                  TRUE               TRUE               TRUE               TRUE 
              fakerake    format_keywords         get_ngrams      get_stopwords 
                  TRUE               TRUE               TRUE               TRUE 
            get_tokens      language_code remove_punctuation   suggest_keywords 
                  TRUE               TRUE               TRUE               TRUE 
         suggest_title 
                  TRUE 
...
| Execution Time | 2025-02-18 04:12:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bb48c383ea_1739851962
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEdmLqY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_discoverableresearch_v0.0.1-tikzDictionary"
