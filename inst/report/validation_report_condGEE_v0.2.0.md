# Validation Report - condGEE@0.2.0
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | David Clement <dyc24@cornell.edu>                    |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    condGEE  K1.exp K1.norm   K1.t3  K2.exp K2.norm   K2.t3 
...
| Execution Time | 2025-02-17 03:40:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67664cf14_1739763632
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQSGwA5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_condGEE_v0.2.0-tikzDictionary"
