...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Carl Witthoft <cellocgw@gmail.com>                   |
...
Overall the package has 10 exported objects. 10 are documented:
        ...
        base2base        bigAnd        bigNot         bigOr     bigShiftL 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        bigShiftR        bigXor buildBinaries       fracB2B         noExp 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-15 04:03:06 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd33485e99_1739592181
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjxJeSr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigBits_v1.3-tikzDictionary"
