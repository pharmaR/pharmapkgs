# Validation Report - cdmTools@1.0.5
...
| export_help          | 13                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Pablo Nájera <pnajera@comillas.edu>      |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/pablo-najera/cdmTools |
...
|     | package                     | type    |
|:----|:----------------------------|:--------|
| 1   | GDINA (\>= 2.8.0)           | Imports |
| 2   | ggplot2 (\>= 3.3.0)         | Imports |
| 3   | psych (\>= 1.9.12)          | Imports |
| 4   | sirt (\>= 3.9-4)            | Imports |
| 5   | parallel (\>= 3.6.3)        | Imports |
| 6   | stats (\>= 3.6.3)           | Imports |
| 7   | GPArotation (\>= 2014.11-1) | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
          ...
          CA.MI        estQ        genQ        GNPC      is.Qid       missQ 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
     modelcompK      orderQ         paK   personFit       RDINA RDINA2GDINA 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
           valQ 
           TRUE 
...
| Execution Time | 2025-02-16 03:57:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3f34c10_1739678218
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpg6riJZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cdmTools_v1.0.5-tikzDictionary"
