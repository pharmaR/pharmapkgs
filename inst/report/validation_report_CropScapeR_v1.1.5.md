# Validation Report - CropScapeR@1.1.5
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Bowen Chen <bwchen0719@gmail.com>                    |
...
| 3   | raster (\>= 3.0)        | Imports |
| 4   | sf (\>= 0.8)            | Imports |
| 5   | data.table (\>= 1.12.8) | Imports |
| 6   | httr (\>= 1.4.1)        | Imports |
| 7   | RJSONIO (\>= 1.3)       | Imports |
| 8   | utils (\>= 3.6.1)       | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
      ...
      GetCDLComp   GetCDLData  GetCDLImage   GetCDLStat manualrotate 
...
| Execution Time | 2025-02-17 04:23:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66cf30815_1739766186
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1g7s7r
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CropScapeR_v1.1.5-tikzDictionary"
