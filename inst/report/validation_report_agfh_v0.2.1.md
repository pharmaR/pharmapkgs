...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Marten Thompson <thom7058@umn.edu>                   |
...
Overall the package has 22 exported objects. 22 are documented:
    ...
    adj_profile_likelihood_theta_var_maker   adj_resid_likelihood_theta_var_maker 
                                      TRUE                                   TRUE 
                       agfh_theta_new_pred                       anderson_darling 
                                      TRUE                                   TRUE 
                              beta_err_gen                        cramer_vonmises 
                                      TRUE                                   TRUE 
                             gamma_err_gen                      hb_theta_new_pred 
                                      TRUE                                   TRUE 
                        kolmogorov_smirnov                      make_agfh_sampler 
                                      TRUE                                   TRUE 
                        make_gibbs_sampler                       map_from_density 
                                      TRUE                                   TRUE 
                                       mse                               null_gen 
                                      TRUE                                   TRUE 
          resid_likelihood_theta_var_maker                          RM_beta_eblue 
                                      TRUE                                   TRUE 
                            RM_theta_eblup                      RM_theta_new_pred 
                                      TRUE                                   TRUE 
                   RM_theta_var_moment_est                           shapiro_wilk 
                                      TRUE                                   TRUE 
                             test_u_normal                     theta_var_est_grid 
                                      TRUE                                   TRUE 
...
| Execution Time | 2025-02-14 06:42:25 UTC |
...
running this report
    ...
    PROCESSX_PS726d7ac1b1db_1739515342
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcMcjZ5
