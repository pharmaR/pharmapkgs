# Validation Report - bazar@1.0.11
...
| export_help          | 41                                  |
| has_website          | TRUE                                |
| has_maintainer       | Paul Poncet <paulponcet@yahoo.fr>   |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/paulponcet/bazar |
...
Overall the package has 41 exported objects. 38 are documented:

                 %:%              %?%            %nin%     almost.equal 
               FALSE            FALSE            FALSE             TRUE 
       almost.unique      almost.zero         as.empty           as.fun 
                TRUE             TRUE             TRUE             TRUE 
               as.na         as.nlist   as.wholenumber              bot 
                TRUE             TRUE             TRUE             TRUE 
              concat          concat_          concat0             Copy 
                TRUE             TRUE             TRUE             TRUE 
               erase     get_all_funs     get_all_pkgs         get_vars 
                TRUE             TRUE             TRUE             TRUE 
            is.empty       is.formula         is.nlist   is.wholenumber 
                TRUE             TRUE             TRUE             TRUE 
                isNA library_with_dep         make_idx            mgsub 
                TRUE             TRUE             TRUE             TRUE 
               nlist        normalize            pause require_with_dep 
                TRUE             TRUE             TRUE             TRUE 
                rle2          rollfun  sessionPackages           stopif 
                TRUE             TRUE             TRUE             TRUE 
               sumNA              top             trim          unwhich 
                TRUE             TRUE             TRUE             TRUE 
              verlan 
                TRUE 
...
| Execution Time | 2025-02-15 03:43:29 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd71b4f40a_1739591004
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbQOPAA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bazar_v1.0.11-tikzDictionary"
