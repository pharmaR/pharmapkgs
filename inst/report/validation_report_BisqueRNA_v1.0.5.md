# Validation Report - BisqueRNA@1.0.5
...
| export_help          | 6                                  |
| has_website          | TRUE                               |
| has_maintainer       | Brandon Jew <brandon.jew@ucla.edu> |
...
Overall the package has 6 exported objects. 6 are documented:
     ...
     CalculateSCCellProportions         GenerateSCReference 
                           TRUE                        TRUE 
       MarkerBasedDecomposition ReferenceBasedDecomposition 
                           TRUE                        TRUE 
          SeuratToExpressionSet                SimulateData 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-15 04:18:11 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd426b20a9_1739593086
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp37BnEd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BisqueRNA_v1.0.5-tikzDictionary"
