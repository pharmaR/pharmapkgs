# Validation Report - describedata@0.1.1
...
| export_help          | 10                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Craig McGowan <mcgowan.cj@gmail.com>          |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/craigjmcgowan/describedata |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    bivariate_compare           gladder            ladder        nagelkerke 
                 TRUE              TRUE              TRUE              TRUE 
       norm_dist_plot        proc_means            pwcorr       sample_flow 
                 TRUE              TRUE              TRUE              TRUE 
           stata_tidy       univar_freq 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-18 03:46:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb416cc3c97_1739850360
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpgk9bvD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_describedata_v0.1.1-tikzDictionary"
