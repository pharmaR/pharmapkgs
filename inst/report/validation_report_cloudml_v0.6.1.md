# Validation Report - cloudml@0.6.1
...
Overall the package has 20 exported objects. 20 are documented:
       ...
       cloudml_deploy   cloudml_predict     cloudml_train       gcloud_exec 
                 TRUE              TRUE              TRUE              TRUE 
          gcloud_init    gcloud_install   gcloud_terminal    gcloud_version 
                 TRUE              TRUE              TRUE              TRUE 
              gs_copy       gs_data_dir gs_data_dir_local      gs_local_dir 
                 TRUE              TRUE              TRUE              TRUE 
             gs_rsync       gsutil_exec        job_cancel       job_collect 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:35:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3688d8b7e_1739680518
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpyv1VaR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cloudml_v0.6.1-tikzDictionary"
