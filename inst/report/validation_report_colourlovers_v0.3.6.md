# Validation Report - colourlovers@0.3.6
...
| export_help          | 13                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Andrew Heiss <andrew@andrewheiss.com>       |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/andrewheiss/colourlovers |
...
Overall the package has 13 exported objects. 13 are documented:
       ...
       clcolor   clcolors    cllover   cllovers  clpalette clpalettes  clpattern 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
    clpatterns      clpie      clpng    clquery    clstats     swatch 
...
| Execution Time | 2025-02-16 05:01:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bc312e33e7a_1739682071
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoDaTGX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colourlovers_v0.3.6-tikzDictionary"
