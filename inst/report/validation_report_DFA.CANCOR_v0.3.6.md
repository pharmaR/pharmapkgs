# Validation Report - DFA.CANCOR@0.3.6
...
Overall the package has 9 exported objects. 9 are documented:
            ...
            CANCOR            DFA    GROUP.DIFFS GROUP.PROFILES    HOMOGENEITY 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         LINEARITY      NORMALITY       OUTLIERS PLOT_LINEARITY 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 03:52:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47cdee613_1739850763
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeCLwBy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DFA.CANCOR_v0.3.6-tikzDictionary"
