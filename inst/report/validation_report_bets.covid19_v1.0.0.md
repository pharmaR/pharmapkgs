# Validation Report - bets.covid19@1.0.0
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Qingyuan Zhao <qyzhao@statslab.cam.ac.uk>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/qingyuanzhao/bets.covid19         |
...
Overall the package has 5 exported objects. 5 are documented:
        ...
        age.process  bets.inference bets.likelihood    date.process preprocess.data 
...
| Execution Time | 2025-02-15 03:56:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd22a14a62_1739591792
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbMrp2B
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bets.covid19_v1.0.0-tikzDictionary"
