# Validation Report - bestNormalize@1.9.1
...
| export_help | 19 |
| has_website | TRUE |
| has_maintainer | Ryan Andrew Peterson <ryan.a.peterson@cuanschutz.edu> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/petersonR/bestNormalize |
...
designit, LongDat, mlr3pipelines, phytoclass, povmap, RESIDE, tLOH

## Namespace

Overall the package has 19 exported objects. 19 are documented:

                 arcsinh_x        bestLogConstant          bestNormalize 
                      TRUE                   TRUE                   TRUE 
                  binarize                 boxcox           center_scale 
                      TRUE                   TRUE                   TRUE 
        double_reverse_log                  exp_x                lambert 
                      TRUE                   TRUE                   TRUE 
                     log_x           no_transform              orderNorm 
                      TRUE                   TRUE                   TRUE 
             required_pkgs                 sqrt_x    step_best_normalize 
                      TRUE                   TRUE                   TRUE 
        step_bestNormalize step_bestNormalize_new         step_orderNorm 
                      TRUE                   TRUE                   TRUE 
                yeojohnson 
                      TRUE 
...
| Execution Time | 2025-02-15 03:54:41 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2716af0e_1739591676
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvsJ60l
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bestNormalize_v1.9.1-tikzDictionary"
