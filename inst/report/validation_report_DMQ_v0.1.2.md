...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Leopoldo Catania <leopoldo.catania@econ.au.dk>       |
...
Overall the package has 8 exported objects. 3 are documented:

    EstimateDMQ  fn.DEoptim    fn.optim    fn.solnp ForecastDMQ  MomentsDMQ 
          FALSE        TRUE        TRUE        TRUE       FALSE       FALSE 
    SimulateDMQ   UpdateDMQ 
          FALSE       FALSE 
...
| Execution Time | 2025-02-18 04:27:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41c0850f5_1739852860
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpG5UJLA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DMQ_v0.1.2-tikzDictionary"
