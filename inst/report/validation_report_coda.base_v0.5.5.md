# Validation Report - coda.base@0.5.5
...
| export_help          | 26                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Marc Comas-Cufí <mcomas@imae.udg.edu>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/mcomas/coda.base                  |
...
Overall the package has 26 exported objects. 26 are documented:
          ...
          alr_basis           alr_c           basis cbalance_approx       cdp_basis 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      cdp_partition          center       clr_basis           clr_c            comp 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        composition           coord     coordinates            dist           gmean 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          ilr_basis           ilr_c       olr_basis           olr_c  pairwise_basis 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           pb_basis        pc_basis    plot_balance        read_cdp       sbp_basis 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    variation_array 
               TRUE 
...
| Execution Time | 2025-02-16 04:50:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bc343b35d1e_1739681414
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfOsjqk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coda.base_v0.5.5-tikzDictionary"
