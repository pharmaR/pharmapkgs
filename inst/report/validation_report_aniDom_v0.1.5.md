...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Damien R. Farine <damien.farine@ieu.uzh.ch>          |
...
Overall the package has 8 exported objects. 8 are documented:
                               ...
                               elo_scores estimate_uncertainty_by_repeatability 
                                     TRUE                                  TRUE 
        estimate_uncertainty_by_splitting                 generate_interactions 
                                     TRUE                                  TRUE 
                     plot_hierarchy_shape                            plot_ranks 
                                     TRUE                                  TRUE 
                        plot_trajectories                      plot_winner_prob 
                                     TRUE                                  TRUE 
...
| Execution Time | 2025-02-14 06:54:29 UTC |
...
running this report
    ...
    PROCESSX_PS726d533e3c0b_1739516066
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9oDpPh
