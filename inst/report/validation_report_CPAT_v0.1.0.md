...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Curtis Miller <cmiller@math.utah.edu>                |
...
| 1   | stats (\>= 3.2)     | Imports   |
| 2   | utils (\>= 3.2)     | Imports   |
| 3   | grDevices (\>= 3.2) | Imports   |
| 4   | Rdpack (\>= 0.9)    | Imports   |
| 5   | methods (\>= 3.2)   | Imports   |
| 6   | Rcpp (\>= 0.12)     | Imports   |
| 7   | purrr (\>= 0.2)     | Imports   |
| 8   | Rcpp                | LinkingTo |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    Andrews.test   CUSUM.test      DE.test      HR.test      HS.test 
...
| Execution Time | 2025-02-17 04:12:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd648dd60ea_1739765539
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVsLUMn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CPAT_v0.1.0-tikzDictionary"
