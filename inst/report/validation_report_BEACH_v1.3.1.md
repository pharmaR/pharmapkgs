...
| export_help          | 0                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Danni Yu <danni.yu@gmail.com>                        |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | shiny (\>= 0.12.2)   | Imports |
| 2   | DT (\>= 0.1)         | Imports |
| 3   | haven (\>= 0.1.1)    | Imports |
| 4   | xtable (\>= 1.7-4)   | Imports |
| 5   | rtf (\>= 0.4-11)     | Imports |
| 6   | plyr (\>= 1.8.2)     | Imports |
| 7   | sas7bdat (\>= 0.5)   | Imports |
| 8   | WriteXLS (\>= 3.5.1) | Imports |
| 9   | rJava(\>= 0.9-6)     | Imports |
| 10  | devtools (\>= 1.9)   | Imports |
...
| Execution Time | 2025-02-15 03:49:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6a4c035c_1739591373
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphjoTFg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BEACH_v1.3.1-tikzDictionary"
