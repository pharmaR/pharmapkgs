# Validation Report - ClaimsProblems@0.2.1
...
| export_help          | 29                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Iago Núñez Lugilde <iago.nunez.lugilde@uvigo.es>     |
...
Overall the package has 29 exported objects. 29 are documented:
                  ...
                  AA         allrules             APRO               CD 
                TRUE             TRUE             TRUE             TRUE 
                  CE              CEA              CEL  coalitionalgame 
                TRUE             TRUE             TRUE             TRUE 
      cumawardscurve   deviationindex               DT      dynamicplot 
                TRUE             TRUE             TRUE             TRUE 
           giniindex       indexgpath      lorenzcurve  lorenzdominance 
                TRUE             TRUE             TRUE             TRUE 
                  MO       pathawards      pathawards3              PIN 
                TRUE             TRUE             TRUE             TRUE 
            plotrule              PRO      problemdata               RA 
                TRUE             TRUE             TRUE             TRUE 
           schedrule       schedrules      setofawards           Talmud 
                TRUE             TRUE             TRUE             TRUE 
    verticalruleplot 
                TRUE 
...
| Execution Time | 2025-02-16 04:25:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3239e52e6_1739679936
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmprn3PSH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClaimsProblems_v0.2.1-tikzDictionary"
