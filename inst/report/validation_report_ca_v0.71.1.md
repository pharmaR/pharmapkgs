...
archdata, bibliometrix, CAinterprTools, caplot, caresid, clustrd,
easyCODA, factoextra, idm, lakhesis, mclm, PBImisc, quanteda.textmodels,
RcmdrPlugin.temis, seriation, T2Qv, tall, TextMiningGUI, vcdExtra

## Namespace

Overall the package has 10 exported objects. 1 are documented:

              ca       caconv      cacoord iterate.mjca         mjca   multilines 
           FALSE        FALSE        FALSE        FALSE        FALSE         TRUE 
         pchlist      plot.ca    plot.mjca    plot3d.ca 
...
| Execution Time | 2025-02-16 03:32:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31603069_1739676722
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBBJHNw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ca_v0.71.1-tikzDictionary"
