# Validation Report - detect@0.4.6
...
| has_source_control   | https://github.com/psolymos/detect |
...
Overall the package has 22 exported objects. 22 are documented:
                  ...
                  AUC         bootstrap            cmulti        cmulti.fit 
                 TRUE              TRUE              TRUE              TRUE 
          cmulti.fit0       cmulti2.fit        convertEDR drop.scope.svisit 
                 TRUE              TRUE              TRUE              TRUE 
          extractBOOT        extractMLE        hbootindex        is.present 
                 TRUE              TRUE              TRUE              TRUE 
        load_BAM_QPAD       predictMCMC           rocplot             svabu 
                 TRUE              TRUE              TRUE              TRUE 
            svabu.fit        svabu.step             svocc         svocc.fit 
                 TRUE              TRUE              TRUE              TRUE 
           svocc.step               zif 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-18 03:49:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4665454ef_1739850572
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSAbZlV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_detect_v0.4.6-tikzDictionary"
