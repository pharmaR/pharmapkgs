...
Overall the package has 60 exported objects. 60 are documented:
             ...
             compute_effects                  cos_deg               diagn_plot 
                       ...
                       gauss          gaussian.loglik    gaussian.loglik.alpha 
                        ...
                        TRUE                     TRUE                     TRUE 
           gen.probs.gmjmcmc         gen.probs.mjmcmc           get.best.model 
                        TRUE                     TRUE                     TRUE 
               get.mpm.model                  gmjmcmc         gmjmcmc.parallel 
                        TRUE                     TRUE                     TRUE 
                          hs    linear.g.prior.loglik                log_prior 
                        TRUE                     TRUE                     TRUE 
             logistic.loglik      logistic.loglik.ala    logistic.loglik.alpha 
                        TRUE                     TRUE                     TRUE 
              marginal.probs            merge_results                   mjmcmc 
                        TRUE                     TRUE                     TRUE 
             mjmcmc.parallel             model.string                    ngelu 
                        TRUE                     TRUE                     TRUE 
                         nhs                      not                    nrelu 
                        TRUE                     TRUE                     TRUE 
                          p0                      p05                     p0p0 
                       ...
                       p0pm2                       p2                       p3 
                        ...
                        pm05                      pm1                      pm2 
                        TRUE                     TRUE                     TRUE 
                        relu           set.transforms                  sigmoid 
                        TRUE                     TRUE                     TRUE 
                     sin_deg                   sqroot        string.population 
                        TRUE                     TRUE                     TRUE 
    string.population.models                     to23                     to25 
                        TRUE                     TRUE                     TRUE 
                        to35                     to72                    troot 
                        TRUE                     TRUE                     TRUE 
...
There are 80 help pages with examples, from 80 (100.00 %).
...
| Execution Time | 2025-02-27 03:21:13 UTC |
...
running this report
    ...
    PROCESSX_PS1c621c1b4922_1740626469
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaINMWG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FBMS_v1.1-tikzDictionary"
