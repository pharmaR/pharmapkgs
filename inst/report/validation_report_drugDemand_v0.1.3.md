# Validation Report - drugDemand@0.1.3
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Kaifeng Lu <kaifenglu@gmail.com>                     |
...
|     | package                 | type      |
|:----|:------------------------|:----------|
| 1   | Rcpp (\>= 1.0.10)       | Imports   |
| 2   | dplyr (\>= 1.1.0)       | Imports   |
| 3   | rlang (\>= 1.1.0)       | Imports   |
| 4   | purrr (\>= 1.0.2)       | Imports   |
| 5   | stringr (\>= 1.4.0)     | Imports   |
| 6   | plotly (\>= 4.10.1)     | Imports   |
| 7   | survival (\>= 2.41-3)   | Imports   |
| 8   | mvtnorm (\>= 1.1-3)     | Imports   |
| 9   | erify (\>= 0.4.0)       | Imports   |
| 10  | stats (\>= 3.5.0)       | Imports   |
| 11  | MASS (\>= 7.3-54)       | Imports   |
| 12  | nlme (\>= 3.1-153)      | Imports   |
| 13  | L1pack (\>= 0.41-24)    | Imports   |
| 14  | eventPred (\>= 0.2.3)   | Imports   |
| 15  | parallel (\>= 4.1.2)    | Imports   |
| 16  | foreach (\>= 1.5.2)     | Imports   |
| 17  | doParallel (\>= 1.0.17) | Imports   |
| 18  | doRNG (\>= 1.8.6)       | Imports   |
| 19  | Rcpp                    | LinkingTo |
...
Overall the package has 16 exported objects. 16 are documented:
             ...
             f_cum_dose f_dispensing_models         f_dose_draw       f_dose_draw_1 
                   TRUE                TRUE                TRUE                TRUE 
        f_dose_draw_t_1      f_dose_new_cpp     f_dose_observed  f_dose_ongoing_cpp 
                   TRUE                TRUE                TRUE                TRUE 
              f_dose_pp       f_drug_demand            f_fit_di            f_fit_ki 
                   TRUE                TRUE                TRUE                TRUE 
               f_fit_t0            f_fit_ti       f_ongoing_new          rdirichlet 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 04:48:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bb467637fab_1739854096
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWOJLcf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drugDemand_v0.1.3-tikzDictionary"
