# Validation Report - bayesbio@1.0.0
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Andrew McKenzie <amckenz@gmail.com>                  |
...
Overall the package has 12 exported objects. 12 are documented:
           ...
           a_hat_mle          allDups    createStrings       ggHorizBar 
                TRUE             TRUE             TRUE             TRUE 
         jaccardSets      nearestTime nearestTimeandID     p.adjust.nlp 
                TRUE             TRUE             TRUE             TRUE 
         pubmedQuery       subsupDiag unequalVarShrink   weightedShrink 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 03:32:05 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd52304d1a_1739590321
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3tX5c1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesbio_v1.0.0-tikzDictionary"
