# Validation Report - cvTools@0.3.3
...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Andreas Alfons <alfons@ese.eur.nl>                   |
...
CenBAR, curvir, enetLTS, FRESA.CAD, FWDselect, GRNNs, KRMM, l1spectral,
mogavs, OPTS, robCompositions, scMerge, SCtools, seqArchR, STOPES

## Namespace

Overall the package has 21 exported objects. 21 are documented:

        cvFit   cvFolds      cvLm   cvLmrob     cvLts   cvNames cvNames<- cvReshape 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
     cvSelect    cvTool  cvTuning      fits    fits<-      mape      mspe       ncv 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
        nfits     repCV     rmspe    rtmspe     tmspe 
...
| Execution Time | 2025-02-17 04:45:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6482a332c_1739767503
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8jR5zl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cvTools_v0.3.3-tikzDictionary"
