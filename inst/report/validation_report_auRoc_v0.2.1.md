...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Dai Feng <daifeng.stat@gmail.com>                    |
...
|     | package          | type    |
|:----|:-----------------|:--------|
| 1   | rjags (\>= 3-11) | Depends |
| 2   | ProbYX(\>= 1.1)  | Depends |
| 3   | coda(\>= 0.16-1) | Imports |
| 4   | MBESS(\>= 3.3.3) | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
      ...
      auc.nonpara.kernel       auc.nonpara.mw       auc.para.bayes 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-14 07:32:32 UTC |
...
running this report
    ...
    PROCESSX_PS1c0913891f82_1739518349
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBs3EV9
