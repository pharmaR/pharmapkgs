# Validation Report - dampack@1.0.2.1000
...
| export_help          | 24                                   |
| has_website          | TRUE                                 |
| has_maintainer       | David Garibay <dgari039@uottawa.ca>  |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/DARTH-git/dampack |
...
Overall the package has 24 exported objects. 24 are documented:
            ...
            beta_params           calc_evpi          calc_evppi           calc_evsi 
                   TRUE                TRUE                TRUE                TRUE 
          calc_exp_loss     calculate_icers calculate_icers_psa                ceac 
                   TRUE                TRUE                TRUE                TRUE 
      create_dsa_oneway   create_dsa_twoway    dirichlet_params        gamma_params 
                   TRUE                TRUE                TRUE                TRUE 
           gen_psa_samp        lnorm_params        make_psa_obj           metamodel 
                   TRUE                TRUE                TRUE                TRUE 
           number_ticks                owsa      owsa_opt_strat        owsa_tornado 
                   TRUE                TRUE                TRUE                TRUE 
           run_owsa_det             run_psa        run_twsa_det                twsa 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:53:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62608de6b_1739767978
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzPgbrv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dampack_v1.0.2.1000-tikzDictionary"
