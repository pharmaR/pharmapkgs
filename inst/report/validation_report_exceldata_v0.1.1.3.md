# Validation Report - exceldata@0.1.1.3
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Lisa Avery <lisa.avery@uhn.ca>                       |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    addFactorVariables          checkData   createCalculated    importExcelData 
                  TRUE               TRUE               TRUE               TRUE 
         plotVariables       readDataDict      readExcelData 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:48:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d4576d1aa73_1739940498
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxpfcJl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exceldata_v0.1.1.3-tikzDictionary"
