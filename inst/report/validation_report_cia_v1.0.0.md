...
| export_help          | 30                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Mathew Varidel <mathew.varidel@sydney.edu.au> |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | bnlearn (\>= 4.9) | Imports |
| 2   | igraph            | Imports |
| 3   | doParallel        | Imports |
| 4   | parallel          | Imports |
| 5   | foreach           | Imports |
| 6   | arrangements      | Imports |
| 7   | graphics          | Imports |
| 8   | dplyr             | Imports |
| 9   | rlang             | Imports |
| 10  | fastmatch         | Imports |
| 11  | methods           | Imports |
| 12  | gRain             | Imports |
...
Overall the package has 30 exported objects. 30 are documented:
                      ...
                      BNLearnScorer        CalculateAcceptanceRates 
                               TRUE                            TRUE 
         CalculateEdgeProbabilities            CalculateFeatureMean 
                               TRUE                            TRUE 
               CollectUniqueObjects                    CreateScorer 
                               TRUE                            TRUE 
                         DAGtoCPDAG                  DAGtoPartition 
                               TRUE                            TRUE 
                    DefaultProposal                   FlattenChains 
                               TRUE                            TRUE 
                        GetEmptyDAG      GetIncrementalScoringEdges 
                               TRUE                            TRUE 
      GetLowestPairwiseScoringEdges                          GetMAP 
                               TRUE                            TRUE 
                      MutilateGraph                   PartitionMCMC 
                               TRUE                            TRUE 
                     PartitiontoDAG                 PlotConcordance 
                               TRUE                            TRUE 
            PlotCumulativeMeanTrace                  PlotScoreTrace 
                               TRUE                            TRUE 
                  PostProcessChains                    SampleChains 
                               TRUE                            TRUE 
            SampleEdgeProbabilities SamplePosteriorPredictiveChains 
                               TRUE                            TRUE 
                           ScoreDAG          ScoreLabelledPartition 
                               TRUE                            TRUE 
                          toBNLearn                         togRain 
                               TRUE                            TRUE 
                           toMatrix              UniformlySampleDAG 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-16 04:17:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31546c1fa_1739679450
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOX618v
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cia_v1.0.0-tikzDictionary"
