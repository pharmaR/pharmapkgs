# Validation Report - carbonr@0.2.1
...
| export_help          | 31                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Lily Clements <lily@idems.international>             |
...
Overall the package has 31 exported objects. 30 are documented:
                           ...
                           %>%                 add_inputs 
                         FALSE                       TRUE 
            airplane_emissions             airport_finder 
                          TRUE                       TRUE 
         anaesthetic_emissions         building_emissions 
                          TRUE                       TRUE 
           carbon_price_credit                  check_CPI 
                          TRUE                       TRUE 
         clinical_theatre_data clinical_theatre_emissions 
                          TRUE                       TRUE 
        construction_emissions          degree_conversion 
                          TRUE                       TRUE 
                 distance_calc       electrical_emissions 
                          TRUE                       TRUE 
               ferry_emissions               gg_value_box 
                          TRUE                       TRUE 
               hotel_emissions        household_emissions 
                          TRUE                       TRUE 
                land_emissions         material_emissions 
                          TRUE                       TRUE 
               metal_emissions           office_emissions 
                          TRUE                       TRUE 
               paper_emissions          plastic_emissions 
                          TRUE                       TRUE 
                rail_emissions                rail_finder 
                          TRUE                       TRUE 
                     raw_fuels               relative_gti 
                          TRUE                       TRUE 
                seaport_finder            shiny_emissions 
                          TRUE                       TRUE 
             vehicle_emissions 
                          TRUE 
...
| Execution Time | 2025-02-16 03:40:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3b485254_1739677239
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz431LR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_carbonr_v0.2.1-tikzDictionary"
