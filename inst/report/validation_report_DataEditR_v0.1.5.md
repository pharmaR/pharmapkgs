# Validation Report - DataEditR@0.1.5
...
| export_help          | 13                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Dillon Hammill <Dillon.Hammill@anu.edu.au> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/DillonHammill/DataEditR |
...
|:----|:--------------------------|:--------|
| 1   | R(\>= 3.5.0)              | Depends |
| 2   | shiny (\>= 1.5.0)         | Imports |
| 3   | shinyBS                   | Imports |
| 4   | shinyjs                   | Imports |
| 5   | bslib                     | Imports |
| 6   | rhandsontable (\>= 0.3.8) | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
           ...
           data_edit   dataEditServer       dataEditUI dataFilterServer 
                TRUE             TRUE             TRUE             TRUE 
        dataFilterUI  dataInputServer      dataInputUI dataOutputServer 
                TRUE             TRUE             TRUE             TRUE 
        dataOutputUI dataSelectServer     dataSelectUI   dataSyncServer 
                TRUE             TRUE             TRUE             TRUE 
          dataSyncUI 
                TRUE 
...
| Execution Time | 2025-02-17 04:57:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bd622323da2_1739768248
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXh9O2R
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DataEditR_v0.1.5-tikzDictionary"
