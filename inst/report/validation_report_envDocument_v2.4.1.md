# Validation Report - envDocument@2.4.1
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Donald Jackson <donald.jackson@bms.com>              |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/dgJacks0n/envDocument             |
...
Overall the package has 10 exported objects. 10 are documented:
           ...
           env_doc   get_Rversion get_scriptpath  getDominoInfo     getGitInfo 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    getPackageInfo        getRepo  getScriptInfo  getScriptPath     getSysInfo 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:11:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d452c0bfc89_1739938279
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0ZL6Jl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_envDocument_v2.4.1-tikzDictionary"
