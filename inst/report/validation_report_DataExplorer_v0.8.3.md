# Validation Report - DataExplorer@0.8.3
...
| export_help          | 22                               |
| has_website          | TRUE                             |
| has_maintainer       | Boxuan Cui <boxuancui@gmail.com> |
| bugs_status          | subscript out of bounds          |
| has_bug_reports_url  | 1                                |
| downloads_1yr        | 122316                           |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | data.table (\>= 1.13.4) | Imports |
| 2   | reshape2 (\>= 1.4.3)    | Imports |
| 3   | scales (\>= 1.1.0)      | Imports |
| 4   | ggplot2                 | Imports |
| 5   | gridExtra               | Imports |
| 6   | rmarkdown (\>= 2.5)     | Imports |
| 7   | networkD3 (\>= 0.4)     | Imports |
| 8   | stats                   | Imports |
| 9   | utils                   | Imports |
| 10  | tools                   | Imports |
| 11  | parallel                | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
    ...
    configure_report    create_report     drop_columns          dummify 
                TRUE             TRUE             TRUE             TRUE 
      group_category        introduce         plot_bar     plot_boxplot 
                TRUE             TRUE             TRUE             TRUE 
    plot_correlation     plot_density   plot_histogram       plot_intro 
                TRUE             TRUE             TRUE             TRUE 
        plot_missing      plot_prcomp          plot_qq plot_scatterplot 
                TRUE             TRUE             TRUE             TRUE 
            plot_str plotDataExplorer  profile_missing      set_missing 
                TRUE             TRUE             TRUE             TRUE 
       split_columns   update_columns 
                TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:57:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bd635e2055e_1739768255
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTh0EZU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DataExplorer_v0.8.3-tikzDictionary"
