...
| export_help          | 11                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Lukas Bütikofer <lukas.buetikofer@ctu.unibe.ch> |
| bugs_status          | 0.8666667                                       |
| size_codebase        | 1244                                            |
| has_source_control   | https://github.com/CTU-Bern/accrualPlot         |
...
Overall the package has 11 exported objects. 11 are documented:
          ...
          accrual_create_df    accrual_linear_model        accrual_plot_abs 
                       TRUE                    TRUE                    TRUE 
           accrual_plot_cum    accrual_plot_predict         accrual_predict 
                       TRUE                    TRUE                    TRUE 
              accrual_table       accrual_time_unit     gg_accrual_plot_abs 
                       TRUE                    TRUE                    TRUE 
        gg_accrual_plot_cum gg_accrual_plot_predict 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-14 06:30:59 UTC |
...
running this report
    ...
    PROCESSX_PS726d43870fc3_1739514657
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpU7iGmJ
