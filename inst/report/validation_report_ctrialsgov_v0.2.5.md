# Validation Report - ctrialsgov@0.2.5
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Taylor Arnold <tarnold2@richmond.edu>                |
...
Overall the package has 15 exported objects. 15 are documented:
        ...
        ctgov_create_data  ctgov_gantt_labeller      ctgov_get_schema 
                     TRUE                  TRUE                  TRUE 
               ctgov_kwic      ctgov_load_cache     ctgov_load_sample 
                     TRUE                  TRUE                  TRUE 
      ctgov_plot_timeline           ctgov_query     ctgov_query_terms 
                     TRUE                  TRUE                  TRUE 
             ctgov_schema      ctgov_set_schema ctgov_text_similarity 
                     TRUE                  TRUE                  TRUE 
              ctgov_tfidf       ctgov_to_plotly              has_term 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-17 04:35:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62e63c597_1739766921
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwZQmF8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ctrialsgov_v0.2.5-tikzDictionary"
