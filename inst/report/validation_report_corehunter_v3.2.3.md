# Validation Report - corehunter@3.2.3
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Herman De Beukelaer <herman.debeukelaer@gmail.com>   |
...
Overall the package has 12 exported objects. 12 are documented:
            ...
            coreHunterData              distances           evaluateCore 
                      TRUE                   TRUE                   TRUE 
               exampleData              genotypes   getAlleleFrequencies 
                      TRUE                   TRUE                   TRUE 
    getNormalizationRanges              objective             phenotypes 
                      TRUE                   TRUE                   TRUE 
            read.autodelim             sampleCore               setRange 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-17 03:57:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62abeb040_1739764618
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbOZc7U
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corehunter_v3.2.3-tikzDictionary"
