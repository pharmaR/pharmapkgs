# Validation Report - datanugget@1.3.1
...
| export_help          | 0                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yajie Duan <yajieritaduan@gmail.com>                 |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | doSNOW (\>= 1.0.16)  | Depends |
| 2   | foreach (\>= 1.5.1)  | Depends |
| 3   | parallel (\>= 4.0.5) | Depends |
| 4   | Rfast(\>= 2.0.7)     | Depends |
...
| Execution Time | 2025-02-17 04:58:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bd675e9b38e_1739768330
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpF986Vj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datanugget_v1.3.1-tikzDictionary"
