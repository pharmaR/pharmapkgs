# Validation Report - EasyABC@1.5.2
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Nicolas Dumoulin <nicolas.dumoulin@inrae.fr>         |
...
Overall the package has 7 exported objects. 7 are documented:
           ...
           ABC_emulation             ABC_mcmc        ABC_rejection 
                    TRUE                 TRUE                 TRUE 
          ABC_sequential         binary_model binary_model_cluster 
                    TRUE                 TRUE                 TRUE 
                    SABC 
                    TRUE 
...
| Execution Time | 2025-02-18 05:10:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4fd0fe67_1739855407
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpH5jB0P
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EasyABC_v1.5.2-tikzDictionary"
