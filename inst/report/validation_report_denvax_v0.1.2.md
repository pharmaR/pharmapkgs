# Validation Report - denvax@0.1.2
...
| export_help          | 6                                             |
| has_website          | TRUE                                          |
| has_maintainer       | Carl A. B. Pearson <carl.pearson@lshtm.ac.uk> |
| bugs_status          | 0                                             |
| has_source_control   | https://gitlab.com/cabp_LSHTM/denvax          |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    build.project          nPxA           ROI     ROIcoeffs       serofit 
...
| Execution Time | 2025-02-18 03:43:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45b0d2d0b_1739850186
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXxzONn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_denvax_v0.1.2-tikzDictionary"
