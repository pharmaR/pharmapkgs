# Validation Report - cmocean@0.3.2
...
| export_help          | 4                                 |
| has_website          | TRUE                              |
| has_maintainer       | Ivan Krylov <ikrylov@disroot.org> |
| bugs_status          | 1                                 |
...
plotdap, rerddapXtracto, vprr

## Namespace

Overall the package has 4 exported objects. 4 are documented:

                 cmocean  scale_color_cmocean scale_colour_cmocean 
                    TRUE                 TRUE                 TRUE 
      scale_fill_cmocean 
                    TRUE 
...
| Execution Time | 2025-02-23 03:23:30 UTC |
...
running this report
    ...
    PROCESSX_PS1d257e3b7690_1740281006
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvQ2Yn2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmocean_v0.3.2-tikzDictionary"
