# Validation Report - fairmodels@1.2.1
...
| export_help          | 25                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Jakub Wiśniewski <jakwisn@gmail.com> |
...
Overall the package has 25 exported objects. 25 are documented:
                         ...
                         all_cutoffs calculate_group_fairness_metrics 
                                TRUE                             TRUE 
              ceteris_paribus_cutoff                    choose_metric 
                                TRUE                             TRUE 
                    confusion_matrix         disparate_impact_remover 
                                TRUE                             TRUE 
              expand_fairness_object                   fairness_check 
                                TRUE                             TRUE 
           fairness_check_regression                 fairness_heatmap 
                                TRUE                             TRUE 
                        fairness_pca                   fairness_radar 
                                TRUE                             TRUE 
                      group_matrices                     group_metric 
                                TRUE                             TRUE 
             group_model_performance                    metric_scores 
                                TRUE                             TRUE 
            performance_and_fairness                     plot_density 
                                TRUE                             TRUE 
                     plot_fairmodels                 pre_process_data 
                                TRUE                             TRUE 
                  regression_metrics                         resample 
                                TRUE                             TRUE 
                            reweight                        roc_pivot 
                                TRUE                             TRUE 
                       stack_metrics 
...
| Execution Time | 2025-02-19 05:08:18 UTC |
...
running this report
    ...
    PROCESSX_PS1d4523266d26_1739941692
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJpdoMU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fairmodels_v1.2.1-tikzDictionary"
