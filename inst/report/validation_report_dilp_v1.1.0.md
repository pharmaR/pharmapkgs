...
| export_help          | 11                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Matthew J. Butrim <mbutrim@uwyo.edu> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/mjbutrim/dilp     |
...
Overall the package has 11 exported objects. 10 are documented:
                 ...
                 %>%         calc_lma             dilp         dilp_cca 
               FALSE             TRUE             TRUE             TRUE 
         dilp_errors    dilp_outliers  dilp_processing              lma 
                TRUE             TRUE             TRUE             TRUE 
          precip_slr         temp_slr view_regressions 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:06:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4132df283_1739851593
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLD37pp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dilp_v1.1.0-tikzDictionary"
