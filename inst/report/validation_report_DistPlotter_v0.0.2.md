# Validation Report - DistPlotter@0.0.2
...
| export_help          | 1                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Christopher Casement <casementc@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/ccasement/DistPlotter   |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | colourpicker (\>= 1.1.1) | Imports |
| 2   | dplyr (\>= 1.0.8)        | Imports |
| 3   | DT (\>= 0.20)            | Imports |
| 4   | extraDistr (\>= 1.9.1)   | Imports |
| 5   | ggplot2 (\>= 3.3.5)      | Imports |
| 6   | rio (\>= 0.5.29)         | Imports |
| 7   | scales (\>= 1.1.1)       | Imports |
| 8   | shiny (\>= 1.7.1)        | Imports |
| 9   | shinyalert (\>= 3.0.0)   | Imports |
| 10  | shinyBS (\>= 0.61)       | Imports |
| 11  | shinyjs (\>= 2.1.0)      | Imports |
| 12  | shinyWidgets (\>= 0.6.4) | Imports |
| 13  | stringi (\>= 1.7.6)      | Imports |
| 14  | stringr (\>= 1.4.0)      | Imports |
...
| Execution Time | 2025-02-18 04:19:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4382d98e2_1739852348
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8M4GMy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DistPlotter_v0.0.2-tikzDictionary"
