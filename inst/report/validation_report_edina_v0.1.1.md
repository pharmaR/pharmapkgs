...
| export_help          | 12                                            |
| has_website          | TRUE                                          |
| has_maintainer       | James Joseph Balamuta <balamut2@illinois.edu> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/tmsalab/edina              |
...
Overall the package has 12 exported objects. 12 are documented:
                  ...
                  as_q_matrix                auto_edina                  autoplot 
                         TRUE                      TRUE                      TRUE 
                   best_model                       DIC                     edina 
                         TRUE                      TRUE                      TRUE 
             extract_q_matrix     model_selection_graph parameter_evolution_graph 
                         TRUE                      TRUE                      TRUE 
                          PPP                   q_graph                  q_matrix 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-19 03:41:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d451e1b77ae_1739936493
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAaoRK4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_edina_v0.1.1-tikzDictionary"
