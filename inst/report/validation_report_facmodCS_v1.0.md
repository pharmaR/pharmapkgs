# Validation Report - facmodCS@1.0
...
| export_help          | 30                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mido Shammaa <midoshammaa@yahoo.com>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/robustport/facmodCS               |
...
| 2   | xts                  | Imports |
| 3   | zoo                  | Imports |
| 4   | PerformanceAnalytics | Imports |
| 5   | lattice              | Imports |
| 6   | methods              | Imports |
| 7   | sn                   | Imports |
| 8   | tseries              | Imports |
| 9   | robustbase           | Imports |
| 10  | RobStatTM            | Imports |
...
Overall the package has 30 exported objects. 30 are documented:
                   ...
                   convert         dCornishFisher extractRegressionStats 
                      TRUE                   TRUE                   TRUE 
                    fitFfm               fitFfmDT                  fmCov 
                      TRUE                   TRUE                   TRUE 
                fmEsDecomp          fmmcSemiParam                  fmRsq 
                      TRUE                   TRUE                   TRUE 
                fmSdDecomp               fmTstats            fmVaRDecomp 
                      TRUE                   TRUE                   TRUE 
              lagExposures         pCornishFisher           portEsDecomp 
                      TRUE                   TRUE                   TRUE 
              portSdDecomp          portVaRDecomp         qCornishFisher 
                      TRUE                   TRUE                   TRUE 
            rCornishFisher           repExposures              repReturn 
                      TRUE                   TRUE                   TRUE 
                   repRisk     residualizeReturns         riskDecomp.ffm 
                      TRUE                   TRUE                   TRUE 
             roll.fitFfmDT                specFfm   standardizeExposures 
                      TRUE                   TRUE                   TRUE 
        standardizeReturns               tsPlotMP                    vif 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-19 05:03:51 UTC |
...
running this report
    ...
    PROCESSX_PS1d4574447c62_1739941425
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEabDi4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_facmodCS_v1.0-tikzDictionary"
