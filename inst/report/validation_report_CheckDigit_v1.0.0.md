# Validation Report - CheckDigit@1.0.0
...
| export_help          | 2                                                |
| has_website          | TRUE                                             |
| has_maintainer       | Justin Brantley <fascinatingfingers@icloud.com>  |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://gitlab.com/fascinatingfingers/checkdigit |
...
Overall the package has 2 exported objects. 2 are documented:
    ...
    AppendCheckDigit VerifyCheckDigit 
                TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:09:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bc368da4692_1739678987
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpExExdS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CheckDigit_v1.0.0-tikzDictionary"
