# Validation Report - dataspice@1.1.0
...
| export_help          | 13                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Bryce Mecum <brycemecum@gmail.com>    |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/ropensci/dataspice |
...
Overall the package has 13 exported objects. 12 are documented:
                ...
                %>%      build_site    create_spice     edit_access edit_attributes 
              FALSE            TRUE            TRUE            TRUE            TRUE 
        edit_biblio   edit_creators    eml_to_spice     prep_access prep_attributes 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         serve_site    spice_to_eml     write_spice 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 05:01:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bd628fc42d9_1739768488
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7QmFaz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dataspice_v1.1.0-tikzDictionary"
