# Validation Report - configr@0.3.5
...
| export_help          | 19                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Jianfeng Li <lee_jianfeng@sjtu.edu.cn> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/Miachol/configr     |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | jsonlite (\>= 1.2)   | Imports |
| 2   | ini (\>= 0.2)        | Imports |
| 3   | yaml (\>= 2.1.3)     | Imports |
| 4   | RcppTOML (\>= 0.1.3) | Imports |
| 5   | stringr (\>= 1.2.0)  | Imports |
| 6   | utils                | Imports |
| 7   | glue                 | Imports |
...
LACE, pannotator, rDataPipeline

## Namespace

Overall the package has 19 exported objects. 19 are documented:

             config.help    config.list.merge  config.sections.del 
                    TRUE                 TRUE                 TRUE 
          convert.config          eval.config    eval.config.merge 
                    TRUE                 TRUE                 TRUE 
    eval.config.sections         fetch.config      get.config.type 
                    TRUE                 TRUE                 TRUE 
        is.config.active is.configfile.active          is.ini.file 
                    TRUE                 TRUE                 TRUE 
            is.json.file         is.toml.file         is.yaml.file 
                    TRUE                 TRUE                 TRUE 
             parse.extra          read.config           str2config 
                    TRUE                 TRUE                 TRUE 
            write.config 
                    TRUE 
...
| Execution Time | 2025-02-17 03:42:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61bc921fe_1739763766
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmporX6Fp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_configr_v0.3.5-tikzDictionary"
