...
| export_help | 22 |
| has_website | TRUE |
| has_maintainer | Figueiredo Renato <renato.figueiredo@oregonstate.edu> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/FaaSr/FaaSr-package |
...
| 2   | httr                         | Imports |
| 3   | uuid                         | Imports |
| 4   | paws.application.integration | Imports |
| 5   | paws.compute                 | Imports |
| 6   | paws.storage                 | Imports |
| 7   | paws.security.identity       | Imports |
| 8   | cli                          | Imports |
| 9   | jsonvalidate                 | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
                         ...
                         faasr      faasr_arrow_s3_bucket 
                          TRUE                       TRUE 
             faasr_delete_file           faasr_delete_log 
                          TRUE                       TRUE 
         faasr_delete_log_date             faasr_get_file 
                          TRUE                       TRUE 
         faasr_get_folder_list              faasr_get_log 
                          TRUE                       TRUE 
              faasr_get_log_df      faasr_invoke_workflow 
                          TRUE                       TRUE 
                     faasr_log                faasr_parse 
                          TRUE                       TRUE 
                faasr_put_file                 faasr_rank 
                          TRUE                       TRUE 
       faasr_register_workflow       faasr_replace_values 
                          TRUE                       TRUE 
       faasr_run_user_function   faasr_set_workflow_timer 
                          TRUE                       TRUE 
                   faasr_start                 faasr_test 
                          TRUE                       TRUE 
                 faasr_trigger faasr_unset_workflow_timer 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-19 05:01:35 UTC |
...
running this report
    ...
    PROCESSX_PS1d4553fe1c62_1739941288
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpg9AJRv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FaaSr_v1.4.3-tikzDictionary"
