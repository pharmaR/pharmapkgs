# Validation Report - CytobankAPI@2.2.1
...
Overall the package has 5 exported objects. 131 are documented:

                          authenticate                   CytobankAPI_news 
                                  TRUE                               TRUE 
    helper.channel_ids_from_long_names helper.filter_names_to_ids_from_df 
                                  TRUE                               TRUE 
...
There are 23 help pages with examples, from 33 (69.70 %).
...
| Execution Time | 2025-02-17 04:47:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6a751d8b_1739767622
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSoWYTN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CytobankAPI_v2.2.1-tikzDictionary"
