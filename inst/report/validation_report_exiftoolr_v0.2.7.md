# Validation Report - exiftoolr@0.2.7
...
| export_help          | 5                                              |
| has_website          | TRUE                                           |
| has_maintainer       | Joshua O’Brien <joshmobrien@gmail.com>         |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/JoshOBrien/exiftoolr#readme |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    configure_exiftoolr           exif_call           exif_read        exif_version 
                   TRUE                TRUE                TRUE                TRUE 
       install_exiftool 
                   TRUE 
...
| Execution Time | 2025-02-19 04:50:26 UTC |
...
running this report
    ...
    PROCESSX_PS1d452ae6f5fe_1739940619
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXxWWPJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exiftoolr_v0.2.7-tikzDictionary"
