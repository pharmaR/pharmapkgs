...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Anders D. Sleire <sleire@gmail.com>                  |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    cppi dppi msfc obpi shpi slpi 
    TRUE TRUE TRUE TRUE TRUE TRUE 

### Examples

There are 15 help pages with examples, from 22 (68.18 %).
...
| Execution Time | 2025-02-19 04:35:03 UTC |
...
running this report
    ...
    PROCESSX_PS1d453e6dde56_1739939696
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1XCONp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_etrm_v1.0.1-tikzDictionary"
