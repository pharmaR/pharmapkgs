# Validation Report - dabestr@2025.3.14
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Yishan Mai <maiyishan@u.duke.nus.edu>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/ACCLAB/dabestr                    |
...
|:----|:--------------------|:--------|
| 1   | boot                | Imports |
| 2   | brunnermunzel       | Imports |
| 3   | cli                 | Imports |
| 4   | cowplot             | Imports |
| 5   | dplyr               | Imports |
| 6   | effsize             | Imports |
| 7   | ggbeeswarm          | Imports |
| 8   | ggplot2 (\>= 3.5.1) | Imports |
| 9   | ggsci               | Imports |
| 10  | grid                | Imports |
| 11  | magrittr            | Imports |
...
Overall the package has 10 exported objects. 9 are documented:

             %>% cliffs_delta     cohens_d     cohens_h  dabest_plot  forest_plot 
           FALSE         TRUE         TRUE         TRUE         TRUE         TRUE 
        hedges_g         load    mean_diff  median_diff 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-27 03:21:09 UTC |
...
running this report
    ...
    PROCESSX_PS1c627fc058ab_1740626465
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIJAaQt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dabestr_v2025.3.14-tikzDictionary"
