# Validation Report - clordr@1.7.0
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Ting Fung (Ralph) Ma <tingfung.ma@wisc.edu>          |
...
| 2   | MASS (\>= 7.3-45)       | Imports |
| 3   | rootSolve (\>= 1.7)     | Imports |
| 4   | parallel                | Imports |
| 5   | doParallel (\>= 1.0.11) | Imports |
| 6   | foreach (\>= 1.2.0)     | Imports |
| 7   | tmvmixnorm (\>= 1.0.2)  | Imports |
| 8   | utils                   | Imports |
| 9   | stats                   | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
                    ...
                    cl               cl_l            cl.rord           cle.rord 
                  TRUE               TRUE               TRUE               TRUE 
                  clic           sim.rord surrogate.residual 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:35:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33d666e_1739680501
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmRmXYd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clordr_v1.7.0-tikzDictionary"
