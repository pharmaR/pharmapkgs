# Validation Report - biplotEZ@2.2
...
| export_help          | 31                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Sugnet Lubbe <muvisu@sun.ac.za>                      |
...
Overall the package has 31 exported objects. 31 are documented:
                       ...
                       alpha.bags                           AoD 
                             TRUE                          TRUE 
                             axes              axes_coordinates 
                             TRUE                          TRUE 
                           biplot                            CA 
                             TRUE                          TRUE 
                           CATPCA                classification 
                             TRUE                          TRUE 
                         classify                          CLPs 
                             TRUE                          TRUE 
                             CLRs                           CVA 
                        ...
                        density1D                     density2D 
                             TRUE                          TRUE 
                         ellipses extended.matching.coefficient 
                             TRUE                          TRUE 
                     fit.measures                   interpolate 
                             TRUE                          TRUE 
                      legend.type                         means 
                             TRUE                          TRUE 
                          newaxes                    newsamples 
...
| Execution Time | 2025-02-15 04:16:54 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd72b789b9_1739593009
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUrT7VB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biplotEZ_v2.2-tikzDictionary"
