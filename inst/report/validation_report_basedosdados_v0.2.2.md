# Validation Report - basedosdados@0.2.2
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Pedro Cavalcante <pedrocolrj@gmail.com>              |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | purrr (\>= 0.3.4)     | Imports |
| 2   | dplyr (\>= 1.0.6)     | Imports |
| 3   | tibble (\>= 3.1.1)    | Imports |
| 4   | httr (\>= 1.4.2)      | Imports |
| 5   | cli (\>= 2.5.0)       | Imports |
| 6   | magrittr (\>= 2.0.1)  | Imports |
| 7   | readr (\>= 1.4.0)     | Imports |
| 8   | stringr (\>= 1.4.0)   | Imports |
| 9   | dotenv (\>= 1.0.2)    | Imports |
| 10  | bigrquery (\>= 1.4.0) | Imports |
| 11  | glue (\>= 1.4.2)      | Imports |
| 12  | rlang (\>= 0.4.0)     | Imports |
| 13  | writexl (\>= 1.4.0)   | Imports |
| 14  | fs (\>= 1.5.0)        | Imports |
| 15  | dbplyr (\>= 2.1.1)    | Imports |
| 16  | scales (\>= 1.1.1)    | Imports |
| 17  | DBI (\>= 1.1.1)       | Imports |
| 18  | typed (\>= 0.0.1)     | Imports |
| 19  | methods               | Imports |
...
Overall the package has 15 exported objects. 14 are documented:

                        %>%              bd_collect                bd_write 
                      FALSE                    TRUE                    TRUE 
               bd_write_csv            bd_write_rds                  bdplyr 
                       TRUE                    TRUE                    TRUE 
             dataset_search                download          get_billing_id 
                       TRUE                    TRUE                    TRUE 
    get_dataset_description       get_table_columns   get_table_description 
                       TRUE                    TRUE                    TRUE 
        list_dataset_tables                read_sql          set_billing_id 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 07:44:04 UTC |
...
running this report
    ...
    PROCESSX_PS1c091e7baf6_1739519040
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmKEgOy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_basedosdados_v0.2.2-tikzDictionary"
