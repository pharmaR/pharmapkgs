# Validation Report - common@1.1.3
...
| export_help          | 16                                 |
| has_website          | TRUE                               |
| has_maintainer       | David Bosak <dbosak01@gmail.com>   |
| bugs_status          | 0.8                                |
| has_source_control   | https://github.com/dbosak01/common |
...
defineR, fetch, fmtr, libr, logr, procs, reporter, sassy

## Namespace

Overall the package has 16 exported objects. 14 are documented:

               %eq%             %p%         changed copy.attributes        dir.find 
              FALSE           FALSE            TRUE            TRUE            TRUE 
          file.find      find.names        labels<-         roundup      source.all 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             spaces           subsc           supsc          symbol        Sys.path 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                  v 
               TRUE 
...
| Execution Time | 2025-02-17 03:32:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6324831f4_1739763159
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphApAAF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_common_v1.1.3-tikzDictionary"
