# Validation Report - CropWaterBalance@0.2.0
...
| export_help          | 9                                                   |
| has_website          | TRUE                                                |
| has_maintainer       | Gabriel Constantino Blain <gabriel.blain@sp.gov.br> |
| bugs_status          | subscript out of bounds                             |
| has_source_control   | https://github.com/gabrielblain/CropWaterBalance    |
...
Overall the package has 9 exported objects. 9 are documented:
              ...
              Compare               CWB CWB_FixedSchedule       Descriptive 
                 TRUE              TRUE              TRUE              TRUE 
             Dinitial            ET0_HS            ET0_PM            ET0_PT 
                 TRUE              TRUE              TRUE              TRUE 
       Soil_Heat_Flux 
                 TRUE 
...
| Execution Time | 2025-02-17 04:23:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bd654f4ed83_1739766192
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRfjOws
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CropWaterBalance_v0.2.0-tikzDictionary"
