# Validation Report - chilemapas@0.3.0
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    generar_circunscripciones         generar_distritos        generar_provincias 
                         TRUE                      TRUE                      TRUE 
             generar_regiones   generar_servicios_salud 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-16 04:13:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32b73c5a4_1739679199
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2LI6mR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chilemapas_v0.3.0-tikzDictionary"
