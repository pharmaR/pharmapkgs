...
jfa, nlpred, reliabilitydiag, simIReff

## Namespace

Overall the package has 23 exported objects. 42 are documented:

                                      bde                        boundedDensity 
                                     TRUE                                  TRUE 
                                 brVitale                          chen99Kernel 
                                     TRUE                                  TRUE 
                            getSubclasses                     hirukawaJLNKernel 
                                     TRUE                                  TRUE 
                         hirukawaTSKernel jonesCorrectionMuller91BoundaryKernel 
                                     TRUE                                  TRUE 
    jonesCorrectionMuller94BoundaryKernel                            kakizawaB1 
                                     TRUE                                  TRUE 
                               kakizawaB2                            kakizawaB3 
                                     TRUE                                  TRUE 
                                launchApp                 macroBetaChen99Kernel 
                                     TRUE                                  TRUE 
               macroBetaHirukawaJLNKernel             macroBetaHirukawaTSKernel 
                                     TRUE                                  TRUE 
                    microBetaChen99Kernel                                  mise 
                                     TRUE                                  TRUE 
                   muller91BoundaryKernel                muller94BoundaryKernel 
                                     TRUE                                  TRUE 
                         noBoundaryKernel              normalizedBoundaryKernel 
                                     TRUE                                  TRUE 
                                   vitale 
                                     TRUE 
...
There are 48 help pages with examples, from 67 (71.64 %).
...
| Execution Time | 2025-02-15 03:47:59 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd748e7f1d_1739591274
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvPddtP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bde_v1.0.1.1-tikzDictionary"
