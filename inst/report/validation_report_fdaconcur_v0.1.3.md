# Validation Report - fdaconcur@0.1.3
...
| export_help          | 9                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Su I Iao <siao@ucdavis.edu>                  |
| bugs_status          | 0.875                                        |
| has_source_control   | https://github.com/functionaldata/tFDAconcur |
...
Overall the package has 9 exported objects. 9 are documented:
           ...
           ConcReg_Lag          ConcurReg     fitted_ptFCReg        GetCI_Dense 
                  TRUE               TRUE               TRUE               TRUE 
          GetCI_Sparse  historyIndexDense historyIndexSparse            ptFCReg 
                  TRUE               TRUE               TRUE               TRUE 
         smPtFCRegCoef 
                  TRUE 
...
| Execution Time | 2025-02-27 03:21:58 UTC |
...
running this report
    ...
    PROCESSX_PS1c621d302bd5_1740626514
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXOBIY9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fdaconcur_v0.1.3-tikzDictionary"
