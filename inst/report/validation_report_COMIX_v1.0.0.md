...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | S. Gorsky <sgorsky@umass.edu>                        |
...
Overall the package has 15 exported objects. 15 are documented:
                  ...
                  acfParams               calibrate         calibrateNoDist 
                       TRUE                    TRUE                    TRUE 
                      comix     effectiveSampleSize            gewekeParams 
                       TRUE                    TRUE                    TRUE 
               heidelParams plotEffectiveSampleSize        plotGewekeParams 
                       TRUE                    TRUE                    TRUE 
           plotHeidelParams          plotTracePlots            relabelChain 
                       TRUE                    TRUE                    TRUE 
             summarizeChain               tidyChain        transform_params 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-17 03:32:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64b617899_1739763130
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDsNYbk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_COMIX_v1.0.0-tikzDictionary"
