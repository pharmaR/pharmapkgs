# Validation Report - cytominer@0.2.2
...
| export_help          | 18                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Shantanu Singh <shsingh@broadinstitute.org> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/cytomining/cytominer     |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | caret (\>= 6.0.76)        | Imports |
| 2   | doParallel (\>= 1.0.10)   | Imports |
| 3   | dplyr (\>= 0.8.5)         | Imports |
| 4   | foreach (\>= 1.4.3)       | Imports |
| 5   | futile.logger (\>= 1.4.3) | Imports |
| 6   | magrittr (\>= 1.5)        | Imports |
| 7   | Matrix (\>= 1.2)          | Imports |
| 8   | purrr (\>= 0.3.3)         | Imports |
| 9   | rlang (\>= 0.4.5)         | Imports |
| 10  | tibble (\>= 2.1.3)        | Imports |
...
Overall the package has 18 exported objects. 18 are documented:
                    ...
                    aggregate     correlation_threshold             count_na_rows 
                         TRUE                      TRUE                      TRUE 
                   covariance           drop_na_columns              drop_na_rows 
                         TRUE                      TRUE                      TRUE 
       extract_subpopulations           generalized_log generate_component_matrix 
                         TRUE                      TRUE                      TRUE 
                    normalize     replicate_correlation  sparse_random_projection 
                         TRUE                      TRUE                      TRUE 
                  svd_entropy                 transform       variable_importance 
                         TRUE                      TRUE                      TRUE 
              variable_select        variance_threshold                    whiten 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-17 04:47:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bd653310fe1_1739767641
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPeK8WB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cytominer_v0.2.2-tikzDictionary"
