...
| export_help          | 34                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Henna D. Bhramdat <bhramdath@ufl.edu>                |
...
Overall the package has 34 exported objects. 34 are documented:
            ...
            ApplyBC.2d      AutoAdjust.2d        beamApplyBC     beamDimensions 
                  TRUE               TRUE               TRUE               TRUE 
        beamElementMat       beamExpandEM    beamForceVector       beamGLForces 
                  TRUE               TRUE               TRUE               TRUE 
          beamGlobalEM        beamNodeDis     beamPlotSystem      beamReducedEM 
                  TRUE               TRUE               TRUE               TRUE 
            beamStress            beamUDL      Dimensions.2d      ElementMat.2d 
                  TRUE               TRUE               TRUE               TRUE 
          EulerBeamFEA        ExpandEM.2d       ExpandSFT.2d       FEMStrain.2d 
                  TRUE               TRUE               TRUE               TRUE 
          FEMStress.2d     ForceVector.2d        GLForces.2d       GlobalMat.2d 
                  TRUE               TRUE               TRUE               TRUE 
        LocalStress.2d    ManualAdjust.2d         NodeDis.2d      PlotSystem.2d 
                  TRUE               TRUE               TRUE               TRUE 
          ReducedEM.2d       ReducedSF.2d      SinglePoly.2d SurfaceTraction.2d 
                  TRUE               TRUE               TRUE               TRUE 
          ThreshPts.2d    triangulate0.2d 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-27 03:24:18 UTC |
...
running this report
    ...
    PROCESSX_PS1c62530cb757_1740626655
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB53bAa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FEA_v0.0.2-tikzDictionary"
