# Validation Report - blockTools@0.6.6
...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Ryan T. Moore <rtm@american.edu>                     |
...
Overall the package has 11 exported objects. 11 are documented:
         ...
         assg2xBalance         assignment              block     block2seqblock 
                  TRUE               TRUE               TRUE               TRUE 
        createBlockIDs           diagnose extract_conditions    invertRIconfInt 
                  TRUE               TRUE               TRUE               TRUE 
                outCSV             outTeX           seqblock 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:24:11 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4c2a635f_1739593446
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7wFgOO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blockTools_v0.6.6-tikzDictionary"
