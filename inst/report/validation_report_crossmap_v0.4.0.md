# Validation Report - crossmap@0.4.0
...
| has_source_control   | https://github.com/rossellhayes/crossmap             |
...
Overall the package has 41 exported objects. 41 are documented:
           ...
           autonames        cross_fit    cross_fit_glm cross_fit_robust 
                TRUE             TRUE             TRUE             TRUE 
          cross_join       cross_list        cross_tbl  future_imap_vec 
                TRUE             TRUE             TRUE             TRUE 
      future_map_vec  future_map2_vec  future_pmap_vec      future_xmap 
                TRUE             TRUE             TRUE             TRUE 
     future_xmap_arr  future_xmap_chr  future_xmap_dbl  future_xmap_dfc 
                TRUE             TRUE             TRUE             TRUE 
     future_xmap_dfr  future_xmap_int  future_xmap_lgl  future_xmap_mat 
                TRUE             TRUE             TRUE             TRUE 
     future_xmap_raw  future_xmap_vec     future_xwalk         imap_vec 
                TRUE             TRUE             TRUE             TRUE 
             map_vec         map2_vec         pmap_vec      tidy_glance 
                TRUE             TRUE             TRUE             TRUE 
                xmap         xmap_arr         xmap_chr         xmap_dbl 
                TRUE             TRUE             TRUE             TRUE 
            xmap_dfc         xmap_dfr         xmap_int         xmap_lgl 
                TRUE             TRUE             TRUE             TRUE 
            xmap_mat         xmap_raw         xmap_vec           xpluck 
                TRUE             TRUE             TRUE             TRUE 
               xwalk 
                TRUE 
...
| Execution Time | 2025-02-17 04:24:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6560498e6_1739766235
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpS1EcrF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crossmap_v0.4.0-tikzDictionary"
