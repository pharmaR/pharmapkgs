# Validation Report - causalOT@1.0.2
...
| 8   | osqp                      | Imports   |
| 9   | R6 (\>= 2.4.1)            | Imports   |
| 10  | Rcpp (\>= 1.0.3)          | Imports   |
| 11  | rlang                     | Imports   |
| 12  | sandwich                  | Imports   |
| 13  | torch                     | Imports   |
| 14  | utils                     | Imports   |
| 15  | BH (\>= 1.66.0)           | LinkingTo |
| 16  | Rcpp (\>= 0.12.0)         | LinkingTo |
| 17  | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 18  | torch                     | LinkingTo |
...
Overall the package has 21 exported objects. 21 are documented:
    ...
    barycentric_projection            calc_weight             cotOptions 
                      TRUE                   TRUE                   TRUE 
                    CRASH3             dataHolder                DataSim 
                      TRUE                   TRUE                   TRUE 
             df2dataHolder           entBWOptions                    ESS 
                      TRUE                   TRUE                   TRUE 
           estimate_effect            Hainmueller                LaLonde 
                      TRUE                   TRUE                   TRUE 
              mean_balance                Measure            ot_distance 
                      TRUE                   TRUE                   TRUE 
                 OTProblem                   PSIS              PSIS_diag 
                      TRUE                   TRUE                   TRUE 
                sbwOptions             scmOptions      supported_methods 
                      TRUE                   TRUE                   TRUE 

### Examples

There are 37 help pages with examples, from 42 (88.10 %).
...
| Execution Time | 2025-02-16 03:50:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bc366d5bf0c_1739677801
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyM76UK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causalOT_v1.0.2-tikzDictionary"
