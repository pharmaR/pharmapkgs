# Validation Report - fairadapt@1.0.0
...
| export_help          | 11                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Drago Plecko <www.plecko@gmail.com>  |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/dplecko/fairadapt |
...
Overall the package has 11 exported objects. 11 are documented:
       ...
       adaptedData  computeQuants      fairadapt  fairadaptBoot      fairTwins 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        graphModel   linearQuants   mcqrnnQuants       quantFit   rangerQuants 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    visualizeGraph 
              TRUE 
...
| Execution Time | 2025-02-19 05:07:49 UTC |
...
running this report
    ...
    PROCESSX_PS1d451ba56347_1739941663
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpElYc85
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fairadapt_v1.0.0-tikzDictionary"
