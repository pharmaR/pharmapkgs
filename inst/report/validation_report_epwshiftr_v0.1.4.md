# Validation Report - epwshiftr@0.1.4
...
| export_help          | 15                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Hongyuan Jia <hongyuanjia@outlook.com>     |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/ideas-lab-nus/epwshiftr |
...
| 4   | eplusr (\>= 0.15.2)     | Imports |
| 5   | fst                     | Imports |
| 6   | future.apply            | Imports |
| 7   | jsonlite                | Imports |
| 8   | PCICt                   | Imports |
| 9   | progressr               | Imports |
| 10  | psychrolib              | Imports |
| 11  | R6                      | Imports |
| 12  | rappdirs                | Imports |
| 13  | RNetCDF                 | Imports |
| 14  | units                   | Imports |
...
Overall the package has 15 exported objects. 15 are documented:
          ...
          cmip6_dict        Cmip6Dict       esgf_query        EsgfQuery 
                TRUE             TRUE             TRUE             TRUE 
        extract_data       future_epw     get_data_dir    get_data_node 
                TRUE             TRUE             TRUE             TRUE 
    init_cmip6_index load_cmip6_index      match_coord     morphing_epw 
                TRUE             TRUE             TRUE             TRUE 
          query_esgf  set_cmip6_index summary_database 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 04:22:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d45164e44ec_1739938924
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2VjKJa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epwshiftr_v0.1.4-tikzDictionary"
