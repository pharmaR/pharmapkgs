# Validation Report - CholWishart@1.1.4
...
| export_help          | 10                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Geoffrey Thompson <gzthompson@gmail.com> |
...
bayesWatch, bgsmtr, bspcov, CausalMBSTS, CovCombR, dyads, MixMatrix,
shrinkem, singcar, vglmer

## Namespace

Overall the package has 10 exported objects. 10 are documented:

        dInvWishart        dWishart        lmvgamma       mvdigamma         mvgamma 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       rCholWishart  rGenInvWishart rInvCholWishart     rInvWishart  rPseudoWishart 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-16 04:15:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35a33056a_1739679310
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpzj5AxD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CholWishart_v1.1.4-tikzDictionary"
