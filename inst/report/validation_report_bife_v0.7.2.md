...
| has_source_control   | https://github.com/amrei-stammann/bife |
...
alpaca, insight, marginaleffects

## Namespace

Overall the package has 5 exported objects. 5 are documented:

      apeff_bife    bias_corr         bife bife_control     get_APEs 
...
| Execution Time | 2025-02-15 04:02:34 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3d9f11f8_1739592149
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5zyKtD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bife_v0.7.2-tikzDictionary"
