# Validation Report - benchmarkmeData@1.0.4
...
| has_source_control   | https://github.com/csgillespie/benchmarkme-data |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    get_datatable_past   is_blas_optimize      make_data_set         move_files 
                  TRUE               TRUE               TRUE               TRUE 
             plot_past     select_results  summarise_results 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 03:52:51 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1e1d121b_1739591566
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpevC1Ab
...
These are the options set to generate the report:
    ...
    [1] "validation_report_benchmarkmeData_v1.0.4-tikzDictionary"
