...
| export_help          | 22                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Marcelo Araya-Salas <marcelo.araya@ucr.ac.cr> |
| bugs_status          | subscript out of bounds                       |
| size_codebase        | 6233                                          |
| has_source_control   | https://github.com/ropensci/baRulho           |
...
Overall the package has 22 exported objects. 22 are documented:
                ...
                add_noise      align_test_files           attenuation 
                     TRUE                  TRUE                  TRUE 
             auto_realign            blur_ratio    detection_distance 
                     TRUE                  TRUE                  TRUE 
     envelope_correlation    excess_attenuation          find_markers 
                     TRUE                  TRUE                  TRUE 
           manual_realign     master_sound_file         noise_profile 
                     TRUE                  TRUE                  TRUE 
      plot_aligned_sounds       plot_blur_ratio      plot_degradation 
                     TRUE                  TRUE                  TRUE 
     set_reference_sounds signal_to_noise_ratio                  spcc 
                     TRUE                  TRUE                  TRUE 
      spectrum_blur_ratio  spectrum_correlation          synth_sounds 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-14 07:43:31 UTC |
...
running this report
    ...
    PROCESSX_PS1c0970bc659c_1739519008
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1JIACQ
