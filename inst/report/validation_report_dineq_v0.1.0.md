...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | René Schulenberg <reneschulenberg@gmail.com>         |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | boot (\>= 1.3-20) | Imports |
| 2   | Hmisc (\>= 4.0-3) | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
    ...
    dineq_change_rb        dineq_rb     gini_decomp        gini.wtd      mld_change 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         mld_decomp         mld.wtd      ntiles.wtd       polar.wtd             rif 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               rifr          rifrSE       theil.wtd 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:07:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bb474e3847f_1739851665
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptKmUH6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dineq_v0.1.0-tikzDictionary"
