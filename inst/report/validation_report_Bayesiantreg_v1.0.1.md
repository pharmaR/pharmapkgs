# Validation Report - Bayesiantreg@1.0.1
...
| export_help          | 0                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Margarita Marin <mmarinj@unal.edu.co>                |
...
|:----|:------------------|:--------|
| 1   | MASS (\>= 7.3)    | Imports |
| 2   | Matrix (\>= 1.2)  | Imports |
| 3   | mvtnorm (\>= 1.1) | Imports |
...
| Execution Time | 2025-02-15 03:36:46 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd32fe38e1_1739590601
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxTgj7T
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Bayesiantreg_v1.0.1-tikzDictionary"
