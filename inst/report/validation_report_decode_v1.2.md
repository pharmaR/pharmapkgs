...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Thomas Lui <tlui27@yahoo.com>                        |
...
Overall the package has 10 exported objects. 10 are documented:
         ...
         getAssoGeneSetPValue  getBestAssociatedGeneSet       getBonferroniPValue 
                         TRUE                      TRUE                      TRUE 
    getDE_DC_OptimalThreshold                    getFDR         getPartitionIndex 
                         TRUE                      TRUE                      TRUE 
                   getPathway           openFileToWrite                 runDecode 
                         TRUE                      TRUE                      TRUE 
            sumResult_MinGain 
                         TRUE 
...
| Execution Time | 2025-02-18 03:32:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bb440811708_1739849564
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppVzmNs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_decode_v1.2-tikzDictionary"
