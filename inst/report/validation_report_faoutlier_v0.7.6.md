# Validation Report - faoutlier@0.7.6
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Phil Chalmers <rphilip.chalmers@gmail.com>           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/philchalmers/faoutlier            |
...
| 5   | lattice             | Imports |
| 6   | lavaan              | Imports |
| 7   | mirt (\>= 1.32.1)   | Imports |
| 8   | MASS                | Imports |
| 9   | pbapply (\>= 1.3-0) | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    forward.search            gCD            GOF             LD      obs.resid 
...
| Execution Time | 2025-02-19 05:12:02 UTC |
...
running this report
    ...
    PROCESSX_PS1d453560530a_1739941915
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpcx9aJs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_faoutlier_v0.7.6-tikzDictionary"
