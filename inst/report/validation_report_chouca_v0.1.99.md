# Validation Report - chouca@0.1.99
...
| export_help          | 9                                   |
| has_website          | TRUE                                |
| has_maintainer       | Alexandre Genin <a.a.h.genin@uu.nl> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/alexgenin/chouca |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    as.camodel_initmat         ca_library            camodel   generate_initmat 
                  TRUE               TRUE               TRUE               TRUE 
     landscape_plotter        run_camodel      run_meanfield      trace_plotter 
                  TRUE               TRUE               TRUE               TRUE 
            transition 
                  TRUE 
...
| Execution Time | 2025-02-16 04:16:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33a1424f5_1739679360
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmhVXbm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chouca_v0.1.99-tikzDictionary"
