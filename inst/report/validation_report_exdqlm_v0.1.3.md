# Validation Report - exdqlm@0.1.3
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Raquel Barata <raquel.a.barata@gmail.com>            |
...
| 8   | crch                  | Imports |
| 9   | truncnorm             | Imports |
| 10  | HyperbolicDist        | Imports |
| 11  | GeneralizedHyperbolic | Imports |
| 12  | brms                  | Imports |
| 13  | FNN                   | Imports |
| 14  | LaplacesDemon         | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
           ...
           combineMods           compPlot             dlmMod       exdqlmChecks 
                  TRUE               TRUE               TRUE               TRUE 
        exdqlmForecast         exdqlmISVB         exdqlmMCMC         exdqlmPlot 
                  TRUE               TRUE               TRUE               TRUE 
          polytrendMod            seasMod transfn_exdqlmISVB 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:49:36 UTC |
...
running this report
    ...
    PROCESSX_PS1d4543ea982c_1739940569
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5bn81I
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exdqlm_v0.1.3-tikzDictionary"
