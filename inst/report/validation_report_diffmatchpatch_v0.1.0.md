# Validation Report - diffmatchpatch@0.1.0
...
| export_help          | 12                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Colin Rundel <rundel@gmail.com>          |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/rundel/diffmatchpatch |
...
Overall the package has 12 exported objects. 12 are documented:
     ...
     diff_from_delta diff_levenshtein        diff_make   diff_text_dest 
                TRUE             TRUE             TRUE             TRUE 
    diff_text_source    diff_to_delta     diff_to_html    diff_to_patch 
                TRUE             TRUE             TRUE             TRUE 
         dmp_options       match_find      patch_apply       patch_make 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:04:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43f4404f3_1739851440
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbP3RpM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diffmatchpatch_v0.1.0-tikzDictionary"
