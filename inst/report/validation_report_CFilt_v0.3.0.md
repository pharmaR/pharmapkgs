...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jessica Kubrusly <jessicakubrusly@id.uff.br>         |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         CFbuilder         cosine estimaterating        jaccard  kclosestitems 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           pearson      topkitems      topkusers 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:04:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31a6ea56b_1739678673
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOty6Wh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CFilt_v0.3.0-tikzDictionary"
