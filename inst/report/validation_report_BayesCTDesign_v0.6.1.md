# Validation Report - BayesCTDesign@0.6.1
...
| export_help          | 8                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Barry Eggleston <beggleston@rti.org>      |
| bugs_status          | 1                                         |
| has_source_control   | https://github.com/begglest/BayesCTDesign |
...
|:----|:----------------------|:--------|
| 1   | eha (\>= 2.9.0)       | Imports |
| 2   | ggplot2 (\>= 2.2.1)   | Imports |
| 3   | survival (\>= 2.41-3) | Imports |
| 4   | reshape2 (\>= 1.4.3)  | Imports |
| 5   | stats (\>= 3.5.0)     | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    genbernoullidata  gengaussiandata genlognormaldata   genpoissondata 
                TRUE             TRUE             TRUE             TRUE 
          genpwedata   genweibulldata     historic_sim       simple_sim 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 03:33:06 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdf5b4879_1739590381
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppUag8T
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesCTDesign_v0.6.1-tikzDictionary"
