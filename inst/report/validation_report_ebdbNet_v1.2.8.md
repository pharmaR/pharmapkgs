# Validation Report - ebdbNet@1.2.8
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Andrea Rau <andrea.rau@inra.fr>                      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/andreamrau/ebdbNet                |
...
Overall the package has 7 exported objects. 7 are documented:
         ...
         calcAUC calcSensSpec   dataFormat        ebdbn       hankel plot.ebdbNet 
...
| Execution Time | 2025-02-18 05:15:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bb411edd34_1739855708
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWuwJVH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ebdbNet_v1.2.8-tikzDictionary"
