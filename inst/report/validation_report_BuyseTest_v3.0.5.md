# Validation Report - BuyseTest@3.0.5
...
| export_help          | 32                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Brice Ozenne <brice.mh.ozenne@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/bozenne/BuyseTest     |
| has_bug_reports_url  | 1                                        |
| downloads_1yr        | 8110                                     |
| reverse_dependencies | 0                                        |
| has_examples         | 0.9508197                                |
| dependencies         | 17                                       |
| license              | GPL-3                                    |
...
Overall the package has 18 exported objects. 24 are documented:

     .calcIntegralCif_cpp .calcIntegralSurv_cpp                   auc 
                     TRUE                  TRUE                  TRUE 
                    brier         BuyseMultComp             BuyseTest 
                     TRUE                  TRUE                  TRUE 
        BuyseTest.options             BuyseTTEM calcIntegralSurv2_cpp 
                     TRUE                  TRUE                  TRUE 
               CasinoTest           constStrata               GPC_cpp 
                     TRUE                  TRUE                  TRUE 
                 GPC2_cpp           performance   performanceResample 
                     TRUE                  TRUE                  TRUE 
           powerBuyseTest          simBuyseTest     simCompetingRisks 
                     TRUE                  TRUE                  TRUE 

### Examples

There are 58 help pages with examples, from 61 (95.08 %).
...
| Execution Time | 2025-02-15 04:56:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd49e1b7b6_1739595413
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz6ozGo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BuyseTest_v3.0.5-tikzDictionary"
