...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel Sabanes Bove <daniel.sabanesbove@gmx.net>     |
...
Overall the package has 18 exported objects. 18 are documented:
                    ...
                    BayesMfp                      bfp               bmaPredict 
                        TRUE                     TRUE                     TRUE 
                  BmaSamples             empiricalHpd                findModel 
                        TRUE                     TRUE                     TRUE 
               getLogMargLik              getLogPrior        getPosteriorParms 
                        TRUE                     TRUE                     TRUE 
            getPostExpectedg getPostExpectedShrinkage           inclusionProbs 
                        TRUE                     TRUE                     TRUE 
           plotCurveEstimate               posteriors                 scrBesag 
                        TRUE                     TRUE                     TRUE 
                      scrHpd             transformMfp                       uc 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-22 03:15:33 UTC |
...
running this report
    ...
    PROCESSX_PS1dbbd1aa533_1740194129
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgUHKUP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bfp_v0.0.48-tikzDictionary"
