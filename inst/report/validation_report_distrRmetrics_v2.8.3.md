# Validation Report - distrRmetrics@2.8.3
...
| 2   | methods               | Depends |
| 3   | distr(\>= 2.4)        | Depends |
| 4   | fBasics(\>= 270.73)   | Depends |
| 5   | fGarch(\>= 270.73)    | Depends |
...
Overall the package has 3 exported objects. 7 are documented:
...
| Execution Time | 2025-02-18 04:21:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42cf0bee3_1739852469
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmps7ncVm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distrRmetrics_v2.8.3-tikzDictionary"
