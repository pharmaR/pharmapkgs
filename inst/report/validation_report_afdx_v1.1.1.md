...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | John J. Aponte <john.j.aponte@gmail.com>             |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 266                                                  |
| has_source_control   | https://github.com/johnaponte/afdx                   |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    get_latent_model         logitexp     make_cutoffs   make_n_cutoffs 
                TRUE             TRUE             TRUE             TRUE 
             senspec 
                TRUE 
...
| Execution Time | 2025-02-14 06:41:06 UTC |
...
running this report
    ...
    PROCESSX_PS726d2f39f2dd_1739515263
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPEcVIO
