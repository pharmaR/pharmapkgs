# Validation Report - Certara.Xpose.NLME@2.0.2
...
Overall the package has 12 exported objects. 12 are documented:
            ...
            eta_vs_cov    get_overallNlme        get_prmNlme     nlme.cov.splom 
                  TRUE               TRUE               TRUE               TRUE 
       nlme.par.vs.cov nlme.ranpar.vs.cov    nlme.var.vs.cov         prm_vs_cov 
                  TRUE               TRUE               TRUE               TRUE 
            res_vs_cov          xplot_box          xposeNlme     xposeNlmeModel 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:03:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3720c14ea_1739678596
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpK6JPGx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Certara.Xpose.NLME_v2.0.2-tikzDictionary"
