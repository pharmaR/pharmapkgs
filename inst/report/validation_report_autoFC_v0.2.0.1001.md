...
| export_help          | 18                                  |
| has_website          | TRUE                                |
| has_maintainer       | Mengtong Li <ml70@illinois.edu>     |
| bugs_status          | subscript out of bounds             |
| size_codebase        | 786                                 |
| has_source_control   | https://github.com/tspsyched/autoFC |
...
Overall the package has 18 exported objects. 18 are documented:
    ...
    build_scale_with_blueprint       build_TIRT_var_names 
                          TRUE                       TRUE 
              cal_block_energy  cal_block_energy_with_iia 
                          TRUE                       TRUE 
           construct_blueprint   convert_to_TIRT_response 
                          TRUE                       TRUE 
         empirical_reliability                     facfun 
                          TRUE                       TRUE 
                fit_TIRT_model          get_CFA_estimates 
                          TRUE                       TRUE 
                       get_iia    get_simulation_matrices 
                          TRUE                       TRUE 
            get_TIRT_long_data          make_random_block 
                          TRUE                       TRUE 
                   plot_scores             predict_scores 
                          TRUE                       TRUE 
                    RMSE_range     sa_pairing_generalized 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-14 07:33:18 UTC |
...
running this report
    ...
    PROCESSX_PS1c09327a2778_1739518395
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz7iT2E
