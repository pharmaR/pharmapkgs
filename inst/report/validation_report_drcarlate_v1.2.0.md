# Validation Report - drcarlate@1.2.0
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Mingxin Zhang <21110680035@m.fudan.edu.cn>           |
...
Overall the package has 17 exported objects. 17 are documented:
                      ...
                      ATEDGP                  ATEJLTZ                ATEOutput 
                        TRUE                     TRUE                     TRUE 
                ATETrueValue               CovAdptRnd feasiblePostLassoMatTool 
                        TRUE                     TRUE                     TRUE 
                     FuncDGP                     JLTZ              LinearLogit 
                        TRUE                     TRUE                     TRUE 
                 LogisticReg                  norminv                   Output 
                        TRUE                     TRUE                     TRUE 
                       pihat              splinebasis                    stanE 
                        TRUE                     TRUE                     TRUE 
                         tau                TrueValue 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-18 04:44:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42953bca_1739853852
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBNb4eI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drcarlate_v1.2.0-tikzDictionary"
