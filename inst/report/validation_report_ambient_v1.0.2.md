...
| export_help          | 37                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Thomas Lin Pedersen <thomasp85@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| size_codebase        | 813                                       |
| has_source_control   | https://github.com/thomasp85/ambient      |
...
Overall the package has 37 exported objects. 37 are documented:
              ...
              billow            blend              cap          clamped 
                TRUE             TRUE             TRUE             TRUE 
          curl_noise              fbm         fracture gen_checkerboard 
                TRUE             TRUE             TRUE             TRUE 
           gen_cubic       gen_perlin      gen_simplex      gen_spheres 
                TRUE             TRUE             TRUE             TRUE 
           gen_value        gen_waves        gen_white       gen_worley 
                TRUE             TRUE             TRUE             TRUE 
      gradient_noise        grid_cell        long_grid       noise_blue 
                TRUE             TRUE             TRUE             TRUE 
         noise_cubic     noise_perlin    noise_simplex      noise_value 
                TRUE             TRUE             TRUE             TRUE 
         noise_white     noise_worley        normalise        normalize 
                TRUE             TRUE             TRUE             TRUE 
             reflect           ridged           rotate            shear 
                TRUE             TRUE             TRUE             TRUE 
            slice_at    spectral_gain          stretch     trans_affine 
                TRUE             TRUE             TRUE             TRUE 
           translate 
                TRUE 
...
| Execution Time | 2025-02-14 06:51:35 UTC |
...
running this report
    ...
    PROCESSX_PS726d551f7f8c_1739515893
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCDIxqS
