...
| has_source_control   | https://github.com/eheinzen/elo        |
...
Overall the package has 25 exported objects. 25 are documented:
               ...
               adjust             brier          elo.calc        elo.colley 
                 TRUE              TRUE              TRUE              TRUE 
              elo.glm   elo.markovchain   elo.model.frame          elo.prob 
                 TRUE              TRUE              TRUE              TRUE 
              elo.run elo.run.multiteam        elo.update        elo.winpct 
                 TRUE              TRUE              TRUE              TRUE 
              favored        final.elos             group          is.score 
                 TRUE              TRUE              TRUE              TRUE 
                    k               mov               mse         multiteam 
                 TRUE              TRUE              TRUE              TRUE 
              neutral           players        rank.teams           regress 
                 TRUE              TRUE              TRUE              TRUE 
                score 
                 TRUE 
...
| Execution Time | 2025-02-19 03:57:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d4549426489_1739937465
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIZfVg4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_elo_v3.0.2-tikzDictionary"
