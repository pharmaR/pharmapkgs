# Validation Report - discrim@1.0.1
...
| has_source_control   | https://github.com/tidymodels/discrim    |
...
fastml, finetune, tidyAML

## Namespace

Overall the package has 7 exported objects. 7 are documented:

    fit_regularized_linear   fit_regularized_quad        frac_common_cov 
                      TRUE                   TRUE                   TRUE 
             frac_identity     klar_bayes_wrapper           pred_wrapper 
                      TRUE                   TRUE                   TRUE 
                smoothness 
                      TRUE 
...
| Execution Time | 2025-02-18 04:14:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45305dfa1_1739852053
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeXpSwp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_discrim_v1.0.1-tikzDictionary"
