...
| export_help          | 11                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Sukalpo Saha <sukalpo.saha@pfizer.com>         |
| bugs_status          | subscript out of bounds                        |
| size_codebase        | 582                                            |
| has_source_control   | https://github.com/pharmaverse/admiralvaccine/ |
...
Overall the package has 11 exported objects. 11 are documented:
    ...
    derive_diam_to_sev_records       derive_fever_records 
                          TRUE                       TRUE 
          derive_var_aval_adis           derive_vars_crit 
                          TRUE                       TRUE 
        derive_vars_event_flag       derive_vars_max_flag 
                          TRUE                       TRUE 
    derive_vars_merged_vaccine         derive_vars_params 
                          TRUE                       TRUE 
             derive_vars_vaxdt                   max_flag 
                          TRUE                       TRUE 
           post_process_reacto 
                          TRUE 
...
| Execution Time | 2025-02-14 06:38:36 UTC |
...
running this report
    ...
    PROCESSX_PS726d34ce2474_1739515113
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiAeyWn
