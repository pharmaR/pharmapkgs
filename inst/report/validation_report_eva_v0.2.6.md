...
| export_help          | 29                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Brian Bader <bbader.stat@gmail.com>       |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/brianbader/eva_package |
...
Overall the package has 29 exported objects. 29 are documented:
            ...
            dgevr          dgpd      gevrDiag        gevrEd       gevrFit 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    gevrMultScore   gevrPbScore gevrProfShape        gevrRl  gevrSeqTests 
             TRUE          TRUE          TRUE          TRUE          TRUE 
            gpdAd        gpdCvm       gpdDiag        gpdFit     gpdImAsym 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          gpdImPb  gpdMultScore    gpdPbScore  gpdProfShape         gpdRl 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      gpdSeqTests       mrlPlot          pgev          pgpd      pSeqStop 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             qgev          qgpd         rgevr          rgpd 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 04:37:22 UTC |
...
running this report
    ...
    PROCESSX_PS1d455b44f7b1_1739939836
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLK9k5T
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eva_v0.2.6-tikzDictionary"
