...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Salvador Gezan <salvador.gezan@vsni.co.uk>           |
...
Overall the package has 18 exported objects. 18 are documented:
            ...
            full2sparse           G.inverse            G.matrix           G.predict 
                   TRUE                TRUE                TRUE                TRUE 
               G.tuneup           H.inverse            H.matrix kinship.diagnostics 
                   TRUE                TRUE                TRUE                TRUE 
        kinship.heatmap         kinship.pca           match.G2A match.kinship2pheno 
                   TRUE                TRUE                TRUE                TRUE 
           qc.filtering             snp.pca         snp.pruning          snp.recode 
                   TRUE                TRUE                TRUE                TRUE 
            sparse2full     synthetic.cross 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-14 07:28:04 UTC |
...
running this report
    ...
    PROCESSX_PS1c09f3878cb_1739518081
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMqxEW7
