...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Andrea Batch <Andrea.Julca@bea.gov>                  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/us-bea/bea.R                      |
...
| 11  | gtable         | Imports |
| 12  | scales         | Imports |
| 13  | htmltools      | Imports |
| 14  | httpuv         | Imports |
| 15  | xtable         | Imports |
| 16  | stringi        | Imports |
| 17  | magrittr       | Imports |
| 18  | htmlwidgets    | Imports |
| 19  | Rcpp           | Imports |
| 20  | munsell        | Imports |
| 21  | colorspace     | Imports |
| 22  | plyr           | Imports |
| 23  | yaml           | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
             ...
             bea2List           bea2Tab            beaGet         beaParams 
                 TRUE              TRUE              TRUE              TRUE 
         beaParamVals         beaSearch           beaSets beaUpdateMetadata 
                 TRUE              TRUE              TRUE              TRUE 
               beaViz 
                 TRUE 
...
| Execution Time | 2025-02-15 03:49:32 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2e147255_1739591367
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvRlktR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bea.R_v1.0.6-tikzDictionary"
