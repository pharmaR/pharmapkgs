...
| size_codebase        | 5427                                        |
| has_source_control   | https://github.com/HenrikBengtsson/aroma.cn |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | R.utils (\>= 2.11.0)     | Depends |
| 2   | aroma.core (\>= 3.2.2)   | Depends |
| 3   | R.methodsS3 (\>= 1.8.1)  | Imports |
| 4   | R.oo (\>= 1.24.0)        | Imports |
| 5   | R.filesets (\>= 2.14.0)  | Imports |
| 6   | R.cache (\>= 0.15.0)     | Imports |
| 7   | matrixStats (\>= 0.61.0) | Imports |
| 8   | PSCBS (\>= 0.65.0)       | Imports |
| 9   | future.apply             | Imports |
...
| Execution Time | 2025-02-14 07:24:29 UTC |
...
running this report
    ...
    PROCESSX_PS1c092323ff1f_1739517867
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDG0iLy
