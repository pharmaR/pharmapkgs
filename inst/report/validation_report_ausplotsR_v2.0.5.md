...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Greg Guerin <ggueri01@gmail.com>                     |
...
Overall the package has 12 exported objects. 12 are documented:
    ...
    ausplots_trajectory     ausplots_visual          basal_area    fractional_cover 
                   TRUE                TRUE                TRUE                TRUE 
           get_ausplots   growth_form_table        map_ausplots       optim_species 
                   TRUE                TRUE                TRUE                TRUE 
               plot_opt  single_cover_value        species_list       species_table 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-14 07:32:36 UTC |
...
running this report
    ...
    PROCESSX_PS1c096b6aaac0_1739518353
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdY1NMO
