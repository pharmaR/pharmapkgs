# Validation Report - denoiSeq@0.1.1
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Gershom Buri <buri@aims.edu.gh>                      |
...
Overall the package has 7 exported objects. 7 are documented:
         ...
         denoiseq  getSamplesOf       results setInitValues setReplicates 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     setStepSizes tunedStepSize 
             TRUE          TRUE 
...
| Execution Time | 2025-02-18 03:42:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4311da855_1739850115
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXfsYT1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_denoiSeq_v0.1.1-tikzDictionary"
