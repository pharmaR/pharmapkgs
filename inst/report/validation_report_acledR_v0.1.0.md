# Validation Report - acledR@0.1.0
...
| export_help          | 9                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Trey Billing <t.billing@acleddata.com> |
| bugs_status          | 1                                      |
...
Overall the package has 9 exported objects. 8 are documented:
                            ...
                            %>%                acled_access 
                          FALSE                        TRUE 
                      acled_api         acled_deletions_api 
                           TRUE                        TRUE 
                 acled_rounding acled_transform_interaction 
                           TRUE                        TRUE 
         acled_transform_longer       acled_transform_wider 
                           TRUE                        TRUE 
                   acled_update 
                           TRUE 
...
| Execution Time | 2025-02-25 03:20:16 UTC |
...
running this report
    ...
    PROCESSX_PS1d28245c6782_1740453612
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzVRsvB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_acledR_v0.1.0-tikzDictionary"
