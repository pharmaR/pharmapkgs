...
| export_help          | 7                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Riccardo Giubilei <riccardogbl@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/ricgbl/etree           |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | brainGraph          | Imports |
| 2   | cluster             | Imports |
| 3   | energy              | Imports |
| 4   | fda.usc (\>= 2.0.0) | Imports |
| 5   | igraph              | Imports |
| 6   | NetworkDistance     | Imports |
| 7   | parallel            | Imports |
| 8   | partykit            | Imports |
| 9   | survival            | Imports |
| 10  | TDA                 | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
        ...
        depth dist_comp   eforest     etree nodeapply   nodeids     width 
...
| Execution Time | 2025-02-19 04:34:49 UTC |
...
running this report
    ...
    PROCESSX_PS1d4516cf79f_1739939682
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDvq7B2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_etree_v0.1.0-tikzDictionary"
