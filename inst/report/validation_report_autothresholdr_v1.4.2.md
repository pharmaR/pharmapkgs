...
| size_codebase        | 525                                                |
| has_source_control   | https://github.com/rorynolan/autothresholdr#readme |
...
|     | package               | type      |
|:----|:----------------------|:----------|
| 1   | checkmate (\>= 1.9.3) | Imports   |
| 2   | ijtiff (\>= 2.2)      | Imports   |
| 3   | magrittr (\>= 1.5)    | Imports   |
| 4   | purrr                 | Imports   |
| 5   | Rcpp (\>= 1.0.11)     | Imports   |
| 6   | rlang (\>= 0.3.3)     | Imports   |
| 7   | stats                 | Imports   |
| 8   | strex (\>= 1.4.1)     | Imports   |
| 9   | stringr (\>= 1.4)     | Imports   |
| 10  | Rcpp (\>= 1.0.11)     | LinkingTo |
...
Overall the package has 11 exported objects. 11 are documented:
                ...
                apply_mask            auto_thresh auto_thresh_apply_mask 
                      TRUE                   TRUE                   TRUE 
          auto_thresh_mask                   mask             masked_arr 
                      TRUE                   TRUE                   TRUE 
         mean_stack_thresh       med_stack_thresh     stack_threshed_img 
                      TRUE                   TRUE                   TRUE 
                        th           threshed_arr 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-14 07:35:03 UTC |
...
running this report
    ...
    PROCESSX_PS1c09353d923a_1739518500
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjwlfnA
