# Validation Report - coffee@0.4.3
...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Maarten Blaauw <maarten.blaauw@qub.ac.uk>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/Maarten14C/coffee                 |
...
| 2   | rintcal (\>= 1.1.0) | Imports |
| 3   | rice (\>= 0.4.0)    | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
      ...
      ages.undated draw.MCMCrings     draw.rings     draw.strat            IAT 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         MCMCrings          rings       scissors      sim.rings      sim.strat 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             strat  strat.cleanup        thinner      withinhpd 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:53:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35201d973_1739681624
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXgIlQz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coffee_v0.4.3-tikzDictionary"
