...
| size_codebase        | 2938                                  |
| has_source_control   | https://github.com/r-lib/asciicast    |
...
|     | package               | type      |
|:----|:----------------------|:----------|
| 1   | cli (\>= 3.3.0.9000)  | Imports   |
| 2   | curl                  | Imports   |
| 3   | jsonlite              | Imports   |
| 4   | magick (\>= 2.2.9002) | Imports   |
| 5   | processx (\>= 3.7.0)  | Imports   |
| 6   | tibble                | Imports   |
| 7   | utils                 | Imports   |
| 8   | V8                    | Imports   |
| 9   | withr                 | Imports   |
| 10  | processx              | LinkingTo |
...
Overall the package has 19 exported objects. 19 are documented:
            ...
            asciicast_options   asciicast_start_process          asciinema_player 
                         TRUE                      TRUE                      TRUE 
                 clear_screen             default_theme expect_snapshot_r_process 
                         TRUE                      TRUE                      TRUE 
                  get_locales         init_knitr_engine         install_phantomjs 
                         TRUE                      TRUE                      TRUE 
                  merge_casts                     pause                      play 
                         TRUE                      TRUE                      TRUE 
                    read_cast                    record             record_output 
                         TRUE                      TRUE                      TRUE 
                    write_gif                write_html                write_json 
                         TRUE                      TRUE                      TRUE 
                    write_svg 
                         TRUE 
...
| Execution Time | 2025-02-14 07:26:30 UTC |
...
running this report
    ...
    PROCESSX_PS1c093c38ba6d_1739517987
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmputnCR6
