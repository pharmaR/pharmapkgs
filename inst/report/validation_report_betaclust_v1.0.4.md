# Validation Report - betaclust@1.0.4
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Koyel Majumdar <koyel.majumdar@ucdconnect.ie>        |
...
Overall the package has 11 exported objects. 11 are documented:
         ...
         AUC_WD_metric             beta_k            beta_kn            beta_kr 
                  TRUE               TRUE               TRUE               TRUE 
             betaclust DMC_identification     ecdf.betaclust             em_aic 
                  TRUE               TRUE               TRUE               TRUE 
                em_bic             em_icl          threshold 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 03:55:23 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd45a9668f_1739591718
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCqSc5v
...
These are the options set to generate the report:
    ...
    [1] "validation_report_betaclust_v1.0.4-tikzDictionary"
