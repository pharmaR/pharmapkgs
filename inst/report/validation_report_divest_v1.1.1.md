# Validation Report - divest@1.1.1
...
| export_help          | 9                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Jon Clayden <code@clayden.org>       |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/jonclayden/divest |
...
Overall the package has 9 exported objects. 9 are documented:
           ...
           convertDicom divest.capabilities        fromBidsJson     imageAttributes 
                   TRUE                TRUE                TRUE                TRUE 
      imageAttributes<-           readDicom           scanDicom           sortDicom 
                   TRUE                TRUE                TRUE                TRUE 
             toBidsJson 
                   TRUE 
...
| Execution Time | 2025-02-18 04:23:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41bf6bc75_1739852598
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfbLgBG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_divest_v1.1.1-tikzDictionary"
