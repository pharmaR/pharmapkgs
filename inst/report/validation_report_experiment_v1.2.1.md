# Validation Report - experiment@1.2.1
...
| export_help          | 13                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Kosuke Imai <imai@harvard.edu>           |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/kosukeimai/experiment |
...
Overall the package has 13 exported objects. 13 are documented:
           ...
           ATEbounds       ATEcluster         ATEnocov ATOPnoassumption 
                TRUE             TRUE             TRUE             TRUE 
             ATOPobs         ATOPsens            AUPEC      CACEcluster 
                TRUE             TRUE             TRUE             TRUE 
            CADErand          CADEreg             PAPD             PAPE 
                TRUE             TRUE             TRUE             TRUE 
           randomize 
                TRUE 
...
| Execution Time | 2025-02-19 04:52:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d452fca7e3b_1739940719
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcHdON6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_experiment_v1.2.1-tikzDictionary"
