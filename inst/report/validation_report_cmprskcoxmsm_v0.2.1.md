# Validation Report - cmprskcoxmsm@0.2.1
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yiran Zhang <yiz038@health.ucsd.edu>                 |
...
Overall the package has 6 exported objects. 6 are documented:
             ...
             cif_est             doPS     plot_est_cif          plot.PS 
                TRUE             TRUE             TRUE             TRUE 
          pvalFormat weight_cause_cox 
                TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:45:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37f30d7c2_1739681123
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcK5RV3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmprskcoxmsm_v0.2.1-tikzDictionary"
