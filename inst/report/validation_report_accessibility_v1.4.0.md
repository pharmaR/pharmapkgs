...
| export_help          | 18                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Daniel Herszenhut <dhersz@gmail.com>     |
| bugs_status          | 0.8666667                                |
| size_codebase        | 1910                                     |
| has_source_control   | https://github.com/ipeaGIT/accessibility |
...
Overall the package has 18 exported objects. 18 are documented:
             ...
             balancing_cost     concentration_index         cost_to_closest 
                       TRUE                    TRUE                    TRUE 
          cumulative_cutoff     cumulative_interval            decay_binary 
                       TRUE                    TRUE                    TRUE 
          decay_exponential            decay_linear          decay_logistic 
                       TRUE                    TRUE                    TRUE 
                decay_power           decay_stepped             fgt_poverty 
                       TRUE                    TRUE                    TRUE 
    floating_catchment_area              gini_index                 gravity 
                       TRUE                    TRUE                    TRUE 
                palma_ratio    spatial_availability                 theil_t 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 06:30:47 UTC |
...
running this report
    ...
    PROCESSX_PS726d1cb3ee56_1739514644
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp430Pi4
