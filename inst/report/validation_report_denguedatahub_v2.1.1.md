# Validation Report - denguedatahub@2.1.1
...
| export_help          | 7                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Thiyanga S. Talagala <ttalagala@sjp.ac.lk> |
...
| 10  | purrr              | Imports |
| 11  | xml2               | Imports |
| 12  | tabulapdf          | Imports |
| 13  | rlang (\>= 0.4.11) | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
           ...
           convert_slwer_to_tidy convert_srilanka_wer_to_tidy 
                            TRUE                         TRUE 
        download_pdfwer_srilanka              filter_year_wer 
                            TRUE                         TRUE 
                   get_addresses        get_pdflinks_srilanka 
                            TRUE                         TRUE 
                         min_max 
                            TRUE 
...
| Execution Time | 2025-02-18 03:41:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4179a88a1_1739850102
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwlCeqD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_denguedatahub_v2.1.1-tikzDictionary"
