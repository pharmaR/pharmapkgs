# Validation Report - cgmquantify@0.1.0
...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Maria Henriquez <marhenriq@gmail.com>                |
...
Overall the package has 18 exported objects. 18 are documented:
               ...
               eA1c             GMI            HBGI      interdaycv      interdaysd 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         intradaycv      intradaysd         J_index            LBGI       LBGI_HBGI 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                MGE             MGN    plot_glucose             POR        readfile 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    summary_glucose             TIR             TOR 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-16 04:06:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bc339ccf5e2_1739678777
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPtQqeR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cgmquantify_v0.1.0-tikzDictionary"
