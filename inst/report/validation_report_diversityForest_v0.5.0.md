# Validation Report - diversityForest@0.5.0
...
| 14  | RcppEigen         | Imports   |
| 15  | survival          | Imports   |
| 16  | patchwork         | Imports   |
| 17  | Rcpp              | LinkingTo |
| 18  | RcppEigen         | LinkingTo |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            divfor     importance interactionfor       multifor    plotEffects 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           plotMcl       plotPair        plotVar    predictions     tunedivfor 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:23:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb419bbc47d_1739852591
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJmBWNM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diversityForest_v0.5.0-tikzDictionary"
