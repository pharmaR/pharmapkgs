# Validation Report - excessmort@0.8.0
...
| export_help | 12 |
| has_website | FALSE |
| has_maintainer | Rafael A. Irizarry <rafael_irizarry@dfci.harvard.edu> |
...
Overall the package has 12 exported objects. 12 are documented:
       ...
       approx_demographics      collapse_age_dist collapse_counts_by_age 
                      TRUE                   TRUE                   TRUE 
            compute_counts       compute_expected      excess_cumulative 
                      TRUE                   TRUE                   TRUE 
              excess_model            excess_plot    expected_diagnostic 
                      TRUE                   TRUE                   TRUE 
             expected_plot       get_demographics              group_age 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-19 04:48:53 UTC |
...
running this report
    ...
    PROCESSX_PS1d4589644ab_1739940527
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpcv6sWc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_excessmort_v0.8.0-tikzDictionary"
