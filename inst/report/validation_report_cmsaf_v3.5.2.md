...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | cmsafops (\>= 1.4.0)   | Depends |
| 2   | cmsafvis (\>= 1.2.0)   | Depends |
| 3   | colourpicker (\>= 1.0) | Imports |
| 4   | colorspace (\>= 1.4)   | Imports |
| 5   | FNN (\>= 1.1)          | Imports |
| 6   | maps (\>= 3.3)         | Imports |
| 7   | ncdf4 (\>= 1.17)       | Imports |
| 8   | R.utils (\>= 2.9)      | Imports |
| 9   | raster (\>= 3.0)       | Imports |
| 10  | shiny (\>= 1.4)        | Imports |
| 11  | shinyFiles (\>= 0.8.0) | Imports |
| 12  | shinyjs (\>= 1.1)      | Imports |
| 13  | shinythemes (\>= 1.1)  | Imports |
| 14  | shinyWidgets (\>= 0.6) | Imports |
| 15  | tcltk (\>= 3.5)        | Imports |
| 16  | data.table             | Imports |
| 17  | SearchTrees            | Imports |
| 18  | xml2                   | Imports |
...
| Execution Time | 2025-02-16 04:46:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32c183629_1739681158
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPiG5GV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmsaf_v3.5.2-tikzDictionary"
