# Validation Report - comorbidPGS@0.3.4
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Vincent Pascat <vincent.pascat@univ-lille.fr>        |
...
Overall the package has 7 exported objects. 7 are documented:
             ...
             assoc      assocplot    centileplot  decileboxplot    densityplot 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        multiassoc multiphenassoc 
              TRUE           TRUE 
...
| Execution Time | 2025-02-17 03:33:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd665ad85e7_1739763204
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfK6CaD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comorbidPGS_v0.3.4-tikzDictionary"
