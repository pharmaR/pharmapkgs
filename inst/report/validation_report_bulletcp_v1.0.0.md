# Validation Report - bulletcp@1.0.0
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Nathaniel Garton <nate.garton13@gmail.com>           |
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            detect_cp   get_grooves_bcp          imputeGP              mlgp 
                 TRUE              TRUE              TRUE              TRUE 
     robust_loess_fit       runmcmc_cp0       runmcmc_cp1  runmcmc_cp1_left 
                 TRUE              TRUE              TRUE              TRUE 
    runmcmc_cp1_right       runmcmc_cp2     runmcmc_cpall 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:54:27 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd66e20bdf_1739595261
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoG2mML
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bulletcp_v1.0.0-tikzDictionary"
