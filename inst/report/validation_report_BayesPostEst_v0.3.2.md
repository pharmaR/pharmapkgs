# Validation Report - BayesPostEst@0.3.2
...
| export_help          | 10                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Shana Scogin <shanarscogin@gmail.com>       |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/ShanaScogin/BayesPostEst |
...
| 9   | stats             | Imports |
| 10  | texreg            | Imports |
| 11  | tidyr (\>= 0.5.1) | Imports |
| 12  | HDInterval        | Imports |
| 13  | ROCR              | Imports |
| 14  | graphics          | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
      ...
      mcmcAveProb  mcmcCoefPlot        mcmcFD    mcmcFDplot   mcmcMargEff 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      mcmcObsProb       mcmcReg    mcmcRocPrc mcmcRocPrcGen       mcmcTab 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-15 03:39:41 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1721ff81_1739590776
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8EBdKY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesPostEst_v0.3.2-tikzDictionary"
