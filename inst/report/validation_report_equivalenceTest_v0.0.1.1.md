# Validation Report - equivalenceTest@0.0.1.1
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Chao Wang <wan9c9@gmail.com>                         |
...
Overall the package has 8 exported objects. 8 are documented:
             ...
             createEquivTestSmpl         equivTestFixedMargin 
                            TRUE                         TRUE 
    equivTestFixedMarginCombPlot              equivTestMWCMLE 
                            TRUE                         TRUE 
                   equivTestPlot             histWNormDensity 
                            TRUE                         TRUE 
        scatterPlotEquivTestData              summarizeSample 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-19 04:24:36 UTC |
...
running this report
    ...
    PROCESSX_PS1d457665488c_1739939070
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpriSZeu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_equivalenceTest_v0.0.1.1-tikzDictionary"
