# Validation Report - dostats@1.3.3
...
| export_help          | 22                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Andrew Redd <Andrew.Redd@hsc.utah.edu>               |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/halpo/dostats                     |
...
Overall the package has 22 exported objects. 20 are documented:
                 ...
                 .T             %.%      %contains%     class.stats         collect 
               TRUE           FALSE           FALSE            TRUE            TRUE 
            compose        contains         dostats    factor.stats          fill_v 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              first            last        listrows       make_call     make_new_id 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                 me   numeric.stats           onarg            pval          redirf 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    seq_consecutive           wargs 
               TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:36:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bb459f10b07_1739853373
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6Seca1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dostats_v1.3.3-tikzDictionary"
