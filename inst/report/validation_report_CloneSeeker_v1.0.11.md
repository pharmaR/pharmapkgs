# Validation Report - CloneSeeker@1.0.11
...
Overall the package has 11 exported objects. 11 are documented:
              ...
              dataGen   generateSimplex generateTumorData          getClone 
                 TRUE              TRUE              TRUE              TRUE 
        plotTumorData            runAlg     sampleSimplex        seekClones 
                 TRUE              TRUE              TRUE              TRUE 
                Tumor          tumorGen      WeightVector 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:34:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3621355b0_1739680489
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7WTq0s
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CloneSeeker_v1.0.11-tikzDictionary"
