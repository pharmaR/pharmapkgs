# Validation Report - ClimClass@2.1.0
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Emanuele Eccel <emanuele.eccel@fmach.it>             |
...
Overall the package has 11 exported objects. 11 are documented:
              ...
              arid      as.datcli       bagn_gau        climate         contin 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            ExAtRa koeppen_geiger        oiv_ind          peguy            RDI 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      thornthwaite 
              TRUE 
...
| Execution Time | 2025-02-16 04:31:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3e33c669_1739680278
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7YptK5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClimClass_v2.1.0-tikzDictionary"
