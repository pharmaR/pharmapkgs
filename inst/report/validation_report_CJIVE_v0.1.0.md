...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Raphiel Murden <rmurden@emory.edu>                   |
...
Overall the package has 22 exported objects. 22 are documented:
          ...
          AdjSigVarExp            cc.jive       cc.jive.pred    chord.norm.diff 
                  TRUE               TRUE               TRUE               TRUE 
           ConvSims_gg  create.graph.long    GenerateToyData  GetSimResults_Dir 
                  TRUE               TRUE               TRUE               TRUE 
          gg.corr.plot  gg.load.norm.plot       gg.norm.plot       gg.rank.plot 
                  TRUE               TRUE               TRUE               TRUE 
    gg.score.norm.plot             MatVar            MatVar2      Melt.Sim.Cors 
                  TRUE               TRUE               TRUE               TRUE 
          perm.jntrank     scale_loadings       show.image.2              sjive 
                  TRUE               TRUE               TRUE               TRUE 
             vec2net.l          vec2net.u 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:24:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bc363b3b4ff_1739679879
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUwWNy9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CJIVE_v0.1.0-tikzDictionary"
