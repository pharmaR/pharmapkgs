# Validation Report - ctsemOMX@1.0.6
...
| has_source_control   | https://github.com/cdriveraus/ctsemOMX               |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 5181                                                 |
| reverse_dependencies | 1                                                    |
| has_examples         | 0.5833333                                            |
| dependencies         | 9                                                    |
| license              | GPL-3                                                |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | ctsem (\>= 3.3.2)  | Depends |
| 2   | OpenMx (\>= 2.9.0) | Depends |
| 3   | graphics           | Imports |
| 4   | grDevices          | Imports |
| 5   | Matrix             | Imports |
| 6   | methods            | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
                 ...
                 ctCI ctCompareExpected             ctFit ctGenerateFromFit 
                 TRUE              TRUE              TRUE              TRUE 
            ctIndplot    ctModelFromFit   ctMultigroupFit            ctPlot 
                 TRUE              TRUE              TRUE              TRUE 
        ctPostPredict        ctRefineTo 
                 TRUE              TRUE 

### Examples

There are 14 help pages with examples, from 24 (58.33 %).
...
| Execution Time | 2025-02-17 04:35:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bd627b1cb95_1739766946
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmprrqc57
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ctsemOMX_v1.0.6-tikzDictionary"
