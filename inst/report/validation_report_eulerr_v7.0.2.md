# Validation Report - eulerr@7.0.2
...
| export_help          | 4                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Johan Larsson <johanlarsson@outlook.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/jolars/eulerr         |
...
| 4   | grid                            | Imports   |
| 5   | polyclip                        | Imports   |
| 6   | polylabelr                      | Imports   |
| 7   | Rcpp                            | Imports   |
| 8   | stats                           | Imports   |
| 9   | utils                           | Imports   |
| 10  | Rcpp (\>= 0.12.12)              | LinkingTo |
| 11  | RcppArmadillo (\>= 0.7.600.1.0) | LinkingTo |
...
cola, hicVennDiagram, ISAnalytics, pcutils, RulesTools, seqsetvis, ypssc

## Namespace

Overall the package has 4 exported objects. 4 are documented:

        error_plot          euler eulerr_options           venn 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:35:58 UTC |
...
running this report
    ...
    PROCESSX_PS1d4513f7cc33_1739939752
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnP2z5N
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eulerr_v7.0.2-tikzDictionary"
