...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | JQ Veenstra <jqveenstra@gmail.com>                   |
...
Overall the package has 19 exported objects. 19 are documented:
             ...
             arfima      arfima.sim         arfima0   arfimachanges        ARToPacf 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          bestModes             BIC        distance         iARFIMA    IdentInvertQ 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            lARFIMA      lARFIMAwTF        PacfToAR      removeMode sim_from_fitted 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           tacfplot           tacvf     tacvfARFIMA            weed 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 07:22:58 UTC |
...
running this report
    ...
    PROCESSX_PS1c09385d865d_1739517775
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZEJFHU
