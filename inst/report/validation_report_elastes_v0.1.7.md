# Validation Report - elastes@0.1.7
...
| export_help          | 3                                              |
| has_website          | TRUE                                           |
| has_maintainer       | Manuel Pfeuffer <manuel.pfeuffer@hu-berlin.de> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/mpff/elastes                |
...
| 5   | splines               | Imports |
| 6   | mgcv                  | Imports |
| 7   | sparseFLMM            | Imports |
| 8   | orthogonalsplinebasis | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    compute_elastic_shape_mean                  get_evals 
                          TRUE                       TRUE 
            get_procrustes_fit 
                          TRUE 
...
| Execution Time | 2025-02-19 03:54:08 UTC |
...
running this report
    ...
    PROCESSX_PS1d452d75e59d_1739937242
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb5eQ0c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_elastes_v0.1.7-tikzDictionary"
