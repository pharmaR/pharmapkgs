...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Christopher Weld <ceweld241@gmail.com>               |
...
Overall the package has 23 exported objects. 23 are documented:
                ...
                binomTest     binomTestCoverage binomTestCoveragePlot 
                     TRUE                  TRUE                  TRUE 
        binomTestEnsemble          binomTestMSE              coversim 
                     TRUE                  TRUE                  TRUE 
                   crplot             dinvgauss               dllogis 
                     TRUE                  TRUE                  TRUE 
                 gammaMLE           invgaussMLE           km.coverage 
                     TRUE                  TRUE                  TRUE 
              km.outcomes                km.pmf            km.support 
                     TRUE                  TRUE                  TRUE 
                  km.surv             llogisMLE             pinvgauss 
                     TRUE                  TRUE                  TRUE 
                  pllogis             qinvgauss               qllogis 
                     TRUE                  TRUE                  TRUE 
                rinvgauss               rllogis 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-17 03:42:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6d5a110d_1739763725
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8rz5sw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conf_v1.9.1-tikzDictionary"
