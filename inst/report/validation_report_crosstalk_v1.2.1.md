# Validation Report - crosstalk@1.2.1
...
| has_source_control   | https://github.com/rstudio/crosstalk |
| has_bug_reports_url  | 1                                    |
| downloads_1yr        | 4458145                              |
...
bamm, boxly, clinDataReview, clinUtils, connectwidgets, cubble, detourr,
DT, echarty, enviGCMS, forestly, GGally, govdown, gprofiler2,
gwpcormapper, kpiwidget, langevitour, leaflet, lineupjs, linevis,
plotly, RagGrid, reactable, rgl, shinybody, sigmajs, SimSurvey, threejs,
tsibbletalk, upsetjs
...
Overall the package has 14 exported objects. 14 are documented:
           ...
           animation_options                   bscols              ClientValue 
                        TRUE                     TRUE                     TRUE 
               crosstalkLibs          filter_checkbox            filter_select 
                        TRUE                     TRUE                     TRUE 
               filter_slider getDefaultReactiveDomain            is.SharedData 
                        TRUE                     TRUE                     TRUE 
          maintain_selection    scale_color_selection     scale_fill_selection 
                        TRUE                     TRUE                     TRUE 
            selection_factor               SharedData 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-17 04:24:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bd643c5b9c2_1739766278
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMlAWcp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crosstalk_v1.2.1-tikzDictionary"
