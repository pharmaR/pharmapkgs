# Validation Report - CDMConnector@1.7.0
...
Overall the package has 107 exported objects. 106 are documented:

                            %>%            append_permanent 
                          FALSE                        TRUE 
                appendPermanent                     as_date 
                           TRUE                        TRUE 
                         asDate               assert_tables 
                           TRUE                        TRUE 
            assert_write_schema                assertTables 
                           TRUE                        TRUE 
              assertWriteSchema                   attrition 
                           TRUE                        TRUE 
          benchmarkCDMConnector                        bind 
                           TRUE                        TRUE 
                 cdm_disconnect                 cdm_flatten 
                           TRUE                        TRUE 
                   cdm_from_con        cdm_from_environment 
                           TRUE                        TRUE 
                 cdm_from_files             cdm_from_tables 
                           TRUE                        TRUE 
                       cdm_name                  cdm_sample 
                           TRUE                        TRUE 
                 cdm_select_tbl                  cdm_subset 
                           TRUE                        TRUE 
              cdm_subset_cohort                      cdmCon 
                           TRUE                        TRUE 
                  cdmDisconnect                  cdmFlatten 
                           TRUE                        TRUE 
                     cdmFromCon          cdmFromEnvironment 
                           TRUE                        TRUE 
                   cdmFromFiles               cdmFromTables 
                           TRUE                        TRUE 
                        cdmName                   cdmSample 
                           TRUE                        TRUE 
                      cdmSelect                cdmSelectTbl 
                           TRUE                        TRUE 
                      cdmSubset             cdmSubsetCohort 
                           TRUE                        TRUE 
                     cdmVersion              cdmWriteSchema 
                           TRUE                        TRUE 
               cohort_attrition                cohort_count 
                           TRUE                        TRUE 
                   cohort_erafy                  cohort_set 
                           TRUE                        TRUE 
                   cohort_union             cohortAttrition 
                           TRUE                        TRUE 
                 cohortCodelist                 cohortCount 
                           TRUE                        TRUE 
                    cohortErafy                   cohortSet 
                           TRUE                        TRUE 
                    cohortUnion                     compute 
                           TRUE                        TRUE 
                  compute_query                computeQuery 
                    ...
                    copy_cdm_to                   copyCdmTo 
                       ...
                       datepart                        dbms 
                           TRUE                        TRUE 
                       dbSource       download_eunomia_data 
                           TRUE                        TRUE 
            downloadEunomiaData             dropSourceTable 
                           TRUE                        TRUE 
                      dropTable                 eunomia_dir 
                           TRUE                        TRUE 
           eunomia_is_available                  eunomiaDir 
                           TRUE                        TRUE 
             eunomiaIsAvailable            example_datasets 
                           TRUE                        TRUE 
                exampleDatasets         generate_cohort_set 
                           TRUE                        TRUE 
    generate_concept_cohort_set           generateCohortSet 
                           TRUE                        TRUE 
       generateConceptCohortSet                   in_schema 
                           TRUE                        TRUE 
                       inSchema                 insertTable 
                           TRUE                        TRUE 
              intersect_cohorts            intersectCohorts 
                           TRUE                        TRUE 
                    list_tables            listSourceTables 
                           TRUE                        TRUE 
                     listTables    new_generated_cohort_set 
                           TRUE                        TRUE 
                 newCohortTable       newGeneratedCohortSet 
                           TRUE                        TRUE 
                read_cohort_set               readCohortSet 
                           TRUE                        TRUE 
                readSourceTable     record_cohort_attrition 
                           TRUE                        TRUE 
          recordCohortAttrition             require_eunomia 
                           TRUE                        TRUE 
                 requireEunomia                    settings 
                           TRUE                        TRUE 
                       snapshot                        stow 
                           TRUE                        TRUE 
             summarise_quantile           summariseQuantile 
                           TRUE                        TRUE 
             summarize_quantile           summarizeQuantile 
                           TRUE                        TRUE 
                      tbl_group                    tblGroup 
                           TRUE                        TRUE 
...
There are 52 help pages with examples, from 53 (98.11 %).
...
| Execution Time | 2025-02-16 03:56:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3330d394a_1739678212
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1oy0Wo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CDMConnector_v1.7.0-tikzDictionary"
