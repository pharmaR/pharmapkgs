# Validation Report - care4cmodel@1.0.3
...
| export_help          | 24                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Peter Biber <p.biber@tum.de>                         |
...
Overall the package has 24 exported objects. 24 are documented:
               ...
               aggregate_raw_sim_rslt           avg_extraction_distance 
                                 TRUE                              TRUE 
                          c4c_concept                  co2_eval_cutting 
                                 TRUE                              TRUE 
                      co2_eval_moving                    exp_decay_rate 
                                 TRUE                              TRUE 
              fuel_and_co2_evaluation             fuel_cons_forwarder_1 
                                 TRUE                              TRUE 
                fuel_cons_forwarder_2             fuel_cons_harvester_1 
                                 TRUE                              TRUE 
                fuel_cons_harvester_2        fuel_cons_road_maintenance 
                                 TRUE                              TRUE 
                          fuel_to_co2       growth_and_yield_evaluation 
                                 TRUE                              TRUE 
                       is_c4c_concept                   new_c4c_concept 
                                 TRUE                              TRUE 
                          setup_parms                 setup_risk_events 
                                 TRUE                              TRUE 
                      setup_statevars sim_area_single_concept_with_risk 
                                 TRUE                              TRUE 
              simulate_single_concept                  survival_weibull 
                                 TRUE                              TRUE 
                 validate_c4c_concept                       wood_to_co2 
                                 TRUE                              TRUE 
...
| Execution Time | 2025-02-16 03:41:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bc372309ec4_1739677292
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpkb6vhg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_care4cmodel_v1.0.3-tikzDictionary"
