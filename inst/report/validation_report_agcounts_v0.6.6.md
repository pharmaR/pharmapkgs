...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Brian C. Helsel <bhelsel@kumc.edu>                   |
...
| 8   | utils         | Imports   |
| 9   | zoo           | Imports   |
| 10  | reticulate    | Imports   |
| 11  | dplyr         | Imports   |
| 12  | stringr       | Imports   |
| 13  | ggplot2       | Imports   |
| 14  | reactable     | Imports   |
| 15  | shiny         | Imports   |
| 16  | bslib         | Imports   |
| 17  | read.gt3x     | Imports   |
| 18  | DBI           | Imports   |
| 19  | RSQLite       | Imports   |
| 20  | Rcpp          | LinkingTo |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         agcalibrate           agread agShinyDeployApp calculate_counts 
                TRUE             TRUE             TRUE             TRUE 
          get_counts 
                TRUE 
...
| Execution Time | 2025-02-14 06:42:08 UTC |
...
running this report
    ...
    PROCESSX_PS726d7cae97c5_1739515325
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgwSXLI
