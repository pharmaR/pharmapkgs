# Validation Report - cosinor2@0.2.1
...
| export_help          | 7                                  |
| has_website          | TRUE                               |
| has_maintainer       | Augustin Mutak <mutak94@gmail.com> |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/amutak/cosinor2 |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | cosinor (\>= 1.1)        | Depends |
| 2   | cowplot (\>= 0.9.3)      | Imports |
| 3   | scales (\>= 1.0.0)       | Imports |
| 4   | magrittr (\>= 1.5)       | Imports |
| 5   | stringr (\>= 1.3.1)      | Imports |
| 6   | purrr(\>= 0.2.5)         | Imports |
| 7   | ggplot2 (\>= 3.0.0)      | Imports |
| 8   | matrixStats (\>= 0.52.2) | Imports |
| 9   | Hmisc (\>= 4.0-3)        | Imports |
...
ActCR, matrixTests, mMARCH.AC, postGGIR

## Namespace

Overall the package has 7 exported objects. 7 are documented:

        correct.acrophase        cosinor.detect      cosinor.poptests 
                     TRUE                  TRUE                  TRUE 
               cosinor.PR           periodogram population.cosinor.lm 
                     TRUE                  TRUE                  TRUE 
                ssections 
                     TRUE 
...
| Execution Time | 2025-02-17 04:02:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66011515b_1739764957
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp686FkG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cosinor2_v0.2.1-tikzDictionary"
