# Validation Report - CleaningValidation@1.0
...
| export_help | 34 |
| has_website | TRUE |
| has_maintainer | Xiande Yang <xyang1@apotex.com> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/ChandlerXiandeYang/CleaningValidation |
...
| 2   | rlang               | Imports |
| 3   | ggplot2 (\>= 3.3.3) | Imports |
| 4   | cowplot (\>= 1.1.1) | Imports |
| 5   | dunn.test           | Imports |
| 6   | boot                | Imports |
| 7   | AER                 | Imports |
| 8   | lme4                | Imports |
...
Overall the package has 34 exported objects. 34 are documented:
                  ...
                  cv01_dfclean     cv02_nonpro_oos_reswab 
                          TRUE                       TRUE 
          cv03_usl_unification         cv04_histogram_kde 
                          TRUE                       TRUE 
           cv05_sw_norm_test_1        cv06_sw_norm_test_2 
                          TRUE                       TRUE 
     cv07_median_control_chart cv071_median_control_chart 
                          TRUE                       TRUE 
        cv08_variability_chart               cv09_kw_test 
                          TRUE                       TRUE 
     cv10_dunn_test_vs_control         cv11_vca_by_median 
                          TRUE                       TRUE 
                  cv12_kde_ppu          cv13_poisson_test 
                          TRUE                       TRUE 
          cv14_dispersion_test            cv15_mic_mutate 
                          TRUE                       TRUE 
                  cv16_u_chart                 cv17_cusum 
                          TRUE                       TRUE 
                     cv18_ewma        cv19_poisson_simple 
                          TRUE                       TRUE 
            cv20_poisson_fixed         cv21_poisson_mixed 
                          TRUE                       TRUE 
        cv22_var_random_effect    cv23_random_effect_coef 
                          TRUE                       TRUE 
                  cv24_vca_mic            cv25_qbinom_ppu 
                          TRUE                       TRUE 
             cv26_qpoisson_ppu          cv27_anscombe_ppu 
                          TRUE                       TRUE 
              cv28_freeman_ppu               cv29_mic_ppu 
                          TRUE                       TRUE 
          cv30_dar_car_mic_ppu                     Eq_CAR 
                          TRUE                       TRUE 
                        Eq_DAR                     Eq_Mic 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-16 04:28:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37e823f25_1739680106
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3zjvA1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CleaningValidation_v1.0-tikzDictionary"
