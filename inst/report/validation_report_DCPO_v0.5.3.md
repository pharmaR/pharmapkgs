...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Frederick Solt <frederick-solt@uiowa.edu>            |
...
| 14  | BH (\>= 1.66.0-1)         | LinkingTo |
| 15  | Rcpp (\>= 0.12.0)         | LinkingTo |
| 16  | RcppEigen (\>= 0.3.3.4.0) | LinkingTo |
...
| Execution Time | 2025-02-17 05:11:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bd650ce91d_1739769098
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiyJzW9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DCPO_v0.5.3-tikzDictionary"
