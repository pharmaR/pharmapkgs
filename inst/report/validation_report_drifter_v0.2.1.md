# Validation Report - drifter@0.2.1
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    calculate_covariate_drift        calculate_distance     calculate_model_drift 
                         TRUE                      TRUE                      TRUE 
    calculate_residuals_drift               check_drift      compare_two_profiles 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-18 04:46:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45c3a6332_1739853977
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp05f74c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drifter_v0.2.1-tikzDictionary"
