...
| export_help          | 10                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Debora Zuanny <deborazuanny@gmail.com> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/dboslab/expowo      |
...
| 13  | cowplot       | Imports |
| 14  | plyr          | Imports |
| 15  | PupillometryR | Imports |
| 16  | scales        | Imports |
| 17  | viridisLite   | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
         ...
         accGraph get_year_pubs       megaGen       powoFam    powoGenera 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          powoMap    powoSpDist   powoSpecies       saveCSV        topGen 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 04:54:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d454377a41d_1739940839
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXZhIR9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_expowo_v2.0-tikzDictionary"
