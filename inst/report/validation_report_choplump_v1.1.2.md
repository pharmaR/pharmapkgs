# Validation Report - choplump@1.1.2
...
Overall the package has 18 exported objects. 18 are documented:
                    ...
                    chooseMatrix                         chop 
                            TRUE                         TRUE 
                     chopGeneral                     choplump 
                            TRUE                         TRUE 
                  choplumpApprox                choplumpExact 
                            TRUE                         TRUE 
                 choplumpExactMC              choplumpGeneral 
                            TRUE                         TRUE 
                      cm.compact                  methodRule1 
                            TRUE                         TRUE 
                 Qh.times.dhyper                         TDiM 
                            TRUE                         TRUE 
                    testfunc.DiM              testfunc.wilcox 
                            TRUE                         TRUE 
         testfunc.wilcox.general         testfunc.wilcox.ties 
                            TRUE                         TRUE 
    testfunc.wilcox.ties.general       wilcox.manyzeros.exact 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-16 04:15:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc331849f42_1739679327
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpW1oELo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_choplump_v1.1.2-tikzDictionary"
