# Validation Report - epichains@0.1.1
...
| export_help          | 6                                           |
| has_website          | TRUE                                        |
| has_maintainer       | James M. Azam <james.azam@lshtm.ac.uk>      |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/epiverse-trace/epichains |
...
Overall the package has 6 exported objects. 6 are documented:
                  ...
                  dborel           likelihood               rborel 
                    TRUE                 TRUE                 TRUE 
                 rgborel simulate_chain_stats      simulate_chains 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:14:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d458e499ba_1739938486
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWdMoVq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epichains_v0.1.1-tikzDictionary"
