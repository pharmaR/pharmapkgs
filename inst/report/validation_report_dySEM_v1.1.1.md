...
| export_help          | 21                                 |
| has_website          | TRUE                               |
| has_maintainer       | John Sakaluk <jksakaluk@gmail.com> |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/jsakaluk/dySEM  |
...
Overall the package has 21 exported objects. 20 are documented:
                    ...
                    %>%  getConstraintTests          getDydmacs    getDyReliability 
                  FALSE                TRUE                TRUE                TRUE 
           getIndistFit   getInvarCompTable outputConstraintTab  outputInvarCompTab 
                   TRUE                TRUE                TRUE                TRUE 
            outputModel      outputParamFig      outputParamTab      scrapeVarCross 
                   TRUE                TRUE                TRUE                TRUE 
             scriptAPIM          scriptBiDy           scriptCFA           scriptCFM 
                   TRUE                TRUE                TRUE                TRUE 
            scriptDyEFA         scriptINULL          scriptISAT           scriptMIM 
                   TRUE                TRUE                TRUE                TRUE 
          scriptObsAPIM 
                   TRUE 
...
| Execution Time | 2025-02-18 05:07:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4127dd947_1739855262
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptUlkGh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dySEM_v1.1.1-tikzDictionary"
