# Validation Report - cosinor@1.2.3
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Michael Sachs <sachsmc@gmail.com>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/sachsmc/cosinor                   |
...
ActCR, cosinor2, GLMMcosinor, matrixTests, mMARCH.AC, postGGIR

## Namespace

Overall the package has 7 exported objects. 7 are documented:

      cosinor_analyzer         cosinor.lm cosinor.lm.default  ggplot_cosinor.lm 
                  TRUE               TRUE               TRUE               TRUE 
      simulate_cosinor       test_cosinor    update_covnames 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:02:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bd638d4b481_1739764951
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQOyjnT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cosinor_v1.2.3-tikzDictionary"
