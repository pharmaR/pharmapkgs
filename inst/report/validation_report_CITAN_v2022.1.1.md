# Validation Report - CITAN@2022.1.1
...
| has_source_control   | https://github.com/gagolews/CITAN       |
...
Overall the package has 19 exported objects. 19 are documented:
                     ...
                     dbExecQuery                    lbsAssess 
                            TRUE                         TRUE 
                        lbsClear                   lbsConnect 
                            TRUE                         TRUE 
                       lbsCreate lbsDeleteAllAuthorsDocuments 
                            TRUE                         TRUE 
             lbsDescriptiveStats                lbsDisconnect 
                            TRUE                         TRUE 
                 lbsGetCitations            lbsGetInfoAuthors 
                            TRUE                         TRUE 
             lbsGetInfoDocuments           lbsImportDocuments 
                            TRUE                         TRUE 
                lbsSearchAuthors           lbsSearchDocuments 
                            TRUE                         TRUE 
                         lbsTidy                  Scopus_ASJC 
                            TRUE                         TRUE 
            Scopus_ImportSources               Scopus_ReadCSV 
                            TRUE                         TRUE 
               Scopus_SourceList 
                            TRUE 
...
| Execution Time | 2025-02-16 04:22:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33acfea79_1739679771
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFE84BT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CITAN_v2022.1.1-tikzDictionary"
