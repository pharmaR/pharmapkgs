# Validation Report - cointmonitoR@0.1.0
...
| has_source_control | https://github.com/aschersleben/cointmonitoR |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | cointReg (\>= 0.2.0)     | Depends |
| 2   | stats                    | Imports |
| 3   | graphics                 | Imports |
| 4   | matrixStats (\>= 0.14.1) | Imports |
...
Overall the package has 2 exported objects. 2 are documented:
    ...
    monitorCointegration  monitorStationarity 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:56:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35fa44d9c_1739681771
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWH4Ifw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cointmonitoR_v0.1.0-tikzDictionary"
