# Validation Report - ecotraj@0.1.1
...
| export_help          | 18                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Miquel De Cáceres <miquelcaceres@gmail.com>          |
...
Overall the package has 18 exported objects. 18 are documented:
               ...
               centerTrajectories        compareToStateEnvelope 
                             TRUE                          TRUE 
      compareToTrajectoryEnvelope                     is.metric 
                             TRUE                          TRUE 
                 segmentDistances      stateEnvelopeVariability 
                             TRUE                          TRUE 
                 trajectoryAngles            trajectoryAngles2D 
                             TRUE                          TRUE 
            trajectoryConvergence      trajectoryDirectionality 
                             TRUE                          TRUE 
              trajectoryDistances trajectoryEnvelopeVariability 
                             TRUE                          TRUE 
                trajectoryLengths           trajectoryLengths2D 
                             TRUE                          TRUE 
                   trajectoryPCoA                trajectoryPlot 
                             TRUE                          TRUE 
             trajectoryProjection           trajectorySelection 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-19 03:37:58 UTC |
...
running this report
    ...
    PROCESSX_PS1d4550255018_1739936272
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAJxEZu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecotraj_v0.1.1-tikzDictionary"
