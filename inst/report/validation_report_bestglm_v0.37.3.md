# Validation Report - bestglm@0.37.3
...
| export_help          | 26                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yuanhao Lai <ylai72@uwo.ca>                          |
...
genridge, GGMnonreg, mplot, NADA2, regclass, tidyfit
...
Overall the package has 26 exported objects. 26 are documented:
               ...
               bestglm                CVd               CVDH              CVHTF 
                  TRUE               TRUE               TRUE               TRUE 
                 dgrid       fitted.pcreg    glmnetGridTable      glmnetPredict 
                  TRUE               TRUE               TRUE               TRUE 
         grpregPredict              LOOCV          NNPredict          oneSDRule 
                  TRUE               TRUE               TRUE               TRUE 
                 pcreg              pcreg         plot.pcreg        plot1SDRule 
                  TRUE               TRUE               TRUE               TRUE 
         predict.pcreg      print.bestglm        print.pcreg    residuals.pcreg 
                  TRUE               TRUE               TRUE               TRUE 
               sphereX    summary.bestglm      summary.pcreg          to.binary 
                  TRUE               TRUE               TRUE               TRUE 
    trainTestPartition               vifx 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 03:54:25 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1f86f822_1739591660
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEdlWYn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bestglm_v0.37.3-tikzDictionary"
