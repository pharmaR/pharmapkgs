# Validation Report - decompr@6.4.0
...
| export_help          | 7                                 |
| has_website          | TRUE                              |
| has_maintainer       | Bastiaan Quast <bquast@gmail.com> |
| bugs_status          | 0.875                             |
| has_source_control   | https://github.com/bquast/decompr |
...
Overall the package has 7 exported objects. 7 are documented:
                 ...
                 decomp                 kww            leontief         load_tables 
                   TRUE                TRUE                TRUE                TRUE 
    load_tables_vectors                 wwz             wwz2kww 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 03:33:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4458a125f_1739849594
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2td08T
...
These are the options set to generate the report:
    ...
    [1] "validation_report_decompr_v6.4.0-tikzDictionary"
