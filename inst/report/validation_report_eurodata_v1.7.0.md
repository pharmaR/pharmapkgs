# Validation Report - eurodata@1.7.0
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Aleksander Rutkowski <alek.rutkowski@gmail.com>      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/alekrutkowski/eurodata/           |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    as.EurostatDataList      browseDataList             compare            describe 
                   TRUE                TRUE                TRUE                TRUE 
                   find          importData      importDataList      importDimLabel 
                   TRUE                TRUE                TRUE                TRUE 
           importLabels      importMetabase 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:36:40 UTC |
...
running this report
    ...
    PROCESSX_PS1d451cb1ccd5_1739939794
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphLbqeX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eurodata_v1.7.0-tikzDictionary"
