# Validation Report - essentials@0.1.0
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Andrew Simmons <akwsimmo@gmail.com>                  |
...
Overall the package has 15 exported objects. 15 are documented:
             ...
             as.numbers           as.scalar as.scalar.character   as.scalar.complex 
                   TRUE                TRUE                TRUE                TRUE 
       as.scalar.double   as.scalar.integer   as.scalar.logical    as.scalar.number 
                   TRUE                TRUE                TRUE                TRUE 
      as.scalar.numeric      as.scalar.real    as.scalar.string           aslength1 
                   TRUE                TRUE                TRUE                TRUE 
                  hypot          is.numbers             numbers 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:31:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d45710e6698_1739939466
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGz101n
...
These are the options set to generate the report:
    ...
    [1] "validation_report_essentials_v0.1.0-tikzDictionary"
