# Validation Report - ecostate@0.2.0
...
| export_help          | 13                                        |
| has_website          | TRUE                                      |
| has_maintainer       | James T. Thorson <James.Thorson@noaa.gov> |
...
Overall the package has 13 exported objects. 13 are documented:
          ...
          abm3pc_sys  add_equilibrium      compute_nll   compute_tracer 
                TRUE             TRUE             TRUE             TRUE 
                dBdt         ddirmult         ecostate ecostate_control 
                TRUE             TRUE             TRUE             TRUE 
               ode23     plot_foodweb    print_ecopars           rk4sys 
                TRUE             TRUE             TRUE             TRUE 
     stanza_settings 
                TRUE 
...
| Execution Time | 2025-02-19 03:37:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d4552684c2_1739936225
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT3aJ5d
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecostate_v0.2.0-tikzDictionary"
