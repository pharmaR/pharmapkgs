# Validation Report - excluder@0.5.1
...
| export_help | 28 |
| has_website | TRUE |
| has_maintainer | Jeffrey R. Stevens <jeffrey.r.stevens@protonmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/ropensci/excluder/ |
...
Overall the package has 28 exported objects. 27 are documented:

                    %>%    check_duplicates      check_duration            check_ip 
                  FALSE                TRUE                TRUE                TRUE 
         check_location       check_preview      check_progress    check_resolution 
                   TRUE                TRUE                TRUE                TRUE 
    collapse_exclusions          deidentify  exclude_duplicates    exclude_duration 
                   TRUE                TRUE                TRUE                TRUE 
             exclude_ip    exclude_location     exclude_preview    exclude_progress 
                   TRUE                TRUE                TRUE                TRUE 
     exclude_resolution     mark_duplicates       mark_duration             mark_ip 
                   TRUE                TRUE                TRUE                TRUE 
          mark_location        mark_preview       mark_progress     mark_resolution 
                   TRUE                TRUE                TRUE                TRUE 
      remove_label_rows      rename_columns    unite_exclusions          use_labels 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:49:00 UTC |
...
running this report
    ...
    PROCESSX_PS1d45161585d1_1739940534
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOzI84J
...
These are the options set to generate the report:
    ...
    [1] "validation_report_excluder_v0.5.1-tikzDictionary"
