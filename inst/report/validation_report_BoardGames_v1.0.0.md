# Validation Report - BoardGames@1.0.0
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Derek Qiu <qiu.derek.d@gmail.com>                    |
...
Overall the package has 9 exported objects. 9 are documented:
           ...
           detect_seq          get_cols         get_diags          get_rows 
                 TRUE              TRUE              TRUE              TRUE 
         get_surround          index2xy     is_palindrome UltimateTicTacToe 
                 TRUE              TRUE              TRUE              TRUE 
             xy2index 
                 TRUE 
...
| Execution Time | 2025-02-15 04:29:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd68b1f35e_1739593783
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKVA0YK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BoardGames_v1.0.0-tikzDictionary"
