...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Rafael Benitez <rabesua@uv.es>                       |
...
Overall the package has 19 exported objects. 19 are documented:
        ...
        afmAdhesionEnergy afmBaselineCorrection       afmContactPoint 
                     TRUE                  TRUE                  TRUE 
                  afmdata        afmDetachPoint           afmExpDecay 
                     TRUE                  TRUE                  TRUE 
            afmexperiment            afmExtract        afmIndentation 
                     TRUE                  TRUE                  TRUE 
               afmReadJPK      afmReadJPKFolder          afmReadVeeco 
                     TRUE                  TRUE                  TRUE 
       afmReadVeecoFolder       afmYoungModulus     afmZeroPointSlope 
                     TRUE                  TRUE                  TRUE 
           append.afmdata            is.afmdata      is.afmexperiment 
                     TRUE                  TRUE                  TRUE 
              windowedFit 
                     TRUE 
...
| Execution Time | 2025-02-14 06:41:35 UTC |
...
running this report
    ...
    PROCESSX_PS726d2651b7ac_1739515293
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphOM8qb
