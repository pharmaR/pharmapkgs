# Validation Report - cropcircles@0.2.4
...
| export_help          | 7                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Daniel Oehm <danieloehm@gmail.com>   |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/doehm/cropcircles |
...
Overall the package has 7 exported objects. 7 are documented:
           ...
           circle_crop        crop_circle         crop_heart           crop_hex 
                  TRUE               TRUE               TRUE               TRUE 
    crop_parallelogram        crop_square           hex_crop 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:22:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bd625619d9b_1739766156
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuI1Qbv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cropcircles_v0.2.4-tikzDictionary"
