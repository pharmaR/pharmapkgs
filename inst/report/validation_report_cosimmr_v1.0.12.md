# Validation Report - cosimmr@1.0.12
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Emma Govan <emmagovan@gmail.com>                     |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/emmagovan/cosimmr                 |
...
Overall the package has 5 exported objects. 5 are documented:
            ...
            cosimmr_ffvb         cosimmr_load posterior_predictive 
                    TRUE                 TRUE                 TRUE 
     print.cosimmr_input            prior_viz 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-17 04:02:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6635d42d8_1739764945
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpzy1RpM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cosimmr_v1.0.12-tikzDictionary"
