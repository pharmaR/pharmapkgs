...
| export_help          | 19                                  |
| has_website          | TRUE                                |
| has_maintainer       | Carl Boettiger <cboettig@gmail.com> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/ropensci/EML/    |
...
dataspice, ecocomDP, finch, geometa, metajam

## Namespace

Overall the package has 19 exported objects. 19 are documented:

                  as_emld               eml_get          eml_validate 
                     TRUE                  TRUE                  TRUE 
           get_attributes           get_unit_id          get_unitList 
                     TRUE                  TRUE                  TRUE 
          is_standardUnit              read_eml        set_attributes 
                     TRUE                  TRUE                  TRUE 
             set_coverage           set_methods          set_physical 
                     TRUE                  TRUE                  TRUE 
     set_responsibleParty          set_software set_taxonomicCoverage 
                     TRUE                  TRUE                  TRUE 
             set_TextType          set_unitList      shiny_attributes 
                     TRUE                  TRUE                  TRUE 
                write_eml 
                     TRUE 
...
| Execution Time | 2025-02-19 04:02:17 UTC |
...
running this report
    ...
    PROCESSX_PS1d456b60ad_1739937731
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnWmPgX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EML_v2.0.6.1-tikzDictionary"
