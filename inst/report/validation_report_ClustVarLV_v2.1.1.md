# Validation Report - ClustVarLV@2.1.1
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Evelyne Vigneau <evelyne.vigneau@oniris-nantes.fr>   |
...
Overall the package has 16 exported objects. 16 are documented:
          ...
          boot_clv            CLV     CLV_kmeans          CLV3W   CLV3W_kmeans 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       data_biplot       get_comp    get_loading  get_partition     get_weight 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         imput_clv           LCLV         lm_CLV       plot_var plot_var.clv3w 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       stand_quali 
              TRUE 
...
| Execution Time | 2025-02-16 04:42:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32a6331ec_1739680927
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJ9GmUt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClustVarLV_v2.1.1-tikzDictionary"
