...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Sebastian Bayer <sebastian.bayer@uni-konstanz.de>    |
...
Overall the package has 20 exported objects. 20 are documented:
                   ...
                   cdf_at_quantile         conditional_mean_sigma 
                              TRUE                           TRUE 
    conditional_truncated_variance      density_quantile_function 
                              TRUE                           TRUE 
                          esr_loss                     esr_rho_lp 
                              TRUE                           TRUE 
                             esreg                   estfun.esreg 
                             ...
                             G_vec                         G1_fun 
                              TRUE                           TRUE 
                      G1_prime_fun             G1_prime_prime_fun 
                              TRUE                           TRUE 
                      G2_curly_fun                         G2_fun 
                              TRUE                           TRUE 
                      G2_prime_fun                 G2_prime_prime 
                              TRUE                           TRUE 
                     lambda_matrix                   sigma_matrix 
                              TRUE                           TRUE 
                             vcovA                          vcovB 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-19 04:30:58 UTC |
...
running this report
    ...
    PROCESSX_PS1d4577664c6c_1739939452
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSin2q1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_esreg_v0.6.2-tikzDictionary"
