...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | ggplot2 (\>= 3.0.0) | Depends |
| 2   | randomForest        | Depends |
| 3   | caTools             | Imports |
| 4   | cli (\>= 1.1.0)     | Imports |
| 5   | dlookr              | Imports |
| 6   | dplyr (\>= 0.7.6)   | Imports |
| 7   | future              | Imports |
| 8   | ggmosaic            | Imports |
| 9   | MASS                | Imports |
| 10  | MLmetrics           | Imports |
| 11  | methods             | Imports |
| 12  | parallelly          | Imports |
| 13  | party               | Imports |
| 14  | purrr               | Imports |
| 15  | ROCR                | Imports |
| 16  | ranger              | Imports |
...
Overall the package has 17 exported objects. 17 are documented:
                    ...
                    cleanse            compare_diag     compare_performance 
                       TRUE                    TRUE                    TRUE 
               compare_plot compare_target_category  compare_target_numeric 
                       TRUE                    TRUE                    TRUE 
                extract_set                matthews      performance_metric 
                       TRUE                    TRUE                    TRUE 
                plot_cutoff        plot_performance              run_models 
                       TRUE                    TRUE                    TRUE 
            run_performance             run_predict         sampling_target 
                       TRUE                    TRUE                    TRUE 
                   split_by          treatment_corr 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-14 06:49:28 UTC |
...
running this report
    ...
    PROCESSX_PS726ddb9a38c_1739515765
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpl40uOL
