...
| export_help          | 26                               |
| has_website          | TRUE                             |
| has_maintainer       | Martin Petr <contact@bodkan.net> |
| bugs_status          | subscript out of bounds          |
| size_codebase        | 721                              |
| has_source_control   | https://github.com/bodkan/admixr |
...
Overall the package has 26 exported objects. 25 are documented:
                   ...
                   %>%         count_snps                  d      download_data 
                 FALSE               TRUE               TRUE               TRUE 
            eigenstrat                 f3                 f4            f4ratio 
                  TRUE               TRUE               TRUE               TRUE 
            filter_bed   keep_transitions            loginfo   merge_eigenstrat 
                  TRUE               TRUE               TRUE               TRUE 
                 qpAdm       qpAdm_filter     qpAdm_rotation             qpWave 
                  TRUE               TRUE               TRUE               TRUE 
             read_geno           read_ind        read_output           read_snp 
                  TRUE               TRUE               TRUE               TRUE 
               relabel              reset transversions_only         write_geno 
                  TRUE               TRUE               TRUE               TRUE 
             write_ind          write_snp 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-14 06:38:49 UTC |
...
running this report
    ...
    PROCESSX_PS726d75f833f1_1739515126
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAkFhzl
