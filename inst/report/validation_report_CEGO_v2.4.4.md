...
| export_help          | 102                                                  |
| has_website          | FALSE                                                |
| has_maintainer       | Martin Zaefferer <mzaefferer@gmail.com>              |
...
Overall the package has 102 exported objects. 102 are documented:
                 ...
                 distancePermutationLevenshtein 
                         ...
                         distancePermutationLex 
                                           TRUE 
                   distancePermutationManhattan 
                                           TRUE 
                    distancePermutationPosition 
                                           TRUE 
                   distancePermutationPosition2 
                                           TRUE 
                           distancePermutationR 
                                           TRUE 
                        distancePermutationSwap 
                                           TRUE 
                     distancePermutationSwapInv 
                                           TRUE 
                          distanceRealEuclidean 
                                           TRUE 
                    distanceSequenceLevenshtein 
                                           TRUE 
                          distanceStringHamming 
                                           TRUE 
                            distanceStringLCStr 
                                           TRUE 
                     ...
                     landscapeGeneratorGaussian 
                                           TRUE 
                landscapeGeneratorGaussianBuild 
                                           TRUE 
                 landscapeGeneratorGaussianEval 
                                           TRUE 
...
There are 119 help pages with examples, from 119 (100.00 %).
...
| Execution Time | 2025-02-16 03:58:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36f0cc20_1739678300
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8tvmR9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CEGO_v2.4.4-tikzDictionary"
