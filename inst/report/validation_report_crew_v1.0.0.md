...
| has_source_control   | https://github.com/wlandau/crew                    |
...
| 3   | getip                | Imports |
| 4   | later                | Imports |
| 5   | mirai (\>= 2.0.1)    | Imports |
| 6   | nanonext (\>= 1.4.0) | Imports |
| 7   | processx             | Imports |
| 8   | promises             | Imports |
| 9   | ps                   | Imports |
| 10  | R6                   | Imports |
...
crew.aws.batch, crew.cluster, targets
...
Overall the package has 45 exported objects. 45 are documented:
                         ...
                         all_of                      any_of 
                           TRUE                        TRUE 
                       contains                 crew_assert 
                           TRUE                        TRUE 
                     crew_async            crew_class_async 
                           TRUE                        TRUE 
              crew_class_client       crew_class_controller 
                           TRUE                        TRUE 
    crew_class_controller_group         crew_class_launcher 
                           TRUE                        TRUE 
      crew_class_launcher_local    crew_class_monitor_local 
                           TRUE                        TRUE 
               crew_class_queue            crew_class_relay 
                           TRUE                        TRUE 
            crew_class_throttle              crew_class_tls 
                           TRUE                        TRUE 
                     crew_clean                 crew_client 
                           TRUE                        TRUE 
                crew_controller       crew_controller_group 
                           TRUE                        TRUE 
          crew_controller_local              crew_deprecate 
                           TRUE                        TRUE 
                      crew_eval             crew_eval_async 
                           TRUE                        TRUE 
                  crew_launcher         crew_launcher_local 
                           TRUE                        TRUE 
             crew_monitor_local          crew_options_local 
                           TRUE                        TRUE 
           crew_options_metrics                  crew_queue 
                           TRUE                        TRUE 
               crew_random_name                  crew_relay 
                           TRUE                        TRUE 
                     crew_retry      crew_terminate_process 
                           TRUE                        TRUE 
          crew_terminate_signal               crew_throttle 
                           TRUE                        TRUE 
                       crew_tls                 crew_worker 
                           TRUE                        TRUE 
...
There are 33 help pages with examples, from 36 (91.67 %).
...
| Execution Time | 2025-02-17 04:19:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6637b2577_1739765986
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6KeXoT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crew_v1.0.0-tikzDictionary"
