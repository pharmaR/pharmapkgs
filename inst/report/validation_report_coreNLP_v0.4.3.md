# Validation Report - coreNLP@0.4.3
...
Overall the package has 12 exported objects. 12 are documented:
         ...
         annotateFile    annotateString   downloadCoreNLP    getCoreference 
                 TRUE              TRUE              TRUE              TRUE 
        getDependency         getOpenIE          getParse      getSentiment 
                 TRUE              TRUE              TRUE              TRUE 
             getToken       initCoreNLP loadXMLAnnotation   universalTagset 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-24 03:21:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a36ec0d5a_1740367295
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmuaBO5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coreNLP_v0.4.3-tikzDictionary"
