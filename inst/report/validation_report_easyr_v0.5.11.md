# Validation Report - easyr@0.5.11
...
| export_help | 69 |
| has_website | TRUE |
| has_maintainer | Bryce Chamberlain <bryce.chamberlain@oliverwyman.com> |
| bugs_status | 0.8666667 |
| has_source_control | https://github.com/oliver-wyman-actuarial/easyr |
...
Overall the package has 69 exported objects. 68 are documented:
              ...
              %ni%         astext          atype          begin       binbyvol 
             FALSE           TRUE           TRUE           TRUE           TRUE 
             bindf     cache.init       cache.ok             cc       char2fac 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           charnum        checkeq    clear.cache          coalf           crun 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             ddiff           dict          drows          ecopy             eq 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          fac2char         fjoinf         fldict           fmat   getbetterint 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           getinfo             gr      hashfiles         ijoinf         ischar 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            isdate          isfac          isnum          isval          jrepl 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              left       likedate         ljoinf  match.factors          mdiff 
              TRUE           TRUE           TRUE           TRUE           TRUE 
               mid             na         namesx            nan         nanull 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              null           pad0          qdiff       read.any       read.txt 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             right      runfolder     save.cache            sch            spl 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              strx         sumnum          tcmsg           tcol         tcwarn 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            tobool         tochar         todate          tonum         usepkg 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    validate.equal              w         xldate          ydiff 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-25 03:24:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d2866ed8208_1740453890
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5Q3Wqx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easyr_v0.5.11-tikzDictionary"
