# Validation Report - cogirt@1.0.0
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Michael Thomas <michael.l.thomas@colostate.edu>      |
...
Overall the package has 6 exported objects. 6 are documented:
                ...
                cog_cat         cog_cat_sim             cog_irt dich_response_model 
                   TRUE                TRUE                TRUE                TRUE 
      dich_response_sim                 lrt 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:54:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3515496f6_1739681642
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdHzHta
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cogirt_v1.0.0-tikzDictionary"
