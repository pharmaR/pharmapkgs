...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Wenhan Lu <wlu@broadinstitute.org>                   |
...
Overall the package has 13 exported objects. 13 are documented:
                     ...
                     ALLSPICE       ALLSPICE_simulation      format_ALLSPICE_data 
                         TRUE                      TRUE                      TRUE 
                   get_ac_mat                get_af_mat              get_beta_hat 
                         TRUE                      TRUE                      TRUE 
                    get_c_hat              get_geno_mat get_likelihood_test_stats 
                         TRUE                      TRUE                      TRUE 
                 get_mle_beta            get_pheno_pair           get_single_geno 
                         TRUE                      TRUE                      TRUE 
                get_true_beta 
                         TRUE 
...
| Execution Time | 2025-02-14 06:49:14 UTC |
...
running this report
    ...
    PROCESSX_PS726d12d69531_1739515751
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2sJ7Kf
