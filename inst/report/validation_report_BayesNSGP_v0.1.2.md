# Validation Report - BayesNSGP@0.1.2
...
| export_help          | 29                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel Turek <danielturek@gmail.com>                 |
...
Overall the package has 29 exported objects. 29 are documented:
                      ...
                      calcQF           calculateAD_ns            calculateU_ns 
                        TRUE                     TRUE                     TRUE 
          conditionLatentObs       determineNeighbors              dmnorm_nngp 
                        TRUE                     TRUE                     TRUE 
                  dmnorm_sgv             inverseEigen              matern_corr 
                        TRUE                     TRUE                     TRUE 
          nimble_sparse_chol  nimble_sparse_crossprod      nimble_sparse_solve 
                        TRUE                     TRUE                     TRUE 
    nimble_sparse_tcrossprod                   nsCorr              nsCrosscorr 
                        TRUE                     TRUE                     TRUE 
                 nsCrossdist            nsCrossdist3d                   nsDist 
                        TRUE                     TRUE                     TRUE 
                    nsDist3d                nsgpModel              nsgpPredict 
                        TRUE                     TRUE                     TRUE 
         orderCoordinatesMMD            R_sparse_chol       R_sparse_crossprod 
                        TRUE                     TRUE                     TRUE 
              R_sparse_solve      R_sparse_tcrossprod              rmnorm_nngp 
                        TRUE                     TRUE                     TRUE 
                  rmnorm_sgv                 sgvSetup 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-15 03:38:59 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd164510b6_1739590735
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdD5Kkg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesNSGP_v0.1.2-tikzDictionary"
