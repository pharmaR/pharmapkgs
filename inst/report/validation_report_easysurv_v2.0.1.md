# Validation Report - easysurv@2.0.1
...
| export_help          | 15                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Niall Davison <niall.davison@maplehealthgroup.com> |
| bugs_status          | subscript out of bounds                            |
| has_source_control   | https://github.com/Maple-Health-Group/easysurv     |
...
Overall the package has 15 exported objects. 15 are documented:
                  ...
                  fit_models                   get_km           get_schoenfeld 
                        TRUE                     TRUE                     TRUE 
           inspect_surv_data             plot_cloglog                  plot_km 
                        TRUE                     TRUE                     TRUE 
             plot_schoenfeld         predict_and_plot              quick_start 
                        TRUE                     TRUE                     TRUE 
                quick_start2             quick_start3                  test_ph 
                        TRUE                     TRUE                     TRUE 
              theme_easysurv theme_risktable_easysurv              write_to_xl 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-18 05:13:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41b8d603_1739855591
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaSehpq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easysurv_v2.0.1-tikzDictionary"
