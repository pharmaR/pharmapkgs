...
Overall the package has 14 exported objects. 14 are documented:
      ...
      bootstrap_se           ciee      ciee_loop      deriv_obj est_funct_expr 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     generate_data  get_estimates        hessian       mult_reg       naive_se 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           res_reg    sandwich_se         scores       sem_appl 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:18:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bc368f8f18f_1739679501
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFNHqjb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CIEE_v0.1.1-tikzDictionary"
