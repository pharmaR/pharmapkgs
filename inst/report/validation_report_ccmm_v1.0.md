...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Michael B. Sohn <msohn@mail.med.upenn.edu>           |
...
Overall the package has 4 exported objects. 4 are documented:
                ...
                ccmm          ccmm.sa ccmm.sensitivity tide.ci.zero.rho 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-16 03:54:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33986516_1739678044
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwQzc8A
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ccmm_v1.0-tikzDictionary"
