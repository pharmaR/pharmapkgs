...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Antonio Canale <antonio.canale@unipd.it>             |
...
| 2   | KernSmooth           | Imports   |
| 3   | ggplot2              | Imports   |
| 4   | gtools               | Imports   |
| 5   | mvtnorm              | Imports   |
| 6   | splines2 (\>= 0.3.1) | Imports   |
| 7   | truncnorm            | Imports   |
| 8   | rlang                | Imports   |
| 9   | RcppArmadillo        | LinkingTo |
| 10  | Rcpp (\>= 1.0.5)     | LinkingTo |
...
Overall the package has 10 exported objects. 10 are documented:
           ...
           add.risk  as.classCoMiRe        betaplot             BMD        bmd.plot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       comire.gibbs    fit.pdf.mcmc post.pred.check   predict_new_z        riskplot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 03:32:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bd661223fe6_1739763124
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFcm06P
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CoMiRe_v0.8-tikzDictionary"
