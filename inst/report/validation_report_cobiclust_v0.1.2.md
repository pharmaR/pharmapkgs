# Validation Report - cobiclust@0.1.2
...
| export_help          | 11                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Julie Aubert <julie.aubert@inrae.fr>     |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/julieaubert/cobiclust |
...
Overall the package has 11 exported objects. 11 are documented:
     ...
     alpha_calculation          cobiclust     cobiclustering              foo_a 
                  TRUE               TRUE               TRUE               TRUE 
              init_pam  is.cobiclustering     lb_calculation            penalty 
                  TRUE               TRUE               TRUE               TRUE 
        qu_calculation   qukg_calculation selection_criteria 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:48:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3179c3975_1739681332
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuPeLmE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cobiclust_v0.1.2-tikzDictionary"
