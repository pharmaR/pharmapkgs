...
| export_help          | 35                                                 |
| has_website          | FALSE                                              |
| has_maintainer       | Phillip D. Alderman <phillip.alderman@okstate.edu> |
...
Overall the package has 35 exported objects. 35 are documented:
       ...
       add_col_widths         add_v_fmt      as_DSSAT_tbl          calc_AMP 
                 TRUE              TRUE              TRUE              TRUE 
             calc_TAV      clear_output   convert_to_date       mutate_cond 
                 TRUE              TRUE              TRUE              TRUE 
        name_to_regex  read_casupro_eco          read_cul        read_dssat 
                 TRUE              TRUE              TRUE              TRUE 
        read_dssbatch          read_eco        read_filea        read_filet 
                 TRUE              TRUE              TRUE              TRUE 
           read_filex       read_output         read_pest read_soil_profile 
                 TRUE              TRUE              TRUE              TRUE 
             read_sol         read_tier    read_tier_data          read_wth 
                 TRUE              TRUE              TRUE              TRUE 
            run_dssat write_casupro_eco         write_cul    write_dssbatch 
                 TRUE              TRUE              TRUE              TRUE 
            write_eco       write_filea       write_filet       write_filex 
                 TRUE              TRUE              TRUE              TRUE 
            write_sol        write_tier         write_wth 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:52:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41933f7b5_1739854362
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIWo4VT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DSSAT_v0.0.9-tikzDictionary"
