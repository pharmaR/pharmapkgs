# Validation Report - fedmatch@2.1.0
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Chris Webster <chris0webster@gmail.com>              |
...
Overall the package has 14 exported objects. 13 are documented:
                        ...
                        %>%    build_clean_settings            build_corpus 
                      FALSE                    TRUE                    TRUE 
       build_fuzzy_settings build_multivar_settings    build_score_settings 
                       TRUE                    TRUE                    TRUE 
                 build_tier       calculate_weights           clean_strings 
                       TRUE                    TRUE                    TRUE 
             match_evaluate              merge_plus              tier_match 
                       TRUE                    TRUE                    TRUE 
       wgt_jaccard_distance          word_frequency 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-27 03:25:45 UTC |
...
running this report
    ...
    PROCESSX_PS1c627ce650e6_1740626741
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpibDUEm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fedmatch_v2.1.0-tikzDictionary"
