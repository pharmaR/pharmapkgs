...
| export_help          | 23                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | David Quesada <dkesada@gmail.com>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/dkesada/dbnR                      |
...
|     | package                 | type      |
|:----|:------------------------|:----------|
| 1   | bnlearn (\>= 4.5)       | Depends   |
| 2   | data.table (\>= 1.12.4) | Imports   |
| 3   | Rcpp (\>= 1.0.2)        | Imports   |
| 4   | magrittr (\>= 1.5)      | Imports   |
| 5   | R6 (\>= 2.4.1)          | Imports   |
| 6   | stats (\>= 3.6.0)       | Imports   |
| 7   | MASS (\>= 7.3-55)       | Imports   |
| 8   | Rcpp                    | LinkingTo |
...
Overall the package has 23 exported objects. 23 are documented:
                        ...
                        calc_mu                  calc_sigma 
                           TRUE                        TRUE 
                         degree           filter_same_cycle 
                           TRUE                        TRUE 
               filtered_fold_dt              fit_dbn_params 
                           TRUE                        TRUE 
                        fold_dt                 forecast_ts 
                           TRUE                        TRUE 
    generate_random_network_exp             learn_dbn_struc 
                           TRUE                        TRUE 
                  mvn_inference                       nodes 
                           TRUE                        TRUE 
                        nodes<-        plot_dynamic_network 
                           TRUE                        TRUE 
            plot_static_network                  predict_bn 
                           TRUE                        TRUE 
                     predict_dt                 rbn.dbn.fit 
                           TRUE                        TRUE 
                    reduce_freq                       score 
                           TRUE                        TRUE 
                   shift_values                   smooth_ts 
                           TRUE                        TRUE 
                    time_rename 
                           TRUE 
...
There are 104 help pages with examples, from 114 (91.23 %).
...
| Execution Time | 2025-02-17 05:07:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bd635b99e30_1739768855
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpms2JGC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dbnR_v0.7.9-tikzDictionary"
