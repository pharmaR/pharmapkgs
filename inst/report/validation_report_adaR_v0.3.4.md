...
| export_help          | 36                                    |
| has_website          | TRUE                                  |
| has_maintainer       | David Schoch <david@schochastics.net> |
| bugs_status          | 0.8666667                             |
| size_codebase        | 2382                                  |
| has_source_control   | https://github.com/gesistsa/adaR      |
...
Overall the package has 36 exported objects. 36 are documented:
                ...
                ada_clear_hash             ada_clear_port 
                          TRUE                       TRUE 
              ada_clear_search           ada_get_basename 
                          TRUE                       TRUE 
                ada_get_domain               ada_get_hash 
                          TRUE                       TRUE 
                  ada_get_host           ada_get_hostname 
                          TRUE                       TRUE 
                  ada_get_href           ada_get_password 
                          TRUE                       TRUE 
              ada_get_pathname               ada_get_port 
                          TRUE                       TRUE 
              ada_get_protocol             ada_get_search 
                          TRUE                       TRUE 
              ada_get_username        ada_has_credentials 
                          TRUE                       TRUE 
        ada_has_empty_hostname               ada_has_hash 
                          TRUE                       TRUE 
              ada_has_hostname ada_has_non_empty_password 
                          TRUE                       TRUE 
    ada_has_non_empty_username               ada_has_port 
                          TRUE                       TRUE 
                ada_has_search               ada_set_hash 
                          TRUE                       TRUE 
                  ada_set_host           ada_set_hostname 
                          TRUE                       TRUE 
                  ada_set_href           ada_set_password 
                          TRUE                       TRUE 
              ada_set_pathname               ada_set_port 
                          TRUE                       TRUE 
              ada_set_protocol             ada_set_search 
                          TRUE                       TRUE 
              ada_set_username              ada_url_parse 
                          TRUE                       TRUE 
                 public_suffix                url_decode2 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-14 06:35:12 UTC |
...
running this report
    ...
    PROCESSX_PS726d7633e283_1739514909
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpateyJX
