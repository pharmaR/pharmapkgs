# Validation Report - biglasso@1.6.0
...
| export_help          | 5                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Patrick Breheny <patrick-breheny@uiowa.edu> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/pbreheny/biglasso        |
...
|     | package                     | type      |
|:----|:----------------------------|:----------|
| 1   | bigmemory (\>= 4.5.0)       | Depends   |
| 2   | Matrix                      | Depends   |
| 3   | ncvreg                      | Depends   |
| 4   | Rcpp (\>= 0.12.1)           | Imports   |
| 5   | methods                     | Imports   |
| 6   | Rcpp                        | LinkingTo |
| 7   | RcppArmadillo (\>= 0.8.600) | LinkingTo |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         biglasso  biglasso_fit biglasso_path   cv.biglasso        setupX 
...
| Execution Time | 2025-02-15 04:03:55 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd586b03c5_1739592230
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpd1R1jY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biglasso_v1.6.0-tikzDictionary"
