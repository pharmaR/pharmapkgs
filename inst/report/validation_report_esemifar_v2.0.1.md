# Validation Report - esemifar@2.0.1
...
Overall the package has 10 exported objects. 10 are documented:
      ...
      arma_to_ar   arma_to_ma    critMatlm    d_to_coef    dsmoothlm     esemifar 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
    farima_to_ar farima_to_ma      gsmooth    tsmoothlm 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-19 04:29:56 UTC |
...
running this report
    ...
    PROCESSX_PS1d45d49c294_1739939389
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppgbwjA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_esemifar_v2.0.1-tikzDictionary"
