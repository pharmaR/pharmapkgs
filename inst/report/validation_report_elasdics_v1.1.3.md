# Validation Report - elasdics@1.1.3
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Lisa Steyer <lisa.steyer@hu-berlin.de>               |
...
Overall the package has 8 exported objects. 8 are documented:
              ...
              align_curves           center_curve   compute_elastic_mean 
                      TRUE                   TRUE                   TRUE 
    fit_elastic_regression   get_arc_length_param              get_evals 
                      TRUE                   TRUE                   TRUE 
       get_points_from_srv    get_srv_from_points 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-19 03:53:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d455f42cdb2_1739937228
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNFSoVd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_elasdics_v1.1.3-tikzDictionary"
