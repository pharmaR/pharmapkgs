# Validation Report - COVIDIBGE@0.2.2
...
| export_help          | 6                                         |
| has_website          | FALSE                                     |
| has_maintainer       | Gabriel Assuncao <pacotesipd@ibge.gov.br> |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    covid_deflator   covid_design  covid_example covid_labeller      get_covid 
...
| Execution Time | 2025-02-17 04:08:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67906ddc6_1739765316
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpN7GnkR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_COVIDIBGE_v0.2.2-tikzDictionary"
