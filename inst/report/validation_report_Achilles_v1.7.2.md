...
| export_help          | 34                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Frank DeFalco <fdefalco@ohdsi.org>                   |
...
|     | package                       | type    |
|:----|:------------------------------|:--------|
| 1   | DatabaseConnector (\>= 2.0.0) | Depends |
| 2   | SqlRender (\>= 1.6.0)         | Imports |
| 3   | dplyr                         | Imports |
| 4   | jsonlite                      | Imports |
| 5   | ParallelLogger                | Imports |
| 6   | readr                         | Imports |
...
Overall the package has 34 exported objects. 34 are documented:
                           ...
                           achilles                   createIndices 
                               TRUE                            TRUE 
                   createTimeSeries            dropAllScratchTables 
                               TRUE                            TRUE 
           exportConditionEraToJson           exportConditionToJson 
                               TRUE                            TRUE 
              exportDashboardToJson         exportDataDensityToJson 
                               TRUE                            TRUE 
                  exportDeathToJson             exportDrugEraToJson 
                               TRUE                            TRUE 
                   exportDrugToJson         exportMeasurementToJson 
                               TRUE                            TRUE 
                   exportMetaToJson   exportObservationPeriodToJson 
                               TRUE                            TRUE 
            exportObservationToJson         exportPerformanceToJson 
                               TRUE                            TRUE 
                 exportPersonToJson           exportProcedureToJson 
                               TRUE                            TRUE 
                 exportResultsToCSV                    exportToAres 
                               TRUE                            TRUE 
                       exportToJson         exportVisitDetailToJson 
                               TRUE                            TRUE 
                  exportVisitToJson              getAnalysisDetails 
                               TRUE                            TRUE 
                getSeasonalityScore                 getTemporalData 
                               TRUE                            TRUE 
                       isStationary             listMissingAnalyses 
                               TRUE                            TRUE 
                 optimizeAtlasCache performTemporalCharacterization 
                               TRUE                            TRUE 
                 runMissingAnalyses                 showReportTypes 
                               TRUE                            TRUE 
                     sumAcrossYears                 tsCompleteYears 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-14 06:31:54 UTC |
...
running this report
    ...
    PROCESSX_PS726d58dc6b49_1739514711
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1Frmgv
