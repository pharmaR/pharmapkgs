# Validation Report - DDPstar@1.0.1
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Maria Xose Rodriguez-Alvarez <mxrodriguez@uvigo.gal> |
...
Overall the package has 11 exported objects. 11 are documented:
                      ...
                      DDPstar                         f               mcmccontrol 
                         TRUE                      TRUE                      TRUE 
              predict.DDPstar predictive.checks.DDPstar             print.DDPstar 
                         TRUE                      TRUE                      TRUE 
                 priorcontrol         quantileResiduals quantileResiduals.DDPstar 
                         TRUE                      TRUE                      TRUE 
                          rae           summary.DDPstar 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-18 03:30:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bb430001465_1739849403
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxRyv0X
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DDPstar_v1.0.1-tikzDictionary"
