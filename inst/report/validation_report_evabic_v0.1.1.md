# Validation Report - evabic@0.1.1
...
| export_help          | 25                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Antoine Bichat <antoine.bichat@proton.me> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/abichat/evabic         |
...
Overall the package has 25 exported objects. 25 are documented:
                ...
                add_names               ebc_ACC       ebc_allmeasures 
                     TRUE                  TRUE                  TRUE 
                  ebc_AUC ebc_AUC_from_measures              ebc_BACC 
                     TRUE                  TRUE                  TRUE 
            ebc_confusion               ebc_DOR                ebc_F1 
                     TRUE                  TRUE                  TRUE 
                  ebc_FDR                ebc_FN               ebc_FNR 
                     TRUE                  TRUE                  TRUE 
                  ebc_FOR                ebc_FP               ebc_FPR 
                     TRUE                  TRUE                  TRUE 
                  ebc_NLR               ebc_NPV               ebc_PLR 
                     TRUE                  TRUE                  TRUE 
                  ebc_PPV              ebc_tidy ebc_tidy_by_threshold 
                     TRUE                  TRUE                  TRUE 
                   ebc_TN               ebc_TNR                ebc_TP 
                     TRUE                  TRUE                  TRUE 
                  ebc_TPR 
                     TRUE 
...
| Execution Time | 2025-02-19 04:37:36 UTC |
...
running this report
    ...
    PROCESSX_PS1d45471ec765_1739939850
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXkv3kc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evabic_v0.1.1-tikzDictionary"
