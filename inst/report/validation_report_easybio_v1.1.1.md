# Validation Report - easybio@1.1.1
...
| export_help          | 33                                  |
| has_website          | TRUE                                |
| has_maintainer       | Wei Cui <m2c.w@outlook.com>         |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/person-c/easybio |
...
Overall the package has 33 exported objects. 33 are documented:
                    ...
                    Artist available_tissue_class  available_tissue_type 
                      TRUE                   TRUE                   TRUE 
              check_marker                dgeList       dprocess_dgeList 
                      TRUE                   TRUE                   TRUE 
                   finsert               get_attr             get_marker 
                      TRUE                   TRUE                   TRUE 
                 groupStat             groupStatI               limmaFit 
                      TRUE                   TRUE                   TRUE 
                   list2dt             list2graph       matchCellMarker2 
                      TRUE                   TRUE                   TRUE 
           plotEnrichment2               plotGSEA plotMarkerDistribution 
                      TRUE                   TRUE                   TRUE 
                   plotORA       plotPossibleCell               plotRank 
                      TRUE                   TRUE                   TRUE 
             plotSeuratDot            plotVolcano            prepare_geo 
                      TRUE                   TRUE                   TRUE 
              prepare_tcga            setcolnames            setrownames 
                      TRUE                   TRUE                   TRUE 
                setSavedir           split_matrix      theme_publication 
                      TRUE                   TRUE                   TRUE 
            tuneParameters         uniprot_id_map                 workIn 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 05:10:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bb464bfc214_1739855441
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsousuW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easybio_v1.1.1-tikzDictionary"
