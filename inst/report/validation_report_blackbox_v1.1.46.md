# Validation Report - blackbox@1.1.46
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | François Rousset <francois.rousset@umontpellier.fr>  |
...
| 1   | numDeriv             | Imports   |
| 2   | rcdd                 | Imports   |
| 3   | geometry (\>= 0.3-6) | Imports   |
| 4   | proxy                | Imports   |
| 5   | spaMM (\>= 3.1.0)    | Imports   |
| 6   | lattice              | Imports   |
| 7   | Rcpp (\>= 0.12.10)   | Imports   |
| 8   | nloptr               | Imports   |
| 9   | MASS                 | Imports   |
| 10  | pbapply              | Imports   |
| 11  | foreach              | Imports   |
...
Overall the package has 4 exported objects. 1 are documented:

          %==nc%       %innc%        %w/o% spaMM.colors 
...
| Execution Time | 2025-02-15 04:20:51 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6a9a5078_1739593246
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCoDtSu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blackbox_v1.1.46-tikzDictionary"
