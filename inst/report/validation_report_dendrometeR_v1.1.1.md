# Validation Report - dendrometeR@1.1.1
...
| export_help          | 9                                              |
| has_website          | TRUE                                           |
| has_maintainer       | Marko Smiljanic <marko.smiljanic313@gmail.com> |
| has_source_control   | https://github.com/smiljanicm/dendrometeR      |
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          climate_seg       cycle_stats       daily_stats dendro.resolution 
                 TRUE              TRUE              TRUE              TRUE 
            fill_gaps         fill_plot         is.dendro         phase_def 
                 TRUE              TRUE              TRUE              TRUE 
           phase_plot 
                 TRUE 
...
| Execution Time | 2025-02-24 03:26:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a415ae058_1740367613
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMmPDsv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dendrometeR_v1.1.1-tikzDictionary"
