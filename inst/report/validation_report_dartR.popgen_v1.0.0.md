# Validation Report - dartR.popgen@1.0.0
...
| 2   | dartR.base           | Depends |
| 3   | dartR.data           | Depends |
| 4   | methods              | Imports |
| 5   | utils                | Imports |
| 6   | MASS                 | Imports |
| 7   | dplyr                | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
                            ...
                            gl.blast                      gl.collapse 
                                TRUE                             TRUE 
                           gl.evanno                   gl.ld.distance 
                                TRUE                             TRUE 
                     gl.ld.haplotype                          gl.LDNe 
                                TRUE                             TRUE 
                    gl.map.structure                      gl.nhybrids 
                                TRUE                             TRUE 
                         gl.outflank            gl.plot.faststructure 
                                TRUE                             TRUE 
                   gl.plot.structure                      gl.run.epos 
                                TRUE                             TRUE 
                gl.run.faststructure                 gl.run.stairway2 
                                TRUE                             TRUE 
                    gl.run.structure                           gl.sfs 
                                TRUE                             TRUE 
                      utils.outflank utils.outflank.MakeDiploidFSTMat 
                                TRUE                             TRUE 
              utils.outflank.plotter           utils.structure.evanno 
                                TRUE                             TRUE 
       utils.structure.genind2gtypes              utils.structure.run 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-17 04:54:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61c1ee089_1739768085
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9r60gI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dartR.popgen_v1.0.0-tikzDictionary"
