...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Moreno I. Coco <moreno.cocoi@gmail.com>              |
...
Overall the package has 12 exported objects. 12 are documented:
               ...
               crqa       drpfromts lorenzattractor         mdDelay           mdFnn 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      optimizeParam    piecewiseRQA         plot_rp           simts         spdiags 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            wincrqa       windowdrp 
               TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:25:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bd659853ed8_1739766345
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpM9adwO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crqa_v2.0.6-tikzDictionary"
