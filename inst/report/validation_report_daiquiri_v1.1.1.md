# Validation Report - daiquiri@1.1.1
...
| export_help          | 19                                        |
| has_website          | TRUE                                      |
| has_maintainer       | T. Phuong Quan <phuong.quan@ndm.ox.ac.uk> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/ropensci/daiquiri      |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | data.table (\>= 1.12.8) | Imports |
| 2   | readr (\>= 2.0.0)       | Imports |
| 3   | ggplot2 (\>= 3.1.0)     | Imports |
| 4   | scales (\>= 1.1.0)      | Imports |
| 5   | cowplot (\>= 0.9.3)     | Imports |
| 6   | rmarkdown               | Imports |
| 7   | reactable (\>= 0.2.3)   | Imports |
| 8   | utils                   | Imports |
| 9   | stats                   | Imports |
| 10  | xfun (\>= 0.15)         | Imports |
...
Overall the package has 19 exported objects. 19 are documented:
            ...
            aggregate_data              close_log        daiquiri_report 
                      TRUE                   TRUE                   TRUE 
    export_aggregated_data            field_types         ft_categorical 
                      TRUE                   TRUE                   TRUE 
               ft_datetime            ft_freetext              ft_ignore 
                      TRUE                   TRUE                   TRUE 
                ft_numeric              ft_simple              ft_strata 
                      TRUE                   TRUE                   TRUE 
              ft_timepoint    ft_uniqueidentifier         initialise_log 
                      TRUE                   TRUE                   TRUE 
              prepare_data              read_data            report_data 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-17 04:51:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67a30da0e_1739767884
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIL1tfi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_daiquiri_v1.1.1-tikzDictionary"
