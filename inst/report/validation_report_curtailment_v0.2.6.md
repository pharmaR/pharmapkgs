# Validation Report - curtailment@0.2.6
...
| export_help          | 11                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Martin Law <martin.law@mrc-bsu.cam.ac.uk> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/martinlaw/curtailment  |
...
Overall the package has 11 exported objects. 11 are documented:
              ...
              drawDiagram    drawDiagramGeneric     find2stageDesigns 
                     TRUE                  TRUE                  TRUE 
         find2stageThetaF              findLoss        findNSCdesigns 
                     TRUE                  TRUE                  TRUE 
            findSCdesigns findSingleSimonDesign          plotByWeight 
                     TRUE                  TRUE                  TRUE 
          singlearmDesign          twoarmDesign 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-17 04:40:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66f5e191c_1739767243
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6OGTmX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_curtailment_v0.2.6-tikzDictionary"
