...
|     | package                   | type      |
|:----|:--------------------------|:----------|
| 1   | BoomSpikeSlab (\>= 1.2.6) | Depends   |
| 2   | zoo (\>= 1.8)             | Depends   |
| 3   | xts                       | Depends   |
| 4   | Boom (\>= 0.9.13)         | Depends   |
| 5   | R(\>= 3.4.0)              | Depends   |
| 6   | Boom (\>= 0.9.13)         | LinkingTo |
...
CausalImpact, MarketMatching

## Namespace

Overall the package has 99 exported objects. 99 are documented:
...
| Execution Time | 2025-02-15 04:51:33 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd45913c5d_1739595088
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTbnS6m
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bsts_v0.9.10-tikzDictionary"
