...
| size_codebase        | 1337                                    |
| has_source_control   | https://github.com/mhahsler/arulesCBA   |
...
| 2   | arules (\>= 1.7-4)         | Depends |
| 3   | methods                    | Imports |
| 4   | discretization (\>= 1.0-1) | Imports |
| 5   | glmnet (\>= 3.0-0)         | Imports |
...
Overall the package has 25 exported objects. 25 are documented:
                   ...
                   accuracy                C4.5_CBA                     CBA 
                       TRUE                    TRUE                    TRUE 
                CBA_ruleset                 classes          classFrequency 
                       TRUE                    TRUE                    TRUE 
                       CMAR                    CPAR discretizeDF.supervised 
                       TRUE                    TRUE                    TRUE 
                       FOIL                   FOIL2           majorityClass 
                       TRUE                    TRUE                    TRUE 
                   mineCARs                PART_CBA     prepareTransactions 
                       TRUE                    TRUE                    TRUE 
                        PRM             pruneCBA_M1             pruneCBA_M2 
                       TRUE                    TRUE                    TRUE 
                       RCAR                response              RIPPER_CBA 
                       TRUE                    TRUE                    TRUE 
        transactionCoverage         transactions2DF  uncoveredClassExamples 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 07:25:58 UTC |
...
running this report
    ...
    PROCESSX_PS1c092add01d1_1739517956
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOyT3ZP
