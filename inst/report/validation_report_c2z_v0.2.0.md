...
| export_help          | 24                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Øystein Olav Skaar <oeysan@gmail.com> |
| bugs_status          | 0.25                                  |
| has_source_control   | https://github.com/oeysan/c2z/        |
...
Overall the package has 24 exported objects. 24 are documented:
             ...
             Cristin   CristinMonthly CristinSupported     CristinUnits 
                TRUE             TRUE             TRUE             TRUE 
     CristinWrangler      DoiCrossref      DoiDatacite           Zotero 
                TRUE             TRUE             TRUE             TRUE 
           ZoteroAdd      ZoteroCheck       ZoteroCopy       ZoteroCran 
                TRUE             TRUE             TRUE             TRUE 
        ZoteroDelete        ZoteroDoi     ZoteroExport        ZoteroGet 
                TRUE             TRUE             TRUE             TRUE 
           ZoteroGov      ZoteroIndex       ZoteroIsbn        ZoteroKey 
                TRUE             TRUE             TRUE             TRUE 
       ZoteroLibrary      ZoteroMatch       ZoteroPost      ZoteroTypes 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-16 03:31:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35d6595cd_1739676696
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphCeo7r
...
These are the options set to generate the report:
    ...
    [1] "validation_report_c2z_v0.2.0-tikzDictionary"
