# Validation Report - ExPanDaR@0.5.3
...
| export_help          | 14                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Joachim Gassen <gassen@wiwi.hu-berlin.de> |
...
| 12  | openssl         | Imports |
| 13  | tictoc          | Imports |
| 14  | shinycssloaders | Imports |
| 15  | kableExtra      | Imports |
| 16  | rio             | Imports |
| 17  | zip             | Imports |
| 18  | rlang           | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
                           ...
                           ExPanD    prepare_by_group_bar_graph 
                             TRUE                          TRUE 
     prepare_by_group_trend_graph prepare_by_group_violin_graph 
                             TRUE                          TRUE 
        prepare_correlation_graph     prepare_correlation_table 
                             TRUE                          TRUE 
        prepare_descriptive_table         prepare_ext_obs_table 
                             TRUE                          TRUE 
     prepare_missing_values_graph  prepare_quantile_trend_graph 
                             TRUE                          TRUE 
         prepare_regression_table          prepare_scatter_plot 
                             TRUE                          TRUE 
              prepare_trend_graph                treat_outliers 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-19 04:50:47 UTC |
...
running this report
    ...
    PROCESSX_PS1d45f733e58_1739940640
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYyQh3D
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ExPanDaR_v0.5.3-tikzDictionary"
