...
| export_help          | 24                                 |
| has_website          | TRUE                               |
| has_maintainer       | Hailong Chai <chaihl17@lzu.edu.cn> |
| has_source_control   | https://github.com/tsiamut/ch      |
...
Overall the package has 24 exported objects. 24 are documented:
      ...
      console_cl      csv2vcf        ggpng        ggPNG ground_state      lat_fmt 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       latex_fmt         mono        monoa        monob period_table   plot_table 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        read.txt        Round      round_1       Round2     scan.str   show_color 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      show_ruler      state_1      state_2     sym2coef     sym2poly         symb 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:06:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bc342ddc2ec_1739678810
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSsS3MI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ch_v0.1.0.2-tikzDictionary"
