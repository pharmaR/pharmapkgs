# Validation Report - cxhull@0.7.4
...
| has_source_control   | https://github.com/stla/cxhull             |
...
archeoViz, gyro, tessellation

## Namespace

Overall the package has 10 exported objects. 10 are documented:

              cxhull      cxhullEdges   dihedralAngles          EdgesAB 
                TRUE             TRUE             TRUE             TRUE 
            EdgesXYZ         hullMesh      hullSummary plotConvexHull3d 
                TRUE             TRUE             TRUE             TRUE 
        TrianglesXYZ      VerticesXYZ 
                TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:45:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bd624164a38_1739767535
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLCU01x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cxhull_v0.7.4-tikzDictionary"
