# Validation Report - coxme@2.2.22
...
|     | package                | type      |
|:----|:-----------------------|:----------|
| 1   | survival (\>= 2.36.14) | Depends   |
| 2   | methods                | Depends   |
| 3   | bdsmatrix(\>= 1.3)     | Depends   |
| 4   | R(\>= 2.10)            | Depends   |
| 5   | nlme                   | Imports   |
| 6   | Matrix (\>= 1.0)       | Imports   |
| 7   | bdsmatrix              | LinkingTo |
...
AICcmodavg, bigQF, car, EQUALSTATS, famSKATRC, finalfit, gap, highMLR,
injurytools, insight, jstable, MAGNAMWAR, mlma, mlmm.gwas, multcomp,
multisite.accuracy, parameters, PenCoxFrail, spicyR, tram, tramME

## Namespace

Overall the package has 12 exported objects. 12 are documented:

             coxme  coxme.control      coxmeFull     coxmeMlist  expand.nested 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     fixed.effects          fixef         lmekin lmekin.control random.effects 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             ranef        VarCorr 
              TRUE           TRUE 
...
There are 14 help pages with examples, from 19 (73.68 %).
...
| Execution Time | 2025-02-24 03:22:24 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a47bfe000_1740367341
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplMJszq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coxme_v2.2.22-tikzDictionary"
