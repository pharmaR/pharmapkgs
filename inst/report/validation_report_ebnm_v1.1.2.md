...
| has_source_control   | https://github.com/stephenslab/ebnm           |
...
Overall the package has 27 exported objects. 27 are documented:
                         ...
                         ebnm          ebnm_add_sampler                  ebnm_ash 
                         TRUE                      TRUE                      TRUE 
             ebnm_deconvolver                 ebnm_flat   ebnm_generalized_binary 
                         TRUE                      TRUE                      TRUE 
                   ebnm_group            ebnm_horseshoe               ebnm_normal 
                         TRUE                      TRUE                      TRUE 
    ebnm_normal_scale_mixture                ebnm_npmle           ebnm_output_all 
                         TRUE                      TRUE                      TRUE 
          ebnm_output_default    ebnm_point_exponential        ebnm_point_laplace 
                         TRUE                      TRUE                      TRUE 
              ebnm_point_mass         ebnm_point_normal      ebnm_scale_normalmix 
                         TRUE                      TRUE                      TRUE 
             ebnm_scale_npmle         ebnm_scale_unimix             ebnm_unimodal 
                         TRUE                      TRUE                      TRUE 
    ebnm_unimodal_nonnegative ebnm_unimodal_nonpositive   ebnm_unimodal_symmetric 
                         TRUE                      TRUE                      TRUE 
                     gammamix                 horseshoe                laplacemix 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-25 03:25:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d285469416a_1740453908
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpytJeVq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ebnm_v1.1.2-tikzDictionary"
