...
| has_source_control   | https://github.com/DarkEyes/EDOIF               |
...
| 3   | igraph            | Imports |
| 4   | ellipsis          | Imports |
| 5   | simpleboot        | Imports |
| 6   | ggplot2 (\>= 3.0) | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
        ...
        checkSim3Res            EDOIF     getADJNetDen  getiGraphNetDen 
                TRUE             TRUE             TRUE             TRUE 
        getiGraphOBJ         getOrder        plotGraph      plotMeanCIs 
                TRUE             TRUE             TRUE             TRUE 
     plotMeanDiffCIs       SimMixDist SimNonNormalDist 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 03:43:07 UTC |
...
running this report
    ...
    PROCESSX_PS1d4542a173b6_1739936581
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpD5vbHv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EDOIF_v0.1.3-tikzDictionary"
