...
| export_help          | 26                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Brooke Anderson <brooke.anderson@colostate.edu> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | http://github.com/sakoehler7/eesim              |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | dplyr (\>= 0.5.0)     | Imports |
| 2   | lubridate (\>= 1.5.6) | Imports |
| 3   | purrr (\>= 0.2.2)     | Imports |
| 4   | splines               | Imports |
| 5   | viridis (\>= 0.4.0)   | Imports |
...
Overall the package has 26 exported objects. 26 are documented:
              ...
              beta_bias            beta_var               bin_t     binary_exposure 
                   TRUE                TRUE                TRUE                TRUE 
                 calc_t       calendar_plot          check_sims continuous_exposure 
                   TRUE                TRUE                TRUE                TRUE 
          coverage_beta       coverage_plot     create_baseline       create_lambda 
                   TRUE                TRUE                TRUE                TRUE 
            create_sims     custom_baseline     custom_exposure               eesim 
                   TRUE                TRUE                TRUE                TRUE 
               fit_mods          format_out           mean_beta          power_beta 
                   TRUE                TRUE                TRUE                TRUE 
             power_calc        sim_baseline        sim_exposure         sim_outcome 
                   TRUE                TRUE                TRUE                TRUE 
             spline_mod        std_exposure 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-19 03:45:28 UTC |
...
running this report
    ...
    PROCESSX_PS1d457cc2bd90_1739936722
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpu9wbWb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eesim_v0.1.0-tikzDictionary"
