...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yin Song <yinsong@uvic.ca>                           |
...
|     | package                    | type    |
|:----|:---------------------------|:--------|
| 1   | Matrix (\>= 1.2.6)         | Depends |
| 2   | mvtnorm (\>= 1.0.5)        | Depends |
| 3   | matrixcalc(\>= 1.0.3)      | Depends |
| 4   | miscTools (\>= 0.6.22)     | Depends |
| 5   | coda (\>= 0.18.1)          | Imports |
| 6   | EDISON (\>= 1.1.1)         | Imports |
| 7   | statmod (\>= 1.4.26)       | Imports |
| 8   | methods (\>= 3.3.3)        | Imports |
| 9   | sparseMVN (\> 0.2.0)       | Imports |
| 10  | inline (\>= 0.3.15)        | Imports |
| 11  | LaplacesDemon (\>= 16.1.0) | Imports |
| 12  | glmnet(\>= 2.0.13)         | Imports |
| 13  | CholWishart (\>= 0.9.3)    | Imports |
| 14  | mnormt (\>= 1.5.4)         | Imports |
| 15  | Rcpp(\>= 0.12.14)          | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
            ...
            bgsmtr      sp_bgsmtr sp_bgsmtr_path 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-15 03:59:21 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3d9cc03a_1739591956
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzwuyPg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bgsmtr_v0.7-tikzDictionary"
