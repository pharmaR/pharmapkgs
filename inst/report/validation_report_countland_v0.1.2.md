# Validation Report - countland@0.1.2
...
| export_help          | 20                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Church Samuel H. <samuelhchurch@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/shchurch/countland      |
...
Overall the package has 20 exported objects. 20 are documented:
             ...
             Cluster        countland              Dot            Embed 
                TRUE             TRUE             TRUE             TRUE 
        PlotEigengap    PlotEmbedding   PlotGeneCounts          PlotIMA 
                TRUE             TRUE             TRUE             TRUE 
        PlotIMAElbow       PlotMarker PlotSharedCounts  RankMarkerGenes 
                TRUE             TRUE             TRUE             TRUE 
       RestoreCounts           RunIMA       ScoreCells       ScoreGenes 
                TRUE             TRUE             TRUE             TRUE 
        SharedCounts        Subsample      SubsetCells      SubsetGenes 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:04:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6b95111d_1739765088
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphRadbT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_countland_v0.1.2-tikzDictionary"
