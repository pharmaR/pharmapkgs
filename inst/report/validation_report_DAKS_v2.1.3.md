...
| export_help          | 22                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Ali Uenlue <ali.uenlue@tum.de>                       |
...
Overall the package has 22 exported objects. 22 are documented:
            ...
            corr_iita             hasse              iita         imp2state 
                 TRUE              TRUE              TRUE              TRUE 
              ind_gen         mini_iita        ob_counter         orig_iita 
                 TRUE              TRUE              TRUE              TRUE 
              pattern          pop_iita      pop_variance        print.iita 
                 TRUE              TRUE              TRUE              TRUE 
            print.pat     print.popiita print.summpopiita       print.ztest 
                 TRUE              TRUE              TRUE              TRUE 
                 simu         state2imp      summary.iita   summary.popiita 
                 TRUE              TRUE              TRUE              TRUE 
             variance            z_test 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:51:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63b05c96a_1739767909
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppVSCcf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DAKS_v2.1.3-tikzDictionary"
