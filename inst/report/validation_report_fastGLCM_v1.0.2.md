# Validation Report - fastGLCM@1.0.2
...
| has_source_control   | https://github.com/mlampros/fastGLCM             |
...
|:----|:-------------------|:----------|
| 1   | R(\>= 3.2.3)       | Depends   |
| 2   | Rcpp (\>= 1.0.8.3) | Imports   |
| 3   | R6                 | Imports   |
| 4   | rlang              | Imports   |
| 5   | OpenImageR         | Imports   |
| 6   | utils              | Imports   |
| 7   | Rcpp               | LinkingTo |
| 8   | RcppArmadillo      | LinkingTo |
| 9   | OpenImageR         | LinkingTo |
...
Overall the package has 3 exported objects. 3 are documented:
             ...
             fastglcm     fastGLCM_Rcpp plot_multi_images 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 05:16:45 UTC |
...
running this report
    ...
    PROCESSX_PS1d453b9bcc3a_1739942198
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNw91FG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastGLCM_v1.0.2-tikzDictionary"
