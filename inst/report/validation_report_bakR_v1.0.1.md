...
| export_help          | 21                                |
| has_website          | TRUE                              |
| has_maintainer       | Isaac Vock <isaac.vock@gmail.com> |
| bugs_status          | 1                                 |
| size_codebase        | 4372                              |
...
Overall the package has 21 exported objects. 21 are documented:
                      ...
                      bakRData                    bakRFit 
                          TRUE                       TRUE 
                    bakRFnData                  cBprocess 
                          TRUE                       TRUE 
                CorrectDropout           DissectMechanism 
                          TRUE                       TRUE 
                 fast_analysis                 fn_process 
                          TRUE                       TRUE 
                         FnPCA                     FnPCA2 
                          TRUE                       TRUE 
                  GSprocessing               Heatmap_kdeg 
                          TRUE                       TRUE 
                       NSSHeat                     plotMA 
                          TRUE                       TRUE 
                   plotVolcano                  QC_checks 
                          TRUE                       TRUE 
               QuantifyDropout           reliableFeatures 
                          TRUE                       TRUE 
             Simulate_bakRData Simulate_relative_bakRData 
                          TRUE                       TRUE 
              VisualizeDropout 
                          TRUE 
...
| Execution Time | 2025-02-14 07:40:43 UTC |
...
running this report
    ...
    PROCESSX_PS1c0915b67f0b_1739518840
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT2teBq
