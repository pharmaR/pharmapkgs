# Validation Report - dlmtree@1.0.0
...
| export_help          | 27                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Daniel Mork <dmork@hsph.harvard.edu>  |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/danielmork/dlmtree |
...
|     | package          | type      |
|:----|:-----------------|:----------|
| 1   | Rcpp (\>= 1.0.4) | Imports   |
| 2   | dplyr            | Imports   |
| 3   | ggplot2          | Imports   |
| 4   | shiny            | Imports   |
| 5   | shinythemes      | Imports   |
| 6   | tidyr            | Imports   |
| 7   | mgcv             | Imports   |
| 8   | Rcpp             | LinkingTo |
...
Overall the package has 27 exported objects. 27 are documented:
            ...
            adj_coexposure         combine.models                dlmtree 
                      TRUE                   TRUE                   TRUE 
                    estDLM                    pip  plot.summary.monotone 
                      TRUE                   TRUE                   TRUE 
         plot.summary.tdlm     plot.summary.tdlmm     plot.summary.tdlnm 
                      TRUE                   TRUE                   TRUE 
              predict.hdlm          predict.hdlmm     print.summary.hdlm 
                      TRUE                   TRUE                   TRUE 
       print.summary.hdlmm print.summary.monotone     print.summary.tdlm 
                      TRUE                   TRUE                   TRUE 
       print.summary.tdlmm    print.summary.tdlnm              sim.hdlmm 
                      TRUE                   TRUE                   TRUE 
                 sim.tdlmm              sim.tdlnm            splitpoints 
                      TRUE                   TRUE                   TRUE 
              summary.hdlm          summary.hdlmm       summary.monotone 
                      TRUE                   TRUE                   TRUE 
              summary.tdlm          summary.tdlmm          summary.tdlnm 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:25:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47b7f1f8c_1739852740
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpX0vUHm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dlmtree_v1.0.0-tikzDictionary"
