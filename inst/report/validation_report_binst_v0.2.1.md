...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Chapman Siu <chpmn.siu@gmail.com>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/jules-and-dave/binst              |
...
Overall the package has 8 exported objects. 8 are documented:
            ...
            create_bins       create_breaks     create_dtbreaks  create_earthbreaks 
                   TRUE                TRUE                TRUE                TRUE 
     create_jenksbreaks create_kmeansbreaks   create_mdlpbreaks         get_control 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 04:10:53 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5b747531_1739592648
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpgrc27X
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binst_v0.2.1-tikzDictionary"
