...
| export_help | 11 |
| has_website | TRUE |
| has_maintainer | Ying Xu <ying.xu3@unsw.edu.au> |
| bugs_status | subscript out of bounds |
| size_codebase | 221 |
| has_source_control | https://github.com/fabilab/cell_atlas_approximations_API |
...
Overall the package has 11 exported objects. 11 are documented:
               ...
               GetAverage   GetCelltypeLocation          GetCelltypes 
                     TRUE                  TRUE                  TRUE 
           GetDataSources           GetFeatures   GetFractionDetected 
                     TRUE                  TRUE                  TRUE 
    GetHighestMeasurement            GetMarkers          GetOrganisms 
                     TRUE                  TRUE                  TRUE 
                GetOrgans    GetSimilarFeatures 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-14 07:30:45 UTC |
...
running this report
    ...
    PROCESSX_PS1c097bd7e76e_1739518242
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSOeYvS
