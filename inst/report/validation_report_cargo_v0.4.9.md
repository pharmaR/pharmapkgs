...
| export_help | 7 |
| has_website | TRUE |
| has_maintainer | David B. Dahl <dahl@stat.byu.edu> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/dbdahl/cargo-framework (repository) |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    api_documentation           authors    build_for_cran           install 
                 TRUE              TRUE              TRUE              TRUE 
          new_package               run           rust_fn 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 03:42:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31f18be37_1739677340
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqeBMC7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cargo_v0.4.9-tikzDictionary"
