# Validation Report - corona@0.3.0
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jo van Schalkwyk <jvanschalkwyk@gmail.com>           |
...
Overall the package has 15 exported objects. 15 are documented:
               ...
               corona        corona_all    corona_citymap   corona_converge 
                 TRUE              TRUE              TRUE              TRUE 
       corona_country   corona_dowjones       corona_life   corona_lockdown 
                 TRUE              TRUE              TRUE              TRUE 
    corona_metabolism      corona_monty    corona_rabbits     corona_totals 
                 TRUE              TRUE              TRUE              TRUE 
        corona_trends     corona_vienna      country_dead 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-17 03:58:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63e099122_1739764707
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXiTie8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corona_v0.3.0-tikzDictionary"
