# Validation Report - braidReports@1.0.1
...
Overall the package has 18 exported objects. 18 are documented:
    ...
    basicBraidAnalysis         geom_braid geom_braid_contour   geom_braid_glass 
                  TRUE               TRUE               TRUE               TRUE 
     geom_braid_smooth        kappa_trans    makeBraidReport   runBraidAnalysis 
                  TRUE               TRUE               TRUE               TRUE 
         scale_x_kappa      scale_y_kappa         stat_braid stat_braid_contour 
                  TRUE               TRUE               TRUE               TRUE 
      stat_braid_glass  stat_braid_smooth          StatBraid   StatBraidContour 
                  TRUE               TRUE               TRUE               TRUE 
        StatBraidGlass    StatBraidSmooth 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:40:17 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd25ca135_1739594412
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptHz6Ly
...
These are the options set to generate the report:
    ...
    [1] "validation_report_braidReports_v1.0.1-tikzDictionary"
