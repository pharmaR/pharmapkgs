# Validation Report - datapasta@3.1.0
...
| export_help          | 24                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Miles McBain <miles.mcbain@gmail.com>    |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/milesmcbain/datapasta |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | readr (\>= 1.2.0)    | Imports |
| 2   | clipr (\>= 0.3.0)    | Imports |
| 3   | rstudioapi (\>= 0.6) | Imports |
| 4   | methods              | Imports |
...
Overall the package has 24 exported objects. 24 are documented:
            ...
            clipboard_context           console_context            custom_context 
                         TRUE                      TRUE                      TRUE 
                    df_format                  df_paste            dfdt_construct 
                         TRUE                      TRUE                      TRUE 
                      dmdclip       dp_set_decimal_mark           dp_set_max_rows 
                         TRUE                      TRUE                      TRUE 
                       dpasta                 dt_format                  dt_paste 
                         TRUE                      TRUE                      TRUE 
             markdown_context           rstudio_context         tribble_construct 
                         TRUE                      TRUE                      TRUE 
               tribble_format             tribble_paste          vector_construct 
                         TRUE                      TRUE                      TRUE 
    vector_construct_vertical             vector_format              vector_paste 
                         TRUE                      TRUE                      TRUE 
        vector_paste_vertical            zzz_rs_dfiddle      zzz_rs_toggle_quotes 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-17 04:59:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61b07bbe2_1739768362
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwNPwr9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datapasta_v3.1.0-tikzDictionary"
