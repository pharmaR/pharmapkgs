...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tony Fujs <tonyfujs@gmail.com>                       |
...
| 2   | dplyr (\>= 0.7.4)      | Imports |
| 3   | httr (\>= 1.3.1)       | Imports |
| 4   | jsonlite (\>= 1.5)     | Imports |
| 5   | purrr (\>= 0.2.4)      | Imports |
| 6   | stringr (\>= 1.2.0)    | Imports |
| 7   | tibble (\>= 1.4.2)     | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
      ...
      attach_file_to_node           create_node           delete_node 
                     TRUE                  TRUE                  TRUE 
             dkanr_logout        dkanr_settings           dkanr_setup 
                     TRUE                  TRUE                  TRUE 
          ds_is_available             ds_search         ds_search_all 
                     TRUE                  TRUE                  TRUE 
              err_handler filters_to_text_query            get_cookie 
                     TRUE                  TRUE                  TRUE 
        get_resource_nids      get_resource_url             get_token 
                     TRUE                  TRUE                  TRUE 
                  get_url          is.dkan_list          is.dkan_node 
                     TRUE                  TRUE                  TRUE 
               list_nodes        list_nodes_all         retrieve_node 
                     TRUE                  TRUE                  TRUE 
              update_node 
                     TRUE 
...
| Execution Time | 2025-02-18 04:24:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bb448002862_1739852672
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9PBAMI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dkanr_v0.1.3-tikzDictionary"
