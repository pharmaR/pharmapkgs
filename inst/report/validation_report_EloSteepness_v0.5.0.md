# Validation Report - EloSteepness@0.5.0
...
| export_help          | 14                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Christof Neumann <christofneumann1@gmail.com> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/gobbios/EloSteepness       |
...
| 7   | aniDom                    | Imports   |
| 8   | BH (\>= 1.66.0)           | LinkingTo |
| 9   | Rcpp (\>= 0.12.0)         | LinkingTo |
| 10  | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 11  | RcppParallel (\>= 5.0.1)  | LinkingTo |
| 12  | rstan (\>= 2.26.0)        | LinkingTo |
| 13  | StanHeaders (\>= 2.26.0)  | LinkingTo |
...
Overall the package has 14 exported objects. 14 are documented:
                 ...
                 catch_warnings            davids_steepness 
                           TRUE                        TRUE 
      elo_steepness_from_matrix elo_steepness_from_sequence 
                           TRUE                        TRUE 
     generate_interaction_probs                 plot_scores 
                           TRUE                        TRUE 
                 plot_steepness   plot_steepness_regression 
                           TRUE                        TRUE 
                   remove_dyads     repeatability_steepness 
                           TRUE                        TRUE 
                         scores            simple_steep_gen 
                           TRUE                        TRUE 
               steepness_precis            upward_steepness 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-19 03:58:19 UTC |
...
running this report
    ...
    PROCESSX_PS1d452aa0fa4a_1739937493
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqipBua
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EloSteepness_v0.5.0-tikzDictionary"
