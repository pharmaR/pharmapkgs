# Validation Report - dartR.sim@0.70
...
| export_help          | 8                                                |
| has_website          | TRUE                                             |
| has_maintainer       | Jose L. Mijangos <luis.mijangos@gmail.com>       |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/green-striped-gecko/dartR.sim |
...
| 13  | shinyBS              | Imports |
| 14  | shinyjs              | Imports |
| 15  | shinythemes          | Imports |
| 16  | shinyWidgets         | Imports |
| 17  | hierfstat            | Imports |
| 18  | reshape2             | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         gl.diagnostics.sim gl.sim.create_dispersal       gl.sim.emigration 
                       TRUE                    TRUE                    TRUE 
                 gl.sim.ind           gl.sim.mutate        gl.sim.offspring 
                       TRUE                    TRUE                    TRUE 
              gl.sim.WF.run         gl.sim.WF.table 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-17 04:55:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61ce05c1a_1739768097
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXW7Dml
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dartR.sim_v0.70-tikzDictionary"
