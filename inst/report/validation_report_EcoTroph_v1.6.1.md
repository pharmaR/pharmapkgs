# Validation Report - EcoTroph@1.6.1
...
| export_help          | 18                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Jerome Guitton <jerome.guitton@agrocampus-ouest.fr>  |
...
Overall the package has 18 exported objects. 18 are documented:
                       ...
                       a13.eq                 a13.eq.ac               check.table 
                         TRUE                      TRUE                      TRUE 
             convert.list2tab        create.ETdiagnosis             create.ETmain 
                         TRUE                      TRUE                      TRUE 
                create.smooth          CTSA.catch.input                 E_MSY_0.1 
                         TRUE                      TRUE                      TRUE 
                         E0.1                      Emsy              mf.diagnosis 
                         TRUE                      TRUE                      TRUE 
    plot_ETdiagnosis_isopleth        read.ecopath.model                     regPB 
                         TRUE                      TRUE                      TRUE 
                     regPB.ac                saturation                 Transpose 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-19 03:38:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d457f3ef5f3_1739936279
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpP0j9lb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EcoTroph_v1.6.1-tikzDictionary"
