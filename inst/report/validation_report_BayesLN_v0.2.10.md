# Validation Report - BayesLN@0.2.10
...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Aldo Gardini <aldo.gardini2@unibo.it>                |
...
|:----|:----------------------|:----------|
| 1   | optimx                | Imports   |
| 2   | GeneralizedHyperbolic | Imports   |
| 3   | gsl                   | Imports   |
| 4   | coda                  | Imports   |
| 5   | Rcpp (\>= 0.12.17)    | Imports   |
| 6   | MASS                  | Imports   |
| 7   | lme4                  | Imports   |
...
Overall the package has 18 exported objects. 18 are documented:
               ...
               dlSMNG             dSMNG            GH_MGF LN_hier_existence 
                 TRUE              TRUE              TRUE              TRUE 
      LN_hierarchical           LN_Mean        LN_MeanReg          LN_Quant 
                 TRUE              TRUE              TRUE              TRUE 
          LN_QuantReg          meanSMNG            plSMNG             pSMNG 
                 TRUE              TRUE              TRUE              TRUE 
               qlSMNG             qSMNG            rlSMNG             rSMNG 
                 TRUE              TRUE              TRUE              TRUE 
             SMNG_MGF        SMNGmoment 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-15 03:37:22 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd71a09cb_1739590637
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOGf1Yi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesLN_v0.2.10-tikzDictionary"
