# Validation Report - BiostatsUHNplus@1.0.2
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Tyler Pittman <tyler.pittman@uhn.ca>                 |
...
Overall the package has 8 exported objects. 8 are documented:
     ...
     ae_timeline_plot  as_numeric_parse  caterpillar_plot         dsmb_ccru 
                 TRUE              TRUE              TRUE              TRUE 
        nice_mcmcglmm nice_mcmcglmm_icc   redcap_data_out  rm_covsum_nested 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:15:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3be2215_1739592943
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9pqKfx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BiostatsUHNplus_v1.0.2-tikzDictionary"
