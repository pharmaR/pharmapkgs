# Validation Report - epe4md@0.1.4
...
| export_help          | 22                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Gabriel Konzen <gabriel.konzen@epe.gov.br>           |
...
| 12  | tsibble           | Imports |
| 13  | stringr           | Imports |
| 14  | fabletools        | Imports |
| 15  | feasts            | Imports |
| 16  | tibble            | Imports |
| 17  | assertthat        | Imports |
| 18  | forcats           | Imports |
| 19  | future            | Imports |
| 20  | magrittr          | Imports |
| 21  | readr             | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
                     ...
                     epe4md_calcula          epe4md_calibra_curva_s 
                               TRUE                            TRUE 
               epe4md_casos_payback       epe4md_fatores_publicacao 
                               TRUE                            TRUE 
     ...
     epe4md_graf_part_fonte_geracao epe4md_graf_part_fonte_potencia 
          ...
          epe4md_graf_part_segmento            epe4md_graf_pot_acum 
                               TRUE                            TRUE 
              epe4md_graf_pot_anual          epe4md_graf_pot_regiao 
                               TRUE                            TRUE 
           epe4md_graf_pot_segmento            epe4md_investimentos 
                               TRUE                            TRUE 
           epe4md_mercado_potencial                  epe4md_payback 
                               TRUE                            TRUE 
                epe4md_prepara_base           epe4md_proj_adotantes 
                               TRUE                            TRUE 
                epe4md_proj_geracao              epe4md_proj_mensal 
                               TRUE                            TRUE 
               epe4md_proj_potencia      epe4md_sumariza_resultados 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-19 04:14:17 UTC |
...
running this report
    ...
    PROCESSX_PS1d4549932198_1739938451
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFAN5zC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epe4md_v0.1.4-tikzDictionary"
