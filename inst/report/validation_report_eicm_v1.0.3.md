...
| export_help          | 11                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Miguel Porto <mpbertolo@gmail.com>   |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/miguel-porto/eicm |
...
Overall the package has 11 exported objects. 11 are documented:
                      ...
                      as.eicm coefficientComparisonPlot                      eicm 
                         TRUE                      TRUE                      TRUE 
                    eicm.data                  eicm.fit               eicm.matrix 
                         TRUE                      TRUE                      TRUE 
                 eicm.options              generateEICM           interactionPlot 
                         TRUE                      TRUE                      TRUE 
                     isCyclic     plotNetworkFromMatrix 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-19 03:51:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d454a23df82_1739937079
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGQgNly
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eicm_v1.0.3-tikzDictionary"
