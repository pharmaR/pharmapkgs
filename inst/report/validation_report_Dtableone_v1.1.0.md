# Validation Report - Dtableone@1.1.0
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Youngmi Park <02141@snubh.org>                       |
...
|:----|:------------------|:--------|
| 1   | dplyr             | Imports |
| 2   | epiR (\>= 2.0.61) | Imports |
| 3   | irr (\>= 0.84.1)  | Imports |
| 4   | pROC (\>= 1.18.5) | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
             ...
             ci95 CreateTableD2   loadPackage        printp 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 04:54:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4bb4300b_1739854461
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWUmoLw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Dtableone_v1.1.0-tikzDictionary"
