# Validation Report - circlus@0.0.1
...
Overall the package has 8 exported objects. 8 are documented:
            ...
            dpkbd     dspcauchy     FLXMCpkbd FLXMCspcauchy     FLXMRpkbd 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    FLXMRspcauchy         rpkbd     rspcauchy 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-16 04:21:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bc381fe0ec_1739679670
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNnpfo0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_circlus_v0.0.1-tikzDictionary"
