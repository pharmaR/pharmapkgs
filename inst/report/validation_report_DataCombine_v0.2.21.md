# Validation Report - DataCombine@0.2.21
...
| export_help          | 24                                                  |
| has_website          | TRUE                                                |
| has_maintainer       | Christopher Gandrud <christopher.gandrud@gmail.com> |
...
dynsim, E4tools, gesttools, psData, rties

## Namespace

Overall the package has 24 exported objects. 24 are documented:

     CasesTable      change  CountSpell      dMerge      DropNA    FillDown 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
         FillIn    FindDups FindReplace   grepl.sub   InsertRow   MoveFront 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
          NaVar  PercChange    rmExcept       shift     shiftMA       slide 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
        slideMA SpreadDummy    StartEnd  TimeExpand    TimeFill     VarDrop 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 04:56:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6315b5527_1739768204
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpj6RgdO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DataCombine_v0.2.21-tikzDictionary"
