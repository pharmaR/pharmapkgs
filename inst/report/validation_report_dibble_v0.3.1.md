# Validation Report - dibble@0.3.1
...
| export_help          | 19                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Mizuki Uchida <uchidamizuki@vivaldi.net> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/UchidaMizuki/dibble   |
...
Overall the package has 19 exported objects. 19 are documented:
        ...
        apply as_dibble broadcast  colnames      diag    diag<-    dibble dibble_by 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
          eye    filter    ifelse is_dibble      ncol      nrow      ones      pmax 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
         pmin  rownames     zeros 
         TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-18 03:59:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4211ddc44_1739851167
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpALnDsL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dibble_v0.3.1-tikzDictionary"
