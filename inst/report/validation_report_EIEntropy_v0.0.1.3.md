# Validation Report - EIEntropy@0.0.1.3
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Silvia María Franco Anaya <sfrana@unileon.es>        |
...
Overall the package has 4 exported objects. 4 are documented:
       ...
       ei_gce    ei_gme financial    social 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-19 03:51:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d45737bfcea_1739937093
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHrklVn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EIEntropy_v0.0.1.3-tikzDictionary"
