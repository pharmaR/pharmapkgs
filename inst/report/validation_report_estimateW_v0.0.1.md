# Validation Report - estimateW@0.0.1
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tamas Krisztin <krisztin@iiasa.ac.at>                |
...
Overall the package has 19 exported objects. 19 are documented:
           ...
           bbinompdf      beta_priors     beta_sampler          betapdf 
                TRUE             TRUE             TRUE             TRUE 
    logdetAinvUpdate  logdetPaceBarry      normalgamma       rho_priors 
                TRUE             TRUE             TRUE             TRUE 
         rho_sampler              sar             sarw              sdm 
                TRUE             TRUE             TRUE             TRUE 
                sdmw     sigma_priors    sigma_sampler          sim_dgp 
                TRUE             TRUE             TRUE             TRUE 
                slxw         W_priors        W_sampler 
                TRUE             TRUE             TRUE 

### Examples

There are 18 help pages with examples, from 22 (81.82 %).
...
| Execution Time | 2025-02-19 04:32:15 UTC |
...
running this report
    ...
    PROCESSX_PS1d45544f4b5c_1739939529
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkTb4zC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_estimateW_v0.0.1-tikzDictionary"
