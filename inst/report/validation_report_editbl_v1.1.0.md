# Validation Report - editbl@1.1.0
...
| export_help | 12 |
| has_website | TRUE |
| has_maintainer | Jasper Schelfhout <jasper.schelfhout@openanalytics.eu> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/openanalytics/editbl |
...
Overall the package has 12 exported objects. 12 are documented:
               ...
               connectDB         customButton        e_rows_insert 
                    TRUE                 TRUE                 TRUE 
           e_rows_update                  eDT            eDTOutput 
                    TRUE                 TRUE                 TRUE 
              foreignTbl          inputServer              inputUI 
                    TRUE                 TRUE                 TRUE 
              runDemoApp selectInputDT_Server     selectInputDT_UI 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 03:41:53 UTC |
...
running this report
    ...
    PROCESSX_PS1d451a6e28bb_1739936507
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUawS77
...
These are the options set to generate the report:
    ...
    [1] "validation_report_editbl_v1.1.0-tikzDictionary"
