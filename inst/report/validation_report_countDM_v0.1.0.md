# Validation Report - countDM@0.1.0
...
Overall the package has 21 exported objects. 21 are documented:
         ...
         bell_mle data_criminal   data_sbirth        dbellt      dzibellt 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        mle_borel        mle_bt   mle_poisson    mle_zibell   mle_zibellt 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          mle_zip   mle_zoibell      mle_zoip      mle.bell        pbellt 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         pzibellt        qbellt      qzibellt        rbellt      rzibellt 
             TRUE          TRUE          TRUE          TRUE          TRUE 
               TP 
             TRUE 
...
| Execution Time | 2025-02-17 04:04:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66b573668_1739765041
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp65UuST
...
These are the options set to generate the report:
    ...
    [1] "validation_report_countDM_v0.1.0-tikzDictionary"
