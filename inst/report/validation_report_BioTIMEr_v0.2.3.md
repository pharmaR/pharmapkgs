# Validation Report - BioTIMEr@0.2.3
...
| export_help          | 9                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Alban Sagouis <alban.sagouis@idiv.de>  |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/bioTIMEHub/BioTIMEr |
...
Overall the package has 9 exported objects. 9 are documented:
         ...
         getAlphaMetrics       getBetaMetrics getLinearRegressions 
                    TRUE                 TRUE                 TRUE 
                gridding           resampling  scale_color_biotime 
                    TRUE                 TRUE                 TRUE 
    scale_colour_biotime   scale_fill_biotime         themeBioTIME 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:15:59 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd796dee52_1739592954
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjcX5SX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BioTIMEr_v0.2.3-tikzDictionary"
