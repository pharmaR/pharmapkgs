# Validation Report - dirttee@1.0.2
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alexander Seipp <alexander.seipp@uni-oldenburg.de>   |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | expectreg(\>= 0.5.0) | Depends |
| 2   | formula.tools        | Imports |
| 3   | MASS                 | Imports |
| 4   | Matrix               | Imports |
| 5   | mgcv                 | Imports |
| 6   | nloptr               | Imports |
| 7   | provenance           | Imports |
| 8   | rlang                | Imports |
| 9   | splines              | Imports |
| 10  | survival             | Imports |
...
Overall the package has 15 exported objects. 15 are documented:
       ...
       boot.modreg       dasynorm        dgumbel  expectreg.aft  expectreg.ipc 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            modreg modreg.control       pasynorm        pgumbel       qasynorm 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           qgumbel      qureg.aft       rasynorm        rgumbel      weightsKM 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:10:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45e4faebe_1739851831
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSMHC4h
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dirttee_v1.0.2-tikzDictionary"
