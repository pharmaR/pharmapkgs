...
| export_help          | 1                                              |
| has_website          | TRUE                                           |
| has_maintainer       | R. Wayne Oldford <rwoldford@uwaterloo.ca>      |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/great-northern-diver/diver/ |
...
|:----|:----------------------|:--------|
| 1   | cli (\>= 1.1.0)       | Imports |
| 2   | crayon (\>= 1.3.4)    | Imports |
| 3   | rstudioapi (\>= 0.10) | Imports |
| 4   | loon (\>= 1.2.2)      | Imports |
| 5   | loon.data             | Imports |
| 6   | ggmulti               | Imports |
| 7   | loon.ggplot           | Imports |
| 8   | zenplots              | Imports |
| 9   | loon.shiny            | Imports |
| 10  | loon.tourr            | Imports |
| 11  | stats                 | Imports |
...
| Execution Time | 2025-02-18 04:22:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bb422636f9f_1739852558
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7UMPev
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diveR_v0.1.2-tikzDictionary"
