# Validation Report - BayesReversePLLH@1.5
...
Overall the package has 15 exported objects. 15 are documented:
                          ...
                          ApproxMean             BayesPiecewiseHazard 
                                TRUE                             TRUE 
             BayesPiecewiseHazardCOV          BayesPiecewiseHazardTrt 
                                TRUE                             TRUE 
       BayesPiecewiseLinearLogHazard BayesPiecewiseLinearLogHazardCOV 
                                TRUE                             TRUE 
    BayesPiecewiseLinearLogHazardTrt                GetALLHazLogSlope 
                                TRUE                             TRUE 
                      GetALLHazPiece                    GetALLSurvPEH 
                                TRUE                             TRUE 
                      GetALLSurvPLLH              PostMeanHazLogSlope 
                                TRUE                             TRUE 
                    PostMeanHazPiece                  PostMeanSurvPEH 
                                TRUE                             TRUE 
                    PostMeanSurvPLLH 
                                TRUE 
...
| Execution Time | 2025-02-15 03:40:33 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5e699a6_1739590828
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMFkPU1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesReversePLLH_v1.5-tikzDictionary"
