# Validation Report - BinaryEPPM@3.0
...
| export_help          | 29                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | David M. Smith <dmccsmith@verizon.net>               |
...
Overall the package has 29 exported objects. 29 are documented:
                       ...
                       BBprob                BinaryEPPM                    CBprob 
                         TRUE                      TRUE                      TRUE 
              coef.BinaryEPPM cooks.distance.BinaryEPPM                   doubexp 
                         TRUE                      TRUE                      TRUE 
                    doubrecip                  EPPMprob         fitted.BinaryEPPM 
                         TRUE                      TRUE                      TRUE 
                       GBprob      hatvalues.BinaryEPPM               LL.gradient 
                         TRUE                      TRUE                      TRUE 
         LL.Regression.Binary         logLik.BinaryEPPM                    loglog 
                         TRUE                      TRUE                      TRUE 
              Model.BCBinProb              Model.Binary                  Model.GB 
                         TRUE                      TRUE                      TRUE 
                  Model.JMVGB                negcomplog           plot.BinaryEPPM 
                         TRUE                      TRUE                      TRUE 
                   powerlogit        predict.BinaryEPPM          print.BinaryEPPM 
                         TRUE                      TRUE                      TRUE 
      print.summaryBinaryEPPM      residuals.BinaryEPPM        summary.BinaryEPPM 
                         TRUE                      TRUE                      TRUE 
              vcov.BinaryEPPM       waldtest.BinaryEPPM 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-15 04:07:36 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd14cd29d1_1739592451
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNksnHp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BinaryEPPM_v3.0-tikzDictionary"
