# Validation Report - configural@0.1.5
...
Overall the package has 25 exported objects. 24 are documented:
      ...
      .fungible_extrema                 %&%          adjust_Rsq     complete_matrix 
                   TRUE               FALSE                TRUE                TRUE 
         cor_covariance cor_covariance_meta          cor_labels             cpa_mat 
                   TRUE                TRUE                TRUE                TRUE 
             cpa_scores                cvec            fungible       harmonic_mean 
                   TRUE                TRUE                TRUE                TRUE 
         n_effective_R2                rvec          transition       var_error_cpa 
                   TRUE                TRUE                TRUE                TRUE 
                   vech           vech2full               vechs          vechs2full 
                   TRUE                TRUE                TRUE                TRUE 
                 wt_cor              wt_cov             wt_dist             wt_mean 
                   TRUE                TRUE                TRUE                TRUE 
                 wt_var 
                   TRUE 
...
| Execution Time | 2025-02-17 03:42:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61d10d516_1739763772
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSpMMMT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_configural_v0.1.5-tikzDictionary"
