# Validation Report - EIAapi@0.1.2
...
| export_help          | 3                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Rami Krispin <rami.krispin@gmail.com> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/RamiKrispin/EIAapi |
...
| 2   | dplyr (\>= 1.0.9)       | Imports |
| 3   | jsonlite (\>= 1.8.2)    | Imports |
| 4   | lubridate (\>= 1.8.0)   | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    eia_backfill      eia_get eia_metadata 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-19 03:51:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d452965aa5d_1739937066
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwVRY6m
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EIAapi_v0.1.2-tikzDictionary"
