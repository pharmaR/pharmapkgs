# Validation Report - FDboost@1.1.2
...
| has_source_control   | https://github.com/boost-R/FDboost        |
...
Overall the package has 45 exported objects. 41 are documented:

                       %A%                   %A0%                  %Xa0% 
                     FALSE                  FALSE                  FALSE 
                      %Xc%             applyFolds                   bbsc 
                     FALSE                   TRUE                   TRUE 
               bconcurrent                   bfpc                  bhist 
                      TRUE                   TRUE                   TRUE 
                    bhistx                  bolsc            bootstrapCI 
                      TRUE                   TRUE                   TRUE 
                  brandomc                bsignal                    clr 
                      TRUE                   TRUE                   TRUE 
                    cvLong                   cvMa              factorize 
                      TRUE                   TRUE                   TRUE 
                   FDboost             FDboostLSS                 funMRD 
                      TRUE                   TRUE                   TRUE 
                    funMSE                funplot            funRsquared 
                      TRUE                   TRUE                   TRUE 
                getArgvals          getArgvalsLab                  getId 
                      TRUE                   TRUE                   TRUE 
                  getIdLab                getTime             getTimeLab 
                      TRUE                   TRUE                   TRUE 
                      getX                getXLab                hmatrix 
                      TRUE                   TRUE                   TRUE 
        integrationWeights integrationWeightsLeft             is.hmatrix 
                      TRUE                   TRUE                   TRUE 
                 o_control           plotPredCoef          plotPredicted 
                      TRUE                   TRUE                   TRUE 
             plotResiduals           reweightData         subset_hmatrix 
                      TRUE                   TRUE                   TRUE 
              truncateTime        validateFDboost              wide2long 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-27 03:23:01 UTC |
...
running this report
    ...
    PROCESSX_PS1c626ae339a9_1740626577
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppGMevR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FDboost_v1.1.2-tikzDictionary"
