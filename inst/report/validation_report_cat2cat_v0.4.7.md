# Validation Report - cat2cat@0.4.7
...
| export_help          | 11                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Maciej Nasinski <nasinski.maciej@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/Polkas/cat2cat           |
...
Overall the package has 11 exported objects. 11 are documented:
    ...
    cat_apply_freq        cat2cat    cat2cat_agg cat2cat_ml_run      cross_c2c 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         dummy_c2c      get_freqs   get_mappings       plot_c2c      prune_c2c 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       summary_c2c 
              TRUE 
...
| Execution Time | 2025-02-16 03:45:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3c55bdca_1739677543
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpu45K6l
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cat2cat_v0.4.7-tikzDictionary"
