# Validation Report - brulee@0.4.0
...
| export_help          | 16                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Max Kuhn <max@posit.co>              |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/tidymodels/brulee |
...
|:----|:-------------------|:--------|
| 1   | cli                | Imports |
| 2   | coro (\>= 1.0.1)   | Imports |
| 3   | dplyr              | Imports |
| 4   | generics           | Imports |
| 5   | ggplot2            | Imports |
| 6   | glue               | Imports |
| 7   | hardhat            | Imports |
| 8   | rlang (\>= 1.1.1)  | Imports |
| 9   | stats              | Imports |
| 10  | tibble             | Imports |
| 11  | torch (\>= 0.13.0) | Imports |
| 12  | utils              | Imports |
...
Overall the package has 16 exported objects. 15 are documented:
                       ...
                       %>%               autoplot     brulee_activations 
                     FALSE                   TRUE                   TRUE 
         brulee_linear_reg    brulee_logistic_reg             brulee_mlp 
                      TRUE                   TRUE                   TRUE 
      brulee_mlp_two_layer brulee_multinomial_reg                   coef 
                      TRUE                   TRUE                   TRUE 
         matrix_to_dataset        schedule_cyclic    schedule_decay_expo 
                      TRUE                   TRUE                   TRUE 
       schedule_decay_time          schedule_step         set_learn_rate 
                      TRUE                   TRUE                   TRUE 
                   tunable 
                      TRUE 
...
| Execution Time | 2025-02-15 04:47:20 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd29df27fa_1739594835
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpA8BbNV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brulee_v0.4.0-tikzDictionary"
