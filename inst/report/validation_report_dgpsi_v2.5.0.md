...
| export_help          | 30                                  |
| has_website          | TRUE                                |
| has_maintainer       | Deyu Ming <deyu.ming.16@ucl.ac.uk>  |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/mingdeyu/dgpsi-R |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | reticulate (\>= 1.26)   | Imports |
| 2   | benchmarkme (\>= 1.0.8) | Imports |
| 3   | utils                   | Imports |
| 4   | ggplot2                 | Imports |
| 5   | ggforce                 | Imports |
| 6   | reshape2                | Imports |
...
Overall the package has 30 exported objects. 30 are documented:
               ...
               alm        combine       continue    deserialize         design 
              TRUE           TRUE           TRUE           TRUE           TRUE 
               dgp           draw get_thread_num             gp        init_py 
              TRUE           TRUE           TRUE           TRUE           TRUE 
               lgp           mice          nllik           pack          prune 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              read      serialize         set_id        set_imp set_linked_idx 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          set_seed set_thread_num    set_vecchia     trace_plot         unpack 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            update       validate           vigf         window          write 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 03:56:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43cc3e92c_1739851006
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBUNiOD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dgpsi_v2.5.0-tikzDictionary"
