# Validation Report - BTLLasso@0.1.13
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Gunther Schauberger <gunther.schauberger@tum.de>     |
...
|     | package           | type      |
|:----|:------------------|:----------|
| 1   | Rcpp (\>= 0.11.3) | Imports   |
| 2   | stringr           | Imports   |
| 3   | psychotools       | Imports   |
| 4   | Matrix            | Depends   |
| 5   | parallel          | Depends   |
| 6   | Rcpp              | LinkingTo |
...
Overall the package has 6 exported objects. 6 are documented:
        ...
        boot.BTLLasso          BTLLasso     ctrl.BTLLasso       cv.BTLLasso 
                 TRUE              TRUE              TRUE              TRUE 
                paths response.BTLLasso 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:52:36 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5c8623c5_1739595151
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDGB49j
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BTLLasso_v0.1.13-tikzDictionary"
