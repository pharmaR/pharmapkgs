...
| has_source_control   | https://github.com/ikosmidis/brglm                |
...
abn, analogue, BradleyTerry2, brglm2, brlrmr, cnvGSA, enrichwith,
ggeffects, glmvsd, mbrglm, MixedPsy, optmatch, picante

## Namespace

Overall the package has 19 exported objects. 19 are documented:

                     brglm          brglm.control              brglm.fit 
                      TRUE                   TRUE                   TRUE 
        checkModifications          confint.brglm  confint.profile.brglm 
                      TRUE                   TRUE                   TRUE 
                   gethats           glm.control1          modifications 
                      TRUE                   TRUE                   TRUE 
    modifiedScoreStatistic    pairs.profile.brglm      penalizedDeviance 
                      TRUE                   TRUE                   TRUE 
        plot.profile.brglm            print.brglm    print.profile.brglm 
                      TRUE                   TRUE                   TRUE 
       print.summary.brglm          profile.brglm   separation.detection 
                      TRUE                   TRUE                   TRUE 
             summary.brglm 
                      TRUE 
...
| Execution Time | 2025-02-15 04:43:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5220dbab_1739594612
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0EhsG9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brglm_v0.7.2-tikzDictionary"
