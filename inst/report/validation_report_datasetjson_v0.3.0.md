# Validation Report - datasetjson@0.3.0
...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mike Stackhouse <mike.stackhouse@atorusresearch.com> |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | yyjsonr (\>= 0.1.18)     | Imports |
| 2   | jsonvalidate (\>= 1.3.1) | Imports |
| 3   | hms                      | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
               ...
               dataset_json     get_column_metadata       read_dataset_json 
                       TRUE                    TRUE                    TRUE 
          set_dataset_label        set_dataset_name            set_file_oid 
                       TRUE                    TRUE                    TRUE 
               set_item_oid       set_last_modified        set_metadata_ref 
                       TRUE                    TRUE                    TRUE 
       set_metadata_version          set_originator       set_source_system 
                       TRUE                    TRUE                    TRUE 
              set_study_oid set_variable_attributes   validate_dataset_json 
                       TRUE                    TRUE                    TRUE 
         write_dataset_json 
                       TRUE 
...
| Execution Time | 2025-02-17 05:01:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65aa5b3f4_1739768457
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKyRIIg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datasetjson_v0.3.0-tikzDictionary"
