# Validation Report - detpack@1.1.3
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel Meyer <meyerda@ethz.ch>                       |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    det.construct       det.cut        det.de     det.leafs     det.query 
...
| Execution Time | 2025-02-18 03:50:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bb49ba9100_1739850635
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwBtjK0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_detpack_v1.1.3-tikzDictionary"
