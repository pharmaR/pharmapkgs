# Validation Report - DescribeDisplay@0.2.11
...
| export_help          | 9                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Dianne Cook <dicook@monash.edu>          |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/ggobi/DescribeDisplay |
...
|:----|:--------------------|:--------|
| 1   | reshape2            | Imports |
| 2   | ggplot2 (\>= 3.4.1) | Imports |
| 3   | plyr                | Imports |
| 4   | scales              | Imports |
| 5   | grid                | Imports |
| 6   | GGally (\>= 2.1.2)  | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
         ...
         addbrush      axesGrob  axesViewport    dd_example       dd_load 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        geom_axis       range01 removehiddens    zeeThemAll 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 03:46:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bb445eeed79_1739850373
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpmma1Tw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DescribeDisplay_v0.2.11-tikzDictionary"
