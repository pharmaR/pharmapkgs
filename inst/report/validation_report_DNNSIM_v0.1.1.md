# Validation Report - DNNSIM@0.1.1
...
| export_help          | 2                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Qingyang Liu <rh8liuqy@gmail.com>                    |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | reticulate (\>= 1.37.0) | Imports |
| 2   | stats (\>= 4.3.0)       | Imports |
| 3   | Rdpack (\>= 2.6)        | Imports |
...
| Execution Time | 2025-02-18 04:29:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bb410fd5ce_1739852979
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpG4d4F6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DNNSIM_v0.1.1-tikzDictionary"
