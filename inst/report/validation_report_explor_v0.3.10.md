# Validation Report - explor@0.3.10
...
| export_help          | 11                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Julien Barnier <julien.barnier@cnrs.fr> |
...
Overall the package has 11 exported objects. 11 are documented:
        ...
        CA_var_plot          explor           ggind           ggvar      MCA_biplot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       MCA_ind_plot    MCA_var_plot    PCA_ind_plot    PCA_var_plot prepare_results 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      speMCA_varsup 
               TRUE 
...
| Execution Time | 2025-02-19 04:53:09 UTC |
...
running this report
    ...
    PROCESSX_PS1d456e984a48_1739940783
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkzOVHr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_explor_v0.3.10-tikzDictionary"
