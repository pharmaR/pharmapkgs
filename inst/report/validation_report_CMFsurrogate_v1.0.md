# Validation Report - CMFsurrogate@1.0
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Layla Parast <parast@austin.utexas.edu>              |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    gen.bootstrap.weights pte.estimate.multiple                 resam 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:44:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33ab63033_1739681042
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9Qmaua
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CMFsurrogate_v1.0-tikzDictionary"
