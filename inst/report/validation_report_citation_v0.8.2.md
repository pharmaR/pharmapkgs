# Validation Report - citation@0.8.2
...
| export_help          | 11                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Jan Philipp Dietrich <dietrich@pik-potsdam.de> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/pik-piam/citation           |
...
Overall the package has 11 exported objects. 11 are documented:
       ...
       cff2bibentry          cff2md           cff2r      cff2zenodo       cffReport 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       citation_doi citation2zenodo  package2zenodo           r2cff        read_cff 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          scanRepos 
               TRUE 
...
| Execution Time | 2025-02-16 04:23:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3450131ae_1739679777
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppNHfZW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_citation_v0.8.2-tikzDictionary"
