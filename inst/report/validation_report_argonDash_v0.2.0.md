...
| size_codebase        | 525                                     |
| has_source_control   | https://github.com/RinteRface/argonDash |
...
Overall the package has 25 exported objects. 25 are documented:
            ...
            argonAvatar        argonAvatars       argonDashBody     argonDashFooter 
                   TRUE                TRUE                TRUE                TRUE 
       argonDashGallery     argonDashHeader     argonDashNavbar       argonDashPage 
                   TRUE                TRUE                TRUE                TRUE 
       argonDashSidebar        argonDropNav argonDropNavDivider    argonDropNavItem 
                   TRUE                TRUE                TRUE                TRUE 
      argonDropNavTitle     argonFooterItem     argonFooterMenu       argonInfoCard 
                   TRUE                TRUE                TRUE                TRUE 
    argonSidebarDivider  argonSidebarHeader    argonSidebarItem    argonSidebarMenu 
                   TRUE                TRUE                TRUE                TRUE 
           argonTabItem       argonTabItems          argonTable      argonTableItem 
                   TRUE                TRUE                TRUE                TRUE 
        argonTableItems 
                   TRUE 
...
| Execution Time | 2025-02-14 07:23:11 UTC |
...
running this report
    ...
    PROCESSX_PS1c095c9362f7_1739517789
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaTljLY
