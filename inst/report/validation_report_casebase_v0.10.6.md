# Validation Report - casebase@0.10.6
...
| export_help          | 11                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Sahir Bhatnagar <sahir.bhatnagar@gmail.com> |
...
Overall the package has 10 exported objects. 11 are documented:

               absoluteRisk   absoluteRisk.CompRisk checkArgsEventIndicator 
                       TRUE                    TRUE                    TRUE 
         checkArgsTimeEvent         fitSmoothHazard     fitSmoothHazard.fit 
                       TRUE                    TRUE                    TRUE 
                 hazardPlot                 popTime                prepareX 
                       TRUE                    TRUE                    TRUE 
             sampleCaseBase 
                       TRUE 
...
| Execution Time | 2025-02-16 03:44:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bc352f77bac_1739677473
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWASZTI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_casebase_v0.10.6-tikzDictionary"
