# Validation Report - beyondWhittle@1.3.0
...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Renate Meyer <renate.meyer@auckland.ac.nz>           |
...
Overall the package has 21 exported objects. 21 are documented:
               ...
               bayes_factor  bdp_dw_bayes_factor_k1   bdp_dw_est_post_stats 
                       TRUE                    TRUE                    TRUE 
     bdp_dw_mcmc_params_gen bdp_dw_prior_params_gen            fourier_freq 
                       TRUE                    TRUE                    TRUE 
                   gibbs_ar            gibbs_bdp_dw                gibbs_np 
                       TRUE                    TRUE                    TRUE 
                  gibbs_npc               gibbs_var               gibbs_vnp 
                       TRUE                    TRUE                    TRUE 
     local_moving_FT_zigzag              pacf_to_ar                psd_arma 
                       TRUE                    TRUE                    TRUE 
               psd_tvarma12               psd_varma                 rmvnorm 
                       TRUE                    TRUE                    TRUE 
              scree_type_ar            sim_tvarma12               sim_varma 
                       TRUE                    TRUE                    TRUE 

### Examples

There are 126 help pages with examples, from 126 (100.00 %).
...
| Execution Time | 2025-02-15 03:57:03 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1b1646ce_1739591818
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqFNn9H
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beyondWhittle_v1.3.0-tikzDictionary"
