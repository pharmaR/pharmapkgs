# Validation Report - distrTEst@2.8.3
...
distrDoc, distrEllipse

## Namespace

Overall the package has 3 exported objects. 12 are documented:

      distrTEstoptions     EvaluationList getdistrTEstOption 
                  TRUE               TRUE               TRUE 

### Examples

There are 4 help pages with examples, from 17 (23.53 %).
...
| Execution Time | 2025-02-18 04:21:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46db4127a_1739852490
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpU9H1eB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distrTEst_v2.8.3-tikzDictionary"
