# Validation Report - epanetReader@0.7.3
...
| has_source_control   | https://github.com/bradleyjeck/epanetReader          |
...
Overall the package has 19 exported objects. 19 are documented:
    ...
    epanetDefaultOptions    expandedLinkTable        is.epanet.inp 
                    TRUE                 TRUE                 TRUE 
           is.epanet.rpt     is.epanetmsx.rpt is.expandedLinkTable 
                    TRUE                 TRUE                 TRUE 
            is.sparkline    is.sparklineTable   plotElementsLegend 
                    TRUE                 TRUE                 TRUE 
            plotInpLinks         plotInpNodes   plotSparklineTable 
                    TRUE                 TRUE                 TRUE 
      read_lines_wrapper             read.inp          read.msxrpt 
                    TRUE                 TRUE                 TRUE 
                read.rpt            sparkline       sparklineTable 
                    TRUE                 TRUE                 TRUE 
               write.inp 
                    TRUE 
...
| Execution Time | 2025-02-19 04:13:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d457a7c249c_1739938430
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpttQJoS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epanetReader_v0.7.3-tikzDictionary"
