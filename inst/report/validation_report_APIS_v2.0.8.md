...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Julien Roche <julien.roche@inrae.fr>                 |
...
Overall the package has 10 exported objects. 10 are documented:
               ...
               APIS_2n            APIS_3n   assignment_power    import_from_ped 
                  TRUE               TRUE               TRUE               TRUE 
       import_from_vcf    launch_APIShiny         plot_delta    plot_mismatches 
                  TRUE               TRUE               TRUE               TRUE 
    plot_probabilities simulate_offspring 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-14 07:18:08 UTC |
...
running this report
    ...
    PROCESSX_PS1c09956768_1739517485
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpY9RlnN
