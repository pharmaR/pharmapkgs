# Validation Report - confinterpret@1.0.0
...
| export_help          | 12                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Jim Vine <code@jimvine.co.uk>            |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/jimvine/confinterpret |
...
Overall the package has 12 exported objects. 12 are documented:
                      ...
                      confinterpret           interpret_equivalence 
                               TRUE                            TRUE 
           interpret_noninferiority           interpret_superiority 
                               TRUE                            TRUE 
              interpretation_result              interpretation_set 
                               TRUE                            TRUE 
        interpretations_equivalence  interpretations_noninferiority 
                               TRUE                            TRUE 
        interpretations_superiority plot_interpretation_result_list 
                               TRUE                            TRUE 
     validate_interpretation_result     validate_interpretation_set 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-17 03:43:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bd640c8c8d0_1739763778
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcgCoMy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_confinterpret_v1.0.0-tikzDictionary"
