...
| export_help          | 27                                 |
| has_website          | TRUE                               |
| has_maintainer       | Zachary Neal <zpneal@msu.edu>      |
| bugs_status          | 0.9666667                          |
| size_codebase        | 1349                               |
| has_source_control   | https://github.com/zpneal/backbone |
...
Overall the package has 27 exported objects. 27 are documented:
                ...
                backbone.extract             backbone.suggest 
                            TRUE                         TRUE 
                            bicm                    disparity 
                            TRUE                         TRUE 
                        fastball                         fdsm 
                        ...
                        fixedrow                       global 
                            ...
                            TRUE                         TRUE 
                              pb                         sdsm 
                            TRUE                         TRUE 
                        sparsify      sparsify.with.geometric 
                            TRUE                         TRUE 
             sparsify.with.gspar sparsify.with.hypergeometric 
                            TRUE                         TRUE 
           sparsify.with.jaccard    sparsify.with.localdegree 
                            TRUE                         TRUE 
             sparsify.with.lspar        sparsify.with.meetmin 
                            TRUE                         TRUE 
     sparsify.with.quadrilateral      sparsify.with.simmelian 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-14 07:39:11 UTC |
...
running this report
    ...
    PROCESSX_PS1c096e663845_1739518748
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7UshBB
