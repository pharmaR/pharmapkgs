# Validation Report - cellKey@1.0.2
...
| export_help          | 10                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Bernhard Meindl <bernhard.meindl@statistik.gv.at> |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/sdcTools/cellKey               |
...
|:----|:----------------------------|:--------|
| 1   | R(\>= 4.1)                  | Depends |
| 2   | sdcHierarchies (\>= 0.19.3) | Depends |
| 3   | data.table                  | Depends |
| 4   | rlang                       | Imports |
| 5   | methods                     | Imports |
| 6   | digest (\>= 0.6.23)         | Imports |
| 7   | sdcTable (\>= 0.32.2)       | Imports |
| 8   | ptable (\>= 1.0.0)          | Imports |
| 9   | cli                         | Imports |
| 10  | utils                       | Imports |
| 11  | yaml                        | Imports |
| 12  | parallel                    | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       ck_cnt_measures ck_create_testdata      ck_flexparams  ck_generate_rkeys 
                  TRUE               TRUE               TRUE               TRUE 
        ck_params_cnts     ck_params_nums       ck_read_yaml           ck_setup 
                  TRUE               TRUE               TRUE               TRUE 
       ck_simpleparams        ck_vignette 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-16 03:58:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bc38d098b2_1739678311
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXTOfDK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cellKey_v1.0.2-tikzDictionary"
