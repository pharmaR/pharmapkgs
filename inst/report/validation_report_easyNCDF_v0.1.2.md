# Validation Report - easyNCDF@0.1.2
...
| export_help | 6 |
| has_website | TRUE |
| has_maintainer | An-Chi Ho <an.ho@bsc.es> |
...
Overall the package has 6 exported objects. 6 are documented:
         ...
         ArrayToNc        NcClose         NcOpen     NcReadDims NcReadVarNames 
...
| Execution Time | 2025-02-18 05:11:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bb460fdff52_1739855510
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppUYrk2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easyNCDF_v0.1.2-tikzDictionary"
