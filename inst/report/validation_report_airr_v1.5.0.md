...
| export_help          | 23                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Jason Vander Heiden <jason.vanderheiden@gmail.com> |
...
Overall the package has 20 exported objects. 20 are documented:
                ...
                AIRRSchema        AlignmentSchema         DataFileSchema 
                      TRUE                   TRUE                   TRUE 
         GenotypeSetSchema      GermlineSetSchema             InfoSchema 
                      TRUE                   TRUE                   TRUE 
               load_schema              read_airr         read_alignment 
                      TRUE                   TRUE                   TRUE 
        read_rearrangement           read_tabular    RearrangementSchema 
                      TRUE                   TRUE                   TRUE 
          RepertoireSchema          validate_airr validate_rearrangement 
                      TRUE                   TRUE                   TRUE 
          validate_tabular             write_airr        write_alignment 
                      TRUE                   TRUE                   TRUE 
       write_rearrangement          write_tabular 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-14 06:46:19 UTC |
...
running this report
    ...
    PROCESSX_PS726d54c70295_1739515576
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmphs1kHf
