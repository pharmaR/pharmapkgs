# Validation Report - ciphertext@0.1.1
...
| export_help          | 13                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Luigi Annicchiarico <luigi.annic@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/Luigi-Annic/ciphertext   |
...
Overall the package has 13 exported objects. 13 are documented:
                 ...
                 affine              atbash    bifid_delastelle              caesar 
                   TRUE                TRUE                TRUE                TRUE 
             nullcipher            playfair            polybius           railfence 
                   TRUE                TRUE                TRUE                TRUE 
                scytale simple_substitution        singlecolumn   trifid_delastelle 
                   TRUE                TRUE                TRUE                TRUE 
               vigenere 
                   TRUE 
...
| Execution Time | 2025-02-16 04:20:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3a520d48_1739679602
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvTmsd1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ciphertext_v0.1.1-tikzDictionary"
