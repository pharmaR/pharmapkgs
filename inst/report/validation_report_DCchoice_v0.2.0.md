# Validation Report - DCchoice@0.2.0
...
| export_help          | 15                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Hideo Aizaki <azk-r@spa.nifty.com>                   |
...
marginaleffects, RcmdrPlugin.DCCV

## Namespace

Overall the package has 15 exported objects. 15 are documented:

           bootCI         ct2df      dbchoice       dbspike  dccvResponse 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             krCI      kristrom    oohbchoice     oohbspike      sbchoice 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          sbspike     spikeCoef   turnbull.db turnbull.oohb   turnbull.sb 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 05:09:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6465861de_1739768944
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2FXf2W
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DCchoice_v0.2.0-tikzDictionary"
