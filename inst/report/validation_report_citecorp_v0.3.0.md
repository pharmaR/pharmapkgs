# Validation Report - citecorp@0.3.0
...
| has_source_control   | https://github.com/ropenscilabs/citecorp (devel) |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | crul (\>= 0.7.0)    | Imports |
| 2   | data.table          | Imports |
| 3   | fauxpas (\>= 0.5.0) | Imports |
| 4   | jsonlite            | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    oc_coci_citation    oc_coci_cites     oc_coci_meta     oc_coci_refs 
                TRUE             TRUE             TRUE             TRUE 
          oc_doi2ids  oc_lookup_check     oc_pmcid2ids      oc_pmid2ids 
                TRUE             TRUE             TRUE             TRUE 

### Examples

There are 3 help pages with examples, from 6 (50.00 %).
...
| Execution Time | 2025-02-16 04:23:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3467f1c78_1739679788
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSaAXDi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_citecorp_v0.3.0-tikzDictionary"
