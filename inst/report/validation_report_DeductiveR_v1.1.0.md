# Validation Report - DeductiveR@1.1.0
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Alonso Arriagada <alonso.arriagada@usach.cl>         |
...
Overall the package has 5 exported objects. 5 are documented:
            ...
            DR DR_boxplot    DR_plot   DR_stats     DR_SVC 
...
| Execution Time | 2025-02-18 03:34:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4219c9f1a_1739849649
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpM4CMHw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DeductiveR_v1.1.0-tikzDictionary"
