...
| size_codebase        | 973                                          |
| has_source_control   | https://github.com/jacobkap/asciiSetupReader |
...
Overall the package has 6 exported objects. 6 are documented:
            ...
            make_sps_setup            parse_setup       read_ascii_setup 
                      TRUE                   TRUE                   TRUE 
    read_ascii_setup_addin       sas_ascii_reader      spss_ascii_reader 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-14 07:26:41 UTC |
...
running this report
    ...
    PROCESSX_PS1c09396eb245_1739517998
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQiTRib
