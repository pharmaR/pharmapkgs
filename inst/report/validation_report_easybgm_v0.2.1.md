# Validation Report - easybgm@0.2.1
...
| export_help          | 10                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Karoline Huth <k.huth@uva.nl>           |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/KarolineHuth/easybgm |
...
| 1   | BDgraph          | Imports |
| 2   | BGGM             | Imports |
| 3   | bgms (\>= 0.1.3) | Imports |
| 4   | dplyr            | Imports |
| 5   | ggplot2          | Imports |
| 6   | HDInterval       | Imports |
| 7   | igraph           | Imports |
| 8   | qgraph           | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
                          ...
                          easybgm               plot_centrality 
                             TRUE                          TRUE 
    plot_complexity_probabilities             plot_edgeevidence 
                             TRUE                          TRUE 
                     plot_network             plot_parameterHDI 
                             TRUE                          TRUE 
           plot_prior_sensitivity                plot_structure 
                             TRUE                          TRUE 
     plot_structure_probabilities               sparse_or_dense 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-18 05:10:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47fa87fe7_1739855434
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTqzT6L
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easybgm_v0.2.1-tikzDictionary"
