# Validation Report - ecocbo@0.12.0
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Arturo Sanchez-Porras <sp.arturo@gmail.com>          |
...
Overall the package has 12 exported objects. 12 are documented:
            ...
            balanced_sampling        balanced_sampling2          permanova_oneway 
                         TRUE                      TRUE                      TRUE 
             permanova_twoway                plot_power                 prep_data 
                         TRUE                      TRUE                      TRUE 
    prep_data_nestedsymmetric          prep_data_single                  scompvar 
                         TRUE                      TRUE                      TRUE 
                     sim_beta                   sim_cbo                        SS 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-19 03:33:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d45453f9169_1739936006
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNqZbK6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecocbo_v0.12.0-tikzDictionary"
