# Validation Report - cleaner@1.5.5
...
| has_source_control   | https://github.com/msberends/cleaner      |
...
Overall the package has 28 exported objects. 28 are documented:
         ...
         as.currency    as.percentage            clean  clean_character 
                TRUE             TRUE             TRUE             TRUE 
      clean_currency       clean_Date     clean_double     clean_factor 
                TRUE             TRUE             TRUE             TRUE 
       clean_integer    clean_logical    clean_numeric clean_percentage 
                TRUE             TRUE             TRUE             TRUE 
       clean_POSIXct  format_datetime     format_names   format_p_value 
                TRUE             TRUE             TRUE             TRUE 
                freq     freq.default           header      is.currency 
                TRUE             TRUE             TRUE             TRUE 
             is.freq    is.percentage       na_replace       percentage 
                TRUE             TRUE             TRUE             TRUE 
               rdate      regex_false       regex_true         top_freq 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:28:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bc365b8e190_1739680089
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpM70dfz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cleaner_v1.5.5-tikzDictionary"
