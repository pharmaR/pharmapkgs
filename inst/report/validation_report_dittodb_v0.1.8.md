# Validation Report - dittodb@0.1.8
...
| has_source_control   | https://github.com/ropensci/dittodb |
...
Overall the package has 31 exported objects. 31 are documented:
                ...
                .db_mock_paths               .dittodb_env 
                          TRUE                       TRUE 
           capture_db_requests              check_db_path 
                          TRUE                       TRUE 
                 check_for_pkg            clean_statement 
                          TRUE                       TRUE 
                 db_mock_paths           db_path_sanitize 
                          TRUE                       TRUE 
                 dbMockConnect        dittodb_debug_level 
                          TRUE                       TRUE 
                    expect_sql                 get_dbname 
                          TRUE                       TRUE 
                  get_redactor                   get_type 
                          TRUE                       TRUE 
                          hash             hash_db_object 
                          TRUE                       TRUE 
                     make_path          nycflights_sqlite 
                          TRUE                       TRUE 
       nycflights13_create_sql nycflights13_create_sqlite 
                          TRUE                       TRUE 
                redact_columns          sanitize_table_id 
                          TRUE                       TRUE 
               serialize_bit64    set_dittodb_debug_level 
                          TRUE                       TRUE 
            start_db_capturing              start_mock_db 
                          TRUE                       TRUE 
             stop_db_capturing               stop_mock_db 
                          TRUE                       TRUE 
                   use_dittodb               with_mock_db 
                          TRUE                       TRUE 
                with_mock_path 
                          TRUE 
...
| Execution Time | 2025-02-18 04:21:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4550215c3_1739852510
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWD9KFd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dittodb_v0.1.8-tikzDictionary"
