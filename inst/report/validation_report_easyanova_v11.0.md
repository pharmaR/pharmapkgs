# Validation Report - easyanova@11.0
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Emmanuel Arnhold <emmanuelarnhold@yahoo.com.br>      |
...
Overall the package has 11 exported objects. 11 are documented:
         ...
         box.plot           ea1           ea2            ec            ic 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          ic.plot        m.plot    means.plot means.plotfat        p.plot 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              tab 
             TRUE 
...
| Execution Time | 2025-02-18 05:10:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bb441eebf48_1739855427
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoVwPqm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easyanova_v11.0-tikzDictionary"
