...
| export_help          | 37                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Karsten Tabelow <tabelow@wias-berlin.de>             |
...
Overall the package has 37 exported objects. 37 are documented:
    ...
    adimpro.options    adjust.image        awsaniso        awsimage       awspimage 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             awsraw      clip.image         combine     develop.raw           edges 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      extract.image    extract.info      extract.ni         hsi2rgb      imganiso2D 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         make.image     mask.create    plot.adimpro      read.image        read.raw 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           rgb2grey         rgb2hsi         rgb2xyz         rgb2yiq         rgb2yuv 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             rimage  rimage.options    rotate.image         segment      show.image 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       shrink.image summary.adimpro     write.image       write.raw         xyz2rgb 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            yiq2rgb         yuv2rgb 
               TRUE            TRUE 
...
| Execution Time | 2025-02-14 06:37:37 UTC |
...
running this report
    ...
    PROCESSX_PS726d323cf0fa_1739515055
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpW3gWtS
