# Validation Report - dendroextras@0.2.3
...
biplotbootGUI, multibiplotGUI, nat.nblast

## Namespace

Overall the package has 7 exported objects. 7 are documented:

      color_clusters  colour_clusters         labels<-     leaf_colours 
                TRUE             TRUE             TRUE             TRUE 
     set_leaf_colors set_leaf_colours            slice 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 03:40:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bb431a048e9_1739850051
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLBpXFC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dendroextras_v0.2.3-tikzDictionary"
