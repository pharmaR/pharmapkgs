...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yao Geng <gengyao0103521@qq.com>                     |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    Autoplotprotein    conservation            data     domain_data     length_data 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         plotdomain  plotmutagensis        plotsite       site_data 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 07:34:17 UTC |
...
running this report
    ...
    PROCESSX_PS1c0976e9026_1739518454
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpzpe6oC
