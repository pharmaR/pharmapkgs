...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Pierre Lefeuvre <pierre.lefeuvre@cirad.fr>           |
...
Overall the package has 15 exported objects. 15 are documented:
         ...
         circular_tree        plot.jplace        plot.pplace   pplace_to_matrix 
                  TRUE               TRUE               TRUE               TRUE 
       pplace_to_table pplace_to_taxonomy       print.jplace       print.pplace 
                  TRUE               TRUE               TRUE               TRUE 
          print.protdb        read_jplace        read_protdb        read_sqlite 
                  TRUE               TRUE               TRUE               TRUE 
                refpkg         sub_pplace       write_jplace 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:36:08 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3d9c69b9_1739594162
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpp2PGCj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BoSSA_v3.7-tikzDictionary"
