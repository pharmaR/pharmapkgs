...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yaoxiang Li <yl814@georgetown.edu>                   |
...
|:----|:--------------------------|:----------|
| 1   | R(\>= 3.1.0)              | Depends   |
| 2   | methods (\>= 3.5.1)       | Imports   |
| 3   | mcmcse (\>= 1.3-2)        | Imports   |
| 4   | pgmm (\>= 1.2.3)          | Imports   |
| 5   | mvtnorm (\>= 1.0-10)      | Imports   |
| 6   | MASS (\>= 7.3-51.1)       | Imports   |
| 7   | Rcpp (\>= 1.0.1)          | Imports   |
| 8   | gtools (\>= 3.8.1)        | Imports   |
| 9   | label.switching (\>= 1.8) | Imports   |
| 10  | fabMix (\>= 5.0)          | Imports   |
| 11  | mclust (\>= 5.4.3)        | Imports   |
| 12  | Rcpp                      | LinkingTo |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    CalculateProposalLambda    CalculateProposalPsy  EvaluateProposalLambda 
                       TRUE                    TRUE                    TRUE 
        generatePriorLambda        generatePriorPsi     generatePriorThetaY 
                       TRUE                    TRUE                    TRUE 
                 pgmmRJMCMC          stayMCMCupdate     summerizePgmmRJMCMC 
                       TRUE                    TRUE                    TRUE 
              toEthetaYlist 
                       TRUE 
...
| Execution Time | 2025-02-15 04:38:35 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd52e1acb7_1739594310
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbEpljW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bpgmm_v1.0.9-tikzDictionary"
