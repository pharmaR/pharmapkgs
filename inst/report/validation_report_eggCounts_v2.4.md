# Validation Report - eggCounts@2.4
...
| export_help          | 12                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Craig Wang <craigwang247@gmail.com>                  |
...
| 1   | methods                   | Imports   |
| 2   | utils                     | Imports   |
| 3   | rstan (\>= 2.26)          | Imports   |
| 4   | rstantools (\>= 2.3.1)    | Imports   |
| 5   | boot                      | Imports   |
| 6   | coda                      | Imports   |
| 7   | numbers                   | Imports   |
| 8   | lattice                   | Imports   |
| 9   | rootSolve                 | Imports   |
| 10  | Rcpp (\>= 0.12.0)         | Depends   |
| 11  | rstan (\>= 2.26)          | LinkingTo |
| 12  | Rcpp (\>= 1.0.7)          | LinkingTo |
| 13  | BH (\>= 1.75.0)           | LinkingTo |
| 14  | StanHeaders (\>= 2.26.0)  | LinkingTo |
| 15  | RcppEigen (\>= 0.3.3.9.1) | LinkingTo |
| 16  | RcppParallel (\>= 5.1.4)  | LinkingTo |
...
Overall the package has 12 exported objects. 12 are documented:
           ...
           fec_stan      fecr_probs       fecr_stan  fecr_stanExtra fecr_stanSimple 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            fecrtCI  getPrior_delta     getPrior_mu      plotCounts       simData1s 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          simData2s       stan2mcmc 
               TRUE            TRUE 
...
| Execution Time | 2025-02-19 03:48:50 UTC |
...
running this report
    ...
    PROCESSX_PS1d45c460531_1739936924
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXoDL18
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eggCounts_v2.4-tikzDictionary"
