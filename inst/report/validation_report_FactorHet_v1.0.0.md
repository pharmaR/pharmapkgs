# Validation Report - FactorHet@1.0.0
...
| export_help          | 22                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Max Goplerud <mgoplerud@austin.utexas.edu> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/mgoplerud/FactorHet     |
...
|:----|:--------------------------|:----------|
| 1   | Rcpp                      | LinkingTo |
| 2   | RcppEigen (\>= 0.3.3.4.0) | LinkingTo |
| 3   | Rcpp (\>= 1.0.1)          | Imports   |
| 4   | Matrix                    | Imports   |
| 5   | ggplot2                   | Imports   |
| 6   | ParamHelpers              | Imports   |
| 7   | mlr                       | Imports   |
| 8   | mlrMBO                    | Imports   |
| 9   | smoof                     | Imports   |
| 10  | lbfgs                     | Imports   |
...
Overall the package has 22 exported objects. 22 are documented:
                        ...
                        ACE                     AME                    AMIE 
                       TRUE                    TRUE                    TRUE 
                cjoint_plot                diff_AME               FactorHet 
                       TRUE                    TRUE                    TRUE 
          FactorHet_control          FactorHet_init           FactorHet_mbo 
                       TRUE                    TRUE                    TRUE 
      FactorHet_mbo_control         FactorHet_refit       HTE_by_individual 
                       TRUE                    TRUE                    TRUE 
           HTE_by_moderator              manual_AME      margeff_moderators 
                       TRUE                    TRUE                    TRUE 
               marginal_ACE            marginal_AME           marginal_AMIE 
                       TRUE                    TRUE                    TRUE 
              moderator_AME posterior_by_moderators     posterior_FactorHet 
                       TRUE                    TRUE                    TRUE 
              visualize_MBO 
                       TRUE 
...
| Execution Time | 2025-02-19 05:05:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d45563672a8_1739941526
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprgB4Iy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FactorHet_v1.0.0-tikzDictionary"
