# Validation Report - callsync@0.2.3
...
| export_help          | 22                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Simeon Q. Smeele <simeonqs@hotmail.com> |
| bugs_status          | 1                                       |
| has_source_control   | https://github.com/simeonqs/callsync    |
...
| 2   | oce (\>= 1.7)       | Imports |
| 3   | seewave (\>= 2.2.0) | Imports |
| 4   | signal (\>= 0.7)    | Imports |
| 5   | stringr (\>= 1.4.1) | Imports |
| 6   | tuneR (\>= 1.4.0)   | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
                             ...
                             align                 better.spectro 
                              TRUE                           TRUE 
                           calc.am                        calc.fm 
                              TRUE                           TRUE 
                         calc.perf                    call.assign 
                              TRUE                           TRUE 
                       call.detect           call.detect.multiple 
                              TRUE                           TRUE 
                create.spec.object              detect.and.assign 
                              TRUE                           TRUE 
                 export.detections           load.selection.table 
                              TRUE                           TRUE 
             load.selection.tables load.selection.tables.audacity 
                              TRUE                           TRUE 
                         load.wave                  measure.trace 
                              TRUE                           TRUE 
            measure.trace.multiple                         o.to.m 
                              TRUE                           TRUE 
                          run.spcc                      simple.cc 
                              TRUE                           TRUE 
          sliding.pixel.comparison                     trace.fund 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-16 03:35:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bc316f8c244_1739676953
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpClFc9x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_callsync_v0.2.3-tikzDictionary"
