# Validation Report - BivRegBLS@1.1.1
...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Bernard G Francq <BivRegBLS@gmail.com>               |
...
Overall the package has 20 exported objects. 20 are documented:
       ...
       antilog.pred             BLS         BLS.fit          BLS.ht            CBLS 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           CBLS.fit       desc.stat           df.WS              DR      FullCIs.MD 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         FullCIs.XY GraphFullCIs.MD GraphFullCIs.XY         lambdas  MD.horiz.lines 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            MD.plot            OLSh            OLSv        raw.plot         XY.plot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:19:45 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd794cc360_1739593180
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3qNrF3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BivRegBLS_v1.1.1-tikzDictionary"
