# Validation Report - calmate@0.13.0
...
| bugs_status          | 0.75                                        |
| has_source_control   | https://github.com/HenrikBengtsson/calmate/ |
...
| 3   | utils                    | Imports |
| 4   | MASS                     | Imports |
| 5   | R.methodsS3 (\>= 1.8.1)  | Imports |
| 6   | R.oo (\>= 1.24.0)        | Imports |
| 7   | matrixStats (\>= 0.61.0) | Imports |
| 8   | R.filesets (\>= 2.14.0)  | Imports |
...
| Execution Time | 2025-02-16 03:36:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36ea93dba_1739676959
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcS0nT8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_calmate_v0.13.0-tikzDictionary"
