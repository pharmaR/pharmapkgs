# Validation Report - clogitboost@1.1
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Haolun Shi <shl2003@connect.hku.hk>                  |
...
Overall the package has 5 exported objects. 5 are documented:
            ...
            clogitboost            marginal    plot.clogitboost predict.clogitboost 
                   TRUE                TRUE                TRUE                TRUE 
    summary.clogitboost 
                   TRUE 
...
| Execution Time | 2025-02-16 04:34:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3774b184a_1739680472
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpj6Bkbc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clogitboost_v1.1-tikzDictionary"
