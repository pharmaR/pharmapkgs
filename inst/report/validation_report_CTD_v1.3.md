...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Varduhi Petrosyan <varduhi.petrosyan@bcm.edu>        |
...
Overall the package has 18 exported objects. 18 are documented:
            ...
            data.combineData          data.imputeData   data.surrogateProfiles 
                        TRUE                     TRUE                     TRUE 
             data.zscoreData       graph.connectToExt          graph.diffuseP1 
                        TRUE                     TRUE                     TRUE 
     graph.diffusionSnapShot       graph.naivePruning    graph.netWalkSnapShot 
                        TRUE                     TRUE                     TRUE 
       mle.getEncodingLength     mle.getMinPtDistance           mle.getPtBSbyK 
                        TRUE                     TRUE                     TRUE 
               mle.getPtDist   multiNode.getNodeRanks singleNode.getNodeRanksN 
                        TRUE                     TRUE                     TRUE 
        stat.entropyFunction       stat.fishersMethod           stat.getDirSim 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-17 04:33:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61dbba137_1739766804
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCu8SPc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CTD_v1.3-tikzDictionary"
