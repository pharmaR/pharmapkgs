# Validation Report - dejaVu@0.3.1
...
Overall the package has 18 exported objects. 18 are documented:
             ...
             ConstantRateDrop            copy_reference CreateNewDropoutMechanism 
                         TRUE                      TRUE                      TRUE 
     CreateNewImputeMechanism            CreateScenario          expandEventCount 
                         TRUE                      TRUE                      TRUE 
              extract_results         GetImputedDataSet                 ImportSim 
                         TRUE                      TRUE                      TRUE 
                       Impute      LinearRateChangeDrop              MakeDejaData 
                         TRUE                      TRUE                      TRUE 
               numberSubjects                    Simfit          SimulateComplete 
                         TRUE                      TRUE                      TRUE 
              SimulateDropout            subjectsPerArm              weighted_j2r 
                         TRUE                      TRUE                      TRUE 

### Examples

There are 21 help pages with examples, from 31 (67.74 %).
...
| Execution Time | 2025-02-18 03:37:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bb440b778f5_1739849872
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHhzgLa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dejaVu_v0.3.1-tikzDictionary"
