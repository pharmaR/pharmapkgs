# Validation Report - chunkR@1.1.1
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Leandro Roser <learoser@gmail.com>                   |
...
Overall the package has 3 exported objects. 8 are documented:

         chunker chunkR_devel    matrix2df 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:17:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bc347f79a1d_1739679439
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpeq97Dw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chunkR_v1.1.1-tikzDictionary"
