# Validation Report - codacore@0.0.4
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Elliott Gordon-Rodriguez <eg2912@columbia.edu>       |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | tensorflow (\>= 2.1) | Imports |
| 2   | keras (\>= 2.3)      | Imports |
| 3   | pROC (\>= 1.17)      | Imports |
| 4   | R6 (\>= 2.5)         | Imports |
| 5   | gtools(\>= 3.8)      | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
    ...
    activeInputs.codacore              codacore   getBinaryPartitions 
                     TRUE                  TRUE                  TRUE 
      getDenominatorParts          getLogRatios     getNumeratorParts 
                     TRUE                  TRUE                  TRUE 
          getNumLogRatios             getSlopes          getTidyTable 
                     TRUE                  TRUE                  TRUE 
                  plotROC           simulateHTS 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:50:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3545daef6_1739681426
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp88wZIP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_codacore_v0.0.4-tikzDictionary"
