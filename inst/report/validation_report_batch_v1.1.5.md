...
Overall the package has 9 exported objects. 9 are documented:
            ...
            mergeCsv           msplit parseCommandArgs           rbatch 
                TRUE             TRUE             TRUE             TRUE 
      rbatch.default     rbatch.local rbatch.local.run       rbatch.lsf 
                TRUE             TRUE             TRUE             TRUE 
        rbatch.mosix 
                TRUE 
...
| Execution Time | 2025-02-15 03:29:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2f0a5405_1739590173
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpsm21p8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_batch_v1.1.5-tikzDictionary"
