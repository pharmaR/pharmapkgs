# Validation Report - dGAselID@1.2
...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Nicolae Teodor Melita <nt_melita@yahoo.com>          |
...
|:----|:-------------|:--------|
| 1   | Biobase      | Depends |
| 2   | MLInterfaces | Depends |
| 3   | genefilter   | Imports |
| 4   | ALL          | Imports |
| 5   | grDevices    | Imports |
| 6   | graphics     | Imports |
| 7   | stats        | Imports |
...
Overall the package has 18 exported objects. 18 are documented:
             ...
             AnalyzeResults               Crossover                dGAselID 
                       TRUE                    TRUE                    TRUE 
                    Elitism      EmbryonicSelection      EvaluationFunction 
                       TRUE                    TRUE                    TRUE 
         frameShiftMutation             Individuals       InitialPopulation 
                       TRUE                    TRUE                    TRUE 
       largeSegmentDeletion        nonSenseMutation              PlotGenAlg 
                       TRUE                    TRUE                    TRUE 
              pointMutation        RandomAssortment            RandomizePop 
                       TRUE                    TRUE                    TRUE 
           splitChromosomes              transposon wholeChromosomeDeletion 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-18 03:55:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47636a701_1739850935
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2rWubp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dGAselID_v1.2-tikzDictionary"
