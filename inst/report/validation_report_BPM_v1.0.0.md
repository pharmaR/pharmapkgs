...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jianzhao Gao and Xiaodan Fan <gaojz@nankai.edu.cn>   |
...
Overall the package has 3 exported objects. 3 are documented:
     ...
     ApiGetDMCs       BayPM fullSampler 
           TRUE        TRUE        TRUE 

### Examples

There are 4 help pages with examples, from 7 (57.14 %).
...
| Execution Time | 2025-02-15 04:38:46 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5e837f66_1739594321
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT9PlKM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BPM_v1.0.0-tikzDictionary"
