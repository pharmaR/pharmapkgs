# Validation Report - dunlin@0.1.8
...
| has_source_control   | https://github.com/insightsengineering/dunlin/ |
...
| 3   | forcats (\>= 1.0.0)   | Imports |
| 4   | glue (\>= 1.0.0)      | Imports |
| 5   | magrittr (\>= 1.5)    | Imports |
| 6   | methods               | Imports |
| 7   | rlang (\>= 1.0.0)     | Imports |
| 8   | stringr (\>= 1.4.1)   | Imports |
| 9   | tibble (\>= 1.2)      | Imports |
| 10  | yaml (\>= 2.1.15)     | Imports |
...
Overall the package has 26 exported objects. 26 are documented:
                 ...
                 add_whisker    assert_all_tablenames      assert_valid_format 
                        TRUE                     TRUE                     TRUE 
    assert_valid_list_format               attr_label            attr_label_df 
                        TRUE                     TRUE                     TRUE 
                 co_relevels       combine_list_rules            combine_rules 
                        TRUE                     TRUE                     TRUE 
                cut_by_group                  get_arg                  get_log 
                        TRUE                     TRUE                     TRUE 
             join_adsub_adsl               list2rules               log_filter 
                        TRUE                     TRUE                     TRUE 
              ls_explicit_na                 ls_unite     multi_id_pivot_wider 
                        TRUE                     TRUE                     TRUE 
            poly_pivot_wider                print_log                propagate 
                        TRUE                     TRUE                     TRUE 
                    reformat           remove_whisker              render_safe 
                        TRUE                     TRUE                     TRUE 
                        rule             show_whisker 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-18 05:00:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45de4ba87_1739854817
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZvBPQl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dunlin_v0.1.8-tikzDictionary"
