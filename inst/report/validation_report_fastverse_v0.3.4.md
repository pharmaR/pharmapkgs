# Validation Report - fastverse@0.3.4
...
| has_source_control | https://github.com/fastverse |
...
Overall the package has 13 exported objects. 13 are documented:
       ...
       .fastverse_repos     fastverse_child fastverse_conflicts      fastverse_deps 
                   TRUE                TRUE                TRUE                TRUE 
       fastverse_detach    fastverse_extend   fastverse_install  fastverse_packages 
                   TRUE                TRUE                TRUE                TRUE 
        fastverse_reset    fastverse_sitrep    fastverse_update         is_attached 
                   TRUE                TRUE                TRUE                TRUE 
           is_installed 
                   TRUE 
...
| Execution Time | 2025-02-19 05:23:03 UTC |
...
running this report
    ...
    PROCESSX_PS1d455f9077c6_1739942576
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpp451Lk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastverse_v0.3.4-tikzDictionary"
