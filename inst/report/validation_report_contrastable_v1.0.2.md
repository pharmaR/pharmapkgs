# Validation Report - contrastable@1.0.2
...
| export_help          | 22                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Thomas Sostarics <tsostarics@gmail.com>    |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/tsostarics/contrastable |
...
Overall the package has 22 exported objects. 22 are documented:
       ...
       .is_reserved_operator             as.unordered backward_difference_code 
                        TRUE                     TRUE                     TRUE 
       cumulative_split_code      decompose_contrasts         enlist_contrasts 
                        TRUE                     TRUE                     TRUE 
     forward_difference_code        glimpse_contrasts             helmert_code 
                        TRUE                     TRUE                     TRUE 
         interpret_intercept              is_centered            is_orthogonal 
                        TRUE                     TRUE                     TRUE 
                is.unordered     orth_polynomial_code          polynomial_code 
                        TRUE                     TRUE                     TRUE 
         raw_polynomial_code     reverse_helmert_code          scaled_sum_code 
                        TRUE                     TRUE                     TRUE 
               set_contrasts                 sum_code           treatment_code 
                        TRUE                     TRUE                     TRUE 
               use_contrasts 
                        TRUE 
...
| Execution Time | 2025-02-17 03:49:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bd668b1c922_1739764193
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcitX2a
...
These are the options set to generate the report:
    ...
    [1] "validation_report_contrastable_v1.0.2-tikzDictionary"
