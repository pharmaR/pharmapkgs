# Validation Report - dbhydroR@0.2.8
...
| export_help          | 9                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Joseph Stachelek <stachel2@msu.edu>  |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/ropensci/dbhydroR |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    clean_hydro    clean_wq     cleanwq   get_dbkey   get_hydro      get_wq 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
       getdbkey    gethydro       getwq 
           TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 05:06:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63732e1c0_1739768779
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxKqK0l
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dbhydroR_v0.2.8-tikzDictionary"
