# Validation Report - bootstrap@2019.6
...
| export_help          | 11                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Scott Kostyshak <scott.kostyshak@gmail.com> |
| bugs_status          | 0                                           |
| has_source_control   | https://gitlab.com/scottkosty/bootstrap     |
...
adductomicsR, asht, BiodiversityR, braQCA, Dowd, ECGofTestDx,
fishmethods, GENLIB, GRTo, htestClust, IntegratedMRF, multifear,
MultivariateRandomForest, neuroUp, prabclus, QFASA, survcomp

## Namespace

Overall the package has 11 exported objects. 11 are documented:

       abcnon    abcpar    bcanon  bootpred bootstrap     boott  crossval     ctsub 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
    jackknife    xinter    yinter 
         TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-15 04:34:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4c70df8d_1739594077
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMwk3mD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bootstrap_v2019.6-tikzDictionary"
