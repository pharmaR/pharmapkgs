# Validation Report - clustermq@0.9.7
...
| export_help          | 4                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Michael Schubert <mschu.dev@gmail.com>  |
| bugs_status          | subscript out of bounds                 |
| has_bug_reports_url  | 1                                       |
| downloads_1yr        | 17063                                   |
| reverse_dependencies | 3                                       |
| has_examples         | 0.6785714                               |
| dependencies         | 7                                       |
...
drake, historicalborrowlong, targets

## Namespace

Overall the package has 4 exported objects. 4 are documented:

                     Q             Q_rows register_dopar_cmq            workers 
                  TRUE               TRUE               TRUE               TRUE 

### Examples

There are 19 help pages with examples, from 28 (67.86 %).
...
| Execution Time | 2025-02-16 04:39:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bc362e5a8e3_1739680771
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9bBJrk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clustermq_v0.9.7-tikzDictionary"
