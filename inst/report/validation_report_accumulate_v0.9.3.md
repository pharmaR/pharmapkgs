...
| size_codebase        | 276                                                  |
| has_source_control   | https://github.com/markvanderloo/accumulate          |
...
Overall the package has 9 exported objects. 9 are documented:
         ...
         accumulate csh_from_digits        cumulate   frac_complete  from_validator 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       min_complete     min_records     object_list      smoke_test 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 06:31:09 UTC |
...
running this report
    ...
    PROCESSX_PS726dd0e887_1739514666
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcLIFQ1
