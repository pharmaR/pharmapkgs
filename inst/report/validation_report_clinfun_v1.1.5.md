# Validation Report - clinfun@1.1.5
...
| export_help          | 30                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Venkatraman E. Seshan <seshanv@mskcc.org>            |
...
ADCT, binseqtest, EasyDescribe, frequentistSSDBinary, gen2stage, gMWT,
hctrial, IntEREst, ph2bye, ph2mult, RcmdrPlugin.EZR, rocbc, survcomp,
UnplanSimon, VisualizeSimon2Stage

## Namespace

Overall the package has 30 exported objects. 30 are documented:

           aucVardiTest      bdrycross.prob           calogrank            coxphCPE 
                   TRUE                TRUE                TRUE                TRUE 
               coxphERR       coxphQuantile           CPS.ssize            deltaAUC 
                   TRUE                TRUE                TRUE                TRUE 
                fe.mdor            fe.power            fe.ssize           futilbdry 
                   TRUE                TRUE                TRUE                TRUE 
      gsdesign.binomial     gsdesign.normal   gsdesign.survival     jonckheere.test 
                   TRUE                TRUE                TRUE                TRUE 
                   mdrr    oc.twostage.bdry            or2pcase         permlogrank 
                   TRUE                TRUE                TRUE                TRUE 
               ph2simon           ph2single      power.ladesign             pselect 
                   TRUE                TRUE                TRUE                TRUE 
          roc.area.test           roc.curve       roc.perm.test             toxbdry 
                   TRUE                TRUE                TRUE                TRUE 
    twostage.admissible  twostage.inference 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:32:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33c5da79c_1739680341
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTLx1dh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clinfun_v1.1.5-tikzDictionary"
