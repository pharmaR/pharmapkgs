# Validation Report - dataclass@1.0.0
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Chris Walker <walkerjameschris@gmail.com>            |
...
Overall the package has 10 exported objects. 10 are documented:
           ...
           any_obj        atm_vec        chr_vec data_validator      dataclass 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           df_like        dte_vec  enforce_types        lgl_vec        num_vec 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 04:56:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bd611a69953_1739768185
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpL71ZBi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dataclass_v1.0.0-tikzDictionary"
