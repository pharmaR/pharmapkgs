# Validation Report - cmahalanobis@0.5.0
...
| export_help          | 39                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Flavio Gioia <flaviogioia.fg@gmail.com>              |
...
Overall the package has 39 exported objects. 39 are documented:
                    ...
                    cbhattacharyya                    cbraycurtis 
                              TRUE                           TRUE 
                         ccanberra                     cchebyshev 
                              TRUE                           TRUE 
                           ccosine                       ceuclide 
                              TRUE                           TRUE 
                          chamming                     chellinger 
                              TRUE                           TRUE 
                          cjaccard                   cmahalanobis 
                              TRUE                           TRUE 
                        cmanhattan                     cminkowski 
                              TRUE                           TRUE 
                     csorensendice generate_report_cbhattacharyya 
                              TRUE                           TRUE 
       generate_report_cbraycurtis      generate_report_ccanberra 
                              TRUE                           TRUE 
        generate_report_cchebyshev        generate_report_ccosine 
                              TRUE                           TRUE 
          generate_report_ceuclide       generate_report_chamming 
                              TRUE                           TRUE 
        generate_report_chellinger       generate_report_cjaccard 
                              TRUE                           TRUE 
      generate_report_cmahalanobis     generate_report_cmanhattan 
                              TRUE                           TRUE 
        generate_report_cminkowski  generate_report_csorensendice 
                              TRUE                           TRUE 
                      pvaluescbatt                   pvaluescbrcu 
                              TRUE                           TRUE 
                      pvaluesccanb                   pvaluesccheb 
                              TRUE                           TRUE 
                      pvaluesccosi                   pvaluesceucl 
                              TRUE                           TRUE 
                      pvalueschamm                   pvalueschell 
                              TRUE                           TRUE 
                      pvaluescjacc                   pvaluescmaha 
                              TRUE                           TRUE 
                      pvaluescmanh                   pvaluescmink 
                              TRUE                           TRUE 
                      pvaluescsore 
                              TRUE 
...
| Execution Time | 2025-02-16 04:42:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3529ced2f_1739680973
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfxzWdt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmahalanobis_v0.5.0-tikzDictionary"
