# Validation Report - conformalClassification@1.0.0
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Niharika Gauraha <niharika.gauraha@farmbio.uu.se>    |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       CPCalibrationPlot         CPEfficiency          CPErrorRate 
                    TRUE                 TRUE                 TRUE 
          CPObsFuzziness           CPValidity             fitModel 
                    TRUE                 TRUE                 TRUE 
       ICPClassification parTCPClassification    TCPClassification 
                    TRUE                 TRUE                 TRUE 
              tcpPValues 
                    TRUE 
...
| Execution Time | 2025-02-17 03:43:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6254b2a1e_1739763824
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWUqNd6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conformalClassification_v1.0.0-tikzDictionary"
