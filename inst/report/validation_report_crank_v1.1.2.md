...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jim Lemon <drjimlemon@gmail.com>                     |
...
Overall the package has 14 exported objects. 14 are documented:
         ...
         cats2ranks         elrepos        fillArow       fillArows       getLWargs 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        listBuilder     listCrawler lw.FriedmanTest        lwscreen       meanranks 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            muranks page.trend.test         permute          spsort 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-24 03:22:51 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a1d67ec45_1740367367
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptX6LBK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crank_v1.1.2-tikzDictionary"
