...
| export_help          | 39                                  |
| has_website          | TRUE                                |
| has_maintainer       | Mark Clements <mark.clements@ki.se> |
| bugs_status          | subscript out of bounds             |
| size_codebase        | 4820                                |
| has_source_control   | https://github.com/mclements/ascii  |
| has_bug_reports_url  | 1                                   |
| downloads_1yr        | 16302                               |
| reverse_dependencies | 2                                   |
| has_examples         | 0.9550562                           |
| dependencies         | 7                                   |
| license              | GPL (\>= 2)                         |
...
Overall the package has 37 exported objects. 37 are documented:
                    ...
                    ascii          asciiCoefmat              Asciidoc 
                     TRUE                  TRUE                  TRUE 
                  convert          createreport                expand 
                     TRUE                  TRUE                  TRUE 
                      fig            interleave interleave.data.frame 
                     TRUE                  TRUE                  TRUE 
        interleave.matrix                   Org                   out 
                     TRUE                  TRUE                  TRUE 
                   Pandoc             paragraph          paste.matrix 
                     TRUE                  TRUE                  TRUE 
                     plim                Report                  ReST 
                     TRUE                  TRUE                  TRUE 
             RtangleAscii        RweaveAsciidoc             RweaveOrg 
                     TRUE                  TRUE                  TRUE 
             RweavePandoc            RweaveReST             RweaveT2t 
                     TRUE                  TRUE                  TRUE 
            RweaveTextile               section                 sexpr 
                     TRUE                  TRUE                  TRUE 
                      T2t               Textile              tocharac 
                     TRUE                  TRUE                  TRUE 
                 verbatim        weaverAsciidoc             weaverOrg 
                     TRUE                  TRUE                  TRUE 
             weaverPandoc            weaverReST             weaverT2t 
                     TRUE                  TRUE                  TRUE 
            weaverTextile 
                     TRUE 
...
There are 85 help pages with examples, from 89 (95.51 %).
...
| Execution Time | 2025-02-14 07:26:27 UTC |
...
running this report
    ...
    PROCESSX_PS1c091cc704bd_1739517984
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYUryuM
