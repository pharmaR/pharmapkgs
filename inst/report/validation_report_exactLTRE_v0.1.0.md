# Validation Report - exactLTRE@0.1.0
...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Christina Hernandez <cmh352@cornell.edu>             |
...
Overall the package has 22 exported objects. 22 are documented:
      ...
      calc_matrix_effects calc_matrix_responses         classicalLTRE 
                     TRUE                  TRUE                  TRUE 
      classicalLTRE_fixed  classicalLTRE_random     collapse_mat_list 
                     TRUE                  TRUE                  TRUE 
               cov_matrix             exactLTRE       exactLTRE_fixed 
                     TRUE                  TRUE                  TRUE 
         exactLTRE_random    fundamental_matrix       generation_time 
                     TRUE                  TRUE                  TRUE 
                  lamDiff     lamDiff_symmetric                lamVar 
                     TRUE                  TRUE                  TRUE 
                 lifespan          make.Gmatrix           mean_matrix 
                     TRUE                  TRUE                  TRUE 
                 r_nought                 reMat     run_matrix_checks 
                     TRUE                  TRUE                  TRUE 
        variance_complete 
                     TRUE 
...
| Execution Time | 2025-02-19 04:46:31 UTC |
...
running this report
    ...
    PROCESSX_PS1d451ff517e0_1739940385
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptvNIhg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exactLTRE_v0.1.0-tikzDictionary"
