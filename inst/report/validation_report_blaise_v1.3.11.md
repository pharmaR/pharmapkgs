# Validation Report - blaise@1.3.11
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Sjoerd Ophof <sjoerd.ophof@gmail.com>                |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | dplyr (\>= 0.7.2)   | Imports |
| 2   | readr (\>= 1.1.1)   | Imports |
| 3   | stringr (\>= 1.2.0) | Imports |
| 4   | utils (\>= 3.4.1)   | Imports |
| 5   | tibble (\>= 1.3.3)  | Imports |
| 6   | tools (\>= 3.4.1)   | Imports |
| 7   | methods (\>= 3.4.1) | Imports |
| 8   | stats (\>= 3.4.1)   | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
                ...
                read_fwf_blaise            write_fwf_blaise 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-15 04:21:02 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5bf3e9c_1739593257
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNS8DuJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blaise_v1.3.11-tikzDictionary"
