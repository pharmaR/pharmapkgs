# Validation Report - condSURV@2.0.4
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Marta Sestelo <sestelo@uvigo.es>                     |
...
BayesFBHborrow, cenROC, GFDrmst, GFDsurv

## Namespace

Overall the package has 12 exported objects. 12 are documented:

             Beran             KM            KMW            LLW            NWW 
              TRUE           TRUE           TRUE           TRUE           TRUE 
               PKM           PKMW    plot.survCS   print.survCS summary.survCS 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          survCOND         survCS 
              TRUE           TRUE 
...
| Execution Time | 2025-02-17 03:41:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bd644092b05_1739763690
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT3u6aL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_condSURV_v2.0.4-tikzDictionary"
