# Validation Report - bpmnVisualizationR@0.5.0
...
| export_help | 10 |
| has_website | TRUE |
| has_maintainer | Celine Souchet <process.analytics.dev+CRAN@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/process-analytics/bpmn-visualization-R/ |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    bpmnVisualizationROutput        create_edge_style     create_gradient_fill 
                        TRUE                     TRUE                     TRUE 
              create_overlay     create_overlay_style       create_shape_style 
                        TRUE                     TRUE                     TRUE 
                     display    overlay_edge_position   overlay_shape_position 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-15 04:38:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd66cf3476_1739594333
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLfEPlo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bpmnVisualizationR_v0.5.0-tikzDictionary"
