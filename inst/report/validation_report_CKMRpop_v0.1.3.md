# Validation Report - CKMRpop@0.1.3
...
| 7   | magrittr         | Imports   |
| 8   | purrr            | Imports   |
| 9   | Rcpp (\>= 1.0.4) | Imports   |
| 10  | readr            | Imports   |
| 11  | stats            | Imports   |
| 12  | stringr          | Imports   |
| 13  | tibble           | Imports   |
| 14  | tidygraph        | Imports   |
| 15  | tidyr            | Imports   |
| 16  | vroom            | Imports   |
...
Overall the package has 27 exported objects. 26 are documented:
                                        ...
                                        %>%                              amm2tibble 
                                      FALSE                                    TRUE 
                            anc_match_masks                         ancestor_abbrvs 
                                       TRUE                                    TRUE 
                              cat_dom_relat                   compile_related_pairs 
                                       TRUE                                    TRUE 
           count_and_plot_ancestry_matrices        count_and_plot_mate_distribution 
                                       TRUE                                    TRUE 
                           downsample_pairs find_ancestors_and_relatives_of_samples 
                                       TRUE                                    TRUE 
              ggplot_census_by_year_age_sex                            install_spip 
                                       TRUE                                    TRUE 
                           leslie_from_spip                    plot_amm_from_matrix 
                                       TRUE                                    TRUE 
                            plot_conn_comps                         prepare_for_dfs 
                                       TRUE                                    TRUE 
                     primary_ancestor_pairs            rcpp_ancestors_and_relatives 
                                       TRUE                                    TRUE 
               relationship_zone_perimeters                                run_spip 
                                       TRUE                                    TRUE 
                                 slurp_spip                             spip_exists 
                                       TRUE                                    TRUE 
                                  spip_help                          spip_help_full 
                                       TRUE                                    TRUE 
       summarize_offspring_and_mate_numbers          summarize_survival_from_census 
                                       TRUE                                    TRUE 
                         uncooked_spaghetti 
                                       TRUE 
...
There are 43 help pages with examples, from 48 (89.58 %).
...
| Execution Time | 2025-02-16 04:25:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35ed80dee_1739679913
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpl8f2Iw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CKMRpop_v0.1.3-tikzDictionary"
