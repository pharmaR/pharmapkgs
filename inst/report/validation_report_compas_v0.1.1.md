# Validation Report - compas@0.1.1
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Samuel W.K. Wong <samuel.wong@uwaterloo.ca>          |
...
Overall the package has 5 exported objects. 5 are documented:
      ...
      calCo calscco  dfireE pdbrmsd torsion 
...
| Execution Time | 2025-02-17 03:35:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67558bf7d_1739763296
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWzxw3e
...
These are the options set to generate the report:
    ...
    [1] "validation_report_compas_v0.1.1-tikzDictionary"
