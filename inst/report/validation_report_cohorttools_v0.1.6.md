# Validation Report - cohorttools@0.1.6
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jari Haukka <jari.haukka@helsinki.fi>                |
...
| 4   | stats         | Imports |
| 5   | survival      | Imports |
| 6   | DiagrammeR    | Imports |
| 7   | DiagrammeRsvg | Imports |
| 8   | rsvg          | Imports |
| 9   | mgcv          | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
          ...
          boxesLx  estim.hazard      gv2image   mkflowchart   mkratetable 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       plotcuminc plotratetable 
             TRUE          TRUE 
...
| Execution Time | 2025-02-16 04:55:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33866c045_1739681736
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZUNq14
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cohorttools_v0.1.6-tikzDictionary"
