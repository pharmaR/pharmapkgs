# Validation Report - fable.ata@0.0.6
...
| 4   | dplyr                       | Imports |
| 5   | tsibble                     | Imports |
| 6   | distributional              | Imports |
| 7   | tsbox                       | Imports |
| 8   | lubridate                   | Imports |
| 9   | fabletools (\>= 0.3.3)      | Depends |
| 10  | ATAforecasting (\>= 0.0.60) | Depends |
...
| Execution Time | 2025-02-19 05:02:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d4559d01eb4_1739941324
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6x5HCm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fable.ata_v0.0.6-tikzDictionary"
