...
| export_help | 2 |
| has_website | FALSE |
| has_maintainer | Jacques-Henri Jourdan <jacques-henri.jourdan@cnrs.fr> |
...
|     | package                         | type      |
|:----|:--------------------------------|:----------|
| 1   | RcppArmadillo (\>= 0.7.100.3.1) | LinkingTo |
| 2   | BH (\>= 1.55)                   | LinkingTo |
| 3   | RcppProgress (\>= 0.2.1)        | LinkingTo |
| 4   | Rcpp                            | LinkingTo |
...
| Execution Time | 2025-02-18 03:54:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4322af8cb_1739850859
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3vmg9Q
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dfmta_v1.7.6-tikzDictionary"
