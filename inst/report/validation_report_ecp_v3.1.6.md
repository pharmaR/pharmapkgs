...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Wenyu Zhang <wz258@cornell.edu>                      |
...
AneuFinder, CONFESS, envoutliers, ftsa, FuzzyPovertyR, ggchangepoint,
RMaCzek, rplanes
...
Overall the package has 9 exported objects. 8 are documented:
          ...
          e.agglo        e.cp3o  e.cp3o_delta    e.divisive    getBetween 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        getWithin          kcpa       ks.cp3o ks.cp3o_delta 
...
| Execution Time | 2025-02-19 03:38:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d45ca51d67_1739936299
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXafojR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecp_v3.1.6-tikzDictionary"
