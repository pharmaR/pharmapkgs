# Validation Report - CalibratR@0.1.2
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Dominik Heider <heiderd@mathematik.uni-marburg.de>   |
...
Overall the package has 9 exported objects. 9 are documented:
             ...
             build_GUESS            calibrate               getECE 
                    TRUE                 TRUE                 TRUE 
                  getMCE    predict_calibratR        predict_GUESS 
                    TRUE                 TRUE                 TRUE 
    reliability_diagramm statistics_calibratR  visualize_calibratR 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-16 03:35:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35b451ef4_1739676927
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpt3v7V3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CalibratR_v0.1.2-tikzDictionary"
