# Validation Report - epitrix@0.4.0
...
| export_help          | 14                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Thibaut Jombart <thibautjombart@gmail.com> |
...
Overall the package has 14 exported objects. 14 are documented:
                         ...
                         AR2R0               clean_labels 
                          TRUE                       TRUE 
     empirical_incubation_dist             fit_disc_gamma 
                          TRUE                       TRUE 
     fit_gamma_incubation_dist       gamma_log_likelihood 
                          TRUE                       TRUE 
         gamma_mucv2shapescale      gamma_shapescale2mucv 
                          TRUE                       TRUE 
                    hash_names               lm2R0_sample 
                          TRUE                       TRUE 
                         R02AR R02herd_immunity_threshold 
                          TRUE                       TRUE 
                          r2R0               sim_linelist 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-19 04:19:58 UTC |
...
running this report
    ...
    PROCESSX_PS1d453acd5161_1739938792
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzCuxQG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epitrix_v0.4.0-tikzDictionary"
