# Validation Report - DisImpact@0.0.21
...
| export_help          | 12                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Vinh Nguyen <nguyenvq714@gmail.com>    |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/vinhdizzo/DisImpact |
...
| 7   | fst                     | Imports |
| 8   | DBI                     | Imports |
| 9   | duckdb (\>= 0.5.0)      | Imports |
| 10  | glue                    | Imports |
| 11  | stringr                 | Imports |
| 12  | data.table (\>= 1.14.2) | Imports |
| 13  | collapse                | Imports |
| 14  | sets                    | Imports |
...
Overall the package has 12 exported objects. 12 are documented:
                 ...
                 di_80_index               di_calc_dt              di_calc_sql 
                        TRUE                     TRUE                     TRUE 
                  di_iterate            di_iterate_dt       di_iterate_on_long 
                        TRUE                     TRUE                     TRUE 
              di_iterate_sql                   di_ppg           di_ppg_iterate 
                        TRUE                     TRUE                     TRUE 
               di_prop_index                  ppg_moe surround_quote_if_needed 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-18 04:15:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47cb8452e_1739852114
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpipyODB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DisImpact_v0.0.21-tikzDictionary"
