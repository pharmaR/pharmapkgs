...
| export_help          | 16                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Maximilian Boeck <maximilian.boeck@fau.de> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/mboeck11/BGVAR          |
...
| 9   | methods              | Imports   |
| 10  | parallel             | Imports   |
| 11  | Rcpp (\>= 1.0.3)     | Imports   |
| 12  | RcppParallel         | Imports   |
| 13  | readxl               | Imports   |
| 14  | stats                | Imports   |
| 15  | stochvol (\>= 3.0.3) | Imports   |
| 16  | utils                | Imports   |
| 17  | xts                  | Imports   |
| 18  | zoo                  | Imports   |
| 19  | Rcpp                 | LinkingTo |
| 20  | RcppArmadillo        | LinkingTo |
| 21  | RcppProgress         | LinkingTo |
| 22  | RcppParallel         | LinkingTo |
| 23  | stochvol             | LinkingTo |
| 24  | GIGrvg               | LinkingTo |
...
Overall the package has 16 exported objects. 16 are documented:
      ...
      add_shockinfo     avg.pair.cc           bgvar       conv.diag             dic 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      excel_to_list            fevd   get_shockinfo           gfevd              hd 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                irf  list_to_matrix             lps  matrix_to_list resid.corr.test 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               rmse 
               TRUE 
...
| Execution Time | 2025-02-15 03:59:31 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd54ce695f_1739591967
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnrocVH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BGVAR_v2.5.8-tikzDictionary"
