# Validation Report - FaultTree@1.0.1
...
| export_help          | 23                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Jacob Ormerod <jake@openreliability.org>             |
...
Overall the package has 23 exported objects. 5 are documented:

               addActive            addDemand         addDuplicate 
                   FALSE                FALSE                FALSE 
              addExposed             addHouse            addLatent 
                   FALSE                FALSE                FALSE 
                addLogic       addProbability       addUndeveloped 
                   FALSE                FALSE                FALSE 
           applyCollapse              cutsets           ftree.calc 
                    TRUE                FALSE                FALSE 
              ftree.make            ftree2bdd           ftree2html 
                   FALSE                FALSE                FALSE 
             ftree2table     hierarchyDF2json parameter_conversion 
                   FALSE                FALSE                 TRUE 
                      pc             prob2lam          probability 
                    TRUE                 TRUE                FALSE 
              tagconnect           test.ftree 
                   FALSE                 TRUE 
...
| Execution Time | 2025-02-19 05:23:47 UTC |
...
running this report
    ...
    PROCESSX_PS1d459971f5e_1739942620
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRnimi9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FaultTree_v1.0.1-tikzDictionary"
