# Validation Report - calibrar@0.9.0
...
| export_help          | 19                                                  |
| has_website          | TRUE                                                |
| has_maintainer       | Ricardo Oliveros-Ramos <ricardo.oliveros@gmail.com> |
| bugs_status          | 1                                                   |
...
Overall the package has 19 exported objects. 19 are documented:
      ...
      .get_command_argument     .read_configuration                   ahres 
                       TRUE                    TRUE                    TRUE 
              calibrar_demo               calibrate        calibration_data 
                       TRUE                    TRUE                    TRUE 
          calibration_objFn       calibration_setup createObjectiveFunction 
                       TRUE                    TRUE                    TRUE 
                    fitness         gaussian_kernel      getCalibrationInfo 
                       TRUE                    TRUE                    TRUE 
            getObservedData                gradient                   objFn 
                       TRUE                    TRUE                    TRUE 
                     optim2                  optimh                 sphereN 
                       TRUE                    TRUE                    TRUE 
                 spline_par 
                       TRUE 
...
| Execution Time | 2025-02-16 03:34:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35fa98e98_1739676890
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxWqbsm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_calibrar_v0.9.0-tikzDictionary"
