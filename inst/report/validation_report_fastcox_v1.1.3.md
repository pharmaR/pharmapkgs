# Validation Report - fastcox@1.1.3
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Yi Yang <yi.yang6@mcgill.ca>                         |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/emeryyi/fastcox                   |
...
Overall the package has 4 exported objects. 4 are documented:
            ...
            cocktail      cv.cocktail      cv.survpath predict.cocktail 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 05:15:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d456acc45de_1739942118
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZBc3xO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastcox_v1.1.3-tikzDictionary"
