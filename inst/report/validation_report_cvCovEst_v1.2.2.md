# Validation Report - cvCovEst@1.2.2
...
| export_help          | 20                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Philippe Boileau <philippe_boileau@berkeley.edu> |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/PhilBoileau/cvCovEst          |
...
bdsvd, PPLasso, WLogit

## Namespace

Overall the package has 20 exported objects. 20 are documented:

               adaptiveLassoEst                  bandingEst 
                           TRUE                        TRUE 
                       cvCovEst             cvFrobeniusLoss 
                           TRUE                        TRUE 
          cvMatrixFrobeniusLoss cvScaledMatrixFrobeniusLoss 
                           TRUE                        TRUE 
           denseLinearShrinkEst                 is.cvCovEst 
                           TRUE                        TRUE 
                linearShrinkEst           linearShrinkLWEst 
                           TRUE                        TRUE 
                  nlShrinkLWEst                     poetEst 
                           TRUE                        TRUE 
                  robustPoetEst                sampleCovEst 
                           TRUE                        TRUE 
                        scadEst    spikedFrobeniusShrinkEst 
                           TRUE                        TRUE 
        spikedOperatorShrinkEst        spikedSteinShrinkEst 
                           TRUE                        TRUE 
                    taperingEst             thresholdingEst 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-17 04:43:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bd644017c61_1739767391
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYBDNoc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cvCovEst_v1.2.2-tikzDictionary"
