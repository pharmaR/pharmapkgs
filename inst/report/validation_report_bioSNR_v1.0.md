...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Matthew Duggan <mtd72@cornell.edu>                   |
...
Overall the package has 8 exported objects. 8 are documented:
      ...
      absorptionAir absorptionWater            opDB            rmax           snell 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         soundSpeed    specLvlGraph             wof 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:15:15 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd40f5a148_1739592910
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz4MsmH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bioSNR_v1.0-tikzDictionary"
