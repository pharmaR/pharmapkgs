# Validation Report - Distance@2.0.0
...
| has_source_control   | https://github.com/DistanceDevelopment/Distance/ |
| has_bug_reports_url  | 1                                                |
| downloads_1yr        | 18642                                            |
| reverse_dependencies | 3                                                |
| has_examples         | 0.6595745                                        |
| dependencies         | 4                                                |
| license              | GPL (\>= 2)                                      |
...
Overall the package has 17 exported objects. 17 are documented:
                   ...
                   bootdht bootdht_Dhat_summarize bootdht_Nhat_summarize 
                      TRUE                   TRUE                   TRUE 
               chi2_select          convert_units            create_bins 
                      TRUE                   TRUE                   TRUE 
               create.bins                   dht2                     ds 
                      TRUE                   TRUE                   TRUE 
                    ds.gof              dummy_ddf                 gof_ds 
                      TRUE                   TRUE                   TRUE 
          make_activity_fn                   QAIC    summarize_ds_models 
                      TRUE                   TRUE                   TRUE 
                 unflatten            units_table 
                      TRUE                   TRUE 

### Examples

There are 31 help pages with examples, from 47 (65.96 %).
...
| Execution Time | 2025-02-18 04:17:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bb448da870b_1739852222
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpr13Kog
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Distance_v2.0.0-tikzDictionary"
