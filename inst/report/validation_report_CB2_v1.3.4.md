...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Hyun-Hwan Jeong <jeong.hyunhwan@gmail.com>           |
...
Overall the package has 13 exported objects. 13 are documented:
           ...
           calc_mappability                  fit_ab                 get_CPM 
                       TRUE                    TRUE                    TRUE 
      join_count_and_design      measure_gene_stats     measure_sgrna_stats 
                       TRUE                    TRUE                    TRUE 
          plot_corr_heatmap plot_count_distribution            plot_dotplot 
                       TRUE                    TRUE                    TRUE 
                   plot_PCA                   quant          run_estimation 
                       TRUE                    TRUE                    TRUE 
            run_sgrna_quant 
                       TRUE 
...
| Execution Time | 2025-02-16 03:50:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3776a8fd8_1739677855
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuccNwv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CB2_v1.3.4-tikzDictionary"
