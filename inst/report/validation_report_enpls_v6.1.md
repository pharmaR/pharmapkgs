...
| export_help          | 13                                 |
| has_website          | TRUE                               |
| has_maintainer       | Nan Xiao <me@nanx.me>              |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/nanxstats/enpls |
...
Overall the package has 13 exported objects. 13 are documented:
       ...
       cv.enpls   cv.enspls    enpls.ad   enpls.fit    enpls.fs   enpls.mae 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
       enpls.od  enpls.rmse enpls.rmsle   enspls.ad  enspls.fit   enspls.fs 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
      enspls.od 
           TRUE 
...
| Execution Time | 2025-02-19 04:08:47 UTC |
...
running this report
    ...
    PROCESSX_PS1d4529807134_1739938121
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXkMrUc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_enpls_v6.1-tikzDictionary"
