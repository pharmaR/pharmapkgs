...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Fanni Zhang <rstatpackages@gmail.com>                |
...
Overall the package has 8 exported objects. 8 are documented:
      ...
      absolute.risk   check.summary     error.table error.table.all  list.constants 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       recode.check   relative.risk    risk.summary 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 03:47:01 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdbb8e0e7_1739591217
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkNs6Mz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BCRA_v2.1.2-tikzDictionary"
