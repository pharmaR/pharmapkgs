# Validation Report - bigReg@0.1.5
...
| export_help          | 0                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Chibisi Chima-Okereke <chibisi@active-analytics.com> |
...
|     | package                         | type      |
|:----|:--------------------------------|:----------|
| 1   | Rcpp (\>= 1.0.11)               | Depends   |
| 2   | parallel                        | Depends   |
| 3   | methods                         | Depends   |
| 4   | stats                           | Depends   |
| 5   | uuid (\>= 0.1-2)                | Depends   |
| 6   | MASS (\>= 7.3-39)               | Depends   |
| 7   | Rcpp                            | LinkingTo |
| 8   | RcppArmadillo (\>= 0.5.200.1.0) | LinkingTo |
...
| Execution Time | 2025-02-15 04:05:10 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6aef5959_1739592305
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUI3f00
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigReg_v0.1.5-tikzDictionary"
