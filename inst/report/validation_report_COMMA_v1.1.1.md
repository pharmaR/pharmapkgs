...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Kimberly Webb <kah343@cornell.edu>                   |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | Matrix (\> 1.4-1)       | Imports |
| 2   | turboEM (\>= 2021.1)    | Imports |
| 3   | dplyr (\>= 1.1.4)       | Imports |
| 4   | foreach (\>= 1.5.2)     | Imports |
| 5   | parallel (\>= 4.3.1)    | Imports |
| 6   | doParallel (\>= 1.0.17) | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
                  ...
                  COMMA_data                 COMMA_EM    COMMA_EM_bootstrap_SE 
                        TRUE                     TRUE                     TRUE 
                   COMMA_OLS   COMMA_OLS_bootstrap_SE                COMMA_PVW 
                        TRUE                     TRUE                     TRUE 
      COMMA_PVW_bootstrap_SE   misclassification_prob true_classification_prob 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-17 03:32:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bd659ba666e_1739763136
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2QVOSD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_COMMA_v1.1.1-tikzDictionary"
