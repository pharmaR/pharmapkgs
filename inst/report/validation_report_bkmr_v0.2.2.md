...
| export_help          | 17                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Jennifer F. Bobb <jenniferfederbobb@gmail.com> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/jenfb/bkmr                  |
...
bkmrhat, CompMix, mpower

## Namespace

Overall the package has 17 exported objects. 17 are documented:

             ComputePostmeanHnew                  ExtractEsts 
                            TRUE                         TRUE 
                     ExtractPIPs                 ExtractSamps 
                            TRUE                         TRUE 
                InvestigatePrior                      kmbayes 
                            TRUE                         TRUE 
            OverallRiskSummaries                PlotPriorFits 
                            TRUE                         TRUE 
          PredictorResponseBivar PredictorResponseBivarLevels 
                            TRUE                         TRUE 
      PredictorResponseBivarPair      PredictorResponseUnivar 
                            TRUE                         TRUE 
                      SamplePred                      SimData 
                            TRUE                         TRUE 
             SingVarIntSummaries         SingVarRiskSummaries 
                            TRUE                         TRUE 
                       TracePlot 
                            TRUE 
...
| Execution Time | 2025-02-15 04:20:24 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd354805fd_1739593219
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZGedfE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bkmr_v0.2.2-tikzDictionary"
