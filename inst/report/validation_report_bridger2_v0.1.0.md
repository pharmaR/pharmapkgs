# Validation Report - bridger2@0.1.0
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Naoto Imamachi <naoto.imamachi@gmail.com>            |
...
Overall the package has 14 exported objects. 14 are documented:
                      ...
                      BridgeRCore         BridgeRDatasetChecker 
                             TRUE                          TRUE 
         BridgeRDataSetFromMatrix         BridgeRDataSetFromRaw 
                             TRUE                          TRUE 
                     BridgeReport             BridgeRGrubbsTest 
                             TRUE                          TRUE 
       BridgeRHalfLifeCalc3models   BridgeRHalfLifeCalcR2Select 
                             TRUE                          TRUE 
             BridgeRNormalization   BridgeRNormalizationFactors 
                             TRUE                          TRUE 
    BridgeRNormalizationFactorsHK       BridgeRPvalueEvaluation 
                             TRUE                          TRUE 
             BridgeRResultChecker         CalcHalflifeDeviation 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-15 04:44:11 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd9d811ec_1739594646
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoPqd4m
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bridger2_v0.1.0-tikzDictionary"
