# Validation Report - complmrob@0.7.0
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | David Kepplinger <david.kepplinger@gmail.com>        |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/dakep/complmrob                   |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    bootcoefs complmrob    isomLR isomLRinv 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-17 03:36:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63532afb4_1739763394
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgEnj3L
...
These are the options set to generate the report:
    ...
    [1] "validation_report_complmrob_v0.7.0-tikzDictionary"
