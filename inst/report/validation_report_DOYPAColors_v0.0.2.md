# Validation Report - DOYPAColors@0.0.2
...
| export_help          | 7                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Jorge Mestre <jorge.mestre.tomas@csic.es> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/jmestret/DOYPAColors   |
...
Overall the package has 7 exported objects. 7 are documented:
                 ...
                 doypa    list_doypa_pals preview_doypa_pals        preview_pal 
                  TRUE               TRUE               TRUE               TRUE 
     scale_color_doypa scale_colour_doypa   scale_fill_doypa 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 04:39:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4346ee3f1_1739853560
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdMdBhq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DOYPAColors_v0.0.2-tikzDictionary"
