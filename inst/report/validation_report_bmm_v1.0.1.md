...
| export_help          | 53                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Vencislav Popov <vencislav.popov@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/venpopov/bmm             |
...
Overall the package has 53 exported objects. 52 are documented:
                               ...
                               bmf2bf                               bmm 
                                 TRUE                              TRUE 
                          bmm_options                        bmmformula 
                                 TRUE                              TRUE 
                     c_bessel2sqrtexp                  c_sqrtexp2bessel 
                                 TRUE                              TRUE 
    calc_error_relative_to_nontargets                        check_data 
                                 TRUE                              TRUE 
                      configure_model                   configure_prior 
                                 TRUE                              TRUE 
                        default_prior                           deg2rad 
                                 TRUE                              TRUE 
                                 dimm                        dmixture2p 
                                 TRUE                              TRUE 
                           dmixture3p                              dsdm 
                            ...
                            mixture3p                              pimm 
                                 TRUE                              TRUE 
                           pmixture2p                        pmixture3p 
                                 TRUE                              TRUE 
                      postprocess_brm            print_pretty_models_md 
                                 TRUE                              TRUE 
                                 psdm                              qimm 
                                 TRUE                              TRUE 
                           qmixture2p                        qmixture3p 
                                 TRUE                              TRUE 
                                 qsdm                           rad2deg 
                                 TRUE                              TRUE 
                          restructure            revert_postprocess_brm 
                                 TRUE                              TRUE 
                                 rimm                        rmixture2p 
                                 TRUE                              TRUE 
                           rmixture3p                              rsdm 
                             ...
                             stancode                          standata 
                                 TRUE                              TRUE 
                     supported_models                use_model_template 
                                 TRUE                              TRUE 
                                 wrap 
                                 TRUE 
...
| Execution Time | 2025-02-15 04:27:05 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd696e8d91_1739593620
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpopFYqs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bmm_v1.0.1-tikzDictionary"
