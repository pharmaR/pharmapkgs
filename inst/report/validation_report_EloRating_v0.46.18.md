# Validation Report - EloRating@0.46.18
...
| has_source_control   | https://github.com/gobbios/EloRating          |
...
Overall the package has 38 exported objects. 38 are documented:
                    ...
                    CBI         coresidence correctly_predicted        creatematrix 
                   TRUE                TRUE                TRUE                TRUE 
      createstartvalues             DCindex                  DS          dyadic_dom 
                   TRUE                TRUE                TRUE                TRUE 
       dyadic_reversals            e.single             elo.seq             eloplot 
                   TRUE                TRUE                TRUE                TRUE 
            extract_elo             fastelo             h.index         heatmapplot 
                   TRUE                TRUE                TRUE                TRUE 
             incontable         individuals                 ISI            ISIranks 
                   TRUE                TRUE                TRUE                TRUE 
         lastdaypresent              likelo             mat2seq           optimizek 
                   TRUE                TRUE                TRUE                TRUE 
              optistart    presence_summary               prunk           randomelo 
                   TRUE                TRUE                TRUE                TRUE 
       randomeloextract      randomsequence           scale_elo            seqcheck 
                   TRUE                TRUE                TRUE                TRUE 
             simple_dom            stab_elo           steepness            traj_elo 
                   TRUE                TRUE                TRUE                TRUE 
           transitivity             winprob 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-19 03:58:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d45c0b5d51_1739937486
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpS2zL2X
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EloRating_v0.46.18-tikzDictionary"
