...
clusterSEs, DCEtool, discrtr, ExactMed, ggeffects, glm.predict, gofcat,
idefix, marginaleffects, mlogit, multpois, pleLMA, Ravages, seqimpute,
WeightIt
...
Overall the package has 14 exported objects. 13 are documented:
           ...
           %>%    arrange  as_tibble      dfidx     filter   fold_idx        idx 
         FALSE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
      idx_name     mutate       pull     select      slice  transmute unfold_idx 
...
| Execution Time | 2025-02-18 03:53:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bb461985a39_1739850827
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpu4LiOK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dfidx_v0.1.0-tikzDictionary"
