# Validation Report - Coinprofile@0.1.9
...
| export_help          | 3                                              |
| has_website          | TRUE                                           |
| has_maintainer       | Wilmer Martinez <womartin@asu.edu>             |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/WilmerMartinezR/Coinprofile |
...
| 4   | coin                        | Imports |
| 5   | Rdpack                      | Imports |
| 6   | exactRankTests (\>= 0.8-29) | Imports |
| 7   | ggplot2 (\>= 1.0.1)         | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    coincident_profile             dif_TP      TP_BryBoschan 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:56:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3522541f4_1739681759
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwhFNJx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Coinprofile_v0.1.9-tikzDictionary"
