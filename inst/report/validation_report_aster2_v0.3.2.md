...
Overall the package has 20 exported objects. 20 are documented:
                     ...
                     asterdata                  constancy 
                          TRUE                       TRUE 
                      cumulant              fam.bernoulli 
                          TRUE                       TRUE 
               fam.multinomial  fam.normal.location.scale 
                          TRUE                       TRUE 
                   fam.poisson fam.zero.truncated.poisson 
                          TRUE                       TRUE 
                       is.same          is.validasterdata 
                          TRUE                       TRUE 
                 is.validtheta                 is.validxi 
                          TRUE                       TRUE 
                      jacobian                       link 
                          TRUE                       TRUE 
          transformConditional         transformSaturated 
                          TRUE                       TRUE 
        transformUnconditional             validasterdata 
                          TRUE                       TRUE 
                    validtheta                    validxi 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-14 07:29:16 UTC |
...
running this report
    ...
    PROCESSX_PS1c093c79a702_1739518153
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkRzvDp
