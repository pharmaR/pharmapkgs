# Validation Report - chemdeg@0.1.4
...
| export_help          | 12                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Matteo Migliorini <matteo.migliorini@univr.it> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/migliomatte/chemdeg         |
...
Overall the package has 12 exported objects. 12 are documented:
               ...
               AICC     chiquad_red       det_order           f_gen            FOMT 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              FOMTm goodness_of_fit        kin_regr    par_est_FOMT     phase_space 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           plot_ord         results 
               TRUE            TRUE 
...
| Execution Time | 2025-02-16 04:11:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc352c8b408_1739679076
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOu35jt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chemdeg_v0.1.4-tikzDictionary"
