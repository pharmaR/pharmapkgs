...
| size_codebase        | 136                                                  |
| has_source_control   | https://github.com/XiaoouPan/adaHuber                |
...
| 2   | Rcpp                            | LinkingTo |
| 3   | RcppArmadillo (\>= 0.9.850.1.0) | LinkingTo |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         adaHuber.cov adaHuber.cv.lasso    adaHuber.lasso     adaHuber.mean 
                 TRUE              TRUE              TRUE              TRUE 
         adaHuber.reg 
                 TRUE 
...
| Execution Time | 2025-02-14 06:34:18 UTC |
...
running this report
    ...
    PROCESSX_PS726d5717c729_1739514855
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIghr2H
