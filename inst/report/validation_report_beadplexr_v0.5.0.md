# Validation Report - beadplexr@0.5.0
...
| export_help          | 31                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Ulrik Stervbo <ulrik.stervbo@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://gitlab.com/ustervbo/beadplexr   |
...
Overall the package has 31 exported objects. 31 are documented:
                  ...
                  approx_adjust       as_data_frame_analyte 
                           TRUE                        TRUE 
                       bp_clara                   bp_dbscan 
                           TRUE                        TRUE 
                 bp_density_cut                   bp_kmeans 
                           TRUE                        TRUE 
                      bp_mclust            calc_analyte_mfi 
                           TRUE                        TRUE 
                  calc_std_conc     calculate_concentration 
                           TRUE                        TRUE 
                    density_cut                   despeckle 
                           TRUE                        TRUE 
                 dist_chebyshev      do_find_turning_points 
                           TRUE                        TRUE 
                 facs_density1d              facs_density2d 
                           TRUE                        TRUE 
                    facs_hexbin                   facs_plot 
                           TRUE                        TRUE 
                   facs_scatter          fit_standard_curve 
                           TRUE                        TRUE 
               identify_analyte        identify_cba_analyte 
                           TRUE                        TRUE 
    identify_legendplex_analyte   identify_macsplex_analyte 
                           TRUE                        TRUE 
                     load_panel               plot_estimate 
                           TRUE                        TRUE 
                 plot_std_curve        plot_target_est_conc 
                           TRUE                        TRUE 
                       read_fcs             trim_population 
                           TRUE                        TRUE 
                  turning_point 
                           TRUE 
...
| Execution Time | 2025-02-15 03:49:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd31faff4c_1739591378
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTQuP44
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beadplexr_v0.5.0-tikzDictionary"
