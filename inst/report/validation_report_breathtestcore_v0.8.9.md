# Validation Report - breathtestcore@0.8.9
...
| export_help          | 26                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Dieter Menne <dieter.menne@menne-biomed.de> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/dmenne/breathtestcore    |
...
Overall the package has 26 exported objects. 26 are documented:
                ...
                breathtest_data    breathtest_read_function 
                           TRUE                        TRUE 
                    btcore_file                cleanup_data 
                           TRUE                        TRUE 
                  coef_by_group          coef_diff_by_group 
                           TRUE                        TRUE 
                   cum_exp_beta                  dob_to_pdr 
                           TRUE                        TRUE 
                       exp_beta                  extract_id 
                           TRUE                        TRUE 
                       nlme_fit                     nls_fit 
                           TRUE                        TRUE 
                       null_fit         read_any_breathtest 
                           TRUE                        TRUE 
                  read_breathid           read_breathid_xml 
                           TRUE                        TRUE 
          read_breathtest_excel                   read_iris 
                           TRUE                        TRUE 
                  read_iris_csv    simulate_breathtest_data 
                           TRUE                        TRUE 
                 subsample_data            t50_bluck_coward 
                           TRUE                        TRUE 
                 t50_maes_ghoos t50_maes_ghoos_scintigraphy 
                           TRUE                        TRUE 
              tlag_bluck_coward             tlag_maes_ghoos 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-15 04:43:08 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5b84ef5_1739594583
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRFiAlc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_breathtestcore_v0.8.9-tikzDictionary"
