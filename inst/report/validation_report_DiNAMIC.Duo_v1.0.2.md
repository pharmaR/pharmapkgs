# Validation Report - DiNAMIC.Duo@1.0.2
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Vonn Walter <vwalter1@pennstatehealth.psu.edu>       |
...
Overall the package has 10 exported objects. 10 are documented:
          ...
          cyclicNullR   cyclicShiftColR          dataPrep     genomeChrPlot 
                 TRUE              TRUE              TRUE              TRUE 
           genomePlot        peelingOne peelingOneIterate        peelingTwo 
                 TRUE              TRUE              TRUE              TRUE 
    peelingTwoIterate    resultsProcess 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:07:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4727febfd_1739851658
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPhC5iW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiNAMIC.Duo_v1.0.2-tikzDictionary"
