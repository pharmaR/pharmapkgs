...
| export_help          | 27                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Neil Marchant <ngmarchant@gmail.com> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/cleanzr/clevr     |
...
Overall the package has 27 exported objects. 27 are documented:
                ...
                accuracy_pairs             adj_rand_index 
                          TRUE                       TRUE 
       balanced_accuracy_pairs         canonicalize_pairs 
                          TRUE                       TRUE 
        clusters_to_membership          clusters_to_pairs 
                          TRUE                       TRUE 
                  completeness contingency_table_clusters 
                          TRUE                       TRUE 
       contingency_table_pairs       eval_report_clusters 
                          TRUE                       TRUE 
             eval_report_pairs            f_measure_pairs 
                          TRUE                       TRUE 
               fowlkes_mallows      fowlkes_mallows_pairs 
                          TRUE                       TRUE 
                   homogeneity     membership_to_clusters 
                          TRUE                       TRUE 
           membership_to_pairs                mutual_info 
                          TRUE                       TRUE 
             pairs_to_clusters        pairs_to_membership 
                          TRUE                       TRUE 
               precision_pairs                 rand_index 
                          TRUE                       TRUE 
                  recall_pairs          sensitivity_pairs 
                          TRUE                       TRUE 
             specificity_pairs                  v_measure 
                          TRUE                       TRUE 
                variation_info 
                          TRUE 
...
| Execution Time | 2025-02-16 04:29:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37471585f_1739680146
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvC2DH1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clevr_v0.1.2-tikzDictionary"
