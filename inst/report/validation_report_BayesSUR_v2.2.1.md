# Validation Report - BayesSUR@2.2.1
...
| export_help          | 9                                  |
| has_website          | TRUE                               |
| has_maintainer       | Zhi Zhao <zhi.zhao@medisin.uio.no> |
| bugs_status          | 1                                  |
| has_source_control   | https://github.com/mbant/BayesSUR  |
...
Overall the package has 9 exported objects. 9 are documented:
         ...
         BayesSUR          elpd  getEstimator       plotCPO plotEstimator 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        plotGraph plotManhattan  plotMCMCdiag   plotNetwork 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-21 13:14:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a763061ce_1740143642
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpY3RlsA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesSUR_v2.2.1-tikzDictionary"
