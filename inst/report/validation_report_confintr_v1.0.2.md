# Validation Report - confintr@1.0.2
...
| export_help          | 29                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Michael Mayer <mayermichael79@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/mayer79/confintr      |
| has_bug_reports_url  | 1                                        |
| downloads_1yr        | 105835                                   |
...
Overall the package has 29 exported objects. 29 are documented:
        ...
        ci_chisq_ncp           ci_cor      ci_cramersv         ci_f_ncp 
                TRUE             TRUE             TRUE             TRUE 
              ci_IQR      ci_kurtosis           ci_mad          ci_mean 
                TRUE             TRUE             TRUE             TRUE 
        ci_mean_diff        ci_median   ci_median_diff     ci_oddsratio 
                TRUE             TRUE             TRUE             TRUE 
       ci_proportion      ci_quantile ci_quantile_diff      ci_rsquared 
                TRUE             TRUE             TRUE             TRUE 
               ci_sd      ci_skewness           ci_var         cramersv 
                TRUE             TRUE             TRUE             TRUE 
             is.cint         kurtosis           moment        oddsratio 
                TRUE             TRUE             TRUE             TRUE 
             se_mean     se_mean_diff    se_proportion           se_var 
                TRUE             TRUE             TRUE             TRUE 
            skewness 
                TRUE 
...
| Execution Time | 2025-02-17 03:43:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6821fd01_1739763784
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAW9quZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_confintr_v1.0.2-tikzDictionary"
