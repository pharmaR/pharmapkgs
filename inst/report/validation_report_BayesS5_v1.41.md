# Validation Report - BayesS5@1.41
...
| export_help          | 17                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Minsuk Shin <minsuk000@gmail.com>                    |
...
Overall the package has 17 exported objects. 17 are documented:
    ...
    Bernoulli_Uniform         hyper_par         ind_fun_g      ind_fun_NLfP 
                 TRUE              TRUE              TRUE              TRUE 
        ind_fun_pemom     ind_fun_pimom         obj_fun_g     obj_fun_pemom 
                 TRUE              TRUE              TRUE              TRUE 
        obj_fun_pimom            result     result_est_LS    result_est_MAP 
                 TRUE              TRUE              TRUE              TRUE 
                   S5       S5_additive       S5_parallel               SSS 
                 TRUE              TRUE              TRUE              TRUE 
              Uniform 
                 TRUE 
...
| Execution Time | 2025-02-15 03:41:03 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd174b8641_1739590859
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpq1YZcY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesS5_v1.41-tikzDictionary"
