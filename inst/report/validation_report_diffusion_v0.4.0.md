# Validation Report - diffusion@0.4.0
...
| export_help          | 8                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Oliver Schaer <info@oliverschaer.ch> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/mamut86/diffusion |
| has_bug_reports_url  | 1                                    |
| downloads_1yr        | 4068                                 |
| reverse_dependencies | 0                                    |
| has_examples         | 0.5789474                            |
| dependencies         | 3                                    |
| license              | LGPL-2.1                             |
...
Overall the package has 8 exported objects. 8 are documented:
                  ...
                  difcurve              diffusion                is.bass 
                      TRUE                   TRUE                   TRUE 
              is.diffusion             Nortonbass       Nortonbass_error 
                      TRUE                   TRUE                   TRUE 
    Nortonbass_startvalgen           seqdiffusion 
                      TRUE                   TRUE 

### Examples

There are 11 help pages with examples, from 19 (57.89 %).
...
| Execution Time | 2025-02-18 04:04:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4341eff44_1739851473
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpvt3aG9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diffusion_v0.4.0-tikzDictionary"
