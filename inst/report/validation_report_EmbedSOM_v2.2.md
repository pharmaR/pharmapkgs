# Validation Report - EmbedSOM@2.2
...
| export_help          | 23                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mirek Kratochvil <exa.exa@gmail.com>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/exaexa/EmbedSOM                   |
...
Overall the package has 23 exported objects. 23 are documented:
        ...
        ClusterPalette           EmbedSOM         ExprColors ExpressionGradient 
                  TRUE               TRUE               TRUE               TRUE 
     ExpressionPalette             GQTSOM        GraphCoords     Initialize_PCA 
                  TRUE               TRUE               TRUE               TRUE 
             kMeansMap          kNNCoords     MapDataToCodes          MSTCoords 
                  TRUE               TRUE               TRUE               TRUE 
        NormalizeColor           PlotData        PlotDefault          PlotEmbed 
                  TRUE               TRUE               TRUE               TRUE 
                PlotGG          RandomMap                SOM         tSNECoords 
                  TRUE               TRUE               TRUE               TRUE 
            UMAPCoords      UMatrixCoords         uwotCoords 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:00:07 UTC |
...
running this report
    ...
    PROCESSX_PS1d45654ba1f0_1739937601
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPnPMqe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EmbedSOM_v2.2-tikzDictionary"
