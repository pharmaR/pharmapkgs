# Validation Report - colorr@1.0.0
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Charles Crabtree <ccrabtr@umich.edu>                 |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    epl.colors mlb.colors nba.colors nfl.colors nhl.colors 
...
| Execution Time | 2025-02-16 05:00:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36fa8d37e_1739682006
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDNlOMH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colorr_v1.0.0-tikzDictionary"
