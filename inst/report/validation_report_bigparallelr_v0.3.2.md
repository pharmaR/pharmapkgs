# Validation Report - bigparallelr@0.3.2
...
| has_source_control   | https://github.com/privefl/bigparallelr    |
...
| 3   | flock                  | Imports |
| 4   | parallel               | Imports |
| 5   | parallelly             | Imports |
| 6   | RhpcBLASctl            | Imports |
| 7   | foreach                | Depends |
...
bigsnpr, bigstatsr, bigutilsr, Compositional, PRSPGx

## Namespace

Overall the package has 19 exported objects. 19 are documented:

          assert_cores         cols_along    get_blas_ncores               lock 
                  TRUE               TRUE               TRUE               TRUE 
           makeCluster           nb_cores               plus  register_parallel 
                  TRUE               TRUE               TRUE               TRUE 
    registerDoParallel         rows_along          seq_range    set_blas_ncores 
                  TRUE               TRUE               TRUE               TRUE 
           split_costs           split_df          split_len     split_parapply 
                  TRUE               TRUE               TRUE               TRUE 
             split_vec        stopCluster             unlock 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:04:49 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd76e5b119_1739592284
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzLASAh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigparallelr_v0.3.2-tikzDictionary"
