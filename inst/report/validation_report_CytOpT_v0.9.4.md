# Validation Report - CytOpT@0.9.4
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Boris Hejblum <boris.hejblum@u-bordeaux.fr>          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/sistm/CytOpT-R/                   |
...
Overall the package has 7 exported objects. 7 are documented:
        ...
        barplot_prop     Bland_Altman           CytOpT  cytopt_desasc_r 
                TRUE             TRUE             TRUE             TRUE 
     cytopt_minmax_r          KL_plot Label_Prop_sto_r 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:47:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66b206e84_1739767647
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpopQ5Vk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CytOpT_v0.9.4-tikzDictionary"
