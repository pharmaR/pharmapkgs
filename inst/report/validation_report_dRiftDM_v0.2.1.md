# Validation Report - dRiftDM@0.2.1
...
| export_help          | 30                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Valentin Koob <v.koob@web.de>        |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/bucky2177/dRiftDM |
...
Overall the package has 30 exported objects. 30 are documented:
                ...
                b_coding           b_coding<-           calc_stats 
                    TRUE                 TRUE                 TRUE 
                  coef<-            comp_funs          comp_funs<- 
                    TRUE                 TRUE                 TRUE 
         component_shelf                conds               dmc_dm 
                    TRUE                 TRUE                 TRUE 
                drift_dm       estimate_model   estimate_model_ids 
                    TRUE                 TRUE                 TRUE 
               flex_prms          flex_prms<- get_example_fits_ids 
                    TRUE                 TRUE                 TRUE 
           load_fits_ids     modify_flex_prms             obs_data 
                    TRUE                 TRUE                 TRUE 
              obs_data<-           prms_solve         prms_solve<- 
                    TRUE                 TRUE                 TRUE 
             ratcliff_dm    re_evaluate_model        simulate_data 
                    TRUE                 TRUE                 TRUE 
         simulate_traces      simulate_values               solver 
                    TRUE                 TRUE                 TRUE 
                solver<-               ssp_dm        unpack_traces 
                    TRUE                 TRUE                 TRUE 

### Examples

There are 115 help pages with examples, from 115 (100.00 %).
...
| Execution Time | 2025-02-18 04:46:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb425b69ef5_1739853971
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpr4J9YX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dRiftDM_v0.2.1-tikzDictionary"
