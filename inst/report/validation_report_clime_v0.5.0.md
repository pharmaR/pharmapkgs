...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Xi (Rossi) Luo <xi.rossi.luo@gmail.com>              |
...
DensParcorr, growthrate, HDTSA, lorec, pulsar, TransGraph

## Namespace

Overall the package has 4 exported objects. 4 are documented:

         clime   cv.clime likelihood    tracel2 
          TRUE       TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-16 04:31:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3625c2806_1739680289
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAhark8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clime_v0.5.0-tikzDictionary"
