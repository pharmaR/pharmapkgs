# Validation Report - equateIRT@2.5.1
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Michela Battauz <michela.battauz@uniud.it>           |
...
equateMultiple, kequate

## Namespace

Overall the package has 17 exported objects. 17 are documented:

           alldirec      bisectorec         chainec         convert        dif.test 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              direc             eqc         id.test import.flexmirt   import.irtpro 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         import.ltm     import.mirt             itm           linkp          modIRT 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              score         sd.test 
               TRUE            TRUE 
...
| Execution Time | 2025-02-19 04:23:41 UTC |
...
running this report
    ...
    PROCESSX_PS1d456245c5c1_1739939014
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp84YO7b
...
These are the options set to generate the report:
    ...
    [1] "validation_report_equateIRT_v2.5.1-tikzDictionary"
