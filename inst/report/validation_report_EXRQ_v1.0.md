...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Huixia Judy Wang <judywang@gwu.edu>                  |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    est.gamma.func      Estc.func   EVI.CFG.func PowT.1tau.func        qpareto 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           rpareto  select.k.func      testC.EVI     ThreeStage       TwoStage 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:55:03 UTC |
...
running this report
    ...
    PROCESSX_PS1d452725f9cd_1739940896
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuKLLD1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EXRQ_v1.0-tikzDictionary"
