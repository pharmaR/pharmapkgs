...
| size_codebase        | 200                                       |
| has_source_control   | https://github.com/cloudyr/aws.comprehend |
...
Overall the package has 8 exported objects. 8 are documented:
             ...
             comprehendHTTP         detect_entities         detect_language 
                       TRUE                    TRUE                    TRUE 
    detect_medical_entities      detect_medical_phi          detect_phrases 
                       TRUE                    TRUE                    TRUE 
           detect_sentiment           detect_syntax 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-14 07:36:33 UTC |
...
running this report
    ...
    PROCESSX_PS1c0956375957_1739518589
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfELVwa
