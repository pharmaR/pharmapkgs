# Validation Report - DTComPair@1.2.6
...
| has_source_control | https://github.com/chstock/DTComPair |
...
Overall the package has 21 exported objects. 21 are documented:
           ...
           acc.1test       acc.paired              DLR      dlr.regtest 
                TRUE             TRUE             TRUE             TRUE 
      ellipse.pv.rpv  generate.paired            pv.gs          pv.prev 
                TRUE             TRUE             TRUE             TRUE 
              pv.rpv           pv.wgs   read.tab.1test  read.tab.paired 
                TRUE             TRUE             TRUE             TRUE 
      represent.long     sesp.diff.ci  sesp.exactbinom sesp.gen.mcnemar 
                TRUE             TRUE             TRUE             TRUE 
        sesp.mcnemar         sesp.rel        tab.1test       tab.paired 
                TRUE             TRUE             TRUE             TRUE 
          tpffpf.rel 
                TRUE 
...
| Execution Time | 2025-02-18 04:55:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb459d85ea7_1739854511
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpo1MQSg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DTComPair_v1.2.6-tikzDictionary"
