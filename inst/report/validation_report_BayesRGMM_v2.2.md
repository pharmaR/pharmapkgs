# Validation Report - BayesRGMM@2.2
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Kuo-Jung Lee <kuojunglee@ncku.edu.tw>                |
...
Overall the package has 7 exported objects. 7 are documented:
                                    ...
                                    AR1.cor                BayesCumulativeProbitHSD 
                                       TRUE                                    TRUE 
                          BayesRobustProbit                BayesRobustProbitSummary 
                                       TRUE                                    TRUE 
                                CorrMat.HSD                  SimulatedDataGenerator 
                                       TRUE                                    TRUE 
...
| Execution Time | 2025-02-15 03:40:38 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2e10460_1739590833
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9vFHJ3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesRGMM_v2.2-tikzDictionary"
