# Validation Report - BoostMLR@1.0.3
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Amol Pande <amoljpande@gmail.com>                    |
...
Overall the package has 9 exported objects. 9 are documented:
            ...
            BoostMLR    BoostMLR.news partial.BoostMLR     plotBoostMLR 
                TRUE             TRUE             TRUE             TRUE 
            plotVIMP  predictBoostMLR          simLong   updateBoostMLR 
                TRUE             TRUE             TRUE             TRUE 
       vimp.BoostMLR 
                TRUE 
...
| Execution Time | 2025-02-15 04:32:49 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd35c8c9f_1739593964
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6Epqct
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BoostMLR_v1.0.3-tikzDictionary"
