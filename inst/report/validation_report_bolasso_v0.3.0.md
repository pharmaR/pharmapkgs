# Validation Report - bolasso@0.3.0
...
| export_help          | 7                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Daniel Molitor <molitdj97@gmail.com> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/dmolitor/bolasso  |
...
| 2   | future.apply (\>= 1.1.0) | Imports |
| 3   | gamlr (\>= 1.0)          | Imports |
| 4   | generics                 | Imports |
| 5   | ggplot2                  | Imports |
| 6   | glmnet (\>= 3.0)         | Imports |
| 7   | progressr                | Imports |
| 8   | stats                    | Imports |
| 9   | tibble                   | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
                      ...
                      bolasso   plot_selected_variables plot_selection_thresholds 
                         TRUE                      TRUE                      TRUE 
           selected_variables             selected_vars      selection_thresholds 
                         TRUE                      TRUE                      TRUE 
                         tidy 
                         TRUE 
...
| Execution Time | 2025-02-15 04:30:56 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2dc6b861_1739593851
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp43saet
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bolasso_v0.3.0-tikzDictionary"
