# Validation Report - climatrends@0.5
...
| export_help          | 9                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Kauê de Sousa <desousa.kaue@gmail.com> |
...
chirps, ClimMobTools, gosset

## Namespace

Overall the package has 9 exported objects. 9 are documented:

    crop_sensitive     cumdrought        cumrain            ETo            GDD 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    get_timeseries     late_frost       rainfall    temperature 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:31:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31cfc3c38_1739680272
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxQJiHl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_climatrends_v0.5-tikzDictionary"
