# Validation Report - BayesDIP@0.1.1
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Chen Wang <wangc10@vcu.edu>                          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | <https://github.com/chenw10/BayesDIP>                |
...
Overall the package has 10 exported objects. 10 are documented:
           ...
           OneSampleBernoulli OneSampleBernoulli.Design          OneSampleNormal1 
                         TRUE                      TRUE                      TRUE 
      OneSampleNormal1.Design          OneSampleNormal2   OneSampleNormal2.Design 
                         TRUE                      TRUE                      TRUE 
             OneSamplePoisson   OneSamplePoisson.Design        TwoSampleBernoulli 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-15 03:33:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1d1e568f_1739590417
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpObsYTc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesDIP_v0.1.1-tikzDictionary"
