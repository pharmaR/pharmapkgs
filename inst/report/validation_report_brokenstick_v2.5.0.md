# Validation Report - brokenstick@2.5.0
...
Overall the package has 8 exported objects. 8 are documented:
        ...
        brokenstick      control_kr       get_knots       get_omega          get_r2 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                 kr plot_trajectory     set_control 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:46:05 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2f051082_1739594760
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIV4yjD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brokenstick_v2.5.0-tikzDictionary"
