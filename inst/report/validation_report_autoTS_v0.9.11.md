...
| export_help          | 15                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Vivien Roussez <vivien.roussez@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| size_codebase        | 216                                       |
| has_source_control   | https://github.com/vivienroussez/autoTS   |
...
Overall the package has 15 exported objects. 15 are documented:
         ...
         complete.ts     getBestModel     getFrequency          my.bats 
                TRUE             TRUE             TRUE             TRUE 
              my.ets           my.mae   my.predictions       my.prophet 
                TRUE             TRUE             TRUE             TRUE 
             my.rmse        my.sarima     my.shortterm          my.stlm 
                TRUE             TRUE             TRUE             TRUE 
            my.tbats       prepare.ts runUserInterface 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-14 07:35:10 UTC |
...
running this report
    ...
    PROCESSX_PS1c0995fbf6e_1739518507
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpazXVQZ
