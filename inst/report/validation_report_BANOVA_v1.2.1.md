...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Chen Dong <chendong.math.umd@gmail.com>              |
...
Overall the package has 20 exported objects. 20 are documented:
                    ...
                    BAnova       BANOVA.Bernoulli        BANOVA.Binomial 
                      TRUE                   TRUE                   TRUE 
              BANOVA.build      BANOVA.floodlight       BANOVA.mediation 
                      TRUE                   TRUE                   TRUE 
              BANOVA.model BANOVA.multi.mediation     BANOVA.Multinomial 
                      TRUE                   TRUE                   TRUE 
             BANOVA.Normal  BANOVA.ordMultinomial         BANOVA.Poisson 
                      TRUE                   TRUE                   TRUE 
                BANOVA.run          BANOVA.simple               BANOVA.T 
                      TRUE                   TRUE                   TRUE 
                 conv.diag           pairs.BANOVA      table.predictions 
                      TRUE                   TRUE                   TRUE 
             table.pvalues             trace.plot 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-14 07:42:16 UTC |
...
running this report
    ...
    PROCESSX_PS1c0936c554bd_1739518933
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpizdqk5
