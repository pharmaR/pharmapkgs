# Validation Report - evalITR@1.0.0
...
| export_help          | 18                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Michael Lingzhi Li <mili@hbs.edu>     |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/MichaelLLi/evalITR |
...
| 1   | dplyr (\>= 1.0)    | Depends |
| 2   | MASS (\>= 7.0)     | Depends |
| 3   | Matrix (\>= 1.0)   | Depends |
| 4   | quadprog (\>= 1.0) | Depends |
| 5   | stats              | Depends |
| 6   | caret              | Imports |
| 7   | cli                | Imports |
| 8   | e1071              | Imports |
...
| 21  | scales             | Imports |
| 22  | utils              | Imports |
| 23  | bartCause          | Imports |
| 24  | SuperLearner       | Imports |
...
Overall the package has 18 exported objects. 18 are documented:
             ...
             AUPEC        AUPECcv   consist.test consistcv.test   estimate_itr 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      evaluate_itr           GATE         GATEcv       het.test     hetcv.test 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              PAPD         PAPDcv           PAPE         PAPEcv            PAV 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             PAVcv  plot_estimate       test_itr 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:37:50 UTC |
...
running this report
    ...
    PROCESSX_PS1d459a97688_1739939864
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB6llrn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evalITR_v1.0.0-tikzDictionary"
