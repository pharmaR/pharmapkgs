# Validation Report - catsim@0.2.4
...
Overall the package has 14 exported objects. 14 are documented:
             ...
             adj_rand       adjusted_mi           binssim       catmssim_2d 
                 TRUE              TRUE              TRUE              TRUE 
     catmssim_3d_cube catmssim_3d_slice            catsim       cohen_kappa 
                 TRUE              TRUE              TRUE              TRUE 
                 gini          ginicorr     normalized_mi        rand_index 
                 TRUE              TRUE              TRUE              TRUE 
             sqrtgini      sqrtginicorr 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-16 03:48:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bc335085b0e_1739677682
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCTQcUw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_catsim_v0.2.4-tikzDictionary"
