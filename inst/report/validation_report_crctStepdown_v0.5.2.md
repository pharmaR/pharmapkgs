# Validation Report - crctStepdown@0.5.2
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Sam Watson <s.i.watson@bham.ac.uk>                   |
...
|     | package                   | type      |
|:----|:--------------------------|:----------|
| 1   | Rcpp (\>= 0.12.0)         | LinkingTo |
| 2   | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 3   | RcppParallel (\>= 5.0.1)  | LinkingTo |
| 4   | fastglm (\>= 0.0.3)       | LinkingTo |
| 5   | fastglm                   | Imports   |
| 6   | Rcpp                      | Imports   |
| 7   | ggplot2                   | Imports   |
| 8   | ggpubr                    | Imports   |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    est_null_model gen_rand_order    outname_fit setParallelCRT       simpleLM 
...
| Execution Time | 2025-02-17 04:18:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bd674980b4c_1739765908
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLsqdzC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crctStepdown_v0.5.2-tikzDictionary"
