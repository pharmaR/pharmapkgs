# Validation Report - Bchron@4.7.6
...
| export_help          | 14                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Andrew Parnell <Andrew.Parnell@mu.ie> |
...
Overall the package has 14 exported objects. 13 are documented:
                  ...
                  %>%   BchronCalibrate       BchronCheck     BchronDensity 
                FALSE              TRUE              TRUE              TRUE 
    BchronDensityFast       Bchronology         BchronRSL   choosePositions 
                 TRUE              TRUE              TRUE              TRUE 
        coreInfluence    createCalCurve     dateInfluence               hdr 
                 TRUE              TRUE              TRUE              TRUE 
           sampleAges       unCalibrate 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-15 03:46:30 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd430c6b86_1739591185
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGcPd30
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Bchron_v4.7.6-tikzDictionary"
