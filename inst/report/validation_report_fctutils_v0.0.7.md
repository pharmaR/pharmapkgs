# Validation Report - fctutils@0.0.7
...
| export_help          | 52                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Kai Guo <guokai8@gmail.com>                          |
...
Overall the package has 52 exported objects. 52 are documented:
              ...
              ft_apply       ft_char_freq    ft_collapse_lev         ft_combine 
                  TRUE               TRUE               TRUE               TRUE 
             ft_concat           ft_count          ft_decode           ft_dummy 
                  TRUE               TRUE               TRUE               TRUE 
         ft_duplicates          ft_encode         ft_extract       ft_factorize 
                  TRUE               TRUE               TRUE               TRUE 
        ft_filter_freq     ft_filter_func      ft_filter_pos            ft_freq 
                  TRUE               TRUE               TRUE               TRUE 
    ft_group_by_prefix          ft_impute          ft_insert       ft_intersect 
                  TRUE               TRUE               TRUE               TRUE 
                ft_len   ft_level_lengths     ft_level_order     ft_level_stats 
                  TRUE               TRUE               TRUE               TRUE 
           ft_map_func         ft_mapping           ft_merge   ft_merge_similar 
                  TRUE               TRUE               TRUE               TRUE 
                 ft_na      ft_pad_levels           ft_pairs ft_pattern_replace 
                  TRUE               TRUE               TRUE               TRUE 
                ft_pos      ft_regex_freq   ft_remove_levels   ft_rename_levels 
                  TRUE               TRUE               TRUE               TRUE 
     ft_reorder_within         ft_replace      ft_replace_na ft_replace_pattern 
                  TRUE               TRUE               TRUE               TRUE 
            ft_reverse          ft_rollup   ft_sample_levels            ft_sort 
                  TRUE               TRUE               TRUE               TRUE 
        ft_sort_custom           ft_split    ft_split_levels             ft_sub 
                  TRUE               TRUE               TRUE               TRUE 
        ft_substr_freq           ft_table           ft_union     ft_unique_comb 
                  TRUE               TRUE               TRUE               TRUE 

### Examples

There are 52 help pages with examples, from 52 (100.00 %).
...
| Execution Time | 2025-02-27 03:21:22 UTC |
...
running this report
    ...
    PROCESSX_PS1c6238d40057_1740626478
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeiDgRD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fctutils_v0.0.7-tikzDictionary"
