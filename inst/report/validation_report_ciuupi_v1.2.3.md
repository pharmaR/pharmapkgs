# Validation Report - ciuupi@1.2.3
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Paul Kabaila <P.Kabaila@latrobe.edu.au>              |
...
Overall the package has 11 exported objects. 11 are documented:
               ...
               acX_to_rho             bs_ciuupi              bsspline 
                     TRUE                  TRUE                  TRUE 
              ci_standard ciuupi_observed_value              cpciuupi 
                     TRUE                  TRUE                  TRUE 
                   plot_b               plot_cp                plot_s 
                     TRUE                  TRUE                  TRUE 
         plot_squared_sel             selciuupi 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:23:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3698050a6_1739679833
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvkOXXe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ciuupi_v1.2.3-tikzDictionary"
