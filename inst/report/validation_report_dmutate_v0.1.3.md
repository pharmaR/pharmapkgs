# Validation Report - dmutate@0.1.3
...
| export_help          | 17                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Kyle T Baron <kylebtwin@imap.cc>     |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/kylebaron/dmutate |
...
Overall the package has 15 exported objects. 16 are documented:

         as_idata     as.covset build_covform  build_covobj        covset 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          dmutate mutate_random    new_covobj         rbern     rbinomial 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       rlmassnorm      rlmvnorm     rmassnorm       rmvnorm         rvset 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 04:28:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4715a2d6d_1739852907
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmK0WIC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dmutate_v0.1.3-tikzDictionary"
