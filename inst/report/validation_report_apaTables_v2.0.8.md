...
| export_help          | 9                                      |
| has_website          | TRUE                                   |
| has_maintainer       | David Stanley <dstanley@uoguelph.ca>   |
| bugs_status          | 0.1333333                              |
| size_codebase        | 2668                                   |
| has_source_control   | https://github.com/dstanley4/apaTables |
...
Overall the package has 9 exported objects. 9 are documented:
                ...
                apa.1way.table             apa.2way.table 
                          TRUE                       TRUE 
                 apa.aov.table              apa.cor.table 
                          TRUE                       TRUE 
                   apa.d.table          apa.ezANOVA.table 
                          TRUE                       TRUE 
            apa.reg.boot.table              apa.reg.table 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-14 07:17:05 UTC |
...
running this report
    ...
    PROCESSX_PS1c096783c260_1739517422
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOn0QeV
