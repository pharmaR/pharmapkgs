# Validation Report - delayed@0.5.0
...
| export_help          | 10                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Jeremy Coyle <jeremyrcoyle@gmail.com> |
...
| 2   | igraph      | Imports |
| 3   | future      | Imports |
| 4   | rstackdeque | Imports |
| 5   | rlang       | Imports |
| 6   | data.table  | Imports |
| 7   | visNetwork  | Imports |
| 8   | uuid        | Imports |
| 9   | BBmisc      | Imports |
| 10  | progress    | Imports |
| 11  | R.utils     | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
        ...
        bundle_delayed            delayed            Delayed        delayed_fun 
                  TRUE               TRUE               TRUE               TRUE 
          eval_delayed find_delayed_error          FutureJob plot_delayed_shiny 
                  TRUE               TRUE               TRUE               TRUE 
             Scheduler      SequentialJob 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-18 03:38:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb461c469b2_1739849885
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIgVxWD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_delayed_v0.5.0-tikzDictionary"
