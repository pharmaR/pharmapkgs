...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Stefan Konigorski <stefan.konigorski@gmail.com>      |
...
Overall the package has 16 exported objects. 16 are documented:
                          ...
                          cjamp                  cjamp_loop 
                           TRUE                        TRUE 
               compute_expl_var                 compute_MAF 
                           TRUE                        TRUE 
        generate_clayton_copula     generate_doubleton_data 
                           TRUE                        TRUE 
              generate_genodata        generate_phenodata_1 
                           TRUE                        TRUE 
    generate_phenodata_1_simple    generate_phenodata_2_bvn 
                           TRUE                        TRUE 
    generate_phenodata_2_copula     generate_singleton_data 
                           TRUE                        TRUE 
            get_estimates_naive                  lrt_copula 
                           TRUE                        TRUE 
                      lrt_param                 minusloglik 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-16 04:24:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3d67eaf2_1739679862
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpx4reDC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CJAMP_v0.1.1-tikzDictionary"
