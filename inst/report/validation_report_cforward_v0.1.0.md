# Validation Report - cforward@0.1.0
...
| has_source_control   | https://github.com/muschellij2/cforward |
...
Overall the package has 5 exported objects. 4 are documented:
                     ...
                     %>%             cforward         cforward_one 
                   FALSE                 TRUE                 TRUE 
    estimate_concordance           make_folds 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:04:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35ecda05e_1739678695
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpF6SLKu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cforward_v0.1.0-tikzDictionary"
