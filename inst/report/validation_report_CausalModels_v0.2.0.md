# Validation Report - CausalModels@0.2.0
...
| export_help          | 9                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Joshua Anderson <jwanderson198@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/ander428/CausalModels  |
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          doubly_robust         gestimation         init_params         ipweighting 
                   TRUE                TRUE                TRUE                TRUE 
                 iv_est  outcome_regression propensity_matching   propensity_scores 
                   TRUE                TRUE                TRUE                TRUE 
        standardization 
                   TRUE 
...
| Execution Time | 2025-02-16 03:49:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bc334f9f97d_1739677790
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMQCZOD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CausalModels_v0.2.0-tikzDictionary"
