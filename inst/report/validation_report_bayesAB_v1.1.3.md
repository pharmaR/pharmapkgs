# Validation Report - bayesAB@1.1.3
...
| export_help          | 14                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Frank Portman <frank1214@gmail.com>     |
| bugs_status          | 0.7666667                               |
| has_source_control   | https://github.com/FrankPortman/bayesAB |
...
| 2   | ggplot2 (\>= 3.2.0) | Imports   |
| 3   | methods             | Imports   |
| 4   | rlang (\>= 0.4.0)   | Imports   |
| 5   | Rcpp                | LinkingTo |
...
Overall the package has 14 exported objects. 14 are documented:
             ...
             banditize          bayesTest            combine       deployBandit 
                  TRUE               TRUE               TRUE               TRUE 
                  grab           plotBeta          plotGamma       plotInvGamma 
                  TRUE               TRUE               TRUE               TRUE 
         plotLogNormal         plotNormal plotNormalInvGamma         plotPareto 
                  TRUE               TRUE               TRUE               TRUE 
           plotPoisson             rename 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 03:31:24 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd442bd024_1739590280
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkK05Tm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesAB_v1.1.3-tikzDictionary"
