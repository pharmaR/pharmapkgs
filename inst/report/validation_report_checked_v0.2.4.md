# Validation Report - checked@0.2.4
...
| has_source_control   | https://github.com/Genentech/checked      |
| has_bug_reports_url  | 1                                         |
| downloads_1yr        | 4181                                      |
| reverse_dependencies | 0                                         |
| has_examples         | 0.8974359                                 |
| dependencies         | 9                                         |
...
Overall the package has 23 exported objects. 23 are documented:
                   ...
                   check_design          check_dev_rev_deps 
                           TRUE                        TRUE 
                      check_dir                  check_pkgs 
                           TRUE                        TRUE 
                 check_rev_deps             check_task_spec 
                           TRUE                        TRUE 
       custom_install_task_spec           install_task_spec 
                           TRUE                        TRUE 
               new_check_design    new_rev_dep_check_design 
                           TRUE                        TRUE 
                   package_spec package_spec_archive_source 
                           TRUE                        TRUE 
            package_spec_source           reporter_ansi_tty 
                           TRUE                        TRUE 
             reporter_basic_tty            reporter_default 
                           TRUE                        TRUE 
                        results             results_to_file 
                           TRUE                        TRUE 
         rev_dep_check_tasks_df      revdep_check_task_spec 
                           TRUE                        TRUE 
                            run       source_check_tasks_df 
                           TRUE                        TRUE 
                      task_spec 
                           TRUE 
...
There are 35 help pages with examples, from 39 (89.74 %).
...
| Execution Time | 2025-02-16 04:10:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3787afc4e_1739678999
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7vc0Ca
...
These are the options set to generate the report:
    ...
    [1] "validation_report_checked_v0.2.4-tikzDictionary"
