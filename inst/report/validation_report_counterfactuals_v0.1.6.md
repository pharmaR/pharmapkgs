# Validation Report - counterfactuals@0.1.6
...
| export_help          | 10                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Susanne Dandl <dandls.datascience@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/dandls/counterfactuals    |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    CounterfactualMethodClassif    CounterfactualMethodRegr 
                           TRUE                        TRUE 
                     MOCClassif                     MOCRegr 
                           TRUE                        TRUE 
                    NICEClassif                    NICERegr 
                           TRUE                        TRUE 
            RandomSearchClassif            RandomSearchRegr 
                           TRUE                        TRUE 
                  WhatIfClassif                  WhatIfRegr 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-17 04:04:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6433d2ca4_1739765059
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcWCAdP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_counterfactuals_v0.1.6-tikzDictionary"
