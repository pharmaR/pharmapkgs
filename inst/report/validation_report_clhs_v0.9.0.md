...
| has_source_control   | https://github.com/pierreroudier/clhs/           |
...
Overall the package has 2 exported objects. 2 are documented:
                 ...
                 clhs similarity_buffer 
                 TRUE              TRUE 

### Examples

There are 2 help pages with examples, from 4 (50.00 %).
...
| Execution Time | 2025-02-16 04:29:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bc335bd7901_1739680152
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwPGGFs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clhs_v0.9.0-tikzDictionary"
