# Validation Report - convoSPAT@1.2.7
...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mark D. Risser <markdrisser@gmail.com>               |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | http://github.com/markdrisser/convoSPAT              |
...
Overall the package has 16 exported objects. 16 are documented:
                    ...
                    Aniso_fit               cov_spatial               evaluate_CV 
                         TRUE                      TRUE                      TRUE 
                 f_mc_kernels                kernel_cov       make_global_loglik1 
                         TRUE                      TRUE                      TRUE 
    make_global_loglik1_kappa       make_global_loglik2 make_global_loglik2_kappa 
                         TRUE                      TRUE                      TRUE 
          make_global_loglik3 make_global_loglik3_kappa make_global_loglik4_kappa 
                         TRUE                      TRUE                      TRUE 
               make_local_lik                      mc_N               NSconvo_fit 
                         TRUE                      TRUE                      TRUE 
                  NSconvo_sim 
                         TRUE 
...
| Execution Time | 2025-02-17 03:52:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6670bdf8d_1739764323
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYXPIgM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_convoSPAT_v1.2.7-tikzDictionary"
