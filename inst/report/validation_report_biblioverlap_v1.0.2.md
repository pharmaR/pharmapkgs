# Validation Report - biblioverlap@1.0.2
...
| export_help          | 6                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Gabriel Vieira <gabriel.vieira@bioqmed.ufrj.br> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/gavieira/biblioverlap        |
...
| 1   | dplyr         | Imports |
| 2   | ggplot2       | Imports |
| 3   | ggVennDiagram | Imports |
| 4   | magrittr      | Imports |
| 5   | Matrix        | Imports |
| 6   | parallel      | Imports |
| 7   | rlang         | Imports |
| 8   | shiny         | Imports |
| 9   | stringdist    | Imports |
| 10  | UpSetR        | Imports |
| 11  | uuid          | Imports |
...
Overall the package has 6 exported objects. 5 are documented:
                      ...
                      %>%          biblioverApp          biblioverlap 
                    FALSE                  TRUE                  TRUE 
    plot_matching_summary            plot_upset             plot_venn 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-15 04:01:19 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6f0fed92_1739592074
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPISevo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biblioverlap_v1.0.2-tikzDictionary"
