...
| size_codebase        | 995                                 |
| has_source_control   | https://github.com/ropensci/arkdb   |
...
Overall the package has 13 exported objects. 13 are documented:
                     ...
                     ark      arkdb_delete_db             local_db 
                    TRUE                 TRUE                 TRUE 
     local_db_disconnect       process_chunks  streamable_base_csv 
                    TRUE                 TRUE                 TRUE 
     streamable_base_tsv   streamable_parquet streamable_readr_csv 
                    TRUE                 TRUE                 TRUE 
    streamable_readr_tsv     streamable_table     streamable_vroom 
                    TRUE                 TRUE                 TRUE 
                   unark 
                    TRUE 
...
| Execution Time | 2025-02-14 07:23:59 UTC |
...
running this report
    ...
    PROCESSX_PS1c0961af26fb_1739517836
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgH14hu
