# Validation Report - chords@0.95.4
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jonathan Rosenblatt <johnros@bgu.ac.il>              |
...
Overall the package has 6 exported objects. 6 are documented:
           ...
           Estimate.b.k            getTheta initializeRdsObject     makeJackControl 
                   TRUE                TRUE                TRUE                TRUE 
          makeRdsSample   thetaSmoothingNks 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:15:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3a32e825_1739679344
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpg0rjh8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chords_v0.95.4-tikzDictionary"
