...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Josh Gardner <jpgard@umich.edu>                      |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    auc_compare    fbh_test      se_auc  stouffer_z 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-14 07:31:47 UTC |
...
running this report
    ...
    PROCESSX_PS1c097c3bac73_1739518304
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfnqDN5
