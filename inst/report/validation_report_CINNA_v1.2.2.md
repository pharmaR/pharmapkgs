...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Minoo Ashtiani <ashtiani.minoo@gmail.com>            |
...
| 2   | network    | Imports |
| 3   | sna        | Imports |
| 4   | centiserve | Imports |
| 5   | FactoMineR | Imports |
| 6   | factoextra | Imports |
| 7   | GGally     | Imports |
| 8   | pheatmap   | Imports |
| 9   | corrplot   | Imports |
| 10  | dendextend | Imports |
| 11  | viridis    | Imports |
| 12  | ggplot2    | Imports |
| 13  | Rtsne      | Imports |
| 14  | plyr       | Imports |
| 15  | circlize   | Imports |
| 16  | intergraph | Imports |
| 17  | utils      | Imports |
| 18  | stats      | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
              ...
              calculate_centralities  dangalchev_closeness_centrality 
                                TRUE                             TRUE 
             giant_component_extract         graph_extract_components 
                                TRUE                             TRUE 
                    group_centrality              harmonic_centrality 
                                TRUE                             TRUE 
           local_bridging_centrality          misc_extract_components 
                                TRUE                             TRUE 
                    pca_centralities              proper_centralities 
                                TRUE                             TRUE 
      summary_calculate_centralities summary_graph_extract_components 
                                TRUE                             TRUE 
            summary_pca_centralities        summary_tsne_centralities 
                                TRUE                             TRUE 
                   tsne_centralities            visualize_association 
                                TRUE                             TRUE 
              visualize_correlations             visualize_dendrogram 
                                TRUE                             TRUE 
                     visualize_graph                visualize_heatmap 
                                TRUE                             TRUE 
          visualize_pair_correlation          wiener_index_centrality 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-16 04:19:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35d378e6a_1739679580
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvzcMu5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CINNA_v1.2.2-tikzDictionary"
