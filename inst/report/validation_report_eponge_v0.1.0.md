# Validation Report - eponge@0.1.0
...
| export_help | 9 |
| has_website | TRUE |
| has_maintainer | Krzysztof Joachimiak <joachimiak.krzysztof@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/krzjoa/eponge |
...
Overall the package has 9 exported objects. 9 are documented:
                      ...
                      erase              erase_data                erase_df 
                       TRUE                    TRUE                    TRUE 
            erase_functions                erase_if           erase_masking 
                       TRUE                    TRUE                    TRUE 
    erase_masking_functions     erase_non_functions            erase_values 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-19 04:21:21 UTC |
...
running this report
    ...
    PROCESSX_PS1d4520203dca_1739938875
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp64qDS1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eponge_v0.1.0-tikzDictionary"
