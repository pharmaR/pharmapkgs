...
| export_help          | 8                                             |
| has_website          | TRUE                                          |
| has_maintainer       | Tim Taylor <tim.taylor@hiddenelephants.co.uk> |
...
Overall the package has 8 exported objects. 8 are documented:
           ...
           aggregate_age_counts          breaks_to_interval 
                           TRUE                        TRUE 
                       cut_ages          reaggregate_counts 
                           TRUE                        TRUE 
    reaggregate_interval_counts  reaggregate_interval_rates 
                           TRUE                        TRUE 
              reaggregate_rates       split_interval_counts 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-14 06:42:21 UTC |
...
running this report
    ...
    PROCESSX_PS726d3f1f430d_1739515338
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5fFSE9
