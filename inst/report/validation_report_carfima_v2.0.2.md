# Validation Report - carfima@2.0.2
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Hyungsuk Tak <hyungsuk.tak@gmail.com>                |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | mvtnorm(\>= 1.0-11)   | Imports |
| 2   | DEoptim (\>= 2.2-5)   | Imports |
| 3   | pracma (\>= 2.2.9)    | Imports |
| 4   | truncnorm (\>= 1.0-8) | Imports |
| 5   | invgamma (\>= 1.1)    | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
           ...
           carfima carfima.loglik    carfima.sim 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 03:42:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35fcaf_1739677335
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxygvMG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_carfima_v2.0.2-tikzDictionary"
