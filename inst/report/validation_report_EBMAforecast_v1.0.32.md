# Validation Report - EBMAforecast@1.0.32
...
| export_help          | 17                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Florian M. Hollenbach <fho.egb@cbs.dk>               |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/fhollenbach/EBMA/                 |
...
|     | package          | type      |
|:----|:-----------------|:----------|
| 1   | Rcpp (\>= 1.0.2) | Imports   |
| 2   | plyr             | Imports   |
| 3   | graphics         | Imports   |
| 4   | separationplot   | Imports   |
| 5   | Hmisc            | Imports   |
| 6   | abind            | Imports   |
| 7   | gtools           | Imports   |
| 8   | methods          | Imports   |
...
Overall the package has 4 exported objects. 13 are documented:

    calibrateEnsemble     compareModels       EBMApredict  makeForecastData 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 05:15:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43cb1671f_1739855737
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzvtmmF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EBMAforecast_v1.0.32-tikzDictionary"
