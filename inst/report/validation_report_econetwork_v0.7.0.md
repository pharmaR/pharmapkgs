# Validation Report - econetwork@0.7.0
...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Vincent Miele <vincent.miele@univ-lyon1.fr>          |
...
| 1   | stats       | Imports   |
| 2   | igraph      | Imports   |
| 3   | rdiversity  | Imports   |
| 4   | blockmodels | Imports   |
| 5   | bipartite   | Imports   |
| 6   | Rcpp        | Imports   |
| 7   | Rcpp        | LinkingTo |
...
Overall the package has 6 exported objects. 6 are documented:
          ...
          cpness  disPairwise divPartition       elgrin    embedding   getMetaweb 
...
| Execution Time | 2025-02-19 03:35:45 UTC |
...
running this report
    ...
    PROCESSX_PS1d453d4e209_1739936139
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpl9hzsV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_econetwork_v0.7.0-tikzDictionary"
