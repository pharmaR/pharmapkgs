# Validation Report - box.linters@0.10.5
...
| export_help | 22 |
| has_website | TRUE |
| has_maintainer | Ricardo Rodrigo Basa <opensource+rodrigo@appsilon.com> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/Appsilon/box.linters |
...
Overall the package has 22 exported objects. 22 are documented:
     ...
     box_alphabetical_calls_linter            box_default_linters 
                              TRUE                           TRUE 
      box_func_import_count_linter      box_mod_fun_exists_linter 
                              TRUE                           TRUE 
         box_pkg_fun_exists_linter      box_separate_calls_linter 
                              TRUE                           TRUE 
        box_trailing_commas_linter    box_universal_import_linter 
                              TRUE                           TRUE 
     box_unused_att_mod_obj_linter  box_unused_att_pkg_fun_linter 
                              TRUE                           TRUE 
    box_unused_attached_mod_linter box_unused_attached_pkg_linter 
                              TRUE                           TRUE 
                  box_usage_linter        is_treesitter_installed 
                              TRUE                           TRUE 
         namespaced_function_calls                r6_usage_linter 
                              TRUE                           TRUE 
             rhino_default_linters              style_box_use_dir 
                              TRUE                           TRUE 
                style_box_use_file             style_box_use_text 
                              TRUE                           TRUE 
     unused_declared_object_linter                  use_box_lintr 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-15 04:37:10 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2e3bad4d_1739594225
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzP02C9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_box.linters_v0.10.5-tikzDictionary"
