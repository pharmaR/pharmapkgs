# Validation Report - cellpypes@0.3.0
...
| export_help          | 12                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Felix Frauhammer <felixfrauhammer@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/FelixTheStudent/cellpypes |
...
Overall the package has 12 exported objects. 12 are documented:
          ...
          class_to_deseq2              classify                  feat 
                     TRUE                  TRUE                  TRUE 
                 find_knn          plot_classes             plot_last 
                     TRUE                  TRUE                  TRUE 
    pool_across_neighbors            pseudobulk         pseudobulk_id 
                     TRUE                  TRUE                  TRUE 
       pype_code_template      pype_from_seurat                  rule 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 03:58:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36a8c3a34_1739678322
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpr8KylB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cellpypes_v0.3.0-tikzDictionary"
