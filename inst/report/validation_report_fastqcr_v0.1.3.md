# Validation Report - fastqcr@0.1.3
...
| 4   | ggplot2             | Imports |
| 5   | magrittr            | Imports |
| 6   | readr (\>= 1.3.0)   | Imports |
| 7   | rmarkdown (\>= 1.4) | Imports |
| 8   | rvest               | Imports |
| 9   | tibble              | Imports |
| 10  | tidyr               | Imports |
| 11  | scales              | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
                ...
                fastqc     fastqc_install       qc_aggregate           qc_fails 
                  TRUE               TRUE               TRUE               TRUE 
               qc_plot qc_plot_collection        qc_problems            qc_read 
                  TRUE               TRUE               TRUE               TRUE 
    qc_read_collection          qc_report           qc_stats           qc_unzip 
                  TRUE               TRUE               TRUE               TRUE 
              qc_warns 
                  TRUE 
...
| Execution Time | 2025-02-19 05:20:30 UTC |
...
running this report
    ...
    PROCESSX_PS1d4542d3e07f_1739942423
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1Ar9IR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastqcr_v0.1.3-tikzDictionary"
