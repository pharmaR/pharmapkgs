# Validation Report - bios2mds@1.2.3
...
Overall the package has 20 exported objects. 20 are documented:
          ...
          col.group             dif             dis    export.fasta extract.cluster 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       import.fasta      import.msf      kmeans.run         mat.dif         mat.dis 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               mmds   mmds.2D.multi    mmds.2D.plot    mmds.3D.plot       mmds.plot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       mmds.project      random.msa      scree.plot       sil.score  write.mmds.pdb 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:14:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1fec7884_1739592883
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmphp5wS8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bios2mds_v1.2.3-tikzDictionary"
