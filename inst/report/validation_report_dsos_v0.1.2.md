...
| export_help          | 10                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Vathy M. Kamulete <vathymut@gmail.com> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/vathymut/dsos       |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | data.table (\>= 1.14.6)   | Imports |
| 2   | future.apply (\>= 1.10.0) | Imports |
| 3   | ggplot2 (\>= 3.4.0)       | Imports |
| 4   | scales (\>= 1.2.1)        | Imports |
| 5   | simctest (\>= 2.6)        | Imports |
| 6   | stats (\>= 4.2.1)         | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
           ...
           as_bf    as_pvalue   at_from_os       at_oob   bf_compare   bf_from_os 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      pt_from_os       pt_oob     pt_refit wauc_from_os 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-18 04:52:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41455a306_1739854341
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUnq8v0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsos_v0.1.2-tikzDictionary"
