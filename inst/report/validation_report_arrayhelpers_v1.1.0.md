...
| export_help          | 26                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | C. Beleites <claudia.beleites@chemometrix.eu>        |
...
Overall the package has 21 exported objects. 21 are documented:
                 ...
                 array2df             array2vec arrayhelpers.unittest 
                     TRUE                  TRUE                  TRUE 
            colMeans.AsIs          colSums.AsIs                delold 
                     TRUE                  TRUE                  TRUE 
                   drop1d          dropdimnames             ensuredim 
                     TRUE                  TRUE                  TRUE 
                 groupsum                   lon                makeNd 
                     TRUE                  TRUE                  TRUE 
                     ndim          numericindex            restoredim 
                     TRUE                  TRUE                  TRUE 
            rowMeans.AsIs          rowSums.AsIs                 slice 
                     TRUE                  TRUE                  TRUE 
                  slice<-                    ta             vec2array 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-21 13:10:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a5eb6c406_1740143428
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZZHBo3
