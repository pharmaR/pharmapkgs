# Validation Report - CorrMixed@1.1
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Wim Van der Elst <Wim.vanderelst@gmail.com>          |
...
Overall the package has 7 exported objects. 7 are documented:
         ...
         plot.Explore.WS.Corr        plot.WS.Corr.Mixed    plot.WS.Corr.Mixed.SAS 
                         TRUE                      TRUE                      TRUE 
      summary.Explore.WS.Corr        summary.Fract.Poly     summary.WS.Corr.Mixed 
                         TRUE                      TRUE                      TRUE 
    summary.WS.Corr.Mixed.SAS 
                         TRUE 
...
| Execution Time | 2025-02-17 04:01:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bd644e5da87_1739764868
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkH0ZuI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CorrMixed_v1.1-tikzDictionary"
