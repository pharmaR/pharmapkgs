# Validation Report - biodosetools@3.6.1
...
| export_help          | 14                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Alfredo Hernández <aldomann.designs@gmail.com>     |
| bugs_status          | subscript out of bounds                            |
| has_source_control   | https://github.com/biodosetools-team/biodosetools/ |
...
| 12  | shiny                    | Imports |
| 13  | shinydashboard           | Imports |
| 14  | shinyWidgets (\>= 0.5.0) | Imports |
...
Overall the package has 14 exported objects. 13 are documented:

                               %>%          calculate_aberr_table 
                             FALSE                           TRUE 
           calculate_genome_factor    calculate_trans_rate_manual 
                              TRUE                           TRUE 
    calculate_trans_rate_sigurdson  estimate_hetero_mixed_poisson 
                              TRUE                           TRUE 
     estimate_partial_body_dolphin      estimate_whole_body_delta 
                              TRUE                           TRUE 
        estimate_whole_body_merkle                            fit 
                              TRUE                           TRUE 
         plot_estimated_dose_curve            plot_fit_dose_curve 
                              TRUE                           TRUE 
             protracted_g_function                        run_app 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-15 04:12:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd8974d32_1739592729
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpyc4Nre
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biodosetools_v3.6.1-tikzDictionary"
