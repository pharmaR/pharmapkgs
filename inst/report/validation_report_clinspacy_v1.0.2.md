# Validation Report - clinspacy@1.0.2
...
| export_help          | 8                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Karandeep Singh <kdpsingh@umich.edu> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/ML4LHS/clinspacy  |
...
Overall the package has 8 exported objects. 7 are documented:
                            ...
                            %>%              bind_clinspacy 
                          FALSE                        TRUE 
      bind_clinspacy_embeddings                   clinspacy 
                           TRUE                        TRUE 
                 clinspacy_init dataset_cui2vec_definitions 
                           TRUE                        TRUE 
     dataset_cui2vec_embeddings           dataset_mtsamples 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-16 04:33:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33663b6b1_1739680392
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXQWf9U
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clinspacy_v1.0.2-tikzDictionary"
