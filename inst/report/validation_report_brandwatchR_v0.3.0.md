# Validation Report - brandwatchR@0.3.0
...
| export_help          | 25                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Donal Phipps <donal.phipps@gmail.com>  |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/Phippsy/brandwatchR |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | httr (\>= 1.3.1)      | Imports |
| 2   | jsonlite (\>= 1.5)    | Imports |
| 3   | data.table (\>= 1.10) | Imports |
...
Overall the package has 25 exported objects. 25 are documented:
                    ...
                    bwr_auth           bwr_cat_create              bwr_cat_get 
                        TRUE                     TRUE                     TRUE 
             bwr_filters_get       bwr_mentions_chart         bwr_mentions_get 
                        TRUE                     TRUE                     TRUE 
     bwr_mentions_topauthors      bwr_mentions_topics    bwr_mentions_topsites 
                        TRUE                     TRUE                     TRUE 
    bwr_mentions_toptweeters       bwr_mentions_total          bwr_metrics_get 
                        TRUE                     TRUE                     TRUE 
            bwr_projects_get          bwr_query_check         bwr_query_create 
                        TRUE                     TRUE                     TRUE 
            bwr_query_delete            bwr_query_get      bwr_querygrp_delete 
                        TRUE                     TRUE                     TRUE 
            bwr_querygrp_get          bwr_rule_delete             bwr_rule_get 
                        TRUE                     TRUE                     TRUE 
              bwr_tag_create           bwr_tag_delete              bwr_tag_get 
                        TRUE                     TRUE                     TRUE 
                  bwr_wf_get 
                        TRUE 
...
| Execution Time | 2025-02-15 04:41:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2e961f44_1739594469
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvZSuk4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brandwatchR_v0.3.0-tikzDictionary"
