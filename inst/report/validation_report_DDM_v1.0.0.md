...
| export_help          | 39                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tim Riffe <riffe@demogr.mpg.de>                      |
...
Overall the package has 39 exported objects. 39 are documented:
                    ...
                    addcod             adjustages         assignNoteCode 
                      TRUE                   TRUE                   TRUE 
                 avgDeaths                 cdmltw                    ddm 
                      TRUE                   TRUE                   TRUE 
                   ddmplot      detectAgeInterval              detectSex 
                      TRUE                   TRUE                   TRUE 
                   eOpenCD              fakeDates                    ggb 
                      TRUE                   TRUE                   TRUE 
             ggbChooseAges    ggbcoverageFromAges    ggbcoverageFromYear 
                      TRUE                   TRUE                   TRUE 
         ggbFittedFromAges          ggbgetAgesFit              ggbgetRMS 
                      TRUE                   TRUE                   TRUE 
            ggbMakeColumns                 ggbseg ggbsegCoverageFromYear 
                      TRUE                   TRUE                   TRUE 
         ggbsegMakeColumns                group01               guessage 
                      TRUE                   TRUE                   TRUE 
         guessDeathsColumn             headerPrep                  inUSR 
                      TRUE                   TRUE                   TRUE 
                isLeapYear             reduceOpen                    seg 
                      TRUE                   TRUE                   TRUE 
       segCoverageFromAges    segCoverageFromYear         segMakeColumns 
                      TRUE                   TRUE                   TRUE 
                   segplot             single2abr               slopeint 
                      TRUE                   TRUE                   TRUE 
                      yint                  yint2                  ypart 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-24 03:26:16 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a6fb2238f_1740367572
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpY8zCm5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DDM_v1.0.0-tikzDictionary"
