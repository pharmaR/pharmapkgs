# Validation Report - DSMolgenisArmadillo@2.0.9
...
| export_help          | 24                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Mariska Slofstra <m.k.slofstra@umcg.nl>            |
| bugs_status          | subscript out of bounds                            |
| has_source_control   | https://github.com/molgenis/molgenis-r-datashield/ |
| has_bug_reports_url  | 1                                                  |
| downloads_1yr        | 5297                                               |
| reverse_dependencies | 0                                                  |
| has_examples         | 0.8965517                                          |
| dependencies         | 10                                                 |
| license              | LGPL (\>= 2.1)                                     |
...
Overall the package has 2 exported objects. 2 are documented:
              ...
              armadillo armadillo.get_token 
                   TRUE                TRUE 

### Examples

There are 26 help pages with examples, from 29 (89.66 %).
...
| Execution Time | 2025-02-18 04:52:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4168c90e8_1739854320
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2CoBnc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DSMolgenisArmadillo_v2.0.9-tikzDictionary"
