# Validation Report - coder@0.13.10
...
| export_help          | 12                             |
| has_website          | TRUE                           |
| has_maintainer       | Erik Bulow <eriklgb@gmail.com> |
...
Overall the package has 12 exported objects. 11 are documented:
               ...
               %>% all_classcodes  as.classcodes     categorize       classify 
             FALSE           TRUE           TRUE           TRUE           TRUE 
          codebook      codebooks         codify          index  is.classcodes 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    set_classcodes      visualize 
              TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:52:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bc331322cbe_1739681531
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzNiRQV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coder_v0.13.10-tikzDictionary"
