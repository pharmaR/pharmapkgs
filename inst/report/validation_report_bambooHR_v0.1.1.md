...
| export_help          | 15                                  |
| has_website          | TRUE                                |
| has_maintainer       | Tom Bowling <tom.bowling@ascent.io> |
| bugs_status          | 1                                   |
| size_codebase        | 451                                 |
...
Overall the package has 15 exported objects. 14 are documented:
                     ...
                     %>%            build_url         config_setup 
                   FALSE                 TRUE                 TRUE 
        get_company_file         get_employee    get_employee_file 
                    TRUE                 TRUE                 TRUE 
                get_meta           get_report          get_request 
                    TRUE                 TRUE                 TRUE 
               get_table get_timeoff_policies get_timeoff_requests 
                    TRUE                 TRUE                 TRUE 
       get_timeoff_types         get_whos_out           use_config 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-14 07:41:19 UTC |
...
running this report
    ...
    PROCESSX_PS1c093aba6e3a_1739518876
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJB0FiJ
