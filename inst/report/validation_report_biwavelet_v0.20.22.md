# Validation Report - biwavelet@0.20.22
...
| export_help          | 14                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Tarik Gouhier <tarik.gouhier@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/tgouhier/biwavelet   |
...
rroad, vectorwavelet, WaverideR

## Namespace

Overall the package has 14 exported objects. 14 are documented:

        ar1.spectrum       check.data       convolve2D       phase.plot 
                TRUE             TRUE             TRUE             TRUE 
                pwtc           wclust            wdist               wt 
                TRUE             TRUE             TRUE             TRUE 
            wt.bases           wt.sig              wtc wtc_sig_parallel 
                TRUE             TRUE             TRUE             TRUE 
             wtc.sig              xwt 
                TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:20:02 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd706317fb_1739593197
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpm4auoW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biwavelet_v0.20.22-tikzDictionary"
