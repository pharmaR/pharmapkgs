...
| export_help          | 44                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Victor Navarro <navarrov@cardiff.ac.uk> |
| bugs_status          | 1                                       |
| has_source_control   | https://github.com/victor-navarro/calmr |
...
Overall the package has 24 exported objects. 42 are documented:

        calmr_model_graph      calmr_model_plot       calmr_verbosity 
                     TRUE                  TRUE                  TRUE 
           compare_models             fit_model            get_design 
                     TRUE                  TRUE                  TRUE 
           get_graph_opts             get_model    get_optimizer_opts 
                     TRUE                  TRUE                  TRUE 
           get_parameters       make_experiment         model_outputs 
                     TRUE                  TRUE                  TRUE 
           parameter_info          parse_design          patch_graphs 
                     TRUE                  TRUE                  TRUE 
              patch_plots          phase_parser                   rsa 
                     TRUE                  TRUE                  TRUE 
           run_experiment set_reward_parameters    supported_families 
                     TRUE                  TRUE                  TRUE 
         supported_models  supported_optimizers       supported_plots 
                     TRUE                  TRUE                  TRUE 

### Examples

There are 24 help pages with examples, from 30 (80.00 %).
...
| Execution Time | 2025-02-16 03:36:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32f9e6c0f_1739676964
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCtcohe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_calmr_v0.6.1-tikzDictionary"
