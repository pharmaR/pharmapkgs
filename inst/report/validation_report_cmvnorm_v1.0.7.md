# Validation Report - cmvnorm@1.0.7
...
| has_source_control   | https://github.com/RobinHankin/cmvnorm      |
...
Overall the package has 15 exported objects. 15 are documented:
                   ...
                   complex_CF              corr_complex                  dcmvnorm 
                         TRUE                      TRUE                      TRUE 
                         Im<- interpolant.quick.complex               isHermitian 
                         TRUE                      TRUE                      TRUE 
                        ishpd                  rcmvnorm                    rcnorm 
                         TRUE                      TRUE                      TRUE 
                        rcwis                      Re<- scales.likelihood.complex 
                         TRUE                      TRUE                      TRUE 
                           sd                       var                     zapim 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-16 04:46:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36f0f0832_1739681199
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTfUpRd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmvnorm_v1.0.7-tikzDictionary"
