# Validation Report - ConvergenceClubs@2.2.5
...
| export_help          | 6                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Roberto Sichera <rob.sichera@gmail.com> |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | lmtest (\>= 0.9-35)  | Imports |
| 2   | sandwich (\>= 2.3-4) | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
            ...
            computeH      estimateMod        findClubs       mergeClubs 
                TRUE             TRUE             TRUE             TRUE 
      mergeDivergent transition_paths 
                TRUE             TRUE 
...
| Execution Time | 2025-02-17 03:50:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65a0dbfac_1739764252
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfZdkkh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ConvergenceClubs_v2.2.5-tikzDictionary"
