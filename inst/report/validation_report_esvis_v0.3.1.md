...
| export_help          | 12                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Daniel Anderson <daniela@uoregon.edu> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/datalorax/esvis    |
...
Overall the package has 12 exported objects. 12 are documented:
             ...
             auc    binned_es  binned_plot        coh_d    ecdf_plot       hedg_g 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
             pac  pac_compare      pp_plot         tpac tpac_compare            v 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-19 04:33:18 UTC |
...
running this report
    ...
    PROCESSX_PS1d4532bdf449_1739939592
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoUDgZm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_esvis_v0.3.1-tikzDictionary"
