...
| export_help          | 9                                              |
| has_website          | TRUE                                           |
| has_maintainer       | Marcell Granat <granat.marcell@uni-neumann.hu> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/MarcellGranat/currr         |
...
Overall the package has 9 exported objects. 9 are documented:
                ...
                cp_map         cp_map_chr         cp_map_dbl         cp_map_dfc 
                  TRUE               TRUE               TRUE               TRUE 
            cp_map_dfr         cp_map_lgl remove_currr_cache         saving_map 
                  TRUE               TRUE               TRUE               TRUE 
      saving_map_nodot 
                  TRUE 
...
| Execution Time | 2025-02-17 04:40:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66cce649_1739767218
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCcPHoV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_currr_v0.1.2-tikzDictionary"
