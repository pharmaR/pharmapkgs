# Validation Report - easycensus@1.1.1
...
| export_help          | 26                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Cory McCartan <cmccartan@g.harvard.edu>     |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/CoryMcCartan/easycensus/ |
...
Overall the package has 26 exported objects. 26 are documented:
           ...
           as_estimate          cens_find      cens_find_acs      cens_find_dec 
                  TRUE               TRUE               TRUE               TRUE 
              cens_geo       cens_get_acs       cens_get_dec       cens_get_raw 
                  TRUE               TRUE               TRUE               TRUE 
        cens_margin_to  cens_parse_tables        est_pct_chg           est_prop 
                  TRUE               TRUE               TRUE               TRUE 
              estimate            get_est            get_moe             get_se 
                  TRUE               TRUE               TRUE               TRUE 
           is_estimate           tidy_age      tidy_age_bins     tidy_ethnicity 
                  TRUE               TRUE               TRUE               TRUE 
      tidy_income_bins        tidy_parens          tidy_race tidy_race_detailed 
                  TRUE               TRUE               TRUE               TRUE 
         tidy_simplify            to_rvar 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-18 05:10:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45784362e_1739855448
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfHGNnL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easycensus_v1.1.1-tikzDictionary"
