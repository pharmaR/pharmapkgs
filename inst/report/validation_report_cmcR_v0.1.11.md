...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Joe Zemmels <jzemmels@iastate.edu>                   |
...
| 10  | utils                  | Imports |
| 11  | scales                 | Imports |
| 12  | ggnewscale (\>= 0.4.6) | Imports |
| 13  | quantreg               | Imports |
| 14  | tibble                 | Imports |
| 15  | tidyr                  | Imports |
| 16  | rlang                  | Imports |
| 17  | patchwork              | Imports |
| 18  | ggplotify              | Imports |
...
Overall the package has 22 exported objects. 21 are documented:
                                       ...
                                       %>%                                cmcPlot 
                                     FALSE                                   TRUE 
              comparison_alignedTargetCell                 comparison_allTogether 
                                      TRUE                                   TRUE 
                comparison_calcPropMissing                comparison_cellDivision 
                                      TRUE                                   TRUE 
                            comparison_cor                     comparison_fft_ccf 
                                      TRUE                                   TRUE 
               comparison_getTargetRegions              comparison_replaceMissing 
                                      TRUE                                   TRUE 
             comparison_standardizeHeights                           decision_CMC 
                                      TRUE                                   TRUE 
                decision_combineDirections       decision_highCMC_cmcThetaDistrib 
                                      TRUE                                   TRUE 
    decision_highCMC_identifyHighCMCThetas                        preProcess_crop 
                                      TRUE                                   TRUE 
                          preProcess_erode                 preProcess_gaussFilter 
                                      TRUE                                   TRUE 
                    preProcess_ransacLevel              preProcess_removeFPCircle 
                                      TRUE                                   TRUE 
                    preProcess_removeTrend                            x3pListPlot 
                                      TRUE                                   TRUE 
...
| Execution Time | 2025-02-16 04:43:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3436f2bfb_1739681013
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2esOkY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmcR_v0.1.11-tikzDictionary"
