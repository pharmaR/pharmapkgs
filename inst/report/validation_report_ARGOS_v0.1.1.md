...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Kevin Egan <kevin.egan@durham.ac.uk>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 711                                                  |
| has_source_control   | <https://github.com/kevinegan31/ARGOS-Package>       |
...
Overall the package has 13 exported objects. 13 are documented:
                    ...
                    alasso                  argos    build_design_matrix 
                      TRUE                   TRUE                   TRUE 
            cubic2d_system     duffing_oscillator                  lasso 
                      TRUE                   TRUE                   TRUE 
           linear2d_system        linear3d_system          lorenz_system 
                      TRUE                   TRUE                   TRUE 
            lotka_volterra         rossler_system sg_optimal_combination 
                      TRUE                   TRUE                   TRUE 
            vdp_oscillator 
                      TRUE 
...
| Execution Time | 2025-02-14 07:23:18 UTC |
...
running this report
    ...
    PROCESSX_PS1c09428a69f6_1739517795
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCgF7F2
