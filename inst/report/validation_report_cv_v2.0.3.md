...
| export_help          | 19                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Georges Monette <georges+cv@yorku.ca> |
...
Overall the package has 19 exported objects. 19 are documented:
             ...
             BayesRule         BayesRule2       compareFolds                 cv 
                  TRUE               TRUE               TRUE               TRUE 
             cvCompute             cvInfo            cvMixed           cvSelect 
                  TRUE               TRUE               TRUE               TRUE 
                  fold              folds        GetResponse          medAbsErr 
                  TRUE               TRUE               TRUE               TRUE 
                models                mse               rmse    selectModelList 
                  TRUE               TRUE               TRUE               TRUE 
         selectStepAIC        selectTrans selectTransStepAIC 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:42:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63c470043_1739767360
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgK0G90
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cv_v2.0.3-tikzDictionary"
