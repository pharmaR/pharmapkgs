...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Radek Halfar <radek.halfar@vsb.cz>                   |
...
Overall the package has 3 exported objects. 3 are documented:
         ...
         find_chaos    find_motions find_regularity 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 05:02:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bb450a1e6d5_1739854954
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGgwr6z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dydea_v0.1.0-tikzDictionary"
