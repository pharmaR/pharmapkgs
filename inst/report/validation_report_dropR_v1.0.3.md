...
| export_help | 15 |
| has_website | TRUE |
| has_maintainer | Annika Tave Overlander <annika-tave.overlander@uni.kn> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/iscience-kn/dropR |
...
Overall the package has 15 exported objects. 15 are documented:
      ...
      add_dropout_idx     compute_stats          do_chisq            do_kpm 
                 TRUE              TRUE              TRUE              TRUE 
                do_ks       do_or_table          do_steps          get_odds 
                 TRUE              TRUE              TRUE              TRUE 
       get_odds_ratio get_steps_by_cond      get_survdiff     plot_do_curve 
                 TRUE              TRUE              TRUE              TRUE 
          plot_do_kpm        plot_do_ks         start_app 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:47:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4582c02e1_1739854044
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKS6riY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dropR_v1.0.3-tikzDictionary"
