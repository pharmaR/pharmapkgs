# Validation Report - datastepr@0.0.2
...
| export_help          | 3                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Brandon Taylor <brandon.taylor221@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/bramtayl/datastepr        |
...
| 2   | lazyeval (\>= 0.1.10) | Imports |
| 3   | R6 (\>= 2.0.1)        | Imports |
| 4   | magrittr (\>= 1.5)    | Imports |
| 5   | tibble (\>= 1.1)      | Imports |
...
| Execution Time | 2025-02-17 05:01:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6497c0c35_1739768507
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfwnsUN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datastepr_v0.0.2-tikzDictionary"
