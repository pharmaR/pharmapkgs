# Validation Report - CvmortalityMult@1.0.9
...
| export_help          | 5                                              |
| has_website          | TRUE                                           |
| has_maintainer       | David Atance <david.atance@uah.es>             |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/davidAtance/CvmortalityMult |
...
Overall the package has 5 exported objects. 5 are documented:
            ...
            fitLCmulti    MeasureAccuracy multipopulation_cv          residSVD2 
                  TRUE               TRUE               TRUE               TRUE 
              SpainMap 
                  TRUE 
...
| Execution Time | 2025-02-17 04:44:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6186f209c_1739767459
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9OPVYB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CvmortalityMult_v1.0.9-tikzDictionary"
