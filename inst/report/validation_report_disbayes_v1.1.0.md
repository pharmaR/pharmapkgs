# Validation Report - disbayes@1.1.0
...
| export_help | 11 |
| has_website | TRUE |
| has_maintainer | Christopher Jackson <chris.jackson@mrc-bsu.cam.ac.uk> |
...
Overall the package has 11 exported objects. 11 are documented:
                   ...
                   ci2num     conflict_disbayes              disbayes 
                     TRUE                  TRUE                  TRUE 
            disbayes_hier                   loo             loo_indiv 
                     TRUE                  TRUE                  TRUE 
            looi_disbayes plotfit_data_disbayes      plotfit_disbayes 
                     TRUE                  TRUE                  TRUE 
                     tidy           tidy_obsdat 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-18 04:11:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47a9dee51_1739851864
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppdYS2D
...
These are the options set to generate the report:
    ...
    [1] "validation_report_disbayes_v1.1.0-tikzDictionary"
