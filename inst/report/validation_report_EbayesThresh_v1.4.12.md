# Validation Report - EbayesThresh@1.4.12
...
| has_source_control   | https://github.com/stephenslab/EbayesThresh   |
| has_bug_reports_url  | 1                                             |
| downloads_1yr        | 622377                                        |
...
adlift, binhf, CVThresh, GSD, icmm, nlt, POCRE

## Namespace

Overall the package has 24 exported objects. 24 are documented:

             beta.cauchy         beta.laplace       cauchy.medzero 
                    TRUE                 TRUE                 TRUE 
       cauchy.threshzero         ebayesthresh ebayesthresh.wavelet 
                    TRUE                 TRUE                 TRUE 
                 isotone   laplace.threshzero    negloglik.laplace 
                    TRUE                 TRUE                 TRUE 
                postmean      postmean.cauchy     postmean.laplace 
                    TRUE                 TRUE                 TRUE 
                 postmed       postmed.cauchy      postmed.laplace 
                    TRUE                 TRUE                 TRUE 
                  tfromw               tfromx             threshld 
                    TRUE                 TRUE                 TRUE 
              vecbinsolv           wandafromx               wfromt 
                    TRUE                 TRUE                 TRUE 
                  wfromx            wmonfromx            zetafromx 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-18 05:14:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43313c78c_1739855680
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZ0Z37E
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EbayesThresh_v1.4.12-tikzDictionary"
