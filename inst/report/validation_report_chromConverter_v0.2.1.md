# Validation Report - chromConverter@0.2.1
...
| export_help          | 12                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Ethan Bass <ethanbass@gmail.com>            |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/ethanbass/chromConverter |
...
Overall the package has 12 exported objects. 12 are documented:
              ...
              call_entab       call_openchrom      configure_aston 
                    TRUE                 TRUE                 TRUE 
    read_chemstation_csv      read_chromeleon          read_chroms 
                    TRUE                 TRUE                 TRUE 
               read_mzml        read_shimadzu       read_thermoraw 
                    TRUE                 TRUE                 TRUE 
         read_waters_arw         sp_converter         uv_converter 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:16:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bc329722b24_1739679372
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmC0FND
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chromConverter_v0.2.1-tikzDictionary"
