# Validation Report - basemaps@0.0.8
...
| export_help          | 18                                               |
| has_website          | FALSE                                            |
| has_maintainer       | Jakob Schwalb-Willmann <dev@schwalb-willmann.de> |
...
Overall the package has 18 exported objects. 18 are documented:
            ...
            basemap  basemap_geotif basemap_gglayer  basemap_ggplot  basemap_magick 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    basemap_mapview    basemap_plot     basemap_png  basemap_raster   basemap_stars 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      basemap_terra        draw_ext     flush_cache    get_defaults    get_maptypes 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          gg_raster  reset_defaults    set_defaults 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 07:44:14 UTC |
...
running this report
    ...
    PROCESSX_PS1c099550027_1739519051
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVivPNp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_basemaps_v0.0.8-tikzDictionary"
