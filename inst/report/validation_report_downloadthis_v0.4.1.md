# Validation Report - downloadthis@0.4.1
...
| export_help | 5 |
| has_website | TRUE |
| has_maintainer | Felipe Mattioni Maturana <felipe.mattioni@med.uni-tuebingen.de> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/fmmattioni/downloadthis |
...
EpiCompare, metabolic

## Namespace

Overall the package has 5 exported objects. 4 are documented:

              %>%  download_dir download_file download_link download_this 
...
| Execution Time | 2025-02-18 04:39:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47853543_1739853534
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8icz7Q
...
These are the options set to generate the report:
    ...
    [1] "validation_report_downloadthis_v0.4.1-tikzDictionary"
