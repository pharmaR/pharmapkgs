# Validation Report - cglasso@2.0.7
...
Overall the package has 29 exported objects. 29 are documented:
                 ...
                 cggm          cggm.fit           cglasso       cglasso.fit 
                 TRUE              TRUE              TRUE              TRUE 
             ColMeans          colNames        colNames<-           ColVars 
                 TRUE              TRUE              TRUE              TRUE 
             datacggm             event        fit_matrix       function2xy 
                 TRUE              TRUE              TRUE              TRUE 
             getGraph         getMatrix            impute is.cglasso2igraph 
                 TRUE              TRUE              TRUE              TRUE 
          is.datacggm             lower             npred             nresp 
                 TRUE              TRUE              TRUE              TRUE 
                 QFun           qqcnorm             rcggm          rowNames 
                 TRUE              TRUE              TRUE              TRUE 
           rowNames<-    select_cglasso     ShowStructure          to_graph 
                 TRUE              TRUE              TRUE              TRUE 
                upper 
                 TRUE 
...
| Execution Time | 2025-02-16 04:06:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bc366eb2d0d_1739678755
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXYO1MJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cglasso_v2.0.7-tikzDictionary"
