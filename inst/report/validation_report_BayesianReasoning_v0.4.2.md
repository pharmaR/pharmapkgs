# Validation Report - BayesianReasoning@0.4.2
...
| export_help          | 6                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Gorka Navarrete <gorkang@gmail.com>          |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/gorkang/BayesianReasoning |
...
Overall the package has 6 exported objects. 5 are documented:
                          ...
                          FALSE                        TRUE 
                    plot_cutoff PPV_diagnostic_vs_screening 
                           TRUE                        TRUE 
                    PPV_heatmap   remove_layers_cutoff_plot 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-15 03:36:36 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd22d1e093_1739590591
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppJ47XH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesianReasoning_v0.4.2-tikzDictionary"
