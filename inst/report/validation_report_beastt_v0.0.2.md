# Validation Report - beastt@0.0.2
...
| export_help          | 18                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Christina Fillmore <christina.e.fillmore@gsk.com> |
| bugs_status          | 0.9666667                                         |
| has_source_control   | https://github.com/GSK-Biostatistics/beastt       |
...
| 15  | rstantools (\>= 2.4.0)    | Imports   |
| 16  | stringr                   | Imports   |
| 17  | tidyr                     | Imports   |
| 18  | BH (\>= 1.66.0)           | LinkingTo |
| 19  | Rcpp (\>= 0.12.0)         | LinkingTo |
| 20  | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 21  | RcppParallel (\>= 5.0.1)  | LinkingTo |
...
Overall the package has 18 exported objects. 18 are documented:
              ...
              calc_post_beta           calc_post_norm        calc_post_weibull 
                        TRUE                     TRUE                     TRUE 
       calc_power_prior_beta    calc_power_prior_norm calc_power_prior_weibull 
                        TRUE                     TRUE                     TRUE 
               calc_prop_scr                   glance              is_prop_scr 
                        TRUE                     TRUE                     TRUE 
                   mix_means               mix_sigmas                plot_dist 
                        TRUE                     TRUE                     TRUE 
               prop_scr_dens            prop_scr_hist            prop_scr_love 
                        TRUE                     TRUE                     TRUE 
            robustify_mvnorm           robustify_norm                     tidy 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-25 03:20:30 UTC |
...
running this report
    ...
    PROCESSX_PS1d2870f1be84_1740453626
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT0Jvec
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beastt_v0.0.2-tikzDictionary"
