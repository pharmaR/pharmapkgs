# Validation Report - DemografixeR@0.1.1
...
| export_help          | 8                                                 |
| has_website          | TRUE                                              |
| has_maintainer       | Matthias Brenninkmeijer <matthias@brennotten.net> |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/matbmeijer/DemografixeR        |
...
Overall the package has 8 exported objects. 7 are documented:
                    ...
                    %>%               agify           genderize         get_api_key 
                  FALSE                TRUE                TRUE                TRUE 
            nationalize      remove_api_key        save_api_key supported_countries 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 03:39:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bb494c4c53_1739849980
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzRQss5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DemografixeR_v0.1.1-tikzDictionary"
