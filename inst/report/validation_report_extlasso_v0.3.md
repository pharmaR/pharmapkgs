# Validation Report - extlasso@0.3
...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | B N Mandal <mandal.stat@gmail.com>                   |
...
Overall the package has 22 exported objects. 22 are documented:
                     ...
                     bars         coef.extlasso           cv.binomial 
                     TRUE                  TRUE                  TRUE 
              cv.extlasso             cv.normal            cv.poisson 
                     TRUE                  TRUE                  TRUE 
                 extlasso extlasso.binom.lambda     extlasso.binomial 
                     TRUE                  TRUE                  TRUE 
     extlasso.norm.lambda       extlasso.normal  extlasso.pois.lambda 
                     TRUE                  TRUE                  TRUE 
         extlasso.poisson             fl.lambda                  fold 
                     TRUE                  TRUE                  TRUE 
               fusedlasso                 kfold       msefun.binomial 
                     TRUE                  TRUE                  TRUE 
            msefun.normal        msefun.poisson         plot.extlasso 
                     TRUE                  TRUE                  TRUE 
         predict.extlasso 
                     TRUE 
...
| Execution Time | 2025-02-19 04:55:38 UTC |
...
running this report
    ...
    PROCESSX_PS1d454998867a_1739940932
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpedysGR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extlasso_v0.3-tikzDictionary"
