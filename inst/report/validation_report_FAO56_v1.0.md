...
| export_help          | 27                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ali Ahani <ali.ahani66@gmail.com>                    |
...
Overall the package has 27 exported objects. 27 are documented:
      ...
      AtmPres    CSSRad    DD2Rad        DH EarSunDis   EffPrec      ET_c   ETo_FPM 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
      ETo_Hrg   ETo_Pan     ExRad   JulDate    MeanRH  MeanTemp      MSVP     NLRad 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
         NRad     NSRad   PanCoef    PsyCon    RelHum     SatVP   SlpSVPC    SolDec 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
       SolRad     SunHA   WndSp2m 
         TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-19 05:11:47 UTC |
...
running this report
    ...
    PROCESSX_PS1d4516a67124_1739941901
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp16fNiT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FAO56_v1.0-tikzDictionary"
