# Validation Report - clusterGeneration@1.3.8
...
corTest, DoubleML, EMJMCMC, FracKrigingR, IVPP, mlVAR, mmrm, mvnimpute,
phytools, remaCor, rEMM, skewMLRM, stats4teaching, stream, VisCov

## Namespace

Overall the package has 13 exported objects. 13 are documented:

            genOrthogonal     genPositiveDefMat        genRandomClust 
                     TRUE                  TRUE                  TRUE 
           getSepProjData      getSepProjTheory nearestNeighborSepVal 
                     TRUE                  TRUE                  TRUE 
         plot1DProjection      plot2DProjection           rcorrmatrix 
                     TRUE                  TRUE                  TRUE 
             sepIndexData        sepIndexTheory        simClustDesign 
                     TRUE                  TRUE                  TRUE 
             viewClusters 
                     TRUE 
...
| Execution Time | 2025-02-16 04:38:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37c256071_1739680725
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplJALz6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clusterGeneration_v1.3.8-tikzDictionary"
