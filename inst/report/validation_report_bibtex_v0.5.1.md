# Validation Report - bibtex@0.5.1
...
| has_source_control   | https://github.com/ropensci/bibtex            |
...
allMT, cffr, ChemmineR, cols4all, formatBibtex, handlr, iemisctext,
markovMSM, rcrossref, RefManageR, rmdfiltr, scRNAseqApp, softbib

## Namespace

Overall the package has 3 exported objects. 3 are documented:

    do_read_bib    read.bib   write.bib 
           TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-15 04:01:35 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd66c13b10_1739592090
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmprwu0xt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bibtex_v0.5.1-tikzDictionary"
