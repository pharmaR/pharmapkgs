# Validation Report - bmscstan@1.2.1.0
...
| export_help          | 11                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Michele Scandola <michele.scandola@univr.it> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/michelescandola/bmscstan  |
...
Overall the package has 11 exported objects. 11 are documented:
                              ...
                              BMSC                       BMSC_loo 
                              TRUE                           TRUE 
                  BMSC_loo_compare                  BMSC_mcse_loo 
                              TRUE                           TRUE 
                 BMSC_pareto_k_ids BMSC_pareto_k_influence_values 
                              TRUE                           TRUE 
               BMSC_pareto_k_table           BMSC_pareto_k_values 
                              TRUE                           TRUE 
            BMSC_psis_n_eff_values                      BMSC_waic 
                              TRUE                           TRUE 
                     pairwise.BMSC 
                              TRUE 
...
| Execution Time | 2025-02-15 04:27:33 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7bfe96b4_1739593648
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6wpXl6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bmscstan_v1.2.1.0-tikzDictionary"
