...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Campo Bavo D.C. <bavo.decock@kuleuven.be>            |
...
Overall the package has 14 exported objects. 14 are documented:
    ...
    adjustIntercept BalanceProperty        findbars           fixef       glFormula 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        hierCredGLM hierCredibility hierCredTweedie      is.formula        isNested 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             nobars        NrUnique           ranef     tweedieGLMM 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 06:33:39 UTC |
...
running this report
    ...
    PROCESSX_PS726d31538023_1739514816
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLLPw80
