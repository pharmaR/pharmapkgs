...
| has_source_control   | https://github.com/eddelbuettel/drat |
...
conos, docuSignr, knfi, pagoda2, tashu, USA.state.boundaries

## Namespace

Overall the package has 10 exported objects. 10 are documented:

                           addRepo                archivePackages 
                              TRUE                           TRUE 
    archivePackagesForAllRversions                    getRepoInfo 
                              TRUE                           TRUE 
                          initRepo                  insertPackage 
                              TRUE                           TRUE 
                    insertPackages                      pruneRepo 
                              TRUE                           TRUE 
          pruneRepoForAllRversions                     updateRepo 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-18 04:43:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4750ecf5_1739853798
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpe2pOvG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drat_v0.2.5-tikzDictionary"
