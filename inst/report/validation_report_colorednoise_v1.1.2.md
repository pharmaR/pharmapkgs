# Validation Report - colorednoise@1.1.2
...
|     | package                 | type      |
|:----|:------------------------|:----------|
| 1   | stats (\>= 3.3.2)       | Imports   |
| 2   | purrr (\>= 0.2.3)       | Imports   |
| 3   | Rcpp (\>= 1.0.5)        | Imports   |
| 4   | data.table (\>= 1.12.8) | Imports   |
| 5   | Rcpp                    | LinkingTo |
...
Overall the package has 9 exported objects. 9 are documented:
           ...
           autocorr_sim     autocorrelation colored_multi_rnorm       colored_noise 
                   TRUE                TRUE                TRUE                TRUE 
                cor2cov        matrix_model         multi_rnorm     stdev_transform 
                   TRUE                TRUE                TRUE                TRUE 
       unstructured_pop 
                   TRUE 
...
| Execution Time | 2025-02-16 04:59:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bc313e7d791_1739681947
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNFYeJ3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colorednoise_v1.1.2-tikzDictionary"
