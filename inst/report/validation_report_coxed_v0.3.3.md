...
| export_help          | 17                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | “Kropko, Jonathan” <jkropko@virginia.edu>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/jkropko/coxed                     |
...
Overall the package has 17 exported objects. 17 are documented:
     ...
     baseline.build   baseline.plot             bca        bootcov2        censor.x 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              coxed       coxed.gam   coxed.gam.tvc      coxed.npsf  coxed.npsf.tvc 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          data.plot     generate.lm make.margeffect    rank.predict    sim.survdata 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       survsim.plot   user.baseline 
               TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:10:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6277ea845_1739765436
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXszdX8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coxed_v0.3.3-tikzDictionary"
