...
| has_source_control | https://github.com/christopherkenny/feltr |
...
Overall the package has 16 exported objects. 16 are documented:
        ...
        felt_add_map_layers felt_add_map_layers_url         felt_create_map 
                       TRUE                    TRUE                    TRUE 
            felt_delete_map   felt_delete_map_layer      felt_finish_upload 
                       TRUE                    TRUE                    TRUE 
          felt_get_comments            felt_get_map   felt_get_map_elements 
                       TRUE                    TRUE                    TRUE 
        felt_get_map_layers          felt_get_style           felt_get_user 
                       TRUE                    TRUE                    TRUE 
           felt_patch_style            get_felt_key            has_felt_key 
                       TRUE                    TRUE                    TRUE 
               set_felt_key 
                       TRUE 
...
| Execution Time | 2025-02-27 03:26:12 UTC |
...
running this report
    ...
    PROCESSX_PS1c62246ac5d3_1740626768
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsJMk68
...
These are the options set to generate the report:
    ...
    [1] "validation_report_feltr_v0.0.4-tikzDictionary"
