...
| export_help          | 68                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Chris Mann <cmann3@unl.edu>                          |
...
Overall the package has 68 exported objects. 68 are documented:
               ...
               attr_off             attr_on              bg_off               bg_on 
                   TRUE                TRUE                TRUE                TRUE 
                 box_at               clear           color_off          color_pair 
                   TRUE                TRUE                TRUE                TRUE 
               draw_arc         draw_bezier         draw_circle        draw_ellipse 
                   TRUE                TRUE                TRUE                TRUE 
                draw_fn           draw_lerp           draw_path            draw_ray 
                   TRUE                TRUE                TRUE                TRUE 
              draw_rect          draw_shape               erase example_luckynumber 
                   TRUE                TRUE                TRUE                TRUE 
                 fg_off               fg_on         fill_circle        fill_ellipse 
                   TRUE                TRUE                TRUE                TRUE 
              fill_rect          fill_shape               getkp              getkpl 
                   TRUE                TRUE                TRUE                TRUE 
                grid_at            grid_mat         hide_cursor               hline 
                   TRUE                TRUE                TRUE                TRUE 
               hline_at             in.term         load_cursor             make_bg 
                   TRUE                TRUE                TRUE                TRUE 
                make_fg          make_style                  mv              mv_col 
                   TRUE                TRUE                TRUE                TRUE 
                 mv_row               mv_to            path_arc         path_bezier 
                   TRUE                TRUE                TRUE                TRUE 
            path_circle        path_ellipse           path_fill             path_fn 
                   TRUE                TRUE                TRUE                TRUE 
      path_intersection           path_lerp            path_ray           path_rect 
                   TRUE                TRUE                TRUE                TRUE 
             path_shape               repch               reset         save_cursor 
                   TRUE                TRUE                TRUE                TRUE 
            show_cursor               style            term_dim               vline 
                   TRUE                TRUE                TRUE                TRUE 
               vline_at                  wr              wrapup                wrat 
                   TRUE                TRUE                TRUE                TRUE 
                   wrch              wrchat                wrkp               wrkpl 
                   TRUE                TRUE                TRUE                TRUE 

### Examples

There are 69 help pages with examples, from 69 (100.00 %).
...
| Execution Time | 2025-02-17 04:40:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6d073246_1739767230
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGppu4e
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cursr_v0.1.0-tikzDictionary"
