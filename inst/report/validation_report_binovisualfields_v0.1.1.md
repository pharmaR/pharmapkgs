# Validation Report - binovisualfields@0.1.1
...
| export_help          | 12                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Ping Liu <ping.liu@unimelb.edu.au>                   |
...
Overall the package has 12 exported objects. 12 are documented:
      ...
      binovfcal    caltheta     colfunc    colorkey     get_col get_inv_col 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
         makevf      plotvf    plotvf_2   plotvfray      rotate     rundemo 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-15 04:10:03 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6a43d504_1739592598
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpV18S0i
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binovisualfields_v0.1.1-tikzDictionary"
