# Validation Report - cpsurvsim@1.2.2
...
| export_help          | 6                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Camille Hochheimer <dochoch19@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/camillejo/cpsurvsim   |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | plyr (\>= 1.8.5)  | Imports |
| 2   | stats             | Imports |
| 3   | Hmisc (\>= 4.3.0) | Imports |
| 4   | knitr (\>= 1.27)  | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
     ...
     exp_cdfsim    exp_icdf  exp_memsim weib_cdfsim   weib_icdf weib_memsim 
...
| Execution Time | 2025-02-17 04:16:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bd633efd012_1739765768
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxfqMfu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cpsurvsim_v1.2.2-tikzDictionary"
