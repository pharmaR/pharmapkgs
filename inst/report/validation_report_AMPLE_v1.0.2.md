...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Finlay Scott <finlays@spc.int>                       |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/PacificCommunity/ofp-sam-ample    |
...
| 9   | shinyjs (\>= 2.1.0)         | Imports |
| 10  | ggplot2 (\>= 3.4.0)         | Imports |
| 11  | shinyscreenshot (\>= 0.2.0) | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
                 ...
                 assessment   comparing_performance                constant 
                       TRUE                    TRUE                    TRUE 
           estimation_error              get_hcr_ip              get_hcr_op 
                       TRUE                    TRUE                    TRUE 
           get_stock_params               intro_hcr   measuring_performance 
                       TRUE                    TRUE                    TRUE 
       mp_params_switcheroo        mpParamsSetterUI stockParamsSetterServer 
                       TRUE                    TRUE                    TRUE 
                  threshold 
                       TRUE 
...
| Execution Time | 2025-02-14 06:52:58 UTC |
...
running this report
    ...
    PROCESSX_PS726d751944f6_1739515975
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnElIpZ
