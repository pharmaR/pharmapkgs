# Validation Report - episcan@0.0.1
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Beibei Jiang <beibei_jiang@psych.mpg.de>             |
...
Overall the package has 11 exported objects. 11 are documented:
       ...
       checkchunksize   epiblaster1geno  epiblaster2genos           epiHSIC 
                 TRUE              TRUE              TRUE              TRUE 
         epiHSIC1geno     epiHSIC2genos           episcan            getcor 
                 TRUE              TRUE              TRUE              TRUE 
        WriteSnpPairs WriteSnpPairs_sym              ZtoP 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 04:18:55 UTC |
...
running this report
    ...
    PROCESSX_PS1d4529d91558_1739938729
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppY7rwD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_episcan_v0.0.1-tikzDictionary"
