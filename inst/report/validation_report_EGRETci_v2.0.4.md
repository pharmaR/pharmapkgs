# Validation Report - EGRETci@2.0.4
...
| has_source_control   | https://github.com/USGS-R/EGRETci |
...
Overall the package has 19 exported objects. 19 are documented:
           ...
           blockSample         bootAnnual            ciBands     ciCalculations 
                  TRUE               TRUE               TRUE               TRUE 
          genDailyBoot       makeAnnualPI        makeDailyPI        makeMonthPI 
                  TRUE               TRUE               TRUE               TRUE 
         monthSeqToDec   plotConcHistBoot   plotFluxHistBoot plotHistogramTrend 
                  TRUE               TRUE               TRUE               TRUE 
                  pVal      runGroupsBoot       runPairsBoot        saveEGRETci 
                  TRUE               TRUE               TRUE               TRUE 
            setForBoot         trendSetUp                wBT 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 03:49:31 UTC |
...
running this report
    ...
    PROCESSX_PS1d452eca7bfb_1739936965
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfOCMJX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EGRETci_v2.0.4-tikzDictionary"
