# Validation Report - ebTobit@1.0.2
...
| export_help          | 13                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Alton Barbehenn <altonbarbehenn@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/barbehenna/ebTobit      |
...
Overall the package has 13 exported objects. 13 are documented:
                    ...
                    ConvexDual               ConvexPrimal 
                          TRUE                       TRUE 
                       ebTobit                         EM 
                          TRUE                       TRUE 
                    is.ebTobit            lik_GaussianPIC 
                          TRUE                       TRUE 
                        likMat                new_ebTobit 
                          TRUE                       TRUE 
    posterior_L1mediod.ebTobit     posterior_mean.ebTobit 
                          TRUE                       TRUE 
        posterior_mode.ebTobit                   tobit_sd 
                          TRUE                       TRUE 
                  tobit_sd_mle 
                          TRUE 
...
| Execution Time | 2025-02-18 05:16:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42afa5c34_1739855794
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAMgZab
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ebTobit_v1.0.2-tikzDictionary"
