...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Maogui Hu <humg@lreis.ac.cn>                         |
...
Overall the package has 21 exported objects. 21 are documented:
                   ...
                   ataCoKriging             ataCoKriging.cv 
                           TRUE                        TRUE 
            ataIsClusterEnabled                  ataKriging 
                           TRUE                        TRUE 
                  ataKriging.cv ataSetNumberOfThreadsForOMP 
                           TRUE                        TRUE 
                ataStartCluster              ataStopCluster 
                           TRUE                        TRUE 
                   atpCoKriging                  atpKriging 
                           TRUE                        TRUE 
                     autofitVgm         deconvPointCrossVgm 
                           TRUE                        TRUE 
                 deconvPointVgm  deconvPointVgmForCoKriging 
                           TRUE                        TRUE 
              discretizePolygon            discretizeRaster 
                           TRUE                        TRUE 
                extractPointVgm               plotDeconvVgm 
                           TRUE                        TRUE 
              rbindDiscreteArea          subsetDiscreteArea 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-14 07:30:25 UTC |
...
running this report
    ...
    PROCESSX_PS1c095b2220a_1739518222
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpW2k5z9
