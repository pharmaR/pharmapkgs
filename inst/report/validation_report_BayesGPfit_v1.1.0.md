# Validation Report - BayesGPfit@1.1.0
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jian Kang <jiankang@umich.edu>                       |
...
Overall the package has 14 exported objects. 14 are documented:
                ...
                GP.Bayes.fit           GP.create.cols      GP.eigen.funcs.fast 
                        TRUE                     TRUE                     TRUE 
    GP.eigen.funcs.fast.orth           GP.eigen.value        GP.fast.Bayes.fit 
                        TRUE                     TRUE                     TRUE 
           GP.generate.grids            GP.plot.curve           GP.plot.curves 
                        TRUE                     TRUE                     TRUE 
                  GP.predict   GP.simulate.curve.fast  GP.simulate.curves.fast 
                        TRUE                     TRUE                     TRUE 
                GP.std.grids               GP.summary 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-15 03:35:19 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7368e6ea_1739590514
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTr6Gyw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesGPfit_v1.1.0-tikzDictionary"
