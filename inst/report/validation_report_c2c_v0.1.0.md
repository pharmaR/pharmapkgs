...
| export_help          | 9                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Mitchell Lyons <mitchell.lyons@gmail.com> |
| has_source_control   | https://github.com/mitchest/c2c/          |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    calculate_clustering_metrics                class_entropy 
                            TRUE                         TRUE 
                    class_purity                 get_conf_mat 
                            TRUE                         TRUE 
                        get_hard             labels_to_matrix 
                            TRUE                         TRUE 
                 overall_entropy               overall_purity 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-16 03:31:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bc360ed6f55_1739676691
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNWQPvX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_c2c_v0.1.0-tikzDictionary"
