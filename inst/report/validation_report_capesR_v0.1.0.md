# Validation Report - capesR@0.1.0
...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Hugo Vasconcelos Medeiros <hugo.medeiros@ufpe.br>    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | <https://github.com/hugoavmedeiros/capesR>           |
...
Overall the package has 6 exported objects. 6 are documented:
     ...
     baixar_dados_capes  buscar_texto_capes download_capes_data     ler_dados_capes 
                   TRUE                TRUE                TRUE                TRUE 
        read_capes_data   search_capes_text 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 03:39:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33dad64a3_1739677144
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHOAIhU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_capesR_v0.1.0-tikzDictionary"
