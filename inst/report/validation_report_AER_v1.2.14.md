...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | car (\>= 2.0-19)      | Depends |
| 2   | lmtest                | Depends |
| 3   | sandwich (\>= 2.4-0)  | Depends |
| 4   | survival (\>= 2.37-5) | Depends |
| 5   | zoo                   | Depends |
| 6   | stats                 | Imports |
| 7   | Formula (\>= 0.2-0)   | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    dispersiontest          ivreg      ivreg.fit          tobit 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-21 13:08:18 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a4e1936d3_1740143295
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJgyF8E
