# Validation Report - disprofas@0.2.0
...
| has_source_control   | https://github.com/piusdahinden/disprofas  |
...
Overall the package has 12 exported objects. 12 are documented:
            ...
            bootstrap_f2 check_point_location                   f1 
                    TRUE                 TRUE                 TRUE 
                      f2          gep_by_nera       get_hotellings 
                    TRUE                 TRUE                 TRUE 
             get_sim_lim           get_T2_one           get_T2_two 
                    TRUE                 TRUE                 TRUE 
                   mimcr                mztia           plot_mztia 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-18 04:16:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bb49cb5087_1739852189
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTuGrxx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_disprofas_v0.2.0-tikzDictionary"
