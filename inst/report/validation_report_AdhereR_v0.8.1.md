...
| export_help          | 35                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Dan Dediu <ddediu@gmail.com>                         |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 11891                                                |
| has_source_control   | https://github.com/ddediu/AdhereR                    |
...
Overall the package has 35 exported objects. 35 are documented:
                         ...
                         callAdhereR                  CMA_per_episode 
                                TRUE                             TRUE 
                    CMA_polypharmacy               CMA_sliding_window 
                                TRUE                             TRUE 
                                CMA0                             CMA1 
                                TRUE                             TRUE 
                                CMA2                             CMA3 
                                ...
                                CMA8                             CMA9 
                                TRUE                             TRUE 
             compute_event_durations           compute.event.int.gaps 
                                TRUE                             TRUE 
          compute.treatment.episodes            cover_special_periods 
                                TRUE                             TRUE 
             get.event.plotting.area         get.legend.plotting.area 
                                TRUE                             TRUE 
                  get.plotted.events         get.plotted.partial.cmas 
                                TRUE                             TRUE 
            getCallerWrapperLocation                           getCMA 
                                TRUE                             TRUE 
                        getEventInfo       getEventsToEpisodesMapping 
                                TRUE                             TRUE 
    getEventsToSlidingWindowsMapping                getInnerEventInfo 
                                TRUE                             TRUE 
                              getMGs               last.plot.get.info 
                                TRUE                             TRUE 
            map.event.coords.to.plot             plot_interactive_cma 
                                TRUE                             TRUE 
               prune_event_durations                        subsetCMA 
                                TRUE                             TRUE 
                  time_to_initiation 
                                TRUE 
...
| Execution Time | 2025-02-14 06:37:31 UTC |
...
running this report
    ...
    PROCESSX_PS726d75f298c8_1739515048
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpucg4hU
