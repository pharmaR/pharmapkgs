# Validation Report - beezdiscounting@0.3.2
...
| export_help          | 25                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Brent A. Kaplan <bkaplan.ku@gmail.com>               |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/brentkaplan/beezdiscounting       |
...
|     | package    | type    |
|:----|:-----------|:--------|
| 1   | beezdemand | Imports |
| 2   | broom      | Imports |
| 3   | dplyr      | Imports |
| 4   | ggplot2    | Imports |
| 5   | gtools     | Imports |
| 6   | magrittr   | Imports |
| 7   | minpack.lm | Imports |
| 8   | psych      | Imports |
| 9   | purrr      | Imports |
| 10  | stringr    | Imports |
| 11  | tibble     | Imports |
...
Overall the package has 25 exported objects. 24 are documented:
                       ...
                       %>%                 ans_dd                 ans_pd 
                     FALSE                   TRUE                   TRUE 
                 calc_aucs          calc_conf_int                calc_dd 
                      TRUE                   TRUE                   TRUE 
                   calc_pd                calc_r2     check_unsystematic 
                      TRUE                   TRUE                   TRUE 
                    fit_dd      generate_data_mcq       get_lookup_table 
                      TRUE                   TRUE                   TRUE 
          long_to_wide_mcq long_to_wide_mcq_excel                plot_dd 
                      TRUE                   TRUE                   TRUE 
                   prop_ss             results_dd               score_dd 
                      TRUE                   TRUE                   TRUE 
               score_mcq27               score_pd          summarize_mcq 
                      TRUE                   TRUE                   TRUE 
                 timing_dd              timing_pd       wide_to_long_mcq 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 03:51:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4e15749d_1739591498
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSHERMF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beezdiscounting_v0.3.2-tikzDictionary"
