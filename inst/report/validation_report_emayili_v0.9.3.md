# Validation Report - emayili@0.9.3
...
epitweetr, login, Microsoft365R, sendgridr, shiny.reglog
...
Overall the package has 53 exported objects. 52 are documented:
                  ...
                  attachment                      bcc                       cc 
                        TRUE                     TRUE                     TRUE 
                      cleave                 comments                compliant 
                        TRUE                     TRUE                     TRUE 
                     display                   domain                  encrypt 
                        TRUE                     TRUE                     TRUE 
                    envelope                  expires                     from 
                        TRUE                     TRUE                     TRUE 
                       gmail                     html                       id 
                        TRUE                     TRUE                     TRUE 
                  importance                inreplyto                 keywords 
                        TRUE                     TRUE                     TRUE 
                       local               mailersend                mailfence 
                        TRUE                     TRUE                     TRUE 
                     mailgun                 mailtrap               message_id 
                        TRUE                     TRUE                     TRUE 
                   normalise                  parties                 priority 
                        TRUE                     TRUE                     TRUE 
                   qp_decode                qp_encode                      raw 
                        TRUE                     TRUE                     TRUE 
                  references                   render                    reply 
                        TRUE                     TRUE                     TRUE 
                     replyby request_receipt_delivery     request_receipt_read 
                        TRUE                     TRUE                     TRUE 
                 return_path                   sender                 sendgrid 
                        TRUE                     TRUE                     TRUE 
                  sendinblue              sensitivity                   server 
                        TRUE                     TRUE                     TRUE 
                   signature               smtpbucket                  subject 
                        TRUE                     TRUE                     TRUE 
                    template                     text                       to 
                        TRUE                     TRUE                     TRUE 
                    validate                zeptomail 
...
| Execution Time | 2025-02-19 03:59:40 UTC |
...
running this report
    ...
    PROCESSX_PS1d451d4e643a_1739937574
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6V0wRP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emayili_v0.9.3-tikzDictionary"
