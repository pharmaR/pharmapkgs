# Validation Report - BNrich@0.1.1
...
| export_help          | 8                                                |
| has_website          | TRUE                                             |
| has_maintainer       | Samaneh Maleknia <maleknias@gmail.com>           |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/Samaneh-Bioinformatics/BNrich |
...
Overall the package has 8 exported objects. 8 are documented:
          ...
          BN_struct          BNrich        esti_par fetch_data_file        LASSO_BN 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         parm_Ttest      unify_path         var_mat 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:29:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd282534b7_1739593749
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnLDmam
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BNrich_v0.1.1-tikzDictionary"
