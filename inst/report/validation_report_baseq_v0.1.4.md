...
| export_help          | 26                                |
| has_website          | TRUE                              |
| has_maintainer       | Ambu Vijayan <ambuvjyn@gmail.com> |
| bugs_status          | subscript out of bounds           |
| size_codebase        | 440                               |
| has_source_control   | https://github.com/ambuvjyn/baseq |
...
Overall the package has 26 exported objects. 26 are documented:
            ...
            clean_DNA_file     clean_DNA_sequence         clean_RNA_file 
                      TRUE                   TRUE                   TRUE 
        clean_RNA_sequence         clean_sequence            count_bases 
                      TRUE                   TRUE                   TRUE 
         count_seq_pattern         dna_to_protein             dna_to_rna 
                      TRUE                   TRUE                   TRUE 
            fastq_to_fasta             gc_content        gc_content_file 
                      TRUE                   TRUE                   TRUE 
          read.fasta_to_df     read.fasta_to_list       read.fastq_to_df 
                      TRUE                   TRUE                   TRUE 
        read.fastq_to_list     reverse_complement rna_reverse_complement 
                      TRUE                   TRUE                   TRUE 
                rna_to_dna         rna_to_protein      write.df_to_fasta 
                      TRUE                   TRUE                   TRUE 
         write.df_to_fastq       write.dna_to_rna    write.list_to_fasta 
                      TRUE                   TRUE                   TRUE 
       write.list_to_fastq       write.rna_to_dna 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-14 07:44:21 UTC |
...
running this report
    ...
    PROCESSX_PS1c0967c40af5_1739519058
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpulCIla
...
These are the options set to generate the report:
    ...
    [1] "validation_report_baseq_v0.1.4-tikzDictionary"
