# Validation Report - dataresqc@1.1.1
...
| export_help          | 25                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yuri Brugnara <yuri.brugnara@gmail.com>              |
...
Overall the package has 25 exported objects. 25 are documented:
                ...
                check_sef     climatic_outliers        climexp_to_sef 
                     TRUE                  TRUE                  TRUE 
         convert_pressure    daily_out_of_range      daily_repetition 
                     TRUE                  TRUE                  TRUE 
        duplicate_columns       duplicate_dates       duplicate_times 
                     TRUE                  TRUE                  TRUE 
        impossible_values  internal_consistency            plot_daily 
                     TRUE                  TRUE                  TRUE 
            plot_decimals         plot_subdaily     plot_weekly_cycle 
                     TRUE                  TRUE                  TRUE 
                       qc             read_meta              read_sef 
                     TRUE                  TRUE                  TRUE 
    subdaily_out_of_range   subdaily_repetition    temporal_coherence 
                     TRUE                  TRUE                  TRUE 
         wmo_gross_errors  wmo_time_consistency           write_flags 
                     TRUE                  TRUE                  TRUE 
                write_sef 
                     TRUE 
...
| Execution Time | 2025-02-17 05:00:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bd668b07796_1739768399
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdzS6pi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dataresqc_v1.1.1-tikzDictionary"
