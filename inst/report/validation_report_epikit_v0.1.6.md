# Validation Report - epikit@0.1.6
...
| has_source_control   | https://github.com/R4EPI/epikit     |
...
| 1   | binom              | Imports |
| 2   | scales             | Imports |
| 3   | dplyr (\>= 1.0.2)  | Imports |
| 4   | rlang              | Imports |
| 5   | forcats            | Imports |
| 6   | tidyr (\>= 1.0.0)  | Imports |
| 7   | tibble (\>= 3.0.0) | Imports |
| 8   | glue               | Imports |
...
Overall the package has 29 exported objects. 29 are documented:
         ...
         add_weights_cluster       add_weights_strata           age_categories 
                        TRUE                     TRUE                     TRUE 
    assert_positive_timespan              attack_rate        augment_redundant 
                        TRUE                     TRUE                     TRUE 
          case_fatality_rate    case_fatality_rate_df          constrain_dates 
                        TRUE                     TRUE                     TRUE 
            dots_to_charlist             fac_from_num              find_breaks 
                        TRUE                     TRUE                     TRUE 
             find_date_cause            find_end_date          find_start_date 
                        TRUE                     TRUE                     TRUE 
                      fmt_ci                fmt_ci_df                fmt_count 
                        TRUE                     TRUE                     TRUE 
                     fmt_pci               fmt_pci_df              gen_polygon 
                        TRUE                     TRUE                     TRUE 
              gen_population     group_age_categories              merge_ci_df 
                        TRUE                     TRUE                     TRUE 
                merge_pci_df           mortality_rate         rename_redundant 
                        TRUE                     TRUE                     TRUE 
                    unite_ci                   zcurve 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-19 04:17:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d45789b0527_1739938625
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTkGVqN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epikit_v0.1.6-tikzDictionary"
