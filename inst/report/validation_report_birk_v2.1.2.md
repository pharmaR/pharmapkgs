...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Matthew A. Birk <matthewabirk@gmail.com>             |
...
Overall the package has 8 exported objects. 8 are documented:
             ...
             conv_dim         conv_unit conv_unit_options         geom_mean 
                 TRUE              TRUE              TRUE              TRUE 
            range_seq                se         summ_stat     which.closest 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:17:21 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd60446255_1739593036
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJiDsBC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_birk_v2.1.2-tikzDictionary"
