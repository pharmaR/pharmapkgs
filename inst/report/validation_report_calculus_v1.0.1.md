# Validation Report - calculus@1.0.1
...
| export_help          | 45                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Emanuele Guidotti <emanuele.guidotti@unine.ch> |
...
bayesCureRateModel, difNLR, metafor, mosaicCalc, yuima

## Namespace

Overall the package has 45 exported objects. 29 are documented:

         %cross%       %curl%       %diff%        %div% %divergence%        %dot% 
           FALSE        FALSE        FALSE        FALSE        FALSE        FALSE 
      %gradient%    %hessian%      %inner%   %jacobian%  %kronecker%  %laplacian% 
           FALSE        FALSE        FALSE        FALSE        FALSE        FALSE 
            %mx%      %outer%       %prod%        %sum%          c2e  contraction 
           FALSE        FALSE        FALSE        FALSE         TRUE         TRUE 
           cross         curl        delta   derivative     diagonal   diagonal<- 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      divergence          e2c     einstein      epsilon     evaluate     gradient 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
         hermite      hessian        index      index<-     integral     jacobian 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       laplacian           mx        mxdet        mxinv         mxtr          ode 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      partitions       taylor         wrap 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 03:34:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36e1d5820_1739676849
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9N2SJt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_calculus_v1.0.1-tikzDictionary"
