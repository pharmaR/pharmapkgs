...
Overall the package has 41 exported objects. 41 are documented:
            ...
            AFLocalSigma                  aws         aws.gaussian 
                    TRUE                 TRUE                 TRUE 
               aws.irreg          aws.segment            aws3Dmask 
                    TRUE                 TRUE                 TRUE 
           aws3Dmaskfull              awsdata             awslinsd 
                    TRUE                 TRUE                 TRUE 
           awsLocalSigma          awstestprop           awsweights 
                    TRUE                 TRUE                 TRUE 
                 binning       estGlobalSigma   estimateSigmaCompl 
                    TRUE                 TRUE                 TRUE 
                 gethani              getvofh          ICIcombined 
                    TRUE                 TRUE                 TRUE 
               ICIsmooth               kernsm                lpaws 
                    TRUE                 TRUE                 TRUE 
          medianFilter3D              nlmeans                 paws 
                    TRUE                 TRUE                 TRUE 
            pawstestprop            qmeasures  residualSpatialCorr 
                    TRUE                 TRUE                 TRUE 
        residualVariance             smooth3D                smse3 
                    TRUE                 TRUE                 TRUE 
                 smse3ms              sofmchi        TGV_denoising 
                    TRUE                 TRUE                 TRUE 
    TGV_denoising_colour         TV_denoising  TV_denoising_colour 
                    TRUE                 TRUE                 TRUE 
                    vaws              vawscov                vpaws 
                    TRUE                 TRUE                 TRUE 
                vpawscov            vpawscov2 
...
There are 27 help pages with examples, from 31 (87.10 %).
...
| Execution Time | 2025-02-14 07:36:25 UTC |
...
running this report
    ...
    PROCESSX_PS1c09435eba18_1739518582
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnyuHCF
