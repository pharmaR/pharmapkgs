# Validation Report - condathis@0.1.1
...
| export_help          | 15                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Lucio Queiroz <luciorqueiroz@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/luciorq/condathis    |
...
Overall the package has 15 exported objects. 15 are documented:
             ...
             create_env          env_exists         get_env_dir     get_install_dir 
                   TRUE                TRUE                TRUE                TRUE 
           get_sys_arch  install_micromamba    install_packages           list_envs 
                   TRUE                TRUE                TRUE                TRUE 
          list_packages micromamba_bin_path        parse_output          remove_env 
                   TRUE                TRUE                TRUE                TRUE 
                    run             run_bin    with_sandbox_dir 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 03:40:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bd634746904_1739763609
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNLsGez
...
These are the options set to generate the report:
    ...
    [1] "validation_report_condathis_v0.1.1-tikzDictionary"
