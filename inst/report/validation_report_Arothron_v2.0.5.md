...
| export_help          | 34                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Antonio Profico <antonio.profico@gmail.com>          |
...
Overall the package has 34 exported objects. 34 are documented:
        ...
        aro.clo.points        arraytolist          bary.mesh  compare_check.set 
                  TRUE               TRUE               TRUE               TRUE 
          CScorreffect          dec.curve                dta          endomaker 
                  TRUE               TRUE               TRUE               TRUE 
         endomaker_dir       export_amira  export_amira.path       ext.int.mesh 
                  TRUE               TRUE               TRUE               TRUE 
          ext.mesh.rai           grid_pov     image2palettes landmark_frm2amira 
                  TRUE               TRUE               TRUE               TRUE 
           listtoarray      localmeshdiff    MLECScorrection         noise.mesh 
                  TRUE               TRUE               TRUE               TRUE 
          out.inn.mesh  patches_frm2amira       PCscoresCorr        permutangle 
                  TRUE               TRUE               TRUE               TRUE 
          pov_selecter     read.amira.dir     read.amira.set    read.path.amira 
                  TRUE               TRUE               TRUE               TRUE 
                repmat spherical.flipping         trasf.mesh       twodvarshape 
                  TRUE               TRUE               TRUE               TRUE 
             twodviews            volendo 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-14 07:24:36 UTC |
...
running this report
    ...
    PROCESSX_PS1c0913b9c28e_1739517873
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJSJ1f7
