# Validation Report - doolkit@1.42.2
...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ghislain Thiery <ghislain.thiery@ntymail.com>        |
...
Overall the package has 23 exported objects. 23 are documented:
         ...
         angularity             arc          area2d        dkborder          dkcrop 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              dkmap        dkorigin       dkprofile       dksetview             dne 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               elev           hypso          inclin          oedist             opc 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               opcr          orient    poly.network polygon.network             rfi 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              rrate     shape.index           slope 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:34:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4315d5b52_1739853257
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcpiPdT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doolkit_v1.42.2-tikzDictionary"
