# Validation Report - ClusROC@1.0.2
...
| export_help          | 6                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Duc-Khanh To <toduc@stat.unipd.it>    |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/toduckhanh/ClusROC |
...
Overall the package has 6 exported objects. 6 are documented:
         ...
         ci_clus_vus         clus_lme  clus_opt_thres3 clus_roc_surface 
                TRUE             TRUE             TRUE             TRUE 
           clus_tcfs         clus_vus 
                TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:37:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bc348d34a98_1739680633
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5CBLNX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClusROC_v1.0.2-tikzDictionary"
