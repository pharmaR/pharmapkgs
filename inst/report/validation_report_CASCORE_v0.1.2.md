# Validation Report - CASCORE@0.1.2
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Yaofang Hu <yaofangh@smu.edu>                        |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         ADMM      CASC   CASCORE Cov_based Net_based      nPCA      oPCA     SCORE 
...
| Execution Time | 2025-02-16 03:44:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33308f5ef_1739677462
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaIjyO9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CASCORE_v0.1.2-tikzDictionary"
