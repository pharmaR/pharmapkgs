# Validation Report - DepLogo@1.2.1
...
| export_help          | 28                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jan Grau <grau@informatik.uni-halle.de>              |
...
Overall the package has 28 exported objects. 28 are documented:
                  ...
                  Alphabet           alphabet.dna       alphabet.dna.gap 
                      TRUE                   TRUE                   TRUE 
          alphabet.protein   alphabet.protein.gap           alphabet.rna 
                      TRUE                   TRUE                   TRUE 
          alphabet.rna.gap             colorchart               deprects 
                      TRUE                   TRUE                   TRUE 
                    DLData filter.by.conservation filter.by.dependencies 
                      TRUE                   TRUE                   TRUE 
            filter.by.gaps          filterColumns                getDeps 
                      TRUE                   TRUE                   TRUE 
                    getPWM                   logo              partition 
                      TRUE                   TRUE                   TRUE 
                plotBlocks            plotDeparcs            plotDeplogo 
                      TRUE                   TRUE                   TRUE 
             plotDepmatrix          replaceColors                 revcom 
                      TRUE                   TRUE                   TRUE 
                  subBoxes               subLines          suggestColors 
                      TRUE                   TRUE                   TRUE 
            summary.DLData 
                      TRUE 
...
| Execution Time | 2025-02-18 03:44:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44aaf2af6_1739850244
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpO7k1ws
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DepLogo_v1.2.1-tikzDictionary"
