# Validation Report - catSurv@1.5.0
...
| export_help          | 80                              |
| has_website          | FALSE                           |
| has_maintainer       | Erin Rossiter <erossite@nd.edu> |
...
| 9   | BH(\>= 1.69.0.1)   | LinkingTo |
| 10  | Rcpp(\>= 1.0.1)    | LinkingTo |
| 11  | RcppArmadillo      | LinkingTo |
| 12  | RcppGSL(\>= 0.3.6) | LinkingTo |
| 13  | RcppParallel       | LinkingTo |
...
Overall the package has 26 exported objects. 77 are documented:

        checkStopRules               d1LL               d2LL         estimateSE 
                  TRUE               TRUE               TRUE               TRUE 
         estimateTheta         expectedKL     expectedObsInf         expectedPV 
                  TRUE               TRUE               TRUE               TRUE 
             fisherInf     fisherTestInfo               gpcm                grm 
                  TRUE               TRUE               TRUE               TRUE 
            likelihood       likelihoodKL          lookAhead                ltm 
                  TRUE               TRUE               TRUE               TRUE 
              makeTree             obsInf               plot        posteriorKL 
                  TRUE               TRUE              FALSE               TRUE 
                 prior        probability         selectItem simulateFisherInfo 
                  TRUE               TRUE               TRUE               TRUE 
        simulateThetas                tpm 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-16 03:48:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36860e2f9_1739677688
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHmj547
...
These are the options set to generate the report:
    ...
    [1] "validation_report_catSurv_v1.5.0-tikzDictionary"
