# Validation Report - dismo@1.3.16
...
| export_help          | 4                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Robert J. Hijmans <r.hijmans@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_bug_reports_url  | 1                                       |
| downloads_1yr        | 112005                                  |
| reverse_dependencies | 19                                      |
| has_examples         | 0.8867925                               |
| dependencies         | 6                                       |
| license              | GPL (\>= 3)                             |
...
| 1   | Rcpp                | Imports   |
| 2   | methods             | Imports   |
| 3   | terra (\>= 1.5-34)  | Imports   |
| 4   | Rcpp                | LinkingTo |
| 5   | raster (\>= 3.5-21) | Depends   |
| 6   | sp (\>= 1.4-5)      | Depends   |
...
BiodiversityR, biomod2, dartR.base, dartR.spatial, ecospat, ENMTools,
gbm.auto, hemispheR, maskRangeR, maxlike, NicheBarcoding, PopGenReport,
rangeModelMetadata, red, sdm, SDMtune, SSDM, wallace, webSDM

## Namespace

Overall the package has 0 exported objects. 3 are documented:

    named logical(0)

### Examples

There are 47 help pages with examples, from 53 (88.68 %).
...
| Execution Time | 2025-02-18 04:15:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb410b5905c_1739852127
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpE7MzOt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dismo_v1.3.16-tikzDictionary"
