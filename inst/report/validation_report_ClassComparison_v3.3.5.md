# Validation Report - ClassComparison@3.3.5
...
Overall the package has 16 exported objects. 20 are documented:

                  Bum            Dudoit              dwil     likelihoodBum 
                 TRUE              TRUE              TRUE              TRUE 
     MultiLinearModel        MultiTtest  MultiTtestPaired MultiTtestUnequal 
                 TRUE              TRUE              TRUE              TRUE 
           multiTukey MultiWilcoxonTest           rankSum               Sam 
                 TRUE              TRUE              TRUE              TRUE 
          SingleGroup       SmoothTtest              TNoM     TwoGroupStats 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:26:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36ab2cc91_1739679987
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZPhmjc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClassComparison_v3.3.5-tikzDictionary"
