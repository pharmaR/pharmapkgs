# Validation Report - cmprskQR@0.9.2
...
| export_help | 7 |
| has_website | TRUE |
| has_maintainer | Stephan Dlugosz <stephan.dlugosz@googlemail.com> |
| bugs_status | scraping bug reports fromm BugReports host ‘bitbucket’ not implemented |
| has_source_control | https://bitbucket.org/sdlugosz/cmprskqr |
...
Overall the package has 7 exported objects. 7 are documented:
                  ...
                  crrQR          plot.crrQR  plot.predict.crrQR       predict.crrQR 
                   TRUE                TRUE                TRUE                TRUE 
            print.crrQR print.summary.crrQR       summary.crrQR 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:45:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33be2d819_1739681129
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxOrg4u
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmprskQR_v0.9.2-tikzDictionary"
