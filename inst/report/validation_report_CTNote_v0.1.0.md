# Validation Report - CTNote@0.1.0
...
| export_help          | 10                                  |
| has_website          | TRUE                                |
| has_maintainer       | Gabriel Odom <gabriel.odom@fiu.edu> |
...
Overall the package has 10 exported objects. 10 are documented:
             ...
             collapse_lattice             count_matches          detect_in_window 
                         TRUE                      TRUE                      TRUE 
            detect_subpattern     impute_missing_visits measure_abstinence_period 
                         TRUE                      TRUE                      TRUE 
            measure_retention     recode_missing_visits           view_by_lattice 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-17 04:34:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bd632e73cce_1739766890
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2eAVis
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CTNote_v0.1.0-tikzDictionary"
