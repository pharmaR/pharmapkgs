# Validation Report - condTruncMVN@0.0.2
...
| export_help          | 4                                      |
| has_website          | FALSE                                  |
| has_maintainer       | Paul M. Hargarten <hargartenp@vcu.edu> |
...
|:----|:------------------------|:--------|
| 1   | R(\>= 3.5.0)            | Depends |
| 2   | condMVNorm(\>= 2020.1)  | Imports |
| 3   | matrixNormal(\>= 0.0.1) | Imports |
| 4   | tmvmixnorm(\>= 1.0.2)   | Imports |
| 5   | tmvtnorm(\>= 1.4-10)    | Imports |
| 6   | truncnorm(\>= 1.0-8)    | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
         ...
         condtMVN dcmvtruncnorm pcmvtruncnorm rcmvtruncnorm 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 03:41:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61935ed4a_1739763696
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbGzjnC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_condTruncMVN_v0.0.2-tikzDictionary"
