# Validation Report - BuildSys@1.1.2
...
| export_help          | 13                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Paavo Jumppanen <paavo.jumppanen@csiro.au> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/pjumppanen/BuildSys     |
...
Overall the package has 13 exported objects. 13 are documented:
            ...
            buildMakefile                 clean           includePath 
                     TRUE                  TRUE                  TRUE 
    initProjectFromFolder    installIncludePath    installLibraryPath 
                     TRUE                  TRUE                  TRUE 
              libraryPath           loadLibrary                  make 
                     TRUE                  TRUE                  TRUE 
                  objPath            sourcePath         unloadLibrary 
                     TRUE                  TRUE                  TRUE 
                  vcDebug 
                     TRUE 
...
| Execution Time | 2025-02-15 04:53:57 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd422bf5f7_1739595232
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoBYOKx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BuildSys_v1.1.2-tikzDictionary"
