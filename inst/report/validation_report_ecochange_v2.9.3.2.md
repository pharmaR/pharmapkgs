# Validation Report - ecochange@2.9.3.2
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Wilson Lara Henao <wilarhen@gmail.com>               |
...
Overall the package has 13 exported objects. 13 are documented:
           ...
           EBVstats        echanges  gaugeIndicator         getGADM          getrsp 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             getWRS          listGP   plot.EBVstats   plot.echanges  plot.Indicator 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            rsp2ebv sampleIndicator    tabuleRaster 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 03:33:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d45475955b3_1739936013
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB5KC5f
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecochange_v2.9.3.2-tikzDictionary"
