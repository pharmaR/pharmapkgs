...
Overall the package has 48 exported objects. 45 are documented:

               ..      .compfun   .save_names       .sumfun           All 
             TRUE         FALSE         FALSE         FALSE          TRUE 
              Any  auto_cluster         chain         chars           Chr 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    close_cluster          cols          Comp            DF          enum 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              Env         first       flatten        groups          ifor 
             TRUE          TRUE          TRUE          TRUE          TRUE 
            items          iter          lagg          List       Logical 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             lrep           Mat           Max          Mean           Min 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             None     null.omit           Num         Paste          Prod 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             rest          roll          rows      separate         slice 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           splitn         Stats           Sum     transpose        unroll 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             vals           Vec           zip 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 03:56:16 UTC |
...
running this report
    ...
    PROCESSX_PS1d4527edea7b_1739937370
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpr5NzDm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eList_v0.2.0-tikzDictionary"
