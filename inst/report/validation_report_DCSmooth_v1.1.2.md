# Validation Report - DCSmooth@1.1.2
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Bastian Schaefer <bastian.schaefer@uni-paderborn.de> |
...
Overall the package has 11 exported objects. 11 are documented:
              ...
              dcs kernel.assign   kernel.list     qarma.est     qarma.sim 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        sarma.est     sarma.sim   set.options   sfarima.est   sfarima.sim 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      surface.dcs 
             TRUE 
...
| Execution Time | 2025-02-17 05:11:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61ab537d9_1739769104
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpI2PVV5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DCSmooth_v1.1.2-tikzDictionary"
