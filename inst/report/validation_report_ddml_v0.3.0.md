...
| export_help          | 14                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Thomas Wiemann <wiemann@uchicago.edu> |
| bugs_status          | 0.9                                   |
| has_source_control   | https://github.com/thomaswiemann/ddml |
...
Overall the package has 14 exported objects. 14 are documented:
        ...
        crosspred      crossval      ddml_ate      ddml_att    ddml_fpliv 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        ddml_late     ddml_pliv      ddml_plm       mdl_glm    mdl_glmnet 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       mdl_ranger   mdl_xgboost           ols shortstacking 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 03:29:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47c6ead7c_1739849360
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeK2TyB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ddml_v0.3.0-tikzDictionary"
