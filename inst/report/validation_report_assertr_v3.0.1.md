...
| export_help | 37 |
| has_website | TRUE |
| has_maintainer | Tony Fischetti <tony.fischetti@gmail.com> |
| bugs_status | subscript out of bounds |
| size_codebase | 870 |
| has_source_control | https://docs.ropensci.org/assertr/ (website) |
...
Overall the package has 37 exported objects. 37 are documented:
                    ...
                    assert            assert_rows              chain_end 
                      TRUE                   TRUE                   TRUE 
               chain_start             col_concat          defect_append 
                      TRUE                   TRUE                   TRUE 
          defect_df_return          defect_report duplicates_across_cols 
                      TRUE                   TRUE                   TRUE 
              error_append        error_df_return          error_logical 
                      TRUE                   TRUE                   TRUE 
              error_report           error_return             error_stop 
                      TRUE                   TRUE                   TRUE 
             has_all_names              has_class         has_only_names 
                      TRUE                   TRUE                   TRUE 
                    in_set                 insist            insist_rows 
                      TRUE                   TRUE                   TRUE 
                   is_uniq              just_warn              maha_dist 
                      TRUE                   TRUE                   TRUE 
                    not_na            num_row_NAs         success_append 
                      TRUE                   TRUE                   TRUE 
          success_continue      success_df_return        success_logical 
                      TRUE                   TRUE                   TRUE 
            success_report                 verify            warn_report 
                      TRUE                   TRUE                   TRUE 
            warning_append          within_bounds          within_n_mads 
                      TRUE                   TRUE                   TRUE 
              within_n_sds 
                      TRUE 
...
| Execution Time | 2025-02-14 07:28:21 UTC |
...
running this report
    ...
    PROCESSX_PS1c0921c068ef_1739518098
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoPd0iA
