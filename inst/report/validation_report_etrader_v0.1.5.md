# Validation Report - etrader@0.1.5
...
| export_help          | 22                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Anthony Balentine <exploringfinance1@gmail.com> |
...
Overall the package has 22 exported objects. 21 are documented:
                        ...
                        %>%    etrd_account_balance       etrd_account_list 
                      FALSE                    TRUE                    TRUE 
     etrd_account_portfolio       etrd_alert_detail             etrd_alerts 
                       TRUE                    TRUE                    TRUE 
     etrd_auth_access_token   etrd_auth_credentials     etrd_auth_login_url 
                       TRUE                    TRUE                    TRUE 
     etrd_auth_manage_token       etrd_cancel_order            etrd_get_url 
                       TRUE                    TRUE                    TRUE 
          etrd_market_quote       etrd_option_chain  etrd_option_expiration 
                       TRUE                    TRUE                    TRUE 
         etrd_order_history     etrd_place_eq_order     etrd_place_mf_order 
                       TRUE                    TRUE                    TRUE 
      etrd_place_optn_order     etrd_product_search etrd_transaction_detail 
                       TRUE                    TRUE                    TRUE 
          etrd_transactions 
                       TRUE 
...
| Execution Time | 2025-02-19 04:34:42 UTC |
...
running this report
    ...
    PROCESSX_PS1d457acc7210_1739939675
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNSHvWA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_etrader_v0.1.5-tikzDictionary"
