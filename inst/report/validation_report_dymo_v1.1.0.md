...
| 2   | ggplot2 (\>= 3.3.5)    | Imports |
| 3   | readr (\>= 2.1.2)      | Imports |
| 4   | lubridate (\>= 1.7.10) | Imports |
| 5   | imputeTS (\>= 3.2)     | Imports |
| 6   | fANCOVA (\>= 0.6-1)    | Imports |
| 7   | scales (\>= 1.1.1)     | Imports |
| 8   | tictoc (\>= 1.0.1)     | Imports |
| 9   | modeest (\>= 2.4.0)    | Imports |
| 10  | moments (\>= 0.14)     | Imports |
| 11  | greybox (\>= 1.0.1)    | Imports |
| 12  | MASS (\>= 7.3-54)      | Imports |
| 13  | matlib (\>= 0.9.5)     | Imports |
| 14  | narray (\>= 0.4.1.1)   | Imports |
...
| Execution Time | 2025-02-18 05:03:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bb441ebe5_1739854989
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB1SaC2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dymo_v1.1.0-tikzDictionary"
