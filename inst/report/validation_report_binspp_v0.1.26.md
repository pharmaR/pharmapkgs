# Validation Report - binspp@0.1.26
...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Remes Radim <inrem@jcu.cz>                           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/tomasmrkvicka/binspp              |
...
Overall the package has 9 exported objects. 9 are documented:
           ...
           estgtp       estgtpr       estintp    first_step  plot_outputs 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    print_outputs   re_estimate          rgtp  rThomasInhom 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-15 04:10:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5fe372d9_1739592637
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIDH36B
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binspp_v0.1.26-tikzDictionary"
