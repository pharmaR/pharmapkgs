...
| export_help          | 7                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Mikko Kuronen <mikko.kuronen@luke.fi> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/mikkoku/efdm       |
...
Overall the package has 7 exported objects. 7 are documented:
       ...
       define_activity estimatetransprobs           prior_ff         prior_grow 
                  TRUE               TRUE               TRUE               TRUE 
               runEFDM         transprobs       transprobs<- 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 03:46:22 UTC |
...
running this report
    ...
    PROCESSX_PS1d4544ef268b_1739936776
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdH4Uq6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_efdm_v0.2.1-tikzDictionary"
