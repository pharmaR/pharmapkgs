# Validation Report - covid19us@0.1.9
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Amanda Dobbyn <amanda.e.dobbyn@gmail.com>            |
...
Overall the package has 11 exported objects. 9 are documented:

                  %<>%                %>%  get_counties_info get_info_covid19us 
                 FALSE              FALSE               TRUE               TRUE 
    get_states_current   get_states_daily    get_states_info   get_tracker_urls 
                  TRUE               TRUE               TRUE               TRUE 
        get_us_current       get_us_daily  refresh_covid19us 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:08:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bd614785d6d_1739765304
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpypbFk2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covid19us_v0.1.9-tikzDictionary"
