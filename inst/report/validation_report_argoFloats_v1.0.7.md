...
| export_help          | 30                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Dan Kelley <dan.kelley@dal.ca>           |
| bugs_status          | subscript out of bounds                  |
| size_codebase        | 2696                                     |
| has_source_control   | https://github.com/ArgoCanada/argoFloats |
...
Overall the package has 24 exported objects. 24 are documented:
                   ...
                   applyQC  argoDefaultBathymetry     argoDefaultDestdir 
                      TRUE                   TRUE                   TRUE 
       argoDefaultIndexAge  argoDefaultProfileAge      argoDefaultServer 
                      TRUE                   TRUE                   TRUE 
      argoFloatsClearCache        argoFloatsDebug argoFloatsGetFromCache 
                      TRUE                   TRUE                   TRUE 
        argoFloatsIsCached    argoFloatsListCache argoFloatsStoreInCache 
                      TRUE                   TRUE                   TRUE 
      argoFloatsWhenCached    downloadWithRetries               getIndex 
                      TRUE                   TRUE                   TRUE 
         getProfileFromUrl            getProfiles       hasArgoTestCache 
                      TRUE                   TRUE                   TRUE 
                 hexToBits                 mapApp             plotArgoTS 
                      TRUE                   TRUE                   TRUE 
              readProfiles            showQCTests            useAdjusted 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-14 07:23:08 UTC |
...
running this report
    ...
    PROCESSX_PS1c0975876d41_1739517785
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSe5p4j
