...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Steve Weston <stephen.b.weston@gmail.com>            |
...
batchtools, BVSNLP, doRNG, MoBPS, moc.gapbk, NMF

## Namespace

Overall the package has 10 exported objects. 10 are documented:

        closeCluster      clusterSize  dompiWorkerLoop      exportDoMPI 
                TRUE             TRUE             TRUE             TRUE 
     getDoMpiCluster   openMPIcluster    registerDoMPI      setRngDoMPI 
                TRUE             TRUE             TRUE             TRUE 
    sinkWorkerOutput  startMPIcluster 
                TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:33:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bb420cc7885_1739853231
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdMMZAE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doMPI_v0.2.2-tikzDictionary"
