# Validation Report - censored@0.3.3
...
| has_source_control   | https://github.com/tidymodels/censored |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | parsnip (\>= 1.3.0)      | Depends |
| 2   | survival (\>= 3.7-0)     | Depends |
| 3   | cli                      | Imports |
| 4   | dials                    | Imports |
| 5   | dplyr (\>= 0.8.0.1)      | Imports |
| 6   | generics                 | Imports |
| 7   | glue                     | Imports |
| 8   | hardhat (\>= 1.4.1)      | Imports |
| 9   | lifecycle                | Imports |
| 10  | mboost                   | Imports |
| 11  | prodlim (\>= 2023.03.31) | Imports |
| 12  | purrr                    | Imports |
| 13  | rlang (\>= 1.0.0)        | Imports |
| 14  | stats                    | Imports |
| 15  | tibble (\>= 3.1.3)       | Imports |
| 16  | tidyr (\>= 1.0.0)        | Imports |
| 17  | vctrs                    | Imports |
...
easysurv, lnmixsurv, MachineShop, survex, tidyAML, tune

## Namespace

Overall the package has 15 exported objects. 15 are documented:

          blackboost_train           coxnet_train         hazard_survreg 
                      TRUE                   TRUE                   TRUE 
      survival_prob_coxnet    survival_prob_coxph   survival_prob_mboost 
                      TRUE                   TRUE                   TRUE 
        survival_prob_orsf survival_prob_partykit survival_prob_pecRpart 
                      TRUE                   TRUE                   TRUE 
    survival_prob_survbagg  survival_prob_survreg   survival_time_coxnet 
                      TRUE                   TRUE                   TRUE 
       survival_time_coxph   survival_time_mboost survival_time_survbagg 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:00:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc38f63cff_1739678420
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1rTkIX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_censored_v0.3.3-tikzDictionary"
