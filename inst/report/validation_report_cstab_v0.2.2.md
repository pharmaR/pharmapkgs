...
| export_help          | 3                                               |
| has_website          | FALSE                                           |
| has_maintainer       | Jonas M. B. Haslbeck <jonas.haslbeck@gmail.com> |
...
|     | package           | type      |
|:----|:------------------|:----------|
| 1   | Rcpp (\>= 0.11.4) | Depends   |
| 2   | cluster           | Imports   |
| 3   | fastcluster       | Imports   |
| 4   | Rcpp              | LinkingTo |
...
| Execution Time | 2025-02-17 04:32:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63bc0b392_1739766718
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvI6FPd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cstab_v0.2.2-tikzDictionary"
