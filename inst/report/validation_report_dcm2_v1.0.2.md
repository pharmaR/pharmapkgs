...
| export_help          | 12                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Jeffrey Hoover <jeffrey.c.hoover@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/atlas-aai/dcm2           |
...
Overall the package has 12 exported objects. 11 are documented:
           ...
           :=     .data       %>% as_binary  as_label   as_name   calc_m2     enquo 
         TRUE      TRUE     FALSE      TRUE      TRUE      TRUE      TRUE      TRUE 
       enquos    fit_m2 inv_logit     logit 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-17 05:10:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bd613230c27_1739769047
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpm6f2yL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dcm2_v1.0.2-tikzDictionary"
