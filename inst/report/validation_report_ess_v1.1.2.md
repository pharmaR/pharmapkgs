...
| export_help          | 19                               |
| has_website          | TRUE                             |
| has_maintainer       | Mads Lindskou <mads@math.aau.dk> |
| bugs_status          | subscript out of bounds          |
| has_source_control   | https://github.com/mlindsk/ess   |
...
Overall the package has 19 exported objects. 19 are documented:
                ...
                adj_lst             adj_mat          as_adj_lst          as_adj_mat 
                   TRUE                TRUE                TRUE                TRUE 
              as_igraph          components                 dfs  dgm_sim_from_graph 
                   TRUE                TRUE                TRUE                TRUE 
                entropy      fit_components           fit_graph            gengraph 
                   TRUE                TRUE                TRUE                TRUE 
        is_decomposable make_complete_graph     make_null_graph                 mcs 
                   TRUE                TRUE                TRUE                TRUE 
                    rip            subgraph                walk 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:31:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d45316fd18f_1739939459
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppmnKIT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ess_v1.1.2-tikzDictionary"
