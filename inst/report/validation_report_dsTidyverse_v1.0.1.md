# Validation Report - dsTidyverse@1.0.1
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tim Cadman <t.j.cadman@umcg.nl>                      |
...
Overall the package has 17 exported objects. 17 are documented:
                             ...
                             arrangeDS                         asTibbleDS 
                                  TRUE                               TRUE 
                            bindColsDS                         bindRowsDS 
                                  TRUE                               TRUE 
                            caseWhenDS checkPermissivePrivacyControlLevel 
                                  TRUE                               TRUE 
                            distinctDS                           filterDS 
                                  TRUE                               TRUE 
                             groupByDS                        groupKeysDS 
                                  TRUE                               TRUE 
                              ifElseDS  listPermittedTidyverseFunctionsDS 
                                  TRUE                               TRUE 
                              mutateDS                           renameDS 
                                  TRUE                               TRUE 
                              selectDS                            sliceDS 
...
| Execution Time | 2025-02-18 04:53:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4407ef812_1739854425
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8sNz4j
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsTidyverse_v1.0.1-tikzDictionary"
