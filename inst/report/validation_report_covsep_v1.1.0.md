# Validation Report - covsep@1.1.0
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Shahin Tavakoli <s.tavakoli@warwick.ac.uk>           |
...
Overall the package has 10 exported objects. 10 are documented:
                       ...
                       clt_test    empirical_bootstrap_test 
                           TRUE                        TRUE 
        gaussian_bootstrap_test       generate_surface_data 
                           TRUE                        TRUE 
    HS_empirical_bootstrap_test  HS_gaussian_bootstrap_test 
                           TRUE                        TRUE 
           marginal_covariances       projected_differences 
                           TRUE                        TRUE 
             renormalize_mtnorm                     rmtnorm 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-17 04:09:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bd622c5276a_1739765376
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4Kcvsm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covsep_v1.1.0-tikzDictionary"
