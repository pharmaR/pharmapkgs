# Validation Report - BGData@2.4.1
...
| export_help          | 29                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Alexander Grueneberg <cran@agrueneberg.info> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/QuantGen/BGData           |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | BEDMatrix (\>= 1.4.0)    | Depends |
| 2   | LinkedMatrix (\>= 1.3.0) | Depends |
| 3   | symDMatrix (\>= 2.0.0)   | Depends |
| 4   | methods                  | Imports |
| 5   | parallel                 | Imports |
| 6   | crochet (\>= 2.1.0)      | Imports |
| 7   | bigmemory                | Imports |
| 8   | synchronicity            | Imports |
| 9   | ff                       | Imports |
| 10  | bit                      | Imports |
...
LinkedMatrix, symDMatrix

## Namespace

Overall the package has 23 exported objects. 29 are documented:

             as.BGData             BGData       chunkedApply         chunkedMap 
                  TRUE               TRUE               TRUE               TRUE 
           findRelated                FWD               geno             geno<- 
                  TRUE               TRUE               TRUE               TRUE 
                  getG    getG_symDMatrix               GWAS        load.BGData 
                  TRUE               TRUE               TRUE               TRUE 
                   map              map<-       orderedMerge              pheno 
                  TRUE               TRUE               TRUE               TRUE 
               pheno<-         preprocess            readRAW readRAW_big.matrix 
                  TRUE               TRUE               TRUE               TRUE 
        readRAW_matrix           segments          summarize 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 03:58:12 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd48bd1f4c_1739591887
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8Pm950
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BGData_v2.4.1-tikzDictionary"
