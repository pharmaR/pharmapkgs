# Validation Report - BatchGetSymbols@2.6.4
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Marcelo Perlin <marceloperlin@gmail.com>             |
...
Overall the package has 10 exported objects. 10 are documented:
     ...
     BatchGetSymbols         calc.ret       df.fill.na  fix.ticker.name 
                TRUE             TRUE             TRUE             TRUE 
      get.clean.data GetFTSE100Stocks    GetIbovStocks   GetSP500Stocks 
                TRUE             TRUE             TRUE             TRUE 
        myGetSymbols     reshape.wide 
                TRUE             TRUE 
...
| Execution Time | 2025-02-15 03:29:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5362399d_1739590183
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsWdYPY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BatchGetSymbols_v2.6.4-tikzDictionary"
