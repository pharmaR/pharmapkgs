...
| export_help          | 79                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Maximilian Pilz <maximilian.pilz@itwm.fraunhofer.de> |
| bugs_status          | subscript out of bounds                              |
| size_codebase        | 1941                                                 |
| has_source_control   | https://github.com/optad/adoptr                      |
| has_bug_reports_url  | 1                                                    |
| downloads_1yr        | 5615                                                 |
| reverse_dependencies | 1                                                    |
| has_examples         | 0.9361702                                            |
| dependencies         | 3                                                    |
...
Overall the package has 49 exported objects. 72 are documented:
                    ...
                    ConditionalPower            ConditionalSampleSize 
                                TRUE                             TRUE 
                     ContinuousPrior cumulative_distribution_function 
                                TRUE                             TRUE 
                            evaluate                      expectation 
                                TRUE                             TRUE 
                            expected           ExpectedNumberOfEvents 
                                TRUE                             TRUE 
                  ExpectedSampleSize               get_initial_design 
                                TRUE                             TRUE 
           get_lower_boundary_design                    get_tau_ANOVA 
                                TRUE                             TRUE 
                  get_tau_Pearson2xK                 get_tau_ZSquared 
                                TRUE                             TRUE 
           get_upper_boundary_design            GroupSequentialDesign 
                                TRUE                             TRUE 
                          make_fixed                     make_tunable 
                                TRUE                             TRUE 
                   MaximumSampleSize                         minimize 
                                TRUE                             TRUE 
                                   n                               n1 
                                TRUE                             TRUE 
                                  N1                               n2 
                        ...
                        NestedModels                           Normal 
                                TRUE                             TRUE 
                      OneStageDesign                       Pearson2xK 
                                TRUE                             TRUE 
                      PointMassPrior                        posterior 
                                TRUE                             TRUE 
                               Power                   predictive_cdf 
                                TRUE                             TRUE 
                      predictive_pdf     probability_density_function 
                                TRUE                             TRUE 
                             Student                       subject_to 
                                TRUE                             TRUE 
                            Survival                   SurvivalDesign 
                                TRUE                             TRUE 
                  tunable_parameters                   TwoStageDesign 
                                TRUE                             TRUE 
                            ZSquared 
                                TRUE 
...
There are 44 help pages with examples, from 47 (93.62 %).
...
| Execution Time | 2025-02-14 06:39:15 UTC |
...
running this report
    ...
    PROCESSX_PS726d462fd6bd_1739515152
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqmG4Bk
