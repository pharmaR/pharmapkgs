# Validation Report - clarify@0.2.1
...
| export_help          | 6                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Noah Greifer <ngreifer@iq.harvard.edu> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/iqss/clarify        |
...
| 2   | pbapply (\>= 1.7-0)          | Imports |
| 3   | chk (\>= 0.9.0)              | Imports |
| 4   | rlang (\>= 1.0.6)            | Imports |
| 5   | insight (\>= 0.19.11)        | Imports |
| 6   | marginaleffects (\>= 0.20.0) | Imports |
| 7   | mvnfast (\>= 0.2.6)          | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
        ...
        misim       sim  sim_adrf   sim_ame sim_apply  sim_setx 
...
| Execution Time | 2025-02-16 04:26:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bc313d7c3c3_1739679970
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbFRwmp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clarify_v0.2.1-tikzDictionary"
