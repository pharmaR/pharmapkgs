...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Henning Redestig <henning.red@gmail.com>             |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/hredestig/crmn                    |
...
Overall the package has 7 exported objects. 16 are documented:

    dropunusedlevels        normalize          normFit         normPred 
                TRUE             TRUE             TRUE             TRUE 
        standardsFit    standardsPred       weightnorm 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:21:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bd632b9d0ff_1739766089
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCNmzs6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crmn_v0.0.21-tikzDictionary"
