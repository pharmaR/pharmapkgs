...
| export_help          | 30                           |
| has_website          | TRUE                         |
| has_maintainer       | Gerold Hepp <gisler@hepp.cc> |
...
Overall the package has 30 exported objects. 30 are documented:
                 ...
                 alter           by______           by_____S           by____M_ 
                  TRUE               TRUE               TRUE               TRUE 
              by___H__           by_m____           by_Q____           byY_____ 
                  TRUE               TRUE               TRUE               TRUE 
              byYm____           byYmd___           byYmdH__           byYmdHM_ 
                  TRUE               TRUE               TRUE               TRUE 
              byYmdHMS           byYQ____              clone           colapply 
                  TRUE               TRUE               TRUE               TRUE 
                  cols               DTSg             getCol  interpolateLinear 
                  TRUE               TRUE               TRUE               TRUE 
                   nas            refresh          rollapply           rollback 
                  TRUE               TRUE               TRUE               TRUE 
          rowaggregate            rowbind S3WrapperGenerator        setColNames 
                  TRUE               TRUE               TRUE               TRUE 
               setCols             values 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-18 04:57:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bb49d87ddf_1739854645
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1a2cv5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DTSg_v2.0.0-tikzDictionary"
