# Validation Report - DNAmixturesLite@0.0.1
...
Overall the package has 24 exported objects. 24 are documented:
    ...
    buildMixtureDomains          DNAmixture      DNAmixtureData                dyes 
                   TRUE                TRUE                TRUE                TRUE 
                 dyes<-           getShapes                logL              logL.K 
                   TRUE                TRUE                TRUE                TRUE 
                logL.UK          logLpres.K         logLpres.UK       map.genotypes 
                   TRUE                TRUE                TRUE                TRUE 
                  mixML              mixpar   prequential.score              qqpeak 
                   TRUE                TRUE                TRUE                TRUE 
         removePeakInfo         rPeakHeight              setCPT            setCPT.D 
                   TRUE                TRUE                TRUE                TRUE 
               setCPT.O            setCPT.Q         setPeakInfo              varEst 
                   TRUE                TRUE                TRUE                TRUE 

### Examples

There are 22 help pages with examples, from 30 (73.33 %).
...
| Execution Time | 2025-02-25 03:22:35 UTC |
...
running this report
    ...
    PROCESSX_PS1d28263a53d8_1740453751
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJfMpIY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DNAmixturesLite_v0.0.1-tikzDictionary"
