# Validation Report - dyndimred@1.0.4
...
| has_source_control   | https://github.com/dynverse/dyndimred  |
...
Overall the package has 15 exported objects. 15 are documented:
                    ...
                    dimred      dimred_dm_destiny dimred_dm_diffusionmap 
                      TRUE                   TRUE                   TRUE 
                dimred_ica          dimred_knn_fr    dimred_landmark_mds 
                      TRUE                   TRUE                   TRUE 
                dimred_lle             dimred_mds      dimred_mds_isomds 
                      TRUE                   TRUE                   TRUE 
         dimred_mds_sammon      dimred_mds_smacof             dimred_pca 
                      TRUE                   TRUE                   TRUE 
               dimred_tsne            dimred_umap    list_dimred_methods 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 05:05:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42fa30d57_1739855127
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7KKPmH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dyndimred_v1.0.4-tikzDictionary"
