...
| export_help          | 26                                  |
| has_website          | TRUE                                |
| has_maintainer       | Eric Hare <erichare@iastate.edu>    |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/erichare/bulletr |
...
Overall the package has 26 exported objects. 26 are documented:
          ...
          boot_fit_loess          bulletAlign  bulletCheckCrossCut 
                    TRUE                 TRUE                 TRUE 
         bulletGetMaxCMS bulletGetMaxCMS_nist         bulletSmooth 
                    TRUE                 TRUE                 TRUE 
                     CMS            fit_loess          fortify_x3p 
                    TRUE                 TRUE                 TRUE 
              get_bullet         get_crosscut          get_grooves 
                    TRUE                 TRUE                 TRUE 
               get_peaks       get_peaks_nist            getCircle 
                    TRUE                 TRUE                 TRUE 
                getTwist               maxCMS         plot_3d_land 
                    TRUE                 TRUE                 TRUE 
              predCircle           predSmooth       processBullets 
                    TRUE                 TRUE                 TRUE 
                read_x3p           sample_x3p          smoothloess 
                    TRUE                 TRUE                 TRUE 
      striation_identify        unfortify_x3p 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:54:32 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2d8fadf3_1739595267
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRmqyge
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bulletr_v0.1-tikzDictionary"
