...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jessica Vandeleest <vandelee@ucdavis.edu>            |
...
Overall the package has 8 exported objects. 8 are documented:
            ...
            as.SimilarityMatrix as.symmetricAdjacencyMatrix 
                           TRUE                        TRUE 
                     getEnsList                      GetSim 
                           TRUE                        TRUE 
                   plotCLUSTERS        plotMultiEigenvalues 
                           TRUE                        TRUE 
                 plotTheCluster           temperatureSample 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-17 05:09:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bd668675203_1739768983
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpe7bfh8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DCG_v0.9.3-tikzDictionary"
