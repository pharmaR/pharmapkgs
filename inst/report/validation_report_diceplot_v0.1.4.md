# Validation Report - diceplot@0.1.4
...
| export_help | 9 |
| has_website | TRUE |
| has_maintainer | Matthias Flotho <matthias.flotho@ccb.uni-saarland.de> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/maflot/Diceplot |
...
| 3   | tidyr (\>= 1.3.0)       | Imports |
| 4   | data.table (\>= 1.14.8) | Imports |
| 5   | cowplot                 | Imports |
| 6   | tibble                  | Imports |
| 7   | stats                   | Imports |
| 8   | rlang                   | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
       ...
       calculate_dot_size create_custom_legends  create_var_positions 
                     TRUE                  TRUE                  TRUE 
                dice_plot           domino_plot           order_cat_b 
                     TRUE                  TRUE                  TRUE 
       perform_clustering      prepare_box_data     prepare_plot_data 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-18 04:00:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4339ce171_1739851213
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzDWnT5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diceplot_v0.1.4-tikzDictionary"
