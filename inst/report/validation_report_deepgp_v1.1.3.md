# Validation Report - deepgp@1.1.3
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Annie S. Booth <annie_booth@ncsu.edu>                |
...
Overall the package has 11 exported objects. 11 are documented:
                ...
                ALC        continue            crps   fit_one_layer fit_three_layer 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      fit_two_layer            IMSE            rmse           score         sq_dist 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               trim 
               TRUE 
...
| Execution Time | 2025-02-18 03:34:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47140401_1739849693
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQdRdYi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deepgp_v1.1.3-tikzDictionary"
