...
| bugs_status          | 1                                          |
| size_codebase        | 786                                        |
| has_source_control   | https://github.com/ericdunipace/approxOT   |
...
|     | package          | type      |
|:----|:-----------------|:----------|
| 1   | Rcpp (\>= 1.0.3) | Imports   |
| 2   | stats            | Imports   |
| 3   | Rcpp             | LinkingTo |
| 4   | RcppEigen        | LinkingTo |
| 5   | RcppCGAL         | LinkingTo |
| 6   | BH               | LinkingTo |
...
Overall the package has 11 exported objects. 11 are documented:
           ...
           as.transport.plan                cost_calc     general_1d_transport 
                        TRUE                     TRUE                     TRUE 
          hilbert.projection        is.transport.plan             sinkhorn_pot 
                        TRUE                     TRUE                     TRUE 
           transport_options           transport_plan   transport_plan_given_C 
                        TRUE                     TRUE                     TRUE 
    transport_plan_multimarg              wasserstein 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-14 07:19:18 UTC |
...
running this report
    ...
    PROCESSX_PS1c094c487fd0_1739517555
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpm4HH1m
