...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Emeline Courtois <courtoise@iarc.who.int>            |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | Matrix (\>= 1.0-6) | Depends |
| 2   | glmnet (\>= 3.0-2) | Depends |
| 3   | speedglm           | Imports |
| 4   | xgboost            | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
        ...
        adapt_bic    adapt_cisl      adapt_cv    adapt_univ          cisl 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       est_ps_bic   est_ps_hdps    est_ps_xgb     lasso_bic      lasso_cv 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       lasso_perm     ps_adjust ps_adjust_one       ps_pond   ps_pond_one 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     summary_stat 
             TRUE 
...
| Execution Time | 2025-02-21 13:07:30 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a4200e780_1740143246
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpp12VOf
