...
Overall the package has 8 exported objects. 8 are documented:
                 ...
                 binda      binda.ranking            chances        dichotomize 
                  TRUE               TRUE               TRUE               TRUE 
       is.binaryMatrix  optimizeThreshold plot.binda.ranking      predict.binda 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:07:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd63706a0_1739592473
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBuYsfK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binda_v1.0.4-tikzDictionary"
