# Validation Report - donutsk@0.1.1
...
| export_help          | 28                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Dmitry Kibalnikov <d.kibalnikov@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/dkibalnikov/donutsk     |
...
Overall the package has 28 exported objects. 28 are documented:
               ...
               circle               eye    geom_donut_ext geom_donut_ext_hl 
                 TRUE              TRUE              TRUE              TRUE 
      geom_donut_ext0    geom_donut_int geom_donut_int_hl   geom_donut_int0 
                 TRUE              TRUE              TRUE              TRUE 
       geom_label_ext    geom_label_int          geom_pin     geom_pin_head 
                 TRUE              TRUE              TRUE              TRUE 
        geom_pin_line     geom_text_ext     geom_text_int           packing 
                 TRUE              TRUE              TRUE              TRUE 
                petal      StatDonutExt    StatDonutExtHl      StatDonutInt 
                 TRUE              TRUE              TRUE              TRUE 
       StatDonutIntHl      StatLabelExt      StatLabelInt       StatPinHead 
                 TRUE              TRUE              TRUE              TRUE 
          StatPinLine       StatTextExt       StatTextInt                tv 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:34:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb462b3d339_1739853244
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmph6mgwp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_donutsk_v0.1.1-tikzDictionary"
