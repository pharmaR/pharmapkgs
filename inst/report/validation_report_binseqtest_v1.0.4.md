# Validation Report - binseqtest@1.0.4
...
Overall the package has 17 exported objects. 18 are documented:

        analyzeBound  analyzeBoundNBF         designAb      designFixed 
                TRUE             TRUE             TRUE             TRUE 
    designFixedpower        designOBF   designOBFpower      designSimon 
                TRUE             TRUE             TRUE             TRUE 
                  EN   getAlternative       getTSalpha           modify 
                TRUE             TRUE             TRUE             TRUE 
            powerBsb  print.stopTable           prStop        stopTable 
                TRUE             TRUE             TRUE             TRUE 
     unirootDiscrete 
                TRUE 
...
| Execution Time | 2025-02-15 04:10:31 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5657fc94_1739592626
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoCKLwx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binseqtest_v1.0.4-tikzDictionary"
