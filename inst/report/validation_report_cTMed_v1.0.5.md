...
| export_help          | 37                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Ivan Jacob Agaloos Pesigan <r.jeksterslab@gmail.com> |
| bugs_status          | subscript out of bounds                              |
| has_source_control   | https://github.com/jeksterslab/cTMed                 |
...
Overall the package has 37 exported objects. 37 are documented:
                    ...
                    BootBeta              BootBetaStd      BootIndirectCentral 
                        TRUE                     TRUE                     TRUE 
                     BootMed               BootMedStd         BootTotalCentral 
                        TRUE                     TRUE                     TRUE 
                   DeltaBeta             DeltaBetaStd     DeltaIndirectCentral 
                        TRUE                     TRUE                     TRUE 
                    DeltaMed              DeltaMedStd        DeltaTotalCentral 
                        TRUE                     TRUE                     TRUE 
                      Direct                DirectStd                   ExpCov 
                        TRUE                     TRUE                     TRUE 
                     ExpMean                 Indirect          IndirectCentral 
                        TRUE                     TRUE                     TRUE 
                 IndirectStd                   MCBeta                MCBetaStd 
                        TRUE                     TRUE                     TRUE 
           MCIndirectCentral                    MCMed                 MCMedStd 
                        TRUE                     TRUE                     TRUE 
                       MCPhi               MCPhiSigma           MCTotalCentral 
                        TRUE                     TRUE                     TRUE 
                         Med                   MedStd            PosteriorBeta 
                        TRUE                     TRUE                     TRUE 
    PosteriorIndirectCentral             PosteriorMed    PosteriorTotalCentral 
                        TRUE                     TRUE                     TRUE 
                       Total             TotalCentral                 TotalStd 
                        TRUE                     TRUE                     TRUE 
                  Trajectory 
                        TRUE 
...
| Execution Time | 2025-02-17 04:34:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67fcb6f97_1739766866
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppYpxFC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cTMed_v1.0.5-tikzDictionary"
