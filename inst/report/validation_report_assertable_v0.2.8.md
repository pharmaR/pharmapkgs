...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Grant Nguyen <grant.nguyen@gmail.com>                |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    assert_colnames assert_coltypes      assert_ids    assert_nrows   assert_values 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        check_files    import_files 
               TRUE            TRUE 
...
| Execution Time | 2025-02-14 07:28:14 UTC |
...
running this report
    ...
    PROCESSX_PS1c094c55310_1739518091
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8HWSYh
