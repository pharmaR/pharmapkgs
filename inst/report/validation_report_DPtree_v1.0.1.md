# Validation Report - DPtree@1.0.1
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Shaoyang Ning <shaoyangning@fas.harvard.edu>         |
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          dDPTreeRealize        DPTreeDensity   DPTreePMeanDensity 
                    TRUE                 TRUE                 TRUE 
         DPTreePosterior DPTreePosteriorMulti          DPTreePrior 
                    TRUE                 TRUE                 TRUE 
          pDPTreeRealize        RealizeDPTree  SampleDPTreeDensity 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-18 04:41:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4367eabbe_1739853700
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnZffc5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DPtree_v1.0.1-tikzDictionary"
