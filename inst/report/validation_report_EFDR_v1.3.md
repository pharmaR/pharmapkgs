...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Andrew Zammit-Mangion <andrewzm@gmail.com>           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/andrewzm/EFDR/                    |
...
| 2   | Matrix                 | Imports |
| 3   | methods                | Imports |
| 4   | foreach (\>= 1.4.2)    | Imports |
| 5   | doParallel (\>= 1.0.8) | Imports |
| 6   | waveslim (\>= 1.7.5)   | Imports |
| 7   | parallel               | Imports |
| 8   | gstat (\>= 1.0-19)     | Imports |
| 9   | tidyr (\>= 0.1.0.9000) | Imports |
| 10  | dplyr (\>= 0.3.0.2)    | Imports |
| 11  | sp (\>= 1.0-15)        | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            df.to.mat  diagnostic.table          fdrpower            regrid 
                 TRUE              TRUE              TRUE              TRUE 
           test_image   test.bonferroni         test.efdr test.efdr.condsim 
                 TRUE              TRUE              TRUE              TRUE 
             test.fdr          test.los            wav_th 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 03:46:29 UTC |
...
running this report
    ...
    PROCESSX_PS1d457901a568_1739936783
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1evMGN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EFDR_v1.3-tikzDictionary"
