# Validation Report - CptNonPar@0.2.1
...
| export_help          | 4                                             |
| has_website          | TRUE                                          |
| has_maintainer       | Euan T. McGonigle <e.t.mcgonigle@soton.ac.uk> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/EuanMcGonigle/CptNonPar    |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    multilag.cpts.merge  multiscale.np.mojo             np.mojo    np.mojo.multilag 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:16:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65ca9805_1739765792
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp19iAJo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CptNonPar_v0.2.1-tikzDictionary"
