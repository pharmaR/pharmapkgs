# Validation Report - ellipticalsymmetry@0.1.2
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Marko Palangetic <marko.palangetic@ugent.be>         |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | foreach (\>= 1.5.1)     | Depends |
| 2   | stats (\>= 2.4.0)       | Imports |
| 3   | datasets(\>= 2.4.0)     | Imports |
| 4   | ICSNP (\>= 1.1.1)       | Imports |
| 5   | doParallel (\>= 1.0.16) | Imports |
| 6   | doRNG (\>= 1.8.2)       | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
                ...
                HufferPark KoltchinskiiSakhanenko                    MPQ 
                      TRUE                   TRUE                   TRUE 
            PseudoGaussian                 Schott            SkewOptimal 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-19 03:57:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d451404c8e7_1739937425
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprJTqcM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ellipticalsymmetry_v0.1.2-tikzDictionary"
