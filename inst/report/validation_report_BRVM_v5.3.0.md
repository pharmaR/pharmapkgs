...
| export_help          | 33                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Sessie Koffi Frederic <koffisessie@gmail.com>        |
...
| 13  | tibble             | Imports |
| 14  | xml2               | Imports |
| 15  | highcharter        | Imports |
| 16  | xts                | Imports |
| 17  | formattable        | Imports |
| 18  | timeDate           | Imports |
| 19  | rvest              | Imports |
| 20  | lubridate          | Imports |
...
Overall the package has 33 exported objects. 32 are documented:

                      :=                .data                  %>% 
                    TRUE                 TRUE                FALSE 
                as_label              as_name        BRVM_bySector 
                    TRUE                 TRUE                 TRUE 
                BRVM_cap     BRVM_company_cap    BRVM_company_info 
                    TRUE                 TRUE                 TRUE 
       BRVM_company_rank     BRVM_company_url       BRVM_direction 
                    TRUE                 TRUE                 TRUE 
                BRVM_get            BRVM_get1           BRVM_index 
                    TRUE                 TRUE                 TRUE 
        BRVM_index_stock BRVM_market_activity            BRVM_plot 
                    TRUE                 TRUE                 TRUE 
               BRVM_rank    BRVM_stock_market     BRVM_ticker_desc 
                    TRUE                 TRUE                 TRUE 
            BRVM_tickers      BRVM_traded_val           BRVM.index 
                    TRUE                 TRUE                 TRUE 
             company_cap      company_country       company_nbrank 
                    TRUE                 TRUE                 TRUE 
          company_sector   company_traded_val                enquo 
                    TRUE                 TRUE                 TRUE 
                  enquos       normality_test    stationarity_test 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:47:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdd28c1ee_1739594852
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTp3Svx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BRVM_v5.3.0-tikzDictionary"
