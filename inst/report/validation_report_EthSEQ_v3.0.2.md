# Validation Report - EthSEQ@3.0.2
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Alessandro Romanel <alessandro.romanel@unitn.it>     |
...
| 3   | parallel                | Imports   |
| 4   | grDevices               | Imports   |
| 5   | MASS (\>= 7.3-47)       | Imports   |
| 6   | geometry (\>= 0.3-6)    | Imports   |
| 7   | data.table (\>= 1.10.0) | Imports   |
| 8   | SNPRelate (\>= 1.8.0)   | Imports   |
| 9   | gdsfmt (\>= 1.10.1)     | Imports   |
| 10  | plot3D (\>= 1.1)        | Imports   |
| 11  | Rcpp (\>= 0.11.0)       | Imports   |
| 12  | Rcpp                    | LinkingTo |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    ethseq.Analysis       ethseq.RM   getModelsList  getSamplesInfo 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 04:34:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d45567f61ac_1739939647
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXH70cG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EthSEQ_v3.0.2-tikzDictionary"
