# Validation Report - coursekata@0.18.1
...
| export_help          | 27                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Adam Blake <adam@coursekata.org>           |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/coursekata/coursekata-r |
...
|:----|:-----------------------|:--------|
| 1   | cli (\>= 3.2.0)        | Imports |
| 2   | dslabs (\>= 0.7.4)     | Imports |
| 3   | ggformula (\>= 0.10.1) | Imports |
| 4   | ggplot2 (\>= 3.5.0)    | Imports |
| 5   | glue (\>= 1.6.2)       | Imports |
| 6   | lsr (\>= 0.5.2)        | Imports |
| 7   | Metrics                | Imports |
| 8   | mosaic (\>= 1.8.3)     | Imports |
| 9   | palmerpenguins         | Imports |
| 10  | purrr (\>= 0.3.4)      | Imports |
| 11  | remotes                | Imports |
| 12  | rlang (\>= 1.0.2)      | Imports |
| 13  | supernova (\>= 2.5.1)  | Imports |
| 14  | vctrs (\>= 0.4.1)      | Imports |
| 15  | viridisLite            | Imports |
...
Overall the package has 27 exported objects. 27 are documented:
                              ...
                              b                          b0 
                           TRUE                        TRUE 
                             b1           coursekata_attach 
                           TRUE                        TRUE 
             coursekata_install       coursekata_load_theme 
                           TRUE                        TRUE 
            coursekata_packages          coursekata_palette 
                           TRUE                        TRUE 
    coursekata_palette_provider            coursekata_repos 
                           TRUE                        TRUE 
        coursekata_unload_theme           coursekata_update 
                           TRUE                        TRUE 
                              f                   fit_stats 
                           TRUE                        TRUE 
                       fitstats                        fVal 
                       ...
                       gf_model                       lower 
                         ...
                         middle                           p 
                           TRUE                        TRUE 
                            pre                         PRE 
                           TRUE                        TRUE 
      scale_discrete_coursekata                  split_data 
                           TRUE                        TRUE 
                          tails            theme_coursekata 
                           TRUE                        TRUE 
                          upper 
                           TRUE 
...
| Execution Time | 2025-02-17 04:05:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67f897fa8_1739765154
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGBRJ9f
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coursekata_v0.18.1-tikzDictionary"
