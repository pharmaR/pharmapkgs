# Validation Report - checkpoint@1.0.2
...
| has_source_control   | https://github.com/RevolutionAnalytics/checkpoint |
...
Overall the package has 9 exported objects. 9 are documented:
                ...
                checkpoint      create_checkpoint delete_all_checkpoints 
                      TRUE                   TRUE                   TRUE 
         delete_checkpoint    list_mran_snapshots     scan_project_files 
                      TRUE                   TRUE                   TRUE 
              uncheckpoint         use_checkpoint      use_mran_snapshot 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:10:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3181453a2_1739679032
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpC49R7q
...
These are the options set to generate the report:
    ...
    [1] "validation_report_checkpoint_v1.0.2-tikzDictionary"
