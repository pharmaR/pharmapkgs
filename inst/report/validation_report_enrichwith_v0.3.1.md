# Validation Report - enrichwith@0.3.1
...
| has_source_control   | https://github.com/ikosmidis/enrichwith           |
...
brglm2, hdbayes, mbrglm, psc, WeightIt

## Namespace

Overall the package has 12 exported objects. 12 are documented:

    create_enrichwith_skeleton                     enrich 
                          TRUE                       TRUE 
                  enriched_glm    get_auxiliary_functions 
                          TRUE                       TRUE 
             get_bias_function        get_dmodel_function 
                          TRUE                       TRUE 
        get_enrichment_options   get_information_function 
                          TRUE                       TRUE 
           get_pmodel_function        get_qmodel_function 
                          TRUE                       TRUE 
            get_score_function      get_simulate_function 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-19 04:09:08 UTC |
...
running this report
    ...
    PROCESSX_PS1d45c6859ee_1739938141
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz3JziR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_enrichwith_v0.3.1-tikzDictionary"
