# Validation Report - BayesGmed@0.0.3
...
| export_help | 3 |
| has_website | FALSE |
| has_maintainer | Belay Birlie Yimer <belaybirlie.yimer@manchester.ac.uk> |
...
| 9   | RcppParallel (\>= 5.0.1)  | LinkingTo |
| 10  | rstan (\>= 2.18.1)        | LinkingTo |
| 11  | StanHeaders (\>= 2.18.0)  | LinkingTo |
...
Overall the package has 3 exported objects. 3 are documented:
            ...
            bayesgmed    bayesgmed_sens bayesgmed_summary 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 03:35:03 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6800bb03_1739590499
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT8upke
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesGmed_v0.0.3-tikzDictionary"
