# Validation Report - ezknitr@0.6.3
...
| has_source_control   | https://github.com/ropensci/ezknitr |
...
|:----|:---------------------|:--------|
| 1   | knitr (\>= 1.7)      | Imports |
| 2   | markdown (\>= 0.7)   | Imports |
| 3   | R.utils (\>= 1.34.0) | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
                ...
                ezknit             ezspin    open_output_dir set_default_params 
                  TRUE               TRUE               TRUE               TRUE 
     setup_ezknit_test  setup_ezspin_test 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-19 05:00:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d4530a102e6_1739941245
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpu7PFCb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ezknitr_v0.6.3-tikzDictionary"
