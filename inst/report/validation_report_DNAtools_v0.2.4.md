# Validation Report - DNAtools@0.2.4
...
|     | package                   | type      |
|:----|:--------------------------|:----------|
| 1   | Rsolnp (\>= 1.16)         | Imports   |
| 2   | multicool (\>= 0.1-10)    | Imports   |
| 3   | Rcpp (\>= 0.12.12)        | Imports   |
| 4   | RcppParallel (\>= 4.3.20) | Imports   |
| 5   | Rcpp                      | LinkingTo |
| 6   | RcppParallel              | LinkingTo |
| 7   | RcppProgress              | LinkingTo |
...
Overall the package has 18 exported objects. 18 are documented:
             ...
             convolve        dbCollapse         dbCompare          dbExpect 
                 TRUE              TRUE              TRUE              TRUE 
           dbSimulate        dbVariance        estimatePD           freqEst 
                 TRUE              TRUE              TRUE              TRUE 
    optim.relatedness          pContrib    pContrib_locus    plot.dbcompare 
                 TRUE              TRUE              TRUE              TRUE 
         plot.dbOptim           Pnm_all         Pnm_locus   print.dbcompare 
                 TRUE              TRUE              TRUE              TRUE 
        print.dbOptim    simAlleleFreqs 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:29:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44bb2f336_1739852940
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1AJuCw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DNAtools_v0.2.4-tikzDictionary"
