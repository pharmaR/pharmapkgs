# Validation Report - fastNaiveBayes@2.2.1
...
| export_help          | 10                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Martin Skogholt <m.skogholt@gmail.com>      |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/mskogholt/fastNaiveBayes |
...
Overall the package has 10 exported objects. 10 are documented:
             ...
             fastNaiveBayes           fnb.bernoulli fnb.detect_distribution 
                       TRUE                    TRUE                    TRUE 
               fnb.gaussian                fnb.load         fnb.multinomial 
                       TRUE                    TRUE                    TRUE 
                fnb.poisson                fnb.save               fnb.train 
                       TRUE                    TRUE                    TRUE 
                 fnb.update 
                       TRUE 
...
| Execution Time | 2025-02-19 05:19:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d456900f2f5_1739942365
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjXZEuR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastNaiveBayes_v2.2.1-tikzDictionary"
