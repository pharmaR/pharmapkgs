# Validation Report - DescToolsAddIns@1.12
...
| has_source_control   | https://github.com/AndriSignorell/DescToolsAddIns/ |
...
| 1   | base                    | Depends |
| 2   | stats                   | Depends |
| 3   | DescTools (\>= 0.99.30) | Imports |
| 4   | rstudioapi (\>= 0.1)    | Imports |
| 5   | manipulate              | Imports |
| 6   | writexl                 | Imports |
| 7   | foreign                 | Imports |
...
Overall the package has 48 exported objects. 48 are documented:
                    ...
                    Arrow            BuildModel              ColorDlg 
                     TRUE                  TRUE                  TRUE 
                ColPicker        CreateBookmark        DeleteBookmark 
                     TRUE                  TRUE                  TRUE 
                     Desc            dir.choose                  Edit 
                     TRUE                  TRUE                  TRUE 
                  Enquote              EnquoteS           EvalEnquote 
                     TRUE                  TRUE                  TRUE 
                  Example       FileBrowserOpen         FileImportDlg 
                     TRUE                  TRUE                  TRUE 
                 FileOpen           FileOpenDlg            FileSaveAs 
                     TRUE                  TRUE                  TRUE 
            FlipBackSlash         FlushToSource         GetExcelRange 
                     TRUE                  TRUE                  TRUE 
           GetExcelRangeH                  Head                  Info 
                     TRUE                  TRUE                  TRUE 
               InspectPnt               IntView             NewObject 
                     TRUE                  TRUE                  TRUE 
                     Plot                 PlotD               PlotMar 
                     TRUE                  TRUE                  TRUE 
                  PlotPar               PlotPch RecreateBookmarkChunk 
                     TRUE                  TRUE                  TRUE 
         RemoveDuplicates        RenameBookmark                Select 
                     TRUE                  TRUE                  TRUE 
           SelectBookmark          SelectVarDlg              SetArrow 
                     TRUE                  TRUE                  TRUE 
                  Shuffle               SortAsc              SortDesc 
                     TRUE                  TRUE                  TRUE 
                      Str                  Str1               Unclass 
                     TRUE                  TRUE                  TRUE 
             WrdBookmarks                XLView                Xplore 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-18 03:47:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42c4500fe_1739850450
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplVshk7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DescToolsAddIns_v1.12-tikzDictionary"
