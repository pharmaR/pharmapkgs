...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Danielle Demateis <Danielle.Demateis@colostate.edu>  |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         cross_basis             dlim model_comparison  plot_cumulative 
                TRUE             TRUE             TRUE             TRUE 
            plot_DLF         sim_data          sim_dlf         sim_dlim 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:25:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45a38f260_1739852713
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp68NxQh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dlim_v0.1.0-tikzDictionary"
