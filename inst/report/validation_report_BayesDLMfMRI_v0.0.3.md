# Validation Report - BayesDLMfMRI@0.0.3
...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Carlos Pérez <caaperezag@unal.edu.co>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/JohnatanLAB/BayesDLMfMRI/         |
...
| 3   | neurobase        | Imports   |
| 4   | pbapply          | Imports   |
| 5   | Rcpp (\>= 1.0.4) | Imports   |
| 6   | Rdpack           | Imports   |
| 7   | mathjaxr         | Imports   |
| 8   | Rcpp             | LinkingTo |
| 9   | RcppArmadillo    | LinkingTo |
| 10  | RcppDist         | LinkingTo |
...
Overall the package has 14 exported objects. 14 are documented:
                ...
                ffdEvidenceFETS             ffdEvidenceFFBS 
                           TRUE                        TRUE 
                ffdEvidenceFSTS        ffdGroupEvidenceFETS 
                           TRUE                        TRUE 
           ffdGroupEvidenceFFBS        ffdGroupEvidenceFSTS 
                           TRUE                        TRUE 
          get_example_fMRI_data get_example_fMRI_data_group 
                           TRUE                        TRUE 
           GroupSingleVoxelFETS        GroupSingleVoxelFFBS 
                           TRUE                        TRUE 
           GroupSingleVoxelFSTS             SingleVoxelFETS 
                           TRUE                        TRUE 
                SingleVoxelFFBS             SingleVoxelFSTS 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-15 03:33:57 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4bcf11a8_1739590432
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPP8fv7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesDLMfMRI_v0.0.3-tikzDictionary"
