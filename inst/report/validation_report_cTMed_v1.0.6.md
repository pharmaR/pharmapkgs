...
Overall the package has 35 exported objects. 35 are documented:
                   ...
                   DeltaBeta             DeltaBetaStd     DeltaIndirectCentral 
                    ...
                    DeltaMed              DeltaMedStd        DeltaTotalCentral 
                        TRUE                     TRUE                     TRUE 
                      Direct                DirectStd                 Indirect 
                        TRUE                     TRUE                     TRUE 
             IndirectCentral              IndirectStd                   MCBeta 
                        TRUE                     TRUE                     TRUE 
                   MCBetaStd        MCIndirectCentral                    MCMed 
                        TRUE                     TRUE                     TRUE 
                    MCMedStd                    MCPhi               MCPhiSigma 
                        TRUE                     TRUE                     TRUE 
              MCTotalCentral                      Med                   MedStd 
                        TRUE                     TRUE                     TRUE 
               PosteriorBeta PosteriorIndirectCentral             PosteriorMed 
                        TRUE                     TRUE                     TRUE 
       PosteriorTotalCentral                    Total             TotalCentral 
                        TRUE                     TRUE                     TRUE 
                    TotalStd               Trajectory 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-24 03:23:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a139059fb_1740367422
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKnGr9O
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cTMed_v1.0.6-tikzDictionary"
