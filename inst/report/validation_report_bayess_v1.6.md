...
| has_source_control | https://github.com/jmm34/bayess |
...
Overall the package has 43 exported objects. 43 are documented:
            ...
            ardipper           ARllog             ARmh         BayesReg 
                TRUE             TRUE             TRUE             TRUE 
            BayesReg            gibbs        gibbscap1        gibbscap2 
                TRUE             TRUE             TRUE             TRUE 
           gibbsmean        gibbsnorm      hmflatlogit     hmflatloglin 
                TRUE             TRUE             TRUE             TRUE 
        hmflatprobit            hmhmm       hmmeantemp     hmnoinflogit 
                TRUE             TRUE             TRUE             TRUE 
       hmnoinfloglin    hmnoinfprobit          isinghm        isingibbs 
                TRUE             TRUE             TRUE             TRUE 
             logitll  logitnoinflpost         loglinll loglinnoinflpost 
                TRUE             TRUE             TRUE             TRUE 
              MAllog             MAmh   ModChoBayesReg            pbino 
                TRUE             TRUE             TRUE             TRUE 
            pcapture         pdarroch          plotmix       pottsgibbs 
                TRUE             TRUE             TRUE             TRUE 
             pottshm           probet         probitll probitnoinflpost 
                TRUE             TRUE             TRUE             TRUE 
          rdirichlet      reconstruct          solbeta         sumising 
                TRUE             TRUE             TRUE             TRUE 
              thresh        truncnorm           xneig4 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 03:40:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd273f1ff4_1739590854
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpd0Nkyq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayess_v1.6-tikzDictionary"
