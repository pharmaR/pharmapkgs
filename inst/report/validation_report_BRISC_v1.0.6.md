...
| export_help          | 9                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Arkajyoti Saha <arkajyotisaha93@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/ArkajyotiSaha/BRISC     |
...
nnSVG, RandomForestsGLS, spoon

## Namespace

Overall the package has 9 exported objects. 9 are documented:

        BRISC_bootstrap   BRISC_correlation BRISC_decorrelation    BRISC_estimation 
                   TRUE                TRUE                TRUE                TRUE 
         BRISC_neighbor         BRISC_order    BRISC_prediction    BRISC_simulation 
                   TRUE                TRUE                TRUE                TRUE 
     BRISC_variogram.ci 
                   TRUE 
...
| Execution Time | 2025-02-15 04:45:02 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd69c40a8e_1739594697
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWss6MM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BRISC_v1.0.6-tikzDictionary"
