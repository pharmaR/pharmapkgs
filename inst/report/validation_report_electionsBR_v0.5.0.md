# Validation Report - electionsBR@0.5.0
...
| export_help          | 21                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Denisson Silva <denissoncsol@gmail.com> |
...
| 3   | data.table (\>= 1.9.8) | Imports |
| 4   | haven (\>= 1.0.0)      | Imports |
| 5   | readr                  | Imports |
| 6   | httr                   | Imports |
| 7   | curl                   | Imports |
...
Overall the package has 21 exported objects. 20 are documented:
                        ...
                        %>%           candidate_fed         candidate_local 
                      FALSE                    TRUE                    TRUE 
       details_mun_zone_fed  details_mun_zone_local        elections_cepesp 
                       TRUE                    TRUE                    TRUE 
              elections_tse              legend_fed            legend_local 
                       TRUE                    TRUE                    TRUE 
                 parties_br      party_mun_zone_fed    party_mun_zone_local 
                       TRUE                    TRUE                    TRUE 
      personal_finances_fed personal_finances_local               seats_fed 
                       TRUE                    TRUE                    TRUE 
                seats_local                   uf_br       vote_mun_zone_fed 
                       TRUE                    TRUE                    TRUE 
        vote_mun_zone_local        vote_section_fed      vote_section_local 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-19 03:55:02 UTC |
...
running this report
    ...
    PROCESSX_PS1d45223c15a_1739937296
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4dDCl5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_electionsBR_v0.5.0-tikzDictionary"
