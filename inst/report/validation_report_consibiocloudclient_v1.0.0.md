# Validation Report - consibiocloudclient@1.0.0
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tobias Nordahl <tnk@consibio.com>                    |
...
Overall the package has 17 exported objects. 17 are documented:
           ...
           get_api_url        get_datalog         get_device        get_devices 
                  TRUE               TRUE               TRUE               TRUE 
           get_element       get_elements        get_project     get_project_id 
                  TRUE               TRUE               TRUE               TRUE 
          get_projects           get_test       get_users_me is_valid_entity_id 
                  TRUE               TRUE               TRUE               TRUE 
     is_valid_username              login             logout        set_api_url 
                  TRUE               TRUE               TRUE               TRUE 
        set_project_id 
                  TRUE 
...
| Execution Time | 2025-02-17 03:47:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bd649d920ef_1739764035
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpO4FFZm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_consibiocloudclient_v1.0.0-tikzDictionary"
