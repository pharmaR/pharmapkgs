# Validation Report - CureAuxSP@0.0.1
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Jie Ding <dingjie@mail.dlut.edu.cn>                  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | <https://github.com/biostat-jieding/CureAuxSP>       |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    Print.SMC.AuxSP       Probs.Sub       sdata.SMC       SMC.AuxSP 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:39:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67a62a062_1739767162
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCRyWxZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CureAuxSP_v0.0.1-tikzDictionary"
