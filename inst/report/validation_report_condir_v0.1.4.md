# Validation Report - condir@0.1.4
...
| export_help          | 8                                                 |
| has_website          | TRUE                                              |
| has_maintainer       | Angelos-Miltiadis Krypotos <amkrypotos@gmail.com> |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/AngelosPsy/condir              |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | BayesFactor (\>= 0.9.12) | Imports |
| 2   | stats (\>= 3.3.2)        | Imports |
| 3   | knitr (\>= 1.28)         | Imports |
| 4   | xtable (\>= 1.8.2)       | Imports |
| 5   | psych (\>= 1.9.12)       | Imports |
| 6   | graphics (\>= 3.3.2)     | Imports |
| 7   | effsize (\>= 0.7.8)      | Imports |
| 8   | shiny (\>= 1.7.0)        | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
           ...
           csCompare           csPlot         csReport csRobustnessPlot 
                TRUE             TRUE             TRUE             TRUE 
       csSensitivity          csShine          csTable          roundBF 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 03:40:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66879ce47_1739763644
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5ZeENT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_condir_v0.1.4-tikzDictionary"
