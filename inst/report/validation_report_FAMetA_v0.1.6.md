# Validation Report - FAMetA@0.1.6
...
| export_help | 18 |
| has_website | FALSE |
| has_maintainer | Maribel Alcoriza-Balaguer <maribel_alcoriza@iislafe.es> |
...
Overall the package has 18 exported objects. 18 are documented:
                    ...
                    addFA            annotateFA     blankSubstraction 
                     TRUE                  TRUE                  TRUE 
               changeFArt       correctNatAb13C   curateFAannotations 
                     TRUE                  TRUE                  TRUE 
           dataCorrection  desaturationAnalysis    elongationAnalysis 
                     TRUE                  TRUE                  TRUE 
    externalNormalization           normalizeIS                plotFA 
                     TRUE                  TRUE                  TRUE 
           readfadatafile              removeFA      searchFAisotopes 
                     TRUE                  TRUE                  TRUE 
                 searchIS      summarizeResults     synthesisAnalysis 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-19 05:09:30 UTC |
...
running this report
    ...
    PROCESSX_PS1d455676c15_1739941764
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRdr9ay
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FAMetA_v0.1.6-tikzDictionary"
