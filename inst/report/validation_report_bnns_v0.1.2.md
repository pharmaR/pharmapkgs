...
| export_help          | 13                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Swarnendu Chatterjee <swarnendu.stat@gmail.com> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/swarnendu-stat/bnns          |
...
Overall the package has 13 exported objects. 13 are documented:
                       ...
                       bnns              bnns_train      generate_stan_code 
                       TRUE                    TRUE                    TRUE 
     generate_stan_code_bin  generate_stan_code_cat generate_stan_code_cont 
                       TRUE                    TRUE                    TRUE 
                measure_bin             measure_cat            measure_cont 
                       TRUE                    TRUE                    TRUE 
                       relu                 sigmoid              softmax_3d 
                       TRUE                    TRUE                    TRUE 
                   softplus 
                       TRUE 
...
| Execution Time | 2025-02-15 04:28:29 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd588746f3_1739593704
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpu0WdV2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bnns_v0.1.2-tikzDictionary"
