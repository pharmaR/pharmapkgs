# Validation Report - covid19tunisia@0.1.0
...
| export_help          | 2                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Mouna Belaid <belaid.mounaa@gmail.com>               |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/MounaBelaid/covid19tunisia        |
...
| 2   | glue (\>= 1.3.2)      | Imports |
| 3   | lubridate (\>= 1.7.4) | Imports |
| 4   | magrittr (\>= 1.5)    | Imports |
| 5   | readr (\>= 1.3.1)     | Imports |
| 6   | stringr (\>= 1.4.0)   | Imports |
| 7   | tidyr (\>= 1.0.2)     | Imports |
| 8   | knitr (\>= 1.7)       | Imports |
...
Overall the package has 2 exported objects. 2 are documented:
    ...
    get_info_covid19tunisia  refresh_covid19tunisia 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-17 04:08:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66f51e378_1739765298
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTFPEhw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covid19tunisia_v0.1.0-tikzDictionary"
