# Validation Report - CLSIEP15@0.1.0
...
| export_help | 4 |
| has_website | FALSE |
| has_maintainer | Claucio Antonio Rank Filho <claucio.filho@hitechnologies.com.br> |
...
Overall the package has 4 exported objects. 4 are documented:
        ...
        calculate_aov_infos calculate_bias_interval      calculate_uvl_info 
                       TRUE                    TRUE                    TRUE 
         create_table_ep_15 
                       TRUE 
...
| Execution Time | 2025-02-16 04:36:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3587db51d_1739680558
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpseyoAP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CLSIEP15_v0.1.0-tikzDictionary"
