# Validation Report - basket@0.10.11
...
| export_help          | 18                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Michael J. Kane <michael.kane@yale.edu> |
| bugs_status          | subscript out of bounds                 |
| size_codebase        | 1807                                    |
| has_source_control   | https://github.com/kaneplusplus/basket  |
...
Overall the package has 18 exported objects. 18 are documented:
                ...
                basket         basket_map        basket_name         basket_pep 
                  TRUE               TRUE               TRUE               TRUE 
       cluster_baskets        cluster_map cluster_membership        cluster_pep 
                  TRUE               TRUE               TRUE               TRUE 
              get_seed          mem_exact           mem_mcmc       plot_density 
                  TRUE               TRUE               TRUE               TRUE 
              plot_map           plot_mem           plot_pep     plot_pep_graph 
                  TRUE               TRUE               TRUE               TRUE 
      sample_posterior          update_p0 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-14 07:45:08 UTC |
...
running this report
    ...
    PROCESSX_PS1c0923d0a7b3_1739519105
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTxnVit
...
These are the options set to generate the report:
    ...
    [1] "validation_report_basket_v0.10.11-tikzDictionary"
