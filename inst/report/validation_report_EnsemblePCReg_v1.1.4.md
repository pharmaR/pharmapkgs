# Validation Report - EnsemblePCReg@1.1.4
...
Overall the package has 6 exported objects. 6 are documented:
                        ...
                        epcreg epcreg.baselearner.control 
                          TRUE                       TRUE 
     epcreg.integrator.control                epcreg.load 
                          TRUE                       TRUE 
                   epcreg.save    Regression.Sweep.CV.Fit 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-19 04:09:49 UTC |
...
running this report
    ...
    PROCESSX_PS1d451b5c2509_1739938183
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOHbRXf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EnsemblePCReg_v1.1.4-tikzDictionary"
