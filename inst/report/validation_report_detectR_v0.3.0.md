# Validation Report - detectR@0.3.0
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Changryong Baek <crbaek@skku.edu>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/crbaek/detectR                    |
...
Overall the package has 7 exported objects. 7 are documented:
       ...
       detectBinary    detectGlasso detectMaxChange   detectSliding      testGlasso 
...
| Execution Time | 2025-02-18 03:50:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bb442752456_1739850597
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp24EBvY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_detectR_v0.3.0-tikzDictionary"
