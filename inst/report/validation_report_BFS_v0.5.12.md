...
| export_help          | 12                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Felix Luginbuhl <felix.luginbuhl@protonmail.ch> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/lgnbhl/BFS/                  |
...
Overall the package has 12 exported objects. 11 are documented:
                        ...
                        %>%      bfs_download_asset    bfs_download_geodata 
                      FALSE                    TRUE                    TRUE 
     bfs_get_asset_metadata       bfs_get_base_maps         bfs_get_catalog 
                       TRUE                    TRUE                    TRUE 
       bfs_get_catalog_data bfs_get_catalog_geodata  bfs_get_catalog_tables 
                       TRUE                    TRUE                    TRUE 
               bfs_get_data   bfs_get_data_comments        bfs_get_metadata 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-15 03:57:50 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdee0b2ac_1739591866
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdLc7Yw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BFS_v0.5.12-tikzDictionary"
