# Validation Report - fanovaGraph@1.5
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Sonja Kuhnt <sonja.kuhnt@fh-dortmund.de>             |
...
Overall the package has 13 exported objects. 13 are documented:
              ...
              estimateGraph                 i2Index              kmAdditive 
                       TRUE                    TRUE                    TRUE 
           kmPredictWrapper          plotDeltaJumps         plotGraphChange 
                       TRUE                    TRUE                    TRUE 
             plotManipulate                  plotTk         predictAdditive 
                       TRUE                    TRUE                    TRUE 
                simAdditive               threshold thresholdIdentification 
                       TRUE                    TRUE                    TRUE 
                 totalIndex 
                       TRUE 
...
| Execution Time | 2025-02-19 05:11:19 UTC |
...
running this report
    ...
    PROCESSX_PS1d45185b72fe_1739941872
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdtzXAa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fanovaGraph_v1.5-tikzDictionary"
