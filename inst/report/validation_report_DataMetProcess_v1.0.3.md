# Validation Report - DataMetProcess@1.0.3
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Wagner Martins dos Santos <wagnnerms97@gmail.com>    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/wagnnerms97/DataMetProcess        |
...
Overall the package has 5 exported objects. 5 are documented:
          ...
          adjustDate     calculateDMY calculateETrefPM         DMPshiny 
                TRUE             TRUE             TRUE             TRUE 
          list_inmet 
                TRUE 
...
| Execution Time | 2025-02-17 04:58:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6283658e_1739768305
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRLSS4P
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DataMetProcess_v1.0.3-tikzDictionary"
