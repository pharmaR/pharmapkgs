# Validation Report - downloader@0.4
...
| has_source_control   | https://github.com/wch/downloader  |
| has_bug_reports_url  | 1                                  |
| downloads_1yr        | 271318                             |
...
biomartr, CANSIM2R, DEET, drake, ELMER, EpiMix, etl, fishualize, imager,
imgpalr, materialmodifier, mdsr, MethReg, neonUtilities, PharmacoGx,
pkgfilecache, quantmod, RadioGx, recount, rfars, RKEEL, rtrek, scMappR,
seqmagick, sketcher, stationaRy, TCGAbiolinks, ToxicoGx, Xeva, yarn

## Namespace

Overall the package has 3 exported objects. 3 are documented:

      download    sha_url source_url 
          TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-18 04:38:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bb431c6fde8_1739853528
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpj26agP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_downloader_v0.4-tikzDictionary"
