...
| export_help          | 25                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Norm Matloff <nsmatloff@ucdavis.edu> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/matloff/dsld      |
...
Overall the package has 25 exported objects. 25 are documented:
           ...
           dsldCHunting dsldConditDisparity     dsldConfounders      dsldDensityByS 
                   TRUE                TRUE                TRUE                TRUE 
      dsldFairUtilTrade           dsldFgrrm      dsldFreqPCoord    dsldFrequencyByS 
                   TRUE                TRUE                TRUE                TRUE 
               dsldFrrm            dsldIamb          dsldLinear           dsldLogit 
                   TRUE                TRUE                TRUE                TRUE 
         dsldMatchedATE              dsldML            dsldNclm        dsldOHunting 
                   TRUE                TRUE                TRUE                TRUE 
          dsldQeFairKNN        dsldQeFairRF  dsldQeFairRidgeLin  dsldQeFairRidgeLog 
                   TRUE                TRUE                TRUE                TRUE 
      dsldScatterPlot3D dsldTakeALookAround             dsldZlm            dsldZlrm 
                   TRUE                TRUE                TRUE                TRUE 
        getSuggestedLib 
                   TRUE 
...
| Execution Time | 2025-02-18 04:51:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41c9516b1_1739854277
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1q7H5v
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsld_v0.2.2-tikzDictionary"
