...
| export_help          | 35                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Giovanni Petris <GPetris@uark.edu>                   |
...
CureDepCens, DepCens, exdqlm, ExGaussEstim, longitudinalANAL, maxLik,
MfUSampler, NTS, RGAP, TPMplt

## Namespace

Overall the package has 35 exported objects. 34 are documented:

              %+%          arms   ARtransPars        as.dlm         bdiag 
            FALSE          TRUE          TRUE          TRUE          TRUE 
               C0          C0<- convex.bounds     dropFirst       ergMean 
             ...
             JV<-            JW          JW<-            m0          m0<- 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         mcmcMean     mcmcMeans        mcmcSD      rwishart             V 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              V<-             W           W<-             X           X<- 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 04:25:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4383ff92f_1739852727
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6FOW0l
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dlm_v1.1.6.1-tikzDictionary"
