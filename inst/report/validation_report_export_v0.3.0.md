# Validation Report - export@0.3.0
...
| export_help          | 22                                          |
| has_website          | FALSE                                       |
| has_maintainer       | Tom Wenseleers <tom.wenseleers@kuleuven.be> |
...
| 3   | datasets              | Imports |
| 4   | grDevices             | Imports |
| 5   | officer (\>= 0.2.2)   | Imports |
| 6   | rvg (\>= 0.1.8)       | Imports |
| 7   | xtable (\>= 1.8-2)    | Imports |
| 8   | flextable (\>= 0.4.3) | Imports |
| 9   | rgl (\>= 0.99.16)     | Imports |
| 10  | xml2 (\>= 1.2.0)      | Imports |
| 11  | stargazer (\>= 5.2.1) | Imports |
| 12  | openxlsx (\>= 4.0.17) | Imports |
| 13  | broom (\>= 0.4.4)     | Imports |
| 14  | devEMF (\>= 3.8)      | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
         ...
         graph2bitmap         graph2doc         graph2eps         graph2jpg 
                 TRUE              TRUE              TRUE              TRUE 
         graph2office         graph2pdf         graph2png         graph2ppt 
                 TRUE              TRUE              TRUE              TRUE 
            graph2svg         graph2tif      graph2vector        rgl2bitmap 
                 TRUE              TRUE              TRUE              TRUE 
              rgl2png         table2csv        table2csv2         table2doc 
                 TRUE              TRUE              TRUE              TRUE 
          table2excel        table2html      table2office         table2ppt 
                 TRUE              TRUE              TRUE              TRUE 
    table2spreadsheet         table2tex 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-19 04:53:44 UTC |
...
running this report
    ...
    PROCESSX_PS1d453a99c956_1739940818
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHwJJuO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_export_v0.3.0-tikzDictionary"
