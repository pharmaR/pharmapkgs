...
| export_help          | 12                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Lasse Hjort Jakobsen <hjort9230@hotmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/LasseHjort/cuRe           |
...
Overall the package has 12 exported objects. 12 are documented:
             ...
             calc.Crude calc.Crude.quantile  calc.cure.quantile             calc.LL 
                   TRUE                TRUE                TRUE                TRUE 
       calc.LL.quantile                  cb                 cbc      fit.cure.model 
                   TRUE                TRUE                TRUE                TRUE 
            general.haz    GenFlexCureModel              lrtest                 lts 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:39:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6465edff_1739767156
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfAz2VT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cuRe_v1.1.1-tikzDictionary"
