# Validation Report - BootMRMR@0.1
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Samarendra Das <samarendra4849@gmail.com>            |
...
Overall the package has 12 exported objects. 12 are documented:
      ...
      bmrmr.pval.cutoff bmrmr.weight.cutoff       bootmr.weight         geneslect.f 
                   TRUE                TRUE                TRUE                TRUE 
       mbmr.pval.cutoff  mbmr.weight.cutoff         mrmr.cutoff          pval.bmrmr 
                   TRUE                TRUE                TRUE                TRUE 
              pval.mbmr         topsis.meth         weight.mbmr        Weights.mrmr 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 04:34:03 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd380e8a3d_1739594038
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmppe8OzL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BootMRMR_v0.1-tikzDictionary"
