# Validation Report - BSPBSS@1.0.5
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Ben Wu <wuben@ruc.edu.cn>                            |
...
| 7   | glmnet        | Imports   |
| 8   | gplots        | Imports   |
| 9   | BayesGPfit    | Imports   |
| 10  | svd           | Imports   |
| 11  | neurobase     | Imports   |
| 12  | oro.nifti     | Imports   |
...
Overall the package has 7 exported objects. 7 are documented:
        ...
        init_bspbss     levelplot2D     mcmc_bspbss      output_nii         pre_nii 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        sim_2Dimage sum_mcmc_bspbss 
               TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:49:49 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd37725d6b_1739594984
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIe8ZpW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BSPBSS_v1.0.5-tikzDictionary"
