...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Guangbao Guo <ggb11111111@163.com>                   |
...
Overall the package has 13 exported objects. 13 are documented:
          ...
          DEM     DRPCA      DTSR        EM  IndexCPP       KNN      mean     MLPCA 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
       NIPALS      RPCA       SVD SVDImpute       TSR 
...
| Execution Time | 2025-02-18 04:57:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bb424c6facc_1739854652
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqBBwsl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DTSR_v0.1.0-tikzDictionary"
