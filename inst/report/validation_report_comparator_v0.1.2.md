# Validation Report - comparator@0.1.2
...
| bugs_status          | 0.5714286                                |
| has_source_control   | https://github.com/ngmarchant/comparator |
...
Overall the package has 23 exported objects. 23 are documented:
     ...
     as.PairwiseMatrix         BinaryComp          Chebyshev           Constant 
                  TRUE               TRUE               TRUE               TRUE 
    DamerauLevenshtein        elementwise          Euclidean      FuzzyTokenSet 
                  TRUE               TRUE               TRUE               TRUE 
                 gmean            Hamming              hmean       InVocabulary 
                  TRUE               TRUE               TRUE               TRUE 
                  Jaro        JaroWinkler                LCS        Levenshtein 
                  TRUE               TRUE               TRUE               TRUE 
                Lookup          Manhattan          Minkowski         MongeElkan 
                  TRUE               TRUE               TRUE               TRUE 
                   OSA           pairwise     PairwiseMatrix 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 03:33:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61bebf430_1739763222
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpahC8HJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comparator_v0.1.2-tikzDictionary"
