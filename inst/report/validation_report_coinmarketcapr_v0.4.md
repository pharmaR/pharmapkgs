# Validation Report - coinmarketcapr@0.4
...
| export_help          | 17                                       |
| has_website          | TRUE                                     |
| has_maintainer       | AbdulMajedRaja RS <amrrs.data@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/amrrs/coinmarketcapr  |
...
Overall the package has 17 exported objects. 17 are documented:
                ...
                get_api_info      get_crypto_listings           get_crypto_map 
                        TRUE                     TRUE                     TRUE 
      get_crypto_marketpairs          get_crypto_meta         get_crypto_ohlcv 
                        TRUE                     TRUE                     TRUE 
           get_crypto_quotes         get_exchange_map        get_exchange_meta 
                        TRUE                     TRUE                     TRUE 
        get_global_marketcap get_marketcap_ticker_all     get_price_conversion 
                        TRUE                     TRUE                     TRUE 
                   get_setup     get_valid_currencies      plot_top_currencies 
                        TRUE                     TRUE                     TRUE 
                 reset_setup                    setup 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-16 04:55:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31ec3a409_1739681753
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwnGLnW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coinmarketcapr_v0.4-tikzDictionary"
