# Validation Report - bsgof@0.23.8
...
| export_help          | 6                                 |
| has_website          | TRUE                              |
| has_maintainer       | Chanseok Park <statpnu@gmail.com> |
...
Overall the package has 6 exported objects. 6 are documented:
              ...
              bs.mle           bs.mme          bs.plot          bs.test 
                TRUE             TRUE             TRUE             TRUE 
    bs.test.critical   bs.test.pvalue 
                TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:48:34 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1df27fee_1739594909
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpD0Rb0S
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bsgof_v0.23.8-tikzDictionary"
