# Validation Report - evolMap@1.3.8
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Modesto Escobar <modesto@usal.es>                    |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    add_description    add_entities       add_links     add_markers     add_periods 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       add_tutorial      create_map    get_location  list_providers 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 04:42:53 UTC |
...
running this report
    ...
    PROCESSX_PS1d457ecc8e4a_1739940167
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpD3eZRs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evolMap_v1.3.8-tikzDictionary"
