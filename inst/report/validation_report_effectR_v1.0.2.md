# Validation Report - effectR@1.0.2
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Javier Tabima <tabimaj@oregonstate.edu>              |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    effector.summary         hmm.logo       hmm.search     regex.search 
                TRUE             TRUE             TRUE             TRUE 
       shiny.effectR 
                TRUE 
...
| Execution Time | 2025-02-19 03:47:02 UTC |
...
running this report
    ...
    PROCESSX_PS1d456bfd2a02_1739936816
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7oMKGe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_effectR_v1.0.2-tikzDictionary"
