# Validation Report - bnmonitor@0.2.2
...
| export_help          | 34                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Manuele Leonelli <manuele.leonelli@ie.edu>           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/manueleleonelli/bnmonitor         |
...
Overall the package has 34 exported objects. 34 are documented:
            ...
            amalgamation          asy_measure                bn2ci 
                    TRUE                 TRUE                 TRUE 
                  bn2gbn                   CD     col_covar_matrix 
                    TRUE                 TRUE                 TRUE 
          covariance_var             diameter                  dwi 
                    TRUE                 TRUE                 TRUE 
           edge_strength                  ewi   final_node_monitor 
                    TRUE                 TRUE                 TRUE 
                     Fro       global_monitor      influential_obs 
                    TRUE                 TRUE                 TRUE 
                Jeffreys                   KL            KL_bounds 
                    TRUE                 TRUE                 TRUE 
                mean_var       model_pres_cov          mutual_info 
                    TRUE                 TRUE                 TRUE 
            node_monitor         orderp_covar partial_covar_matrix 
                    TRUE                 TRUE                 TRUE 
      proportional_covar            psd_check     row_covar_matrix 
                    TRUE                 TRUE                 TRUE 
             sensitivity            sensquery     seq_cond_monitor 
                    TRUE                 TRUE                 TRUE 
        seq_marg_monitor    seq_pa_ch_monitor   total_covar_matrix 
                    TRUE                 TRUE                 TRUE 
           uniform_covar 
                    TRUE 
...
| Execution Time | 2025-02-15 04:28:24 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd63980012_1739593699
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAgHwS7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bnmonitor_v0.2.2-tikzDictionary"
