# Validation Report - cytometree@2.0.2
...
| export_help          | 10                                            |
| has_website          | FALSE                                         |
| has_maintainer       | Boris P Hejblum <boris.hejblum@u-bordeaux.fr> |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       Annotation   bootstrapCI     CytofTree    CytomeTree     FmeasureC 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    FmeasureC_no0  plot_cytopop    plot_graph    plot_nodes  RetrievePops 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 04:47:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65cf8ffe3_1739767634
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDYSXwa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cytometree_v2.0.2-tikzDictionary"
