# Validation Report - DOSPortfolio@0.1.0
...
| export_help | 5 |
| has_website | TRUE |
| has_maintainer | Erik Thorsén <erik.thorsen@math.su.se> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/Statistics-In-Portfolio-Theory/DOSportfolio |
...
Overall the package has 5 exported objects. 5 are documented:
          ...
          DOSPortfolio         r0Strategy               wGMV wGMVNonOverlapping 
                  TRUE               TRUE               TRUE               TRUE 
       wGMVOverlapping 
                  TRUE 
...
| Execution Time | 2025-02-18 04:36:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42a05ae49_1739853359
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptJd52n
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DOSPortfolio_v0.1.0-tikzDictionary"
