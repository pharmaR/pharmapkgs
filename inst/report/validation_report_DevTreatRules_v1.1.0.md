# Validation Report - DevTreatRules@1.1.0
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jeremy Roth <jhroth@uw.edu>                          |
...
Overall the package has 5 exported objects. 5 are documented:
                   ...
                   BuildRule CompareRulesOnValidation             EvaluateRule 
                        TRUE                     TRUE                     TRUE 
                 PredictRule                SplitData 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-18 03:51:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44330c453_1739850712
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcwsQNW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DevTreatRules_v1.1.0-tikzDictionary"
