...
| has_source_control   | https://github.com/NCEAS/codyn/         |
...
Overall the package has 19 exported objects. 19 are documented:
           ...
           abundance_change    abundance_difference     community_diversity 
                       TRUE                    TRUE                    TRUE 
        community_stability     community_structure            curve_change 
                       TRUE                    TRUE                    TRUE 
           curve_difference            cyclic_shift         mean_rank_shift 
                       TRUE                    TRUE                    TRUE 
        multivariate_change multivariate_difference              RAC_change 
                       TRUE                    TRUE                    TRUE 
             RAC_difference              rank_shift             rate_change 
                       TRUE                    TRUE                    TRUE 
       rate_change_interval               synchrony                turnover 
                       TRUE                    TRUE                    TRUE 
             variance_ratio 
                       TRUE 
...
| Execution Time | 2025-02-16 04:53:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc347691ad_1739681577
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKy2GTd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_codyn_v2.0.5-tikzDictionary"
