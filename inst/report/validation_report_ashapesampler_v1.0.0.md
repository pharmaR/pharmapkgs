...
| export_help          | 28                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Emily Winn-Nunez <emily_winn-nunez@brown.edu>        |
...
Overall the package has 28 exported objects. 28 are documented:
                ...
                calc_overlap_2D             calc_overlap_3D 
                           TRUE                        TRUE 
                count_neighbors euclid_dists_point_cloud_2D 
                           TRUE                        TRUE 
    euclid_dists_point_cloud_3D       extract_complex_edges 
                           TRUE                        TRUE 
          extract_complex_faces         extract_complex_tet 
                           TRUE                        TRUE 
                    extreme_pts           generate_ashape2d 
                           TRUE                        TRUE 
              generate_ashape3d           get_alpha_complex 
                           TRUE                        TRUE 
             n_bound_connect_2D          n_bound_connect_3D 
                           TRUE                        TRUE 
            n_bound_homology_2D         n_bound_homology_3D 
                           TRUE                        TRUE 
                 read_alpha_txt                     readOFF 
                           TRUE                        TRUE 
                  runif_annulus               runif_ball_3D 
                           TRUE                        TRUE 
                     runif_cube                  runif_disk 
                           TRUE                        TRUE 
                 runif_shell_3D                runif_square 
                           TRUE                        TRUE 
               sampling2Dashape            sampling3Dashape 
                           TRUE                        TRUE 
                      tau_bound             write_alpha_txt 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-14 07:27:02 UTC |
...
running this report
    ...
    PROCESSX_PS1c0944532da9_1739518019
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpxt8fDy
