...
| export_help          | 28                            |
| has_website          | TRUE                          |
| has_maintainer       | Joe Roe <joe@joeroe.io>       |
| bugs_status          | subscript out of bounds       |
| has_source_control   | https://github.com/joeroe/era |
...
Overall the package has 28 exported objects. 28 are documented:
               ...
               era  era_direction      era_epoch      era_label       era_name 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         era_scale       era_unit       era_year  era_year_days era_year_label 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              eras         is_era    is_era_year   is_valid_era    is_valid_yr 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             is_yr      this_year   validate_era    validate_yr             yr 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       yr_earliest         yr_era       yr_era<-      yr_latest       yr_range 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        yr_set_era        yr_sort   yr_transform 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:25:04 UTC |
...
running this report
    ...
    PROCESSX_PS1d4579d5f3f3_1739939097
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphoniOY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_era_v0.5.0-tikzDictionary"
