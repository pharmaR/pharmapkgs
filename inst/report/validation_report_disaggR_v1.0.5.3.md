# Validation Report - disaggR@1.0.5.3
...
| export_help          | 27                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Pauline Meinzel <pauline.meinzel@insee.fr> |
...
Overall the package has 24 exported objects. 24 are documented:
         ...
         annualBenchmark            bflSmooth      default_col_pal 
                    TRUE                 TRUE                 TRUE 
         default_lty_pal      default_margins default_theme_ggplot 
                    TRUE                 TRUE                 TRUE 
                distance           in_disaggr         in_revisions 
                    TRUE                 TRUE                 TRUE 
               in_sample           in_scatter           model.list 
                    TRUE                 TRUE                 TRUE 
                outliers                prais               rePort 
                    TRUE                 TRUE                 TRUE 
        residuals_extrap       reUseBenchmark               reView 
                    TRUE                 TRUE                 TRUE 
                     rho                   se        smoothed.part 
                    TRUE                 TRUE                 TRUE 
           smoothed.rate      threeRuleSmooth    twoStepsBenchmark 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-18 04:10:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42390e6f4_1739851838
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpo6bEEU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_disaggR_v1.0.5.3-tikzDictionary"
