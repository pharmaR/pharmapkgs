# Validation Report - deeplr@2.0.1
...
| export_help          | 29                                    |
| has_website          | TRUE                                  |
| has_maintainer       | David Zumbach <david.zumbach@gfzb.ch> |
...
Overall the package has 29 exported objects. 29 are documented:
     ...
     available_languages available_languages2               detect 
                    TRUE                 TRUE                 TRUE 
                 detect2                 pimp                pimp2 
                    TRUE                 TRUE                 TRUE 
              split_text            toChinese           toChinese2 
                    TRUE                 TRUE                 TRUE 
               toEnglish           toEnglish2             toFrench 
                    TRUE                 TRUE                 TRUE 
               toFrench2             toGerman            toGerman2 
                    TRUE                 TRUE                 TRUE 
               toItalian           toItalian2           toJapanese 
                    TRUE                 TRUE                 TRUE 
             toJapanese2         toPortuguese        toPortuguese2 
                    TRUE                 TRUE                 TRUE 
               toRussian           toRussian2            toSpanish 
                    TRUE                 TRUE                 TRUE 
              toSpanish2            translate           translate2 
                    TRUE                 TRUE                 TRUE 
                   usage               usage2 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-18 03:35:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41d6b61ed_1739849705
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplH3cj7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deeplr_v2.0.1-tikzDictionary"
