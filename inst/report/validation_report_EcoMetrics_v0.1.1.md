# Validation Report - EcoMetrics@0.1.1
...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Mutua Kilai <kilaimutua@gmail.com>                   |
...
Overall the package has 18 exported objects. 18 are documented:
                         ...
                         ACF_PLOT    autocorrelation_assumption 
                             TRUE                          TRUE 
                       best_arima               check_model_sig 
                             TRUE                          TRUE 
               check_stationarity                     fit_arima 
                             TRUE                          TRUE 
        get_coefficients_variance                   get_confint 
                             TRUE                          TRUE 
       get_significant_predictors heteroscedasticity_assumption 
                             TRUE                          TRUE 
     multicollinearity_assumption          normality_assumption 
                             TRUE                          TRUE 
                        ols_model                 ols_model_sig 
                             TRUE                          TRUE 
                  ols_model_stats                     PACF_PLOT 
                             TRUE                          TRUE 
                  predict_dep_var          select_optimal_model 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-19 03:35:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d452b4f6527_1739936106
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpym0cm8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EcoMetrics_v0.1.1-tikzDictionary"
