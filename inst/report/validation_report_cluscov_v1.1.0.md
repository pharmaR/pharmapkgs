# Validation Report - cluscov@1.1.0
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Emmanuel S Tsyawo <estsyawo@temple.edu>              |
...
Overall the package has 10 exported objects. 10 are documented:
         ...
         c_chmod        CCRls  CCRls.coord      CCRseqk        chmod     dcluspar 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
    goldensearch      goldopt     linrclus       netdat 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:36:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3e618200_1739680610
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvhCOQ1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cluscov_v1.1.0-tikzDictionary"
