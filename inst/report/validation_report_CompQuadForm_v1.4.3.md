# Validation Report - CompQuadForm@1.4.3
...
| export_help          | 0                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | P. Lafaye de Micheaux <lafaye@unsw.edu.au>           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 215524                                               |
| reverse_dependencies | 64                                                   |
| has_examples         | 1                                                    |
| license              | GPL (\>= 2)                                          |
...
Overall the package has 64 reverse dependencies:

AllelicSeries, bigQF, CKAT, CONCUR, CTxCC, cvmdisc, dearseq, DR.SC,
EDFtest, energy, famSKATRC, fdaACF, FSTpackage, GALLO, GENESIS, ghcm,
GMMAT, gofedf, goProfiles, hrt, ICSKAT, iGasso, kangar00, KEPTED,
KnockoffScreen, KSPM, LGEWIS, LGRF, lit, MAGEE, MAPITR, MDMR, meta,
metafor, mhurdle, MiRKAT, MTAR, MVLM, mvMAPIT, nethet, newIMVC,
nonnest2, ofGEM, OmnibusFisher, pairkat, pedgene, performance, POINT,
POSTm, qfratio, qtlpoly, remotePARTS, rqt, RTSA, SAIGEgds, SEAGLE,
shotGroups, SIMICO, skedastic, sphunif, survey, weakARMA, wwntests,
ZIM4rv
...
| Execution Time | 2025-02-17 03:37:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bd632559d97_1739763469
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJjSGVZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CompQuadForm_v1.4.3-tikzDictionary"
