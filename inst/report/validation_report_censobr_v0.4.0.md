# Validation Report - censobr@0.4.0
...
| export_help          | 11                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Rafael H. M. Pereira <rafa.pereira.br@gmail.com> |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/ipeaGIT/censobr               |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | arrow (\>= 15.0.1) | Imports |
| 2   | checkmate          | Imports |
| 3   | curl (\>= 5.0.0)   | Imports |
| 4   | DBI                | Imports |
| 5   | dplyr              | Imports |
| 6   | duckdb             | Imports |
| 7   | duckplyr           | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            censobr_cache       data_dictionary      interview_manual 
                     TRUE                  TRUE                  TRUE 
            questionnaire       read_emigration         read_families 
                     TRUE                  TRUE                  TRUE 
          read_households        read_mortality       read_population 
                     TRUE                  TRUE                  TRUE 
              read_tracts set_censobr_cache_dir 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:00:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3255dc9df_1739678409
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUWbzj6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_censobr_v0.4.0-tikzDictionary"
