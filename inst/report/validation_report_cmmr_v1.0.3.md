...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Yaoxiang Li <liyaoxiang@outlook.com>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/YaoxiangLi/cmmr                   |
...
Overall the package has 6 exported objects. 6 are documented:
         ...
         advanced_batch_search               batch_search 
                          TRUE                       TRUE 
    create_advanced_batch_body          create_batch_body 
                          TRUE                       TRUE 
              create_msms_body                msms_search 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-16 04:44:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31b6f86d8_1739681089
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOzHZ1T
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmmr_v1.0.3-tikzDictionary"
