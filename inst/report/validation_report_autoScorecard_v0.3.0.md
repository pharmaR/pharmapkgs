...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tai-Sen Zheng <jc3802201@gmail.com>                  |
...
Overall the package has 19 exported objects. 19 are documented:
         ...
         auto_scorecard             best_iv             best_vs      binning_eqfreq 
                   TRUE                TRUE                TRUE                TRUE 
          binning_eqwid       binning_kmean           bins_chim           bins_tree 
                   TRUE                TRUE                TRUE                TRUE 
      bins_unsupervised      comparison_two comparison_two_data         data_detect 
                   TRUE                TRUE                TRUE                TRUE 
             filter_var              get_IV    noauto_scorecard   noauto_scorecard2 
                   TRUE                TRUE                TRUE                TRUE 
             plot_board             psi_cal             rep_woe 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-14 07:34:38 UTC |
...
running this report
    ...
    PROCESSX_PS1c096c32a5f3_1739518475
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDFkXIt
