# Validation Report - DominoDataR@0.2.3
...
| export_help          | 12                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Gabriel Haim <gabriel.haim@dominodatalab.com>        |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/dominodatalab/DominoDataR         |
...
Overall the package has 12 exported objects. 12 are documented:
           ...
           add_credentials           add_override      datasource_client 
                      TRUE                   TRUE                   TRUE 
                get_object              list_keys            object_http 
                      TRUE                   TRUE                   TRUE 
                put_object py_domino_data_install  py_select_interpreter 
                      TRUE                   TRUE                   TRUE 
                     query            save_object          upload_object 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:33:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bb463e322ad_1739853218
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFaLW1d
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DominoDataR_v0.2.3-tikzDictionary"
