# Validation Report - calibmsm@1.1.1
...
| export_help          | 3                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Alexander Pate <alexander.pate@manchester.ac.uk>     |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    calc_weights    calib_msm     metadata 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 03:34:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3311c6e42_1739676885
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzNqc4k
...
These are the options set to generate the report:
    ...
    [1] "validation_report_calibmsm_v1.1.1-tikzDictionary"
