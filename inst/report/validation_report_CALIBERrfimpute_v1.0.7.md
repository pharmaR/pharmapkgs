# Validation Report - CALIBERrfimpute@1.0.7
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Anoop Shah <anoop@doctors.org.uk>                    |
...
Overall the package has 5 exported objects. 5 are documented:
               ...
               makemar  mice.impute.rfcat mice.impute.rfcont       setRFoptions 
                  TRUE               TRUE               TRUE               TRUE 
               simdata 
                  TRUE 
...
| Execution Time | 2025-02-16 03:34:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3665348df_1739676880
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpcg3ECF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CALIBERrfimpute_v1.0.7-tikzDictionary"
