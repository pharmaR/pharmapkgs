...
| has_source_control   | https://github.com/mrc-ide/dde          |
...
Overall the package has 10 exported objects. 10 are documented:
                ...
                difeq    difeq_continue   difeq_replicate             dopri 
                 TRUE              TRUE              TRUE              TRUE 
       dopri_continue dopri_interpolate            dopri5          dopri853 
                 TRUE              TRUE              TRUE              TRUE 
                 ylag             yprev 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-18 03:28:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46443af15_1739849310
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHWrKAS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dde_v1.0.7-tikzDictionary"
