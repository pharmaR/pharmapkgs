...
| export_help          | 12                                      |
| has_website          | FALSE                                   |
| has_maintainer       | Aboozar Hadavand <hadavand.a@gmail.com> |
...
Overall the package has 12 exported objects. 12 are documented:
           ...
           crsra_anonymize  crsra_assessmentskips      crsra_delete_user 
                      TRUE                   TRUE                   TRUE 
        crsra_gradesummary           crsra_import crsra_import_as_course 
                      TRUE                   TRUE                   TRUE 
       crsra_import_course     crsra_membershares         crsra_progress 
                      TRUE                   TRUE                   TRUE 
           crsra_tabledesc     crsra_timetofinish       crsra_whichtable 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-17 04:26:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61e41570a_1739766400
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKY331V
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crsra_v0.2.3-tikzDictionary"
