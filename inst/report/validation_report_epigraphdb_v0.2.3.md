# Validation Report - epigraphdb@0.2.3
...
| export_help          | 23                                |
| has_website          | TRUE                              |
| has_maintainer       | Yi Liu <yi6240.liu@bristol.ac.uk> |
...
Overall the package has 23 exported objects. 22 are documented:
                         ...
                         %>%               confounder                   cypher 
                       FALSE                     TRUE                     TRUE 
          drugs_risk_factors              genetic_cor          literature_gwas 
                        TRUE                     TRUE                     TRUE 
    mappings_gene_to_protein          meta_nodes_list     meta_nodes_list_node 
                        TRUE                     TRUE                     TRUE 
      meta_nodes_search_node           meta_rels_list       meta_rels_list_rel 
                        TRUE                     TRUE                     TRUE 
                          mr                  obs_cor        ontology_gwas_efo 
                        TRUE                     TRUE                     TRUE 
                     pathway                     pqtl                pqtl_list 
                        TRUE                     TRUE                     TRUE 
                  pqtl_pleio       protein_in_pathway         query_epigraphdb 
                        TRUE                     TRUE                     TRUE 
           xqtl_multi_snp_mr       xqtl_single_snp_mr 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-19 04:16:43 UTC |
...
running this report
    ...
    PROCESSX_PS1d452202cc6e_1739938597
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJSAxL6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epigraphdb_v0.2.3-tikzDictionary"
