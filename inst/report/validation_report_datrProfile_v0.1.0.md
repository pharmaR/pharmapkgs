# Validation Report - datrProfile@0.1.0
...
| export_help          | 5                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Arnaldo Vitaliano <vitaliano@gmail.com>   |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/avitaliano/datrProfile |
...
Overall the package has 5 exported objects. 5 are documented:
      ...
      closeConnection         connectDB   getTableColumns prepareConnection 
                 TRUE              TRUE              TRUE              TRUE 
           runProfile 
                 TRUE 
...
| Execution Time | 2025-02-17 05:04:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bd671009356_1739768665
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnVOCtT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datrProfile_v0.1.0-tikzDictionary"
