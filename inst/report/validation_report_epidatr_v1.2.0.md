# Validation Report - epidatr@1.2.0
...
| export_help          | 39                                    |
| has_website          | TRUE                                  |
| has_maintainer       | David Weber <davidweb@andrew.cmu.edu> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/cmu-delphi/epidatr |
...
Overall the package has 39 exported objects. 39 are documented:
                    ...
                    avail_endpoints                      cache_info 
                               TRUE                            TRUE 
                        clear_cache               covidcast_epidata 
                               TRUE                            TRUE 
                      disable_cache                        epirange 
                               TRUE                            TRUE 
                              fetch                 fetch_args_list 
                               TRUE                            TRUE 
                        get_api_key         pub_covid_hosp_facility 
                               TRUE                            TRUE 
     pub_covid_hosp_facility_lookup pub_covid_hosp_state_timeseries 
                               TRUE                            TRUE 
                      pub_covidcast              pub_covidcast_meta 
                               TRUE                            TRUE 
                         pub_delphi              pub_dengue_nowcast 
                               TRUE                            TRUE 
                       pub_ecdc_ili                     pub_flusurv 
                               TRUE                            TRUE 
                        pub_fluview            pub_fluview_clinical 
                               TRUE                            TRUE 
                   pub_fluview_meta                         pub_gft 
                               TRUE                            TRUE 
                       pub_kcdc_ili                        pub_meta 
                               TRUE                            TRUE 
                   pub_nidss_dengue                   pub_nidss_flu 
                               TRUE                            TRUE 
                        pub_nowcast                 pub_paho_dengue 
                               TRUE                            TRUE 
                           pub_wiki                         pvt_cdc 
                               TRUE                            TRUE 
                 pvt_dengue_sensors                         pvt_ght 
                               TRUE                            TRUE 
                  pvt_meta_norostat                    pvt_norostat 
                               TRUE                            TRUE 
                         pvt_quidel                     pvt_sensors 
                               TRUE                            TRUE 
                        pvt_twitter                    save_api_key 
                               TRUE                            TRUE 
                          set_cache 
                               TRUE 
...
| Execution Time | 2025-02-19 04:15:48 UTC |
...
running this report
    ...
    PROCESSX_PS1d45326dcb1e_1739938541
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpW46NG3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epidatr_v1.2.0-tikzDictionary"
