...
| export_help | 4 |
| has_website | TRUE |
| has_maintainer | Falco Joannes Bargagli Stoffi <fbargaglistoffi@hsph.harvard.edu> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/NSAPH-Software/CRE |
...
| 10  | xtable       | Imports |
| 11  | glmnet       | Imports |
| 12  | bartCause    | Imports |
| 13  | stabs        | Imports |
| 14  | stringr      | Imports |
| 15  | SuperLearner | Imports |
| 16  | magrittr     | Imports |
| 17  | ggplot2      | Imports |
| 18  | arules       | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
                     ...
                     cre generate_cre_dataset           get_logger 
                    TRUE                 TRUE                 TRUE 
              set_logger 
                    TRUE 
...
| Execution Time | 2025-02-17 04:18:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bd625cd5361_1739765914
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpurGcLN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CRE_v0.2.7-tikzDictionary"
