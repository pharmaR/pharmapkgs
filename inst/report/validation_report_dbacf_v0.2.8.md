...
| export_help | 5 |
| has_website | FALSE |
| has_maintainer | Inder Tecuapetla-Gómez |
...
Overall the package has 5 exported objects. 5 are documented:
                ...
                dbacf         dbacf_AR1    nearPDToeplitz   projectToeplitz 
                 TRUE              TRUE              TRUE              TRUE 
    symBandedToeplitz 
                 TRUE 
...
| Execution Time | 2025-02-17 05:05:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6595efeaf_1739768709
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8C2bhn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dbacf_v0.2.8-tikzDictionary"
