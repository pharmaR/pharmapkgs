...
| export_help          | 17                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Armin Ströbel <arminstroebel@web.de>    |
| bugs_status          | subscript out of bounds                 |
| size_codebase        | 1431                                    |
| has_source_control   | https://github.com/arminstroebel/atable |
...
Overall the package has 17 exported objects. 17 are documented:
         ...
         add_name_to_statistics           add_name_to_tests 
                           TRUE                        TRUE 
                         atable              atable_compact 
                           TRUE                        TRUE 
            atable_longitudinal              atable_options 
                           TRUE                        TRUE 
           atable_options_reset        create_alias_mapping 
                           TRUE                        TRUE 
              format_statistics                format_tests 
                           TRUE                        TRUE 
                      get_alias is_syntactically_valid_name 
                           TRUE                        TRUE 
             multi_sample_htest                  replace_NA 
                           TRUE                        TRUE 
                     statistics          translate_to_LaTeX 
                           TRUE                        TRUE 
               two_sample_htest 
                           TRUE 
...
| Execution Time | 2025-02-14 07:30:18 UTC |
...
running this report
    ...
    PROCESSX_PS1c0931f04734_1739518215
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0bRvSB
