# Validation Report - Eunomia@2.0.0
...
| has_source_control   | https://github.com/OHDSI/Eunomia   |
...
CohortGenerator, FeatureExtraction, OhdsiShinyAppBuilder,
PatientLevelPrediction, TreatmentPatterns

## Namespace

Overall the package has 7 exported objects. 7 are documented:

                  createCohorts         downloadEunomiaData 
                           TRUE                        TRUE 
                exportDataFiles             extractLoadData 
                           TRUE                        TRUE 
                getDatabaseFile getEunomiaConnectionDetails 
                           TRUE                        TRUE 
                  loadDataFiles 
                           TRUE 
...
| Execution Time | 2025-02-19 04:36:19 UTC |
...
running this report
    ...
    PROCESSX_PS1d456e3c908d_1739939773
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzD1Juw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Eunomia_v2.0.0-tikzDictionary"
