# Validation Report - distrEllipse@2.8.4
...
| 3   | graphics              | Depends |
| 4   | mvtnorm               | Depends |
| 5   | setRNG(\>= 2006.2-1)  | Depends |
| 6   | distr(\>= 2.8.0)      | Depends |
| 7   | distrEx(\>= 2.8.0)    | Depends |
| 8   | distrSim(\>= 2.2)     | Depends |
| 9   | startupmsg(\>= 1.0.0) | Imports |
| 10  | stats                 | Imports |
...
Overall the package has 9 exported objects. 25 are documented:

              distrEllipseMASK        distrEllipseoptions 
                          TRUE                       TRUE 
        EllipticalDistribution      getdistrEllipseOption 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-18 04:19:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bb421a288c3_1739852374
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJCzm7C
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distrEllipse_v2.8.4-tikzDictionary"
