# Validation Report - bayesdfa@1.3.3
...
| export_help          | 21                                |
| has_website          | TRUE                              |
| has_maintainer       | Eric J. Ward <eric.ward@noaa.gov> |
...
Overall the package has 21 exported objects. 21 are documented:
                  ...
                  dfa_cv           dfa_fitted         dfa_loadings 
                    TRUE                 TRUE                 TRUE 
              dfa_trends      find_dfa_trends find_inverted_chains 
                    TRUE                 TRUE                 TRUE 
            find_regimes           find_swans              fit_dfa 
                    TRUE                 TRUE                 TRUE 
             fit_regimes        invert_chains         is_converged 
                    TRUE                 TRUE                 TRUE 
                     loo          plot_fitted        plot_loadings 
                    TRUE                 TRUE                 TRUE 
       plot_regime_model          plot_trends            predicted 
                    TRUE                 TRUE                 TRUE 
           rotate_trends              sim_dfa            trend_cor 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 03:33:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1f55942f_1739590412
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuxmtHV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesdfa_v1.3.3-tikzDictionary"
