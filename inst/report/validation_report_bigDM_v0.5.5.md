...
| export_help          | 14                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Aritz Adin <aritz.adin@unavarra.es>            |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/spatialstatisticsupna/bigDM |
...
| 10  | methods      | Imports |
| 11  | parallel     | Imports |
| 12  | RColorBrewer | Imports |
| 13  | Rdpack       | Imports |
| 14  | sf           | Imports |
| 15  | spatialreg   | Imports |
| 16  | spdep        | Imports |
| 17  | stats        | Imports |
| 18  | utils        | Imports |
| 19  | rlist        | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
           ...
           add_neighbour             CAR_INLA clustering_partition 
                    TRUE                 TRUE                 TRUE 
       connect_subgraphs         divide_carto            MCAR_INLA 
                    TRUE                 TRUE                 TRUE 
               mergeINLA   Mmodel_compute_cor          Mmodel_icar 
                    TRUE                 TRUE                 TRUE 
              Mmodel_iid          Mmodel_lcar          Mmodel_pcar 
                    TRUE                 TRUE                 TRUE 
        random_partition           STCAR_INLA 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:03:33 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd56218839_1739592208
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEFOhGf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigDM_v0.5.5-tikzDictionary"
