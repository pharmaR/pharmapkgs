# Validation Report - DiPhiSeq@0.2.0
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jun Li <jun.li@nd.edu>                               |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    diphiseq  outprop    robnb  robtest 
        TRUE     TRUE     TRUE     TRUE 
...
| Execution Time | 2025-02-18 04:08:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4ec8c6f0_1739851691
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXYexAG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiPhiSeq_v0.2.0-tikzDictionary"
