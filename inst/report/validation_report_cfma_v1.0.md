...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yi Zhao <zhaoyi1026@gmail.com>                       |
...
Overall the package has 6 exported objects. 6 are documented:
         ...
         FMA.concurrent FMA.concurrent.boot   FMA.concurrent.CV      FMA.historical 
                   TRUE                TRUE                TRUE                TRUE 
    FMA.historical.boot   FMA.historical.CV 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:04:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bc38f7b28_1739678678
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGI7Lvc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cfma_v1.0-tikzDictionary"
