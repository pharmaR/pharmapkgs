...
| export_help          | 6                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Tobias Ruettenauer <ruettenauer@sowi.uni-kl.de> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/ruettenauer/feisr            |
...
Overall the package has 6 exported objects. 6 are documented:
             ...
             bsfeistest             detrend                feis            feistest 
                   TRUE                TRUE                TRUE                TRUE 
    model.response.feis              slopes 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-27 03:26:03 UTC |
...
running this report
    ...
    PROCESSX_PS1c623ff9a538_1740626759
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIlueCU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_feisr_v1.3.0-tikzDictionary"
