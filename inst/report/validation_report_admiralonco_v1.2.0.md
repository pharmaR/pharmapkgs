...
| export_help          | 29                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Stefan Bundfuss <stefan.bundfuss@roche.com> |
| bugs_status          | subscript out of bounds                     |
| size_codebase        | 905                                         |
| has_source_control   | https://github.com/pharmaverse/admiralonco  |
...
Overall the package has 29 exported objects. 29 are documented:
                      ...
                      crsp_y_cr                   crsp_y_pr 
                           TRUE                        TRUE 
                    death_event            derive_param_bor 
                           TRUE                        TRUE 
       derive_param_clinbenefit  derive_param_confirmed_bor 
                           TRUE                        TRUE 
    derive_param_confirmed_resp       derive_param_response 
                           TRUE                        TRUE 
                      filter_pd            get_crpr_dataset 
                           TRUE                        TRUE 
                   lasta_censor            lastalive_censor 
                           TRUE                        TRUE 
                no_data_missing                   no_data_n 
                           TRUE                        TRUE 
                       pd_event                 rand_censor 
                           TRUE                        TRUE 
                          rsp_y                 signal_crpr 
                           TRUE                        TRUE 
                    trts_censor 
...
| Execution Time | 2025-02-14 06:38:26 UTC |
...
running this report
    ...
    PROCESSX_PS726d2cd2561a_1739515104
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpavCmcu
