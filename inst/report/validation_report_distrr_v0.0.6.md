# Validation Report - distrr@0.0.6
...
| export_help          | 17                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Sandro Petrillo Burri <gibo.gaf@gmail.com>           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/gibonet/distrr                    |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | magrittr (\>= 1.5) | Imports |
| 2   | dplyr (\>= 0.7.4)  | Imports |
| 3   | rlang              | Imports |
| 4   | utils              | Imports |
| 5   | stats              | Imports |
| 6   | tidyr (\>= 0.7.0)  | Imports |
...
Overall the package has 17 exported objects. 16 are documented:
                ...
                FALSE              TRUE              TRUE              TRUE 
                 dcc5              dcc6        dcc6_fixed    extract_unique 
                 TRUE              TRUE              TRUE              TRUE 
      extract_unique2   extract_unique3   extract_unique4   extract_unique5 
                 TRUE              TRUE              TRUE              TRUE 
    Fhat_conditional_          Fhat_df_         jointfun_        only_joint 
                 TRUE              TRUE              TRUE              TRUE 
                   wq 
                 TRUE 
...
| Execution Time | 2025-02-18 04:21:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bb421e6ac09_1739852462
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpsr4Bvg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distrr_v0.0.6-tikzDictionary"
