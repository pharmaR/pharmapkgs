# Validation Report - conf.design@2.0.0
...
DoE.base, HVT, rsm, sFFLHD, SOAs

## Namespace

Overall the package has 7 exported objects. 7 are documented:

    conf.design    conf.set  direct.sum   factorize        join      primes 
...
| Execution Time | 2025-02-17 03:42:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bd659d7dadc_1739763731
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6ppGBw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conf.design_v2.0.0-tikzDictionary"
