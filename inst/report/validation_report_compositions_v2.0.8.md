# Validation Report - compositions@2.0.8
...
aqp, Arothron, CiteFuse, CoDaImpact, CoDaLoMic, codaredistlm, coseq,
countprop, emmeans, ggtern, gmGeostats, HybridMicrobiomes, itraxR,
metamicrobiomeR, microbiome, MRPC, multilevelcoda, multimedia,
omicplotR, parafac4microbiome, powerPLS, QFASA, scone, simmr,
Toothnroll, Unico, vdar

## Namespace

Overall the package has 17 exported objects. 17 are documented:

           geometricmean     geometricmeanCol     geometricmeanRow 
                    TRUE                 TRUE                 TRUE 
       getDetectionlimit getStickyClassOption           groupparts 
                    TRUE                 TRUE                 TRUE 
                     gsi     gsi.buildilrBase             gsi.getD 
                    TRUE                 TRUE                 TRUE 
     gsi.ilrBase2signary    gsi.merge2signary   gsi.optimalilrBase 
                    TRUE                 TRUE                 TRUE 
            gsi.OrderIlr            gsi.orSum          gsi.PrinBal 
                    TRUE                 TRUE                 TRUE 
              gsi.pStore  gsi.signary2ilrBase 
                    TRUE                 TRUE 

### Examples

There are 212 help pages with examples, from 212 (100.00 %).
...
| Execution Time | 2025-02-23 03:25:38 UTC |
...
running this report
    ...
    PROCESSX_PS1d254c5dafb9_1740281134
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsYgyYB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_compositions_v2.0.8-tikzDictionary"
