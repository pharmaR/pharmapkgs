...
| export_help          | 47                               |
| has_website          | TRUE                             |
| has_maintainer       | Peter Hoff <peter.hoff@duke.edu> |
| bugs_status          | subscript out of bounds          |
| size_codebase        | 1768                             |
| has_source_control   | https://github.com/pdhoff/amen   |
| has_bug_reports_url  | 1                                |
| downloads_1yr        | 6828                             |
| reverse_dependencies | 0                                |
| has_examples         | 0.8923077                        |
| dependencies         | 0                                |
| license              | GPL-3                            |
...
Overall the package has 47 exported objects. 47 are documented:
           ...
           addlines             ame         ame_rep        circplot    design_array 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              el2sm        gofstats         ldZgbme        llsrmRho           mhalf 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            netplot     precomputeX    raSab_bin_fc   raSab_cbin_fc    raSab_frn_fc 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        rbeta_ab_fc rbeta_ab_rep_fc         rmvnorm         rrho_fc         rrho_mh 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        rrho_mh_rep          rs2_fc      rs2_rep_fc         rSab_fc         rSuv_fc 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             rUV_fc      rUV_rep_fc      rUV_sym_fc           rwish       rZ_bin_fc 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         rZ_cbin_fc       rZ_frn_fc       rZ_nrm_fc       rZ_ord_fc       rZ_rrl_fc 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          rZ_tob_fc        simY_bin        simY_frn        simY_nrm        simY_ord 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           simY_rrl        simY_tob            simZ           sm2el           Xbeta 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               xnet         zscores 
               TRUE            TRUE 
...
There are 58 help pages with examples, from 65 (89.23 %).
...
| Execution Time | 2025-02-14 06:51:56 UTC |
...
running this report
    ...
    PROCESSX_PS726d29bb333a_1739515913
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5afq6i
