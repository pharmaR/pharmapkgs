# Validation Report - ElliptCopulas@0.1.4.1
...
| has_source_control   | https://github.com/AlexisDerumigny/ElliptCopulas |
...
Overall the package has 24 exported objects. 24 are documented:
                ...
                compute_etahat       compute_matrix_alpha 
                          TRUE                       TRUE 
              Convert_g1_To_f1          Convert_g1_To_Fg1 
                          TRUE                       TRUE 
             Convert_g1_To_Qg1          Convert_gd_To_fR2 
                          TRUE                       TRUE 
              Convert_gd_To_g1     DensityGenerator.check 
                          TRUE                       TRUE 
    DensityGenerator.normalize             derivative.psi 
                          TRUE                       TRUE 
                derivative.rho             derivative.tau 
                          TRUE                       TRUE 
                     EllCopEst           EllCopLikelihood 
                          TRUE                       TRUE 
                     EllCopSim           EllDistrDerivEst 
                          TRUE                       TRUE 
                   EllDistrEst          EllDistrEst.adapt 
                          TRUE                       TRUE 
                   EllDistrSim            EllDistrSimCond 
                          TRUE                       TRUE 
              estim_tilde_AMSE                KTMatrixEst 
                          TRUE                       TRUE 
                  TEllDistrEst    vectorized_Faa_di_Bruno 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-19 03:56:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d4539d4a35b_1739937411
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTxCOHq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ElliptCopulas_v0.1.4.1-tikzDictionary"
