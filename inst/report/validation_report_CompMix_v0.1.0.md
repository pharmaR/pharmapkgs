# Validation Report - CompMix@0.1.0
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Wei Hao <weihao@umich.edu>                           |
...
| 5   | hierNet      | Imports |
| 6   | glmnet       | Imports |
| 7   | SuperLearner | Imports |
| 8   | bkmr         | Imports |
| 9   | qgcomp       | Imports |
| 10  | gWQS         | Imports |
| 11  | pROC         | Imports |
| 12  | randomForest | Imports |
| 13  | devtools     | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
         ...
         Comp.Mix lmi_simul_dat simul_x_block 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 03:36:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bd623641dbf_1739763400
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVJA6DH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CompMix_v0.1.0-tikzDictionary"
