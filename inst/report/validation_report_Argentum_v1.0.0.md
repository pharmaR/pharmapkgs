# Validation Report - Argentum@1.0.0
...
| export_help          | 8                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Thomas Artopoulos <thomas.artopoulos@gmail.com> |
| bugs_status          | subscript out of bounds                         |
| size_codebase        | 338                                             |
| has_source_control   | https://github.com/thomasartopoulos/argentum/   |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         argentum_download_layers     argentum_get_capabilities 
                             TRUE                          TRUE 
        argentum_import_wfs_layer argentum_interactive_download 
                             TRUE                          TRUE 
      argentum_interactive_import          argentum_list_layers 
                             TRUE                          TRUE 
      argentum_list_organizations  argentum_select_organization 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-14 07:23:01 UTC |
...
running this report
    ...
    PROCESSX_PS1c09b6b071b_1739517779
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJhBfw1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Argentum_v1.0.0-tikzDictionary"
