...
| export_help          | 29                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Charles J. Geyer <geyer@umn.edu>                     |
...
Overall the package has 29 exported objects. 29 are documented:
            ...
            anovaAsterOrReasterList                           aster 
                               TRUE                            TRUE 
                     astertransform                   fam.bernoulli 
                               TRUE                            TRUE 
                        fam.default           fam.negative.binomial 
                               TRUE                            TRUE 
                fam.normal.location                     fam.poisson 
                               TRUE                            TRUE 
    fam.truncated.negative.binomial           fam.truncated.poisson 
                               TRUE                            TRUE 
                             famfun                         makezwz 
                               TRUE                            TRUE 
                              mlogl                       newpickle 
...
| Execution Time | 2025-02-21 13:11:31 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a2ef671fe_1740143487
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgQDhEd
