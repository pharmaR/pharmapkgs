...
| export_help          | 21                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Cam Race <cameron.race@education.gov.uk>        |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/dfe-analytical-services/dfeR |
...
Overall the package has 21 exported objects. 21 are documented:
            ...
            comma_sep    create_project   fetch_countries        fetch_lads 
                 TRUE              TRUE              TRUE              TRUE 
            fetch_las       fetch_pcons     fetch_regions       fetch_wards 
                 TRUE              TRUE              TRUE              TRUE 
            format_ay format_ay_reverse         format_fy format_fy_reverse 
                 TRUE              TRUE              TRUE              TRUE 
        get_clean_sql  get_ons_api_data   pretty_filesize        pretty_num 
                 TRUE              TRUE              TRUE              TRUE 
     pretty_num_table pretty_time_taken     round_five_up    toggle_message 
                 TRUE              TRUE              TRUE              TRUE 
            z_replace 
                 TRUE 
...
| Execution Time | 2025-02-18 03:53:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47c2c88f2_1739850814
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpF0uqEQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dfeR_v1.0.1-tikzDictionary"
