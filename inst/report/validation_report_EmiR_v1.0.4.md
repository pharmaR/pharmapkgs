...
Overall the package has 34 exported objects. 34 are documented:
               ...
               ackley_func     animate_population       bohachevsky_func 
                      TRUE                   TRUE                   TRUE 
             colville_func             config_abc            config_algo 
                      TRUE                   TRUE                   TRUE 
                config_bat              config_cs              config_ga 
                      TRUE                   TRUE                   TRUE 
                config_gsa             config_gwo              config_hs 
                      TRUE                   TRUE                   TRUE 
                config_ihs             config_mfo              config_ps 
                      TRUE                   TRUE                   TRUE 
                 config_sa             config_woa   constrained_function 
                      TRUE                   TRUE                   TRUE 
                constraint freudenstein_roth_func         get_population 
                      TRUE                   TRUE                   TRUE 
             griewank_func     list_of_algorithms      list_of_functions 
                      TRUE                   TRUE                   TRUE 
       miele_cantrell_func               minimize              parameter 
                      TRUE                   TRUE                   TRUE 
                parameters           plot_history        plot_population 
                      TRUE                   TRUE                   TRUE 
            rastrigin_func        rosenbrock_func          schwefel_func 
                      TRUE                   TRUE                   TRUE 
...
There are 34 help pages with examples, from 37 (91.89 %).
...
| Execution Time | 2025-02-19 04:01:43 UTC |
...
running this report
    ...
    PROCESSX_PS1d455778d4eb_1739937697
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUhfH6g
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EmiR_v1.0.4-tikzDictionary"
