# Validation Report - bmstdr@0.7.9
...
| export_help          | 21                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Sujit K. Sahu <S.K.Sahu@soton.ac.uk> |
...
| 3   | ggplot2                   | Imports   |
| 4   | rstan                     | Imports   |
| 5   | rstantools                | Imports   |
| 6   | spBayes                   | Imports   |
| 7   | CARBayes                  | Imports   |
| 8   | CARBayesST                | Imports   |
| 9   | spTDyn                    | Imports   |
| 10  | MCMCpack                  | Imports   |
| 11  | Rdpack                    | Imports   |
| 12  | mnormt                    | Imports   |
| 13  | inlabru                   | Imports   |
| 14  | ggpubr                    | Imports   |
| 15  | Rcpp (\>= 0.12.0)         | Depends   |
| 16  | BH (\>= 1.66.0)           | LinkingTo |
| 17  | Rcpp (\>= 0.12.0)         | LinkingTo |
| 18  | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 19  | rstan (\>= 2.18.1)        | LinkingTo |
| 20  | StanHeaders (\>= 2.18.0)  | LinkingTo |
| 21  | RcppParallel              | LinkingTo |
...
Overall the package has 21 exported objects. 21 are documented:
                           ...
                           Bcartime                         BCauchy 
                               TRUE                            TRUE 
                           Bmchoice                  Bmoving_sptime 
                               TRUE                            TRUE 
                   bmstdr_variogram                         Bnormal 
                               TRUE                            TRUE 
                           Bspatial                         Bsptime 
                               TRUE                            TRUE 
    calculate_validation_statistics                   fig11.13.plot 
                               TRUE                            TRUE 
                 fnc.delete.map.XYZ         get_parameter_estimates 
                               TRUE                            TRUE 
           get_validation_summaries                    getvalidrows 
                               TRUE                            TRUE 
                   hitandfalsealarm                       is.bmstdr 
                               TRUE                            TRUE 
                          materncov                       maternfun 
                               TRUE                            TRUE 
                    obs_v_pred_plot                    phichoice_sp 
                               TRUE                            TRUE 
                         phichoicep 
                               TRUE 
...
| Execution Time | 2025-02-15 04:27:39 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd24c19e84_1739593654
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqyRYEZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bmstdr_v0.7.9-tikzDictionary"
