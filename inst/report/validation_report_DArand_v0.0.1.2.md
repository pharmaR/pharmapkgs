# Validation Report - DArand@0.0.1.2
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Dorota Desaulle <dorota.desaulle@u-paris.fr>         |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    build_example        DArand   select_prob 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 04:54:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bd666d8e5cb_1739768047
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp31woGj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DArand_v0.0.1.2-tikzDictionary"
