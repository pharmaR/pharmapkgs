# Validation Report - decompDL@0.1.0
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Kapil Choudhary <kapiliasri@gmail.com>               |
...
| 4   | tsutils        | Imports |
| 5   | stats          | Imports |
| 6   | BiocGenerics   | Imports |
| 7   | utils          | Imports |
| 8   | graphics       | Imports |
| 9   | magrittr       | Imports |
| 10  | Rlibeemd       | Imports |
| 11  | TSdeeplearning | Imports |
| 12  | VMDecomp       | Imports |
...
Overall the package has 12 exported objects. 12 are documented:
     ...
     ceemdGRU ceemdLSTM  ceemdRNN   eemdGRU  eemdLSTM   eemdRNN    emdGRU   emdLSTM 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
       emdRNN    vmdGRU   vmdLSTM    vmdRNN 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-18 03:33:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44aa2094d_1739849576
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp90dkfk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_decompDL_v0.1.0-tikzDictionary"
