# Validation Report - CirceR@1.3.3
...
| export_help          | 8                                |
| has_website          | TRUE                             |
| has_maintainer       | Chris Knoll <cknoll@ohdsi.org>   |
| bugs_status          | subscript out of bounds          |
| has_source_control   | https://github.com/OHDSI/CirceR/ |
...
CDMConnector, CohortGenerator, TreatmentPatterns

## Namespace

Overall the package has 8 exported objects. 8 are documented:

                buildCohortQuery         buildConceptSetQuery 
                            TRUE                         TRUE 
        cohortExpressionFromJson          cohortPrintFriendly 
                            TRUE                         TRUE 
    conceptSetExpressionFromJson  conceptSetListPrintFriendly 
                            TRUE                         TRUE 
         conceptSetPrintFriendly        createGenerateOptions 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-16 04:20:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34cc76557_1739679630
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCWUKFL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CirceR_v1.3.3-tikzDictionary"
