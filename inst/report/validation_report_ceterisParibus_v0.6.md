# Validation Report - ceterisParibus@0.6
...
Overall the package has 12 exported objects. 12 are documented:
            ...
            calculate_oscillations             calculate_profiles 
                              TRUE                           TRUE 
            calculate_profiles_lce      calculate_variable_splits 
                              TRUE                           TRUE 
                   ceteris_paribus          ceteris_paribus_layer 
                              TRUE                           TRUE 
    local_conditional_expectations                      local_fit 
                              TRUE                           TRUE 
                 select_neighbours                  select_sample 
                              TRUE                           TRUE 
                           what_if                     what_if_2d 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-16 04:03:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bc377cf9840_1739678618
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb2cgRO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ceterisParibus_v0.6-tikzDictionary"
