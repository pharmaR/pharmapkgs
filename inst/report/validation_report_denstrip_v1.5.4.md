# Validation Report - denstrip@1.5.4
...
Overall the package has 20 exported objects. 20 are documented:
                    ...
                    bpstrip                 cistrip              densregion 
                       TRUE                    TRUE                    TRUE 
         densregion.default       densregion.normal                denstrip 
                       TRUE                    TRUE                    TRUE 
            denstrip.legend         denstrip.normal           panel.bpstrip 
                       TRUE                    TRUE                    TRUE 
              panel.cistrip          panel.denstrip   panel.denstrip.legend 
                       TRUE                    TRUE                    TRUE 
      panel.denstrip.normal panel.sectioned.density           panel.vwstrip 
                       TRUE                    TRUE                    TRUE 
       panel.vwstrip.normal       sectioned.density          seqToIntervals 
                       TRUE                    TRUE                    TRUE 
                    vwstrip          vwstrip.normal 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-18 03:43:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46ea2854d_1739850180
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYizEu2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_denstrip_v1.5.4-tikzDictionary"
