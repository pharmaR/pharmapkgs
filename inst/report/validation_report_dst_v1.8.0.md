...
| export_help          | 49                                |
| has_website          | FALSE                             |
| has_maintainer       | Peiyuan Zhu <garyzhubc@gmail.com> |
...
Overall the package has 49 exported objects. 49 are documented:
                ...
                addTobca                  bca              bcaNorm 
                    TRUE                 TRUE                 TRUE 
                bcaPrint        bcaPrintLarge               bcaRel 
                    TRUE                 TRUE                 TRUE 
                bcaTrunc              belplau          belplauEval 
                    TRUE                 TRUE                 TRUE 
                belplauH    belplauHLogsumexp           belplauHQQ 
                    TRUE                 TRUE                 TRUE 
        belplauLogsumexp          belplauPlot          commonality 
                    TRUE                 TRUE                 TRUE 
                  decode            DoSSnames              dotprod 
                    TRUE                 TRUE                 TRUE 
                 doubles               dsrwon      dsrwonLogsumexp 
                    TRUE                 TRUE                 TRUE 
                    elim               encode             extFrame 
                    TRUE                 TRUE                 TRUE 
                  extmin               inters       intersBySSName 
                    TRUE                 TRUE                 TRUE 
                  logsum       marrayToMatrix       matrixToMarray 
                    TRUE                 TRUE                 TRUE 
           mFromMarginal              mFromQQ     mFromQQRecursive 
                    TRUE                 TRUE                 TRUE 
            mobiusInvHQQ             nameCols        nameCols_prod 
                    TRUE                 TRUE                 TRUE 
                nameRows                nzdsr       nzdsrLogsumexp 
                    TRUE                 TRUE                 TRUE 
                 peeling            plautrans         productSpace 
                    TRUE                 TRUE                 TRUE 
               reduction                shape             tabresul 
                    TRUE                 TRUE                 TRUE 
                ttmatrix ttmatrixFromMarginal       ttmatrixFromQQ 
                    TRUE                 TRUE                 TRUE 
       ttmatrixPartition 
                    TRUE 
...
| Execution Time | 2025-02-18 04:53:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41b0b5b4f_1739854383
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpuribam
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dst_v1.8.0-tikzDictionary"
