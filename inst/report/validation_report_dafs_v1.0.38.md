...
Overall the package has 15 exported objects. 15 are documented:
              ...
              fitPvalue               fmtST formatScientificTeX             intPlot 
                   TRUE                TRUE                TRUE                TRUE 
                   last           pairsDAFS            plotBoth    plotBoth.control 
                   TRUE                TRUE                TRUE                TRUE 
       plotRegDiagPlots             printCI              pvalue                 Rsq 
                   TRUE                TRUE                TRUE                TRUE 
              shadeDens         StangleBook          SweaveBook 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-24 03:24:45 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a417830d9_1740367481
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpy0g5oT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dafs_v1.0.38-tikzDictionary"
