...
| export_help          | 27                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | James E. Pustejovsky <jepusto@gmail.com>             |
...
Overall the package has 27 exported objects. 27 are documented:
                     ...
                     ARPsimulator           augmented_recording 
                             TRUE                          TRUE 
    continuous_duration_recording                       eq_dist 
                             TRUE                          TRUE 
                   event_counting                       F_const 
                             TRUE                          TRUE 
                            F_exp                         F_gam 
                             TRUE                          TRUE 
                        F_gam_mix                        F_unif 
                             TRUE                          TRUE 
                           F_weib              incidence_bounds 
                             TRUE                          TRUE 
                   interim_bounds            interval_recording 
                             TRUE                          TRUE 
                     logRespRatio      momentary_time_recording 
                             TRUE                          TRUE 
                       PIR_loglik                       PIR_MOM 
                             TRUE                          TRUE 
                prevalence_bounds                         r_AIR 
                             TRUE                          TRUE 
                r_behavior_stream        r_continuous_recording 
                             TRUE                          TRUE 
                 r_event_counting                         r_MTS 
                             TRUE                          TRUE 
                            r_PIR                         r_WIR 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-14 07:24:47 UTC |
...
running this report
    ...
    PROCESSX_PS1c09a89c5d_1739517884
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdsvzIM
