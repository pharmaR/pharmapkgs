...
| export_help | 17 |
| has_website | TRUE |
| has_maintainer | Pedro H. C. Sant’Anna <pedrosantanna@causal-solutions.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/pedrohcgs/DRDID |
...
| 1   | stats               | Imports   |
| 2   | trust               | Imports   |
| 3   | BMisc (\>= 1.4.1)   | Imports   |
| 4   | Rcpp (\>= 1.0.12)   | Imports   |
| 5   | fastglm (\>= 0.0.3) | Imports   |
| 6   | Rcpp (\>= 1.0.12)   | LinkingTo |
...
Overall the package has 17 exported objects. 17 are documented:
                ...
                drdid   drdid_imp_panel      drdid_imp_rc     drdid_imp_rc1 
                 TRUE              TRUE              TRUE              TRUE 
          drdid_panel          drdid_rc         drdid_rc1     ipw_did_panel 
                 TRUE              TRUE              TRUE              TRUE 
           ipw_did_rc            ipwdid             ordid     reg_did_panel 
                 TRUE              TRUE              TRUE              TRUE 
           reg_did_rc std_ipw_did_panel    std_ipw_did_rc    twfe_did_panel 
                 TRUE              TRUE              TRUE              TRUE 
          twfe_did_rc 
                 TRUE 
...
| Execution Time | 2025-02-18 04:44:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bb426f88aec_1739853885
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5VHV0p
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DRDID_v1.2.0-tikzDictionary"
