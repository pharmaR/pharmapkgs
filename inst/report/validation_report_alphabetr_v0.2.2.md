...
| export_help          | 15                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Edward Lee <email.edwardlee@gmail.com> |
| bugs_status          | subscript out of bounds                |
| size_codebase        | 1170                                   |
| has_source_control   | http://github.com/edwardslee/alphabetr |
...
| 2   | clue (\>= 0.3-50)     | Imports   |
| 3   | dplyr (\>= 0.4.3)     | Imports   |
| 4   | multicool (\>= 0.1-9) | Imports   |
| 5   | Rcpp                  | LinkingTo |
...
Overall the package has 15 exported objects. 15 are documented:
                           ...
                           bagpipe                   chain_scores 
                              TRUE                           TRUE 
              combine_freq_results                  create_clones 
                              TRUE                           TRUE 
                       create_data        create_data_singlecells 
                              TRUE                           TRUE 
      dual_discrim_dual_likelihood dual_discrim_shared_likelihood 
                              TRUE                           TRUE 
                         dual_eval                      dual_tail 
                              TRUE                           TRUE 
                          dual_top                  freq_estimate 
                              TRUE                           TRUE 
                         freq_eval              likelihood_single 
                              TRUE                           TRUE 
                    read_alphabetr 
                              TRUE 
...
| Execution Time | 2025-02-14 06:49:41 UTC |
...
running this report
    ...
    PROCESSX_PS726d5881315f_1739515778
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPUfAo8
