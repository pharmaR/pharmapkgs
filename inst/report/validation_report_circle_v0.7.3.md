# Validation Report - circle@0.7.3
...
| export_help          | 20                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Patrick Schratz <patrick.schratz@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/ropensci/circle          |
...
Overall the package has 20 exported objects. 20 are documented:
    ...
    browse_circle_token              circle create_checkout_key delete_checkout_key 
                   TRUE                TRUE                TRUE                TRUE 
         delete_env_var  edit_circle_config         enable_repo get_build_artifacts 
                   TRUE                TRUE                TRUE                TRUE 
      get_checkout_keys     get_circle_user        get_env_vars            get_jobs 
                   TRUE                TRUE                TRUE                TRUE 
          get_pipelines       get_workflows    has_checkout_key       list_projects 
                   TRUE                TRUE                TRUE                TRUE 
              new_build      retry_workflow         set_env_var   use_circle_deploy 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:20:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33fa8ad8c_1739679642
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpE0MsRo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_circle_v0.7.3-tikzDictionary"
