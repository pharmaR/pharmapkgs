...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Jeffrey Durieux <durieux.jeffrey@gmail.com>          |
...
| 8   | magrittr  | Imports |
| 9   | neurobase | Imports |
| 10  | oro.nifti | Imports |
| 11  | servr     | Imports |
| 12  | htmltools | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
                   ...
                   CICA        computeRVmat        embed_papaya  FindRationalStarts 
                   TRUE                TRUE                TRUE                TRUE 
     get_papaya_version          loadNIfTIs             matcher              papaya 
                   TRUE                TRUE                TRUE                TRUE 
             papaya_div         pass_papaya     SequentialScree            Sim_CICA 
                   TRUE                TRUE                TRUE                TRUE 
            Sr_to_nifti update_papaya_build 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:17:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bc317ac0c12_1739679467
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplAdjrM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CICA_v1.1.1-tikzDictionary"
