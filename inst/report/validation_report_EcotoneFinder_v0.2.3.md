# Validation Report - EcotoneFinder@0.2.3
...
| export_help          | 29                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Antoine Bagnaro <antoine.bagnaro@wanadoo.fr>         |
...
Overall the package has 29 exported objects. 29 are documented:
                 ...
                 arrange.vars                   cbindna               clustergram 
                         TRUE                      TRUE                      TRUE 
           clustergram.cmeans    clustergram.cmeans.Ind        clustergram.kmeans 
                         TRUE                      TRUE                      TRUE 
    clustergram.plot.matlines      clustergram.vegclust  clustergram.vegclust.Ind 
                         TRUE                      TRUE                      TRUE 
               clustergramInd            CommunityColor               curveNoPlot 
                         TRUE                      TRUE                      TRUE 
                      DistEco             EcotoneFinder       EcotoneFinderSeries 
                         TRUE                      TRUE                      TRUE 
              ExtractCentroid FuzzyIndice.plot.matlines                 ggEcotone 
                         TRUE                      TRUE                      TRUE 
             NetworkCommunity                NetworkEco          NetworkEcoSeries 
                         TRUE                      TRUE                      TRUE 
                      plotEco               plotEcotone                   plotEnv 
                         TRUE                      TRUE                      TRUE 
                    plotSlope                   rbindna                     Slope 
                         TRUE                      TRUE                      TRUE 
                SyntheticData       SyntheticDataSeries 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-19 03:37:31 UTC |
...
running this report
    ...
    PROCESSX_PS1d45d421175_1739936246
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHu5fxh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EcotoneFinder_v0.2.3-tikzDictionary"
