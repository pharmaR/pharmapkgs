# Validation Report - BurStFin@1.3
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Pat Burns <patrick@burns-stat.com>                   |
...
Overall the package has 8 exported objects. 8 are documented:
               ...
               alpha.proxy      factor.model.stat        partial.rainbow 
                      TRUE                   TRUE                   TRUE 
               slideWeight              threeDarr      var.add.benchmark 
                      TRUE                   TRUE                   TRUE 
    var.relative.benchmark       var.shrink.eqcor 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:56:05 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7556825e_1739595360
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptrrXHb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BurStFin_v1.3-tikzDictionary"
