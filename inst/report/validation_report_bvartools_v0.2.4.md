# Validation Report - bvartools@0.2.4
...
| export_help          | 19                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Franz X. Mohr <franz.x.mohr@outlook.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/franzmohr/bvartools   |
...
Overall the package has 19 exported objects. 19 are documented:
                 ...
                 add_priors                    bvar                bvarpost 
                       TRUE                    TRUE                    TRUE 
                       bvec            bvec_to_bvar                bvecpost 
                       TRUE                    TRUE                    TRUE 
                        dfm                 dfmpost          draw_posterior 
                       TRUE                    TRUE                    TRUE 
                       fevd                 gen_dfm                 gen_var 
                       TRUE                    TRUE                    TRUE 
                    gen_vec         inclusion_prior                     irf 
                       TRUE                    TRUE                    TRUE 
            minnesota_prior post_normal_covar_const   post_normal_covar_tvp 
                       TRUE                    TRUE                    TRUE 
                 ssvs_prior 
                       TRUE 
...
| Execution Time | 2025-02-15 04:57:21 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd12a6c9a9_1739595436
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmprrgy6Y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bvartools_v0.2.4-tikzDictionary"
