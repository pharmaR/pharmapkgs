# Validation Report - coreCT@1.3.3
...
| export_help          | 11                                 |
| has_website          | TRUE                               |
| has_maintainer       | Troy D. Hill <Hill.Troy@gmail.com> |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/troyhill/coreCT |
...
Overall the package has 11 exported objects. 11 are documented:
           ...
           conv     convDir     convert  convertDir    coreHist    getRoots 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
    getRootsDir  getSurface    rootSize rootSizeDir     voxDims 
...
| Execution Time | 2025-02-17 03:56:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bd640fa88e3_1739764612
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJJL1Lw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coreCT_v1.3.3-tikzDictionary"
