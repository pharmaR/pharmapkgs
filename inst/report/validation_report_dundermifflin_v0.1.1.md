# Validation Report - dundermifflin@0.1.1
...
| export_help          | 28                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tyler Bradley <tcb85@drexel.edu>                     |
...
Overall the package has 28 exported objects. 28 are documented:
          ...
          accounting             andy           angela        corporate 
                TRUE             TRUE             TRUE             TRUE 
               creed customer_service           darryl           dwight 
                TRUE             TRUE             TRUE             TRUE 
                erin    filter_quotes        get_quote               hr 
                TRUE             TRUE             TRUE             TRUE 
                 jim            kelly            kevin       last_quote 
                TRUE             TRUE             TRUE             TRUE 
            meredith          michael            oscar              pam 
                TRUE             TRUE             TRUE             TRUE 
             phyllis     random_scene        reception             ryan 
                TRUE             TRUE             TRUE             TRUE 
               sales         she_said          stanley             toby 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 05:00:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bb473dadec_1739854810
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqWOtkD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dundermifflin_v0.1.1-tikzDictionary"
