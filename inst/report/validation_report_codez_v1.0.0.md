...
| export_help | 1 |
| has_website | TRUE |
| has_maintainer | Giancarlo Vercellino <giancarlo.vercellino@gmail.com> |
...
| 2   | abind (\>= 1.4-5)       | Imports |
| 3   | ggplot2 (\>= 3.3.6)     | Imports |
| 4   | readr (\>= 2.1.2)       | Imports |
| 5   | fANCOVA (\>= 0.6-1)     | Imports |
| 6   | imputeTS (\>= 3.2)      | Imports |
| 7   | modeest (\>= 2.4.0)     | Imports |
| 8   | scales (\>= 1.1.1)      | Imports |
| 9   | tictoc (\>= 1.0.1)      | Imports |
| 10  | tensorflow (\>= 2.9.0)  | Imports |
| 11  | keras (\>= 2.9.0)       | Imports |
| 12  | moments (\>= 0.14)      | Imports |
| 13  | narray (\>= 0.4.1.1)    | Imports |
| 14  | fastDummies (\>= 1.6.3) | Imports |
| 15  | entropy (\>= 1.3.1)     | Imports |
| 16  | philentropy (\>= 0.5.0) | Imports |
| 17  | greybox (\>= 1.0.1)     | Imports |
| 18  | lubridate (\>= 1.7.10)  | Imports |
...
| Execution Time | 2025-02-16 04:52:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bc376b5ad2b_1739681554
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuvyzB2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_codez_v1.0.0-tikzDictionary"
