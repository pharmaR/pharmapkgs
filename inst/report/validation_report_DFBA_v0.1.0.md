...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel H. Barch <daniel.barch@tufts.edu>             |
...
Overall the package has 14 exported objects. 14 are documented:
         ...
         dfba_bayes_vs_t_power     dfba_beta_bayes_factor 
                          TRUE                       TRUE 
            dfba_beta_contrast      dfba_beta_descriptive 
                          TRUE                       TRUE 
                 dfba_binomial dfba_bivariate_concordance 
                          TRUE                       TRUE 
                    dfba_gamma          dfba_mann_whitney 
                          TRUE                       TRUE 
                  dfba_mcnemar           dfba_median_test 
                          TRUE                       TRUE 
              dfba_power_curve             dfba_sign_test 
                          TRUE                       TRUE 
                 dfba_sim_data              dfba_wilcoxon 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-18 03:53:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4104ec0ac_1739850776
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeCBL9Q
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DFBA_v0.1.0-tikzDictionary"
