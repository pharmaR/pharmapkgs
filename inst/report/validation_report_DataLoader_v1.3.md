# Validation Report - DataLoader@1.3
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Srivenkatesh Gandhi <srivenkateshg@sase.ssn.edu.in>  |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    importAllMdf importAllSdf    importCsv   importCsv2  importExcel   importPipe 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       importTab  importTilde 
            TRUE         TRUE 
...
| Execution Time | 2025-02-17 04:58:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6d622ef1_1739768286
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9eG4HH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DataLoader_v1.3-tikzDictionary"
