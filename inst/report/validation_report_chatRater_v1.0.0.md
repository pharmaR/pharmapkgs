# Validation Report - chatRater@1.0.0
...
| export_help          | 2                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Shiyang Zheng <Shiyang.Zheng@nottingham.ac.uk>       |
...
Overall the package has 2 exported objects. 2 are documented:
            ...
            generate_ratings generate_ratings_for_all 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-18 03:28:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42978e1f7_1739849298
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7G506m
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chatRater_v1.0.0-tikzDictionary"
