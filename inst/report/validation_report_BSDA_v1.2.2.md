...
| export_help          | 11                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Alan T. Arnholt <arnholtat@appstate.edu> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/alanarnholt/BSDA      |
| has_bug_reports_url  | 1                                        |
| downloads_1yr        | 186156                                   |
...
BFF, bridger2, CGPfunctions, CIplot, DanielBiostatistics10th, IIS, NSM3,
SAP, statBasics, SVMDO

## Namespace

Overall the package has 11 exported objects. 11 are documented:

           CIsim Combinations          EDA     normarea        nsize      ntester 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       SIGN.test          SRS    tsum.test       z.test    zsum.test 
            TRUE         TRUE         TRUE         TRUE         TRUE 

### Examples

There are 330 help pages with examples, from 330 (100.00 %).
...
| Execution Time | 2025-02-15 04:48:23 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5bc581eb_1739594898
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqnWMAJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BSDA_v1.2.2-tikzDictionary"
