# Validation Report - bayesImageS@0.6.1
...
| export_help | 14 |
| has_website | TRUE |
| has_maintainer | Matt Moores <mmoores@gmail.com> |
| bugs_status | scraping bug reports fromm BugReports host ‘bitbucket’ not implemented |
| has_source_control | https://bitbucket.org/Azeari/bayesimages |
...
Overall the package has 14 exported objects. 14 are documented:
         ...
         exactPotts       getBlocks        getEdges    getNeighbors        gibbsGMM 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          gibbsNorm      gibbsPotts       initSedki       mcmcPotts mcmcPottsNoData 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           smcPotts  sufficientStat        swNoData    testResample 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 03:36:56 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1e15bf80_1739590612
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRBz1AZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesImageS_v0.6.1-tikzDictionary"
