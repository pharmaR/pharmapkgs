# Validation Report - detrendr@0.6.15
...
| export_help          | 25                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Rory Nolan <rorynoolan@gmail.com>            |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/rorynolan/detrendr#readme |
...
|     | package                     | type      |
|:----|:----------------------------|:----------|
| 1   | arrayhelpers (\>= 1.1.0)    | Imports   |
| 2   | autothresholdr (\>= 1.3.11) | Imports   |
| 3   | checkmate (\>= 1.9.3)       | Imports   |
| 4   | doParallel                  | Imports   |
| 5   | dplyr                       | Imports   |
| 6   | filesstrings (\>= 3.2.4)    | Imports   |
| 7   | foreach                     | Imports   |
| 8   | ijtiff (\>= 2.2)            | Imports   |
| 9   | iterators                   | Imports   |
...
| 15  | RcppParallel (\>= 5.1.7)    | Imports   |
| 16  | rlang (\>= 0.3.3)           | Imports   |
| 17  | stringr (\>= 1.4)           | Imports   |
| 18  | tools                       | Imports   |
| 19  | withr (\>= 2.1)             | Imports   |
| 20  | Rcpp (\>= 1.0.10)           | LinkingTo |
| 21  | RcppParallel (\>= 5.1.7)    | LinkingTo |
...
Overall the package has 25 exported objects. 25 are documented:
         ...
         apply_on_pillars           best_degree                best_l 
                     TRUE                  TRUE                  TRUE 
               best_swaps              best_tau    brightness_pillars 
                     TRUE                  TRUE                  TRUE 
            detrended_img    dir_detrend_boxcar       dir_detrend_exp 
                     TRUE                  TRUE                  TRUE 
      dir_detrend_polynom        dir_detrend_rh dir_detrend_robinhood 
                     TRUE                  TRUE                  TRUE 
       img_detrend_boxcar       img_detrend_exp   img_detrend_polynom 
                     TRUE                  TRUE                  TRUE 
           img_detrend_rh img_detrend_robinhood           mean_frames 
                     TRUE                  TRUE                  TRUE 
             mean_pillars        median_pillars            rfromboxes 
                     TRUE                  TRUE                  TRUE 
                 rtoboxes            sum_frames           sum_pillars 
                     TRUE                  TRUE                  TRUE 
              var_pillars 
                     TRUE 
...
| Execution Time | 2025-02-18 03:51:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4463946f8_1739850654
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6WcIIh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_detrendr_v0.6.15-tikzDictionary"
