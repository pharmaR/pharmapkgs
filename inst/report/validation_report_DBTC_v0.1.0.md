...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Robert G Young <rgyoung6@gmail.com>                  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | <https://github.com/rgyoung6/DBTC>                   |
...
Overall the package has 8 exported objects. 8 are documented:
     ...
     combine_assign_output    combine_dada_output combine_reduced_output 
                      TRUE                   TRUE                   TRUE 
            dada_implement          make_BLAST_DB            reduce_taxa 
                      TRUE                   TRUE                   TRUE 
                 seq_BLAST           taxon_assign 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-17 05:08:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63c1a7244_1739768900
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSafbsH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DBTC_v0.1.0-tikzDictionary"
