# Validation Report - bespatial@0.1.2
...
|     | package            | type      |
|:----|:-------------------|:----------|
| 1   | comat (\>= 0.9.2)  | LinkingTo |
| 2   | Rcpp               | LinkingTo |
| 3   | RcppArmadillo      | LinkingTo |
| 4   | belg               | Imports   |
| 5   | comat              | Imports   |
| 6   | Rcpp               | Imports   |
| 7   | terra (\>= 1.5-13) | Imports   |
| 8   | tibble             | Imports   |
| 9   | landscapemetrics   | Imports   |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    bes_g_cushman     bes_g_gao bes_m_cushman    bes_m_zhao bes_p_cushman 
...
| Execution Time | 2025-02-15 03:54:09 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd32d12117_1739591644
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoEKdqz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bespatial_v0.1.2-tikzDictionary"
