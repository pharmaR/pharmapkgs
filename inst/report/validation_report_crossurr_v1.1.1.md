# Validation Report - crossurr@1.1.1
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Denis Agniel <dagniel@rand.org>                      |
...
Overall the package has 3 exported objects. 3 are documented:
         ...
         sim_data  xf_surrogate xfr_surrogate 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 04:24:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6540a3c2_1739766290
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptgWjfw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crossurr_v1.1.1-tikzDictionary"
