# Validation Report - chicane@0.1.8
...
| export_help          | 29                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Syed Haider <Syed.Haider@icr.ac.uk>                  |
...
Overall the package has 29 exported objects. 29 are documented:
                  ...
                  add.covariates     add.fragment.coordinates 
                            TRUE                         TRUE 
              bedtools.installed    check.model.numerical.fit 
                            TRUE                         TRUE 
                         chicane           combine.replicates 
                            TRUE                         TRUE 
              compare.replicates     convert.hicup.digest.bed 
                            TRUE                         TRUE 
         convert.standard.format         convert.to.one.based 
                            TRUE                         TRUE 
               create.locus.plot         create.modelfit.plot 
                            TRUE                         TRUE 
                    distance.bin               distance.split 
                            TRUE                         TRUE 
                  fill.in.zeroes                fill.in.zeros 
                            TRUE                         TRUE 
                filter.fragments                    fit.model 
                            TRUE                         TRUE 
           get.combination.count               get.components 
                            TRUE                         TRUE 
                    get.distance            get.id.components 
                            TRUE                         TRUE 
              get.interaction.id             get.trans.counts 
                            TRUE                         TRUE 
        multiple.testing.correct                 prepare.data 
                            TRUE                         TRUE 
                        read.bed stratified.enrichment.sample 
                            TRUE                         TRUE 
                 test.enrichment 
                            TRUE 
...
| Execution Time | 2025-02-16 04:12:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3addadfc_1739679171
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFpF56G
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chicane_v0.1.8-tikzDictionary"
