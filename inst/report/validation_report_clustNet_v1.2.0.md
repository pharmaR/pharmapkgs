# Validation Report - clustNet@1.2.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Fritz Bayer <frbayer@ethz.ch>                        |
...
Overall the package has 8 exported objects. 8 are documented:
             ...
             bestAICsearch           density_plot     get_classification 
                      TRUE                   TRUE                   TRUE 
              get_clusters get_clusters_bernoulli          nice_DAG_plot 
                      TRUE                   TRUE                   TRUE 
             plot_clusters             sampleData 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:41:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bc374e2dd6_1739680863
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6P1X2j
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clustNet_v1.2.0-tikzDictionary"
