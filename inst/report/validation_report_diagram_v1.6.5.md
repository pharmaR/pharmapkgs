# Validation Report - diagram@1.6.5
...
augmentedRCBD, autonomics, bratteli, CARMS, cfda, communication,
CytoPipeline, datafsm, diffEnrich, dtpcrm, ecolMod, FME, genpathmox,
GMRP, heemod, irtawsi, LIM, LMest, lqmix, maat, markovchain, PGRdup,
plspm, primer, prodlim, QAEnsemble, Rramas, soilfoodwebs, StratigrapheR

## Namespace

Overall the package has 30 exported objects. 30 are documented:

         bentarrow    coordinates    curvedarrow   en.Amplifier en.Capacitator 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    en.Capacitator      en.Ground        en.Node    en.Resistor      en.Signal 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     en.Transistor     enResistor    openplotmat        plotmat        plotweb 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      segmentarrow      selfarrow      shadowbox     splitarrow  straightarrow 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       textdiamond    textellipse      textempty       texthexa      textmulti 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      textparallel      textplain       textrect      textround      treearrow 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 03:58:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4544736f4_1739851103
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6JPnJ2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diagram_v1.6.5-tikzDictionary"
