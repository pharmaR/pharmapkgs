# Validation Report - CohensdpLibrary@0.5.11
...
Overall the package has 20 exported objects. 20 are documented:
             ...
             Cohensdp           dkprime           dlprime          dlsecond 
                 TRUE              TRUE              TRUE              TRUE 
           dpilsecond           explain          Hedgesgp hypergeometric0F1 
                 TRUE              TRUE              TRUE              TRUE 
    hypergeometric1F1 hypergeometric2F1                 J           pkprime 
                 TRUE              TRUE              TRUE              TRUE 
              plprime          plsecond        ppilsecond           qkprime 
                 TRUE              TRUE              TRUE              TRUE 
              qlprime          qlsecond        qpilsecond         summarize 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:54:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32130a8f2_1739681665
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLZI4aZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CohensdpLibrary_v0.5.11-tikzDictionary"
