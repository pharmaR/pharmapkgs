# Validation Report - DeRezende.Ferreira@0.1.0
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Oleksandr Castello <alexander-castello@libero.it>    |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    DRF.5F.rates  DRF.5F.tFix  DRF.5F.tVar 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-18 03:45:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bb466d514c3_1739850315
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNqIuYB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DeRezende.Ferreira_v0.1.0-tikzDictionary"
