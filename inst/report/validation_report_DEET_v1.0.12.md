...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Dustin Sokolowski <dustin.sokolowski@sickkids.ca>    |
...
Overall the package has 9 exported objects. 9 are documented:
                ...
                adjust_DE_cutoffs            DEET_data_download 
                             TRUE                          TRUE 
                      DEET_enrich         DEET_enrich_genesonly 
                             TRUE                          TRUE 
             DEET_enrichment_plot          DEET_feature_extract 
                             TRUE                          TRUE 
          DEET_Input_as_Reference         DEET_plot_correlation 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-18 03:36:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bb468205a77_1739849767
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpc53Mcp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DEET_v1.0.12-tikzDictionary"
