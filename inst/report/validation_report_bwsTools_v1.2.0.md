# Validation Report - bwsTools@1.2.0
...
| export_help          | 8                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Mark White <markhwhiteii@gmail.com>      |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/markhwhiteii/bwsTools |
...
Overall the package has 8 exported objects. 8 are documented:
           ...
           ae_mnl   diffscoring e_bayescoring           elo    eloscoring 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        make_bibd     prscoring   walkscoring 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-15 04:58:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd16f963de_1739595512
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuWe0EN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bwsTools_v1.2.0-tikzDictionary"
