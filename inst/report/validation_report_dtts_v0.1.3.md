...
|:----|:-----------------------|:----------|
| 1   | nanotime               | Imports   |
| 2   | data.table (\>= 1.5.0) | Imports   |
| 3   | methods                | Imports   |
| 4   | bit64                  | Imports   |
| 5   | Rcpp (\>= 0.11.5)      | Imports   |
| 6   | RcppCCTZ (\>= 0.2.0)   | Imports   |
| 7   | Rcpp                   | LinkingTo |
| 8   | RcppCCTZ               | LinkingTo |
| 9   | RcppDate               | LinkingTo |
| 10  | nanotime               | LinkingTo |
...
| Execution Time | 2025-02-18 04:57:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44845de83_1739854672
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB5EDUr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dtts_v0.1.3-tikzDictionary"
