# Validation Report - comprehenr@0.6.10
...
| has_source_control   | https://github.com/gdemin/comprehenr |
...
BERT, flowTraceR, mpwR, Revticulate

## Namespace

Overall the package has 13 exported objects. 13 are documented:

         alter  enumerate    exclude   lag_list       mark   numerate      to_df 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
       to_list     to_vec     unmark unnumerate unzip_list  zip_lists 
...
| Execution Time | 2025-02-17 03:38:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd646b7b808_1739763481
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjOo9m2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comprehenr_v0.6.10-tikzDictionary"
