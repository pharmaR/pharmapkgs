# Validation Report - classInt@0.4.11
...
| export_help          | 9                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Roger Bivand <Roger.Bivand@nhh.no>     |
| bugs_status          | 1                                      |
| has_source_control   | https://github.com/r-spatial/classInt/ |
| has_bug_reports_url  | 1                                      |
| downloads_1yr        | 2943326                                |
...
BeeBDC, biscale, bivariatemaps, CAinterprTools, cartography, datamods,
deprivateR, dlookr, ecospat, eurostat, FAOSTAT, geocmeans,
GoodmanKruskal, GREENeR, hydroTSM, insurancerating, lidR, mapgl,
mapmisc, mapsf, mapStats, necountries, noisemodel, oceanis, pals,
piecenorms, questionr, ref.ICAR, rworldmap, segmetric, sf, shar,
spatialrisk, spBFA, spBPS, spCP, spdep, spNetwork, stars, synthpop,
tidyvpc, tmap, vpc, womblR

## Namespace

Overall the package has 9 exported objects. 9 are documented:

         classify_intervals          classIntervals  classIntervals2shingle 
                       TRUE                    TRUE                    TRUE 
                findColours                findCols getBclustClassIntervals 
                       TRUE                    TRUE                    TRUE 
    getHclustClassIntervals             jenks.tests             nPartitions 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-23 03:22:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d2575247885_1740280928
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpriPLxJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_classInt_v0.4.11-tikzDictionary"
