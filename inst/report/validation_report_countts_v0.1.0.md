# Validation Report - countts@0.1.0
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Tanujit Chakraborty <tanujitisi@gmail.com>           |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    apply_laplacePoisson       apply_linearTS       apply_normalNB 
                    TRUE                 TRUE                 TRUE 
              apply_ZINB            apply_ZIP       output_summary 
                    TRUE                 TRUE                 TRUE 
        update_algorithm 
                    TRUE 
...
| Execution Time | 2025-02-17 04:05:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bd645435012_1739765148
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbQqT7R
...
These are the options set to generate the report:
    ...
    [1] "validation_report_countts_v0.1.0-tikzDictionary"
