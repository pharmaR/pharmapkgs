# Validation Report - BayesianFactorZoo@0.0.0.3
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jiantao Huang <huangjt@hku.hk>                       |
...
Overall the package has 8 exported objects. 8 are documented:
              ...
              BayesianFM          BayesianSDF    continuous_ss_sdf 
                    TRUE                 TRUE                 TRUE 
    continuous_ss_sdf_v2  dirac_ss_sdf_pvalue       psi_to_priorSR 
                    TRUE                 TRUE                 TRUE 
                 SDF_gmm  Two_Pass_Regression 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 03:35:45 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd252b34b0_1739590540
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJojAd0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesianFactorZoo_v0.0.0.3-tikzDictionary"
