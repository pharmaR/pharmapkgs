# Validation Report - BlakerCI@1.0.6
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jan Klaschka <klaschka@cs.cas.cz>                    |
...
Overall the package has 12 exported objects. 12 are documented:
                  ...
                  binom.blaker.acc      binom.blaker.acc.single.p 
                              TRUE                           TRUE 
               binom.blaker.limits       binom.blaker.lower.limit 
                              TRUE                           TRUE 
            binom.blaker.VHadj.acc      binom.blaker.VHadj.limits 
                              TRUE                           TRUE 
    binom.blaker.VHadj.lower.limit             poisson.blaker.acc 
                              TRUE                           TRUE 
       poisson.blaker.acc.single.p          poisson.blaker.limits 
                              TRUE                           TRUE 
        poisson.blaker.lower.limit     poisson.blaker.upper.limit 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-22 03:17:43 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb60dc4e62_1740194259
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSjL7nO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BlakerCI_v1.0.6-tikzDictionary"
