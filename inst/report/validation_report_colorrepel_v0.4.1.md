# Validation Report - colorrepel@0.4.1
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Rui Fu <raysinensis@gmail.com>                       |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/raysinensis/color_repel           |
...
Overall the package has 8 exported objects. 8 are documented:
            ...
            average_clusters average_clusters_rowwise      by_cluster_sampling 
                        TRUE                     TRUE                     TRUE 
                 color_repel                 get_labs           gg_color_repel 
                        TRUE                     TRUE                     TRUE 
         ggplotly_background              label_repel 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-16 05:00:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bc371e25569_1739682024
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIbh2mv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colorrepel_v0.4.1-tikzDictionary"
