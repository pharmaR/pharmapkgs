...
| export_help          | 20                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Julian Taylor <julian.taylor@adelaide.edu.au> |
| bugs_status          | subscript out of bounds                       |
| size_codebase        | 1452                                          |
| has_source_control   | https://github.com/DrJ001/ASMap               |
...
Overall the package has 20 exported objects. 20 are documented:
           ...
           alignCross        breakCross        combineMap         fixClones 
                 TRUE              TRUE              TRUE              TRUE 
            genClones           heatMap        mergeCross            mstmap 
                 TRUE              TRUE              TRUE              TRUE 
         mstmap.cross mstmap.data.frame           pp.init        profileGen 
                 TRUE              TRUE              TRUE              TRUE 
          profileMark         pullCross         pushCross            pValue 
                 TRUE              TRUE              TRUE              TRUE 
             quickEst           statGen          statMark       subsetCross 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-14 07:27:29 UTC |
...
running this report
    ...
    PROCESSX_PS1c091d3b30b1_1739518046
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjnEoQy
