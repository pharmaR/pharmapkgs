# Validation Report - blockCV@3.1.5
...
| export_help          | 13                                  |
| has_website          | TRUE                                |
| has_maintainer       | Roozbeh Valavi <valavi.r@gmail.com> |
| bugs_status          | 0.8666667                           |
| has_source_control   | https://github.com/rvalavi/blockCV  |
...
BiodiversityR, confcons, ENMeval, forestecology, intSDM,
mlr3spatiotempcv, PointedSDMs, tidysdm

## Namespace

Overall the package has 13 exported objects. 13 are documented:

             buffering      cv_block_size          cv_buffer         cv_cluster 
                  TRUE               TRUE               TRUE               TRUE 
               cv_nndm            cv_plot      cv_similarity         cv_spatial 
                  TRUE               TRUE               TRUE               TRUE 
    cv_spatial_autocor           envBlock      rangeExplorer   spatialAutoRange 
                  TRUE               TRUE               TRUE               TRUE 
          spatialBlock 
                  TRUE 
...
| Execution Time | 2025-02-22 03:17:58 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb138e516_1740194274
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOcRV7f
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blockCV_v3.1.5-tikzDictionary"
