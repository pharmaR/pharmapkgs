...
| export_help          | 44                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Niek Stevenson <niek.stevenson@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/ampl-psych/EMC2        |
...
| 14  | Matrix      | Imports   |
| 15  | Rcpp        | Imports   |
| 16  | Brobdingnag | Imports   |
| 17  | corrplot    | Imports   |
| 18  | colorspace  | Imports   |
| 19  | psych       | Imports   |
| 20  | utils       | Imports   |
| 21  | lpSolve     | Imports   |
| 22  | WienR       | Imports   |
...
Overall the package has 44 exported objects. 44 are documented:
                   ...
                   chain_n                  check                compare 
                      TRUE                   TRUE                   TRUE 
           compare_subject            contr.anova            contr.bayes 
                      TRUE                   TRUE                   TRUE 
          contr.decreasing       contr.increasing               credible 
                      TRUE                   TRUE                   TRUE 
                       DDM                 design            ess_summary 
                      TRUE                   TRUE                   TRUE 
                       fit             gd_summary        get_BayesFactor 
                      TRUE                   TRUE                   TRUE 
                  get_data               get_pars             hypothesis 
                      TRUE                   TRUE                   TRUE 
               init_chains                    LBA                    LNR 
                      TRUE                   TRUE                   TRUE 
                 make_data               make_emc    make_random_effects 
                      TRUE                   TRUE                   TRUE 
                mapped_par           merge_chains        pairs_posterior 
                      TRUE                   TRUE                   TRUE 
                parameters plot_defective_density               plot_fit 
                      TRUE                   TRUE                   TRUE 
                 plot_pars             plot_prior         plot_relations 
                      TRUE                   TRUE                   TRUE 
             plot_sbc_ecdf          plot_sbc_hist      posterior_summary 
                      TRUE                   TRUE                   TRUE 
                     prior           profile_plot                    RDM 
                      TRUE                   TRUE                   TRUE 
                  recovery    run_bridge_sampling                run_emc 
                      TRUE                   TRUE                   TRUE 
                   run_sbc       sampled_p_vector 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-19 04:00:21 UTC |
...
running this report
    ...
    PROCESSX_PS1d452871b30b_1739937615
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT5TxAT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EMC2_v2.1.0-tikzDictionary"
