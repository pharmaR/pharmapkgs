# Validation Report - baskexact@1.0.1
...
| export_help          | 24                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Lukas Baumann <baumann@imbi.uni-heidelberg.de>       |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 2225                                                 |
| has_source_control   | https://github.com/lbau7/baskexact                   |
...
Overall the package has 24 exported objects. 24 are documented:
          ...
          adjust_lambda         basket_test   check_mon_between    check_mon_within 
                   TRUE                TRUE                TRUE                TRUE 
                    ecd                 ess               estim       get_scenarios 
                   TRUE                TRUE                TRUE                TRUE 
     globalweights_diff   globalweights_fix   interim_posterior    interim_postpred 
                   TRUE                TRUE                TRUE                TRUE 
             opt_design        plot_weights                 pow setupOneStageBasket 
                   TRUE                TRUE                TRUE                TRUE 
    setupTwoStageBasket                toer         weights_cpp    weights_fujikawa 
                   TRUE                TRUE                TRUE                TRUE 
            weights_jsd         weights_mml        weights_pool    weights_separate 
                   TRUE                TRUE                TRUE                TRUE 

### Examples

There are 24 help pages with examples, from 26 (92.31 %).
...
| Execution Time | 2025-02-14 07:45:15 UTC |
...
running this report
    ...
    PROCESSX_PS1c093ba64145_1739519112
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpq2pRcu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_baskexact_v1.0.1-tikzDictionary"
