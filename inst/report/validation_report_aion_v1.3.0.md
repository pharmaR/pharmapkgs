...
| size_codebase | 1285 |
| has_source_control | https://github.com/tesselle/aion |
...
Overall the package has 22 exported objects. 50 are documented:

                   AD               b2k                BC               BCE 
                 TRUE              TRUE              TRUE              TRUE 
                   BP                CE     fixed_from_AD    fixed_from_b2k 
                 TRUE              TRUE              TRUE              TRUE 
        fixed_from_BC    fixed_from_BCE     fixed_from_BP     fixed_from_CE 
                 TRUE              TRUE              TRUE              TRUE 
    fixed_from_julian       fixed_to_AD      fixed_to_b2k       fixed_to_BC 
                 TRUE              TRUE              TRUE              TRUE 
         fixed_to_BCE       fixed_to_BP       fixed_to_CE   fixed_to_julian 
                 TRUE              TRUE              TRUE              TRUE 
                    J         year_axis 
                 TRUE              TRUE 
...
There are 31 help pages with examples, from 37 (83.78 %).
...
| Execution Time | 2025-02-14 06:45:26 UTC |
...
running this report
    ...
    PROCESSX_PS726d621ca35_1739515523
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpflOHHd
