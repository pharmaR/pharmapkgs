# Validation Report - CircMLE@0.3.0
...
| export_help          | 18                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Robert Fitak <rfitak9@gmail.com>                     |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | circular (\>= 0.4-7) | Imports |
| 2   | stats                | Imports |
| 3   | energy (\>= 1.7-7)   | Imports |
...
Overall the package has 18 exported objects. 18 are documented:
       ...
       check_data    ci_circmle      circ_mle dcor.circular       HR_test 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          lr_test            M1           M2A           M2B           M2C 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              M3A           M3B           M4A           M4B           M5A 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              M5B  plot_circMLE    pycke_test 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-16 04:21:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34150b2ff_1739679675
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpsqcf5c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CircMLE_v0.3.0-tikzDictionary"
