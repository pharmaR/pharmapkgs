# Validation Report - ChainLadder@0.2.20
...
| export_help          | 57                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Markus Gesmann <markus.gesmann@googlemail.com> |
| bugs_status          | 0.7666667                                      |
| has_bug_reports_url  | 1                                              |
| downloads_1yr        | 46763                                          |
| reverse_dependencies | 3                                              |
| has_examples         | 0.9871795                                      |
| dependencies         | 13                                             |
| license              | GPL (\>= 2)                                    |
...
Overall the package has 35 exported objects. 31 are documented:

           as.LongTriangle            as.triangle                    ata 
                      TRUE                   TRUE                  FALSE 
           BootChainLadder            BS.paid.adj                    CDR 
                      TRUE                   TRUE                   TRUE 
               chainladder checkTriangleInflation           ClarkCapeCod 
                      TRUE                   TRUE                  FALSE 
                  ClarkLDF              CLFMdelta               cum2incr 
                      TRUE                  FALSE                   TRUE 
                 cyEffTest              dfCorTest    getLatestCumulative 
                      TRUE                   TRUE                   TRUE 
                glmReserve               incr2cum        inflateTriangle 
                      TRUE                   TRUE                   TRUE 
                 Join2Fits             JoinFitMse             LRfunction 
                      TRUE                   TRUE                  FALSE 
           MackChainLadder                    Mse       MultiChainLadder 
                      TRUE                   TRUE                   TRUE 
         MultiChainLadder2      MunichChainLadder      PaidIncurredChain 
                      TRUE                   TRUE                   TRUE 
            QuantileIFRS17               residCor               residCov 
                      TRUE                   TRUE                   TRUE 
                   Table64                Table65                Table68 
                     FALSE                  FALSE                  FALSE 
                  triangle         tweedieReserve 
                      TRUE                   TRUE 

### Examples

There are 77 help pages with examples, from 78 (98.72 %).
...
| Execution Time | 2025-02-16 04:07:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31edd973e_1739678821
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTaLrZs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ChainLadder_v0.2.20-tikzDictionary"
