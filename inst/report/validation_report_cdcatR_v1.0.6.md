# Validation Report - cdcatR@1.0.6
...
| export_help          | 6                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Miguel A. Sorrel <miguel.sorrel@uam.es> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/miguel-sorrel/cdcatR |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | cdmTools (\>= 1.0.1) | Imports |
| 2   | GDINA (\>= 2.2.0)    | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
         ...
         att.plot         cdcat cdcat.summary      gen.data  gen.itembank 
...
| Execution Time | 2025-02-16 03:55:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34d41513d_1739678147
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpupUhgk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cdcatR_v1.0.6-tikzDictionary"
