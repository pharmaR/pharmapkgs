# Validation Report - eodhdR2@0.5.1
...
| export_help | 11 |
| has_website | TRUE |
| has_maintainer | Marcelo S. Perlin <marceloperlin@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/EodHistoricalData/R-Library-for-financial-data-2024 |
...
Overall the package has 11 exported objects. 11 are documented:
      ...
      get_demo_token    get_dividends    get_exchanges get_fundamentals 
                TRUE             TRUE             TRUE             TRUE 
            get_ipos         get_news       get_prices       get_splits 
                TRUE             TRUE             TRUE             TRUE 
         get_tickers parse_financials        set_token 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 04:13:15 UTC |
...
running this report
    ...
    PROCESSX_PS1d451e401602_1739938389
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmhDMoY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eodhdR2_v0.5.1-tikzDictionary"
