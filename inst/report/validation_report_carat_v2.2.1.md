...
| export_help          | 27                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Xiaoqing Ye <ye_xiaoq@163.com>                       |
...
Overall the package has 27 exported objects. 27 are documented:
           ...
           AdjBCD    AdjBCD.sim     AdjBCD.ui     boot.test     compPower 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         compRand     corr.test       DoptBCD   DoptBCD.sim    DoptBCD.ui 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        evalPower      evalRand  evalRand.sim       getData       HuHuCAR 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      HuHuCAR.sim    HuHuCAR.ui     PocSimMIN PocSimMIN.sim  PocSimMIN.ui 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        rand.test        StrBCD    StrBCD.sim     StrBCD.ui        StrPBR 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       StrPBR.sim     StrPBR.ui 
             TRUE          TRUE 
...
| Execution Time | 2025-02-16 03:40:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bc341a3bf96_1739677207
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkcS7jZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_carat_v2.2.1-tikzDictionary"
