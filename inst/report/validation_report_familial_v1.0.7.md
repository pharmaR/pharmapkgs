# Validation Report - familial@1.0.7
...
| export_help          | 6                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Ryan Thompson <ryan.thompson-1@uts.edu.au> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/ryan-thompson/familial  |
...
Overall the package has 6 exported objects. 6 are documented:
         ...
         bayes.boot     center.test      fit.family     rudirichlet    weighted.mad 
...
| Execution Time | 2025-02-19 05:09:45 UTC |
...
running this report
    ...
    PROCESSX_PS1d456bcdbc1_1739941778
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDKinGb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_familial_v1.0.7-tikzDictionary"
