# Validation Report - condor@3.0.0
...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Arni Magnusson <thisisarni@gmail.com>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/PacificCommunity/ofp-sam-condor   |
...
Overall the package has 14 exported objects. 14 are documented:
          ...
          condor_dir  condor_download       condor_log         condor_q 
                TRUE             TRUE             TRUE             TRUE 
           condor_qq        condor_rm     condor_rmdir    condor_submit 
                TRUE             TRUE             TRUE             TRUE 
            dos2unix print.condor_log   print.condor_q  ssh_exec_stdout 
                TRUE             TRUE             TRUE             TRUE 
    summary.condor_q         unix2dos 
                TRUE             TRUE 
...
| Execution Time | 2025-02-17 03:41:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63da08970_1739763679
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQuIWCR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_condor_v3.0.0-tikzDictionary"
