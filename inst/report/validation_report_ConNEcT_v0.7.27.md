# Validation Report - ConNEcT@0.7.27
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Nadja Bodner <nadja.bodner@kuleuven.be>              |
...
Overall the package has 19 exported objects. 19 are documented:
           ...
           conData          conMx        conNEcT        conProf        conTest 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      funClassJacc    funCorrJacc       funKappa     funLogOdds        funOdds 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          funPhiCC   funPropAgree        getProb     lagthemats        modelAD 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           modelNO       permutAD       permutNO qgraph.conNEcT 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 03:45:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64bafb6e_1739763941
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprqjDHi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ConNEcT_v0.7.27-tikzDictionary"
