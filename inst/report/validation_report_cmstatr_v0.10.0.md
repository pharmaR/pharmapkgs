# Validation Report - cmstatr@0.10.0
...
| export_help          | 36                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Stefan Kloppenborg <stefan@kloppenborg.ca> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/cmstatr/cmstatr         |
...
Overall the package has 36 exported objects. 36 are documented:
                    ...
                    ad_ksample anderson_darling_lognormal 
                          TRUE                       TRUE 
       anderson_darling_normal   anderson_darling_weibull 
                          TRUE                       TRUE 
                       augment                basis_anova 
                          TRUE                       TRUE 
                  basis_hk_ext            basis_lognormal 
                          TRUE                       TRUE 
    basis_nonpara_large_sample               basis_normal 
                          TRUE                       TRUE 
               basis_pooled_cv            basis_pooled_sd 
                          TRUE                       TRUE 
                 basis_weibull               calc_cv_star 
                          TRUE                       TRUE 
             condition_summary                         cv 
                          TRUE                       TRUE 
             equiv_change_mean        equiv_mean_extremum 
                          TRUE                       TRUE 
      geom_jitter_failure_mode                     glance 
                          TRUE                       TRUE 
                      hk_ext_z             hk_ext_z_j_opt 
                          TRUE                       TRUE 
                       k_equiv            k_factor_normal 
                          TRUE                       TRUE 
                   levene_test    maximum_normed_residual 
                          TRUE                       TRUE 
              nested_data_plot      nonpara_binomial_rank 
                          TRUE                       TRUE 
          normalize_group_mean    normalize_ply_thickness 
                          TRUE                       TRUE 
        separate_failure_modes                   stat_esf 
                          TRUE                       TRUE 
         stat_normal_surv_func                       tidy 
                          TRUE                       TRUE 
              transform_mod_cv        transform_mod_cv_ad 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-16 04:46:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bc358edc14a_1739681181
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnPtPHA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmstatr_v0.10.0-tikzDictionary"
