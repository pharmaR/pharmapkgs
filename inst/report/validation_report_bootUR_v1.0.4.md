# Validation Report - bootUR@1.0.4
...
| export_help          | 13                                                  |
| has_website          | TRUE                                                |
| has_maintainer       | Stephan Smeekes <s.smeekes@maastrichtuniversity.nl> |
| bugs_status          | subscript out of bounds                             |
| has_source_control   | https://github.com/smeekes/bootUR                   |
...
| 2   | stats         | Imports   |
| 3   | urca          | Imports   |
| 4   | RcppParallel  | Imports   |
| 5   | parallelly    | Imports   |
| 6   | Rcpp          | LinkingTo |
| 7   | RcppArmadillo | LinkingTo |
| 8   | RcppParallel  | LinkingTo |
| 9   | RcppThread    | LinkingTo |
...
Overall the package has 13 exported objects. 13 are documented:
                         ...
                         boot_sqt                    boot_union 
                             TRUE                          TRUE 
                          boot_ur check_missing_insample_values 
                             TRUE                          TRUE 
                        diff_mult     find_nonmissing_subsample 
                             TRUE                          TRUE 
                order_integration           plot_missing_values 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-15 04:35:11 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1dde750e_1739594106
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbZiRE1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bootUR_v1.0.4-tikzDictionary"
