# Validation Report - eva3dm@0.99.1
...
| export_help          | 32                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Daniel Schuch <underschuch@gmail.com> |
...
Overall the package has 32 exported objects. 30 are documented:

              %at%           %IN%            atr           cate          daily 
             FALSE          FALSE           TRUE           TRUE           TRUE 
               eva extract_max_8h   extract_mean  extract_serie  get_distances 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            hourly         interp   legend_range           ma8h           mda8 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            ncdump        overlay      plot_diff      plot_rast           q2rh 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              rain rast_to_netcdf      read_stat           rh2q            sat 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              stat       template          uv2wd          uv2ws           vars 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          wrf_rast     write_stat 
              TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:37:29 UTC |
...
running this report
    ...
    PROCESSX_PS1d457543bef0_1739939843
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp53YmjO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eva3dm_v0.99.1-tikzDictionary"
