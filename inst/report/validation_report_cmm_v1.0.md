...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | L. A. van der Ark <L.A.vanderArk@uva.nl>             |
...
Overall the package has 11 exported objects. 11 are documented:
        ...
        ConstraintMatrix         DesignMatrix            DirectSum 
                    TRUE                 TRUE                 TRUE 
              JoinModels       MarginalMatrix     MarginalModelFit 
                    TRUE                 TRUE                 TRUE 
                 Margins      ModelStatistics RecordsToFrequencies 
                    TRUE                 TRUE                 TRUE 
        SampleStatistics   SpecifyCoefficient 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:44:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31e46b572_1739681083
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpU1PCB4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmm_v1.0-tikzDictionary"
