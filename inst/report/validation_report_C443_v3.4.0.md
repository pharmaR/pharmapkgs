...
| export_help          | 5                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Aniek Sies <aniek.sies@kuleuven.be>        |
| bugs_status          | 1                                          |
| has_source_control   | https://github.com/KULeuven-PPW-OKPIV/C443 |
...
Overall the package has 5 exported objects. 5 are documented:
       ...
       clusterforest         clusters      medoidtrees treesimilarities 
                TRUE             TRUE             TRUE             TRUE 
          treesource 
                TRUE 
...
| Execution Time | 2025-02-16 03:31:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3203aceed_1739676712
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpt6unw9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_C443_v3.4.0-tikzDictionary"
