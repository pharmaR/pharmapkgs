# Validation Report - fastml@0.4.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Selcuk Korkmaz <selcukorkmaz@gmail.com>              |
...
| 20  | plsmod       | Imports |
| 21  | probably     | Imports |
| 22  | viridisLite  | Imports |
| 23  | DALEX        | Imports |
| 24  | magrittr     | Imports |
| 25  | patchwork    | Imports |
| 26  | pROC         | Imports |
| 27  | janitor      | Imports |
| 28  | stringr      | Imports |
| 29  | DT           | Imports |
...
| 34  | dbscan       | Imports |
| 35  | ggpubr       | Imports |
| 36  | gridExtra    | Imports |
| 37  | htmlwidgets  | Imports |
| 38  | kableExtra   | Imports |
| 39  | moments      | Imports |
| 40  | naniar       | Imports |
| 41  | plotly       | Imports |
| 42  | scales       | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    evaluate_models     fastexplain     fastexplore          fastml      load_model 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           sanitize      save_model    train_models 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 05:19:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d4556d88505_1739942358
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUnefKR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastml_v0.4.0-tikzDictionary"
