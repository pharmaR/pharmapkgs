...
| export_help          | 25                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Teemu Daniel Laajala <teelaa@utu.fi>                 |
...
Overall the package has 22 exported objects. 22 are documented:
    ...
    bootstrapRegCoefs      conforminput                cv          cv.alpha 
                 TRUE              TRUE              TRUE              TRUE 
              cv.grid            heatcv integrateRegCurve      interact.all 
                 TRUE              TRUE              TRUE              TRUE 
        interact.part          meanrank       NelsonAalen      normriskrank 
                 TRUE              TRUE              TRUE              TRUE 
                 plot           PSP.BOX           PSP.CSP            PSP.KM 
                 TRUE              TRUE              TRUE              TRUE 
               PSP.NA           PSP.PCA      score.cindex        score.iAUC 
                 TRUE              TRUE              TRUE              TRUE 
         TimeSurvProb                zt 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-19 04:14:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d453d2ed4c0_1739938444
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAfye5x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ePCR_v0.11.0-tikzDictionary"
