# Validation Report - beaver@1.0.0
...
| export_help          | 15                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Hollins Showalter <hollins.showalter@gmail.com>      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/rich-payne/beaver                 |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | checkmate (\>= 2.1) | Imports |
| 2   | dplyr (\>= 1.0)     | Imports |
| 3   | ellipsis (\>= 0.3)  | Imports |
| 4   | fs (\>= 1.5)        | Imports |
| 5   | ggplot2 (\>= 3.3)   | Imports |
| 6   | purrr (\>= 0.3)     | Imports |
| 7   | rjags (\>= 4.12)    | Imports |
| 8   | rlang (\>= 1.0)     | Imports |
| 9   | stringr (\>= 1.5)   | Imports |
| 10  | tibble (\>= 3.1)    | Imports |
| 11  | tidyr (\>= 1.1)     | Imports |
| 12  | yodel (\>= 1.0)     | Imports |
...
Overall the package has 15 exported objects. 15 are documented:
                  ...
                  beaver_mcmc          data_negbin_emax                     draws 
                         TRUE                      TRUE                      TRUE 
            model_negbin_emax          model_negbin_exp        model_negbin_indep 
                         TRUE                      TRUE                      TRUE 
          model_negbin_linear    model_negbin_loglinear      model_negbin_logquad 
                         TRUE                      TRUE                      TRUE 
            model_negbin_quad model_negbin_sigmoid_emax                 posterior 
                         TRUE                      TRUE                      TRUE 
             posterior_g_comp                    pr_eoi             pr_eoi_g_comp 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-15 03:50:45 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3168d310_1739591441
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwVNgfm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beaver_v1.0.0-tikzDictionary"
