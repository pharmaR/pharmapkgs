...
ensemblepp, exdqlm, insight, marginaleffects, MortalityGaps, NetSimR,
scoringRules
...
Overall the package has 40 exported objects. 40 are documented:
      ...
      CensoredLogistic     CensoredNormal  CensoredStudentsT               crch 
                  TRUE               TRUE               TRUE               TRUE 
            crch.boost     crch.boost.fit       crch.control           crch.fit 
                  TRUE               TRUE               TRUE               TRUE 
          crch.stabsel            dclogis             dcnorm                dct 
                  TRUE               TRUE               TRUE               TRUE 
               dtlogis             dtnorm                dtt    getSummary.crch 
                  TRUE               TRUE               TRUE               TRUE 
                  hxlr       hxlr.control            pclogis             pcnorm 
                  TRUE               TRUE               TRUE               TRUE 
                   pct            ptlogis             ptnorm                ptt 
                  TRUE               TRUE               TRUE               TRUE 
               qclogis             qcnorm                qct            qtlogis 
                  TRUE               TRUE               TRUE               TRUE 
                qtnorm                qtt            rclogis             rcnorm 
                  TRUE               TRUE               TRUE               TRUE 
                   rct            rtlogis             rtnorm                rtt 
                  TRUE               TRUE               TRUE               TRUE 
                  trch  TruncatedLogistic    TruncatedNormal TruncatedStudentsT 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-24 03:22:56 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a14299ae6_1740367372
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpE53Ulk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crch_v1.2.1-tikzDictionary"
