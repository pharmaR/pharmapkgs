# Validation Report - carpenter@0.2.2
...
| export_help          | 12                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Luke Johnston <lwjohnst@gmail.com>      |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/lwjohnst86/carpenter |
...
Overall the package has 12 exported objects. 11 are documented:
               ...
               %>%       add_rows    build_table  outline_table       renaming 
             FALSE           TRUE           TRUE           TRUE           TRUE 
          stat_iqr      stat_mean    stat_meanSD    stat_median stat_medianIQR 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         stat_nPct    stat_stddev 
              TRUE           TRUE 
...
| Execution Time | 2025-02-16 03:43:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35d2ff1c8_1739677388
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyYAWvk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_carpenter_v0.2.2-tikzDictionary"
