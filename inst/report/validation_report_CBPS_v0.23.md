...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Christian Fong <cjfong@umich.edu>                    |
...
causal.decomp, causalOT, CERFIT, cobalt, MatchIt, mvGPS, PanelMatch,
WeightIt
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          AsyVar      balance         CBIV        CBMSM         CBPS     CBPS.fit 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
          hdCBPS       npCBPS vcov_outcome 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 03:52:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bc311490369_1739677919
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFgqqk4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CBPS_v0.23-tikzDictionary"
