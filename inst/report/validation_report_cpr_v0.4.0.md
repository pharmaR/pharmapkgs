...
| export_help          | 29                                |
| has_website          | TRUE                              |
| has_maintainer       | Peter DeWitt <dewittpe@gmail.com> |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/dewittpe/cpr/  |
...
| 2   | lme4 (\>= 1.1.35.1) | Imports   |
| 3   | plot3D              | Imports   |
| 4   | Rcpp (\>= 1.0.11)   | Imports   |
| 5   | rgl                 | Imports   |
| 6   | scales              | Imports   |
| 7   | Rcpp                | LinkingTo |
...
Overall the package has 29 exported objects. 29 are documented:
               ...
               bsplineD            bsplines             btensor        build_tensor 
                   TRUE                TRUE                TRUE                TRUE 
                     cn                 cnr    coarsen_ordinate                  cp 
                   TRUE                TRUE                TRUE                TRUE 
                cp_diff            cp_value                 cpr   d_order_statistic 
                   TRUE                TRUE                TRUE                TRUE 
             get_spline         get_surface        hat_ordinate        influence_of 
                   TRUE                TRUE                TRUE                TRUE 
    influence_of_iknots   influence_weights       insert_a_knot    insertion_matrix 
                   TRUE                TRUE                TRUE                TRUE 
            matrix_rank   p_order_statistic     refine_ordinate        sign_changes 
                   TRUE                TRUE                TRUE                TRUE 
       trimmed_quantile     update_bsplines      update_btensor        wiegh_iknots 
                   TRUE                TRUE                TRUE                TRUE 
                 wiggle 
                   TRUE 
...
| Execution Time | 2025-02-17 04:15:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bd618d66f8_1739765725
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeOIoIS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cpr_v0.4.0-tikzDictionary"
