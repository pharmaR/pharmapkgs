# Validation Report - batata@0.2.1
...
| export_help | 14 |
| has_website | TRUE |
| has_maintainer | Mohamed El Fodil Ihaddaden <ihaddaden.fodeil@gmail.com> |
| bugs_status | 0.3333333 |
| has_source_control | https://github.com/feddelegrand7/batata |
...
Overall the package has 14 exported objects. 14 are documented:
      ...
      display_most_starred        display_starred            fresh_start 
                      TRUE                   TRUE                   TRUE 
      install_most_starred   install_starred_cran install_starred_github 
                      TRUE                   TRUE                   TRUE 
           latest_packages     rm_latest_packages      rm_since_packages 
                      TRUE                   TRUE                   TRUE 
         rm_today_packages  rm_yesterday_packages         since_packages 
                      TRUE                   TRUE                   TRUE 
            today_packages     yesterday_packages 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-15 03:29:32 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd192c7110_1739590168
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpP0dKcL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_batata_v0.2.1-tikzDictionary"
