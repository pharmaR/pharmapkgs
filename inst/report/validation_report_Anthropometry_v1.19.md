...
Overall the package has 40 exported objects. 40 are documented:
                   ...
                   anthrCases        archetypesBoundary              archetypoids 
                         TRUE                      TRUE                      TRUE 
                 array3Dlandm         bustSizesStandard         CCbiclustAnthropo 
                         TRUE                      TRUE                      TRUE 
       cdfDissWomenPrototypes       checkBranchLocalIMO        checkBranchLocalMO 
                         TRUE                      TRUE                      TRUE 
    computSizesHipamAnthropom        computSizesTrimowa             figures8landm 
                         TRUE                      TRUE                      TRUE 
             getBestPamsamIMO           getBestPamsamMO             getDistMatrix 
                         TRUE                      TRUE                      TRUE 
               HartiganShapes            hipamAnthropom               LloydShapes 
                         TRUE                      TRUE                      TRUE 
          nearestToArchetypes               optraShapes   overlapBiclustersByRows 
                         TRUE                      TRUE                      TRUE 
        percentilsArchetypoid            plotPrototypes    plotTreeHipamAnthropom 
                         TRUE                      TRUE                      TRUE 
                plotTrimmOutl             preprocessing                projShapes 
                         TRUE                      TRUE                      TRUE 
                  qtranShapes           screeArchetypal            shapes3dShapes 
                         TRUE                      TRUE                      TRUE 
          skeletonsArchetypal     stepArchetypesRawData          stepArchetypoids 
                         TRUE                      TRUE                      TRUE 
                     TDDclust        trimmedLloydShapes                trimmedoid 
                         TRUE                      TRUE                      TRUE 
                    trimmOutl                   trimowa          weightsMixtureUB 
                         TRUE                      TRUE                      TRUE 
           xyplotPCArchetypes 
                         TRUE 
...
There are 48 help pages with examples, from 52 (92.31 %).
...
| Execution Time | 2025-02-14 06:57:04 UTC |
...
running this report
    ...
    PROCESSX_PS726d2333c71e_1739516221
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgJWxok
