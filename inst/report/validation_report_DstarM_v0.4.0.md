# Validation Report - DstarM@0.4.0
...
| export_help          | 24                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Don van den Bergh <donvdbergh@hotmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/vandenman/DstarM        |
...
Overall the package has 24 exported objects. 24 are documented:
      ...
      battacharyya          chisq       chisqFit        Density         estCdf 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         estDstarM          estND    estObserved         estQdf        getPdfs 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           getSter         getTer      hellinger    LBA.density      normalize 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      obsQuantiles   plotObserved rtDescriptives         rtHist        simData 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           testFun  upgradeDstarM   Voss.density Wiener.density 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:53:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44cc221b4_1739854397
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpfe9FCI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DstarM_v0.4.0-tikzDictionary"
