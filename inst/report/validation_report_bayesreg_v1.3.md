# Validation Report - bayesreg@1.3
...
| export_help          | 1                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel F. Schmidt <daniel.schmidt@monash.edu>        |
...
|:----|:------------------------|:--------|
| 1   | stats (\>= 3.0)         | Imports |
| 2   | pgdraw (\>= 1.0)        | Depends |
| 3   | doParallel (\>= 1.0.16) | Depends |
...
| Execution Time | 2025-02-15 03:40:12 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6a7c1fea_1739590807
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZma5qJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesreg_v1.3-tikzDictionary"
