# Validation Report - bayesCT@0.99.3
...
| export_help          | 29                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Thevaa Chandereng <chandereng@wisc.edu>      |
| bugs_status          | 0.7                                          |
| has_source_control   | https://github.com/thevaachandereng/bayesCT/ |
...
Overall the package has 29 exported objects. 28 are documented:
                    ...
                    %>%            analysis          beta_prior   binomial_analysis 
                  FALSE                TRUE                TRUE                TRUE 
       binomial_outcome        binomialBACT       data_binomial         data_normal 
                   TRUE                TRUE                TRUE                TRUE 
          data_survival          enrollment     enrollment_rate         gamma_prior 
                   TRUE                TRUE                TRUE                TRUE 
    historical_binomial   historical_normal historical_survival          hypothesis 
                   TRUE                TRUE                TRUE                TRUE 
                 impute     normal_analysis      normal_outcome          normalBACT 
                   TRUE                TRUE                TRUE                TRUE 
          pw_exp_impute          pw_exp_sim       randomization           randomize 
                   TRUE                TRUE                TRUE                TRUE 
               simulate       study_details   survival_analysis    survival_outcome 
                   TRUE                TRUE                TRUE                TRUE 
           survivalBACT 
                   TRUE 
...
| Execution Time | 2025-02-15 03:33:01 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd59186e71_1739590376
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKgiOKb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesCT_v0.99.3-tikzDictionary"
