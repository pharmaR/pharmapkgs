# Validation Report - epiomics@1.2.0
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    coef_plot_from_owas      meet_in_middle                owas         owas_clogit 
                   TRUE                TRUE                TRUE                TRUE 
            owas_qgcomp        volcano_owas 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:18:13 UTC |
...
running this report
    ...
    PROCESSX_PS1d4520875438_1739938687
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuZoIUX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epiomics_v1.2.0-tikzDictionary"
