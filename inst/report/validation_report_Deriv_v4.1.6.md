...
| export_help          | 7                                      |
| has_website          | FALSE                                  |
| has_maintainer       | Serguei Sokol <sokol@insa-toulouse.fr> |
| bugs_status          | subscript out of bounds                |
| has_bug_reports_url  | 1                                      |
| downloads_1yr        | 2090984                                |
...
apollo, cccrm, ctsem, curesurv, doBy, docopulae, fitode, gpuMagic,
iccCounts, interp, irtpwr, mirt, mosaicCalc, neuralnet, nlsr, nlstac,
OEFPIL, ordinalCont, PFIM, regmedint, resde, RGCCA, rsq, seeds,
Sim.DiffProc, stokes, THREC, xgxr

## Namespace

Overall the package has 7 exported objects. 7 are documented:

              Cache         deCache           Deriv           drule         format1 
...
| Execution Time | 2025-02-18 03:45:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45966ae2a_1739850321
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpo7p3x0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Deriv_v4.1.6-tikzDictionary"
