# Validation Report - causaleffect@1.3.15
...
| has_source_control   | https://github.com/santikka/causaleffect/            |
...
Overall the package has 10 exported objects. 9 are documented:
           ...
           aux.effect     causal.effect        generalize    get.expression 
                 TRUE              TRUE              TRUE              TRUE 
       meta.transport     parse.graphml           recover surrogate.outcome 
                 TRUE              TRUE              TRUE              TRUE 
            transport verma.constraints 
                 TRUE             FALSE 
...
| Execution Time | 2025-02-16 03:49:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bc319eeef96_1739677752
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZhDKId
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causaleffect_v1.3.15-tikzDictionary"
