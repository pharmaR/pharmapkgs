# Validation Report - dotwhisker@0.8.3
...
| export_help          | 7                              |
| has_website          | TRUE                           |
| has_maintainer       | Yue Hu <yuehu@tsinghua.edu.cn> |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | ggplot2 (\>= 2.2.1) | Depends |
| 2   | grid                | Imports |
| 3   | gtable              | Imports |
| 4   | gridExtra           | Imports |
| 5   | stats               | Imports |
| 6   | parameters          | Imports |
| 7   | performance         | Imports |
| 8   | patchwork           | Imports |
| 9   | dplyr               | Imports |
| 10  | stringr             | Imports |
| 11  | ggstance            | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
          ...
          add_brackets             by_2sd             dwplot relabel_predictors 
                  TRUE               TRUE               TRUE               TRUE 
        relabel_y_axis      secret_weapon     small_multiple 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 04:37:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bb473e3b5f3_1739853435
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmputKPO9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dotwhisker_v0.8.3-tikzDictionary"
