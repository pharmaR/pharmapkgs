# Validation Report - cleanNLP@3.1.0
...
| export_help          | 8                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Taylor B. Arnold <tarnold2@richmond.edu> |
...
Overall the package has 8 exported objects. 8 are documented:
          ...
          cnlp_annotate cnlp_download_spacy     cnlp_init_spacy   cnlp_init_stringi 
                   TRUE                TRUE                TRUE                TRUE 
       cnlp_init_udpipe      cnlp_utils_pca       cnlp_utils_tf    cnlp_utils_tfidf 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:28:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3332a32d6_1739680112
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsnHR3X
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cleanNLP_v3.1.0-tikzDictionary"
