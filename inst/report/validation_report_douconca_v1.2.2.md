# Validation Report - douconca@1.2.2
...
| export_help          | 9                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Bart-Jan van Rossum <bart-jan.vanrossum@wur.nl> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/Biometris/douconca           |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | ggplot2 (\>= 3.5.1) | Imports |
| 2   | ggrepel             | Imports |
| 3   | gridExtra           | Imports |
| 4   | permute             | Imports |
| 5   | rlang               | Imports |
| 6   | stats               | Imports |
| 7   | vegan (\>= 2.6-8)   | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
               ...
               anova_sites          anova_species                  dc_CA 
                      TRUE                   TRUE                   TRUE 
                  fCWM_SNC            getPlotdata      plot_dcCA_CWM_SNC 
                      TRUE                   TRUE                   TRUE 
    plot_species_scores_bk                 scores                   wrda 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:38:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47340bf79_1739853488
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpL3iQ9o
...
These are the options set to generate the report:
    ...
    [1] "validation_report_douconca_v1.2.2-tikzDictionary"
