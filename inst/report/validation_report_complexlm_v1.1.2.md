# Validation Report - complexlm@1.1.2
...
| export_help          | 24                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | William Ryan <wryan1@binghamton.edu>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/QuantumOfMoose/complexlm          |
...
Overall the package has 24 exported objects. 24 are documented:
    ...
    .vcov.aliased.complex             anova.zlm          complexdqlrs 
                     TRUE                  TRUE                  TRUE 
                      cor                   cov                    lm 
                     TRUE                  TRUE                  TRUE 
                   lm.fit               lm.wfit                   mad 
                     TRUE                  TRUE                  TRUE 
              mahalanobis           matrixweave        median.complex 
                     TRUE                  TRUE                  TRUE 
             psi.bisquare            psi.hampel             psi.huber 
                     TRUE                  TRUE                  TRUE 
                    range                   rlm           summary.zlm 
                     TRUE                  TRUE                  TRUE 
                      var              vcov.zlm               wmedian 
                     TRUE                  TRUE                  TRUE 
               zhatvalues              zlm.wfit         zmodel.matrix 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-17 03:36:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bd68081c9e_1739763371
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1j67lX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_complexlm_v1.1.2-tikzDictionary"
