# Validation Report - chlorpromazineR@0.2.0
...
| has_source_control   | https://github.com/ropensci/chlorpromazineR |
...
Overall the package has 6 exported objects. 6 are documented:
      ...
      add_key  check_ap check_key     to_ap    to_cpz  trim_key 
...
| Execution Time | 2025-02-16 04:14:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34353309d_1739679260
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXlwLVy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chlorpromazineR_v0.2.0-tikzDictionary"
