# Validation Report - bayesvl@0.8.5
...
| export_help          | 48                                  |
| has_website          | TRUE                                |
| has_maintainer       | Viet-Phuong La <lvphuong@gmail.com> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/sshpa/bayesvl    |
...
| 6   | reshape2                 | Imports |
| 7   | dplyr                    | Imports |
| 8   | rstan (\>= 2.10.0)       | Depends |
| 9   | StanHeaders (\>= 2.18.0) | Depends |
| 10  | stats                    | Depends |
| 11  | graphics                 | Depends |
| 12  | methods                  | Depends |
...
Overall the package has 48 exported objects. 24 are documented:

              bayesvl           bayesvl           bayesvl           bayesvl 
              ...
              bayesvl           bayesvl           bayesvl           bayesvl 
                FALSE             FALSE             FALSE             FALSE 
           bvl_addArc       bvl_addNode    bvl_bnBarchart       bvl_bnBayes 
                 TRUE              TRUE              TRUE              TRUE 
           bvl_bnPlot       bvl_bnScore    bvl_bnStrength       bvl_formula 
                 TRUE              TRUE              TRUE              TRUE 
       bvl_model2Stan      bvl_modelFit      bvl_plotAcfs     bvl_plotAreas 
                 TRUE              TRUE              TRUE              TRUE 
      bvl_plotDensity bvl_plotDensity2d      bvl_plotDiag    bvl_plotGelman 
                 TRUE              TRUE              TRUE              TRUE 
      bvl_plotGelmans bvl_plotIntervals     bvl_plotPairs    bvl_plotParams 
                 TRUE              TRUE              TRUE              TRUE 
         bvl_plotTest     bvl_plotTrace    bvl_stanParams    bvl_stanPriors 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 03:42:21 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1c147422_1739590936
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFl26eI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesvl_v0.8.5-tikzDictionary"
