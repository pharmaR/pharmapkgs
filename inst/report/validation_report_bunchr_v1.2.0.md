# Validation Report - bunchr@1.2.0
...
| export_help          | 9                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Itai Trilnick <itai.trilnick@berkeley.edu> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | http://github.com/trilnick/bunchr          |
...
Overall the package has 9 exported objects. 9 are documented:
              ...
              bunch    bunch_viewer        bunchApp     earning_fun  elas_equalizer 
               TRUE            TRUE            TRUE            TRUE            TRUE 
     kink_estimator notch_estimator       util_calc  util_equalizer 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:55:13 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7395495f_1739595308
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpy6KLSI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bunchr_v1.2.0-tikzDictionary"
