# Validation Report - dafishr@1.0.1
...
| export_help          | 8                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Fabio Favoretto <fabio@gocmarineprogram.org> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/CBMC-GCMP/dafishr         |
...
Overall the package has 8 exported objects. 7 are documented:
                     ...
                     %>%    clean_land_points        join_mpa_data 
                   FALSE                 TRUE                 TRUE 
    join_ports_locations            model_vms    preprocessing_vms 
                    TRUE                 TRUE                 TRUE 
               vms_clean         vms_download 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-17 04:50:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6607d4019_1739767834
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpg6JfAe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dafishr_v1.0.1-tikzDictionary"
