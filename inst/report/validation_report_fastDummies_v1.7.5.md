# Validation Report - fastDummies@1.7.5
...
| has_source_control   | https://github.com/jacobkap/fastDummies |
| has_bug_reports_url  | 1                                       |
| downloads_1yr        | 575303                                  |
...
bigDM, bnpa, causalweight, cbcTools, ClusterVAR, CMMs, codez, conText,
countts, dagitty, deepdive, DMCFB, drf, framecleaner, fusedMGM,
GenMarkov, getspanel, gscaLCA, jenga, logitr, manydist, MplusAutomation,
multifear, naive, NeuralSens, nlive, psyntur, RCTrep, ResIN, reslr,
ReSurv, RobinCar, scpi, segen, Seurat, smdi, spinner, spooky,
TangledFeatures, tetragon, tidycomm, tidyvpc, TSCI

## Namespace

Overall the package has 3 exported objects. 3 are documented:

       dummy_cols dummy_columns    dummy_rows 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 05:15:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d4560fd41e2_1739942147
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpl58lSD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastDummies_v1.7.5-tikzDictionary"
