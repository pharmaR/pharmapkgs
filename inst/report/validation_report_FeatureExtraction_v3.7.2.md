# Validation Report - FeatureExtraction@3.7.2
...
| bugs_status          | 0.7                                        |
| has_source_control   | https://github.com/OHDSI/FeatureExtraction |
...
|     | package                       | type    |
|:----|:------------------------------|:--------|
| 1   | DatabaseConnector (\>= 3.0.0) | Depends |
| 2   | Andromeda                     | Depends |
| 3   | methods                       | Imports |
| 4   | dplyr                         | Imports |
| 5   | rJava                         | Imports |
| 6   | jsonlite                      | Imports |
| 7   | SqlRender (\>= 1.18.0)        | Imports |
| 8   | ParallelLogger (\>= 2.0.2)    | Imports |
| 9   | cli                           | Imports |
| 10  | pillar                        | Imports |
| 11  | readr                         | Imports |
| 12  | rlang                         | Imports |
...
| Execution Time | 2025-02-27 03:24:46 UTC |
...
running this report
    ...
    PROCESSX_PS1c6210147b65_1740626682
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxW8Knn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FeatureExtraction_v3.7.2-tikzDictionary"
