# Validation Report - CTRing@0.1.0
...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Robert Schneider <robert_schneider@uqar.ca>          |
...
Overall the package has 22 exported objects. 22 are documented:
         ...
         addRingFromImage    addRingFromProfile              addYears 
                     TRUE                  TRUE                  TRUE 
              calcAvgDens          checkProfile   deleteRingFromImage 
                     TRUE                  TRUE                  TRUE 
    deleteRingFromProfile      densityDataFrame           detect_pith 
                     TRUE                  TRUE                  TRUE 
           extractProfile               getEwLw          getImageInfo 
                     TRUE                  TRUE                  TRUE 
            grayToDensity         imageToMatrix         locatePathEnd 
                     TRUE                  TRUE                  TRUE 
          pithCoordinates      plotImageProfile           plotProfile 
                     TRUE                  TRUE                  TRUE 
               relToPixel        removeLastYear            verifyPith 
                     TRUE                  TRUE                  TRUE 
               xBitTo8Bit 
                     TRUE 
...
| Execution Time | 2025-02-17 04:35:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bd653cac7b8_1739766927
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLRMeOT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CTRing_v0.1.0-tikzDictionary"
