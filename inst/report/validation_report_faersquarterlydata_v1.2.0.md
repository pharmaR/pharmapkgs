# Validation Report - faersquarterlydata@1.2.0
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Luis Garcez <luisgarcez1@gmail.com>                  |
...
Overall the package has 15 exported objects. 15 are documented:
             ...
             arrange_date        estimate_chisq        estimate_infoc 
                     TRUE                  TRUE                  TRUE 
             estimate_prr          estimate_ror  estimate_ror_bygroup 
                     TRUE                  TRUE                  TRUE 
            faersxml_to_r get_duplicate_caseids   retrieve_faersascii 
                     TRUE                  TRUE                  TRUE 
        retrieve_faersxml retrieve_faersxml_all  retrieve_unique_info 
                     TRUE                  TRUE                  TRUE 
        summary_faersdata   unify_tabular_ascii        unzip_faerszip 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-19 05:07:20 UTC |
...
running this report
    ...
    PROCESSX_PS1d455511ebfa_1739941634
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkPOMLH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_faersquarterlydata_v1.2.0-tikzDictionary"
