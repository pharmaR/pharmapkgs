...
| export_help          | 24                                       |
| has_website          | FALSE                                    |
| has_maintainer       | Julien Lanthier <julien.lanthier@hec.ca> |
...
Overall the package has 24 exported objects. 24 are documented:
                        ...
                        BixiData                BKTRRegressor 
                            TRUE                         TRUE 
                  CompositionOps                       Kernel 
                            TRUE                         TRUE 
               KernelAddComposed               KernelComposed 
                            TRUE                         TRUE 
                    KernelMatern            KernelMulComposed 
                            TRUE                         TRUE 
                 KernelParameter               KernelPeriodic 
                            TRUE                         TRUE 
                        KernelRQ                     KernelSE 
                            TRUE                         TRUE 
                KernelWhiteNoise              plot_beta_dists 
                            TRUE                         TRUE 
      plot_covariates_beta_dists       plot_hyperparams_dists 
                            TRUE                         TRUE 
      plot_hyperparams_traceplot           plot_spatial_betas 
                            TRUE                         TRUE 
             plot_temporal_betas             plot_y_estimates 
                            TRUE                         TRUE 
           reshape_covariate_dfs simulate_spatiotemporal_data 
                            TRUE                         TRUE 
                  TensorOperator                          TSR 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-15 04:20:40 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6030605e_1739593235
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpS2M4Qi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BKTR_v0.2.0-tikzDictionary"
