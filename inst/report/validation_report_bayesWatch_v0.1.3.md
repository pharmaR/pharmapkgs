# Validation Report - bayesWatch@0.1.3
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Alexander C. Murph <murph290@gmail.com>              |
...
| 2   | parallel (\>= 3.6.2)  | Imports   |
| 3   | Matrix                | Imports   |
| 4   | Hotelling             | Imports   |
| 5   | CholWishart           | Imports   |
| 6   | ggplot2               | Imports   |
| 7   | gridExtra (\>= 0.9.1) | Imports   |
| 8   | BDgraph               | Imports   |
| 9   | methods               | Imports   |
| 10  | MASS                  | Imports   |
| 11  | stats                 | Imports   |
...
Overall the package has 3 exported objects. 3 are documented:
            ...
            bayeswatch      detect_faults get_point_estimate 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 03:42:26 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd17350573_1739590942
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJqfacz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesWatch_v0.1.3-tikzDictionary"
