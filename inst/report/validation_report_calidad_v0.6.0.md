# Validation Report - calidad@0.6.0
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Klaus Lehmann <klehmann@fen.uchile.cl>               |
...
Overall the package has 6 exported objects. 6 are documented:
          ...
          assess  create_html  create_mean  create_prop  create_size create_total 
...
| Execution Time | 2025-02-16 03:35:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bc353dfbfaf_1739676933
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpD3Qtb3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_calidad_v0.6.0-tikzDictionary"
