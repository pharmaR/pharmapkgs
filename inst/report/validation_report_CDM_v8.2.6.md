...
| bugs_status          | 0.8571429                                       |
| has_source_control   | https://github.com/alexanderrobitzsch/CDM       |
...
cdcatR, dina, GDINA, immer, LAM, mdmb, miceadds, mnlfa, sirt, STARTS,
TAM, TDCM
...
Overall the package has 101 exported objects. 101 are documented:
                                    ...
                                    abs_approx_D1 
                                        ...
                                        cat_paste 
                                          ...
                                          cdi.kli 
                                             TRUE 
                     cdm_attach_internal_function 
                                             TRUE 
                    cdm_calc_information_criteria 
                                             TRUE 
                                          cdm_fa1 
                                             TRUE 
                                   cdm_fit_normal 
                                 ...
                                 cdm_matrixstring 
                                             TRUE 
                     cdm_parameter_regularization 
                                             TRUE 
                             cdm_pem_acceleration 
                                             TRUE 
    cdm_pem_acceleration_assign_output_parameters 
                                             TRUE 
                                    cdm_pem_inits 
                                             TRUE 
                    cdm_pem_inits_assign_parmlist 
                                             TRUE 
                      cdm_penalty_threshold_elnet 
                                             TRUE 
                      ...
                      cdm_penalty_threshold_ridge 
                       ...
                       cdm_penalty_threshold_scad 
                                             TRUE 
                     cdm_penalty_threshold_scadL2 
                                             TRUE 
                        cdm_penalty_threshold_tlp 
                                             TRUE 
                               cdm_penalty_values 
                                             TRUE 
                           cdm_print_summary_call 
                                             TRUE 
               cdm_print_summary_computation_time 
                                             TRUE 
...
| Execution Time | 2025-02-23 03:20:00 UTC |
...
running this report
    ...
    PROCESSX_PS1d257b3a43a6_1740280796
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgyEGi2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CDM_v8.2.6-tikzDictionary"
