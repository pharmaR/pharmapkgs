...
| export_help          | 4                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Ignacio Martinez <ignacio@martinez.fyi> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/google/bsynth        |
...
| 9   | methods                   | Imports   |
| 10  | purrr                     | Imports   |
| 11  | rstan (\>= 2.18.1)        | Imports   |
| 12  | rstantools (\>= 2.1.1)    | Imports   |
| 13  | scales                    | Imports   |
| 14  | tibble                    | Imports   |
| 15  | tidyr                     | Imports   |
| 16  | vizdraws (\>= 1.1)        | Imports   |
| 17  | stats                     | Imports   |
| 18  | rlang                     | Imports   |
...
| 23  | rstan (\>= 2.18.1)        | LinkingTo |
| 24  | StanHeaders (\>= 2.18.0)  | LinkingTo |
...
Overall the package has 4 exported objects. 3 are documented:

               %>% bayesianFactor  bayesianSynth     time_tiles 
             FALSE           TRUE           TRUE           TRUE 

### Examples

There are 10 help pages with examples, from 12 (83.33 %).
...
| Execution Time | 2025-02-15 04:52:08 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1f786922_1739595122
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5Ytr5Y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bsynth_v1.0-tikzDictionary"
