...
| export_help          | 41                                 |
| has_website          | TRUE                               |
| has_maintainer       | Soenke Hoffmann <sohoffma@ovgu.de> |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/OvGU-SH/desk    |
...
Overall the package has 41 exported objects. 41 are documented:
              ...
              acc        ar1sim     arguments      bc.model       bc.test 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          bp.test       cochorc      datasets           ddw       def.exp 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          def.log       dw.test       gq.test           hcc          hilu 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              ivr       jb.test          lagk   makedata.bc makedata.corr 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         mc.table   new.session           ols ols.has.const  ols.infocrit 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     ols.interval   ols.predict    par.f.test    par.t.test       pc.test 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              pdw        qlr.cv      qlr.test repeat.sample    reset.test 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           rm.all      roll.win  rprofile.add rprofile.open           Sxy 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          wh.test 
             TRUE 
...
| Execution Time | 2025-02-18 03:48:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bb459b6c410_1739850534
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUZwdzM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_desk_v1.1.2-tikzDictionary"
