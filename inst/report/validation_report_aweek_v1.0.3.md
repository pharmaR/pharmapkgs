...
Overall the package has 9 exported objects. 9 are documented:
             ...
             as.aweek change_week_start         date2week      factor_aweek 
                 TRUE              TRUE              TRUE              TRUE 
            get_aweek          get_date    get_week_start    set_week_start 
                 TRUE              TRUE              TRUE              TRUE 
            week2date 
                 TRUE 
...
| Execution Time | 2025-02-14 07:36:07 UTC |
...
running this report
    ...
    PROCESSX_PS1c0974049518_1739518564
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT9oM3e
