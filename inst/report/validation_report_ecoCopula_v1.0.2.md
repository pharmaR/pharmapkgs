# Validation Report - ecoCopula@1.0.2
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Gordana Popovic <g.popovic@unsw.edu.au>              |
...
Overall the package has 15 exported objects. 15 are documented:
                     ...
                     cgr                 cord    fitted.stackedsdm 
                    TRUE                 TRUE                 TRUE 
               ldTweedie             plot.cgr            plot.cord 
                    TRUE                 TRUE                 TRUE 
         plot.stackedsdm   predict.stackedsdm            print.cgr 
                    TRUE                 TRUE                 TRUE 
              print.cord residuals.stackedsdm        simulate.cord 
                    TRUE                 TRUE                 TRUE 
              stackedsdm          summary.cgr         summary.cord 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 03:33:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d45f7080ec_1739936026
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRJoNa6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecoCopula_v1.0.2-tikzDictionary"
