# Validation Report - DoubleML@1.0.1
...
| export_help          | 16                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Philipp Bach <philipp.bach@uni-hamburg.de>  |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/DoubleML/doubleml-for-r/ |
...
|:----|:-------------------------|:--------|
| 1   | R6 (\>= 2.4.1)           | Imports |
| 2   | data.table (\>= 1.12.8)  | Imports |
| 3   | stats                    | Imports |
| 4   | checkmate                | Imports |
| 5   | mlr3 (\>= 0.5.0)         | Imports |
| 6   | mlr3tuning (\>= 0.3.0)   | Imports |
| 7   | mvtnorm                  | Imports |
| 8   | utils                    | Imports |
| 9   | clusterGeneration        | Imports |
| 10  | readstata13              | Imports |
| 11  | mlr3learners (\>= 0.3.0) | Imports |
| 12  | mlr3misc                 | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
         ...
         double_ml_data_from_data_frame          double_ml_data_from_matrix 
                                   TRUE                                TRUE 
                    DoubleMLClusterData                        DoubleMLData 
                                   TRUE                                TRUE 
                           DoubleMLIIVM                         DoubleMLIRM 
                                   TRUE                                TRUE 
                           DoubleMLPLIV                         DoubleMLPLR 
                                   TRUE                                TRUE 
                             fetch_401k                         fetch_bonus 
                                   TRUE                                TRUE 
                         make_iivm_data                       make_irm_data 
                                   TRUE                                TRUE 
                      make_pliv_CHS2015 make_pliv_multiway_cluster_CKMS2021 
                                   TRUE                                TRUE 
                   make_plr_CCDDHNR2018                make_plr_turrell2018 
                                   TRUE                                TRUE 
...
| Execution Time | 2025-02-18 04:37:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42adc4482_1739853469
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplyScA5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DoubleML_v1.0.1-tikzDictionary"
