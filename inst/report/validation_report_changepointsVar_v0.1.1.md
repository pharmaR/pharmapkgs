# Validation Report - changepointsVar@0.1.1
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Gianluca Sottile <gianluca.sottile@unipa.it>         |
...
Overall the package has 3 exported objects. 3 are documented:
     ...
     fit.control jumpointsVar  sel.control 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:07:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3d8bca91_1739678866
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppyaPR2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_changepointsVar_v0.1.1-tikzDictionary"
