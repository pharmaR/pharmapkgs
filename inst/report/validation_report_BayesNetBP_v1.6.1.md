# Validation Report - BayesNetBP@1.6.1
...
| export_help          | 18                        |
| has_website          | FALSE                     |
| has_maintainer       | Han Yu <hyu9@buffalo.edu> |
...
Overall the package has 18 exported objects. 18 are documented:
        ...
        AbsorbEvidence     bn_to_graphNEL ClusterTreeCompile        ComputeKLDs 
                  TRUE               TRUE               TRUE               TRUE 
    ElimTreeInitialize        FactorQuery           GetValue        Initializer 
                  TRUE               TRUE               TRUE               TRUE 
     LocalModelCompile          Marginals           PlotCGBN      PlotMarginals 
                  TRUE               TRUE               TRUE               TRUE 
              PlotTree          Propagate qtlnet_to_graphNEL     runBayesNetApp 
                  TRUE               TRUE               TRUE               TRUE 
               Sampler   SummaryMarginals 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 03:38:54 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6b5ebb08_1739590730
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIKOHiR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesNetBP_v1.6.1-tikzDictionary"
