# Validation Report - chooseGCM@1.0.2
...
| export_help          | 14                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Luíz Esser <luizesser@gmail.com>       |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/luizesser/chooseGCM |
...
| 2   | cluster    | Imports |
| 3   | cowplot    | Imports |
| 4   | factoextra | Imports |
| 5   | ggcorrplot | Imports |
| 6   | ggplot2    | Imports |
| 7   | graphics   | Imports |
| 8   | httr       | Imports |
| 9   | methods    | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
    ...
    closestdist_gcms     compare_gcms         cor_gcms        dist_gcms 
                TRUE             TRUE             TRUE             TRUE 
            env_gcms     flatten_gcms      hclust_gcms      import_gcms 
                TRUE             TRUE             TRUE             TRUE 
         kmeans_gcms  montecarlo_gcms        optk_gcms     summary_gcms 
                TRUE             TRUE             TRUE             TRUE 
      transform_gcms   worldclim_data 
                TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:15:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc345eefd48_1739679316
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPzlAJD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chooseGCM_v1.0.2-tikzDictionary"
