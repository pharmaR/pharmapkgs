# Validation Report - dosresmeta@2.0.1
...
| export_help          | 12                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Alessio Crippa <alessio.crippa@ki.se> |
...
Overall the package has 12 exported objects. 12 are documented:
           ...
           covar.logrr          covar.smd         dosresmeta dosresmeta.control 
                  TRUE               TRUE               TRUE               TRUE 
        dosresmeta.fit             fpgrid            fracpol                gof 
                  TRUE               TRUE               TRUE               TRUE 
                   grl            hamling                vpc           waldtest 
                  TRUE               TRUE               TRUE               TRUE 

### Examples

There are 19 help pages with examples, from 40 (47.50 %).
...
| Execution Time | 2025-02-18 04:36:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47bb3403f_1739853366
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDiF23H
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dosresmeta_v2.0.1-tikzDictionary"
