# Validation Report - benthos@1.3.8
...
| export_help          | 62                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Dennis Walvoort <dennis.Walvoort@wur.nl>             |
...
Overall the package has 62 exported objects. 62 are documented:
            ...
            abundance        abundance_              ambi             ambi_ 
                 TRUE              TRUE              TRUE              TRUE 
          as_accepted       bray_curtis               eqr      generic_name 
                 TRUE              TRUE              TRUE              TRUE 
     genus_to_species          get_ambi           get_iti          get_taxa 
                 TRUE              TRUE              TRUE              TRUE 
            get_worms         harmonize          has_ambi         has_ambi_ 
                 TRUE              TRUE              TRUE              TRUE 
              has_iti          has_iti_              hill             hill_ 
                 TRUE              TRUE              TRUE              TRUE 
                hill0            hill0_             hill1            hill1_ 
                 TRUE              TRUE              TRUE              TRUE 
                hill2            hill2_              hpie             hpie_ 
                 TRUE              TRUE              TRUE              TRUE 
             hurlbert         hurlbert_       is_accepted      is_accepted_ 
                 TRUE              TRUE              TRUE              TRUE 
             is_azoic        is_binomen          is_worms         is_worms_ 
                 TRUE              TRUE              TRUE              TRUE 
                  iti              iti_               lnn              lnn_ 
                 TRUE              TRUE              TRUE              TRUE 
             margalef         margalef_              pool         read_ambi 
                 TRUE              TRUE              TRUE              TRUE 
           read_beqi2          read_iti          read_ref         read_taxa 
                 TRUE              TRUE              TRUE              TRUE 
             read_twn              rygg             rygg_           shannon 
                 TRUE              TRUE              TRUE              TRUE 
             shannon_           simpson          simpson_  species_richness 
                 TRUE              TRUE              TRUE              TRUE 
    species_richness_     specific_name          strip_sp          to_worms 
                 TRUE              TRUE              TRUE              TRUE 
      total_abundance  total_abundance_ 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-22 03:15:08 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb23404dd8_1740194104
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0QEfrE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_benthos_v1.3.8-tikzDictionary"
