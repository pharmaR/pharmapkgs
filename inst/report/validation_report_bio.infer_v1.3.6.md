# Validation Report - bio.infer@1.3.6
...
Overall the package has 30 exported objects. 30 are documented:
       ...
       correct.taxanames           flist.data          flist.match 
                    TRUE                 TRUE                 TRUE 
               formtomat         get.dupe.sel              get.otu 
                    TRUE                 TRUE                 TRUE 
         get.taxon.names        get.taxonomic      get.valid.names 
                    TRUE                 TRUE                 TRUE 
                 in.ITIS       incorp.correct             infergui 
                    TRUE                 TRUE                 TRUE 
               load.itis     load.revised.otu load.revised.species 
                    TRUE                 TRUE                 TRUE 
            locate.dupes        make.fulltab1         make.species 
                    TRUE                 TRUE                 TRUE 
                  makess              mlsolve          modalDialog 
                    TRUE                 TRUE                 TRUE 
        output.tax.table     parse.taxon.name         remove.dupes 
                    TRUE                 TRUE                 TRUE 
            resolve.mult         sel.coeffile            taxon.env 
                    TRUE                 TRUE                 TRUE 
            tklist.modal           trait.stat              view.te 
                    TRUE                 TRUE                 TRUE 

### Examples

There are 42 help pages with examples, from 43 (97.67 %).
...
| Execution Time | 2025-02-15 04:11:03 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd218c6f71_1739592659
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpthP7fD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bio.infer_v1.3.6-tikzDictionary"
