# Validation Report - errorist@0.1.2
...
| export_help          | 6                                         |
| has_website          | TRUE                                      |
| has_maintainer       | James Balamuta <balamut2@illinois.edu>    |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/coatless-rpkg/errorist |
...
Overall the package has 6 exported objects. 6 are documented:
      ...
      disable_error_shim     disable_errorist disable_warning_shim 
                    TRUE                 TRUE                 TRUE 
       enable_error_shim      enable_errorist  enable_warning_shim 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:27:43 UTC |
...
running this report
    ...
    PROCESSX_PS1d45473fe75c_1739939257
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVNhvrk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_errorist_v0.1.2-tikzDictionary"
