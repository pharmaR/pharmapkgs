...
| has_source_control   | https://github.com/patzaw/bscui/          |
...
Overall the package has 19 exported objects. 19 are documented:
           ...
           add_bscui_element                    bscui              bscuiOutput 
                        TRUE                     TRUE                     TRUE 
                  bscuiProxy      click_bscui_element    export_bscui_to_image 
                        TRUE                     TRUE                     TRUE 
               get_bscui_svg     order_bscui_elements    remove_bscui_elements 
                        TRUE                     TRUE                     TRUE 
                 renderBscui     set_bscui_attributes        set_bscui_options 
                        TRUE                     TRUE                     TRUE 
         set_bscui_selection         set_bscui_styles    set_bscui_ui_elements 
                        TRUE                     TRUE                     TRUE 
     update_bscui_attributes   update_bscui_selection      update_bscui_styles 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-15 04:48:17 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd66fc164b_1739594892
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5eV09c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bscui_v0.1.5-tikzDictionary"
