# Validation Report - easyPSID@0.1.2
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Brian Aronson <bdaronson@gmail.com>                  |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | stringr (\>= 1.0.0)  | Depends |
| 2   | LaF (\>= 0.6.0)      | Depends |
| 3   | foreign (\>= 0.8-67) | Depends |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       convert_from_rds      convert_to_rds create_custom_panel      create_extract 
                   TRUE                TRUE                TRUE                TRUE 
       find_description           find_name          find_years     rename_fam_vars 
                   TRUE                TRUE                TRUE                TRUE 
        rename_ind_vars     unzip_all_files 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-18 05:12:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44c610322_1739855544
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpd9eJT3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easyPSID_v0.1.2-tikzDictionary"
