...
| size_codebase | 414 |
| has_source_control | https://github.com/sigbertklinke/andrews (development version) |
...
Overall the package has 9 exported objects. 9 are documented:
              ...
              andrews          andrews0           deftype generate_n_primes 
                 TRUE              TRUE              TRUE              TRUE 
            normalize          numarray      outlyingness         selectand 
                 TRUE              TRUE              TRUE              TRUE 
                  zzz 
                 TRUE 
...
| Execution Time | 2025-02-14 06:54:06 UTC |
...
running this report
    ...
    PROCESSX_PS726d743f714a_1739516043
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXDNkiv
