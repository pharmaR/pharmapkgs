...
| export_help          | 37                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Joe Russell <jrussell@mango-solutions.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/mangothecat/BLCOP       |
| has_bug_reports_url  | 1                                          |
| downloads_1yr        | 4375                                       |
| reverse_dependencies | 0                                          |
| has_examples         | 0.8846154                                  |
| dependencies         | 10                                         |
...
| 2   | MASS                     | Imports |
| 3   | quadprog                 | Imports |
| 4   | RUnit (\>= 0.4.22)       | Imports |
| 5   | timeSeries               | Imports |
| 6   | fBasics                  | Imports |
| 7   | fMultivar                | Imports |
| 8   | fPortfolio (\>= 3011.81) | Imports |
| 9   | rmarkdown                | Imports |
| 10  | knitr                    | Imports |
...
Overall the package has 33 exported objects. 36 are documented:

              addBLViews          addCOPViews             assetSet 
                    TRUE                 TRUE                 TRUE 
            BLCOPOptions          BLPosterior              BLViews 
                    TRUE                 TRUE                 TRUE 
                CAPMList          confidences        confidences<- 
                    TRUE                 TRUE                 TRUE 
           confidences<-         COPPosterior             COPViews 
                    TRUE                 TRUE                 TRUE 
           createBLViews       createCOPViews         distribution 
                    TRUE                 TRUE                 TRUE 
       getPosteriorEstim        getPriorEstim       mvdistribution 
                    TRUE                 TRUE                 TRUE 
              newPMatrix       numSimulations    optimalPortfolios 
                    TRUE                 TRUE                 TRUE 
                 PMatrix            PMatrix<-         posteriorEst 
                    TRUE                 TRUE                 TRUE 
    posteriorFeasibility     posteriorMeanCov posteriorSimulations 
                    TRUE                 TRUE                 TRUE 
              priorViews                 qv<-        runBLCOPTests 
                    TRUE                 TRUE                 TRUE 
              sampleFrom        updateBLViews           viewMatrix 
                    TRUE                 TRUE                 TRUE 

### Examples

There are 23 help pages with examples, from 26 (88.46 %).
...
| Execution Time | 2025-02-15 04:21:52 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd28c94a1a_1739593307
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGTOpbN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BLCOP_v0.3.3-tikzDictionary"
