# Validation Report - BigVAR@1.1.2
...
| export_help          | 15                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Will Nicholson <wbn8@cornell.edu>     |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/wbnicholson/BigVAR |
| has_bug_reports_url  | 1                                     |
| downloads_1yr        | 6504                                  |
| reverse_dependencies | 2                                     |
| has_examples         | 0.7727273                             |
| dependencies         | 13                                    |
| license              | GPL (\>= 2)                           |
...
frequencyConnectedness, VIRF

## Namespace

Overall the package has 11 exported objects. 15 are documented:

                     BigVAR.est                  BigVAR.fit 
                           TRUE                        TRUE 
                 constructModel                   cv.BigVAR 
                           TRUE                        TRUE 
                     MultVarSim                 PredictVARX 
                           TRUE                        TRUE 
    SparsityPlot.BigVAR.results                VarptoVar1MC 
                           TRUE                        TRUE 
                        VARXFit            VARXForecastEval 
                           TRUE                        TRUE 
                    VARXLagCons 
                           TRUE 
...
There are 17 help pages with examples, from 22 (77.27 %).
...
| Execution Time | 2025-02-15 04:06:26 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd303c7187_1739592381
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNP9yt2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BigVAR_v1.1.2-tikzDictionary"
