# Validation Report - clusrank@1.0.4
...
| bugs_status          | 1                                       |
| has_source_control   | https://github.com/wenjie2wang/clusrank |
| has_bug_reports_url  | 1                                       |
| downloads_1yr        | 12784                                   |
| reverse_dependencies | 0                                       |
| has_examples         | 0.5555556                               |
| dependencies         | 4                                       |
| license              | GPL (\>= 3)                             |
...
Overall the package has 4 exported objects. 4 are documented:
                     ...
                     cluster          clusWilcox.test pairwise.clusWilcox.test 
                        TRUE                     TRUE                     TRUE 
                     stratum 
                        TRUE 
...
There are 5 help pages with examples, from 9 (55.56 %).
...
| Execution Time | 2025-02-23 03:22:51 UTC |
...
running this report
    ...
    PROCESSX_PS1d253be52062_1740280967
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbbDGR5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clusrank_v1.0.4-tikzDictionary"
