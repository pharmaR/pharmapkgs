# Validation Report - domino@0.3.1
...
| export_help          | 15                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Nick Elprin <nick@dominodatalab.com>                 |
...
Overall the package has 15 exported objects. 15 are documented:
        ...
        domino.create      domino.debug       domino.diff   domino.download 
                 TRUE              TRUE              TRUE              TRUE 
          domino.dump        domino.get       domino.init      domino.login 
                 TRUE              TRUE              TRUE              TRUE 
         domino.reset        domino.run domino.runCommand   domino.snapshot 
                 TRUE              TRUE              TRUE              TRUE 
        domino.status       domino.sync     domino.upload 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:33:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb412e73a31_1739853211
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0G8JBp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_domino_v0.3.1-tikzDictionary"
