# Validation Report - conditionz@0.1.0
...
| has_source_control   | https://github.com/ropenscilabs/conditionz  |
...
Overall the package has 6 exported objects. 6 are documented:
      ...
      capture_message   capture_warning   ConditionKeeper handle_conditions 
                 TRUE              TRUE              TRUE              TRUE 
      handle_messages   handle_warnings 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-17 03:41:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66b5111d2_1739763661
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb8tHe0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conditionz_v0.1.0-tikzDictionary"
