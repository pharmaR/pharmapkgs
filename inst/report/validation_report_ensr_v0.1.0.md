...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Peter DeWitt <peter.dewitt@ucdenver.edu>             |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/dewittpe/ensr                     |
...
Overall the package has 5 exported objects. 5 are documented:
                 ...
                 ensr lambda_alpha_grid        lambda_max        preferable 
                 TRUE              TRUE              TRUE              TRUE 
          standardize 
                 TRUE 
...
| Execution Time | 2025-02-19 04:10:23 UTC |
...
running this report
    ...
    PROCESSX_PS1d45b142760_1739938217
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzozzUZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ensr_v0.1.0-tikzDictionary"
