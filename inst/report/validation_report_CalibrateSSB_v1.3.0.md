# Validation Report - CalibrateSSB@1.3.0
...
| export_help          | 14                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Oyvind Langsrud <oyl@ssb.no>                     |
| has_source_control   | https://github.com/statisticsnorway/CalibrateSSB |
...
Overall the package has 14 exported objects. 14 are documented:
                ...
                AkuData        CalibrateSSB   CalibrateSSBpanel           CalSSBobj 
                   TRUE                TRUE                TRUE                TRUE 
    CalSSBobjReGenesees         CrossStrata             LagDiff       LinCombMatrix 
                   TRUE                TRUE                TRUE                TRUE 
          MatchVarNames     OrderedVarNames     PanelEstimation              Period 
                   TRUE                TRUE                TRUE                TRUE 
             PeriodDiff   WideFromCalibrate 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 03:35:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3694bae6b_1739676906
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBUJOLD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CalibrateSSB_v1.3.0-tikzDictionary"
