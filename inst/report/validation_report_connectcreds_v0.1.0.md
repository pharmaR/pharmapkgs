# Validation Report - connectcreds@0.1.0
...
| export_help          | 4                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Aaron Jacobs <aaron.jacobs@posit.co>      |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/posit-dev/connectcreds |
...
Overall the package has 4 exported objects. 4 are documented:
              ...
              connect_viewer_token               has_viewer_token 
                              TRUE                           TRUE 
    local_mocked_connect_responses  with_mocked_connect_responses 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-17 03:45:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bd659ce1b6e_1739763953
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvYIRup
...
These are the options set to generate the report:
    ...
    [1] "validation_report_connectcreds_v0.1.0-tikzDictionary"
