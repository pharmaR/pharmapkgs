...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yuping Wang <yuping.wang@plus.ac.at>                 |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | copBasic (\>= 2.2.3)    | Imports |
| 2   | cowplot (\>= 1.1.2)     | Imports |
| 3   | dendextend (\>= 1.17.1) | Imports |
| 4   | factoextra (\>= 1.0.7)  | Imports |
| 5   | FOCI (\>= 0.1.3)        | Imports |
| 6   | ggplot2 (\>= 3.4.4)     | Imports |
| 7   | graphics (\>= 4.3.0)    | Imports |
| 8   | grDevices (\>= 0.5-1)   | Imports |
| 9   | gtools (\>= 3.9.5)      | Imports |
| 10  | phylogram (\>= 2.1.0)   | Imports |
| 11  | rlang (\>= 1.1.4)       | Imports |
| 12  | stats (\>= 4.3.0)       | Imports |
...
| Execution Time | 2025-02-18 04:01:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45d76d0df_1739851290
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFujxxX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_didec_v0.1.0-tikzDictionary"
