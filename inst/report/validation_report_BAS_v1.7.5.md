...
| export_help          | 39                                  |
| has_website          | TRUE                                |
| has_maintainer       | Merlise Clyde <clyde@duke.edu>      |
| bugs_status          | subscript out of bounds             |
| size_codebase        | 2462                                |
| has_source_control   | https://github.com/merliseclyde/BAS |
| has_bug_reports_url  | 1                                   |
| downloads_1yr        | 18283                               |
| reverse_dependencies | 3                                   |
| has_examples         | 0.9454545                           |
| dependencies         | 4                                   |
| license              | GPL (\>= 3)                         |
...
Overall the package has 39 exported objects. 39 are documented:
             ...
             aic.prior            bas.glm             bas.lm      Bayes.outlier 
                  TRUE               TRUE               TRUE               TRUE 
          bayesglm.fit          Bernoulli Bernoulli.heredity      beta.binomial 
                  TRUE               TRUE               TRUE               TRUE 
            beta.prime          bic.prior                CCH     cv.summary.bas 
                  TRUE               TRUE               TRUE               TRUE 
           diagnostics          EB.global           EB.local          eplogprob 
                  TRUE               TRUE               TRUE               TRUE 
        eplogprob.marg force.heredity.bas            g.prior            hyper.g 
                  TRUE               TRUE               TRUE               TRUE 
             hyper.g.n  hypergeometric1F1  hypergeometric2F1           IC.prior 
                  TRUE               TRUE               TRUE               TRUE 
             intrinsic           Jeffreys    list2matrix.bas  list2matrix.which 
                  TRUE               TRUE               TRUE               TRUE 
                  phi1             robust               tCCH       testBF.prior 
                  TRUE               TRUE               TRUE               TRUE 
                    TG   tr.beta.binomial         tr.poisson     tr.power.prior 
                  TRUE               TRUE               TRUE               TRUE 
                 trCCH            uniform       which.matrix 
                  TRUE               TRUE               TRUE 

### Examples

There are 52 help pages with examples, from 55 (94.55 %).
...
| Execution Time | 2025-02-14 07:43:35 UTC |
...
running this report
    ...
    PROCESSX_PS1c095cd51124_1739519012
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZqek0r
