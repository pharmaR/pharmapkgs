# Validation Report - crossword.r@0.3.6
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Peter Meissner <retep.meissner@gmail.com>            |
...
| 3   | stringr (\>= 1.2.0)    | Imports |
| 4   | magrittr (\>= 1.5)     | Imports |
| 5   | jsonlite (\>= 1.5)     | Imports |
| 6   | r6extended (\>= 0.1.1) | Imports |
...
Overall the package has 3 exported objects. 2 are documented:
                      ...
                      %>%             Crossword cw_wordlist_animal_en 
                    FALSE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-17 04:25:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61fa8ef51_1739766326
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppRGudi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crossword.r_v0.3.6-tikzDictionary"
