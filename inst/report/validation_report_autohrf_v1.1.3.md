...
| size_codebase        | 701                                     |
| has_source_control   | https://github.com/demsarjure/autohrf   |
...
Overall the package has 18 exported objects. 18 are documented:
                    ...
                    autohrf         convolve_events            convolve_hrf 
                       TRUE                    TRUE                    TRUE 
         create_boynton_hrf            create_child create_first_generation 
                       TRUE                    TRUE                    TRUE 
      create_new_generation          create_spm_hrf              downsample 
                       TRUE                    TRUE                    TRUE 
             evaluate_model      fit_to_constraints         get_best_models 
                       TRUE                    TRUE                    TRUE 
                get_parents        plot_best_models             plot_events 
                       TRUE                    TRUE                    TRUE 
               plot_fitness              plot_model               run_model 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 07:33:32 UTC |
...
running this report
    ...
    PROCESSX_PS1c091de95705_1739518409
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpj7DOot
