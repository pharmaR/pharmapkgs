...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Ruizhe Ma <maruizhe.cs@gmail.com>                    |
...
|:----|:-------------------|:--------|
| 1   | dtw (\>= 1.22)     | Imports |
| 2   | dtwclust (\>= 5.5) | Imports |
| 3   | parallel (\>= 4.2) | Imports |
| 4   | magrittr (\>= 2.0) | Imports |
| 5   | utils              | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
        ...
        createDistMatrix    createLabelMatrix createStandardMatrix 
                    TRUE                 TRUE                 TRUE 
                     ddc 
                    TRUE 
...
| Execution Time | 2025-02-17 05:12:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6585e6529_1739769149
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVpvYoC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ddc_v1.0.1-tikzDictionary"
