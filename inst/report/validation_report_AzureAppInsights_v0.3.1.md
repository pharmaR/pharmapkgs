...
| export_help          | 7                                           |
| has_website          | FALSE                                       |
| has_maintainer       | Stefan McKinnon Edwards <smhe@kamstrup.com> |
...
Overall the package has 7 exported objects. 7 are documented:
                     ...
                     config                    demo includeAzureAppInsights 
                       TRUE                    TRUE                    TRUE 
     is_instrumentation_key   startAzureAppInsights              trackEvent 
                       TRUE                    TRUE                    TRUE 
                trackMetric 
                       TRUE 
...
| Execution Time | 2025-02-14 07:37:30 UTC |
...
running this report
    ...
    PROCESSX_PS1c095695456f_1739518647
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBgePsT
