...
| export_help          | 30                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Derek Chiu <dchiu@bccrc.ca>            |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/AlineTalhouk/diceR/ |
...
| 3   | class             | Imports   |
| 4   | clue              | Imports   |
| 5   | clusterCrit       | Imports   |
| 6   | clv               | Imports   |
| 7   | clValid           | Imports   |
| 8   | dplyr (\>= 0.7.5) | Imports   |
| 9   | ggplot2           | Imports   |
...
| 15  | methods           | Imports   |
| 16  | pheatmap          | Imports   |
| 17  | purrr (\>= 0.2.3) | Imports   |
| 18  | RankAggreg        | Imports   |
| 19  | Rcpp              | Imports   |
| 20  | stringr           | Imports   |
| 21  | tidyr             | Imports   |
| 22  | yardstick         | Imports   |
| 23  | Rcpp              | LinkingTo |
...
Overall the package has 30 exported objects. 30 are documented:
                  ...
                  asrs        compactness  consensus_cluster  consensus_combine 
                  TRUE               TRUE               TRUE               TRUE 
    consensus_evaluate   consensus_matrix               CSPA                cts 
                  TRUE               TRUE               TRUE               TRUE 
                  dice         ev_confmat             ev_nmi          graph_all 
                  TRUE               TRUE               TRUE               TRUE 
             graph_cdf   graph_delta_area      graph_heatmap     graph_tracking 
                  TRUE               TRUE               TRUE               TRUE 
            impute_knn     impute_missing            k_modes                LCA 
                  TRUE               TRUE               TRUE               TRUE 
                   LCE    majority_voting          min_fnorm                PAC 
                  TRUE               TRUE               TRUE               TRUE 
            pcn_select       pcn_simulate       prepare_data      relabel_class 
                  TRUE               TRUE               TRUE               TRUE 
              sigclust                srs 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-18 04:00:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43bbfdc11_1739851219
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8KsRhL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diceR_v3.0.0-tikzDictionary"
