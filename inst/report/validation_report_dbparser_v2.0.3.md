# Validation Report - dbparser@2.0.3
...
| export_help          | 5                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Mohammed Ali <moh_fcis@yahoo.com>    |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/ropensci/dbparser |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         cett_nodes_options       drug_node_options           parseDrugBank 
                       TRUE                    TRUE                    TRUE 
    references_node_options  show_dvobject_metadata 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-17 05:07:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bd631527da4_1739768862
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTG2TLv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dbparser_v2.0.3-tikzDictionary"
