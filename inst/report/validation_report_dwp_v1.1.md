...
| export_help          | 61                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel Dalthorp <ddalthorp@protonmail.com>           |
...
Overall the package has 61 exported objects. 61 are documented:
           ...
           Acins   addCarcass          aic    calcMstar    cof2parms        cofOK 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
          cofOK0     cofOKInf     dd2ddSim         ddCI          ddd        ddFit 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           ddSim          dmb        dxep0      dxep012     dxep0123       dxep02 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           dxep1       dxep12      dxep123        dxep2       dxepi0       estdwp 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
          estpsi      exclude exportGenEst        fmmax     fmmax.ab formatGenEst 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        getncarc     incGamma   initLayout          MCI  modelFilter    mpp2ddSim 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        MpriorOK          off        parOK          pdd          pmb        postM 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        postM.ab      prepmod     prepRing   psi_extend        pxep0      pxep012 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        pxep0123       pxep02        pxep1       pxep12      pxep123        pxep2 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
          pxepi0          qdd          rcd          rdd  readCarcass         rmat 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           stats 
            TRUE 
...
| Execution Time | 2025-02-18 05:02:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4502bd1a9_1739854926
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOdQ2Cp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dwp_v1.1-tikzDictionary"
