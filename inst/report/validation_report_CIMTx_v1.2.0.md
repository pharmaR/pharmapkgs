...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jiayi Ji <jjy2876@gmail.com>                         |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | nnet (\>= 7.3-16)         | Imports |
| 2   | BART (\>= 2.9)            | Imports |
| 3   | twang (\>= 2.5)           | Imports |
| 4   | arm (\>= 1.2-12)          | Imports |
| 5   | dplyr (\>= 1.0.7)         | Imports |
| 6   | Matching (\>= 4.9-11)     | Imports |
| 7   | magrittr (\>= 2.0.1)      | Imports |
| 8   | WeightIt (\>= 0.12.0)     | Imports |
| 9   | tmle (\>= 1.5.0.2)        | Imports |
| 10  | tidyr (\>= 1.1.4)         | Imports |
| 11  | stats                     | Imports |
| 12  | ggplot2 (\>= 3.3.5)       | Imports |
| 13  | cowplot (\>= 1.1.1)       | Imports |
| 14  | mgcv (\>= 1.8-38)         | Imports |
| 15  | metR (\>= 0.11.0)         | Imports |
| 16  | stringr (\>= 1.4.0)       | Imports |
| 17  | SuperLearner (\>= 2.0-28) | Imports |
| 18  | foreach (\>= 1.5.1)       | Imports |
| 19  | doParallel (\>= 1.0.16)   | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
       ...
       ce_estimate       data_sim             sa true_c_fun_cal 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:19:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34317f96e_1739679546
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDns0kj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CIMTx_v1.2.0-tikzDictionary"
