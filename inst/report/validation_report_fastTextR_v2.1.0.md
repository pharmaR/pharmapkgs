# Validation Report - fastTextR@2.1.0
...
| has_source_control   | https://github.com/EmilHvitfeldt/fastTextR |
...
PsychWordVec, wordsalad

## Namespace

Overall the package has 13 exported objects. 13 are documented:

                fasttext         ft_analogies           ft_control 
                    TRUE                 TRUE                 TRUE 
                 ft_load ft_nearest_neighbors         ft_normalize 
                    TRUE                 TRUE                 TRUE 
              ft_predict              ft_save  ft_sentence_vectors 
                    TRUE                 TRUE                 TRUE 
                 ft_test             ft_train      ft_word_vectors 
                    TRUE                 TRUE                 TRUE 
                ft_words 
                    TRUE 
...
| Execution Time | 2025-02-19 05:22:26 UTC |
...
running this report
    ...
    PROCESSX_PS1d455f0d2d3a_1739942540
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplpMJfs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastTextR_v2.1.0-tikzDictionary"
