# Validation Report - diffval@1.1.0
...
| export_help          | 10                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Tiago Monteiro-Henriques <tmh.dev@icloud.com> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://gitlab.com/point-veg/diffval          |
...
Overall the package has 10 exported objects. 10 are documented:
             ...
             bigdata_tdv   explore_tabulation  identical_partition 
                    TRUE                 TRUE                 TRUE 
    optim_tdv_gurobi_k_2 optim_tdv_hill_climb optim_tdv_simul_anne 
                    TRUE                 TRUE                 TRUE 
     partition_tdv_grasp  partition_tdv_grdtp           tabulation 
                    TRUE                 TRUE                 TRUE 
                     tdv 
                    TRUE 
...
| Execution Time | 2025-02-18 04:04:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4848fc5_1739851486
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJA59QF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diffval_v1.1.0-tikzDictionary"
