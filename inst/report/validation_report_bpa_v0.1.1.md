...
| has_source_control   | https://github.com/bgreenwell/bpa               |
...
Overall the package has 6 exported objects. 5 are documented:
                       ...
                       %>% basic_pattern_analysis                    bpa 
                     FALSE                   TRUE                   TRUE 
               get_pattern          match_pattern                trim_ws 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:38:01 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2b8a82f2_1739594276
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp77mPzt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bpa_v0.1.1-tikzDictionary"
