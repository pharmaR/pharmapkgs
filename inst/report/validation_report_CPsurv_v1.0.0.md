# Validation Report - CPsurv@1.0.0
...
| export_help          | 1                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Stefanie Krügel <stefanie.kruegel@gmail.com>         |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | survival (\>= 2.40-1) | Imports |
| 2   | muhaz (\>= 1.2.6)     | Imports |
| 3   | parallel (\>= 3.2.3)  | Imports |
...
| Execution Time | 2025-02-17 04:16:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6218a0cee_1739765762
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTRbikD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CPsurv_v1.0.0-tikzDictionary"
