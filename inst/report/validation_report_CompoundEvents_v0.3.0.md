# Validation Report - CompoundEvents@0.3.0
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Zengchao Hao <z.hao4univ@gmail.com>                  |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    DriverLGR   Empdis1   Empdis2     GetDC     GetDH     GetWH  ImpactMG     LMFDH 
...
| Execution Time | 2025-02-17 03:37:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64622d7d1_1739763458
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpambnEp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CompoundEvents_v0.3.0-tikzDictionary"
