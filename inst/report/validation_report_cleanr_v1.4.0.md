# Validation Report - cleanr@1.4.0
...
| export_help          | 19                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Andreas Dominik Cullmann <fvafrcu@mailbox.org>       |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://gitlab.com/fvafrcu/cleanr                    |
...
Overall the package has 19 exported objects. 19 are documented:
            ...
            check_directory              check_file       check_file_layout 
                       TRUE                    TRUE                    TRUE 
          check_file_length        check_file_width   check_function_layout 
                       TRUE                    TRUE                    TRUE 
    check_functions_in_file        check_line_width     check_nesting_depth 
                       TRUE                    TRUE                    TRUE 
        check_num_arguments         check_num_lines check_num_lines_of_code 
                       TRUE                    TRUE                    TRUE 
              check_package            check_return                     gco 
                       TRUE                    TRUE                    TRUE 
         get_cleanr_options            is_not_false load_internal_functions 
                       TRUE                    TRUE                    TRUE 
         set_cleanr_options 
                       TRUE 
...
| Execution Time | 2025-02-16 04:28:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36bc4bcbd_1739680117
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpy4pfiC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cleanr_v1.4.0-tikzDictionary"
