# Validation Report - censusr@0.0.4
...
| export_help          | 5                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Greg Macfarlane <greg@transportfoundry.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/transportfoundry/censusr |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | dplyr (\>= 0.4.3) | Depends |
| 2   | httr (\>= 1.0.0)  | Depends |
| 3   | stringr           | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
             ...
             aggregate_moe           append_geoid        call_census_api 
                      TRUE                   TRUE                   TRUE 
           call_geolocator call_geolocator_latlon 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:00:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3546bef00_1739678448
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3JF5HB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_censusr_v0.0.4-tikzDictionary"
