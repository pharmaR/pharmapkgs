# Validation Report - DataPackageR@0.16.1
...
| export_help          | 27                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Dave Slager <dslager@fredhutch.org>      |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/ropensci/DataPackageR |
...
| 2   | desc          | Imports |
| 3   | digest        | Imports |
| 4   | futile.logger | Imports |
| 5   | knitr         | Imports |
| 6   | pkgbuild      | Imports |
| 7   | pkgload       | Imports |
| 8   | rmarkdown     | Imports |
| 9   | roxygen2      | Imports |
| 10  | rprojroot     | Imports |
| 11  | usethis       | Imports |
| 12  | utils         | Imports |
| 13  | yaml          | Imports |
...
Overall the package has 27 exported objects. 27 are documented:
         ...
         assert_data_version     construct_yml_config             data_version 
                        TRUE                     TRUE                     TRUE 
        datapackage_skeleton     datapackage.skeleton datapackager_object_read 
                        TRUE                     TRUE                     TRUE 
                 dataVersion                 document          keepDataObjects 
                        TRUE                     TRUE                     TRUE 
               package_build        project_data_path     project_extdata_path 
                        TRUE                     TRUE                     TRUE 
                project_path          use_data_object               use_ignore 
                        TRUE                     TRUE                     TRUE 
       use_processing_script          use_raw_dataset            yml_add_files 
                        TRUE                     TRUE                     TRUE 
             yml_add_objects      yml_disable_compile       yml_enable_compile 
                        TRUE                     TRUE                     TRUE 
                    yml_find           yml_list_files         yml_list_objects 
                        TRUE                     TRUE                     TRUE 
            yml_remove_files       yml_remove_objects                yml_write 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-17 04:59:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6272a6376_1739768355
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaYPlxg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DataPackageR_v0.16.1-tikzDictionary"
