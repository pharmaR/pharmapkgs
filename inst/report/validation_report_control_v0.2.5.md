# Validation Report - control@0.2.5
...
| export_help          | 60                                 |
| has_website          | FALSE                              |
| has_maintainer       | Ben C. Ubah <ubah.ben22@gmail.com> |
...
Overall the package has 60 exported objects. 60 are documented:
        ...
        abcdchk       acker      append        bode    bodeplot         c2d 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
           care       cloop     connect        ctrb        damp      dcgain 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
          esort    fdbcksys    feedback    freqresp      gensig  givens_rot 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
        impulse impulseplot     initial initialplot      ismimo      issiso 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
           lsim    lsimplot       ltifr       ltitr     nyquist nyquistplot 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
           obsv    ordschur    parallel         pid       place        pole 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
       poly2str     polysub        ramp    rampplot   removesys   selectsys 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
         series          ss       ss2tf       ss2zp      ssdata        step 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
       stepplot    sysgroup          tf          TF       tf2ss       tf2zp 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
          tfchk      tfdata       zp2ss       zp2tf         zpk     zpkdata 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 03:50:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6549c03c7_1739764217
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKefV7L
...
These are the options set to generate the report:
    ...
    [1] "validation_report_control_v0.2.5-tikzDictionary"
