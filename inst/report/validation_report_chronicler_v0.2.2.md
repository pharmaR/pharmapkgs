# Validation Report - chronicler@0.2.2
...
| export_help          | 13                                    |
| has_website          | FALSE                                 |
| has_maintainer       | Bruno Rodrigues <bruno@brodrigues.co> |
...
Overall the package has 13 exported objects. 12 are documented:
              ...
              %>=%   as_chronicle    bind_record     check_diff        check_g 
             FALSE           TRUE           TRUE           TRUE           TRUE 
    flatten_record    fmap_record   is_chronicle           pick         purely 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          read_log         record    record_many 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:16:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34ea641_1739679411
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHz8Hh4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chronicler_v0.2.2-tikzDictionary"
