# Validation Report - BIOMASS@2.2.3
...
| export_help          | 26                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Dominique Lamonica <dominique.lamonica@ird.fr> |
| bugs_status          | 0.9333333                                      |
| has_source_control   | https://github.com/umr-amap/BIOMASS/           |
...
Overall the package has 26 exported objects. 26 are documented:
             ...
             AGBmonteCarlo          attributeTree     attributeTreeCoord 
                      TRUE                   TRUE                   TRUE 
    bilinear_interpolation           cacheManager              cachePath 
                      TRUE                   TRUE                   TRUE 
          check_plot_coord             clearCache             computeAGB 
                      TRUE                   TRUE                   TRUE 
                  computeE      computeFeldRegion        correctCoordGPS 
                      TRUE                   TRUE                   TRUE 
               correctTaxo            createCache                cutPlot 
                      TRUE                   TRUE                   TRUE 
               divide_plot        getBioclimParam            getTaxonomy 
                      TRUE                   TRUE                   TRUE 
            getWoodDensity            latlong2UTM                modelHD 
                      TRUE                   TRUE                   TRUE 
              numberCorner          predictHeight              retrieveH 
                      TRUE                   TRUE                   TRUE 
           subplot_summary          summaryByPlot 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-25 03:20:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d2859dfb3a0_1740453635
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4wuXy3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BIOMASS_v2.2.3-tikzDictionary"
