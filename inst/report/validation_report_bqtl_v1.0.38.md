...
| export_help          | 28                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Charles C. Berry <cberry@ucsd.edu>                   |
...
Overall the package has 28 exported objects. 28 are documented:
               ...
               bc1.levels                  bqtl           bqtl.fitter 
                     TRUE                  TRUE                  TRUE 
                  configs             f2.levels                lapadj 
                     TRUE                  TRUE                  TRUE 
             linear.bayes                 locus                loglik 
                     TRUE                  TRUE                  TRUE 
                  logpost     make.analysis.obj        make.map.frame 
                     TRUE                  TRUE                  TRUE 
    make.regressor.matrix     make.state.matrix           make.varcov 
                     TRUE                  TRUE                  TRUE 
                map.index               map.loc          map.location 
                     TRUE                  TRUE                  TRUE 
                map.names           marker.fill        plot.map.frame 
                     TRUE                  TRUE                  TRUE 
                posterior             ri.levels                  swap 
                     TRUE                  TRUE                  TRUE 
                  swapbc1                swapf2                 twohk 
                     TRUE                  TRUE                  TRUE 
                   varcov 
                     TRUE 
...
| Execution Time | 2025-02-15 04:39:32 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd13f5eb95_1739594367
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmVOFDM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bqtl_v1.0.38-tikzDictionary"
