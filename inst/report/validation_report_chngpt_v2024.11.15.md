# Validation Report - chngpt@2024.11.15
...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Youyi Fong <youyifong@gmail.com>                     |
...
| 1   | survival                | Imports |
| 2   | splines                 | Imports |
| 3   | kyotil (\>= 2020.10-12) | Imports |
| 4   | boot                    | Imports |
| 5   | MASS                    | Imports |
| 6   | methods                 | Imports |
| 7   | lme4                    | Imports |
| 8   | parallel                | Imports |
| 9   | RhpcBLASctl             | Imports |
...
InteractionPoweR, pssmooth

## Namespace

Overall the package has 21 exported objects. 21 are documented:

              antoch.test           chngpt.test               chngptm 
                     TRUE                  TRUE                  TRUE 
               chngptm.xy          convert.coef          double.hinge 
                     TRUE                  TRUE                  TRUE 
               hinge.test               lincomb performance.unit.test 
                     TRUE                  TRUE                  TRUE 
         plot.chngpt.test          plot.chngptm     plot.double.hinge 
                     TRUE                  TRUE                  TRUE 
                 predictx         print.chngptm            sim.chngpt 
                     TRUE                  TRUE                  TRUE 
                sim.hinge                sim.my            sim.pastor 
                     TRUE                  TRUE                  TRUE 
           sim.threephase sim.twophase.ran.inte        threshold.func 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-23 03:21:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d2565802a16_1740280867
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeasGn0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chngpt_v2024.11.15-tikzDictionary"
