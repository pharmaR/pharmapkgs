# Validation Report - clintools@0.9.10.1
...
| export_help          | 18                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Markus Harboe Olsen <oel@oelfam.com>  |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/lilleoel/clintools |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | signal (\>= 0.7-6)      | Imports |
| 2   | xml2 (\>= 1.3.2)        | Imports |
| 3   | lme4 (\>= 1.1-27.1)     | Imports |
| 4   | ggplot2 (\>= 3.3.0)     | Imports |
| 5   | pROC (\>= 1.18.0)       | Imports |
| 6   | irr (\>= 0.84.1)        | Imports |
| 7   | nlme (\>= 3.1-160)      | Imports |
| 8   | parameters (\>= 0.19.0) | Imports |
| 9   | stringi (\>= 1.7.8)     | Imports |
| 10  | scales (\>= 1.2.1)      | Imports |
| 11  | dplyr (\>= 1.1.2)       | Imports |
| 12  | survival (\>= 3.4-0)    | Imports |
| 13  | pander (\>= 0.6.5)      | Imports |
...
Overall the package has 18 exported objects. 18 are documented:
         ...
         calcrel      cdm.fig     cdm.miss      clinmon   comparerel    danishcpr 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       dilations        iscus      ortable      PLR3000 questionaire      quietly 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           recol   rowMedians      rrGcomp         sRCT          tbl          TFA 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:33:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36e7ee28f_1739680398
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpX2cHZC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clintools_v0.9.10.1-tikzDictionary"
