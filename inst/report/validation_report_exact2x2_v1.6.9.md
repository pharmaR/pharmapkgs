# Validation Report - exact2x2@1.6.9
...
asht, DescrTab2, exactci, jmv, pCalibrate, vvdoctor

## Namespace

Overall the package has 46 exported objects. 46 are documented:

          binomMeld.test         blaker.exact          borrControl 
                    TRUE                 TRUE                 TRUE 
            borrOrdering          borrPreCalc            borrPvals 
                    TRUE                 TRUE                 TRUE 
                borrTest             boschloo             calcTall 
                    TRUE                 TRUE                 TRUE 
    constrMLE.difference  constrMLE.oddsratio      constrMLE.ratio 
                    TRUE                 TRUE                 TRUE 
                 createR             exact2x2           exact2x2CI 
                    TRUE                 TRUE                 TRUE 
            exact2x2Plot        exact2x2Pvals           fillsquare 
                    TRUE                 TRUE                 TRUE 
            fisher.exact       fisherCalcMidp             getColor 
                    TRUE                 TRUE                 TRUE 
            getDeltaGrid              getPDQD                getPI 
                    TRUE                 TRUE                 TRUE 
               getPrange        mcnemar.exact   mcnemar.exact.calc 
                    TRUE                 TRUE                 TRUE 
          mcnemarExactDP             orderMat            pickTstat 
                    TRUE                 TRUE                 TRUE 
             plotRankMat                plotT           power2grid 
                    TRUE                 TRUE                 TRUE 
    power2gridDifference      power2gridRatio             power2x2 
                    TRUE                 TRUE                 TRUE 
                Power2x2            powerBorr       powerPaired2x2 
                    TRUE                 TRUE                 TRUE 
                   ss2x2                SS2x2            ucControl 
                    TRUE                 TRUE                 TRUE 
          uncondExact2x2  uncondExact2x2Pvals       uncondPower2x2 
                    TRUE                 TRUE                 TRUE 
             unirootGrid 
                    TRUE 
...
| Execution Time | 2025-02-19 04:45:42 UTC |
...
running this report
    ...
    PROCESSX_PS1d455fed5587_1739940336
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpF8w1qg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exact2x2_v1.6.9-tikzDictionary"
