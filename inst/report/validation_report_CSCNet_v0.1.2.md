# Validation Report - CSCNet@0.1.2
...
| export_help          | 2                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Shahin Roshani <s.roshani@nki.nl>                    |
...
|     | package                         | type    |
|:----|:--------------------------------|:--------|
| 1   | tidyverse (\>= 1.3.1)           | Depends |
| 2   | magrittr (\>= 2.0.3)            | Depends |
| 3   | dplyr (\>= 1.0.9)               | Imports |
| 4   | purrr (\>= 0.3.4)               | Imports |
| 5   | stringr (\>= 1.4.0)             | Imports |
| 6   | tibble (\>= 3.1.7)              | Imports |
| 7   | survival (\>= 3.3-1)            | Imports |
| 8   | prodlim (\>= 2019.11.13)        | Imports |
| 9   | riskRegression (\>= 2022.03.22) | Imports |
| 10  | glmnet (\>= 4.1-4)              | Imports |
| 11  | caret (\>= 6.0-92)              | Imports |
| 12  | recipes (\>= 0.2.0)             | Imports |
| 13  | future (\>= 1.26.1)             | Imports |
| 14  | furrr (\>= 0.3.0)               | Imports |
...
| Execution Time | 2025-02-17 04:29:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67556cfc8_1739766590
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptLvrXW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CSCNet_v0.1.2-tikzDictionary"
