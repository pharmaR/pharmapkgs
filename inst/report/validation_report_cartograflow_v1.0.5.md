# Validation Report - cartograflow@1.0.5
...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Sylvain Blondeau <blondeau.sylvain@yahoo.fr>         |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/fbahoken/cartogRaflow             |
...
Overall the package has 13 exported objects. 13 are documented:
     ...
     flowanalysis     flowcarre    flowcontig      flowdist      flowgini 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     flowjointure     flowlowup       flowmap    flowplaces    flowreduct 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    flowstructmat    flowtabmat      flowtype 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-16 03:43:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37d2dbb4b_1739677409
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4WjESR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cartograflow_v1.0.5-tikzDictionary"
