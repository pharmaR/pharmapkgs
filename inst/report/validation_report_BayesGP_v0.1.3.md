# Validation Report - BayesGP@0.1.3
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ziang Zhang <ziangzhang@uchicago.edu>                |
...
|     | package            | type      |
|:----|:-------------------|:----------|
| 1   | TMB (\>= 1.9.7)    | LinkingTo |
| 2   | RcppEigen          | LinkingTo |
| 3   | TMB (\>= 1.9.7)    | Imports   |
| 4   | numDeriv           | Imports   |
| 5   | rstan              | Imports   |
| 6   | sfsmisc            | Imports   |
| 7   | Matrix (\>= 1.6.3) | Imports   |
| 8   | aghq (\>= 0.4.1)   | Imports   |
| 9   | fda                | Imports   |
| 10  | tmbstan            | Imports   |
| 11  | LaplacesDemon      | Imports   |
| 12  | methods            | Imports   |
...
Overall the package has 19 exported objects. 19 are documented:
                 ...
                 compute_post_fun_iwp              compute_post_fun_sgp 
                                 TRUE                              TRUE 
     compute_weights_precision_helper                   custom_template 
                                 TRUE                              TRUE 
    extract_mean_interval_given_samps                                 f 
                                 TRUE                              TRUE 
         get_default_option_list_MCMC                global_poly_helper 
                                 TRUE                              TRUE 
               global_poly_helper_sgp                 local_poly_helper 
                                 TRUE                              TRUE 
                            model_fit                    model_fit_loop 
                                 TRUE                              TRUE 
                         para_density                        post_table 
                                 TRUE                              TRUE 
                 prior_conversion_iwp              prior_conversion_sgp 
                                 TRUE                              TRUE 
                  sample_fixed_effect                        sd_density 
                                 TRUE                              TRUE 
                              sd_plot 
                                 TRUE 
...
| Execution Time | 2025-02-15 03:35:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd77d57cd5_1739590509
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIKuC7F
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesGP_v0.1.3-tikzDictionary"
