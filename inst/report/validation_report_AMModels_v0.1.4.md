...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jon Katz <jonkatz4@gmail.com>                        |
...
Overall the package has 21 exported objects. 21 are documented:
              ...
              amData         ammlDesc       ammlDesc<-         ammlInfo 
                TRUE             TRUE             TRUE             TRUE 
          ammlInfo<-          amModel       amModelLib         dataMeta 
                TRUE             TRUE             TRUE             TRUE 
          dataMeta<-        getAMData       getAMModel   grepAMModelLib 
                TRUE             TRUE             TRUE             TRUE 
    insertAMModelLib           lsData         lsModels        modelMeta 
                TRUE             TRUE             TRUE             TRUE 
         modelMeta<-         modelMgr           rmData          rmModel 
                TRUE             TRUE             TRUE             TRUE 
        simCovariate 
                TRUE 
...
| Execution Time | 2025-02-14 06:52:30 UTC |
...
running this report
    ...
    PROCESSX_PS726d58feec35_1739515947
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpU7mLh5
