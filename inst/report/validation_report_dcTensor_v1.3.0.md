# Validation Report - dcTensor@1.3.0
...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Koki Tsuyuzaki <k.t.the-answer@hotmail.co.jp>        |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/rikenbit/dcTensor                 |
...
Overall the package has 9 exported objects. 9 are documented:
       ...
       djNMF     dNMF    dNMTF     dNTD     dNTF     dPLS   dsiNMF     dSVD 
...
| Execution Time | 2025-02-17 05:12:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bd684c9b8c_1739769117
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8iKkrj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dcTensor_v1.3.0-tikzDictionary"
