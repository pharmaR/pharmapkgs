# Validation Report - FastGaSP@0.6.0
...
Overall the package has 25 exported objects. 31 are documented:

       A_t_times_x_particle      A_times_x_particle         Construct_G_exp 
                       TRUE                    TRUE                    TRUE 
     Construct_G_matern_5_2         Construct_W_exp  Construct_W_matern_5_2 
                       TRUE                    TRUE                    TRUE 
           Construct_W0_exp Construct_W0_matern_5_2     extract_time_window 
                       TRUE                    TRUE                    TRUE 
         f_Vicsek_variation                   fgasp                    fmou 
                       TRUE                    TRUE                    TRUE 
       get_consecutive_data          Get_log_det_S2                 Get_Q_K 
                       TRUE                    TRUE                    TRUE 
                    Get_R_y                   gppca         IKF_CG_particle 
                       TRUE                    TRUE                    TRUE 
       IKF_CG_particle_cell                 log_lik               Sample_KF 
                       TRUE                    TRUE                    TRUE 
             Sample_KF_post       simulate_particle         trajectory_data 
                       TRUE                    TRUE                    TRUE 
                     Vicsek 
                       TRUE 
...
There are 41 help pages with examples, from 47 (87.23 %).
...
| Execution Time | 2025-02-19 05:16:30 UTC |
...
running this report
    ...
    PROCESSX_PS1d457c60428d_1739942184
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpls2YKm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FastGaSP_v0.6.0-tikzDictionary"
