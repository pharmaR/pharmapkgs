...
| size_codebase        | 922                                     |
| has_source_control   | https://github.com/paulnorthrop/bang    |
...
Overall the package has 7 exported objects. 7 are documented:
                ...
                hanova1                 hef            pp_check      set_user_prior 
                   TRUE                TRUE                TRUE                TRUE 
    sim_pred_beta_binom sim_pred_gamma_pois    sim_pred_hanova1 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-14 07:42:05 UTC |
...
running this report
    ...
    PROCESSX_PS1c0918d529b3_1739518922
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDicMT6
