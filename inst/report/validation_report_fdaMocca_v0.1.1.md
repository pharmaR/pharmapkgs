# Validation Report - fdaMocca@0.1.1
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Natalya Pya Arnqvist <nat.pya@gmail.com>             |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         criteria.mocca      estimate.mocca        logLik.mocca               mocca 
                   TRUE                TRUE                TRUE                TRUE 
             plot.mocca         print.mocca print.summary.mocca       summary.mocca 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-27 03:22:11 UTC |
...
running this report
    ...
    PROCESSX_PS1c62ef6b20e_1740626528
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKd7HhI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fdaMocca_v0.1.1-tikzDictionary"
