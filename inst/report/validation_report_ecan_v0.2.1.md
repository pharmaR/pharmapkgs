...
| export_help | 27 |
| has_website | TRUE |
| has_maintainer | Toshikazu Matsumura <matutosi@gmail.com> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/matutosi/ecan |
...
Overall the package has 27 exported objects. 26 are documented:
                        ...
                        %>%         add_mid_p_bin_w               bin_width 
                      FALSE                    TRUE                    TRUE 
              cls_add_group               cls_color                 cluster 
                       TRUE                    TRUE                    TRUE 
             cols_one2multi                df2table                 dist2df 
                       TRUE                    TRUE                    TRUE 
                   distance draw_layer_construction             gen_example 
                       TRUE                    TRUE                    TRUE 
                    ind_val          is_multi2multi            is_one2multi 
                       TRUE                    TRUE                    TRUE 
                 is_one2one               mid_point           ord_add_group 
                       TRUE                    TRUE                    TRUE 
          ord_extract_score                ord_plot              ordination 
                       TRUE                    TRUE                    TRUE 
                pad2longest               read_biss        select_one2multi 
                       TRUE                    TRUE                    TRUE 
                       shdi                table2df           unique_length 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-18 05:17:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bb445bea849_1739855815
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyHku68
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecan_v0.2.1-tikzDictionary"
