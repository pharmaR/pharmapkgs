...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Quinten Stokkink <q.a.stokkink@tudelft.nl>           |
...
Overall the package has 6 exported objects. 6 are documented:
                          ...
                          apng         APNG_BLEND_OP_OVER 
                          TRUE                       TRUE 
          APNG_BLEND_OP_SOURCE APNG_DISPOSE_OP_BACKGROUND 
                          TRUE                       TRUE 
          APNG_DISPOSE_OP_NONE   APNG_DISPOSE_OP_PREVIOUS 
                          TRUE                       TRUE 

### Examples

There are 0 help pages with examples, from 5 (0.00 %).
...
| Execution Time | 2025-02-14 07:18:31 UTC |
...
running this report
    ...
    PROCESSX_PS1c09714534a7_1739517508
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8a1gZC
