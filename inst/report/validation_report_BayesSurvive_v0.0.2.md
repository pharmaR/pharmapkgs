# Validation Report - BayesSurvive@0.0.2
...
| has_source_control   | https://github.com/ocbe-uio/BayesSurvive |
...
|:----|:----------------------------|:----------|
| 1   | Rcpp                        | LinkingTo |
| 2   | RcppArmadillo (\>= 0.9.000) | LinkingTo |
| 3   | Rcpp                        | Imports   |
| 4   | ggplot2                     | Imports   |
| 5   | GGally                      | Imports   |
| 6   | mvtnorm                     | Imports   |
| 7   | survival                    | Imports   |
| 8   | riskRegression              | Imports   |
| 9   | utils                       | Imports   |
| 10  | stats                       | Imports   |
...
Overall the package has 7 exported objects. 7 are documented:
       ...
       BayesSurvive       func_MCMC func_MCMC_graph       plotBrier     UpdateGamma 
...
| Execution Time | 2025-02-15 03:41:34 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4bced039_1739590890
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeBcNPt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesSurvive_v0.0.2-tikzDictionary"
