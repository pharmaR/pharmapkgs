...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel M. Griffith <griffith.dan@gmail.com>          |
...
Overall the package has 8 exported objects. 8 are documented:
            ...
            cooccur create.N.matrix    effect.sizes       obs.v.exp            pair 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    pair.attributes    pair.profile      prob.table 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 03:52:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6498c350e_1739764329
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3DQvDb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cooccur_v1.3-tikzDictionary"
