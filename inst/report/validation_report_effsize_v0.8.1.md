# Validation Report - effsize@0.8.1
...
| export_help          | 4                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Marco Torchiano <marco.torchiano@polito.it> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/mtorchiano/effsize/      |
| has_bug_reports_url  | 1                                           |
| downloads_1yr        | 120956                                      |
...
adventr, atable, condir, Counternull, dabestr, flowGraph, LongDat, mbir,
multifear, psyntur, regtomean, ScottKnottESD, shipunov, sprtt,
tidystats, topics
...
Overall the package has 4 exported objects. 4 are documented:
      ...
      cliff.delta       cohen.d print.effsize          VD.A 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 03:48:03 UTC |
...
running this report
    ...
    PROCESSX_PS1d454e954ca3_1739936877
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB7ev4u
...
These are the options set to generate the report:
    ...
    [1] "validation_report_effsize_v0.8.1-tikzDictionary"
