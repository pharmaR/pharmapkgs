...
| export_help          | 32                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Christina Harvey <harveyca@umich.edu>  |
| bugs_status          | subscript out of bounds                |
| size_codebase        | 1392                                   |
| has_source_control   | https://github.com/charvey23/AvInertia |
...
Overall the package has 32 exported objects. 32 are documented:
    ...
    calc_inertia_conesolid calc_inertia_cylhollow  calc_inertia_cylsolid 
                      TRUE                   TRUE                   TRUE 
      calc_inertia_ellcone    calc_inertia_ellcyl   calc_inertia_ellipse 
                      TRUE                   TRUE                   TRUE 
    calc_inertia_platerect  calc_inertia_platetri calc_inertia_pyrasolid 
                      TRUE                   TRUE                   TRUE 
                  calc_rot            calc_univec   combine_inertialprop 
                      TRUE                   TRUE                   TRUE 
      compute_feat_inertia      density_optimizer        kronecker_delta 
                      TRUE                   TRUE                   TRUE 
         massprop_birdwing         massprop_bones      massprop_feathers 
                      TRUE                   TRUE                   TRUE 
             massprop_head       massprop_muscles          massprop_neck 
                      TRUE                   TRUE                   TRUE 
               massprop_pm      massprop_restbody          massprop_skin 
                      TRUE                   TRUE                   TRUE 
             massprop_tail         massprop_torso         orient_feather 
                      TRUE                   TRUE                   TRUE 
              parallelaxis             plot_CGloc                   rotx 
                      TRUE                   TRUE                   TRUE 
                store_data    structural2VRP_feat 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-14 07:35:53 UTC |
...
running this report
    ...
    PROCESSX_PS1c0969670912_1739518550
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpscYJO0
