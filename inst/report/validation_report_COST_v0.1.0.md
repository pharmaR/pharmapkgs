...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yanlin Tang <yanlintang2018@163.com>                 |
...
Overall the package has 15 exported objects. 15 are documented:
             ...
             Data.COST   example.forecast example.prediction       Forecasts.CF 
                  TRUE               TRUE               TRUE               TRUE 
      Forecasts.COST.G   Forecasts.COST.t       Forecasts.GP            logL.CF 
                  TRUE               TRUE               TRUE               TRUE 
           logL.COST.G        logL.COST.t            logL.GP Predictions.COST.G 
                  TRUE               TRUE               TRUE               TRUE 
    Predictions.COST.t     Predictions.GP  rank.multivariate 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:03:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6132a7f38_1739764987
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkclyRG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_COST_v0.1.0-tikzDictionary"
