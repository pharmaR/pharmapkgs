...
Overall the package has 52 exported objects. 52 are documented:
              ...
              biv.plot           biv.test             canomi            compana 
                  TRUE               TRUE               TRUE               TRUE 
                domain             dunnfa             eisera               enfa 
                  TRUE               TRUE               TRUE               TRUE 
            engen2008I        engen2008II             gnesfa          hist.enfa 
                  TRUE               TRUE               TRUE               TRUE 
          hist.kselect        hist.madifa          histniche      kplot.kselect 
                  TRUE               TRUE               TRUE               TRUE 
               kselect             madifa          mahasuhab         niche.test 
                  TRUE               TRUE               TRUE               TRUE 
           plot.canomi       plot.kselect        plot.madifa            plot.wi 
                  TRUE               TRUE               TRUE               TRUE 
          predict.enfa     predict.madifa           prepksel       print.canomi 
                  TRUE               TRUE               TRUE               TRUE 
         print.compana       print.dunnfa         print.enfa   print.engenetalI 
                  TRUE               TRUE               TRUE               TRUE 
     print.engenetalII          print.esr       print.gnesfa      print.kselect 
                  TRUE               TRUE               TRUE               TRUE 
          print.madifa print.rand.kselect          print.wiI         print.wiII 
                  TRUE               TRUE               TRUE               TRUE 
           print.wiIII         profilehab       rand.kselect      randtest.enfa 
                  TRUE               TRUE               TRUE               TRUE 
              s.madifa       scatter.enfa        scatter.esr     scatter.madifa 
                  TRUE               TRUE               TRUE               TRUE 
          scatterniche             widesI            widesII           widesIII 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-14 06:36:39 UTC |
...
running this report
    ...
    PROCESSX_PS726d248db0a1_1739514996
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJWg6p8
