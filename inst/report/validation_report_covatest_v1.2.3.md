# Validation Report - covatest@1.2.3
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Sandra De Iaco <sandra.deiaco@unisalento.it>         |
...
| 9   | zoo                   | Imports |
| 10  | gstat                 | Imports |
| 11  | sp (\>= 0.9-72)       | Imports |
| 12  | spacetime (\>= 1.0-0) | Imports |
...
Overall the package has 9 exported objects. 13 are documented:

         blocks     couples  covablocks    covaprop    covastat   covastatM 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
    read.STdata    sepindex     setzero 
           TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 04:06:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65670124e_1739765178
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprSo9pM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covatest_v1.2.3-tikzDictionary"
