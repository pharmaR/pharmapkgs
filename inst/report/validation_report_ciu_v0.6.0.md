...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Kary Främling <Kary.Framling@umu.se>                 |
...
Overall the package has 16 exported objects. 16 are documented:
                    ...
                    ciu         ciu.barplot         ciu.explain          ciu.ggplot 
                   TRUE                TRUE                TRUE                TRUE 
         ciu.ggplot.col   ciu.list.to.frame    ciu.meta.explain ciu.meta.result.new 
                   TRUE                TRUE                TRUE                TRUE 
                ciu.new             ciu.pie            ciu.plot         ciu.plot.3D 
                   TRUE                TRUE                TRUE                TRUE 
           ciu.relative      ciu.result.new         ciu.textual          ciu.to.CIU 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:23:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bc320dcb602_1739679828
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVmKIPK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ciu_v0.6.0-tikzDictionary"
