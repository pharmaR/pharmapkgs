# Validation Report - CompositionalRF@1.0
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | Compositional            | Imports |
| 2   | doParallel               | Imports |
| 3   | foreach                  | Imports |
| 4   | MultivariateRandomForest | Imports |
| 5   | Rfast                    | Imports |
| 6   | stats                    | Imports |
...
| Execution Time | 2025-02-17 03:37:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67f1bf177_1739763441
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDZLBSF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CompositionalRF_v1.0-tikzDictionary"
