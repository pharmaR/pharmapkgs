# Validation Report - excel2eprime@0.4.0
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Jack Will <wujackwill@outlook.com>                   |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/wujackwill/excel2eprime           |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    excel2eprime_example             split_12             split_22 
                    TRUE                 TRUE                 TRUE 
               split_222          split_basic 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:48:18 UTC |
...
running this report
    ...
    PROCESSX_PS1d454bc7fab9_1739940491
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRGD2g8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_excel2eprime_v0.4.0-tikzDictionary"
