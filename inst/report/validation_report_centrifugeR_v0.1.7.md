# Validation Report - centrifugeR@0.1.7
...
| export_help          | 9                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Duy Nghia Pham <nghiapham@yandex.com> |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | pracma (\>= 2.4.2)      | Imports |
| 2   | shiny (\>= 1.7.4)       | Imports |
| 3   | shinythemes (\>= 1.2.0) | Imports |
| 4   | grDevices               | Imports |
| 5   | graphics                | Imports |
| 6   | utils                   | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          launch          p2c         pie2        rotor   rotorCheck   rotorEqual 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      rotorSpeed rotorUnequal  rotorVerify 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:01:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36613deae_1739678470
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1ErUi8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_centrifugeR_v0.1.7-tikzDictionary"
