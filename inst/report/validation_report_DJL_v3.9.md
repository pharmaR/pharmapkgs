...
| export_help          | 24                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Dong-Joon Lim <tgno3.com@gmail.com>                  |
...
Overall the package has 24 exported objects. 24 are documented:
                ...
                dm.ddf             dm.dea      dm.dynamic.bc             dm.hdf 
                  TRUE               TRUE               TRUE               TRUE 
        dm.mahalanobis     dm.network.dea             dm.sbm              dm.sf 
                  TRUE               TRUE               TRUE               TRUE 
            ma.aps.reg           map.corr        map.soa.ddf        map.soa.dea 
                  TRUE               TRUE               TRUE               TRUE 
           map.soa.hdf        map.soa.sbm         map.soa.sf                plp 
                  TRUE               TRUE               TRUE               TRUE 
               roc.dea            roc.hdf      roc.malmquist             roc.sf 
                  TRUE               TRUE               TRUE               TRUE 
    target.arrival.dea target.arrival.hdf  target.arrival.sf    target.spec.dea 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 04:24:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43b859f59_1739852666
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVfGhJg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DJL_v3.9-tikzDictionary"
