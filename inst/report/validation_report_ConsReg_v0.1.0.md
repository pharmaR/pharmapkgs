# Validation Report - ConsReg@0.1.0
...
| export_help          | 3                                  |
| has_website          | TRUE                               |
| has_maintainer       | Josep Puig <puigjos@gmail.com>     |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/puigjos/ConsReg |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | data.table (\>= 1.10) | Imports |
| 2   | forecast (\>= 8.0)    | Imports |
| 3   | rlang (\>= 0.4)       | Imports |
| 4   | nloptr (\>= 1.2)      | Imports |
| 5   | FME (\>= 1.3)         | Imports |
| 6   | MCMCpack (\>= 1.4)    | Imports |
| 7   | Rsolnp (\>= 1.15)     | Imports |
| 8   | DEoptim (\>= 2.2)     | Imports |
| 9   | dfoptim               | Imports |
| 10  | GA (\>= 3.0)          | Imports |
| 11  | GenSA (\>= 1.1)       | Imports |
| 12  | Metrics               | Imports |
| 13  | ggplot2               | Imports |
| 14  | adaptMCMC             | Imports |
| 15  | Rcpp                  | Imports |
...
| Execution Time | 2025-02-17 03:48:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64539926_1739764076
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprutTuS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ConsReg_v0.1.0-tikzDictionary"
