# Validation Report - dcmodify@0.9.0
...
| has_source_control   | https://github.com/data-cleaning/dcmodify   |
...
| 1   | methods                | Depends |
| 2   | yaml                   | Imports |
| 3   | validate (\>= 1.1.3)   | Imports |
| 4   | lumberjack (\>= 1.3.1) | Imports |
| 5   | settings               | Imports |
| 6   | utils                  | Imports |
...
Overall the package has 17 exported objects. 17 are documented:
          ...
          as_yaml   description description<-         do_by   export_yaml 
             TRUE          TRUE          TRUE          TRUE          TRUE 
            label       label<-        max_by       mean_by        min_by 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         modifier        modify     modify_so        origin      origin<- 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           sum_by     variables 
             TRUE         FALSE 
...
| Execution Time | 2025-02-17 05:11:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65a6614e2_1739769059
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvgsaRC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dcmodify_v0.9.0-tikzDictionary"
