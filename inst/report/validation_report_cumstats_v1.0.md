# Validation Report - cumstats@1.0
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Arturo Erdely <arturo.erdely@comunidad.unam.mx>      |
...
Overall the package has 12 exported objects. 12 are documented:
     ...
     cumgmean  cumhmean   cumkurt   cummean cummedian   cummode  cumquant   cumskew 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
       cumvar  kurtosis      Mode  skewness 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-17 04:38:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64131c76d_1739767131
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpETzIww
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cumstats_v1.0-tikzDictionary"
