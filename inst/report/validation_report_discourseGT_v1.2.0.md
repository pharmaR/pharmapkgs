# Validation Report - discourseGT@1.2.0
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Qi Cui <q1cui@ucsd.edu>                              |
...
Overall the package has 11 exported objects. 11 are documented:
               ...
               basicPlot      coreNetAnalysis         edgelist_raw 
                    TRUE                 TRUE                 TRUE 
                plot1Att             plot2Att          plotNGTData 
                    TRUE                 TRUE                 TRUE 
           prepareGraphs subgroupsNetAnalysis           summaryNet 
                    TRUE                 TRUE                 TRUE 
          tabulate_edges            writeData 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-18 04:12:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43a4871da_1739851949
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmps4f48X
...
These are the options set to generate the report:
    ...
    [1] "validation_report_discourseGT_v1.2.0-tikzDictionary"
