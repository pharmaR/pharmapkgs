# Validation Report - Factoshiny@2.7
...
|     | package                    | type    |
|:----|:---------------------------|:--------|
| 1   | FactoMineR (\>= 2.3)       | Depends |
| 2   | shiny                      | Depends |
| 3   | FactoInvestigate (\>= 1.5) | Depends |
| 4   | ggplot2                    | Depends |
| 5   | DT                         | Imports |
| 6   | colourpicker               | Imports |
| 7   | grDevices                  | Imports |
| 8   | tcltk                      | Imports |
| 9   | ggrepel                    | Imports |
| 10  | shinydashboard             | Imports |
| 11  | shinyjqui                  | Imports |
| 12  | missMDA                    | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
            ...
            CAshiny     catdesshiny     condesshiny      Factoshiny       FAMDshiny 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          HCPCshiny        MCAshiny        MFAshiny        PCAshiny   print.CAshiny 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    print.FAMDshiny print.HCPCshiny  print.MCAshiny  print.PCAshiny 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 05:06:16 UTC |
...
running this report
    ...
    PROCESSX_PS1d451a5639bc_1739941569
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpdrh1ru
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Factoshiny_v2.7-tikzDictionary"
