# Validation Report - copcor@2024.7.31
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    cove.boost.collapse.strata            draw.x.axis.cor 
                          TRUE                       TRUE 
                      get.xlim       marker.name.to.assay 
                          TRUE                       TRUE 
                           pcr                       pcr2 
                          TRUE                       TRUE 
          predictCompetingRisk      predictCompetingRisk2 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-17 03:53:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63bd4416e_1739764405
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPoq8Da
...
These are the options set to generate the report:
    ...
    [1] "validation_report_copcor_v2024.7.31-tikzDictionary"
