# Validation Report - bodycomp@1.0.0
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Gleidson Mendes Rebouças <gleidsonreboucas@uern.br>  |
...
Overall the package has 12 exported objects. 12 are documented:
             ...
             Durnin.4sites          Guedes.3sites         Jackson.3sites 
                      TRUE                   TRUE                   TRUE 
            Jackson.7sites        Petroski.2sites        Petroski.3sites 
                      TRUE                   TRUE                   TRUE 
           Petroski.4sites       Slaughter.2sites Slaughter.2sites.Matur 
                      TRUE                   TRUE                   TRUE 
              Sloan.2sites            YMCA.3sites            YMCA.4sites 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:30:11 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd696c5b5d_1739593806
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOHBD0J
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bodycomp_v1.0.0-tikzDictionary"
