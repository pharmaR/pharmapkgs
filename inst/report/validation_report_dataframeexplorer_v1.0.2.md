# Validation Report - dataframeexplorer@1.0.2
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Ashrith Reddy <ashrithssreddy@gmail.com>             |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    detect_const_cols  detect_dupl_cols   frequency_table   glimpse_to_file 
                 TRUE              TRUE              TRUE              TRUE 
        level_of_data percentiles_table 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:57:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6f5edd4d_1739768267
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwFolLK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dataframeexplorer_v1.0.2-tikzDictionary"
