# Validation Report - CovTools@0.5.4
...
| export_help          | 22                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Kisung You <kisungyou@outlook.com>                   |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/kisungyou/CovTools                |
...
Overall the package has 22 exported objects. 22 are documented:
            ...
            BCovTest1.mxPBF        BDiagTest1.mxPBF                 CovDist 
                       TRUE                    TRUE                    TRUE 
              CovEst.2003LW          CovEst.2010OAS         CovEst.2010RBLW 
                       TRUE                    TRUE                    TRUE 
            CovEst.adaptive             CovEst.hard           CovEst.hardPD 
                       TRUE                    TRUE                    TRUE 
              CovEst.nearPD             CovEst.soft                 CovMean 
                       TRUE                    TRUE                    TRUE 
           CovTest1.2013Cai CovTest1.2014Srivastava        CovTest2.2013Cai 
                       TRUE                    TRUE                    TRUE 
          DiagTest1.2011Cai       DiagTest1.2015Lan           PreEst.2014An 
                       TRUE                    TRUE                    TRUE 
        PreEst.2014Banerjee          PreEst.2017Lee           PreEst.glasso 
                       TRUE                    TRUE                    TRUE 
                 samplecovs 
                       TRUE 
...
| Execution Time | 2025-02-17 04:09:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd612b7f8b7_1739765394
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRgwi5j
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CovTools_v0.5.4-tikzDictionary"
