# Validation Report - cplm@0.7.12.1
...
| export_help          | 32                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Yanwei (Wayne) Zhang <actuary_zhang@hotmail.com>     |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/actuaryzhang/cplm                 |
...
actuaRE, ChainLadder, GlmSimulatoR, HeritSeq, insight, Maaslin2,
parameters, performance

## Namespace

Overall the package has 9 exported objects. 10 are documented:

     bcplm    bsp  cpglm cpglmm   getF   gini  plotF   sp2d     tp 
...
| Execution Time | 2025-02-17 04:13:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bd616f81229_1739765611
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyAnaUS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cplm_v0.7.12.1-tikzDictionary"
