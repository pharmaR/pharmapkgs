# Validation Report - DiceEval@1.6.1
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | C. Helbert <Celine.Helbert@ec-lyon.fr>               |
...
Overall the package has 14 exported objects. 12 are documented:

        crossValidation           formulaAm           formulaLm                 MAE 
                   TRUE               FALSE               FALSE                TRUE 
        modelComparison            modelFit        modelPredict     penaltyPolyMARS 
                   TRUE                TRUE                TRUE                TRUE 
                     R2      residualsStudy                 RMA                RMSE 
                   TRUE                TRUE                TRUE                TRUE 
          stepEvolution testCrossValidation 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-18 03:59:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bb438708e2a_1739851187
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2PtQiE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiceEval_v1.6.1-tikzDictionary"
