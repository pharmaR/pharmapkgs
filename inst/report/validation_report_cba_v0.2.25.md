...
| export_help          | 24                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Christian Buchta <christian.buchta@wu.ac.at>         |
...
CellTrails, DiffLogo, greed, proxy, rattle, scde

## Namespace

Overall the package has 24 exported objects. 24 are documented:

               as.dummy              ccfkms     circleplot.dist             clmplot 
                   TRUE                TRUE                TRUE                TRUE 
           cluster.dist                gknn              implot              lmplot 
                   TRUE                TRUE                TRUE                TRUE 
       order.data.frame          order.dist        order.greedy        order.length 
                   TRUE                TRUE                TRUE                TRUE 
           order.matrix       order.optimal            proximus              rlbmat 
                   TRUE                TRUE                TRUE                TRUE 
            rockCluster            rockLink              sdists       sdists.center 
                   TRUE                TRUE                TRUE                TRUE 
    sdists.center.align        sdists.trace              stress         stress.dist 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-22 03:21:38 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb40c5ea52_1740194494
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbIxp9H
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cba_v0.2.25-tikzDictionary"
