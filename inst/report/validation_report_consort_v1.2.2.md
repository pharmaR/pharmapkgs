# Validation Report - consort@1.2.2
...
| export_help          | 13                                 |
| has_website          | TRUE                               |
| has_maintainer       | Alim Dayim <ad938@cam.ac.uk>       |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/adayim/consort/ |
...
Overall the package has 13 exported objects. 13 are documented:
          ...
          add_box add_label_box  add_side_box     add_split    build_grid 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      build_grviz   connect_box  consort_plot      gen_text    get_coords 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     grid.textbox      move_box       textbox 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 03:47:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66eca38a2_1739764047
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvT5bTK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_consort_v1.2.2-tikzDictionary"
