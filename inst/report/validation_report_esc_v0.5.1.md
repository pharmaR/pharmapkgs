...
metaConvert, multifear, rmcorr

## Namespace

Overall the package has 30 exported objects. 30 are documented:

           cohens_d        cohens_f     combine_esc convert_d2etasq     convert_d2f 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    convert_d2logit    convert_d2or     convert_d2r    convert_or2d     convert_r2z 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        convert_z2r    effect_sizes         esc_2x2           esc_B        esc_beta 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       esc_bin_prop       esc_chisq           esc_f   esc_mean_gain     esc_mean_sd 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        esc_mean_se         esc_phi         esc_rpb           esc_t     eta_squared 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           hedges_g        log_odds      odds_ratio      pearsons_r       write_esc 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 04:28:53 UTC |
...
running this report
    ...
    PROCESSX_PS1d454b06d1f0_1739939327
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb4ctoo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_esc_v0.5.1-tikzDictionary"
