# Validation Report - CopCTS@1.0.0
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Fuyuan David Li <LFY@gwmail.gwu.edu>                 |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    condQestCopC      estCopC   genLatentY   selectCopC 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-17 03:53:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6b09266a_1739764411
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaAvvAg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CopCTS_v1.0.0-tikzDictionary"
