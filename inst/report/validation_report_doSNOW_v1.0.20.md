# Validation Report - doSNOW@1.0.20
...
adductomicsR, atakrig, AUCell, autostsm, avotrex, bagged.outliertrees,
bayNorm, betapart, brada, BuyseTest, cdcatR, cdmTools, ClustAll,
CRTConjoint, datanugget, DepecheR, E4tools, ecocbo, eicm, enmpa, EpiMix,
exuber, ezCutoffs, fHMM, florabr, FourWayHMM, GFM, gofCopula, gscaLCA,
heterocop, ILoReg, iprior, lcc, LEGIT, lordif, M3C, MatrixHMM,
MatrixMixtures, MetaNet, misspi, moc.gapbk, moderate.mediation, mop,
mpower, msPurity, NetworkExtinction, NeuroDecodeR, nimbleCarbon,
paxtoolsr, pctax, pcutils, preciseTAD, purgeR, PWEXP, rcarbon,
rcellminer, rcontroll, RCTS, ReporterScore, ResIN, RprobitB, rrepast,
scBio, scpi, SEMdeep, SenTinMixt, seqimpute, sgsR, ShortForm, simDAG,
smam, speaq, SPUTNIK, starvars, STATegRa, transcriptogramer, tsmp,
VertexWiseR, WaverideR, wflo
...
| Execution Time | 2025-02-18 04:35:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46dca5360_1739853352
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2CusIG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doSNOW_v1.0.20-tikzDictionary"
