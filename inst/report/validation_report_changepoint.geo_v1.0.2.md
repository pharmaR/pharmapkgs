# Validation Report - changepoint.geo@1.0.2
...
| export_help          | 26                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Rebecca Killick <r.killick@lancaster.ac.uk>          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/grundy95/changepoint.geo/         |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 3325                                                 |
| reverse_dependencies | 0                                                    |
| has_examples         | 0.5208333                                            |
| dependencies         | 6                                                    |
| license              | GPL                                                  |
...
|:----|:---------------|:--------|
| 1   | R(\>= 3.6)     | Depends |
| 2   | changepoint    | Depends |
| 3   | changepoint.np | Depends |
| 4   | methods        | Depends |
| 5   | ggplot2        | Depends |
| 6   | Rdpack         | Imports |
...
Overall the package has 3 exported objects. 23 are documented:

       angle.mapping distance.mapping           geomcp 
                TRUE             TRUE             TRUE 

### Examples

There are 25 help pages with examples, from 48 (52.08 %).
...
| Execution Time | 2025-02-16 04:07:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34a8c58e8_1739678843
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTwFzvh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_changepoint.geo_v1.0.2-tikzDictionary"
