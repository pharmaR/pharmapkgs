# Validation Report - cpsvote@0.1.0
...
| export_help          | 10                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Jay Lee <jaylee@reed.edu>            |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/Reed-EVIC/cpsvote |
...
Overall the package has 10 exported objects. 9 are documented:
                     ...
                     %>%    cps_download_data    cps_download_docs 
                   FALSE                 TRUE                 TRUE 
               cps_label       cps_load_basic             cps_read 
                    TRUE                 TRUE                 TRUE 
           cps_read_year      cps_recode_vote         cps_refactor 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-17 04:16:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6529949b0_1739765774
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9fb5Dk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cpsvote_v0.1.0-tikzDictionary"
