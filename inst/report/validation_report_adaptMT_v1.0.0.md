...
| export_help          | 14                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Lihua Lei <lihua.lei@berkeley.edu>    |
| bugs_status          | 0.6666667                             |
| size_codebase        | 1293                                  |
| has_source_control   | https://github.com/lihualei71/adaptMT |
...
Overall the package has 14 exported objects. 14 are documented:
                  ...
                  adapt           adapt_gam           adapt_glm        adapt_glmnet 
                   TRUE                TRUE                TRUE                TRUE 
            beta_family           corr_lfdr           ctgm_lfdr     gen_adapt_model 
                   TRUE                TRUE                TRUE                TRUE 
         gen_exp_family inv_gaussian_family        plot_1d_lfdr      plot_1d_thresh 
                   TRUE                TRUE                TRUE                TRUE 
           plot_2d_lfdr      plot_2d_thresh 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-14 06:34:56 UTC |
...
running this report
    ...
    PROCESSX_PS726d4a3d3dab_1739514893
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2JfM8b
