# Validation Report - BrownDog@0.2.1
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yan Zhao <yanzhao3@illinois.edu>                     |
...
Overall the package has 6 exported objects. 6 are documented:
          ...
          convert_file           download       extract_file            get_key 
                  TRUE               TRUE               TRUE               TRUE 
    get_output_formats          get_token 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:46:45 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1205b04b_1739594800
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyjS4GO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BrownDog_v0.2.1-tikzDictionary"
