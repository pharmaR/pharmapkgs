# Validation Report - DendroSync@0.1.4
...
| export_help | 15 |
| has_website | TRUE |
| has_maintainer | Josu G. Alday <josucham@gmail.com> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://bitbucket.org/josucham/dendrosync/src/issues/ |
...
Overall the package has 15 exported objects. 15 are documented:
            ...
            bet.aSE     bet.het.aSE       csbet.aSE   csbet.het.aSE        cswi.aSE 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       cswi.het.aSE   dendro.varcov         gen.aSE     gen.het.aSE         het.var 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          mod.table            sync       sync.plot      sync.trend sync.trend.plot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 03:41:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47028a613_1739850077
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2Yz8ie
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DendroSync_v0.1.4-tikzDictionary"
