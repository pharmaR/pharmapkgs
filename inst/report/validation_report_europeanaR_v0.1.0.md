# Validation Report - europeanaR@0.1.0
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Alexandros Kouretsis <akourets@ionio.gr>             |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/AleKoure/europeanaR               |
...
Overall the package has 7 exported objects. 7 are documented:
          ...
          download_media              get_key     query_record_api 
                    TRUE                 TRUE                 TRUE 
        query_search_api              set_key tidy_cursored_search 
                    TRUE                 TRUE                 TRUE 
       tidy_search_items 
                    TRUE 
...
| Execution Time | 2025-02-19 04:36:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d45580eb783_1739939808
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuDi0Vl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_europeanaR_v0.1.0-tikzDictionary"
