...
| export_help          | 18                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Housen Chu <hchu@lbl.gov>               |
| bugs_status          | subscript out of bounds                 |
| size_codebase        | 1206                                    |
| has_source_control   | https://github.com/chuhousen/amerifluxr |
...
Overall the package has 18 exported objects. 18 are documented:
       ...
       amf_check_site_id    amf_data_coverage    amf_download_base 
                    TRUE                 TRUE                 TRUE 
        amf_download_bif     amf_extract_badm      amf_filter_base 
                    TRUE                 TRUE                 TRUE 
           amf_list_data    amf_list_metadata   amf_parse_basename 
                    TRUE                 TRUE                 TRUE 
    amf_plot_datasummary    amf_plot_datayear        amf_read_base 
                    TRUE                 TRUE                 TRUE 
            amf_read_bif        amf_site_info            amf_sites 
                    TRUE                 TRUE                 TRUE 
      amf_summarize_data         amf_var_info        amf_variables 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-14 06:51:59 UTC |
...
running this report
    ...
    PROCESSX_PS726d3a26328b_1739515916
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpp0gxbM
