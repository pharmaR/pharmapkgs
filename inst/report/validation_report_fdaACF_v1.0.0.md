# Validation Report - fdaACF@1.0.0
...
| export_help | 17 |
| has_website | TRUE |
| has_maintainer | Guillermo Mestre Marcos <guillermo.mestre@comillas.edu> |
| has_source_control | https://github.com/GMestreM/fdaACF |
...
Overall the package has 17 exported objects. 17 are documented:
        ...
        estimate_iid_distr_Imhof        estimate_iid_distr_MC 
                            TRUE                         TRUE 
                   fit_ARHp_FPCA           FTS_identification 
                            TRUE                         TRUE 
               integral_operator                       mat2fd 
                            TRUE                         TRUE 
          obtain_autocorrelation   obtain_autocov_eigenvalues 
                            TRUE                         TRUE 
           obtain_autocovariance                  obtain_FACF 
                            TRUE                         TRUE 
                    obtain_FPACF        obtain_suface_L2_norm 
                            TRUE                         TRUE 
             plot_autocovariance                    plot_FACF 
                            TRUE                         TRUE 
         reconstruct_fd_from_PCA simulate_iid_brownian_bridge 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-27 03:21:49 UTC |
...
running this report
    ...
    PROCESSX_PS1c6226024be5_1740626505
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuVMNuR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fdaACF_v1.0.0-tikzDictionary"
