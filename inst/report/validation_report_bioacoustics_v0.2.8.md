# Validation Report - bioacoustics@0.2.8
...
| export_help          | 13                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Jean Marchal <jean.marchal@wavx.ca>   |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/wavx/bioacoustics/ |
...
| 5   | methods            | Imports   |
| 6   | moments            | Imports   |
| 7   | Rcpp (\>= 0.12.13) | Imports   |
| 8   | stringr            | Imports   |
| 9   | tools              | Imports   |
| 10  | tuneR (\>= 1.3.0)  | Imports   |
...
Overall the package has 13 exported objects. 13 are documented:
         ...
         blob_detection               fspec            metadata          mp3_to_wav 
                   TRUE                TRUE                TRUE                TRUE 
                plot_zc          read_audio            read_mp3            read_wac 
                   TRUE                TRUE                TRUE                TRUE 
               read_wav             read_zc             spectro threshold_detection 
                   TRUE                TRUE                TRUE                TRUE 
               write_zc 
                   TRUE 
...
| Execution Time | 2025-02-15 04:11:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd661c7ce1_1739592669
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTsEKKo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bioacoustics_v0.2.8-tikzDictionary"
