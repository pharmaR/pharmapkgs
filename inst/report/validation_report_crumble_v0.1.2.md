# Validation Report - crumble@0.1.2
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Nicholas Williams <ntwilliams.personal@gmail.com>    |
...
| 11  | generics         | Imports |
| 12  | lmtp             | Imports |
| 13  | mlr3superlearner | Imports |
| 14  | progressr        | Imports |
| 15  | ife (\>= 0.1.0)  | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
              ...
              crumble   crumble_control sequential_module              tidy 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:27:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bd641fe23fb_1739766449
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRse7o7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crumble_v0.1.2-tikzDictionary"
