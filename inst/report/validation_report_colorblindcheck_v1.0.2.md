# Validation Report - colorblindcheck@1.0.2
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    palette_bivariate_plot          palette_check           palette_dist 
                      TRUE                   TRUE                   TRUE 
              palette_plot 
                      TRUE 
...
| Execution Time | 2025-02-16 04:58:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35fc6c72c_1739681924
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmph5iqtu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colorblindcheck_v1.0.2-tikzDictionary"
