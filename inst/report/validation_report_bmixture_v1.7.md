# Validation Report - bmixture@1.7
...
Overall the package has 19 exported objects. 19 are documented:
            ...
            bmixgamma          bmixnorm             bmixt         dmixgamma 
                 TRUE              TRUE              TRUE              TRUE 
             dmixnorm             dmixt    plot.bmixgamma     plot.bmixnorm 
                 TRUE              TRUE              TRUE              TRUE 
           plot.bmixt   print.bmixgamma    print.bmixnorm       print.bmixt 
                 TRUE              TRUE              TRUE              TRUE 
           rdirichlet         rmixgamma          rmixnorm             rmixt 
                 TRUE              TRUE              TRUE              TRUE 
    summary.bmixgamma  summary.bmixnorm     summary.bmixt 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:26:54 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd694d0b44_1739593609
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeNLf8P
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bmixture_v1.7-tikzDictionary"
