# Validation Report - deepredeff@0.1.1
...
| export_help | 8 |
| has_website | TRUE |
| has_maintainer | Ruth Kristianingsih <ruth.kristianingsih30@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/ruthkr/deepredeff/ |
...
Overall the package has 8 exported objects. 7 are documented:
                   ...
                   %>%          aas_to_df       aasset_to_df     encode_integer 
                 FALSE               TRUE               TRUE               TRUE 
        encode_one_hot        fasta_to_df install_tensorflow   predict_effector 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 03:35:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45aab5fcf_1739849730
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFFXOOT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deepredeff_v0.1.1-tikzDictionary"
