...
| export_help          | 4                                 |
| has_website          | TRUE                              |
| has_maintainer       | Daniel Touw <touw@ese.eur.nl>     |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/djwtouw/CCMMR/ |
...
|     | package              | type      |
|:----|:---------------------|:----------|
| 1   | RANN (\>= 2.6.1)     | Imports   |
| 2   | Rcpp (\>= 1.0.7)     | Imports   |
| 3   | methods (\>= 4.1.0)  | Imports   |
| 4   | graphics (\>= 4.1.0) | Imports   |
| 5   | Rcpp                 | LinkingTo |
...
Overall the package has 4 exported objects. 4 are documented:
              ...
              clusters  convex_clustering convex_clusterpath     sparse_weights 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 03:54:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34c27ffa3_1739678049
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqtIBbB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CCMMR_v0.2.1-tikzDictionary"
