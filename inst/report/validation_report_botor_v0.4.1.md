...
Overall the package has 40 exported objects. 40 are documented:
                 ...
                 boto3_version                      botor 
                          TRUE                       TRUE 
                  botor_client               check_s3_uri 
                          TRUE                       TRUE 
                 expect_s3_uri                        iam 
                          TRUE                       TRUE 
                  iam_get_user                 iam_whoami 
                          TRUE                       TRUE 
                       kinesis    kinesis_describe_stream 
                          TRUE                       TRUE 
           kinesis_get_records kinesis_get_shard_iterator 
                          TRUE                       TRUE 
            kinesis_put_record                        kms 
                          TRUE                       TRUE 
                   kms_decrypt           kms_decrypt_file 
                          TRUE                       TRUE 
                   kms_encrypt           kms_encrypt_file 
                          TRUE                       TRUE 
         kms_generate_data_key                 mime_guess 
                          TRUE                       TRUE 
                            s3                    s3_copy 
                          TRUE                       TRUE 
                     s3_delete           s3_download_file 
                          TRUE                       TRUE 
                     s3_exists            s3_list_buckets 
                          TRUE                       TRUE 
                         s3_ls                  s3_object 
                          TRUE                       TRUE 
         s3_put_object_tagging                    s3_read 
                          TRUE                       TRUE 
                s3_upload_file                   s3_write 
                          TRUE                       TRUE 
                            sm              sm_get_secret 
                          TRUE                       TRUE 
                           ssm          ssm_get_parameter 
                          TRUE                       TRUE 
                    sts_whoami                test_s3_uri 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-15 04:36:25 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd649ffc75_1739594180
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUOnTBv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_botor_v0.4.1-tikzDictionary"
