# Validation Report - causaloptim@1.0.0
...
| export_help          | 29                                  |
| has_website          | TRUE                                |
| has_maintainer       | Michael C Sachs <sachsmc@gmail.com> |
...
Overall the package has 29 exported objects. 29 are documented:
                 ...
                 analyze_graph                    btm_var 
                          TRUE                       TRUE 
            causalproblemcheck check_constraints_violated 
                          TRUE                       TRUE 
        check_linear_objective              check_parents 
                          TRUE                       TRUE 
              constraintscheck         create_causalmodel 
                          TRUE                       TRUE 
          create_effect_vector create_linearcausalproblem 
                          TRUE                       TRUE 
               create_q_matrix   create_response_function 
                          TRUE                       TRUE 
                find_all_paths         get_default_effect 
                          TRUE                       TRUE 
                 graphrescheck           initialize_graph 
                          TRUE                       TRUE 
              interpret_bounds               latex_bounds 
                          TRUE                       TRUE 
                  list_to_path          optimize_effect_2 
                          TRUE                       TRUE 
             parse_constraints               parse_effect 
                          TRUE                       TRUE 
                 plot_graphres                 querycheck 
                          TRUE                       TRUE 
                    rdirichlet        sample_distribution 
                          TRUE                       TRUE 
               simulate_bounds              specify_graph 
                          TRUE                       TRUE 
                 update_effect 
                          TRUE 
...
| Execution Time | 2025-02-16 03:50:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bc377ca7743_1739677795
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpp2hoZr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causaloptim_v1.0.0-tikzDictionary"
