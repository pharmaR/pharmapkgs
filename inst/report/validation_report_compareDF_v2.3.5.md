# Validation Report - compareDF@2.3.5
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Alex Joseph <alexsanjoseph@gmail.com>                |
...
| 3   | htmlTable (\>= 1.5)     | Imports |
| 4   | openxlsx (\>= 4.1)      | Imports |
| 5   | tidyr (\>= 1.1.0)       | Imports |
| 6   | stringr (\>= 1.4.0)     | Imports |
| 7   | tibble (\>= 3.0.1)      | Imports |
| 8   | rlang                   | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
             ...
             compare_df create_output_table  create_wide_output           view_html 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 03:34:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6243d9d0d_1739763250
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppnYISi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_compareDF_v2.3.5-tikzDictionary"
