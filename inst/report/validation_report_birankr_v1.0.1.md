# Validation Report - birankr@1.0.1
...
Overall the package has 10 exported objects. 10 are documented:
                ...
                bipartite_rank                    br_bgrm 
                          TRUE                       TRUE 
                     br_birank                  br_cohits 
                          TRUE                       TRUE 
                       br_hits                   pagerank 
                          TRUE                       TRUE 
           project_to_one_mode sparsematrix_from_edgelist 
                          TRUE                       TRUE 
      sparsematrix_from_matrix    sparsematrix_rm_weights 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-15 04:16:59 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3b318161_1739593014
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJXc96l
...
These are the options set to generate the report:
    ...
    [1] "validation_report_birankr_v1.0.1-tikzDictionary"
