# Validation Report - binom@1.1.1.1
...
baker, bnem, bootLR, cancerclass, EGRETci, epikit, escalation,
GenderInfer, IncidencePrevalence, inctools, interfacer, matchedcc, NSM3,
papci, presize, RCMsize, RJafroc, rtdists, sarks, seedr, simr,
TreatmentSelection, trialr, xgxr

## Namespace

Overall the package has 21 exported objects. 21 are documented:

        binom.agresti.coull             binom.asymp             binom.bayes 
                       TRUE                    TRUE                    TRUE 
    binom.bayes.densityplot           binom.cloglog           binom.confint 
                       TRUE                    TRUE                    TRUE 
             binom.coverage             binom.exact            binom.length 
                       TRUE                    TRUE                    TRUE 
                binom.logit               binom.lrt             binom.optim 
                       TRUE                    TRUE                    TRUE 
                 binom.plot             binom.power            binom.probit 
                       TRUE                    TRUE                    TRUE 
              binom.profile         binom.prop.test               binom.sim 
                       TRUE                    TRUE                    TRUE 
               binom.wilson     cloglog.sample.size           tkbinom.power 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-15 04:09:36 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5799f5cd_1739592571
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdaT1Th
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binom_v1.1.1.1-tikzDictionary"
