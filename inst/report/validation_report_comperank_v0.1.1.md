# Validation Report - comperank@0.1.1
...
| has_source_control   | https://github.com/echasnovski/comperank        |
...
|     | package              | type      |
|:----|:---------------------|:----------|
| 1   | comperes (\>= 0.1.0) | Depends   |
| 2   | dplyr (\>= 0.6.0)    | Imports   |
| 3   | Rcpp                 | Imports   |
| 4   | rlang (\>= 0.2.0)    | Imports   |
| 5   | tibble               | Imports   |
| 6   | Rcpp                 | LinkingTo |
...
Overall the package has 23 exported objects. 23 are documented:
          ...
          add_elo_ratings add_iterative_ratings                   elo 
                     TRUE                  TRUE                  TRUE 
         normalize_keener           rank_colley              rank_elo 
                     TRUE                  TRUE                  TRUE 
           rank_iterative           rank_keener           rank_markov 
                     TRUE                  TRUE                  TRUE 
              rank_massey               rank_od           rate_colley 
                     TRUE                  TRUE                  TRUE 
                 rate_elo        rate_iterative           rate_keener 
                     TRUE                  TRUE                  TRUE 
              rate_markov           rate_massey               rate_od 
                     TRUE                  TRUE                  TRUE 
               round_rank           skew_keener              teleport 
                     TRUE                  TRUE                  TRUE 
               vote_equal             vote_self 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-17 03:35:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64de46923_1739763314
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnxmIvw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comperank_v0.1.1-tikzDictionary"
