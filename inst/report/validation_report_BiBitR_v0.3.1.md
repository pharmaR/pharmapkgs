# Validation Report - BiBitR@0.3.1
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | De Troyer Ewoud <ewoud.detroyer@uhasselt.be>         |
...
| 5   | viridis     | Imports |
| 6   | cluster     | Imports |
| 7   | dendextend  | Imports |
| 8   | lattice     | Imports |
| 9   | grDevices   | Imports |
| 10  | graphics    | Imports |
| 11  | randomcoloR | Imports |
| 12  | biclust     | Imports |
...
miRSM, RcmdrPlugin.BiclustGUI

## Namespace

Overall the package has 15 exported objects. 15 are documented:

                     bibit  bibit_columnextension                 bibit2 
                      TRUE                   TRUE                   TRUE 
                    bibit3       bibit3_patternBC          BiBitWorkflow 
                      TRUE                   TRUE                   TRUE 
        ClusterRowCoverage                ColInfo             ColNoiseBC 
                      TRUE                   TRUE                   TRUE 
           CompareResultJI      make_arff_row_col                  MaxBC 
                      TRUE                   TRUE                   TRUE 
                NoiseScree         RowTest_Fisher UpdateBiclust_RowNoise 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:00:47 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4d4fc224_1739592042
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0mcxhL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BiBitR_v0.3.1-tikzDictionary"
