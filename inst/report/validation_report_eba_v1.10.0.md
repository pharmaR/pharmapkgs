...
| export_help          | 18                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Florian Wickelmaier <wickelmaier@web.de>             |
...
Overall the package has 18 exported objects. 18 are documented:
    ...
    balanced.pcdesign              boot          circular             cov.u 
                 TRUE              TRUE              TRUE              TRUE 
                  eba         eba.order        group.test    inclusion.rule 
                 TRUE              TRUE              TRUE              TRUE 
            kendall.u        linear2btl               mbt            OptiPt 
                 TRUE              TRUE              TRUE              TRUE 
                  pcX            strans         thurstone            trineq 
                 TRUE              TRUE              TRUE              TRUE 
               uscale         wald.test 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-25 03:24:58 UTC |
...
running this report
    ...
    PROCESSX_PS1d2821f1bddc_1740453894
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9iyxF1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eba_v1.10.0-tikzDictionary"
