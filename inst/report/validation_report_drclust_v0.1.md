...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ionel Prunila <ionel.prunila@uniroma1.it>            |
...
Overall the package has 15 exported objects. 15 are documented:
         ...
         apseudoF       centree       cluster CronbachAlpha         disfa 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           dispca      doublekm        dpcakm      dpseudoF        factkm 
             TRUE          TRUE          TRUE          TRUE          TRUE 
            heatm    kaiserCrit         mrand         redkm    silhouette 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 04:44:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4165048f7_1739853858
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqmcSiA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drclust_v0.1-tikzDictionary"
