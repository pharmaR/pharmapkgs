# Validation Report - cellWise@2.5.3
...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jakob Raymaekers <jakob.raymaekers@kuleuven.be>      |
...
| 10  | utils                           | Imports   |
| 11  | shape                           | Imports   |
| 12  | Rcpp (\>= 0.12.10.14)           | Imports   |
| 13  | Rcpp                            | LinkingTo |
| 14  | RcppArmadillo (\>= 0.7.600.1.0) | LinkingTo |
...
classmap, ConfidenceEllipse, fMRIscrub, GSE, OutliersO3, RCTS, RDnp,
RMSS, robStepSplitReg, ShapleyOutlier, srlars

## Namespace

Overall the package has 23 exported objects. 23 are documented:

              cellHandler               cellMap               cellMCD 
                     TRUE                  TRUE                  TRUE 
             checkDataSet             cwLocScat                   DDC 
                     TRUE                  TRUE                  TRUE 
               DDCpredict                    DI           estLocScale 
                     TRUE                  TRUE                  TRUE 
           generateCorMat          generateData                 ICPCA 
                     TRUE                  TRUE                  TRUE 
                 MacroPCA       MacroPCApredict            outlierMap 
                     TRUE                  TRUE                  TRUE 
             plot_cellMCD               transfo       transfo_newdata 
                     TRUE                  TRUE                  TRUE 
    transfo_transformback               truncPC                unpack 
                     TRUE                  TRUE                  TRUE 
               weightedEM                  wrap 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-16 03:59:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31af36f8c_1739678349
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCqyvxS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cellWise_v2.5.3-tikzDictionary"
