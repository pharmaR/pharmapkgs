...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Corie Drake <therealcfdrake@gmail.com>               |
...
Overall the package has 17 exported objects. 17 are documented:
                            ...
                            boot_ML                     estimate_ML 
                               TRUE                            TRUE 
                 estimate_ML_binary          estimate_ML_continuous 
                               TRUE                            TRUE 
                estimate_ML_ordinal     generate_multimethod_binary 
                               TRUE                            TRUE 
    generate_multimethod_continuous       generate_multimethod_data 
                               TRUE                            TRUE 
       generate_multimethod_ordinal                         plot_ML 
                               TRUE                            TRUE 
                     plot_ML_binary              plot_ML_continuous 
                               TRUE                            TRUE 
                    plot_ML_ordinal                    pollinate_ML 
                               TRUE                            TRUE 
                pollinate_ML_binary         pollinate_ML_continuous 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-19 04:01:15 UTC |
...
running this report
    ...
    PROCESSX_PS1d4579c3a158_1739937669
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbjIRgV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emery_v0.5.1-tikzDictionary"
