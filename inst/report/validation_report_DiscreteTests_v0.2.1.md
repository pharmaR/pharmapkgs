# Validation Report - DiscreteTests@0.2.1
...
| has_source_control   | https://github.com/DISOhda/DiscreteTests |
...
DiscreteFDR, DiscreteFWER, FDX

## Namespace

Overall the package has 10 exported objects. 10 are documented:

                 binom_test_pv              binom.test.pv 
                          TRUE                       TRUE 
           DiscreteTestResults DiscreteTestResultsSummary 
                          TRUE                       TRUE 
                fisher_test_pv             fisher.test.pv 
                          TRUE                       TRUE 
               mcnemar_test_pv            mcnemar.test.pv 
                          TRUE                       TRUE 
               poisson_test_pv            poisson.test.pv 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-18 04:13:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bb410471299_1739852033
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkJAvoR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiscreteTests_v0.2.1-tikzDictionary"
