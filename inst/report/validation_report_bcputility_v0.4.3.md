# Validation Report - bcputility@0.4.3
...
| export_help          | 12                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Thomas Roh <thomas@roh.engineering>  |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/tomroh/bcputility |
...
Overall the package has 12 exported objects. 12 are documented:
           ...
           bcpExport        bcpImport       bcpVersion checkTableExists 
                TRUE             TRUE             TRUE             TRUE 
         createTable        dropTable              int  makeConnectArgs 
                TRUE             TRUE             TRUE             TRUE 
        mapDataTypes    sqlcmdVersion        varBinary          varChar 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 03:46:56 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4fdeb592_1739591211
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8JdagE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bcputility_v0.4.3-tikzDictionary"
