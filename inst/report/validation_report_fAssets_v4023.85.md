# Validation Report - fAssets@4023.85
...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Stefan Theussl <Stefan.Theussl@R-project.org>        |
...
| 3   | fBasics    | Depends |
| 4   | fMultivar  | Imports |
| 5   | robustbase | Imports |
| 6   | MASS       | Imports |
| 7   | sn         | Imports |
| 8   | ecodist    | Imports |
| 9   | mvnormtest | Imports |
| 10  | energy     | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
        ...
        .baggedMeanCov .bayesSteinMeanCov           .cov.arw          .cov.nnve 
                  TRUE               TRUE               TRUE               TRUE 
           .cov.shrink   .donostahMeanCov .ledoitWolfMeanCov        .rmtMeanCov 
                  TRUE               TRUE               TRUE               TRUE 
       .studentMeanCov 
                  TRUE 
...
| Execution Time | 2025-02-19 05:13:51 UTC |
...
running this report
    ...
    PROCESSX_PS1d456001a14c_1739942024
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpINSXe5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fAssets_v4023.85-tikzDictionary"
