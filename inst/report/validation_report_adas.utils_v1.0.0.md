...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Paolo Bosetti <paolo.bosetti@unitn.it>               |
...
Overall the package has 22 exported objects. 21 are documented:
                  ...
                  %>%         chauvenet    daniel_plot_hn    daniel_plot_qq 
                FALSE              TRUE              TRUE              TRUE 
         examples_url      fp_add_names      fp_add_scale   fp_alias_matrix 
                 TRUE              TRUE              TRUE              TRUE 
           fp_all_drs  fp_augment_axial fp_augment_center  fp_design_matrix 
                 TRUE              TRUE              TRUE              TRUE 
      fp_effect_names       fp_fraction      fp_gen2alias           fp_info 
                 TRUE              TRUE              TRUE              TRUE 
         fp_merge_drs       fp_read_csv     fp_treatments      fp_write_csv 
                 TRUE              TRUE              TRUE              TRUE 
             normplot      pareto_chart 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-14 06:35:15 UTC |
...
running this report
    ...
    PROCESSX_PS726d37bdbcf9_1739514912
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuUZaYy
