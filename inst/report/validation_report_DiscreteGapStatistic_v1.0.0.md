# Validation Report - DiscreteGapStatistic@1.0.0
...
| export_help          | 19                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Eduardo Cortes <ecortesg@buffalo.edu>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/ecortesgomez/DiscreteGapStatistic |
...
| 5   | pheatmap       | Imports |
| 6   | dplyr          | Imports |
| 7   | Polychrome     | Imports |
| 8   | RColorBrewer   | Imports |
| 9   | reshape2       | Imports |
| 10  | tidyr          | Imports |
| 11  | ComplexHeatmap | Imports |
| 12  | cluster        | Imports |
| 13  | stats          | Imports |
...
Overall the package has 19 exported objects. 19 are documented:
    ...
    BhattacharyyaDist         ChisqDist      clusGapDiscr     clusterFunSel 
                 TRUE              TRUE              TRUE              TRUE 
          cramersVmod           CramerV dissbhattacharyya     disschisquare 
                 TRUE              TRUE              TRUE              TRUE 
          disscramerv       disshamming     disshellinger      distanceHeat 
                 TRUE              TRUE              TRUE              TRUE 
       distancematrix             findK     HellingerDist           kmodesD 
                 TRUE              TRUE              TRUE              TRUE 
    likert.heat.plot2        ResHeatmap           SimData 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:13:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4214c58b1_1739852007
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIcuJ1i
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiscreteGapStatistic_v1.0.0-tikzDictionary"
