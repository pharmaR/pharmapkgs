# Validation Report - cmenet@0.1.2
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Simon Mak <sm769@duke.edu>                           |
...
Overall the package has 4 exported objects. 4 are documented:
            ...
            cmenet      cv.cmenet full.model.mtx     predictcme 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:43:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bc372fcfcb5_1739681025
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpr7gO4w
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmenet_v0.1.2-tikzDictionary"
