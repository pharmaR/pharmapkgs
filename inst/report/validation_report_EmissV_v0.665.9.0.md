# Validation Report - EmissV@0.665.9.0
...
Overall the package has 12 exported objects. 12 are documented:
        ...
        areaSource       emission emissionFactor       gridInfo     lineSource 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         plumeRise    pointSource   rasterSource           read     speciation 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     totalEmission       vehicles 
              TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:01:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d45335ba84c_1739937710
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpL6MM3B
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EmissV_v0.665.9.0-tikzDictionary"
