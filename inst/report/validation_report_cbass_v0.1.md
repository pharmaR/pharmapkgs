...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Frank Marrs <fmarrs3@lanl.gov>                       |
...
Overall the package has 5 exported objects. 5 are documented:
     ...
     augment.X  fit.cbass       p.mu pred.cbass   sample.z 
...
| Execution Time | 2025-02-16 03:51:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3339dd37f_1739677871
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmppy3YtF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cbass_v0.1-tikzDictionary"
