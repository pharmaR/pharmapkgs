# Validation Report - DIRECT@1.1.0
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Audrey Q. Fu <audreyqyfu@gmail.com>                  |
...
Overall the package has 15 exported objects. 15 are documented:
             ...
             dDirichlet              DIRECT             dMVNorm              DPMCMC 
                   TRUE                TRUE                TRUE                TRUE 
             outputData    plotClustersMean     plotClustersPCA      plotClustersSD 
                   TRUE                TRUE                TRUE                TRUE 
         plotSimulation          rDirichlet             relabel resampleClusterProb 
                   TRUE                TRUE                TRUE                TRUE 
                rMVNorm         simuDataREM       summaryDIRECT 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 04:09:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44fe1c625_1739851739
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiyTMQs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DIRECT_v1.1.0-tikzDictionary"
