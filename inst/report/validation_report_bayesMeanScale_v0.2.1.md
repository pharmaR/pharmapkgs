# Validation Report - bayesMeanScale@0.2.1
...
| export_help          | 7                                          |
| has_website          | TRUE                                       |
| has_maintainer       | David M. Dalenberg <dalenbe2@gmail.com>    |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/dalenbe2/bayesMeanScale |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | bayestestR (\>= 0.13.2) | Imports |
| 2   | data.table (\>= 1.15.2) | Imports |
| 3   | magrittr (\>= 2.0.3)    | Imports |
| 4   | posterior (\>= 1.5.0)   | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
      ...
      bayesCountMargEffF     bayesCountPredsF    bayesMargCompareF 
                    TRUE                 TRUE                 TRUE 
           bayesMargEffF bayesOrdinalMargEffF   bayesOrdinalPredsF 
                    TRUE                 TRUE                 TRUE 
             bayesPredsF 
                    TRUE 
...
| Execution Time | 2025-02-15 03:37:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6e02e168_1739590663
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzWotTP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesMeanScale_v0.2.1-tikzDictionary"
