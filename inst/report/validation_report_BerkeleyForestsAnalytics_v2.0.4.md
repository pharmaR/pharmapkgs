# Validation Report - BerkeleyForestsAnalytics@2.0.4
...
| export_help | 10 |
| has_website | TRUE |
| has_maintainer | Kea Rutherford <krutherford@berkeley.edu> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/kearutherford/BerkeleyForestsAnalytics |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            BiomassNSVB         CoarseFuels        CompilePlots CompileSurfaceFuels 
                   TRUE                TRUE                TRUE                TRUE 
              FineFuels          ForestComp           ForestStr          LitterDuff 
                   TRUE                TRUE                TRUE                TRUE 
         SummaryBiomass         TreeBiomass 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-15 03:53:53 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd13e31653_1739591629
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpvzx0Mb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BerkeleyForestsAnalytics_v2.0.4-tikzDictionary"
