...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Andre M. de Roos <A.M.deRoos@uva.nl>                 |
...
|:----|:-----------------------------|:--------|
| 1   | graphics                     | Imports |
| 2   | deSolve (\>= 1.3)            | Imports |
| 3   | rootSolve (\>= 1.8)          | Imports |
| 4   | rstudioapi (\>= 0.13)        | Imports |
| 5   | shiny (\>= 1.7)              | Imports |
| 6   | shinyjs (\>= 2.1)            | Imports |
| 7   | shinydashboard (\>= 0.7)     | Imports |
| 8   | shinydashboardPlus (\>= 2.0) | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
     ...
     bifurcation deBifExample    deBifHelp   deBifReset   phaseplane 
...
| Execution Time | 2025-02-18 03:31:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb420e66557_1739849478
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnQUnWh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deBif_v0.1.9-tikzDictionary"
