...
| export_help          | 29                               |
| has_website          | TRUE                             |
| has_maintainer       | Timothy Keitt <tkeitt@gmail.com> |
| bugs_status          | subscript out of bounds          |
| has_source_control   | https://github.com/thk686/fftab  |
...
Overall the package has 29 exported objects. 29 are documented:
               ...
               add_cplx            add_l2nm            add_l2sq            add_polr 
                   TRUE                TRUE                TRUE                TRUE 
               add_rect            can_repr          cross_spec               fftab 
                   TRUE                TRUE                TRUE                TRUE 
    fourier_frequencies             get_arg              get_fx         get_fx_norm 
                   TRUE                TRUE                TRUE                TRUE 
                 get_im            get_l2nm            get_l2sq             get_mod 
                   TRUE                TRUE                TRUE                TRUE 
               get_polr              get_re            get_rect            get_repr 
                   TRUE                TRUE                TRUE                TRUE 
               has_cplx            has_polr            has_rect              ifftab 
                   TRUE                TRUE                TRUE                TRUE 
             phase_diff            set_repr             to_cplx             to_polr 
                   TRUE                TRUE                TRUE                TRUE 
                to_rect 
                   TRUE 
...
| Execution Time | 2025-02-27 03:27:56 UTC |
...
running this report
    ...
    PROCESSX_PS1c6238b773f8_1740626872
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXHC2DE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fftab_v0.1.0-tikzDictionary"
