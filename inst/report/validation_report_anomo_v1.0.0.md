...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Zuchao Shen <zuchao.shen@gmail.com>                  |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | graphics (\>= 4.0.0) | Depends |
| 2   | base(\>= 4.0.0)      | Depends |
...
Overall the package has 4 exported objects. 4 are documented:
               ...
               mcci    od.eq.2group power.eq.2group              re 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-24 03:21:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a23d8a1df_1740367268
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMzsY3T
...
These are the options set to generate the report:
    ...
    [1] "validation_report_anomo_v1.0.0-tikzDictionary"
