# Validation Report - cdlTools@1.13
...
| export_help          | 7                                  |
| has_website          | TRUE                               |
| has_maintainer       | Jonathan Lisic <jlisic@gmail.com>  |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/jlisic/cdlTools |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    createComparableCDL                fips              getCDL         getCDL_bbox 
                   TRUE                TRUE                TRUE                TRUE 
             matchCount            metadata      updateNamesCDL 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 03:56:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37d4d1759_1739678201
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6xwmh0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cdlTools_v1.13-tikzDictionary"
