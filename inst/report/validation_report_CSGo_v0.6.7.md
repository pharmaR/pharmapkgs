...
| export_help          | 10                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Adson Costanzi <adsoncostanzi32@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/adsoncostanzifilho/CSGo |
...
Overall the package has 10 exported objects. 9 are documented:
                  ...
                  %>%      csgo_api_ach   csgo_api_friend  csgo_api_profile 
                FALSE              TRUE              TRUE              TRUE 
       csgo_api_stats get_stats_friends    get_stats_user  scale_color_csgo 
                 TRUE              TRUE              TRUE              TRUE 
      scale_fill_csgo        theme_csgo 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:30:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6648896ec_1739766620
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3qko5B
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CSGo_v0.6.7-tikzDictionary"
