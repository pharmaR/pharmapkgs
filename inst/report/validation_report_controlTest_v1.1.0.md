# Validation Report - controlTest@1.1.0
...
| export_help          | 2                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Eric S. Kawaguchi <erickawaguchi@ucla.edu>           |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | survival (\>= 2.41)  | Imports |
| 2   | graphics (\>= 3.4.0) | Imports |
...
Overall the package has 2 exported objects. 2 are documented:
    ...
    quantileControlTest          quantileSE 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-17 03:50:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67d373fec_1739764228
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKAk4Oq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_controlTest_v1.1.0-tikzDictionary"
