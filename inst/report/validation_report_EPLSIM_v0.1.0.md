# Validation Report - EPLSIM@0.1.0
...
| export_help          | 8                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Yuyan Wang <yuyan.wang@nyumc.org>         |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/YuyanWangSixTwo/EPLSIM |
...
Overall the package has 8 exported objects. 8 are documented:
               ...
               confounder.trans          e.interaction.plot 
                           TRUE                        TRUE 
                    e.main.plot interquartile.quartile.plot 
                           TRUE                        TRUE 
           mixture.overall.plot                  plsi.lr.v1 
                           TRUE                        TRUE 
                   si.coef.plot                 si.fun.plot 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-19 04:20:33 UTC |
...
running this report
    ...
    PROCESSX_PS1d457d7fdbc5_1739938826
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHTJDfE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EPLSIM_v0.1.0-tikzDictionary"
