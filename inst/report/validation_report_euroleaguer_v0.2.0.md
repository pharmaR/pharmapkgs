# Validation Report - euroleaguer@0.2.0
...
| export_help          | 26                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Flavio Leccese <flavioleccese92@gmail.com>           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/FlavioLeccese92/euroleaguer/      |
...
Overall the package has 26 exported objects. 26 are documented:
    ...
    getCompetitionAheadBehind    getCompetitionCalendar       getCompetitionGames 
                         TRUE                      TRUE                      TRUE 
        getCompetitionHistory     getCompetitionMargins      getCompetitionPhases 
                         TRUE                      TRUE                      TRUE 
         getCompetitionRounds   getCompetitionStandings     getCompetitionStreaks 
                         TRUE                      TRUE                      TRUE 
          getCompetitionTeams           getGameBoxScore          getGameEvolution 
                         TRUE                      TRUE                      TRUE 
                getGameHeader         getGamePlayByPlay            getGamePlayers 
                         TRUE                      TRUE                      TRUE 
                getGamePoints              getGameRound         getPlayerAdvanced 
                         TRUE                      TRUE                      TRUE 
                getPlayerMisc           getPlayerPoints            getPlayerStats 
                         TRUE                      TRUE                      TRUE 
                      getTeam              getTeamGames          getTeamLeadStats 
                         TRUE                      TRUE                      TRUE 
                getTeamPeople              getTeamStats 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-19 04:36:47 UTC |
...
running this report
    ...
    PROCESSX_PS1d4573f748ec_1739939801
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6qhbg1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_euroleaguer_v0.2.0-tikzDictionary"
