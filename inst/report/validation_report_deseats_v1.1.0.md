# Validation Report - deseats@1.1.0
...
| export_help          | 58                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Dominik Schulz <dominik.schulz@uni-paderborn.de>     |
...
| 10  | future           | Imports   |
| 11  | furrr            | Imports   |
| 12  | future.apply     | Imports   |
| 13  | progressr        | Imports   |
| 14  | purrr            | Imports   |
| 15  | rlang            | Imports   |
| 16  | tidyr            | Imports   |
| 17  | Rcpp             | LinkingTo |
| 18  | RcppArmadillo    | LinkingTo |
| 19  | methods          | Depends   |
...
Overall the package has 36 exported objects. 52 are documented:

              animate        arma_to_ar        arma_to_ma   boundary_method 
                 TRUE              TRUE              TRUE              TRUE 
    boundary_method<-             BV4.1            bwidth    bwidth_confint 
                 TRUE              TRUE              TRUE              TRUE 
             bwidth<-       create.gain     deseasonalize           deseats 
                 TRUE              TRUE              TRUE              TRUE 
              detrend              expo              gain           hA_calc 
                 TRUE              TRUE              TRUE              TRUE 
      hamilton_filter        kernel_fun      kernel_fun<-       llin_decomp 
                 TRUE              TRUE              TRUE              TRUE 
            lm_decomp         ma_decomp          measures        order_poly 
                 TRUE              TRUE              TRUE              TRUE 
         order_poly<-           read_ts  runDecomposition        s_semiarma 
                 TRUE              TRUE              TRUE              TRUE 
               season          season<-        seasonplot     seasonplot_gg 
                 TRUE              TRUE              TRUE              TRUE 
        select_bwidth       set_options             trend         zoo_to_ts 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 03:47:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47b59b6b5_1739850456
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpd1Gilh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deseats_v1.1.0-tikzDictionary"
