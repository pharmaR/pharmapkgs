...
DescrTab2, DescTools, exact2x2, kyotil, neatStats

## Namespace

Overall the package has 6 exported objects. 6 are documented:

     exact.reject.region           exact.test    paired.exact.test 
                    TRUE                 TRUE                 TRUE 
    paired.reject.region     power.exact.test    power.paired.test 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:45:28 UTC |
...
running this report
    ...
    PROCESSX_PS1d453081a806_1739940322
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpP2GVSh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Exact_v3.3-tikzDictionary"
