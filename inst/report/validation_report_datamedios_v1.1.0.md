# Validation Report - datamedios@1.1.0
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Exequiel Trujillo <exequiel.trujillo@ug.uchile.cl>   |
...
Overall the package has 9 exported objects. 9 are documented:
         ...
         agregar_datos_unicos       extraccion_parrafos    extraer_noticias_fecha 
                         TRUE                      TRUE                      TRUE 
     extraer_noticias_max_res     grafico_notas_por_mes             init_req_bbcl 
                         TRUE                      TRUE                      TRUE 
               limpieza_notas tabla_frecuencia_palabras                word_cloud 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-19 03:30:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d45691348e0_1739935834
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJgc7OF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datamedios_v1.1.0-tikzDictionary"
