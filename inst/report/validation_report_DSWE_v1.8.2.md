...
| export_help          | 16                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Yu Ding <yuding2007@gmail.com>           |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/TAMU-AML/DSWE-Package |
...
|     | package                         | type      |
|:----|:--------------------------------|:----------|
| 1   | Rcpp (\>= 1.0.4.6)              | LinkingTo |
| 2   | RcppArmadillo (\>= 0.9.870.2.0) | LinkingTo |
| 3   | Rcpp (\>= 1.0.4.6)              | Imports   |
| 4   | matrixStats (\>= 0.55.0)        | Imports   |
| 5   | FNN (\>= 1.1.3)                 | Imports   |
| 6   | KernSmooth (\>= 2.23-16)        | Imports   |
| 7   | mixtools (\>= 1.1.0)            | Imports   |
| 8   | gss (\>= 2.2-2)                 | Imports   |
| 9   | e1071 (\>= 1.7-3)               | Imports   |
| 10  | stats (\>= 3.5.0)               | Imports   |
| 11  | dplyr (\>= 1.0.9)               | Imports   |
| 12  | xgboost (\>= 1.7.7.1)           | Imports   |
...
Overall the package has 16 exported objects. 16 are documented:
                          ...
                          AMK             ComparePCurve ComputeWeightedDifference 
                         TRUE                      TRUE                      TRUE 
                     CovMatch               deltaEnergy                     funGP 
                         TRUE                      TRUE                      TRUE 
                    imptPower                  KnnPCFit                KnnPredict 
                         TRUE                      TRUE                      TRUE 
                    KnnUpdate               SplinePCFit                  SvmPCFit 
                         TRUE                      TRUE                      TRUE 
                     syncSize                    tempGP                updateData 
                         TRUE                      TRUE                      TRUE 
                     XgbPCFit 
                         TRUE 
...
| Execution Time | 2025-02-18 04:54:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44bc55834_1739854447
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXnL1ki
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DSWE_v1.8.2-tikzDictionary"
