# Validation Report - EHRtemporalVariability@1.2.1
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Carlos Sáez <carsaesi@upv.es>                        |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/hms-dbmi/EHRtemporalVariability   |
...
Overall the package has 4 exported objects. 8 are documented:

    estimateDataTemporalMap   estimateIGTTrajectory              formatDate 
                       TRUE                    TRUE                    TRUE 
               icd9toPheWAS 
                       TRUE 
...
| Execution Time | 2025-02-19 03:50:38 UTC |
...
running this report
    ...
    PROCESSX_PS1d4531ad71b1_1739937032
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvXXDgn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EHRtemporalVariability_v1.2.1-tikzDictionary"
