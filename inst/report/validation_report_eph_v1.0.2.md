...
| export_help          | 13                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Carolina Pradier <carolinapradier@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/ropensci/eph              |
...
Overall the package has 13 exported objects. 12 are documented:
                    ...
                    %>%    calculate_errors   calculate_poverty calculate_tabulates 
                  FALSE                TRUE                TRUE                TRUE 
               get_eahu       get_microdata   get_poverty_lines    get_total_urbano 
                   TRUE                TRUE                TRUE                TRUE 
       map_agglomerates       organize_caes        organize_cno     organize_labels 
                   TRUE                TRUE                TRUE                TRUE 
        organize_panels 
                   TRUE 
...
| Execution Time | 2025-02-19 04:14:24 UTC |
...
running this report
    ...
    PROCESSX_PS1d452878c189_1739938458
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppL6HgC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eph_v1.0.2-tikzDictionary"
