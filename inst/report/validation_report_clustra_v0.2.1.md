# Validation Report - clustra@0.2.1
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | George Ostrouchov <go@tennessee.edu>                 |
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            clustra    clustra_rand     clustra_sil         deltime        deltimeT 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      gen_traj_data     plot_sample plot_silhouette    plot_smooths       rand_plot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       trajectories 
               TRUE 
...
| Execution Time | 2025-02-16 04:41:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3331afa65_1739680880
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLRX5nF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clustra_v0.2.1-tikzDictionary"
