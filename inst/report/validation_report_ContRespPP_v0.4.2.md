# Validation Report - ContRespPP@0.4.2
...
| export_help          | 6                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Victoria Sieck <vcarrillo314@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/jcliff89/ContRespPP  |
...
Overall the package has 6 exported objects. 6 are documented:
                     ...
                     gibbs.sampler        gibbs.sampler.posterior 
                              TRUE                           TRUE 
     gibbs.sampler.posterior.rjags       gibbs.sampler.predictive 
                              TRUE                           TRUE 
    gibbs.sampler.predictive.rjags                   prob.creator 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-17 03:50:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64ea8d1c5_1739764205
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpA1XfxI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ContRespPP_v0.4.2-tikzDictionary"
