# Validation Report - conjoint@1.41
...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Tomasz Bartlomowicz <tomasz.bartlomowicz@ue.wroc.pl> |
...
Overall the package has 16 exported objects. 16 are documented:
                 ...
                 caBTL    caEncodedDesign  caFactorialDesign       caImportance 
                  TRUE               TRUE               TRUE               TRUE 
               caLogit       caMaxUtility            caModel    caPartUtilities 
                  TRUE               TRUE               TRUE               TRUE 
         caRankToScore  caRecreatedDesign     caSegmentation   caTotalUtilities 
                  TRUE               TRUE               TRUE               TRUE 
           caUtilities           Conjoint ShowAllSimulations   ShowAllUtilities 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 03:45:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bd676456751_1739763912
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1P7cw3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conjoint_v1.41-tikzDictionary"
