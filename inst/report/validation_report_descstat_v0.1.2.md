# Validation Report - descstat@0.1.2
...
Overall the package has 24 exported objects. 23 are documented:
            ...
            %>%      as_bin  as_numeric conditional  cont_table correlation 
          FALSE        TRUE        TRUE        TRUE        TRUE        TRUE 
     covariance     extract  freq_table        gini       gmean      is_bin 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
          joint    kurtosis       madev    marginal      medial      modval 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
       pre_plot   pre_print     regline    skewness       stdev    variance 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 

### Examples

There are 7 help pages with examples, from 13 (53.85 %).
...
| Execution Time | 2025-02-24 03:27:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a4890599f_1740367641
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpR8wfjC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_descstat_v0.1.2-tikzDictionary"
