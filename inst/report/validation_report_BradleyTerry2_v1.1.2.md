# Validation Report - BradleyTerry2@1.1.2
...
| export_help          | 8                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Heather Turner <ht@heatherturner.net>    |
| bugs_status          | 0.1578947                                |
| has_source_control   | https://github.com/hturner/BradleyTerry2 |
...
caret, fastR2, finetune, gap, gosset, PlackettLuce

## Namespace

Overall the package has 8 exported objects. 8 are documented:

         BTabilities              BTm countsToBinomial      GenDavidson 
                TRUE             TRUE             TRUE             TRUE 
             glmmPQL  glmmPQL.control  plotProportions           qvcalc 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-22 03:19:01 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb5d96c205_1740194337
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkcOISI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BradleyTerry2_v1.1.2-tikzDictionary"
