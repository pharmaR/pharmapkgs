...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Gunratan Lonare <lonare.gunratan@gmail.com>          |
...
Overall the package has 11 exported objects. 11 are documented:
         ...
         get8KItems   getBusinDescr  getDailyMaster getFilingHeader   getFilingInfo 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         getFilings  getFilingsHTML  getMasterIndex     getMgmtDisc    getSentiment 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      searchFilings 
               TRUE 
...
| Execution Time | 2025-02-19 03:40:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d4545a1b02b_1739936440
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpfoswfn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_edgar_v2.0.7-tikzDictionary"
