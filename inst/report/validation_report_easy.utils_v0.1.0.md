# Validation Report - easy.utils@0.1.0
...
Overall the package has 14 exported objects. 15 are documented:
     ...
     checkAlignedDims   checkSameLength       chunkPoints     fastIntersect 
                 TRUE              TRUE              TRUE              TRUE 
        fetchColnames   identicalFMatch   identicalNoAttr isValidCharacters 
                 TRUE              TRUE              TRUE              TRUE 
         pasteFactors    replaceEntries         unlistMap  validMatDimnames 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-25 03:24:40 UTC |
...
running this report
    ...
    PROCESSX_PS1d287f130969_1740453876
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeDPHVB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easy.utils_v0.1.0-tikzDictionary"
