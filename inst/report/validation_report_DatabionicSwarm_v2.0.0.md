# Validation Report - DatabionicSwarm@2.0.0
...
|     | package                  | type      |
|:----|:-------------------------|:----------|
| 1   | Rcpp (\>= 1.0.8)         | Imports   |
| 2   | RcppParallel (\>= 5.1.4) | Imports   |
| 3   | deldir                   | Imports   |
| 4   | GeneralizedUmatrix       | Imports   |
| 5   | ABCanalysis              | Imports   |
| 6   | ggplot2                  | Imports   |
| 7   | Rcpp                     | LinkingTo |
| 8   | RcppArmadillo            | LinkingTo |
| 9   | RcppParallel             | LinkingTo |
...
DRquality, FCPS, ProjectionBasedClustering

## Namespace

Overall the package has 13 exported objects. 13 are documented:

                  DBSclustering             Delaunay4Points 
                           TRUE                        TRUE 
                   DijkstraSSSP GeneratePswarmVisualization 
                           TRUE                        TRUE 
           ProjectedPoints2Grid                      Pswarm 
                           TRUE                        TRUE 
             RelativeDifference        RobustNorm_BackTrafo 
                           TRUE                        TRUE 
            RobustNormalization                  sESOM4BMUs 
                           TRUE                        TRUE 
                    setGridSize         ShortestGraphPathsC 
                           TRUE                        TRUE 
                   UniquePoints 
                           TRUE 
...
| Execution Time | 2025-02-17 04:56:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62727d19e_1739768179
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCUVL2c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DatabionicSwarm_v2.0.0-tikzDictionary"
