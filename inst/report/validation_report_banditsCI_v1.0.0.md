...
| export_help          | 24                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Molly Offer-Westort <mollyow@gmail.com>           |
| bugs_status          | subscript out of bounds                           |
| size_codebase        | 708                                               |
| has_source_control   | https://github.com/UChicago-pol-methods/banditsCI |
...
Overall the package has 24 exported objects. 24 are documented:
                             ...
                             .check_A                .check_first_batch 
                                 TRUE                              TRUE 
                         .check_shape                       aw_estimate 
                                 TRUE                              TRUE 
                            aw_scores                            aw_var 
                                 TRUE                              TRUE 
                     calculate_balwts calculate_continuous_X_statistics 
                                 TRUE                              TRUE 
                        draw_thompson                          estimate 
                                 TRUE                              TRUE 
                 generate_bandit_data                       ifelse_clip 
                                 TRUE                              TRUE 
                         impose_floor                        LinTSModel 
                                 TRUE                              TRUE 
                     output_estimates        plot_cumulative_assignment 
                                 TRUE                              TRUE 
                           ridge_init               ridge_muhat_lfo_pai 
                                 TRUE                              TRUE 
                         ridge_update                    run_experiment 
                                 TRUE                              TRUE 
                     simple_tree_data                    stick_breaking 
                                 TRUE                              TRUE 
            twopoint_stable_var_ratio                   update_thompson 
                                 TRUE                              TRUE 
...
| Execution Time | 2025-02-14 07:41:55 UTC |
...
running this report
    ...
    PROCESSX_PS1c0979ebea1_1739518912
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpv0wCZ6
