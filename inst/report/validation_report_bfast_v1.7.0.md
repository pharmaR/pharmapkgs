...
| export_help          | 12                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Dainius Masiliūnas <pastas4@gmail.com> |
...
|     | package                     | type      |
|:----|:----------------------------|:----------|
| 1   | strucchangeRcpp (\>= 1.5-4) | Depends   |
| 2   | graphics                    | Imports   |
| 3   | stats                       | Imports   |
| 4   | zoo                         | Imports   |
| 5   | forecast                    | Imports   |
| 6   | Rcpp (\>= 0.12.7)           | Imports   |
| 7   | Rdpack (\>= 0.7)            | Imports   |
| 8   | Rcpp                        | LinkingTo |
...
Rwtss, strucchangeRcpp, TSS.RESTREND

## Namespace

Overall the package has 12 exported objects. 12 are documented:

                   bfast              bfast01      bfast01classify 
                    TRUE                 TRUE                 TRUE 
                 bfast0n            bfastlite         bfastmonitor 
                    TRUE                 TRUE                 TRUE 
                 bfastpp              bfastts        create16dayts 
                    TRUE                 TRUE                 TRUE 
     set_default_options set_fallback_options     set_fast_options 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 03:57:13 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd69d18836_1739591829
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLSBFqf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bfast_v1.7.0-tikzDictionary"
