...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Cristian Oliva-Aviles <coliva@colostate.edu>         |
...
Overall the package has 9 exported objects. 9 are documented:
           ...
           bcgam      sm.conc      sm.conv      sm.decr sm.decr.conc sm.decr.conv 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
         sm.incr sm.incr.conc sm.incr.conv 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-15 03:46:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd13feb194_1739591170
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzHmRKl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bcgam_v1.0-tikzDictionary"
