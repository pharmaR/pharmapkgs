# Validation Report - corrViz@0.1.0
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alan Inglis <alan.n.inglis@gmail.com>                |
...
Overall the package has 13 exported objects. 13 are documented:
      ...
      animSolar corrBarplot  corrBubble   corrChord  corrCircle    corrGrid 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
    corrHeatmap corrNetwork   corrPairs  corrSankey   corrShiny   corrSolar 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
    matrix2long 
           TRUE 
...
| Execution Time | 2025-02-17 04:01:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62eee52bc_1739764904
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpx40Bxj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corrViz_v0.1.0-tikzDictionary"
