...
| size_codebase        | 147                                        |
| has_source_control   | https://github.com/stla/amVennDiagram5     |
...
Overall the package has 5 exported objects. 5 are documented:
        ...
        allVennDiagrams       amVennDiagram amVennDiagramOutput        makeVennData 
                   TRUE                TRUE                TRUE                TRUE 
    renderAmVennDiagram 
                   TRUE 
...
| Execution Time | 2025-02-14 06:53:18 UTC |
...
running this report
    ...
    PROCESSX_PS726d4f80348a_1739515995
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphUZOJ1
