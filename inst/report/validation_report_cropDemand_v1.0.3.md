# Validation Report - cropDemand@1.0.3
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | dplyr(\>= 0.3.0.1) | Imports |
| 2   | ggplot2(\>= 3.3.2) | Imports |
| 3   | terra              | Imports |
| 4   | sf                 | Imports |
| 5   | tidyr              | Imports |
| 6   | ncdf4              | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    download_terraclimate       eto_calibration               loadROI 
                     TRUE                  TRUE                  TRUE 
            monthly_stack              plot_AWC       ppt_calibration 
                     TRUE                  TRUE                  TRUE 
        see_brazil_biomes     see_brazil_states           waterDemand 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-17 04:22:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64a4a71e4_1739766168
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkLNJT0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cropDemand_v1.0.3-tikzDictionary"
