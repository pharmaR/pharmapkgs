...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Eric Bair <eric.bair@sciome.com>                     |
...
Overall the package has 4 exported objects. 4 are documented:
     ...
     calc.ec  calc.ed    eadrm eadrm.ci 
        TRUE     TRUE     TRUE     TRUE 
...
| Execution Time | 2025-02-18 05:08:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46a3428b0_1739855304
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJ1GgVK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eadrm_v0.1.4-tikzDictionary"
