# Validation Report - drcte@1.0.30
...
drcSeedGerm, statforbiology

## Namespace

Overall the package has 14 exported objects. 14 are documented:

            compCDF   decumulate_te           drmte    drmteControl        group_te 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                KDE         KDE.fun     loglogistic loglogisticSurv       lognormal 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            melt_te           NPMLE        plotData      ungroup_te 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:44:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45f13e1e6_1739853872
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphJKk3N
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drcte_v1.0.30-tikzDictionary"
