...
| export_help          | 18                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Jialu Fang <u3008682@connect.hku.hk>                 |
...
Overall the package has 18 exported objects. 18 are documented:
           ...
           aCFO.next         CFO.next           CFO.oc    CFO.selectmtd 
                TRUE             TRUE             TRUE             TRUE 
            CFO.simu       CFO2d.next         CFO2d.oc  CFO2d.selectmtd 
                TRUE             TRUE             TRUE             TRUE 
          CFO2d.simu      CFOeff.next        CFOeff.oc CFOeff.selectobd 
                TRUE             TRUE             TRUE             TRUE 
         CFOeff.simu       gammatable   lateonset.next   lateonset.simu 
                TRUE             TRUE             TRUE             TRUE 
           pCFO.next        rCFO.next 
                TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:04:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3943d524_1739678689
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFKJNnO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CFO_v2.2.0-tikzDictionary"
