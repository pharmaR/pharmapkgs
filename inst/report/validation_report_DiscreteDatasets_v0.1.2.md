# Validation Report - DiscreteDatasets@0.1.2
...
| has_source_control   | https://github.com/DISOhda/DiscreteDatasets |
...
DiscreteFDR, DiscreteFWER, sgof

## Namespace

Overall the package has 2 exported objects. 2 are documented:

    reconstruct_four  reconstruct_two 
                TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:12:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44809fa34_1739851968
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpq6snXY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiscreteDatasets_v0.1.2-tikzDictionary"
