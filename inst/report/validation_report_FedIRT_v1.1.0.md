# Validation Report - FedIRT@1.1.0
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Biying Zhou <zby.zhou@mail.utoronto.ca>              |
...
Overall the package has 16 exported objects. 16 are documented:
          ...
          fedirt   fedirt_2PL  fedirt_file  fedirt_gpcm       g_logL g_logL_entry 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
     g_logL_gpcm         logL   logL_entry    logL_gpcm          mem    personfit 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
     personscore    runclient    runserver           SE 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-27 03:25:40 UTC |
...
running this report
    ...
    PROCESSX_PS1c62265a7e23_1740626737
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRNlPez
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FedIRT_v1.1.0-tikzDictionary"
