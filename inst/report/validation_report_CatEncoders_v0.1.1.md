# Validation Report - CatEncoders@0.1.1
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | Matrix (\>= 1.2-6)     | Imports |
| 2   | data.table (\>= 1.9.6) | Imports |
| 3   | methods                | Imports |
...
dblr, DeepPINCS, GenProSeq, VAExprs

## Namespace

Overall the package has 4 exported objects. 4 are documented:

    inverse.transform  LabelEncoder.fit OneHotEncoder.fit         transform 
                 TRUE              TRUE              TRUE              TRUE 

### Examples

There are 4 help pages with examples, from 9 (44.44 %).
...
| Execution Time | 2025-02-16 03:46:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33c48f28a_1739677607
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9rJq0j
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CatEncoders_v0.1.1-tikzDictionary"
