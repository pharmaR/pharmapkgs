...
| export_help          | 26                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Antonio Gasparrini <antonio.gasparrini@lshtm.ac.uk>  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/gasparrini/dlnm                   |
...
attrib, collin, DiscreteDLM, dlim, eesim, FluMoDL, incidental, mixmeta,
mvmeta, season
...
Overall the package has 26 exported objects. 26 are documented:
                              ...
                              cbPen                  coef.crosspred 
                               TRUE                            TRUE 
                   coef.crossreduce                              cr 
                               TRUE                            TRUE 
                         crossbasis                       crosspred 
                               TRUE                            TRUE 
                        crossreduce                      equalknots 
                               TRUE                            TRUE 
                            exphist                 lines.crosspred 
                               TRUE                            TRUE 
                  lines.crossreduce                        logknots 
                               TRUE                            TRUE 
                           onebasis                  plot.crosspred 
                               TRUE                            TRUE 
                   plot.crossreduce                points.crosspred 
                               TRUE                            TRUE 
                 points.crossreduce        Predict.matrix.cb.smooth 
                               TRUE                            TRUE 
                                 ps smooth.construct.cb.smooth.spec 
                               TRUE                            TRUE 
                 summary.crossbasis               summary.crosspred 
                               TRUE                            TRUE 
                summary.crossreduce                summary.onebasis 
                               TRUE                            TRUE 
                     vcov.crosspred                vcov.crossreduce 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-18 04:25:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4cd9fcf6_1739852747
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBPobzR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dlnm_v2.4.7-tikzDictionary"
