...
| has_source_control   | https://github.com/jokergoo/CePa                     |
...
Overall the package has 27 exported objects. 27 are documented:
                       ...
                       cepa                cepa.all       cepa.all.parallel 
                       TRUE                    TRUE                    TRUE 
                   cepa.ora            cepa.ora.all         cepa.univariate 
                       TRUE                    TRUE                    TRUE 
        cepa.univariate.all        generate.pathway                get.cepa 
                       TRUE                    TRUE                    TRUE 
                    p.table           pathway.nodes               plot.cepa 
                       TRUE                    TRUE                    TRUE 
              plot.cepa.all  plot.pathway.catalogue               plotGraph 
                       TRUE                    TRUE                    TRUE 
                   plotNull              print.cepa          print.cepa.all 
                       TRUE                    TRUE                    TRUE 
    print.pathway.catalogue               radiality                   reach 
                       TRUE                    TRUE                    TRUE 
                   read.cls                read.gct                  report 
                       TRUE                    TRUE                    TRUE 
                sampleLabel   set.pathway.catalogue                  spread 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-16 04:01:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32ed6fe98_1739678486
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKhWaID
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CePa_v0.8.1-tikzDictionary"
