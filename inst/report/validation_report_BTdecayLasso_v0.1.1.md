# Validation Report - BTdecayLasso@0.1.1
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yunpeng Zhou <u3514104@connect.hku.hk>               |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    boot.BTdecayLasso       BTdataframe           BTdecay      BTdecayLasso 
                 TRUE              TRUE              TRUE              TRUE 
        BTdecayLassoC     BTdecayLassoF 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:52:25 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd394bcaf5_1739595140
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpk8NF5h
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BTdecayLasso_v0.1.1-tikzDictionary"
