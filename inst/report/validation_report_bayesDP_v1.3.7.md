# Validation Report - bayesDP@1.3.7
...
| export_help          | 11                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Graeme L. Hickey <graemeleehickey@gmail.com> |
| bugs_status          | 0                                            |
| has_source_control   | https://github.com/graemeleehickey/bayesDP   |
...
Overall the package has 8 exported objects. 8 are documented:
          ...
          alpha_discount          bdpbinomial                bdplm 
                    TRUE                 TRUE                 TRUE 
                bdplogit            bdpnormal          bdpsurvival 
                    TRUE                 TRUE                 TRUE 
                   ppexp probability_discount 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 03:34:02 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd29201c66_1739590438
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0RlYbG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesDP_v1.3.7-tikzDictionary"
