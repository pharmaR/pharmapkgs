...
| export_help          | 9                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Jakub Nowosad <nowosad.jakub@gmail.com> |
...
bespatial, motif, raceland, spatialising

## Namespace

Overall the package has 9 exported objects. 9 are documented:

    get_cocoma get_cocove   get_coma   get_cove get_incoma get_incove get_wecoma 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
    get_wecove  it_metric 
          TRUE       TRUE 
...
| Execution Time | 2025-02-16 05:02:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bc318ee6f47_1739682118
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnZahLB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comat_v0.9.5-tikzDictionary"
