# Validation Report - Crossover@0.1.22
...
| export_help          | 12                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Kornelius Rohmeyer <rohmeyer@small-projects.de> |
| bugs_status          | 0.6666667                                       |
| has_source_control   | https://github.com/kornl/Crossover/wiki         |
...
| 1   | ggplot2                    | Depends   |
| 2   | MASS                       | Imports   |
| 3   | crossdes (\>= 1.1-1)       | Imports   |
| 4   | xtable                     | Imports   |
| 5   | methods                    | Imports   |
| 6   | Matrix                     | Imports   |
| 7   | rJava (\>= 0.8-3)          | Imports   |
| 8   | CommonJavaJars (\>= 1.1.0) | Imports   |
| 9   | Rcpp (\>= 0.10.3)          | Imports   |
| 10  | RcppArmadillo (\>= 0.2.0)  | Imports   |
| 11  | JavaGD                     | Imports   |
| 12  | multcomp                   | Imports   |
| 13  | stats4                     | Imports   |
| 14  | digest                     | Imports   |
| 15  | Rcpp (\>= 0.10.3)          | LinkingTo |
| 16  | RcppArmadillo (\>= 0.2.0)  | LinkingTo |
...
Overall the package has 8 exported objects. 10 are documented:

        buildSummaryTable        canonicalOrder             contrMat2 
                     TRUE                  TRUE                  TRUE 
             CrossoverGUI     design.efficiency     general.carryover 
                     TRUE                  TRUE                  TRUE 
        general.carryover searchCrossOverDesign 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-24 03:23:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a7ea10cd0_1740367390
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEsEkj6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Crossover_v0.1.22-tikzDictionary"
