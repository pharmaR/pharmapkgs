# Validation Report - clustMixType@0.4.2
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Gero Szepannek <gero.szepannek@web.de>               |
...
butcher, CAST, citrus, clustTMB, FCPS, FeatureImpCluster, iClusterVB,
multilevLCA, phyloregion, radiant.multivariate, tidyclust, vetiver

## Namespace

Overall the package has 5 exported objects. 5 are documented:

           clprofiles            kproto         lambdaest  stability_kproto 
                 TRUE              TRUE              TRUE              TRUE 
    validation_kproto 
                 TRUE 
...
| Execution Time | 2025-02-23 03:23:08 UTC |
...
running this report
    ...
    PROCESSX_PS1d251a31b7c8_1740280985
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppYrY0S
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clustMixType_v0.4.2-tikzDictionary"
