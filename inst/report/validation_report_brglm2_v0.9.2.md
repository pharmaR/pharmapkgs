# Validation Report - brglm2@0.9.2
...
| has_source_control   | https://github.com/ikosmidis/brglm2               |
...
cobalt, detectseparation, ExactMed, ggeffects, LogisticCopula,
marginaleffects, meta, netmeta, parameters, pawscore, PPSFS, ProSGPV,
smcfcs, SOIL, SPIChanges, WeightIt

## Namespace

Overall the package has 12 exported objects. 12 are documented:

                       bracl            brglm_control                brglm_fit 
                        TRUE                     TRUE                     TRUE 
                brglmControl                 brglmFit               brmultinom 
                        TRUE                     TRUE                     TRUE 
                        brnb check_infinite_estimates        detect_separation 
                        TRUE                     TRUE                     TRUE 
                        expo                      mis      ordinal_superiority 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-15 04:43:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd593f86e4_1739594617
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEsym8r
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brglm2_v0.9.2-tikzDictionary"
