# Validation Report - dtpcrm@0.1.1
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Christina Yap <yapchristina17@gmail.com>             |
...
Overall the package has 13 exported objects. 13 are documented:
                          ...
                          applied_crm                   applied_crm_sim 
                                 TRUE                              TRUE 
                      applied_titecrm               applied_titecrm_sim 
                                 TRUE                              TRUE 
                applied_titecrmts_sim                    calculate_dtps 
                                 TRUE                              TRUE 
                              dtpflow                          plot_crm 
                                 TRUE                              TRUE 
           stop_for_consensus_reached  stop_for_excess_toxicity_empiric 
                                 TRUE                              TRUE 
    stop_for_excess_toxicity_logistic              stop_for_sample_size 
                                 TRUE                              TRUE 
                          summary_crm 
                                 TRUE 
...
| Execution Time | 2025-02-18 04:56:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46b0ca31a_1739854582
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVYOYoN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dtpcrm_v0.1.1-tikzDictionary"
