# Validation Report - batchtma@0.1.6
...
| export_help          | 3                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Konrad Stopsack <stopsack@post.harvard.edu>          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/stopsack/batchtma                 |
...
Overall the package has 3 exported objects. 3 are documented:
       ...
       adjust_batch diagnose_models      plot_batch 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 03:30:18 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6c52932b_1739590213
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0njwlU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_batchtma_v0.1.6-tikzDictionary"
