# Validation Report - doebioresearch@0.1.0
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Raj Popat <popatrajc@gmail.com>                      |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | agricolae (\>= 1.3.3) | Imports |
| 2   | stats (\>= 4.0.2)     | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
    ...
    arcsineretransform   arcsinetransform                crd          fcrd2fact 
                  TRUE               TRUE               TRUE               TRUE 
             fcrd3fact          frbd2fact          frbd3fact     logretransform 
                  TRUE               TRUE               TRUE               TRUE 
          logtransform                lsd               rcbd          splitplot 
                  TRUE               TRUE               TRUE               TRUE 
       sqrtretransform      sqrttransform          stripplot       yieldconvert 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 04:32:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bb414c7c838_1739853158
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZ5Ur3W
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doebioresearch_v0.1.0-tikzDictionary"
