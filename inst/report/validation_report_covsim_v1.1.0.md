# Validation Report - covsim@1.1.0
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Njaal Foldnes <njal.foldnes@gmail.com>               |
...
|     | package                      | type    |
|:----|:-----------------------------|:--------|
| 1   | rvinecopulib (\>= 0.5.1.1.0) | Imports |
| 2   | lavaan (\>= 0.6-5)           | Imports |
| 3   | nleqslv                      | Imports |
| 4   | PearsonDS                    | Imports |
| 5   | MASS                         | Imports |
| 6   | stats                        | Imports |
...
| Execution Time | 2025-02-17 04:09:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bd671e250c7_1739765382
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2ALccf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covsim_v1.1.0-tikzDictionary"
