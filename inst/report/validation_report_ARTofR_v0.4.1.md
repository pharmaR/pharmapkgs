...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Huanyuan Zhang <hyzhang1996@gmail.com>               |
...
|     | package                     | type    |
|:----|:----------------------------|:--------|
| 1   | bannerCommenter (\>= 1.0.0) | Imports |
| 2   | clipr (\>= 0.4.0)           | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
    ...
    my_own_banner       xxx_box      xxx_box1  xxx_divider1  xxx_divider2 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         xxx_list     xxx_list1    xxx_title0    xxx_title1    xxx_title2 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       xxx_title3 
             TRUE 
...
| Execution Time | 2025-02-14 07:25:38 UTC |
...
running this report
    ...
    PROCESSX_PS1c09440393b5_1739517935
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOo5QpD
