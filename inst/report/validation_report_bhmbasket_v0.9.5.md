# Validation Report - bhmbasket@0.9.5
...
| export_help | 23 |
| has_website | TRUE |
| has_maintainer | Stephan Wojciekowski <stephan.wojciekowski@boehringer-ingelheim.com> |
...
Overall the package has 23 exported objects. 23 are documented:
          ...
          combinePriorParameters          continueRecruitment 
                            TRUE                         TRUE 
                     createTrial                 getEstimates 
                            TRUE                         TRUE 
                  getGoDecisions           getGoProbabilities 
                            TRUE                         TRUE 
                        getMuVar           getPriorParameters 
                            TRUE                         TRUE 
                        invLogit                 loadAnalyses 
                            TRUE                         TRUE 
                   loadScenarios                        logit 
                            TRUE                         TRUE 
               negateGoDecisions              performAnalyses 
                            TRUE                         TRUE 
                    saveAnalyses                saveScenarios 
                            TRUE                         TRUE 
                  scaleRoundList      setPriorParametersBerry 
                            TRUE                         TRUE 
         setPriorParametersExNex   setPriorParametersExNexAdj 
                            TRUE                         TRUE 
        setPriorParametersPooled setPriorParametersStratified 
                            TRUE                         TRUE 
               simulateScenarios 
                            TRUE 
...
| Execution Time | 2025-02-15 04:00:09 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd688f37f7_1739592004
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpY9ksHC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bhmbasket_v0.9.5-tikzDictionary"
