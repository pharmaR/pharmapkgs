# Validation Report - comperes@0.2.7
...
| export_help          | 28                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Evgeni Chasnovski <evgeni.chasnovski@gmail.com> |
| bugs_status          | 1                                               |
| has_source_control   | https://github.com/echasnovski/comperes         |
...
| 2   | magrittr          | Imports |
| 3   | rlang (\>= 0.1.2) | Imports |
| 4   | tibble            | Imports |
| 5   | tidyr (\>= 0.7.0) | Imports |
...
Overall the package has 28 exported objects. 27 are documented:
                    ...
                    %>%           as_longcr           as_tibble           as_widecr 
                  FALSE                TRUE                TRUE                TRUE 
           get_matchups            h2h_funs            h2h_long             h2h_mat 
                   TRUE                TRUE                TRUE                TRUE 
              is_longcr        is_pairgames           is_widecr   join_game_summary 
                   TRUE                TRUE                TRUE                TRUE 
      join_item_summary join_player_summary             levels2         long_to_mat 
                   TRUE                TRUE                TRUE                TRUE 
            mat_to_long            num_wins      summarise_game      summarise_item 
                   TRUE                TRUE                TRUE                TRUE 
       summarise_player      summarize_game      summarize_item    summarize_player 
                   TRUE                TRUE                TRUE                TRUE 
           summary_funs         to_h2h_long          to_h2h_mat        to_pairgames 
                   TRUE                TRUE                TRUE                TRUE 

### Examples

There are 16 help pages with examples, from 18 (88.89 %).
...
| Execution Time | 2025-02-17 03:35:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd652abc0ad_1739763319
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppMlaLw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comperes_v0.2.7-tikzDictionary"
