# Validation Report - ceramic@0.9.5
...
| export_help          | 21                                  |
| has_website          | TRUE                                |
| has_maintainer       | Michael Sumner <mdsumner@gmail.com> |
...
Overall the package has 21 exported objects. 21 are documented:
                ...
                cc_casey             cc_davis         cc_elevation 
                    TRUE                 TRUE                 TRUE 
                cc_heard          cc_kingston          cc_location 
                    TRUE                 TRUE                 TRUE 
            cc_macquarie            cc_mawson        ceramic_cache 
                    TRUE                 TRUE                 TRUE 
           ceramic_tiles  clear_ceramic_cache          get_api_key 
                    TRUE                 TRUE                 TRUE 
               get_tiles     get_tiles_buffer        get_tiles_dim 
                    TRUE                 TRUE                 TRUE 
          get_tiles_zoom mercator_tile_extent           plot_tiles 
                    TRUE                 TRUE                 TRUE 
              read_tiles     tiles_to_polygon           unpack_rgb 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:02:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bc397212ea_1739678525
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUC4PJ3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ceramic_v0.9.5-tikzDictionary"
