# Validation Report - ExpGenetic@0.1.0
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yuqing Wu <wuyuqing0104@163.com>                     |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | DESeq2 (\>= 1.34.0)       | Imports |
| 2   | futile.logger (\>= 1.4.3) | Imports |
| 3   | ggplot2 (\>= 3.3.6)       | Imports |
| 4   | ggsci (\>= 2.9)           | Imports |
| 5   | plyr (\>= 1.8.7)          | Imports |
| 6   | VennDiagram (\>= 1.7.3)   | Imports |
...
Overall the package has 12 exported objects. 12 are documented:
     ...
     basepreplot  Countfilter    Get12Bins   GetDAtable    GetDEdata      lenplot 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
    mirnapredata    polyDESeq    Rpmfilter  srnapredata     VennData     VennPlot 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 

### Examples

There are 18 help pages with examples, from 21 (85.71 %).
...
| Execution Time | 2025-02-19 04:52:26 UTC |
...
running this report
    ...
    PROCESSX_PS1d452aa80cb9_1739940740
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEMQiZk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ExpGenetic_v0.1.0-tikzDictionary"
