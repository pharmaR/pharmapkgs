# Validation Report - FFTrees@2.0.0
...
| has_source_control   | https://github.com/ndphillips/FFTrees/ |
...
Overall the package has 25 exported objects. 25 are documented:
                        ...
                        add_fft_df                      add_nodes 
                              TRUE                           TRUE 
                     describe_data                     drop_nodes 
                              TRUE                           TRUE 
                        edit_nodes                        FFTrees 
                              TRUE                           TRUE 
                     fftrees_apply                 fftrees_create 
                              TRUE                           TRUE 
                   fftrees_cuerank                 fftrees_define 
                              TRUE                           TRUE 
                fftrees_ffttowords  fftrees_threshold_factor_grid 
                              TRUE                           TRUE 
    fftrees_threshold_numeric_grid         fftrees_wordstofftrees 
                              TRUE                           TRUE 
                     FFTrees.guide                     flip_exits 
                              TRUE                           TRUE 
                     get_best_tree                  get_exit_type 
                              TRUE                           TRUE 
                        get_fft_df                        inwords 
                              TRUE                           TRUE 
                       read_fft_df                  reorder_nodes 
                              TRUE                           TRUE 
                      select_nodes                       showcues 
                              TRUE                           TRUE 
                      write_fft_df 
                              TRUE 
...
| Execution Time | 2025-02-27 03:28:01 UTC |
...
running this report
    ...
    PROCESSX_PS1c62f776bc_1740626877
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpc8JTF4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FFTrees_v2.0.0-tikzDictionary"
