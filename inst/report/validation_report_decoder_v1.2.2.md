# Validation Report - decoder@1.2.2
...
Overall the package has 12 exported objects. 12 are documented:
                  ...
                  as.key          as.keyvalue             as.value 
                    TRUE                 TRUE                 TRUE 
                    code               decode               is.key 
                    TRUE                 TRUE                 TRUE 
             is.keyvalue             is.value     kungalv2Fyrbodal 
                    TRUE                 TRUE                 TRUE 
    kungalv2Storgoteborg           real_names   short_region_names 
                    TRUE                 TRUE                 TRUE 

### Examples

There are 7 help pages with examples, from 42 (16.67 %).
...
| Execution Time | 2025-02-18 03:32:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42c458cfd_1739849570
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2Ao152
...
These are the options set to generate the report:
    ...
    [1] "validation_report_decoder_v1.2.2-tikzDictionary"
