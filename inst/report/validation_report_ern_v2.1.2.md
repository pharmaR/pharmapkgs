...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | David Champredon <david.champredon@canada.ca>        |
...
Overall the package has 8 exported objects. 8 are documented:
          ...
          agg_to_daily           def_dist      estimate_R_cl      estimate_R_ww 
                  TRUE               TRUE               TRUE               TRUE 
     get_discrete_dist plot_diagnostic_cl plot_diagnostic_ww          plot_dist 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:27:09 UTC |
...
running this report
    ...
    PROCESSX_PS1d45607128e5_1739939222
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8BLXi9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ern_v2.1.2-tikzDictionary"
