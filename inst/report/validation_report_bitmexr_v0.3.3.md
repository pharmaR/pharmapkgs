# Validation Report - bitmexr@0.3.3
...
| export_help          | 22                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Harry Fisher <harryfisher21@gmail.com> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/hfshr/bitmexr/      |
...
Overall the package has 22 exported objects. 22 are documented:
       ...
       available_symbols        bucket_trades    cancel_all_orders 
                    TRUE                 TRUE                 TRUE 
            cancel_order           edit_order           get_bitmex 
                    TRUE                 TRUE                 TRUE 
       map_bucket_trades           map_trades          place_order 
                    TRUE                 TRUE                 TRUE 
             post_bitmex     tn_bucket_trades tn_cancel_all_orders 
                    TRUE                 TRUE                 TRUE 
         tn_cancel_order        tn_edit_order        tn_get_bitmex 
                    TRUE                 TRUE                 TRUE 
    tn_map_bucket_trades        tn_map_trades       tn_place_order 
                    TRUE                 TRUE                 TRUE 
          tn_post_bitmex            tn_trades               trades 
                    TRUE                 TRUE                 TRUE 
             valid_dates 
                    TRUE 
...
| Execution Time | 2025-02-15 04:18:39 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2b3765a6_1739593114
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1OXzJW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bitmexr_v0.3.3-tikzDictionary"
