...
| export_help          | 21                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Elias Carvalho <ecacarva@gmail.com>                  |
...
Overall the package has 21 exported objects. 21 are documented:
                    ...
                    boot.strap.bn              check.algorithms 
                             TRUE                          TRUE 
         check.dichotomic.one.var     check.levels.one.variable 
                             TRUE                          TRUE 
                         check.na         check.ordered.one.var 
                             TRUE                          TRUE 
              check.ordered.to.pa                check.outliers 
                             TRUE                          TRUE 
               check.type.one.var                   check.types 
                             TRUE                          TRUE 
    check.variables.to.be.ordered      convert.confusion.matrix 
                             TRUE                          TRUE 
                   create.cluster                create.dummies 
                             TRUE                          TRUE 
                gera.bn.structure                       gera.pa 
                             TRUE                          TRUE 
                    gera.pa.model              mount.wl.bl.list 
                             TRUE                          TRUE 
            outcome.predictor.var           preprocess.outliers 
                             TRUE                          TRUE 
              transf.into.ordinal 
                             TRUE 
...
| Execution Time | 2025-02-15 04:28:40 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd241eef1d_1739593715
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7Ga72O
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bnpa_v0.3.0-tikzDictionary"
