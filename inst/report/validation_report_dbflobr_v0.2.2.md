# Validation Report - dbflobr@0.2.2
...
| export_help          | 8                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Evan Amies-Galonski <evan@poissonconsulting.ca> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/poissonconsulting/dbflobr    |
...
Overall the package has 8 exported objects. 8 are documented:
     ...
     add_blob_column      delete_flob import_all_flobs     import_flobs 
                TRUE             TRUE             TRUE             TRUE 
           read_flob   save_all_flobs       save_flobs       write_flob 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 05:05:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6367bf6c3_1739768753
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxMnNNm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dbflobr_v0.2.2-tikzDictionary"
