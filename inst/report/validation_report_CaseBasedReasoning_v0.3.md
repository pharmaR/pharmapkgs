# Validation Report - CaseBasedReasoning@0.3
...
| export_help          | 13                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Simon Mueller <simon.mueller@muon-stat.com>    |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/sipemu/case-based-reasoning |
...
Overall the package has 13 exported objects. 13 are documented:
                    ...
                    asDistObject                     CoxModel 
                            TRUE                         TRUE 
                  depth_distance         distanceRandomForest 
                            TRUE                         TRUE 
    edges_between_terminal_nodes                generate_grid 
                            TRUE                         TRUE 
                     LinearModel                LogisticModel 
                            TRUE                         TRUE 
              proximity_distance     ranger_forests_to_matrix 
                            TRUE                         TRUE 
                         RFModel                terminalNodes 
                            TRUE                         TRUE 
                weightedDistance 
                            TRUE 
...
There are 10 help pages with examples, from 16 (62.50 %).
...
| Execution Time | 2025-02-16 03:44:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34558049d_1739677478
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBjECz4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CaseBasedReasoning_v0.3-tikzDictionary"
