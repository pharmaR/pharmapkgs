# Validation Report - demogR@0.6.0
...
Overall the package has 22 exported objects. 22 are documented:
           ...
           calc.ro         cdmlte         cdmltn         cdmlts         cdmltw 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             coale         cohort eigen.analysis       elassens     fullsecder 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          gen.time        keyfitz           lams  leslie.matrix    leslie.row1 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        life.table      loop.elas            m2v          odiag project.leslie 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            secder     stoch.sens 
              TRUE           TRUE 
...
| Execution Time | 2025-02-18 03:39:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46f6da036_1739849974
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgVjLnr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_demogR_v0.6.0-tikzDictionary"
