# Validation Report - ergm.ego@1.1.2
...
|     | package                     | type      |
|:----|:----------------------------|:----------|
| 1   | ergm (\>= 4.8.1)            | Depends   |
| 2   | egor (\>= 1.24.2)           | Depends   |
| 3   | network (\>= 1.19.0)        | Depends   |
| 4   | statnet.common (\>= 4.11.0) | Imports   |
| 5   | RColorBrewer (\>= 1.1-3)    | Imports   |
| 6   | purrr (\>= 1.0.2)           | Imports   |
| 7   | tibble (\>= 3.2.1)          | Imports   |
| 8   | dplyr (\>= 1.1.4)           | Imports   |
| 9   | survey (\>= 4.4-2)          | Imports   |
| 10  | stats                       | Imports   |
| 11  | methods                     | Imports   |
| 12  | ergm                        | LinkingTo |
...
Overall the package has 10 exported objects. 10 are documented:
              ...
              as_egor.egodata         COLLAPSE_SMALLEST          control.ergm.ego 
                         TRUE                      TRUE                      TRUE 
    control.simulate.ergm.ego                  ergm.ego      ergm.ego_attr_levels 
                         TRUE                      TRUE                      TRUE 
           ergm.ego_get_vattr                    sample                    snctrl 
                         TRUE                      TRUE                      TRUE 
             template_network 
                         TRUE 
...
| Execution Time | 2025-02-19 04:25:59 UTC |
...
running this report
    ...
    PROCESSX_PS1d4557dfd182_1739939153
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppScvET
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ergm.ego_v1.1.2-tikzDictionary"
