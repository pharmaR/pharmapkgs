...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Colin Millar <colin.millar@ices.dk>                  |
...
Overall the package has 7 exported objects. 7 are documented:
            ...
            as.gam         BICadj            efp       invlogit          logit 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    overdispersion       transpar 
              TRUE           TRUE 
...
| Execution Time | 2025-02-19 03:45:42 UTC |
...
running this report
    ...
    PROCESSX_PS1d454fb33e96_1739936736
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2PGzBc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ef_v1.2.0-tikzDictionary"
