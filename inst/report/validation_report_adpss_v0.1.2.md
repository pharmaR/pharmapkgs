...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Kosuke Kashiwabara <kashiwabara-tky@umin.ac.jp>      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 476                                                  |
| has_source_control   | https://github.com/ca4wa/R-adpss                     |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    adaptive_analysis_norm_global  adaptive_analysis_norm_local 
                             TRUE                          TRUE 
      exp_sample_size_norm_global       sample_size_norm_global 
                             TRUE                          TRUE 
           sample_size_norm_local         work_test_norm_global 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-14 06:39:35 UTC |
...
running this report
    ...
    PROCESSX_PS726d665db1e8_1739515172
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAfX98F
