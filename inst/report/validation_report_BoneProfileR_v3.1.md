# Validation Report - BoneProfileR@3.1
...
Overall the package has 18 exported objects. 18 are documented:
                           ...
                           BP                BP_AutoFit       BP_ChooseBackground 
                         TRUE                      TRUE                      TRUE 
              BP_ChooseCenter       BP_ChooseForeground       BP_DetectBackground 
                         TRUE                      TRUE                      TRUE 
             BP_DetectCenters       BP_DetectForeground      BP_DuplicateAnalysis 
                         TRUE                      TRUE                      TRUE 
       BP_EstimateCompactness BP_FitBayesianCompactness       BP_FitMLCompactness 
                         TRUE                      TRUE                      TRUE 
    BP_FitMLRadialCompactness    BP_GetFittedParameters           BP_ListAnalyses 
                         TRUE                      TRUE                      TRUE 
            BP_LnLCompactness              BP_OpenImage                 BP_Report 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-15 04:31:35 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5b141fbc_1739593890
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptHdsdB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BoneProfileR_v3.1-tikzDictionary"
