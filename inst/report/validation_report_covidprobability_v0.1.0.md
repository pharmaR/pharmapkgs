# Validation Report - covidprobability@0.1.0
...
| export_help          | 7                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Eric Brown <eb@ericebrown.com>              |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/eebrown/covidprobability |
...
Overall the package has 7 exported objects. 7 are documented:
            ...
            adjust_pretest      calc_postest_prob individual_probability 
                      TRUE                   TRUE                   TRUE 
           posttest_series        probability_any         prop_remaining 
                      TRUE                   TRUE                   TRUE 
          unit_probability 
                      TRUE 
...
| Execution Time | 2025-02-17 04:09:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bd676dbb623_1739765340
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9f6Rzn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covidprobability_v0.1.0-tikzDictionary"
