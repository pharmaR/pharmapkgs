# Validation Report - decido@0.3.0
...
eplusr, raybevel, rayrender, silicate

## Namespace

Overall the package has 3 exported objects. 3 are documented:

        earcut  plot_ears plot_holes 
          TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-18 03:32:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47341f0de_1739849527
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7yLoXq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_decido_v0.3.0-tikzDictionary"
