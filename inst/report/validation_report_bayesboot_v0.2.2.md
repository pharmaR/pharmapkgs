# Validation Report - bayesboot@0.2.2
...
| has_source_control   | https://github.com/rasmusab/bayesboot |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | plyr (\>= 1.8.3)      | Imports |
| 2   | HDInterval(\>= 0.1.1) | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    as.bayesboot    bayesboot     plotPost  rudirichlet 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-15 03:32:10 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd27c2e1c6_1739590326
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFLQD02
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesboot_v0.2.2-tikzDictionary"
