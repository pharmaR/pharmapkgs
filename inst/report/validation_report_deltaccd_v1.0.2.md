# Validation Report - deltaccd@1.0.2
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Jake Hughey <jakejhughey@gmail.com>                  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/hugheylab/deltaccd                |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | doRNG (\>= 1.6.6)       | Imports |
| 2   | foreach (\>= 1.4.3)     | Imports |
| 3   | ggplot2 (\>= 2.2.1)     | Imports |
| 4   | rlang (\>= 0.4.11)      | Imports |
| 5   | scales (\>= 0.5.0)      | Imports |
| 6   | statmod (\>= 1.4.30)    | Imports |
| 7   | data.table (\>= 1.14.0) | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
           ...
           calcCCD   calcDeltaCCD      getRefCor    plotHeatmap plotRefHeatmap 
...
| Execution Time | 2025-02-18 03:38:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4612b73aa_1739849910
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDCMgVi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deltaccd_v1.0.2-tikzDictionary"
