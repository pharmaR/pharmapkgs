# Validation Report - CopulaGAMM@0.4.1
...
| export_help          | 71                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Bruno N Remillard <bruno.remillard@hec.ca>           |
...
Overall the package has 71 exported objects. 71 are documented:
             ...
             berncpdf            coplik              dbvn             dbvn2 
                 TRUE              TRUE              TRUE              TRUE 
              dbvncop           dbvtcop              dcop              dfgm 
                 TRUE              TRUE              TRUE              TRUE 
                 dfrk              dgal              dgum               dhr 
                 TRUE              TRUE              TRUE              TRUE 
                 djoe             dmtcj              dpla     EstContinuous 
                 TRUE              TRUE              TRUE              TRUE 
          EstDiscrete           expcond           expcpdf          ffgmders 
                 TRUE              TRUE              TRUE              TRUE 
             ffrkders          fgumders          fjoeders         fmtcjders 
                 TRUE              TRUE              TRUE              TRUE 
             fnorders          fpladers            ftders           ftdersP 
                 TRUE              TRUE              TRUE              TRUE 
             geomcpdf           invfunc           lapcpdf           linkCop 
                 TRUE              TRUE              TRUE              TRUE 
       MAP.continuous      MAP.discrete           margins            mlecop 
                 TRUE              TRUE              TRUE              TRUE 
          mlecop.disc      multinomcpdf       nbinom1cpdf        nbinomcpdf 
                 TRUE              TRUE              TRUE              TRUE 
             normcpdf             pcond          pcondcla          pcondfgm 
                 TRUE              TRUE              TRUE              TRUE 
             pcondfrk          pcondgal          pcondgum           pcondhr 
                 TRUE              TRUE              TRUE              TRUE 
             pcondjoe          pcondnor          pcondpla            pcondt 
                 TRUE              TRUE              TRUE              TRUE 
             poiscpdf predictContinuous   predictDiscrete          pseudosC 
                 TRUE              TRUE              TRUE              TRUE 
                qcond          qcondcla          qcondfgm          qcondfra 
                 TRUE              TRUE              TRUE              TRUE 
             qcondgal          qcondgum           qcondhr          qcondjoe 
                 TRUE              TRUE              TRUE              TRUE 
             qcondnor          qcondpla            qcondt     SimGenCluster 
                 TRUE              TRUE              TRUE              TRUE 
       SimMultinomial             tcpdf          weibcpdf 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-17 03:55:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6297fe737_1739764512
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5ozlKi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CopulaGAMM_v0.4.1-tikzDictionary"
