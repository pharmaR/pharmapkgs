# Validation Report - ffmanova@1.1.2
...
| has_source_control   | https://github.com/olangsrud/ffmanova |
...
Overall the package has 22 exported objects. 22 are documented:
             ...
             adjust         ffAnova        ffmanova    ffmanovatest      ffModelObj 
               TRUE            TRUE            TRUE            TRUE            TRUE 
     fixModelMatrix       linregEst             m2c      manova5050     matlabColon 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       multiPvalues multiStatistics          myorth          orth_D    rotationtest 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      rotationtests          stdize         stdize3         unitest        unitests 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              x_Obj          xy_Obj 
               TRUE            TRUE 
...
| Execution Time | 2025-02-27 03:27:43 UTC |
...
running this report
    ...
    PROCESSX_PS1c621a05510b_1740626859
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqFzoj5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ffmanova_v1.1.2-tikzDictionary"
