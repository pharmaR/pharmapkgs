# Validation Report - EpiTest@1.0.0
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Simon Rio <simon.rio@cirad.fr>                       |
...
Overall the package has 4 exported objects. 3 are documented:
             ...
             %>%  EpiTest.fit EpiTest.plot VarList.comp 
...
| Execution Time | 2025-02-19 04:19:44 UTC |
...
running this report
    ...
    PROCESSX_PS1d457edc73ba_1739938778
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpxy7fjh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EpiTest_v1.0.0-tikzDictionary"
