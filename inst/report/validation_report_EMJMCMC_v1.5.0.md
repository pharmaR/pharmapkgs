# Validation Report - EMJMCMC@1.5.0
...
Overall the package has 19 exported objects. 19 are documented:
                      ...
                      erf      estimate.bas.glm       estimate.bas.lm 
                     TRUE                  TRUE                  TRUE 
            estimate.bigm        estimate.elnet   estimate.gamma.cpen 
                     TRUE                  TRUE                  TRUE 
    estimate.gamma.cpen_2          estimate.glm    estimate.logic.glm 
                     TRUE                  TRUE                  TRUE 
        estimate.logic.lm     estimate.speedglm             LogicRegr 
                     TRUE                  TRUE                  TRUE 
                        m            parall.gmj       pinferunemjmcmc 
                     TRUE                  TRUE                  TRUE 
               runemjmcmc               sigmoid      simplify.formula 
                     TRUE                  TRUE                  TRUE 
           truncfactorial 
                     TRUE 
...
| Execution Time | 2025-02-19 04:02:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d453d41f2af_1739937724
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJS2exo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EMJMCMC_v1.5.0-tikzDictionary"
