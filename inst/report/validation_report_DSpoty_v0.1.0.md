# Validation Report - DSpoty@0.1.0
...
| export_help          | 17                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Alberto Almuiña <albertogonzalezalmuinha@gmail.com>  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/AlbertoAlmuinha/DSpoty            |
...
Overall the package has 17 exported objects. 17 are documented:
                      ...
                      get_album_popularity                             get_artist 
                                      TRUE                                   TRUE 
                         get_artist_albums                      get_artist_tracks 
                                      TRUE                                   TRUE 
                get_artist_tracks_features                   get_artists_by_genre 
                                      TRUE                                   TRUE 
                       get_related_artists                    get_several_artists 
                                      TRUE                                   TRUE 
                        get_several_tracks            get_several_tracks_features 
                                      TRUE                                   TRUE 
    get_several_tracks_features_vectorized            get_similar_songs_algorithm 
                                      TRUE                                   TRUE 
                  get_spotify_access_token                       get_spotify_item 
                                      TRUE                                   TRUE 
                      get_track_popularity             get_tracks_recommendations 
                                      TRUE                                   TRUE 
        get_tracks_recommendations_by_name 
                                      TRUE 
...
| Execution Time | 2025-02-18 04:52:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4178b4a49_1739854348
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpceyCkH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DSpoty_v0.1.0-tikzDictionary"
