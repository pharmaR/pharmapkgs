# Validation Report - CARBayesST@4.0
...
| export_help          | 9                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Duncan Lee <Duncan.Lee@glasgow.ac.uk>    |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/duncanplee/CARBayesST |
...
|:----|:------------------|:----------|
| 1   | MASS              | Depends   |
| 2   | Rcpp (\>= 0.11.5) | Depends   |
| 3   | CARBayesdata      | Imports   |
| 4   | coda              | Imports   |
| 5   | dplyr             | Imports   |
| 6   | GGally            | Imports   |
| 7   | ggplot2           | Imports   |
...
| 16  | spdep             | Imports   |
| 17  | stats             | Imports   |
| 18  | truncdist         | Imports   |
| 19  | truncnorm         | Imports   |
| 20  | utils             | Imports   |
| 21  | Rcpp              | LinkingTo |
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          MVST.CARar   ST.CARadaptive      ST.CARanova         ST.CARar 
                TRUE             TRUE             TRUE             TRUE 
    ST.CARclustrends     ST.CARlinear  ST.CARlocalised ST.CARsepspatial 
                TRUE             TRUE             TRUE             TRUE 
          W.estimate 
                TRUE 
...
| Execution Time | 2025-02-16 03:40:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37a75baff_1739677223
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4GJxee
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CARBayesST_v4.0-tikzDictionary"
