...
| size_codebase        | 243                                          |
| has_source_control   | https://github.com/r-tensorflow/autokeras    |
...
Overall the package has 11 exported objects. 11 are documented:
                            ...
                            evaluate                     export_model 
                                TRUE                             TRUE 
                                 fit                install_autokeras 
                                TRUE                             TRUE 
              model_image_classifier            model_image_regressor 
                                TRUE                             TRUE 
    model_structured_data_classifier  model_structured_data_regressor 
                                TRUE                             TRUE 
               model_text_classifier             model_text_regressor 
                                TRUE                             TRUE 
                             predict 
                                TRUE 
...
| Execution Time | 2025-02-14 07:33:42 UTC |
...
running this report
    ...
    PROCESSX_PS1c094633d9ee_1739518419
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpULJjV2
