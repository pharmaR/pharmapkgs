# Validation Report - enderecobr@0.4.1
...
| has_source_control   | https://github.com/ipeaGIT/enderecobr |
...
Overall the package has 14 exported objects. 14 are documented:
                     ...
                     codigos_estados               codigos_municipios 
                                TRUE                             TRUE 
              correspondencia_campos       correspondencia_logradouro 
                                TRUE                             TRUE 
                  padronizar_bairros                  padronizar_ceps 
                                TRUE                             TRUE 
             padronizar_complementos             padronizar_enderecos 
                                TRUE                             TRUE 
                  padronizar_estados           padronizar_logradouros 
                                TRUE                             TRUE 
    padronizar_logradouros_completos            padronizar_municipios 
                                TRUE                             TRUE 
                  padronizar_numeros   padronizar_tipos_de_logradouro 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-19 04:06:37 UTC |
...
running this report
    ...
    PROCESSX_PS1d457db53ce9_1739937991
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3c4r08
...
These are the options set to generate the report:
    ...
    [1] "validation_report_enderecobr_v0.4.1-tikzDictionary"
