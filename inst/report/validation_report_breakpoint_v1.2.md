# Validation Report - breakpoint@1.2
...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Priyadarshana W.J.R.M. <mjayawardana@swin.edu.au>    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/madawaweer/breakpoint             |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | ggplot2 (\>= 1.0.0)     | Imports |
| 2   | MASS                    | Imports |
| 3   | msm (\>= 1.0.1)         | Imports |
| 4   | foreach (\>= 1.2.0)     | Imports |
| 5   | parallel                | Imports |
| 6   | doParallel (\>= 1.0.10) | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
                     ...
                     CE.NB             CE.NB.Init    CE.Normal.Init.Mean 
                      TRUE                   TRUE                   TRUE 
    CE.Normal.Init.MeanVar         CE.Normal.Mean      CE.Normal.MeanVar 
                      TRUE                   TRUE                   TRUE 
                   CE.ZINB           CE.ZINB.Init            profilePlot 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:42:57 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4aba2874_1739594572
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPbR5IW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_breakpoint_v1.2-tikzDictionary"
