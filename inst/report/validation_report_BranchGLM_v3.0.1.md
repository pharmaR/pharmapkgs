# Validation Report - BranchGLM@3.0.1
...
| export_help          | 12                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Jacob Seedorff <jacob-seedorff@uiowa.edu>    |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/JacobSeedorff21/BranchGLM |
...
Overall the package has 12 exported objects. 12 are documented:
                        ...
                        AUC               BranchGLM           BranchGLM.fit 
                       TRUE                    TRUE                    TRUE 
                     Cindex         fit.BranchGLMVS       MultipleROCCurves 
                       TRUE                    TRUE                    TRUE 
                     plotCI                     ROC                   Table 
                       TRUE                    TRUE                    TRUE 
         VariableImportance VariableImportance.boot       VariableSelection 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-15 04:41:03 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd60684073_1739594458
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnwZMGw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BranchGLM_v3.0.1-tikzDictionary"
