# Validation Report - condvis2@0.1.2
...
| has_source_control   | https://github.com/cbhurley/condvis2      |
...
Overall the package has 21 exported objects. 21 are documented:
              ...
              alongPath        centroidPath           claraPath       conditionPlot 
                   TRUE                TRUE                TRUE                TRUE 
                condvis           CVpredict         diffitsPath      hiresponsePath 
                   TRUE                TRUE                TRUE                TRUE 
             kmeansPath             lofPath      loresponsePath              medoid 
                   TRUE                TRUE                TRUE                TRUE 
             medoidPath             pamPath     pathInterpolate plotTourDiagnostics 
                   TRUE                TRUE                TRUE                TRUE 
             randomPath         sectionPlot             seqPath    similarityweight 
                   TRUE                TRUE                TRUE                TRUE 
            weightcolor 
                   TRUE 
...
| Execution Time | 2025-02-17 03:41:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66973aabf_1739763714
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpool0gD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_condvis2_v0.1.2-tikzDictionary"
