# Validation Report - DescrTab2@2.1.16
...
| export_help          | 14                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Jan Meis <meis@imbi.uni-heidelberg.de> |
...
| 12  | scales                | Imports |
| 13  | cli                   | Imports |
| 14  | kableExtra            | Imports |
| 15  | flextable (\>= 0.6.6) | Imports |
| 16  | officer               | Imports |
| 17  | knitr                 | Imports |
| 18  | rmarkdown             | Imports |
| 19  | haven                 | Imports |
| 20  | Hmisc                 | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
    ...
    codegen_load_all_sas_data                     descr            extract_labels 
                         TRUE                      TRUE                      TRUE 
           farrington.manning         guess_ID_variable              lapply_descr 
                         TRUE                      TRUE                      TRUE 
       list_freetext_markdown             parse_formats          print_test_names 
                         TRUE                      TRUE                      TRUE 
        read_redcap_formatted        read_sas_formatted                  sig_test 
                         TRUE                      TRUE                      TRUE 
         split_redcap_dataset                   unlabel 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-18 03:47:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46a5a085e_1739850418
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpbiwmu8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DescrTab2_v2.1.16-tikzDictionary"
