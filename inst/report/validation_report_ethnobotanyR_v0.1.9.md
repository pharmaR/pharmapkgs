# Validation Report - ethnobotanyR@0.1.9
...
| export_help          | 16                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Cory Whitney <whitney.cory@gmail.com> |
...
Overall the package has 16 exported objects. 16 are documented:
                      ...
                      CIs                   CVe        ethno_alluvial 
                     TRUE                  TRUE                  TRUE 
    ethno_bayes_consensus            ethno_boot            ethnoChord 
                     TRUE                  TRUE                  TRUE 
                      FCs                   FLs                   NUs 
                     TRUE                  TRUE                  TRUE 
              Radial_plot                  RFCs                   RIs 
                     TRUE                  TRUE                  TRUE 
               simple_UVs                   URs                 URsum 
                     TRUE                  TRUE                  TRUE 
                      UVs 
                     TRUE 
...
| Execution Time | 2025-02-19 04:34:07 UTC |
...
running this report
    ...
    PROCESSX_PS1d454899b3de_1739939640
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpczdbxB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ethnobotanyR_v0.1.9-tikzDictionary"
