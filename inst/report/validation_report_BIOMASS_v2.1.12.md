# Validation Report - BIOMASS@2.1.12
...
Overall the package has 20 exported objects. 20 are documented:
         ...
         AGBmonteCarlo      attributeTree attributeTreeCoord       cacheManager 
                  TRUE               TRUE               TRUE               TRUE 
             cachePath         computeAGB           computeE  computeFeldRegion 
                  TRUE               TRUE               TRUE               TRUE 
       correctCoordGPS        correctTaxo        createCache            cutPlot 
                  TRUE               TRUE               TRUE               TRUE 
       getBioclimParam        getTaxonomy     getWoodDensity        latlong2UTM 
                  TRUE               TRUE               TRUE               TRUE 
               modelHD       numberCorner          retrieveH      summaryByPlot 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:13:36 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd26d565ec_1739592811
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmMd5Pq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BIOMASS_v2.1.12-tikzDictionary"
