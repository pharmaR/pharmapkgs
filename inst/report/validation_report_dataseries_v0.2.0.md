# Validation Report - dataseries@0.2.0
...
| export_help          | 4                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Christoph Sax <christoph.sax@gmail.com> |
...
Overall the package has 4 exported objects. 4 are documented:
     ...
     cache_ls  cache_rm        ds inventory 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-17 05:00:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67cfc0e29_1739768444
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphfXlNh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dataseries_v0.2.0-tikzDictionary"
