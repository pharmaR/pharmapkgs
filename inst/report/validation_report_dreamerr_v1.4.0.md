# Validation Report - dreamerr@1.4.0
...
| export_help          | 40                                          |
| has_website          | FALSE                                       |
| has_maintainer       | Laurent Berge <laurent.berge@u-bordeaux.fr> |
| bugs_status          | subscript out of bounds                     |
| has_bug_reports_url  | 1                                           |
| downloads_1yr        | 149645                                      |
...
fastdid, fixest, fplot, ggfixest, hdd, summclust

## Namespace

Overall the package has 40 exported objects. 40 are documented:

                   check_arg           check_arg_plus               check_expr 
                        TRUE                     TRUE                     TRUE 
             check_expr_hook            check_set_arg          check_set_value 
                        TRUE                     TRUE                     TRUE 
                 check_value         check_value_plus          enumerate_items 
                        TRUE                     TRUE                     TRUE 
                  fit_screen                  fsignif generate_check_expr_hook 
                        TRUE                     TRUE                     TRUE 
           generate_get_hook        generate_set_hook       generate_stop_hook 
                        TRUE                     TRUE                     TRUE 
          generate_warn_hook                 ifsingle                   ifunit 
                        TRUE                     TRUE                     TRUE 
                    n_letter                     n_th                  n_times 
                        TRUE                     TRUE                     TRUE 
               package_stats                   plural               plural_len 
                        TRUE                     TRUE                     TRUE 
                   set_check                 set_hook                   set_up 
                        TRUE                     TRUE                     TRUE 
           setDreamerr_check     setDreamerr_dev.mode   setDreamerr_show_stack 
                        TRUE                     TRUE                     TRUE 
                       sfill              signif_plus                stop_hook 
                        TRUE                     TRUE                     TRUE 
                     stop_up                    stopi             suggest_item 
                        TRUE                     TRUE                     TRUE 
               validate_dots                warn_hook                  warn_up 
                        TRUE                     TRUE                     TRUE 
                       warni 
                        TRUE 
...
| Execution Time | 2025-02-18 04:45:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47f54f704_1739853911
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKXMwPt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dreamerr_v1.4.0-tikzDictionary"
