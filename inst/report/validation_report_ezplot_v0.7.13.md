# Validation Report - ezplot@0.7.13
...
| export_help          | 34                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Wojtek Kostelecki <wojtek.kostelecki@gmail.com>      |
...
Overall the package has 34 exported objects. 34 are documented:
             ...
             agg_data         area_plot          bar_plot     calendar_plot 
                 TRUE              TRUE              TRUE              TRUE 
         density_plot distribution_plot            ez_app            ez_col 
                 TRUE              TRUE              TRUE              TRUE 
               ez_jet         ez_labels            ez_png         ez_server 
                 TRUE              TRUE              TRUE              TRUE 
                ez_ui    histogram_plot           ks_plot         lift_plot 
                 TRUE              TRUE              TRUE              TRUE 
            line_plot        model_plot           na_plot           no_null 
                 TRUE              TRUE              TRUE              TRUE 
              perf_df  performance_plot          pie_plot           pr_plot 
                 TRUE              TRUE              TRUE              TRUE 
             roc_plot          save_png      scatter_plot    secondary_plot 
                 TRUE              TRUE              TRUE              TRUE 
            side_plot     text_contrast          theme_ez         tile_plot 
                 TRUE              TRUE              TRUE              TRUE 
        variable_plot    waterfall_plot 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-19 05:01:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d455025d143_1739941260
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEnyqWW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ezplot_v0.7.13-tikzDictionary"
