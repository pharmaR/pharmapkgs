...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | miscF (\>= 0.1-4)    | Depends |
| 2   | lme4 (\>= 1.0-4)     | Depends |
| 3   | R2jags (\>= 0.03-11) | Imports |
| 4   | coda (\>= 0.16-1)    | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
     ...
     agree.ccc agree.icc1 agree.plot  agree.sdd agree.sddm agree.wscv 
...
| Execution Time | 2025-02-14 06:43:01 UTC |
...
running this report
    ...
    PROCESSX_PS726d321d75ef_1739515378
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZ3oR6g
