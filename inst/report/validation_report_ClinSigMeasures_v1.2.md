# Validation Report - ClinSigMeasures@1.2
...
| export_help | 16 |
| has_website | FALSE |
| has_maintainer | Mike Malek-Ahmadi <michael.malekahmadi@bannerhealth.com> |
...
Overall the package has 16 exported objects. 16 are documented:
              ...
              cohens_d           cohens_q                 cv             lr_neg 
                  TRUE               TRUE               TRUE               TRUE 
                lr_pos                nnd                nnt                npv 
                  TRUE               TRUE               TRUE               TRUE 
            odds_ratio     partial_eta_sq                ppv                psi 
                  TRUE               TRUE               TRUE               TRUE 
    robust_effect_size        sensitivity        specificity       youden_index 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:33:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3f7eaae4_1739680386
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpefxHnG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClinSigMeasures_v1.2-tikzDictionary"
