# Validation Report - ClinicalUtilityRecal@0.1.0
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Anu Mishra <anmishra@uw.edu>                         |
...
Overall the package has 10 exported objects. 10 are documented:
      ...
      calCurvPlot         calWt    constRecal cvRepWtTuning    cvWtTuning 
             TRUE          TRUE          TRUE          TRUE          TRUE 
               nb       RAWgrid  snbRecalPlot      stdRecal       wtRecal 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-16 04:32:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37cb7e940_1739680363
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxNG2zG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClinicalUtilityRecal_v0.1.0-tikzDictionary"
