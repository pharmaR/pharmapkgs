...
| has_source_control   | https://github.com/macmillancontentscience/dlr |
...
morphemepiece, wordpiece

## Namespace

Overall the package has 8 exported objects. 8 are documented:

                   app_cache_dir   construct_cached_file_path 
                            TRUE                         TRUE 
    construct_processed_filename                  maybe_cache 
                            TRUE                         TRUE 
                   maybe_process                read_or_cache 
                            TRUE                         TRUE 
                 read_or_process            set_app_cache_dir 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-18 04:26:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42830a263_1739852767
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6MaoeV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dlr_v1.0.1-tikzDictionary"
