# Validation Report - EstimationTools@4.0.0
...
| export_help          | 28                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Jaime Mosquera <jmosquerag@unal.edu.co>      |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/Jaimemosg/EstimationTools |
...
Overall the package has 28 exported objects. 28 are documented:
     ...
     bootstrap_maxlogL           coefMany   extract_fun_args        fo_and_data 
                  TRUE               TRUE               TRUE               TRUE 
          formula2Surv         gauss_quad      half_norm_key         hazard_fun 
                  TRUE               TRUE               TRUE               TRUE 
       hazard_rate_key       Hazard_Shape        integration     interp.options 
                  TRUE               TRUE               TRUE               TRUE 
       is.EmpiricalTTT     is.HazardShape         is.maxlogL legend.HazardShape 
                  TRUE               TRUE               TRUE               TRUE 
         loess.options           log_link         logit_link            maxlogL 
                  TRUE               TRUE               TRUE               TRUE 
            maxlogLreg        NegInv_link       null_maxlogL  saturated_maxlogL 
                  TRUE               TRUE               TRUE               TRUE 
               summate   TTT_hazard_shape    TTTE_Analytical        uniform_key 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:32:22 UTC |
...
running this report
    ...
    PROCESSX_PS1d451d4652c7_1739939536
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4cuyW4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EstimationTools_v4.0.0-tikzDictionary"
