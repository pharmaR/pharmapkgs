# Validation Report - distreg.vis@1.7.5
...
| export_help          | 9                                              |
| has_website          | TRUE                                           |
| has_maintainer       | Stanislaus Stadlmann <stanislaus@stadlmann.cm> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/Stan125/distreg.vis         |
...
| 2   | utils                     | Imports |
| 3   | methods                   | Imports |
| 4   | shiny (\>= 1.0.3)         | Imports |
| 5   | bamlss (\>= 0.1-2)        | Imports |
| 6   | gamlss (\>= 5.0-6)        | Imports |
| 7   | gamlss.dist (\>= 5.1-0)   | Imports |
| 8   | ggplot2 (\>= 2.2.1)       | Imports |
| 9   | rhandsontable (\>= 0.3.4) | Imports |
| 10  | magrittr (\>= 1.5)        | Imports |
| 11  | formatR (\>= 1.5)         | Imports |
| 12  | betareg (\>= 3.1-2)       | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    distreg_checker      model_data  model_fam_data         moments       plot_dist 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       plot_moments           preds        set_mean             vis 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:19:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4660a36c2_1739852368
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptWBvOA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distreg.vis_v1.7.5-tikzDictionary"
