...
| export_help          | 29                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Trevor Hastie <hastie@stanford.edu>      |
| bugs_status          | subscript out of bounds                  |
| size_codebase        | 2118                                     |
| has_source_control   | https://github.com/JamesYang007/adelie-r |
...
Overall the package has 29 exported objects. 29 are documented:
                   ...
                   coef.grpnet                  cv.grpnet 
                          TRUE                       TRUE 
                  gaussian_cov               glm.binomial 
                          TRUE                       TRUE 
                       glm.cox               glm.gaussian 
                          TRUE                       TRUE 
             glm.multigaussian            glm.multinomial 
                          TRUE                       TRUE 
                   glm.poisson                     grpnet 
                          TRUE                       TRUE 
        io.snp_phased_ancestry            io.snp_unphased 
                          TRUE                       TRUE 
             matrix.block_diag         matrix.concatenate 
                          TRUE                       TRUE 
                  matrix.dense           matrix.eager_cov 
                          TRUE                       TRUE 
            matrix.interaction       matrix.kronecker_eye 
                          TRUE                       TRUE 
               matrix.lazy_cov             matrix.one_hot 
                          TRUE                       TRUE 
    matrix.snp_phased_ancestry        matrix.snp_unphased 
                          TRUE                       TRUE 
                 matrix.sparse         matrix.standardize 
                          TRUE                       TRUE 
                 matrix.subset                plot.grpnet 
                          TRUE                       TRUE 
                predict.grpnet            print.cv.grpnet 
                          TRUE                       TRUE 
                   set_configs 
                          TRUE 
...
| Execution Time | 2025-02-14 06:36:49 UTC |
...
running this report
    ...
    PROCESSX_PS726d53e5c2a4_1739515006
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpujx0C5
