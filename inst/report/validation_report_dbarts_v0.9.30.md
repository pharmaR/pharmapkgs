# Validation Report - dbarts@0.9.30
...
| export_help          | 14                               |
| has_website          | TRUE                             |
| has_maintainer       | Vincent Dorie <vdorie@gmail.com> |
| bugs_status          | subscript out of bounds          |
| has_source_control   | https://github.com/vdorie/dbarts |
...
bartCause, bartMan, bundle, butcher, countSTAR, EBcoBART, glossa,
marginaleffects, MatchIt, mcmcsae, riAFTBART, stan4bart, tidyAML,
...
Overall the package has 14 exported objects. 14 are documented:
                      ...
                      dbartsData                      extract 
                            TRUE                         TRUE 
                   guessNumCores                      makeind 
                            TRUE                         TRUE 
    makeModelMatrixFromDataFrame          makeTestModelMatrix 
                            TRUE                         TRUE 
                         pd2bart                       pdbart 
                            TRUE                         TRUE 
                        rbart_vi                        xbart 
...
| Execution Time | 2025-02-17 05:05:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61356e244_1739768716
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb4mLC7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dbarts_v0.9.30-tikzDictionary"
