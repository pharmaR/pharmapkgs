# Validation Report - corTESTsrd@1.0.0
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | David Lun <lun@hydro.tuwien.ac.at>                   |
...
Overall the package has 6 exported objects. 6 are documented:
                      ...
                      corTESTsrd      kendall_var_independent 
                            TRUE                         TRUE 
     long_run_var_est_kendall_H0 long_run_var_est_spearman_H0 
                            TRUE                         TRUE 
                         rankacf     spearman_var_independent 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-17 04:02:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63aefad49_1739764922
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8coMZ9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corTESTsrd_v1.0.0-tikzDictionary"
