...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Anja Lange <anja.lange@uni-due.de>                   |
...
Overall the package has 8 exported objects. 8 are documented:
        ...
        accepted.amplicons            ampliconduo      discordance.delta 
                      TRUE                   TRUE                   TRUE 
        filter.ampliconduo filter.ampliconduo.set        plotAmpliconduo 
                      TRUE                   TRUE                   TRUE 
       plotAmpliconduo.set          plotORdensity 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-14 06:53:01 UTC |
...
running this report
    ...
    PROCESSX_PS726d5cfb20ec_1739515978
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKzvuFH
