# Validation Report - d3plus@0.1.0
...
Overall the package has 10 exported objects. 10 are documented:
        ...
        d3p_data       d3p_id    d3p_links    d3p_nodes     d3p_type        d3p_x 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           d3p_y       d3plus d3plusOutput renderD3plus 
            TRUE         TRUE         TRUE         TRUE 

### Examples

There are 1 help pages with examples, from 9 (11.11 %).
...
| Execution Time | 2025-02-17 04:48:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63e99f80f_1739767703
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpm6lPPI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_d3plus_v0.1.0-tikzDictionary"
