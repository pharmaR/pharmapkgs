# Validation Report - baygel@0.3.0
...
| has_source_control   | https://github.com/Jarod-Smithy/baygel               |
...
| 2   | RcppArmadillo (\>= 0.11.1.1.0) | Imports   |
| 3   | Rcpp                           | LinkingTo |
| 4   | RcppArmadillo                  | LinkingTo |
| 5   | RcppProgress                   | LinkingTo |
...
Overall the package has 7 exported objects. 7 are documented:
     ...
     blockBAGENI blockBAGENII    blockBAGL    blockBAGR    blockBGEN     blockBGL 
...
| Execution Time | 2025-02-15 03:42:52 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd55c93e_1739590967
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBatjYm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_baygel_v0.3.0-tikzDictionary"
