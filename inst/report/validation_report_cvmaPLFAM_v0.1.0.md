# Validation Report - cvmaPLFAM@0.1.0
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Shishi Liu <liushishi_644@163.com>                   |
...
Overall the package has 6 exported objects. 6 are documented:
      ...
      cvfolds cvmaPLFAM  data_gen  fpcscore modelspec  predRisk 
...
| Execution Time | 2025-02-17 04:44:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63e4db171_1739767441
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5BmUcz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cvmaPLFAM_v0.1.0-tikzDictionary"
