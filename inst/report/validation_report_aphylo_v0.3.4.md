...
| bugs_status          | 0.5909091                             |
| size_codebase        | 3204                                  |
| has_source_control   | https://github.com/USCbiostats/aphylo |
...
Overall the package has 40 exported objects. 40 are documented:
                ...
                accuracy_sifter                   aphylo_cv 
                           TRUE                        TRUE 
    APHYLO_DEFAULT_MCMC_CONTROL              aphylo_formula 
                           TRUE                        TRUE 
         aphylo_from_data_frame                 aphylo_mcmc 
                           TRUE                        TRUE 
                     aphylo_mle        APHYLO_PARAM_DEFAULT 
                           TRUE                        TRUE 
                            auc                 balance_ann 
                           TRUE                        TRUE 
                         bprior                   dist2root 
                           TRUE                        TRUE 
                  get_postorder       imputate_duplications 
                           TRUE                        TRUE 
                 list_offspring                list_parents 
                           TRUE                        TRUE 
                        LogLike                    mislabel 
                           TRUE                        TRUE 
                           Nann                  Nannotated 
                           TRUE                        TRUE 
                     new_aphylo           new_aphylo_pruner 
                           TRUE                        TRUE 
                         Ntrees                 plot_logLik 
                           TRUE                        TRUE 
              plot_multivariate         predict_brute_force 
                           TRUE                        TRUE 
              predict_pre_order            prediction_score 
                           TRUE                        TRUE 
                        raphylo           rdrop_annotations 
                           TRUE                        TRUE 
                       read_nhx                read_panther 
                           TRUE                        TRUE 
                       read_pli                read.panther 
                           TRUE                        TRUE 
                   rmultiAphylo             sim_fun_on_tree 
                           TRUE                        TRUE 
                       sim_tree                      states 
                           TRUE                        TRUE 
                         uprior                   write_pli 
...
There are 36 help pages with examples, from 38 (94.74 %).
...
| Execution Time | 2025-02-14 07:18:01 UTC |
...
running this report
    ...
    PROCESSX_PS1c095534e0d8_1739517478
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiKPUr0
