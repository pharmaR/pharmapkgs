# Validation Report - fastOnlineCpt@1.0
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Georg Hahn <ghahn@hsph.harvard.edu>                  |
...
Overall the package has 5 exported objects. 5 are documented:
           ...
           addData       checkCpt  fastOnlineCpt    lastCptTest resetAlgorithm 
...
| Execution Time | 2025-02-19 05:19:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d457c692352_1739942380
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1monVz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastOnlineCpt_v1.0-tikzDictionary"
