# Validation Report - CopSens@0.1.0
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Jiajing Zheng <carolinez6850@gmail.com>              |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/JiajingZ/CopSens                  |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | pcaMethods (\>= 1.78.0) | Imports |
| 2   | CVXR (\>= 1.0)          | Imports |
| 3   | MASS (\>= 7.3-53)       | Imports |
| 4   | ggplot2 (\>= 3.3.3)     | Imports |
| 5   | stats (\>= 4.0.3)       | Imports |
| 6   | dplyr (\>= 1.0.3)       | Imports |
| 7   | tidyr (\>= 1.1.2)       | Imports |
| 8   | tidyverse (\>= 1.3.0)   | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
        ...
        bcalibrate         cal_rv     gcalibrate plot_estimates 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 03:54:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64bb12df2_1739764464
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7GmTod
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CopSens_v0.1.0-tikzDictionary"
