# Validation Report - CRTgeeDR@2.0.1
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Melanie Prague <mprague@hsph.harvard.edu>            |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    geeDREstimation           getCI       getOMPlot       getPSPlot 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:27:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67a557ba8_1739766424
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1855xC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CRTgeeDR_v2.0.1-tikzDictionary"
