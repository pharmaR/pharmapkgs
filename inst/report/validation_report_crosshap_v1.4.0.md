# Validation Report - crosshap@1.4.0
...
| export_help          | 22                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Jacob Marsh <jake.marsh@live.com.au> |
...
Overall the package has 22 exported objects. 21 are documented:
                        ...
                        %>%              arith_mode   build_bot_halfeyeplot 
                      FALSE                    TRUE                    TRUE 
      build_left_alleleplot      build_left_posplot       build_mid_dotplot 
                       TRUE                    TRUE                    TRUE 
    build_right_clusterplot   build_right_phenoplot    build_summary_tables 
                       TRUE                    TRUE                    TRUE 
         build_top_metaplot            clustree_viz            crosshap_viz 
                       TRUE                    TRUE                    TRUE 
                 mean_na.rm        prepare_hap_umap             pseudo_haps 
                       TRUE                    TRUE                    TRUE 
                    read_LD           read_metadata              read_pheno 
                       TRUE                    TRUE                    TRUE 
                   read_vcf         run_haplotyping run_hdbscan_haplotyping 
                       TRUE                    TRUE                    TRUE 
                  tagphenos 
                       TRUE 
...
| Execution Time | 2025-02-17 04:23:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bd614326efe_1739766223
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyHABfX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crosshap_v1.4.0-tikzDictionary"
