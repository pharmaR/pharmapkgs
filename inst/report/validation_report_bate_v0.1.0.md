...
| export_help          | 17                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Deepankar Basu <dbasu@umass.edu>                     |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/dbasu-umass/bate/                 |
...
Overall the package has 17 exported objects. 17 are documented:
      ...
      collect_par     cplotbias      delfplot     dplotbate expand_border 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       get_border       mycubic        mydisc      osterbds  osterdelstar 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           ovbias     ovbias_lm    ovbias_par     partocoef    selectroot 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       split_nurr       urrplot 
             TRUE          TRUE 
...
| Execution Time | 2025-02-15 03:30:28 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6e0ddf0a_1739590224
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJLBGXl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bate_v0.1.0-tikzDictionary"
