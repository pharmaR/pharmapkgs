...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Lukas Isermann <lukas.isermann@uni-mannheim.de>      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 665                                                  |
| has_source_control   | https://github.com/liserman/archiveRetriever/        |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    archive_overview   retrieve_links    retrieve_urls      scrape_urls 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-14 07:21:44 UTC |
...
running this report
    ...
    PROCESSX_PS1c095ee0db14_1739517701
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoD3OdJ
