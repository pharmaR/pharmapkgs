...
| export_help          | 22                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mirrelijn M. van Nee <m.vannee@amsterdamumc.nl>      |
...
Overall the package has 22 exported objects. 22 are documented:
                   ...
                   coef.ecpc                createCon           createGroupset 
                        TRUE                     TRUE                     TRUE 
                     createS       createZforGroupset        createZforSplines 
                        TRUE                     TRUE                     TRUE 
                     cv.ecpc                     ecpc        hierarchicalLasso 
                        TRUE                     TRUE                     TRUE 
             obtainHierarchy                penalties                plot.ecpc 
                        TRUE                     TRUE                     TRUE 
                  postSelect             predict.ecpc               print.ecpc 
                        TRUE                     TRUE                     TRUE 
                produceFolds                   simDat              splitMedian 
                        TRUE                     TRUE                     TRUE 
                summary.ecpc        visualiseGroupset visualiseGroupsetweights 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-19 03:38:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d4575dc525d_1739936306
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQVKcOY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecpc_v3.1.1-tikzDictionary"
