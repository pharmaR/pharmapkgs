# Validation Report - blavaan@0.5.8
...
| export_help          | 20                                  |
| has_website          | TRUE                                |
| has_maintainer       | Edgar Merkle <merklee@missouri.edu> |
| bugs_status          | 0.9666667                           |
| has_source_control   | https://github.com/ecmerkle/blavaan |
...
| 1   | R(\>= 3.5.0)              | Depends   |
| 2   | methods                   | Depends   |
| 3   | Rcpp(\>= 0.12.15)         | Depends   |
| 4   | stats                     | Imports   |
| 5   | utils                     | Imports   |
| 6   | graphics                  | Imports   |
| 7   | lavaan(\>= 0.6-18)        | Imports   |
| 8   | coda                      | Imports   |
| 9   | mnormt                    | Imports   |
| 10  | nonnest2(\>= 0.5-7)       | Imports   |
| 11  | loo(\>= 2.0)              | Imports   |
| 12  | rstan(\>= 2.26.0)         | Imports   |
| 13  | rstantools(\>= 1.5.0)     | Imports   |
| 14  | RcppParallel (\>= 5.0.1)  | Imports   |
| 15  | bayesplot                 | Imports   |
| 16  | Matrix                    | Imports   |
| 17  | future.apply              | Imports   |
| 18  | tmvnsim                   | Imports   |
| 19  | StanHeaders (\>= 2.26.0)  | LinkingTo |
| 20  | rstan (\>= 2.26.0)        | LinkingTo |
| 21  | BH (\>= 1.69.0)           | LinkingTo |
| 22  | Rcpp (\>= 0.12.15)        | LinkingTo |
| 23  | RcppEigen (\>= 0.3.3.4.0) | LinkingTo |
| 24  | RcppParallel (\>= 5.0.1)  | LinkingTo |
...
bayestestR, brxx, insight, performance, semTools, tidySEM
...
Overall the package has 16 exported objects. 16 are documented:
                     ...
                     bcfa                    BF               bgrowth 
                     TRUE                  TRUE                  TRUE 
                  blavaan           blavCompare        blavFitIndices 
                     TRUE                  TRUE                  TRUE 
              blavInspect           blavPredict              blavTech 
                     TRUE                  TRUE                  TRUE 
                     bsem               dpriors              labelfun 
                     TRUE                  TRUE                  TRUE 
                     ppmc            sampleData standardizedposterior 
                     TRUE                  TRUE                  TRUE 
...
There are 13 help pages with examples, from 14 (92.86 %).
...
| Execution Time | 2025-02-22 03:17:48 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb2ae3f6bf_1740194264
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXcCEeg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blavaan_v0.5.8-tikzDictionary"
