...
| has_source_control   | https://github.com/cran-task-views/ctv/              |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       available.views check_ctv_packages         CRAN.views                ctv 
                  TRUE               TRUE               TRUE               TRUE 
              ctv2html     download.views      install.views           read.ctv 
                  TRUE               TRUE               TRUE               TRUE 
    repos_update_views       update.views 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:36:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bd676e3af0a_1739766995
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfU4jpH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ctv_v0.9.6-tikzDictionary"
