# Validation Report - BayesGrowth@1.0.0
...
| export_help          | 7                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Jonathan Smart <jonsmartphd@gmail.com>       |
| bugs_status          | 1                                            |
| has_source_control   | https://github.com/jonathansmart/BayesGrowth |
...
| 8   | RcppParallel (\>= 5.0.1)  | Imports   |
| 9   | rstan (\>= 2.18.1)        | Imports   |
| 10  | rstantools (\>= 2.3.1.1)  | Imports   |
| 11  | stats                     | Imports   |
| 12  | tibble                    | Imports   |
| 13  | tidybayes                 | Imports   |
| 14  | BH (\>= 1.66.0)           | LinkingTo |
| 15  | Rcpp (\>= 0.12.0)         | LinkingTo |
| 16  | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 17  | RcppParallel (\>= 5.0.1)  | LinkingTo |
| 18  | rstan (\>= 2.18.1)        | LinkingTo |
| 19  | StanHeaders (\>= 2.18.0)  | LinkingTo |
...
Overall the package has 7 exported objects. 7 are documented:
              ...
              Calc_Gompertz_LAA           Calc_Logistic_LAA 
                           TRUE                        TRUE 
                  Calc_VBGF_LAA Calculate_MCMC_growth_curve 
                           TRUE                        TRUE 
          Compare_Growth_Models        Estimate_MCMC_Growth 
                           TRUE                        TRUE 
            Get_MCMC_parameters 
                           TRUE 
...
| Execution Time | 2025-02-15 03:35:24 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7e7e7e68_1739590519
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7vkGgy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesGrowth_v1.0.0-tikzDictionary"
