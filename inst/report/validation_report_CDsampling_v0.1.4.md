# Validation Report - CDsampling@0.1.4
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yifei Huang <yhuan39@uic.edu>                        |
...
Overall the package has 16 exported objects. 16 are documented:
    ...
    approxtoexact_constrained_func             approxtoexact_func 
                              TRUE                           TRUE 
                   bounded_uniform                     F_func_GLM 
                              TRUE                           TRUE 
                        F_func_MLM                  Fdet_func_GLM 
                              TRUE                           TRUE 
                     Fdet_func_MLM                 Fdet_func_unif 
                              TRUE                           TRUE 
                       Fi_func_MLM               iset_func_trauma 
                              TRUE                           TRUE 
                   iset_func_trial        liftone_constrained_GLM 
                              TRUE                           TRUE 
           liftone_constrained_MLM                    liftone_GLM 
                              TRUE                           TRUE 
                       liftone_MLM                     W_func_GLM 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-16 03:57:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34873f919_1739678245
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyViXE5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CDsampling_v0.1.4-tikzDictionary"
