...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Birk Diedenhofen <mail@birkdiedenhofen.de>           |
...
apaText, CoNI, networktools, rmcorr, subscore, umx
...
Overall the package has 7 exported objects. 7 are documented:
                       ...
                       as.htest                       cocor 
                           TRUE                        TRUE 
    cocor.dep.groups.nonoverlap    cocor.dep.groups.overlap 
                           TRUE                        TRUE 
             cocor.indep.groups             get.cocor.input 
                           TRUE                        TRUE 
              get.cocor.results 
                           TRUE 
...
| Execution Time | 2025-02-16 04:49:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bc326c9ef50_1739681379
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplfuSoV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cocor_v1.1.4-tikzDictionary"
