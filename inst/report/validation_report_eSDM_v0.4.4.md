...
| export_help          | 8                                  |
| has_website          | TRUE                               |
| has_maintainer       | Sam Woodman <sam.woodman@noaa.gov> |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/swfsc/eSDM/     |
...
Overall the package has 8 exported objects. 8 are documented:
       ...
       ensemble_create   ensemble_rescale           eSDM_GUI evaluation_metrics 
                  TRUE               TRUE               TRUE               TRUE 
       model_abundance        overlay_sdm pts2poly_centroids  pts2poly_vertices 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:29:28 UTC |
...
running this report
    ...
    PROCESSX_PS1d45a752971_1739939361
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpnio593
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eSDM_v0.4.4-tikzDictionary"
