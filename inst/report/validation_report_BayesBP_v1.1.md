...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Li-Syuan Hong <lisyuan@nhri.org.tw>                  |
...
Overall the package has 16 exported objects. 16 are documented:
                     ...
                     bin                 BP2D            BP2D_coef 
                    TRUE                 TRUE                 TRUE 
              BP2D_table              BPbasis               BPFhat 
                    TRUE                 TRUE                 TRUE 
       Credible_interval             gen_data                    M 
                    TRUE                 TRUE                 TRUE 
              PD_BPbasis            PD_BPFhat PD_Credible_interval 
                    TRUE                 TRUE                 TRUE 
                    Rhat          scale_to_01             write.BP 
                    TRUE                 TRUE                 TRUE 
           write.BPtable 
                    TRUE 
...
| Execution Time | 2025-02-15 03:32:15 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd57213382_1739590331
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPNZCGV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesBP_v1.1-tikzDictionary"
