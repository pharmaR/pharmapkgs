# Validation Report - diagL1@1.0.0
...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Kevin Allan Sales Rodrigues <kevin.asr@outlook.com>  |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | quantreg (\>= 5.97)      | Depends |
| 2   | greekLetters (\>= 1.0.2) | Depends |
| 3   | stats                    | Imports |
| 4   | methods                  | Imports |
| 5   | conquer                  | Imports |
| 6   | lawstat                  | Imports |
| 7   | MatrixModels             | Imports |
| 8   | Matrix                   | Imports |
| 9   | MASS                     | Imports |
| 10  | cubature                 | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
         ...
         boot_het.regL1          boot.regL1      class_to_regL1         class_to_rq 
                   TRUE                TRUE                TRUE                TRUE 
           CookDistance            dlaplace                  FD forwardSearch_regL1 
                   TRUE                TRUE                TRUE                TRUE 
                HV_test          lambda_mle          lambda_ros   laplace.dist.test 
                   TRUE                TRUE                TRUE                TRUE 
                LF_test        likelihoodCD         likelihoodD                 PIF 
                   TRUE                TRUE                TRUE                TRUE 
               plaplace            qlaplace               regL1           regL1_het 
                   TRUE                TRUE                TRUE                TRUE 
               rlaplace                 SAE 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-18 03:58:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bb442ce1b75_1739851083
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOUG9R2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diagL1_v1.0.0-tikzDictionary"
