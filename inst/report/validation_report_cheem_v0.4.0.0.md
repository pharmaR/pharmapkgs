# Validation Report - cheem@0.4.0.0
...
| export_help          | 18                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Nicholas Spyrison <spyrison@gmail.com> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/nspyrison/cheem/    |
...
Overall the package has 18 exported objects. 17 are documented:
                           ...
                           %>%           as_logical_index 
                         FALSE                       TRUE 
                      cheem_ls             color_scale_of 
                          TRUE                       TRUE 
           contains_nonnumeric                global_view 
                          TRUE                       TRUE 
                   is_discrete               is_diverging 
                          TRUE                       TRUE 
                  linear_tform             logistic_tform 
                          TRUE                       TRUE 
                  problem_type proto_basis1d_distribution 
                          TRUE                       TRUE 
             radial_cheem_tour                 rnorm_from 
                          TRUE                       TRUE 
                       run_app               subset_cheem 
                          TRUE                       TRUE 
                     sug_basis              sug_manip_var 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-16 04:10:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34bccfe36_1739679048
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLSAEF9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cheem_v0.4.0.0-tikzDictionary"
