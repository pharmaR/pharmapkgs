# Validation Report - epinetr@0.96
...
| export_help          | 20                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Dion Detterer <ddettere@myune.edu.au>   |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/diondetterer/epinetr |
...
| 3   | igraph (\>= 1.2.4)    | Imports   |
| 4   | methods (\>= 2.10)    | Imports   |
| 5   | Rcpp (\>= 0.12.18)    | Imports   |
| 6   | RcppAlgos (\>= 2.4.1) | Imports   |
| 7   | reshape2 (\>= 1.4.3)  | Imports   |
| 8   | vcfR (\>= 1.8.0)      | Imports   |
| 9   | Rcpp                  | LinkingTo |
...
Overall the package has 20 exported objects. 20 are documented:
          ...
          addEffects     attachEpiNet      getAddCoefs     getAddOffset 
                TRUE             TRUE             TRUE             TRUE 
    getAlleleFreqRun    getComponents        getEpiNet     getEpiOffset 
                TRUE             TRUE             TRUE             TRUE 
        getEpistasis          getGeno         getHaplo     getIncMatrix 
                TRUE             TRUE             TRUE             TRUE 
      getInteraction      getPedigree        getPhased           getQTL 
                TRUE             TRUE             TRUE             TRUE 
           getSubPop         loadGeno       Population           runSim 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 04:17:59 UTC |
...
running this report
    ...
    PROCESSX_PS1d4518f899aa_1739938673
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9vy3NP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epinetr_v0.96-tikzDictionary"
