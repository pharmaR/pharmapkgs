# Validation Report - currentSurvival@1.1
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Eva Koritakova <koritakova@iba.muni.cz>              |
...
Overall the package has 16 exported objects. 16 are documented:
             ...
             cci  cci.nostrat     cci.pest    cci.strat    chisq.log chisq.loglog 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
     chisq.naive         clfs clfs.nostrat    clfs.pest   clfs.strat   comci.pest 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        lfs.pest   pvals.2cat    pvals.cat      stretch 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-17 04:40:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67109ac1c_1739767206
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAq6oOj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_currentSurvival_v1.1-tikzDictionary"
