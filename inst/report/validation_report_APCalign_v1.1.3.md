# Validation Report - APCalign@1.1.3
...
| export_help          | 14                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Daniel Falster <daniel.falster@unsw.edu.au> |
| bugs_status          | 1                                           |
| size_codebase        | 3167                                        |
| has_source_control   | https://github.com/traitecoevo/APCalign     |
...
Overall the package has 14 exported objects. 14 are documented:
                            ...
                            align_taxa create_species_state_origin_matrix 
                                  TRUE                               TRUE 
        create_taxonomic_update_lookup                    default_version 
                                  TRUE                               TRUE 
           get_apc_genus_family_lookup                       get_versions 
                                  TRUE                               TRUE 
              load_taxonomic_resources       native_anywhere_in_australia 
                                  TRUE                               TRUE 
                     standardise_names             standardise_taxon_rank 
                                  TRUE                               TRUE 
                state_diversity_counts                        strip_names 
                                  TRUE                               TRUE 
                     strip_names_extra                    update_taxonomy 
                                  TRUE                               TRUE 
...
| Execution Time | 2025-02-14 07:17:15 UTC |
...
running this report
    ...
    PROCESSX_PS1c093b94a1a5_1739517432
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnW1n58
...
These are the options set to generate the report:
    ...
    [1] "validation_report_APCalign_v1.1.3-tikzDictionary"
