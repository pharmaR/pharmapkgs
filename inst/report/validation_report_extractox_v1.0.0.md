# Validation Report - extractox@1.0.0
...
| export_help          | 15                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Claudio Zanettini <claudio.zanettini@gmail.com> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/c1au6i0/extractox            |
...
Overall the package has 15 exported objects. 15 are documented:
          ...
          extr_casrn_from_cid            extr_chem_info              extr_comptox 
                         TRUE                      TRUE                      TRUE 
                     extr_ctd                  extr_ice      extr_ice_assay_names 
                         TRUE                      TRUE                      TRUE 
                    extr_iris            extr_monograph                extr_pprtv 
                         TRUE                      TRUE                      TRUE 
            extr_pubchem_fema          extr_pubchem_ghs             extr_tetramer 
                         TRUE                      TRUE                      TRUE 
                     extr_tox         with_extr_sandbox write_dataframes_to_excel 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-19 04:55:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d452be39515_1739940946
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOMnn9x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extractox_v1.0.0-tikzDictionary"
