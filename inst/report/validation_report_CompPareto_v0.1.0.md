# Validation Report - CompPareto@0.1.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Bowen Liu <bowen.liu@umkc.edu>                       |
...
Overall the package has 8 exported objects. 8 are documented:
      ...
      dcomppareto dwdcomppareto   pcomppareto pwdcomppareto   qcomppareto 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    qwdcomppareto   rcomppareto rwdcomppareto 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 03:37:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bd625d1d40d_1739763464
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZ7r6ek
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CompPareto_v0.1.0-tikzDictionary"
