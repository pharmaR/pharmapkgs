# Validation Report - causalCmprsk@2.0.0
...
| export_help          | 5                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Bella Vakulenko-Lagun <blagun@stat.haifa.ac.il> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/Bella2001/causalCmprsk       |
...
Overall the package has 5 exported objects. 5 are documented:
          ...
          fit.cox    fit.nonpar get.numAtRisk  get.pointEst   get.weights 
...
| Execution Time | 2025-02-16 03:48:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bc314981a42_1739677731
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpY6zBSZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causalCmprsk_v2.0.0-tikzDictionary"
