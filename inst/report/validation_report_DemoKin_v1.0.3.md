# Validation Report - DemoKin@1.0.3
...
| export_help          | 13                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Iván Williams <act.ivanwilliams@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/IvanWilli/DemoKin       |
...
Overall the package has 13 exported objects. 12 are documented:

                                 %>%                              kin 
                               FALSE                             TRUE 
                     kin_multi_stage               kin_time_invariant 
                                TRUE                             TRUE 
             kin_time_invariant_2sex                 kin_time_variant 
                                TRUE                             TRUE 
               kin_time_variant_2sex                          kin2sex 
                                TRUE                             TRUE 
    output_period_cohort_combination                     plot_diagram 
                                TRUE                             TRUE 
                          rename_kin                  timevarying_kin 
                                TRUE                             TRUE 
                timevarying_kin_2sex 
                                TRUE 
...
| Execution Time | 2025-02-18 03:40:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bb472910ce5_1739850012
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1XIpLX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DemoKin_v1.0.3-tikzDictionary"
