...
| export_help          | 10                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Ioannis Mavrogiannis <mavrogiannis.ioa@gmail.com> |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/Mavrogiannis-Ioannis/dsmmR     |
...
Overall the package has 10 exported objects. 10 are documented:
              ...
              create_sequence                  fit_dsmm                get_kernel 
                         TRUE                      TRUE                      TRUE 
                      is.dsmm is.dsmm_fit_nonparametric    is.dsmm_fit_parametric 
                         TRUE                      TRUE                      TRUE 
        is.dsmm_nonparametric        is.dsmm_parametric        nonparametric_dsmm 
                         TRUE                      TRUE                      TRUE 
              parametric_dsmm 
                         TRUE 
...
| Execution Time | 2025-02-18 04:51:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bb410f00c0e_1739854313
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYVw9Rq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsmmR_v1.0.5-tikzDictionary"
