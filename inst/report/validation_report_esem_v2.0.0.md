...
| export_help          | 11                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Maria Prokofieva <maria.prokofieva@gmail.com> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/maria-pro/esem             |
...
Overall the package has 11 exported objects. 10 are documented:
                  ...
                  %>%   create_referent            esem_c          esem_cfa 
                FALSE              TRUE              TRUE              TRUE 
      esem_cfa_syntax         esem_cfa2          esem_efa       esem_syntax 
                 TRUE              TRUE              TRUE              TRUE 
     esem_syntax_keys esem_syntax_mplus       make_target 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 04:29:49 UTC |
...
running this report
    ...
    PROCESSX_PS1d457016c6d0_1739939382
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAf10u1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_esem_v2.0.0-tikzDictionary"
