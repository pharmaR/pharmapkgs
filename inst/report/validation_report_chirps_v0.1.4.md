# Validation Report - chirps@0.1.4
...
| export_help          | 6                                   |
| has_website          | TRUE                                |
| has_maintainer       | Kauê de Sousa <kaue.desousa@inn.no> |
...
apsimx, climatrends, gosset

## Namespace

Overall the package has 6 exported objects. 6 are documented:

        as.geojson     get_chirps     get_chirts        get_esi      get_imerg 
...
| Execution Time | 2025-02-16 04:13:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36ff3c684_1739679232
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCdyrmO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chirps_v0.1.4-tikzDictionary"
