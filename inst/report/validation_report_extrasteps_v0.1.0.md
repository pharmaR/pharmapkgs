# Validation Report - extrasteps@0.1.0
...
| has_source_control   | https://github.com/EmilHvitfeldt/extrasteps |
...
Overall the package has 13 exported objects. 12 are documented:
                      ...
                      FALSE                    TRUE                    TRUE 
           step_date_before       step_date_nearest           step_difftime 
                       TRUE                    TRUE                    TRUE 
       step_encoding_binary step_encoding_frequency             step_maxabs 
                       TRUE                    TRUE                    TRUE 
                step_minmax             step_robust         step_time_event 
                       TRUE                    TRUE                    TRUE 
        step_unit_normalize 
                       TRUE 
...
| Execution Time | 2025-02-19 04:56:49 UTC |
...
running this report
    ...
    PROCESSX_PS1d453bf4729_1739941003
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkGSa2b
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extrasteps_v0.1.0-tikzDictionary"
