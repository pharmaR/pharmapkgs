...
| export_help          | 45                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Rodney Sparapani <rsparapa@mcw.edu>                  |
...
Overall the package has 45 exported objects. 45 are documented:
               ...
               abart  bartModelMatrix        class.ind       crisk.bart 
                TRUE             TRUE             TRUE             TRUE 
      crisk.pre.bart      crisk2.bart    draw_lambda_i            gbart 
                TRUE             TRUE             TRUE             TRUE 
          gewekediag            lbart            mbart           mbart2 
                TRUE             TRUE             TRUE             TRUE 
            mc.abart  mc.cores.openmp    mc.crisk.bart  mc.crisk.pwbart 
                TRUE             TRUE             TRUE             TRUE 
      mc.crisk2.bart mc.crisk2.pwbart         mc.gbart         mc.lbart 
                TRUE             TRUE             TRUE             TRUE 
            mc.mbart        mc.mbart2         mc.pbart        mc.pwbart 
                TRUE             TRUE             TRUE             TRUE 
       mc.recur.bart  mc.recur.pwbart     mc.surv.bart   mc.surv.pwbart 
                TRUE             TRUE             TRUE             TRUE 
            mc.wbart     mc.wbart.gse            pbart           pwbart 
                TRUE             TRUE             TRUE             TRUE 
          recur.bart   recur.pre.bart     recur.pwbart         rs.pbart 
                TRUE             TRUE             TRUE             TRUE 
             rtgamma           rtnorm      spectrum0ar       srstepwise 
                TRUE             TRUE             TRUE             TRUE 
             stratrs        surv.bart    surv.pre.bart      surv.pwbart 
                TRUE             TRUE             TRUE             TRUE 
               wbart 
                TRUE 
...
| Execution Time | 2025-02-14 07:43:10 UTC |
...
running this report
    ...
    PROCESSX_PS1c0924087b7a_1739518987
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNJHaxB
