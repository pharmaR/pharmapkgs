...
| export_help          | 3                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Olga Lezhnina <olga.lezhnina@tib.eu>        |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://gitlab.com/TIBHannover/orkg/dtreg-r |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    load_datatype   show_fields     to_jsonld 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 04:56:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4468cdced_1739854603
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3PcSl9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dtreg_v1.1.1-tikzDictionary"
