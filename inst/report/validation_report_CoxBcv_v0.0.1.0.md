# Validation Report - CoxBcv@0.0.1.0
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Xueqi Wang <xueqi.wang@duke.edu>                     |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       CoxBcv.fg  CoxBcv.fgmr    CoxBcv.kc  CoxBcv.kcmr   CoxBcv.mbn CoxBcv.mbnmr 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       CoxBcv.md  CoxBcv.mdmr    CoxBcv.mr   CoxBcv.rob 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-17 04:10:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6cf3690a_1739765430
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCpY04i
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CoxBcv_v0.0.1.0-tikzDictionary"
