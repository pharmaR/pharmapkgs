# Validation Report - CMHNPA@1.1.1
...
| export_help | 16 |
| has_website | FALSE |
| has_maintainer | G. C. Livingston Jr <Glen.LivingstonJr@newcastle.edu.au> |
...
Overall the package has 16 exported objects. 16 are documented:
                  ...
                  ARL              CARL               CMH            durbin 
                 TRUE              TRUE              TRUE              TRUE 
             friedman           gen_cor                KW              mu_r 
                 TRUE              TRUE              TRUE              TRUE 
             np_anova orthogonal_scores              PARL              Poly 
                 TRUE              TRUE              TRUE              TRUE 
                   RL    row_col_effect              T_Mu unconditional_CMH 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:44:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33becd3eb_1739681060
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEkSqsR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CMHNPA_v1.1.1-tikzDictionary"
