# Validation Report - dichromat@2.0.0.1
...
biovizBase, dplR, eSDM, inlcolor, iNZightPlots, pals, rasterVis, ratlas,
scales, ternvis, tmaptools, viridis

## Namespace

Overall the package has 2 exported objects. 2 are documented:

    colorschemes    dichromat 
            TRUE         TRUE 
...
| Execution Time | 2025-02-24 03:28:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a7649c42a_1740367677
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpE06Esn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dichromat_v2.0.0.1-tikzDictionary"
