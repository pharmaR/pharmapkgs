# Validation Report - comFuncs@0.0.6
...
| export_help          | 5                                 |
| has_website          | TRUE                              |
| has_maintainer       | Hanming Tu <hanming.tu@gmail.com> |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/TuCai/comFuncs |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | shiny (\>= 1.3.2) | Imports |
| 2   | stats (\>= 4.0.3) | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    cvt_class2df     echo_msg get_abs_path     is_empty    start_app 
...
| Execution Time | 2025-02-16 05:04:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3747aaed6_1739682237
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYAWT1d
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comFuncs_v0.0.6-tikzDictionary"
