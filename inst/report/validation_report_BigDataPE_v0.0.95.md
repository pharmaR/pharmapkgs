# Validation Report - BigDataPE@0.0.95
...
| has_source_control   | <https://github.com/StrategicProjects/bigdatape>     |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    bdpe_fetch_chunks   bdpe_fetch_data    bdpe_get_token  bdpe_list_tokens 
                 TRUE              TRUE              TRUE              TRUE 
    bdpe_remove_token  bdpe_store_token     parse_queries 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 03:27:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bb432c4f7c9_1739849261
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4qX4uk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BigDataPE_v0.0.95-tikzDictionary"
