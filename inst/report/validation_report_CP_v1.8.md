...
| export_help | 7 |
| has_website | TRUE |
| has_maintainer | Andreas Kuehnapfel <andreas.kuehnapfel@imise.uni-leipzig.de> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_bug_reports_url | 0 |
| downloads_1yr | 3004 |
| reverse_dependencies | 0 |
| has_examples | 0.1707317 |
| dependencies | 4 |
| license | GPL-3 |
...
Overall the package has 7 exported objects. 7 are documented:
          ...
          CompSurvMod         ConPwrExp ConPwrExpAndersen   ConPwrNonMixExp 
                 TRUE              TRUE              TRUE              TRUE 
    ConPwrNonMixGamma   ConPwrNonMixWei GenerateDataFrame 
                 TRUE              TRUE              TRUE 

### Examples

There are 7 help pages with examples, from 41 (17.07 %).
...
| Execution Time | 2025-02-17 04:12:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6491260b0_1739765521
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpf8CLBL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CP_v1.8-tikzDictionary"
