# Validation Report - bigmds@3.0.0
...
| export_help          | 6                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Cristian Pachón García <cc.pachon@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/pachoning/bigmds          |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    divide_conquer_mds           fast_mds  interpolation_mds       landmark_mds 
                  TRUE               TRUE               TRUE               TRUE 
             pivot_mds        reduced_mds 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:04:27 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd14f9a3e6_1739592262
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXrc4x6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigmds_v3.0.0-tikzDictionary"
