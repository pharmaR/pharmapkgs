# Validation Report - cookiemonster@0.0.3
...
Overall the package has 7 exported objects. 7 are documented:
       ...
       add_cookies    decrypt_vec    default_jar delete_cookies    encrypt_vec 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       get_cookies  store_cookies 
              TRUE           TRUE 
...
| Execution Time | 2025-02-17 03:52:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bd618844960_1739764346
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHRAY0A
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cookiemonster_v0.0.3-tikzDictionary"
