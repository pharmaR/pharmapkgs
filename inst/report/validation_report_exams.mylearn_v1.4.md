# Validation Report - exams.mylearn@1.4
...
| export_help          | 2                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Darjus Hosszejni <darjus.hosszejni@wu.ac.at> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/hdarjus/exams.mylearn     |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | exams (\>= 2.3-4)    | Imports |
| 2   | glue (\>= 1.4.0)     | Imports |
| 3   | stringr (\>= 1.4.0)  | Imports |
| 4   | stringi (\>= 1.4.6)  | Imports |
| 5   | pkgbuild (\>= 1.1.0) | Imports |
| 6   | xml2 (\>= 1.2.5)     | Imports |
...
| Execution Time | 2025-02-19 04:47:42 UTC |
...
running this report
    ...
    PROCESSX_PS1d457c791470_1739940456
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGELfpn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exams.mylearn_v1.4-tikzDictionary"
