# Validation Report - DiSCos@0.1.1
...
| export_help          | 6                                        |
| has_website          | TRUE                                     |
| has_maintainer       | David Van Dijcke <dvdijcke@umich.edu>    |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/Davidvandijcke/DiSCos |
...
| 5   | evmix       | Imports |
| 6   | utils       | Imports |
| 7   | extremeStat | Imports |
| 8   | MASS        | Imports |
| 9   | data.table  | Depends |
| 10  | ggplot2     | Depends |
...
Overall the package has 6 exported objects. 6 are documented:
         ...
         DiSCo DiSCo_iter     DiSCoT   DiSCoTEA     ex_gmm     permut 
...
| Execution Time | 2025-02-18 04:12:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45d525157_1739851942
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZTw8L5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiSCos_v0.1.1-tikzDictionary"
