...
| export_help          | 24                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Stefan Zeugner <stefan.zeugner@ec.europa.eu>         |
...
Overall the package has 24 exported objects. 24 are documented:
            ...
            as.zlm beta.draws.bma        bin2hex            bms  estimates.bma 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          f21hyper  fullmodel.ssq       gdensity        hex2bin       info.bma 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            is.bma      is.topmod        lps.bma       plotComp       plotConv 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     plotModelsize        pmp.bma       pmpmodel       post.pr2       post.var 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      pred.density         topmod  topmodels.bma            zlm 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-15 04:27:28 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4d2441ec_1739593643
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcI90gQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BMS_v0.3.5-tikzDictionary"
