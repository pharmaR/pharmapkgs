# Validation Report - discfrail@0.1
...
| export_help          | 5                                                   |
| has_website          | TRUE                                                |
| has_maintainer       | Francesca Gasperoni <francesca.gasperoni@polimi.it> |
| bugs_status          | subscript out of bounds                             |
| has_source_control   | https://github.com/fgaspe04/discfrail               |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    nelsonaalen_npdf         npdf_cox         sim_npdf       sim_weibdf 
                TRUE             TRUE             TRUE             TRUE 
        survfit_npdf 
                TRUE 
...
| Execution Time | 2025-02-18 04:11:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bb417a76cce_1739851890
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfZsskP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_discfrail_v0.1-tikzDictionary"
