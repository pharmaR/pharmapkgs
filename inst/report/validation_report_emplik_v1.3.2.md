# Validation Report - emplik@1.3.2
...
| export_help          | 52                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mai Zhou <maizhou@gmail.com>                         |
...
Compositional, elhmc, extremis, generalRSS, glmc, kmc, LRTesteR, maczic,
mvhtests, spearmanCI
...
Overall the package has 52 exported objects. 52 are documented:
           ...
           BJnoint         bjtest       bjtest1d       bjtestII     cumsumsurv 
              TRUE           TRUE           TRUE           TRUE           TRUE 
               DnR      el.cen.EM     el.cen.EM2   el.cen.kmc1d    el.cen.test 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        el.ltrc.EM        el.test     el.test.wt    el.test.wt2   el.trun.test 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      emplikH.disc  emplikH.disc2  emplikH1.test      emplikH1B      emplikH1P 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     emplikH2.test      emplikH2B      emplikH2P emplikHs.disc2 emplikHs.test2 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          findLnew         findUL        findUL2      findULold       findUnew 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             gradf         gradf2         gradf3           llog          llogp 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            llogpp         logelr        logwelr           LTRC        MMRtime 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       RankRegTest   RankRegTestH        redistF          ROCnp         ROCnp2 
              TRUE           TRUE           TRUE           TRUE           TRUE 
               WCY    Wdataclean2    Wdataclean3    Wdataclean5            WKM 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           WRegEst       WRegTest 
              TRUE           TRUE 
...
| Execution Time | 2025-02-25 03:27:03 UTC |
...
running this report
    ...
    PROCESSX_PS1d286b192960_1740454020
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXtVCGr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emplik_v1.3.2-tikzDictionary"
