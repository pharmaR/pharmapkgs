# Validation Report - downsize@0.2.3
...
| export_help          | 20                                             |
| has_website          | TRUE                                           |
| has_maintainer       | William Michael Landau <will.landau@gmail.com> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/wlandau/downsize            |
...
Overall the package has 20 exported objects. 20 are documented:
            ...
            arg_small        check_args          downsize    downsize_error 
                 TRUE              TRUE              TRUE              TRUE 
                   ds     help_downsize        make_small           my_mode 
                 TRUE              TRUE              TRUE              TRUE 
      production_mode        scale_down          scale_up           scaling 
                 TRUE              TRUE              TRUE              TRUE 
      should_downsize        subset_dim     subset_length       subset_ncol 
                 TRUE              TRUE              TRUE              TRUE 
          subset_nrow subset_single_dim         test_mode     use_arg_small 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:39:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bb460e29f46_1739853547
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz9xQmL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_downsize_v0.2.3-tikzDictionary"
