...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Michael Gabel <m_gabel@gmx.de>                       |
...
Overall the package has 15 exported objects. 15 are documented:
         ...
         aicc.weights        base.optim   combine.and.fit       combine.par 
                 TRUE              TRUE              TRUE              TRUE 
                famos famos.performance  get.most.distant  make.directories 
                 TRUE              TRUE              TRUE              TRUE 
           model.appr    parscale.famos random.init.model  retrieve.results 
                 TRUE              TRUE              TRUE              TRUE 
       return.results          sc.order    set.crit.parms 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 05:10:28 UTC |
...
running this report
    ...
    PROCESSX_PS1d452d248d4a_1739941822
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRYwoW4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FAMoS_v0.3.0-tikzDictionary"
