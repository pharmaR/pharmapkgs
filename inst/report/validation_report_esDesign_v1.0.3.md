# Validation Report - esDesign@1.0.3
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Zhao Yang <yangz98@connect.hku.hk>                   |
...
Overall the package has 19 exported objects. 19 are documented:
         ...
         AED.boundary           AED.sim AED1_SSR.boundary       AED1_SSR.CP 
                 TRUE              TRUE              TRUE              TRUE 
          AED1_SSR.N2      AED1_SSR.sim AED2_SSR.boundary       AED2_SSR.CP 
                 TRUE              TRUE              TRUE              TRUE 
         AED2_SSR.sim AED3_SSR.boundary       AED3_SSR.CP      AED3_SSR.sim 
                 TRUE              TRUE              TRUE              TRUE 
             MaST.sim            SD.sim              SigP        sSize.norm 
                 TRUE              TRUE              TRUE              TRUE 
         SSR.boundary            SSR.CP           SSR.sim 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 04:29:21 UTC |
...
running this report
    ...
    PROCESSX_PS1d455d60bf4a_1739939354
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpC0R700
...
These are the options set to generate the report:
    ...
    [1] "validation_report_esDesign_v1.0.3-tikzDictionary"
