...
| export_help          | 11                             |
| has_website          | TRUE                           |
| has_maintainer       | Martin Loos <mloos@envibee.ch> |
...
InterpretMSSpectrum, ptairMS, RMassBank

## Namespace

Overall the package has 11 exported objects. 11 are documented:

    check_chemform      check_ded  check_several       envelope           getR 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        isopattern        isowrap      mergeform      multiform        subform 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           vdetect 
              TRUE 
...
| Execution Time | 2025-02-19 04:11:53 UTC |
...
running this report
    ...
    PROCESSX_PS1d452e47e9c_1739938306
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptwRldg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_enviPat_v2.6-tikzDictionary"
