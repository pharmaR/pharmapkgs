# Validation Report - epicmodel@0.2.0
...
| export_help          | 27                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Felix Forster <felix.forster@med.uni-muenchen.de> |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/forsterepi/epicmodel           |
...
| 12  | rlang       | Imports |
| 13  | shiny       | Imports |
| 14  | shinyalert  | Imports |
| 15  | shinyjs     | Imports |
| 16  | shinythemes | Imports |
| 17  | spsUtil     | Imports |
| 18  | stringr     | Imports |
| 19  | tibble      | Imports |
| 20  | tidyr       | Imports |
...
Overall the package has 27 exported objects. 27 are documented:
             ...
             are_sufficient          check_steplist              create_scc 
                       TRUE                    TRUE                    TRUE 
                effect_size               empty_scc          empty_steplist 
                       TRUE                    TRUE                    TRUE 
           export_mechanism               intervene launch_steplist_creator 
                       TRUE                    TRUE                    TRUE 
                  mechanism        necessary_causes           new_mechanism 
                       TRUE                    TRUE                    TRUE 
                    new_scc            new_steplist                plot_dag 
                       TRUE                    TRUE                    TRUE 
                    prevent      remove_all_modules               remove_na 
                       TRUE                    TRUE                    TRUE 
             remove_segment        sc_contain_steps          scc_cause_sets 
                       TRUE                    TRUE                    TRUE 
                 scc_to_dag              show_steps        uncheck_steplist 
                       TRUE                    TRUE                    TRUE 
         validate_mechanism            validate_scc       validate_steplist 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-19 04:15:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d452c3176af_1739938500
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQfiQt3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epicmodel_v0.2.0-tikzDictionary"
