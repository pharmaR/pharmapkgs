...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | John Ford <JoRuFo@gmail.com>                         |
...
Overall the package has 10 exported objects. 10 are documented:
                        ...
                        calf calf_exact_binary_subset          calf_fractional 
                        TRUE                     TRUE                     TRUE 
              calf_randomize              calf_subset                  cv.calf 
                        TRUE                     TRUE                     TRUE 
         perm_target_cv.calf               write.calf     write.calf_randomize 
                        TRUE                     TRUE                     TRUE 
           write.calf_subset 
                        TRUE 
...
| Execution Time | 2025-02-16 03:34:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3325edfcf_1739676875
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpah1oXR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CALF_v1.0.17-tikzDictionary"
