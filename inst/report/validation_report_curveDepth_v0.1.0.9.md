# Validation Report - curveDepth@0.1.0.9
...
| export_help | 8 |
| has_website | FALSE |
| has_maintainer | Pavlo Mozharovskyi <pavlo.mozharovskyi@telecom-paristech.fr> |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    depth.curve.Tukey      depthc.Tukey       dist.curves dist.curves.asymm 
                 TRUE              TRUE              TRUE              TRUE 
          dist.images     images2curves     sample.curves          voxelize 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:41:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bd656187fc_1739767255
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp369DQT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_curveDepth_v0.1.0.9-tikzDictionary"
