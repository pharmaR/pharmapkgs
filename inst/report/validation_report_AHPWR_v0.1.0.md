...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Luciane Ferreira Alcoforado <lucianea@id.uff.br>     |
...
Overall the package has 19 exported objects. 18 are documented:
              ...
              autoVetor calcula_prioridades                  CI                  CR 
                   TRUE                TRUE                TRUE                TRUE 
             flow_chart      formata_tabela     formata_tabela2                 ler 
                   TRUE                TRUE                TRUE                TRUE 
             matrix_ahp   matriz_julgamento           normaliza              ranque 
                   TRUE                TRUE                TRUE                TRUE 
       tabela_holistica   transforma_tabela            xlsx_ahp 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-14 06:44:36 UTC |
...
running this report
    ...
    PROCESSX_PS726d22b9cd36_1739515474
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxP1xrF
