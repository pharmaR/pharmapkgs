# Validation Report - depCensoring@0.1.5
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Negera Wakgari Deresa <negera.deresa@gmail.com>      |
...
| 13  | mvtnorm      | Imports |
| 14  | rafalib      | Imports |
| 15  | rvinecopulib | Imports |
| 16  | matrixcalc   | Imports |
| 17  | nloptr       | Imports |
| 18  | stringr      | Imports |
| 19  | numDeriv     | Imports |
| 20  | copula       | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
                    ...
                    cophfunc          estimate.cmprsk               fitDepCens 
                        TRUE                     TRUE                     TRUE 
                fitIndepCens           ktau.to.coppar Likelihood.Profile.Solve 
                        TRUE                     TRUE                     TRUE 
                 NonParTrans                 ParamCop                   SolveH 
                        TRUE                     TRUE                     TRUE 
                      SolveL                  SolveLI                   SurvDC 
                        TRUE                     TRUE                     TRUE 
                  SurvDC.GoF                    TCsim 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-18 03:43:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4354cc4eb_1739850219
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp64vLc6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_depCensoring_v0.1.5-tikzDictionary"
