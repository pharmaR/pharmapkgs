...
| export_help          | 19                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Stephanie Evert <stephanie.evert@fau.de>             |
...
Overall the package has 19 exported objects. 19 are documented:
                    ...
                    alpha.col                binom.pval                     chisq 
                         TRUE                      TRUE                      TRUE 
                   chisq.pval                 colVector                cont.table 
                         TRUE                      TRUE                      TRUE 
              corpora.palette               fisher.pval                   keyness 
                         TRUE                      TRUE                      TRUE 
                    prop.cint                        qw                 rowVector 
                         TRUE                      TRUE                      TRUE 
                    sample.df          simulated.census simulated.language.course 
                         TRUE                      TRUE                      TRUE 
          simulated.wikipedia                stars.pval                   z.score 
                         TRUE                      TRUE                      TRUE 
                 z.score.pval 
                         TRUE 
...
| Execution Time | 2025-02-17 03:58:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bd660a0f0c_1739764731
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpby1kb4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corpora_v0.6-tikzDictionary"
