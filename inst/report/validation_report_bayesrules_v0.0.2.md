# Validation Report - bayesrules@0.0.2
...
| export_help          | 22                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Mine Dogucu <mdogucu@gmail.com>            |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/bayes-rules/bayesrules/ |
...
Overall the package has 22 exported objects. 22 are documented:
       ...
       naive_classification_summary naive_classification_summary_cv 
                               TRUE                            TRUE 
                          plot_beta              plot_beta_binomial 
                               TRUE                            TRUE 
                       plot_beta_ci        plot_binomial_likelihood 
                               TRUE                            TRUE 
                         plot_gamma              plot_gamma_poisson 
                               TRUE                            TRUE 
                        plot_normal          plot_normal_likelihood 
                               TRUE                            TRUE 
                 plot_normal_normal         plot_poisson_likelihood 
                               TRUE                            TRUE 
                 prediction_summary           prediction_summary_cv 
                               TRUE                            TRUE 
                        sample_mode                  summarize_beta 
                               TRUE                            TRUE 
            summarize_beta_binomial                 summarize_gamma 
                               TRUE                            TRUE 
            summarize_gamma_poisson         summarize_normal_normal 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-15 03:40:53 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd389656ef_1739590849
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6t55vW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesrules_v0.0.2-tikzDictionary"
