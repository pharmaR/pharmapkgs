...
| export_help          | 38                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Steven Malevich <sbmalev@gmail.com>        |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/ltrr-arizona-edu/burnr/ |
...
Overall the package has 38 exported objects. 38 are documented:
                  ...
                  as_fhx               as.fhx            composite 
                    TRUE                 TRUE                 TRUE 
    count_event_position         count_injury      count_recording 
                    TRUE                 TRUE                 TRUE 
              count_scar      count_year_span               delete 
                    TRUE                 TRUE                 TRUE 
                     fhx           first_year      get_event_years 
                    TRUE                 TRUE                 TRUE 
              get_series             get_year           inner_type 
                    TRUE                 TRUE                 TRUE 
               intervals               is_fhx         is_intervals 
                    TRUE                 TRUE                 TRUE 
                  is_sea               is.fhx         is.intervals 
                    TRUE                 TRUE                 TRUE 
                  is.sea            last_year        make_rec_type 
                    TRUE                 TRUE                 TRUE 
              outer_type      percent_scarred       plot_demograph 
                    TRUE                 TRUE                 TRUE 
     plot_intervals_dist         plot_sealags             read_fhx 
                    TRUE                 TRUE                 TRUE 
            sample_depth                  sea series_mean_interval 
                    TRUE                 TRUE                 TRUE 
            series_names         series_stats            write_fhx 
                    TRUE                 TRUE                 TRUE 
              year_range     yearly_recording 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:55:54 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd62c109bd_1739595349
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdUOVdh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_burnr_v0.6.1-tikzDictionary"
