# Validation Report - dfoptim@2023.1.0
...
afex, atRisk, calibrar, ConsReg, cops, CSTE, cxr, dRiftDM, DynTxRegime,
flexFitR, foreSIGHT, lme4, matrisk, metadat, metafor, mvord, npcs,
optimx, qra, reReg, ROI.plugin.optimx, SensIAT, sklarsomega, stepPenal,
stops
...
| Execution Time | 2025-02-18 03:54:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb420e8368e_1739850872
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzkrUGo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dfoptim_v2023.1.0-tikzDictionary"
