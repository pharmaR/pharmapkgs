# Validation Report - didimputation@0.3.0
...
| 3   | fixest (\>= 0.10.0)     | Depends   |
| 4   | data.table (\>= 1.10.0) | Depends   |
| 5   | Matrix                  | Imports   |
| 6   | magrittr                | Imports   |
| 7   | Rcpp                    | Imports   |
| 8   | broom                   | Imports   |
...
| Execution Time | 2025-02-18 04:02:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bb450692c31_1739851316
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpI6QkTn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_didimputation_v0.3.0-tikzDictionary"
