...
Overall the package has 14 exported objects. 14 are documented:
                ...
                cca.ct          center.ct             cor.ct             cov.ct 
                  TRUE               TRUE               TRUE               TRUE 
           inprod.cent          kmeans.ct             lda.ct          meanbasis 
                  TRUE               TRUE               TRUE               TRUE 
                pca.ct     plot.kmeans.ct        plot.lda.ct plot.silhouette.ct 
                  TRUE               TRUE               TRUE               TRUE 
         silhouette.ct     standardize.ct 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:34:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bd645dfbdd_1739766884
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpdbqer7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ctmva_v1.4.0-tikzDictionary"
