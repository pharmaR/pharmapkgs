# Validation Report - csranks@1.2.3
...
| export_help          | 10                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Daniel Wilhelm <d.wilhelm@lmu.de>           |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/danielwilhelm/R-CS-ranks |
...
Overall the package has 10 exported objects. 10 are documented:
             ...
             csranks csranks_multinom        cstaubest       cstauworst 
                TRUE             TRUE             TRUE             TRUE 
               frank    frank_against            irank    irank_against 
                TRUE             TRUE             TRUE             TRUE 
             lmranks      plotranking 
                TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:31:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61be4ea2d_1739766706
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6CfSDI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_csranks_v1.2.3-tikzDictionary"
