...
| has_source_control | https://github.com/christopherkenny/dots |
...
Overall the package has 15 exported objects. 14 are documented:
                     ...
                     %>%           clip_water                 dots 
                   FALSE                 TRUE                 TRUE 
             dots_points  engine_sf_hexagonal     engine_sf_random 
                    TRUE                 TRUE                 TRUE 
       engine_sf_regular  engine_sp_clustered  engine_sp_hexagonal 
                    TRUE                 TRUE                 TRUE 
    engine_sp_nonaligned     engine_sp_random    engine_sp_regular 
                    TRUE                 TRUE                 TRUE 
    engine_sp_stratified         engine_terra           filter_pts 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-18 04:37:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42e8ab532_1739853414
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptMD4nv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dots_v0.0.2-tikzDictionary"
