# Validation Report - cencrne@1.0.0
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Mingyang Ren <renmingyang17@mails.ucas.ac.cn>        |
...
Overall the package has 4 exported objects. 4 are documented:
          ...
          evaluation          gen.int   genelambda.obo network.comm.num 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-16 03:59:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3301ef82_1739678371
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0wM0Ye
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cencrne_v1.0.0-tikzDictionary"
