# Validation Report - FamEvent@3.2
...
| export_help          | 29                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yun-Hee Choi <yun-hee.choi@schulich.uwo.ca>          |
...
Overall the package has 29 exported objects. 29 are documented:
                   ...
                   carrierprob                   fampower 
                          TRUE                       TRUE 
                    penetrance             penetrance_cmp 
                          TRUE                       TRUE 
                      penmodel               penmodel_cmp 
                          TRUE                       TRUE 
                    penmodelEM                    penplot 
                          TRUE                       TRUE 
                   penplot_cmp              plot.penmodel 
                          TRUE                       TRUE 
             plot.penmodel_cmp                plot.simfam 
                          TRUE                       TRUE 
               plot.simfam_cmp            plot.simfam_tvc 
                          TRUE                       TRUE 
                  plot.simfam2             print.penmodel 
                          TRUE                       TRUE 
            print.penmodel_cmp     print.summary.penmodel 
                          TRUE                       TRUE 
    print.summary.penmodel_cmp                     simfam 
                          TRUE                       TRUE 
                    simfam_cmp                 simfam_tvc 
                          TRUE                       TRUE 
                       simfam2           summary.penmodel 
                          TRUE                       TRUE 
          summary.penmodel_cmp             summary.simfam 
                          TRUE                       TRUE 
            summary.simfam_cmp         summary.simfam_tvc 
                          TRUE                       TRUE 
               summary.simfam2 
                          TRUE 
...
| Execution Time | 2025-02-19 05:09:38 UTC |
...
running this report
    ...
    PROCESSX_PS1d45665b56be_1739941771
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLzhlXD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FamEvent_v3.2-tikzDictionary"
