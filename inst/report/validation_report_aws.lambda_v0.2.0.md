...
| export_help          | 20                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Jon Harmon <jonthegeek@gmail.com>     |
| bugs_status          | subscript out of bounds               |
| size_codebase        | 504                                   |
| has_source_control   | https://github.com/cloudyr/aws.lambda |
...
Overall the package has 20 exported objects. 20 are documented:
             ...
             create_function    create_function_alias          delete_function 
                        TRUE                     TRUE                     TRUE 
       delete_function_alias             get_function       get_function_alias 
                        TRUE                     TRUE                     TRUE 
           get_function_name      get_function_policy       get_lambda_account 
                        TRUE                     TRUE                     TRUE 
             invoke_function               lambdaHTTP    list_function_aliases 
                        TRUE                     TRUE                     TRUE 
      list_function_versions           list_functions    make_function_version 
                        TRUE                     TRUE                     TRUE 
    publish_function_version          update_function    update_function_alias 
                        TRUE                     TRUE                     TRUE 
        update_function_code   update_function_config 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-14 07:36:51 UTC |
...
running this report
    ...
    PROCESSX_PS1c093b4b6c2c_1739518608
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdLimN9
