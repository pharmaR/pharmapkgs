# Validation Report - deprivateR@0.1.0
...
| export_help          | 7                                                  |
| has_website          | TRUE                                               |
| has_maintainer       | Christopher Prener <christopher.prener@pfizer.com> |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    dep_build_varlist    dep_calc_index     dep_get_index    dep_map_breaks 
                 TRUE              TRUE              TRUE              TRUE 
      dep_percentiles     dep_quantiles   dep_sample_data 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 03:44:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43bd3a594_1739850283
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpphD7Z2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deprivateR_v0.1.0-tikzDictionary"
