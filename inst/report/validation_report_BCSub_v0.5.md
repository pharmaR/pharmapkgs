...
| export_help          | 0                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jiehuan Sun <jiehuan.sun@yale.edu>                   |
...
| 2   | mcclust (\>= 1.0)    | Depends   |
| 3   | nFactors (\>= 2.3.3) | Depends   |
| 4   | Rcpp (\>= 0.12.6)    | Imports   |
| 5   | Rcpp                 | LinkingTo |
...
| Execution Time | 2025-02-15 03:47:22 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd65e2eb4c_1739591238
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpN04wpe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BCSub_v0.5-tikzDictionary"
