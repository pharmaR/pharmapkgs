# Validation Report - DescribeDF@0.2.1
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Sandip Garai <sandipnicksandy@gmail.com>             |
...
AriGaMyANNSVR, WaveletMLbestFL

## Namespace

Overall the package has 3 exported objects. 3 are documented:

        df_descstat df_nonlinearity df_stationarity 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 03:46:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42aaf192d_1739850366
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJhasqq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DescribeDF_v0.2.1-tikzDictionary"
