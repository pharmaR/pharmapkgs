...
| export_help          | 10                                      |
| has_website          | FALSE                                   |
| has_maintainer       | Robert Fulton <rfulton@algorithmia.com> |
| bugs_status          | subscript out of bounds                 |
| size_codebase        | 583                                     |
| has_bug_reports_url  | 1                                       |
| downloads_1yr        | 3501                                    |
| reverse_dependencies | 0                                       |
| has_examples         | 0.4545455                               |
| dependencies         | 4                                       |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            AlgorithmiaAlgorithm            AlgorithmiaClient 
                            TRUE                         TRUE 
        AlgorithmiaDataDirectory          AlgorithmiaDataFile 
                            TRUE                         TRUE 
    AlgorithmiaDirectoryIterator          getAlgorithmHandler 
                            TRUE                         TRUE 
            getAlgorithmiaClient        ReadAcl.MY_ALGORITHMS 
                            TRUE                         TRUE 
                 ReadAcl.PRIVATE               ReadAcl.PUBLIC 
                            TRUE                         TRUE 

### Examples

There are 5 help pages with examples, from 11 (45.45 %).
...
| Execution Time | 2025-02-14 06:48:14 UTC |
...
running this report
    ...
    PROCESSX_PS726d1b155190_1739515691
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2UCbt5
