...
| bugs_status | 1 |
| has_source_control | https://github.com/ropensci/cffr |
...
|:----|:-------------------------|:--------|
| 1   | cli (\>= 2.0.0)          | Imports |
| 2   | desc (\>= 1.3.0)         | Imports |
| 3   | jsonlite (\>= 1.7.2)     | Imports |
| 4   | jsonvalidate (\>= 1.1.0) | Imports |
| 5   | yaml (\>= 2.2.1)         | Imports |
...
iemisctext, jab.adverse.reactions, rcompendium, sdcLog, washr
...
Overall the package has 34 exported objects. 34 are documented:
                      ...
                      as_bibentry                        as_cff 
                             TRUE                          TRUE 
                    as_cff_person                        as.cff 
                             TRUE                          TRUE 
                              cff                    cff_create 
                             TRUE                          TRUE 
            cff_extract_to_bibtex               cff_from_bibtex 
                             TRUE                          TRUE 
                   cff_gha_update          cff_git_hook_install 
                             TRUE                          TRUE 
              cff_git_hook_remove                    cff_modify 
                             TRUE                          TRUE 
               cff_parse_citation              cff_parse_person 
                             TRUE                          TRUE 
          cff_parse_person_bibtex                      cff_read 
                             TRUE                          TRUE 
                     cff_read_bib             cff_read_bib_text 
                             TRUE                          TRUE 
            cff_read_cff_citation             cff_read_citation 
                             TRUE                          TRUE 
             cff_read_description cff_schema_definitions_entity 
                             TRUE                          TRUE 
    cff_schema_definitions_person   cff_schema_definitions_refs 
                             TRUE                          TRUE 
                  cff_schema_keys       cff_schema_keys_license 
                             TRUE                          TRUE 
                    cff_to_bibtex                  cff_validate 
                             TRUE                          TRUE 
                        cff_write                 cff_write_bib 
                             TRUE                          TRUE 
               cff_write_citation          encoded_utf_to_latex 
                             TRUE                          TRUE 
                        write_bib                write_citation 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-16 04:04:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32ab4f17c_1739678662
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0hOqfM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cffr_v1.2.0-tikzDictionary"
