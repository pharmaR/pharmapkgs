# Validation Report - concorR@0.2.1
...
| export_help          | 10                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Adrienne Traxler <adrienne.traxler@wright.edu> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/ATraxLab/concorR            |
...
Overall the package has 10 exported objects. 10 are documented:
                 ...
                 concor concor_igraph_apply  concor_make_igraph             concor1 
                   TRUE                TRUE                TRUE                TRUE 
               make_blk        make_reduced make_reduced_igraph            plot_blk 
                   TRUE                TRUE                TRUE                TRUE 
           plot_reduced          plot_socio 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-17 03:39:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6169d78ef_1739763586
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb1BN9z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_concorR_v0.2.1-tikzDictionary"
