# Validation Report - covafillr@0.4.4
...
| export_help          | 7                                                  |
| has_website          | TRUE                                               |
| has_maintainer       | Christoffer Moesgaard Albertsen <cmoe@aqua.dtu.dk> |
| bugs_status          | subscript out of bounds                            |
| has_source_control   | https://github.com/calbertsen/covafillr            |
...
Overall the package has 7 exported objects. 7 are documented:
           ...
           covafill        covatree        cxxFlags             kde  loadJAGSModule 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      stat_covafill suggestBandwith 
               TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:06:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6768628e9_1739765166
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsaVbJ9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covafillr_v0.4.4-tikzDictionary"
