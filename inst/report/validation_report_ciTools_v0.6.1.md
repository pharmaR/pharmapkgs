# Validation Report - ciTools@0.6.1
...
| export_help          | 4                                  |
| has_website          | TRUE                               |
| has_maintainer       | John Haman <jhaman@ida.org>        |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/jthaman/ciTools |
...
EPLSIM, i2extras, incidence2, insurancerating, trending

## Namespace

Overall the package has 4 exported objects. 4 are documented:

          add_ci       add_pi    add_probs add_quantile 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:23:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36019865e_1739679816
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNq5XS3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ciTools_v0.6.1-tikzDictionary"
