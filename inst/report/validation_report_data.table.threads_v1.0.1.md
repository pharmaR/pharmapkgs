# Validation Report - data.table.threads@1.0.1
...
| export_help          | 3                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Anirban Chetia <ac4743@nau.edu>                      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/Anirban166/data.table.threads     |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    addRecommendedEfficiency   findOptimalThreadCount           setThreadCount 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-17 04:55:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bd68a6fc2c_1739768141
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMORRw0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_data.table.threads_v1.0.1-tikzDictionary"
