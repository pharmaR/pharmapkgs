# Validation Report - bootsurv@0.0.1
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Zeinab Mashreghi <z.mashreghi@uwinnipeg.ca>          |
...
Overall the package has 4 exported objects. 4 are documented:
           ...
           boot.twostage   boot.weights.stsrs    direct.boot.stsrs 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:34:59 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd36f29cbc_1739594094
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpY9mXV1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bootsurv_v0.0.1-tikzDictionary"
