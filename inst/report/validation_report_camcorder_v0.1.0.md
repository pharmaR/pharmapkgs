# Validation Report - camcorder@0.1.0
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Ellis Hughes <ellishughes@live.com>                  |
...
Overall the package has 5 exported objects. 5 are documented:
          ...
          gg_playback         gg_record    gg_resize_film gg_stop_recording 
                 TRUE              TRUE              TRUE              TRUE 
      record_polaroid 
                 TRUE 
...
| Execution Time | 2025-02-16 03:36:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35b45fc98_1739676980
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpA8bRlc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_camcorder_v0.1.0-tikzDictionary"
