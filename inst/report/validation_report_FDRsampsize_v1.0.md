# Validation Report - FDRsampsize@1.0
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Stan Pounds <stanley.pounds@stjude.org>              |
...
Overall the package has 16 exported objects. 16 are documented:
              ...
              afdr      alpha.fdr    alpha.power  average.power      fdr.power 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      fdr.sampsize        pi.star      power.cox     power.hart       power.li 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    power.onesampt   power.oneway  power.ranksum power.signtest    power.tcorr 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    power.twosampt 
              TRUE 
...
| Execution Time | 2025-02-27 03:23:51 UTC |
...
running this report
    ...
    PROCESSX_PS1c62157860f2_1740626627
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbVFs07
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FDRsampsize_v1.0-tikzDictionary"
