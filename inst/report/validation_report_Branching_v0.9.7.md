# Validation Report - Branching@0.9.7
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Camilo Jose Torres-Jimenez <cjtorresj@unal.edu.co>   |
...
Overall the package has 5 exported objects. 5 are documented:
          ...
          BGWM.covar BGWM.covar.estim        BGWM.mean  BGWM.mean.estim 
                TRUE             TRUE             TRUE             TRUE 
               rBGWM 
                TRUE 
...
| Execution Time | 2025-02-15 04:41:09 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd21ed6a24_1739594464
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdSLtVG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Branching_v0.9.7-tikzDictionary"
