...
| export_help          | 60                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Emrah Altun <emrahaltun123@gmail.com>                |
...
Overall the package has 60 exported objects. 60 are documented:
          ...
          cdfbsgdp        cdfeexp          cdfer          cdfew       cdfgamma 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         cdfggamma      cdfgumbel    cdfinvgamma   cdfiwweibull        cdflevy 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        cdflnormal      cdfpareto    cdfrayleigh     cdfweibull       expexpcp 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          expraycp       expweicp       fitbsgpd      fitexpexp fitexprayleigh 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     fitexpweibull       fitgamma      fitggamma      fitgumbel    fitinvgamma 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       fitiweibull        fitlevy     fitlnormal      fitpareto    fitrayleigh 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        fitweibull        gammacp       ggammacp       gumbelcp     invgammacp 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        iweibullcp         levycp      lnormalcp       paretocp       pdfbsgdp 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           pdfeexp          pdfer          pdfew       pdfgamma      pdfggamma 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         pdfgumbel    pdfinvgamma    pdfiweibull        pdflevy     pdflnormal 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         pdfpareto    pdfrayleigh     pdfweibull     rayleighcp         rbsgpd 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           rexpexp   rexprayleigh    rexpweibull          rlevy      weibullcp 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:27:29 UTC |
...
running this report
    ...
    PROCESSX_PS1d451f746166_1739939243
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWd6nlD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ERPeq_v0.1.0-tikzDictionary"
