...
| export_help          | 20                                         |
| has_website          | FALSE                                      |
| has_maintainer       | Casey M. Jelsema <jelsema.casey@gmail.com> |
| bugs_status          | 0                                          |
...
Overall the package has 20 exported objects. 20 are documented:
               ...
               as.clme               clme            clme_em      clme_em_fixed 
                  TRUE               TRUE               TRUE               TRUE 
         clme_em_mixed        clme_resids create.constraints      fixed.effects 
                  TRUE               TRUE               TRUE               TRUE 
               is.clme           lrt.stat             minque   model_terms_clme 
                  TRUE               TRUE               TRUE               TRUE 
        random.effects         resid_boot         shiny_clme   shinyServer_clme 
                  TRUE               TRUE               TRUE               TRUE 
          shinyUI_clme            VarCorr             w.stat         w.stat.ind 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-23 03:22:42 UTC |
...
running this report
    ...
    PROCESSX_PS1d254a40ee9a_1740280959
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2k93Di
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CLME_v2.0.12-tikzDictionary"
