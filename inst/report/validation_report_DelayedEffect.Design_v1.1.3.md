# Validation Report - DelayedEffect.Design@1.1.3
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Bill Wheeler <wheelerb@imsweb.com>                   |
...
Overall the package has 12 exported objects. 12 are documented:
                ...
                GPW.logrank                HR.APPLE           HR.APPLE.plus 
                       TRUE                    TRUE                    TRUE 
                    N.APPLE            N.APPLE.plus               pow.APPLE 
                       TRUE                    TRUE                    TRUE 
             pow.APPLE.plus              pow.SEPPLE         pow.SEPPLE.plus 
                       TRUE                    TRUE                    TRUE 
       pow.SEPPLE.random.DE           pow.sim.logrk pow.sim.logrk.random.DE 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-18 03:38:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43264b251_1739849891
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphZ6GO6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DelayedEffect.Design_v1.1.3-tikzDictionary"
