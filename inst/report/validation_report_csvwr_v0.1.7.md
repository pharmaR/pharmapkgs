...
| export_help          | 16                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Robin Gower <csvwr@infonomics.ltd.uk> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/Robsteranium/csvwr |
...
Overall the package has 16 exported objects. 16 are documented:
                          ...
                          base_uri                create_metadata 
                              TRUE                           TRUE 
                      csvw_to_list                  csvwr_example 
                              TRUE                           TRUE 
                  datatype_to_type                derive_metadata 
                              TRUE                           TRUE 
               derive_table_schema                  extract_table 
                              TRUE                           TRUE 
                         read_csvw            read_csvw_dataframe 
                              TRUE                           TRUE 
                     read_metadata           render_uri_templates 
                              TRUE                           TRUE 
         transform_datetime_format               type_to_datatype 
                              TRUE                           TRUE 
                     validate_csvw validate_referential_integrity 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-17 04:32:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64375e61_1739766774
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsTHTVq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_csvwr_v0.1.7-tikzDictionary"
