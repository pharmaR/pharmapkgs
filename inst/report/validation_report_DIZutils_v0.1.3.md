# Validation Report - DIZutils@0.1.3
...
| has_source_control   | https://github.com/miracum/misc-dizutils        |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    check_if_table_exists      close_connection         combine_stats 
                     TRUE                  TRUE                  TRUE 
            db_connection        get_config_env        get_db_systems 
                     TRUE                  TRUE                  TRUE 
           query_database            xml_2_json 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-18 04:24:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42f57913_1739852659
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptpvEIc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DIZutils_v0.1.3-tikzDictionary"
