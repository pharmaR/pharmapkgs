# Validation Report - curephEM@0.3.0
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jue (Marquis) Hou <hou00123@umn.edu>                 |
...
Overall the package has 7 exported objects. 7 are documented:
     ...
     basehaz.cureph          cureph  cureph.control   cureph.simgen       Surv.cure 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           survpred survpred.cureph 
               TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:39:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bd663a322e_1739767175
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkGnZlf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_curephEM_v0.3.0-tikzDictionary"
