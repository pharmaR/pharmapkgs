# Validation Report - caretForecast@0.1.1
...
| export_help          | 11                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Resul Akay <resulakay1@gmail.com>       |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/Akai01/caretForecast |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | forecast (\>= 8.15)  | Imports |
| 2   | caret (\>= 6.0.88)   | Imports |
| 3   | magrittr (\>= 2.0.1) | Imports |
| 4   | methods (\>= 4.1.1)  | Imports |
| 5   | dplyr (\>= 1.0.9)    | Imports |
| 6   | generics (\>= 0.1.3) | Imports |
...
WaveletETS, WaveletGBM, WaveletKNN, WaveletLSTM
...
Overall the package has 11 exported objects. 9 are documented:
             ...
             autolayer           autoplot conformalRegressor           forecast 
                  TRUE               TRUE               TRUE               TRUE 
           get_var_imp           split_ts  suggested_methods 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 03:42:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32278f167_1739677329
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppMFepP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_caretForecast_v0.1.1-tikzDictionary"
