# Validation Report - distory@1.4.5
...
MHD, pcmabc, Rtapas, treespace

## Namespace

Overall the package has 15 exported objects. 15 are documented:

               bethe.tree        bin.multiPhylo     boot.samples.idxs 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-18 04:19:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46a1b4f15_1739852341
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTwv6Ip
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distory_v1.4.5-tikzDictionary"
