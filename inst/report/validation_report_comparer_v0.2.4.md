# Validation Report - comparer@0.2.4
...
| has_source_control   | https://github.com/CollinErickson/comparer  |
...
Overall the package has 17 exported objects. 17 are documented:
                 ...
                 ffexp               hype                mbc    par_discretenum 
                  TRUE               TRUE               TRUE               TRUE 
           par_integer          par_log10        par_ordered           par_unif 
                  TRUE               TRUE               TRUE               TRUE 
         par_unordered            R6_hype R6_par_discretenum        R6_par_hype 
                  TRUE               TRUE               TRUE               TRUE 
        R6_par_integer       R6_par_log10     R6_par_ordered        R6_par_unif 
                  TRUE               TRUE               TRUE               TRUE 
      R6_par_unordered 
                  TRUE 
...
| Execution Time | 2025-02-17 03:34:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6434f4949_1739763273
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJqc7mg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comparer_v0.2.4-tikzDictionary"
