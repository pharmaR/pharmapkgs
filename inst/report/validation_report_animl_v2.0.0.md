...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Kyra Swanson <tswanson@sdzwa.org>                    |
...
Overall the package has 22 exported objects. 22 are documented:
        ...
        build_file_manifest              check_file             crop_images 
                       TRUE                    TRUE                    TRUE 
            detect_MD_batch    extract_frame_single          extract_frames 
                       TRUE                    TRUE                    TRUE 
         extract_frames_old             get_animals               get_empty 
                       TRUE                    TRUE                    TRUE 
                  load_data              load_model            megadetector 
                       TRUE                    TRUE                    TRUE 
                   parse_MD              plot_boxes         predict_species 
                       TRUE                    TRUE                    TRUE 
                remove_link               save_data sequence_classification 
                       TRUE                    TRUE                    TRUE 
                    sort_MD            sort_species           update_labels 
                       TRUE                    TRUE                    TRUE 
           WorkingDirectory 
                       TRUE 
...
| Execution Time | 2025-02-14 06:55:00 UTC |
...
running this report
    ...
    PROCESSX_PS726d7fdef848_1739516097
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmphidbrr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_animl_v2.0.0-tikzDictionary"
