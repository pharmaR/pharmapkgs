...
| has_source_control | https://github.com/miferreiro/bdpar |
| has_bug_reports_url | 1 |
| downloads_1yr | 4005 |
| reverse_dependencies | 0 |
| has_examples | 0.1944444 |
| dependencies | 6 |
| license | GPL-3 |
...
Overall the package has 34 exported objects. 33 are documented:
                   ...
                   %>|%    AbbreviationPipe               Bdpar           bdpar.log 
                  FALSE                TRUE                TRUE                TRUE 
          bdpar.Options         Connections     ContractionPipe     DefaultPipeline 
                   TRUE                TRUE                TRUE                TRUE 
        DynamicPipeline        ExtractorEml    ExtractorFactory        ExtractorSms 
                   TRUE                TRUE                TRUE                TRUE 
         ExtractorYtbid           File2Pipe       FindEmojiPipe    FindEmoticonPipe 
                   TRUE                TRUE                TRUE                TRUE 
        FindHashtagPipe         FindUrlPipe    FindUserNamePipe         GenericPipe 
                   TRUE                TRUE                TRUE                TRUE 
        GenericPipeline       GuessDatePipe   GuessLanguagePipe            Instance 
                   TRUE                TRUE                TRUE                TRUE 
       InterjectionPipe   MeasureLengthPipe     ResourceHandler         runPipeline 
                   TRUE                TRUE                TRUE                TRUE 
              SlangPipe        StopWordPipe    StoreFileExtPipe TargetAssigningPipe 
                   TRUE                TRUE                TRUE                TRUE 
...
There are 7 help pages with examples, from 36 (19.44 %).
...
| Execution Time | 2025-02-15 03:48:40 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd42eb74fa_1739591315
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1PetDi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bdpar_v3.1.0-tikzDictionary"
