...
| has_source_control   | https://github.com/tmsalab/cIRT               |
...
| 2   | Rcpp                           | LinkingTo |
| 3   | RcppArmadillo (\>= 0.10.8.1.0) | LinkingTo |
...
Overall the package has 10 exported objects. 10 are documented:
      ...
      center_matrix            cIRT      direct_sum Generate_Choice       probitHLM 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          riwishart         rmvnorm        rwishart  Total_Tabulate TwoPLChoicemcmc 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-16 04:22:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37192c5a8_1739679749
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpirDT8f
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cIRT_v1.3.2-tikzDictionary"
