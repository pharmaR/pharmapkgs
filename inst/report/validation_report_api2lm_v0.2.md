...
| export_help          | 30                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Joshua P. French <joshua.french@ucdenver.edu>        |
...
Overall the package has 30 exported objects. 30 are documented:
                 ...
                 auto_mfrow autoplot.confint_adjust            coef_compare 
                       TRUE                    TRUE                    TRUE 
                coef_matrix          confint_adjust              cooks_plot 
                       TRUE                    TRUE                    TRUE 
                cooks_stats              cooks_test             dfbeta_plot 
                       TRUE                    TRUE                    TRUE 
               dfbetas_plot             dffits_plot            dffits_stats 
                       TRUE                    TRUE                    TRUE 
                dffits_test      format_perc_api2lm           get_residuals 
                       TRUE                    TRUE                    TRUE 
              index_plot_lm          influence_plot         influence_stats 
                       TRUE                    TRUE                    TRUE 
              leverage_plot          leverage_stats           leverage_test 
                       TRUE                    TRUE                    TRUE 
               outlier_plot           outlier_stats            outlier_test 
                       TRUE                    TRUE                    TRUE 
             predict_adjust                rdeleted           residual_plot 
                       TRUE                    TRUE                    TRUE 
                 rjackknife                    rloo                 sl_plot 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 07:18:04 UTC |
...
running this report
    ...
    PROCESSX_PS1c09f5e68e5_1739517482
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuGt5zn
