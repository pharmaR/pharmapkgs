# Validation Report - bioregion@1.2.0
...
| export_help          | 34                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Maxime Lenormand <maxime.lenormand@inrae.fr> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/bioRgeo/bioregion         |
...
| 6   | dbscan         | Imports   |
| 7   | dynamicTreeCut | Imports   |
| 8   | fastcluster    | Imports   |
| 9   | fastkmedoids   | Imports   |
| 10  | ggplot2        | Imports   |
...
| 17  | Rdpack         | Imports   |
| 18  | rlang          | Imports   |
| 19  | rmarkdown      | Imports   |
| 20  | segmented      | Imports   |
| 21  | sf             | Imports   |
| 22  | stats          | Imports   |
| 23  | tidyr          | Imports   |
| 24  | utils          | Imports   |
...
Overall the package has 34 exported objects. 34 are documented:
          ...
          betapart_to_bioregion           bioregion_metrics 
                           TRUE                        TRUE 
     bioregionalization_metrics compare_bioregionalizations 
                           TRUE                        TRUE 
                       cut_tree               dissimilarity 
                           TRUE                        TRUE 
    dissimilarity_to_similarity              find_optimal_n 
                           TRUE                        TRUE 
                     hclu_diana            hclu_hierarclust 
                           TRUE                        TRUE 
                    hclu_optics            install_binaries 
                           TRUE                        TRUE 
                 map_bioregions                  mat_to_net 
                           TRUE                        TRUE 
                     net_to_mat              netclu_beckett 
                           TRUE                        TRUE 
                  netclu_greedy              netclu_infomap 
                           TRUE                        TRUE 
               netclu_labelprop         netclu_leadingeigen 
                           TRUE                        TRUE 
                  netclu_leiden              netclu_louvain 
                           TRUE                        TRUE 
                   netclu_oslom             netclu_walktrap 
                           TRUE                        TRUE 
                  nhclu_affprop                 nhclu_clara 
                           TRUE                        TRUE 
                  nhclu_clarans                nhclu_dbscan 
                           TRUE                        TRUE 
                   nhclu_kmeans                   nhclu_pam 
                           TRUE                        TRUE 
                     similarity similarity_to_dissimilarity 
                           TRUE                        TRUE 
           site_species_metrics         site_species_subset 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-15 04:14:31 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1011cf_1739592866
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVLzCZc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bioregion_v1.2.0-tikzDictionary"
