# Validation Report - dendroNetwork@0.5.4
...
| export_help          | 13                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Ronald Visser <r.m.visser@saxion.nl>      |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/ropensci/dendroNetwork |
...
Overall the package has 13 exported objects. 13 are documented:
        ...
        clique_community_names clique_community_names_par 
                          TRUE                       TRUE 
               cor_mat_overlap          cyto_clean_styles 
                          TRUE                       TRUE 
         cyto_create_cpm_style       cyto_create_gn_style 
                          TRUE                       TRUE 
             cyto_create_graph             dendro_network 
                          TRUE                       TRUE 
              find_all_cpm_com                   gn_names 
                          TRUE                       TRUE 
                     sim_table                    t_value 
                          TRUE                       TRUE 
                    wuchswerte 
...
| Execution Time | 2025-02-18 03:41:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bb480f5b89_1739850070
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpokObNY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dendroNetwork_v0.5.4-tikzDictionary"
