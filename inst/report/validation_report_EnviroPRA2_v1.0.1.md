# Validation Report - EnviroPRA2@1.0.1
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Fernando Barrio-Parra <fernando.barrio@upm.es>       |
...
Overall the package has 13 exported objects. 13 are documented:
                         ...
                         AD                     AIR                    DWIR 
                       TRUE                    TRUE                    TRUE 
         Fit_dist_parameter           fit_dist_test                      HI 
                       TRUE                    TRUE                    TRUE 
                   HIdermal           plot_fit_dist random_number_generator 
                       TRUE                    TRUE                    TRUE 
                       RISK              RISKdermal                     SIR 
                       TRUE                    TRUE                    TRUE 
                         VI 
...
| Execution Time | 2025-02-19 04:12:13 UTC |
...
running this report
    ...
    PROCESSX_PS1d454bc170c3_1739938327
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb9H51y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EnviroPRA2_v1.0.1-tikzDictionary"
