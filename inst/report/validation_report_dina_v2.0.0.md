...
| has_source_control   | https://github.com/tmsalab/dina               |
...
|     | package                     | type      |
|:----|:----------------------------|:----------|
| 1   | simcdm (\>= 0.1.0)          | Depends   |
| 2   | Rcpp (\>= 1.0.0)            | LinkingTo |
| 3   | RcppArmadillo (\>= 0.9.200) | LinkingTo |
| 4   | simcdm                      | LinkingTo |
| 5   | rgen                        | LinkingTo |
...
| Execution Time | 2025-02-18 04:07:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bb417fa047d_1739851645
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpifZ2C7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dina_v2.0.0-tikzDictionary"
