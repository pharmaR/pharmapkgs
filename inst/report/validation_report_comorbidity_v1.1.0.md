# Validation Report - comorbidity@1.1.0
...
| export_help          | 4                                                |
| has_website          | TRUE                                             |
| has_maintainer       | Alessandro Gasparini <alessandro@ellessenne.xyz> |
| bugs_status          | 0.7333333                                        |
| has_source_control   | https://github.com/ellessenne/comorbidity        |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    available_algorithms          comorbidity          sample_diag 
                    TRUE                 TRUE                 TRUE 
                   score 
                    TRUE 
...
| Execution Time | 2025-02-17 03:33:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61db17131_1739763199
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1PWzUF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comorbidity_v1.1.0-tikzDictionary"
