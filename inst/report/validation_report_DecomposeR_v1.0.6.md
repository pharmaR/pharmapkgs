# Validation Report - DecomposeR@1.0.6
...
| export_help          | 45                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Sebastien Wouters <wouterseb@gmail.com>              |
...
| 4   | usethis                   | Imports |
| 5   | tictoc                    | Imports |
| 6   | StratigrapheR (\>= 1.1.1) | Imports |
| 7   | grid                      | Imports |
| 8   | hexbin                    | Imports |
| 9   | colorRamps                | Imports |
| 10  | dplyr (\>= 1.0.0)         | Imports |
...
Overall the package has 45 exported objects. 45 are documented:
                ...
                approx.cor                 as.emd               as.pulse 
                      TRUE                   TRUE                   TRUE 
                 check.emd               condense           dq.algorithm 
                      TRUE                   TRUE                   TRUE 
                 extremist              extricate                    gzc 
                      TRUE                   TRUE                   TRUE 
             gzc.algorithm          gzc.departure        HilbertEnvelope 
                      TRUE                   TRUE                   TRUE 
          HilbertTransform             inst.pulse             inst.ratio 
                      TRUE                   TRUE                   TRUE 
    InstantaneousFrequency              integrity                 is.emd 
                      TRUE                   TRUE                   TRUE 
                  is.pulse               is.ratio            is.simp.emd 
                      TRUE                   TRUE                   TRUE 
                 mode.bind                mode.in               mode.out 
                      TRUE                   TRUE                   TRUE 
                 n.extrema              normalise              normalize 
                      TRUE                   TRUE                   TRUE 
                 oscillate              parsimony              pile.down 
                      TRUE                   TRUE                   TRUE 
                   pile.up               plot_emd               plot_hex 
                      TRUE                   TRUE                   TRUE 
                 plot_hist               plot_imf             plot_pulse 
                      TRUE                   TRUE                   TRUE 
                plot_ratio        PrecisionTester                 ratios 
                      TRUE                   TRUE                   TRUE 
                 repl.bind               repl.out                respace 
                      TRUE                   TRUE                   TRUE 
                  simp.emd             simple.ssa               symmetry 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 03:33:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4328e90a7_1739849588
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpR5xZyo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DecomposeR_v1.0.6-tikzDictionary"
