...
| export_help          | 40                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Jens Harbers <jensharbers@gmail.com>          |
| bugs_status          | subscript out of bounds                       |
| size_codebase        | 1615                                          |
| has_source_control   | https://github.com/jensharbers/agricolaeplotr |
...
Overall the package has 40 exported objects. 40 are documented:
                     ...
                     citations                    DOE_obj 
                          TRUE                       TRUE 
        full_control_positions              make_polygons 
                          TRUE                       TRUE 
                    plot_alpha                   plot_bib 
                          TRUE                       TRUE 
                   plot_cyclic                   plot_dau 
                          TRUE                       TRUE 
               plot_design_crd  plot_design.factorial_crd 
                          TRUE                       TRUE 
     plot_design.factorial_lsd plot_design.factorial_rcbd 
                          TRUE                       TRUE 
                 plot_fieldhub                plot_graeco 
                          TRUE                       TRUE 
             plot_latin_square        plot_lattice_simple 
                          TRUE                       TRUE 
           plot_lattice_triple      plot_longest_diagonal 
                          TRUE                       TRUE 
                     plot_rcbd             plot_split_crd 
                          TRUE                       TRUE 
                plot_split_lsd            plot_split_rcbd 
                          TRUE                       TRUE 
                    plot_strip                plot_youden 
                          TRUE                       TRUE 
             protective_layers           sample_locations 
                          TRUE                       TRUE 
                    serpentine                    summary 
                          TRUE                       TRUE 
             test_input_extend           test_input_ncols 
                          TRUE                       TRUE 
              test_input_nrows         test_input_reverse 
                          TRUE                       TRUE 
              test_input_shift        test_name_in_column 
                          TRUE                       TRUE 
             test_names_design                test_string 
                          TRUE                       TRUE 
                      theme_gi               theme_poster 
                          TRUE                       TRUE 
                    theme_pres                   to_table 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-14 06:43:11 UTC |
...
running this report
    ...
    PROCESSX_PS726d4417c056_1739515388
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZBqSbw
