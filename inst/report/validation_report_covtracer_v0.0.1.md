# Validation Report - covtracer@0.0.1
...
| export_help          | 10                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Doug Kelkhoff <doug.kelkhoff@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/genentech/covtracer  |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    join_on_containing_srcrefs                pkg_srcrefs 
                          TRUE                       TRUE 
                pkg_srcrefs_df                      Rd_df 
                          TRUE                       TRUE 
                  test_srcrefs            test_srcrefs_df 
                          TRUE                       TRUE 
                 test_trace_df         test_trace_mapping 
                          TRUE                       TRUE 
                 trace_srcrefs           trace_srcrefs_df 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-17 04:10:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6df8e80f_1739765400
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp20MlmN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covtracer_v0.0.1-tikzDictionary"
