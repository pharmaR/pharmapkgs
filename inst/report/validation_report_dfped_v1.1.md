...
| export_help          | 35                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Artemis Toumazi <artemis.toumazi@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | http://github.com/artemis-toumazi/dfped     |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | rstan(\>= 2.8.1)    | Depends |
| 2   | stats4              | Depends |
| 3   | ggplot2 (\>= 2.0.0) | Imports |
| 4   | methods             | Imports |
| 5   | stats               | Imports |
| 6   | graphics            | Imports |
| 7   | grDevices           | Imports |
...
Overall the package has 35 exported objects. 35 are documented:
            ...
            albAge    alpha1AGage          Cladu      Clch.Allo    Clch.Linear 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          Clch.Mat          Clchu         concAd         concCh         crmAtj 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        doseChoice      doseRange            Fch           fuCh        KCYP1A2 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           KCYP2B6    KCYP2C18_19        KCYP2C8        KCYP2C9        KCYP2D6 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           KCYP2E1         KCYP3A      KCYP3A4_5 kickoffControl      metaPhase 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     plotEstimates    priorChoice       sigmaEss        sigmaHI        sigmaLI 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              simu     simulation       skeleton           waic   weightCYPsum 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 03:54:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4182035fb_1739850891
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpomKVRx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dfped_v1.1-tikzDictionary"
