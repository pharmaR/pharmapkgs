...
Overall the package has 24 exported objects. 24 are documented:
                  ...
                  anofa             anofaES        anofaN2Power           anofaPlot 
                   TRUE                TRUE                TRUE                TRUE 
           anofaPower2N            CI.count contrastFrequencies               count 
                   TRUE                TRUE                TRUE                TRUE 
          emFrequencies             explain                 GRF     has.cbind.terms 
                   TRUE                TRUE                TRUE                TRUE 
       has.nested.terms          in.formula          init.count          is.formula 
                   TRUE                TRUE                TRUE                TRUE 
           is.one.sided        sub.formulas           summarize          toCompiled 
                   TRUE                TRUE                TRUE                TRUE 
                 toLong               toRaw           toTabular              toWide 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-14 06:55:48 UTC |
...
running this report
    ...
    PROCESSX_PS726d4f9a0980_1739516145
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyXPR14
