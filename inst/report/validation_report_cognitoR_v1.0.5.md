# Validation Report - cognitoR@1.0.5
...
| export_help          | 7                                   |
| has_website          | FALSE                               |
| has_maintainer       | Pablo Pagnone <pablodp84@gmail.com> |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    cognito_add_account      cognito_server          cognito_ui       cookie_server 
                   TRUE                TRUE                TRUE                TRUE 
              cookie_ui       logout_server           logout_ui 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:54:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3acdcab7_1739681659
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpxr3yPK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cognitoR_v1.0.5-tikzDictionary"
