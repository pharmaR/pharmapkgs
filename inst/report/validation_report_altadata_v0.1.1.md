...
| export_help          | 15                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Emre Durukan <emredurukan@altadata.io>               |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 257                                                  |
| has_source_control   | https://github.com/altabering/altadata-r             |
...
Overall the package has 15 exported objects. 15 are documented:
               ...
               aldatata.api_key       altadata.condition_in 
                           TRUE                        TRUE 
      altadata.condition_not_in              altadata.equal 
                           TRUE                        TRUE 
              altadata.get_data         altadata.get_header 
                           TRUE                        TRUE 
          altadata.greater_than altadata.greater_than_equal 
                           TRUE                        TRUE 
             altadata.less_than    altadata.less_than_equal 
                           TRUE                        TRUE 
     altadata.list_subscription               altadata.load 
                           TRUE                        TRUE 
             altadata.not_equal             altadata.select 
                           TRUE                        TRUE 
                  altadata.sort 
                           TRUE 
...
| Execution Time | 2025-02-14 06:50:28 UTC |
...
running this report
    ...
    PROCESSX_PS726d33e3324b_1739515825
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpR8NAW5
