...
| export_help          | 17                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Philippe Massicotte <pmassicotte@hotmail.com> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/PMassicotte/eemR           |
...
Overall the package has 17 exported objects. 17 are documented:
                   ...
                   eem_bind    eem_biological_index         eem_coble_peaks 
                       TRUE                    TRUE                    TRUE 
                    eem_cut       eem_export_matlab             eem_extract 
                       TRUE                    TRUE                    TRUE 
     eem_fluorescence_index  eem_humification_index eem_inner_filter_effect 
                       TRUE                    TRUE                    TRUE 
                  eem_names             eem_names<-               eem_peaks 
                       TRUE                    TRUE                    TRUE 
    eem_raman_normalisation                eem_read        eem_remove_blank 
                       TRUE                    TRUE                    TRUE 
      eem_remove_scattering     eem_set_wavelengths 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-19 03:45:15 UTC |
...
running this report
    ...
    PROCESSX_PS1d45643813e9_1739936709
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAP6u6F
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eemR_v1.0.1-tikzDictionary"
