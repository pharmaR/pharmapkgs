# Validation Report - clttools@1.3
...
| export_help          | 25                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Simiao Ye <simiao.ye@gmail.com>                      |
...
Overall the package has 25 exported objects. 25 are documented:
      ...
      beta.simu.plot  binom.simu.plot  chisq.simu.plot             coin 
                TRUE             TRUE             TRUE             TRUE 
           coin.plot        coin.simu   coin.simu.plot             dice 
                TRUE             TRUE             TRUE             TRUE 
           dice.plot        dice.simu   dice.simu.plot  distr.simu.plot 
                TRUE             TRUE             TRUE             TRUE 
      expo.simu.plot             expt         expt.mse        expt.plot 
                TRUE             TRUE             TRUE             TRUE 
           expt.simu   expt.simu.plot   gamm.simu.plot   geom.simu.plot 
                TRUE             TRUE             TRUE             TRUE 
     hyper.simu.plot nbinom.simu.plot normal.simu.plot   pois.simu.plot 
                TRUE             TRUE             TRUE             TRUE 
      unif.simu.plot 
                TRUE 
...
| Execution Time | 2025-02-16 04:36:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35297d3af_1739680564
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDJLlZh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clttools_v1.3-tikzDictionary"
