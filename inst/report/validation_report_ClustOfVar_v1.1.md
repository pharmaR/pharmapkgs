# Validation Report - ClustOfVar@1.1
...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Marie Chavent <Marie.Chavent@u-bordeaux.fr>          |
...
GroupBN, Information, Rprofet

## Namespace

Overall the package has 20 exported objects. 20 are documented:

             bootvar       clust_diss     clusterscore        cutreevar 
                TRUE             TRUE             TRUE             TRUE 
            descript        getnnsvar        hclustvar        kmeansvar 
                TRUE             TRUE             TRUE             TRUE 
         mixedVarSim     plot.clustab    plot.clustvar   plot.hclustvar 
                TRUE             TRUE             TRUE             TRUE 
    predict.clustvar    print.clustab   print.clustvar  print.hclustvar 
                TRUE             TRUE             TRUE             TRUE 
                rand        stability  summary.clustab summary.clustvar 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:41:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32dda7a94_1739680869
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQZES9K
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClustOfVar_v1.1-tikzDictionary"
