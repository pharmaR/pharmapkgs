# Validation Report - dtComb@1.0.4
...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Gokmen Zararsiz <gokmen.zararsiz@gmail.com>          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/gokmenzararsiz/dtComb             |
...
Overall the package has 13 exported objects. 13 are documented:
    ...
    availableMethods   helper_minimax    helper_minmax       helper_PCL 
                TRUE             TRUE             TRUE             TRUE 
           helper_PT        helper_TS          linComb         mathComb 
                TRUE             TRUE             TRUE             TRUE 
              mlComb       nonlinComb         plotComb        std.train 
                TRUE             TRUE             TRUE             TRUE 
      transform_math 
                TRUE 
...
| Execution Time | 2025-02-18 04:55:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4394a4624_1739854503
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqkWnHi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dtComb_v1.0.4-tikzDictionary"
