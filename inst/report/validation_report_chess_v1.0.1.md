...
| export_help          | 46                               |
| has_website          | TRUE                             |
| has_maintainer       | C. Lente <clente@curso-r.com>    |
| bugs_status          | subscript out of bounds          |
| has_source_control   | https://github.com/curso-r/chess |
...
Overall the package has 46 exported objects. 45 are documented:
                               ...
                               %>%                           back 
                             FALSE                           TRUE 
                    can_claim_draw          can_claim_fifty_moves 
                              TRUE                           TRUE 
    can_claim_threefold_repetition                            fen 
                              TRUE                           TRUE 
                           forward                           game 
                              TRUE                           TRUE 
                       gives_check                 halfmove_clock 
                              TRUE                           TRUE 
               has_castling_rights                 has_en_passant 
                              TRUE                           TRUE 
         has_insufficient_material   has_kingside_castling_rights 
                              TRUE                           TRUE 
     has_queenside_castling_rights                  install_chess 
                              TRUE                           TRUE 
                        is_capture                    is_castling 
                              TRUE                           TRUE 
                          is_check                   is_checkmate 
                              TRUE                           TRUE 
                     is_en_passant         is_fivefold_repetition 
                              TRUE                           TRUE 
                      is_game_over       is_insufficient_material 
                              TRUE                           TRUE 
                   is_irreversible           is_kingside_castling 
                              TRUE                           TRUE 
             is_queenside_castling                  is_repetition 
                              TRUE                           TRUE 
              is_seventyfive_moves                   is_stalemate 
                              TRUE                           TRUE 
                        is_zeroing                           move 
                              TRUE                           TRUE 
                       move_number                          moves 
...
| Execution Time | 2025-02-16 04:12:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3613784af_1739679132
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxR7WuK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chess_v1.0.1-tikzDictionary"
