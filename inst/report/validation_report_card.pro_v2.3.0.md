# Validation Report - card.pro@2.3.0
...
| export_help          | 16                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Obinna Obianom <idonshayo@gmail.com> |
...
Overall the package has 16 exported objects. 16 are documented:
       ...
       add.JQuery      altPanel      card.pro collapseEntry  empty.server 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      footerPanel      moveable           nav    primePanel progressInput 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              row      tabEntry  template.loc   titlePanel2   use.cardpro 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          wrapper 
             TRUE 
...
| Execution Time | 2025-02-16 03:41:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bc391a9a03_1739677255
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAjwjzZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_card.pro_v2.3.0-tikzDictionary"
