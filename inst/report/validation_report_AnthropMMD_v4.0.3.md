...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Frédéric Santos <frederic.santos@u-bordeaux.fr>      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 1038                                                 |
| has_source_control   | https://gitlab.com/f-santos/anthropmmd/              |
...
Overall the package has 9 exported objects. 9 are documented:
           ...
           binary_to_table                    mmd               mmd_boot 
                      TRUE                   TRUE                   TRUE 
      plot.anthropmmd_boot plot.anthropmmd_result          select_traits 
                      TRUE                   TRUE                   TRUE 
                 start_mmd               StartMMD          table_relfreq 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-14 06:57:00 UTC |
...
running this report
    ...
    PROCESSX_PS726d5a52fab7_1739516217
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKJv7rY
