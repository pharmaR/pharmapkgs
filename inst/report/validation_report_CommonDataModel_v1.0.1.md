# Validation Report - CommonDataModel@1.0.1
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Clair Blacketer <mblacke@its.jnj.com>                |
...
Overall the package has 14 exported objects. 14 are documented:
             ...
             buildRelease       buildReleaseZip             createDdl 
                     TRUE                  TRUE                  TRUE 
        createForeignKeys     createPrimaryKeys    downloadCurrentDdl 
                     TRUE                  TRUE                  TRUE 
               executeDdl listSupportedDialects listSupportedVersions 
                     TRUE                  TRUE                  TRUE 
                parseWiki              writeDdl      writeForeignKeys 
                     TRUE                  TRUE                  TRUE 
               writeIndex      writePrimaryKeys 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-17 03:32:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bd621e0a58a_1739763164
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLnncpd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CommonDataModel_v1.0.1-tikzDictionary"
