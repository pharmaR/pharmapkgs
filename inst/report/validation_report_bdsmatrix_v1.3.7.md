# Validation Report - bdsmatrix@1.3.7
...
bbmle, coxme, famSKATRC, finalfit, gap, insight, INTACT, pcalg, plm,
plsVarSel, PRSPGx, sparsediscrim, splm

## Namespace

Overall the package has 7 exported objects. 9 are documented:

               bdsBlock                bdsI           bdsmatrix       bdsmatrix.ibd 
                   TRUE                TRUE                TRUE                TRUE 
    bdsmatrix.reconcile               gchol       listbdsmatrix 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 03:49:11 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2924e52b_1739591346
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1xAZ02
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bdsmatrix_v1.3.7-tikzDictionary"
