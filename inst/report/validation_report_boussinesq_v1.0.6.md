# Validation Report - boussinesq@1.0.6
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Emanuele Cordano <emanuele.cordano@gmail.com>        |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/ecor/boussinesq                   |
...
Overall the package has 5 exported objects. 5 are documented:
                      ...
                      beq.lin     beq.lin.dimensionless                  beq.song 
                         TRUE                      TRUE                      TRUE 
       beq.song.dimensionless coefficient.song.solution 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-15 04:36:47 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd508cf987_1739594202
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIxQSiO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_boussinesq_v1.0.6-tikzDictionary"
