# Validation Report - breathteststan@0.8.9
...
| has_source_control   | https://github.com/dmenne/breathteststan    |
...
|:----|:---------------------------|:----------|
| 1   | methods                    | Depends   |
| 2   | Rcpp (\>= 1.0.6)           | Depends   |
| 3   | breathtestcore (\>= 0.8.8) | Imports   |
| 4   | dplyr                      | Imports   |
| 5   | purrr                      | Imports   |
| 6   | rstan (\>= 2.32.0)         | Imports   |
| 7   | rstantools (\>= 2.4.0)     | Imports   |
| 8   | stringr                    | Imports   |
| 9   | tidyr                      | Imports   |
| 10  | BH (\>= 1.72)              | LinkingTo |
| 11  | Rcpp (\>= 1.0.6)           | LinkingTo |
| 12  | RcppEigen (\>= 0.3.4)      | LinkingTo |
| 13  | rstan (\>= 2.32.0)         | LinkingTo |
...
| Execution Time | 2025-02-15 04:43:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccda0a246d_1739594589
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuLPLIG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_breathteststan_v0.8.9-tikzDictionary"
