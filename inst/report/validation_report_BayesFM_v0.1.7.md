# Validation Report - BayesFM@0.1.7
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Rémi Piatek <remi.piatek@gmail.com>                  |
...
| 2   | coda                  | Imports |
| 3   | ggplot2 (\>= 2.1.0)   | Imports |
| 4   | gridExtra             | Imports |
| 5   | plyr (\>= 1.8.0)      | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
                  ...
                  befa post.column.switch   post.sign.switch simul.dedic.facmod 
                  TRUE               TRUE               TRUE               TRUE 
      simul.nfac.prior      simul.R.prior 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 03:34:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd65565ef2_1739590478
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7syJPm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesFM_v0.1.7-tikzDictionary"
