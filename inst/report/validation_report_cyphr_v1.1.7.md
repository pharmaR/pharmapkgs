...
| export_help          | 25                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Rich FitzJohn <rich.fitzjohn@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/ropensci/cyphr       |
...
|:----|:--------------------|:--------|
| 1   | getPass             | Imports |
| 2   | openssl (\>= 0.9.9) | Imports |
| 3   | sodium (\>= 1.2.1)  | Imports |
...
Overall the package has 25 exported objects. 25 are documented:
        ...
        data_admin_authorise          data_admin_init     data_admin_list_keys 
                        TRUE                     TRUE                     TRUE 
    data_admin_list_requests                 data_key      data_request_access 
                        TRUE                     TRUE                     TRUE 
                     decrypt                 decrypt_             decrypt_data 
                        TRUE                     TRUE                     TRUE 
                decrypt_file           decrypt_object           decrypt_string 
                        TRUE                     TRUE                     TRUE 
                     encrypt                 encrypt_             encrypt_data 
                        TRUE                     TRUE                     TRUE 
                encrypt_file           encrypt_object           encrypt_string 
                        TRUE                     TRUE                     TRUE 
                 key_openssl               key_sodium          keypair_openssl 
                        TRUE                     TRUE                     TRUE 
              keypair_sodium         rewrite_register      session_key_refresh 
                        TRUE                     TRUE                     TRUE 
                  ssh_keygen 
                        TRUE 
...
| Execution Time | 2025-02-17 04:46:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65169b2_1739767609
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvsfAHc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cyphr_v1.1.7-tikzDictionary"
