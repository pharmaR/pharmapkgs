# Validation Report - classicaltest@0.7.0
...
| export_help | 6 |
| has_website | FALSE |
| has_maintainer | Andrés Christiansen <andres.christiansen@iea-hamburg.de> |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    classicaltest       correct        ctitem      ctperson   dichotomize 
...
There are 5 help pages with examples, from 8 (62.50 %).
...
| Execution Time | 2025-02-16 04:26:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31ef7fc0_1739680004
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjeuKia
...
These are the options set to generate the report:
    ...
    [1] "validation_report_classicaltest_v0.7.0-tikzDictionary"
