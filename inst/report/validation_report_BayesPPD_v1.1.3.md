# Validation Report - BayesPPD@1.1.3
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yueqi Shen <angieshen6@gmail.com>                    |
...
Overall the package has 9 exported objects. 9 are documented:
               ...
               glm.fixed.a0           glm.random.a0    normalizing.constant 
                       TRUE                    TRUE                    TRUE 
         power.glm.fixed.a0     power.glm.random.a0  power.two.grp.fixed.a0 
                       TRUE                    TRUE                    TRUE 
    power.two.grp.random.a0        two.grp.fixed.a0       two.grp.random.a0 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-15 03:39:46 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd55945978_1739590782
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprFISPJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesPPD_v1.1.3-tikzDictionary"
