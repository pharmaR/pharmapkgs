# Validation Report - DescriptiveWH@1.0.3
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | William Herrera-Caceres <williamandresh@hotmail.com> |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/William-HC/DescriptiveWH          |
...
|:----|:---------------------|:--------|
| 1   | R(\>= 3.6)           | Depends |
| 2   | stats (\>= 3.6.3)    | Imports |
| 3   | graphics (\>= 3.6.3) | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
     ...
     destatWH   distrWH    freqWH    meanWH outlierWH 
...
| Execution Time | 2025-02-18 03:46:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47f4e521a_1739850405
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYJbE61
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DescriptiveWH_v1.0.3-tikzDictionary"
