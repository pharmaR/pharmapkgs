# Validation Report - crossval@1.0.5
...
Overall the package has 3 exported objects. 3 are documented:
     ...
     confusionMatrix         crossval diagnosticErrors 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:25:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6367eae11_1739766302
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoVVhiy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crossval_v1.0.5-tikzDictionary"
