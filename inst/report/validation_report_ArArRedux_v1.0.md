...
Overall the package has 24 exported objects. 24 are documented:
              ...
              average      averagebyday         blankcorr       calibration 
                 TRUE              TRUE              TRUE              TRUE 
         clcorrection            concat   decaycorrection      fitlogratios 
                 TRUE              TRUE              TRUE              TRUE 
        fractionation           get4039           getages       getJfactors 
                 TRUE              TRUE              TRUE              TRUE 
            getmasses      interference          loaddata  loadirradiations 
                 TRUE              TRUE              TRUE              TRUE 
    massfractionation          newredux             param          plotcorr 
                 TRUE              TRUE              TRUE              TRUE 
              process              read    redux2isoplotr      weightedmean 
                 TRUE              TRUE              TRUE              TRUE 

### Examples

There are 28 help pages with examples, from 34 (82.35 %).
...
| Execution Time | 2025-02-14 07:20:43 UTC |
...
running this report
    ...
    PROCESSX_PS1c092b18fd47_1739517640
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYsntC8
