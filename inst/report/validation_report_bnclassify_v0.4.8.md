# Validation Report - bnclassify@0.4.8
...
| export_help          | 37                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Mihaljevic Bojan <boki.mihaljevic@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/bmihaljevic/bnclassify    |
...
| 2   | entropy(\>= 1.2.0)      | Imports   |
| 3   | matrixStats(\>= 0.14.0) | Imports   |
| 4   | rpart(\>= 4.1-8)        | Imports   |
| 5   | Rcpp                    | Imports   |
| 6   | Rcpp                    | LinkingTo |
| 7   | BH                      | LinkingTo |
...
Overall the package has 37 exported objects. 37 are documented:
              ...
              accuracy               aode           as_grain          as_igraph 
                  TRUE               TRUE               TRUE               TRUE 
                as_mlr       awnb_weights                bnc               bsej 
                  TRUE               TRUE               TRUE               TRUE 
             class_var            classes            cLogLik                cmi 
                  TRUE               TRUE               TRUE               TRUE 
                    cv           families   feature_families           features 
                  TRUE               TRUE               TRUE               TRUE 
                  fssj             is_anb              is_nb             is_ode 
                  TRUE               TRUE               TRUE               TRUE 
         is_semi_naive                kdb                 lp   makeRLearner.bnc 
                  TRUE               TRUE               TRUE               TRUE 
    manb_arc_posterior        modelstring              narcs                 nb 
                  TRUE               TRUE               TRUE               TRUE 
               nparams             params predictLearner.bnc             tan_cl 
                  TRUE               TRUE               TRUE               TRUE 
                tan_hc           tan_hcsp   trainLearner.bnc             values 
                  TRUE               TRUE               TRUE               TRUE 
                  vars 
                  TRUE 
...
There are 76 help pages with examples, from 78 (97.44 %).
...
| Execution Time | 2025-02-15 04:27:56 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd27b1dede_1739593671
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsZacE6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bnclassify_v0.4.8-tikzDictionary"
