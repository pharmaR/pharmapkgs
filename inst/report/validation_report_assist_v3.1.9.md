...
Overall the package has 41 exported objects. 0 are documented:

         alogit       bdiag    chol.new       cubic      cubic2       dcrdr 
          FALSE       FALSE       FALSE       FALSE       FALSE       FALSE 
          dmudr       dsidr        dsms      gdmudr      gdsidr     hat.ssr 
          FALSE       FALSE       FALSE       FALSE       FALSE       FALSE 
          ident         inc        kron      linear     linear2     lspline 
          FALSE       FALSE       FALSE       FALSE       FALSE       FALSE 
            nnr nnr.control    periodic     quintic    quintic2     rk.prod 
          FALSE       FALSE       FALSE       FALSE       FALSE       FALSE 
         septic     septic2     shrink0     shrink1      sine4p         slm 
          FALSE       FALSE       FALSE       FALSE       FALSE       FALSE 
            snm snm.control         snr snr.control      sphere         ssr 
          FALSE       FALSE       FALSE       FALSE       FALSE       FALSE 
    ssr.control          tp   tp.linear   tp.pseudo     xyplot2 
          FALSE       FALSE       FALSE       FALSE       FALSE 

### Examples

There are 76 help pages with examples, from 77 (98.70 %).
...
| Execution Time | 2025-02-14 07:28:45 UTC |
...
running this report
    ...
    PROCESSX_PS1c0963fc7593_1739518122
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphTRksX
