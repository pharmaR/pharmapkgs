# Validation Report - DGLMExtPois@0.2.3
...
| export_help | 8 |
| has_website | TRUE |
| has_maintainer | Francisco Martinez <fmartin@ujaen.es> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/franciscomartinezdelrio/DGLMExtPois |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | nloptr (\>= 1.2.1) | Imports |
| 2   | COMPoissonReg      | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    CMP_expected          dhP      glm.CMP       glm.hP  hP_expected       lrtest 
...
| Execution Time | 2025-02-18 03:56:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bb463cf2995_1739850980
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPClMPX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DGLMExtPois_v0.2.3-tikzDictionary"
