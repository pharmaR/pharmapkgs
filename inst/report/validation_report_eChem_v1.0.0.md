...
| export_help          | 24                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | David Harvey <harvey@depauw.edu>                     |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/dtharvey/eChem                    |
...
Overall the package has 24 exported objects. 24 are documented:
        ...
        animateCA     animateCC     animateCV    animateLSV    annotateCA 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       annotateCC    annotateCV   annotateLSV        plotCA        plotCC 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           plotCV  plotDiffGrid plotDiffusion      plotGrid       plotLSV 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    plotPotential      sampleCA      sampleCC      sampleCV     sampleLSV 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       simulateCA    simulateCC    simulateCV   simulateLSV 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 03:32:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d4578ded32c_1739935920
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp78vs22
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eChem_v1.0.0-tikzDictionary"
