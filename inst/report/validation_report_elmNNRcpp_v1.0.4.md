# Validation Report - elmNNRcpp@1.0.4
...
| has_source_control   | https://github.com/mlampros/elmNNRcpp            |
...
| 1   | R(\>= 3.0.2)            | Depends   |
| 2   | KernelKnn               | Depends   |
| 3   | Rcpp (\>= 0.12.17)      | Imports   |
| 4   | Rcpp                    | LinkingTo |
| 5   | RcppArmadillo (\>= 0.8) | LinkingTo |
...
Overall the package has 4 exported objects. 4 are documented:
              ...
              elm   elm_predict     elm_train onehot_encode 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 03:57:24 UTC |
...
running this report
    ...
    PROCESSX_PS1d45510b075b_1739937438
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8Y6L2T
...
These are the options set to generate the report:
    ...
    [1] "validation_report_elmNNRcpp_v1.0.4-tikzDictionary"
