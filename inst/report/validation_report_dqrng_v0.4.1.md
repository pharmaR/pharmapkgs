...
| export_help          | 14                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Ralf Stubner <ralf.stubner@gmail.com> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/daqana/dqrng       |
| has_bug_reports_url  | 1                                     |
| downloads_1yr        | 448122                                |
...
|     | package            | type      |
|:----|:-------------------|:----------|
| 1   | Rcpp (\>= 0.12.16) | Imports   |
| 2   | Rcpp               | LinkingTo |
| 3   | BH (\>= 1.64.0-1)  | LinkingTo |
| 4   | sitmo (\>= 2.0.0)  | LinkingTo |
...
AdaptGauss, colorrepel, DelayedRandomArray, dexter, DropletUtils,
FunChisq, greeks, GridOnClusters, HDMAADMM, melt, PCAtools, rnndescent,
scran, SpaDES.tools, tetragon, uwot

## Namespace

Overall the package has 14 exported objects. 14 are documented:

                 dqrexp           dqrmvnorm     dqrng_get_state     dqrng_set_state 
                   TRUE                TRUE                TRUE                TRUE 
              dqRNGkind             dqrnorm       dqrrademacher             dqrunif 
                   TRUE                TRUE                TRUE                TRUE 
               dqsample        dqsample.int          dqset.seed generateSeedVectors 
                   TRUE                TRUE                TRUE                TRUE 
       register_methods     restore_methods 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-18 04:42:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4689fdff1_1739853720
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFiF3pe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dqrng_v0.4.1-tikzDictionary"
