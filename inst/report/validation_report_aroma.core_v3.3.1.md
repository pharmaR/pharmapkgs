...
| size_codebase        | 17337                                         |
| has_source_control   | https://github.com/HenrikBengtsson/aroma.core |
| has_bug_reports_url  | 1                                             |
| downloads_1yr        | 11222                                         |
| reverse_dependencies | 5                                             |
| has_examples         | 0.9923664                                     |
| dependencies         | 16                                            |
| license              | LGPL (\>= 2.1)                                |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | R.utils (\>= 2.10.1)     | Depends |
| 2   | R.filesets (\>= 2.14.0)  | Depends |
| 3   | R.devices (\>= 2.16.1)   | Depends |
| 4   | stats                    | Imports |
| 5   | tools                    | Imports |
| 6   | utils                    | Imports |
| 7   | R.methodsS3 (\>= 1.8.1)  | Imports |
| 8   | R.oo (\>= 1.24.0)        | Imports |
| 9   | R.cache (\>= 0.14.0)     | Imports |
| 10  | R.rsp (\>= 0.44.0)       | Imports |
| 11  | matrixStats (\>= 0.57.0) | Imports |
| 12  | RColorBrewer (\>= 1.1-2) | Imports |
| 13  | PSCBS (\>= 0.65.0)       | Imports |
| 14  | listenv                  | Imports |
| 15  | future                   | Imports |
| 16  | BiocManager              | Imports |
...
Overall the package has 3 exported objects. 2 are documented:
    ...
    .conflicts.OK      .Machine       process 
            FALSE          TRUE          TRUE 

### Examples

There are 130 help pages with examples, from 131 (99.24 %).
...
| Execution Time | 2025-02-14 07:24:33 UTC |
...
running this report
    ...
    PROCESSX_PS1c09629b254d_1739517870
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvB2OJ8
