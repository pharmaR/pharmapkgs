# Validation Report - experDesign@0.4.0
...
| has_source_control   | https://github.com/llrs/experDesign/           |
...
Overall the package has 29 exported objects. 29 are documented:
              ...
              batch_names            check_data           check_index 
                     TRUE                  TRUE                  TRUE 
            compare_index         create_subset                design 
                     TRUE                  TRUE                  TRUE 
             distribution               entropy      evaluate_entropy 
                     TRUE                  TRUE                  TRUE 
    evaluate_independence        evaluate_index          evaluate_mad 
                     TRUE                  TRUE                  TRUE 
            evaluate_mean           evaluate_na         evaluate_orig 
                     TRUE                  TRUE                  TRUE 
              evaluate_sd         extreme_cases             follow_up 
                     TRUE                  TRUE                  TRUE 
               follow_up2               inspect       optimum_batches 
                     TRUE                  TRUE                  TRUE 
           optimum_subset         position_name              qcSubset 
                     TRUE                  TRUE                  TRUE 
               replicates         sizes_batches               spatial 
                     TRUE                  TRUE                  TRUE 
                use_index        valid_followup 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-19 04:51:51 UTC |
...
running this report
    ...
    PROCESSX_PS1d4516566261_1739940704
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvPvMjF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_experDesign_v0.4.0-tikzDictionary"
