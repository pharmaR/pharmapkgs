# Validation Report - binman@0.1.3
...
| export_help          | 17                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Ju Yeong Kim <jkim2345@fredhutch.org> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/ropensci/binman    |
| has_bug_reports_url  | 1                                     |
| downloads_1yr        | 50474                                 |
| reverse_dependencies | 2                                     |
| has_examples         | 0.7058824                             |
| dependencies         | 9                                     |
...
Overall the package has 17 exported objects. 17 are documented:
                      ...
                      app_dir          assign_directory            download_files 
                         TRUE                      TRUE                      TRUE 
            increment_version             list_versions            noproc_dlfiles 
                         TRUE                      TRUE                      TRUE 
                parse_version predl_bitbucket_downloads       predl_github_assets 
                         TRUE                      TRUE                      TRUE 
         predl_google_storage              process_yaml            render_version 
                         TRUE                      TRUE                      TRUE 
                reset_version               rm_platform                rm_version 
                         TRUE                      TRUE                      TRUE 
                  set_version          unziptar_dlfiles 
                         TRUE                      TRUE 

### Examples

There are 12 help pages with examples, from 17 (70.59 %).
...
| Execution Time | 2025-02-15 04:09:09 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd669da265_1739592544
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprkP51n
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binman_v0.1.3-tikzDictionary"
