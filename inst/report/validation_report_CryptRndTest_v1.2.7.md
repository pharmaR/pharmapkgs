# Validation Report - CryptRndTest@1.2.7
...
Overall the package has 13 exported objects. 13 are documented:
    ...
    adaptive.chi.square   birthday.spacings          book.stack                 GCD 
                   TRUE                TRUE                TRUE                TRUE 
                GCD.big               GCD.q            GCD.test   random.walk.tests 
                   TRUE                TRUE                TRUE                TRUE 
                Strlng2   TBT.criticalValue           toBaseTen           toBaseTwo 
                   TRUE                TRUE                TRUE                TRUE 
     topological.binary 
                   TRUE 
...
| Execution Time | 2025-02-17 04:29:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64bb9f146_1739766541
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNU08mG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CryptRndTest_v1.2.7-tikzDictionary"
