# Validation Report - concatipede@1.0.1
...
| export_help          | 12                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Matteo Vecchi <matteo.vecchi15@gmail.com> |
| bugs_status          | 0.8571429                                 |
| has_source_control   | https://github.com/tardipede/concatipede  |
...
Overall the package has 12 exported objects. 11 are documented:
                    ...
                    %>%     auto_match_seqs         concatipede concatipede_example 
                  FALSE                TRUE                TRUE                TRUE 
    concatipede_prepare          find_fasta   get_genbank_table             read_xl 
                   TRUE                TRUE                TRUE                TRUE 
            write_fasta         write_nexus        write_phylip            write_xl 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 03:39:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67e3de33d_1739763545
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkyvRDa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_concatipede_v1.0.1-tikzDictionary"
