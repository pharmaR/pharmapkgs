...
| export_help          | 11                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Jos Smits <Jsmits@science.ru.nl>          |
| bugs_status          | subscript out of bounds                   |
| size_codebase        | 784                                       |
| has_source_control   | https://github.com/JGASmits/AnanseSeurat/ |
...
Overall the package has 11 exported objects. 10 are documented:

                        %>%         config_scANANSE           DEGS_scANANSE 
                      FALSE                    TRUE                    TRUE 
      export_ATAC_maelstrom    export_ATAC_scANANSE     export_CPM_scANANSE 
                       TRUE                    TRUE                    TRUE 
          Factor_Motif_Plot import_seurat_maelstrom  import_seurat_scANANSE 
                       TRUE                    TRUE                    TRUE 
         Maelstrom_Motif2TF          per_cluster_df 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-14 06:53:52 UTC |
...
running this report
    ...
    PROCESSX_PS726d6130c650_1739516029
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdvnNcz
