# Validation Report - beezdemand@0.1.2
...
| export_help          | 21                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Brent Kaplan <bkaplan.ku@gmail.com>                  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/brentkaplan/beezdemand            |
...
Overall the package has 21 exported objects. 21 are documented:
                 ...
                 ChangeData               CheckCols       CheckUnsystematic 
                       TRUE                    TRUE                    TRUE 
                     ExtraF               FitCurves           FitMeanCurves 
                       TRUE                    TRUE                    TRUE 
            GetAnalyticPmax GetAnalyticPmaxFallback         GetDescriptives 
                       TRUE                    TRUE                    TRUE 
               GetEmpirical                    GetK              GetSharedK 
                       TRUE                    TRUE                    TRUE 
              GetValsForSim                lambertW               PlotCurve 
                       TRUE                    TRUE                    TRUE 
                 PlotCurves                    pull          RecodeOutliers 
                       TRUE                    TRUE                    TRUE 
               ReplaceZeros          SimulateDemand               theme_apa 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-15 03:51:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccda1b0f79_1739591493
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvpsFzl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beezdemand_v0.1.2-tikzDictionary"
