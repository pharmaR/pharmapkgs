# Validation Report - ClusTorus@0.2.2
...
| export_help          | 19                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Seungki Hong <skgaboja@snu.ac.kr>        |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/sungkyujung/ClusTorus |
...
Overall the package has 19 exported objects. 19 are documented:
                ...
                ang.dist            ang.minus            ang.pdist 
                    TRUE                 TRUE                 TRUE 
              clus.torus cluster.assign.torus         cp.torus.kde 
                    TRUE                 TRUE                 TRUE 
      ellip.kmeans.torus           EMsinvMmix           grid.torus 
                    TRUE                 TRUE                 TRUE 
        hyperparam.alpha         hyperparam.J     hyperparam.torus 
                    TRUE                 TRUE                 TRUE 
               icp.torus       icp.torus.eval            kde.torus 
                    TRUE                 TRUE                 TRUE 
            kmeans.torus             on.torus            tor.minus 
                    TRUE                 TRUE                 TRUE 
            wtd.stat.ang 
                    TRUE 
...
| Execution Time | 2025-02-16 04:41:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35f615f68_1739680875
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZEHyIq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClusTorus_v0.2.2-tikzDictionary"
