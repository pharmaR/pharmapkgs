...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Javier Espinosa <javier.espinosa.b@usach.cl>         |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | VGAM (\>= 1.0-5)   | Imports |
| 2   | gtools (\>= 3.5.0) | Imports |
| 3   | stats (\>= 3.4.3)  | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
           ...
           confRegCCR confRegUCRandUCCR              mdcp      monoTestBonf 
                 TRUE              TRUE              TRUE              TRUE 
      monoTestConfReg          plotCMLE 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:25:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67cee638b_1739766332
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNNkStD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crov_v0.3.0-tikzDictionary"
