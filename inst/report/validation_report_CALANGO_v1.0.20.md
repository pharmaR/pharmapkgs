# Validation Report - CALANGO@1.0.20
...
| export_help          | 5                                   |
| has_website          | TRUE                                |
| has_maintainer       | Felipe Campelo <fcampelo@gmail.com> |
| bugs_status          | 1                                   |
...
| 2   | pbmcapply (\>= 1.5.0)     | Imports |
| 3   | ape (\>= 5.3.0)           | Imports |
| 4   | rmarkdown (\>= 2.1.0)     | Imports |
| 5   | nlme (\>= 3.1.0)          | Imports |
| 6   | BiocManager (\>= 1.30.10) | Imports |
| 7   | dendextend (\>= 1.15.2)   | Imports |
| 8   | heatmaply (\>= 1.1.0)     | Imports |
| 9   | ggplot2 (\>= 2.3.2)       | Imports |
| 10  | plotly (\>= 4.9.2)        | Imports |
| 11  | DT (\>= 0.13)             | Imports |
| 12  | htmltools (\>= 0.5.0)     | Imports |
| 13  | htmlwidgets (\>= 1.5.1)   | Imports |
| 14  | pkgdown (\>= 1.5.1)       | Imports |
| 15  | knitr (\>= 1.28)          | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
      ...
      install_bioc_dependencies                 make_report 
                           TRUE                        TRUE 
    retrieve_calanguize_genomes         retrieve_data_files 
                           TRUE                        TRUE 
                    run_CALANGO 
                           TRUE 
...
| Execution Time | 2025-02-16 03:33:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35c4c486a_1739676833
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2lKAS3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CALANGO_v1.0.20-tikzDictionary"
