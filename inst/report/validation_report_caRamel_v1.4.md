...
| export_help          | 20                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Fabrice Zaoui <fabrice.zaoui@edf.fr> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/fzao/caRamel      |
...
Overall the package has 20 exported objects. 20 are documented:
              ...
              boxes         caRamel         Cextrap         Cinterp  Crecombination 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          Cusecovar    decrease_pop        Dimprove        dominate       dominated 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           downsize         matvcov         newXval          pareto    plot_caramel 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        plot_pareto plot_population         rselect        val2rank        vol_splx 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-16 03:40:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36272d3df_1739677202
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpibePCi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_caRamel_v1.4-tikzDictionary"
