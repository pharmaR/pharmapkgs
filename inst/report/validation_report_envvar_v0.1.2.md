# Validation Report - envvar@0.1.2
...
| has_source_control   | https://github.com/briandconnelly/envvar |
...
Overall the package has 20 exported objects. 20 are documented:
              ...
              envvar_get       envvar_get_csv      envvar_get_date 
                    TRUE                 TRUE                 TRUE 
     envvar_get_datetime       envvar_get_dir      envvar_get_file 
                    TRUE                 TRUE                 TRUE 
      envvar_get_integer envvar_get_ipaddress      envvar_get_list 
                    TRUE                 TRUE                 TRUE 
      envvar_get_logical   envvar_get_numeric     envvar_get_oneof 
                    TRUE                 TRUE                 TRUE 
          envvar_get_psv       envvar_get_url      envvar_get_uuid 
                    TRUE                 TRUE                 TRUE 
      envvar_get_version        envvar_is_set          envvar_list 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:13:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d456cc9be4f_1739938375
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphQI3Po
...
These are the options set to generate the report:
    ...
    [1] "validation_report_envvar_v0.1.2-tikzDictionary"
