...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | David Rubinger <david.rubinger@gmail.com>            |
...
| 4   | jsonlite (\>= 1.6)  | Imports |
| 5   | tibble (\>= 2.1.1)  | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
          ...
          bq_groups bq_transactions        bq_users 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:44:57 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd35eca3aa_1739594692
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIplwnK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_briqr_v0.1.0-tikzDictionary"
