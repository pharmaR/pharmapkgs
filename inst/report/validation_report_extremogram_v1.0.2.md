# Validation Report - extremogram@1.0.2
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Nadezda Frolova <nfrolova@ualberta.ca>               |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | boot(\>= 1.3-11)    | Imports |
| 2   | MASS(\>= 7.3-31)    | Imports |
| 3   | parallel(\>= 3.1.1) | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
       ...
       bootconf1    bootconf2    bootconfr extremogram1 extremogram2 extremogramr 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
         permfn1      permfn2      permfnr 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-19 04:58:29 UTC |
...
running this report
    ...
    PROCESSX_PS1d4524e1b9b3_1739941103
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp430AcU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extremogram_v1.0.2-tikzDictionary"
