# Validation Report - ebvcube@0.3.3
...
| export_help          | 16                                 |
| has_website          | TRUE                               |
| has_maintainer       | Luise Quoss <luise.quoss@idiv.de>  |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/EBVCube/ebvcube |
...
Overall the package has 16 exported objects. 16 are documented:
           ...
           ebv_add_data         ebv_analyse       ebv_attribute          ebv_create 
                   TRUE                TRUE                TRUE                TRUE 
    ebv_create_taxonomy   ebv_datacubepaths        ebv_download             ebv_map 
                   TRUE                TRUE                TRUE                TRUE 
           ebv_metadata      ebv_properties            ebv_read         ebv_read_bb 
                   TRUE                TRUE                TRUE                TRUE 
           ebv_read_shp        ebv_resample           ebv_trend           ebv_write 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 05:16:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47f28f68d_1739855801
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgtlNME
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ebvcube_v0.3.3-tikzDictionary"
