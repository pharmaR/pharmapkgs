...
Overall the package has 8 exported objects. 8 are documented:
            ...
            Adjacency           DiffHub   hub.pval.cutoff           hub.wgs 
                 TRUE              TRUE              TRUE              TRUE 
              HubPlot         HubStatus        pvalue.hub WeightedGeneScore 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 03:57:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb415298687_1739851032
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUUIPbe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dhga_v0.1-tikzDictionary"
