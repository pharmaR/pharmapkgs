# Validation Report - copulaboost@0.1.0
...
| export_help          | 2                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Simon Boge Brant <simbrant91@gmail.com>              |
...
|     | package                      | type    |
|:----|:-----------------------------|:--------|
| 1   | rvinecopulib (\>= 0.5.4.1.0) | Imports |
...
| Execution Time | 2025-02-17 03:54:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65103269d_1739764494
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8j4S7u
...
These are the options set to generate the report:
    ...
    [1] "validation_report_copulaboost_v0.1.0-tikzDictionary"
