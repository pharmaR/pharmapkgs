...
| export_help          | 9                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Chris Hartgerink <chris@libscie.org> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/libscie/datr      |
...
Overall the package has 9 exported objects. 9 are documented:
      ...
      clone_dat  create_dat dat_install install_dat     log_dat    pull_dat 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
      share_dat  status_dat    sync_dat 
           TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 05:04:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65f9ece95_1739768659
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfmkvO4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datr_v0.1.0-tikzDictionary"
