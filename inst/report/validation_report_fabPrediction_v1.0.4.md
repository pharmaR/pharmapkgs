# Validation Report - fabPrediction@1.0.4
...
| export_help          | 17                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Elizabeth Bersson <elizabeth.bersson@duke.edu> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/betsybersson/fabPrediction  |
...
Overall the package has 17 exported objects. 17 are documented:
    ...
    bayesMultinomialPrediction      bayesNormalPrediction 
                          TRUE                       TRUE 
                 dtaPrediction                        eye 
                          TRUE                       TRUE 
      fabCategoricalPrediction    fabContinuousPrediction 
                          TRUE                       TRUE 
                  fayHerriotEB                    initMoM 
                          TRUE                       TRUE 
              normalPrediction               pluginValues 
                          TRUE                       TRUE 
                 polyaGradient               polyaHessian 
                          TRUE                       TRUE 
                      polyaMLE         predictionInterval 
                          TRUE                       TRUE 
                 predictionSet                 rdirichlet 
                          TRUE                       TRUE 
               row_standardize 
                          TRUE 
...
| Execution Time | 2025-02-19 05:02:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d457a504d6c_1739941360
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsT8lGr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fabPrediction_v1.0.4-tikzDictionary"
