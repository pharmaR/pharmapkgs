...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Nicolas Hiot <nicolas.hiot@univ-orleans.fr>          |
...
Overall the package has 18 exported objects. 18 are documented:
       ...
       as.interval  cluster_color degree2logical  fuzzy_icmeans     iaggregate 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             ibind      igenerate        ikmeans         ineokm           iokm 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       is.interval        measure          neokm            okm          r1okm 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             r2okm  read.interval write.interval 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 04:06:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63d59a07c_1739765214
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplEl1YN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_COveR_v1.1.0-tikzDictionary"
