...
| export_help          | 19                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Miriam Esteve <mestevecampello@gmail.com> |
...
Overall the package has 19 exported objects. 19 are documented:
                ...
                bestEAT           bestRFEAT                 EAT EAT_frontier_levels 
                   TRUE                TRUE                TRUE                TRUE 
         EAT_leaf_stats            EAT_size      efficiencyCEAT   efficiencyDensity 
                   TRUE                TRUE                TRUE                TRUE 
          efficiencyEAT    efficiencyJitter     efficiencyRFEAT            frontier 
                   TRUE                TRUE                TRUE                TRUE 
                plotEAT           plotRFEAT          rankingEAT        rankingRFEAT 
                   TRUE                TRUE                TRUE                TRUE 
                  RFEAT            X2Y2.sim              Y1.sim 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 05:13:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb442e4d14_1739855611
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOYCKXy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eat_v0.1.4-tikzDictionary"
