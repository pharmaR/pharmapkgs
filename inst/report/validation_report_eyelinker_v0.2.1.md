# Validation Report - eyelinker@0.2.1
...
| export_help          | 6                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Austin Hurst <ajhurst@uwaterloo.ca>  |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/a-hurst/eyelinker |
...
Overall the package has 6 exported objects. 4 are documented:

              %In%       %within%       read_asc       read.asc which_interval 
...
| Execution Time | 2025-02-19 04:59:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d4532381b7e_1739941146
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJQe0Vs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eyelinker_v0.2.1-tikzDictionary"
