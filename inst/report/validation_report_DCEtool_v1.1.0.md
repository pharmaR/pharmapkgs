# Validation Report - DCEtool@1.1.0
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel Perez Troncoso <danielperez@ugr.es>           |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    dce_toolbox     DCEtool  list.match 
           TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 05:09:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62ac1d8a5_1739768976
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuVB5SD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DCEtool_v1.1.0-tikzDictionary"
