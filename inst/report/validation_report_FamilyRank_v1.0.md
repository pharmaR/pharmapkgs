# Validation Report - FamilyRank@1.0
...
| export_help          | 0                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Michelle Saul <msaul@carisls.com>                    |
...
| 2   | plyr (\>= 1.8.6)  | Imports   |
| 3   | stats (\>= 3.6.0) | Imports   |
| 4   | Rcpp              | LinkingTo |
...
| Execution Time | 2025-02-19 05:10:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d4529791827_1739941807
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTqIlfU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FamilyRank_v1.0-tikzDictionary"
