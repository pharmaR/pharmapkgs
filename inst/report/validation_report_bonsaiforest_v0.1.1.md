# Validation Report - bonsaiforest@0.1.1
...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Isaac Gravestock <isaac.gravestock@roche.com>        |
| bugs_status          | subscript out of bounds                              |
| has_source_control   | https://github.com/insightsengineering/bonsaiforest/ |
...
| 14  | tibble            | Imports   |
| 15  | tidyr             | Imports   |
| 16  | tidyselect        | Imports   |
| 17  | vdiffr            | Imports   |
| 18  | Rcpp              | LinkingTo |
| 19  | RcppArmadillo     | LinkingTo |
...
Overall the package has 16 exported objects. 16 are documented:
           ...
           ahr_estimation           ahr_from_km               compare 
                     TRUE                  TRUE                  TRUE 
              elastic_net generate_stacked_data             horseshoe 
                     TRUE                  TRUE                  TRUE 
           lor_estimation                 naive              naivepop 
                     TRUE                  TRUE                  TRUE 
               preprocess      simul_covariates            simul_data 
                     TRUE                  TRUE                  TRUE 
                simul_pfs             subgroups       survival_curves 
                     TRUE                  TRUE                  TRUE 
            trt_horseshoe 
                     TRUE 
...
| Execution Time | 2025-02-15 04:31:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3969312b_1739593913
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNLxawL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bonsaiforest_v0.1.1-tikzDictionary"
