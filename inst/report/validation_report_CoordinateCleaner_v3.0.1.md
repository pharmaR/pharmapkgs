# Validation Report - CoordinateCleaner@3.0.1
...
| export_help          | 25                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Alexander Zizka <zizka.alexander@gmail.com> |
...
bdc, BeeBDC, dynamicSDM, gatoRs

## Namespace

Overall the package has 25 exported objects. 25 are documented:

              cc_aohi            cc_cap            cc_cen           cc_coun 
                 TRUE              TRUE              TRUE              TRUE 
              cc_dupl            cc_equ           cc_gbif           cc_inst 
                 TRUE              TRUE              TRUE              TRUE 
              cc_iucn           cc_outl            cc_sea            cc_urb 
                 TRUE              TRUE              TRUE              TRUE 
               cc_val           cc_zero           cd_ddmm          cd_round 
                 TRUE              TRUE              TRUE              TRUE 
               cf_age          cf_equal           cf_outl          cf_range 
                 TRUE              TRUE              TRUE              TRUE 
    clean_coordinates     clean_dataset     clean_fossils   is.spatialvalid 
                 TRUE              TRUE              TRUE              TRUE 
         write_pyrate 
                 TRUE 
...
| Execution Time | 2025-02-17 03:53:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bd640fe7739_1739764382
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQTyysh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CoordinateCleaner_v3.0.1-tikzDictionary"
