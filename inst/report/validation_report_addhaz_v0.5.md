...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Renata T C Yokota <renatayokota@gmail.com>           |
...
|:----|:-------------------|:--------|
| 1   | stats              | Depends |
| 2   | boot (\>= 1.3-17)  | Depends |
| 3   | Matrix (\>= 1.2-3) | Depends |
| 4   | MASS               | Depends |
...
| Execution Time | 2025-02-14 06:35:47 UTC |
...
running this report
    ...
    PROCESSX_PS726d1f88beb3_1739514945
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSF6KiE
