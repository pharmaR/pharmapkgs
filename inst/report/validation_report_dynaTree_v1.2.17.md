# Validation Report - dynaTree@1.2.17
...
| export_help          | 31                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Robert B. Gramacy <rbg@vt.edu>                       |
...
Overall the package has 31 exported objects. 31 are documented:
                      ...
                      alc          alc.dynaTree                alcalc 
                     TRUE                  TRUE                  TRUE 
                     alcX         alcX.dynaTree                  copy 
                     TRUE                  TRUE                  TRUE 
            copy.dynaTree           deletecloud          deleteclouds 
                     TRUE                  TRUE                  TRUE 
                 dynaTree             dynaTrees                 getBF 
                     TRUE                  TRUE                  TRUE 
             plotprogress                   qEI          qEI.dynaTree 
                     TRUE                  TRUE                  TRUE 
                 qEntropy     qEntropy.dynaTree            rejuvenate 
                     TRUE                  TRUE                  TRUE 
      rejuvenate.dynaTree             relevance    relevance.dynaTree 
                     TRUE                  TRUE                  TRUE 
                   retire       retire.dynaTree                  sens 
                     TRUE                  TRUE                  TRUE 
            sens.dynaTree             treestats    treestats.dynaTree 
                     TRUE                  TRUE                  TRUE 
             varproptotal varproptotal.dynaTree            varpropuse 
                     TRUE                  TRUE                  TRUE 
      varpropuse.dynaTree 
                     TRUE 
...
| Execution Time | 2025-02-18 05:04:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bb473b47e33_1739855092
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpkbbiqu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dynaTree_v1.2.17-tikzDictionary"
