# Validation Report - conformalInference.multi@1.1.1
...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Paolo Vergottini <paolo.vergottini@gmail.com>        |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | future (\>= 1.23.0)      | Imports |
| 2   | future.apply (\>= 1.8.1) | Imports |
| 3   | ggplot2 (\>= 3.3.5)      | Imports |
| 4   | glmnet                   | Imports |
| 5   | gridExtra (\>= 2.3)      | Imports |
| 6   | hrbrthemes               | Imports |
| 7   | stats                    | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
         ...
         computing_s_regression     conformal.multidim.full 
                           TRUE                        TRUE 
    conformal.multidim.jackplus   conformal.multidim.msplit 
                           TRUE                        TRUE 
       conformal.multidim.split                elastic.funs 
                           TRUE                        TRUE 
                     lasso.funs                    lm_multi 
                           TRUE                        TRUE 
                     mean_multi               plot_multidim 
                           TRUE                        TRUE 
                     ridge.funs 
                           TRUE 
...
| Execution Time | 2025-02-17 03:44:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62f703243_1739763836
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEA1qqK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conformalInference.multi_v1.1.1-tikzDictionary"
