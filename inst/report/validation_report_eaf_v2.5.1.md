...
| export_help | 29 |
| has_website | TRUE |
| has_maintainer | Manuel López-Ibáñez <manuel.lopez-ibanez@manchester.ac.uk> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/MLopez-Ibanez/eaf |
...
|     | package     | type    |
|:----|:------------|:--------|
| 1   | modeltools  | Imports |
| 2   | graphics    | Imports |
| 3   | grDevices   | Imports |
| 4   | matrixStats | Imports |
| 5   | Rdpack      | Imports |
...
IOHanalyzer, ParamHelpers

## Namespace

Overall the package has 29 exported objects. 29 are documented:

            attsurf2df avg_hausdorff_dist     choose_eafdiff choose_eafdiffplot 
                  TRUE               TRUE               TRUE               TRUE 
               eafdiff        eafdiffplot            eafplot               eafs 
                  TRUE               TRUE               TRUE               TRUE 
      epsilon_additive       epsilon_mult   filter_dominated   hv_contributions 
                  TRUE               TRUE               TRUE               TRUE 
           hypervolume                igd           igd_plus    is_nondominated 
                  TRUE               TRUE               TRUE               TRUE 
       largest_eafdiff          normalise        pareto_rank           pdf_crop 
                  TRUE               TRUE               TRUE               TRUE 
         read_datasets     read.data.sets         symDifPlot     total_whv_rect 
                  TRUE               TRUE               TRUE               TRUE 
              vorobDev             vorobT           whv_hype           whv_rect 
                  TRUE               TRUE               TRUE               TRUE 
        write_datasets 
                  TRUE 
...
| Execution Time | 2025-02-18 05:08:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bb454f55e39_1739855310
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKjOQHy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eaf_v2.5.1-tikzDictionary"
