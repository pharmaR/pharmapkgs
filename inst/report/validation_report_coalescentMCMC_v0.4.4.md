# Validation Report - coalescentMCMC@0.4.4
...
Overall the package has 16 exported objects. 15 are documented:
           ...
           .coalescentMCMCenv            cleanMCMCtrees            coalescentMCMC 
                        FALSE                      TRUE                      TRUE 
                        dcoal              dcoal.linear                dcoal.step 
                         TRUE                      TRUE                      TRUE 
                   dcoal.time               dcoal.time2               getLastTree 
                         TRUE                      TRUE                      TRUE 
                 getMCMCstats              getMCMCtrees NeighborhoodRearrangement 
                         TRUE                      TRUE                      TRUE 
                    plotTHETA          proba.coalescent             saveMCMCtrees 
                         TRUE                      TRUE                      TRUE 
               sim.coalescent 
                         TRUE 
...
| Execution Time | 2025-02-16 04:48:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bc347437363_1739681297
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcDFy82
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coalescentMCMC_v0.4.4-tikzDictionary"
