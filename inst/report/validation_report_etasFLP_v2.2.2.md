# Validation Report - etasFLP@2.2.2
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Marcello Chiodi <marcello.chiodi@unipa.it>           |
...
Overall the package has 17 exported objects. 17 are documented:
                 ...
                 b.guten              bwd.nrd    compare.etasclass 
                    TRUE                 TRUE                 TRUE 
         daily.etasclass                eqcat        etas.starting 
                    TRUE                 TRUE                 TRUE 
               etasclass       kde2d.integral     kde2dnew.fortran 
                    TRUE                 TRUE                 TRUE 
               magn.plot             MLA.freq        simpson.coeff 
                    TRUE                 TRUE                 TRUE 
              simpson.kD            time2date   timecharunique2seq 
                    TRUE                 TRUE                 TRUE 
    timeupdate.etasclass              xy.grid 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:33:53 UTC |
...
running this report
    ...
    PROCESSX_PS1d455208212f_1739939626
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfcuWwa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_etasFLP_v2.2.2-tikzDictionary"
