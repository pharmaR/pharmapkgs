# Validation Report - epiparameter@0.4.1
...
| export_help          | 30                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Joshua W. Lambert <joshua.lambert@lshtm.ac.uk>  |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/epiverse-trace/epiparameter/ |
...
| 3   | cli            | Imports |
| 4   | distcrete      | Imports |
| 5   | distributional | Imports |
| 6   | epiparameterDB | Imports |
| 7   | graphics       | Imports |
| 8   | lifecycle      | Imports |
| 9   | pillar         | Imports |
| 10  | rlang          | Imports |
...
simulist, superspreading

## Namespace

Overall the package has 30 exported objects. 30 are documented:

                    as_epiparameter             assert_epiparameter 
                               TRUE                            TRUE 
            calc_disc_dist_quantile                             cdf 
                               TRUE                            TRUE 
    convert_params_to_summary_stats convert_summary_stats_to_params 
                               TRUE                            TRUE 
                    create_citation                 create_metadata 
                               TRUE                            TRUE 
               create_method_assess        create_prob_distribution 
                               TRUE                            TRUE 
                      create_region            create_summary_stats 
                               TRUE                            TRUE 
                 create_uncertainty                      discretise 
                               TRUE                            TRUE 
                         discretize                      epidist_db 
                               TRUE                            TRUE 
                       epiparameter                 epiparameter_db 
                               TRUE                            TRUE 
                      extract_param                        generate 
                               TRUE                            TRUE 
                       get_citation                  get_parameters 
                               TRUE                            TRUE 
                      is_continuous                 is_epiparameter 
                               TRUE                            TRUE 
             is_epiparameter_params                is_parameterised 
                               TRUE                            TRUE 
                   is_parameterized                    is_truncated 
                               TRUE                            TRUE 
                      parameter_tbl               test_epiparameter 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-19 04:18:20 UTC |
...
running this report
    ...
    PROCESSX_PS1d4523445f2a_1739938694
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4KgVIl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epiparameter_v0.4.1-tikzDictionary"
