# Validation Report - earthtide@0.1.7
...
| export_help          | 4                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Jonathan Kennel <jkennel@uoguelph.ca> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/jkennel/earthtide  |
...
| 2   | R6 (\>= 2.3.0)   | Imports   |
| 3   | RcppThread       | Imports   |
| 4   | Rcpp (\>= 1.0.0) | LinkingTo |
| 5   | RcppThread       | LinkingTo |
...
Overall the package has 4 exported objects. 4 are documented:
        ...
        calc_earthtide          Earthtide           get_iers get_main_frequency 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 05:09:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4350cbcea_1739855372
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpswZEtO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_earthtide_v0.1.7-tikzDictionary"
