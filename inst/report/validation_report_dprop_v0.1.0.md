...
Overall the package has 29 exported objects. 29 are documented:
        ...
        d_beta     d_bexp       d_bs     d_burr     d_chen      d_chi       d_EE 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
          d_EW      d_exp        d_F      d_fre    d_gamma d_gompertz   d_gumbel 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
       d_ingam    d_kburr     d_kexp      d_kum  d_kumnorm      d_lap  d_lnormal 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
       d_logis      d_lom     d_naka       d_nh   d_normal     d_rayl       d_st 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
         d_wei 
          TRUE 
...
| Execution Time | 2025-02-18 04:41:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4425f41d7_1739853680
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3n1awL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dprop_v0.1.0-tikzDictionary"
