# Validation Report - chipPCR@1.0.2
...
| export_help          | 23                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Stefan Roediger <stefan.roediger@b-tu.de> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/PCRuniversum/chipPCR   |
...
MBmca, RDML, shinyMolBio

## Namespace

Overall the package has 18 exported objects. 18 are documented:

           AmpSim    AmpSim.gui     amptester amptester.gui        bg.max 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              CPP       effcalc         fixNA    humanrater         inder 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         lm.coefs       MFIaggr   MFIaggr.gui    normalizer    plotCurves 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          rounder      smoother        th.cyc 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-16 04:13:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bc358076c75_1739679226
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNXZulC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chipPCR_v1.0.2-tikzDictionary"
