...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Manjari Das <manjari8d@gmail.com>                    |
...
Overall the package has 14 exported objects. 14 are documented:
            ...
            informat           plotci          popsize     popsize_cond 
                TRUE             TRUE             TRUE             TRUE 
       popsize_simul         qhat_gam       qhat_logit      qhat_mlogit 
                TRUE             TRUE             TRUE             TRUE 
         qhat_ranger qhat_rangerlogit          qhat_sl         reformat 
                TRUE             TRUE             TRUE             TRUE 
           simuldata             tmle 
                TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:47:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45d04cfe3_1739854070
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvjVnVh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drpop_v0.0.3-tikzDictionary"
