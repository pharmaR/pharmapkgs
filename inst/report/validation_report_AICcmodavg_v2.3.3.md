...
Overall the package has 52 exported objects. 52 are documented:
                   ...
                   formulaShort                       ictab 
                    ...
                    mb.gof.test                      modavg 
                           TRUE                        TRUE 
                   modavgCustom                modavgEffect 
                           TRUE                        TRUE 
                       modavgIC                  modavgPred 
                           TRUE                        TRUE 
                   modavgShrink                    multComp 
                           TRUE                        TRUE 
                     Nmix.chisq               Nmix.gof.test 
                           TRUE                        TRUE 
                      predictSE               predictSE.gls 
                           TRUE                        TRUE 
                  predictSE.lme               predictSE.mer 
                           TRUE                        TRUE 
               predictSE.merMod    predictSE.unmarkedFitPCO 
                           TRUE                        TRUE 
    predictSE.unmarkedFitPCount             reverse.exclude 
                           TRUE                        TRUE 
                   reverse.parm                   summaryOD 
                           TRUE                        TRUE 
                         useBIC                useBICCustom 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-14 06:44:53 UTC |
...
running this report
    ...
    PROCESSX_PS726d641da68e_1739515490
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQIhtni
