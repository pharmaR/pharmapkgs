...
| export_help          | 13                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Alex Bhattacharya <alex.bhatt@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/alexbhatt/epidm       |
...
Overall the package has 13 exported objects. 13 are documented:
             ...
             cip_spells        csv_from_zip          group_time     inpatient_codes 
                   TRUE                TRUE                TRUE                TRUE 
          lookup_recode proxy_episode_dates  respeciate_generic           sql_clean 
                   TRUE                TRUE                TRUE                TRUE 
            sql_connect            sql_read           sql_write       uk_patient_id 
                   TRUE                TRUE                TRUE                TRUE 
              valid_nhs 
                   TRUE 
...
| Execution Time | 2025-02-19 04:16:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d456de370a7_1739938555
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbGnNVN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epidm_v1.0.4-tikzDictionary"
