# Validation Report - CGPfunctions@0.6.3
...
| export_help          | 10                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Chuck Powell <ibecav@gmail.com>        |
| bugs_status          | 0.7666667                              |
| has_source_control   | https://github.com/ibecav/CGPfunctions |
...
| 2   | DescTools (\>= 0.99.32) | Imports |
| 3   | dplyr                   | Imports |
| 4   | forcats                 | Imports |
| 5   | ggmosaic                | Imports |
| 6   | ggplot2 (\>= 3.3.0)     | Imports |
| 7   | ggrepel                 | Imports |
| 8   | methods                 | Imports |
| 9   | paletteer               | Imports |
| 10  | partykit                | Imports |
| 11  | purrr                   | Imports |
| 12  | rlang                   | Imports |
| 13  | scales (\>= 1.1.0)      | Imports |
| 14  | sjstats (\>= 0.17.9)    | Imports |
| 15  | stats                   | Imports |
| 16  | stringr                 | Imports |
| 17  | tidyr                   | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
              ...
              aovtype2        chaid_table cross2_var_vectors               Mode 
                  TRUE               TRUE               TRUE               TRUE 
       newggslopegraph            OurConf      Plot2WayANOVA          PlotXTabs 
                  TRUE               TRUE               TRUE               TRUE 
            PlotXTabs2            SeeDist 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:06:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bc354ac8408_1739678794
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyoZtg8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CGPfunctions_v0.6.3-tikzDictionary"
