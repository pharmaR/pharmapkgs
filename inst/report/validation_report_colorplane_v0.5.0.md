# Validation Report - colorplane@0.5.0
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Bradley R Buchsbaum <brad.buchsbaum@gmail.com>       |
...
Overall the package has 12 exported objects. 17 are documented:

          alpha_channel           as_hexcol              as_rgb        blend_colors 
                   TRUE                TRUE                TRUE                TRUE 
                col2hex  ConstantColorPlane  DiscreteColorPlane           get_color 
                   TRUE                TRUE                TRUE                TRUE 
          HexColorPlane IntensityColorPlane          map_colors       RGBColorPlane 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 05:00:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bc330e84379_1739682000
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpadOOnY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colorplane_v0.5.0-tikzDictionary"
