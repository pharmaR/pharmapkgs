# Validation Report - bestridge@1.0.7
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Liyuan Hu <huly5@mail2.sysu.edu.cn>                  |
...
Overall the package has 7 exported objects. 7 are documented:
            ...
            bsrr     gen.data  logLik.bsrr    plot.bsrr predict.bsrr   print.bsrr 
...
There are 9 help pages with examples, from 15 (60.00 %).
...
| Execution Time | 2025-02-15 03:54:51 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdca286b8_1739591687
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpg9XHPK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bestridge_v1.0.7-tikzDictionary"
