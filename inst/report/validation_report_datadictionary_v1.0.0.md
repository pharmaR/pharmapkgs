# Validation Report - datadictionary@1.0.0
...
| export_help          | 2                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Bethany Jones <r.data.nerd@gmail.com>                |
...
Overall the package has 2 exported objects. 2 are documented:
     ...
     create_dictionary summarise_variable 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:57:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6137ff1aa_1739768229
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0jQyNs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datadictionary_v1.0.0-tikzDictionary"
