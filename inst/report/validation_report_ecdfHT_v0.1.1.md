# Validation Report - ecdfHT@0.1.1
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | John P Nolan <jpnolan@american.edu>                  |
...
Overall the package has 16 exported objects. 16 are documented:
                      ...
                      decdfHT                    ecdfHT                 ecdfHT.2d 
                         TRUE                      TRUE                      TRUE 
               ecdfHT.2d.axes               ecdfHT.axes               ecdfHT.draw 
                         TRUE                      TRUE                      TRUE 
                   ecdfHT.fit          ecdfHT.fit.tails                  ecdfHT.g 
                         TRUE                      TRUE                      TRUE 
                     ecdfHT.h           ecdfHT.multivar ecdfHT.multivar.transform 
                         TRUE                      TRUE                      TRUE 
                      lp.norm                   pecdfHT                   qecdfHT 
                         TRUE                      TRUE                      TRUE 
                      recdfHT 
                         TRUE 
...
| Execution Time | 2025-02-18 05:17:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47d65a5c_1739855850
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpI3Tpqo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecdfHT_v0.1.1-tikzDictionary"
