# Validation Report - evtclass@1.0
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Edoardo Vignotto <edoardo.vignotto@unige.ch>         |
...
Overall the package has 4 exported objects. 4 are documented:
     ...
     gevcTest gevcTrain  gpdcTest gpdcTrain 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-19 04:44:24 UTC |
...
running this report
    ...
    PROCESSX_PS1d456fc0fa65_1739940258
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQpD8eR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evtclass_v1.0-tikzDictionary"
