# Validation Report - bayclumpr@0.1.0
...
| export_help          | 11                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Cristian Roman Palacios <cromanpa94@arizona.edu> |
...
Overall the package has 11 exported objects. 11 are documented:
    ...
    cal.bayesian       cal.ci  cal.dataset   cal.deming      cal.ols    cal.prior 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        cal.wols     cal.york rec.bayesian  rec.clumped    rec.prior 
...
| Execution Time | 2025-02-15 03:30:59 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3d8ae750_1739590254
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYmh0TS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayclumpr_v0.1.0-tikzDictionary"
