# Validation Report - BayesDesign@0.1.1
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Chia-Wei Hsu <Chia-Wei.Hsu@stjude.org>               |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    optimal_OneStage optimal_TwoStage         tot_time 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 03:33:31 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd78910174_1739590407
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBBhY5O
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesDesign_v0.1.1-tikzDictionary"
