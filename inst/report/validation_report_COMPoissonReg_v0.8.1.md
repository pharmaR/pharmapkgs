# Validation Report - COMPoissonReg@0.8.1
...
| export_help          | 35                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Andrew Raim <andrew.raim@gmail.com>                  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/lotze/COMPoissonReg               |
...
DGLMExtPois, GENESIS, miRecSurv, MLE
...
Overall the package has 35 exported objects. 35 are documented:
                    ...
                    dcmp               dzicmp                 dzip 
                    TRUE                 TRUE                 TRUE 
                    ecmp             equitest               ezicmp 
                    TRUE                 TRUE                 TRUE 
                    ezip          get.control            get.fixed 
                    TRUE                 TRUE                 TRUE 
                get.init        get.init.zero      get.modelmatrix 
                    TRUE                 TRUE                 TRUE 
              get.offset      get.offset.zero              glm.cmp 
                    TRUE                 TRUE                 TRUE 
             glm.cmp.raw        glm.zicmp.raw             leverage 
                    TRUE                 TRUE                 TRUE 
                    ncmp                   nu parametric.bootstrap 
                    TRUE                 TRUE                 TRUE 
                    pcmp               pzicmp                 pzip 
                    TRUE                 TRUE                 TRUE 
                    qcmp               qzicmp                 qzip 
...
| Execution Time | 2025-02-17 03:36:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6221a44d9_1739763411
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnV8rEo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_COMPoissonReg_v0.8.1-tikzDictionary"
