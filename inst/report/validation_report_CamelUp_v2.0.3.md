# Validation Report - CamelUp@2.0.3
...
| export_help | 10 |
| has_website | FALSE |
| has_maintainer | Michael Czekanski <middleburystatspackages@gmail.com> |
| bugs_status | subscript out of bounds |
| has_bug_reports_url | 1 |
| downloads_1yr | 3468 |
| reverse_dependencies | 0 |
| has_examples | 0.3846154 |
| dependencies | 8 |
| license | GPL-3 |
...
Overall the package has 10 exported objects. 10 are documented:
                 ...
                 Board              Camel                Die               Game 
                  TRUE               TRUE               TRUE               TRUE 
                LegBet        playCamelUp             Player simulateMoveNTimes 
                  TRUE               TRUE               TRUE               TRUE 
             Simulator              Space 
                  TRUE               TRUE 
...
There are 5 help pages with examples, from 13 (38.46 %).
...
| Execution Time | 2025-02-16 03:36:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bc366bbab1_1739676985
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbBJheM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CamelUp_v2.0.3-tikzDictionary"
