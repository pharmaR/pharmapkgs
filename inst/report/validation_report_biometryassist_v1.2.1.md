# Validation Report - biometryassist@1.2.1
...
| export_help          | 12                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Sam Rogers <biometrytraining@adelaide.edu.au> |
...
Overall the package has 12 exported objects. 12 are documented:
                ...
                autoplot             des_info               design 
                    TRUE                 TRUE                 TRUE 
                heat_map       install_asreml            logl_test 
                    TRUE                 TRUE                 TRUE 
    multiple_comparisons              resplot               resplt 
                    TRUE                 TRUE                 TRUE 
           summary_graph        update_asreml            variogram 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:13:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2fc06a7_1739592817
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpccc43u
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biometryassist_v1.2.1-tikzDictionary"
