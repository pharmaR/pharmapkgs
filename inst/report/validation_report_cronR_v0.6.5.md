...
| has_source_control   | https://github.com/bnosac/cronR                      |
...
Overall the package has 9 exported objects. 9 are documented:
             ...
             cron_add        cron_clear         cron_load           cron_ls 
                 TRUE              TRUE              TRUE              TRUE 
           cron_njobs           cron_rm      cron_rscript cron_rstudioaddin 
                 TRUE              TRUE              TRUE              TRUE 
            cron_save 
                 TRUE 
...
| Execution Time | 2025-02-17 04:22:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bd642a51931_1739766138
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxmeAnc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cronR_v0.6.5-tikzDictionary"
