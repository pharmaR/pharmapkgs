# Validation Report - chem16S@1.2.0
...
| has_source_control   | https://github.com/jedick/chem16S                    |
...
Overall the package has 11 exported objects. 11 are documented:
              ...
              chemlab      get_metadata get_metric_byrank       get_metrics 
                 TRUE              TRUE              TRUE              TRUE 
             map_taxa      plot_metrics   plot_ps_metrics  plot_ps_metrics2 
                 TRUE              TRUE              TRUE              TRUE 
           ps_metrics     ps_taxacounts          read_RDP 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:11:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32078edf1_1739679065
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIQNJgC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chem16S_v1.2.0-tikzDictionary"
