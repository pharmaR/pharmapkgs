# Validation Report - CACIMAR@1.0.0
...
| export_help          | 9                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Junyao Jiang <jiangjunyao789@163.com>   |
| bugs_status          | 0                                       |
| has_source_control   | https://github.com/jiang-junyao/CACIMAR |
...
Overall the package has 9 exported objects. 9 are documented:
                   ...
                   CACIMAR_cols         Format_Markers_Frac 
                           TRUE                        TRUE 
                    Heatmap_Cor           Identify_CellType 
                           TRUE                        TRUE 
    Identify_ConservedCellTypes   Identify_ConservedMarkers 
                           TRUE                        TRUE 
     Identify_ConservedNetworks            Identify_Markers 
                           TRUE                        TRUE 
            Plot_MarkersHeatmap 
                           TRUE 
...
| Execution Time | 2025-02-16 03:32:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bc366bb1196_1739676759
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1L19RL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CACIMAR_v1.0.0-tikzDictionary"
