# Validation Report - bisque@1.0.2
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Joshua Hewitt <joshua.hewitt@duke.edu>               |
...
| 3   | foreach                   | Imports   |
| 4   | itertools                 | Imports   |
| 5   | Rcpp (\>= 0.12.4)         | LinkingTo |
| 6   | RcppArmadillo             | LinkingTo |
| 7   | RcppEigen (\>= 0.3.3.3.1) | LinkingTo |
...
Overall the package has 15 exported objects. 15 are documented:
    ...
    createLocScaleGrid               dmix               emix                itx 
                  TRUE               TRUE               TRUE               TRUE 
               jac.exp       jac.invlogit            jac.log          jac.logit 
                  TRUE               TRUE               TRUE               TRUE 
              kCompute             logjac               sFit              sKrig 
                  TRUE               TRUE               TRUE               TRUE 
                    tx             wBuild               wMix 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:18:06 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd74abae41_1739593081
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoHd9fl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bisque_v1.0.2-tikzDictionary"
