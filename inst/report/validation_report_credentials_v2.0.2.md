# Validation Report - credentials@2.0.2
...
Overall the package has 17 exported objects. 17 are documented:
        ...
        credential_approve        credential_fill  credential_helper_get 
                      TRUE                   TRUE                   TRUE 
    credential_helper_list  credential_helper_set      credential_reject 
                      TRUE                   TRUE                   TRUE 
        git_credential_ask  git_credential_forget  git_credential_update 
                      TRUE                   TRUE                   TRUE 
            set_github_pat          ssh_agent_add               ssh_home 
                      TRUE                   TRUE                   TRUE 
              ssh_key_info             ssh_keygen           ssh_read_key 
                      TRUE                   TRUE                   TRUE 
          ssh_setup_github  ssh_update_passphrase 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-17 04:18:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6c6a9d86_1739765932
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6YpZIi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_credentials_v2.0.2-tikzDictionary"
