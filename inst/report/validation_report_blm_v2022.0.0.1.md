# Validation Report - blm@2022.0.0.1
...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | S.Kovalchik <s.a.kovalchik@gmail.com>                |
...
Overall the package has 12 exported objects. 13 are documented:
                   ...
                   blm         crude.risk                 EO              expit 
                  TRUE               TRUE               TRUE               TRUE 
                   gof        gof.pearson             lexpit              logit 
                  TRUE               TRUE               TRUE               TRUE 
                   LRT risk.exposure.plot           Rsquared  which.at.boundary 
                  TRUE               TRUE               TRUE               TRUE 

### Examples

There are 17 help pages with examples, from 25 (68.00 %).
...
| Execution Time | 2025-02-15 04:22:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd29453db0_1739593352
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpX7Zfda
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blm_v2022.0.0.1-tikzDictionary"
