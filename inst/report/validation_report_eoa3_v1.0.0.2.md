# Validation Report - eoa3@1.0.0.2
...
Overall the package has 13 exported objects. 13 are documented:
    ...
    calcMstar   est_cp0    est_g0   est_pk0     fmmax  fmmax.ab     getab       MCI 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
     MpriorOK     postM  postM.ab   sim_cp0   sim_pk0 
...
| Execution Time | 2025-02-19 04:13:08 UTC |
...
running this report
    ...
    PROCESSX_PS1d45580de313_1739938382
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpopMal1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eoa3_v1.0.0.2-tikzDictionary"
