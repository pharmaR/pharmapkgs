...
| export_help | 4 |
| has_website | FALSE |
| has_maintainer | Alessio Petrozziello <alessio.petrozziello@port.ac.uk> |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    OSelm_train.formula      OSelm_training         predict_elm          preProcess 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 03:57:31 UTC |
...
running this report
    ...
    PROCESSX_PS1d455afaead6_1739937445
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmphdws85
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ELMR_v1.0-tikzDictionary"
