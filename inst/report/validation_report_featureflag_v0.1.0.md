# Validation Report - featureflag@0.1.0
...
| export_help          | 5                                                 |
| has_website          | TRUE                                              |
| has_maintainer       | Ryszard Szymański <ryszard.szymanski@outlook.com> |
| bugs_status          | 0.9655172                                         |
| has_source_control   | https://github.com/szymanskir/featureflag         |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    create_bool_feature_flag      create_feature_flag               feature_if 
                        TRUE                     TRUE                     TRUE 
              feature_ifelse               is_enabled 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-27 03:24:55 UTC |
...
running this report
    ...
    PROCESSX_PS1c623ae9b0a6_1740626691
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHZmaTx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_featureflag_v0.1.0-tikzDictionary"
