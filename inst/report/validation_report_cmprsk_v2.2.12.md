# Validation Report - cmprsk@2.2.12
...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Bob Gray <gray@jimmy.harvard.edu>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 203759                                               |
| reverse_dependencies | 35                                                   |
| has_examples         | 1                                                    |
| dependencies         | 1                                                    |
| license              | GPL (\>= 2)                                          |
...
Overall the package has 35 reverse dependencies:

adjustedCurves, APtools, autoReg, broom, broom.helpers, CohortSurvival,
cohorttools, crrstep, currentSurvival, Cyclops, DynForest, Epi,
FamEvent, fastcmprsk, finalfit, frailtyHL, gcerisk, GFGM.copula,
ggscidca, Greg, gtsummary, jskm, mets, missDeaths, mstate, PBIR, pec,
QHScrnomo, RcmdrPlugin.EZR, reportRmd, riskRegression, rmdl, survminer,
survout, tidycmprsk
...
Overall the package has 11 exported objects. 11 are documented:
             ...
             [.cuminc               crr            cuminc       plot.cuminc 
                 TRUE              TRUE              TRUE              TRUE 
     plot.predict.crr       predict.crr         print.crr      print.cuminc 
                 TRUE              TRUE              TRUE              TRUE 
    print.summary.crr       summary.crr        timepoints 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:45:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bc339914f65_1739681118
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVef3yy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmprsk_v2.2.12-tikzDictionary"
