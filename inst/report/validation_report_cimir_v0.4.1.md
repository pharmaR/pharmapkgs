...
| export_help          | 20                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Michael Koohafkan <michael.koohafkan@gmail.com> |
| bugs_status          | 1                                               |
| has_source_control   | https://github.com/mkoohafkan/cimir             |
...
| 1   | curl (\>= 4.3)     | Imports |
| 2   | glue (\>= 1.3)     | Imports |
| 3   | stringr (\>= 1.4)  | Imports |
| 4   | dplyr (\>= 0.8)    | Imports |
| 5   | tidyr (\>= 1.0)    | Imports |
| 6   | jsonlite (\>= 1.6) | Imports |
| 7   | purrr (\>= 0.3)    | Imports |
| 8   | rlang (\>= 0.4)    | Imports |
...
Overall the package has 20 exported objects. 20 are documented:
       ...
       cimis_compass_to_degrees                  cimis_data 
                           TRUE                        TRUE 
       cimis_degrees_to_compass                 cimis_flags 
                           TRUE                        TRUE 
          cimis_format_location                 cimis_items 
                           TRUE                        TRUE 
          cimis_spatial_zipcode           cimis_split_query 
                           TRUE                        TRUE 
                  cimis_station           cimis_to_datetime 
                           TRUE                        TRUE 
                  cimis_zipcode                  data_items 
                           TRUE                        TRUE 
                       get_data                 get_station 
                           TRUE                        TRUE 
    get_station_spatial_zipcode         get_station_zipcode 
                           TRUE                        TRUE 
                     is_key_set                  remove_key 
                           TRUE                        TRUE 
                        set_key                 to_datetime 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-23 03:21:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d2564b36226_1740280888
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1Gr7Aw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cimir_v0.4.1-tikzDictionary"
