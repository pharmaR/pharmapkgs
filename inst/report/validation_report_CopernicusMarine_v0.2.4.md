# Validation Report - CopernicusMarine@0.2.4
...
| has_source_control   | https://github.com/pepijn-devries/CopernicusMarine |
...
Overall the package has 13 exported objects. 13 are documented:
              ...
              addCmsWMTSTiles          cms_cite_product         cms_download_stac 
                         TRUE                      TRUE                      TRUE 
          cms_download_subset       cms_list_stac_files                 cms_login 
                         TRUE                      TRUE                      TRUE 
          cms_product_details      cms_product_metadata      cms_product_services 
                         TRUE                      TRUE                      TRUE 
            cms_products_list       cms_stac_properties          cms_wmts_details 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-17 03:54:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bd615ecd6ce_1739764435
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3DXWVV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CopernicusMarine_v0.2.4-tikzDictionary"
