# Validation Report - extBatchMarking@1.1.0
...
| export_help          | 4                                                |
| has_website          | TRUE                                             |
| has_maintainer       | Kehinde Olobatuyi <olobatuyikenny@uvic.ca>       |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/Olobatuyi/extBatchMarking_cov |
...
Overall the package has 4 exported objects. 4 are documented:
          ...
          batchMarkHmmLL       batchMarkOptim batchMarkUnmarkHmmLL 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:55:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d45399ebac9_1739940903
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppTuI1y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extBatchMarking_v1.1.0-tikzDictionary"
