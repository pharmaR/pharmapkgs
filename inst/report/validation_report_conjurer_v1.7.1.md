# Validation Report - conjurer@1.7.1
...
| export_help          | 11                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Sidharth Macherla <msidharthrasik@gmail.com> |
...
Overall the package has 11 exported objects. 11 are documented:
         ...
         buildCust buildHierarchy        buildId buildModelData     buildNames 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          buildNum    buildPareto   buildPattern      buildProd      extractDf 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          genTrans 
              TRUE 
...
| Execution Time | 2025-02-17 03:45:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64f78c651_1739763923
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDyAgte
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conjurer_v1.7.1-tikzDictionary"
