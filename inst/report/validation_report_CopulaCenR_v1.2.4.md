# Validation Report - CopulaCenR@1.2.4
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tao Sun <sun.tao@ruc.edu.cn>                         |
...
Overall the package has 12 exported objects. 12 are documented:
              ...
              data_sim_copula             ic_par_copula ic_scmprisk_spTran_copula 
                         TRUE                      TRUE                      TRUE 
             ic_spTran_copula                    IRsurv                lrt_copula 
                         TRUE                      TRUE                      TRUE 
                rc_par_copula           rc_scmprisk_Cox rc_scmprisk_sp_copula_pen 
                         TRUE                      TRUE                      TRUE 
              rc_spCox_copula              score_copula                tau_copula 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-17 03:55:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64b1bb98e_1739764500
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYTU0Nv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CopulaCenR_v1.2.4-tikzDictionary"
