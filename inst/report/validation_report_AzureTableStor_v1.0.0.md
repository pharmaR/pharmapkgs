...
| size_codebase                   | 441                                     |
| has_source_control              | https://github.com/Azure/AzureTableStor |
...
Overall the package has 15 exported objects. 15 are documented:
         ...
         call_table_endpoint create_batch_transaction     create_storage_table 
                        TRUE                     TRUE                     TRUE 
      create_table_operation     delete_storage_table      delete_table_entity 
                        TRUE                     TRUE                     TRUE 
        do_batch_transaction         get_table_entity    import_table_entities 
                        TRUE                     TRUE                     TRUE 
         insert_table_entity      list_storage_tables      list_table_entities 
                        TRUE                     TRUE                     TRUE 
               storage_table           table_endpoint      update_table_entity 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-14 07:38:13 UTC |
...
running this report
    ...
    PROCESSX_PS1c096c5c0aac_1739518690
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBCFIpb
