...
| export_help          | 20                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Sebastien Plutniak <sebastien.plutniak@posteo.net> |
| bugs_status          | subscript out of bounds                            |
| size_codebase        | 1070                                               |
| has_source_control   | https://github.com/sebastien-plutniak/archeofrag   |
...
Overall the package has 20 exported objects. 20 are documented:
                 ...
                 frag.cycles           frag.diameters     frag.edges.weighting 
                        TRUE                     TRUE                     TRUE 
             frag.get.layers     frag.get.layers.pair      frag.get.parameters 
                        TRUE                     TRUE                     TRUE 
             frag.graph.plot        frag.graph.reduce    frag.layers.admixture 
                        TRUE                     TRUE                     TRUE 
        frag.layers.cohesion    frag.observer.failure        frag.path.lengths 
                        TRUE                     TRUE                     TRUE 
    frag.relations.by.layers       frag.simul.compare       frag.simul.process 
                        TRUE                     TRUE                     TRUE 
        frag.simul.summarise            make_cr_graph          make_crsr_graph 
                        TRUE                     TRUE                     TRUE 
            make_frag_object            make_sr_graph 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-14 07:21:17 UTC |
...
running this report
    ...
    PROCESSX_PS1c093e7979b4_1739517674
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphIcr7E
