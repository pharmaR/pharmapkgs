# Validation Report - cassowaryr@2.0.2
...
| export_help          | 24                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Harriet Mason <harriet.m.mason@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/numbats/cassowaryr     |
| has_bug_reports_url  | 1                                         |
| downloads_1yr        | 3388                                      |
| reverse_dependencies | 2                                         |
| has_examples         | 0.8275862                                 |
| dependencies         | 12                                        |
| license              | GPL-3                                     |
...
|:----|:--------------------|:--------|
| 1   | igraph              | Imports |
| 2   | alphahull (\>= 2.5) | Imports |
| 3   | splancs             | Imports |
| 4   | interp (\>= 1.1-6)  | Imports |
| 5   | energy              | Imports |
| 6   | dplyr               | Imports |
| 7   | ggplot2             | Imports |
| 8   | magrittr            | Imports |
...
Overall the package has 24 exported objects. 24 are documented:
         ...
         calc_scags calc_scags_wide  draw_alphahull draw_convexhull        draw_mst 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          sc_clumpy     sc_clumpy_r      sc_clumpy2       sc_convex         sc_dcor 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       sc_monotonic     sc_outlying       sc_skewed       sc_skinny       sc_sparse 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         sc_sparse2      sc_splines     sc_striated    sc_striated2      sc_stringy 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         sc_striped           scree       top_pairs       top_scags 
               TRUE            TRUE            TRUE            TRUE 

### Examples

There are 24 help pages with examples, from 29 (82.76 %).
...
| Execution Time | 2025-02-16 03:45:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bc320055ff5_1739677521
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplXG1cu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cassowaryr_v2.0.2-tikzDictionary"
