# Validation Report - bumblebee@0.1.0
...
| export_help          | 7                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Lerato E Magosi <magosil86@gmail.com> |
...
| 2   | gtools (\>= 3.8.2)   | Imports |
| 3   | Hmisc (\>= 4.4-2)    | Imports |
| 4   | magrittr (\>= 2.0.1) | Imports |
| 5   | rmarkdown (\>= 2.6)  | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
                            ...
                            estimate_c_hat                   estimate_multinom_ci 
                                      TRUE                                   TRUE 
                            estimate_p_hat estimate_prob_group_pairing_and_linked 
                                      TRUE                                   TRUE 
                        estimate_theta_hat     estimate_transmission_flows_and_ci 
                                      TRUE                                   TRUE 
                                prep_p_hat 
                                      TRUE 
...
| Execution Time | 2025-02-15 04:55:01 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4adca636_1739595296
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeDLBwl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bumblebee_v0.1.0-tikzDictionary"
