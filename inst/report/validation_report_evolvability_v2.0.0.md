# Validation Report - evolvability@2.0.0
...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Geir H. Bolstad <geir.bolstad@nina.no>               |
...
Overall the package has 21 exported objects. 21 are documented:
                    ...
                    Almer            Almer_boot              Almer_SE 
                     TRUE                  TRUE                  TRUE 
                Almer_sim          conditionalG      evolvabilityBeta 
                     TRUE                  TRUE                  TRUE 
     evolvabilityBetaMCMC evolvabilityBetaMCMC2     evolvabilityMeans 
                     TRUE                  TRUE                  TRUE 
    evolvabilityMeansMCMC                   GLS            macro_pred 
                     TRUE                  TRUE                  TRUE 
                 meanStdG          meanStdGMCMC                 phylH 
                     TRUE                  TRUE                  TRUE 
               randomBeta              rate_gls         rate_gls_boot 
                     TRUE                  TRUE                  TRUE 
             rate_gls_sim      round_and_format         simulate_rate 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-19 04:43:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d4585ce55a_1739940188
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZNd0nw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evolvability_v2.0.0-tikzDictionary"
