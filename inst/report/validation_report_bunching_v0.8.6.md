# Validation Report - bunching@0.8.6
...
| export_help          | 12                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Panos Mavrokonstantis <mavpanos@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/mavpanos/bunching       |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | BB (\>= 2014.10-1)  | Depends |
| 2   | dplyr (\>= 0.8.1)   | Depends |
| 3   | ggplot2 (\>= 3.1.1) | Depends |
| 4   | stats               | Depends |
| 5   | tidyr (\>= 0.8.2)   | Depends |
...
Overall the package has 12 exported objects. 12 are documented:
             ...
             bin_data           bunchit      do_bootstrap     do_correction 
                 TRUE              TRUE              TRUE              TRUE 
            domregion        elasticity      fit_bunching  marginal_buncher 
                 TRUE              TRUE              TRUE              TRUE 
       notch_equation     plot_bunching         plot_hist prep_data_for_fit 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:55:07 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd361d70a5_1739595302
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2BUIv3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bunching_v0.8.6-tikzDictionary"
