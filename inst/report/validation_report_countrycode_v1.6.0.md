# Validation Report - countrycode@1.6.0
...
| export_help | 4 |
| has_website | TRUE |
| has_maintainer | Vincent Arel-Bundock <vincent.arel-bundock@umontreal.ca> |
| bugs_status | subscript out of bounds |
| has_bug_reports_url | 1 |
| downloads_1yr | 1548029 |
...
auk, BeeBDC, clinDataReview, cmsafvis, contactdata, CoordinateCleaner,
cranly, ctrdata, echarts4r, epiCleanr, eurostat, faers, fishRman,
giscoR, GSODR, idbr, igoR, mapSpain, marginaleffects,
MazamaSpatialUtils, migest, overviewR, peacesciencer, photon, PolarCAP,
psData, regions, ripc, rwunderground, socialmixr, subincomeR,
tabularmaps, TimeVizPro, troopdata, unvotes, wcde, wdpar, weed, widyr,
WorldMapR, xSub
...
Overall the package has 4 exported objects. 4 are documented:
       ...
       countrycode    countryname get_dictionary    guess_field 
              TRUE           TRUE           TRUE           TRUE 

### Examples

There are 5 help pages with examples, from 7 (71.43 %).
...
| Execution Time | 2025-02-17 04:05:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6349bdcff_1739765112
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptLDKDA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_countrycode_v1.6.0-tikzDictionary"
