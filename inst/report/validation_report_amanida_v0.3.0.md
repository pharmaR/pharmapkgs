...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Maria Llambrich <maria.llambrich@urv.cat>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 578                                                  |
| has_source_control   | https://github.com/mariallr/amanida                  |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       amanida_read  amanida_report    amanida_vote     check_names compute_amanida 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       explore_plot     getsampleDB      METAtables    volcano_plot       vote_plot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 06:51:02 UTC |
...
running this report
    ...
    PROCESSX_PS726d7d3d7010_1739515859
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYXegH8
