# Validation Report - BayesERtools@0.2.1
...
| export_help          | 48                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Kenta Yoshida <yoshida.kenta.6@gmail.com>            |
...
| 7   | rlang                 | Imports |
| 8   | rstanarm              | Imports |
| 9   | rstanemax (\>= 0.1.8) | Imports |
| 10  | loo                   | Imports |
| 11  | tidybayes             | Imports |
| 12  | bayestestR            | Imports |
| 13  | posterior             | Imports |
...
Overall the package has 48 exported objects. 48 are documented:
               ...
               .dev_ermod_refmodel           .select_cov_projpred 
                              TRUE                           TRUE 
                   ...
                   as_draws_matrix                 as_draws_rvars 
                              TRUE                           TRUE 
                 build_spec_coveff build_spec_coveff_one_variable 
                              TRUE                           TRUE 
                 calc_ersim_med_qi                  dev_ermod_bin 
                              TRUE                           TRUE 
             dev_ermod_bin_cov_sel             dev_ermod_bin_emax 
                              TRUE                           TRUE 
        dev_ermod_bin_emax_exp_sel          dev_ermod_bin_exp_sel 
                              TRUE                           TRUE 
                    dev_ermod_emax         dev_ermod_emax_exp_sel 
                              TRUE                           TRUE 
                     dev_ermod_lin          dev_ermod_lin_cov_sel 
                              TRUE                           TRUE 
             dev_ermod_lin_exp_sel                     eval_ermod 
                              TRUE                           TRUE 
               extract_coef_exp_ci                   extract_data 
                              TRUE                           TRUE 
              extract_exp_sel_comp     extract_exp_sel_list_model 
                              TRUE                           TRUE 
                       extract_mod                extract_var_cov 
                              TRUE                           TRUE 
              extract_var_exposure               extract_var_resp 
                              TRUE                           TRUE 
              extract_var_selected                            loo 
                              TRUE                           TRUE 
                       p_direction                    plot_coveff 
                              TRUE                           TRUE 
                           plot_er                plot_er_exp_sel 
                              TRUE                           TRUE 
                       plot_er_gof        plot_submod_performance 
                              TRUE                           TRUE 
                  plot_var_ranking                   print_coveff 
                              TRUE                           TRUE 
               replace_spec_coveff                   run_kfold_cv 
                              TRUE                           TRUE 
                        sim_coveff                         sim_er 
                              TRUE                           TRUE 
                      sim_er_curve              sim_er_curve_marg 
                              TRUE                           TRUE 
                    sim_er_new_exp            sim_er_new_exp_marg 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-15 03:34:12 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd672fef68_1739590448
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnYXyeO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesERtools_v0.2.1-tikzDictionary"
