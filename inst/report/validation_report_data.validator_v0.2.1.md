# Validation Report - data.validator@0.2.1
...
| export_help          | 12                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Marcin Dubel <opensource+marcin@appsilon.com> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/Appsilon/data.validator    |
...
|     | package                    | type    |
|:----|:---------------------------|:--------|
| 1   | assertr (\>= 2.8)          | Imports |
| 2   | shiny.semantic (\>= 0.3.3) | Imports |
| 3   | knitr                      | Imports |
| 4   | purrr                      | Imports |
| 5   | dplyr                      | Imports |
| 6   | tidyr                      | Imports |
...
Overall the package has 12 exported objects. 12 are documented:
                  ...
                  add_results    data_validation_report               get_results 
                         TRUE                      TRUE                      TRUE 
         render_raw_report_ui render_semantic_report_ui               save_report 
                         TRUE                      TRUE                      TRUE 
                 save_results              save_summary                  validate 
                         TRUE                      TRUE                      TRUE 
                validate_cols               validate_if             validate_rows 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-17 04:55:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6363507e6_1739768154
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpD66Jb3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_data.validator_v0.2.1-tikzDictionary"
