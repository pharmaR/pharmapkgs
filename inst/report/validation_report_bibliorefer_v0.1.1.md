# Validation Report - bibliorefer@0.1.1
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Márcio Eustáquio <marcioeustaquio@id.uff.br>         |
...
Overall the package has 7 exported objects. 7 are documented:
         ...
         ajust_pagin      auxinf_autr       crit_quant example_database 
                TRUE             TRUE             TRUE             TRUE 
    principal_lister produc_cientific       tabel_gera 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:01:13 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd31ea24e0_1739592069
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3msoKU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bibliorefer_v0.1.1-tikzDictionary"
