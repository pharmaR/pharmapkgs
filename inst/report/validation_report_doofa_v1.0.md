...
Overall the package has 13 exported objects. 13 are documented:
               ...
               bin            coa          cycle      doofa.pwo    gen.design2 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    initial.design            one            pwo         revbin        shuffle 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              swap           vbin        vrevbin 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:34:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44a6e3e9d_1739853251
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpy7xv85
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doofa_v1.0-tikzDictionary"
