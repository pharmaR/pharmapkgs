# Validation Report - biotools@4.2
...
| export_help | 25 |
| has_website | TRUE |
| has_maintainer | Anderson Rodrigo da Silva <anderson.agro@hotmail.com> |
...
micompr, MultivariateAnalysis

## Namespace

Overall the package has 25 exported objects. 24 are documented:

                      aer                  boxM       confusionmatrix 
                     TRUE                  TRUE                  TRUE 
              coph.tocher              cov2pcov          creategroups 
                     TRUE                  TRUE                  TRUE 
                  D2.disc               D2.dist             distClust 
                     TRUE                  TRUE                  TRUE 
            findSubsample           fitplotsize            gencovtest 
                     TRUE                  TRUE                  TRUE 
    germinationcount.test           mantelPower            mantelTest 
                     TRUE                  TRUE                  TRUE 
             multcor.test            mvpaircomp       optimumplotsize 
                     TRUE                  TRUE                  TRUE 
             pathanalysis          raise.matrix            samplesize 
                     TRUE                 FALSE                  TRUE 
                      sHe                 singh           spatialpred 
                     TRUE                  TRUE                  TRUE 
                   tocher 
                     TRUE 
...
| Execution Time | 2025-02-15 04:16:04 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd56624db5_1739592960
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0N4aVU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biotools_v4.2-tikzDictionary"
