# Validation Report - DGEobj@1.1.2
...
Overall the package has 20 exported objects. 20 are documented:
           ...
           addItem       addItems annotateDGEobj       baseType      baseTypes 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     getAttributes    getBaseType        getItem       getItems        getType 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        initDGEobj  initDGEobjDef      inventory        newType    resetDGEobj 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            rmItem  setAttributes showAttributes       showMeta      showTypes 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 03:55:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42edab623_1739850948
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5vVZIX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DGEobj_v1.1.2-tikzDictionary"
