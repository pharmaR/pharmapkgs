# Validation Report - CornerstoneR@2.0.2
...
| export_help          | 10                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Gerrith Djaja <gerrith.djaja@camline.com>        |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://gitlab.com/camLine/CornerstoneR/-/issues |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | checkmate (\>= 1.9.1) | Imports |
| 2   | data.table (\>= 1.10) | Imports |
| 3   | minpack.lm            | Imports |
| 4   | ranger                | Imports |
| 5   | SpatialTools          | Imports |
| 6   | vcd                   | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
             ...
             fitFunction matchNearestNeighbor           mosaicPlot 
                    TRUE                 TRUE                 TRUE 
            randomForest  randomForestPredict      redirectDataset 
                    TRUE                 TRUE                 TRUE 
             reshapeLong     reshapeTranspose          reshapeWide 
                    TRUE                 TRUE                 TRUE 
            showVersions 
                    TRUE 
...
There are 11 help pages with examples, from 14 (78.57 %).
...
| Execution Time | 2025-02-17 03:58:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62fdc38f9_1739764683
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCcP8N5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CornerstoneR_v2.0.2-tikzDictionary"
