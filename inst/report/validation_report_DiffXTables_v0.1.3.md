# Validation Report - DiffXTables@0.1.3
...
Overall the package has 7 exported objects. 7 are documented:
           ...
           cp.chisq.test   heterogeneity.test marginal.change.test 
                    TRUE                 TRUE                 TRUE 
        sharma.song.test simulate_diff_tables        strength.test 
                    TRUE                 TRUE                 TRUE 
           type.analysis 
                    TRUE 
...
| Execution Time | 2025-02-18 04:05:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb433c16126_1739851500
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJ9HImj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiffXTables_v0.1.3-tikzDictionary"
