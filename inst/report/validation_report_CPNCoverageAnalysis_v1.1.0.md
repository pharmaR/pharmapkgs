# Validation Report - CPNCoverageAnalysis@1.1.0
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Sebastian Moreno <sebastian.moreno.araya@gmail.com>  |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    estimate_participant       generate_norms   property_simulator 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-17 04:14:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6744e55d2_1739765653
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoqbC7u
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CPNCoverageAnalysis_v1.1.0-tikzDictionary"
