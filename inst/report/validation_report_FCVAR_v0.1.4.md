...
| export_help          | 14                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Lealand Morin <lealand.morin@ucf.edu> |
| bugs_status          | 1                                     |
| has_source_control   | https://github.com/LeeMorinUCF/FCVAR  |
...
Overall the package has 14 exported objects. 14 are documented:
           ...
           FCVARboot    FCVARbootRank        FCVARestn    FCVARforecast 
                TRUE             TRUE             TRUE             TRUE 
       FCVARhypoTest   FCVARlagSelect    FCVARlikeGrid     FCVARoptions 
                TRUE             TRUE             TRUE             TRUE 
      FCVARrankTests         FCVARsim       FCVARsimBS         FracDiff 
                TRUE             TRUE             TRUE             TRUE 
    GetCharPolyRoots         MVWNtest 
                TRUE             TRUE 
...
| Execution Time | 2025-02-27 03:21:31 UTC |
...
running this report
    ...
    PROCESSX_PS1c62f943bcc_1740626487
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdwVr9F
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FCVAR_v0.1.4-tikzDictionary"
