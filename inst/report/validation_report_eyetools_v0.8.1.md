# Validation Report - eyetools@0.8.1
...
| export_help          | 19                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Tom Beesley <t.beesley@lancaster.ac.uk> |
...
Overall the package has 19 exported objects. 19 are documented:
                  ...
                  AOI_seq              AOI_time       AOI_time_binned 
                     TRUE                  TRUE                  TRUE 
             combine_eyes    compare_algorithms conditional_transform 
                     TRUE                  TRUE                  TRUE 
            create_AOI_df  dist_to_visual_angle   fixation_dispersion 
                     TRUE                  TRUE                  TRUE 
             fixation_VTI        hdf5_get_event            hdf5_to_df 
                     TRUE                  TRUE                  TRUE 
              interpolate       plot_AOI_growth          plot_heatmap 
                     TRUE                  TRUE                  TRUE 
                 plot_seq          plot_spatial           saccade_VTI 
                     TRUE                  TRUE                  TRUE 
                 smoother 
                     TRUE 
...
| Execution Time | 2025-02-19 04:59:33 UTC |
...
running this report
    ...
    PROCESSX_PS1d455bf0330b_1739941167
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpW3mlyJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eyetools_v0.8.1-tikzDictionary"
