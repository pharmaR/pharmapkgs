# Validation Report - cppRouting@3.1
...
| export_help          | 12                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Vincent Larmet <larmet.vincent@gmail.com>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/vlarmet/cppRouting                |
...
| 2   | RcppParallel     | Imports   |
| 3   | RcppProgress     | Imports   |
...
GISSB, himach, spNetwork, uci

## Namespace

Overall the package has 12 exported objects. 12 are documented:

         assign_traffic        cpp_contract        cpp_simplify             get_aon 
                   TRUE                TRUE                TRUE                TRUE 
             get_detour get_distance_matrix   get_distance_pair       get_isochrone 
                   TRUE                TRUE                TRUE                TRUE 
        get_multi_paths       get_path_pair           makegraph               to_df 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:15:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bd623c0ab7_1739765719
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuuqVMc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cppRouting_v3.1-tikzDictionary"
