# Validation Report - clifro@3.2.5
...
| export_help          | 13                                  |
| has_website          | TRUE                                |
| has_maintainer       | Blake Seers <blake.seers@gmail.com> |
| bugs_status          | 1                                   |
| has_source_control   | https://github.com/ropensci/clifro  |
...
Overall the package has 9 exported objects. 11 are documented:

       cf_curl_opts     cf_datatype cf_find_station   cf_last_query        cf_query 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        cf_save_kml      cf_station         cf_user        windrose 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-23 03:22:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d253cf0be97_1740280941
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLRXW51
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clifro_v3.2.5-tikzDictionary"
