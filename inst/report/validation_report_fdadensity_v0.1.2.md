# Validation Report - fdadensity@0.1.2
...
| export_help          | 15                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Alexander Petersen <petersen@pstat.ucsb.edu> |
| bugs_status          | 0.5                                          |
| has_source_control   | https://github.com/functionaldata/tDENS      |
...
Overall the package has 15 exported objects. 15 are documented:
    ...
    CreateModeOfVarPlotLQ2D                dens2lqd                 dens2qd 
                       TRUE                    TRUE                    TRUE 
              dens2quantile     DeregulariseByAlpha                FPCAdens 
                       TRUE                    TRUE                    TRUE 
                     GetFVE               getWFmean                lqd2dens 
                       TRUE                    TRUE                    TRUE 
               lqd2quantile           MakeDENsample           MakeLQDsample 
                       TRUE                    TRUE                    TRUE 
         normaliseDensities                 qd2dens       RegulariseByAlpha 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-27 03:22:02 UTC |
...
running this report
    ...
    PROCESSX_PS1c626c8374c1_1740626519
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpd9njkW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fdadensity_v0.1.2-tikzDictionary"
