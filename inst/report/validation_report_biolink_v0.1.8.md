# Validation Report - biolink@0.1.8
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Aaron Wolen <aaron@wolen.com>                        |
...
Overall the package has 13 exported objects. 13 are documented:
     ...
     build_link   link_bioc   link_cran link_entrez     link_go   link_kegg 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
    link_pubmed    url_bioc    url_cran  url_entrez      url_go    url_kegg 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
     url_pubmed 
           TRUE 
...
| Execution Time | 2025-02-15 04:13:09 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdc014485_1739592784
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvDxqnV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biolink_v0.1.8-tikzDictionary"
