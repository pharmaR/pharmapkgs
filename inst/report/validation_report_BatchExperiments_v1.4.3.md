# Validation Report - BatchExperiments@1.4.3
...
| bugs_status          | 0.5625                                     |
| has_source_control   | https://github.com/tudo-r/BatchExperiments |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | BatchJobs (\>= 1.7)    | Depends |
| 2   | backports              | Imports |
| 3   | utils                  | Imports |
| 4   | stats                  | Imports |
| 5   | checkmate (\>= 1.8.5)  | Imports |
| 6   | BBmisc (\>= 1.11)      | Imports |
| 7   | DBI                    | Imports |
| 8   | RSQLite (\>= 2.0)      | Imports |
| 9   | data.table (\>= 1.9.6) | Imports |
...
Overall the package has 20 exported objects. 20 are documented:
                        ...
                        addAlgorithm                   addExperiments 
                                TRUE                             TRUE 
                          addProblem                  findExperiments 
                                TRUE                             TRUE 
             generateProblemInstance                     getAlgorithm 
                                TRUE                             TRUE 
                     getAlgorithmIds               getExperimentParts 
                                TRUE                             TRUE 
                            getIndex                       getProblem 
                                TRUE                             TRUE 
                       getProblemIds                    getResultVars 
                                TRUE                             TRUE 
                          makeDesign           makeExperimentRegistry 
                                TRUE                             TRUE 
            reduceResultsExperiments reduceResultsExperimentsParallel 
                                TRUE                             TRUE 
                     removeAlgorithm                removeExperiments 
                                TRUE                             TRUE 
                       removeProblem             summarizeExperiments 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-15 03:29:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2446dd71_1739590178
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz77dwT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BatchExperiments_v1.4.3-tikzDictionary"
