...
| export_help          | 15                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Chawezi Miti <chawezi.miti@nottingham.ac.uk> |
...
Overall the package has 15 exported objects. 15 are documented:
            ...
            blbin   ble_profile          blqr       bolides          cbvn 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    expl_boundary          kurt     limfactor       na.drop        ocskew 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        predictBL     seHessian          skew   startValues     summastat 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-15 04:20:46 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd24f97abc_1739593241
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4SbUTo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BLA_v1.0.1-tikzDictionary"
