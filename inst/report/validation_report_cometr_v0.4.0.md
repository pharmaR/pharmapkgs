# Validation Report - cometr@0.4.0
...
| export_help          | 18                                 |
| has_website          | TRUE                               |
| has_maintainer       | Nimrod Lahav <nimrod@comet.com>    |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/comet-ml/cometr |
...
Overall the package has 18 exported objects. 18 are documented:
                  ...
                  Artifact          ArtifactAsset               call_api 
                      TRUE                   TRUE                   TRUE 
           create_artifact      create_experiment         create_project 
                      TRUE                   TRUE                   TRUE 
            delete_project        disable_logging             Experiment 
                      TRUE                   TRUE                   TRUE 
           get_api_version            get_columns         get_experiment 
                      TRUE                   TRUE                   TRUE 
           get_experiments get_multi_metric_chart           get_projects 
                      TRUE                   TRUE                   TRUE 
            get_workspaces         LoggedArtifact    LoggedArtifactAsset 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-16 05:03:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3c660e38_1739682219
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6gtfnP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cometr_v0.4.0-tikzDictionary"
