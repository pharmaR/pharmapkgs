# Validation Report - cartographr@0.2.2
...
| export_help          | 19                                          |
| has_website          | TRUE                                        |
| has_maintainer       | David Willinger <david.willinger@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/da-wi/cartographr        |
...
Overall the package has 19 exported objects. 19 are documented:
                     ...
                     crop           get_osmdata           get_palette 
                     TRUE                  TRUE                  TRUE 
                 plot_map        preprocess_map          print_config 
                     TRUE                  TRUE                  TRUE 
                 save_map       set_attribution       set_output_size 
                     TRUE                  TRUE                  TRUE 
            theme_infomap   theme_infomap_anton  theme_infomap_barlow 
                     TRUE                  TRUE                  TRUE 
     theme_infomap_cinzel theme_infomap_poppins          theme_poster 
                     TRUE                  TRUE                  TRUE 
       theme_poster_anton   theme_poster_barlow   theme_poster_cinzel 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 03:43:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36923b55e_1739677430
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfoAc9f
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cartographr_v0.2.2-tikzDictionary"
