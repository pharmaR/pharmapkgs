# Validation Report - dataCompare@1.0.5
...
| export_help          | 8                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Sergio Ewane Ebouele <info@dataforknow.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/seewe/dataCompare        |
...
| 14  | shinydashboardPlus | Imports |
| 15  | shinyWidgets       | Imports |
| 16  | skimr              | Imports |
| 17  | tools              | Imports |
| 18  | utils              | Imports |
...
Overall the package has 8 exported objects. 7 are documented:
                               ...
                               FALSE                             TRUE 
    compare_data_frame_object_report             data_table_formatter 
                                TRUE                             TRUE 
                run_data_compare_app                   same_variables 
                                TRUE                             TRUE 
                           skim_char                         skim_num 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-17 04:56:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6367773c9_1739768210
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptjSS9Q
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dataCompare_v1.0.5-tikzDictionary"
