...
| export_help          | 12                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Kent Russell <kent.russell@timelyportfolio.com> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/timelyportfolio/d3r          |
...
Overall the package has 12 exported objects. 12 are documented:
    ...
    d3_dep_jetpack      d3_dep_v3      d3_dep_v4      d3_dep_v5      d3_dep_v6 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         d3_dep_v7      d3_igraph        d3_json        d3_nest       d3_party 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          d3_table          d3_v8 
              TRUE           TRUE 
...
| Execution Time | 2025-02-17 04:48:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bd623c657e2_1739767716
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpprA03W
...
These are the options set to generate the report:
    ...
    [1] "validation_report_d3r_v1.1.0-tikzDictionary"
