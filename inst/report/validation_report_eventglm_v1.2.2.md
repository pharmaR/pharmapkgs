# Validation Report - eventglm@1.2.2
...
Overall the package has 13 exported objects. 13 are documented:
                       ...
                       cumincglm   jackknife.competing.risks2 
                            TRUE                         TRUE 
             jackknife.survival2  leaveOneOut.competing.risks 
                            TRUE                         TRUE 
    leaveOneOut.competing.risks2         leaveOneOut.survival 
                            TRUE                         TRUE 
           leaveOneOut.survival2                 pseudo_aareg 
                            TRUE                         TRUE 
                    pseudo_coxph           pseudo_independent 
                            TRUE                         TRUE 
               pseudo_stratified                     rmeanglm 
                            TRUE                         TRUE 
                            Surv 
                            TRUE 
...
| Execution Time | 2025-02-19 04:40:04 UTC |
...
running this report
    ...
    PROCESSX_PS1d451b567a9c_1739939998
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHH4YFH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eventglm_v1.2.2-tikzDictionary"
