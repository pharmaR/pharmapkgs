# Validation Report - evapoRe@1.0.0
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Akbar Rahmati Ziveh <rahmati_ziveh@fzp.czu.cz>       |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/AkbarR1184/evapoRe                |
...
Overall the package has 4 exported objects. 4 are documented:
      ...
      download_data download_t_data          muldpm             pet 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 04:38:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d4510d5a35a_1739939906
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpC60nND
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evapoRe_v1.0.0-tikzDictionary"
