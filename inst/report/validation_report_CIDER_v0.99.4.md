# Validation Report - CIDER@0.99.4
...
| export_help          | 14                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Zhiyuan Hu <zhiyuan.cheryl.hu@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/zhiyuan-hu-lab/CIDER  |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | limma (\>= 3.42.0)   | Imports |
| 2   | edgeR (\>= 3.28.0)   | Imports |
| 3   | stats (\>= 3.6.2)    | Imports |
| 4   | foreach (\>= 1.4.7)  | Imports |
| 5   | Seurat (\>= 3.1.0)   | Imports |
| 6   | utils (\>= 3.6.2)    | Imports |
| 7   | pheatmap (\>= 1.0.0) | Imports |
| 8   | dbscan (\>= 1.1-5)   | Imports |
| 9   | kernlab (\>= 0.9-29) | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
    ...
    calculateDistMatOneModel             downsampling             estimateProb 
                        TRUE                     TRUE                     TRUE 
             finalClustering    gatherInitialClusters               getDistMat 
                        TRUE                     TRUE                     TRUE 
                     getIDEr           hdbscan.seurat        initialClustering 
                        TRUE                     TRUE                     TRUE 
        mergeInitialClusters              plotDistMat              plotHeatmap 
                        TRUE                     TRUE                     TRUE 
                 plotNetwork              scatterPlot 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-16 04:18:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31bacb2f1_1739679495
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBL0PPk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CIDER_v0.99.4-tikzDictionary"
