# Validation Report - cherry@0.6.15
...
| export_help          | 28                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jelle Goeman <j.j.goeman@lumc.nl>                    |
...
Overall the package has 18 exported objects. 26 are documented:

            adjusted           closed        construct      curveFisher 
                TRUE             TRUE             TRUE             TRUE 
    curveMeinshausen       curveSimes        DAGmethod          DAGpick 
                TRUE             TRUE             TRUE             TRUE 
          hommelFast             pick       pickFisher  pickMeinshausen 
                TRUE             TRUE             TRUE             TRUE 
           pickSimes     regionmethod       regionpick       regionplot 
                TRUE             TRUE             TRUE             TRUE 
         regionplot2   structuredHolm 
                TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:12:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33ee78662_1739679121
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbCgZuR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cherry_v0.6.15-tikzDictionary"
