# Validation Report - bnviewer@0.1.6
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Robson Fernandes <robson.fernandes@usp.br>           |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | visNetwork (\>= 2.0.4) | Imports |
| 2   | bnlearn (\>= 4.3)      | Imports |
| 3   | methods                | Imports |
| 4   | igraph (\>= 1.2.4)     | Imports |
| 5   | shiny                  | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
          ...
          bn.to.igraph model.to.structure    strength.viewer             viewer 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:29:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1d6573bd_1739593772
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0rhKRY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bnviewer_v0.1.6-tikzDictionary"
