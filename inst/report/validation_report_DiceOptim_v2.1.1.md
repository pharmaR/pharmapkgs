# Validation Report - DiceOptim@2.1.1
...
| export_help          | 42                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Victor Picheny <victor.picheny@toulouse.inra.fr>     |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | DiceKriging (\>= 1.2) | Depends |
| 2   | methods               | Depends |
| 3   | randtoolbox           | Imports |
| 4   | pbivnorm              | Imports |
| 5   | rgenoud               | Imports |
| 6   | mnormt                | Imports |
| 7   | DiceDesign            | Imports |
| 8   | parallel              | Imports |
...
comparer, GPareto, GPGame, laGP, stops
...
Overall the package has 42 exported objects. 42 are documented:
                       ...
                       AEI               AEI.grad                    AKG 
                      TRUE                   TRUE                   TRUE 
                  AKG.grad                branin2           checkPredict 
                      TRUE                   TRUE                   TRUE 
                   crit_AL               crit_EFI           crit_SUR_cst 
                      TRUE                   TRUE                   TRUE 
         critcst_optimizer                easyEGO            easyEGO.cst 
                      TRUE                   TRUE                   TRUE 
                   EGO.cst             EGO.nsteps                     EI 
                      TRUE                   TRUE                   TRUE 
                   EI.grad                    EQI               EQI.grad 
                      TRUE                   TRUE                   TRUE 
            fastEGO.nsteps                fastfun         goldsteinprice 
                      TRUE                   TRUE                   TRUE 
                  hartman4 integration_design_cst       kriging.quantile 
                      TRUE                   TRUE                   TRUE 
     kriging.quantile.grad                max_AEI                max_AKG 
                      TRUE                   TRUE                   TRUE 
                  max_crit                 max_EI                max_EQI 
                      TRUE                   TRUE                   TRUE 
                   max_qEI           min_quantile        noisy.optimizer 
                      TRUE                   TRUE                   TRUE 
            ParrConstraint            qEGO.nsteps                    qEI 
                      TRUE                   TRUE                   TRUE 
                  qEI.grad            rosenbrock4           sampleFromEI 
                      TRUE                   TRUE                   TRUE 
                   sphere6           TREGO.nsteps     update_km_noisyEGO 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:00:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bb430794af6_1739851206
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCiwCGV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiceOptim_v2.1.1-tikzDictionary"
