# Validation Report - boodist@1.0.0
...
| has_source_control   | https://github.com/stla/boodist            |
...
| 1   | R6            | Imports   |
| 2   | Rcpp          | Imports   |
| 3   | RcppNumerical | Imports   |
| 4   | stats         | Imports   |
| 5   | BH            | LinkingTo |
| 6   | Rcpp          | LinkingTo |
| 7   | RcppEigen     | LinkingTo |
| 8   | RcppNumerical | LinkingTo |
...
Overall the package has 10 exported objects. 10 are documented:
                    ...
                    findChi2df                findChi2ncp 
                          TRUE                       TRUE 
    GeneralizedInverseGaussian                     Gumbel 
                          TRUE                       TRUE 
              Hyperexponential               InverseGamma 
                          TRUE                       TRUE 
               InverseGaussian      NormalInverseGaussian 
                          TRUE                       TRUE 
                    SkewNormal                    Student 
                          TRUE                       TRUE 
...
There are 4 help pages with examples, from 10 (40.00 %).
...
| Execution Time | 2025-02-15 04:32:04 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5505451d_1739593919
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOVAPRo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_boodist_v1.0.0-tikzDictionary"
