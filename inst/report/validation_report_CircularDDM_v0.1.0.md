# Validation Report - CircularDDM@0.1.0
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yi-Shin Lin <yishin.lin@utas.edu.au>                 |
...
| 2   | Rcpp (\>= 0.12.3)               | LinkingTo |
| 3   | RcppArmadillo (\>= 0.6.700.6.0) | LinkingTo |
...
Overall the package has 6 exported objects. 6 are documented:
     ...
     besselzero       dcddm   logLik_dt logLik_resp       rcddm         rvm 
...
| Execution Time | 2025-02-16 04:22:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3508dc6e9_1739679720
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3Gso5y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CircularDDM_v0.1.0-tikzDictionary"
