# Validation Report - ComparisonSurv@1.1.1
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Zheng Chen <zheng-chen@hotmail.com>                  |
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          crosspoint   Cumhazard.plot Descriptive.stat    Fixpoint.test 
                TRUE             TRUE             TRUE             TRUE 
         Hazard.plot        Long.test     Overall.test       Short.test 
                TRUE             TRUE             TRUE             TRUE 
       Survival.plot 
                TRUE 
...
| Execution Time | 2025-02-17 03:34:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64c5c7f98_1739763291
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmply8tzI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ComparisonSurv_v1.1.1-tikzDictionary"
