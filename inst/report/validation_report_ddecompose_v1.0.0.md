# Validation Report - ddecompose@1.0.0
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Samuel Meier <samuel.meier+ddecompose@immerda.ch>    |
...
Overall the package has 5 exported objects. 5 are documented:
        ...
        dfl_decompose estimate_iq_range estimate_iq_ratio  GU_normalization 
                 TRUE              TRUE              TRUE              TRUE 
         ob_decompose 
                 TRUE 
...
| Execution Time | 2025-02-18 03:28:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45157e641_1739849316
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmps2QJ5x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ddecompose_v1.0.0-tikzDictionary"
