# Validation Report - ExplainPrediction@1.3.0
...
|     | package                    | type    |
|:----|:---------------------------|:--------|
| 1   | CORElearn (\>= 1.52.0)     | Imports |
| 2   | semiArtificial (\>= 2.2.5) | Imports |
...
| Execution Time | 2025-02-19 04:52:55 UTC |
...
running this report
    ...
    PROCESSX_PS1d454621a4b3_1739940768
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpI2rCIr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ExplainPrediction_v1.3.0-tikzDictionary"
