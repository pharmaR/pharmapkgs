...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Prabhleen Kaur <prabhleen.kaur.ucd@gmail.com>        |
...
Overall the package has 19 exported objects. 19 are documented:
        ...
        bootstrapped_difference_pvalues                 correlation_analyze 
                                   TRUE                                TRUE 
            distance_radian_coordinates           get_coordinates_in_radian 
                                   TRUE                                TRUE 
                       get_interactions                 get_network_summary 
                                   TRUE                                TRUE 
                  get_spatial_threshold                           global_CI 
                                   TRUE                                TRUE 
                        global_width_CI                   interacting_pairs 
                                   TRUE                                TRUE 
              network_from_interactions                       node_level_CI 
                                   TRUE                                TRUE 
            obtain_bootstrapped_samples           obtain_network_subsamples 
                                   TRUE                                TRUE 
       obtain_permuted_network_versions                        plot_network 
                                   TRUE                                TRUE 
               regression_slope_analyze          subsampled_network_metrics 
                                   TRUE                                TRUE 
...
| Execution Time | 2025-02-14 06:55:07 UTC |
...
running this report
    ...
    PROCESSX_PS726d57adf07_1739516104
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuB5yqR
