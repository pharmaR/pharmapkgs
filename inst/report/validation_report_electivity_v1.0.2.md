# Validation Report - electivity@1.0.2
...
| export_help          | 8                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Desi Quintans <science@desiquintans.com>   |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/DesiQuintans/electivity |
...
Overall the package has 8 exported objects. 8 are documented:
       ...
       chesson_alpha ivlev_electivity     ivlev_forage jacob_electivity 
                TRUE             TRUE             TRUE             TRUE 
        jacob_forage   strauss_linear    vs_electivity   vs_select_coef 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 03:55:09 UTC |
...
running this report
    ...
    PROCESSX_PS1d45637e3187_1739937303
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfYdQjm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_electivity_v1.0.2-tikzDictionary"
