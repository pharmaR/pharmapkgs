# Validation Report - coveffectsplot@1.0.6
...
| export_help          | 7                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Samer Mouksassi <samermouksassi@gmail.com>   |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/smouksassi/coveffectsplot |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | data.table (\>= 1.9.8) | Depends |
| 2   | colourpicker           | Imports |
| 3   | egg                    | Imports |
| 4   | grid                   | Imports |
| 5   | ggplot2 (\>= 3.3.2)    | Imports |
| 6   | shiny                  | Imports |
| 7   | stats                  | Imports |
| 8   | utils                  | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
                  ...
                  deltamethod            draw_key_hpath      draw_key_pointrangeh 
                         TRUE                      TRUE                      TRUE 
            expand_modelframe               forest_plot           get_sample_data 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-17 04:06:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65abd6ce9_1739765202
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp866Tb2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coveffectsplot_v1.0.6-tikzDictionary"
