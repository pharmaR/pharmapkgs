# Validation Report - CARRoT@3.0.2
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alina Bazarova <al.bazarova@fz-juelich.de>           |
...
Overall the package has 19 exported objects. 19 are documented:
                    ...
                    AUC              av_out                comb  compute_max_length 
                   TRUE                TRUE                TRUE                TRUE 
     compute_max_weight     compute_weights           cross_val                 cub 
                   TRUE                TRUE                TRUE                TRUE 
               find_int            find_sub         get_indices     get_predictions 
                   TRUE                TRUE                TRUE                TRUE 
    get_predictions_lin   get_probabilities        make_numeric   make_numeric_sets 
                   TRUE                TRUE                TRUE                TRUE 
                  quadr            regr_ind     sum_weights_sub 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 03:43:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37dbe80bf_1739677398
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9ilMvI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CARRoT_v3.0.2-tikzDictionary"
