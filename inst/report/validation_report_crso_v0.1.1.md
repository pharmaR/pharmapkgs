...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Michael Klein <michael.klein@yale.edu>               |
...
Overall the package has 15 exported objects. 15 are documented:
         ...
         buildRuleLibrary     evaluateListOfIMs         getBestRsList 
                     TRUE                  TRUE                  TRUE 
                 getCoreK             getCoreRS               getGCDs 
                     TRUE                  TRUE                  TRUE 
                  getGCEs               getGCRs          getPoolSizes 
                     TRUE                  TRUE                  TRUE 
        getRulesAsStrings    makeFilteredImList makePhaseOneOrderedRM 
                     TRUE                  TRUE                  TRUE 
     makePhaseThreeImList    makePhaseTwoImList       makeSubCoreList 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-17 04:26:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bd662e36989_1739766394
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgGeZfV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crso_v0.1.1-tikzDictionary"
