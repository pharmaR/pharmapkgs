# Validation Report - EQUIVNONINF@1.0.2
...
| export_help          | 40                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Stefan Wellek <stefan.wellek@zi-mannheim.de>         |
...
Overall the package has 40 exported objects. 40 are documented:
            ...
            bi1st       bi2aeq1       bi2aeq2       bi2aeq3  bi2by_ni_del 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      bi2by_ni_OR     bi2diffac      bi2dipow       bi2rlv1       bi2rlv2 
             TRUE          TRUE          TRUE          TRUE          TRUE 
            bi2st       bi2ste1       bi2ste2       bi2ste3 bi2wld_ni_del 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     cf_reh_exact   cf_reh_midp        exp1st      fstretch       gofhwex 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       gofhwex_1s      gofind_t      gofsimpt          mawi     mcnasc_ni 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         mcnby_ni   mcnby_ni_pp      mcnemasc      mcnempow      mwtie_fr 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         mwtie_xy      po_pbibe       postmys       pow_abe       powsign 
             TRUE          TRUE          TRUE          TRUE          TRUE 
            sgnrk      srktie_d      srktie_m         tt1st         tt2st 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 04:24:43 UTC |
...
running this report
    ...
    PROCESSX_PS1d453afc745f_1739939077
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDFlUKB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EQUIVNONINF_v1.0.2-tikzDictionary"
