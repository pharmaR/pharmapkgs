# Validation Report - constellation@0.2.0
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Mark Sendak <mark.sendak@gmail.com>                  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/marksendak/constellation          |
...
Overall the package has 5 exported objects. 5 are documented:
                  ...
                  bundle          constellate constellate_criteria 
                    TRUE                 TRUE                 TRUE 
               incidents         value_change 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-17 03:48:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61fba6cd0_1739764093
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB7mM5f
...
These are the options set to generate the report:
    ...
    [1] "validation_report_constellation_v0.2.0-tikzDictionary"
