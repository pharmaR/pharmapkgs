# Validation Report - datafsm@0.2.4
...
| export_help | 22 |
| has_website | TRUE |
| has_maintainer | Jonathan M. Gilligan <jonathan.gilligan@vanderbilt.edu> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/jonathan-g/datafsm |
...
|     | package           | type      |
|:----|:------------------|:----------|
| 1   | methods (\>= 4.0) | Depends   |
| 2   | stats (\>= 4.0)   | Depends   |
| 3   | Rcpp (\>= 1.0)    | LinkingTo |
| 4   | caret (\>= 6.0)   | Imports   |
| 5   | GA (\>= 3.2)      | Imports   |
| 6   | Rcpp (\>= 1.0)    | Imports   |
...
Overall the package has 18 exported objects. 18 are documented:
             ...
             action_vec    add_interact_num    best_performance     build_bitstring 
                   TRUE                TRUE                TRUE                TRUE 
            compare_fsm   decode_action_vec    decode_state_mat    degeneracy_check 
                   TRUE                TRUE                TRUE                TRUE 
     estimation_details        evolve_model     evolve_model_cv evolve_model_ntimes 
                   TRUE                TRUE                TRUE                TRUE 
         find_wildcards          fitnessCPP         performance              states 
                   TRUE                TRUE                TRUE                TRUE 
                var_imp              varImp 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:57:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67ac9e3cb_1739768274
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMmRTnf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datafsm_v0.2.4-tikzDictionary"
