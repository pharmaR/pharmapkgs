...
| export_help          | 26                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Bill Pikounis <cg@billpikounis.net>                  |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | Hmisc (\>= 3.17-1) | Depends |
| 2   | VGAM (\>= 1.0-0)   | Imports |
| 3   | methods            | Imports |
| 4   | grDevices          | Imports |
| 5   | graphics           | Imports |
| 6   | stats              | Imports |
...
Overall the package has 7 exported objects. 26 are documented:

                      comparisons              comparisonsgraph 
                             TRUE                          TRUE 
                    errorbargraph                   factorInSeq 
                             TRUE                          TRUE 
                          prepare        prepareCGOneFactorData 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-16 04:05:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33253d18a_1739678717
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpy7GcO3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cg_v1.0.3-tikzDictionary"
