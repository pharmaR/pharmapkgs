...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Kyle Butts <kyle.butts@colorado.edu>                 |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | fixest (\>= 0.10.1) | Depends |
| 2   | data.table          | Imports |
| 3   | SparseM             | Imports |
| 4   | MatrixExtra         | Imports |
| 5   | Matrix              | Imports |
| 6   | stats               | Imports |
| 7   | boot                | Imports |
| 8   | broom               | Imports |
...
| 10  | rlang               | Imports |
| 11  | did                 | Imports |
| 12  | staggered           | Imports |
| 13  | didimputation       | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
               ...
               did2s      event_study         gen_data plot_event_study 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:01:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43a9a16f4_1739851277
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUXy0e3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_did2s_v1.0.2-tikzDictionary"
