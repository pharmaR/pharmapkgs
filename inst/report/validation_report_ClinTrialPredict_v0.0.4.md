# Validation Report - ClinTrialPredict@0.0.4
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yang Ding <tomding.biostat@gmail.com>                |
...
Overall the package has 10 exported objects. 10 are documented:
        ...
        CensRate.OneArm     CensTime.TwoArm NumEventsSub.OneArm NumEventsSub.TwoArm 
                   TRUE                TRUE                TRUE                TRUE 
         ObsTime.OneArm      ObsTime.TwoArm      SimData.OneArm      SimData.TwoArm 
                   TRUE                TRUE                TRUE                TRUE 
       TrialPred.OneArm    TrialPred.TwoArm 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:33:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bc369962359_1739680404
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKCGIdf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClinTrialPredict_v0.0.4-tikzDictionary"
