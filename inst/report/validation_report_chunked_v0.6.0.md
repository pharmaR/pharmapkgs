# Validation Report - chunked@0.6.0
...
| has_source_control   | https://github.com/edwindj/chunked     |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    insert_chunkwise_into        read_chunkwise    read_csv_chunkwise 
                     TRUE                  TRUE                  TRUE 
      read_csv2_chunkwise    read_laf_chunkwise  read_table_chunkwise 
                     TRUE                  TRUE                  TRUE 
          write_chunkwise   write_csv_chunkwise  write_csv2_chunkwise 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:17:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3548de220_1739679428
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLbunRp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chunked_v0.6.0-tikzDictionary"
