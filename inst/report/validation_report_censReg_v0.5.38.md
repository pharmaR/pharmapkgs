# Validation Report - censReg@0.5.38
...
| export_help | 1 |
| has_website | TRUE |
| has_maintainer | Arne Henningsen <arne.henningsen@gmail.com> |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | maxLik (\>= 0.7-3)     | Depends |
| 2   | glmmML (\>= 0.81-6)    | Imports |
| 3   | sandwich (\>= 2.2-6)   | Imports |
| 4   | miscTools (\>= 0.6-11) | Imports |
| 5   | stats (\>= 2.15.0)     | Imports |
| 6   | plm                    | Imports |
...
cmtest, GLMpack, gravity, insight, micsr
...
| Execution Time | 2025-02-23 03:20:17 UTC |
...
running this report
    ...
    PROCESSX_PS1d253d78550c_1740280814
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmps4wzUE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_censReg_v0.5.38-tikzDictionary"
