...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Limei Wang <lemon619@gmail.com>                      |
...
|     | package          | type      |
|:----|:-----------------|:----------|
| 1   | DysPIAData       | Depends   |
| 2   | Rcpp (\>= 1.0.4) | Imports   |
| 3   | BiocParallel     | Imports   |
| 4   | fastmatch        | Imports   |
...
Overall the package has 4 exported objects. 4 are documented:
                   ...
                   calcDyspiaStat      calcDyspiaStatCumulative 
                             TRUE                          TRUE 
    calcDyspiaStatCumulativeBatch                        DysPIA 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-18 05:07:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4334d69ec_1739855269
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXgNsv6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DysPIA_v1.3-tikzDictionary"
