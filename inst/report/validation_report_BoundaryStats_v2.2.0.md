# Validation Report - BoundaryStats@2.2.0
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Amy Luo <aluo@vols.utk.edu>                          |
...
Overall the package has 15 exported objects. 15 are documented:
     ...
     boundary_null_distrib   categorical_boundary        define_boundary 
                      TRUE                   TRUE                   TRUE 
    gauss_random_field_sim          lisa_clusters           max_subgraph 
                      TRUE                   TRUE                   TRUE 
      mod_random_clust_sim             n_subgraph                Odirect 
                      TRUE                   TRUE                   TRUE 
      overlap_null_distrib                     Ox                    Oxy 
                      TRUE                   TRUE                   TRUE 
             plot_boundary      random_raster_sim         sobel_operator 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:36:30 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd54f9ecd3_1739594185
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprRe5If
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BoundaryStats_v2.2.0-tikzDictionary"
