...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Vasyl Pihur <vpihur@gmail.com>                       |
...
ClustAll, Cluster.OBeu, diceR, ibawds, jrSiCKLSNMF, latrend, MultIS,
nomclust, omada, OMICsPCA, R3CPET, RadialVisGadgets, RankAggreg, uHMM,
visxhclust, WormTensor

## Namespace

Overall the package has 11 exported objects. 17 are documented:

    annotationListToMatrix                    BHI                    BSI 
                      TRUE                   TRUE                   TRUE 
                   clValid           connectivity                   dunn 
                      TRUE                   TRUE                   TRUE 
           getRanksWeights                matchGO     readAnnotationFile 
                      TRUE                   TRUE                   TRUE 
                      sota              stability 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:42:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bc331983ae_1739680950
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB4BmhE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clValid_v0.7-tikzDictionary"
