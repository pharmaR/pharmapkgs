# Validation Report - EScvtmle@0.0.2
...
| export_help | 3 |
| has_website | TRUE |
| has_maintainer | Lauren Eyler Dang <lauren.eyler@berkeley.edu> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/Lauren-EylerDang/EScvtmle/tree/main |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | SuperLearner (\>= 2.0.28) | Depends |
| 2   | origami (\>= 1.0.5)       | Imports |
| 3   | dplyr (\>= 1.0.8)         | Imports |
| 4   | tidyselect (\>= 1.2.0)    | Imports |
| 5   | MASS (\>= 7.3.54)         | Imports |
| 6   | stringr (\>= 1.4.0)       | Imports |
| 7   | ggplot2 (\>= 3.3.6)       | Imports |
| 8   | gridExtra (\>= 2.3)       | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
         ...
         ES.cvtmle  plot.EScvtmle print.EScvtmle 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:29:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d4589a9c08_1739939347
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBhyIcH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EScvtmle_v0.0.2-tikzDictionary"
