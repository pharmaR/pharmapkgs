...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | wavethresh         | Depends |
| 2   | adlift (\>= 0.9.2) | Depends |
| 3   | EbayesThresh       | Depends |
...
| Execution Time | 2025-02-15 04:09:03 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3ada788b_1739592538
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7YJE0k
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binhf_v1.0.3-tikzDictionary"
