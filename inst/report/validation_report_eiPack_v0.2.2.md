# Validation Report - eiPack@0.2.2
...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Michael Kellermann <mrkellermann@gmail.com>          |
...
Overall the package has 13 exported objects. 13 are documented:
              ...
              bounds       cover.plot      densityplot      ei.MD.bayes 
                TRUE             TRUE             TRUE             TRUE 
              ei.reg     ei.reg.bayes        lambda.MD       lambda.reg 
                TRUE             TRUE             TRUE             TRUE 
    lambda.reg.bayes          mergeMD      plot.bounds       read.betas 
                TRUE             TRUE             TRUE             TRUE 
              tuneMD 
                TRUE 
...
| Execution Time | 2025-02-19 03:52:40 UTC |
...
running this report
    ...
    PROCESSX_PS1d451262d8ed_1739937154
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuVZdpD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eiPack_v0.2.2-tikzDictionary"
