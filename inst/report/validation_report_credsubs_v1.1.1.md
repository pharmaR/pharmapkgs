# Validation Report - credsubs@1.1.1
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Patrick Schnell <schnell.31@osu.edu>                 |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    build.shiny.calc         credsubs   credsubs.level   run.shiny.calc 
                TRUE             TRUE             TRUE             TRUE 
       sim.cred.band 
                TRUE 
...
| Execution Time | 2025-02-17 04:19:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62019d3ce_1739765968
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxTd0uB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_credsubs_v1.1.1-tikzDictionary"
