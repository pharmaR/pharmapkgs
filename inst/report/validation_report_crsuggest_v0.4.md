# Validation Report - crsuggest@0.4
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Kyle Walker <kyle@walker-data.com>                   |
...
Overall the package has 4 exported objects. 4 are documented:
          ...
          guess_crs     suggest_crs suggest_top_crs        view_crs 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:26:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bd648331e58_1739766406
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKMagPA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crsuggest_v0.4-tikzDictionary"
