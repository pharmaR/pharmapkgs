# Validation Report - CohortAlgebra@0.3.0
...
| export_help          | 6                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Gowtham Rao <rao@ohdsi.org>            |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/OHDSI/CohortAlgebra |
...
Overall the package has 6 exported objects. 6 are documented:
           ...
           appendCohortTables               copyCohorts          intersectCohorts 
                         TRUE                      TRUE                      TRUE 
                 minusCohorts removeOverlappingSubjects              unionCohorts 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-16 04:54:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33ad176ec_1739681677
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpzla24t
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CohortAlgebra_v0.3.0-tikzDictionary"
