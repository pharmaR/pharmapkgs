# Validation Report - factor256@0.1.0
...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Hugh Parsonage <hugh.parsonage@gmail.com>            |
...
Overall the package has 20 exported objects. 20 are documented:
                 ...
                 as_factor         deinterlace256 deinterlace256_columns 
                      TRUE                   TRUE                   TRUE 
                 factor256          factor256_ein       factor256_enotin 
                      TRUE                   TRUE                   TRUE 
              factor256_in        factor256_notin           interlace256 
                      TRUE                   TRUE                   TRUE 
      interlace256_columns           is.factor256          isntSorted256 
                      TRUE                   TRUE                   TRUE 
                  order256                rank256           recompose256 
                      TRUE                   TRUE                   TRUE 
                relevel256             setkeyv256            tabulate256 
                      TRUE                   TRUE                   TRUE 
        tabulate256_levels              unique256 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-19 05:05:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d4545a78fef_1739941504
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHDKsYt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_factor256_v0.1.0-tikzDictionary"
