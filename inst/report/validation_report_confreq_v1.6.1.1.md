# Validation Report - confreq@1.6.1.1
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Joerg-Henrik Heine <jhheine@googlemail.com>          |
...
Overall the package has 17 exported objects. 17 are documented:
      ...
      binomial_test_cfa                 CFA  chi_local_test_cfa             dat2cov 
                   TRUE                TRUE                TRUE                TRUE 
                dat2fre      design_cfg_cfa          df_des_cfa        expected_cfa 
                   TRUE                TRUE                TRUE                TRUE 
    expected_margin_cfa             fre2dat             fre2tab                ftab 
                   TRUE                TRUE                TRUE                TRUE 
                     lr         pos_cfg_cfa               S2CFA        stirling_cfa 
                   TRUE                TRUE                TRUE                TRUE 
            z_tests_cfa 
                   TRUE 
...
| Execution Time | 2025-02-17 03:44:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bd613ce46d6_1739763853
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpavI6v6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_confreq_v1.6.1.1-tikzDictionary"
