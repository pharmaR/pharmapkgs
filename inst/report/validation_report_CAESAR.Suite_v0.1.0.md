# Validation Report - CAESAR.Suite@0.1.0
...
| export_help          | 22                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Xiao Zhang <zhangxiao1994@cuhk.edu.cn>       |
| has_source_control   | https://github.com/XiaoZhangryy/CAESAR.Suite |
...
Overall the package has 22 exported objects. 22 are documented:
                         ...
                         acc       add.gene.embedding           annotation_mat 
                        TRUE                     TRUE                     TRUE 
                         auc        CAESAR.annotation       CAESAR.coembedding 
                        TRUE                     TRUE                     TRUE 
    CAESAR.coembedding.image             CAESAR.CTDEP    CAESAR.enrich.pathway 
                        TRUE                     TRUE                     TRUE 
         CAESAR.enrich.score               CAESAR.RUV       Cauchy.Combination 
                        TRUE                     TRUE                     TRUE 
        cellembedding_matrix     cellembedding_seurat                   CoUMAP 
                        TRUE                     TRUE                     TRUE 
                 CoUMAP.plot           find.sig.genes  getneighborhood_fastcpp 
                        TRUE                     TRUE                     TRUE 
                       Intsg            marker.select           markerList2mat 
                        TRUE                     TRUE                     TRUE 
                    SigScore 
                        TRUE 
...
There are 25 help pages with examples, from 27 (92.59 %).
...
| Execution Time | 2025-02-16 03:33:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bc347267cca_1739676790
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT0clJC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CAESAR.Suite_v0.1.0-tikzDictionary"
