# Validation Report - countSTAR@1.0.2
...
| export_help | 29 |
| has_website | TRUE |
| has_maintainer | Brian King <brianking387@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://bking124.github.io/countSTAR/ |
...
| 9   | graphics        | Imports   |
| 10  | Matrix          | Imports   |
| 11  | spikeSlabGAM    | Imports   |
| 12  | splines2        | Imports   |
| 13  | randomForest    | Imports   |
| 14  | Rcpp            | Imports   |
| 15  | TruncatedNormal | Imports   |
| 16  | truncdist       | Imports   |
| 17  | KFAS            | Imports   |
...
Overall the package has 29 exported objects. 29 are documented:
                     ...
                     a_j             bam_star            bart_star 
                    TRUE                 TRUE                 TRUE 
                blm_star            credBands              ergMean 
                    TRUE                 TRUE                 TRUE 
                    g_bc                g_bnp                g_cdf 
                    TRUE                 TRUE                 TRUE 
            g_inv_approx             g_inv_bc             gbm_star 
                    TRUE                 TRUE                 TRUE 
              genEM_star         genMCMC_star           getEffSize 
                    TRUE                 TRUE                 TRUE 
          init_lm_gprior              lm_star            plot_coef 
                    TRUE                 TRUE                 TRUE 
             plot_fitted             plot_pmf                pvals 
                    TRUE                 TRUE                 TRUE 
       randomForest_star          round_floor     sample_lm_gprior 
                    TRUE                 TRUE                 TRUE 
                  simBaS simulate_nb_friedman       simulate_nb_lm 
                    TRUE                 TRUE                 TRUE 
             spline_star              warpDLM 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-17 04:05:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61242cedd_1739765130
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpc683jn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_countSTAR_v1.0.2-tikzDictionary"
