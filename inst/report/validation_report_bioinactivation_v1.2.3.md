# Validation Report - bioinactivation@1.2.3
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | dplyr (\>= 0.4.1)     | Imports |
| 2   | deSolve (\>= 1.11)    | Imports |
| 3   | FME (\>= 1.3.2)       | Imports |
| 4   | lazyeval (\>= 0.1.10) | Imports |
| 5   | ggplot2 (\>= 2.0.0)   | Imports |
| 6   | MASS (\>= 7.3-39)     | Imports |
| 7   | graphics (\>= 3.1.3)  | Imports |
| 8   | stats (\>= 3.1.3)     | Imports |
| 9   | rlang(\>= 0.1.2)      | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
       ...
       fit_dynamic_inactivation       fit_inactivation_MCMC 
                           TRUE                        TRUE 
    fit_isothermal_inactivation   get_isothermal_model_data 
                           TRUE                        TRUE 
                 get_model_data             goodness_of_fit 
                           TRUE                        TRUE 
             is.FitInactivation      is.FitInactivationMCMC 
                           TRUE                        TRUE 
          is.IsoFitInactivation     is.PredInactivationMCMC 
                           TRUE                        TRUE 
           is.SimulInactivation        predict_inactivation 
                           TRUE                        TRUE 
      predict_inactivation_MCMC        time_to_logreduction 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-15 04:12:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd60a13189_1739592773
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpl518Zf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bioinactivation_v1.2.3-tikzDictionary"
