# Validation Report - bspcov@1.0.1
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Kyeongwon Lee <kwlee1718@gmail.com>                  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/statjs/bspcov                     |
...
| 20  | ggmcmc               | Imports |
| 21  | caret                | Imports |
| 22  | FinCovRegularization | Imports |
| 23  | mvtnorm              | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
        ...
        bandPPP     bmspcov  cv.bandPPP cv.thresPPP    estimate    sbmspcov 
...
| Execution Time | 2025-02-15 04:49:55 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdfcf55e3_1739594990
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpe6XLZC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bspcov_v1.0.1-tikzDictionary"
