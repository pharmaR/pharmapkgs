# Validation Report - blandr@0.6.0
...
| export_help          | 22                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Deepankar Datta <deepankar.datta@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/deepankardatta/blandr/   |
...
Overall the package has 22 exported objects. 22 are documented:
      ...
      blandr.data.preparation      blandr.dataset.fibre       blandr.dataset.load 
                         TRUE                      TRUE                      TRUE 
        blandr.dataset.o2sats       blandr.dataset.pefr        blandr.dataset.sbp 
                         TRUE                      TRUE                      TRUE 
      blandr.display.and.draw               blandr.draw  blandr.method.comparison 
                         TRUE                      TRUE                      TRUE 
         blandr.output.report        blandr.output.text        blandr.plot.ggplot 
                         TRUE                      TRUE                      TRUE 
           blandr.plot.limits     blandr.plot.normality            blandr.plot.qq 
                         TRUE                      TRUE                      TRUE 
            blandr.plot.rplot         blandr.statistics blandr.statistics.formula 
                         TRUE                      TRUE                      TRUE 
             jamoviBAanalysis     jamoviBAplotHistogram            jamoviBAplotQQ 
                         TRUE                      TRUE                      TRUE 
                jamoviBAstats 
                         TRUE 
...
| Execution Time | 2025-02-15 04:21:19 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3a7416bc_1739593274
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp41vRGv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blandr_v0.6.0-tikzDictionary"
