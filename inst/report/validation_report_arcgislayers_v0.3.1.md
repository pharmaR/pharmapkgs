...
| size_codebase        | 2552                                     |
| has_source_control   | https://github.com/R-ArcGIS/arcgislayers |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | arcgisutils (\>= 0.2.0) | Imports |
| 2   | arcpbf (\>= 0.1.5)      | Imports |
| 3   | cli                     | Imports |
| 4   | httr2 (\>= 1.0.5)       | Imports |
| 5   | jsonify                 | Imports |
| 6   | lifecycle               | Imports |
| 7   | RcppSimdJson            | Imports |
| 8   | rlang                   | Imports |
| 9   | sf                      | Imports |
| 10  | terra                   | Imports |
| 11  | utils                   | Imports |
...
Overall the package has 28 exported objects. 28 are documented:
            ...
            .publish_params            add_features                add_item 
                       TRUE                    TRUE                    TRUE 
                   arc_open              arc_raster                arc_read 
                       TRUE                    TRUE                    TRUE 
                 arc_select             clear_query   create_feature_server 
                       TRUE                    TRUE                    TRUE 
            delete_features    download_attachments          get_all_layers 
                       TRUE                    TRUE                    TRUE 
                  get_layer     get_layer_estimates              get_layers 
                       TRUE                    TRUE                    TRUE 
                list_fields              list_items       match_spatial_rel 
                       TRUE                    TRUE                    TRUE 
     prepare_spatial_filter            publish_item           publish_layer 
                       TRUE                    TRUE                    TRUE 
         pull_field_aliases query_layer_attachments           refresh_layer 
                       TRUE                    TRUE                    TRUE 
             truncate_layer         update_features           update_params 
                       TRUE                    TRUE                    TRUE 
               xss_defaults 
                       TRUE 
...
| Execution Time | 2025-02-14 07:21:00 UTC |
...
running this report
    ...
    PROCESSX_PS1c0922ac2d6c_1739517657
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmph1cu5O
