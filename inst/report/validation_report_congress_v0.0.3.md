# Validation Report - congress@0.0.3
...
| has_source_control | https://github.com/christopherkenny/congress |
...
Overall the package has 22 exported objects. 22 are documented:
               ...
               cong_amendment                 cong_bill         cong_bound_record 
                         TRUE                      TRUE                      TRUE 
               cong_committee    cong_committee_meeting      cong_committee_print 
                         TRUE                      TRUE                      TRUE 
        cong_committee_report             cong_congress         cong_daily_record 
                         TRUE                      TRUE                      TRUE 
                 cong_hearing  cong_house_communication    cong_house_requirement 
                         TRUE                      TRUE                      TRUE 
                  cong_member           cong_nomination               cong_record 
                         TRUE                      TRUE                      TRUE 
            cong_request_next cong_senate_communication            cong_summaries 
                         TRUE                      TRUE                      TRUE 
                  cong_treaty          get_congress_key          has_congress_key 
                         TRUE                      TRUE                      TRUE 
             set_congress_key 
                         TRUE 
...
| Execution Time | 2025-02-17 03:44:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6400aa7be_1739763877
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJHonV3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_congress_v0.0.3-tikzDictionary"
