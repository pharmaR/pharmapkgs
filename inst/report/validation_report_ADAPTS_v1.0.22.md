...
| export_help          | 34                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Samuel A Danziger <sam.danziger@gmail.com>           |
...
Overall the package has 34 exported objects. 34 are documented:
                         ...
                         AugmentSigMatrix                             buildSeed 
                                     TRUE                                  TRUE 
                        buildSpilloverMat                               calcAcc 
                                     TRUE                                  TRUE 
                          clustWspillOver                     collapseCellTypes 
                                     TRUE                                  TRUE 
                      estCellCounts.nPass                        estCellPercent 
                                     TRUE                                  TRUE 
                       estCellPercent.DCQ            estCellPercent.DeconRNASeq 
                                     TRUE                                  TRUE 
                      estCellPercent.nnls estCellPercent.proportionsInAdmixture 
                                     TRUE                                  TRUE 
                 estCellPercent.spillOver               estCellPercent.svmdecon 
                                     TRUE                                  TRUE 
                                 getF1mcc                          getLM22cells 
                                     TRUE                                  TRUE 
                              gListFromRF                  hierarchicalClassify 
                                     TRUE                                  TRUE 
                        hierarchicalSplit                            loadMGSM27 
                                     TRUE                                  TRUE 
                               loadModMap                   loopTillConvergence 
                                     TRUE                                  TRUE 
                         matrixToGenelist                           meanResults 
                                     TRUE                                  TRUE 
                           missForest.par                            plotKappas 
                                     TRUE                                  TRUE 
                                  rankByT                           remakeLM22p 
                                     TRUE                                  TRUE 
                                 scSample                         shrinkByKappa 
                                     TRUE                                  TRUE 
                          shrinkSigMatrix                    spillToConvergence 
                                     TRUE                                  TRUE 
                              splitSCdata                    testAllSigMatrices 
                                     TRUE                                  TRUE 
...
| Execution Time | 2025-02-14 06:35:02 UTC |
...
running this report
    ...
    PROCESSX_PS726d16544a1b_1739514900
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgsrTZl
