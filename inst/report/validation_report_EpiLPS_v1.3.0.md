# Validation Report - EpiLPS@1.3.0
...
| 4   | coda (\>= 0.19-4)    | Imports   |
| 5   | EpiEstim (\>= 2.2-4) | Imports   |
| 6   | ggplot2 (\>= 3.3.5)  | Imports   |
...
Overall the package has 12 exported objects. 12 are documented:
        ...
        epicurve       episim   estimIncub       estimR   estimRmcmc  histosmooth 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           Idist     incubsim   nowcasting  nowcastingR   perfRestim Rmodelpriors 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-19 04:17:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d4577edad72_1739938638
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprdXQCj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EpiLPS_v1.3.0-tikzDictionary"
