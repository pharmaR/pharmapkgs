# Validation Report - emIRT@0.0.14
...
Overall the package has 10 exported objects. 10 are documented:
        ...
        binIRT boot_emIRT  convertRC     dynIRT  getStarts    hierIRT makePriors 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
    networkIRT     ordIRT    poisIRT 
          TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-19 04:01:50 UTC |
...
running this report
    ...
    PROCESSX_PS1d4542116b3f_1739937704
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpv5hzlL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emIRT_v0.0.14-tikzDictionary"
