# Validation Report - corrgram@1.14
...
| export_help          | 12                               |
| has_website          | TRUE                             |
| has_maintainer       | Kevin Wright <kw.stat@gmail.com> |
...
agridat, Doscheda, fastR2, Guerry, heplots, STAT, STAT2, VisCollin

## Namespace

Overall the package has 12 exported objects. 12 are documented:

         corrgram     panel.bar    panel.conf     panel.cor panel.density 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    panel.ellipse    panel.fill  panel.minmax     panel.pie     panel.pts 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      panel.shade     panel.txt 
             TRUE          TRUE 
...
| Execution Time | 2025-02-17 04:00:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bd653e6f48e_1739764844
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplOM9NL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corrgram_v1.14-tikzDictionary"
