# Validation Report - Davies@1.2.0
...
Overall the package has 32 exported objects. 32 are documented:
            ...
            davies.moment          davies.start               ddavies 
                     TRUE                  TRUE                  TRUE 
                ddavies.p                  dgld                dgld.p 
                     TRUE                  TRUE                  TRUE 
             expected.gld   expected.gld.approx        expected.value 
                     TRUE                  TRUE                  TRUE 
    expected.value.approx          fit.davies.p          fit.davies.q 
                     TRUE                  TRUE                  TRUE 
                 kurtosis         least.squares            likelihood 
                     TRUE                  TRUE                  TRUE 
                        M    maximum.likelihood                    mu 
                     TRUE                  TRUE                  TRUE 
       neg.log.likelihood             objective      objective.approx 
                     TRUE                  TRUE                  TRUE 
                  pdavies                  pgld                plotcf 
                     TRUE                  TRUE                  TRUE 
                  qdavies                  qgld               rdavies 
                     TRUE                  TRUE                  TRUE 
                     rgld               rstupid              skewness 
                     TRUE                  TRUE                  TRUE 
            twolines.vert              variance 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-24 03:25:26 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a44f38bec_1740367522
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuACls3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Davies_v1.2.0-tikzDictionary"
