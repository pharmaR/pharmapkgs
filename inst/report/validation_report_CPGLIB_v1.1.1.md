# Validation Report - CPGLIB@1.1.1
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Anthony Christidis <anthony.christidis@stat.ubc.ca>  |
...
Overall the package has 4 exported objects. 4 are documented:
            ...
            cpg      cv.cpg cv.ProxGrad    ProxGrad 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 04:13:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd642813d3d_1739765599
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUBgfi6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CPGLIB_v1.1.1-tikzDictionary"
