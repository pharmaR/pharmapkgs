# Validation Report - distcomp@1.3.3
...
Overall the package has 38 exported objects. 38 are documented:
     ...
     availableComputations   availableDataSources              CoxMaster 
                      TRUE                   TRUE                   TRUE 
                 CoxWorker createHEWorkerInstance      createNCPInstance 
                      TRUE                   TRUE                   TRUE 
      createWorkerInstance   defineNewComputation  destroyInstanceObject 
                      TRUE                   TRUE                   TRUE 
             distcompSetup        executeHEMethod          executeMethod 
                      TRUE                   TRUE                   TRUE 
                generateId     getComputationInfo              getConfig 
                      TRUE                   TRUE                   TRUE 
                  HEMaster     HEQueryCountMaster     HEQueryCountWorker 
                      TRUE                   TRUE                   TRUE 
            makeDefinition           makeHEMaster             makeMaster 
                      TRUE                   TRUE                   TRUE 
                   makeNCP             makeWorker                    NCP 
                      TRUE                   TRUE                   TRUE 
          QueryCountMaster       QueryCountWorker   resetComputationInfo 
                      TRUE                   TRUE                   TRUE 
            runDistcompApp     saveNewComputation             saveNewNCP 
                      TRUE                   TRUE                   TRUE 
        setComputationInfo            setupMaster            setupWorker 
                      TRUE                   TRUE                   TRUE 
                 SVDMaster              SVDWorker   uploadNewComputation 
                      TRUE                   TRUE                   TRUE 
              uploadNewNCP              writeCode 
                      TRUE                   TRUE 

### Examples

There are 30 help pages with examples, from 40 (75.00 %).
...
| Execution Time | 2025-02-18 04:17:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4130ce889_1739852263
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZ2xMyX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distcomp_v1.3.3-tikzDictionary"
