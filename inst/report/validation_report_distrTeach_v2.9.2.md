# Validation Report - distrTeach@2.9.2
...
| 2   | methods               | Depends |
| 3   | distr(\>= 2.2)        | Depends |
| 4   | distrEx(\>= 2.2)      | Depends |
| 5   | startupmsg(\>= 1.0.0) | Imports |
| 6   | grDevices             | Imports |
| 7   | graphics              | Imports |
| 8   | stats                 | Imports |
...
Overall the package has 3 exported objects. 4 are documented:
        ...
        illustrateCLT illustrateCLT.tcl     illustrateLLN 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:21:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bb413a6a9f8_1739852483
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwilN6v
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distrTeach_v2.9.2-tikzDictionary"
