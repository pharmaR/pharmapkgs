# Validation Report - excelR@0.4.0
...
| export_help          | 8                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Swechhya Bista <swechhyabista@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/Swechhya/excelR       |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | htmlwidgets (\>= 1.3) | Imports |
| 2   | jsonlite (\>= 1.6)    | Imports |
...
guiplot, sangeranalyseR

## Namespace

Overall the package has 8 exported objects. 8 are documented:

                    excel_to_R                excelOutput 
                          TRUE                       TRUE 
                    excelTable          get_selected_data 
                          TRUE                       TRUE 
    get_selected_data_boundary                getComments 
                          TRUE                       TRUE 
                   renderExcel                setComments 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-19 04:48:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d453a672f51_1739940512
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHK5gLW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_excelR_v0.4.0-tikzDictionary"
