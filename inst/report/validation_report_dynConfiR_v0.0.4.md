# Validation Report - dynConfiR@0.0.4
...
| export_help          | 32                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Sebastian Hellmann <sebastian.hellmann@ku.de> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/SeHellmann/dynConfiR       |
...
Overall the package has 32 exported objects. 32 are documented:
         ...
         CDFtoQuantiles               d2DSD            dDDMConf                dIRM 
                   TRUE                TRUE                TRUE                TRUE 
                  dIRM2               dPCRM                dWEV           fitRTConf 
                   TRUE                TRUE                TRUE                TRUE 
        fitRTConfModels            LogLikRM           LogLikWEV      PDFtoQuantiles 
                   TRUE                TRUE                TRUE                TRUE 
            predictConf   predictConfModels predictDDMConf_Conf   predictDDMConf_RT 
                   TRUE                TRUE                TRUE                TRUE 
         predictRM_Conf        predictRM_RT           predictRT     predictRTModels 
                   TRUE                TRUE                TRUE                TRUE 
        predictWEV_Conf       predictWEV_RT               r2DSD            rDDMConf 
                   TRUE                TRUE                TRUE                TRUE 
                   rIRM                rLCA               rPCRM           rRM_Kiani 
                   TRUE                TRUE                TRUE                TRUE 
                   rWEV          simulateRM      simulateRTConf         simulateWEV 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 05:05:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41ee8b623_1739855113
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLkLshZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dynConfiR_v0.0.4-tikzDictionary"
