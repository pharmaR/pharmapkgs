# Validation Report - crplyr@0.4.0
...
| has_source_control   | https://github.com/Crunch-io/crplyr  |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | crunch (\>= 1.15.3)  | Depends |
| 2   | dplyr                | Depends |
| 3   | methods              | Imports |
| 4   | ggplot2              | Imports |
| 5   | httptest (\>= 3.0.0) | Imports |
| 6   | lazyeval             | Imports |
| 7   | lifecycle            | Imports |
| 8   | purrr                | Imports |
| 9   | tibble               | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
            ...
            as_cr_tibble GroupedCrunchDataset         theme_crunch 
                    TRUE                 TRUE                 TRUE 
            unweighted_n 
                    TRUE 
...
| Execution Time | 2025-02-17 04:25:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bd643f6eb72_1739766338
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmphi9bpb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crplyr_v0.4.0-tikzDictionary"
