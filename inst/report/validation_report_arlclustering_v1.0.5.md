...
| export_help          | 23                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mohamed El-Moussaoui <med.elmoussaoui.ced@gmail.com> |
| bugs_status          | subscript out of bounds                              |
| size_codebase        | 273                                                  |
| has_source_control   | https://github.com/assuom44/arlclustering            |
...
Overall the package has 23 exported objects. 23 are documented:
                     ...
                     arlc_calculate_mode               arlc_clean_final_rules 
                                    TRUE                                 TRUE 
                      arlc_clusters_plot             arlc_convert_date_format 
                                    TRUE                                 TRUE 
                           arlc_count_na                      arlc_df_summary 
                                    TRUE                                 TRUE 
             arlc_fct_clean_transactions arlc_fct_get_best_apriori_thresholds 
                                    TRUE                                 TRUE 
               arlc_file_exists_readable                 arlc_gen_gross_rules 
                                    TRUE                                 TRUE 
                   arlc_gen_transactions               arlc_generate_clusters 
                                    TRUE                                 TRUE 
             arlc_generate_date_sequence                    arlc_generate_uid 
                                    TRUE                                 TRUE 
             arlc_get_apriori_thresholds             arlc_get_network_dataset 
                                    TRUE                                 TRUE 
                     arlc_get_NonR_rules           arlc_get_significant_rules 
                                    TRUE                                 TRUE 
                  arlc_is_numeric_vector                      arlc_list_to_df 
                                    TRUE                                 TRUE 
                       arlc_measure_time                arlc_normalize_vector 
                                    TRUE                                 TRUE 
                         arlc_replace_na 
                                    TRUE 
...
| Execution Time | 2025-02-14 07:24:06 UTC |
...
running this report
    ...
    PROCESSX_PS1c097927a9aa_1739517843
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplFeE06
