...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Josep Lluis Carrasco <jlcarrasco@ub.edu>             |
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            ccc_est ccc_est_by_time    ccc_sim_data          ccc_vc          ccclon 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            ccclonw          cccUst           cccvc       lme_model   sim_power_ccc 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              Ztest 
               TRUE 
...
| Execution Time | 2025-02-16 03:53:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36df7f236_1739677990
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLhpTJo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cccrm_v3.0.4-tikzDictionary"
