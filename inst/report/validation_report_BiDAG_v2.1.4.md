...
Overall the package has 37 exported objects. 37 are documented:
           ...
           bidag2coda    bidag2codalist      compact2full       compareDAGs 
                 TRUE              TRUE              TRUE              TRUE 
          compareDBNs connectedSubGraph          DAGscore          DBNscore 
                 TRUE              TRUE              TRUE              TRUE 
                edgep      full2compact            getDAG      getMCMCscore 
                 TRUE              TRUE              TRUE              TRUE 
           getRuntime          getSpace       getSubGraph          getTrace 
                 TRUE              TRUE              TRUE              TRUE 
              graph2m     iterativeMCMC          itercomp           learnBN 
                 TRUE              TRUE              TRUE              TRUE 
              m2graph            modelp         orderMCMC     partitionMCMC 
                 TRUE              TRUE              TRUE              TRUE 
             plot2in1           plotDBN         plotdiffs      plotdiffsDBN 
                 TRUE              TRUE              TRUE              TRUE 
             plotpcor        plotpedges          sampleBN        samplecomp 
                 TRUE              TRUE              TRUE              TRUE 
      scoreagainstDAG   scoreagainstDBN   scoreparameters        scorespace 
                 TRUE              TRUE              TRUE              TRUE 
           string2mat 
                 TRUE 
...
There are 50 help pages with examples, from 54 (92.59 %).
...
| Execution Time | 2025-02-15 04:02:07 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd77fe3410_1739592122
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzruVG9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BiDAG_v2.1.4-tikzDictionary"
