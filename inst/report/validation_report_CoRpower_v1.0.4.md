# Validation Report - CoRpower@1.0.4
...
| export_help          | 7                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Michal Juraska <mjuraska@fredhutch.org> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/mjuraska/CoRpower    |
...
Overall the package has 7 exported objects. 7 are documented:
           ...
           computeN    computePower   plotPowerCont    plotPowerTri plotROCcurveTri 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       plotRRgradVE   plotVElatCont 
               TRUE            TRUE 
...
| Execution Time | 2025-02-17 03:59:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67f9b7373_1739764743
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMx4jXc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CoRpower_v1.0.4-tikzDictionary"
