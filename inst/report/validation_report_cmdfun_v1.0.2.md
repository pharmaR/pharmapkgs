# Validation Report - cmdfun@1.0.2
...
| export_help          | 21                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Spencer Nystrom <nystromdev@gmail.com> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/snystrom/cmdfun     |
...
Overall the package has 21 exported objects. 21 are documented:
    ...
    .check_valid_command_path         .check_valid_util              cmd_args_all 
                         TRUE                      TRUE                      TRUE 
                cmd_args_dots            cmd_args_named      cmd_error_if_missing 
                         TRUE                      TRUE                      TRUE 
               cmd_file_combn           cmd_file_expect    cmd_help_flags_similar 
                         TRUE                      TRUE                      TRUE 
       cmd_help_flags_suggest      cmd_help_parse_flags         cmd_install_check 
                         TRUE                      TRUE                      TRUE 
         cmd_install_is_valid             cmd_list_drop       cmd_list_drop_named 
                         TRUE                      TRUE                      TRUE 
              cmd_list_interp             cmd_list_keep       cmd_list_keep_named 
                         TRUE                      TRUE                      TRUE 
            cmd_list_to_flags           cmd_path_search        cmd_ui_file_exists 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-16 04:43:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bc332a851c5_1739681019
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUx449g
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmdfun_v1.0.2-tikzDictionary"
