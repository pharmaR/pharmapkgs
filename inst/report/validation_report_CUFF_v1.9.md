...
| export_help          | 25                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Charles-Édouard Giguère <ce.giguere@gmail.com>       |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/giguerch/CUFF                     |
...
Overall the package has 25 exported objects. 22 are documented:

                  %+%               %n%             %xyb%                cf 
                FALSE             FALSE             FALSE              TRUE 
                 clip      column_types       correlation             cross 
                 TRUE              TRUE              TRUE              TRUE 
                 freq              ftab            meansd          numtostr 
                 TRUE              TRUE              TRUE              TRUE 
             pal_CUFF        print.corr       print.cross print.frequencies 
                 TRUE              TRUE              TRUE              TRUE 
                   pv             sum.n            to_csv            to_csv 
                 TRUE              TRUE              TRUE              TRUE 
                Total              view                xf              xtab 
                 TRUE              TRUE              TRUE              TRUE 
               xyboth 
...
| Execution Time | 2025-02-17 04:38:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6abd61d0_1739767100
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDEd9yQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CUFF_v1.9-tikzDictionary"
