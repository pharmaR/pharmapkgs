# Validation Report - edgebundleR@0.1.4
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Garth Tarr <garth.tarr@gmail.com>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/garthtarr/edgebundleR             |
...
Overall the package has 5 exported objects. 5 are documented:
          ...
          edgebundle edgebundleOutput renderEdgebundle   saveEdgebundle 
                TRUE             TRUE             TRUE             TRUE 
           shinyedge 
                TRUE 
...
| Execution Time | 2025-02-19 03:41:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d452841f860_1739936460
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpO5WBbm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_edgebundleR_v0.1.4-tikzDictionary"
