...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Marcin Dubel <marcindubel@gmail.com>                 |
...
Overall the package has 18 exported objects. 18 are documented:
                           ...
                           bma_summary                   exogenous_matrix 
                                  TRUE                               TRUE 
               feature_standardization                            hessian 
                                  TRUE                               TRUE 
                initialize_model_space                    join_lagged_col 
                                  TRUE                               TRUE 
                   likelihoods_summary                   matrices_from_df 
                                  TRUE                               TRUE 
                   optimal_model_space regressor_names_from_params_vector 
                                  TRUE                               TRUE 
                 residual_maker_matrix                       SEM_B_matrix 
                                  TRUE                               TRUE 
                          SEM_C_matrix                 SEM_dep_var_matrix 
                                  TRUE                               TRUE 
                        SEM_likelihood                     SEM_psi_matrix 
                                  TRUE                               TRUE 
                 SEM_regressors_matrix                   SEM_sigma_matrix 
                                  TRUE                               TRUE 
...
| Execution Time | 2025-02-15 03:49:06 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd14498dc_1739591341
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp32Rv8I
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bdsm_v0.1.0-tikzDictionary"
