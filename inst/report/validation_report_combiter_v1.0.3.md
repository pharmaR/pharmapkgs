# Validation Report - combiter@1.0.3
...
| export_help          | 15                                |
| has_website          | TRUE                              |
| has_maintainer       | Kota Mori <kmori05@gmail.com>     |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/kota7/combiter |
...
Overall the package has 15 exported objects. 15 are documented:
         ...
         getFirst       getLast       hasNext       hasPrev       icartes 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         icartesv         icomb        icombv         iperm        ipermv 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          isubset      isubsetv      nextElem      prevElem recursiveiter 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-16 05:03:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37a601e4a_1739682195
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpjn2Bmo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_combiter_v1.0.3-tikzDictionary"
