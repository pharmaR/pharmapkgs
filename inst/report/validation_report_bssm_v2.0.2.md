...
| export_help          | 46                                 |
| has_website          | TRUE                               |
| has_maintainer       | Jouni Helske <jouni.helske@iki.fi> |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/helske/bssm     |
...
Overall the package has 46 exported objects. 46 are documented:
               ...
               ar1_lg            ar1_ng           as_bssm          as_draws 
                 TRUE              TRUE              TRUE              TRUE 
          as_draws_df    asymptotic_var  bootstrap_filter            bsm_lg 
                 TRUE              TRUE              TRUE              TRUE 
               bsm_ng check_diagnostics cpp_example_model               ekf 
                 TRUE              TRUE              TRUE              TRUE 
    ekf_fast_smoother      ekf_smoother       ekpf_filter      estimate_ess 
                 TRUE              TRUE              TRUE              TRUE 
        expand_sample     fast_smoother             gamma       gamma_prior 
                 TRUE              TRUE              TRUE              TRUE 
      gaussian_approx        halfnormal  halfnormal_prior              iact 
                 TRUE              TRUE              TRUE              TRUE 
    importance_sample           kfilter            normal      normal_prior 
                 TRUE              TRUE              TRUE              TRUE 
    particle_smoother      post_correct          run_mcmc      sim_smoother 
                 TRUE              TRUE              TRUE              TRUE 
             smoother           ssm_mlg           ssm_mng           ssm_nlg 
                 TRUE              TRUE              TRUE              TRUE 
              ssm_sde           ssm_ulg           ssm_ung         suggest_N 
                 TRUE              TRUE              TRUE              TRUE 
                  svm           tnormal     tnormal_prior               ukf 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:50:53 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4fc4abee_1739595047
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJvMs3d
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bssm_v2.0.2-tikzDictionary"
