# Validation Report - fdrtool@1.2.18
...
admix, asm, carSurv, crossmeta, DEP, DiffCorr, DMCHMM, dsos, EGRNi, ERP,
FitHiC, frontier, GeneCycle, GeneNet, ggisotonic, GiANT, GSRI, HDMT,
hdthreshold, HybridMTest, iclogcondist, idiolect, IHW, InvStablePrior,
les, LorMe, medScan, meshr, metapone, MixTwice, MonotoneHazardRatio,
mutoss, NetworkToolbox, nlnet, oposSOM, OVESEG, PolySTest, qgraph,
rags2ridges, rnmamod, Rtpca, sand, sda, SimSeq, SOHPIE, st, survML,
TBEST, vaccine, wrMisc, wrProteo, wrTopDownFrag

## Namespace

Overall the package has 23 exported objects. 23 are documented:

          censored.fit              dcor0          dhalfnorm            fdrtool 
                  TRUE               TRUE               TRUE               TRUE 
        fitted.monoreg        fndr.cutoff             gcmlcm          grenander 
                  TRUE               TRUE               TRUE               TRUE 
              hc.score          hc.thresh            monoreg              pcor0 
                  TRUE               TRUE               TRUE               TRUE 
             phalfnorm     plot.grenander       plot.monoreg pval.estimate.eta0 
                  TRUE               TRUE               TRUE               TRUE 
                 qcor0          qhalfnorm              rcor0  residuals.monoreg 
                  TRUE               TRUE               TRUE               TRUE 
             rhalfnorm           sd2theta           theta2sd 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-27 03:23:56 UTC |
...
running this report
    ...
    PROCESSX_PS1c625db4ab59_1740626632
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWSBQGc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fdrtool_v1.2.18-tikzDictionary"
