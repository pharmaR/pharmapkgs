# Validation Report - catalog@0.1.1
...
| export_help          | 21                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Nathan Eastwood <nathan.eastwood@icloud.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/nathaneastwood/catalog    |
...
Overall the package has 21 exported objects. 21 are documented:
              ...
              cache_table           clear_cache          create_table 
                     TRUE                  TRUE                  TRUE 
         current_database       database_exists drop_global_temp_view 
                     TRUE                  TRUE                  TRUE 
           drop_temp_view       function_exists          get_function 
                     TRUE                  TRUE                  TRUE 
                get_table             is_cached          list_columns 
                     TRUE                  TRUE                  TRUE 
           list_databases        list_functions           list_tables 
                     TRUE                  TRUE                  TRUE 
       recover_partitions       refresh_by_path         refresh_table 
                     TRUE                  TRUE                  TRUE 
     set_current_database          table_exists         uncache_table 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 03:45:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3684c4687_1739677554
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSbujey
...
These are the options set to generate the report:
    ...
    [1] "validation_report_catalog_v0.1.1-tikzDictionary"
