# Validation Report - camtrapR@2.3.0
...
| export_help | 33 |
| has_website | TRUE |
| has_maintainer | Juergen Niedballa <camtrapr@gmail.com> |
| bugs_status | scraping bug reports fromm BugReports host ‘google’ not implemented |
| has_source_control | https://github.com/jniedballa/camtrapR |
...
Overall the package has 28 exported objects. 31 are documented:

               activityDensity          activityHistogram 
                          TRUE                       TRUE 
               activityOverlap             activityRadial 
                          TRUE                       TRUE 
               addCopyrightTag                  addToPath 
                          TRUE                       TRUE 
            appendSpeciesNames            cameraOperation 
                          TRUE                       TRUE 
    checkSpeciesIdentification          checkSpeciesNames 
                          TRUE                       TRUE 
                communityModel       createSpeciesFolders 
                          TRUE                       TRUE 
          createStationFolders           detectionHistory 
                          TRUE                       TRUE 
                 detectionMaps               exifTagNames 
                          TRUE                       TRUE 
             filterRecordTable        fixDateTimeOriginal 
                          TRUE                       TRUE 
              getSpeciesImages                imageRename 
                          TRUE                       TRUE 
                 OCRdataFields                recordTable 
                          TRUE                       TRUE 
         recordTableIndividual    spatialDetectionHistory 
                          TRUE                       TRUE 
               surveyDashboard               surveyReport 
                          TRUE                       TRUE 
               timeShiftImages      writeDateTimeOriginal 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-16 03:37:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bc355fd6e8c_1739677033
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8ApMAy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_camtrapR_v2.3.0-tikzDictionary"
