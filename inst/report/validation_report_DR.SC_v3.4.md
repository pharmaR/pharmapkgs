...
| export_help          | 15                                |
| has_website          | TRUE                              |
| has_maintainer       | Wei Liu <liuweideng@gmail.com>    |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/feiyoung/DR.SC |
...
| 11  | methods          | Imports   |
| 12  | purrr            | Imports   |
| 13  | S4Vectors        | Imports   |
| 14  | RColorBrewer     | Imports   |
| 15  | Rcpp (\>= 1.0.5) | Imports   |
| 16  | Seurat           | Imports   |
| 17  | stats            | Imports   |
| 18  | Rcpp             | LinkingTo |
...
Overall the package has 15 exported objects. 15 are documented:
                  ...
                  DR.SC           DR.SC_fit            drscPlot            FindSVGs 
                   TRUE                TRUE                TRUE                TRUE 
         gendata_RNAExp              getAdj         getAdj_auto       getAdj_manual 
                   TRUE                TRUE                TRUE                TRUE 
               mbicPlot       read10XVisium        readscRNAseq             RunWPCA 
                   TRUE                TRUE                TRUE                TRUE 
            selectModel spatialPlotClusters             topSVGs 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 04:42:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43d11769e_1739853739
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpr2cVEl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DR.SC_v3.4-tikzDictionary"
