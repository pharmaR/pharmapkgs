# Validation Report - ecmwfr@2.0.3
...
| bugs_status          | 1                                        |
| has_source_control   | https://github.com/bluegreen-labs/ecmwfr |
...
Overall the package has 10 exported objects. 10 are documented:
        ...
        wf_archetype wf_check_request  wf_dataset_info      wf_datasets 
                TRUE             TRUE             TRUE             TRUE 
           wf_delete       wf_get_key       wf_request wf_request_batch 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 03:33:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d455598e8e1_1739935999
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB1y5Dj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecmwfr_v2.0.3-tikzDictionary"
