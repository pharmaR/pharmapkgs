# Validation Report - biosampleR@1.0.4
...
| export_help          | 5                                                |
| has_website          | TRUE                                             |
| has_maintainer       | Craig Eric Simpkins <simpkinscraig063@gmail.com> |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/csim063/biosampleR            |
...
Overall the package has 5 exported objects. 5 are documented:
            ...
            calc_delta_var calc_diversity_indices        create_resample 
                      TRUE                   TRUE                   TRUE 
       generate_subsamples       get_sample_stats 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:14:53 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd35a3123f_1739592888
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdK4CUU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biosampleR_v1.0.4-tikzDictionary"
