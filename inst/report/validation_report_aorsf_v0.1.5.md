...
| export_help          | 28                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Byron Jaeger <bjaeger@wakehealth.edu> |
| bugs_status          | 0.8                                   |
| size_codebase        | 4994                                  |
| has_source_control   | https://github.com/ropensci/aorsf     |
...
Overall the package has 28 exported objects. 28 are documented:
                           ...
                           orsf                orsf_control 
                           TRUE                        TRUE 
    orsf_control_classification            orsf_control_cph 
                           TRUE                        TRUE 
            orsf_control_custom           orsf_control_fast 
                           TRUE                        TRUE 
               orsf_control_net     orsf_control_regression 
                           TRUE                        TRUE 
          orsf_control_survival                orsf_ice_inb 
                           TRUE                        TRUE 
                   orsf_ice_new                orsf_ice_oob 
                           TRUE                        TRUE 
                    orsf_pd_inb                 orsf_pd_new 
                           TRUE                        TRUE 
                    orsf_pd_oob              orsf_scale_cph 
                           TRUE                        TRUE 
             orsf_summarize_uni          orsf_time_to_train 
                           TRUE                        TRUE 
                     orsf_train            orsf_unscale_cph 
                           TRUE                        TRUE 
                    orsf_update                     orsf_vi 
                           TRUE                        TRUE 
                  orsf_vi_anova              orsf_vi_negate 
                           TRUE                        TRUE 
                orsf_vi_permute                   orsf_vint 
                           TRUE                        TRUE 
                        orsf_vs              pred_spec_auto 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-14 07:16:38 UTC |
...
running this report
    ...
    PROCESSX_PS1c0961fe8a34_1739517395
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAINEcg
