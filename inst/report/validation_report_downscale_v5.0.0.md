# Validation Report - downscale@5.0.0
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Charles Marsh <charlie.marsh@mailbox.org>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/charliem2003/downscale            |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | cubature (\>= 1.1-2)   | Imports |
| 2   | graphics               | Imports |
| 3   | grDevices              | Imports |
| 4   | methods                | Imports |
| 5   | minpack.lm (\>= 1.1-9) | Imports |
| 6   | Rmpfr                  | Imports |
| 7   | stats                  | Imports |
| 8   | sf (\>= 1.0-9)         | Imports |
| 9   | terra (\>= 1.7-3)      | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
                 ...
                 downscale     ensemble.downscale          hui.downscale 
                      TRUE                   TRUE                   TRUE 
    plot.predict.downscale      predict.downscale                upgrain 
                      TRUE                   TRUE                   TRUE 
         upgrain.threshold 
                      TRUE 
...
| Execution Time | 2025-02-18 04:39:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4174a142f_1739853541
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuZi4pR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_downscale_v5.0.0-tikzDictionary"
