# Validation Report - ergMargins@1.3
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Scott Duxbury <duxbury@email.unc.edu>                |
...
Overall the package has 6 exported objects. 6 are documented:
      ...
      edge.prob2     ergm.AME     ergm.MEM     ergm.mma ergm.mod.mma     vif.ergm 
...
| Execution Time | 2025-02-19 04:26:20 UTC |
...
running this report
    ...
    PROCESSX_PS1d455ca34617_1739939174
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpL4BTf9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ergMargins_v1.3-tikzDictionary"
