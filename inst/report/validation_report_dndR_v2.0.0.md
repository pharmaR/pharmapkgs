...
| export_help          | 35                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Nicholas Lyon <njlyon@alumni.iastate.edu> |
...
Overall the package has 35 exported objects. 35 are documented:
       ...
       ability_scores  ability_singular       class_block              coin 
                 TRUE              TRUE              TRUE              TRUE 
           cr_convert     creature_list     creature_text               d10 
                 TRUE              TRUE              TRUE              TRUE 
                 d100               d12                d2               d20 
                 TRUE              TRUE              TRUE              TRUE 
                   d3                d4                d6                d8 
                 TRUE              TRUE              TRUE              TRUE 
          dnd_classes  dnd_damage_types         dnd_races encounter_creator 
                 TRUE              TRUE              TRUE              TRUE 
             mod_calc   monster_creator     monster_stats       npc_creator 
                 TRUE              TRUE              TRUE              TRUE 
        party_diagram        pc_creator     pc_level_calc  probability_plot 
                 TRUE              TRUE              TRUE              TRUE 
            race_mods            reroll              roll        spell_list 
                 TRUE              TRUE              TRUE              TRUE 
           spell_text           xp_cost           xp_pool 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:29:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45bff4c39_1739852946
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkLNLu5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dndR_v2.0.0-tikzDictionary"
