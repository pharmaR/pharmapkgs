# Validation Report - clusternomics@0.1.1
...
| export_help          | 8                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Evelina Gabasova <egabasova@gmail.com>    |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/evelinag/clusternomics |
...
Overall the package has 8 exported objects. 8 are documented:
           ...
           clusterSizes  coclusteringMatrix      contextCluster empiricalBayesPrior 
                   TRUE                TRUE                TRUE                TRUE 
          generatePrior generateTestData_1D generateTestData_2D    numberOfClusters 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:39:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bc355717d14_1739680777
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp86rnk1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clusternomics_v0.1.1-tikzDictionary"
