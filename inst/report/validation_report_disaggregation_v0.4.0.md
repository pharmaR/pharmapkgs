# Validation Report - disaggregation@0.4.0
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tim Lucas <timcdlucas@gmail.com>                     |
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            as.disag_data            build_mesh           disag_model 
                     TRUE                  TRUE                  TRUE 
      getCovariateRasters        getPolygonData      getStartendindex 
                     TRUE                  TRUE                  TRUE 
        make_model_object plot_disag_model_data         predict_model 
                     TRUE                  TRUE                  TRUE 
      predict_uncertainty          prepare_data 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-18 04:10:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4163e4666_1739851851
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzEwBvh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_disaggregation_v0.4.0-tikzDictionary"
