...
| export_help          | 36                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Leah F. South <l1.south@qut.edu.au>                  |
...
Overall the package has 27 exported objects. 33 are documented:

                           bsl                 cell_prior 
                          TRUE                       TRUE 
                      cell_sim                   cell_sum 
                          TRUE                       TRUE 
               combinePlotsBSL                    cor2cov 
                          TRUE                       TRUE 
               estimateLoglike    estimateWhiteningMatrix 
                          TRUE                       TRUE 
              gaussianRankCorr            gaussianSynLike 
                          TRUE                       TRUE 
    gaussianSynLikeGhuryeOlkin                  ma2_prior 
                          TRUE                       TRUE 
                       ma2_sim                ma2_sim_vec 
                          TRUE                       TRUE 
                       ma2_sum                   mgnk_sim 
                      ...
                      mgnk_sum                   newModel 
                          TRUE                       TRUE 
                 obsMat2deltax              selectPenalty 
                          TRUE                       TRUE 
        semiparaKernelEstimate                   sim_toad 
                          TRUE                       TRUE 
                 simulate_cell             synLikeMisspec 
                          TRUE                       TRUE 
                    toad_prior                   toad_sim 
                          TRUE                       TRUE 
                      toad_sum 
...
| Execution Time | 2025-02-15 04:49:20 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd585b8de1_1739594955
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdmAAk2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BSL_v3.2.5-tikzDictionary"
