# Validation Report - BinaryDosage@1.0.0
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | John Morrison <jmorr@usc.edu>                        |
...
Overall the package has 13 exported objects. 13 are documented:
       ...
       bdapply    bdmerge   genapply    gentobd     getaaf  getbdinfo getgeninfo 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
        getmaf     getrsq     getsnp getvcfinfo   vcfapply    vcftobd 
...
| Execution Time | 2025-02-15 04:07:26 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd339b193e_1739592441
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfXGOTI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BinaryDosage_v1.0.0-tikzDictionary"
