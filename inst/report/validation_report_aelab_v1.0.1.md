...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Zhao-Jun Yong <nuannuan0425@gmail.com>               |
...
Overall the package has 12 exported objects. 12 are documented:
            ...
            calculate_do   calculate_ghg_flux calculate_regression 
                    TRUE                 TRUE                 TRUE 
            combine_hobo      combine_weather     convert_ghg_unit 
                    TRUE                 TRUE                 TRUE 
            convert_time            plot_hobo         process_hobo 
                    TRUE                 TRUE                 TRUE 
            process_info      process_weather    tidy_ghg_analyzer 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-14 06:40:37 UTC |
...
running this report
    ...
    PROCESSX_PS726d33166117_1739515234
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphC4F1b
