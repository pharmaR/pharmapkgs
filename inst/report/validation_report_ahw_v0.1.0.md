...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Pål Christie Ryalen <p.c.ryalen@medisin.uio.no>      |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    addNoiseAtEventTimes      makeContWeights            naReplace 
                    TRUE                 TRUE                 TRUE 
         plotContWeights          refineTable 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-14 06:44:43 UTC |
...
running this report
    ...
    PROCESSX_PS726d6654a808_1739515480
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsYo2Io
