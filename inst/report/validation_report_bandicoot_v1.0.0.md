...
| export_help          | 27                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Weihao Li <llreczx@gmail.com>           |
| bugs_status          | 0.8571429                               |
| size_codebase        | 554                                     |
| has_source_control   | https://github.com/TengMCing/bandicoot/ |
...
Overall the package has 27 exported objects. 16 are documented:

                 %-%             %-=%              %+%             %+=% 
               FALSE            FALSE            FALSE            FALSE 
          %contains%             %eq%             %ge%             %gt% 
               FALSE            FALSE            FALSE            FALSE 
                %le%             %lt%             %ne% as_bandicoot_oop 
               FALSE            FALSE            FALSE             TRUE 
                BASE            base_    bind_fn_2_env     check_method 
                TRUE             TRUE             TRUE             TRUE 
           copy_attr    define_pkg_fn is_bandicoot_oop             iter 
                TRUE             TRUE             TRUE             TRUE 
                 len        new_class  register_method             repr 
                TRUE             TRUE             TRUE             TRUE 
    sub_fn_body_name            super       use_method 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-14 07:41:44 UTC |
...
running this report
    ...
    PROCESSX_PS1c09616bee12_1739518901
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1i75UZ
