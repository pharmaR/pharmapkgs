# Validation Report - EquiSurv@0.1.0
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Kathrin Moellenhoff <kathrin.moellenhoff@rub.de>     |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    boot_exponential    boot_gaussian    boot_logistic boot_loglogistic 
                TRUE             TRUE             TRUE             TRUE 
      boot_lognormal     boot_weibull     confint_diff  confint_km_diff 
                TRUE             TRUE             TRUE             TRUE 
           test_diff      test_nonpar 
                TRUE             TRUE 
...
| Execution Time | 2025-02-19 04:24:15 UTC |
...
running this report
    ...
    PROCESSX_PS1d4548a7e276_1739939049
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpa0GQ6c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EquiSurv_v0.1.0-tikzDictionary"
