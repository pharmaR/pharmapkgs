...
| export_help          | 34                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Fraser Morton <fraser.morton@glasgow.ac.uk> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/fragla/eq5d              |
...
Overall the package has 34 exported objects. 34 are documented:
                              ...
                              eq5drcw                             eq5dy 
                                 TRUE                              TRUE 
                              eq5dy3l             get_all_health_states 
                                 TRUE                              TRUE 
    get_dimensions_from_health_states get_health_states_from_dimensions 
                                 TRUE                              TRUE 
        getDimensionsFromHealthStates                   getHealthStates 
                                 TRUE                              TRUE 
        getHealthStatesFromDimensions                               hpg 
                                 TRUE                              TRUE 
                                 hsdi                               lfs 
                                 TRUE                              TRUE 
                                  lss                              pchc 
...
| Execution Time | 2025-02-19 04:22:31 UTC |
...
running this report
    ...
    PROCESSX_PS1d452d1946f7_1739938945
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpD8V8ay
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eq5d_v0.15.6-tikzDictionary"
