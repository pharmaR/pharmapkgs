# Validation Report - closeloop@0.1.0
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Shubhram Pandey <shubhram1992@gmail.com>             |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/heorlytics/closeloop              |
...
Overall the package has 4 exported objects. 4 are documented:
         ...
         calc_dist     check_data        is_prop specify_weight 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:35:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bc360f11dd3_1739680507
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpulnIi1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_closeloop_v0.1.0-tikzDictionary"
