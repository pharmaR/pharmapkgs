# Validation Report - edgarWebR@1.1.0
...
| export_help          | 26                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Micah J Waldstein <micah@waldste.in>    |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/mwaldstein/edgarWebR |
...
Overall the package has 26 exported objects. 26 are documented:
                        ...
                        cik_search                company_details 
                              TRUE                           TRUE 
                   company_filings                   company_href 
                              TRUE                           TRUE 
               company_information                 company_search 
                              TRUE                           TRUE 
                    current_events                  effectiveness 
                              TRUE                           TRUE 
                    filing_details               filing_documents 
                              TRUE                           TRUE 
                     filing_filers                   filing_funds 
                              TRUE                           TRUE 
                filing_information                      full_text 
                              TRUE                           TRUE 
                  fund_fast_search                    fund_search 
                              TRUE                           TRUE 
                     header_search                 latest_filings 
                              TRUE                           TRUE 
                      parse_filing               parse_submission 
                              TRUE                           TRUE 
                 parse_text_filing           submission_file_href 
                              TRUE                           TRUE 
                   submission_href          submission_index_href 
                              TRUE                           TRUE 
    variable_insurance_fast_search      variable_insurance_search 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-19 03:40:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d45d1921f_1739936446
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7tgyYs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_edgarWebR_v1.1.0-tikzDictionary"
