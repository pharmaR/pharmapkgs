...
| export_help | 29 |
| has_website | TRUE |
| has_maintainer | Guillermo Roditi Dominguez <guillermo@newriverinvestments.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/groditi/blsR |
...
Overall the package has 29 exported objects. 29 are documented:
                 ...
                 bls_get_key              bls_has_key              bls_request 
                        TRUE                     TRUE                     TRUE 
                 bls_set_key            bls_unset_key            data_as_table 
                        TRUE                     TRUE                     TRUE 
          data_as_tidy_table          get_all_surveys   get_latest_observation 
                        TRUE                     TRUE                     TRUE 
                get_n_series       get_n_series_table       get_popular_series 
                        TRUE                     TRUE                     TRUE 
                  get_series         get_series_table        get_series_tables 
                        TRUE                     TRUE                     TRUE 
             get_survey_info             merge_tables        merge_tidy_tables 
                        TRUE                     TRUE                     TRUE 
           query_all_surveys query_latest_observation           query_n_series 
                        TRUE                     TRUE                     TRUE 
        query_popular_series             query_series        query_survey_info 
                        TRUE                     TRUE                     TRUE 
    reduce_spanned_responses     span_request_queries      span_series_request 
                        TRUE                     TRUE                     TRUE 
                tidy_periods        tidy_table_as_zoo 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-15 04:25:30 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd17309188_1739593525
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpwrzoj9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blsR_v0.5.0-tikzDictionary"
