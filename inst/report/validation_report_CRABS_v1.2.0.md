...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Bjørn Tore Kopperud <kopperud@protonmail.com>        |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/afmagee/CRABS                     |
...
Overall the package has 14 exported objects. 14 are documented:
                     ...
                     congruent.models               crabs.loglikelihood 
                                 TRUE                              TRUE 
                         create.model   full.plot.regularity.thresholds 
                                 TRUE                              TRUE 
               joint.congruent.models                          model2df 
                                 TRUE                              TRUE 
                        read.RevBayes               sample.basic.models 
                                 TRUE                              TRUE 
            sample.basic.models.joint           sample.congruence.class 
                                 TRUE                              TRUE 
    sample.congruence.class.posterior                      sample.rates 
                                 TRUE                              TRUE 
                  summarize.posterior                  summarize.trends 
                                 TRUE                              TRUE 
...
| Execution Time | 2025-02-17 04:17:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bd678f25e44_1739765817
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpS6rRov
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CRABS_v1.2.0-tikzDictionary"
