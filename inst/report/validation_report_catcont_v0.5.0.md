# Validation Report - catcont@0.5.0
...
| export_help | 9 |
| has_website | TRUE |
| has_maintainer | Christopher Brown <chris.brown@decisionpatterns.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/decisionpatterns/catcont |
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          cat_cont         is_cat        is_cont  mutate_if_cat mutate_if_cont 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        select_cat    select_cont      which_cat     which_cont 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 03:46:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3479a104f_1739677575
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0BDUOf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_catcont_v0.5.0-tikzDictionary"
