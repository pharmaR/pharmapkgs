# Validation Report - fastpng@0.1.7
...
| has_source_control   | https://github.com/coolbutuseless/fastpng |
...
|     | package               | type      |
|:----|:----------------------|:----------|
| 1   | colorfast             | LinkingTo |
| 2   | colorfast (\>= 1.0.1) | Imports   |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         get_png_info          raw_spec          read_png spng_decode_flags 
                 TRUE              TRUE              TRUE              TRUE 
            write_png 
                 TRUE 
...
| Execution Time | 2025-02-19 05:20:15 UTC |
...
running this report
    ...
    PROCESSX_PS1d457a70b6c1_1739942409
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwwsOzB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastpng_v0.1.7-tikzDictionary"
