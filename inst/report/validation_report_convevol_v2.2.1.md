# Validation Report - convevol@2.2.1
...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | C. Tristan Stayton <tstayton@bucknell.edu>           |
...
Overall the package has 22 exported objects. 22 are documented:
           ...
           allmaxdist ancestrallineages       calcchanges          calcConv 
                 TRUE              TRUE              TRUE              TRUE 
           calcConvCt            calcCs          calcCsCt           convnum 
                 TRUE              TRUE              TRUE              TRUE 
           convnumsig           convrat        convratsig           convSig 
                 TRUE              TRUE              TRUE              TRUE 
            convSigCt           findanc   labelstonumbers           maxdist 
                 TRUE              TRUE              TRUE              TRUE 
             multianc            plot2D            plotCt       plotellipse 
                 TRUE              TRUE              TRUE              TRUE 
          pullNodeSeq           pwCheck 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-17 03:51:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bd619d6608c_1739764305
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBa0dbt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_convevol_v2.2.1-tikzDictionary"
