# Validation Report - condvis@0.5.1
...
| export_help          | 12                                  |
| has_website          | TRUE                                |
| has_maintainer       | Mark O’Connell <mark_ajoc@yahoo.ie> |
...
Overall the package has 12 exported objects. 12 are documented:
            ...
            arrangeC           ceplot         condtour       cont2color 
                TRUE             TRUE             TRUE             TRUE 
               dist1     factor2color      interpolate         makepath 
                TRUE             TRUE             TRUE             TRUE 
              plotxc           plotxs       savingby2d similarityweight 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 03:41:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bd641d99861_1739763708
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMcc7w4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_condvis_v0.5.1-tikzDictionary"
