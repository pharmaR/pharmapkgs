...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Kuan-Yu (Alex) Chen <alexkychen@gmail.com>           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 3843                                                 |
| has_source_control   | https://github.com/alexkychen/assignPOP              |
...
Overall the package has 13 exported objects. 13 are documented:
     ...
     accuracy.kfold     accuracy.MC   accuracy.plot    assign.kfold   assign.matrix 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          assign.MC        assign.X      check.loci    compile.data membership.plot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       read.Genepop  read.Structure   reduce.allele 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 07:28:38 UTC |
...
running this report
    ...
    PROCESSX_PS1c09798127cc_1739518115
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxYj93h
