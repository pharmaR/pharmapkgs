# Validation Report - bigchess@1.9.1
...
| export_help          | 33                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Wojciech Rosa <w.rosa@pollub.pl>                     |
...
Overall the package has 33 exported objects. 33 are documented:
          ...
          analyze_game   analyze_position browse_eco_opening     browse_opening 
                  TRUE               TRUE               TRUE               TRUE 
         extract_moves            lan2san            n_moves     player_profile 
                  TRUE               TRUE               TRUE               TRUE 
         plot_tree_eco     plot_tree_move           read.pgn        read.pgn.db 
                  TRUE               TRUE               TRUE               TRUE 
           read.pgn.ff            san2lan         stat_moves           tree_eco 
                  TRUE               TRUE               TRUE               TRUE 
             tree_move            uci_cmd          uci_debug         uci_engine 
                  TRUE               TRUE               TRUE               TRUE 
                uci_go        uci_isready          uci_parse      uci_ponderhit 
                  TRUE               TRUE               TRUE               TRUE 
          uci_position           uci_quit           uci_read       uci_register 
                  TRUE               TRUE               TRUE               TRUE 
         uci_setoption           uci_stop            uci_uci     uci_ucinewgame 
                  TRUE               TRUE               TRUE               TRUE 
             write.pgn 
                  TRUE 
...
| Execution Time | 2025-02-15 04:03:12 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd25fb1fb0_1739592187
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9XwsTl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigchess_v1.9.1-tikzDictionary"
