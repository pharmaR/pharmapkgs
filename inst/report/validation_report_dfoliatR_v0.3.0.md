# Validation Report - dfoliatR@0.3.0
...
| export_help          | 20                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Chris Guiterman <christopher.guiterman@noaa.gov> |
...
Overall the package has 20 exported objects. 20 are documented:
             ...
             as_defol            as_obr          as.defol            as.obr 
                 TRUE              TRUE              TRUE              TRUE 
                defol       defol_stats   defoliate_trees  get_defol_events 
                 TRUE              TRUE              TRUE              TRUE 
                  gsi    id_defoliation          is.defol            is.obr 
                 TRUE              TRUE              TRUE              TRUE 
                  obr          outbreak    outbreak_stats        plot_defol 
                 TRUE              TRUE              TRUE              TRUE 
        plot_outbreak      sample_depth      series_names stack_defoliation 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 03:54:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4fd9d480_1739850865
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJMkTKq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dfoliatR_v0.3.0-tikzDictionary"
