# Validation Report - camtrapdp@0.3.1
...
| export_help          | 18                                  |
| has_website          | TRUE                                |
| has_maintainer       | Peter Desmet <peter.desmet@inbo.be> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/inbo/camtrapdp   |
...
Overall the package has 18 exported objects. 17 are documented:
                    ...
                    %>%     check_camtrapdp         deployments       deployments<- 
                  FALSE                TRUE                TRUE                TRUE 
                 events     example_dataset  filter_deployments        filter_media 
                   TRUE                TRUE                TRUE                TRUE 
    filter_observations           locations               media             media<- 
                   TRUE                TRUE                TRUE                TRUE 
           observations      observations<-      read_camtrapdp                taxa 
                   TRUE                TRUE                TRUE                TRUE 
                version           write_dwc 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 03:37:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bc311ea1c1f_1739677027
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpx18yKO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_camtrapdp_v0.3.1-tikzDictionary"
