# Validation Report - datana@1.0.5
...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Christian Salas-Eljatib <cseljatib@gmail.com>        |
...
Overall the package has 16 exported objects. 16 are documented:
                  ...
                  cdf          contrast       deleteRight          descstat 
                 TRUE              TRUE              TRUE              TRUE 
    findColumn.byname             gmean             kurto               lrt 
                 TRUE              TRUE              TRUE              TRUE 
                 moda             pvalt             pvalz              skew 
                 TRUE              TRUE              TRUE              TRUE 
          timeserplot         xyboxplot            xyhist       xymultiplot 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:58:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66ec7cfa5_1739768324
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjkNnHU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datana_v1.0.5-tikzDictionary"
