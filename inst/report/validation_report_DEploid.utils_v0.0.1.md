# Validation Report - DEploid.utils@0.0.1
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            computeObsWSAF extractCoverageFromTxt extractCoverageFromVcf 
                      TRUE                   TRUE                   TRUE 
               extractPLAF       haplotypePainter               histWSAF 
                      TRUE                   TRUE                   TRUE 
              plotAltVsRef         plotObsExpWSAF        plotProportions 
                      TRUE                   TRUE                   TRUE 
            plotWSAFvsPLAF 
                      TRUE 
...
| Execution Time | 2025-02-18 03:44:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4566a5b49_1739850257
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1HQLy0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DEploid.utils_v0.0.1-tikzDictionary"
