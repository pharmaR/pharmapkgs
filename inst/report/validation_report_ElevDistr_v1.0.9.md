# Validation Report - ElevDistr@1.0.9
...
| export_help          | 8                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Livio Bätscher <livio_999@hotmail.com>      |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/LivioBaetscher/ElevDistr |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         calculate_distance classify_above_treeline    distance_to_treeline 
                       TRUE                    TRUE                    TRUE 
              generate_grid       generate_point_df       get_nearest_point 
                       TRUE                    TRUE                    TRUE 
                 plot_distr         sample_treeline 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-19 03:55:29 UTC |
...
running this report
    ...
    PROCESSX_PS1d4558f8444c_1739937323
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpX8ujn3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ElevDistr_v1.0.9-tikzDictionary"
