# Validation Report - dbi.table@1.0.3
...
| export_help          | 14                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Kjell P. Konis <kjellk@gmail.com>    |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/kjellpk/dbi.table |
...
Overall the package has 10 exported objects. 10 are documented:
      ...
      as.dbi.table chinook.duckdb chinook.sqlite           csql     dbi.attach 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       dbi.catalog      dbi.table   is.dbi.table reference.test       sql.join 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 05:06:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6198ae9b9_1739768792
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpD19Vk1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dbi.table_v1.0.3-tikzDictionary"
