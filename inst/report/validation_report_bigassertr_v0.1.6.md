# Validation Report - bigassertr@0.1.6
...
| has_source_control   | https://github.com/privefl/bigassertr      |
...
bigparallelr, bigreadr, bigsnpr, bigsparser, bigstatsr, bigutilsr, rmio,
runonce
...
Overall the package has 25 exported objects. 25 are documented:
               ...
               assert_01           assert_all          assert_args 
                    TRUE                 TRUE                 TRUE 
            assert_class assert_class_or_null assert_df_with_names 
                    TRUE                 TRUE                 TRUE 
              assert_dir         assert_exist           assert_ext 
                    TRUE                 TRUE                 TRUE 
              assert_int       assert_lengths      assert_multiple 
                    TRUE                 TRUE                 TRUE 
           assert_nodots       assert_noexist          assert_nona 
                    TRUE                 TRUE                 TRUE 
         assert_one_bool       assert_one_int       assert_package 
                    TRUE                 TRUE                 TRUE 
              assert_pos        assert_sorted          assert_type 
                    TRUE                 TRUE                 TRUE 
                message2               printf                stop2 
                    TRUE                 TRUE                 TRUE 
                warning2 
                    TRUE 
...
| Execution Time | 2025-02-15 04:03:01 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd47aa475c_1739592176
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFgoxXm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigassertr_v0.1.6-tikzDictionary"
