...
| export_help          | 27                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Mark Pletscher <pletscher.mark@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| size_codebase        | 1621                                      |
| has_source_control   | https://github.com/pletschm/aldvmm/       |
...
Overall the package has 27 exported objects. 27 are documented:
                 ...
                 aldvmm        aldvmm.check           aldvmm.cv     aldvmm.getnames 
                   TRUE                TRUE                TRUE                TRUE 
          aldvmm.getpar          aldvmm.gof           aldvmm.gr         aldvmm.init 
                   TRUE                TRUE                TRUE                TRUE 
              aldvmm.ll           aldvmm.mm         aldvmm.pred           aldvmm.sc 
                   TRUE                TRUE                TRUE                TRUE 
           aldvmm.sefit          aldvmm.sum           aldvmm.tm         coef.aldvmm 
                   TRUE                TRUE                TRUE                TRUE 
          estfun.aldvmm      formula.aldvmm model.matrix.aldvmm         nobs.aldvmm 
                   TRUE                TRUE                TRUE                TRUE 
         predict.aldvmm        print.aldvmm    residuals.aldvmm      summary.aldvmm 
                   TRUE                TRUE                TRUE                TRUE 
           terms.aldvmm       update.aldvmm         vcov.aldvmm 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-14 06:47:40 UTC |
...
running this report
    ...
    PROCESSX_PS726d6cd6239d_1739515657
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB1Ru5I
