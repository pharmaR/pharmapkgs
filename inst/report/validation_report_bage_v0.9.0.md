...
| export_help          | 41                                         |
| has_website          | TRUE                                       |
| has_maintainer       | John Bryant <john@bayesiandemography.com>  |
| bugs_status          | 0.5333333                                  |
| size_codebase        | 14318                                      |
| has_source_control   | https://github.com/bayesiandemography/bage |
...
|     | package              | type      |
|:----|:---------------------|:----------|
| 1   | rvec (\>= 0.0.7)     | Depends   |
| 2   | cli                  | Imports   |
| 3   | generics             | Imports   |
| 4   | Matrix               | Imports   |
| 5   | methods              | Imports   |
| 6   | parallel             | Imports   |
| 7   | poputils (\>= 0.3.3) | Imports   |
| 8   | sparseMVN            | Imports   |
| 9   | stats                | Imports   |
| 10  | tibble               | Imports   |
| 11  | TMB                  | Imports   |
...
Overall the package has 41 exported objects. 41 are documented:
                         ...
                         AR                     AR1                 augment 
                       TRUE                    TRUE                    TRUE 
                 components            computations                equation 
                       TRUE                    TRUE                    TRUE 
                        fit                forecast                generate 
                       TRUE                    TRUE                    TRUE 
                  is_fitted                   Known                     Lin 
                       TRUE                    TRUE                    TRUE 
                     Lin_AR                 Lin_AR1               mod_binom 
                       TRUE                    TRUE                    TRUE 
                   mod_norm                mod_pois                       N 
                       TRUE                    TRUE                    TRUE 
                       NFix          replicate_data              report_sim 
                       TRUE                    TRUE                    TRUE 
                         RW                 RW_Seas                     RW2 
                       TRUE                    TRUE                    TRUE 
                 RW2_Infant                RW2_Seas set_datamod_outcome_rr3 
                       TRUE                    TRUE                    TRUE 
                   set_disp              set_n_draw               set_prior 
                       TRUE                    TRUE                    TRUE 
                set_var_age       set_var_sexgender            set_var_time 
                       TRUE                    TRUE                    TRUE 
                         Sp                     SVD                  SVD_AR 
                       TRUE                    TRUE                    TRUE 
                    SVD_AR1                  SVD_RW                 SVD_RW2 
                       TRUE                    TRUE                    TRUE 
                       tidy                   unfit 
                       TRUE                    TRUE 
...
There are 51 help pages with examples, from 54 (94.44 %).
...
| Execution Time | 2025-02-14 07:40:01 UTC |
...
running this report
    ...
    PROCESSX_PS1c091d6b74c_1739518798
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKgGeNR
