...
| export_help          | 23                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Vipavee Trivittayasil <vipavee.tri@gmail.com>        |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/chengvt/EEM                       |
...
Overall the package has 23 exported objects. 23 are documented:
          ...
          commonizeEEM             cutEEM      delScattering     delScattering2 
                  TRUE               TRUE               TRUE               TRUE 
               drawEEM          drawEEMgg drawEEMgg_internal       findLocalMax 
                  TRUE               TRUE               TRUE               TRUE 
                  fold      generateColor      generatePoint              getEM 
                  TRUE               TRUE               TRUE               TRUE 
                 getEX         getLoading             getReg          normalize 
                  TRUE               TRUE               TRUE               TRUE 
           plotLoading            plotReg          plotScore         plotScorem 
                  TRUE               TRUE               TRUE               TRUE 
            prcompname            readEEM             unfold 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 03:44:28 UTC |
...
running this report
    ...
    PROCESSX_PS1d455d28cdf2_1739936662
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdgLp6u
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EEM_v1.1.1-tikzDictionary"
