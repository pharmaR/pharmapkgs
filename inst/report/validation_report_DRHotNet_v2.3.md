# Validation Report - DRHotNet@2.3
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Alvaro Briz-Redon <alvaro.briz@uv.es>                |
...
| 1   | graphics             | Imports |
| 2   | grDevices            | Imports |
| 3   | PBSmapping           | Imports |
| 4   | raster               | Imports |
| 5   | sp                   | Imports |
| 6   | spatstat.geom        | Imports |
| 7   | spatstat.linnet      | Imports |
| 8   | spatstat (\>= 2.0-0) | Imports |
| 9   | spdep                | Imports |
| 10  | stats                | Imports |
| 11  | utils                | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
                         ...
                         drhot                     drsens 
                          TRUE                       TRUE 
                     drsummary NeighbourhoodMatrixNetwork 
                          TRUE                       TRUE 
                       plothot                   plotrelp 
                          TRUE                       TRUE 
                       relpnet 
...
| Execution Time | 2025-02-18 04:45:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46c20465d_1739853944
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpobL4hu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DRHotNet_v2.3-tikzDictionary"
