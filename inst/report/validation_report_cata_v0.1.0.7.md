# Validation Report - cata@0.1.0.7
...
Overall the package has 19 exported objects. 19 are documented:
                ...
                bcluster.h             bcluster.n               cochranQ 
                 ...
                 code.topk evaluateClusterQuality                   getb 
                      TRUE                   TRUE                   TRUE 
               homogeneity                inspect               mcnemarQ 
                      TRUE                   TRUE                   TRUE 
                     pLift                rv.coef                 salton 
                      TRUE                   TRUE                   TRUE 
             selectionPlot               toMatrix                   topc 
                      TRUE                   TRUE                   TRUE 
              toWideMatrix 
                      TRUE 
...
| Execution Time | 2025-02-16 03:45:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32ea0a2fd_1739677548
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7Ia8v9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cata_v0.1.0.7-tikzDictionary"
