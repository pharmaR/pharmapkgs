...
| export_help          | 14                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Alfonso De Falco <alfonsodefalco90@gmail.com> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/alfodefalco/dPCP           |
...
Overall the package has 14 exported objects. 14 are documented:
          ...
          centers_data        cmeans_clus dbscan_combination               dPCP 
                  TRUE               TRUE               TRUE               TRUE 
            export_csv  manual_correction        rain_reclus     read_reference 
                  TRUE               TRUE               TRUE               TRUE 
           read_sample   read_sampleTable   reference_dbscan   replicates_quant 
                  TRUE               TRUE               TRUE               TRUE 
           report_dPCP       target_quant 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-18 04:39:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43c054921_1739853593
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLEoZjz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dPCP_v2.0.1-tikzDictionary"
