...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Lianbo Yu <Lianbo.Yu@osumc.edu>                      |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       calculateGeneLFC   calculateGenePval         densityPlot medianNormalization 
                   TRUE                TRUE                TRUE                TRUE 
               normalMM        permuteLimma     preparePlotData           ridgePlot 
                   TRUE                TRUE                TRUE                TRUE 
               runLimma         scatterPlot 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 03:58:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33e60ddf3_1739678283
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKrxjcy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CEDA_v1.1.1-tikzDictionary"
