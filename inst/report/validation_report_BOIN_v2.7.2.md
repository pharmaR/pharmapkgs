...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Ying Yuan <yyuan@mdanderson.org>                     |
...
Overall the package has 7 exported objects. 7 are documented:
       ...
       get.boundary          get.oc     get.oc.comb       next.comb   next.subtrial 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         select.mtd select.mtd.comb 
               TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:30:33 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1eb02cc1_1739593828
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZPe2As
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BOIN_v2.7.2-tikzDictionary"
