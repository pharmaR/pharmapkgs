# Validation Report - caRecall@0.1.0
...
| export_help          | 9                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Nathan Smith <nwraysmith@gmail.com>   |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/WraySmith/caRecall |
...
Overall the package has 9 exported objects. 9 are documented:
     ...
     count_recall_by_make count_recall_by_model count_recall_by_years 
                     TRUE                  TRUE                  TRUE 
              get_vrd_key        recall_by_make       recall_by_model 
                     TRUE                  TRUE                  TRUE 
         recall_by_number       recall_by_years        recall_details 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 03:41:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36fd1f9f9_1739677297
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFFp3TY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_caRecall_v0.1.0-tikzDictionary"
