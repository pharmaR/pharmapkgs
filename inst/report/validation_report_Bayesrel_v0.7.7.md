# Validation Report - Bayesrel@0.7.7
...
| export_help          | 12                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Julius M. Pfadt <julius.pfadt@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/juliuspfadt/Bayesrel  |
...
Overall the package has 12 exported objects. 12 are documented:
      ...
      bomegas  multiFit omega_fit  omegaFit omegasCFA  p_omegas   p_strel   pOmegas 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
       pStrel  seco_fit   secoFit     strel 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-15 03:40:17 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3fd59fdd_1739590813
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOo8p9J
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Bayesrel_v0.7.7-tikzDictionary"
