# Validation Report - collections@0.3.7
...
| has_source_control   | https://github.com/randy3k/collections/              |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 149847                                               |
...
duckplyr, EpiModel, gamstransfer, languageserver, multiverse, R6P,
wikiTools
...
Overall the package has 13 exported objects. 13 are documented:
               ...
               cls          deque          Deque           dict           Dict 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      ordered_dict    OrderedDict priority_queue  PriorityQueue          queue 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             Queue          stack          Stack 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:57:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34fa98213_1739681824
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfHOHnc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_collections_v0.3.7-tikzDictionary"
