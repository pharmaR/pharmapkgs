...
Overall the package has 13 exported objects. 13 are documented:
        ...
        confints      elastic           ER      explvar grid.arrange  loadingplot 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        loadings  mvrValstats          pls           R2    scoreplot       scores 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
         tableER 
            TRUE 
...
| Execution Time | 2025-02-19 04:24:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d4556782145_1739939090
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptB56CM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ER_v1.1.1-tikzDictionary"
