# Validation Report - CreditRisk@0.1.7
...
| export_help | 13 |
| has_website | FALSE |
| has_maintainer | Alessandro Cimarelli <alessandro.cimarelli@icloud.com> |
...
Overall the package has 13 exported objects. 13 are documented:
                         ...
                         at1p                  BlackCox            calibrate.at1p 
                         TRUE                      TRUE                      TRUE 
           calibrate.BlackCox             calibrate.cds            calibrate.sbtv 
                         TRUE                      TRUE                      TRUE 
                          cds                      cds2        cum_normal_density 
                         TRUE                      TRUE                      TRUE 
    generalized_black_scholes                    Merton                Merton.sim 
                         TRUE                      TRUE                      TRUE 
                         sbtv 
                         TRUE 
...
| Execution Time | 2025-02-17 04:19:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67ad15dcf_1739765956
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp35b9GT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CreditRisk_v0.1.7-tikzDictionary"
