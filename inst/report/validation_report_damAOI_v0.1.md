...
| export_help          | 10                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Chris Littleboy <chris.littleboy@stir.ac.uk> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/chrislittleboy/damaoi     |
...
Overall the package has 10 exported objects. 9 are documented:
                       ...
                       %>% adjustreservoirpolygon      autogetpourpoints 
                     FALSE                   TRUE                   TRUE 
           basinandbuffers        getimpactedarea         getriverpoints 
                      TRUE                   TRUE                   TRUE 
            getshinyparams             makesystem          pointstolines 
                      TRUE                   TRUE                   TRUE 
             preprocessing 
                      TRUE 
...
| Execution Time | 2025-02-17 04:52:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bd660cd6402_1739767959
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp53iKRw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_damAOI_v0.1-tikzDictionary"
