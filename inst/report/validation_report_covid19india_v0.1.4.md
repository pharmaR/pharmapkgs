# Validation Report - covid19india@0.1.4
...
| export_help          | 14                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Max Salvatore <mmsalva@umich.edu>      |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/maxsal/covid19india |
...
Overall the package has 14 exported objects. 13 are documented:
                          ...
                          %>% check_for_data_correction            extract_latest 
                        FALSE                      TRUE                      TRUE 
                 get_all_data                   get_cfr       get_district_counts 
                         TRUE                      TRUE                      TRUE 
           get_metrics_tables            get_nat_counts             get_nat_tests 
                         TRUE                      TRUE                      TRUE 
                    get_r_est                    get_r0          get_state_counts 
                         TRUE                      TRUE                      TRUE 
              get_state_tests             get_state_vax 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-17 04:07:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64f62d7d8_1739765268
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkjyxGo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covid19india_v0.1.4-tikzDictionary"
