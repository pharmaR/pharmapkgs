# Validation Report - decisionSupport@1.114
...
| export_help          | 42                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Eike Luedeling <eike@eikeluedeling.com>              |
...
| 2   | chillR (\>= 0.62)            | Imports |
| 3   | class                        | Imports |
| 4   | dplyr                        | Imports |
| 5   | fANCOVA (\>= 0.5)            | Imports |
| 6   | ggplot2 (\>= 3.2.0)          | Imports |
| 7   | grDevices                    | Imports |
| 8   | magrittr                     | Imports |
| 9   | msm (\>= 1.5)                | Imports |
| 10  | mvtnorm (\>= 1.0.2)          | Imports |
| 11  | nleqslv (\>= 2.6)            | Imports |
| 12  | patchwork                    | Imports |
| 13  | rriskDistributions (\>= 2.0) | Imports |
| 14  | stats (\>= 3.1.3)            | Imports |
| 15  | stringr                      | Imports |
| 16  | tidyr                        | Imports |
...
Overall the package has 42 exported objects. 42 are documented:
                   ...
                   as.estimate              as.estimate1d 
                          TRUE                       TRUE 
                  chance_event            compound_figure 
                          TRUE                       TRUE 
                        corMat                   corMat<- 
                          TRUE                       TRUE 
               decisionSupport                   discount 
                          TRUE                       TRUE 
                empirical_EVPI                   estimate 
                          TRUE                       TRUE 
             estimate_read_csv      estimate_read_csv_old 
                          TRUE                       TRUE 
            estimate_write_csv                 estimate1d 
                          TRUE                       TRUE 
                 eviSimulation             gompertz_yield 
                          TRUE                       TRUE 
      individualEvpiSimulation                   make_CPT 
                          TRUE                       TRUE 
                  mcSimulation                 multi_EVPI 
                          TRUE                       TRUE 
              paramtnormci_fit       paramtnormci_numeric 
                          TRUE                       TRUE 
    plainNames2data.frameNames              plot_cashflow 
                          TRUE                       TRUE 
            plot_distributions                  plot_evpi 
                          TRUE                       TRUE 
                      plot_pls          plsr.mcSimulation 
                          TRUE                       TRUE 
                        random               random_state 
                          TRUE                       TRUE 
               rdist90ci_exact                 rdistq_fit 
                          TRUE                       TRUE 
             rmvnorm90ci_exact               rposnorm90ci 
                          TRUE                       TRUE 
               rtnorm_0_1_90ci                 rtnorm90ci 
                          TRUE                       TRUE 
                    sample_CPT          sample_simple_CPT 
                          TRUE                       TRUE 
                   scenario_mc            temp_situations 
                          TRUE                       TRUE 
                            vv    welfareDecisionAnalysis 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-18 03:32:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46c29a3b6_1739849539
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4FnDAJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_decisionSupport_v1.114-tikzDictionary"
