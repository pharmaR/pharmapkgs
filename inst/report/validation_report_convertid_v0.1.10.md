# Validation Report - convertid@0.1.10
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Vidal Fey <vidal.fey@gmail.com>                      |
...
|     | package       | type    |
|:----|:--------------|:--------|
| 1   | AnnotationDbi | Depends |
| 2   | org.Hs.eg.db  | Imports |
| 3   | org.Mm.eg.db  | Imports |
| 4   | plyr          | Imports |
| 5   | stringr       | Imports |
| 6   | biomaRt       | Imports |
| 7   | stats         | Imports |
...
| 9   | utils         | Imports |
| 10  | rappdirs      | Imports |
| 11  | assertthat    | Imports |
| 12  | methods       | Imports |
| 13  | httr          | Imports |
| 14  | BiocFileCache | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    convert.alias    convert.bm    convertId2        get.bm likely_symbol 
...
| Execution Time | 2025-02-17 03:51:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65e826_1739764287
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmplr9ldP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_convertid_v0.1.10-tikzDictionary"
