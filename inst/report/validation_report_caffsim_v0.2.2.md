# Validation Report - caffsim@0.2.2
...
| export_help          | 10                                 |
| has_website          | TRUE                               |
| has_maintainer       | Sungpil Han <shan@acp.kr>          |
| bugs_status          | 0.5                                |
| has_source_control   | https://github.com/asancpt/caffsim |
...
Overall the package has 10 exported objects. 10 are documented:
         ...
         caffConcTime caffConcTimeMulti      caffDescstat      caffOverdose 
                 TRUE              TRUE              TRUE              TRUE 
          caffPkparam  caffPkparamMulti          caffPlot     caffPlotMulti 
                 TRUE              TRUE              TRUE              TRUE 
            caffShiny         UnitTable 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-16 03:33:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bc321e1180b_1739676796
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIU8v79
...
These are the options set to generate the report:
    ...
    [1] "validation_report_caffsim_v0.2.2-tikzDictionary"
