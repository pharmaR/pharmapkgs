...
| export_help          | 17                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Anders Granholm <andersgran@gmail.com> |
| bugs_status          | 0.9230769                              |
| size_codebase        | 3270                                   |
| has_source_control   | https://github.com/INCEPTdk/adaptr/    |
...
Overall the package has 17 exported objects. 17 are documented:
             ...
             calibrate_trial        check_performance     check_remaining_arms 
                        TRUE                     TRUE                     TRUE 
             extract_results         find_beta_params         plot_convergence 
                        TRUE                     TRUE                     TRUE 
                plot_history        plot_metrics_ecdf              plot_status 
                        TRUE                     TRUE                     TRUE 
                   run_trial               run_trials            setup_cluster 
                        TRUE                     TRUE                     TRUE 
                 setup_trial        setup_trial_binom         setup_trial_norm 
                        TRUE                     TRUE                     TRUE 
    update_saved_calibration      update_saved_trials 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-14 06:34:59 UTC |
...
running this report
    ...
    PROCESSX_PS726d664e0b07_1739514896
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbZFhK1
