...
| export_help          | 6                                 |
| has_website          | TRUE                              |
| has_maintainer       | KS Srikanth <sri.teach@gmail.com> |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/talegari/disto |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | proxy (\>= 0.4.19)       | Imports |
| 2   | dplyr (\>= 0.7.4)        | Imports |
| 3   | assertthat (\>= 0.2.0)   | Imports |
| 4   | fastmatch(\>= 1.1.0)     | Imports |
| 5   | tidyr (\>= 0.8.0)        | Imports |
| 6   | factoextra (\>= 1.0.5)   | Imports |
| 7   | ggplot2 (\>= 2.2.1)      | Imports |
| 8   | broom (\>= 0.4.4)        | Imports |
| 9   | fastcluster (\>= 1.1.25) | Imports |
| 10  | pbapply (\>= 1.3.4)      | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
          ...
          dapply dist_extract dist_replace  dist_subset        disto         size 
...
| Execution Time | 2025-02-18 04:18:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4574517a1_1739852328
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUMqfR1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_disto_v0.2.0-tikzDictionary"
