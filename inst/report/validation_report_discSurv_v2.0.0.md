# Validation Report - discSurv@2.0.0
...
| export_help          | 36                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Thomas Welchowski <welchow@imbie.meb.uni-bonn.de>    |
...
Overall the package has 36 exported objects. 36 are documented:
                    ...
                    adjDevResid             calibrationPlot 
                           TRUE                        TRUE 
                         cIndex             cIndexCompRisks 
                           TRUE                        TRUE 
                   compRisksGEE                  contToDisc 
                           TRUE                        TRUE 
                       covarGEE               dataCensoring 
                           TRUE                        TRUE 
                       dataLong           dataLongCompRisks 
                           TRUE                        TRUE 
       dataLongCompRisksTimeDep          dataLongMultiSpell 
                           TRUE                        TRUE 
                dataLongSubDist             dataLongTimeDep 
                           TRUE                        TRUE 
                       devResid                   estCumInz 
                           TRUE                        TRUE 
                    estMargProb        estMargProbCompRisks 
                           TRUE                        TRUE 
                       estRecal                     estSurv 
                           TRUE                        TRUE 
                    estSurvCens            estSurvCompRisks 
                           TRUE                        TRUE 
                         gumbel                  intPredErr 
                           TRUE                        TRUE 
            intPredErrCompRisks                   lifeTable 
                           TRUE                        TRUE 
                martingaleResid              minNodePruning 
                           TRUE                        TRUE 
        minNodePruningCompRisks                  plotCumInc 
                           TRUE                        TRUE 
                       plotSurv            predErrCompRisks 
                           TRUE                        TRUE 
                   predErrCurve       survTreeLaplaceHazard 
                           TRUE                        TRUE 
    survTreeLaplaceHazardRanger                 weightsLtoT 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-18 04:14:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43befa7eb_1739852067
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwLpeFg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_discSurv_v2.0.0-tikzDictionary"
