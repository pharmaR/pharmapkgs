# Validation Report - Countr@3.5.8
...
| has_source_control | https://github.com/GeoBosh/Countr (devel) |
...
| 10  | car                | Imports   |
| 11  | utils              | Imports   |
| 12  | Rdpack (\>= 0.7-0) | Imports   |
| 13  | lattice            | Imports   |
| 14  | RColorBrewer       | Imports   |
| 15  | dplyr              | Imports   |
| 16  | standardize        | Imports   |
| 17  | lmtest             | Imports   |
| 18  | xtable             | Imports   |
| 19  | Rcpp               | LinkingTo |
...
Overall the package has 34 exported objects. 34 are documented:
          ...
          addBootSampleObject                 chiSq_gof             chiSq_pearson 
                         TRUE                      TRUE                      TRUE 
                 compareToGLM               count_table             CountrFormula 
                         TRUE                      TRUE                      TRUE 
               dCount_conv_bi     dCount_conv_loglik_bi   dCount_conv_loglik_user 
                         TRUE                      TRUE                      TRUE 
             dCount_conv_user         dmodifiedCount_bi             dWeibullCount 
                         TRUE                      TRUE                      TRUE 
         dWeibullCount_loglik        dWeibullgammaCount dWeibullgammaCount_loglik 
                         TRUE                      TRUE                      TRUE 
              evCount_conv_bi         evCount_conv_user            evWeibullCount 
                         TRUE                      TRUE                      TRUE 
          evWeibullgammaCount            frequency_plot               getParNames 
                         TRUE                      TRUE                      TRUE 
                 prob_predict                   renewal           renewal.control 
                         TRUE                      TRUE                      TRUE 
             renewal.convPars        renewal.seriesPars         renewal.weiMethod 
                         TRUE                      TRUE                      TRUE 
                  renewalCoef           renewalCoefList              renewalCount 
                         TRUE                      TRUE                      TRUE 
                 renewalNames            residuals_plot                   se.coef 
                         TRUE                      TRUE                      TRUE 
                         surv 
                         TRUE 
...
| Execution Time | 2025-02-17 04:05:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65658220_1739765100
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNprcy6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Countr_v3.5.8-tikzDictionary"
