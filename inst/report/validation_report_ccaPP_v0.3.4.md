...
| has_source_control   | https://github.com/aalfons/ccaPP   |
...
|:----|:------------------------------|:----------|
| 1   | parallel                      | Depends   |
| 2   | pcaPP (\>= 1.8-1)             | Depends   |
| 3   | robustbase                    | Depends   |
| 4   | Rcpp (\>= 0.11.0)             | Imports   |
| 5   | Rcpp (\>= 0.11.0)             | LinkingTo |
| 6   | RcppArmadillo (\>= 0.4.100.0) | LinkingTo |
...
ctsGE, nanostringr, phantasus, yaImpute

## Namespace

Overall the package has 14 exported objects. 14 are documented:

        ccaGrid     CCAgrid     ccaProj     CCAproj  corKendall        corM 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
     corPearson corQuadrant corSpearman     fastMAD  fastMedian  maxCorGrid 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
     maxCorProj    permTest 
           TRUE        TRUE 
...
| Execution Time | 2025-02-16 03:52:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37c3a09c4_1739677968
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwWRggd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ccaPP_v0.3.4-tikzDictionary"
