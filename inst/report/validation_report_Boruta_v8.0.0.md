# Validation Report - Boruta@8.0.0
...
| export_help          | 21                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Miron Bartosz Kursa <M.Kursa@icm.edu.pl> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://gitlab.com/mbq/Boruta/           |
...
CompositionalML, finnts, fscaret, fuseMLR, HDStIM, mlr3filters,
multiclassPairs, nestedcv, SISIR, varrank

## Namespace

Overall the package has 21 exported objects. 21 are documented:

                  attStats                 Boruta conditionalTransdapter 
                      TRUE                   TRUE                   TRUE 
       decohereTransdapter    getConfirmedFormula        getImpExtraGini 
                      TRUE                   TRUE                   TRUE 
            getImpExtraRaw           getImpExtraZ            getImpFerns 
                      TRUE                   TRUE                   TRUE 
        getImpLegacyRfGini      getImpLegacyRfRaw        getImpLegacyRfZ 
                      TRUE                   TRUE                   TRUE 
              getImpRfGini            getImpRfRaw              getImpRfZ 
                      TRUE                   TRUE                   TRUE 
             getImpXgboost  getNonRejectedFormula  getSelectedAttributes 
                      TRUE                   TRUE                   TRUE 
         imputeTransdapter         plotImpHistory      TentativeRoughFix 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:35:51 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd314461b3_1739594145
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeSZD4B
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Boruta_v8.0.0-tikzDictionary"
