# Validation Report - eyeTrackR@1.0.1
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Hayward Godwin <hg102@soton.ac.uk>                   |
...
Overall the package has 19 exported objects. 19 are documented:
               ...
               analyse.behavioural.data             analyse.calculate.means 
                                   TRUE                                TRUE 
                      analyse.fix.count                analyse.fix.duration 
                                   TRUE                                TRUE 
             analyse.fix.first_duration               analyse.fix.totaltime 
                                   TRUE                                TRUE 
                  analyse.sac.amplitude                 analyse.visit.count 
                                   TRUE                                TRUE 
              organise.behavioural.base        organise.checks.random_trial 
                                   TRUE                                TRUE 
    organise.contingencies.descriptives   organise.exclusions.fix_durations 
                                   TRUE                                TRUE 
          organise.message.descriptives  organise.message.fix_contingencies 
                                   TRUE                                TRUE 
                organise.message.markup           organise.message.removals 
                                   TRUE                                TRUE 
        organise.message.replace_spaces    organise.message.return_specific 
                                   TRUE                                TRUE 
...
| Execution Time | 2025-02-19 04:59:48 UTC |
...
running this report
    ...
    PROCESSX_PS1d457cf5c0a9_1739941181
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSvhRUE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eyeTrackR_v1.0.1-tikzDictionary"
