# Validation Report - DetLifeInsurance@0.1.3
...
| export_help          | 38                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Joaquin Auza <auzajoaquin@gmail.com>            |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/JoaquinAuza/DetLifeInsurance |
...
Overall the package has 38 exported objects. 38 are documented:
                  ...
                  ACont.                   aD                  AD. 
                    ...
                    Avg.                    E                   Em 
                    TRUE                 TRUE                 TRUE 
        Fractional_table        JointSurvival    Loan_amortization 
                    TRUE                 TRUE                 TRUE 
      Payment_Protection          PremiumFrac                qfrac 
                    TRUE                 TRUE                 TRUE 
          Rate_converter                   sf             Survival 
                    TRUE                 TRUE                 TRUE 
            Table_Dormoy       Table_Gompertz        Table_Makeham 
                    TRUE                 TRUE                 TRUE 
            Table_Moivre                  V_a                 V_A. 
                    TRUE                 TRUE                 TRUE 
                    V_aD                V_AD.                 V_av 
                    TRUE                 TRUE                 TRUE 
                   V_Av.                V_avg               V_Avg. 
                    TRUE                 TRUE                 TRUE 
                     V_E V_Payment_Protection 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-18 03:50:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bb428e6b106_1739850616
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpzk0fK0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DetLifeInsurance_v0.1.3-tikzDictionary"
