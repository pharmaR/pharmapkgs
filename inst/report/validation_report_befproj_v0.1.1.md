# Validation Report - befproj@0.1.1
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Peter Thuresson <jpeter.thuresson@gmail.com>         |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    bef_components       bef_proj        bef_raw 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-15 03:51:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd976a89d_1739591503
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPMZ8F3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_befproj_v0.1.1-tikzDictionary"
