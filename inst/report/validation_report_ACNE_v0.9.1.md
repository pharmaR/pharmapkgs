...
| size_codebase        | 637                                     |
| has_source_control   | https://github.com/HenrikBengtsson/ACNE |
...
|     | package                       | type    |
|:----|:------------------------------|:--------|
| 1   | aroma.affymetrix (\>= 2.14.0) | Depends |
| 2   | MASS                          | Imports |
| 3   | R.methodsS3 (\>= 1.7.0)       | Imports |
| 4   | R.oo (\>= 1.23.0)             | Imports |
| 5   | R.utils (\>= 2.1.0)           | Imports |
| 6   | matrixStats (\>= 0.50.0)      | Imports |
| 7   | R.filesets (\>= 2.9.0)        | Imports |
| 8   | aroma.core (\>= 2.14.0)       | Imports |
...
| Execution Time | 2025-02-14 06:32:03 UTC |
...
running this report
    ...
    PROCESSX_PS726d28a3f083_1739514721
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmxfAEB
