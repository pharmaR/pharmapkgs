# Validation Report - FactorCopula@0.9.3
...
Overall the package has 37 exported objects. 37 are documented:
      ...
      continuous2ordinal copselect1FactorTree copselect2FactorTree 
                    TRUE                 TRUE                 TRUE 
           count2ordinal          discrepancy                M2.1F 
                    TRUE                 TRUE                 TRUE 
                   M2.2F           M2Bifactor       M2Second_order 
                    TRUE                 TRUE                 TRUE 
              mle1factor       mle1FactorTree           mle2factor 
                    TRUE                 TRUE                 TRUE 
          mle2factor.bvn       mle2FactorTree          mleBifactor 
                    TRUE                 TRUE                 TRUE 
         mleSecond_order              par2tau               pbnorm 
                    TRUE                 TRUE                 TRUE 
                    pbvt          polychoric0             r1factor 
                    TRUE                 TRUE                 TRUE 
            r1factortree             r2factor         r2factortree 
                    TRUE                 TRUE                 TRUE 
               rBifactor        rSecond_order             select1F 
                    TRUE                 TRUE                 TRUE 
                select2F       selectBifactor   selectFactorTrVine 
                    TRUE                 TRUE                 TRUE 
      selectSecond_order             semicorr              tau2par 
                    TRUE                 TRUE                 TRUE 
        vuong_FactorTree     vuong_structured             vuong.1f 
                    TRUE                 TRUE                 TRUE 
                vuong.2f 
                    TRUE 
...
| Execution Time | 2025-02-19 05:05:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d455f230d68_1739941518
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEfyuZX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FactorCopula_v0.9.3-tikzDictionary"
