...
| export_help          | 5                                |
| has_website          | TRUE                             |
| has_maintainer       | Greg Hunt <greg@firmansyah.com>  |
| bugs_status          | 0.6666667                        |
| has_source_control   | https://github.com/gregfrog/brew |
| has_bug_reports_url  | 1                                |
| downloads_1yr        | 1818693                          |
...
BatchJobs, batchtools, boxly, cola, diezeit, forestly, GladiaTOX,
leafpop, link2GI, metalite.sl, opencpu, pkgndep, rdnb, remotes, Rook,
roxygen2, RWsearch, sos, tinyProject, uavRmp, WebAnalytics

## Namespace

Overall the package has 5 exported objects. 1 are documented:

            brew    brewCache brewCacheOff  brewCacheOn    setBufLen 
...
| Execution Time | 2025-02-22 03:19:16 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb34e2adfc_1740194351
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQyNPmz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brew_v1.0.10-tikzDictionary"
