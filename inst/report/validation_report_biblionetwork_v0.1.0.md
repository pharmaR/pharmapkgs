# Validation Report - biblionetwork@0.1.0
...
| export_help          | 6                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Aurélien Goutsmedt <agoutsmedt@hotmail.fr>  |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/agoutsmedt/biblionetwork |
...
Overall the package has 6 exported objects. 6 are documented:
      ...
      biblio_cocitation     biblio_coupling      coauth_network     coupling_entity 
                   TRUE                TRUE                TRUE                TRUE 
    coupling_similarity   coupling_strength 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-15 04:01:08 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd18d09e7d_1739592063
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRoaDw0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biblionetwork_v0.1.0-tikzDictionary"
