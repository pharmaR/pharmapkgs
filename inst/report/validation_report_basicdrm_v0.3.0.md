# Validation Report - basicdrm@0.3.0
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Nathaniel Twarog <nathaniel.twarog@stjude.org>       |
...
braidReports, braidrm

## Namespace

Overall the package has 9 exported objects. 9 are documented:

    calcHillBootstrap   calcHillConfInt  calculateHillAUC       estimateAIC 
                 TRUE              TRUE              TRUE              TRUE 
          estimateBIC     evalHillModel findBestHillModel      fitHillModel 
                 TRUE              TRUE              TRUE              TRUE 
      invertHillModel 
                 TRUE 
...
| Execution Time | 2025-02-14 07:44:39 UTC |
...
running this report
    ...
    PROCESSX_PS1c094e9ac602_1739519076
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkW1noZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_basicdrm_v0.3.0-tikzDictionary"
