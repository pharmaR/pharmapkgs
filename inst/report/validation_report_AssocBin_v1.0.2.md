...
| export_help          | 25                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Chris Salahub <chris.salahub@uwaterloo.ca>           |
...
Overall the package has 25 exported objects. 25 are documented:
           ...
           binAbsDif           binChi            binMI           binner 
                TRUE             TRUE             TRUE             TRUE 
           catBinner        chiScores        depthFill       halfCutTie 
                TRUE             TRUE             TRUE             TRUE 
           halfSplit            inDep          makeBin     makeCriteria 
                TRUE             TRUE             TRUE             TRUE 
       maxScoreSplit         miScores      plotBinning       randScores 
                TRUE             TRUE             TRUE             TRUE 
        residualFill        rIntSplit       rUnifSplit  sandboxMaxSplit 
                TRUE             TRUE             TRUE             TRUE 
        singleBinner          stopper        uniBinner uniMaxScoreSplit 
                TRUE             TRUE             TRUE             TRUE 
        uniRIntSplit 
                TRUE 
...
| Execution Time | 2025-02-14 07:28:52 UTC |
...
running this report
    ...
    PROCESSX_PS1c09203abb75_1739518129
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFyZ0Mr
