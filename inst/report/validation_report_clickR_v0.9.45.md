# Validation Report - clickR@0.9.45
...
| export_help          | 38                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | David Hervas Marin <ddhervas@yahoo.es>               |
...
Overall the package has 38 exported objects. 32 are documented:

                %<=NA%              %<NA%             %>=NA%              %>NA% 
                 FALSE              FALSE              FALSE              FALSE 
             %between%        %betweenNA% bivariate_outliers      check_quality 
                 FALSE              FALSE               TRUE               TRUE 
           cluster_var        descriptive          f_replace            fix_all 
                  TRUE               TRUE               TRUE               TRUE 
            fix_concat          fix_dates        fix_factors         fix_levels 
                  TRUE               TRUE               TRUE               TRUE 
                fix_NA       fix_numerics              forge           GK_assoc 
                  TRUE               TRUE               TRUE               TRUE 
               good2go          ipboxplot       kill.factors         manual_fix 
                  TRUE               TRUE               TRUE               TRUE 
             mine.plot            mtapply         nice_names           outliers 
                  TRUE               TRUE               TRUE               TRUE 
                  peek       remove_empty    restore_changes     search_scripts 
                  TRUE               TRUE               TRUE               TRUE 
         track_changes              ttrue            unforge          workspace 
                  TRUE               TRUE               TRUE               TRUE 
      workspace_sapply            xscores 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:30:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc377b6fbf5_1739680197
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuDCVTl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clickR_v0.9.45-tikzDictionary"
