# Validation Report - clustAnalytics@0.5.5
...
| export_help          | 23                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Martí Renedo Mirambell <marti.renedo@gmail.com> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/martirm/clustAnalytics       |
...
Overall the package has 23 exported objects. 23 are documented:
                    ...
                    apply_subgraphs                  average_degree 
                               TRUE                            TRUE 
                        average_odf          barabasi_albert_blocks 
                               TRUE                            TRUE 
                      boot_alg_list                     conductance 
                               TRUE                            TRUE 
                           coverage                       cut_ratio 
                               TRUE                            TRUE 
                      density_ratio                    edges_inside 
                               TRUE                            TRUE 
              evaluate_significance         evaluate_significance_r 
                               TRUE                            TRUE 
                          expansion                            FOMD 
                               TRUE                            TRUE 
                   internal_density                         max_odf 
                               TRUE                            TRUE 
                     normalized_cut      reduced_mutual_information 
                               TRUE                            TRUE 
                            relabel                       rewireCpp 
                               TRUE                            TRUE 
                  scoring_functions weighted_clustering_coefficient 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-16 04:37:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33633e309_1739680650
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpspc6Kj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clustAnalytics_v0.5.5-tikzDictionary"
