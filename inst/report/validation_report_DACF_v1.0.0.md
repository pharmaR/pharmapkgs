...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Qimin Liu <qliu6@nd.edu>                             |
...
Overall the package has 6 exported objects. 6 are documented:
        ...
        f.star.test      induce.cfe       lw.f.star       lw.t.test    rec.mean.var 
...
| Execution Time | 2025-02-17 04:49:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67b1132c0_1739767784
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWxHwoP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DACF_v1.0.0-tikzDictionary"
