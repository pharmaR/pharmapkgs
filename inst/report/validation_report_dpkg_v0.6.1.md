...
| export_help          | 15                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Cole Brokamp <cole@colebrokamp.com>  |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/cole-brokamp/dpkg |
...
Overall the package has 15 exported objects. 15 are documented:
               ...
               as_dpkg    dpkg_gh_release          dpkg_meta          read_dpkg 
                  TRUE               TRUE               TRUE               TRUE 
    read_dpkg_metadata               stow        stow_exists    stow_gh_release 
                  TRUE               TRUE               TRUE               TRUE 
             stow_info          stow_path        stow_remove          stow_size 
                  TRUE               TRUE               TRUE               TRUE 
              stow_url     use_dpkg_badge         write_dpkg 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 04:40:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bb466bd15e5_1739853606
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpX8qRcJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dpkg_v0.6.1-tikzDictionary"
