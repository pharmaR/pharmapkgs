...
Overall the package has 18 exported objects. 17 are documented:
              ...
              .onAttach           amova.rda         count.model          count.pred 
                  FALSE                TRUE                TRUE                TRUE 
    environmental.novel         freq.ggplot          freq.model           freq.pred 
                   TRUE                TRUE                TRUE                TRUE 
             moon.waxer           pie.baker    population.shift    shift.dot.ggplot 
                   TRUE                TRUE                TRUE                TRUE 
      shift.moon.ggplot    shift.pie.ggplot   shift.surf.ggplot shift.waffle.ggplot 
                   TRUE                TRUE                TRUE                TRUE 
             VIF.subset        waffle.baker 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-21 13:08:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a11b8f020_1740143330
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeEqX9L
