# Validation Report - cleanTS@0.1.2
...
| export_help          | 13                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Mayur Shende <mayur.k.shende@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/Mayur1009/cleanTS    |
...
| 3   | ggplot2         | Imports |
| 4   | ggtext          | Imports |
| 5   | transformr      | Imports |
| 6   | glue            | Imports |
| 7   | imputeTestbench | Imports |
| 8   | imputeTS        | Imports |
| 9   | lubridate       | Imports |
| 10  | shiny           | Imports |
| 11  | stringr         | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
           ...
           anim_save          animate animate_interval          cleanTS 
                TRUE             TRUE             TRUE             TRUE 
       gen.animation       gen.report    interact_plot         mergecsv 
                TRUE             TRUE             TRUE             TRUE 
    na_interpolation        na_kalman          na_locf            na_ma 
                TRUE             TRUE             TRUE             TRUE 
             na_mean 
                TRUE 
...
| Execution Time | 2025-02-16 04:28:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3162232b0_1739680129
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpG4OZu0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cleanTS_v0.1.2-tikzDictionary"
