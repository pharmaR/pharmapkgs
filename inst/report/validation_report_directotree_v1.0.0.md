# Validation Report - directotree@1.0.0
...
| export_help          | 0                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Louis Sirugue <lsirugue@protonmail.com>              |
...
|     | package                     | type    |
|:----|:----------------------------|:--------|
| 1   | collapsibleTree (\>= 0.1.6) | Imports |
| 2   | data.tree (\>= 0.7.6)       | Imports |
...
| Execution Time | 2025-02-18 04:09:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47487ed9d_1739851772
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0oJfaA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_directotree_v1.0.0-tikzDictionary"
