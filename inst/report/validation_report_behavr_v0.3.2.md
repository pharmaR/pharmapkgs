# Validation Report - behavr@0.3.2
...
| export_help          | 17                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Quentin Geissmann <qgeissmann@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/rethomics/behavr      |
...
damr, ggetho, phase, scopr, sleepr, zeitgebr

## Namespace

Overall the package has 17 exported objects. 17 are documented:

                behavr          bin_apply      bin_apply_all   bind_behavr_list 
                  TRUE               TRUE               TRUE               TRUE 
                  days              hours          is.behavr               meta 
                  TRUE               TRUE               TRUE               TRUE 
                  mins             rejoin          setbehavr            setmeta 
                  TRUE               TRUE               TRUE               TRUE 
             stitch_on  toy_activity_data       toy_dam_data toy_ethoscope_data 
                  TRUE               TRUE               TRUE               TRUE 
                   xmv 
                  TRUE 
...
| Execution Time | 2025-02-15 03:51:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd9daea16_1739591514
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRjLF8i
...
These are the options set to generate the report:
    ...
    [1] "validation_report_behavr_v0.3.2-tikzDictionary"
