# Validation Report - BivRec@1.2.1
...
| export_help          | 11                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Sandra Castro-Pearson <cast0135@umn.edu>      |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/SandraCastroPearson/BivRec |
...
Overall the package has 11 exported objects. 11 are documented:
     ...
     biv.rec.fit   biv.rec.np biv.rec.plot  biv.rec.sim     bivrecNP    bivrecReg 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      bivrecSurv     plotCond    plotJoint     plotMarg    simBivRec 
...
| Execution Time | 2025-02-15 04:19:39 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6cecb69c_1739593175
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyzJntz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BivRec_v1.2.1-tikzDictionary"
