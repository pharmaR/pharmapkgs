...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Jan Fojtik <9afojtik@gmail.com>                      |
...
| 3   | dplyr (\>= 0.7.6)   | Imports |
| 4   | NbClust (\>= 3.0)   | Imports |
| 5   | amap (\>= 0.8-16)   | Imports |
| 6   | tableone            | Imports |
| 7   | stats               | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
             ...
             CluMP CluMP_profiles     CluMP_view  GeneratePanel        OptiNum 
...
| Execution Time | 2025-02-16 04:36:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36e78294c_1739680599
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpK4ITKR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CluMP_v0.8.1-tikzDictionary"
