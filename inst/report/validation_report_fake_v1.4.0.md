...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Barbara Bodinier <barbara.bodinier@gmail.com>        |
...
Overall the package has 21 exported objects. 21 are documented:
           ...
           BlockDiagonal          BlockMatrix       BlockStructure 
                    TRUE                 TRUE                 TRUE 
             Concordance             Contrast  ExpectedCommunities 
                    TRUE                 TRUE                 TRUE 
     ExpectedConcordance              Heatmap           LayeredDAG 
                    TRUE                 TRUE                 TRUE 
    MakePositiveDefinite    MatchingArguments       MinWithinProba 
                    TRUE                 TRUE                 TRUE 
                     ROC    SimulateAdjacency   SimulateClustering 
                    TRUE                 TRUE                 TRUE 
      SimulateComponents  SimulateCorrelation    SimulateGraphical 
                    TRUE                 TRUE                 TRUE 
       SimulatePrecision   SimulateRegression   SimulateStructural 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 05:08:40 UTC |
...
running this report
    ...
    PROCESSX_PS1d45ec808dd_1739941713
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpj8i2Av
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fake_v1.4.0-tikzDictionary"
