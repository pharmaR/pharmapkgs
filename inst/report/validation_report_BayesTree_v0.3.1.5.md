# Validation Report - BayesTree@0.3.1.5
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Robert McCulloch <robert.e.mcculloch@gmail.com>      |
...
BayesTreePrior, causaldrf, psica

## Namespace

Overall the package has 5 exported objects. 5 are documented:

         bart   makeind   pd2bart    pdbart plot.bart 
...
| Execution Time | 2025-02-15 03:42:00 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd376facac_1739590916
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTHkmBI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesTree_v0.3.1.5-tikzDictionary"
