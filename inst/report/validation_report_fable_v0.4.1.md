...
| has_source_control   | https://github.com/tidyverts/fable                |
| has_bug_reports_url  | 1                                                 |
| downloads_1yr        | 232961                                            |
...
|     | package                | type      |
|:----|:-----------------------|:----------|
| 1   | fabletools (\>= 0.3.0) | Depends   |
| 2   | Rcpp (\>= 0.11.0)      | Imports   |
| 3   | rlang (\>= 0.4.6)      | Imports   |
| 4   | stats                  | Imports   |
| 5   | dplyr (\>= 1.0.0)      | Imports   |
| 6   | tsibble (\>= 0.9.0)    | Imports   |
| 7   | tibble                 | Imports   |
| 8   | tidyr                  | Imports   |
| 9   | utils                  | Imports   |
| 10  | distributional         | Imports   |
| 11  | Rcpp (\>= 0.11.0)      | LinkingTo |
...
echos, fableCount, fabletools, feasts, fpp3, grattanInflators,
iNZightTS, netseer, oddnet, vital
...
Overall the package has 18 exported objects. 17 are documented:
     ...
     breusch_godfrey          CROSTON              ETS             MEAN 
                TRUE             TRUE             TRUE             TRUE 
               NAIVE           NNETAR               RW           SNAIVE 
                TRUE             TRUE             TRUE             TRUE 
               THETA             TSLM unitroot_options              VAR 
                TRUE             TRUE             TRUE             TRUE 
              VARIMA             VECM 
                TRUE             TRUE 
...
There are 88 help pages with examples, from 89 (98.88 %).
...
| Execution Time | 2025-02-19 05:02:03 UTC |
...
running this report
    ...
    PROCESSX_PS1d4577a982ee_1739941317
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTGihNS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fable_v0.4.1-tikzDictionary"
