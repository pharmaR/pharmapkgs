# Validation Report - fastRG@0.3.2
...
| has_source_control   | https://github.com/RoheLab/fastRG  |
...
Overall the package has 27 exported objects. 27 are documented:
                   ...
                   chung_lu                   dcsbm          directed_dcsbm 
                       TRUE                    TRUE                    TRUE 
       directed_erdos_renyi   directed_factor_model                eigs_sym 
                       TRUE                    TRUE                    TRUE 
                erdos_renyi             expectation         expected_degree 
                       TRUE                    TRUE                    TRUE 
           expected_degrees        expected_density          expected_edges 
                       TRUE                    TRUE                    TRUE 
         expected_in_degree     expected_out_degree                   mmsbm 
                       TRUE                    TRUE                    TRUE 
            overlapping_sbm       planted_partition       plot_dense_matrix 
                       TRUE                    TRUE                    TRUE 
           plot_expectation      plot_sparse_matrix         sample_edgelist 
                       TRUE                    TRUE                    TRUE 
              sample_igraph           sample_sparse        sample_tidygraph 
                       TRUE                    TRUE                    TRUE 
                        sbm                    svds undirected_factor_model 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-19 05:21:21 UTC |
...
running this report
    ...
    PROCESSX_PS1d4576a211d1_1739942474
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYk4ZnV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastRG_v0.3.2-tikzDictionary"
