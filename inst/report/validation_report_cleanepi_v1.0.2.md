# Validation Report - cleanepi@1.0.2
...
| export_help          | 18                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Karim Mané <karim.mane@lshtm.ac.uk>        |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/epiverse-trace/cleanepi |
...
| 3   | dplyr                | Imports |
| 4   | janitor              | Imports |
| 5   | linelist (\>= 1.0.0) | Imports |
| 6   | lubridate            | Imports |
| 7   | magrittr             | Imports |
| 8   | matchmaker           | Imports |
| 9   | numberize            | Imports |
| 10  | readr                | Imports |
| 11  | rlang                | Imports |
| 12  | snakecase            | Imports |
| 13  | utils                | Imports |
| 14  | withr                | Imports |
...
Overall the package has 18 exported objects. 18 are documented:
           ...
           add_to_dictionary            add_to_report      check_date_sequence 
                        TRUE                     TRUE                     TRUE 
           check_subject_ids               clean_data   clean_using_dictionary 
                        TRUE                     TRUE                     TRUE 
     convert_numeric_to_date       convert_to_numeric      correct_subject_ids 
                        TRUE                     TRUE                     TRUE 
             find_duplicates             print_report         remove_constants 
                        TRUE                     TRUE                     TRUE 
           remove_duplicates   replace_missing_values                scan_data 
                        TRUE                     TRUE                     TRUE 
    standardize_column_names        standardize_dates                 timespan 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-16 04:28:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31a5ec43b_1739680083
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPvTemp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cleanepi_v1.0.2-tikzDictionary"
