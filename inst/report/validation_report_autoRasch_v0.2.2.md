...
| export_help          | 24                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Feri Wijayanto <f.wijayanto@cs.ru.nl>                |
...
Overall the package has 24 exported objects. 24 are documented:
    ...
    autoRaschOptions  backward_search     check.unidim         checkRel 
                TRUE             TRUE             TRUE             TRUE 
       compute_score   compute_scores         corResid      createGroup 
                TRUE             TRUE             TRUE             TRUE 
            fitStats    generate_data    generic_model             gpcm 
                TRUE             TRUE             TRUE             TRUE 
            gpcm_dif          itemfit              pcm          pcm_dif 
                TRUE             TRUE             TRUE             TRUE 
           personfit         plot_EVC    plot_fitStats         plot_ICC 
                TRUE             TRUE             TRUE             TRUE 
          plot_PImap      plot_search         residCor  stepwise_search 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-14 07:34:24 UTC |
...
running this report
    ...
    PROCESSX_PS1c0929d3def1_1739518461
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpdb9bje
