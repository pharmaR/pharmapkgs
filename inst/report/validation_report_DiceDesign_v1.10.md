# Validation Report - DiceDesign@1.10
...
dials, DiceOptim, DiceView, DoE.wrapper, GPareto, GPCsign, GPGame,
hetGP, kergp, pGPx, rlibkriging, sensitivity

## Namespace

Overall the package has 27 exported objects. 27 are documented:

               coverage discrepancyCriteria      discrepESE_LHS       discrepSA_LHS 
                   TRUE                TRUE                TRUE                TRUE 
             dmaxDesign          factDesign    faureprimeDesign           lhsDesign 
                   TRUE                TRUE                TRUE                TRUE 
         maximinESE_LHS       maximinSA_LHS           meshRatio             mindist 
                   TRUE                TRUE                TRUE                TRUE 
            mstCriteria          nolhDesign        nolhdrDesign           olhDesign 
                   TRUE                TRUE                TRUE                TRUE 
                   phiP               rss2d               rss3d         runif.faure 
                   TRUE                TRUE                TRUE                TRUE 
            scaleDesign       straussDesign  unif.test.quantile unif.test.statistic 
                   TRUE                TRUE                TRUE                TRUE 
          unscaleDesign           wspDesign               xDRDN 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 03:59:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4690065b4_1739851180
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4IHVC6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiceDesign_v1.10-tikzDictionary"
