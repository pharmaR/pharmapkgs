# Validation Report - deident@1.0.0
...
Overall the package has 34 exported objects. 34 are documented:
                         ...
                         :=                   .data          adaptive_noise 
                       TRUE                    TRUE                    TRUE 
                   add_blur             add_encrypt               add_group 
                       TRUE                    TRUE                    TRUE 
           add_numeric_blur             add_perturb        add_pseudonymize 
                       TRUE                    TRUE                    TRUE 
                add_shuffle             add_ungroup           apply_deident 
                       TRUE                    TRUE                    TRUE 
        apply_to_data_frame                as_label                 as_name 
                       TRUE                    TRUE                    TRUE 
                BaseDeident                  Blurer           category_blur 
                       TRUE                    TRUE                    TRUE 
             create_deident                 deident deident_job_from_folder 
                       TRUE                    TRUE                    TRUE 
                       Drop               Encrypter                   enquo 
                       TRUE                    TRUE                    TRUE 
                     enquos               from_yaml         GroupedShuffler 
                       TRUE                    TRUE                    TRUE 
              lognorm_noise             new_deident           NumericBlurer 
                       TRUE                    TRUE                    TRUE 
                  Perturber           Pseudonymizer                Shuffler 
                       TRUE                    TRUE                    TRUE 
                white_noise 
                       TRUE 
...
There are 20 help pages with examples, from 29 (68.97 %).
...
| Execution Time | 2025-02-18 03:37:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43f335b3f_1739849866
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpU2cGFg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deident_v1.0.0-tikzDictionary"
