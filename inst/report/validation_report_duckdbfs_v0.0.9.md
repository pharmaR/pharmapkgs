# Validation Report - duckdbfs@0.0.9
...
| has_source_control   | https://github.com/cboettig/duckdbfs |
...
gbifdb, neonstore, overtureR, rfishbase

## Namespace

Overall the package has 11 exported objects. 11 are documented:

           as_dataset           as_view cached_connection  close_connection 
                 TRUE              TRUE              TRUE              TRUE 
     duckdb_s3_config      load_spatial      open_dataset      spatial_join 
                 TRUE              TRUE              TRUE              TRUE 
         st_read_meta             to_sf     write_dataset 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:59:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bb467878969_1739854762
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphWnUyr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_duckdbfs_v0.0.9-tikzDictionary"
