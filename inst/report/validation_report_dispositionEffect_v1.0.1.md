# Validation Report - dispositionEffect@1.0.1
...
| export_help          | 23                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Marco Zanotti <zanottimarco17@gmail.com>          |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/marcozanotti/dispositionEffect |
...
Overall the package has 23 exported objects. 22 are documented:
                       ...
                       %>%   closest_market_price     difftime_financial 
                     FALSE                   TRUE                   TRUE 
       disposition_compute disposition_compute_ts disposition_difference 
                      TRUE                   TRUE                   TRUE 
        disposition_effect    disposition_summary disposition_summary_ts 
                      TRUE                   TRUE                   TRUE 
        evaluate_portfolio           gains_losses          paper_compute 
                      TRUE                   TRUE                   TRUE 
               paper_count         paper_duration            paper_total 
                      TRUE                   TRUE                   TRUE 
               paper_value      portfolio_compute       realized_compute 
                      TRUE                   TRUE                   TRUE 
            realized_count      realized_duration         realized_empty 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:16:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44e735294_1739852175
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4cCa0D
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dispositionEffect_v1.0.1-tikzDictionary"
