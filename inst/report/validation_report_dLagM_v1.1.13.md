# Validation Report - dLagM@1.1.13
...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Haydar Demirhan <haydar.demirhan@rmit.edu.au>        |
...
| 4   | dynlm         | Depends |
| 5   | AER           | Imports |
| 6   | formula.tools | Imports |
| 7   | plyr          | Imports |
| 8   | lmtest        | Imports |
| 9   | strucchange   | Imports |
| 10  | wavethresh    | Imports |
| 11  | MASS          | Imports |
| 12  | roll          | Imports |
| 13  | sandwich      | Imports |
...
Overall the package has 18 exported objects. 18 are documented:
          ...
          ardlBound ardlBoundOrders         ardlDlm             dlm   finiteDLMauto 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           forecast           GMRAE             GoF        koyckDlm            MAPE 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               MASE           MBRAE            MRAE         polyDlm      rolCorPlot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      sdPercentiles           sMAPE       sortScore 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:24:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41cc5fe77_1739852679
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3JlskB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dLagM_v1.1.13-tikzDictionary"
