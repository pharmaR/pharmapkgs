...
| size_codebase        | 370                                         |
| has_source_control   | https://github.com/cloudyr/aws.kms          |
...
Overall the package has 24 exported objects. 24 are documented:
           ...
           create_kms_alias          create_kms_key                 decrypt 
                       TRUE                    TRUE                    TRUE 
           delete_kms_alias          delete_kms_key     delete_kms_material 
                       TRUE                    TRUE                    TRUE 
            disable_kms_key    disable_kms_rotation          enable_kms_key 
                       TRUE                    TRUE                    TRUE 
        enable_kms_rotation                 encrypt           generate_blob 
                       TRUE                    TRUE                    TRUE 
          generate_data_key             get_kms_key        get_kms_rotation 
                       TRUE                    TRUE                    TRUE 
    get_material_parameters                 kmsHTTP        list_kms_aliases 
                       TRUE                    TRUE                    TRUE 
              list_kms_keys        put_kms_material               reencrypt 
                       TRUE                    TRUE                    TRUE 
           undelete_kms_key        update_kms_alias          update_kms_key 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 07:36:47 UTC |
...
running this report
    ...
    PROCESSX_PS1c09221ebcf6_1739518604
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpODf4kf
