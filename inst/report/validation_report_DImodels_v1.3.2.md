# Validation Report - DImodels@1.3.2
...
| export_help | 15 |
| has_website | FALSE |
| has_maintainer | Rafael de Andrade Moral <rafael.deandrademoral@mu.ie> |
...
DImodelsMulti, DImodelsVis

## Namespace

Overall the package has 15 exported objects. 15 are documented:

                  autoDI         contrasts_DI       describe_model 
                    TRUE                 TRUE                 TRUE 
                      DI           DI_compare              DI_data 
                    TRUE                 TRUE                 TRUE 
             DI_data_ADD         DI_data_E_AV           DI_data_FG 
                    TRUE                 TRUE                 TRUE 
    DI_data_fullpairwise      DI_data_prepare              extract 
                    TRUE                 TRUE                 TRUE 
          richness_vs_DI             theta_CI            update_DI 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-18 04:07:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bb412095493_1739851619
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTdMQx0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DImodels_v1.3.2-tikzDictionary"
