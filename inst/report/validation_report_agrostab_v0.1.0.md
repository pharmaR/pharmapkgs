...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Anna Cheshkova <cheshanf@gmail.com>                  |
...
Overall the package has 12 exported objects. 12 are documented:
         ...
         stability.cv stability.env_var      stability.er     stability.hom 
                 TRUE              TRUE              TRUE              TRUE 
        stability.hue   stability.kilch  stability.linbin    stability.mart 
                 TRUE              TRUE              TRUE              TRUE 
        stability.shu     stability.tai   stability.udach  stability.wricke 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-14 06:43:40 UTC |
...
running this report
    ...
    PROCESSX_PS726d5a534af_1739515417
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpI7yjr5
