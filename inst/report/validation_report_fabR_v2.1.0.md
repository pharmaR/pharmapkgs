...
| export_help          | 30                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Guillaume Fabre <guijoseph.fabre@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/GuiFabre/fabR            |
...
banffIT, madshapR, mlstrOpalr, Rmonize

## Namespace

Overall the package has 30 exported objects. 30 are documented:

                 add_index         as_any_boolean            as_any_date 
                      TRUE                   TRUE                   TRUE 
            as_any_integer          as_any_symbol          bookdown_open 
                      TRUE                   TRUE                   TRUE 
           bookdown_render      bookdown_template        collect_roxygen 
                      TRUE                   TRUE                   TRUE 
                 fabR_help           fabR_website      file_index_create 
                      TRUE                   TRUE                   TRUE 
           file_index_read      file_index_search        get_all_na_cols 
                      TRUE                   TRUE                   TRUE 
           get_all_na_rows    get_duplicated_cols    get_duplicated_rows 
                      TRUE                   TRUE                   TRUE 
             get_path_list  get_unique_value_cols      guess_date_format 
                      TRUE                   TRUE                   TRUE 
            make_name_list      message_on_prompt               parceval 
                      TRUE                   TRUE                   TRUE 
      read_csv_any_formats   read_excel_allsheets           silently_run 
                      TRUE                   TRUE                   TRUE 
    template_visual_report         which_any_date  write_excel_allsheets 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-19 05:02:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d45623e1c80_1739941367
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8p14E8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fabR_v2.1.0-tikzDictionary"
