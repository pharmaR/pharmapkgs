...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Florian Jansen <florian.jansen@uni-rostock.de>       |
...
Overall the package has 9 exported objects. 9 are documented:
         ...
         autolayout        betaresp eHOF.modelnames             HOF            Para 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         Para_deriv      Para_niche        Para_opt      pick.model 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 03:50:18 UTC |
...
running this report
    ...
    PROCESSX_PS1d4561ab8708_1739937012
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppyvdBx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eHOF_v1.16-tikzDictionary"
