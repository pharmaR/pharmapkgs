...
| export_help          | 20                              |
| has_website          | TRUE                            |
| has_maintainer       | Gaurav Sood <gsood07@gmail.com> |
| bugs_status          | subscript out of bounds         |
| has_source_control   | http://github.com/soodoku/captR |
...
Overall the package has 20 exported objects. 20 are documented:
           ...
           batch_price       create_batch       delete_batch         delete_job 
                  TRUE               TRUE               TRUE               TRUE 
               get_all  get_batch_details   get_instance_set    get_template_id 
                  TRUE               TRUE               TRUE               TRUE 
      list_batch_files       list_batches          list_docs list_instance_sets 
                  TRUE               TRUE               TRUE               TRUE 
             list_jobs set_batch_template          set_token       submit_batch 
                  TRUE               TRUE               TRUE               TRUE 
        test_readiness     track_progress       upload_image       user_profile 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 03:39:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31ab2cbb6_1739677181
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQJdrqM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_captr_v0.3.0-tikzDictionary"
