# Validation Report - exametrika@1.2.0
...
| export_help          | 57                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Koji Kosugi <kosugitti@gmail.com>                    |
...
Overall the package has 57 exported objects. 57 are documented:
                ...
                AlphaCoefficient                 Biclustering 
                            TRUE                         TRUE 
                           BINET         Biserial_Correlation 
                            TRUE                         TRUE 
                             BNM               calcFitIndices 
                            TRUE                         TRUE 
                            CCRR                          crr 
                            TRUE                         TRUE 
                             CTT                   dataFormat 
                            TRUE                         TRUE 
                  Dimensionality                FieldAnalysis 
                            TRUE                         TRUE 
                         IIF2PLM                      IIF3PLM 
                            TRUE                         TRUE 
               InterItemAnalysis                          IRM 
                            TRUE                         TRUE 
                             IRT                   ITBiserial 
                            TRUE                         TRUE 
                     ItemEntropy                      ItemFit 
                            TRUE                         TRUE 
             ItemInformationFunc                     ItemLift 
                            TRUE                         TRUE 
                        ItemOdds                   ItemReport 
                            TRUE                         TRUE 
                  ItemStatistics                ItemThreshold 
                            TRUE                         TRUE 
                   ItemTotalCorr                         JCRR 
                            TRUE                         TRUE 
                 JointSampleSize                          LCA 
                            TRUE                         TRUE 
                             LDB                        LDLRA 
                            TRUE                         TRUE 
                   LogisticModel               longdataFormat 
                            TRUE                         TRUE 
                             LRA            MutualInformation 
                            TRUE                         TRUE 
                             nrs             OmegaCoefficient 
                            TRUE                         TRUE 
                         passage                   percentile 
                            TRUE                         TRUE 
                  PhiCoefficient                   RaschModel 
                            TRUE                         TRUE 
                     ScoreReport                       sscore 
                            TRUE                         TRUE 
                         stanine            StrLearningGA_BNM 
                            TRUE                         TRUE 
             StrLearningPBIL_BNM        StrLearningPBIL_LDLRA 
                            TRUE                         TRUE 
                 StudentAnalysis                      TestFit 
                            TRUE                         TRUE 
                TestFitSaturated          TestInformationFunc 
                            TRUE                         TRUE 
                  TestStatistics                  tetrachoric 
                            TRUE                         TRUE 
    TetrachoricCorrelationMatrix                     ThreePLM 
                            TRUE                         TRUE 
                          TwoPLM 
                            TRUE 
...
| Execution Time | 2025-02-19 04:47:00 UTC |
...
running this report
    ...
    PROCESSX_PS1d4556c5b7ca_1739940413
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpM4ehKz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exametrika_v1.2.0-tikzDictionary"
