...
| export_help          | 32                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Prabhanjan Tattar <prabhanjannt@gmail.com>           |
...
Overall the package has 32 exported objects. 32 are documented:
              ...
              Binom_Sim           Ehrenfest            Geom_Sim           kurtcoeff 
                   TRUE                TRUE                TRUE                TRUE 
          LRNormal2Mean     LRNormalMean_KV     LRNormalMean_UV LRNormalVariance_UM 
                   TRUE                TRUE                TRUE                TRUE 
                   lval          MPbinomial            MPNormal           MPPoisson 
                   TRUE                TRUE                TRUE                TRUE 
               msteptpm      pareto_density     pareto_quantile         Poisson_Sim 
                   TRUE                TRUE                TRUE                TRUE 
          powertestplot               QH_CI      resistant_line        siegel.tukey 
                   TRUE                TRUE                TRUE                TRUE 
              skewcoeff          ST_Ordered        ST_Unordered      stationdistTPM 
                   TRUE                TRUE                TRUE                TRUE 
                     TM                 TMH      UMPExponential           UMPNormal 
                   TRUE                TRUE                TRUE                TRUE 
             UMPUniform          vonNeumann            WilsonCI             ww.test 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-14 06:32:38 UTC |
...
running this report
    ...
    PROCESSX_PS726d209f9263_1739514756
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7P4NYe
