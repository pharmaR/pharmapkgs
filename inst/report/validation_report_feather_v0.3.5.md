# Validation Report - feather@0.3.5
...
| bugs_status          | 0.8                                 |
| has_source_control   | https://github.com/wesm/feather     |
| has_bug_reports_url  | 1                                   |
| downloads_1yr        | 165387                              |
...
archetyper, civis, D4TAlink.light, epiCleanr, IGoRRR, ProjectTemplate,
RWDataPlyr, tidyverse

## Namespace

Overall the package has 6 exported objects. 6 are documented:

             feather  feather_example feather_examples feather_metadata 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-27 03:24:32 UTC |
...
running this report
    ...
    PROCESSX_PS1c621d329443_1740626668
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp75RSIa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_feather_v0.3.5-tikzDictionary"
