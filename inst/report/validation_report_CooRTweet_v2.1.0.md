# Validation Report - CooRTweet@2.1.0
...
| export_help          | 15                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Nicola Righetti <nicola.righetti@uniurb.it> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/nicolarighetti/CooRTweet |
...
Overall the package has 15 exported objects. 15 are documented:
                   ...
                   account_stats                detect_groups 
                            TRUE                         TRUE 
                flag_speed_share generate_coordinated_network 
                            TRUE                         TRUE 
                     group_stats        load_many_tweets_json 
                            TRUE                         TRUE 
                load_tweets_json      load_twitter_users_json 
                            TRUE                         TRUE 
                  normalize_text                    prep_data 
                            TRUE                         TRUE 
               preprocess_tweets     preprocess_twitter_users 
                            TRUE                         TRUE 
                 remove_hashtags               reshape_tweets 
                            TRUE                         TRUE 
                   simulate_data 
                            TRUE 
...
| Execution Time | 2025-02-17 03:53:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64d9e96d9_1739764387
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwKJ6yn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CooRTweet_v2.1.0-tikzDictionary"
