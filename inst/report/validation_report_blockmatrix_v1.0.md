# Validation Report - blockmatrix@1.0
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         as.blockmatrix        blockmatmult         blockmatrix is.zero.blockmatrix 
                   TRUE                TRUE                TRUE                TRUE 
          ncol_elements       nrow_elements               value             value<- 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 04:23:32 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3275ae99_1739593407
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMQPTAF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blockmatrix_v1.0-tikzDictionary"
