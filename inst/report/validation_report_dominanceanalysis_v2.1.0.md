# Validation Report - dominanceanalysis@2.1.0
...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Claudio Bustos Navarrete <clbustos@gmail.com>        |
...
Overall the package has 21 exported objects. 21 are documented:
             ...
             averageContribution bootAverageDominanceAnalysis 
                            TRUE                         TRUE 
           bootDominanceAnalysis          contributionByLevel 
                            TRUE                         TRUE 
                  da.betareg.fit                   da.clm.fit 
                            TRUE                         TRUE 
                    da.dynlm.fit                   da.glm.fit 
                            TRUE                         TRUE 
                       da.lm.fit               da.lmerMod.fit 
                            TRUE                         TRUE 
                da.lmWithCov.fit            da.mlmWithCov.fit 
                            TRUE                         TRUE 
                     daSubmodels            dominanceAnalysis 
                            TRUE                         TRUE 
               dominanceBriefing              dominanceMatrix 
                            TRUE                         TRUE 
            formulas.daSubmodels                      getFits 
                            TRUE                         TRUE 
                           lmmR2                    lmWithCov 
                            TRUE                         TRUE 
                      mlmWithCov 
...
| Execution Time | 2025-02-18 04:33:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4417363a0_1739853205
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYJqxKG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dominanceanalysis_v2.1.0-tikzDictionary"
