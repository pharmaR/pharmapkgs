# Validation Report - diseasystore@0.3.0
...
| export_help          | 22                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Rasmus Skytte Randløv <rske@ssi.dk>    |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/ssi-dk/diseasystore |
...
Overall the package has 22 exported objects. 21 are documented:
                                   ...
                                   %.%                          add_years 
                                 FALSE                               TRUE 
                            age_labels                        age_on_date 
                                  TRUE                               TRUE 
               available_diseasystores                      diseasyoption 
                                  TRUE                               TRUE 
                   diseasystore_exists                   DiseasystoreBase 
                                  TRUE                               TRUE 
    DiseasystoreEcdcRespiratoryViruses          DiseasystoreGoogleCovid19 
                                  TRUE                               TRUE 
                  DiseasystoreSimulist                  drop_diseasystore 
                                  TRUE                               TRUE 
                        FeatureHandler                   get_diseasystore 
                                  TRUE                               TRUE 
                        key_join_count                       key_join_max 
                                  TRUE                               TRUE 
                          key_join_min                       key_join_sum 
                                  TRUE                               TRUE 
                    source_conn_github                   source_conn_path 
                                  TRUE                               TRUE 
                     test_diseasystore               to_diseasystore_case 
                                  TRUE                               TRUE 
...
| Execution Time | 2025-02-18 04:15:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bb445565111_1739852094
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpgjsx3E
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diseasystore_v0.3.0-tikzDictionary"
