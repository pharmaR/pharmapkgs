# Validation Report - BlockmodelingGUI@1.8.4
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Fabio Ashtar Telarico <telaricof@fdv.uni-lj.si>      |
...
|     | package       | type    |
|:----|:--------------|:--------|
| 1   | blockmodeling | Imports |
| 2   | shiny         | Imports |
| 3   | DT            | Imports |
| 4   | htmlwidgets   | Imports |
| 5   | igraph        | Imports |
| 6   | intergraph    | Imports |
| 7   | network       | Imports |
| 8   | shinybusy     | Imports |
| 9   | shinyjs       | Imports |
| 10  | shinythemes   | Imports |
| 11  | visNetwork    | Imports |
...
| Execution Time | 2025-02-15 04:23:49 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd40a0f81f_1739593424
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpujWTDF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BlockmodelingGUI_v1.8.4-tikzDictionary"
