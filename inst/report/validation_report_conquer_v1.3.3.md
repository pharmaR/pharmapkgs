# Validation Report - conquer@1.3.3
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Xiaoou Pan <xip024@ucsd.edu>                         |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/XiaoouPan/conquer                 |
...
| 4   | stats                           | Imports   |
| 5   | Rcpp                            | LinkingTo |
| 6   | RcppArmadillo (\>= 0.9.850.1.0) | LinkingTo |
...
diagL1, HIMA, Qtools, quantreg, SGDinference

## Namespace

Overall the package has 4 exported objects. 4 are documented:

            conquer  conquer.cv.reg conquer.process     conquer.reg 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 03:46:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6a47eabe_1739764000
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpe95S82
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conquer_v1.3.3-tikzDictionary"
