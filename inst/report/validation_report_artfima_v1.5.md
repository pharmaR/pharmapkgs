...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | A.I. McLeod <aimcleod@uwo.ca>                        |
...
Overall the package has 13 exported objects. 13 are documented:
             ...
             artfima       artfimaSDF     artfimaTACVF           artsim 
                TRUE             TRUE             TRUE             TRUE 
     best_glp_models       bestModels          ifisher      Periodogram 
                TRUE             TRUE             TRUE             TRUE 
        plot.artfima  predict.artfima    print.artfima print.bestmodels 
                TRUE             TRUE             TRUE             TRUE 
                tseg 
                TRUE 
...
| Execution Time | 2025-02-14 07:25:31 UTC |
...
running this report
    ...
    PROCESSX_PS1c097ab351db_1739517928
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmTKljs
