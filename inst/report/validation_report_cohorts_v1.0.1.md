# Validation Report - cohorts@1.0.1
...
| export_help          | 6                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Peer Christensen <hr.pchristensen@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/PeerChristensen/cohorts   |
...
Overall the package has 6 exported objects. 5 are documented:
                   ...
                   %>%   cohort_table_day cohort_table_month   cohort_table_pct 
                 FALSE               TRUE               TRUE               TRUE 
            shift_left     shift_left_pct 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:55:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bc357525f1a_1739681718
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnhN8cq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cohorts_v1.0.1-tikzDictionary"
