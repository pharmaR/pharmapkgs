# Validation Report - chemodiv@0.3.0
...
| export_help          | 11                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Hampus Petrén <hampus.petren@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/hpetren/chemodiv     |
...
Overall the package has 11 exported objects. 11 are documented:
      ...
      calcBetaDiv       calcDiv   calcDivProf chemoDivCheck  chemoDivPlot 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          compDis        molNet    molNetPlot      NPCTable quickChemoDiv 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          sampDis 
             TRUE 
...
| Execution Time | 2025-02-16 04:11:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33788ace6_1739679087
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbYccH6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chemodiv_v0.3.0-tikzDictionary"
