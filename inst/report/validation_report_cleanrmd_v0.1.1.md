# Validation Report - cleanrmd@0.1.1
...
| has_source_control   | https://github.com/gadenbuie/cleanrmd    |
...
epoxy, intradayModel, rmarkdown, SingleCaseES

## Namespace

Overall the package has 4 exported objects. 4 are documented:

    cleanrmd_theme_dependency           cleanrmd_themes       html_document_clean 
                         TRUE                      TRUE                      TRUE 
                 use_cleanrmd 
                         TRUE 
...
| Execution Time | 2025-02-16 04:28:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bc342b48264_1739680123
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNTioD0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cleanrmd_v0.1.1-tikzDictionary"
