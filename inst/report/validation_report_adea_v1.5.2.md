...
| 1   | methods             | Depends |
| 2   | rmarkdown           | Depends |
| 3   | ROI.plugin.glpk     | Depends |
| 4   | ROI.plugin.lpsolve  | Depends |
| 5   | ROI.plugin.symphony | Depends |
| 6   | combinat            | Imports |
| 7   | graphics            | Imports |
| 8   | knitr               | Imports |
| 9   | lpSolveAPI          | Imports |
| 10  | parallel            | Imports |
| 11  | parallelly          | Imports |
| 12  | ROI                 | Imports |
| 13  | slam                | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
                  ...
                  adea  adea_hierarchical adea_load_leverage         adea_loads 
                  TRUE               TRUE               TRUE               TRUE 
       adea_parametric              cadea                dea              fsdea 
                  TRUE               TRUE               TRUE               TRUE 

### Examples

There are 37 help pages with examples, from 43 (86.05 %).
...
| Execution Time | 2025-02-14 06:36:26 UTC |
...
running this report
    ...
    PROCESSX_PS726d73467738_1739514983
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptgFAK3
