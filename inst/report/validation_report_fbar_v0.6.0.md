...
| export_help          | 13                                 |
| has_website          | TRUE                               |
| has_maintainer       | Max Conway <conway.max1@gmail.com> |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/maxconway/fbar  |
...
Overall the package has 13 exported objects. 13 are documented:
       ...
       decompose_metabolites         expanded_to_glpk       expanded_to_gurobi 
                        TRUE                     TRUE                     TRUE 
     expanded_to_reactiontbl          expanded_to_ROI find_flux_variability_df 
                        TRUE                     TRUE                     TRUE 
              find_fluxes_df           gene_associate                gene_eval 
                        TRUE                     TRUE                     TRUE 
                    get_BiGG  reactiontbl_to_expanded    reactiontbl_to_gurobi 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-19 05:25:00 UTC |
...
running this report
    ...
    PROCESSX_PS1d4557b73780_1739942693
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWiNSnK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fbar_v0.6.0-tikzDictionary"
