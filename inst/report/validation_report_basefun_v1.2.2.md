# Validation Report - basefun@1.2.2
...
cotram, counterfactuals, mlt, mlt.docreg, tbm, tram, tramicp, tramME,
tramnet
...
Overall the package has 8 exported objects. 8 are documented:
            ...
            as.basis                b  Bernstein_basis     cyclic_basis 
                TRUE             TRUE             TRUE             TRUE 
     intercept_basis   Legendre_basis        log_basis polynomial_basis 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-21 13:13:02 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a60ea656f_1740143578
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmiMuyP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_basefun_v1.2.2-tikzDictionary"
