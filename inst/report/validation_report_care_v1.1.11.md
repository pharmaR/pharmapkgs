...
crossval, mlr, mlr3filters, mlrCPO, relaimpo, sense

## Namespace

Overall the package has 4 exported objects. 4 are documented:

         carscore make.predlist   predict.slm           slm 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-16 03:41:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3272534be_1739677287
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRgWh2x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_care_v1.1.11-tikzDictionary"
