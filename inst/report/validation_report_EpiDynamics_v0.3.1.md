# Validation Report - EpiDynamics@0.3.1
...
| export_help          | 28                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Oswaldo Santos Baquero <baquero@usp.br>              |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/oswaldosantos/EpiDynamics         |
...
Overall the package has 28 exported objects. 28 are documented:
    ...
    MultiStrainPartialImmunity                   PlotMods 
                          TRUE                       TRUE 
                          SEIR            SEIR4AgeClasses 
                          TRUE                       TRUE 
                   SEIRnStages                        SIR 
                          TRUE                       TRUE 
                sir2AgeClasses                 SIR2Stages 
                          TRUE                       TRUE 
              SIR2TypesImports           SIRAdditiveNoise 
                          TRUE                       TRUE 
                 SIRBirthDeath            SIRCarrierState 
                          TRUE                       TRUE 
                 SIRDemogStoch        SIRInducedMortality 
                          TRUE                       TRUE 
          SIRInducedMortality2         SIRPartialImmunity 
                          TRUE                       TRUE 
        SIRScaledAdditiveNoise         SIRSinusoidalBirth 
                          TRUE                       TRUE 
          SIRSinusoidalForcing                 SIRTauLeap 
                          TRUE                       TRUE 
            SIRTermTimeForcing                  SIRVector 
                          TRUE                       TRUE 
                           SIS             SIS2RiskGroups 
                          TRUE                       TRUE 
                 SISDemogStoch    SISinusoidalTransmBrith 
                          TRUE                       TRUE 
                SISnRiskGroups          SISPairwiseApprox 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-19 04:16:08 UTC |
...
running this report
    ...
    PROCESSX_PS1d45693a8fac_1739938562
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpO1a9zo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EpiDynamics_v0.3.1-tikzDictionary"
