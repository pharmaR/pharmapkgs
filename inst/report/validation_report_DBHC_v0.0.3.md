...
| export_help          | 13                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Gabriel Budel <gabysp_budel@hotmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/gabybudel/DBHC        |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | seqHMM (\>= 1.0.8)   | Imports |
| 2   | TraMineR (\>= 2.0-7) | Imports |
| 3   | reshape2 (\>= 1.2.1) | Imports |
| 4   | ggplot2 (\>= 2.2.1)  | Imports |
| 5   | methods (\>= 4.2.2)  | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
         ...
         assign.clusters          cluster.bic     count.parameters 
                    TRUE                 TRUE                 TRUE 
        emission.heatmap            hmm.clust             model.ll 
                    TRUE                 TRUE                 TRUE 
           partition.bic         select.seeds           seq2hmm.ll 
                    TRUE                 TRUE                 TRUE 
             size.search           smooth.hmm smooth.probabilities 
                    TRUE                 TRUE                 TRUE 
      transition.heatmap 
                    TRUE 
...
| Execution Time | 2025-02-17 05:06:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6263bce6_1739768772
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0idjcb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DBHC_v0.0.3-tikzDictionary"
