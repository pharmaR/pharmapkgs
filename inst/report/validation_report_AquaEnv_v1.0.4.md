...
Overall the package has 30 exported objects. 30 are documented:
              ...
              aquaenv     BufferFactors         c.aquaenv         ConcRelCl 
                 TRUE              TRUE              TRUE              TRUE 
              convert      DeltaPcoeffs           gauge_p            K_BOH3 
                 TRUE              TRUE              TRUE              TRUE 
                K_CO2           K_H2PO4             K_H2S           K_H3PO4 
                 TRUE              TRUE              TRUE              TRUE 
               K_HCO3              K_HF            K_HPO4            K_HSO4 
                 TRUE              TRUE              TRUE              TRUE 
                K_NH4           K_SiOH4          K_SiOOH3               K_W 
                 TRUE              TRUE              TRUE              TRUE 
               K0_CO2             K0_O2     Ksp_aragonite       Ksp_calcite 
                 TRUE              TRUE              TRUE              TRUE 
    MeanMolecularMass     PhysChemConst             TAfit        Technicals 
                 TRUE              TRUE              TRUE              TRUE 
            titration          watdepth 
                 TRUE              TRUE 
...
There are 30 help pages with examples, from 37 (81.08 %).
...
| Execution Time | 2025-02-14 07:20:13 UTC |
...
running this report
    ...
    PROCESSX_PS1c092d543877_1739517610
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpClJ786
