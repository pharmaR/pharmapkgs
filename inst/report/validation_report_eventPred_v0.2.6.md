# Validation Report - eventPred@0.2.6
...
| has_source_control   | https://github.com/kaifenglu/eventPred |
...
| 2   | rlang (\>= 1.0.6)         | Imports |
| 3   | plotly (\>= 4.10.1)       | Imports |
| 4   | survival (\>= 2.41-3)     | Imports |
| 5   | splines (\>= 3.5.0)       | Imports |
| 6   | Matrix (\>= 1.2-14)       | Imports |
| 7   | mvtnorm (\>= 1.1-3)       | Imports |
| 8   | rstpm2 (\>= 1.6.1)        | Imports |
| 9   | numDeriv (\>= 2016.8-1.1) | Imports |
| 10  | purrr (\>= 1.0.2)         | Imports |
| 11  | flexsurv (\>= 2.2.2)      | Imports |
| 12  | erify (\>= 0.4.0)         | Imports |
| 13  | stats (\>= 3.5.0)         | Imports |
| 14  | shiny (\>= 1.7.1)         | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
           ...
           fitDropout     fitEnrollment          fitEvent     getPrediction 
                 TRUE              TRUE              TRUE              TRUE 
           llik_pwexp           pmodavg            ppwexp predictEnrollment 
                 TRUE              TRUE              TRUE              TRUE 
         predictEvent          pwexpreg            qpwexp       runShinyApp 
                 TRUE              TRUE              TRUE              TRUE 
    summarizeObserved 
                 TRUE 
...
| Execution Time | 2025-02-19 04:40:18 UTC |
...
running this report
    ...
    PROCESSX_PS1d4536bbc38e_1739940012
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5rMYlO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eventPred_v0.2.6-tikzDictionary"
