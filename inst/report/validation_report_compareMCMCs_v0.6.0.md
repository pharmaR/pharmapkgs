# Validation Report - compareMCMCs@0.6.0
...
| export_help          | 26                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Perry de Valpine <pdevalpine@berkeley.edu> |
| bugs_status          | 0.9666667                                  |
| has_source_control   | https://github.com/nimble-dev/compareMCMCs |
...
Overall the package has 26 exported objects. 26 are documented:
                    ...
                    addMetrics           applyConversions 
                          TRUE                       TRUE 
                  clearMetrics             combineMetrics 
                          TRUE                       TRUE 
                  compareMCMCs                 getMetrics 
                          TRUE                       TRUE 
             getPageComponents make_MCMC_comparison_pages 
                          TRUE                       TRUE 
                 MCMCdef_dummy               MCMCdef_jags 
                          TRUE                       TRUE 
                  MCMCdef_stan            MCMCmetric_CI95 
                          TRUE                       TRUE 
            MCMCmetric_CI95low         MCMCmetric_CI95upp 
                          TRUE                       TRUE 
         MCMCmetric_efficiency             MCMCmetric_ESS 
                          TRUE                       TRUE 
               MCMCmetric_mean          MCMCmetric_median 
                          TRUE                       TRUE 
                 MCMCmetric_sd                 MCMCresult 
                          TRUE                       TRUE 
            registerMCMCengine            registerMetrics 
                          TRUE                       TRUE 
        registerPageComponents                 renameMCMC 
                          TRUE                       TRUE 
              unregisterMetric   unregisterPageComponents 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-17 03:34:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bd651b2ecfb_1739763262
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9Zi2NA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_compareMCMCs_v0.6.0-tikzDictionary"
