# Validation Report - endoSwitch@1.0.0
...
| has_source_control   | https://github.com/cbw1243/endoSwitch                |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | data.table (\>= 1.12.2) | Imports |
| 2   | maxLik (\>= 1.3-6)      | Imports |
| 3   | stats (\>= 3.6.1)       | Imports |
| 4   | msm (\>= 1.6.7)         | Imports |
...
| Execution Time | 2025-02-19 04:07:04 UTC |
...
running this report
    ...
    PROCESSX_PS1d4529519b23_1739938018
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9Rhvjv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_endoSwitch_v1.0.0-tikzDictionary"
