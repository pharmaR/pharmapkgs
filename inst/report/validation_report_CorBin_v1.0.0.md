# Validation Report - CorBin@1.0.0
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Shuang Song <song-s19@mails.tsinghua.edu.cn>         |
...
Overall the package has 7 exported objects. 7 are documented:
         ...
         cBern  cBern1dep   cBernDCP    cBernEx rhoMax1dep  rhoMaxDCP   rhoMaxEx 
...
| Execution Time | 2025-02-17 03:56:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63db4ce97_1739764571
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYfFGPR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CorBin_v1.0.0-tikzDictionary"
