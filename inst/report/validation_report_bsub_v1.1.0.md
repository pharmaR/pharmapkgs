...
| has_source_control   | https://github.com/jokergoo/bsub                     |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | GlobalOptions (\>= 0.1.1) | Imports |
| 2   | GetoptLong (\>= 0.1.8)    | Imports |
| 3   | digest                    | Imports |
| 4   | utils                     | Imports |
| 5   | stats                     | Imports |
| 6   | clisymbols                | Imports |
| 7   | crayon                    | Imports |
| 8   | methods                   | Imports |
| 9   | grDevices                 | Imports |
| 10  | graphics                  | Imports |
...
Overall the package has 31 exported objects. 31 are documented:
                 ...
                 bconf              bjobs      bjobs_barplot         bjobs_done 
                  TRUE               TRUE               TRUE               TRUE 
            bjobs_exit      bjobs_pending      bjobs_running     bjobs_timeline 
                  TRUE               TRUE               TRUE               TRUE 
                 bkill            brecent         bsub_chunk           bsub_cmd 
                  TRUE               TRUE               TRUE               TRUE 
              bsub_opt        bsub_script   check_dump_files     clear_temp_dir 
                  TRUE               TRUE               TRUE               TRUE 
        get_dependency    is_job_finished            job_log   job_status_by_id 
                  TRUE               TRUE               TRUE               TRUE 
    job_status_by_name            monitor    plot_dependency        print.bconf 
                  TRUE               TRUE               TRUE               TRUE 
           print.bjobs         random_job       retrieve_var            run_cmd 
                  TRUE               TRUE               TRUE               TRUE 
           ssh_connect     ssh_disconnect          wait_jobs 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:51:45 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4144d03d_1739595099
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaoKhMk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bsub_v1.1.0-tikzDictionary"
