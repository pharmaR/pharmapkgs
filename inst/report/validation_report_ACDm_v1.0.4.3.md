...
| export_help          | 45                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Markus Belfrage <markus.belfrage@gmail.com>          |
...
Overall the package has 45 exported objects. 45 are documented:
                 ...
                 acdFit             acf_acd     burrExpectation    computeDurations 
                   TRUE                TRUE                TRUE                TRUE 
                  dburr               dgenf           dgengamma          diurnalAdj 
                   TRUE                TRUE                TRUE                TRUE 
           dmixinvgauss             dmixqwe             dmixqww           dqweibull 
                   TRUE                TRUE                TRUE                TRUE 
             genfHazard      gengammaHazard   mixinvgaussHazard        mixqweHazard 
                   TRUE                TRUE                TRUE                TRUE 
           mixqwwHazard               pburr               pgenf           pgengamma 
                   TRUE                TRUE                TRUE                TRUE 
          plotDescTrans          plotHazard         plotHistAcd              plotLL 
                   TRUE                TRUE                TRUE                TRUE 
        plotRollMeanAcd      plotScatterAcd        pmixinvgauss             pmixqwe 
                   TRUE                TRUE                TRUE                TRUE 
                pmixqww           pqweibull               qburr           qgengamma 
                   TRUE                TRUE                TRUE                TRUE 
              qqplotAcd           qqweibull qweibullExpectation      qweibullHazard 
                   TRUE                TRUE                TRUE                TRUE 
                  rburr      resiDensityAcd           rgengamma           rqweibull 
                   TRUE                TRUE                TRUE                TRUE 
                sim_ACD     standardizeResi           testRmACD           testSTACD 
                   TRUE                TRUE                TRUE                TRUE 
              testTVACD 
                   TRUE 
...
| Execution Time | 2025-02-14 06:31:18 UTC |
...
running this report
    ...
    PROCESSX_PS726d4e9239ea_1739514676
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQOOAc4
