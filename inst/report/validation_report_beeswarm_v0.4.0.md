# Validation Report - beeswarm@0.4.0
...
| export_help          | 4                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Aron Eklund <aroneklund@gmail.com>     |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/aroneklund/beeswarm |
| has_bug_reports_url  | 1                                      |
| downloads_1yr        | 275808                                 |
...
clickR, ggbeeswarm, ggdist, HiResTEC, IRTShiny, mitch, omicsViewer,
OUTRIDER, papaja, sjSDM, tmod, vipor

## Namespace

Overall the package has 4 exported objects. 4 are documented:

    beeswarm   bxplot   swarmx   swarmy 
        TRUE     TRUE     TRUE     TRUE 
...
| Execution Time | 2025-02-15 03:51:32 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd65147cb3_1739591487
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKfaPJD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beeswarm_v0.4.0-tikzDictionary"
