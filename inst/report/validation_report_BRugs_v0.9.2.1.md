# Validation Report - BRugs@0.9.2.1
...
| export_help          | 70                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Uwe Ligges <ligges@statistik.tu-dortmund.de>         |
...
bcrm, dclone, miscF, R2WinBUGS

## Namespace

Overall the package has 70 exported objects. 69 are documented:

                BRugsFit             bugsData            bugsInits 
                    TRUE                 TRUE                 TRUE 
               buildMCMC             dicClear               dicSet 
                    TRUE                 TRUE                 TRUE 
                dicStats         getNumChains           help.BRugs 
                    TRUE                 TRUE                 TRUE 
            help.WinBUGS           infoMemory          infoModules 
                    TRUE                 TRUE                 TRUE 
         infoNodeMethods        infoNodeTypes       infoNodeValues 
                    TRUE                 TRUE                 TRUE 
     infoUpdatersbyDepth   infoUpdatersbyName         loadOpenBUGS 
                    TRUE                 TRUE                FALSE 
      modelAdaptivePhase           modelCheck         modelCompile 
                    TRUE                 TRUE                 TRUE 
               modelData         modelDisable          modelEnable 
                    TRUE                 TRUE                 TRUE 
           modelGenInits           modelInits       modelIteration 
                    TRUE                 TRUE                 TRUE 
              modelNames       modelPrecision       modelSaveState 
                    TRUE                 TRUE                 TRUE 
              modelSetAP          modelSetIts           modelSetOR 
                    TRUE                 TRUE                 TRUE 
              modelSetRN           modelSetWD          modelUpdate 
                    TRUE                 TRUE                 TRUE 
               plotAutoC              plotBgr          plotDensity 
                    TRUE                 TRUE                 TRUE 
             plotHistory           ranksClear             ranksSet 
                    TRUE                 TRUE                 TRUE 
              ranksStats         samplesAutoC           samplesBgr 
                    TRUE                 TRUE                 TRUE 
            samplesClear          samplesCoda        samplesCorrel 
                    TRUE                 TRUE                 TRUE 
          samplesDensity        samplesGetBeg        samplesGetEnd 
                    TRUE                 TRUE                 TRUE 
    samplesGetFirstChain  samplesGetLastChain       samplesGetThin 
                    TRUE                 TRUE                 TRUE 
          samplesHistory      samplesMonitors        samplesSample 
                    TRUE                 TRUE                 TRUE 
              samplesSet        samplesSetBeg        samplesSetEnd 
                    TRUE                 TRUE                 TRUE 
    samplesSetFirstChain  samplesSetLastChain       samplesSetThin 
                    TRUE                 TRUE                 TRUE 
             samplesSize         samplesStats            setValues 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-22 03:19:30 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb25d97d9d_1740194366
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmptzf7DC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BRugs_v0.9.2.1-tikzDictionary"
