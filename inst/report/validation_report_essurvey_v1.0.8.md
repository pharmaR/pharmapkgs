# Validation Report - essurvey@1.0.8
...
| export_help          | 20                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Jorge Cimentada <cimentadaj@gmail.com> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/ropensci/essurvey   |
...
Overall the package has 20 exported objects. 20 are documented:
             ...
             download_country           download_rounds     download_sddf_country 
                         TRUE                      TRUE                      TRUE 
         import_all_cntrounds         import_all_rounds import_all_sddf_cntrounds 
                         TRUE                      TRUE                      TRUE 
               import_country             import_rounds       import_sddf_country 
                         TRUE                      TRUE                      TRUE 
              recode_missings    recode_numeric_missing    recode_strings_missing 
                         TRUE                      TRUE                      TRUE 
                    set_email            show_countries       show_country_rounds 
                         TRUE                      TRUE                      TRUE 
                  show_rounds       show_rounds_country       show_sddf_cntrounds 
                         TRUE                      TRUE                      TRUE 
            show_theme_rounds               show_themes 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-19 04:31:26 UTC |
...
running this report
    ...
    PROCESSX_PS1d457ed133a4_1739939480
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpN56vBf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_essurvey_v1.0.8-tikzDictionary"
