# Validation Report - crfsuite@0.4.2
...
| has_source_control   | https://github.com/bnosac/crfsuite                   |
...
Overall the package has 9 exported objects. 9 are documented:
                    ...
                    as.crf                    crf        crf_caretmethod 
                      TRUE                   TRUE                   TRUE 
      crf_cbind_attributes         crf_evaluation            crf_options 
                      TRUE                   TRUE                   TRUE 
    ner_download_modeldata            txt_feature            txt_sprintf 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-17 04:20:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62713161b_1739766004
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVtYTZE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crfsuite_v0.4.2-tikzDictionary"
