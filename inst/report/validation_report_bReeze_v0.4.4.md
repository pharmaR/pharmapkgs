# Validation Report - bReeze@0.4.4
...
| export_help          | 33                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Christian Graul <christian.graul@gmail.com>          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/chgrl/bReeze                      |
...
Overall the package has 33 exported objects. 33 are documented:
              ...
              aep         avail  availability       changes         clean 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              cln           day      day.plot            en        energy 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             freq     frequency           iec           map      map.plot 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             mast   month.stats            ms            pc           pol 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       polar.plot           pro           set     timestamp            ts 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             turb turb.iec.plot    turbulence            uc   uncertainty 
             TRUE          TRUE          TRUE          TRUE          TRUE 
               wb       weibull   windprofile 
             TRUE          TRUE          TRUE 

### Examples

There are 20 help pages with examples, from 27 (74.07 %).
...
| Execution Time | 2025-02-15 04:43:20 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1f0c21f8_1739594595
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfBLyUZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bReeze_v0.4.4-tikzDictionary"
