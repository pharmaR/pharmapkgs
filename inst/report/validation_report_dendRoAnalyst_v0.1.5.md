# Validation Report - dendRoAnalyst@0.1.5
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Sugam Aryal <sugam.aryal@fau.de>                     |
...
Overall the package has 19 exported objects. 19 are documented:
                 ...
                 clim.twd            daily.data       dendro.resample 
                     TRUE                  TRUE                  TRUE 
          dendro.truncate            dm.detrend       dm.fit.gompertz 
                     TRUE                  TRUE                  TRUE 
      dm.na.interpolation        i.jump.locator          jump.locator 
                     TRUE                  TRUE                  TRUE 
        mean_detrended.dm            mov.cor.dm network.interpolation 
                     TRUE                  TRUE                  TRUE 
                 phase.sc              phase.zg          plot_mov.cor 
                     TRUE                  TRUE                  TRUE 
           plot_SC_output        plot_ZG_output      read.dendrometer 
                     TRUE                  TRUE                  TRUE 
               twd.maxima 
                     TRUE 
...
| Execution Time | 2025-02-18 03:40:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bb458bd5907_1739850044
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGV1caV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dendRoAnalyst_v0.1.5-tikzDictionary"
