# Validation Report - ergm.count@4.1.2
...
|     | package                    | type      |
|:----|:---------------------------|:----------|
| 1   | ergm (\>= 4.2.1)           | Depends   |
| 2   | network (\>= 1.15)         | Depends   |
| 3   | statnet.common (\>= 4.2.0) | Imports   |
| 4   | Rdpack (\>= 2.4)           | Imports   |
| 5   | ergm                       | LinkingTo |
...
There are 6 help pages with examples, from 9 (66.67 %).
...
| Execution Time | 2025-02-19 04:25:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d455b74a9e4_1739939146
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9k1l4Z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ergm.count_v4.1.2-tikzDictionary"
