# Validation Report - epicontacts@1.1.4
...
| export_help          | 16                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Finlay Campbell <finlaycampbell93@gmail.com> |
...
doublIn, epichains, epiflows, outbreaker2, simulist

## Namespace

Overall the package has 16 exported objects. 16 are documented:

                  cases_pal             codeawesome               edges_pal 
                       TRUE                    TRUE                    TRUE 
                    fac2col            get_clusters              get_degree 
                       TRUE                    TRUE                    TRUE 
                     get_id            get_pairwise                 graph3D 
                       TRUE                    TRUE                    TRUE 
           make_epicontacts                spectral   subset_clusters_by_id 
                       TRUE                    TRUE                    TRUE 
    subset_clusters_by_size                    thin                  transp 
                       TRUE                    TRUE                    TRUE 
            vis_epicontacts 
                       TRUE 
...
| Execution Time | 2025-02-19 04:15:20 UTC |
...
running this report
    ...
    PROCESSX_PS1d4523b8c37_1739938514
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXcKFXL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epicontacts_v1.1.4-tikzDictionary"
