...
Overall the package has 8 exported objects. 10 are documented:
      ...
      calculate.effort generate.transects       get.coverage      make.coverage 
                  TRUE               TRUE               TRUE               TRUE 
           make.design        make.region       run.coverage    write.transects 
                  TRUE               TRUE               TRUE               TRUE 

### Examples

There are 15 help pages with examples, from 25 (60.00 %).
...
| Execution Time | 2025-02-18 04:52:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41d4681_1739854369
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpu59EPU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dssd_v1.0.2-tikzDictionary"
