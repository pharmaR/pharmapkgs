# Validation Report - convey@1.0.1
...
| export_help          | 27                                  |
| has_website          | TRUE                                |
| has_maintainer       | Anthony Damico <ajdamico@gmail.com> |
...
COVIDIBGE, PNADcIBGE, PNDSIBGE, PNSIBGE, SIPDIBGE, srvyr

## Namespace

Overall the package has 27 exported objects. 27 are documented:

    contrastinf convey_prep     densfun       h_fun        icdf     svyarpr 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
        svyarpt      svyatk      svyfgt   svyfgtdec      svygei   svygeidec 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
        svygini      svygpg  svyiqalpha      svyisq     svyjdiv  svyjdivdec 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
      svylorenz  svypoormed      svyqsr     svyrich     svyrmir     svyrmpg 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
       svywatts svywattsdec    svyzenga 
           TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 03:51:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6481f17af_1739764311
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZXt4uu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_convey_v1.0.1-tikzDictionary"
