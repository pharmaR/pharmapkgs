# Validation Report - bsearchtools@0.0.61
...
| export_help          | 42                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Marco Giuliano <mgiuliano.mail@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/digEmAll/bsearchtools  |
...
Overall the package has 42 exported objects. 42 are documented:
                        ...
                        AND  as.character.DFI.FEXPR       as.data.frame.DFI 
                       TRUE                    TRUE                    TRUE 
                     as.DFI           as.matrix.DFI                     DFI 
                       TRUE                    TRUE                    TRUE 
               DFI.getIndex             DFI.indexes              DFI.subset 
                       TRUE                    TRUE                    TRUE 
                 DFI.unWrap                      EQ                    EQNA 
                       TRUE                    TRUE                    TRUE 
                         IN          indexesEqualTo indexesEqualToCharacter 
                       TRUE                    TRUE                    TRUE 
      indexesEqualToInteger   indexesEqualToLogical   indexesEqualToNumeric 
                       TRUE                    TRUE                    TRUE 
             indexesInRange indexesInRangeCharacter   indexesInRangeInteger 
                       TRUE                    TRUE                    TRUE 
      indexesInRangeLogical   indexesInRangeNumeric    intersectIndexesList 
                       TRUE                    TRUE                    TRUE 
                     is.DFI                      lb             lbCharacter 
                       TRUE                    TRUE                    TRUE 
                  lbInteger               lbLogical               lbNumeric 
                       TRUE                    TRUE                    TRUE 
                        NOT                      OR               print.DFI 
                       TRUE                    TRUE                    TRUE 
            print.DFI.FEXPR                      RG      toString.DFI.FEXPR 
                       TRUE                    TRUE                    TRUE 
                         ub             ubCharacter               ubInteger 
                       TRUE                    TRUE                    TRUE 
                  ubLogical               ubNumeric        unionIndexesList 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-15 04:48:29 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd47cd7231_1739594904
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmprjnz60
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bsearchtools_v0.0.61-tikzDictionary"
