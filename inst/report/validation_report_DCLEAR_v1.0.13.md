# Validation Report - DCLEAR@1.0.13
...
| export_help          | 23                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Il-Youp Kwak <ikwak2@cau.ac.kr>                      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/ikwak2/DCLEAR                     |
...
| 3   | tensorflow(\>= 2.2.0) | Depends   |
| 4   | BiocParallel          | Imports   |
| 5   | dplyr                 | Imports   |
| 6   | Matrix                | Imports   |
...
| 14  | stringr               | Imports   |
| 15  | tidyr                 | Imports   |
| 16  | rBayesianOptimization | Imports   |
| 17  | rlang                 | Imports   |
| 18  | BiocGenerics          | Imports   |
...
Overall the package has 8 exported objects. 22 are documented:

    get_replacement_probability  get_transition_probability 
                           TRUE                        TRUE 
       positional_mutation_prob         sample_outcome_prob 
                           TRUE                        TRUE 
                    sim_seqdata                          WH 
                           TRUE                        TRUE 
                       WH_train                WH_train_fit 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-17 05:10:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6b9db4b9_1739769015
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7pArZg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DCLEAR_v1.0.13-tikzDictionary"
