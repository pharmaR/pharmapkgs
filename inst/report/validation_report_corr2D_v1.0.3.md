# Validation Report - corr2D@1.0.3
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Robert Geitner <robert.geitner@tu-ilmenau.de>        |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | doParallel (\>= 1.0.8) | Imports |
| 2   | foreach (\>= 1.4.3)    | Imports |
| 3   | parallel (\>= 3.0.2)   | Imports |
| 4   | fields (\>= 8.2-1)     | Imports |
| 5   | mmand (\>= 1.3.0)      | Imports |
| 6   | stats (\>= 3.0.2)      | Imports |
| 7   | grDevices (\>= 3.0.2)  | Imports |
| 8   | graphics (\>= 3.0.2)   | Imports |
| 9   | utils (\>= 3.0.2)      | Imports |
| 10  | colorspace (\>= 1.3-0) | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
            ...
            codis2d          corr2d        corr2t2d       is.corr2d     plot_corr2d 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    plot_corr2din3d       sim2ddata 
               TRUE            TRUE 
...
| Execution Time | 2025-02-17 03:59:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64b933e65_1739764755
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5L0vl1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corr2D_v1.0.3-tikzDictionary"
