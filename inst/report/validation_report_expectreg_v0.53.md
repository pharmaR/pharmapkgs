# Validation Report - expectreg@0.53
...
| export_help | 35 |
| has_website | FALSE |
| has_maintainer | Fabian Otto-Sobotka <fabian.otto-sobotka@uni-oldenburg.de> |
...
| 1   | stats                 | Depends   |
| 2   | parallel              | Depends   |
| 3   | mboost (\>= 2.1.0)    | Depends   |
| 4   | BayesX (\>= 0.2-4)    | Depends   |
| 5   | Matrix                | Depends   |
| 6   | Rcpp (\>= 0.11.2)     | Imports   |
| 7   | splines               | Imports   |
| 8   | quadprog              | Imports   |
| 9   | colorspace (\>= 0.97) | Imports   |
| 10  | fields                | Imports   |
| 11  | Rcpp                  | LinkingTo |
| 12  | RcppEigen             | LinkingTo |
...
dirttee, locpolExpectile

## Namespace

Overall the package has 35 exported objects. 35 are documented:

         cdf.bundle          cdf.qp            demq           ebeta          echisq 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               eemq          eenorm          eeplot            eexp          egamma 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             elnorm           enorm              et           eunif       expectile 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    expectreg.boost    expectreg.ls    expectreg.qp            mono           Mqreg 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             pebeta         pechisq           peemq           peexp         pegamma 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            pelnorm            pemq          penorm             pet          peunif 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               qemq     quant.boost    quant.bundle              rb            remq 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 04:51:44 UTC |
...
running this report
    ...
    PROCESSX_PS1d45640a601f_1739940697
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmprk81au
...
These are the options set to generate the report:
    ...
    [1] "validation_report_expectreg_v0.53-tikzDictionary"
