...
| export_help          | 63                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mathias Ambuehl <mathias.ambuehl@consultag.ch>       |
...
causalHyperGraph, cnaOpt, frscore

## Namespace

Overall the package has 63 exported objects. 63 are documented:

              allCombs         as.condTbl                asf      C_is_submodel 
                  TRUE               TRUE               TRUE               TRUE 
             C_mconcat C_recCharList2char           C_redund       C_relist_Int 
                  TRUE               TRUE               TRUE               TRUE 
                   cna          coherence          condition            condTbl 
                  TRUE               TRUE               TRUE               TRUE 
           configTable              cscna             cscond               csct 
                  TRUE               TRUE               TRUE               TRUE 
                   csf               cstt              ct2df             ctInfo 
                  TRUE               TRUE               TRUE               TRUE 
                cyclic        extract_asf              fs2cs              fscna 
                  TRUE               TRUE               TRUE               TRUE 
                fscond               fsct               fstt            full.ct 
                  TRUE               TRUE               TRUE               TRUE 
               full.tt      getComplexity            getCond        getCondType 
                  TRUE               TRUE               TRUE               TRUE 
      group.by.outcome          hstrsplit    identical.model            is.inus 
                  TRUE               TRUE               TRUE               TRUE 
           is.submodel                lhs          makeFuzzy          matchCond 
                  TRUE               TRUE               TRUE               TRUE 
            minimalize      minimalizeCsf                msc              mvcna 
                  TRUE               TRUE               TRUE               TRUE 
                mvcond               mvct               mvtt           noblanks 
                  TRUE               TRUE               TRUE               TRUE 
             qcond_asf         qcond_bool          qcond_csf          randomAsf 
                  TRUE               TRUE               TRUE               TRUE 
             randomCsf          redundant            relist1                rhs 
                  TRUE               TRUE               TRUE               TRUE 
               rreduce        selectCases       selectCases1               some 
                  TRUE               TRUE               TRUE               TRUE 
               stdCond           truthTab              tt2df 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:46:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36d2fac76_1739681205
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpge2ufd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cna_v3.6.2-tikzDictionary"
