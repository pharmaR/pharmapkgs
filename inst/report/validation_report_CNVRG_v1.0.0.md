...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Joshua Harrison <joshua.grant.harrison@gmail.com>    |
...
Overall the package has 8 exported objects. 8 are documented:
                 ...
                 cnvrg_HMC               cnvrg_VI             diff_abund 
                      TRUE                   TRUE                   TRUE 
            diversity_calc   extract_pi_quantiles extract_point_estimate 
                      TRUE                   TRUE                   TRUE 
                   indexer          isd_transform 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:48:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3747cb244_1739681280
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpk132N5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CNVRG_v1.0.0-tikzDictionary"
