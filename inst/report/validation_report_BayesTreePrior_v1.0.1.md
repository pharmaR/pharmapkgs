# Validation Report - BayesTreePrior@1.0.1
...
| export_help | 11 |
| has_website | FALSE |
| has_maintainer | Alexia Jolicoeur-Martineau <alexia.jolicoeur-martineau@mail.mcgill.ca> |
...
Overall the package has 11 exported objects. 11 are documented:
                 ...
                 BayesTreePrior BayesTreePriorNotOrthogonal 
                           TRUE                        TRUE 
       BayesTreePriorOrthogonal BayesTreePriorOrthogonalInf 
                           TRUE                        TRUE 
                        E_alpha         GetListUniqueSplits 
                           TRUE                        TRUE 
                 NumBotMaxDepth          NumBotMaxDepth_inf 
                           TRUE                        TRUE 
                NumBotMaxDepthX                     p_split 
                           TRUE                        TRUE 
                      Var_alpha 
                           TRUE 
...
| Execution Time | 2025-02-15 03:42:06 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd39698c6a_1739590921
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpt5g39c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesTreePrior_v1.0.1-tikzDictionary"
