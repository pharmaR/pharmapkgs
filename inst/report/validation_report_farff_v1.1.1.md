...
| has_source_control   | https://github.com/mlr-org/farff   |
...
|:----|:----------------------|:--------|
| 1   | BBmisc                | Imports |
| 2   | checkmate (\>= 1.8.0) | Imports |
| 3   | readr (\>= 1.0.0)     | Imports |
| 4   | stringi               | Imports |
...
| Execution Time | 2025-02-19 05:12:38 UTC |
...
running this report
    ...
    PROCESSX_PS1d45782edcc4_1739941952
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjSIAYO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_farff_v1.1.1-tikzDictionary"
