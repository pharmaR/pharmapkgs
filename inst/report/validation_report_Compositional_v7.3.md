# Validation Report - Compositional@7.3
...
| export_help          | 1                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Michail Tsagris <mtsagris@uoc.gr>                    |
...
| 12  | Matrix     | Imports |
| 13  | mda        | Imports |
| 14  | minpack.lm | Imports |
| 15  | mixture    | Imports |
| 16  | nnet       | Imports |
| 17  | quadprog   | Imports |
| 18  | Rfast      | Imports |
| 19  | Rfast2     | Imports |
| 20  | Rnanoflann | Imports |
| 21  | sn         | Imports |
| 22  | stats      | Imports |
...
CompositionalML, CompositionalRF, MLE, QFASA

## Namespace

Overall the package has 1 exported objects. 0 are documented:
...
There are 192 help pages with examples, from 192 (100.00 %).
...
| Execution Time | 2025-02-17 03:37:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6476212e5_1739763429
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmvqIj1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Compositional_v7.3-tikzDictionary"
