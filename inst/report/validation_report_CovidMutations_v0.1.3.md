# Validation Report - CovidMutations@0.1.3
...
| export_help          | 12                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Shaoqian Ma <shaoqianma@qq.com>           |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/MSQ-123/CovidMutations |
...
Overall the package has 12 exported objects. 12 are documented:
         ...
         AssayMutRatio        doubleAssay   globalProteinMut   globalSNPprofile 
                  TRUE               TRUE               TRUE               TRUE 
              indelSNP LastfiveNrMutation        mergeEvents          MutByGene 
                  TRUE               TRUE               TRUE               TRUE 
               mutStat          nucmerRMD        plotMutAnno    plotMutProteins 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:08:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67774024_1739765322
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4H7Q22
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CovidMutations_v0.1.3-tikzDictionary"
