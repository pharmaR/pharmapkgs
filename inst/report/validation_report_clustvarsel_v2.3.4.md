# Validation Report - clustvarsel@2.3.4
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Luca Scrucca <luca.scrucca@unipg.it>                 |
...
Overall the package has 8 exported objects. 8 are documented:
               ...
               BICreg       clustvarsel     clvarselgrbkw     clvarselgrfwd 
                 TRUE              TRUE              TRUE              TRUE 
        clvarselhlbkw     clvarselhlfwd print.clustvarsel     startParallel 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:42:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34aa2c870_1739680932
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpscSivb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clustvarsel_v2.3.4-tikzDictionary"
