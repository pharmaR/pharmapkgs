# Validation Report - BDgraph@2.73
...
| export_help          | 57                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Reza Mohammadi <a.mohammadi@uva.nl>                  |
...
BayesSUR, bayesWatch, bmixture, bootnet, easybgm, heteromixgm, qgraph,
rgm, ssgraph

## Namespace

Overall the package has 57 exported objects. 42 are documented:

                  adj2link                    auc                bdgraph 
                      TRUE                   TRUE                   TRUE 
                bdgraph.dw            bdgraph.mpl            bdgraph.npn 
                      TRUE                   TRUE                   TRUE 
               bdgraph.sim                bdw.reg                     bf 
                      TRUE                   TRUE                   TRUE 
                   compare               conf.mat          conf.mat.plot 
                      TRUE                   TRUE                   TRUE 
                covariance              ddweibull          ddweibull_reg 
                      TRUE                   TRUE                  FALSE 
              detect_cores          get_bounds_dw              get_cores 
                     FALSE                  FALSE                  FALSE 
              get_Ds_tgm_R            get_g_prior            get_g_start 
                     FALSE                  FALSE                  FALSE 
                 get_graph            get_K_start              get_S_n_p 
                     FALSE                  FALSE                  FALSE 
                  get_Ts_R                  gnorm              graph.sim 
                     FALSE                   TRUE                   TRUE 
                  link2adj       log_post_cond_dw                    mse 
                      TRUE                  FALSE                   TRUE 
    near_positive_definite              pdweibull                 pgraph 
                     FALSE                   TRUE                   TRUE 
                    plinks           plot.bdgraph             plot.graph 
                      TRUE                   TRUE                   TRUE 
                  plot.sim               plotcoda                plotroc 
                      TRUE                   TRUE                   TRUE 
         posterior.predict              precision        predict.bdgraph 
                      TRUE                   TRUE                   TRUE 
             print.bdgraph              print.sim              qdweibull 
                      TRUE                   TRUE                   TRUE 
                 rdweibull                 rgwish                rmvnorm 
                      TRUE                   TRUE                   TRUE 
                       roc                  rwish                 select 
                      TRUE                   TRUE                   TRUE 
                  sparsity        summary.bdgraph              traceplot 
                      TRUE                   TRUE                   TRUE 
                  transfer            update_mu_R            update_tu_R 
                      TRUE                  FALSE                  FALSE 
...
| Execution Time | 2025-02-15 03:48:09 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5d934d51_1739591284
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2NzAhx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BDgraph_v2.73-tikzDictionary"
