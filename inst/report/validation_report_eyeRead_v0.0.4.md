# Validation Report - eyeRead@0.0.4
...
| export_help          | 8                                       |
| has_website          | TRUE                                    |
| has_maintainer       | San Verhavert <verhavertsan@gmail.com>  |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/SanVerhavert/eyeRead |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    AOItransitions     codePasses     compileAOI         deg2px       deg2size 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            fixDur         px2deg       size2deg 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:59:26 UTC |
...
running this report
    ...
    PROCESSX_PS1d453282a9f6_1739941160
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1QyHL0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eyeRead_v0.0.4-tikzDictionary"
