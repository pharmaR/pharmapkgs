# Validation Report - bootImpute@1.2.1
...
Overall the package has 4 exported objects. 4 are documented:
           ...
           bootImpute bootImputeAnalyse          bootMice        bootSmcfcs 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:33:52 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd41c225d6_1739594026
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGFJjM4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bootImpute_v1.2.1-tikzDictionary"
