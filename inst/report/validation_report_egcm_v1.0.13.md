...
| export_help          | 30                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Matthew Clegg <matthewcleggphd@gmail.com>            |
...
Overall the package has 30 exported objects. 30 are documented:
                       ...
                       acor               adf_power         adf_power_table 
                       TRUE                    TRUE                    TRUE 
              allpairs.egcm               bvr_power         bvr_power_table 
                       TRUE                    TRUE                    TRUE 
                    bvr_rho                bvr.test                 detrend 
                       TRUE                    TRUE                    TRUE 
                       egcm     egcm.default.i1test     egcm.default.pvalue 
                       TRUE                    TRUE                    TRUE 
        egcm.default.urtest            egcm.i1tests egcm.set.default.i1test 
                       TRUE                    TRUE                    TRUE 
    egcm.set.default.pvalue egcm.set.default.urtest            egcm.urtests 
                       TRUE                    TRUE                    TRUE 
                     is.ar1         is.cointegrated              pgff_power 
                       TRUE                    TRUE                    TRUE 
           pgff_power_table             pgff_rho_ws               pgff.test 
                       TRUE                    TRUE                    TRUE 
                       rar1                  rcoint                sim.egcm 
                       TRUE                    TRUE                    TRUE 
                   ur_power          ur_power_table                   yegcm 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-19 03:48:37 UTC |
...
running this report
    ...
    PROCESSX_PS1d457b9a12c8_1739936911
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOG5rMW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_egcm_v1.0.13-tikzDictionary"
