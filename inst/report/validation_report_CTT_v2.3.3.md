...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | John T. Willse <willse@uncg.edu>                     |
...
CTTinShiny, CTTShiny, CTTvis, IRTShiny, sphereML, subscore

## Namespace

Overall the package has 11 exported objects. 11 are documented:

                 cttICC   disattenuated.cor distractor.analysis  distractorAnalysis 
                   TRUE                TRUE                TRUE                TRUE 
           itemAnalysis          polyserial         reliability               score 
                   TRUE                TRUE                TRUE                TRUE 
        score.transform      spearman.brown           subscales 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:36:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bd648d22d81_1739766971
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZQLJzt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CTT_v2.3.3-tikzDictionary"
