...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Josefina Urquiza <jurquiza@conicet.gov.ar>           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 666                                                  |
| has_source_control   | https://github.com/flortames/Air-Exposure-Model      |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    alternative_trajectories           function_hours              hourly_grid 
                        TRUE                     TRUE                     TRUE 
                  map_colors           points_to_line    temporary_grid_search 
                        TRUE                     TRUE                     TRUE 
              total_exposure      trajectories_tomtom 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-14 06:45:39 UTC |
...
running this report
    ...
    PROCESSX_PS726d5d2a0fd4_1739515537
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpx6wyEQ
