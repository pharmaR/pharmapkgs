# Validation Report - EpiILM@1.5.2
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Waleed Almutiry <wkmtierie@qu.edu.sa>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/waleedalmutiry/EpiILM             |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    as.epidata     epiBR0    epidata     epidic    epilike    epimcmc   pred.epi 
...
| Execution Time | 2025-02-19 04:16:50 UTC |
...
running this report
    ...
    PROCESSX_PS1d4556330d8b_1739938604
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6v8S5i
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EpiILM_v1.5.2-tikzDictionary"
