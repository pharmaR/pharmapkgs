# Validation Report - Bessel@0.6.1
...
ctmm, HypergeoMat, kelvin, kitagawa, MixGHD, MixtureMissing, RcppBessel,
rmgarch, Rmpfr, rvMF, sdetorus

## Namespace

Overall the package has 15 exported objects. 15 are documented:

             AiryA          AiryB        BesselH        BesselI  besselI.ftrms 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    besselI.nuAsym    besselIasym       besselIs        BesselJ       besselJs 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           BesselK besselK.nuAsym    besselKasym        BesselY             bI 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-22 03:15:13 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb75989700_1740194109
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQ5pDPG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Bessel_v0.6.1-tikzDictionary"
