...
| export_help          | 41                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Olaf Mersmann <olafm@p-value.net>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/olafmersmann/emoa/                |
...
bbotk, GPareto, mlr, mlr3hyperband, mlr3mbo, mlrintermbo, mlrMBO,
MOEADr, ParamHelpers, rmoo, STPGA

## Namespace

Overall the package has 41 exported objects. 41 are documented:

                     coalesce         crowding_distance          dominance_matrix 
                         TRUE                      TRUE                      TRUE 
        dominated_hypervolume       emoa_console_logger              emoa_control 
                         TRUE                      TRUE                      TRUE 
                  emoa_logger          emoa_null_logger         epsilon_indicator 
                         TRUE                      TRUE                      TRUE 
     hypervolume_contribution     hypervolume_indicator                  inbounds 
                         TRUE                      TRUE                      TRUE 
                 is_dominated    is_maximally_dominated          nds_cd_selection 
                         TRUE                      TRUE                      TRUE 
             nds_hv_selection                  nds_rank     nondominated_ordering 
                         TRUE                      TRUE                      TRUE 
          nondominated_points          normalize_points                pm_control 
                         TRUE                      TRUE                      TRUE 
                  pm_operator              r1_indicator              r2_indicator 
                         TRUE                      TRUE                      TRUE 
                 r3_indicator               sbx_control              sbx_operator 
                         TRUE                      TRUE                      TRUE 
    steady_state_emoa_control                   sympart                       UF1 
                         TRUE                      TRUE                      TRUE 
                         UF10                       UF2                       UF3 
                         TRUE                      TRUE                      TRUE 
                          UF4                       UF5                       UF6 
                         TRUE                      TRUE                      TRUE 
                          UF7                       UF8                       UF9 
                         TRUE                      TRUE                      TRUE 
           unary_r2_indicator      which_points_on_edge 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-25 03:26:59 UTC |
...
running this report
    ...
    PROCESSX_PS1d2845c11a7d_1740454015
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpa3wTuS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emoa_v0.5.3-tikzDictionary"
