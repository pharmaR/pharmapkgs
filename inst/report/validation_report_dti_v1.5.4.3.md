...
| export_help          | 41                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Karsten Tabelow <karsten.tabelow@wias-berlin.de>     |
...
| 2   | methods                | Imports |
| 3   | parallel               | Imports |
| 4   | adimpro (\>= 0.9)      | Imports |
| 5   | aws (\>= 2.4.1)        | Imports |
| 6   | rgl                    | Imports |
| 7   | oro.nifti (\>= 0.3.9)  | Imports |
| 8   | oro.dicom              | Imports |
| 9   | gsl                    | Imports |
| 10  | quadprog               | Imports |
...
Overall the package has 14 exported objects. 37 are documented:

     AdjacencyMatrix         aflsigmc          afsigmc        awslsigmc 
                TRUE             TRUE             TRUE             TRUE 
            awssigmc   combineDWIdata       dkiIndices      dti.options 
                TRUE             TRUE             TRUE             TRUE 
             dtiData  medinria2tensor      readDWIdata showFAColorScale 
                TRUE             TRUE             TRUE             TRUE 
             subsetg  tensor2medinria 
                TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:55:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45dcc7e17_1739854553
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptcHyCP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dti_v1.5.4.3-tikzDictionary"
