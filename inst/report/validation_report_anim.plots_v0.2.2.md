...
| export_help          | 18                                          |
| has_website          | TRUE                                        |
| has_maintainer       | David Hugh-Jones <davidhughjones@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| size_codebase        | 369                                         |
| has_source_control   | https://github.com/hughjonesd/anim.plots    |
...
Overall the package has 18 exported objects. 18 are documented:
         ...
         anim.arrowplot         anim.arrows        anim.barplot        anim.contour 
                   TRUE                TRUE                TRUE                TRUE 
             anim.curve anim.filled.contour           anim.hist          anim.lines 
                   TRUE                TRUE                TRUE                TRUE 
             anim.persp           anim.plot         anim.points           anim.save 
                   TRUE                TRUE                TRUE                TRUE 
       anim.segmentplot       anim.segments         anim.smooth        anim.symbols 
                   TRUE                TRUE                TRUE                TRUE 
              anim.text              replay 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-14 06:54:33 UTC |
...
running this report
    ...
    PROCESSX_PS726d25e0f9ec_1739516070
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTkLfkn
