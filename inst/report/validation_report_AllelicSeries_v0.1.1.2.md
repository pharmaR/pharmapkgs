...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Zachary McCaw <zmccaw@insitro.com>                   |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 1290                                                 |
| has_source_control   | https://github.com/insitro/AllelicSeries             |
...
Overall the package has 16 exported objects. 16 are documented:
        ...
        Aggregator           ASBT         ASBTSS          ASKAT        ASKATSS 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        BaselineSS   CalcSumstats          COAST        COASTSS     Comparator 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            Counts            DGP GenomicControl           isPD            OLS 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        SumCountSS 
              TRUE 
...
| Execution Time | 2025-02-14 06:48:50 UTC |
...
running this report
    ...
    PROCESSX_PS726d3129be3_1739515728
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkyJtqX
