# Validation Report - DoE.wrapper@0.12
...
|:----|:---------------------|:--------|
| 1   | R(\>= 3.1.0)         | Depends |
| 2   | FrF2(\>= 1.6-5)      | Depends |
| 3   | DoE.base(\>= 0.23-4) | Depends |
| 4   | rsm                  | Depends |
| 5   | stats                | Imports |
| 6   | lhs                  | Imports |
| 7   | DiceDesign           | Imports |
| 8   | AlgDesign(\>= 1.1)   | Imports |
...
DoE.base, FrF2, MethodOpt, RcmdrPlugin.DoE

## Namespace

Overall the package has 12 exported objects. 12 are documented:

       bbd.design   ccd.augment    ccd.design   code.design       compare 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    decode.design  Dopt.augment   Dopt.design   lhs.augment    lhs.design 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       rsmformula         Scalc 
             TRUE          TRUE 
...
| Execution Time | 2025-02-18 04:32:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4152c1b35_1739853152
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpqtwmdj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DoE.wrapper_v0.12-tikzDictionary"
