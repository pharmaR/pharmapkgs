# Validation Report - bayesdistreg@0.1.0
...
| export_help          | 25                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Emmanuel Tsyawo <estsyawo@temple.edu>                |
...
Overall the package has 25 exported objects. 25 are documented:
           ...
           asymcnfB         distreg     distreg_cfa distreg_cfa.sas   distreg.asymp 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        distreg.sas      dr_asympar         fitdist        fitlogit         IndepMH 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            indicat     jdpar.asymp         jntCBOM       lapl_aprx      lapl_aprx2 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              logit       LogitLink     par_distreg         parLply       posterior 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            prior_n         prior_u       quant_bdr            RWMH         simcnfB 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 03:33:52 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd792ac44e_1739590427
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoVTbHi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesdistreg_v0.1.0-tikzDictionary"
