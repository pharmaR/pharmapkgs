# Validation Report - distfromq@1.0.4
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Evan Ray <elray@umass.edu>                           |
...
Overall the package has 7 exported objects. 7 are documented:
           ...
           duplicated_tol             make_d_fn             make_p_fn 
                     TRUE                  TRUE                  TRUE 
                make_q_fn             make_r_fn split_disc_cont_ps_qs 
                     TRUE                  TRUE                  TRUE 
               unique_tol 
                     TRUE 
...
| Execution Time | 2025-02-18 04:18:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42d74a1d_1739852295
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpxhq12z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distfromq_v1.0.4-tikzDictionary"
