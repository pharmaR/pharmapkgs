# Validation Report - corncob@0.4.1
...
| has_source_control   | https://github.com/statdivlab/corncob |
...
Overall the package has 28 exported objects. 27 are documented:
                 ...
                 %>%            bbdml      checkNested clean_taxa_names 
               FALSE             TRUE             TRUE             TRUE 
       contrastsTest    convert_phylo             coth differentialTest 
                TRUE             TRUE             TRUE             TRUE 
               fishZ         genInits     HDIbetabinom          hessian 
                TRUE             TRUE             TRUE             TRUE 
            invfishZ         invlogit            logit           lrtest 
                TRUE             TRUE             TRUE             TRUE 
     otu_to_taxonomy            pbLRT            pbRao           pbWald 
                TRUE             TRUE             TRUE             TRUE 
          qbetabinom          raotest        sand_vcov           sandSE 
                TRUE             TRUE             TRUE             TRUE 
               score        waldchisq            waldt    warn_phyloseq 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 03:58:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6f027f97_1739764677
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4SBM1d
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corncob_v0.4.1-tikzDictionary"
