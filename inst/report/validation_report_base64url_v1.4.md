# Validation Report - base64url@1.4
...
| size_codebase        | 23                                 |
| has_source_control   | https://github.com/mllg/base64url  |
| has_bug_reports_url  | 1                                  |
| downloads_1yr        | 122589                             |
...
batchtools, drake, otp, RCy3, targets, txtq, zoltr

## Namespace

Overall the package has 4 exported objects. 4 are documented:

       base32_decode    base32_encode base64_urldecode base64_urlencode 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-14 07:43:53 UTC |
...
running this report
    ...
    PROCESSX_PS1c0939098e62_1739519030
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRNwySG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_base64url_v1.4-tikzDictionary"
