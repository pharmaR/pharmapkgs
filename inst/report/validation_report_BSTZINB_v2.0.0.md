# Validation Report - BSTZINB@2.0.0
...
| export_help          | 14                                  |
| has_website          | TRUE                                |
| has_maintainer       | Suman Majumder <smajumd2@gmail.com> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/SumanM47/BSTZINB |
...
Overall the package has 14 exported objects. 14 are documented:
                    ...
                    BNB               BSTNB             BSTZINB               BZINB 
                   TRUE                TRUE                TRUE                TRUE 
         compute_NB_DIC    compute_ZINB_DIC           conv.test         get_adj_mat 
                   TRUE                TRUE                TRUE                TRUE 
               qRankPar         qRankParTop  ResultTableSummary ResultTableSummary2 
                   TRUE                TRUE                TRUE                TRUE 
         TimetrendCurve         USDmapCount 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-15 04:51:39 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2500ec49_1739595094
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBVRZjb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BSTZINB_v2.0.0-tikzDictionary"
