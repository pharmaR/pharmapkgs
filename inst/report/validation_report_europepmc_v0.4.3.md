# Validation Report - europepmc@0.4.3
...
| export_help          | 17                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Najko Jahn <najko.jahn@gmail.com>      |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/ropensci/europepmc/ |
...
enrichplot, genekitr, tidypmc

## Namespace

Overall the package has 17 exported objects. 17 are documented:

    epmc_annotations_by_id         epmc_citations                epmc_db 
                      TRUE                   TRUE                   TRUE 
             epmc_db_count           epmc_details              epmc_ftxt 
                      TRUE                   TRUE                   TRUE 
            epmc_ftxt_book              epmc_hits        epmc_hits_trend 
                      TRUE                   TRUE                   TRUE 
             epmc_lablinks    epmc_lablinks_count           epmc_profile 
                      TRUE                   TRUE                   TRUE 
                 epmc_refs            epmc_search           epmc_search_ 
                      TRUE                   TRUE                   TRUE 
        epmc_search_by_doi    epmc_search_by_doi_ 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-19 04:37:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d451929e0b0_1739939815
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppEXkio
...
These are the options set to generate the report:
    ...
    [1] "validation_report_europepmc_v0.4.3-tikzDictionary"
