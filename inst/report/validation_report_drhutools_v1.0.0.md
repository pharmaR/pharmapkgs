# Validation Report - drhutools@1.0.0
...
| 11  | stats        | Imports |
| 12  | methods      | Imports |
| 13  | gganimate    | Imports |
| 14  | magick       | Imports |
| 15  | mapview      | Imports |
| 16  | webshot      | Imports |
| 17  | animation    | Imports |
| 18  | png          | Imports |
| 19  | grDevices    | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
            ...
            cdplot   folderSystem        gb_cols         gb_pal        goodmap 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    scale_color_gb  scale_fill_gb         traits 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:46:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47a267565_1739853958
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkBpgSb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drhutools_v1.0.0-tikzDictionary"
