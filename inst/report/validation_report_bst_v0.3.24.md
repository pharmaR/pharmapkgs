...
| export_help          | 38                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Zhu Wang <zwang145@uthsc.edu>                        |
...
bujar, flowml, fscaret, mlr, mpath

## Namespace

Overall the package has 38 exported objects. 38 are documented:

        balanced.folds              bfunc                bst        bst_control 
                  TRUE               TRUE               TRUE               TRUE 
               bst.sel             cv.bst            cv.mada            cv.mbst 
                  TRUE               TRUE               TRUE               TRUE 
          cv.mhingebst       cv.mhingeova            cv.rbst           cv.rmbst 
                  TRUE               TRUE               TRUE               TRUE 
               evalerr            ex1data       fpartial.bst      fpartial.mbst 
                  TRUE               TRUE               TRUE               TRUE 
    fpartial.mhingebst          gaussloss          gaussngra           gradient 
                  TRUE               TRUE               TRUE               TRUE 
             hingeloss          hingengra               loss          loss.mbst 
                  TRUE               TRUE               TRUE               TRUE 
        loss.mhingebst               mada               mbst           mbst_fit 
                  TRUE               TRUE               TRUE               TRUE 
             mhingebst      mhingebst_fit          mhingeova          ngradient 
                  TRUE               TRUE               TRUE               TRUE 
                  nsel       permute.rows          plotCVbst               rbst 
                  TRUE               TRUE               TRUE               TRUE 
              rbstpath              rmbst 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:51:16 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd438f7a48_1739595070
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpu2okkt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bst_v0.3.24-tikzDictionary"
