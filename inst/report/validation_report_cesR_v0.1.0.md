...
| export_help          | 5                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Paul A. Hodgetts <hodgetts.paul@outlook.com> |
| bugs_status          | 1                                            |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         get_ces get_cescodes    get_decon  get_preview get_question 
...
| Execution Time | 2025-02-16 04:03:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc376cc4385_1739678607
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoVoPAP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cesR_v0.1.0-tikzDictionary"
