# Validation Report - distrSim@2.8.5
...
| 2   | methods               | Depends |
| 3   | graphics              | Depends |
| 4   | setRNG(\>= 2006.2-1)  | Depends |
| 5   | distr(\>= 2.5.2)      | Depends |
| 6   | startupmsg(\>= 1.0.0) | Imports |
| 7   | stats                 | Imports |
| 8   | grDevices             | Imports |
...
distrDoc, distrEllipse, distrTEst

## Namespace

Overall the package has 8 exported objects. 38 are documented:

                cload    Contsimulation         Dataclass      distrSimMASK 
                 TRUE              TRUE              TRUE              TRUE 
      distrSimoptions getdistrSimOption     SeqDataFrames        Simulation 
                 TRUE              TRUE              TRUE              TRUE 

### Examples

There are 9 help pages with examples, from 31 (29.03 %).
...
| Execution Time | 2025-02-18 04:21:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4320f7f7f_1739852476
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpW1W9MI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distrSim_v2.8.5-tikzDictionary"
