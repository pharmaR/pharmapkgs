# Validation Report - fastWavelets@1.0.1
...
| export_help          | 8                                         |
| has_website          | TRUE                                      |
| has_maintainer       | John You <johnswyou@gmail.com>            |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/johnswyou/fastWavelets |
...
Overall the package has 8 exported objects. 8 are documented:
          ...
          atrous_dwt           mo_dwt n_boundary_coefs    scaling_coefs 
                TRUE             TRUE             TRUE             TRUE 
      scaling_filter      shape_check    wavelet_coefs   wavelet_filter 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 05:23:17 UTC |
...
running this report
    ...
    PROCESSX_PS1d452e98eba7_1739942591
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJbukbA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastWavelets_v1.0.1-tikzDictionary"
