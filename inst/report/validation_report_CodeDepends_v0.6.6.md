# Validation Report - CodeDepends@0.6.6
...
| export_help          | 35                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Gabriel Becker <gabembecker@gmail.com>  |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/duncantl/CodeDepends |
...
Overall the package has 28 exported objects. 32 are documented:

      addRemoveIntermediates                asVarName      defaultFuncHandlers 
                        TRUE                     TRUE                     TRUE 
            findWhenUnneeded         getDependsThread     getDetailedTimelines 
                        TRUE                     TRUE                     TRUE 
         getExpressionThread                getInputs      getPropagateChanges 
                        TRUE                     TRUE                     TRUE 
           getSectionDepends       getVariableDepends             getVariables 
                        TRUE                     TRUE                     TRUE 
               guessTaskType            highlightCode          historyAsScript 
                        TRUE                     TRUE                     TRUE 
              inputCollector            makeCallGraph            makeTaskGraph 
                        TRUE                     TRUE                     TRUE 
           makeVariableGraph            nseafterfirst      readAnnotatedScript 
                        TRUE                     TRUE                     TRUE 
                  readScript           runUpToSection               scriptInfo 
                        TRUE                     TRUE                     TRUE 
    separateExpressionBlocks           sourceVariable       splitRedefinitions 
                        TRUE                     TRUE                     TRUE 
              updatingScript 
                        TRUE 
...
| Execution Time | 2025-02-16 04:51:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3587f9a49_1739681496
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp54DEkU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CodeDepends_v0.6.6-tikzDictionary"
