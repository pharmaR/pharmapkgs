...
| export_help          | 16                              |
| has_website          | TRUE                            |
| has_maintainer       | Tomas Kliegr <kliegr@gmail.com> |
| bugs_status          | subscript out of bounds         |
| size_codebase        | 714                             |
| has_source_control   | https://github.com/kliegr/arc   |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | arules (\>= 1.7-4) | Depends |
| 2   | R.utils            | Depends |
| 3   | discretization     | Depends |
| 4   | Matrix (\>= 0.5-0) | Imports |
| 5   | methods            | Imports |
| 6   | datasets           | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
                  ...
                  applyCut              applyCuts                    cba 
                      TRUE                   TRUE                   TRUE 
                cba_manual                 cbaCSV                cbaIris 
                      TRUE                   TRUE                   TRUE 
            cbaIrisNumeric           CBARuleModel   CBARuleModelAccuracy 
                      TRUE                   TRUE                   TRUE 
    discretizeUnsupervised           discrNumeric          getAppearance 
                      TRUE                   TRUE                   TRUE 
       getConfVectorForROC                  mdlp2                  prune 
                      TRUE                   TRUE                   TRUE 
                  topRules 
                      TRUE 
...
| Execution Time | 2025-02-14 07:20:46 UTC |
...
running this report
    ...
    PROCESSX_PS1c09555fb8d9_1739517644
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfnCNQB
