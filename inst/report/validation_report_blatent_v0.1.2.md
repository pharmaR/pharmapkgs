# Validation Report - blatent@0.1.2
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jonathan Templin <jonathan-templin@uiowa.edu>        |
...
Overall the package has 12 exported objects. 12 are documented:
                        ...
                        blatentControl                    blatentEstimate 
                                  TRUE                               TRUE 
                           blatentPPMC                    blatentSimulate 
                                  TRUE                               TRUE 
                          calculateDIC                      calculateWAIC 
                                  TRUE                               TRUE 
                 createParameterVector             QmatrixToBlatentSyntax 
                                  TRUE                               TRUE 
        setDefaultInitializeParameters                   setDefaultPriors 
                                  TRUE                               TRUE 
         setDefaultSimulatedParameters setPosteriorPredictiveCheckOptions 
                                  TRUE                               TRUE 
...
| Execution Time | 2025-02-15 04:21:41 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3037966b_1739593296
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvJSyir
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blatent_v0.1.2-tikzDictionary"
