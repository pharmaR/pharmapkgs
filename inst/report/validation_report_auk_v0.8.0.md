...
| size_codebase        | 2425                                           |
| has_source_control   | https://github.com/CornellLabofOrnithology/auk |
...
Overall the package has 43 exported objects. 42 are documented:
                     ...
                     %>%             auk_bbox              auk_bcr 
                   FALSE                 TRUE                 TRUE 
            auk_breeding            auk_clean         auk_complete 
                    TRUE                 TRUE                 TRUE 
             auk_country           auk_county             auk_date 
                    TRUE                 TRUE                 TRUE 
            auk_distance         auk_duration              auk_ebd 
                    TRUE                 TRUE                 TRUE 
         auk_ebd_version           auk_exotic           auk_extent 
                    TRUE                 TRUE                 TRUE 
              auk_filter     auk_get_awk_path     auk_get_ebd_path 
                    TRUE                 TRUE                 TRUE 
         auk_last_edited         auk_observer          auk_project 
                    TRUE                 TRUE                 TRUE 
            auk_protocol           auk_rollup         auk_sampling 
                    TRUE                 TRUE                 TRUE 
              auk_select     auk_set_awk_path     auk_set_ebd_path 
                    TRUE                 TRUE                 TRUE 
             auk_species            auk_split            auk_state 
                    TRUE                 TRUE                 TRUE 
                auk_time           auk_unique          auk_version 
                    TRUE                 TRUE                 TRUE 
                auk_year         auk_zerofill    collapse_zerofill 
                    TRUE                 TRUE                 TRUE 
           ebird_species filter_repeat_visits format_unmarked_occu 
                    TRUE                 TRUE                 TRUE 
      get_ebird_taxonomy    process_barcharts             read_ebd 
                    TRUE                 TRUE                 TRUE 
           read_sampling 
                    TRUE 
...
| Execution Time | 2025-02-14 07:32:22 UTC |
...
running this report
    ...
    PROCESSX_PS1c09749daa_1739518339
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEQcJsz
