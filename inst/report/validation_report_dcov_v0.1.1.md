...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Hang Weiqiang <e0010758@u.nus.edu>                   |
...
BAGofT, dcorVS, dCovTS, pchc, TransGraph

## Namespace

Overall the package has 14 exported objects. 14 are documented:

              centering centering_from_data                dcor           dcor.test 
                   TRUE                TRUE                TRUE                TRUE 
             dcor.ttest              dcor2d                dcov              dcov2d 
                   TRUE                TRUE                TRUE                TRUE 
                  mdcor               mdcov                pcov               pdcor 
                   TRUE                TRUE                TRUE                TRUE 
             pdcor.test               pdcov 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-17 05:11:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bd618d59bc2_1739769085
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7scBiz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dcov_v0.1.1-tikzDictionary"
