# Validation Report - dynsurv@0.4.7
...
| has_source_control   | https://github.com/wenjie2wang/dynsurv |
...
Overall the package has 15 exported objects. 15 are documented:
         ...
         bayesCox  bayesCoxMcmc   is.bayesCox          jump            nu 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         plotCoef  plotJumpHist plotJumpTrace        plotNu      plotSurv 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        splineCox          Surv     survCurve      survDiff        tvTran 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-25 03:24:31 UTC |
...
running this report
    ...
    PROCESSX_PS1d28113428b4_1740453867
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWCCnQY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dynsurv_v0.4.7-tikzDictionary"
