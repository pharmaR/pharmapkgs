# Validation Report - decompML@0.1.1
...
Overall the package has 12 exported objects. 12 are documented:
    ...
    ceemdanARIMA   ceemdanELM  ceemdanTDNN    eemdARIMA      eemdELM     eemdTDNN 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        emdARIMA       emdELM      emdTDNN     vmdARIMA       vmdELM      vmdTDNN 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-19 03:30:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d4525eec0ff_1739935840
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1QQiLI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_decompML_v0.1.1-tikzDictionary"
