# Validation Report - boot.pval@0.6
...
| export_help          | 5                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Måns Thulin <mans@statistikkonsult.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/mthulin/boot.pval    |
...
Overall the package has 5 exported objects. 5 are documented:
            ...
            boot_summary            boot.pval     censboot_summary 
                    TRUE                 TRUE                 TRUE 
    summary_to_flextable        summary_to_gt 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:33:12 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2b88a9d9_1739593987
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwZQPEo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_boot.pval_v0.6-tikzDictionary"
