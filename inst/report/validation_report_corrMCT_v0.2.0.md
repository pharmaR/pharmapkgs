# Validation Report - corrMCT@0.2.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Xin-Wei Huang <xinweihuangstat@gmail.com>            |
...
Overall the package has 8 exported objects. 7 are documented:
                 ...
                 %>%  corr.Bonferroni         corr.WHC      corrmat_AR1 
               FALSE             TRUE             TRUE             TRUE 
       corrmat_block corrmat_blockAR1       corrmat_CS              WHC 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:01:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6ededee4_1739764856
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1uWMxy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corrMCT_v0.2.0-tikzDictionary"
