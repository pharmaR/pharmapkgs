# Validation Report - bluebike@0.0.3
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Ziyue Yang <zyang2k@gmail.com>                       |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    import_month_data  station_distance    station_radius     trip_distance 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:25:41 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1c424bf1_1739593536
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppWRWTE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bluebike_v0.0.3-tikzDictionary"
