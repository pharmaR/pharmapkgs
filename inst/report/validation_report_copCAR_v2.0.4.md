# Validation Report - copCAR@2.0.4
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | John Hughes <drjphughesjr@gmail.com>                 |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    adjacency.matrix           copCAR      negbinomial          rcopCAR 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-23 03:26:31 UTC |
...
running this report
    ...
    PROCESSX_PS1d257923288e_1740281187
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpORCjAT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_copCAR_v2.0.4-tikzDictionary"
