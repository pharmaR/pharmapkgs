...
| export_help          | 8                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Peter W. MacDonald <pwmacdon@umich.edu> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/peterwmacd/fase      |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | RSpectra (\>= 0.16.1) | Imports |
| 2   | rTensor (\>= 1.4.8)   | Imports |
| 3   | splines2 (\>= 0.4.7)  | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
                     ...
                     fase              fase_seq  gaussian_snapshot_bs 
                     TRUE                  TRUE                  TRUE 
     gaussian_snapshot_ss            proc_align proc_align_slicewise3 
                     TRUE                  TRUE                  TRUE 
              proc_align3      rdpg_snapshot_bs 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-19 05:13:36 UTC |
...
running this report
    ...
    PROCESSX_PS1d45701f4fb6_1739942010
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz90YYB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fase_v1.0.1-tikzDictionary"
