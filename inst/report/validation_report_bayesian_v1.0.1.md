# Validation Report - bayesian@1.0.1
...
| export_help          | 8                                  |
| has_website          | TRUE                               |
| has_maintainer       | Hamada S. Badr <badr@jhu.edu>      |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/hsbadr/bayesian |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | brms (\>= 2.21.0)   | Depends |
| 2   | parsnip (\>= 1.2.1) | Depends |
| 3   | dplyr               | Imports |
| 4   | purrr               | Imports |
| 5   | rlang               | Imports |
| 6   | stats               | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
            ...
            bayesian  bayesian_family     bayesian_fit bayesian_formula 
                TRUE             TRUE             TRUE             TRUE 
    bayesian_predict    bayesian_read   bayesian_terms   bayesian_write 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 03:35:34 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd59780161_1739590530
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUg1bjk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesian_v1.0.1-tikzDictionary"
