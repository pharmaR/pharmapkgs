...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Zachary Colburn <zcolburn@gmail.com>                 |
...
| 2   | assertthat(\>= 0.2.0) | Imports   |
| 3   | dplyr(\>= 0.7.4)      | Imports   |
| 4   | igraph                | Imports   |
| 5   | Rcpp                  | LinkingTo |
...
Overall the package has 6 exported objects. 6 are documented:
               ...
               .perform_grouping        .perform_partitioning 
                            TRUE                         TRUE 
                euclidean_linker                   find_blobs 
                            TRUE                         TRUE 
                  find_min_dists identify_thresholded_objects 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-15 04:12:47 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5643f548_1739592762
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpShdkVn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Bioi_v0.2.10-tikzDictionary"
