# Validation Report - ExpertChoice@0.2.0
...
| export_help          | 8                                    |
| has_website          | FALSE                                |
| has_maintainer       | Jed Stephens <STPJED001@myuct.ac.za> |
...
Overall the package has 8 exported objects. 8 are documented:
                     ...
                     augment_levels                check_overshadow 
                               TRUE                            TRUE 
           construct_question_frame                  dce_efficiency 
                               TRUE                            TRUE 
    fractional_factorial_efficiency                  full_factorial 
                               TRUE                            TRUE 
                      modulo_method                   search_design 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-19 04:52:19 UTC |
...
running this report
    ...
    PROCESSX_PS1d455408aba8_1739940733
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZjuRZJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ExpertChoice_v0.2.0-tikzDictionary"
