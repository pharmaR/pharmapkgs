...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Koen W. De Bock <kdebock@audencia.com>               |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | mco (\>= 1.0-15.1)      | Imports |
| 2   | ROCR (\>= 1.0-7)        | Imports |
| 3   | rpart (\>= 4.1-15)      | Imports |
| 4   | zoo (\>= 1.8-6)         | Imports |
| 5   | graphics (\>= 3.5.1)    | Imports |
| 6   | stats (\>= 3.5.1)       | Imports |
| 7   | caTools (\>= 1.18.0)    | Imports |
| 8   | data.table (\>= 1.12.2) | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
             ...
             brierCurve   CSMES.ensNomCurve        CSMES.ensSel       CSMES.predict 
                   TRUE                TRUE                TRUE                TRUE 
    CSMES.predictPareto      plotBrierCurve 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:30:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64210b749_1739766651
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmplucgwv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CSMES_v1.0.1-tikzDictionary"
