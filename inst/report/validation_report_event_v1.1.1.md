...
| export_help          | 47                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Bruce Swihart <bruce.swihart@gmail.com> |
...
Overall the package has 47 exported objects. 47 are documented:
         ...
         autointensity                 bp              coxre           cprocess 
                  TRUE               TRUE               TRUE               TRUE 
    deviance.intensity   deviance.kalsurv    deviance.pbirth                ehr 
                  TRUE               TRUE               TRUE               TRUE 
        fitted.kalsurv            hboxcox              hburr            hcauchy 
                  TRUE               TRUE               TRUE               TRUE 
                  hexp             hgamma           hgextval            hggamma 
                  TRUE               TRUE               TRUE               TRUE 
               hglogis          hgweibull            hhjorth          hinvgauss 
                  TRUE               TRUE               TRUE               TRUE 
              hlaplace             hlnorm             hlogis              hnorm 
                  TRUE               TRUE               TRUE               TRUE 
               hpareto       hskewlaplace           hstudent           hweibull 
                  TRUE               TRUE               TRUE               TRUE 
                 ident            kalsurv                 km             pbirth 
                  TRUE               TRUE               TRUE               TRUE 
             plot.dist     plot.intensity          plot.surv                 pp 
                  TRUE               TRUE               TRUE               TRUE 
       print.intensity      print.kalsurv           print.km         print.llrf 
                  TRUE               TRUE               TRUE               TRUE 
          print.pbirth  residuals.kalsurv              tccov              tpast 
                  TRUE               TRUE               TRUE               TRUE 
                 ttime              tvcov                vdm 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:39:36 UTC |
...
running this report
    ...
    PROCESSX_PS1d458e1c1f5_1739939970
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7osVdd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_event_v1.1.1-tikzDictionary"
