...
Overall the package has 14 exported objects. 14 are documented:
                     ...
                     calculate         create_batch_cases 
                          TRUE                       TRUE 
           create_csv_template  create_sensitivity_config 
                          TRUE                       TRUE 
                     from_cmpx              generate_cmpx 
                          TRUE                       TRUE 
    local_api_activate_license  local_api_batch_calculate 
                          TRUE                       TRUE 
           local_api_calculate            local_api_clone 
                          TRUE                       TRUE 
             local_api_compile      local_api_sensitivity 
                          TRUE                       TRUE 
                         login       sensitivity_analysis 
                          TRUE                       TRUE 

### Examples

There are 14 help pages with examples, from 18 (77.78 %).
...
| Execution Time | 2025-02-14 06:42:18 UTC |
...
running this report
    ...
    PROCESSX_PS726d8785515_1739515335
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0iwAsc
