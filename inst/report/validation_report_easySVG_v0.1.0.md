# Validation Report - easySVG@0.1.0
...
| export_help          | 12                                |
| has_website          | TRUE                              |
| has_maintainer       | Yuting Dai <forlynna@sjtu.edu.cn> |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/ytdai/easySVG  |
...
Overall the package has 12 exported objects. 12 are documented:
      ...
      circle.svg     defs.svg  ellipse.svg get.text.svg    group.svg lim.axis.svg 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        line.svg     pack.svg  polygon.svg polyline.svg     rect.svg      use.svg 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-18 05:13:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44ab708ab_1739855598
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUE5wml
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easySVG_v0.1.0-tikzDictionary"
