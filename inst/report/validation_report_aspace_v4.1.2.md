...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tarmo K. Remmel <remmelt@yorku.ca>                   |
...
Overall the package has 20 exported objects. 20 are documented:
          ...
          acos_d   as_radians       asin_d       atan_d     calc_box      calc_cf 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
     calc_cf2pts     calc_cmd     calc_mdc     calc_mnc     calc_sdd     calc_sde 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           cos_d    distances     plot_box plot_centres     plot_sdd     plot_sde 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           sin_d        tan_d 
            TRUE         TRUE 
...
| Execution Time | 2025-02-14 07:27:43 UTC |
...
running this report
    ...
    PROCESSX_PS1c0927341ca0_1739518060
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCOsREK
