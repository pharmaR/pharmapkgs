# Validation Report - ColorNameR@0.1.0
...
| export_help          | 3                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Marco Sánchez Beeckman <msanchezb3@gmail.com>        |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/msanchez-beeckman/ColorNameR      |
...
Overall the package has 3 exported objects. 3 are documented:
            ...
            colordiff get_closest_color              name 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:59:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35c50ed86_1739681988
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBFfOXx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ColorNameR_v0.1.0-tikzDictionary"
