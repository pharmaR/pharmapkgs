...
| export_help          | 12                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Ernest Guevarra <ernestgmd@gmail.com> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/rapidsurveys/bbw   |
...
Overall the package has 12 exported objects. 12 are documented:
                           ...
                           boot_bw               boot_bw_estimate 
                              TRUE                           TRUE 
                  boot_bw_parallel        boot_bw_sample_clusters 
                              TRUE                           TRUE 
    boot_bw_sample_within_clusters             boot_bw_sequential 
                              TRUE                           TRUE 
                    boot_bw_weight                         bootBW 
                              TRUE                           TRUE 
                       bootClassic                     bootPROBIT 
                              TRUE                           TRUE 
                    estimate_total                         recode 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-15 03:44:41 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2f2d29b_1739591076
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpevz8Rq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bbw_v0.3.0-tikzDictionary"
