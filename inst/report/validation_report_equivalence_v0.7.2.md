# Validation Report - equivalence@0.7.2
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Andrew Robinson <A.Robinson@ms.unimelb.edu.au>       |
...
agridat, marginaleffects

## Namespace

Overall the package has 10 exported objects. 10 are documented:

            equiv.boot            equiv.p equivalence.xyplot         print.tost 
                  TRUE               TRUE               TRUE               TRUE 
             ptte.data          ptte.stat              rtost               tost 
                  TRUE               TRUE               TRUE               TRUE 
             tost.data          tost.stat 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:24:29 UTC |
...
running this report
    ...
    PROCESSX_PS1d453729b871_1739939063
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaP6Pdj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_equivalence_v0.7.2-tikzDictionary"
