# Validation Report - ConsensusOPLS@1.0.0
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Van Du T. Tran <thuong.tran@sib.swiss>               |
...
Overall the package has 8 exported objects. 15 are documented:

       ConsensusOPLS plotContribution          plotDQ2     plotLoadings 
                TRUE             TRUE             TRUE             TRUE 
              plotQ2           plotR2       plotScores          plotVIP 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 03:47:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6644be728_1739764023
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpfe8j2L
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ConsensusOPLS_v1.0.0-tikzDictionary"
