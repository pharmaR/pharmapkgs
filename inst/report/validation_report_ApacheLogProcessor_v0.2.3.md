...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Diogo Silveira Mendonca <diogosmendonca@gmail.com>   |
| bugs_status          | 1                                                    |
| size_codebase        | 325                                                  |
| has_source_control   | https://github.com/diogosmendonca/ApacheLogProcessor |
...
Overall the package has 7 exported objects. 7 are documented:
                         ...
                         clear.urls                  get.url.params 
                               TRUE                            TRUE 
                     parse.php.msgs          read.apache.access.log 
                               TRUE                            TRUE 
              read.apache.error.log read.multiple.apache.access.log 
                               TRUE                            TRUE 
...
There are 7 help pages with examples, from 9 (77.78 %).
...
| Execution Time | 2025-02-14 07:16:58 UTC |
...
running this report
    ...
    PROCESSX_PS1c09645dc1df_1739517415
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2J4vlU
