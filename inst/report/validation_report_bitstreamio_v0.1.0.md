# Validation Report - bitstreamio@0.1.0
...
| has_source_control   | https://github.com/coolbutuseless/bitstreamio |
...
Overall the package has 28 exported objects. 28 are documented:
                   ...
                   assert_bs              bits_to_raw             bits_to_uint 
                        TRUE                     TRUE                     TRUE 
                  bs_advance                 bs_align                 bs_close 
                        TRUE                     TRUE                     TRUE 
                    bs_flush            bs_is_aligned                  bs_open 
                        TRUE                     TRUE                     TRUE 
                     bs_peek              bs_read_bit             bs_read_byte 
                        TRUE                     TRUE                     TRUE 
     bs_read_sint_exp_golomb             bs_read_uint  bs_read_uint_exp_golomb 
                        TRUE                     TRUE                     TRUE 
                bs_write_bit            bs_write_byte bs_write_sint_exp_golomb 
                        TRUE                     TRUE                     TRUE 
               bs_write_uint bs_write_uint_exp_golomb  exp_golomb_bits_to_sint 
                        TRUE                     TRUE                     TRUE 
     exp_golomb_bits_to_uint                    is_bs                 pad_bits 
                        TRUE                     TRUE                     TRUE 
                 raw_to_bits  sint_to_exp_golomb_bits             uint_to_bits 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-15 04:18:55 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd702def92_1739593130
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRgHU9g
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bitstreamio_v0.1.0-tikzDictionary"
