...
| export_help          | 13                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Max Westphal <dev@maxwestphal.io>    |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/maxwestphal/cases |
...
Overall the package has 13 exported objects. 12 are documented:
                      ...
                      %>%            categorize               compare 
                    FALSE                  TRUE                  TRUE 
          define_contrast             draw_data         draw_data_lfc 
                     TRUE                  TRUE                  TRUE 
            draw_data_prb         draw_data_roc              evaluate 
                     TRUE                  TRUE                  TRUE 
    generate_instance_lfc generate_instance_roc      process_instance 
                     TRUE                  TRUE                  TRUE 
                visualize 
                     TRUE 
...
| Execution Time | 2025-02-16 03:44:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37831d016_1739677494
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsoqrpU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cases_v0.2.0-tikzDictionary"
