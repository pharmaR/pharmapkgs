...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Dann Hekman <dannhek@gmail.com>                      |
...
| 2   | glue (\>= 1.8.0)       | Depends |
| 3   | janitor (\>= 2.2.0)    | Depends |
| 4   | lubridate (\>= 1.9.3)  | Depends |
| 5   | methods (\>= 4.4.1)    | Depends |
| 6   | readr (\>= 2.1.5)      | Depends |
| 7   | snakecase (\>= 0.11.1) | Depends |
| 8   | stringr (\>= 1.5.1)    | Depends |
| 9   | utils                  | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
             ...
             clean_bt_list_db combine_clean_bt_list_dbs     process_one_directory 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-14 07:38:57 UTC |
...
running this report
    ...
    PROCESSX_PS1c0970f270ef_1739518734
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8WA3OG
