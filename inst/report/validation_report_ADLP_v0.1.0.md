...
| export_help          | 16                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Yanfeng Li <yanfeng.li@student.unsw.edu.au> |
| bugs_status          | subscript out of bounds                     |
| size_codebase        | 468                                         |
| has_source_control   | https://github.com/agi-lab/ADLP             |
...
Overall the package has 16 exported objects. 16 are documented:
                       ...
                       adlp          adlp_component         adlp_components 
                       TRUE                    TRUE                    TRUE 
                  adlp_CRPS               adlp_dens               adlp_logS 
                       TRUE                    TRUE                    TRUE 
          adlp_partition_ap     adlp_partition_none           adlp_simulate 
                       TRUE                    TRUE                    TRUE 
        calc_adlp_component calc_adlp_component_lst            custom_model 
                       TRUE                    TRUE                    TRUE 
                   MM_optim   train_val_split_by_AP train_val_split_method1 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 06:38:10 UTC |
...
running this report
    ...
    PROCESSX_PS726d4ed1711_1739515087
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpsy42pt
