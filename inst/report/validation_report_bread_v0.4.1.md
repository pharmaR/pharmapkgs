...
| export_help          | 10                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Vincent Guegan <vincent.guegan@banque-france.fr> |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/MagicHead99/bread/            |
...
Overall the package has 10 exported objects. 10 are documented:
      ...
      bcolnames bfile_split     bfilter       bmeta       bnrow   bnumrange 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
          bread     bselect        bsep     bsubset 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-15 04:42:28 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6bdeea77_1739594543
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplfQgqW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bread_v0.4.1-tikzDictionary"
