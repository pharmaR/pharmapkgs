# Validation Report - ClusBoot@1.2.2
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Sugnet Lubbe <slubbe@sun.ac.za>                      |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    boot.proportions  boot.silhouette         clusboot complete.linkage 
                TRUE             TRUE             TRUE             TRUE 
     fpc.clusterboot 
                TRUE 
...
| Execution Time | 2025-02-16 04:36:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bc341644b8a_1739680605
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpL4aUGf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClusBoot_v1.2.2-tikzDictionary"
