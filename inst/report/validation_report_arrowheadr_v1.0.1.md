...
| export_help          | 22                                             |
| has_website          | TRUE                                           |
| has_maintainer       | W. Joel Schneider <w.joel.schneider@gmail.com> |
| bugs_status          | subscript out of bounds                        |
| size_codebase        | 582                                            |
| has_source_control   | https://github.com/wjschne/arrowheadr          |
...
Overall the package has 22 exported objects. 22 are documented:
              ...
              arrow_head_bezier         arrow_head_catenary 
                           TRUE                        TRUE 
             arrow_head_default          arrow_head_deltoid 
                           TRUE                        TRUE 
             arrow_head_ellipse         arrow_head_function 
                           TRUE                        TRUE 
             arrow_head_harpoon     arrow_head_hypotrochoid 
                           TRUE                        TRUE 
                arrow_head_icon            arrow_head_latex 
                           TRUE                        TRUE 
             arrow_head_trefoil arrow_head_wittgenstein_rod 
                           TRUE                        TRUE 
                         nudger              plot_arrowhead 
                           TRUE                        TRUE 
                      reflecter                    rescaler 
                           TRUE                        TRUE 
                rev_matrix_cols             rev_matrix_rows 
                           TRUE                        TRUE 
                        rotater                 transformer 
                           TRUE                        TRUE 
                       unitizer                    v2matrix 
...
| Execution Time | 2025-02-14 07:25:14 UTC |
...
running this report
    ...
    PROCESSX_PS1c0979c703f5_1739517911
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2MklDX
