# Validation Report - cbcTools@0.5.0
...
| export_help          | 10                                        |
| has_website          | TRUE                                      |
| has_maintainer       | John Helveston <john.helveston@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/jhelvy/cbcTools        |
...
Overall the package has 10 exported objects. 10 are documented:
           ...
           cbc_balance        cbc_choices         cbc_design        cbc_overlap 
                  TRUE               TRUE               TRUE               TRUE 
             cbc_power       cbc_profiles       cbc_restrict plot_compare_power 
                  TRUE               TRUE               TRUE               TRUE 
                randLN              randN 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-16 03:51:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31cdc1c89_1739677887
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpw04gGB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cbcTools_v0.5.0-tikzDictionary"
