# Validation Report - businessPlanR@0.1.0
...
| export_help          | 61                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Meik Michalke <meik.michalke@c3s.cc> |
...
Overall the package has 41 exported objects. 61 are documented:

           as_transaction               barplot            calc_staff 
                     TRUE                  TRUE                  TRUE 
                 condense               delayed          depreciation 
                     TRUE                  TRUE                  TRUE 
                  expense             fin_needs            first_last 
                     TRUE                  TRUE                  TRUE 
    get_depreciation_plan           get_expense             get_loans 
                     TRUE                  TRUE                  TRUE 
                 get_misc             get_model            get_period 
                     TRUE                  TRUE                  TRUE 
                 get_plan         get_plan_type           get_revenue 
                     TRUE                  TRUE                  TRUE 
                  get_sum             get_types             get_value 
                     TRUE                  TRUE                  TRUE 
                   growth             kable_bpR          kbl_by_types 
                     TRUE                  TRUE                  TRUE 
               list_plans                  loan            model_node 
                     TRUE                  TRUE                  TRUE 
                 model2df          nice_numbers            operations 
                     TRUE                  TRUE                  TRUE 
           permalink2list             regularly     regularly_delayed 
                     TRUE                  TRUE                  TRUE 
                  revenue            set_misc<-             set_types 
                     TRUE                  TRUE                  TRUE 
              table_model           transaction      transaction_plan 
                     TRUE                  TRUE                  TRUE 
      update_operations<-         update_plan<- 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-22 03:20:19 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb4405f8c5_1740194414
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8U042U
...
These are the options set to generate the report:
    ...
    [1] "validation_report_businessPlanR_v0.1.0-tikzDictionary"
