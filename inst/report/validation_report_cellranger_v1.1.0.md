# Validation Report - cellranger@1.1.0
...
| export_help          | 23                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Jennifer Bryan <jenny@stat.ubc.ca>    |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/rsheets/cellranger |
| has_bug_reports_url  | 1                                     |
| downloads_1yr        | 6802792                               |
...
AOV1R, googlesheets4, knfi, mschart, readODS, readxl, tidytlg, tidyxl,
unpivotr
...
Overall the package has 23 exported objects. 23 are documented:
        ...
        A1_to_R1C1       addr_col       addr_row       anchored   as.cell_addr 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    as.cell_addr_v as.cell_limits      as.ra_ref    as.ra_ref_v       as.range 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         cell_addr      cell_cols    cell_limits      cell_rows       guess_fo 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             is_A1        is_R1C1  letter_to_num  num_to_letter     R1C1_to_A1 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            ra_ref      to_string    to_string_v 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 03:58:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31e021c94_1739678327
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1BSPiD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cellranger_v1.1.0-tikzDictionary"
