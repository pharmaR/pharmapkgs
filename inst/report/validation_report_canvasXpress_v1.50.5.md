# Validation Report - canvasXpress@1.50.5
...
| export_help          | 7                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Connie Brett <connie@aggregate-genius.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/neuhausi/canvasXpress   |
...
dbparser, DGEobj.utils, periscope, periscope2

## Namespace

Overall the package has 7 exported objects. 7 are documented:

          canvasXpress  canvasXpress.json canvasXpressOutput         cxHtmlPage 
                  TRUE               TRUE               TRUE               TRUE 
        cxShinyExample     ggplot.as.list renderCanvasXpress 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 03:38:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3a850ed9_1739677117
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4QzSZd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_canvasXpress_v1.50.5-tikzDictionary"
