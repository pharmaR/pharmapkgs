# Validation Report - EstimateGroupNetwork@0.3.1
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Giulio Costantini <giulio.costantini@unimib.it>      |
...
Overall the package has 5 exported objects. 5 are documented:
               ...
               BootTable          covNoBessel EstimateGroupNetwork 
                    TRUE                 TRUE                 TRUE 
           GroupBootPlot     GroupNetworkBoot 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:32:08 UTC |
...
running this report
    ...
    PROCESSX_PS1d45697bdee5_1739939522
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCel1nm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EstimateGroupNetwork_v0.3.1-tikzDictionary"
