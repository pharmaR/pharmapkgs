...
| 6   | rintcal (\>= 1.1.1) | Imports |
| 7   | rice (\>= 1.0.0)    | Depends |
...
Overall the package has 5 exported objects. 5 are documented:
        ...
        add.dates          clam   deptime.age deptime.depth  plot_proxies 
...
| Execution Time | 2025-02-16 04:25:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bc320759ac_1739679941
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAj7pOD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clam_v2.6.2-tikzDictionary"
