# Validation Report - BNPmix@1.0.2
...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Riccardo Corradin <riccardo.corradin@gmail.com>      |
...
| 8   | Rcpp(\>= 0.12.13) | LinkingTo |
| 9   | RcppDist          | LinkingTo |
...
Overall the package has 18 exported objects. 18 are documented:
            ...
            BNPdens2coda BNPdens2coda.BNPdens           BNPmix_BIN 
                    TRUE                 TRUE                 TRUE 
              BNPmix_psm         BNPmix_VI_LB              BNPpart 
                    TRUE                 TRUE                 TRUE 
         clean_partition             dBNPdens     dBNPdens.BNPdens 
                    TRUE                 TRUE                 TRUE 
              DDPdensity            partition    partition.BNPdens 
                    TRUE                 TRUE                 TRUE 
            plot.BNPdens        print.BNPdens          PYcalibrate 
                    TRUE                 TRUE                 TRUE 
               PYdensity         PYregression      summary.BNPdens 
                    TRUE                 TRUE                 TRUE 

### Examples

There are 20 help pages with examples, from 42 (47.62 %).
...
| Execution Time | 2025-02-15 04:28:52 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7e55911b_1739593727
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5nEOoO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BNPmix_v1.0.2-tikzDictionary"
