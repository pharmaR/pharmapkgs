...
AnomalyScore, CellTrails, ddc, DTWBI, dtwclust, DTWUMI, IncDTW,
MarketMatching, mlmts, parallelDist, pGRN, rplanes, rucrdtw,
sarp.snowprofile.alignment, soundgen, ssMousetrack, TSclust, TSdist,
verification, VLTimeCausality, warbleR

## Namespace

Overall the package has 46 exported objects. 46 are documented:

                 asymmetric            asymmetricP0           asymmetricP05 
                       TRUE                    TRUE                    TRUE 
               asymmetricP1            asymmetricP2              countPaths 
                       TRUE                    TRUE                    TRUE 
                        dtw                 dtwDist                 dtwPlot 
                       TRUE                    TRUE                    TRUE 
           dtwPlotAlignment          dtwPlotDensity         dtwPlotThreeWay 
                       TRUE                    TRUE                    TRUE 
              dtwPlotTwoWay          dtwWindow.plot                  is.dtw 
                       TRUE                    TRUE                    TRUE 
             is.stepPattern           itakuraWindow                mori2006 
                       TRUE                    TRUE                    TRUE 
             mvmStepPattern                noWindow rabinerJuangStepPattern 
                       TRUE                    TRUE                    TRUE 
                      rigid        sakoeChibaWindow       slantedBandWindow 
                       TRUE                    TRUE                    TRUE 
                 symmetric1              symmetric2             symmetricP0 
                       TRUE                    TRUE                    TRUE 
               symmetricP05             symmetricP1             symmetricP2 
                       TRUE                    TRUE                    TRUE 
                     typeIa                 typeIas                  typeIb 
                       TRUE                    TRUE                    TRUE 
                    typeIbs                  typeIc                 typeIcs 
                       TRUE                    TRUE                    TRUE 
                     typeId                 typeIds                 typeIIa 
                       TRUE                    TRUE                    TRUE 
                    typeIIb                 typeIIc                 typeIId 
                       TRUE                    TRUE                    TRUE 
                   typeIIIc                 typeIVc                    warp 
                       TRUE                    TRUE                    TRUE 
                   warpArea 
                       TRUE 
...
| Execution Time | 2025-02-25 03:23:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d284212030d_1740453822
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBSsTiu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dtw_v1.23.1-tikzDictionary"
