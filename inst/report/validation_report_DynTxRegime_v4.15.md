# Validation Report - DynTxRegime@4.15
...
Overall the package has 14 exported objects. 29 are documented:

                   bowl buildModelObjSubset             classif             DTRstep 
                   TRUE                TRUE                TRUE                TRUE 
                   earl          iqLearnFSC          iqLearnFSM          iqLearnFSV 
                   TRUE                TRUE                TRUE                TRUE 
              iqLearnSS        optimalClass          optimalSeq                 owl 
                   TRUE                TRUE                TRUE                TRUE 
                 qLearn                 rwl 
                   TRUE                TRUE 
...
There are 150 help pages with examples, from 242 (61.98 %).
...
| Execution Time | 2025-02-18 05:07:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bb465bf6b3e_1739855241
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpktDNUn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DynTxRegime_v4.15-tikzDictionary"
