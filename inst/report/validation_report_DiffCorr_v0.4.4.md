# Validation Report - DiffCorr@0.4.4
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Atsushi Fukushima <afukushima@gmail.com>             |
...
Overall the package has 16 exported objects. 16 are documented:
            ...
            cluster.molecule            comp.2.cc.fdr                 compcorr 
                        TRUE                     TRUE                     TRUE 
                    cor.dist                cor2.test               generate_g 
                        TRUE                     TRUE                     TRUE 
          get.eigen.molecule get.eigen.molecule.graph                 get.lfdr 
                        TRUE                     TRUE                     TRUE 
                 get.min.max     plotClusterMolecules        plotDiffCorrGroup 
                        TRUE                     TRUE                     TRUE 
              scalingMethods          uncent.cor2dist           uncent.cordist 
                        TRUE                     TRUE                     TRUE 
               write.modules 
                        TRUE 
...
| Execution Time | 2025-02-18 04:03:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb438a2f344_1739851381
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnAVWIc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiffCorr_v0.4.4-tikzDictionary"
