...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ivan Krylov <ikrylov@laser.chem.msu.ru>              |
...
Overall the package has 18 exported objects. 17 are documented:
             ...
             absindex diverging.colours              feem     feemcorcondia 
                 TRUE              TRUE              TRUE              TRUE 
             feemcube         feemflame          feemgrid           feemife 
                 TRUE              TRUE              TRUE              TRUE 
            feemindex     feemjackknife          feemlist       feemparafac 
                 TRUE              TRUE              TRUE              TRUE 
            feemscale       feemscatter     feemsplithalf    marine.colours 
                 TRUE              TRUE              TRUE              TRUE 
              rescale   write.openfluor 
                FALSE              TRUE 
...
| Execution Time | 2025-02-21 13:08:49 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a144295f3_1740143326
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMnrcCE
