# Validation Report - ecoregime@0.2.0
...
| export_help | 11 |
| has_website | TRUE |
| has_maintainer | Martina Sánchez-Pinillos <martina.sanchez.pinillos@gmail.com> |
| bugs_status | 0.6666667 |
| has_source_control | https://github.com/MSPinillos/ecoregime |
...
Overall the package has 11 exported objects. 11 are documented:
              ...
              amplitude                 dBD                dDis        define_retra 
                   TRUE                TRUE                TRUE                TRUE 
                   dEve            dist_edr          net_change            recovery 
                   TRUE                TRUE                TRUE                TRUE 
             resistance           retra_edr state_to_trajectory 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 03:36:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d457bc419af_1739936179
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyjFjl5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecoregime_v0.2.0-tikzDictionary"
