# Validation Report - contsurvplot@0.2.1
...
| has_source_control   | https://github.com/RobinDenz1/contsurvplot |
...
Overall the package has 12 exported objects. 12 are documented:
             ...
             curve_cont plot_surv_3Dsurface  plot_surv_animated      plot_surv_area 
                   TRUE                TRUE                TRUE                TRUE 
         plot_surv_at_t   plot_surv_contour   plot_surv_heatmap     plot_surv_lines 
                   TRUE                TRUE                TRUE                TRUE 
       plot_surv_matrix plot_surv_quantiles      plot_surv_rmst      plot_surv_rmtl 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 03:50:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63b2f4e17_1739764234
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpg9HfXp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_contsurvplot_v0.2.1-tikzDictionary"
