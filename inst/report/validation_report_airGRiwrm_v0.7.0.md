...
| export_help          | 27                                        |
| has_website          | TRUE                                      |
| has_maintainer       | David Dorchies <david.dorchies@inrae.fr>  |
| bugs_status          | subscript out of bounds                   |
| size_codebase        | 2516                                      |
| has_source_control   | https://github.com/inrae/airGRiwrm#readme |
...
Overall the package has 27 exported objects. 27 are documented:
                  ...
                  as.Qm3s           Calibration        ConvertMeteoSD 
                     TRUE                  TRUE                  TRUE 
       CreateCalibOptions      CreateController          CreateGRiwrm 
                     TRUE                  TRUE                  TRUE 
         CreateInputsCrit     CreateInputsModel      CreateRunOptions 
                     TRUE                  TRUE                  TRUE 
         CreateSupervisor          extractParam getAllNodesProperties 
                     TRUE                  TRUE                  TRUE 
        getNodeProperties        getNodeRanking           getNoSD_Ids 
                     TRUE                  TRUE                  TRUE 
                getSD_Ids      isNodeDownstream        isNodeUpstream 
                     TRUE                  TRUE                  TRUE 
                  mermaid      mermaid_gen_link           plot.GRiwrm 
                     TRUE                  TRUE                  TRUE 
             plot.mermaid             plot.Qm3s          reduceGRiwrm 
                     TRUE                  TRUE                  TRUE 
                 RunModel    RunModel_Reservoir      transferGRparams 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-14 06:45:53 UTC |
...
running this report
    ...
    PROCESSX_PS726d4e4db99_1739515550
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpeb7aWt
