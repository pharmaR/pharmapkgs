...
| size_codebase        | 328                                                |
| has_source_control   | https://github.com/wlandau/autometric              |
...
Overall the package has 11 exported objects. 11 are documented:
         ...
         log_active   log_phase_get log_phase_reset   log_phase_set        log_plot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          log_print        log_read       log_start        log_stop     log_support 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        log_version 
               TRUE 
...
| Execution Time | 2025-02-14 07:33:52 UTC |
...
running this report
    ...
    PROCESSX_PS1c094db93d0f_1739518429
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp40Huno
