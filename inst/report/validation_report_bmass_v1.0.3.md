...
| export_help          | 4                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Michael Turchin <mturchin20@uchicago.edu> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/mturchin20/bmass       |
...
Overall the package has 4 exported objects. 4 are documented:
                              ...
                              bmass           GetMarginalPosteriors 
                               TRUE                            TRUE 
                GetModelPriorMatrix GetTopModelsPerSNPViaPosteriors 
                               TRUE                            TRUE 

### Examples

There are 3 help pages with examples, from 10 (30.00 %).
...
| Execution Time | 2025-02-15 04:26:09 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7d4c3939_1739593564
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9R6scD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bmass_v1.0.3-tikzDictionary"
