# Validation Report - depower@2025.1.20
...
| export_help          | 21                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Brett Klamer <code@brettklamer.com>                  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://bitbucket.org/bklamer/depower/               |
...
Overall the package has 21 exported objects. 21 are documented:
               ...
               glm_nb          glmm_bnb      glmm_poisson           lrt_bnb 
                 TRUE              TRUE              TRUE              TRUE 
               lrt_nb       mle_bnb_alt      mle_bnb_null        mle_nb_alt 
                 TRUE              TRUE              TRUE              TRUE 
          mle_nb_null       nll_bnb_alt      nll_bnb_null        nll_nb_alt 
                 TRUE              TRUE              TRUE              TRUE 
          nll_nb_null             power           sim_bnb sim_log_lognormal 
                 TRUE              TRUE              TRUE              TRUE 
               sim_nb     t_test_paired      t_test_welch     wald_test_bnb 
                 TRUE              TRUE              TRUE              TRUE 
         wald_test_nb 
                 TRUE 
...
| Execution Time | 2025-02-18 03:44:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bb479fda25a_1739850276
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprNIjvr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_depower_v2025.1.20-tikzDictionary"
