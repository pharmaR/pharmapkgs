# Validation Report - fastdid@1.0.3
...
| export_help          | 3                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Lin-Tung Tsai <tsaidondon@gmail.com>   |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/TsaiLintung/fastdid |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | data.table (\>= 1.15.0) | Imports |
| 2   | stringr                 | Imports |
| 3   | BMisc                   | Imports |
| 4   | collapse                | Imports |
| 5   | dreamerr (\>= 1.4.0)    | Imports |
| 6   | parglm                  | Imports |
| 7   | ggplot2                 | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
              ...
              fastdid plot_did_dynamics           sim_did 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 05:15:47 UTC |
...
running this report
    ...
    PROCESSX_PS1d457592bb93_1739942140
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVHSqOK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastdid_v1.0.3-tikzDictionary"
