# Validation Report - Bios2cor@2.2.2
...
| export_help          | 30                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Marie Chabbert <marie.chabbert@univ-angers.fr>       |
...
Overall the package has 30 exported objects. 30 are documented:
          ...
          angle2rotamer         angles.plot        centered_pca        delta_filter 
                   TRUE                TRUE                TRUE                TRUE 
       dynamic_circular     dynamic_entropy          dynamic_mi         dynamic_mip 
                   TRUE                TRUE                TRUE                TRUE 
           dynamic_omes   dynamic_structure                elsc             entropy 
                   TRUE                TRUE                TRUE                TRUE 
           import.fasta          import.msf              mcbasc                  mi 
                   TRUE                TRUE                TRUE                TRUE 
                    mip        network.plot                omes              pca_2d 
                   TRUE                TRUE                TRUE                TRUE 
          pca_screeplot          random.msa scores_entropy.plot      scores.boxplot 
                   TRUE                TRUE                TRUE                TRUE 
     top_pairs_analysis       write.entropy           write.pca       write.pca.pdb 
                   TRUE                TRUE                TRUE                TRUE 
           write.scores         xyz2torsion 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-15 04:14:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd192591be_1739592877
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1RNkGg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Bios2cor_v2.2.2-tikzDictionary"
