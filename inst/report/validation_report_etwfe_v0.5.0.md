...
| export_help          | 2                                 |
| has_website          | TRUE                              |
| has_maintainer       | Grant McDermott <gmcd@amazon.com> |
...
|     | package                      | type    |
|:----|:-----------------------------|:--------|
| 1   | fixest (\>= 0.11.2)          | Imports |
| 2   | stats                        | Imports |
| 3   | data.table                   | Imports |
| 4   | Formula                      | Imports |
| 5   | marginaleffects (\>= 0.24.0) | Imports |
| 6   | tinyplot (\>= 0.2.0)         | Imports |
...
| Execution Time | 2025-02-19 04:35:17 UTC |
...
running this report
    ...
    PROCESSX_PS1d4527dc5df4_1739939710
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9WrkwZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_etwfe_v0.5.0-tikzDictionary"
