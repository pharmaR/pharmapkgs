# Validation Report - diagmeta@0.5.1
...
| export_help | 9 |
| has_website | TRUE |
| has_maintainer | Guido Schwarzer <guido.schwarzer@uniklinik-freiburg.de> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/guido-s/diagmeta |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    as.data.frame.diagmeta               diagmeta              diagstats 
                      TRUE                   TRUE                   TRUE 
                  ipd2diag          plot.diagmeta         print.diagmeta 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-24 03:27:52 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a750ed4a2_1740367668
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgTO0uN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diagmeta_v0.5.1-tikzDictionary"
