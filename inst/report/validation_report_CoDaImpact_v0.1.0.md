# Validation Report - CoDaImpact@0.1.0
...
| export_help          | 14                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Lukas Dargel <lukas.dargel@mailbox.org> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/LukeCe/CoDaImpact    |
...
Overall the package has 14 exported objects. 14 are documented:
                       ...
                       alr                 alrInv                    clr 
                      TRUE                   TRUE                   TRUE 
                    clrInv              CoDa_path               CoDa_seq 
                      TRUE                   TRUE                   TRUE 
                       ilr                 ilrInv                Impacts 
                      TRUE                   TRUE                   TRUE 
                    lmCoDa ShareRatioElasticities              ToSimplex 
                      TRUE                   TRUE                   TRUE 
         VariationScenario         VariationTable 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:50:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bc372d60d14_1739681432
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRwMfbc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CoDaImpact_v0.1.0-tikzDictionary"
