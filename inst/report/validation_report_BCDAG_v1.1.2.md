...
| export_help          | 11                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Alessandro Mascaro <alessandro.mascaro@upf.edu> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/alesmascaro/BCDAG            |
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            as_graphNEL        causaleffect    get_causaleffect     get_diagnostics 
                   TRUE                TRUE                TRUE                TRUE 
          get_edgeprobs          get_MAPdag          get_MPMdag get_neighboringDAGs 
                   TRUE                TRUE                TRUE                TRUE 
              learn_DAG                rDAG         rDAGWishart 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 03:45:28 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5372f9e8_1739591123
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdoGls6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BCDAG_v1.1.2-tikzDictionary"
