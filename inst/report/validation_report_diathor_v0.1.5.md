# Validation Report - diathor@0.1.5
...
| export_help          | 27                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Joaquin Cochero <jcochero@ilpla.edu.ar>              |
...
Overall the package has 27 exported objects. 27 are documented:
         ...
         diat_cemfgs_rb      diat_checkName            diat_ddi            diat_des 
                   TRUE                TRUE                TRUE                TRUE 
              diat_disp      diat_diversity            diat_edi           diat_epid 
                   TRUE                TRUE                TRUE                TRUE 
    diat_getDiatBarcode         diat_guilds           diat_idap           diat_idch 
                   TRUE                TRUE                TRUE                TRUE 
               diat_idp            diat_ilm            diat_ips       diat_loadData 
                   TRUE                TRUE                TRUE                TRUE 
              diat_lobo         diat_morpho          diat_pbidw          diat_pdise 
                   TRUE                TRUE                TRUE                TRUE 
              diat_size            diat_sla          diat_spear       diat_taxaList 
                   TRUE                TRUE                TRUE                TRUE 
               diat_tdi         diat_vandam          diaThorAll 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 03:59:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bb438b2ca4d_1739851161
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTjD4cv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diathor_v0.1.5-tikzDictionary"
