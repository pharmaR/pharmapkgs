# Validation Report - Certara.NLME8@3.0.1
...
Certara.RsNLME, Certara.RsNLME.ModelExecutor

## Namespace

Overall the package has 14 exported objects. 14 are documented:

                          checkGCC                checkInstallDir 
                              TRUE                           TRUE 
                  checkLicenseFile               checkMPISettings 
                              TRUE                           TRUE 
                      checkRootDir                  getTableNames 
                              TRUE                           TRUE 
                  performBootstrap performEstimationOnSortColumns 
                              TRUE                           TRUE 
            performParallelNLMERun       performProfileEstimation 
                              TRUE                           TRUE 
         performShotgunCovarSearch     performStepwiseCovarSearch 
                              TRUE                           TRUE 
       reconnectToBootstrapNLMERun           UpdateMDLfrom_dmptxt 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-16 04:02:48 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36a6de8dc_1739678563
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVCt8y8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Certara.NLME8_v3.0.1-tikzDictionary"
