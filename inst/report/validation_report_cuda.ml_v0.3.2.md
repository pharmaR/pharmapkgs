# Validation Report - cuda.ml@0.3.2
...
| export_help          | 33                                 |
| has_website          | TRUE                               |
| has_maintainer       | Daniel Falbel <daniel@rstudio.com> |
...
| 2   | hardhat           | Imports   |
| 3   | parsnip           | Imports   |
| 4   | Rcpp (\>= 1.0.6)  | Imports   |
| 5   | rlang (\>= 0.1.4) | Imports   |
| 6   | Rcpp              | LinkingTo |
...
Overall the package has 33 exported objects. 33 are documented:
           ...
           cuda_ml_agglomerative_clustering cuda_ml_can_predict_class_probabilities 
                                       TRUE                                    TRUE 
                             cuda_ml_dbscan                     cuda_ml_elastic_net 
                                       TRUE                                    TRUE 
                        cuda_ml_fil_enabled                  cuda_ml_fil_load_model 
                                       TRUE                                    TRUE 
                  cuda_ml_inverse_transform                   cuda_ml_is_classifier 
                                       TRUE                                    TRUE 
                             cuda_ml_kmeans                             cuda_ml_knn 
                                       TRUE                                    TRUE 
                   cuda_ml_knn_algo_ivfflat                  cuda_ml_knn_algo_ivfpq 
                                       TRUE                                    TRUE 
                     cuda_ml_knn_algo_ivfsq                           cuda_ml_lasso 
                                       TRUE                                    TRUE 
                       cuda_ml_logistic_reg                             cuda_ml_ols 
                                       TRUE                                    TRUE 
                                cuda_ml_pca                     cuda_ml_rand_forest 
                                       TRUE                                    TRUE 
                          cuda_ml_rand_proj                           cuda_ml_ridge 
                                       TRUE                                    TRUE 
                          cuda_ml_serialise                       cuda_ml_serialize 
                                       TRUE                                    TRUE 
                                cuda_ml_sgd                             cuda_ml_svm 
                                       TRUE                                    TRUE 
                          cuda_ml_transform                            cuda_ml_tsne 
                                       TRUE                                    TRUE 
                               cuda_ml_tsvd                            cuda_ml_umap 
                                       TRUE                                    TRUE 
                        cuda_ml_unserialise                     cuda_ml_unserialize 
                                       TRUE                                    TRUE 
                         cuML_major_version                      cuML_minor_version 
                                       TRUE                                    TRUE 
                                   has_cuML 
                                       TRUE 
...
| Execution Time | 2025-02-17 04:38:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64d1b78a_1739767094
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpnyw4AC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cuda.ml_v0.3.2-tikzDictionary"
