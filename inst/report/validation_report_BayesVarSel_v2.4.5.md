# Validation Report - BayesVarSel@2.4.5
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Gonzalo Garcia-Donato <gonzalo.garciadonato@uclm.es> |
| bugs_status          | subscript out of bounds                              |
| has_source_control   | https://github.com/comodin19/BayesVarSel             |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | MASS (\>= 7.3-45)   | Depends |
| 2   | mvtnorm (\>= 1.0-5) | Depends |
| 3   | parallel (\>= 3.3)  | Depends |
...
Overall the package has 8 exported objects. 8 are documented:
     ...
     BMAcoeff     Btest       Bvs  GibbsBvs GibbsBvsF   histBMA Jointness    pltltn 
...
| Execution Time | 2025-02-15 03:42:16 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7987e63c_1739590931
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpzb4sbP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesVarSel_v2.4.5-tikzDictionary"
