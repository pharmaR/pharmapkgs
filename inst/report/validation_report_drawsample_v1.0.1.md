# Validation Report - drawsample@1.0.1
...
| export_help          | 6                                                 |
| has_website          | TRUE                                              |
| has_maintainer       | Kubra Atalay Kabasakal <katalay@hacettepe.edu.tr> |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/atalay-k/drawsample            |
...
Overall the package has 6 exported objects. 6 are documented:
          ...
          draw_sample    draw_sample_ir     draw_sample_n  draw_sample_n_ir 
                 TRUE              TRUE              TRUE              TRUE 
      draw_sample_rep draw_sample_shiny 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:43:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44a7970ea_1739853825
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpjYBoer
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drawsample_v1.0.1-tikzDictionary"
