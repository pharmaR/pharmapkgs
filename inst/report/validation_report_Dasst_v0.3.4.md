...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Homero Lozza <homerolozza@gmail.com>                 |
...
Overall the package has 11 exported objects. 20 are documented:
          ...
          addDate<-   buildContents       compute<-           Dasst    gatherTables 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       getAncillary      read.dssat searchAncillary     stackTables         summary 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        write.dssat 
               TRUE 
...
| Execution Time | 2025-02-17 04:55:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6662953fe_1739768123
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXq8bLb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Dasst_v0.3.4-tikzDictionary"
