...
Overall the package has 25 exported objects. 25 are documented:
        ...
        abcnonHtest     anovaOneWay       bfControl          bfTest          cvTest 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    latentTransform      medianTest          meldCD       meldtTest        metaNorm 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      methodRuleWMW             pbf        prevSeSp             qbf    quantileTest 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           signTest      simulateSS     tukeyWelsch        var1Test             Vpo 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         wmwControl         wmwTest       WprevSeSp   wspoissonTest         wsrTest 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 07:27:09 UTC |
...
running this report
    ...
    PROCESSX_PS1c0920606369_1739518026
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwtfYjR
