# Validation Report - Counternull@0.2.12
...
| export_help          | 6                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Mabene Yasmine <ymabene@stanford.edu>  |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/ymabene/Counternull |
...
Overall the package has 6 exported objects. 6 are documented:
                 ...
                 adjust_pvalues      create_fisher_interval 
                           TRUE                        TRUE 
               create_null_rand create_randomization_matrix 
                           TRUE                        TRUE 
        find_counternull_values              find_test_stat 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-17 04:04:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd654f5d639_1739765064
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTa47FU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Counternull_v0.2.12-tikzDictionary"
