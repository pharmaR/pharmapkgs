...
| has_source_control   | https://github.com/wlandau/eply                |
...
Overall the package has 9 exported objects. 9 are documented:
            ...
            eply        evals example.expr  example.fun example.with    help_eply 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
          quotes      strings      unquote 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-19 04:20:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d4536fbfe1e_1739938840
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEU5UNo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eply_v0.1.2-tikzDictionary"
