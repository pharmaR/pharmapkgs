# Validation Report - csdata@2024.4.26
...
| export_help          | 12                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Richard Aubrey White <hello@rwhite.no> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/csids/csdata        |
...
csalert, csmaps, cstidy

## Namespace

Overall the package has 12 exported objects. 12 are documented:

     add_granularity_geo_to_data_set             add_iso3_to_data_set 
                                TRUE                             TRUE 
                              config location_code_to_granularity_geo 
                                TRUE                             TRUE 
               location_code_to_iso3                               nb 
                                TRUE                             TRUE 
     nor_locations_hierarchy_from_to              nor_locations_names 
                                TRUE                             TRUE 
         nor_locations_redistricting       nor_population_by_age_cats 
                                TRUE                             TRUE 
                                  se                       set_config 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-17 04:30:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6104a69ba_1739766596
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKbMzIO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_csdata_v2024.4.26-tikzDictionary"
