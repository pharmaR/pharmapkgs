# Validation Report - blocksdesign@4.9
...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Rodney Edmondson <rodney.edmondson@gmail.com>        |
...
Overall the package has 9 exported objects. 9 are documented:
         ...
         A_bound       blocks       design     fraction  GraecoLatin          HCF 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
         isPrime isPrimePower         MOLS 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-15 04:24:06 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4e6b6395_1739593441
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHJGa6B
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blocksdesign_v4.9-tikzDictionary"
