# Validation Report - bioimagetools@1.1.8
...
| export_help          | 24                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Volker Schmid <stats@volkerschmid.de> |
...
Overall the package has 24 exported objects. 24 are documented:
                         ...
                         bwlabel3d                     cmoments3d 
                              TRUE                           TRUE 
                   distance2border                  filterImage3d 
                              TRUE                           TRUE 
                     folder.choose                            img 
                              TRUE                           TRUE 
                       intensity3D                     K.cross.3D 
                              TRUE                           TRUE 
                        L.cross.3D              mexican.hat.brush 
                              TRUE                           TRUE 
    nearest.neighbour.distribution           nearestClassDistance 
                              TRUE                           TRUE 
             nearestClassDistances                        outside 
                              TRUE                           TRUE 
         plotNearestClassDistances                        readBMP 
                              TRUE                           TRUE 
                      readClassTIF                        readTIF 
                              TRUE                           TRUE 
                           segment                segment.outside 
                              TRUE                           TRUE 
                             spots                    standardize 
                              TRUE                           TRUE 
                           table.n                       writeTIF 
...
| Execution Time | 2025-02-15 04:12:53 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd17608c97_1739592768
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpD4PV6o
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bioimagetools_v1.1.8-tikzDictionary"
