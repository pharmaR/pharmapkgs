# Validation Report - clintrialx@0.1.0
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Indraneel Chakraborty <hello.indraneel@gmail.com>    |
...
| 4   | dplyr           | Imports |
| 5   | progress        | Imports |
| 6   | RPostgreSQL     | Imports |
| 7   | tibble          | Imports |
| 8   | DBI             | Imports |
| 9   | rmarkdown       | Imports |
| 10  | xfun (\>= 0.44) | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    aact_check_connection       aact_connection     aact_custom_query 
                     TRUE                  TRUE                  TRUE 
           ctg_bulk_fetch             ctg_count       ctg_data_report 
                     TRUE                  TRUE                  TRUE 
           ctg_get_fields           ctg_get_nct                 hello 
                     TRUE                  TRUE                  TRUE 
             version_info 
                     TRUE 
...
| Execution Time | 2025-02-16 04:33:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bc350496e2d_1739680409
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTZqjkS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clintrialx_v0.1.0-tikzDictionary"
