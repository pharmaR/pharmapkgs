# Validation Report - estimability@1.5.1
...
| export_help          | 8                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Russell Lenth <russell-lenth@uiowa.edu> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/rvlenth/estimability |
| has_bug_reports_url  | 1                                       |
| downloads_1yr        | 1294569                                 |
...
effects, emmeans, estimatr, fddm, fixest, GLMMadaptive, glmmTMB,
LabApplStat, logistf, mmrm, robustlmm, rsm, sdmTMB, spmodel, survstan

## Namespace

Overall the package has 8 exported objects. 8 are documented:

             all.estble            epredict     estble.subspace             eupdate 
                   TRUE                TRUE                TRUE                TRUE 
              is.estble legacy.nonest.basis        nonest.basis    nonest.basis.svd 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:32:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d45aa8d4a1_1739939515
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXtbZaW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_estimability_v1.5.1-tikzDictionary"
