# Validation Report - dcurves@0.5.0
...
| has_source_control   | https://github.com/ddsjoberg/dcurves          |
...
Overall the package has 15 exported objects. 14 are documented:
                         ...
                         %>%                      aes                as_tibble 
                       FALSE                     TRUE                     TRUE 
             coord_cartesian                      dca                geom_line 
                        TRUE                     TRUE                     TRUE 
                      ggplot                     labs net_intervention_avoided 
                        TRUE                     TRUE                     TRUE 
          scale_x_continuous standardized_net_benefit              stat_smooth 
                        TRUE                     TRUE                     TRUE 
                        Surv        test_consequences                 theme_bw 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-17 05:12:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61b1c7051_1739769136
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFgqX7Q
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dcurves_v0.5.0-tikzDictionary"
