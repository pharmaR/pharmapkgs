# Validation Report - clespr@1.1.2
...
|:----|:------------------------|:--------|
| 1   | AER (\>= 1.2-5)         | Imports |
| 2   | pbivnorm (\>= 0.6.0)    | Imports |
| 3   | MASS (\>= 7.3-45)       | Imports |
| 4   | magic (\>= 1.5-6)       | Imports |
| 5   | survival (\>= 2.37-5)   | Imports |
| 6   | clordr (\>= 1.0.2)      | Imports |
| 7   | doParallel (\>= 1.0.11) | Imports |
| 8   | foreach (\>= 1.2.0)     | Imports |
| 9   | utils                   | Imports |
| 10  | stats                   | Imports |
...
| Execution Time | 2025-02-16 04:29:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33896c5aa_1739680140
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8WJCYG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clespr_v1.1.2-tikzDictionary"
