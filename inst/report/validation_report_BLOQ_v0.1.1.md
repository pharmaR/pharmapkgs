...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Vahid Nassiri <vahid.nassiri@openanalytics.eu>       |
...
Overall the package has 12 exported objects. 12 are documented:
              ...
              estimateAUCandStdErr estimateAUCwithCMLperTimePoint 
                              TRUE                           TRUE 
            estimateAUCwithFullCML          estimateAUCwithMVNCML 
                              TRUE                           TRUE 
        estimateAUCwithPairwiseCML                     imputeBLOQ 
                              TRUE                           TRUE 
                         imputeCML                 imputeConstant 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-15 04:24:28 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd438dfd1e_1739593463
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpol6ATk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BLOQ_v0.1.1-tikzDictionary"
