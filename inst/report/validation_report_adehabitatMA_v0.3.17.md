...
Overall the package has 25 exported objects. 25 are documented:
               ...
               .adehabitatMAEnv                  adeoptions 
                           TRUE                        TRUE 
                      area2spol                  asc2spixdf 
                           TRUE                        TRUE 
                         ascgen                 attpol2area 
                           TRUE                        TRUE 
                         buffer               calcperimeter 
                           TRUE                        TRUE 
                   count.points                  distfacmap 
                           TRUE                        TRUE 
                        explore                  getcontour 
                           TRUE                        TRUE 
             head.SpatialPoints head.SpatialPointsDataFrame 
                           TRUE                        TRUE 
    hist.SpatialPixelsDataFrame                        join 
                           TRUE                        TRUE 
                    kasc2spixdf                      labcon 
                           TRUE                        TRUE 
                         lowres                      mimage 
                           TRUE                        TRUE 
                     morphology                   spol2area 
                           TRUE                        TRUE 
                      subsetmap          tail.SpatialPoints 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-14 06:36:46 UTC |
...
running this report
    ...
    PROCESSX_PS726de96a8b9_1739515003
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfhteVx
