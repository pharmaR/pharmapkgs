# Validation Report - dwctaxon@2.0.3
...
| export_help          | 10                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Joel H. Nitta <joelnitta@gmail.com>  |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/ropensci/dwctaxon |
...
Overall the package has 10 exported objects. 10 are documented:
             ...
             dct_add_row    dct_check_mapping   dct_check_sci_name 
                    TRUE                 TRUE                 TRUE 
    dct_check_tax_status   dct_check_taxon_id         dct_drop_row 
                    TRUE                 TRUE                 TRUE 
            dct_fill_col       dct_modify_row          dct_options 
                    TRUE                 TRUE                 TRUE 
            dct_validate 
                    TRUE 
...
| Execution Time | 2025-02-18 05:01:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41a9f7e28_1739854891
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5K6YD4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dwctaxon_v2.0.3-tikzDictionary"
