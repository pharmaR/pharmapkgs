# Validation Report - DiceView@3.1.0
...
| export_help          | 25                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Yann Richet <yann.richet@irsn.fr>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/IRSN/DiceView                     |
...
| 4   | grDevices     | Depends |
| 5   | graphics      | Depends |
| 6   | DiceDesign    | Imports |
| 7   | R.cache       | Imports |
| 8   | geometry      | Imports |
| 9   | scatterplot3d | Imports |
| 10  | parallel      | Imports |
| 11  | foreach       | Imports |
...
Overall the package has 25 exported objects. 25 are documented:
        ...
        Apply.function        are_in.mesh             branin        contourview 
                  TRUE               TRUE               TRUE               TRUE 
     filledcontourview         is_in.mesh            is_in.p            is.mesh 
                  TRUE               TRUE               TRUE               TRUE 
      Memoize.function               mesh        mesh_exsets         mesh_level 
                  TRUE               TRUE               TRUE               TRUE 
              min_dist             optims          plot_mesh        plot2d_mesh 
                  TRUE               TRUE               TRUE               TRUE 
           plot3d_mesh     points_in.mesh    points_out.mesh               root 
                  TRUE               TRUE               TRUE               TRUE 
                 roots         roots_mesh        sectionview      sectionview3d 
                  TRUE               TRUE               TRUE               TRUE 
    Vectorize.function 
                  TRUE 
...
| Execution Time | 2025-02-24 03:27:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a41297d63_1740367673
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmph9bg6c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiceView_v3.1.0-tikzDictionary"
