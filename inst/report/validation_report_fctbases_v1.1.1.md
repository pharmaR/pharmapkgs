# Validation Report - fctbases@1.1.1
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Niels Olsen <nalo@dtu.dk>                            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/naolsen/fctbases                  |
...
Overall the package has 5 exported objects. 5 are documented:
        ...
        make.bspline.basis     make.fourier.basis         make.pol.basis 
                      TRUE                   TRUE                   TRUE 
    make.std.bspline.basis            object.info 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-27 03:21:18 UTC |
...
running this report
    ...
    PROCESSX_PS1c62581d0423_1740626474
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJ6PPnz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fctbases_v1.1.1-tikzDictionary"
