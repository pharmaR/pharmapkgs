# Validation Report - clusterCrit@1.3.0
...
| has_source_control   | https://gitlab.com/iagogv/clusterCrit           |
...
ChemoSpec, clusterMI, diceR, ehymet, latrend

## Namespace

Overall the package has 5 exported objects. 5 are documented:

       bestCriterion      concordance      extCriteria getCriteriaNames 
                TRUE             TRUE             TRUE             TRUE 
         intCriteria 
                TRUE 
...
| Execution Time | 2025-02-16 04:38:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bc354a9af7c_1739680714
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMrxRqq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clusterCrit_v1.3.0-tikzDictionary"
