...
| export_help          | 13                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Agustin Nieto <agustin.nieto77@gmail.com> |
| size_codebase        | 451                                       |
| has_source_control   | https://github.com/agusnieto77/ACEP       |
...
Overall the package has 13 exported objects. 13 are documented:
          ...
          acep_clean          acep_db      acep_detect        acep_frec 
                TRUE             TRUE             TRUE             TRUE 
            acep_int   acep_load_base         acep_men    acep_plot_rst 
                TRUE             TRUE             TRUE             TRUE 
        acep_plot_st         acep_rst       acep_token  acep_token_plot 
                TRUE             TRUE             TRUE             TRUE 
    acep_token_table 
                TRUE 
...
| Execution Time | 2025-02-14 06:31:35 UTC |
...
running this report
    ...
    PROCESSX_PS726d164fc008_1739514692
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmMS41g
