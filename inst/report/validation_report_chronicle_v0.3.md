# Validation Report - chronicle@0.3
...
| export_help          | 35                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Philippe Heymans Smith <pheymanss@gmail.com>         |
...
| 8   | knitr      | Imports |
| 9   | plotly     | Imports |
| 10  | prettydoc  | Imports |
| 11  | purrr      | Imports |
| 12  | readr      | Imports |
| 13  | rlang      | Imports |
| 14  | rmarkdown  | Imports |
| 15  | rmdformats | Imports |
| 16  | scales     | Imports |
| 17  | skimr      | Imports |
| 18  | stats      | Imports |
| 19  | viridis    | Imports |
...
Overall the package has 35 exported objects. 35 are documented:
         ...
         add_barplot      add_boxplot        add_chunk         add_code 
                TRUE             TRUE             TRUE             TRUE 
         add_density      add_dygraph    add_histogram        add_image 
                TRUE             TRUE             TRUE             TRUE 
        add_lineplot       add_quotes    add_raincloud  add_scatterplot 
                TRUE             TRUE             TRUE             TRUE 
           add_table         add_text        add_title       add_violin 
                TRUE             TRUE             TRUE             TRUE 
       assemble_call       check_cols   file_extension     make_barplot 
                TRUE             TRUE             TRUE             TRUE 
        make_boxplot     make_density     make_dygraph   make_histogram 
                TRUE             TRUE             TRUE             TRUE 
       make_lineplot   make_raincloud make_scatterplot       make_title 
                TRUE             TRUE             TRUE             TRUE 
         make_violin    output_config     plot_columns    render_report 
                TRUE             TRUE             TRUE             TRUE 
      report_columns  rmd_title_level      set_classes 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:16:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36b783534_1739679405
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0dUevi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chronicle_v0.3-tikzDictionary"
