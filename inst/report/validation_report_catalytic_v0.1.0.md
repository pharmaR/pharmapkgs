# Validation Report - catalytic@0.1.0
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Dongming Huang <huang.dongming@nus.edu.sg>           |
...
Overall the package has 15 exported objects. 15 are documented:
                      ...
                      cat_cox             cat_cox_bayes       cat_cox_bayes_joint 
                         TRUE                      TRUE                      TRUE 
       cat_cox_initialization              cat_cox_tune                   cat_glm 
                         TRUE                      TRUE                      TRUE 
                cat_glm_bayes       cat_glm_bayes_joint cat_glm_bayes_joint_gibbs 
                         TRUE                      TRUE                      TRUE 
       cat_glm_initialization              cat_glm_tune                   cat_lmm 
                         TRUE                      TRUE                      TRUE 
       cat_lmm_initialization              cat_lmm_tune                 traceplot 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-16 03:46:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bc366eed5d4_1739677559
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxoxURw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_catalytic_v0.1.0-tikzDictionary"
