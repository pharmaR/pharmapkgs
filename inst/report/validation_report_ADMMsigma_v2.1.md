...
| export_help          | 4                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Matt Galloway <gall0441@umn.edu>     |
| bugs_status          | subscript out of bounds              |
| size_codebase        | 428                                  |
| has_source_control   | https://github.com/MGallow/ADMMsigma |
...
| 4   | ggplot2                | Imports   |
| 5   | dplyr                  | Imports   |
| 6   | Rcpp (\>= 0.12.10)     | Depends   |
| 7   | RcppProgress (\>= 0.1) | Depends   |
| 8   | doParallel             | Depends   |
| 9   | Rcpp                   | LinkingTo |
| 10  | RcppArmadillo          | LinkingTo |
| 11  | RcppProgress           | LinkingTo |
...
Overall the package has 4 exported objects. 4 are documented:
         ...
         ADMMc  ADMMsigma     RIDGEc RIDGEsigma 
          TRUE       TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-14 06:38:59 UTC |
...
running this report
    ...
    PROCESSX_PS726d75e80087_1739515136
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpw0qZoY
