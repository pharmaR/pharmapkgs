...
| export_help          | 4                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Corissa T. Rohloff <corissa.wurth@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/crohlo/BEND               |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | coda (\>= 0.19.4)         | Imports |
| 2   | label.switching (\>= 1.8) | Imports |
| 3   | rjags (\>= 4.14)          | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    Bayes_BPREM  Bayes_CREM  Bayes_PREM   plot_BEND 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-15 03:53:01 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4a3357bb_1739591576
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcDnZ86
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BEND_v1.0-tikzDictionary"
