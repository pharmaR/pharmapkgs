...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Benoit Gauzens <benoit.gauzens@gmail.com>            |
...
Overall the package has 17 exported objects. 17 are documented:
                      ...
                      create_Lmatrix          create_matrix_parameter 
                                TRUE                             TRUE 
                 create_model_Scaled            create_model_Unscaled 
                                TRUE                             TRUE 
          create_model_Unscaled_nuts               create_niche_model 
                                TRUE                             TRUE 
           initialise_default_Scaled      initialise_default_Unscaled 
                                TRUE                             TRUE 
    initialise_default_Unscaled_nuts                     is_connected 
                                TRUE                             TRUE 
                            jacobian                    lsoda_wrapper 
                                TRUE                             TRUE 
                         plot_odeweb                   remove_species 
                                TRUE                             TRUE 
                          run_checks                       sort_input 
                                TRUE                             TRUE 
                              TroLev 
                                TRUE 
...
There are 22 help pages with examples, from 28 (78.57 %).
...
| Execution Time | 2025-02-14 07:30:59 UTC |
...
running this report
    ...
    PROCESSX_PS1c097958bbbb_1739518256
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUcZaq9
