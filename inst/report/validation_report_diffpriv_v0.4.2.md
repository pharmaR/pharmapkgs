# Validation Report - diffpriv@0.4.2
...
| export_help          | 15                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Benjamin Rubinstein <brubinstein@unimelb.edu.au> |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/brubinstein/diffpriv          |
...
Overall the package has 11 exported objects. 15 are documented:
                   ...
                   bernstein          DPMechBernstein        DPMechExponential 
                        TRUE                     TRUE                     TRUE 
              DPMechGaussian            DPMechLaplace            DPMechNumeric 
                        TRUE                     TRUE                     TRUE 
                 DPParamsDel              DPParamsEps              DPParamsGam 
                        TRUE                     TRUE                     TRUE 
          sensitivitySampler sensitivitySamplerManual 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-18 04:04:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4b1f7ad3_1739851460
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8NrIWC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diffpriv_v0.4.2-tikzDictionary"
