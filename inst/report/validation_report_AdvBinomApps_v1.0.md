...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Horst Lewitschnig <horst.lewitschnig@infineon.com>   |
...
Overall the package has 11 exported objects. 11 are documented:
        ...
        ci.mult.ref  ci.mult.ref.cm          ci.sas       ci.sas.cm          ci.syn 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          ci.syn.cm    gcd.mult.ref    phi.mult.ref phi.mult.ref.cm         phi.syn 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         phi.syn.cm 
               TRUE 
...
| Execution Time | 2025-02-14 06:39:54 UTC |
...
running this report
    ...
    PROCESSX_PS726d31a5102c_1739515191
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQargg3
