# Validation Report - clustering.sc.dp@1.1
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Tibor Szkaliczki <szkaliczki.tibor@sztaki.hu>        |
...
Overall the package has 4 exported objects. 4 are documented:
        ...
        backtracking.sc.dp       clustering.sc.dp     findwithinss.sc.dp 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:39:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3607b0b32_1739680754
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9Rpp6Y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clustering.sc.dp_v1.1-tikzDictionary"
