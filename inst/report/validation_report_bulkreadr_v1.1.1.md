# Validation Report - bulkreadr@1.1.1
...
| export_help          | 13                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Ezekiel Ogundepo <gbganalyst@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/gbganalyst/bulkreadr |
...
Overall the package has 13 exported objects. 12 are documented:
                          ...
                          %>%           convert_to_date       fill_missing_values 
                        FALSE                      TRUE                      TRUE 
          generate_dictionary                inspect_na                  look_for 
                         TRUE                      TRUE                      TRUE 
                     pull_out   read_csv_files_from_dir read_excel_files_from_dir 
                         TRUE                      TRUE                      TRUE 
          read_excel_workbook              read_gsheets            read_spss_data 
                         TRUE                      TRUE                      TRUE 
              read_stata_data 
                         TRUE 
...
| Execution Time | 2025-02-15 04:54:21 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd296d0fe8_1739595256
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp48358u
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bulkreadr_v1.1.1-tikzDictionary"
