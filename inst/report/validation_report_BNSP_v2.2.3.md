...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Georgios Papageorgiou <gpapageo@gmail.com>           |
...
| 9   | mgcv            | Imports   |
| 10  | corrplot        | Imports   |
| 11  | label.switching | Imports   |
| 12  | cubature        | LinkingTo |
...
Overall the package has 14 exported objects. 14 are documented:
          ...
          chol clustering   continue       dpmj   histCorr       lmrm       mvrm 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
     mvrm2mcmc   plotCorr          s   sinusoid         sm         te         ti 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-15 04:29:25 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7420f98b_1739593760
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9tDx3t
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BNSP_v2.2.3-tikzDictionary"
