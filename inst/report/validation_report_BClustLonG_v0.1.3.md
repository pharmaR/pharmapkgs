# Validation Report - BClustLonG@0.1.3
...
| export_help          | 2                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jiehuan Sun <jiehuan.sun@gmail.com>                  |
...
|     | package           | type      |
|:----|:------------------|:----------|
| 1   | MASS (\>= 7.3-47) | Depends   |
| 2   | lme4 (\>= 1.1-13) | Depends   |
| 3   | mcclust (\>= 1.0) | Depends   |
...
| Execution Time | 2025-02-15 03:46:35 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd66297e31_1739591190
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprqVdEK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BClustLonG_v0.1.3-tikzDictionary"
