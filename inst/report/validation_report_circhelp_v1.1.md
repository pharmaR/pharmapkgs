# Validation Report - circhelp@1.1
...
| export_help          | 29                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Andrey Chetverikov <andrey.chetverikov@uib.no> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/achetverikov/circhelp       |
...
Overall the package has 29 exported objects. 29 are documented:
                     ...
                     angle_diff_180               angle_diff_180_45 
                               TRUE                            TRUE 
                     angle_diff_360               angle_diff_360_90 
                               TRUE                            TRUE 
                      angle_diff_90                  angle_diff_rad 
                               TRUE                            TRUE 
                          circ_corr                      circ_descr 
                               TRUE                            TRUE 
                      circ_lin_corr                      circ_loess 
                               TRUE                            TRUE 
                      circ_mean_180                   circ_mean_360 
                               TRUE                            TRUE 
                      circ_mean_rad                     circ_sd_180 
                               TRUE                            TRUE 
                        circ_sd_360                     circ_sd_rad 
                               TRUE                            TRUE 
                  correct_angle_rad                        pad_circ 
                               TRUE                            TRUE 
             remove_cardinal_biases remove_cardinal_biases_discrete 
                               TRUE                            TRUE 
            vm_circ_sd_deg_to_kappa             vm_circ_sd_to_kappa 
                               TRUE                            TRUE 
                vm_kappa_to_circ_sd         vm_kappa_to_circ_sd_deg 
                               TRUE                            TRUE 
                 weighted_circ_mean             weighted_circ_mean2 
                               TRUE                            TRUE 
                  weighted_circ_rho                weighted_circ_sd 
                               TRUE                            TRUE 
                       weighted_sem 
                               TRUE 
...
| Execution Time | 2025-02-16 04:20:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bc315ced8e8_1739679636
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9eeOvL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_circhelp_v1.1-tikzDictionary"
