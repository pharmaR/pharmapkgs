...
| export_help          | 16                             |
| has_website          | TRUE                           |
| has_maintainer       | Lionel Henry <lionel@posit.co> |
| bugs_status          | subscript out of bounds        |
| has_source_control   | https://github.com/r-lib/coro  |
...
brulee, cito, crumble, deepregression, ellmer, familiar, geodl, luz,
openalexR, plumber, scDHA, SCFA, selenider, shapr, shiny, shinychat,
streamy, tabnet, torch, torchdatasets, torchvision, wikkitidy

## Namespace

Overall the package has 16 exported objects. 16 are documented:

        as_iterator           async   async_collect async_generator       async_ops 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        async_sleep           await      await_each         collect      coro_debug 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          exhausted             gen       generator    is_exhausted            loop 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              yield 
               TRUE 
...
| Execution Time | 2025-02-17 03:58:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bd616659db0_1739764695
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQYzABp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coro_v1.1.0-tikzDictionary"
