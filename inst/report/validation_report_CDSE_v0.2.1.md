...
| export_help          | 21                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Zivan Karaman <zivan.karaman@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/zivankaraman/CDSE    |
...
Overall the package has 21 exported objects. 21 are documented:
             ...
             GetArchiveImage           GetCollections                 GetImage 
                        TRUE                     TRUE                     TRUE 
               GetImageByAOI           GetImageByBbox      GetImageByTimerange 
                        TRUE                     TRUE                     TRUE 
              GetOAuthClient            GetOAuthToken            GetQueryables 
                        TRUE                     TRUE                     TRUE 
               GetStatistics       GetStatisticsByAOI      GetStatisticsByBbox 
                        TRUE                     TRUE                     TRUE 
    GetStatisticsByTimerange               Point2Bbox            SearchCatalog 
                        TRUE                     TRUE                     TRUE 
          SearchCatalogByAOI      SearchCatalogByBbox SearchCatalogByTimerange 
                        TRUE                     TRUE                     TRUE 
              SeasonalFilter        SeasonalTimerange            UniqueCatalog 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-16 03:57:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3ef888ec_1739678251
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6aLwaT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CDSE_v0.2.1-tikzDictionary"
