...
Overall the package has 12 exported objects. 19 are documented:

              anoint       anoint.fit   anoint.formula anoint.subgroups 
                TRUE             TRUE             TRUE             TRUE 
         data.anoint           forest   forest.subsets              obo 
                TRUE             TRUE             TRUE             TRUE 
                 pim          pim.fit      pim.subsets              uim 
                TRUE             TRUE             TRUE             TRUE 

### Examples

There are 14 help pages with examples, from 29 (48.28 %).
...
| Execution Time | 2025-02-14 06:55:52 UTC |
...
running this report
    ...
    PROCESSX_PS726d347f2e42_1739516149
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKGnEof
