# Validation Report - bullseye@0.1.2
...
| export_help          | 27                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Catherine Hurley <catherine.hurley@mu.ie>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/cbhurley/bullseye                 |
...
Overall the package has 27 exported objects. 27 are documented:
                 ...
                 ace_cor          as.pairwise             pair_ace 
                    TRUE                 TRUE                 TRUE 
             pair_cancor             pair_chi         pair_control 
                    TRUE                 TRUE                 TRUE 
                pair_cor            pair_dcor         pair_gkGamma 
                    TRUE                 TRUE                 TRUE 
              pair_gkTau         pair_methods            pair_mine 
                    TRUE                 TRUE                 TRUE 
                pair_nmi        pair_polychor      pair_polyserial 
                    TRUE                 TRUE                 TRUE 
        pair_scagnostics            pair_tauA            pair_tauB 
                    TRUE                 TRUE                 TRUE 
               pair_tauC            pair_tauW     pair_uncertainty 
                    TRUE                 TRUE                 TRUE 
                pairwise          pairwise_by       pairwise_multi 
                    TRUE                 TRUE                 TRUE 
         pairwise_scores        plot_pairwise plot_pairwise_linear 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:54:44 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1a4a4811_1739595279
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9xfkjb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bullseye_v0.1.2-tikzDictionary"
