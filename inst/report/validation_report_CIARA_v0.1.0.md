...
| export_help | 18 |
| has_website | FALSE |
| has_maintainer | Gabriele Lubatti |
...
Overall the package has 18 exported objects. 18 are documented:
                              ...
                              CIARA                      CIARA_gene 
                               TRUE                            TRUE 
    cluster_analysis_integrate_rare            cluster_analysis_sub 
                               TRUE                            TRUE 
                    find_resolution             get_background_full 
                               TRUE                            TRUE 
               guide_edge_colourbar          markers_cluster_seurat 
                               TRUE                            TRUE 
                      merge_cluster             plot_balloon_marker 
                               TRUE                            TRUE 
                          plot_gene                  plot_genes_sum 
                               TRUE                            TRUE 
                plot_heatmap_marker                plot_interactive 
                               TRUE                            TRUE 
                          plot_umap       selection_localized_genes 
                               TRUE                            TRUE 
                           test_hvg             white_black_markers 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-16 04:17:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33f6478e1_1739679461
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpt17LSf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CIARA_v0.1.0-tikzDictionary"
