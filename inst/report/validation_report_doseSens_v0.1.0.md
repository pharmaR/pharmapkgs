# Validation Report - doseSens@0.1.0
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jeffrey Zhang <jzhang17@wharton.upenn.edu>           |
...
Overall the package has 6 exported objects. 6 are documented:
               ...
               binary_thresh_attribute                             dev_TV 
                                  TRUE                               TRUE 
             dose_attributable_general            dose_sensitivity_mc_gen 
                                  TRUE                               TRUE 
    dose_thresh_attributable_one_sided                    normal_test_gen 
                                  TRUE                               TRUE 
...
| Execution Time | 2025-02-18 04:35:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bb463470bea_1739853345
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp24oM9n
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doseSens_v0.1.0-tikzDictionary"
