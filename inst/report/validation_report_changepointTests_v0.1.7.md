# Validation Report - changepointTests@0.1.7
...
Overall the package has 13 exported objects. 13 are documented:
                     ...
                     bootstrapfun                   cpCopDStats 
                             TRUE                          TRUE 
                   cpCopMultStats      cpCopMultStatsBKRSNonSeq 
                             TRUE                          TRUE 
            cpCopMultStatsBKRSSeq                    cpCopStats 
                             TRUE                          TRUE 
                   cpCopStatsBKRS                       emp.cdf 
                             TRUE                          TRUE 
             multiplierDNonSeqfun             multiplierDSeqfun 
                             TRUE                          TRUE 
                    multiplierfun             test.change.point 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-16 04:08:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bc327864957_1739678882
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZigWqm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_changepointTests_v0.1.7-tikzDictionary"
