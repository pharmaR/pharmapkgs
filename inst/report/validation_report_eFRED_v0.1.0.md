...
Overall the package has 36 exported objects. 36 are documented:
                          ...
                          fred              fred_category 
                          TRUE                       TRUE 
        fred_category_children      fred_category_related 
                          TRUE                       TRUE 
    fred_category_related_tags       fred_category_series 
                          TRUE                       TRUE 
            fred_category_tags                 fred_group 
                          TRUE                       TRUE 
             fred_observations          fred_related_tags 
                          TRUE                       TRUE 
                  fred_release         fred_release_dates 
                          TRUE                       TRUE 
     fred_release_related_tags        fred_release_series 
                          TRUE                       TRUE 
          fred_release_sources        fred_release_tables 
                          TRUE                       TRUE 
             fred_release_tags              fred_releases 
                          TRUE                       TRUE 
           fred_releases_dates                fred_search 
                          TRUE                       TRUE 
      fred_search_related_tags           fred_search_tags 
                          TRUE                       TRUE 
                   fred_series     fred_series_categories 
                          TRUE                       TRUE 
           fred_series_release           fred_series_tags 
                          TRUE                       TRUE 
           fred_series_vintage                fred_source 
                          TRUE                       TRUE 
          fred_source_releases               fred_sources 
                          TRUE                       TRUE 
                    fred_state                  fred_tags 
                          TRUE                       TRUE 
              fred_tags_series               fred_updates 
                          TRUE                       TRUE 
                  parse_search               set_fred_key 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-19 03:48:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d4560d9b5c1_1739936884
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXuT40u
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eFRED_v0.1.0-tikzDictionary"
