# Validation Report - concstats@0.1.6
...
| export_help          | 22                                                  |
| has_website          | TRUE                                                |
| has_maintainer       | Andreas Schneider <schneiderconsultingpy@gmail.com> |
| bugs_status          | subscript out of bounds                             |
| has_source_control   | https://github.com/ropensci/concstats/              |
...
Overall the package has 22 exported objects. 22 are documented:
       ...
       concstats_all_comp   concstats_all_inequ concstats_all_mstruct 
                     TRUE                  TRUE                  TRUE 
           concstats_comp   concstats_concstats         concstats_dom 
                     TRUE                  TRUE                  TRUE 
        concstats_entropy        concstats_firm        concstats_gini 
                     TRUE                  TRUE                  TRUE 
            concstats_grs         concstats_hhi       concstats_hhi_d 
                     TRUE                  TRUE                  TRUE 
        concstats_hhi_min       concstats_inequ     concstats_mstruct 
                     TRUE                  TRUE                  TRUE 
         concstats_nrs_eq       concstats_palma     concstats_simpson 
                     TRUE                  TRUE                  TRUE 
           concstats_sten         concstats_top        concstats_top3 
                     TRUE                  TRUE                  TRUE 
           concstats_top5 
                     TRUE 
...
| Execution Time | 2025-02-17 03:39:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bd660accb9c_1739763591
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvzvldZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_concstats_v0.1.6-tikzDictionary"
