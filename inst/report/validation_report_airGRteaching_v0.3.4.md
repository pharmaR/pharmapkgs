# Validation Report - airGRteaching@0.3.4
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | airGR (\>= 1.6.9.27)   | Depends |
| 2   | dygraphs (\>= 1.1.1.6) | Imports |
| 3   | markdown               | Imports |
| 4   | plotrix                | Imports |
| 5   | shiny (\>= 1.1.0)      | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
       ...
       CalGR   dyplot  GetCrit GetParam   PrepGR  ShinyGR    SimGR 
...
| Execution Time | 2025-02-14 06:45:56 UTC |
...
running this report
    ...
    PROCESSX_PS726d32fd4474_1739515553
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAg6cLN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_airGRteaching_v0.3.4-tikzDictionary"
