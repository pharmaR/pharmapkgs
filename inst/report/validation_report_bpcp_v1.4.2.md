...
Overall the package has 36 exported objects. 36 are documented:
                    ...
                    abmm         betaMeldTest  betaMeldTestMidp.mc 
                    TRUE                 TRUE                 TRUE 
            borkowf.calc                 bpcp              bpcp.mc 
                    TRUE                 TRUE                 TRUE 
                 bpcp.mm            bpcp2samp     bpcp2sampControl 
                    TRUE                 TRUE                 TRUE 
             bpcpControl              bpcpfit          bpcpMidp.mm 
                    TRUE                 TRUE                 TRUE 
                  citoLR             fixtdiff             getmarks 
                    TRUE                 TRUE                 TRUE 
              getmarks.x              intChar              kmci1TG 
                    TRUE                 TRUE                 TRUE 
             kmciBorkowf              kmcilog               kmciSW 
                    TRUE                 TRUE                 TRUE 
                  kmciSW               kmciTG          kmConstrain 
                    TRUE                 TRUE                 TRUE 
    kmConstrainBeta.calc            kmgw.calc            kmtestALL 
                    TRUE                 TRUE                 TRUE 
     kmtestConstrainBeta  kmtestConstrainBoot     mdiffmedian.test 
                    TRUE                 TRUE                 TRUE 
                  meldMC               qqbeta        rejectFromInt 
                    TRUE                 TRUE                 TRUE 
                    StCI           tidykmciLR                 uvab 
                    TRUE                 TRUE                 TRUE 

### Examples

There are 17 help pages with examples, from 21 (80.95 %).
...
| Execution Time | 2025-02-15 04:38:24 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd434463cc_1739594299
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2CmwZM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bpcp_v1.4.2-tikzDictionary"
