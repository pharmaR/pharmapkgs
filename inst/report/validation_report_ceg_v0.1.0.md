...
| has_source_control   | https://github.com/ptaranti/ceg   |
| has_bug_reports_url  | 1                                 |
| downloads_1yr        | 2035                              |
| reverse_dependencies | 0                                 |
| has_examples         | 0.6724138                         |
| dependencies         | 7                                 |
...
Overall the package has 6 exported objects. 6 are documented:
                  ...
                  Category      CheckAndCleanData   Stratified.ceg.model 
                      TRUE                   TRUE                   TRUE 
     Stratified.event.tree Stratified.staged.tree               Variable 
                      TRUE                   TRUE                   TRUE 

### Examples

There are 39 help pages with examples, from 58 (67.24 %).
...
| Execution Time | 2025-02-16 03:58:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33f4977ce_1739678294
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLRPKV0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ceg_v0.1.0-tikzDictionary"
