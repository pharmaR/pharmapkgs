# Validation Report - DiagrammeRsvg@0.1
...
| has_source_control   | https://github.com/rich-iannone/DiagrammeRsvg |
| has_bug_reports_url  | 1                                             |
| downloads_1yr        | 61967                                         |
| reverse_dependencies | 40                                            |
| has_examples         | 1                                             |
| dependencies         | 1                                             |
...
Overall the package has 40 reverse dependencies:

actel, behaviorchange, bpmnR, causalHyperGraph, cohorttools,
constructive, csquares, DiagrammeR, dm, FAIRmaterials, fishdata,
geogenr, greta, grPipe, heuristicsmineR, inldata, integr, justifier,
lavaanExtra, lavaanPlot, LearnVizLMM, mlms, netSEM, ODT, PaRe,
PhenotypeR, primer, PRISMA2020, processmapR, profile, Rgff, robotoolbox,
rock, rolap, rolog, seminr, srppp, stratEst, vtree, when
...
| Execution Time | 2025-02-18 03:58:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46c944185_1739851116
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoJsU4e
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DiagrammeRsvg_v0.1-tikzDictionary"
