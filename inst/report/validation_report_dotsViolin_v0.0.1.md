# Validation Report - dotsViolin@0.0.1
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Fernando Roa <froao@ufg.br>                          |
...
Overall the package has 6 exported objects. 6 are documented:
                ...
                dots_and_violin            get_modes_counts 
                           TRUE                        TRUE 
    get_peaks_counts_continuous                   get.peaks 
                           TRUE                        TRUE 
         make_legend_with_stats              plot_dotviolin 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-18 04:37:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46307a6b8_1739853421
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpK9qn2j
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dotsViolin_v0.0.1-tikzDictionary"
