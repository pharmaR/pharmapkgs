...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jan O. Bauer <j.bauer@vu.nl>                         |
...
Overall the package has 8 exported objects. 8 are documented:
              ...
              bdsvd   bdsvd.cov.sim        bdsvd.ht bdsvd.structure   detect.blocks 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              hcsvd   hcsvd.cor.sim    single.bdsvd 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 03:49:16 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2666ca0d_1739591352
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwmZTTB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bdsvd_v0.2.1-tikzDictionary"
