...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Robin Van Oirbeek <robin.vanoirbeek@gmail.com>       |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | plyr (\>= 1.8.4)    | Imports |
| 2   | stringr (\>= 1.1.0) | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
        ...
        checkCharVec      checkIntVec      checkLength    checkLogicVec 
                TRUE             TRUE             TRUE             TRUE 
    checkNumOrIntVec      checkNumVec      checkRanges      checkValues 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 03:51:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46c48188b_1739850680
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplYWBli
...
These are the options set to generate the report:
    ...
    [1] "validation_report_devFunc_v0.1-tikzDictionary"
