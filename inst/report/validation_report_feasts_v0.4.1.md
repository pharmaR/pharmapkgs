# Validation Report - feasts@0.4.1
...
| bugs_status          | 0.5333333                                         |
| has_source_control   | https://github.com/tidyverts/feasts/              |
| has_bug_reports_url  | 1                                                 |
| downloads_1yr        | 213747                                            |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | fabletools (\>= 0.3.1) | Depends |
| 2   | rlang (\>= 0.2.0)      | Imports |
| 3   | tibble (\>= 1.4.1)     | Imports |
| 4   | tsibble (\>= 0.9.0)    | Imports |
| 5   | ggplot2 (\>= 3.0.0)    | Imports |
| 6   | dplyr (\>= 1.0.0)      | Imports |
| 7   | tidyr (\>= 0.8.3)      | Imports |
| 8   | scales (\>= 1.1.0)     | Imports |
| 9   | vctrs                  | Imports |
| 10  | lubridate              | Imports |
| 11  | grid                   | Imports |
| 12  | slider                 | Imports |
| 13  | utils                  | Imports |
| 14  | lifecycle              | Imports |
| 15  | gtable                 | Imports |
...
epe4md, fable, fableCount, fabletools, finnts, fpp3, gratis, iNZightTS,
lterdatasampler, netseer, oddnet, RTL, theft, vital
...
Overall the package has 43 exported objects. 42 are documented:
                                ...
                                %>%                             ACF 
                              FALSE                            TRUE 
                         as_tsibble                       autolayer 
                               TRUE                            TRUE 
                           autoplot                      box_pierce 
                               TRUE                            TRUE 
                                CCF         classical_decomposition 
                               TRUE                            TRUE 
                         coef_hurst          cointegration_johansen 
                               TRUE                            TRUE 
    cointegration_phillips_ouliaris                        feat_acf 
                               TRUE                            TRUE 
                  feat_intermittent                       feat_pacf 
                               TRUE                            TRUE 
                      feat_spectral                        feat_stl 
                               TRUE                            TRUE 
                            gg_arma                          gg_irf 
                               TRUE                            TRUE 
                             gg_lag                       gg_season 
                               TRUE                            TRUE 
                       gg_subseries                    gg_tsdisplay 
                               TRUE                            TRUE 
                     gg_tsresiduals                        guerrero 
                               TRUE                            TRUE 
                          ljung_box               longest_flat_spot 
                               TRUE                            TRUE 
                  n_crossing_points                    n_flat_spots 
                               TRUE                            TRUE 
                               PACF               portmanteau_tests 
                               TRUE                            TRUE 
                     scale_x_cf_lag                    shift_kl_max 
                               TRUE                            TRUE 
                    shift_level_max                   shift_var_max 
                               TRUE                            TRUE 
                       stat_arch_lm                             STL 
                               TRUE                            TRUE 
                      unitroot_kpss                 unitroot_ndiffs 
                               TRUE                            TRUE 
                   unitroot_nsdiffs                     unitroot_pp 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-27 03:24:27 UTC |
...
running this report
    ...
    PROCESSX_PS1c622dd9e8fd_1740626664
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8pm3zq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_feasts_v0.4.1-tikzDictionary"
