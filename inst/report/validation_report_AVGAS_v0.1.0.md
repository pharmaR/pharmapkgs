...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Leiyue Li <lli289.git@gmail.com>                     |
...
| 4   | stats              | Imports |
| 5   | dplyr              | Imports |
| 6   | selectiveInference | Imports |
| 7   | VariableScreening  | Imports |
| 8   | ggplot2            | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
        ...
        ABC   AVGAS   cross  detect Extract  Genone initial     mut 
...
| Execution Time | 2025-02-14 07:35:46 UTC |
...
running this report
    ...
    PROCESSX_PS1c091e79fafa_1739518543
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMJaXrH
