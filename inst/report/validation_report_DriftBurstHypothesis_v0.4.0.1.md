# Validation Report - DriftBurstHypothesis@0.4.0.1
...
| export_help          | 7                                                   |
| has_website          | TRUE                                                |
| has_maintainer       | Emil Sjoerup <emilsjoerup@live.dk>                  |
| bugs_status          | subscript out of bounds                             |
| has_source_control   | https://github.com/emilsjoerup/DriftBurstHypothesis |
...
Overall the package has 7 exported objects. 7 are documented:
          ...
          driftBursts getCriticalValues             getDB           getMean 
                 TRUE              TRUE              TRUE              TRUE 
                getMu          getSigma            getVar 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:46:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4105a4970_1739853964
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpwhwa1f
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DriftBurstHypothesis_v0.4.0.1-tikzDictionary"
