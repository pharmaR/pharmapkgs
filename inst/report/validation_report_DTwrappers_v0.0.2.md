# Validation Report - DTwrappers@0.0.2
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Mayur Bansal <mb4511@columbia.edu>                   |
...
Overall the package has 9 exported objects. 9 are documented:
           ...
           dt.calculate      dt.choose.cols      dt.choose.rows       dt.count.rows 
                   TRUE                TRUE                TRUE                TRUE 
     dt.define.variable     dt.first.k.rows      dt.last.k.rows dt.remove.variables 
                   TRUE                TRUE                TRUE                TRUE 
                dt.sort 
                   TRUE 
...
| Execution Time | 2025-02-18 04:58:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44925f647_1739854700
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6W7T9R
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DTwrappers_v0.0.2-tikzDictionary"
