...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Damien R. Farine <dfarine@ab.mpg.de>                 |
...
Overall the package has 12 exported objects. 12 are documented:
    ...
    get_associations_points_tw    get_group_by_individual 
                          TRUE                       TRUE 
                   get_network       get_sampling_periods 
                          TRUE                       TRUE 
                     gmmevents                        LAR 
                          TRUE                       TRUE 
                           LRA          mrqap.custom.null 
                          TRUE                       TRUE 
                     mrqap.dsp        network_permutation 
                          TRUE                       TRUE 
                  network_swap            print.mrqap.dsp 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-14 07:27:40 UTC |
...
running this report
    ...
    PROCESSX_PS1c095ee9a52e_1739518057
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQRbS5E
