# Validation Report - BeviMed@5.10
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel Greene <dg333@cam.ac.uk>                      |
...
Overall the package has 19 exported objects. 19 are documented:
                                ...
                                bevimed                           bevimed_m 
                                   TRUE                                TRUE 
                     bevimed_polytomous         conditional_prob_pathogenic 
                                   TRUE                                TRUE 
                     expected_explained                 explaining_variants 
                                   TRUE                                TRUE 
    extract_conditional_prob_pathogenic          extract_expected_explained 
                                   TRUE                                TRUE 
            extract_explaining_variants             extract_gamma1_evidence 
                                   TRUE                                TRUE 
               extract_prob_association             extract_prob_pathogenic 
                                   TRUE                                TRUE 
                        gamma0_evidence                     gamma1_evidence 
                                   TRUE                                TRUE 
                                 log_BF                    prob_association 
                                   TRUE                                TRUE 
                     prob_association_m                     prob_pathogenic 
                                   TRUE                                TRUE 
                        subset_variants 
                                   TRUE 
...
| Execution Time | 2025-02-15 03:56:47 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd38e61ed_1739591802
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptMZEMP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BeviMed_v5.10-tikzDictionary"
