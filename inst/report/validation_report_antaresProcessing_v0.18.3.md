...
| size_codebase | 991 |
| has_source_control | https://github.com/rte-antares-rpackage/antaresProcessing |
...
Overall the package has 18 exported objects. 18 are documented:
         ...
         addCongestionLink      addDownwardMargin     addExportAndImport 
                      TRUE                   TRUE                   TRUE 
         addLoadFactorLink             addNetLoad        addUpwardMargin 
                      TRUE                   TRUE                   TRUE 
                   compare     externalDependency              getValues 
                      TRUE                   TRUE                   TRUE 
                loadFactor    mergeAllAntaresData             modulation 
                      TRUE                   TRUE                   TRUE 
               netLoadRamp                surplus        surplusClusters 
                      TRUE                   TRUE                   TRUE 
            surplusSectors             synthesize thermalGroupCapacities 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-14 06:56:43 UTC |
...
running this report
    ...
    PROCESSX_PS726d652a157d_1739516200
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQC98Yf
