# Validation Report - cogmapr@0.9.3
...
| export_help | 37 |
| has_website | TRUE |
| has_maintainer | Frédéric M. Vanwindekens <f.vanwindekens@cra.wallonie.be> |
...
Overall the package has 37 exported objects. 36 are documented:

                        %>%       ConceptCentrality  ConceptCentralityIndiv 
                      FALSE                    TRUE                    TRUE 
            ConceptIndegree    ConceptIndegreeIndiv       ConceptIndicators 
                       TRUE                    TRUE                    TRUE 
       ConceptIndicatorsICM       ConceptIndicIndiv     ConceptIndicSummary 
                       TRUE                    TRUE                    TRUE 
           ConceptOutdegree   ConceptOutdegreeIndiv             ConceptTest 
                       TRUE                    TRUE                    TRUE 
         ConceptTestSummary               coordCMap             data.ggCMap 
                       TRUE                    TRUE                    TRUE 
      df.quotes.scm.concept      df.quotes.scm.edge                 EdgCMap 
                       TRUE                    TRUE                    TRUE 
                 EdgIndCMap              EdgSocCMap                  ggCMap 
                       TRUE                    TRUE                    TRUE 
                  ggCMap.bg               ggCMap.hl         GraphIndicators 
                       TRUE                    TRUE                    TRUE 
         GraphIndicatorsICM    GraphIndicatorsTable                 IndCMap 
                       TRUE                    TRUE                    TRUE 
                plotIndCMap             plotSocCMap             ProjectCMap 
                       TRUE                    TRUE                    TRUE 
                 QuotesCMap           QuotesIndCMap           QuotesSocCMap 
                       TRUE                    TRUE                    TRUE 
           RelationshipTest RelationshipTestSummary           RemoveCodings 
                       TRUE                    TRUE                    TRUE 
                    SocCMap 
                       TRUE 
...
| Execution Time | 2025-02-16 04:54:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35530a6ee_1739681654
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVlK8Ki
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cogmapr_v0.9.3-tikzDictionary"
