...
| export_help          | 59                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Roman Hornung <hornung@ibe.med.uni-muenchen.de>      |
...
Overall the package has 59 exported objects. 58 are documented:
                      ...
                      aprior                  avedist               avedistTwo 
                        TRUE                     TRUE                     TRUE 
                          ba                  baaddon                 bametric 
                        TRUE                     TRUE                     TRUE 
                     bivprob                   bprior             build.design 
                        TRUE                     TRUE                     TRUE 
                    combatba            combatbaaddon                    corba 
                        TRUE                     TRUE                     TRUE 
                  design.mat                diffexprm         diffexprmAfterBR 
                        TRUE                     TRUE                     TRUE 
                          Dt              emfahighdim         extractAffybatch 
                        TRUE                     TRUE                     TRUE 
                     fabatch             fabatchaddon              fuzzywilcox 
                        TRUE                     TRUE                     TRUE 
                      it.sol                   kldist                kldistTwo 
                        TRUE                     TRUE                     TRUE 
                  list.batch               meancenter          meancenteraddon 
                        TRUE                     TRUE                     TRUE 
           mypvcaBatchAssess                nbfactors                     noba 
                        TRUE                     TRUE                     TRUE 
                   nobaaddon normalizeAffyBatchqntval          normalizeqntadd 
                        TRUE                     TRUE                     TRUE 
            normalizeqntadd2          normalizeqntval                   pcplot 
                        TRUE                     TRUE                     TRUE 
                    plotcomp                 postmean                  postvar 
                        TRUE                     TRUE                     TRUE 
                       pvcam              qunormaddon              qunormtrain 
                        TRUE                     TRUE                     TRUE 
                      ratioa              ratioaaddon                   ratiog 
                        TRUE                     TRUE                     TRUE 
                 ratiogaddon                 rmaaddon                 rmatrain 
                        TRUE                     TRUE                     TRUE 
                    sepscore              sepscoreTwo                  skewdiv 
                        TRUE                     TRUE                     TRUE 
                  skewdivTwo              standardize         standardizeaddon 
                        TRUE                     TRUE                     TRUE 
               summarizeadd2            summarizeval2                    svaba 
                       FALSE                     TRUE                     TRUE 
                  svabaaddon             VarInflation 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-14 07:42:30 UTC |
...
running this report
    ...
    PROCESSX_PS1c09413054a8_1739518947
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkO1RP4
