# Validation Report - bigergm@1.2.4
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Cornelius Fritz <corneliusfritz2010@gmail.com>       |
...
|     | package                    | type      |
|:----|:---------------------------|:----------|
| 1   | ergm (\>= 4.5.0)           | Depends   |
| 2   | Rcpp                       | Depends   |
| 3   | Rcpp                       | LinkingTo |
| 4   | RcppArmadillo (\>= 0.10.5) | LinkingTo |
| 5   | RcppArmadillo (\>= 0.10.5) | Imports   |
| 6   | network (\>= 1.16.0)       | Imports   |
| 7   | Matrix                     | Imports   |
| 8   | cachem                     | Imports   |
| 9   | tidyr                      | Imports   |
| 10  | statnet.common             | Imports   |
| 11  | methods                    | Imports   |
| 12  | stringr                    | Imports   |
| 13  | intergraph                 | Imports   |
| 14  | igraph                     | Imports   |
| 15  | parallel                   | Imports   |
| 16  | magrittr                   | Imports   |
| 17  | purrr                      | Imports   |
...
| 22  | rlang                      | Imports   |
| 23  | memoise                    | Imports   |
| 24  | reticulate                 | Imports   |
| 25  | ergm.multi                 | Imports   |
...
Overall the package has 9 exported objects. 9 are documented:
                     ...
                     ari              bigergm          est_between 
                    TRUE                 TRUE                 TRUE 
              est_within get_between_networks  get_within_networks 
                    TRUE                 TRUE                 TRUE 
                  py_dep     simulate_bigergm                 yule 
                    TRUE                 TRUE                 TRUE 

### Examples

There are 13 help pages with examples, from 18 (72.22 %).
...
| Execution Time | 2025-02-25 03:20:34 UTC |
...
running this report
    ...
    PROCESSX_PS1d2874d157bc_1740453630
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpANQCG8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigergm_v1.2.4-tikzDictionary"
