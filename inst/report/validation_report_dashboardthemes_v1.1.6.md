# Validation Report - dashboardthemes@1.1.6
...
| export_help          | 19                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Nik Lilovski <nik.lilovski@outlook.com>     |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/nik01010/dashboardthemes |
...
Overall the package has 19 exported objects. 19 are documented:
    ...
    cssGradientThreeColors     logo_blue_gradient          logo_flat_red 
                      TRUE                   TRUE                   TRUE 
            logo_grey_dark        logo_grey_light           logo_onenote 
                      TRUE                   TRUE                   TRUE 
     logo_poor_mans_flatly   logo_purple_gradient     shinyDashboardLogo 
                      TRUE                   TRUE                   TRUE 
     shinyDashboardLogoDIY shinyDashboardThemeDIY   shinyDashboardThemes 
                      TRUE                   TRUE                   TRUE 
       theme_blue_gradient         theme_flat_red        theme_grey_dark 
                      TRUE                   TRUE                   TRUE 
          theme_grey_light          theme_onenote theme_poor_mans_flatly 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-17 04:55:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63b1d140a_1739768116
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuYtG6a
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dashboardthemes_v1.1.6-tikzDictionary"
