...
| export_help          | 9                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Luca Carraro <luca.carraro@hotmail.it> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/lucarraro/eDITH     |
...
| 2   | OCNet (\>= 1.1.0)  | Imports   |
| 3   | rivnet (\>= 0.4.2) | Imports   |
| 4   | BayesianTools      | Imports   |
| 5   | LaplacesDemon      | Imports   |
| 6   | DHARMa             | Imports   |
| 7   | terra              | Imports   |
| 8   | fields             | Imports   |
| 9   | Rcpp               | LinkingTo |
...
Overall the package has 9 exported objects. 9 are documented:
        ...
        eval_posterior_eDITH posterior_pred_sim_eDITH             run_eDITH_BT 
                        TRUE                     TRUE                     TRUE 
          run_eDITH_BT_joint          run_eDITH_optim    run_eDITH_optim_joint 
                        TRUE                     TRUE                     TRUE 
            run_eDITH_single sampling_strategy_direct   sampling_strategy_eDNA 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-19 03:42:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d451c2d074a_1739936520
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3h4yxh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eDITH_v1.0.0-tikzDictionary"
