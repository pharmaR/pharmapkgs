# Validation Report - bayesassurance@0.1.0
...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Jane Pan <jpan1@ucla.edu>                            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/jpan928/bayesassurance_rpackage   |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | ggplot2 (\>= 3.3.5)  | Imports |
| 2   | plotly (\>= 4.10.0)  | Imports |
| 3   | plot3D (\>= 1.4)     | Imports |
| 4   | pbapply (\>= 1.5.0)  | Imports |
| 5   | dplyr (\>= 1.0.8)    | Imports |
| 6   | MASS (\>= 7.3.55)    | Imports |
| 7   | rlang (\>= 1.0.2)    | Imports |
| 8   | stats (\>= 4.0.5)    | Imports |
| 9   | mathjaxr (\>= 1.5.2) | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
         ...
         assurance_nd_na         bayes_adcock      bayes_goal_func 
                    TRUE                 TRUE                 TRUE 
               bayes_sim    bayes_sim_betabin bayes_sim_unbalanced 
                    TRUE                 TRUE                 TRUE 
    bayes_sim_unknownvar               gen_Xn  gen_Xn_longitudinal 
                    TRUE                 TRUE                 TRUE 
               pwr_curve             pwr_freq 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 03:31:45 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd47e36edf_1739590300
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHUdayy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesassurance_v0.1.0-tikzDictionary"
