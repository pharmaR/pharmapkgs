# Validation Report - exampletestr@1.7.3
...
| has_source_control   | https://github.com/rorynolan/exampletestr#readme |
...
| 6   | rlang (\>= 0.4)      | Imports |
| 7   | roxygen2             | Imports |
| 8   | rstudioapi (\>= 0.4) | Imports |
| 9   | strex (\>= 1.4.2)    | Imports |
| 10  | stringr (\>= 1.5)    | Imports |
| 11  | styler (\>= 1.2)     | Imports |
| 12  | usethis (\>= 2.0)    | Imports |
| 13  | withr (\>= 2.1)      | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
       ...
       make_test_shell_fun make_tests_shells_file  make_tests_shells_pkg 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-19 04:47:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d45727770dc_1739940427
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2nvko3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exampletestr_v1.7.3-tikzDictionary"
