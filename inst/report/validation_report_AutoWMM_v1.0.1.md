...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mallory J Flynn <mallory.flynn@stat.ubc.ca>          |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 518                                                  |
| has_source_control   | https://github.com/malfly/AutoWMM                    |
...
Overall the package has 14 exported objects. 14 are documented:
        ...
        confInts    countTree     drawTree      estTree   ko.weights logEstimates 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        makeTree   mmEstimate        Nhats root.confInt   sampleBeta  ss.confInts 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      ssEstimate      wmmTree 
            TRUE         TRUE 
...
| Execution Time | 2025-02-14 07:35:21 UTC |
...
running this report
    ...
    PROCESSX_PS1c09231e8319_1739518518
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqxWVTp
