...
| export_help          | 27                                |
| has_website          | TRUE                              |
| has_maintainer       | Hong Zhang <mt1022.dev@gmail.com> |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/mt1022/cubar   |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | Biostrings (\>= 2.60.0) | Imports |
| 2   | IRanges (\>= 2.34.0)    | Imports |
| 3   | data.table (\>= 1.14.0) | Imports |
| 4   | ggplot2 (\>= 3.3.5)     | Imports |
| 5   | rlang (\>= 0.4.11)      | Imports |
...
Overall the package has 27 exported objects. 27 are documented:
             ...
             check_cds         codon_diff     codon_optimize       count_codons 
                  TRUE               TRUE               TRUE               TRUE 
    create_codon_table            est_csc est_optimal_codons           est_rscu 
                  TRUE               TRUE               TRUE               TRUE 
       est_trna_weight            get_cai    get_codon_table           get_cscg 
                  TRUE               TRUE               TRUE               TRUE 
                get_dp            get_enc            get_fop             get_gc 
                  TRUE               TRUE               TRUE               TRUE 
              get_gc3s           get_gc4d            get_tai    plot_ca_pairing 
                  TRUE               TRUE               TRUE               TRUE 
              rev_comp      seq_to_codons  show_codon_tables              slide 
                  TRUE               TRUE               TRUE               TRUE 
           slide_apply        slide_codon         slide_plot 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:37:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bd646a6fb54_1739767033
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5jLYmR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cubar_v1.1.0-tikzDictionary"
