# Validation Report - cppdoubles@0.3.0
...
Overall the package has 13 exported objects. 8 are documented:

            %~<%        %~<=%        %~==%         %~>%        %~>=%     abs_diff 
           FALSE        FALSE        FALSE        FALSE        FALSE         TRUE 
       all_equal double_equal    double_gt   double_gte    double_lt   double_lte 
...
| Execution Time | 2025-02-17 04:15:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bd613946cd_1739765713
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbqRHGv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cppdoubles_v0.3.0-tikzDictionary"
