# Validation Report - bigMap@2.3.1
...
| 2   | bigmemory (\>= 4.5.0) | Imports   |
| 3   | parallel (\>= 3.5.0)  | Imports   |
| 4   | RColorBrewer          | Imports   |
| 5   | colorspace            | Imports   |
| 6   | Rcpp                  | LinkingTo |
| 7   | RcppArmadillo         | LinkingTo |
| 8   | BH                    | LinkingTo |
| 9   | bigmemory             | LinkingTo |
...
| Execution Time | 2025-02-15 04:04:16 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1a7113f1_1739592252
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWpnLIB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigMap_v2.3.1-tikzDictionary"
