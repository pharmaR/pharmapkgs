# Validation Report - Blend@0.1.1.1
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Kun Fan <kfan@ksu.edu>                               |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/kunfa/Blend                       |
...
Overall the package has 4 exported objects. 4 are documented:
         ...
         Blend   Coverage plot_Blend  selection 
          TRUE       TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-15 04:21:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4f03c243_1739593313
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaWkUqq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Blend_v0.1.1.1-tikzDictionary"
