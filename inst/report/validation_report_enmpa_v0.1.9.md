...
| export_help          | 31                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Luis F. Arias-Giraldo <lfarias.giraldo@gmail.com> |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/Luisagi/enmpa                  |
...
Overall the package has 31 exported objects. 31 are documented:
                 ...
                 aux_string_comb                 aux_var_comb 
                            TRUE                         TRUE 
                 calibration_glm             evaluation_stats 
                            TRUE                         TRUE 
                        fit_glms                 fit_selected 
                            TRUE                         TRUE 
                    get_formulas            get_formulas_main 
                            TRUE                         TRUE 
              independent_eval01            independent_eval1 
                            TRUE                         TRUE 
                       jackknife              kfold_partition 
                            TRUE                         TRUE 
                 model_selection             model_validation 
                            TRUE                         TRUE 
           new_enmpa_calibration      new_enmpa_fitted_models 
                            TRUE                         TRUE 
                    niche_signal       niche_signal_permanova 
                            TRUE                         TRUE 
         niche_signal_univariate             optimize_metrics 
                            TRUE                         TRUE 
                 plot_importance                      plot_jk 
                            TRUE                         TRUE 
               plot_niche_signal  plot_niche_signal_permanova 
                            TRUE                         TRUE 
    plot_niche_signal_univariate                  predict_glm 
                            TRUE                         TRUE 
                predict_selected                     proc_enm 
                            TRUE                         TRUE 
                        resp2var               response_curve 
                            TRUE                         TRUE 
                  var_importance 
                            TRUE 
...
| Execution Time | 2025-02-19 04:08:26 UTC |
...
running this report
    ...
    PROCESSX_PS1d4547c7570d_1739938100
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2dZrxd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_enmpa_v0.1.9-tikzDictionary"
