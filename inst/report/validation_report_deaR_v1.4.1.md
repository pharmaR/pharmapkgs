...
| export_help          | 42                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Vicente Bolos <vicente.bolos@uv.es>                  |
...
Overall the package has 42 exported objects. 42 are documented:
             ...
             bootstrap_basic         cross_efficiency   cross_efficiency_fuzzy 
                        TRUE                     TRUE                     TRUE 
                    eff_dmus             efficiencies        extreme_efficient 
                        TRUE                     TRUE                     TRUE 
                      is.dea             is.dea_fuzzy               is.deadata 
                        TRUE                     TRUE                     TRUE 
            is.deadata_fuzzy               is.friends                  lambdas 
                        TRUE                     TRUE                     TRUE 
                make_deadata       make_deadata_fuzzy           make_malmquist 
                        TRUE                     TRUE                     TRUE 
             malmquist_index          maximal_friends           model_additive 
                        TRUE                     TRUE                     TRUE 
                model_addmin        model_addsupereff              model_basic 
                        TRUE                     TRUE                     TRUE 
                 model_deaps                model_fdh         model_multiplier 
                        TRUE                     TRUE                     TRUE 
             model_nonradial             model_profit                model_rdm 
                        TRUE                     TRUE                     TRUE 
                model_sbmeff        model_sbmsupereff           model_supereff 
                        TRUE                     TRUE                     TRUE 
        modelfuzzy_guotanaka        modelfuzzy_kaoliu modelfuzzy_possibilistic 
                        TRUE                     TRUE                     TRUE 
                 multipliers                read_data          read_data_fuzzy 
                        TRUE                     TRUE                     TRUE 
              read_malmquist               references                      rts 
                        TRUE                     TRUE                     TRUE 
                      slacks                  targets        undesirable_basic 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-18 03:30:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45d6cac31_1739849447
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcCE3cb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deaR_v1.4.1-tikzDictionary"
