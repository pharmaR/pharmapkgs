...
| export_help          | 43                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Antony M. Overstall <A.M.Overstall@soton.ac.uk>      |
...
|:----|:--------------------------------|:----------|
| 1   | lhs                             | Depends   |
| 2   | Rcpp (\>= 0.12.9)               | Imports   |
| 3   | compare                         | Imports   |
| 4   | randtoolbox                     | Imports   |
| 5   | parallel                        | Imports   |
| 6   | Rcpp                            | LinkingTo |
| 7   | RcppArmadillo (\>= 0.9.100.5.0) | LinkingTo |
...
Overall the package has 43 exported objects. 43 are documented:
                   ...
                   ace             aceglm             acenlm          acephase1 
                  TRUE               TRUE               TRUE               TRUE 
             acephase2             assess      inideshlrnsel       inideshlrsig 
                  TRUE               TRUE               TRUE               TRUE 
          inideslrnsel        inideslrsig       optdesbeetle    optdescomp15bad 
                  TRUE               TRUE               TRUE               TRUE 
       optdescomp15sig optdescomp15sigDRS    optdescomp18bad       optdeshlrbaa 
                  TRUE               TRUE               TRUE               TRUE 
          optdeshlrbad      optdeshlrnsel       optdeshlrsig       optdeslinmod 
                  TRUE               TRUE               TRUE               TRUE 
           optdeslrbaa        optdeslrbad       optdeslrnsel        optdeslrsig 
                  TRUE               TRUE               TRUE               TRUE 
                  pace            paceglm            pacenlm         utilbeetle 
                  TRUE               TRUE               TRUE               TRUE 
         utilcomp15bad      utilcomp15sig   utilcomp15sigDRS      utilcomp18bad 
                  TRUE               TRUE               TRUE               TRUE 
            utilhlrbaa         utilhlrbad        utilhlrnsel         utilhlrsig 
                  TRUE               TRUE               TRUE               TRUE 
            utilityglm         utilitynlm         utillinmod          utillrbaa 
                  TRUE               TRUE               TRUE               TRUE 
             utillrbad         utillrnsel          utillrsig 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-14 06:31:28 UTC |
...
running this report
    ...
    PROCESSX_PS726d64d7a0f4_1739514686
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphmGJjW
