# Validation Report - bmgarch@2.0.0
...
| 10  | BH (\>= 1.72.0-0)         | LinkingTo |
| 11  | Rcpp (\>= 1.0.5)          | LinkingTo |
| 12  | RcppParallel (\>= 5.0.1)  | LinkingTo |
| 13  | RcppEigen (\>= 0.3.3.7.0) | LinkingTo |
| 14  | RcppParallel (\>= 5.0.1)  | LinkingTo |
| 15  | rstan (\>= 2.26.0)        | LinkingTo |
| 16  | StanHeaders (\>= 2.26.0)  | LinkingTo |
...
Overall the package has 5 exported objects. 5 are documented:
          ...
          bmgarch  bmgarch_list      forecast           loo model_weights 
...
| Execution Time | 2025-02-15 04:26:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3014dd85_1739593592
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRdGk0x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bmgarch_v2.0.0-tikzDictionary"
