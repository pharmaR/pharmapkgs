# Validation Report - depmixS4@1.5.0
...
hmmr, InPAS, ldhmm, partCNV, plotHMM, segclust2d, tLOH

## Namespace

Overall the package has 12 exported objects. 42 are documented:

             em  em.control          fb     llratio      logLik      lystig 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
     makeDepmix     makeMix      mlogit multinomial  stationary     viterbi 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 

### Examples

There are 23 help pages with examples, from 30 (76.67 %).
...
| Execution Time | 2025-02-18 03:44:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44423dc3_1739850263
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzyXOEk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_depmixS4_v1.5.0-tikzDictionary"
