# Validation Report - DSLite@1.4.0
...
| has_source_control   | https://github.com/datashield/DSLite/     |
...
dsTidyverse, dsTidyverseClient

## Namespace

Overall the package has 19 exported objects. 19 are documented:

    defaultDSConfiguration                 DSLite           DSLiteServer 
                      TRUE                   TRUE                   TRUE 
              FunctionNode          getDSLiteData              GroupNode 
                      TRUE                   TRUE                   TRUE 
           newDSLiteServer                   Node            NumericNode 
                      TRUE                   TRUE                   TRUE 
            setupCNSIMTest         setupDASIMTest       setupDATASETTest 
                      TRUE                   TRUE                   TRUE 
       setupDISCORDANTTest      setupDSLiteServer      setupSURVIVALTest 
                      TRUE                   TRUE                   TRUE 
                StringNode             SymbolNode              testParse 
                      TRUE                   TRUE                   TRUE 
               UnaryOpNode 
                      TRUE 
...
There are 35 help pages with examples, from 70 (50.00 %).
...
| Execution Time | 2025-02-18 04:51:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4345e41ad_1739854291
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbD0rjB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DSLite_v1.4.0-tikzDictionary"
