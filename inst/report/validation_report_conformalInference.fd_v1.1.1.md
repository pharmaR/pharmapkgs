# Validation Report - conformalInference.fd@1.1.1
...
|:----|:-------------------------|:--------|
| 1   | fda (\>= 5.5.1)          | Imports |
| 2   | future (\>= 1.23.0)      | Imports |
| 3   | future.apply (\>= 1.8.1) | Imports |
| 4   | ggplot2 (\>= 3.3.5)      | Imports |
| 5   | stats                    | Imports |
| 6   | utils                    | Imports |
| 7   | methods                  | Imports |
| 8   | ggnewscale               | Imports |
| 9   | ggpubr                   | Imports |
| 10  | scales                   | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    computing_s_regression             concurrent conformal.fun.jackplus 
                      TRUE                   TRUE                   TRUE 
      conformal.fun.msplit    conformal.fun.split             mean_lists 
                      TRUE                   TRUE                   TRUE 
                  plot_fun 
                      TRUE 
...
| Execution Time | 2025-02-17 03:43:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67588c5e6_1739763830
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuJlrIM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conformalInference.fd_v1.1.1-tikzDictionary"
