# Validation Report - bootPLS@1.0.1
...
| export_help          | 15                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Frederic Bertrand <frederic.bertrand@utt.fr> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/fbertran/bootPLS/         |
...
Overall the package has 15 exported objects. 15 are documented:
    ...
    coefs.plsR.adapt.ncomp        coefs.plsR.CSim     coefs.plsRglm.CSim 
                      TRUE                   TRUE                   TRUE 
          coefs.sgpls.CSim        nbcomp.bootplsR     nbcomp.bootplsRglm 
                      TRUE                   TRUE                   TRUE 
          nbcomp.bootsgpls  nbcomp.bootsgpls.para        nbcomp.bootspls 
                      TRUE                   TRUE                   TRUE 
      nbcomp.bootspls.para    permcoefs.plsR.CSim permcoefs.plsRglm.CSim 
                      TRUE                   TRUE                   TRUE 
      permcoefs.sgpls.CSim              signpred2 simul_data_UniYX_gamma 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:34:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4a041594_1739594049
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp76M7sr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bootPLS_v1.0.1-tikzDictionary"
