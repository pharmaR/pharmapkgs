# Validation Report - BifactorIndicesCalculator@0.2.2
...
| export_help          | 17                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | David Dueber <david.dueber@uky.edu>                  |
| bugs_status          | subscript out of bounds                              |
| has_source_control   | https://github.com/ddueber/BifactorIndicesCalculator |
...
Overall the package has 17 exported objects. 17 are documented:
                         ...
                         ARPB           bifactorIndices      bifactorIndices_expl 
                         TRUE                      TRUE                      TRUE 
         bifactorIndicesMplus bifactorIndicesMplus_ESEM bifactorIndicesMplus_expl 
                         TRUE                      TRUE                      TRUE 
                  cat_Omega_H               cat_Omega_S                    ECV_GS 
                         TRUE                      TRUE                      TRUE 
                       ECV_SG                    ECV_SS                        FD 
                         TRUE                      TRUE                      TRUE 
                            H                      IECV                   Omega_H 
...
| Execution Time | 2025-02-15 04:02:29 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdc601a41_1739592144
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSwmATq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BifactorIndicesCalculator_v0.2.2-tikzDictionary"
