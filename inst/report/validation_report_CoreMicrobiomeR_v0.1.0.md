# Validation Report - CoreMicrobiomeR@0.1.0
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Mohammad Samir Farooqi <samirfarooqi8@gmail.com>     |
...
Overall the package has 5 exported objects. 5 are documented:
       ...
       CoreMicrobiome   group_bar_plots      significance stacked_bar_plots 
                 TRUE              TRUE              TRUE              TRUE 
            visualize 
                 TRUE 
...
| Execution Time | 2025-02-17 03:57:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65651afed_1739764636
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfoBwYr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CoreMicrobiomeR_v0.1.0-tikzDictionary"
