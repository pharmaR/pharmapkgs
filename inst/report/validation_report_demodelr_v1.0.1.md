# Validation Report - demodelr@1.0.1
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | John Zobitz <zobitz@augsburg.edu>                    |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    compute_likelihood        eigenvalues              euler   euler_stochastic 
                  TRUE               TRUE               TRUE               TRUE 
          mcmc_analyze      mcmc_estimate         phaseplane                rk4 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 03:39:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb431de8baa_1739849967
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4Ju2wF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_demodelr_v1.0.1-tikzDictionary"
