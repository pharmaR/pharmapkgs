# Validation Report - boinet@1.1.0
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yusuke Yamaguchi <yamagubed@gmail.com>               |
...
Overall the package has 11 exported objects. 11 are documented:
                      ...
                      boinet                 fp.logit                  gboinet 
                        TRUE                     TRUE                     TRUE 
                   gridoptim                multi.iso               obd.select 
                        TRUE                     TRUE                     TRUE 
                 tite.boinet             tite.gboinet          utility.scoring 
                        TRUE                     TRUE                     TRUE 
    utility.truncated.linear         utility.weighted 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-15 04:30:39 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd104f1bc6_1739593834
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBVuV8f
...
These are the options set to generate the report:
    ...
    [1] "validation_report_boinet_v1.1.0-tikzDictionary"
