# Validation Report - DVHmetrics@0.4.2
...
| export_help          | 22                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Daniel Wollschlaeger <wollschlaeger@uni-mainz.de>    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/dwoll/DVHmetrics/                 |
...
Overall the package has 22 exported objects. 22 are documented:
     ...
     checkConstraint       convertDVH convertDVHsmooth           getBED 
                TRUE             TRUE             TRUE             TRUE 
            getDMEAN          getEQD2           getEUD       getIsoEffD 
                TRUE             TRUE             TRUE             TRUE 
          getMeanDVH        getMetric          getNTCP           getTCP 
                TRUE             TRUE             TRUE             TRUE 
            mergeDVH   readConstraint          readDVH           runGUI 
                TRUE             TRUE             TRUE             TRUE 
      saveConstraint          saveDVH       saveMetric   showConstraint 
                TRUE             TRUE             TRUE             TRUE 
             showDVH      showMeanDVH 
                TRUE             TRUE 
...
| Execution Time | 2025-02-18 05:01:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44ec1849b_1739854864
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5GG6IJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DVHmetrics_v0.4.2-tikzDictionary"
