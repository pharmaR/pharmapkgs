# Validation Report - BB@2019.10.1
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Paul Gilbert <pgilbert.ttv9z@ncf.ca>                 |
...
aftgee, antitrust, bayNorm, BinNonNor, BinOrdNonNor, bunching, calibrar,
CatDyn, combi, coxrt, cxr, dQTG.seq, DSBayes, flexFitR, glinvci, GNE,
ktsolve, LifeHist, maczic, mederrRank, metafor, mixAR, mlfit, mlt,
momentuHMM, mvord, NPCD, optimx, orsk, pcts, pim, PoisBinNonNor,
PoisBinOrdNonNor, PoisNonNor, reReg, RobPer, ROI.plugin.optimx, RPANDA,
SemiEstimate, SimCorrMix, SimMultiCorrData, simsurv, spef, trade

## Namespace

Overall the package has 7 exported objects. 7 are documented:

          BBoptim       BBsolve        dfsane    multiStart projectLinear 
...
| Execution Time | 2025-02-22 03:14:30 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb42db5042_1740194066
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpg9zzn7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BB_v2019.10.1-tikzDictionary"
