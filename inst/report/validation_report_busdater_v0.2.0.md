# Validation Report - busdater@0.2.0
...
| export_help          | 4                                             |
| has_website          | TRUE                                          |
| has_maintainer       | Mick Mioduszewski <mick@mioduszewski.net>     |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/mickmioduszewski/busdater/ |
...
Overall the package has 4 exported objects. 4 are documented:
                   ...
                   FY      get_boundary            get_fy period_boundaries 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:56:23 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd344db870_1739595378
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiBQ03v
...
These are the options set to generate the report:
    ...
    [1] "validation_report_busdater_v0.2.0-tikzDictionary"
