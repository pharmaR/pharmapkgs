...
| export_help          | 25                               |
| has_website          | TRUE                             |
| has_maintainer       | Luis Torgo <ltorgo@dcc.fc.up.pt> |
| bugs_status          | subscript out of bounds          |
| has_source_control   | https://github.com/ltorgo/DMwR2  |
...
| 5   | class (\>= 7.3-14)   | Imports |
| 6   | rpart (\>= 4.1-10)   | Imports |
| 7   | quantmod (\>= 0.4-5) | Imports |
| 8   | dplyr (\>= 0.4.3)    | Imports |
| 9   | readr (\>= 1.0.0)    | Imports |
| 10  | DBI (\>= 0.5)        | Imports |
...
Overall the package has 22 exported objects. 20 are documented:

                  .Eq               .St centralImputation      centralValue 
                FALSE             FALSE              TRUE              TRUE 
        createEmbedDS               kNN     knnImputation          lofactor 
                 TRUE              TRUE              TRUE              TRUE 
              manyNAs       nrLinesFile  outliers.ranking          rpartXse 
                 TRUE              TRUE              TRUE              TRUE 
             rt.prune         sampleCSV        sampleDBMS         SelfTrain 
                 TRUE              TRUE              TRUE              TRUE 
              sigs.PR           SoftMax       tradeRecord   trading.signals 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:28:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4248e0d6c_1739852913
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSh8JCq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DMwR2_v0.0.2-tikzDictionary"
