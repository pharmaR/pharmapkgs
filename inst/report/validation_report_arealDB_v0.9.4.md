...
| export_help          | 20                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Steffen Ehrmann <steffen.ehrmann@posteo.de> |
| bugs_status          | subscript out of bounds                     |
| size_codebase        | 2759                                        |
| has_source_control   | https://github.com/luckinet/arealDB         |
...
Overall the package has 20 exported objects. 20 are documented:
        ...
        .editMatches   .matchOntology  .updateOntology      adb_archive 
                TRUE             TRUE             TRUE             TRUE 
          adb_backup     adb_diagnose      adb_example         adb_init 
                TRUE             TRUE             TRUE             TRUE 
       adb_inventory     adb_ontology       adb_querry        adb_reset 
                TRUE             TRUE             TRUE             TRUE 
         adb_restore      adb_schemas adb_translations     normGeometry 
                TRUE             TRUE             TRUE             TRUE 
           normTable    regDataseries      regGeometry         regTable 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-14 07:22:41 UTC |
...
running this report
    ...
    PROCESSX_PS1c0955e8650a_1739517758
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0uWeTF
