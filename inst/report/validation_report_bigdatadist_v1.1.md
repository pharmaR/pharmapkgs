# Validation Report - bigdatadist@1.1
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Gabriel Martos <gmartos@utdt.edu>                    |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         entropy   entropy.fd      fdframe      gmdepth   gmdepth.fd   kmdepth.fd 
...
| Execution Time | 2025-02-15 04:03:22 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd494903bb_1739592198
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb9gKYB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigdatadist_v1.1-tikzDictionary"
