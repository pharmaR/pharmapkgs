# Validation Report - bisectr@0.1.0
...
| has_source_control   | https://github.com/wch/bisectr                       |
...
Overall the package has 6 exported objects. 6 are documented:
               ...
               bisect_install           bisect_load_all            bisect_require 
                         TRUE                      TRUE                      TRUE 
    bisect_return_interactive            bisect_runtest             bisect_source 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-15 04:17:49 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3cc9cc3_1739593064
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgLwQcz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bisectr_v0.1.0-tikzDictionary"
