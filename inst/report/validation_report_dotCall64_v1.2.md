# Validation Report - dotCall64@1.2
...
| export_help | 4 |
| has_website | TRUE |
| has_maintainer | Reinhard Furrer <reinhard.furrer@uzh.ch> |
| bugs_status | scraping bug reports fromm BugReports host ‘uzh’ not implemented |
| has_bug_reports_url | 1 |
| downloads_1yr | 699476 |
...
fastkqr, GeoModels, spam, sparsegl, vein

## Namespace

Overall the package has 4 exported objects. 4 are documented:

          .C64 integer_dc numeric_dc  vector_dc 
          TRUE       TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-18 04:36:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46862c34f_1739853386
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpuitrnv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dotCall64_v1.2-tikzDictionary"
