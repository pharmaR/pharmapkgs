# Validation Report - ConcordanceTest@1.0.3
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Laura Anton-Sanchez <l.anton@umh.es>                 |
...
Overall the package has 8 exported objects. 8 are documented:
                  ...
                  CT_Coefficient           CT_Critical_Values 
                            TRUE                         TRUE 
                 CT_Density_Plot              CT_Distribution 
                            TRUE                         TRUE 
              CT_Hypothesis_Test          CT_Probability_Plot 
                            TRUE                         TRUE 
                             LOP Permutations_With_Repetition 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-17 03:39:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6518da3b8_1739763580
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptI7VRn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ConcordanceTest_v1.0.3-tikzDictionary"
