...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Johannes Titz <johannes.titz@gmail.com>              |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/johannes-titz/cofad               |
...
Overall the package has 9 exported objects. 8 are documented:

                         %>%            calc_contrast calc_contrast_aggregated 
                       FALSE                     TRUE                     TRUE 
             calc_r_alerting   calc_r_alerting_from_f          calc_r_contrast 
                        TRUE                     TRUE                     TRUE 
           calc_r_effectsize              lambda_diff                  run_app 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-16 04:53:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bc348611326_1739681612
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQpb6Ve
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cofad_v0.3.2-tikzDictionary"
