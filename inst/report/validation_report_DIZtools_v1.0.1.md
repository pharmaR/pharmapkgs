# Validation Report - DIZtools@1.0.1
...
| export_help          | 34                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Jonathan M. Mang <jonathan.mang@uk-erlangen.de> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/miracum/misc-diztools        |
...
DIZutils, DQAgui, DQAstats

## Namespace

Overall the package has 34 exported objects. 33 are documented:

                    %notin%         assign_to_R_env    check_if_unique_rows 
                      FALSE                    TRUE                    TRUE 
            clean_path_name     cleanup_old_logfile                   clear 
                       TRUE                    TRUE                    TRUE 
      close_all_connections        dt_row_to_string                 equals2 
                       TRUE                    TRUE                    TRUE 
                   feedback      file_lines_to_list                 firstup 
                       TRUE                    TRUE                    TRUE 
             format_posixct              get_config   get_current_timestamp 
                       TRUE                    TRUE                    TRUE 
             is_date_format                is.empty log_get_current_options 
                       TRUE                    TRUE                    TRUE 
    log_get_default_options      log_remove_options        log_set_defaults 
                       TRUE                    TRUE                    TRUE 
         number_to_position           paste_pct_sum                  paste2 
                       TRUE                    TRUE                    TRUE 
           pretty_timestamp                    rep2            robust_round 
                       TRUE                    TRUE                    TRUE 
                setdiff_all             setenv_file                 setenv2 
                       TRUE                    TRUE                    TRUE 
        string_replacements         time_diff_print              trim.space 
                       TRUE                    TRUE                    TRUE 
                      vgsub 
                       TRUE 
...
| Execution Time | 2025-02-18 04:24:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45a3c9cb5_1739852652
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnWrUAb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DIZtools_v1.0.1-tikzDictionary"
