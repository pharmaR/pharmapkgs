# Validation Report - ETLUtils@1.5
...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Jan Wijffels <jwijffels@bnosac.be>                   |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/jwijffels/ETLUtils                |
...
Overall the package has 11 exported objects. 11 are documented:
          ...
          factorise      matchmerge   naLOCFPlusone   read.dbi.ffdf  read.jdbc.ffdf 
               TRUE            TRUE            TRUE            TRUE            TRUE 
     read.odbc.ffdf         recoder   renameColumns  write.dbi.ffdf write.jdbc.ffdf 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    write.odbc.ffdf 
               TRUE 
...
| Execution Time | 2025-02-19 04:34:28 UTC |
...
running this report
    ...
    PROCESSX_PS1d4510a20c_1739939661
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppSWZH4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ETLUtils_v1.5-tikzDictionary"
