...
Overall the package has 27 exported objects. 27 are documented:
                      ...
                      belief               beliefList             chooseModels 
                        TRUE                     TRUE                     TRUE 
               chooseOptimal                 crossval                  DEprobs 
                        TRUE                     TRUE                     TRUE 
         determinant.numeric                    getDF                   getGIC 
                        TRUE                     TRUE                     TRUE 
           getModelStructure        init.model.params init.model.params.knowns 
                        TRUE                     TRUE                     TRUE 
        loglikelihood.mModel                      map               mModelList 
                        TRUE                     TRUE                     TRUE 
                 plot.mModel          plot.mModelList                  plotGIC 
                        TRUE                     TRUE                     TRUE 
              predict.mModel           semisupervised       semisupervisedList 
                        TRUE                     TRUE                     TRUE 
                simulateData                     soft                 softList 
                        TRUE                     TRUE                     TRUE 
                  supervised             unsupervised         unsupervisedList 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-15 03:59:05 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6d19cf2_1739591940
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXZM6T2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bgmm_v1.8.5-tikzDictionary"
