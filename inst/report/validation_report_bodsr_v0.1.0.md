...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Francesca Bryden <francesca.bryden@dft.gov.uk>       |
...
Overall the package has 7 exported objects. 7 are documented:
        ...
        get_fares_metadata      get_location_gtfs       get_location_xml 
                      TRUE                   TRUE                   TRUE 
        get_timetable_data get_timetable_metadata             noc_lookup 
                      TRUE                   TRUE                   TRUE 
          xml_file_counter 
                      TRUE 
...
| Execution Time | 2025-02-15 04:30:05 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5357c3a5_1739593800
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbbCo27
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bodsr_v0.1.0-tikzDictionary"
