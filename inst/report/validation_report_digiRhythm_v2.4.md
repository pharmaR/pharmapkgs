# Validation Report - digiRhythm@2.4
...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Hassan-Roland Nasser <hassan.nasser@me.com>          |
...
Overall the package has 14 exported objects. 14 are documented:
                        ...
                        actogram     daily_activity_wrap_plot 
                            TRUE                         TRUE 
          daily_average_activity                  df_act_info 
                            TRUE                         TRUE 
                             dfc              dgm_periodicity 
                            TRUE                         TRUE 
                      diurnality       diurnality_customTimes 
                            TRUE                         TRUE 
    highest_possible_harm_cutoff     import_raw_activity_data 
                            TRUE                         TRUE 
                 is_dgm_friendly     lomb_scargle_periodogram 
                            TRUE                         TRUE 
        remove_activity_outliers                 resample_dgm 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-18 04:06:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb448e3e6cf_1739851559
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpH73Xwz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_digiRhythm_v2.4-tikzDictionary"
