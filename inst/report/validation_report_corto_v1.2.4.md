...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Federico M. Giorgi <federico.giorgi@gmail.com>       |
...
Overall the package has 22 exported objects. 22 are documented:
      ...
      barplot2      corto    fisherp       gsea      gsea2  kmgformat        mra 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
       mraplot        p2r        p2z  plot_gsea plot_gsea2        r2p    scatter 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
        scinot      slice     ssgsea   stouffer  textrepel    val2col  wstouffer 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
           z2p 
          TRUE 
...
| Execution Time | 2025-02-17 04:02:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6646e1a9b_1739764928
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJGipgR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corto_v1.2.4-tikzDictionary"
