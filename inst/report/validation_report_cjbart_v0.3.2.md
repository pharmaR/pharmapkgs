# Validation Report - cjbart@0.3.2
...
| export_help          | 7                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Thomas Robinson <ts.robinson1994@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/tsrobinson/cjbart        |
...
| 4   | tidyr                       | Imports |
| 5   | ggplot2                     | Imports |
| 6   | randomForestSRC (\>= 3.2.2) | Imports |
| 7   | Rdpack                      | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
        ...
        AMCE   cjbart het_vimp     IMCE    pIMCE  rf_vimp     RMCE 
...
| Execution Time | 2025-02-16 04:24:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36d91d602_1739679873
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpe6wAX9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cjbart_v0.3.2-tikzDictionary"
