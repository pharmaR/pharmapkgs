# Validation Report - crossnma@1.3.0
...
| has_source_control | https://github.com/htx-r/crossnma |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | meta (\>= 8.0-1)    | Depends |
| 2   | netmeta (\>= 2.8-0) | Depends |
| 3   | rjags               | Imports |
| 4   | coda                | Imports |
| 5   | dplyr               | Imports |
| 6   | plyr                | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
          ...
          crossnma crossnma.model         league 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 04:24:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bd622ac965_1739766247
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpvx99EM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crossnma_v1.3.0-tikzDictionary"
