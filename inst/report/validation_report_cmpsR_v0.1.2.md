...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Wangqian Ju <wju@iastate.edu>                        |
...
Overall the package has 15 exported objects. 15 are documented:
             ...
             cmps_na_trim     cmps_segment_plot   cmps_signature_plot 
                     TRUE                  TRUE                  TRUE 
       compute_diff_phase compute_score_metrics      compute_ss_ratio 
                     TRUE                  TRUE                  TRUE 
     extract_feature_cmps        get_all_phases              get_ccf4 
                     TRUE                  TRUE                  TRUE 
                  get_ccp         get_ccr_peaks              get_CMPS 
                     TRUE                  TRUE                  TRUE 
            get_seg_scale              get_segs    metric_plot_helper 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:45:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3dc51f26_1739681135
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqkTOnS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmpsR_v0.1.2-tikzDictionary"
