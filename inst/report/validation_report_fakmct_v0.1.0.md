# Validation Report - fakmct@0.1.0
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Alfi Nurrahmah <221810140@stis.ac.id>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | <https://github.com/alfinurrahmah/fakmct>            |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    choice_function          fakmct       fuzzy_and      fuzzy_norm     linalg_norm 
               TRUE            TRUE            TRUE            TRUE            TRUE 
     match_function   update_weight vigilance_check 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 05:09:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d453009d8fc_1739941735
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7wpN61
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fakmct_v0.1.0-tikzDictionary"
