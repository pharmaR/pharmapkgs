# Validation Report - CDatanet@2.2.1
...
| export_help          | 16                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Aristide Houndetoungan <ahoundetoungan@gmail.com> |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/ahoundetoungan/CDatanet        |
...
| 13  | RcppProgress     | LinkingTo |
| 14  | RcppDist         | LinkingTo |
| 15  | RcppNumerical    | LinkingTo |
...
Overall the package has 16 exported objects. 16 are documented:
             ...
             cdnet homophili.data   homophily.fe   homophily.re     mat.to.vec 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      norm.network       peer.avg     remove.ids            sar           sart 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           simcdEy       simcdnet     simnetwork         simsar        simsart 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        vec.to.mat 
              TRUE 
...
| Execution Time | 2025-02-16 03:55:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35306251f_1739678142
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1xlwrn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CDatanet_v2.2.1-tikzDictionary"
