...
| export_help          | 46                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Brian J. Smith <brian-j-smith@uiowa.edu>             |
...
Overall the package has 46 exported objects. 46 are documented:
               ...
               boa.acf          boa.chain      boa.chain.add boa.chain.collapse 
                  TRUE               TRUE               TRUE               TRUE 
         boa.chain.del     boa.chain.eval    boa.chain.gandr   boa.chain.import 
                  TRUE               TRUE               TRUE               TRUE 
        boa.chain.info    boa.chain.reset   boa.chain.subset  boa.chain.support 
                  TRUE               TRUE               TRUE               TRUE 
            boa.geweke          boa.handw            boa.hpd    boa.importASCII 
                  TRUE               TRUE               TRUE               TRUE 
        boa.importBUGS   boa.importMatrix           boa.init           boa.load 
                  TRUE               TRUE               TRUE               TRUE 
              boa.menu            boa.par           boa.plot       boa.plot.acf 
                  TRUE               TRUE               TRUE               TRUE 
        boa.plot.bandg   boa.plot.density     boa.plot.gandr    boa.plot.geweke 
                  TRUE               TRUE               TRUE               TRUE 
      boa.plot.history       boa.plot.par     boa.plot.title     boa.plot.trace 
                  TRUE               TRUE               TRUE               TRUE 
         boa.print.acf      boa.print.cor    boa.print.gandr   boa.print.geweke 
                  TRUE               TRUE               TRUE               TRUE 
       boa.print.handw      boa.print.hpd     boa.print.info      boa.print.par 
                  TRUE               TRUE               TRUE               TRUE 
       boa.print.randl    boa.print.stats           boa.quit          boa.randl 
                  TRUE               TRUE               TRUE               TRUE 
              boa.save          boa.stats 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:29:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2a72e0bf_1739593777
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptoYgD0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_boa_v1.1.8.2-tikzDictionary"
