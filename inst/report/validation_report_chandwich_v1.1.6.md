# Validation Report - chandwich@1.1.6
...
| bugs_status          | 0.5                                       |
| has_source_control   | https://github.com/paulnorthrop/chandwich |
...
chantrics, exdex, lax, lite

## Namespace

Overall the package has 6 exported objects. 6 are documented:

     adjust_loglik compare_models conf_intervals    conf_region        log_gev 
...
| Execution Time | 2025-02-16 04:07:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3a77c3d_1739678832
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJmMXlu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chandwich_v1.1.6-tikzDictionary"
