...
Overall the package has 13 exported objects. 13 are documented:
          ...
          dhb_fixname             dhbin             dhtri          geom_dhb 
                 TRUE              TRUE              TRUE              TRUE 
          geom_dhbtri    geom_label_dhb geom_label_region       geom_region 
                 TRUE              TRUE              TRUE              TRUE 
       geom_regiontri    region_fixname         regionbin         regiontri 
                 TRUE              TRUE              TRUE              TRUE 
            tri_alloc 
                 TRUE 
...
| Execution Time | 2025-02-18 03:57:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4a2d8e17_1739851025
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLV5h4Y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DHBins_v1.1-tikzDictionary"
