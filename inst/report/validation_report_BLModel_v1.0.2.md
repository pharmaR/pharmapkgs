# Validation Report - BLModel@1.0.2
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Andrzej Palczewski <A.Palczewski@mimuw.edu.pl>       |
...
Overall the package has 5 exported objects. 5 are documented:
       ...
       BL_post_distr equilibrium_mean    observ_normal  observ_powerexp 
                TRUE             TRUE             TRUE             TRUE 
           observ_ts 
                TRUE 
...
| Execution Time | 2025-02-15 04:22:53 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3531689b_1739593369
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxsnAG8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BLModel_v1.0.2-tikzDictionary"
