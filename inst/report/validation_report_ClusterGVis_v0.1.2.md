# Validation Report - ClusterGVis@0.1.2
...
| export_help          | 16                                    |
| has_website          | FALSE                                 |
| has_maintainer       | Jun Zhang <3219030654@stu.cpu.edu.cn> |
...
| 1   | Biobase              | Imports |
| 2   | circlize             | Imports |
| 3   | clusterProfiler      | Imports |
| 4   | colorRamps           | Imports |
| 5   | ComplexHeatmap       | Imports |
| 6   | dplyr                | Imports |
| 7   | e1071                | Imports |
| 8   | factoextra           | Imports |
| 9   | ggplot2              | Imports |
...
| 17  | reshape2             | Imports |
| 18  | scales               | Imports |
| 19  | SingleCellExperiment | Imports |
| 20  | stats                | Imports |
| 21  | SummarizedExperiment | Imports |
| 22  | TCseq                | Imports |
| 23  | tibble               | Imports |
...
Overall the package has 14 exported objects. 15 are documented:

                                %>%                     clusterData 
                              FALSE                            TRUE 
                      enrichCluster                           exprs 
                               TRUE                            TRUE 
                        getClusters               normalized_counts 
                               TRUE                            TRUE 
       plot_genes_branched_heatmap2 plot_multiple_branches_heatmap2 
                               TRUE                            TRUE 
           plot_pseudotime_heatmap2           pre_pseudotime_matrix 
                               TRUE                            TRUE 
               prepareDataFromscRNA                      pseudotime 
                               TRUE                            TRUE 
                       size_factors                      visCluster 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-16 04:38:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34516701e_1739680731
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9qYq4K
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClusterGVis_v0.1.2-tikzDictionary"
