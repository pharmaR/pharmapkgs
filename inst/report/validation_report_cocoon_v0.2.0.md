# Validation Report - cocoon@0.2.0
...
| has_source_control | https://github.com/JeffreyRStevens/cocoon |
...
Overall the package has 16 exported objects. 16 are documented:
            ...
            format_bf        format_chr       format_corr       format_mean 
                 TRUE              TRUE              TRUE              TRUE 
        format_meanci     format_meansd     format_meanse     format_median 
                 TRUE              TRUE              TRUE              TRUE 
     format_medianiqr        format_num          format_p format_scientific 
                 TRUE              TRUE              TRUE              TRUE 
         format_stats        format_sub    format_summary      format_ttest 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:49:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3305bd2a5_1739681373
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHPQKhK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cocoon_v0.2.0-tikzDictionary"
