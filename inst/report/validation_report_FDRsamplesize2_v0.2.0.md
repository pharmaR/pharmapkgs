# Validation Report - FDRsamplesize2@0.2.0
...
| export_help          | 35                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yonghui Ni <Yonghui.Ni@STJUDE.ORG>                   |
...
Overall the package has 35 exported objects. 35 are documented:
           ...
           alpha.power.fdr    average.power.coxph   average.power.fisher 
                      TRUE                   TRUE                   TRUE 
        average.power.hart       average.power.li   average.power.oneway 
                      TRUE                   TRUE                   TRUE 
     average.power.ranksum average.power.signrank average.power.signtest 
                      TRUE                   TRUE                   TRUE 
      average.power.t.test    average.power.tcorr  average.power.twoprop 
                      TRUE                   TRUE                   TRUE 
                fdr.avepow        fdr.power.alpha       find.sample.size 
                      TRUE                   TRUE                   TRUE 
               n.fdr.coxph           n.fdr.fisher           n.fdr.negbin 
                      TRUE                   TRUE                   TRUE 
              n.fdr.oneway          n.fdr.poisson          n.fdr.ranksum 
                      TRUE                   TRUE                   TRUE 
            n.fdr.signrank         n.fdr.signtest            n.fdr.tcorr 
                      TRUE                   TRUE                   TRUE 
               n.fdr.ttest          n.fdr.twoprop              power.cox 
                      TRUE                   TRUE                   TRUE 
              power.fisher             power.hart               power.li 
                      TRUE                   TRUE                   TRUE 
              power.oneway          power.ranksum         power.signrank 
                      TRUE                   TRUE                   TRUE 
            power.signtest            power.tcorr 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-27 03:23:46 UTC |
...
running this report
    ...
    PROCESSX_PS1c627df05d84_1740626623
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdmHQF2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FDRsamplesize2_v0.2.0-tikzDictionary"
