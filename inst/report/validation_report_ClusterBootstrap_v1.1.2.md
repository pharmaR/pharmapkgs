# Validation Report - ClusterBootstrap@1.1.2
...
| export_help          | 4                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Mathijs Deen <m.l.deen@fsw.leidenuniv.nl>       |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/mathijsdeen/ClusterBootstrap |
...
Overall the package has 4 exported objects. 4 are documented:
       ...
       clusbootglm clusbootsample            emm          ptest 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:38:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bc347690f36_1739680708
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3O0Ix1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClusterBootstrap_v1.1.2-tikzDictionary"
