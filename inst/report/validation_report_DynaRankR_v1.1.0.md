# Validation Report - DynaRankR@1.1.0
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Eli D. Strauss <straussed@gmail.com>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/straussed/DynaRankR               |
...
Overall the package has 8 exported objects. 8 are documented:
      ...
      dyadic_similarity  edgelist_to_matrix        get_dynamics        get_edgelist 
                   TRUE                TRUE                TRUE                TRUE 
            informed_ds        informed_elo informed_matreorder          plot_ranks 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 05:04:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4fd5244b_1739855051
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2ggne6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DynaRankR_v1.1.0-tikzDictionary"
