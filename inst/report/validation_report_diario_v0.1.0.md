# Validation Report - diario@0.1.0
...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Andre Leite <leite@castlab.org>                      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | <https://github.com/StrategicProjects/diario>        |
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            diario_get_company        diario_get_entities 
                          TRUE                       TRUE 
    diario_get_project_details        diario_get_projects 
                          TRUE                       TRUE 
     diario_get_report_details         diario_get_reports 
                          TRUE                       TRUE 
       diario_get_task_details       diario_get_task_list 
                          TRUE                       TRUE 
        diario_perform_request      diario_retrieve_token 
                          TRUE                       TRUE 
            diario_store_token 
                          TRUE 
...
| Execution Time | 2025-02-18 03:59:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4635316ac_1739851154
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptM5eV3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diario_v0.1.0-tikzDictionary"
