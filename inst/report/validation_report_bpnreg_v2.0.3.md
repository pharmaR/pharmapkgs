# Validation Report - bpnreg@2.0.3
...
| export_help          | 15                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Jolien Cremers <joliencremers@gmail.com> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/joliencremers/bpnreg  |
...
|     | package                        | type      |
|:----|:-------------------------------|:----------|
| 1   | Rcpp (\>= 1.0.2)               | LinkingTo |
| 2   | RcppArmadillo (\>= 0.10.1.2.0) | LinkingTo |
| 3   | BH (\>= 1.69.0.1)              | LinkingTo |
| 4   | Rcpp (\>= 1.0.2)               | Imports   |
| 5   | haven (\>= 2.1.1)              | Imports   |
| 6   | methods (\>= 3.6.0)            | Imports   |
...
Overall the package has 15 exported objects. 15 are documented:
              ...
              BFc         bpnme          bpnr     coef_circ      coef_lin 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         coef_ran           fit       hpd_est  hpd_est_circ     mean_circ 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         mode_est mode_est_circ      rho_circ       sd_circ     traceplot 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-15 04:39:03 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2ce200ff_1739594338
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0QSBDa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bpnreg_v2.0.3-tikzDictionary"
