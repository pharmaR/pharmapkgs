...
| export_help          | 17                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Hanna Meyer <hanna.meyer@uni-muenster.de> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/HannaMeyer/CAST        |
...
meteo, mlr3spatiotempcv, waywiser

## Namespace

Overall the package has 17 exported objects. 17 are documented:

                     aoa                  bss     clustered_sample 
                    TRUE                 TRUE                 TRUE 
    CreateSpacetimeFolds        errorProfiles                  ffs 
                    TRUE                 TRUE                 TRUE 
                 geodist    global_validation                knndm 
                    TRUE                 TRUE                 TRUE 
                    nndm         normalize_DI             show.aoa 
                    TRUE                 TRUE                 TRUE 
                show.ffs           show.knndm            show.nndm 
                    TRUE                 TRUE                 TRUE 
            show.trainDI              trainDI 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-16 03:45:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34e5d5086_1739677527
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZl4ZZa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CAST_v1.0.3-tikzDictionary"
