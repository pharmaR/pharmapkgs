# Validation Report - BINtools@0.2.0
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Ville Satopää <ville.satopaa@gmail.com>              |
...
| 5   | tibble (\>= 3.0.3)        | Imports   |
| 6   | stringi (\>= 1.4.6)       | Imports   |
| 7   | mvtnorm (\>= 1.1.1)       | Imports   |
| 8   | combinat (\>= 0.0.8)      | Imports   |
| 9   | rstantools                | Imports   |
| 10  | BH (\>= 1.66.0)           | LinkingTo |
| 11  | Rcpp (\>= 0.12.0)         | LinkingTo |
| 12  | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 13  | RcppParallel (\>= 5.0.1)  | LinkingTo |
| 14  | rstan (\>= 2.18.1)        | LinkingTo |
| 15  | StanHeaders (\>= 2.18.0)  | LinkingTo |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    complete_summary     estimate_BIN    simulate_data 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:10:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2be8c5ed_1739592653
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpntdPiM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BINtools_v0.2.0-tikzDictionary"
