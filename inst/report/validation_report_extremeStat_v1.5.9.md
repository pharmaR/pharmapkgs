# Validation Report - extremeStat@1.5.9
...
| has_source_control   | https://github.com/brry/extremeStat |
...
|     | package                     | type    |
|:----|:----------------------------|:--------|
| 1   | lmomco (\>= 2.2.5)          | Imports |
| 2   | berryFunctions (\>= 1.15.6) | Imports |
| 3   | pbapply                     | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
      ...
      distLexBoot  distLextreme      distLfit distLquantile  distLweights 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      plotLexBoot  plotLextreme      plotLfit plotLquantile  plotLweights 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           printL         q_gpd    q_weighted      quantGPD 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 04:58:08 UTC |
...
running this report
    ...
    PROCESSX_PS1d4529776adc_1739941081
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpljD9ZX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extremeStat_v1.5.9-tikzDictionary"
