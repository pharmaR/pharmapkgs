# Validation Report - BIFIEsurvey@3.6.6
...
| export_help          | 36                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Alexander Robitzsch <robitzsch@ipn.uni-kiel.de>      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/alexanderrobitzsch/BIFIEsurvey    |
...
CDM, eatRep, LSAmitR, miceadds

## Namespace

Overall the package has 36 exported objects. 36 are documented:

           BIFIE_NMI_inference_parameters            BIFIE.BIFIEcdata2BIFIEdata 
                                     TRUE                                  TRUE 
               BIFIE.BIFIEdata2BIFIEcdata              BIFIE.BIFIEdata2datalist 
                                     TRUE                                  TRUE 
                                 BIFIE.by                          BIFIE.correl 
                                     TRUE                                  TRUE 
                           BIFIE.crosstab                            BIFIE.data 
                                     TRUE                                  TRUE 
                          BIFIE.data.boot                       BIFIE.data.jack 
                                     TRUE                                  TRUE 
                     BIFIE.data.transform               BIFIE.derivedParameters 
                                     TRUE                                  TRUE 
                               BIFIE.ecdf                            BIFIE.freq 
                                     TRUE                                  TRUE 
                               BIFIE.hist                   BIFIE.lavaan.survey 
                                     TRUE                                  TRUE 
                             BIFIE.linreg                       BIFIE.logistreg 
                                     TRUE                                  TRUE 
                                BIFIE.mva                       BIFIE.pathmodel 
                                     TRUE                                  TRUE 
                             BIFIE.survey                     BIFIE.twolevelreg 
                                     TRUE                                  TRUE 
                             BIFIE.univar                     BIFIE.univar.test 
                                     TRUE                                  TRUE 
                           BIFIE.waldtest                      BIFIEdata.select 
                                     TRUE                                  TRUE 
                    BIFIEdata2svrepdesign bifiesurvey_rcpp_replication_variance 
                                     TRUE                                  TRUE 
             bifiesurvey_rcpp_rubin_rules                            bifietable 
                                     TRUE                                  TRUE 
                           load.BIFIEdata                  load.BIFIEdata.files 
                                     TRUE                                  TRUE 
                           save.BIFIEdata                                    se 
                                     TRUE                                  TRUE 
                    svrepdesign2BIFIEdata                       write.BIFIEdata 
                                     TRUE                                  TRUE 
...
| Execution Time | 2025-02-22 03:15:57 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb51ad87a8_1740194153
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpjf9AmX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BIFIEsurvey_v3.6.6-tikzDictionary"
