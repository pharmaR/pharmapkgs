# Validation Report - ETASbootstrap@0.2.0
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Renjie Peng <renjie.peng@mail.mcgill.ca>             |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | ETAS (\>= 0.5.1)          | Imports |
| 2   | MASS (\>= 7.3.58.2)       | Imports |
| 3   | spatstat.geom (\>= 3.2.8) | Imports |
| 4   | stats (\>= 4.2.2)         | Imports |
| 5   | utils (\>= 4.2.2)         | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
                         ...
                         ETAS_Boots            simulate_aftershocks 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-19 04:33:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d455e9bc3b0_1739939619
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpW6nJx6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ETASbootstrap_v0.2.0-tikzDictionary"
