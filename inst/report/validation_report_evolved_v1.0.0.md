# Validation Report - evolved@1.0.0
...
| export_help          | 17                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Matheus Januario <januarioml.eco@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | <https://github.com/Auler-J/evolved>        |
...
Overall the package has 17 exported objects. 17 are documented:
           ...
           calcFossilDivTT checkAndFixUltrametric          countSeqDiffs 
                      TRUE                   TRUE                   TRUE 
        estimateSpeciation                fitCRBD          is.ProteinSeq 
                      TRUE                   TRUE                   TRUE 
                   lttPlot              NatSelSim            OneGenHWSim 
                      TRUE                   TRUE                   TRUE 
                plotNatSel      plotPaintedWhales         plotProteinSeq 
                      TRUE                   TRUE                   TRUE 
         plotRawFossilOccs            plotWFDrift simulateBirthDeathRich 
                      TRUE                   TRUE                   TRUE 
              simulateTree             WFDriftSim 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-19 04:43:21 UTC |
...
running this report
    ...
    PROCESSX_PS1d455eb77f89_1739940195
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkcQIiM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evolved_v1.0.0-tikzDictionary"
