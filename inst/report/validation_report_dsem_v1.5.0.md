...
| export_help          | 17                                     |
| has_website          | TRUE                                   |
| has_maintainer       | James Thorson <James.Thorson@noaa.gov> |
...
Overall the package has 17 exported objects. 17 are documented:
         ...
         as_fitted_DAG             as_sem               cAIC classify_variables 
                  TRUE               TRUE               TRUE               TRUE 
     convert_equations               dsem       dsem_control           dsemRTMB 
                  TRUE               TRUE               TRUE               TRUE 
       list_parameters      loo_residuals           make_dfa      make_dsem_ram 
                  TRUE               TRUE               TRUE               TRUE 
            parse_path stepwise_selection          test_dsep             TMBAIC 
                  TRUE               TRUE               TRUE               TRUE 
          total_effect 
                  TRUE 
...
| Execution Time | 2025-02-18 04:50:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bb423ae9552_1739854236
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpheWPfE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsem_v1.5.0-tikzDictionary"
