# Validation Report - D3partitionR@0.5.0
...
| export_help          | 24                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Antoine Guillot <antoine.guil@outlook.fr>            |
...
| 4   | functional   | Imports |
| 5   | RColorBrewer | Imports |
| 6   | titanic      | Imports |
...
Overall the package has 24 exported objects. 24 are documented:
                      ...
                      add_data             add_nodes_data 
                          TRUE                       TRUE 
                     add_title aggregate_sessions_to_path 
                          TRUE                       TRUE 
         compile_D3_partitionR   compute_unique_leaf_name 
                          TRUE                       TRUE 
                  D3partitionR         D3partitionROutput 
                          TRUE                       TRUE 
                    df_to_nest          find_min_max_tree 
                          TRUE                       TRUE 
           get_all_nodes_names        is_present_variable 
                          TRUE                       TRUE 
            renderD3partitionR                 scale_type 
                          TRUE                       TRUE 
                set_chart_type set_continuous_color_scale 
                          TRUE                       TRUE 
      set_discrete_color_scale      set_labels_parameters 
                          TRUE                       TRUE 
         set_legend_parameters            set_shiny_input 
                          TRUE                       TRUE 
        set_tooltip_parameters                  set_trail 
                          TRUE                       TRUE 
                    strip_path            tooltip_builder 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-17 04:48:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67c5e6898_1739767697
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpokQ8aa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_D3partitionR_v0.5.0-tikzDictionary"
