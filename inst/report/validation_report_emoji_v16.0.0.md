# Validation Report - emoji@16.0.0
...
| export_help          | 29                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Emil Hvitfeldt <emilhhvitfeldt@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/EmilHvitfeldt/emoji    |
...
bskyr, dfeR, DSAIDE, DSAIRM, figma, fio, tabulate, tidyEmoji, worrrd

## Namespace

Overall the package has 29 exported objects. 29 are documented:

                     arrow                  clock   day_in_synodic_cycle 
                      TRUE                   TRUE                   TRUE 
                     emoji            emoji_count           emoji_detect 
                      TRUE                   TRUE                   TRUE 
             emoji_extract      emoji_extract_all             emoji_find 
                      TRUE                   TRUE                   TRUE 
                 emoji_fix             emoji_glue           emoji_locate 
                      TRUE                   TRUE                   TRUE 
          emoji_locate_all            emoji_match        emoji_match_all 
                      TRUE                   TRUE                   TRUE 
    emoji_modifier_extract  emoji_modifier_remove                emoji_p 
                      TRUE                   TRUE                   TRUE 
             emoji_replace      emoji_replace_all     emoji_replace_name 
                      TRUE                   TRUE                   TRUE 
              emoji_subset            emoji_which                   flag 
                      TRUE                   TRUE                   TRUE 
                    keycap                  medal                   moon 
                      TRUE                   TRUE                   TRUE 
                     shape                    zoo 
...
| Execution Time | 2025-02-19 04:03:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d457e307e9d_1739937806
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpErf5TV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emoji_v16.0.0-tikzDictionary"
