# Validation Report - CarletonStats@2.2
...
| export_help          | 16                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Adam Loy <aloy@carleton.edu>          |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/aloy/CarletonStats |
...
Overall the package has 16 exported objects. 16 are documented:
    ...
    anovaSummarized            boot         bootCor      bootPaired       bootSlope 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        confIntDemo         corDemo      groupedBar    missingLevel        permTest 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      permTestAnova     permTestCor  permTestPaired   permTestSlope      qqPlotDemo 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           stemPlot 
               TRUE 
...
| Execution Time | 2025-02-16 03:42:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bc319459156_1739677350
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpe4gcnA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CarletonStats_v2.2-tikzDictionary"
