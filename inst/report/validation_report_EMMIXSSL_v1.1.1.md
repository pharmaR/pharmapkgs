# Validation Report - EMMIXSSL@1.1.1
...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ziyang Lyu <ziyang.lyu@unsw.edu.au>                  |
...
Overall the package has 21 exported objects. 21 are documented:
          ...
          Classifier_Bayes                cov2vec      discriminant_beta 
                      TRUE                   TRUE                   TRUE 
                  EMMIXSSL       get_clusterprobs            get_entropy 
                      TRUE                   TRUE                   TRUE 
              initialvalue               list2par             loglk_full 
                      TRUE                   TRUE                   TRUE 
                  loglk_ig             loglk_miss              logsumexp 
                      TRUE                   TRUE                   TRUE 
           makelabelmatrix neg_objective_function      normalise_logprob 
                      TRUE                   TRUE                   TRUE 
                  par2list                pro2vec                 rlabel 
                      TRUE                   TRUE                   TRUE 
                      rmix                vec2cov                vec2pro 
                      TRUE                   TRUE                   TRUE 

### Examples

There are 21 help pages with examples, from 24 (87.50 %).
...
| Execution Time | 2025-02-19 04:03:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d451880cbf7_1739937779
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptgCc1M
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EMMIXSSL_v1.1.1-tikzDictionary"
