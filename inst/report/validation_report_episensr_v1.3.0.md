# Validation Report - episensr@1.3.0
...
| export_help          | 20                                  |
| has_website          | TRUE                                |
| has_maintainer       | Denis Haine <denis.haine@gmail.com> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/dhaine/episensr  |
...
Overall the package has 20 exported objects. 19 are documented:
                      ...
                      %>%             boot.bias           confounders 
                    FALSE                  TRUE                  TRUE 
        confounders.array       confounders.emm    confounders.evalue 
                     TRUE                  TRUE                  TRUE 
          confounders.ext     confounders.limit      confounders.poly 
                     TRUE                  TRUE                  TRUE 
                    mbias     misclassification misclassification.cov 
                     TRUE                  TRUE                  TRUE 
             multidimBias         multiple.bias              probsens 
                     TRUE                  TRUE                  TRUE 
            probsens.conf          probsens.irr     probsens.irr.conf 
                     TRUE                  TRUE                  TRUE 
             probsens.sel             selection 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-19 04:19:09 UTC |
...
running this report
    ...
    PROCESSX_PS1d4522255cea_1739938743
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpk3xPwB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_episensr_v1.3.0-tikzDictionary"
