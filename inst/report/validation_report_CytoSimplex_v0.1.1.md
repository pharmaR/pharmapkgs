# Validation Report - CytoSimplex@0.1.1
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Yichen Wang <wayichen@umich.edu>                     |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/welch-lab/CytoSimplex             |
...
Overall the package has 6 exported objects. 6 are documented:
          ...
          colNormalize         plotBinary     plotQuaternary        plotTernary 
                  TRUE               TRUE               TRUE               TRUE 
     selectTopFeatures writeQuaternaryGIF 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:47:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66f7f06ca_1739767653
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnizONX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CytoSimplex_v0.1.1-tikzDictionary"
