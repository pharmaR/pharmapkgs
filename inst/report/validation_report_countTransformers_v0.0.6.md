# Validation Report - countTransformers@0.0.6
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Zeyu Zhang <zhzyvv@gmail.com>                        |
...
Overall the package has 10 exported objects. 10 are documented:
        ...
        getJaccard  l2Transformer   lTransformer lv2Transformer  lvTransformer 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     r2Transformer   rTransformer rv2Transformer  rvTransformer  wilcoxWrapper 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 04:05:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bd663003c62_1739765142
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEQnGqb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_countTransformers_v0.0.6-tikzDictionary"
