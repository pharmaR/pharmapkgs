...
| export_help          | 6                                                   |
| has_website          | TRUE                                                |
| has_maintainer       | Alex Przybylski <alexander.przybylski@novartis.com> |
...
Overall the package has 6 exported objects. 6 are documented:
             ...
             apply_contrast     average_predictions         estimate_varcov 
                       TRUE                    TRUE                    TRUE 
        get_marginal_effect predict_counterfactuals          sanitize_model 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-15 03:51:16 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1d0212b6_1739591472
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplwOKy5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beeca_v0.2.0-tikzDictionary"
