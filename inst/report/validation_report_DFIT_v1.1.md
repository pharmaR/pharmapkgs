...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Victor H. Cervantes <vhcervantesb@unal.edu.co>       |
...
Overall the package has 17 exported objects. 17 are documented:
             ...
             AseIrt     Bound3PlIpr            Cdif       CutoffIpr      DeltaMhIrt 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                Dtf ExtractMirtPars             Ipr           IprMh        IprNcdif 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             IprSam          IprUam           IrtMh           Ncdif       PlotNcdif 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         SignedArea    UnsignedArea 
               TRUE            TRUE 
...
| Execution Time | 2025-02-18 03:53:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45e35517d_1739850833
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNEY6go
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DFIT_v1.1-tikzDictionary"
