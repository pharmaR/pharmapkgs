# Validation Report - CommKern@1.0.1
...
| export_help          | 20                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Alexandria Jensen <alexandria.jensen@cuanschutz.edu> |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/aljensen89/CommKern               |
...
Overall the package has 20 exported objects. 20 are documented:
                   ...
                   adj_RI  community_allegiance        community_plot 
                     TRUE                  TRUE                  TRUE 
     consensus_similarity          ext_distance     group_adj_perturb 
                     TRUE                  TRUE                  TRUE 
    group_network_perturb          ham_distance   heatbath_multimodal 
                     TRUE                  TRUE                  TRUE 
                      hms                kernel           matrix_plot 
                     TRUE                  TRUE                  TRUE 
             matrix_to_df                   NMI                purity 
                     TRUE                  TRUE                  TRUE 
      score_cont_nonparam  score_cont_semiparam    score_log_nonparam 
                     TRUE                  TRUE                  TRUE 
      score_log_semiparam   subset_matrix_to_df 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-17 03:32:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62cee710c_1739763153
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAK3dxF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CommKern_v1.0.1-tikzDictionary"
