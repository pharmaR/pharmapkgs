# Validation Report - BinMat@0.1.5
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Clarke van Steenderen <vsteenderen@gmail.com>        |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | pvclust (\>= 2.0)    | Imports |
| 2   | MASS (\>= 7.3)       | Imports |
| 3   | stats (\>= 3.4.0)    | Imports |
| 4   | graphics (\>= 3.4.0) | Imports |
| 5   | base (\>= 3.4.0)     | Imports |
| 6   | ggpubr (\>= 0.4.0)   | Imports |
| 7   | tibble (\>= 3.1.4)   | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            check.data        consolidate             errors        group.names 
                  TRUE               TRUE               TRUE               TRUE 
                  nmds        peak.remove peaks.consolidated     peaks.original 
                  TRUE               TRUE               TRUE               TRUE 
                 scree            shepard              upgma 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:09:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4439dba5_1739592549
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmynKAq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BinMat_v0.1.5-tikzDictionary"
