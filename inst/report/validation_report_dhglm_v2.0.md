...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Maengseok Noh <msnoh@pknu.ac.kr>                     |
...
Overall the package has 3 exported objects. 3 are documented:
         ...
         dhglmfit DHGLMMODELING     plotdhglm 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 03:57:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bb440be3b4c_1739851038
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpd8vyPr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dhglm_v2.0-tikzDictionary"
