# Validation Report - CohortSymmetry@0.2.1
...
| export_help          | 8                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Xihang Chen <xihang.chen@ndorms.ox.ac.uk> |
...
| 2   | dplyr                         | Imports |
| 3   | PatientProfiles               | Imports |
| 4   | rlang                         | Imports |
| 5   | tibble                        | Imports |
| 6   | visOmopResults (\>= 0.4.0)    | Imports |
| 7   | tidyr                         | Imports |
| 8   | omock (\>= 0.3.1)             | Imports |
| 9   | stats                         | Imports |
| 10  | here                          | Imports |
| 11  | omopgenerics (\>= 0.4.0)      | Imports |
| 12  | DrugUtilisation (\>= 0.7.0)   | Imports |
| 13  | CodelistGenerator (\>= 3.1.0) | Imports |
| 14  | ggplot2                       | Imports |
| 15  | duckdb                        | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    generateSequenceCohortSet        mockCohortSymmetry        plotSequenceRatios 
                         TRUE                      TRUE                      TRUE 
         plotTemporalSymmetry   summariseSequenceRatios summariseTemporalSymmetry 
                         TRUE                      TRUE                      TRUE 
          tableSequenceRatios     tableTemporalSymmetry 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-16 04:55:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31e2bc5c0_1739681730
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLnBtAR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CohortSymmetry_v0.2.1-tikzDictionary"
