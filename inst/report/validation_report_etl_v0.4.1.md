...
| export_help          | 20                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Benjamin S. Baumer <ben.baumer@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/beanumber/etl          |
...
Overall the package has 20 exported objects. 20 are documented:
            ...
            create_etl_package                    db_type 
                          TRUE                       TRUE 
                   dbRunScript                     dbWipe 
                          TRUE                       TRUE 
                           etl                etl_cleanup 
                          TRUE                       TRUE 
                    etl_create                etl_extract 
                          TRUE                       TRUE 
                      etl_init                   etl_load 
                          TRUE                       TRUE 
                 etl_transform                 etl_update 
                          TRUE                       TRUE 
    extract_date_from_filename                find_schema 
                          TRUE                       TRUE 
                        is.etl match_files_by_year_months 
                          TRUE                       TRUE 
                smart_download               smart_upload 
                          TRUE                       TRUE 
                 src_mysql_cnf           valid_year_month 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-19 04:34:21 UTC |
...
running this report
    ...
    PROCESSX_PS1d4568a1cf8d_1739939654
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRkuvyX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_etl_v0.4.1-tikzDictionary"
