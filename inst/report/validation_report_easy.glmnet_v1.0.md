# Validation Report - easy.glmnet@1.0
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Joaquim Radua <quimradua@gmail.com>                  |
...
Overall the package has 11 exported objects. 11 are documented:
                    ...
                    assign.folds                           cv 
                            TRUE                         TRUE 
        data.frame2glmnet.matrix data.frame2glmnet.matrix_fit 
                            TRUE                         TRUE 
                      glmnet_fit   glmnet_get.items.relevance 
                            TRUE                         TRUE 
           glmnet_get.main.model               glmnet_predict 
                            TRUE                         TRUE 
            impute.glmnet.matrix     impute.glmnet.matrix_fit 
                            TRUE                         TRUE 
                     surv2binary 
                            TRUE 
...
| Execution Time | 2025-02-18 05:09:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bb444d5ab3a_1739855393
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmfPFPM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easy.glmnet_v1.0-tikzDictionary"
