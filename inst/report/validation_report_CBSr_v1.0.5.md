...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Sangil Lee <sangillee3rd@gmail.com>                  |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | rJava (\>= 0.9-11) | Imports |
| 2   | NlcOptim (\>= 0.6) | Imports |
...
| Execution Time | 2025-02-16 03:52:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bc364d32b7b_1739677941
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIXtxeg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CBSr_v1.0.5-tikzDictionary"
