# Validation Report - conmet@0.1.0
...
| export_help          | 1                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Leander De Schutter <deschutter@rsm.nl>              |
...
|:----|:---------------|:--------|
| 1   | shiny          | Depends |
| 2   | shinydashboard | Depends |
| 3   | foreign        | Imports |
| 4   | waiter         | Imports |
| 5   | shinyWidgets   | Imports |
| 6   | purrr          | Imports |
| 7   | lavaan         | Imports |
| 8   | summarytools   | Imports |
| 9   | stringr        | Imports |
| 10  | dplyr          | Imports |
| 11  | Hmisc          | Imports |
| 12  | semTools       | Imports |
...
| Execution Time | 2025-02-17 03:45:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62f46510f_1739763935
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcPcw9P
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conmet_v0.1.0-tikzDictionary"
