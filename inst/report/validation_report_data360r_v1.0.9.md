# Validation Report - data360r@1.0.9
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Ramin Aliyev <tcdata360@worldbank.org>               |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/mrpsonglao/data360r               |
...
Overall the package has 4 exported objects. 4 are documented:
         ...
         get_data360  get_metadata360 get_resources360       search_360 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:56:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64f62e729_1739768160
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEKBuXU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_data360r_v1.0.9-tikzDictionary"
