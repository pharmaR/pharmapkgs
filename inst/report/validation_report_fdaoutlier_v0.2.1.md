# Validation Report - fdaoutlier@0.2.1
...
| export_help          | 24                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Oluwasegun Taiwo Ojo <seguntaiwoojo@gmail.com> |
| bugs_status          | 0.6666667                                      |
| has_source_control   | https://github.com/otsegun/fdaoutlier          |
...
Overall the package has 24 exported objects. 24 are documented:
               ...
               band_depth               dir_out  directional_quantile 
                     TRUE                  TRUE                  TRUE 
           extremal_depth   extreme_rank_length    functional_boxplot 
                     TRUE                  TRUE                  TRUE 
          linfinity_depth   modified_band_depth                msplot 
                     TRUE                  TRUE                  TRUE 
                     muod      projection_depth         seq_transform 
                     TRUE                  TRUE                  TRUE 
        simulation_model1     simulation_model2     simulation_model3 
                     TRUE                  TRUE                  TRUE 
        simulation_model4     simulation_model5     simulation_model6 
                     TRUE                  TRUE                  TRUE 
        simulation_model7     simulation_model8     simulation_model9 
                     TRUE                  TRUE                  TRUE 
    total_variation_depth               tvd_mss                tvdmss 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-27 03:22:20 UTC |
...
running this report
    ...
    PROCESSX_PS1c6265795d66_1740626537
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgUmCxo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fdaoutlier_v0.2.1-tikzDictionary"
