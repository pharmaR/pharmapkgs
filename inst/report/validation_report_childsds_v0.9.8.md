# Validation Report - childsds@0.9.8
...
| export_help | 20 |
| has_website | FALSE |
| has_maintainer | Mandy Vogel <mandy.vogel@googlemail.com> |
| bugs_status | scraping bug reports fromm BugReports host ‘uni-leipzig’ not implemented |
...
Overall the package has 19 exported objects. 19 are documented:
            ...
            aggregate_lms         calc_confints   calc_percent_excess 
                     TRUE                  TRUE                  TRUE 
            do_iterations   make_percentile_tab make_percentile_tab2d 
                     TRUE                  TRUE                  TRUE 
                  mock_df           mock_values         one_iteration 
                     TRUE                  TRUE                  TRUE 
             prepare_data                   sds                sds_2d 
                     TRUE                  TRUE                  TRUE 
                  sds_pub             sds_pub2d                 sds2d 
                     TRUE                  TRUE                  TRUE 
              select_fams           select_meas           wormplot_gg 
                     TRUE                  TRUE                  TRUE 
            wormplot2d_gg 
                     TRUE 
...
| Execution Time | 2025-02-16 04:13:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bc323302992_1739679193
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmps2cwuy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_childsds_v0.9.8-tikzDictionary"
