# Validation Report - clugenr@1.0.3
...
| export_help          | 16                                |
| has_website          | TRUE                              |
| has_maintainer       | Nuno Fachada <faken@fakenmc.com>  |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/clugen/clugenr |
...
Overall the package has 16 exported objects. 16 are documented:
                 ...
                 angle_btw           angle_deltas             clucenters 
                      TRUE                   TRUE                   TRUE 
                    clugen               clumerge            clupoints_n 
                      TRUE                   TRUE                   TRUE 
             clupoints_n_1 clupoints_n_1_template               clusizes 
                      TRUE                   TRUE                   TRUE 
                 fix_empty         fix_num_points               llengths 
                      TRUE                   TRUE                   TRUE 
            points_on_line      rand_ortho_vector       rand_unit_vector 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:36:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31529d441_1739680593
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpydCxVd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clugenr_v1.0.3-tikzDictionary"
