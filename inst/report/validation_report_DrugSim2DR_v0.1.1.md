# Validation Report - DrugSim2DR@0.1.1
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Junwei Han <hanjunwei1981@163.com>                   |
...
Overall the package has 7 exported objects. 7 are documented:
           ...
           CalDEscore    DrugReposition      DrugSimscore           Gettest 
                 TRUE              TRUE              TRUE              TRUE 
         plotDruglink plotDrugstructure plotTargetheatmap 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:48:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42b50ab69_1739854129
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB8dqaZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DrugSim2DR_v0.1.1-tikzDictionary"
