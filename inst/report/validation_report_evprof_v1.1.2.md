# Validation Report - evprof@1.1.2
...
| export_help          | 32                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Marc Cañigueral <marc.canigueral@udg.edu> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/mcanigueral/evprof/    |
...
Overall the package has 32 exported objects. 32 are documented:
                       ...
                       choose_k_GMM                cluster_sessions 
                               TRUE                            TRUE 
                       cut_sessions                 define_clusters 
                               TRUE                            TRUE 
                    detect_outliers         divide_by_disconnection 
                               TRUE                            TRUE 
                divide_by_timecycle                   drop_outliers 
                               TRUE                            TRUE 
    get_charging_rates_distribution           get_connection_models 
                               TRUE                            TRUE 
           get_daily_avg_n_sessions            get_daily_n_sessions 
                               TRUE                            TRUE 
                  get_dbscan_params               get_energy_models 
                               TRUE                            TRUE 
                       get_ev_model                   plot_bivarGMM 
                               TRUE                            TRUE 
                    plot_density_2D                 plot_density_3D 
                               TRUE                            TRUE 
                plot_division_lines              plot_energy_models 
                               TRUE                            TRUE 
                     plot_histogram             plot_histogram_grid 
                               TRUE                            TRUE 
                       plot_kNNdist             plot_model_clusters 
                               TRUE                            TRUE 
                      plot_outliers                     plot_points 
                               TRUE                            TRUE 
                      read_ev_model               round_to_interval 
                               TRUE                            TRUE 
         save_clustering_iterations                   save_ev_model 
                               TRUE                            TRUE 
                       set_profiles              summarise_sessions 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-19 04:43:56 UTC |
...
running this report
    ...
    PROCESSX_PS1d45523d299f_1739940230
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaNuPlO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evprof_v1.1.2-tikzDictionary"
