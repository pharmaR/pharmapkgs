# Validation Report - BeeGUTS@1.3.0
...
| export_help          | 15                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Benoit Goussen <benoit.goussen@ibacon.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/bgoussen/BeeGUTS        |
...
Overall the package has 15 exported objects. 15 are documented:
                 ...
                 concAC              concAO             concCst    correlation_plot 
                   TRUE                TRUE                TRUE                TRUE 
          criteriaCheck            dataGUTS          fitBeeGUTS                 LCx 
                   TRUE                TRUE                TRUE                TRUE 
                    ppc            predict2 priorposterior_plot    ShortTimeEffects 
                   TRUE                TRUE                TRUE                TRUE 
              traceplot                 TRT            validate 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 03:51:22 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd190e7612_1739591477
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnYYXIL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BeeGUTS_v1.3.0-tikzDictionary"
