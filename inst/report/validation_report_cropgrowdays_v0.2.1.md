# Validation Report - cropgrowdays@0.2.1
...
| export_help          | 11                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Peter Baker <drpetebaker@gmail.com>        |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://gitlab.com/petebaker/cropgrowdays/ |
...
Overall the package has 11 exported objects. 11 are documented:
             ...
             cumulative          daily_mean  date_from_day_year      day_of_harvest 
                   TRUE                TRUE                TRUE                TRUE 
            day_of_year  get_multi_silodata        get_silodata growing_degree_days 
                   TRUE                TRUE                TRUE                TRUE 
         number_of_days    stress_days_over     weather_extract 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:23:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62de51143_1739766174
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpioOi0G
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cropgrowdays_v0.2.1-tikzDictionary"
