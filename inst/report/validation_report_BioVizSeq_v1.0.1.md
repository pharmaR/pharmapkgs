# Validation Report - BioVizSeq@1.0.1
...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Shiqi Zhao <zhaosq89@163.com>                        |
...
Overall the package has 22 exported objects. 22 are documented:
                 ...
                 biovizseq               cdd_plot             cdd_to_loc 
                      TRUE                   TRUE                   TRUE 
                   combi_p              fastaleng             geom_rrect 
                      TRUE                   TRUE                   TRUE 
                  gff_plot             gff_to_loc              meme_plot 
                      TRUE                   TRUE                   TRUE 
                  meme_seq            meme_to_loc             motif_plot 
                      TRUE                   TRUE                   TRUE 
                 pfam_plot            pfam_to_loc     plantcare_classify 
                      TRUE                   TRUE                   TRUE 
            plantcare_plot   plantcare_statistic1   plantcare_statistic2 
                      TRUE                   TRUE                   TRUE 
          plantcare_to_loc             smart_plot           smart_to_loc 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:16:15 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd45d392a1_1739592970
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvL9OF3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BioVizSeq_v1.0.1-tikzDictionary"
