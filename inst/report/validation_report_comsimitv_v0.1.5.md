# Validation Report - comsimitv@0.1.5
...
| export_help | 3 |
| has_website | FALSE |
| has_maintainer | Zoltan Botta-Dukat <botta-dukat.zoltan@okologia.mta.hu> |
...
Overall the package has 3 exported objects. 3 are documented:
     ...
     comm.sampling     comm.simul trait.sampling 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 03:38:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6fd818bf_1739763504
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFPswz4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comsimitv_v0.1.5-tikzDictionary"
