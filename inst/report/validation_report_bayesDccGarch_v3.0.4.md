# Validation Report - bayesDccGarch@3.0.4
...
| export_help          | 10                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Jose Augusto Fiorucci <jafiorucci@gmail.com> |
| bugs_status          | 0                                            |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            bayesDccGarch                dssged               dssnorm 
                     TRUE                  TRUE                  TRUE 
                     dsst           increaseSim        logLikDccGarch 
                     TRUE                  TRUE                  TRUE 
       plot.bayesDccGarch               plotVol predict.bayesDccGarch 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-15 03:33:26 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd26f8d816_1739590402
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkqaEmG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesDccGarch_v3.0.4-tikzDictionary"
