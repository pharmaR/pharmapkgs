# Validation Report - colourvalues@0.3.9
...
| export_help          | 12                                     |
| has_website          | TRUE                                   |
| has_maintainer       | David Cooley <dcooley@symbolix.com.au> |
...
|     | package           | type      |
|:----|:------------------|:----------|
| 1   | BH (\>= 1.81.0)   | LinkingTo |
| 2   | Rcpp (\>= 1.0.10) | LinkingTo |
| 3   | graphics          | Imports   |
...
leafgl, mapdeck, mariner, miaSim, rTwig, spatialrisk, spatialwidget

## Namespace

Overall the package has 12 exported objects. 12 are documented:

       color_palettes      color_values  color_values_rgb   colour_palettes 
                 TRUE              TRUE              TRUE              TRUE 
        colour_values colour_values_rgb     convert_color    convert_colors 
                 TRUE              TRUE              TRUE              TRUE 
       convert_colour   convert_colours       get_palette      show_colours 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 05:01:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3479706d0_1739682083
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUrF3Vb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colourvalues_v0.3.9-tikzDictionary"
