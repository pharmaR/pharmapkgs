# Validation Report - cryptoQuotes@1.3.2
...
| export_help          | 34                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Serkan Korkmaz <serkor1@duck.com>       |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/serkor1/cryptoQuotes |
...
|:----|:----------------------|:--------|
| 1   | cli (\>= 3.6.3)       | Imports |
| 2   | curl (\>= 5.2.1)      | Imports |
| 3   | jsonlite (\>= 1.8.8)  | Imports |
| 4   | lifecycle (\>= 1.0.4) | Imports |
| 5   | plotly (\>= 4.10.4)   | Imports |
| 6   | TTR (\>= 0.24.4)      | Imports |
| 7   | utils                 | Imports |
| 8   | xts (\>= 0.14.0)      | Imports |
...
Overall the package has 34 exported objects. 34 are documented:
                   ...
                   alma available_exchanges available_intervals   available_tickers 
                   TRUE                TRUE                TRUE                TRUE 
        bollinger_bands    calibrate_window               chart                dema 
                   TRUE                TRUE                TRUE                TRUE 
       donchian_channel                 ema               evwma                 fgi 
                   TRUE                TRUE                TRUE                TRUE 
            get_fgindex     get_fundingrate         get_lsratio    get_openinterest 
                   TRUE                TRUE                TRUE                TRUE 
              get_quote                 hma               kline                 lsr 
                   TRUE                TRUE                TRUE                TRUE 
                   macd                ohlc               pline            read_xts 
                   TRUE                TRUE                TRUE                TRUE 
           remove_bound                 rsi                 sma                 smi 
                   TRUE                TRUE                TRUE                TRUE 
           split_window              volume                vwap                 wma 
                   TRUE                TRUE                TRUE                TRUE 
              write_xts               zlema 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:28:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6d8cc2c2_1739766510
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0aCjd7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cryptoQuotes_v1.3.2-tikzDictionary"
