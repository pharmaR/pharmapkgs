# Validation Report - elitism@1.1.1
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jiangtao Gou <gouRpackage@gmail.com>                 |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | MASS (\>= 7.0.0)  | Imports |
| 2   | stats (\>= 4.0.0) | Imports |
...
| Execution Time | 2025-02-19 03:56:23 UTC |
...
running this report
    ...
    PROCESSX_PS1d45383be1aa_1739937377
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp17NsAs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_elitism_v1.1.1-tikzDictionary"
