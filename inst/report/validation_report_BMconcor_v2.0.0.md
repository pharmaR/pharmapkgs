# Validation Report - BMconcor@2.0.0
...
| export_help | 13 |
| has_website | TRUE |
| has_maintainer | Fabio Ashtar Telarico <Fabio-Ashtar.Telarico@fdv.uni-lj.si> |
...
Overall the package has 13 exported objects. 13 are documented:
          ...
          concor   concorcano     concoreg     concorgm concorgmcano  concorgmreg 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
         concors  concorscano   concorsreg       svdbip      svdbip2      svdbips 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           svdcp 
            TRUE 
...
| Execution Time | 2025-02-15 04:26:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd39cb6abc_1739593569
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpgnq2lj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BMconcor_v2.0.0-tikzDictionary"
