# Validation Report - bbdetection@1.0
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Valeriy Zakamulin <valeriz@uia.no>                   |
...
Overall the package has 7 exported objects. 7 are documented:
        ...
        bb.dating.states              bb.plot      bb.summary.stat 
                    TRUE                 TRUE                 TRUE 
          run_dating_alg    run_filtering_alg    setpar_dating_alg 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 03:43:39 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6ad9b469_1739591014
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2ogK9z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bbdetection_v1.0-tikzDictionary"
