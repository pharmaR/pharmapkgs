# Validation Report - eatTools@0.7.8
...
| export_help | 38 |
| has_website | TRUE |
| has_maintainer | Sebastian Weirich <sebastian.weirich@iqb.hu-berlin.de> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/weirichs/eatTools |
...
Overall the package has 38 exported objects. 19 are documented:

                         %$$%  addLeadingZerosToCharInt       asNumericIfPossible 
                        FALSE                      TRUE                      TRUE 
    catch_asNumericIfPossible            cleanifyString        contr.wec.weighted 
                         TRUE                      TRUE                      TRUE 
                         crop                     descr    do_call_rbind_withName 
                         TRUE                      TRUE                      TRUE 
    existsBackgroundVariables                 facToChar                   gsubAll 
                         TRUE                      TRUE                     FALSE 
                  halveString                insert.col             makeDataFrame 
                        FALSE                     FALSE                     FALSE 
                     makeTria                 mergeAttr                  multiseq 
                        FALSE                     FALSE                      TRUE 
            na_omit_selection                num.to.cat         print_and_capture 
                        FALSE                     FALSE                     FALSE 
                          pwc              rbind_common         rbind_fill_vector 
                        FALSE                     FALSE                     FALSE 
                 readMultisep              recodeLookup          removeNonNumeric 
                         TRUE                     FALSE                      TRUE 
                removeNumeric             removePattern                   roundDF 
                         TRUE                      TRUE                      TRUE 
                         seq2              set.col.type              tablePattern 
                         TRUE                      TRUE                      TRUE 
                  tableUnlist                  whereAre                wideToLong 
                        FALSE                     FALSE                     FALSE 
                     wtdTable                    wtdVar 
                        FALSE                     FALSE 
...
| Execution Time | 2025-02-18 05:14:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45a70a03f_1739855652
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbiY4PQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eatTools_v0.7.8-tikzDictionary"
