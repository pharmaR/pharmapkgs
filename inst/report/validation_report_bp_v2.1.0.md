...
| export_help          | 19                                    |
| has_website          | TRUE                                  |
| has_maintainer       | John Schwenck <jschwenck12@gmail.com> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/johnschwenck/bp    |
...
Overall the package has 19 exported objects. 18 are documented:
                 ...
                 %>%           bp_arv        bp_center            bp_cv 
               FALSE             TRUE             TRUE             TRUE 
             bp_hist           bp_mag         bp_range        bp_report 
                TRUE             TRUE             TRUE             TRUE 
          bp_scatter bp_sleep_metrics        bp_stages         bp_stats 
                TRUE             TRUE             TRUE             TRUE 
               bp_sv        bp_tables      bp_ts_plots         dip_calc 
                TRUE             TRUE             TRUE             TRUE 
      dip_class_plot    dow_tod_plots     process_data 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:37:55 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3f4805de_1739594270
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHmNo47
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bp_v2.1.0-tikzDictionary"
