# Validation Report - devRate@0.2.4
...
| export_help          | 17                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Francois Rebaudo <francois.rebaudo@ird.fr> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/frareb/devRate/         |
...
Overall the package has 17 exported objects. 17 are documented:
           ...
           devRateFind         devRateIBM devRateIBMdataBase      devRateIBMgen 
                  TRUE               TRUE               TRUE               TRUE 
       devRateIBMparam     devRateIBMPlot        devRateInfo         devRateMap 
                  TRUE               TRUE               TRUE               TRUE 
          devRateModel    devRateModelAll        devRatePlot    devRatePlotInfo 
                  TRUE               TRUE               TRUE               TRUE 
          devRatePrint       devRateQlBio      devRateQlStat       dRGetMetrics 
                  TRUE               TRUE               TRUE               TRUE 
      dRGetMetricsInfo 
                  TRUE 
...
| Execution Time | 2025-02-18 03:51:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43fcf04a5_1739850699
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcSSksq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_devRate_v0.2.4-tikzDictionary"
