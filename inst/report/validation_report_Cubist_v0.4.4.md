# Validation Report - Cubist@0.4.4
...
| has_source_control   | https://github.com/topepo/Cubist |
| has_bug_reports_url  | 1                                |
| downloads_1yr        | 259167                           |
...
C50, caret, caretForecast, dendroTools, dissever, finnts, flowml,
fscaret, geomod, imputeR, mlr, pdp, rminer, rules, soilassessment,
tidypredict, tidyrules, tsensembler, utsf, viralmodels, viralx

## Namespace

Overall the package has 6 exported objects. 6 are documented:

               cubist     cubistControl exportCubistFiles      makeDataFile 
                 TRUE              TRUE              TRUE              TRUE 
        makeNamesFile QuinlanAttributes 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-17 04:38:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bd643f47051_1739767082
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRCbkl2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Cubist_v0.4.4-tikzDictionary"
