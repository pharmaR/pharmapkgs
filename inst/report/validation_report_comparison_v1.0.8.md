# Validation Report - comparison@1.0.8
...
| has_source_control   | https://github.com/jmcurran/comparison |
...
Overall the package has 13 exported objects. 13 are documented:
                        ...
                        calc.ece                       calcLR 
                            TRUE                         TRUE 
                   calibrate.set   logistic.apply.calibration 
                            TRUE                         TRUE 
    logistic.calibrate.get.model       logistic.calibrate.set 
                            TRUE                         TRUE 
                    makeCompItem                  makeCompVar 
                            TRUE                         TRUE 
      two.level.comparison.items         two.level.components 
                            TRUE                         TRUE 
            two.level.density.LR         two.level.lindley.LR 
                            TRUE                         TRUE 
             two.level.normal.LR 
                            TRUE 
...
| Execution Time | 2025-02-17 03:34:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61b95f6a0_1739763285
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEm3FGG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_comparison_v1.0.8-tikzDictionary"
