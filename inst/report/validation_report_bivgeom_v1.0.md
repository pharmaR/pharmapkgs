...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alessandro Barbiero <alessandro.barbiero@unimi.it>   |
...
Overall the package has 14 exported objects. 14 are documented:
    ...
    corbivgeomRoy   dbivgeomRoy estbivgeomRoy EyxbivgeomRoy   FbivgeomRoy 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    FyxbivgeomRoy    lambda1Roy    lambda2Roy loglikgeomRoy   minuslogRoy 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      rbivgeomRoy RelbivgeomRoy           S.n   SbivgeomRoy 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-15 04:19:28 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2dac79a4_1739593163
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphlY8sR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bivgeom_v1.0-tikzDictionary"
