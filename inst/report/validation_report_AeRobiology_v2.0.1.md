...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | “Jose Oteros” <OterosJose@gmail.com>                 |
...
Overall the package has 17 exported objects. 17 are documented:
       ...
       analyse_trend     calculate_ps          credits      interpollen 
                TRUE             TRUE             TRUE             TRUE 
     iplot_abundance      iplot_pheno     iplot_pollen      iplot_years 
                TRUE             TRUE             TRUE             TRUE 
                  ma    plot_heathour        plot_hour plot_normsummary 
                TRUE             TRUE             TRUE             TRUE 
             plot_ps     plot_summary       plot_trend  pollen_calendar 
                TRUE             TRUE             TRUE             TRUE 
     quality_control 
                TRUE 
...
| Execution Time | 2025-02-14 06:40:46 UTC |
...
running this report
    ...
    PROCESSX_PS726d42715f33_1739515244
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1Zkhk4
