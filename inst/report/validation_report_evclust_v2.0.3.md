# Validation Report - evclust@2.0.3
...
| export_help          | 28                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Thierry Denoeux <tdenoeux@utc.fr>                    |
...
Overall the package has 28 exported objects. 28 are documented:
                  ...
                  bananas              bootclus                  bpec 
                     TRUE                  TRUE                  TRUE 
                     cecm create_fuzzy_credpart  create_hard_credpart 
                     TRUE                  TRUE                  TRUE 
              create_MLCL               createD           createPairs 
                     TRUE                  TRUE                  TRUE 
                credal_RI             delta_Bel                   ecm 
                     TRUE                  TRUE                  TRUE 
                 EkNNclus            expandlink           extractMass 
                     TRUE                  TRUE                  TRUE 
                   harris              kcevclus               kevclus 
                     TRUE                  TRUE                  TRUE 
                 knn_dist                 kpcca                 makeF 
                     TRUE                  TRUE                  TRUE 
                 nnevclus           nnevclus_mb        nonspecificity 
                     TRUE                  TRUE                  TRUE 
       normalize.credpart         pairwise_mass                  pcca 
                     TRUE                  TRUE                  TRUE 
                     recm 
                     TRUE 
...
| Execution Time | 2025-02-19 04:39:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d457ce3dc60_1739939934
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxSCsRi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evclust_v2.0.3-tikzDictionary"
