# Validation Report - BayesCPclust@0.1.0
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ana Carolina da Cruz <adacruz@uwo.ca>                |
...
Overall the package has 16 exported objects. 16 are documented:
        ...
        full_cond     gibbs_alg     logsumexp          Mode            pk 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       possigma2n    postalpha0    postalphak         postK      postK_mk 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           postmk           qn0        qn0_mk           qnj     run_gibbs 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    update_lambda 
             TRUE 
...
| Execution Time | 2025-02-15 03:32:51 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd64f76175_1739590366
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDi6wNb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesCPclust_v0.1.0-tikzDictionary"
