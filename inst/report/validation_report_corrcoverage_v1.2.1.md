# Validation Report - corrcoverage@1.2.1
...
| export_help          | 26                                                  |
| has_website          | TRUE                                                |
| has_maintainer       | Anna Hutchinson <anna.hutchinson@mrc-bsu.cam.ac.uk> |
...
Overall the package has 26 exported objects. 25 are documented:
                  ...
                  %>%       approx.bf.p           bf_func              cor2 
                FALSE              TRUE              TRUE              TRUE 
              corrcov      corrcov_bhat        corrcov_CI   corrcov_CI_bhat 
                 TRUE              TRUE              TRUE              TRUE 
         corrcov_nvar corrcov_nvar_bhat     corrected_cov      corrected_cs 
                 TRUE              TRUE              TRUE              TRUE 
    corrected_cs_bhat           credset          credsetC        credsetmat 
                 TRUE              TRUE              TRUE              TRUE 
               est_mu       est_mu_bhat            logsum            ppfunc 
                 TRUE              TRUE              TRUE              TRUE 
           ppfunc.mat          pvals_pp       Var.data.cc             z_sim 
                 TRUE              TRUE              TRUE              TRUE 
                z0_pp             zj_pp 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-17 03:59:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63cf9c07e_1739764773
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBkUIEt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corrcoverage_v1.2.1-tikzDictionary"
