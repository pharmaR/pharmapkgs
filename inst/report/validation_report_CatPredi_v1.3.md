# Validation Report - CatPredi@1.3
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Irantzu Barrio <irantzu.barrio@ehu.eus>              |
...
Overall the package has 10 exported objects. 10 are documented:
                     ...
                     catpredi         catpredi.survival            comp.cutpoints 
                         TRUE                      TRUE                      TRUE 
      comp.cutpoints.survival           controlcatpredi  controlcatpredi.survival 
                         TRUE                      TRUE                      TRUE 
                plot.catpredi    plot.catpredi.survival          summary.catpredi 
                         TRUE                      TRUE                      TRUE 
...
| Execution Time | 2025-02-16 03:47:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bc337180f09_1739677650
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplKckXv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CatPredi_v1.3-tikzDictionary"
