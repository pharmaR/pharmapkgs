# Validation Report - blindrecalc@1.0.1
...
| has_source_control   | https://github.com/imbi-heidelberg/blindrecalc       |
...
Overall the package has 9 exported objects. 14 are documented:

            adjusted_alpha                 n_dist                  n_fix 
                      TRUE                   TRUE                   TRUE 
                       pow         setupChiSquare setupFarringtonManning 
                      TRUE                   TRUE                   TRUE 
              setupStudent             simulation                   toer 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:22:15 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3db2b1ba_1739593330
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpY8AzVK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blindrecalc_v1.0.1-tikzDictionary"
