...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Danilo Petti <d.petti@essex.ac.uk>                   |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | copent (\>= 0.4)    | Imports |
| 2   | ggplot2 (\>= 3.4.3) | Imports |
| 3   | GJRM (\>= 0.2-6.4)  | Imports |
| 4   | mvtnorm (\>= 1.2-4) | Imports |
| 5   | stats               | Imports |
| 6   | utils               | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    backward_selection_BivCop                     BRBVS  forward_selection_BivCop 
                         TRUE                      TRUE                      TRUE 
                    plotBRBVS        Select_link_BivCop 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-15 04:42:00 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd318e7cf5_1739594515
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNBy9qf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BRBVS_v0.2.1-tikzDictionary"
