...
| export_help          | 20                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Emil Hvitfeldt <emil.hvitfeldt@posit.co> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/tidymodels/embed      |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | recipes (\>= 1.1.0)  | Depends |
| 2   | cli                  | Imports |
| 3   | glue                 | Imports |
| 4   | dplyr (\>= 1.1.0)    | Imports |
| 5   | generics (\>= 0.1.0) | Imports |
| 6   | lifecycle            | Imports |
| 7   | purrr                | Imports |
| 8   | rlang (\>= 1.1.0)    | Imports |
| 9   | rsample              | Imports |
| 10  | stats                | Imports |
| 11  | tibble               | Imports |
| 12  | tidyr                | Imports |
...
bundle, orbital, tidybins, tidytof

## Namespace

Overall the package has 20 exported objects. 20 are documented:

                     add_woe               dictionary            embed_control 
                        TRUE                     TRUE                     TRUE 
               required_pkgs       step_collapse_cart step_collapse_stringdist 
                        TRUE                     TRUE                     TRUE 
        step_discretize_cart      step_discretize_xgb               step_embed 
                        TRUE                     TRUE                     TRUE 
           step_feature_hash       step_lencode_bayes         step_lencode_glm 
                        TRUE                     TRUE                     TRUE 
          step_lencode_mixed          step_pca_sparse    step_pca_sparse_bayes 
                        TRUE                     TRUE                     TRUE 
          step_pca_truncated                step_umap                 step_woe 
                        TRUE                     TRUE                     TRUE 
                        tidy                  tunable 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-19 04:00:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d451385d37f_1739937595
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDGXZZB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_embed_v1.1.5-tikzDictionary"
