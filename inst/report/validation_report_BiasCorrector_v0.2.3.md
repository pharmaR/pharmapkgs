# Validation Report - BiasCorrector@0.2.3
...
| has_source_control   | https://github.com/kapsner/BiasCorrector     |
...
| 2   | DT                          | Imports |
| 3   | magrittr                    | Imports |
| 4   | rBiasCorrection (\>= 0.3.4) | Imports |
| 5   | shiny                       | Imports |
| 6   | shinydashboard              | Imports |
| 7   | shinyjs                     | Imports |
...
Overall the package has 25 exported objects. 25 are documented:
                        ...
                        launch_app  module_calibrationfile_server 
                              TRUE                           TRUE 
         module_calibrationfile_ui   module_correctedplots_server 
                              TRUE                           TRUE 
          module_correctedplots_ui  module_correctedstatistics_ui 
                              TRUE                           TRUE 
      module_correctedstats_server module_experimentalfile_server 
                              TRUE                           TRUE 
        module_experimentalfile_ui       module_fileupload_server 
                              TRUE                           TRUE 
              module_fileupload_ui             module_info_server 
                              TRUE                           TRUE 
                    module_info_ui              module_log_server 
                              TRUE                           TRUE 
                     module_log_ui   module_modelselection_server 
                              TRUE                           TRUE 
          module_modelselection_ui         module_plotting_server 
                              TRUE                           TRUE 
                module_plotting_ui          module_results_server 
                              TRUE                           TRUE 
                 module_results_ui         module_settings_server 
                              TRUE                           TRUE 
                module_settings_ui       module_statistics_server 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-15 04:00:30 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd35a4c60c_1739592026
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVRnZRU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BiasCorrector_v0.2.3-tikzDictionary"
