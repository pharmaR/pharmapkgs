# Validation Report - dynsim@1.2.3
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | ggplot2 (\>= 1.0.1.9003) | Imports |
| 2   | grid                     | Imports |
| 3   | gridExtra (\>= 2.0.0)    | Imports |
| 4   | MASS                     | Imports |
...
| Execution Time | 2025-02-18 05:07:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb428ecd73_1739855220
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5oSYWp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dynsim_v1.2.3-tikzDictionary"
