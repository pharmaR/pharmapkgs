# Validation Report - BayesGWQS@0.1.1
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Matthew Carli <carlimm@mymail.vcu.edu>               |
...
Overall the package has 4 exported objects. 4 are documented:
      ...
      bgwqs.fit      make.X    make.x.s weight.plot 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-15 03:35:29 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd584832a0_1739590525
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgT2z3f
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesGWQS_v0.1.1-tikzDictionary"
