# Validation Report - adelie@1.0.6
...
Overall the package has 34 exported objects. 34 are documented:
                 ...
                 coef.glintnet                coef.grpnet 
                          TRUE                       TRUE 
                   cv.glintnet                  cv.grpnet 
                          TRUE                       TRUE 
                  gaussian_cov                   glintnet 
                          TRUE                       TRUE 
                  glm.binomial                    glm.cox 
                          TRUE                       TRUE 
                  glm.gaussian          glm.multigaussian 
                          TRUE                       TRUE 
               glm.multinomial                glm.poisson 
                          TRUE                       TRUE 
                        grpnet     io.snp_phased_ancestry 
                          TRUE                       TRUE 
               io.snp_unphased          matrix.block_diag 
                          TRUE                       TRUE 
            matrix.concatenate         matrix.convex_relu 
                          TRUE                       TRUE 
    ...
    matrix.snp_phased_ancestry        matrix.snp_unphased 
                 ...
                 matrix.subset                plot.grpnet 
                          TRUE                       TRUE 
              predict.glintnet             predict.grpnet 
                          TRUE                       TRUE 
               print.cv.grpnet                set_configs 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-14 07:16:34 UTC |
...
running this report
    ...
    PROCESSX_PS1c0914b5f6ff_1739517392
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsVa4cY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_adelie_v1.0.6-tikzDictionary"
