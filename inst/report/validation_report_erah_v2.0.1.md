...
| export_help | 30 |
| has_website | TRUE |
| has_maintainer | Xavier Domingo-Almenara <xavier.domingoa@eurecat.org> |
| bugs_status | subscript out of bounds |
| has_bug_reports_url | 1 |
| downloads_1yr | 3952 |
| reverse_dependencies | 0 |
| has_examples | 0.8857143 |
| dependencies | 10 |
| license | GPL (\>= 2) |
...
Overall the package has 30 exported objects. 30 are documented:
                  ...
                  alignComp               alignList                compInfo 
                       TRUE                    TRUE                    TRUE 
             computeRIerror                createdt createInstrumentalTable 
                       TRUE                    TRUE                    TRUE 
           createPhenoTable                dataList          deconvolveComp 
                       TRUE                    TRUE                    TRUE 
                 expClasses              export2CEF              export2MSP 
                       TRUE                    TRUE                    TRUE 
                   findComp            identifyComp                  idList 
                       TRUE                    TRUE                    TRUE 
                  importGMD               importMSP                metaData 
                       TRUE                    TRUE                    TRUE 
                     newExp               phenoData                    plan 
                       TRUE                    TRUE                    TRUE 
                  plotAlign                 plotChr             plotProfile 
                       TRUE                    TRUE                    TRUE 
                plotSpectra             recMissComp              sampleInfo 
                       TRUE                    TRUE                    TRUE 
                   setAlPar               setDecPar           showRTRICurve 
                       TRUE                    TRUE                    TRUE 

### Examples

There are 31 help pages with examples, from 35 (88.57 %).
...
| Execution Time | 2025-02-19 04:25:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d457c2952e2_1739939104
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFbbtxJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_erah_v2.0.1-tikzDictionary"
