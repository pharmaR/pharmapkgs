# Validation Report - chinese.misc@0.2.3
...
| export_help | 33 |
| has_website | TRUE |
| has_maintainer | Jiang Wu <textidea@sina.com> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/githubwwwjjj/chinese.misc/blob/master/README.md |
...
Overall the package has 33 exported objects. 33 are documented:
          ...
          as.character2         as.numeric2         corp_or_dtm          create_ttm 
                   TRUE                TRUE                TRUE                TRUE 
                csv2txt    DEFAULT_control1    DEFAULT_control2      DEFAULT_cutter 
                   TRUE                TRUE                TRUE                TRUE 
         dictionary_dtm         dir_or_file        get_tag_word  get_tmp_chi_locale 
                   TRUE                TRUE                TRUE                TRUE 
    is_character_vector is_positive_integer               m2doc                 m3m 
                   TRUE                TRUE                TRUE                TRUE 
          make_stoplist       match_pattern          output_dtm              scancn 
                   TRUE                TRUE                TRUE                TRUE 
               seg_file           slim_text             sort_tf         sparse_left 
                   TRUE                TRUE                TRUE                TRUE 
                 tf2doc         topic_trend             txt2csv                   V 
                   TRUE                TRUE                TRUE                TRUE 
                     VC                 VCR                  VR                 VRC 
                   TRUE                TRUE                TRUE                TRUE 
               word_cor 
...
| Execution Time | 2025-02-16 04:13:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32b333c41_1739679215
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDr3WaL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chinese.misc_v0.2.3-tikzDictionary"
