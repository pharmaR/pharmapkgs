# Validation Report - crunchy@0.3.3
...
| has_source_control   | https://github.com/Crunch-io/crunchy |
...
Overall the package has 15 exported objects. 14 are documented:
             ...
             .getUserRecord          crunchFillPage         crunchFluidPage 
                      FALSE                    TRUE                    TRUE 
           crunchNavbarPage              crunchPage             crunchyBody 
                       TRUE                    TRUE                    TRUE 
          crunchyPublicBody           crunchyServer crunchyUnauthorizedBody 
                       TRUE                    TRUE                    TRUE 
          listDatasetGadget         makeArrayGadget setCrunchyAuthorization 
                       TRUE                    TRUE                    TRUE 
               shinyDataset               shinyUser     withCrunchyProgress 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-17 04:27:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bd650e3b29e_1739766461
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEWPXc6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crunchy_v0.3.3-tikzDictionary"
