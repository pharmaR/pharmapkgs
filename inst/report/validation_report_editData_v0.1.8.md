# Validation Report - editData@0.1.8
...
| has_source_control   | https://github.com/cardiomoon/editData |
...
ggplotAssist, htsr, rrtable, SemNetCleaner

## Namespace

Overall the package has 15 exported objects. 15 are documented:

     checkboxInput3      dateInput3      editableDT    editableDTUI        editData 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          editFiles          label3           myget        myimport   numericInput3 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       pickerInput3   radioButtons3    selectInput3 selectizeInput3      textInput3 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 03:42:00 UTC |
...
running this report
    ...
    PROCESSX_PS1d459a24068_1739936514
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYo3eIm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_editData_v0.1.8-tikzDictionary"
