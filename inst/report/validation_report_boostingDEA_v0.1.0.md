# Validation Report - boostingDEA@0.1.0
...
| export_help          | 14                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Maria D. Guillen <maria.guilleng@umh.es>      |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/itsmeryguillen/boostingDEA |
...
Overall the package has 14 exported objects. 14 are documented:
        ...
        bestEATBoost    bestMARSBoost      CobbDouglas              DEA 
                TRUE             TRUE             TRUE             TRUE 
          DEA_object              EAT         EATBoost  EATBoost_object 
                TRUE             TRUE             TRUE             TRUE 
          efficiency              FDH       FDH_object      MARSAdapted 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:32:44 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd20ed59f1_1739593958
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcxNCbu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_boostingDEA_v0.1.0-tikzDictionary"
