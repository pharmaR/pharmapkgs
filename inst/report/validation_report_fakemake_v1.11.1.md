# Validation Report - fakemake@1.11.1
...
| has_source_control   | https://gitlab.com/fvafrcu/fakemake                  |
...
Overall the package has 10 exported objects. 10 are documented:
           ...
           add_target        get_target              make provide_make_list 
                 TRUE              TRUE              TRUE              TRUE 
        read_makefile     remove_target          sink_all             touch 
                 TRUE              TRUE              TRUE              TRUE 
            visualize    write_makefile 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-19 05:08:47 UTC |
...
running this report
    ...
    PROCESSX_PS1d453317af33_1739941720
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLBJUPO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fakemake_v1.11.1-tikzDictionary"
