# Validation Report - cubble@1.0.0
...
| has_source_control   | https://github.com/huizezhang-sherry/cubble |
...
Overall the package has 29 exported objects. 29 are documented:
                       ...
                       as_cubble  bind_cols.spatial_cubble_df 
                            TRUE                         TRUE 
    bind_cols.temporal_cubble_df bind_rows.temporal_cubble_df 
                            TRUE                         TRUE 
                       check_key                       coords 
                            TRUE                         TRUE 
                          cubble                 face_spatial 
                            TRUE                         TRUE 
                   face_temporal                       filter 
                            TRUE                         TRUE 
                      geom_glyph               geom_glyph_box 
                            TRUE                         TRUE 
                 geom_glyph_line                        index 
                            TRUE                         TRUE 
                       index_var                    is_cubble 
                            TRUE                         TRUE 
               is_cubble_spatial           is_cubble_temporal 
                            TRUE                         TRUE 
                           is_sf                   is_tsibble 
                            TRUE                         TRUE 
                     make_cubble              make_spatial_sf 
                            TRUE                         TRUE 
           make_temporal_tsibble                  match_sites 
                            TRUE                         TRUE 
                   match_spatial               match_temporal 
                            TRUE                         TRUE 
                         spatial                       unfold 
                            TRUE                         TRUE 
                   update_cubble 
...
| Execution Time | 2025-02-17 04:37:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64b02c6d4_1739767045
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQulY41
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cubble_v1.0.0-tikzDictionary"
