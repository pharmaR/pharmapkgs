...
| export_help          | 33                                                  |
| has_website          | TRUE                                                |
| has_maintainer       | Magnus Dehli Vigeland <m.d.vigeland@medisin.uio.no> |
| bugs_status          | subscript out of bounds                             |
| has_source_control   | https://github.com/magnusdv/dvir                    |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | pedtools (\>= 2.6.0)  | Depends |
| 2   | forrel (\>= 1.5.2)    | Imports |
| 3   | pbapply               | Imports |
| 4   | pedFamilias           | Imports |
| 5   | pedprobr (\>= 0.8.0)  | Imports |
| 6   | ribd                  | Imports |
| 7   | verbalisr (\>= 0.7.1) | Imports |
...
Overall the package has 33 exported objects. 33 are documented:
            ...
            amDrivenDVI           Bmarginal            checkDVI     compactJointRes 
                   TRUE                TRUE                TRUE                TRUE 
            directMatch          dviCompare             dviData            dviJoint 
                   TRUE                TRUE                TRUE                TRUE 
                 dviSim            dviSolve      excludePairing     exclusionMatrix 
                   TRUE                TRUE                TRUE                TRUE 
      expand.grid.nodup       familias2dvir        findExcluded findNonidentifiable 
                   TRUE                TRUE                TRUE                TRUE 
         findUndisputed       formatSummary    generatePairings           getFamily 
                   TRUE                TRUE                TRUE                TRUE 
          getSimpleFams            jointDVI             mergePM               ncomb 
                   TRUE                TRUE                TRUE                TRUE 
             pairwiseLR             plotDVI        plotSolution      plotUndisputed 
                   TRUE                TRUE                TRUE                TRUE 
             relabelDVI       sequentialDVI          setPairing           subsetDVI 
                   TRUE                TRUE                TRUE                TRUE 
        swapOrientation 
                   TRUE 
...
| Execution Time | 2025-02-18 05:01:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44f486421_1739854870
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeaBn7O
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dvir_v3.3.0-tikzDictionary"
