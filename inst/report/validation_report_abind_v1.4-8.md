...
|---:|---:|---:|---:|:---|:---|:---|---:|---:|---:|---:|:---|
| 0 | 1 | 0 | 1 | FALSE | Tony Plate \<tplate at acm.org\> | package DESCRIPTION does not have a BugReports field | 0 | 4055453 | 305 | 2 | MIT + file LICENSE |
...
| Execution Time | 2025-02-07 17:47:18 UTC |
...
running this report
    ...
    PROCESSX_PS1e4c583c4aca_1738950433
                            YES
    ...
    QUARTO_FILTER_DEPENDENCY_FILE
                            /tmp/quarto-session64e42ce99ae7becb/929536a25defecf6/c67546a8bae6a00c
    QUARTO_PROFILE          
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoG3pjn
