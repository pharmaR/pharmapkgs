...
| export_help | 10 |
| has_website | TRUE |
| has_maintainer | Paolo Maranzano <pmaranzano.ricercastatistica@gmail.com> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/PaoloMaranzano/EEAaq_R |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            EEAaq_export       EEAaq_get_data  EEAaq_get_dataframe 
                    TRUE                 TRUE                 TRUE 
      EEAaq_get_stations        EEAaq_idw_map         EEAaq_import 
                    TRUE                 TRUE                 TRUE 
      EEAaq_map_stations        EEAaq_summary EEAaq_time_aggregate 
                    TRUE                 TRUE                 TRUE 
             is_EEAaq_df 
                    TRUE 
...
| Execution Time | 2025-02-19 03:44:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d453b5dcc7d_1739936635
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnMGSwX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EEAaq_v1.0.0-tikzDictionary"
