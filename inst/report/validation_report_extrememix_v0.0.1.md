# Validation Report - extrememix@0.0.1
...
| has_source_control   | https://github.com/manueleleonelli/extrememix |
...
Overall the package has 23 exported objects. 23 are documented:
    ...
    check_convergence             dggpd               DIC           dmgamma 
                 TRUE              TRUE              TRUE              TRUE 
                dmgpd                ES             fggpd             fmgpd 
                 TRUE              TRUE              TRUE              TRUE 
                pggpd           pmgamma             pmgpd              pred 
                 TRUE              TRUE              TRUE              TRUE 
                qggpd           qmgamma             qmgpd             quant 
                 TRUE              TRUE              TRUE              TRUE 
         return_level             rggpd           rmgamma             rmgpd 
                 TRUE              TRUE              TRUE              TRUE 
          upper_bound               VaR              WAIC 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 04:57:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d4559ab42f5_1739941060
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJZgtHb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extrememix_v0.0.1-tikzDictionary"
