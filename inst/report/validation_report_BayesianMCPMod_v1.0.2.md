# Validation Report - BayesianMCPMod@1.0.2
...
| has_source_control | https://github.com/Boehringer-Ingelheim/BayesianMCPMod |
...
Overall the package has 10 exported objects. 10 are documented:
             ...
             assessDesign getBootstrapQuantiles              getContr 
                     TRUE                  TRUE                  TRUE 
              getCritProb                getESS          getModelFits 
                     TRUE                  TRUE                  TRUE 
             getPosterior    performBayesianMCP performBayesianMCPMod 
                     TRUE                  TRUE                  TRUE 
             simulateData 
                     TRUE 
...
| Execution Time | 2025-02-15 03:36:10 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd38caa809_1739590566
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7utJgF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesianMCPMod_v1.0.2-tikzDictionary"
