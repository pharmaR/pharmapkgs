# Validation Report - codingMatrices@0.4.0
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            code_control    code_control_last       code_deviation 
                    TRUE                 TRUE                 TRUE 
    code_deviation_first            code_diff    code_diff_forward 
                    TRUE                 TRUE                 TRUE 
            code_helmert code_helmert_forward            code_poly 
                    TRUE                 TRUE                 TRUE 
              contr.diff       mean_contrasts 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:52:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3385cf2c2_1739681572
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEXpliH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_codingMatrices_v0.4.0-tikzDictionary"
