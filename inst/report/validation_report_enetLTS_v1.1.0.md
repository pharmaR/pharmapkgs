# Validation Report - enetLTS@1.1.0
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Fatma Sevinc Kurnaz <fatmasevinckurnaz@gmail.com>    |
...
Overall the package has 13 exported objects. 13 are documented:
                ...
                cv.enetLTS                enetLTS         fitted.enetLTS 
                      TRUE                   TRUE                   TRUE 
                  lambda00    nonzeroCoef.enetLTS           plot.enetLTS 
                      TRUE                   TRUE                   TRUE 
          plotCoef.enetLTS plotDiagnostic.enetLTS      plotResid.enetLTS 
                      TRUE                   TRUE                   TRUE 
           predict.enetLTS          print.enetLTS      residuals.enetLTS 
                      TRUE                   TRUE                   TRUE 
           weights.enetLTS 
                      TRUE 
...
| Execution Time | 2025-02-19 04:07:45 UTC |
...
running this report
    ...
    PROCESSX_PS1d45126565a0_1739938059
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8o1jqZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_enetLTS_v1.1.0-tikzDictionary"
