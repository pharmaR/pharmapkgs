...
| export_help          | 23                                         |
| has_website          | FALSE                                      |
| has_maintainer       | Joshua French <joshua.french@ucdenver.edu> |
...
Overall the package has 23 exported objects. 21 are documented:

    .legend.horizontal        .legend.mar .legend.scale.args          autoimage 
                 FALSE              FALSE               TRUE               TRUE 
            autolayout         autolegend            automar         autopoints 
                  TRUE               TRUE               TRUE               TRUE 
              autosize         blank.plot        ggautoimage       heat_ppoints 
                  TRUE               TRUE               TRUE               TRUE 
          legend.scale            parrows              paxes             pimage 
                  TRUE               TRUE               TRUE               TRUE 
                plines            ppoints           ppolygon          psegments 
                  TRUE               TRUE               TRUE               TRUE 
                 ptext          reset.par             rotate 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-14 07:33:35 UTC |
...
running this report
    ...
    PROCESSX_PS1c097a37a60a_1739518412
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKQSo2a
