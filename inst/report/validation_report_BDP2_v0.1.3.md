...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Manuel Wiesenfarth <m.wiesenfarth@dkfz.de>           |
...
Overall the package has 10 exported objects. 10 are documented:
                 ...
                 BDP2     BDP2_simulate      BDP2workflow      crit_general 
                 TRUE              TRUE              TRUE              TRUE 
               pFstop       pFstopEcall       pFstopEstop plot.cE_vs_pEcall 
                 TRUE              TRUE              TRUE              TRUE 
    plot.cE_vs_pEstop          plotBDP2 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-15 03:48:35 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7eba0508_1739591310
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXHdTGV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BDP2_v0.1.3-tikzDictionary"
