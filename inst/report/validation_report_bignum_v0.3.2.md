# Validation Report - bignum@0.3.2
...
| export_help          | 11                                        |
| has_website          | TRUE                                      |
| has_maintainer       | David Hall <david.hall.physics@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/davidchall/bignum      |
...
Overall the package has 11 exported objects. 11 are documented:
                    ...
                    as_bigfloat               as_biginteger 
                           TRUE                        TRUE 
                       bigfloat                  biginteger 
                           TRUE                        TRUE 
                          bigpi                 is_bigfloat 
                           TRUE                        TRUE 
                  is_biginteger                NA_bigfloat_ 
                           TRUE                        TRUE 
                 NA_biginteger_ vec_arith.bignum_biginteger 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-15 04:04:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3e4ffe5d_1739592278
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWWt43A
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bignum_v0.3.2-tikzDictionary"
