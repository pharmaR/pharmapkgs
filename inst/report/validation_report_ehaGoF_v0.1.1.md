# Validation Report - ehaGoF@0.1.1
...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alper Gulbe <alper.gulbe@igdir.edu.tr>               |
...
Overall the package has 18 exported objects. 18 are documented:
         ...
         GoF  gofACoD   gofAIC  gofARSq  gofCAIC   gofCoD    gofCV   gofMAD 
        TRUE     TRUE     TRUE     TRUE     TRUE     TRUE     TRUE     TRUE 
     gofMAPE    gofME  gofMRAE    gofPC    gofPI   gofRAE  gofRMSE gofRRMSE 
        TRUE     TRUE     TRUE     TRUE     TRUE     TRUE     TRUE     TRUE 
      gofRSq   gofSDR 
        TRUE     TRUE 
...
| Execution Time | 2025-02-19 03:49:58 UTC |
...
running this report
    ...
    PROCESSX_PS1d455940d1c7_1739936992
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHtSLZa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ehaGoF_v0.1.1-tikzDictionary"
