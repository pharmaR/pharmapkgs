# Validation Report - facerec@0.1.0
...
| export_help          | 12                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Carsten Schwemmer <c.schwem2er@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/methodds/facerec       |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | magrittr (\>= 1.5.0)  | Imports |
| 2   | dplyr (\>= 0.7.0)     | Imports |
| 3   | httr (\>= 1.3.0)      | Imports |
| 4   | jsonlite (\>= 1.5.0)  | Imports |
| 5   | knitr (\>= 1.2.0)     | Imports |
| 6   | stringr (\>= 1.2.0)   | Imports |
| 7   | snakecase (\>= 0.9.0) | Imports |
| 8   | rlang                 | Imports |
...
Overall the package has 12 exported objects. 11 are documented:
                     ...
                     %>%               detect               enroll 
                   FALSE                 TRUE                 TRUE 
            facerec_init        get_galleries get_gallery_subjects 
                    TRUE                 TRUE                 TRUE 
              prep_image            recognize       remove_gallery 
                    TRUE                 TRUE                 TRUE 
          remove_subject               verify         view_subject 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 05:03:44 UTC |
...
running this report
    ...
    PROCESSX_PS1d454a4ae5e7_1739941417
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoIGv0L
...
These are the options set to generate the report:
    ...
    [1] "validation_report_facerec_v0.1.0-tikzDictionary"
