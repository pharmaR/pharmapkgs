...
| has_source_control   | https://github.com/YuLab-SMU/fanyi       |
...
Overall the package has 20 exported objects. 20 are documented:
         ...
         baidu_translate       bing_translate     caiyun_translate 
                    TRUE                 TRUE                 TRUE 
       chatglm_translate                cn2en                en2cn 
                    TRUE                 TRUE                 TRUE 
        fanyi_has_appkey         gene_summary   get_translate_text 
                    TRUE                 TRUE                 TRUE 
                name2sci          search_gene set_translate_option 
                    TRUE                 TRUE                 TRUE 
    set_translate_source        symbol2entrez    tencent_translate 
                    TRUE                 TRUE                 TRUE 
               translate     translate_ggplot volcengine_translate 
                    TRUE                 TRUE                 TRUE 
                   ydict     youdao_translate 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-19 05:11:40 UTC |
...
running this report
    ...
    PROCESSX_PS1d456d689d9e_1739941894
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpdd2j83
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fanyi_v0.0.7-tikzDictionary"
