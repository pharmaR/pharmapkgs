# Validation Report - Dforest@0.4.2
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Leihong Wu <leihong.wu@fda.hhs.gov>                  |
...
Overall the package has 16 exported objects. 16 are documented:
             ...
             cal_MCC           Con_DT           DF_acc      DF_ConfPlot 
                TRUE             TRUE             TRUE             TRUE 
    DF_ConfPlot_accu            DF_CV     DF_CVsummary        DF_dataFs 
                TRUE             TRUE             TRUE             TRUE 
          DF_dataPre          DF_easy          DF_perf          DF_pred 
                TRUE             TRUE             TRUE             TRUE 
            DF_train  DF_Trainsummary          Dforest          Pred_DT 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 03:54:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46badd01a_1739850878
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsKSLpI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Dforest_v0.4.2-tikzDictionary"
