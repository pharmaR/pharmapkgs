...
| export_help          | 4                                 |
| has_website          | TRUE                              |
| has_maintainer       | Raymond Balise <balise@miami.edu> |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/CTN-0094/DOPE  |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    compress_lookup          lookup      lookup_syn           parse 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:34:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bb412100595_1739853277
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJ4XLtl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DOPE_v2.1.0-tikzDictionary"
