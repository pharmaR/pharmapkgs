# Validation Report - causaldrf@0.4.2
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Douglas Galagate <galagated@gmail.com>               |
...
Overall the package has 16 exported objects. 16 are documented:
        ...
        add_spl_est      aipwee_est        bart_est         gam_est          get_ci 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             hi_est        iptw_est        ismw_est          iw_est          nw_est 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        overlap_fun prop_spline_est         reg_est      scalar_wts           t_mod 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           wtrg_est 
               TRUE 
...
| Execution Time | 2025-02-16 03:49:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3402ad008_1739677747
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBPmEEx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causaldrf_v0.4.2-tikzDictionary"
