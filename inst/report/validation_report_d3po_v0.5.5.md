...
| export_help | 22 |
| has_website | TRUE |
| has_maintainer | Mauricio Vargas Sepulveda <m.sepulveda@mail.utoronto.ca> |
...
Overall the package has 22 exported objects. 22 are documented:
             ...
             d3po   d3po_output    d3po_proxy d3po_template          daes 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          map_ids       po_area po_background        po_bar        po_box 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         po_donut       po_font     po_geomap     po_labels     po_legend 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          po_line    po_network        po_pie    po_scatter      po_title 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       po_treemap   render_d3po 
             TRUE          TRUE 
...
| Execution Time | 2025-02-17 04:48:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bd698d4ea5_1739767710
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeNyPHy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_d3po_v0.5.5-tikzDictionary"
