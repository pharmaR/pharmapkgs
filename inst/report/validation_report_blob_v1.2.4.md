...
| has_source_control   | https://github.com/tidyverse/blob |
| has_bug_reports_url  | 1                                 |
| downloads_1yr        | 6016503                           |
...
arrow, b64, bcputility, bigrquery, bigrquerystorage, constructive,
dbflobr, DBI, DBItest, dbplyr, dbx, flobr, ipaddress, nanoarrow, odbc,
RMariaDB, RPostgres, RSQLite, sf, tfevents, tibble

## Namespace

Overall the package has 8 exported objects. 8 are documented:

            as_blob         as.blob            blob         is_blob        new_blob 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      validate_blob   vec_cast.blob vec_ptype2.blob 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:22:59 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1dbca3ff_1739593374
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPkSgFc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blob_v1.2.4-tikzDictionary"
