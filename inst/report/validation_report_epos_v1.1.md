...
| export_help          | 33                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Bernd Mueller <bernd.mueller@zbmed.de> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/bernd-mueller/epos  |
...
Overall the package has 33 exported objects. 33 are documented:
                                ...
                                calcCosine                               calcDice 
                                      TRUE                                   TRUE 
                                  calcDSEA                         calcEnrichment 
                                      TRUE                                   TRUE 
                               calcJaccard                                 cosine 
                                      TRUE                                   TRUE 
                           createBaseTable                 createDashVectorForATC 
                                      TRUE                                   TRUE 
                          createNeuroTable                 createTanimotoBaseline 
                                      TRUE                                   TRUE 
                                      dice                              drawVenn4 
                                      TRUE                                   TRUE 
                              drawVenn4Doc                       drawVenn4DrugDoc 
                                      TRUE                                   TRUE 
                              drawVenn4Syn                              drawVenn5 
                                      TRUE                                   TRUE 
                              drawVenn5Doc                       drawVenn5DrugDoc 
                                      TRUE                                   TRUE 
                              drawVenn5Syn                           drawVennGrid 
                                      TRUE                                   TRUE 
                       filterApprovedDrugs                       filterNeuroDrugs 
                                      TRUE                                   TRUE 
                    genDictListFromRawFreq                              getRefAll 
                                      TRUE                                   TRUE 
                             getTermMatrix                                jaccard 
                                      TRUE                                   TRUE 
                                  plotDSEA                         plotEnrichment 
                                      TRUE                                   TRUE 
                           printTop10Drugs  readAtcMapIntoHashMapAtcCodesAtcNames 
                                      TRUE                                   TRUE 
    readAtcMapIntoHashMapDrugNamesAtcCodes                     readSecondLevelATC 
                                      TRUE                                   TRUE 
...
| Execution Time | 2025-02-19 04:21:28 UTC |
...
running this report
    ...
    PROCESSX_PS1d45192e430_1739938882
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDokP5z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epos_v1.1-tikzDictionary"
