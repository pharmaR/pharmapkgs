# Validation Report - fat2Lpoly@1.2.5
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Alexandre BUREAU <alexandre.bureau@msp.ulaval.ca>    |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    calcule.poids.alphafixe      calcule.poids.Chen           design.1locus 
                       TRUE                    TRUE                    TRUE 
         design.dichotomous     design.endo2disease             design.full 
                       TRUE                    TRUE                    TRUE 
                  fat2Lpoly       fat2Lpoly.withinR      get.scores.pvalues 
                       TRUE                    TRUE                    TRUE 
          read.merlin.files 
                       TRUE 
...
| Execution Time | 2025-02-19 05:23:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d45323dbd35_1739942598
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvlBJzW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fat2Lpoly_v1.2.5-tikzDictionary"
