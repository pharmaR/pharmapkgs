# Validation Report - EvaluationMeasures@1.1.0
...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Babak Khorsand <khorsand@yahoo.com>                  |
...
Overall the package has 23 exported objects. 23 are documented:
       ...
       EvaluationMeasures.Accuracy         EvaluationMeasures.DOR 
                              TRUE                           TRUE 
        EvaluationMeasures.F1Score     EvaluationMeasures.FallOut 
                              TRUE                           TRUE 
      EvaluationMeasures.FBMeasure         EvaluationMeasures.FDR 
                              TRUE                           TRUE 
       EvaluationMeasures.FMeasure         EvaluationMeasures.FNR 
                              TRUE                           TRUE 
            EvaluationMeasures.FOR         EvaluationMeasures.FPR 
                              TRUE                           TRUE 
            EvaluationMeasures.MCC    EvaluationMeasures.MissRate 
                              TRUE                           TRUE 
            EvaluationMeasures.NLR         EvaluationMeasures.NPV 
                              TRUE                           TRUE 
            EvaluationMeasures.PLR         EvaluationMeasures.PPV 
                              TRUE                           TRUE 
      EvaluationMeasures.Precision      EvaluationMeasures.Recall 
                              TRUE                           TRUE 
    EvaluationMeasures.Sensitivity EvaluationMeasures.Specificity 
                              TRUE                           TRUE 
          EvaluationMeasures.table         EvaluationMeasures.TNR 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-19 04:38:18 UTC |
...
running this report
    ...
    PROCESSX_PS1d455c374353_1739939892
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSNCX0Y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EvaluationMeasures_v1.1.0-tikzDictionary"
