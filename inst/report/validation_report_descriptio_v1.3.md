# Validation Report - descriptio@1.3
...
| export_help          | 33                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Nicolas Robette <nicolas.robette@uvsq.fr>     |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/nicolas-robette/descriptio |
...
GDAtools, moreparty, seqhandbook

## Namespace

Overall the package has 33 exported objects. 33 are documented:

          assoc.catcont    assoc.catcont.by        assoc.twocat     assoc.twocat.by 
                   TRUE                TRUE                TRUE                TRUE 
          assoc.twocont    assoc.twocont.by            assoc.xx            assoc.yx 
                   TRUE                TRUE                TRUE                TRUE 
                catdesc             condesc               darma   ggassoc_assocplot 
                   TRUE                TRUE                TRUE                TRUE 
         ggassoc_bertin     ggassoc_boxplot ggassoc_chiasmogram    ggassoc_crosstab 
                   TRUE                TRUE                TRUE                TRUE 
      ggassoc_marimekko     ggassoc_phiplot     ggassoc_scatter            or.table 
                   TRUE                TRUE                TRUE                TRUE 
              pem.table           phi.table            profiles         stat_twocat 
                   TRUE                TRUE                TRUE                TRUE 
             StatTwocat        weighted.cor       weighted.cor2        weighted.cov 
                   TRUE                TRUE                TRUE                TRUE 
          weighted.cov2        weighted.mad   weighted.quantile         weighted.sd 
                   TRUE                TRUE                TRUE                TRUE 
         weighted.table 
                   TRUE 
...
| Execution Time | 2025-02-18 03:46:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41e416796_1739850386
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpbp1iLn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_descriptio_v1.3-tikzDictionary"
