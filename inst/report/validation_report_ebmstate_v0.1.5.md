# Validation Report - ebmstate@0.1.5
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Rui Costa <ruibarrigana@hotmail.com>                 |
...
|     | package                 | type      |
|:----|:------------------------|:----------|
| 1   | survival (\>= 2.44-1.1) | Depends   |
| 2   | mstate (\>= 0.2.11)     | Depends   |
| 3   | Rcpp                    | Imports   |
| 4   | HDInterval              | Imports   |
| 5   | stats                   | Imports   |
| 6   | utils                   | Imports   |
| 7   | methods                 | Imports   |
| 8   | Rcpp                    | LinkingTo |
...
Overall the package has 7 exported objects. 7 are documented:
         ...
         boot_ebmstate             CoxRFX       loo_ebmstate      msfit_generic 
                  TRUE               TRUE               TRUE               TRUE 
    probtrans_ebmstate      probtrans_fft   probtrans_mstate 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 05:15:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bb441a0333e_1739855751
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEFLuv1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ebmstate_v0.1.5-tikzDictionary"
