# Validation Report - bizicount@1.3.3
...
| export_help          | 12                                     |
| has_website          | TRUE                                   |
| has_maintainer       | John Niehaus <jniehaus2257@gmail.com>  |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/jmniehaus/bizicount |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | pbivnorm (\>= 0.6.0)      | Imports |
| 2   | Formula (\>= 1.2-4)       | Imports |
| 3   | rlang (\>= 0.4.7)         | Imports |
| 4   | MASS (\>= 7.3-54)         | Imports |
| 5   | numDeriv (\>= 2016.8-1.1) | Imports |
| 6   | methods                   | Imports |
| 7   | stats                     | Imports |
| 8   | utils                     | Imports |
| 9   | DHARMa (\>= 0.3.4)        | Imports |
| 10  | texreg (\>= 1.37.5)       | Imports |
...
Overall the package has 12 exported objects. 12 are documented:
      ...
      bizicount       dzinb        dzip make_DHARMa       pzinb        pzip 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
          qzinb        qzip       rzinb        rzip     zi_test     zic.reg 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-15 04:20:18 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd60a8d35f_1739593213
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeiUP3C
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bizicount_v1.3.3-tikzDictionary"
