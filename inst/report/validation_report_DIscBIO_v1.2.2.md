# Validation Report - DIscBIO@1.2.2
...
| has_source_control   | https://github.com/ocbe-uio/DIscBIO       |
...
| 15  | fpc                  | Imports |
| 16  | cluster              | Imports |
| 17  | rpart.plot           | Imports |
| 18  | tsne                 | Imports |
| 19  | AnnotationDbi        | Imports |
| 20  | org.Hs.eg.db         | Imports |
| 21  | graphics             | Imports |
| 22  | stats                | Imports |
| 23  | utils                | Imports |
| 24  | impute               | Imports |
| 25  | withr                | Imports |
| 26  | SingleCellExperiment | Depends |
...
Overall the package has 16 exported objects. 38 are documented:

                      as.DISCBIO               ClustDiffGenes 
                            TRUE                         TRUE 
              customConvertFeats                      DISCBIO 
                            TRUE                         TRUE 
    DISCBIO2SingleCellExperiment                        J48DT 
                            TRUE                         TRUE 
                       J48DTeval                      Jaccard 
                            TRUE                         TRUE 
                     NetAnalysis                   Networking 
                            TRUE                         TRUE 
                         plotGap                    PlotMBpca 
                            TRUE                         TRUE 
                             PPI                      RpartDT 
                            TRUE                         TRUE 
                       RpartEVAL                  VolcanoPlot 
                            TRUE                         TRUE 

### Examples

There are 48 help pages with examples, from 50 (96.00 %).
...
| Execution Time | 2025-02-18 04:11:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4230fad79_1739851877
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRxW1pN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DIscBIO_v1.2.2-tikzDictionary"
