# Validation Report - DrugExposureDiagnostics@1.1.1
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Ger Inberg <g.inberg@erasmusmc.nl>                   |
| bugs_status          | subscript out of bounds                              |
| has_source_control   | https://github.com/darwin-eu/DrugExposureDiagnostics |
...
| 3   | magrittr (\>= 2.0.0)        | Imports |
| 4   | rlang (\>= 1.0.0)           | Imports |
| 5   | tidyr (\>= 1.2.0)           | Imports |
| 6   | tidyselect (\>= 1.2.0)      | Imports |
| 7   | checkmate (\>= 2.0.0)       | Imports |
| 8   | glue (\>= 1.5.0)            | Imports |
| 9   | DrugUtilisation (\>= 0.7.0) | Imports |
| 10  | omopgenerics (\>= 0.2.3)    | Imports |
| 11  | shiny (\>= 1.6.0)           | Imports |
| 12  | R6                          | Imports |
...
Overall the package has 8 exported objects. 7 are documented:

                                    %>%                       dataPlotPanel 
                                  FALSE                                TRUE 
                          executeChecks                       metaDataPanel 
                                   TRUE                                TRUE 
                       mockDrugExposure runBenchmarkExecuteSingleIngredient 
                                   TRUE                                TRUE 
                            viewResults                   writeResultToDisk 
                                   TRUE                                TRUE 
...
| Execution Time | 2025-02-18 04:48:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41c2b2a3c_1739854110
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1rb6Xo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DrugExposureDiagnostics_v1.1.1-tikzDictionary"
