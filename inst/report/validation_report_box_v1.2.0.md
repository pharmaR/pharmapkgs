...
| export_help          | 12                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Konrad Rudolph <konrad.rudolph@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/klmr/box               |
...
box.linters, box.lsp, common, cucumber, interface, just.install, rhino,
shiny.telemetry, SouthParkRshiny, stenographer

## Namespace

Overall the package has 12 exported objects. 12 are documented:

                export               file               help               name 
                  TRUE               TRUE               TRUE               TRUE 
           purge_cache register_S3_method             reload        script_path 
                  TRUE               TRUE               TRUE               TRUE 
       set_script_path             topenv             unload                use 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:37:04 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd780c78bd_1739594219
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRAd53Q
...
These are the options set to generate the report:
    ...
    [1] "validation_report_box_v1.2.0-tikzDictionary"
