# Validation Report - crosslag@0.1.0
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yaxin Li <LYX010308@163.com>                         |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | gamm4 (\>= 0.2.6)   | Imports |
| 2   | ggplot2 (\>= 3.5.0) | Imports |
| 3   | lavaan (\>= 0.6.17) | Imports |
| 4   | mgcv (\>= 1.9.1)    | Imports |
| 5   | rms (\>= 6.8.0)     | Imports |
| 6   | ggpubr (\>= 0.6.0)  | Imports |
| 7   | stats (\>= 4.3.2)   | Imports |
| 8   | utils (\>= 3.1.0)   | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    adjust_target    clpm_gam_c    clpm_gam_r  clpm_gamm4_c  clpm_gamm4_r 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      clpm_poly_c   clpm_poly_r    crlog_line    judge_line 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 04:23:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6323c2c24_1739766229
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz2gopQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crosslag_v0.1.0-tikzDictionary"
