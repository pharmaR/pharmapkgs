# Validation Report - facmodTS@1.0
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Doug Martin <martinrd3d@gmail.com>                   |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/robustport/facmodTS               |
...
| 4   | lattice              | Imports |
| 5   | leaps                | Imports |
| 6   | PerformanceAnalytics | Imports |
| 7   | PortfolioAnalytics   | Imports |
| 8   | R.cache              | Imports |
| 9   | corpcor              | Imports |
| 10  | methods              | Imports |
| 11  | quadprog             | Imports |
| 12  | RobStatTM            | Imports |
| 13  | robustbase           | Imports |
| 14  | sandwich             | Imports |
| 15  | sn                   | Imports |
| 16  | xts                  | Imports |
| 17  | zoo                  | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
               ...
               fitTsfm    fitTsfm.control fitTsfmLagLeadBeta          fitTsfmMT 
                  TRUE               TRUE               TRUE               TRUE 
           fitTsfmUpDn              fmCov         fmEsDecomp         fmSdDecomp 
                  TRUE               TRUE               TRUE               TRUE 
           fmVaRDecomp               paFm 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-19 05:03:58 UTC |
...
running this report
    ...
    PROCESSX_PS1d455a2a1f49_1739941432
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeU58IZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_facmodTS_v1.0-tikzDictionary"
