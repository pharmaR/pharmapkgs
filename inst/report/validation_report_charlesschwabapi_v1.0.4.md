# Validation Report - charlesschwabapi@1.0.4
...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Nick Bultman <njbultman74@gmail.com>                 |
...
Overall the package has 23 exported objects. 23 are documented:
                   ...
                   cancel_order                 get_account 
                           TRUE                        TRUE 
            get_account_numbers                get_accounts 
                           TRUE                        TRUE 
      get_authentication_tokens             get_instruments 
                           TRUE                        TRUE 
          get_instruments_cusip            get_market_hours 
                           TRUE                        TRUE 
        get_market_hours_single                  get_movers 
                           TRUE                        TRUE 
              get_option_chains get_option_expiration_chain 
                           TRUE                        TRUE 
                   get_order_id                  get_orders 
                           TRUE                        TRUE 
             get_orders_account           get_price_history 
                           TRUE                        TRUE 
                     get_quotes    get_quotes_single_symbol 
                           TRUE                        TRUE 
                get_transaction            get_transactions 
                           TRUE                        TRUE 
           get_user_preferences                 place_order 
                           TRUE                        TRUE 
                  replace_order 
                           TRUE 
...
| Execution Time | 2025-02-16 04:09:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32a98727_1739678937
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpe87L7k
...
These are the options set to generate the report:
    ...
    [1] "validation_report_charlesschwabapi_v1.0.4-tikzDictionary"
