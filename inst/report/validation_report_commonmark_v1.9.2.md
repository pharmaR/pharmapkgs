# Validation Report - commonmark@1.9.2
...
biocViews, blastula, codemetar, conflr, emayili, epoxy, flextable,
future.tests, gt, gtExtras, huxtable, knitxl, litedown, mailmerge,
markdown, parallelly, pkgnews, progressr, roxygen2, shiny, spelling,
startup, tinkr, xfun
...
Overall the package has 7 exported objects. 7 are documented:
        ...
        list_extensions markdown_commonmark       markdown_html      markdown_latex 
                   TRUE                TRUE                TRUE                TRUE 
           markdown_man       markdown_text        markdown_xml 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-17 03:33:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd646b418a9_1739763176
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUWe2k0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_commonmark_v1.9.2-tikzDictionary"
