# Validation Report - cctools@0.1.2
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Thomas Nagler <thomas.nagler@tum.de>                 |
...
Overall the package has 8 exported objects. 8 are documented:
                ...
                cckde         cont_conv            dcckde              dusb 
                 TRUE              TRUE              TRUE              TRUE 
    expand_as_numeric      expand_names        expand_vec              rusb 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 03:55:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3146cd667_1739678120
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp20mYRC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cctools_v0.1.2-tikzDictionary"
