# Validation Report - bkmrhat@1.1.3
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alexander Keil <akeil@unc.edu>                       |
...
Overall the package has 15 exported objects. 15 are documented:
                       ...
                       comb_bkmrfits             comb_bkmrfits_lowmem 
                                TRUE                             TRUE 
                ExtractPIPs_parallel                  kmbayes_combine 
                                TRUE                             TRUE 
              kmbayes_combine_lowmem                 kmbayes_continue 
                                TRUE                             TRUE 
                        kmbayes_diag                 kmbayes_diagnose 
                                TRUE                             TRUE 
                    kmbayes_parallel        kmbayes_parallel_continue 
                                TRUE                             TRUE 
       OverallRiskSummaries_parallel  PredictorResponseBivar_parallel 
                                TRUE                             TRUE 
    PredictorResponseUnivar_parallel              SamplePred_parallel 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-15 04:20:29 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd20d1af33_1739593224
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmwVZHD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bkmrhat_v1.1.3-tikzDictionary"
