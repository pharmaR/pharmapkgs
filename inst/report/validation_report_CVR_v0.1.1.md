...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Chongliang Luo <chongliang.luo@uconn.edu>            |
...
Overall the package has 4 exported objects. 4 are documented:
            ...
            CVR   cvrsolver SimulateCVR   SparseCCA 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 04:44:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64429e084_1739767472
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJnEfMV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CVR_v0.1.1-tikzDictionary"
