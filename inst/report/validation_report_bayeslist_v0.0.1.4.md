# Validation Report - bayeslist@0.0.1.4
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Xiao Lu <xiao.lu.research@gmail.com>                 |
...
Overall the package has 8 exported objects. 8 are documented:
                    ...
                    bayeslist                  logistic       plot_coef.bayeslist 
                         TRUE                      TRUE                      TRUE 
    plot_prevalence.bayeslist      plot_trace.bayeslist      print_coef.bayeslist 
                         TRUE                      TRUE                      TRUE 
         print_mcmc.bayeslist      print_text.bayeslist 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-15 03:37:12 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1ddcfcc3_1739590627
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp71VSqr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayeslist_v0.0.1.4-tikzDictionary"
