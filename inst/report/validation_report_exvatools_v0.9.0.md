# Validation Report - exvatools@0.9.0
...
| export_help          | 31                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Enrique Feas <efeas@runbox.com>                      |
...
Overall the package has 31 exported objects. 31 are documented:
                   ...
                   bkd             bkdiag             bkoffd                bkt 
                  TRUE               TRUE               TRUE               TRUE 
                  bktt              csums             diagcs              dmult 
                  TRUE               TRUE               TRUE               TRUE 
              get_data get_exvadec_bkdown      get_geo_codes      get_sec_codes 
                  TRUE               TRUE               TRUE               TRUE 
           get_va_exgr       get_va_exgry          get_va_fd        get_xmatrix 
                  TRUE               TRUE               TRUE               TRUE 
                 hmult           info_geo           info_sec    make_custom_wio 
                  TRUE               TRUE               TRUE               TRUE 
          make_exvadec       make_exvadir           make_wio               meld 
                  TRUE               TRUE               TRUE               TRUE 
                 multd              rsums           set_zero           sumgcols 
                  TRUE               TRUE               TRUE               TRUE 
              sumgrows            sumncol            sumnrow 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 04:58:51 UTC |
...
running this report
    ...
    PROCESSX_PS1d4522d54680_1739941124
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTBJ96O
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exvatools_v0.9.0-tikzDictionary"
