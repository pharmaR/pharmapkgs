# Validation Report - brassica@1.0.2
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Mike Lee <random.deviate@gmail.com>                  |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         LIST LowerCode    NotRun       RUN UpperCode 
...
| Execution Time | 2025-02-15 04:41:31 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6d9ac3d8_1739594486
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTSiN1g
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brassica_v1.0.2-tikzDictionary"
