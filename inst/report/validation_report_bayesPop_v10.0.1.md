# Validation Report - bayesPop@10.0.1
         ...
         extract.trajectories.le             get.bPop.pyramid 
          ...
          get.trajectory.indices           has.pop.prediction 
                 ...
                 mac.expression5         migration.totals2age 
                            TRUE                         TRUE 
                   pop.aggregate         pop.aggregate.subnat 
                            TRUE                         TRUE 
                  pop.byage.plot            pop.byage.plotAll 
                            TRUE                         TRUE 
                 pop.byage.table            pop.cleanup.cache 
                            TRUE                         TRUE 
                pop.cohorts.plot                    pop.ggmap 
                            TRUE                         TRUE 
                         pop.map                 pop.map.gvis 
                            TRUE                         TRUE 
                     pop.predict           pop.predict.subnat 
                            TRUE                         TRUE 
                     pop.pyramid               pop.pyramidAll 
                            TRUE                         TRUE 
                pop.trajectories        pop.trajectories.plot 
                            TRUE                         TRUE 
        pop.trajectories.plotAll     pop.trajectories.pyramid 
                            TRUE                         TRUE 
     pop.trajectories.pyramidAll       pop.trajectories.table 
                            TRUE                         TRUE 
                   project.pasfr           project.pasfr.traj 
                            TRUE                         TRUE 
                rcastro.schedule write.pop.projection.summary 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-21 13:14:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a7744c874_1740143637
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzbsKSj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesPop_v10.0.1-tikzDictionary"
