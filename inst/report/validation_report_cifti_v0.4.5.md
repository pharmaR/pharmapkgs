...
| export_help          | 27                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | John Muschelli <muschellij2@gmail.com>               |
...
Overall the package has 27 exported objects. 27 are documented:
           ...
           cifti_as_list  cifti_brain_structs   cifti_coords_gifti 
                    TRUE                 TRUE                 TRUE 
              cifti_data      cifti_read_char            cifti_xml 
                    TRUE                 TRUE                 TRUE 
           cifti_xml_txt  download_cifti_data      get_brain_model 
                    TRUE                 TRUE                 TRUE 
          get_cifti_type        get_named_map           get_parcel 
                    TRUE                 TRUE                 TRUE 
             get_surface           get_volume have_cifti_test_data 
                    TRUE                 TRUE                 TRUE 
        is_cifti_numeric             is.cifti matrix_ind_map_nodes 
                    TRUE                 TRUE                 TRUE 
             nifti_2_hdr    parse_brain_model      parse_named_map 
                    TRUE                 TRUE                 TRUE 
            parse_parcel        parse_surface         parse_volume 
                    TRUE                 TRUE                 TRUE 
              read_cifti            readCIFTI              readcii 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-16 04:18:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bc341177763_1739679518
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmH5Eiz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cifti_v0.4.5-tikzDictionary"
