# Validation Report - eefAnalytics@1.1.5
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Germaine Uwimpuhwe <germaine.uwimpuhwe@durham.ac.uk> |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | R2jags (\>= 0.7)    | Imports |
| 2   | ggplot2 (\>= 3.4.0) | Imports |
| 3   | lme4 (\>= 1.1.0)    | Imports |
| 4   | methods             | Imports |
| 5   | graphics            | Imports |
| 6   | stats               | Imports |
| 7   | mvtnorm (\>= 1.1.2) | Imports |
| 8   | coda (\>= 0.19)     | Imports |
| 9   | MCMCvis (\>= 0.15)  | Imports |
...
Overall the package has 12 exported objects. 12 are documented:
    ...
    caceCRTBoot caceMSTBoot caceSRTBoot ComparePlot    crtBayes     crtFREQ 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
      GainIndex    mlmbayes    mstBayes     mstFREQ    srtBayes     srtFREQ 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-19 03:44:07 UTC |
...
running this report
    ...
    PROCESSX_PS1d4517661036_1739936641
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6auH6m
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eefAnalytics_v1.1.5-tikzDictionary"
