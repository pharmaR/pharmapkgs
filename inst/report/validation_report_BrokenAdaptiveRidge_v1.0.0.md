# Validation Report - BrokenAdaptiveRidge@1.0.0
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | Cyclops (\>= 3.0.0) | Depends |
| 2   | futile.logger       | Imports |
| 3   | bit64               | Imports |
...
Overall the package has 2 exported objects. 2 are documented:
        ...
        createBarPrior createFastBarPrior 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:46:00 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4cf8958d_1739594755
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNMyDpz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BrokenAdaptiveRidge_v1.0.0-tikzDictionary"
