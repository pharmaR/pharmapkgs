# Validation Report - ConsRank@2.1.4
...
| export_help          | 27                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Antonio D’Ambrosio <antdambr@unina.it>               |
...
adabag, ConsRankClass

## Namespace

Overall the package has 27 exported objects. 27 are documented:

           BBFULL   combinpmatr      consrank         DECOR        EMCons 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         FASTcons     FASTDECOR    iw_kemenyd      iw_tau_x iwcombinpmatr 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      iwquickcons       kemenyd  kemenydesign   kemenyscore        labels 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       order2rank    partitions      polyplot     QuickCons    rank2order 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       reordering   scorematrix     stirling2  tabulaterows         tau_x 
             TRUE          TRUE          TRUE          TRUE          TRUE 
            Tau_X     univranks 
             TRUE          TRUE 
...
| Execution Time | 2025-02-17 03:47:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63e504e64_1739764064
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbhpcRO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ConsRank_v2.1.4-tikzDictionary"
