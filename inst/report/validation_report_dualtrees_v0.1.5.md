# Validation Report - dualtrees@0.1.5
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Sebastian Buschow <s6sebusc@uni-bonn.de>             |
...
Overall the package has 14 exported objects. 14 are documented:
            ...
            cen2uv         cen2xy         dt2cen          dtcwt         dtmean 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            fld2dt         get_en         idtcwt            pad      period_bc 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     put_in_mirror smooth_borders         uvplot         xy2cen 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:59:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4df27bc9_1739854735
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmvBj3J
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dualtrees_v0.1.5-tikzDictionary"
