# Validation Report - corporaexplorer@0.9.0
...
| export_help          | 12                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Kristian Lundby Gjerde <kristian.gjerde@gmail.com> |
| bugs_status          | subscript out of bounds                            |
| has_source_control   | https://github.com/kgjerde/corporaexplorer         |
...
Overall the package has 12 exported objects. 11 are documented:
                       ...
                       %>%  create_janeausten_app        create_sotu_app 
                     FALSE                   TRUE                   TRUE 
    create_sotu_decade_app                explore               explore0 
                      TRUE                   TRUE                   TRUE 
              prepare_data    run_corpus_explorer run_document_extractor 
                      TRUE                   TRUE                   TRUE 
        run_janeausten_app           run_sotu_app    run_sotu_decade_app 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-17 03:59:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65e08d86c_1739764737
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGjkhZN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corporaexplorer_v0.9.0-tikzDictionary"
