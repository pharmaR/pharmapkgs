...
| export_help          | 8                                   |
| has_website          | TRUE                                |
| has_maintainer       | Petr Bouchal <pbouchal@gmail.com>   |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/petrbouchal/czso |
...
| 1   | cli                | Imports |
| 2   | curl (\>= 4.3)     | Imports |
| 3   | dplyr (\>= 0.8.3)  | Imports |
| 4   | httr (\>= 1.4.1)   | Imports |
| 5   | jsonlite (\>= 1.6) | Imports |
| 6   | lifecycle          | Imports |
| 7   | magrittr           | Imports |
| 8   | readr (\>= 1.3.1)  | Imports |
| 9   | rlang (\>= 0.4.4)  | Imports |
| 10  | stringi            | Imports |
| 11  | tibble (\>= 2.1.3) | Imports |
| 12  | tools (\>= 3.6.0)  | Imports |
| 13  | utils (\>= 3.6.0)  | Imports |
...
Overall the package has 8 exported objects. 7 are documented:
                          ...
                          %>%     czso_filter_catalogue        czso_get_catalogue 
                        FALSE                      TRUE                      TRUE 
            czso_get_codelist      czso_get_dataset_doc czso_get_dataset_metadata 
                         TRUE                      TRUE                      TRUE 
               czso_get_table     czso_get_table_schema 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-17 04:47:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63a19abc4_1739767666
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkOD5rE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_czso_v0.4.1-tikzDictionary"
