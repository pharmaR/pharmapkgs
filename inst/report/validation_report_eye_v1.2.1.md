...
| export_help          | 22                           |
| has_website          | TRUE                         |
| has_maintainer       | Tjebo Heeren <tjebo@gmx.de>  |
| bugs_status          | subscript out of bounds      |
| has_source_control   | https://github.com/tjebo/eye |
...
|:----|:-----------------------|:--------|
| 1   | cli (\>= 3.0.1)        | Imports |
| 2   | dplyr (\>= 1.0.7)      | Imports |
| 3   | english (\>= 1.2-6)    | Imports |
| 4   | lubridate (\>= 1.7.10) | Imports |
| 5   | magrittr (\>= 2.0.1)   | Imports |
| 6   | pillar (\>= 1.6.2)     | Imports |
| 7   | purrr (\>= 0.3.4)      | Imports |
| 8   | rlang (\>= 0.4.11)     | Imports |
| 9   | stringr (\>= 1.4.0)    | Imports |
| 10  | tibble (\>= 3.1.3)     | Imports |
| 11  | tidyr (\>= 1.1.3)      | Imports |
| 12  | tidyselect (\>= 1.1.1) | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
           ...
           as_etdrs       as_logmar      as_snellen           blink        clean_va 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            cleanVA            eyes          eyestr          getage         hyperop 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               myop          myopic        recodeye          reveal       revealEye 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    set_eye_strings          tidyNA        to_etdrs       to_logmar      to_snellen 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                 va        va_mixed 
               TRUE            TRUE 
...
| Execution Time | 2025-02-19 04:58:58 UTC |
...
running this report
    ...
    PROCESSX_PS1d451be778e4_1739941131
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0tHr97
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eye_v1.2.1-tikzDictionary"
