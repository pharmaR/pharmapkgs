# Validation Report - clusterSEs@2.6.5
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Justin Esarey <justin@justinesarey.com>              |
...
Overall the package has 10 exported objects. 10 are documented:
        ...
        cluster.bs.glm   cluster.bs.ivreg  cluster.bs.mlogit     cluster.bs.plm 
                  TRUE               TRUE               TRUE               TRUE 
        cluster.im.glm   cluster.im.ivreg  cluster.im.mlogit   cluster.wild.glm 
                  TRUE               TRUE               TRUE               TRUE 
    cluster.wild.ivreg   cluster.wild.plm 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:40:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bc366332b8a_1739680800
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgZxNDn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clusterSEs_v2.6.5-tikzDictionary"
