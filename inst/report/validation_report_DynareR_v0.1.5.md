# Validation Report - DynareR@0.1.5
...
Overall the package has 13 exported objects. 13 are documented:
       ...
       add_matlab_path           add_path         eng_dynare         import_log 
                  TRUE               TRUE               TRUE               TRUE 
           include_IRF          input_tex         run_dynare         run_models 
                  TRUE               TRUE               TRUE               TRUE 
    set_dynare_version    set_matlab_path    set_octave_path          write_dyn 
                  TRUE               TRUE               TRUE               TRUE 
             write_mod 
                  TRUE 
...
| Execution Time | 2025-02-18 05:04:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4582efdac_1739855058
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7zoXzg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DynareR_v0.1.5-tikzDictionary"
