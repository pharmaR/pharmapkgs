...
| export_help          | 73                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Pedro Cardoso <pmcardoso@fc.ul.pt>                   |
...
Overall the package has 73 exported objects. 73 are documented:
                  ...
                  alpha.estimate                         beta 
                            TRUE                         TRUE 
                      beta.accum                beta.evenness 
                            TRUE                         TRUE 
                      beta.multi                 contribution 
                            TRUE                         TRUE 
                        coverage                          cwd 
                            TRUE                         TRUE 
                             cwe                          cwm 
                      ...
                      dispersion                        dummy 
                            TRUE                         TRUE 
                        evenness        evenness.contribution 
                            TRUE                         TRUE 
                            fill                        gamma 
                            TRUE                         TRUE 
                             gdm                        gower 
                            ...
                            hill                   hull.alpha 
                            TRUE                         TRUE 
                       hull.beta                   hull.build 
                            TRUE                         TRUE 
               hull.contribution                   hull.gamma 
                            TRUE                         TRUE 
                        hull.sad                  hyper.build 
                            TRUE                         TRUE 
                   hyper.quality                         iaor 
                            TRUE                         TRUE 
                    kernel.alpha                  kernel.beta 
                            TRUE                         TRUE 
            kernel.beta.evenness                 kernel.build 
                            TRUE                         TRUE 
             kernel.contribution            kernel.dispersion 
                            TRUE                         TRUE 
                 kernel.evenness kernel.evenness.contribution 
                            TRUE                         TRUE 
                    kernel.gamma              kernel.hotspots 
                            TRUE                         TRUE 
              kernel.originality                   kernel.sad 
                            TRUE                         TRUE 
               kernel.similarity                      linnean 
                            TRUE                         TRUE 
                         mixture                  optim.alpha 
                            TRUE                         TRUE 
               optim.alpha.stats                   optim.beta 
                            TRUE                         TRUE 
                optim.beta.stats                optim.spatial 
                            TRUE                         TRUE 
                     originality                           r2 
                            TRUE                         TRUE 
                             rao                 raster.alpha 
                            TRUE                         TRUE 
                     raster.beta            raster.dispersion 
                            TRUE                         TRUE 
                 raster.evenness                          sad 
                            TRUE                         TRUE 
                             sar                          ses 
                        ...
                        sim.plot                      sim.sad 
                            TRUE                         TRUE 
                      sim.sample                  sim.spatial 
                            TRUE                         TRUE 
                        sim.tree                        slope 
                            TRUE                         TRUE 
                        standard                   tree.build 
                            TRUE                         TRUE 
                    tree.quality                    tree.zero 
                            TRUE                         TRUE 
                      uniqueness 
                            TRUE 
...
| Execution Time | 2025-02-15 03:29:27 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd443e3bf0_1739590163
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbDKX6W
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BAT_v2.9.6-tikzDictionary"
