# Validation Report - ctrdata@1.20.0
...
| export_help          | 12                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Ralf Herold <ralf.herold@mailbox.org> |
...
| 1   | jsonlite           | Imports |
| 2   | httr               | Imports |
| 3   | curl (\>= 5.1.0)   | Imports |
| 4   | clipr              | Imports |
| 5   | xml2               | Imports |
| 6   | nodbi (\>= 0.10.7) | Imports |
| 7   | stringi            | Imports |
| 8   | lubridate          | Imports |
| 9   | jqr                | Imports |
| 10  | dplyr              | Imports |
...
Overall the package has 12 exported objects. 12 are documented:
    ...
    ctrFindActiveSubstanceSynonyms                 ctrGetQueryUrl 
                              TRUE                           TRUE 
                ctrLoadQueryIntoDb    ctrOpenSearchPagesInBrowser 
                              TRUE                           TRUE 
                   ctrShowOneTrial                   dbFindFields 
                              TRUE                           TRUE 
             dbFindIdsUniqueTrials              dbGetFieldsIntoDf 
                              TRUE                           TRUE 
                    dbQueryHistory        dfMergeVariablesRelevel 
                              TRUE                           TRUE 
                      dfName2Value                  dfTrials2Long 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-17 04:35:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6784c49d0_1739766915
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzOsKDW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ctrdata_v1.20.0-tikzDictionary"
