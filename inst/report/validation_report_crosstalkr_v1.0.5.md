# Validation Report - crosstalkr@1.0.5
...
| export_help          | 34                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Davis Weaver <davis.weaver@case.edu>                 |
...
| 7   | tidyr              | Imports   |
| 8   | tibble             | Imports   |
| 9   | igraph (\>= 1.2.0) | Imports   |
| 10  | Matrix             | Imports   |
| 11  | ensembldb          | Imports   |
| 12  | foreach            | Imports   |
| 13  | doParallel         | Imports   |
| 14  | Rcpp               | Imports   |
| 15  | iterators          | Imports   |
| 16  | ggplot2            | Imports   |
| 17  | STRINGdb           | Imports   |
| 18  | Rcpp               | LinkingTo |
...
Overall the package has 34 exported objects. 34 are documented:
                ...
                add_value        as_gene_symbol        bootstrap_null 
                     TRUE                  TRUE                  TRUE 
               calc_dnp_i               calc_np           calc_np_all 
                     TRUE                  TRUE                  TRUE 
                calc_np_i          combine_null     compute_crosstalk 
                     TRUE                  TRUE                  TRUE 
              compute_dnp            compute_np      compute_null_dnp 
                     TRUE                  TRUE                  TRUE 
       crosstalk_subgraph             dist_calc   experiment_breakout 
                     TRUE                  TRUE                  TRUE 
            final_combine      get_random_graph               gfilter 
                     TRUE                  TRUE                  TRUE 
               gfilter.ct gfilter.igraph_method            gfilter.np 
                     TRUE                  TRUE                  TRUE 
            gfilter.value              load_ppi       node_repression 
                     TRUE                  TRUE                  TRUE 
              norm_colsum               plot_ct      ppi_intersection 
                     TRUE                  TRUE                  TRUE 
                ppi_union          prep_biogrid         prep_stringdb 
                     TRUE                  TRUE                  TRUE 
                sparseRWR     supported_species       tidy_expression 
                     TRUE                  TRUE                  TRUE 
              to_taxon_id 
                     TRUE 
...
| Execution Time | 2025-02-17 04:24:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bd620a42955_1739766284
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFJupse
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crosstalkr_v1.0.5-tikzDictionary"
