...
| size_codebase        | 257                                  |
| has_source_control   | https://github.com/vegawidget/altair |
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | reticulate (\>= 1.23)  | Imports |
| 2   | htmlwidgets            | Imports |
| 3   | assertthat             | Imports |
| 4   | magrittr               | Imports |
| 5   | utils                  | Imports |
| 6   | vegawidget (\>= 0.4.1) | Imports |
| 7   | repr                   | Imports |
...
There are 16 help pages with examples, from 20 (80.00 %).
...
| Execution Time | 2025-02-14 06:50:31 UTC |
...
running this report
    ...
    PROCESSX_PS726d353aa6e6_1739515829
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpx6mKwQ
