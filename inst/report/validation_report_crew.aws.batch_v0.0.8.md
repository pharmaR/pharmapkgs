# Validation Report - crew.aws.batch@0.0.8
...
| has_source_control   | https://github.com/wlandau/crew.aws.batch          |
| has_bug_reports_url  | 1                                                  |
| downloads_1yr        | 8193                                               |
| reverse_dependencies | 0                                                  |
| has_examples         | 0.7272727                                          |
| dependencies         | 9                                                  |
...
|:----|:------------------------|:--------|
| 1   | cli (\>= 3.1.0)         | Imports |
| 2   | crew (\>= 1.0.0)        | Imports |
| 3   | paws.common (\>= 0.7.0) | Imports |
| 4   | paws.compute            | Imports |
| 5   | paws.management         | Imports |
| 6   | R6                      | Imports |
| 7   | rlang                   | Imports |
| 8   | tibble                  | Imports |
| 9   | utils                   | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
              ...
              crew_aws_batch_job_name   crew_class_definition_aws_batch 
                                 TRUE                              TRUE 
        crew_class_launcher_aws_batch      crew_class_monitor_aws_batch 
                                 TRUE                              TRUE 
            crew_controller_aws_batch         crew_definition_aws_batch 
                                 TRUE                              TRUE 
              crew_launcher_aws_batch    crew_launcher_aws_batch_launch 
                                 TRUE                              TRUE 
    crew_launcher_aws_batch_terminate            crew_monitor_aws_batch 
                                 TRUE                              TRUE 
...
There are 8 help pages with examples, from 11 (72.73 %).
...
| Execution Time | 2025-02-17 04:19:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65f1ac69_1739765992
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpClKhF1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crew.aws.batch_v0.0.8-tikzDictionary"
