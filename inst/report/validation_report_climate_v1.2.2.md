# Validation Report - climate@1.2.2
...
| export_help          | 24                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Bartosz Czernecki <nwp@amu.edu.pl>    |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/bczernecki/climate |
...
Overall the package has 24 exported objects. 23 are documented:
                        ...
                        .onAttach                    hydro_imgw 
                            FALSE                          TRUE 
                 hydro_imgw_daily            hydro_imgw_monthly 
                             TRUE                          TRUE 
            hydro_shortening_imgw                    meteo_imgw 
                             TRUE                          TRUE 
                 meteo_imgw_daily          meteo_imgw_datastore 
                             TRUE                          TRUE 
                meteo_imgw_hourly            meteo_imgw_monthly 
                             TRUE                          TRUE 
                   meteo_noaa_co2             meteo_noaa_hourly 
                             TRUE                          TRUE 
                     meteo_ogimet         meteo_shortening_imgw 
                             TRUE                          TRUE 
            nearest_stations_imgw         nearest_stations_noaa 
                             TRUE                          TRUE 
          nearest_stations_ogimet                  ogimet_daily 
                             TRUE                          TRUE 
                    ogimet_hourly              sounding_wyoming 
                             TRUE                          TRUE 
                    spheroid_dist stations_meteo_imgw_telemetry 
                             TRUE                          TRUE 
                  stations_ogimet                      test_url 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-16 04:31:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31b987f23_1739680255
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb1CsYt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_climate_v1.2.2-tikzDictionary"
