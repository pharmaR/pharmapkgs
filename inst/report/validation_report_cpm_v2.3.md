...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Gordon J. Ross <gordon@gordonjross.co.uk>            |
...
Overall the package has 9 exported objects. 0 are documented:

            changeDetected               cpmReset      detectChangePoint 
                     FALSE                  FALSE                  FALSE 
    detectChangePointBatch      getBatchThreshold          getStatistics 
                     FALSE                  FALSE                  FALSE 
      makeChangePointModel     processObservation          processStream 
                     FALSE                  FALSE                  FALSE 
...
| Execution Time | 2025-02-17 04:13:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66a0e3e91_1739765623
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBSpH7J
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cpm_v2.3-tikzDictionary"
