...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | fftwtools (\>= 0.9.11) | Imports |
| 2   | SuperGauss (\>= 2.0.3) | Imports |
| 3   | methods                | Imports |
| 4   | plot3D (\>= 1.4)       | Imports |
...
There are 51 help pages with examples, from 55 (92.73 %).
...
| Execution Time | 2025-02-14 06:46:40 UTC |
...
running this report
    ...
    PROCESSX_PS726d311236ac_1739515597
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4aYhsM
