# Validation Report - dtmapi@0.0.2
...
| export_help | 5 |
| has_website | TRUE |
| has_maintainer | Luong Bang Tran <lutran@iom.int> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/Displacement-Tracking-Matrix/dtmapi-R |
...
Overall the package has 5 exported objects. 5 are documented:
      ...
      get_all_countries  get_all_operations get_idp_admin0_data get_idp_admin1_data 
                   TRUE                TRUE                TRUE                TRUE 
    get_idp_admin2_data 
                   TRUE 
...
| Execution Time | 2025-02-18 04:56:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44c82ad79_1739854560
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbSlpZz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dtmapi_v0.0.2-tikzDictionary"
