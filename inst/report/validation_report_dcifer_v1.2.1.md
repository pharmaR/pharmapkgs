# Validation Report - dcifer@1.2.1
...
| export_help          | 15                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Inna Gerlovina <innager@berkeley.edu>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/EPPIcenter/dcifer                 |
...
Overall the package has 15 exported objects. 15 are documented:
        ...
        calcAfreq   formatAfreq     formatDat generateReval        getCOI 
             TRUE          TRUE          TRUE          TRUE          TRUE 
           ibdDat       ibdEstM       ibdPair      logReval    matchAfreq 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     plotColorbar       plotRel      probUxUy     readAfreq       readDat 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 05:10:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65ca970c1_1739769002
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeYip7x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dcifer_v1.2.1-tikzDictionary"
