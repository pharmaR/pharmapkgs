# Validation Report - ClusVis@1.2.0
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Matthieu Marbac <matthieu.marbac@gmail.com>          |
...
| 5   | mvtnorm             | Imports   |
| 6   | Rmixmod             | Imports   |
| 7   | VarSelLCM (\>= 2.1) | Imports   |
| 8   | Rcpp                | LinkingTo |
| 9   | RcppArmadillo       | LinkingTo |
| 10  | mvtnorm             | LinkingTo |
...
Overall the package has 4 exported objects. 4 are documented:
                ...
                clusvis       clusvisMixmod    clusvisVarSelLCM plotDensityClusVisu 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:42:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36a05e6c0_1739680938
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJnnX4w
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClusVis_v1.2.0-tikzDictionary"
