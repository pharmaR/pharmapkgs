# Validation Report - chessboard@0.1
...
| export_help | 30 |
| has_website | TRUE |
| has_maintainer | Nicolas Casajus <nicolas.casajus@fondationbiodiversite.fr> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/frbcesab/chessboard |
...
Overall the package has 30 exported objects. 29 are documented:
                       ...
                       %>%      append_edge_lists          append_matrix 
                     FALSE                   TRUE                   TRUE 
                    bishop            bishop_left           bishop_right 
                      TRUE                   TRUE                   TRUE 
       connectivity_matrix       create_edge_list     create_node_labels 
                      TRUE                   TRUE                   TRUE 
        distance_euclidean            edges_to_sf   edges_weights_matrix 
                      TRUE                   TRUE                   TRUE 
      edges_weights_vector                   fool             geom_edges 
                      TRUE                   TRUE                   TRUE 
            geom_neighbors              geom_node          get_node_list 
                      TRUE                   TRUE                   TRUE 
             gg_chessboard              gg_matrix                 knight 
                      TRUE                   TRUE                   TRUE 
               knight_left           knight_right    matrix_to_edge_list 
                      TRUE                   TRUE                   TRUE 
     nodes_by_edges_matrix                   pawn                  queen 
                      TRUE                   TRUE                   TRUE 
                      rook spatial_weights_matrix                 wizard 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:12:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33c81b78c_1739679138
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpL5a037
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chessboard_v0.1-tikzDictionary"
