...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Carlos Biagolini-Jr.<c.biagolini@gmail.com>          |
...
Overall the package has 21 exported objects. 21 are documented:
       ...
       aggregation_index  altitudinal_profile             compress 
                    TRUE                 TRUE                 TRUE 
        denseness_column        denseness_row     denseness_sample 
                    TRUE                 TRUE                 TRUE 
         denseness_total        heigh_maximum      heigh_propotion 
                    TRUE                 TRUE                 TRUE 
    heigh_propotion_test          hole_columm             hole_row 
                    TRUE                 TRUE                 TRUE 
            hole_section    hole_section_data    image_information 
                    TRUE                 TRUE                 TRUE 
               light_gap         plot_samples              stretch 
                    TRUE                 TRUE                 TRUE 
         threshold_color threshold_image_list              topline 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:58:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6de6de19_1739595488
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpaZT81u
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bwimage_v1.3-tikzDictionary"
