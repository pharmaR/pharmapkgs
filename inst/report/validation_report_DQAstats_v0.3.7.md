# Validation Report - DQAstats@0.3.7
...
| has_source_control   | https://github.com/miracum/dqa-dqastats      |
...
| 2   | DIZtools (\>= 0.0.8) | Imports |
| 3   | DIZutils (\>= 0.1.2) | Imports |
...
Overall the package has 23 exported objects. 23 are documented:
                   ...
                   atemp_plausi_results check_date_restriction_requirements 
                                   TRUE                                TRUE 
                           completeness                  create_helper_vars 
                                   TRUE                                TRUE 
                      create_pdf_report                        data_loading 
                                   TRUE                                TRUE 
                    descriptive_results                   difference_checks 
                                   TRUE                                TRUE 
                                    dqa                          etl_checks 
                                   TRUE                                TRUE 
                      export_aggregated    format_value_conformance_results 
                                   TRUE                                TRUE 
                       generate_datamap                   get_atemp_plausis 
                                   TRUE                                TRUE 
                     is_latex_installed                            parallel 
                                   TRUE                                TRUE 
                               read_mdr                          reduce_cat 
                                   TRUE                                TRUE 
                               test_csv                        time_compare 
                                   TRUE                                TRUE 
                    uniq_plausi_results                   value_conformance 
                                   TRUE                                TRUE 
...
| Execution Time | 2025-02-18 04:41:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4d5eee62_1739853713
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7ywhwh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DQAstats_v0.3.7-tikzDictionary"
