# Validation Report - csodata@1.5.0
...
| export_help          | 13                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Conor Crowley <conor.crowley@cso.ie>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/CSOIreland/csodata                |
...
Overall the package has 13 exported objects. 13 are documented:
       ...
       cso_clear_cache  cso_disp_geo_meta      cso_disp_meta    cso_get_content 
                  TRUE               TRUE               TRUE               TRUE 
          cso_get_data        cso_get_geo   cso_get_geo_meta   cso_get_interval 
                  TRUE               TRUE               TRUE               TRUE 
          cso_get_meta        cso_get_toc cso_get_var_values       cso_get_vars 
                  TRUE               TRUE               TRUE               TRUE 
        cso_search_toc 
                  TRUE 
...
| Execution Time | 2025-02-17 04:31:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bd672cb6e0f_1739766676
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp615b32
...
These are the options set to generate the report:
    ...
    [1] "validation_report_csodata_v1.5.0-tikzDictionary"
