...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Beatriz Pateiro-Lopez <beatriz.pateiro@usc.es>       |
...
| 3   | R.utils         | Imports |
| 4   | sgeostat        | Imports |
| 5   | spatstat.geom   | Imports |
| 6   | spatstat.random | Imports |
| 7   | splancs         | Imports |
...
alphashape3d, ashapesampler, cassowaryr, directlabels, divent, EcoIndR,
ecospat, hypervolume, molaR, Morphoscape, qlcVisualize, rangeBuilder,
SPIAT
...
Overall the package has 18 exported objects. 18 are documented:
            ...
            ahull   ahull_track     anglesArc           arc     areaahull 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    areaahulleval        ashape    complement        delvor     dummycoor 
             TRUE          TRUE          TRUE          TRUE          TRUE 
               dw      dw_track       inahull         inter          koch 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      lengthahull         rkoch      rotation 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-14 06:49:48 UTC |
...
running this report
    ...
    PROCESSX_PS726d5011c9b1_1739515785
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJYZMeT
