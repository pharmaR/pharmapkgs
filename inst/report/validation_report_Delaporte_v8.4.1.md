# Validation Report - Delaporte@8.4.1
...
| export_help          | 7                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Avraham Adler <Avraham.Adler@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/aadler/Delaporte     |
...
Overall the package has 7 exported objects. 7 are documented:
             ...
             ddelap getDelapThreads        MoMdelap          pdelap          qdelap 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             rdelap setDelapThreads 
               TRUE            TRUE 

### Examples

There are 1 help pages with examples, from 3 (33.33 %).
...
| Execution Time | 2025-02-18 03:38:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41fcc2e5f_1739849879
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQTrd8X
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Delaporte_v8.4.1-tikzDictionary"
