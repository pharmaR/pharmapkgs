# Validation Report - betategarch@3.3
...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Genaro Sucarrat <genaro.sucarrat@bi.no>              |
...
Overall the package has 16 exported objects. 16 are documented:
         ...
         coef.tegarch               dST    fitted.tegarch    logLik.tegarch 
                 TRUE              TRUE              TRUE              TRUE 
      predict.tegarch     print.tegarch residuals.tegarch               rST 
                 TRUE              TRUE              TRUE              TRUE 
           STkurtosis            STmean        STskewness             STvar 
                 TRUE              TRUE              TRUE              TRUE 
      summary.tegarch           tegarch        tegarchSim      vcov.tegarch 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 03:56:21 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6b78bac3_1739591776
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNYvHsA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_betategarch_v3.3-tikzDictionary"
