# Validation Report - BSagri@0.1.10
...
Overall the package has 28 exported objects. 28 are documented:
         ...
         allignment    BOOTSimpsonD    BOOTSimpsonR     c2compnames          CCDiff 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        CCDiff.boot  CCDiff.default         CCRatio    CCRatio.boot CCRatio.default 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              CIGLM            CInp       CInp.bugs     CInp.CCDiff    CInp.CCRatio 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       CInp.default     IAcontrasts IAcontrastsCMAT     minus2slash           SCSnp 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         SCSnp.bugs    SCSnp.CCDiff   SCSnp.CCRatio   SCSnp.default    simplesimint 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            UnlogCI         UnlogCI    UnlogCI.glht 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-22 03:19:35 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb18c4d969_1740194371
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVtErgo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BSagri_v0.1.10-tikzDictionary"
