...
| export_help          | 33                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Leena Choi <leena.choi@vanderbilt.edu>               |
...
Overall the package has 33 exported objects. 33 are documented:
           ...
           addLastDose     analysisPheWAS          buildDose       collapseDose 
                  TRUE               TRUE               TRUE               TRUE 
    dataTransformation         extractMed            freqNum        idCrosswalk 
                  TRUE               TRUE               TRUE               TRUE 
               Logistf           makeDose         parseCLAMP         parseMedEx 
                  TRUE               TRUE               TRUE               TRUE 
      parseMedExtractR         parseMedXN    processLastDose         pullFakeId 
                  TRUE               TRUE               TRUE               TRUE 
            pullRealId      readTransform    run_Build_PK_IV  run_Build_PK_Oral 
                  TRUE               TRUE               TRUE               TRUE 
              run_Demo      run_DrugLevel           run_Labs        run_MedStrI 
                  TRUE               TRUE               TRUE               TRUE 
          run_MedStrII           stdzDose     stdzDoseChange   stdzDoseSchedule 
                  TRUE               TRUE               TRUE               TRUE 
          stdzDuration           stdzFreq          stdzRoute       stdzStrength 
                  TRUE               TRUE               TRUE               TRUE 
          zeroOneTable 
                  TRUE 
...
There are 45 help pages with examples, from 51 (88.24 %).
...
| Execution Time | 2025-02-19 03:50:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d456a3979df_1739937019
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHtwyop
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EHR_v0.4.11-tikzDictionary"
