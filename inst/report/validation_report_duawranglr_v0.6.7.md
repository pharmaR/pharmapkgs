# Validation Report - duawranglr@0.6.7
...
| export_help          | 9                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Benjamin Skinner <btskinner@coe.ufl.edu> |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/btskinner/duawranglr  |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    check_dua_restrictions               deid_dua      make_dua_template 
                      TRUE                   TRUE                   TRUE 
             read_dua_file          see_dua_level        see_dua_options 
                      TRUE                   TRUE                   TRUE 
                set_dua_cw          set_dua_level           write_dua_df 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:59:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46cf94e2e_1739854742
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYtwnZo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_duawranglr_v0.6.7-tikzDictionary"
