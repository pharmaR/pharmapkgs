...
| has_source_control   | https://github.com/ptitle/envirem          |
...
Overall the package has 17 exported objects. 17 are documented:
    ...
    aridityIndexThornthwaite              assignNames    climaticMoistureIndex 
                        TRUE                     TRUE                     TRUE 
              continentality                embergerQ          ETsolradRasters 
                        TRUE                     TRUE                     TRUE 
             generateEnvirem           growingDegDays         monthCountByTemp 
                        TRUE                     TRUE                     TRUE 
                  monthlyPET             namingScheme        otherTempExtremes 
                        TRUE                     TRUE                     TRUE 
              pacificCentric              petExtremes           PETseasonality 
                        TRUE                     TRUE                     TRUE 
             thermicityIndex        verifyRasterNames 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-19 04:12:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d45425f50bc_1739938320
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp588jqS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_envirem_v3.0-tikzDictionary"
