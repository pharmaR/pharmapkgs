...
| export_help          | 15                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Johannes Gruber <johannesb.gruber@gmail.com> |
| bugs_status          | subscript out of bounds                      |
| size_codebase        | 490                                          |
| has_source_control   | https://github.com/JBGruber/askgpt           |
...
Overall the package has 15 exported objects. 15 are documented:
       ...
       annotate_code           askgpt         chat_api  completions_api 
                TRUE             TRUE             TRUE             TRUE 
       document_code   estimate_token     explain_code      list_models 
                TRUE             TRUE             TRUE             TRUE 
            log_init            login new_conversation   parse_response 
                TRUE             TRUE             TRUE             TRUE 
      prompt_history response_history    test_function 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-14 07:27:16 UTC |
...
running this report
    ...
    PROCESSX_PS1c0929d26e40_1739518033
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpP3WQHQ
