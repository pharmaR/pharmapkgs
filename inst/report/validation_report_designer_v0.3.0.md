# Validation Report - designer@0.3.0
...
| export_help          | 1                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Ashley Baldry <arbaldry91@gmail.com> |
...
| 2   | bslib              | Imports |
| 3   | cicerone           | Imports |
| 4   | config (\>= 0.3.1) | Imports |
| 5   | fontawesome        | Imports |
| 6   | golem (\>= 0.3.1)  | Imports |
| 7   | htmltools          | Imports |
| 8   | jsonlite           | Imports |
| 9   | rappdirs           | Imports |
| 10  | shinipsum          | Imports |
| 11  | shiny (\>= 1.7.1)  | Imports |
| 12  | shinyscreenshot    | Imports |
...
| Execution Time | 2025-02-18 03:48:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4270c658f_1739850476
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBWzKY3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_designer_v0.3.0-tikzDictionary"
