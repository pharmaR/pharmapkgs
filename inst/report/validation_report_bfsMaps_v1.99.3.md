# Validation Report - bfsMaps@1.99.3
...
| has_source_control   | https://github.com/AndriSignorell/bfsMaps/ |
...
Overall the package has 21 exported objects. 21 are documented:
           ...
           AddLakes       AddRivers       AddWaters        BfSStamp     CombineKant 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        CombinePolg CombinePolygons DownloadBfSMaps          GetMap      Neighbours 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           PlotBezk        PlotBezk          PlotCH        PlotGreg        PlotKant 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         PlotMapDot        PlotMSRe        PlotPolg     PlotPremReg    SwissLocator 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              tkart 
               TRUE 
...
| Execution Time | 2025-02-15 03:58:01 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7a6236df_1739591876
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLPwVE6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bfsMaps_v1.99.3-tikzDictionary"
