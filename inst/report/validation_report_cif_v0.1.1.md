...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Paolo Paruolo <Paolo.PARUOLO@ec.europa.eu>           |
...
Overall the package has 20 exported objects. 20 are documented:
           ...
           crossing           diffe    ec.companion     ec.datadet1     ec.datadet2 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         ec.datalag          ec.EG1          ec.gfd          ec.gfl         ec.gfld 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             ec.ifp         ec.main      ec.plotfor    ec.plotroots      ec.predict 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    ec.searchbreaks            lagn        listsize             mls        Wald.mls 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-16 04:18:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35cd98674_1739679506
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAWbQ72
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cif_v0.1.1-tikzDictionary"
