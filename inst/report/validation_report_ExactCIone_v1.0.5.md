# Validation Report - ExactCIone@1.0.5
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Chongxiu Yu <yuchongxiu@163.com>                     |
...
Overall the package has 12 exported objects. 12 are documented:
             ...
             WbinoCI    WbinoCI_lower    WbinoCI_upper       WhyperCI_M 
                TRUE             TRUE             TRUE             TRUE 
    WhyperCI_M_lower WhyperCI_M_upper       WhyperCI_N WhyperCI_N_lower 
                TRUE             TRUE             TRUE             TRUE 
    WhyperCI_N_upper          WpoisCI    WpoisCI_lower    WpoisCI_upper 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 04:46:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d45356e94cd_1739940364
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpctrWY6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ExactCIone_v1.0.5-tikzDictionary"
