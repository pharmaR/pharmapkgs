# Validation Report - DClusterm@1.0.1
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Virgilio Gomez-Rubio <virgilio.gomez@uclm.es>        |
...
Overall the package has 8 exported objects. 8 are documented:
                        ...
                        computeprob             DetectClustersModel 
                               TRUE                            TRUE 
                  get.allknclusters                  get.stclusters 
                               TRUE                            TRUE 
                           knbinary                 mergeknclusters 
                               TRUE                            TRUE 
    SelectStatsAllClustersNoOverlap                  slimknclusters 
                               TRUE                            TRUE 
...
| Execution Time | 2025-02-17 05:10:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bd619ed9b43_1739769040
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbMnS43
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DClusterm_v1.0.1-tikzDictionary"
