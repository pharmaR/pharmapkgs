# Validation Report - dataMojo@1.0.0
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jiena McLellan <jienagu90@gmail.com>                 |
...
Overall the package has 17 exported objects. 17 are documented:
           ...
           col_cal_percent            dt_group_by           fill_NA_with 
                      TRUE                   TRUE                   TRUE 
                filter_all          filter_all_at             filter_any 
                      TRUE                   TRUE                   TRUE 
             filter_any_at       get_row_group_by       pivot_percent_at 
                      TRUE                   TRUE                   TRUE 
    pivot_percent_at_multi         reshape_longer          reshape_wider 
                      TRUE                   TRUE                   TRUE 
          row_expand_dates     row_expand_pattern    row_percent_convert 
                      TRUE                   TRUE                   TRUE 
               select_cols          str_split_col 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-17 04:58:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64d0dde6f_1739768318
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCjRq3c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dataMojo_v1.0.0-tikzDictionary"
