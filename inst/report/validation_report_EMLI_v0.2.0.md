...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Vytautas Dulskis <vytautas.dulskis@gmail.com>        |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    calculate_likelihood  estimate_parameters   evaluate_estimates 
                    TRUE                 TRUE                 TRUE 
           generate_data 
                    TRUE 
...
| Execution Time | 2025-02-19 04:02:31 UTC |
...
running this report
    ...
    PROCESSX_PS1d45e7f8abd_1739937745
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEbc4oE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EMLI_v0.2.0-tikzDictionary"
