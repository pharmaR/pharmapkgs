...
| export_help          | 7                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Victoria Dominguez Almela <vda1r22@soton.ac.uk> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/vda1r22/bbnet                |
| has_bug_reports_url  | 1                                               |
| downloads_1yr        | 2348                                            |
| reverse_dependencies | 0                                               |
| has_examples         | 0.4666667                                       |
| dependencies         | 5                                               |
| license              | GPL (\>= 2)                                     |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    bbn.network.diagram         bbn.predict     bbn.sensitivity      bbn.timeseries 
                   TRUE                TRUE                TRUE                TRUE 
          bbn.visualise             isEmpty           multiplot 
                   TRUE                TRUE                TRUE 

### Examples

There are 7 help pages with examples, from 15 (46.67 %).
...
| Execution Time | 2025-02-15 03:44:25 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd789a3015_1739591061
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVTUfr0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bbnet_v1.1.0-tikzDictionary"
