# Validation Report - CVrisk@1.1.1
...
| export_help          | 6                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Victor Castro <vcastro@mgh.harvard.edu> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/vcastro/CVrisk       |
...
Overall the package has 6 exported objects. 6 are documented:
        ...
        ascvd_10y_accaha        ascvd_10y_frs ascvd_10y_frs_simple 
                    TRUE                 TRUE                 TRUE 
            chd_10y_mesa     chd_10y_mesa_cac       compute_CVrisk 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-17 04:44:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67af8dfde_1739767478
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpC42iKC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CVrisk_v1.1.1-tikzDictionary"
