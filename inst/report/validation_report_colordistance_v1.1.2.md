# Validation Report - colordistance@1.1.2
...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Hannah Weller <hannahiweller@gmail.com>              |
...
Overall the package has 23 exported objects. 23 are documented:
           ...
           combineClusters            combineList      convertColorSpace 
                      TRUE                   TRUE                   TRUE 
                exportTree        extractClusters getColorDistanceMatrix 
                      TRUE                   TRUE                   TRUE 
               getHistList           getImageHist          getImagePaths 
                      TRUE                   TRUE                   TRUE 
            getKMeanColors          getKMeansList             getLabHist 
                      TRUE                   TRUE                   TRUE 
            getLabHistList   heatmapColorDistance   imageClusterPipeline 
                      TRUE                   TRUE                   TRUE 
                 loadImage           plotClusters      plotClustersMulti 
                      TRUE                   TRUE                   TRUE 
                  plotHist              plotImage             plotPixels 
                      TRUE                   TRUE                   TRUE 
          removeBackground      scatter3dclusters 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:59:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bc327856c60_1739681941
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSWm5f8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colordistance_v1.1.2-tikzDictionary"
