# Validation Report - evinf@0.8.10
...
| export_help          | 8                                       |
| has_website          | TRUE                                    |
| has_maintainer       | David Randahl <david.randahl@pcr.uu.se> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/Doktorandahl/evinf   |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    coefficient_extractor        compare_models                 evinb 
                     TRUE                  TRUE                  TRUE 
                   evzinb               lr_test        oob_evaluation 
                     TRUE                  TRUE                  TRUE 
               revinb_fit           revzinb_fit 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-19 04:42:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d452d4288cc_1739940124
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9zb6vD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evinf_v0.8.10-tikzDictionary"
