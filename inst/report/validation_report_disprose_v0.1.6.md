# Validation Report - disprose@0.1.6
...
| export_help          | 36                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Elena Filatova <filatova@nniiem.ru>                  |
...
Overall the package has 36 exported objects. 36 are documented:
              ...
              add_adapters        annotate_probes            blast_local 
                      TRUE                   TRUE                   TRUE 
                  count_GC              count_MFE             count_PhCh 
                      TRUE                   TRUE                   TRUE 
                 count_REP               count_TM             cut_probes 
                      TRUE                   TRUE                   TRUE 
                cut_string   delete_AcNum_version   delete_duplicates_DF 
                      TRUE                   TRUE                   TRUE 
            delete_from_DB     fill_blast_results           get_GA_files 
                      TRUE                   TRUE                   TRUE 
                   get_GIs            get_GIs_fix         get_seq_for_DB 
                      TRUE                   TRUE                   TRUE 
        get_seq_for_DB_fix           get_seq_info       get_seq_info_fix 
                      TRUE                   TRUE                   TRUE 
                  index_DB        info_listtodata                list_DB 
                      TRUE                   TRUE                   TRUE 
             make_blast_DB               make_ids           normalize_DF 
                      TRUE                   TRUE                   TRUE 
                   rate_DF   read_and_unite_files           read_from_DB 
                      TRUE                   TRUE                   TRUE 
      read_from_table_file summarize_blast_result                trim_DF 
                      TRUE                   TRUE                   TRUE 
        unite_NCBI_ac.nums           unite_two_DF            write_to_DB 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 04:16:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41a05a10c_1739852195
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnJa17d
...
These are the options set to generate the report:
    ...
    [1] "validation_report_disprose_v0.1.6-tikzDictionary"
