# Validation Report - DrBats@0.1.6
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Benedicte Fontez <benedicte.fontez@supagro.fr>       |
...
Overall the package has 12 exported objects. 12 are documented:
            ...
            coda.obj coinertia.drbats     drbats.simul        histoProj 
                TRUE             TRUE             TRUE             TRUE 
            modelFit      pca.Deville      pca.proj.Xt         postdens 
                TRUE             TRUE             TRUE             TRUE 
             visbeta             visW             W.QR weighted.Deville 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:44:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bb474dddd77_1739853839
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpua16vn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DrBats_v0.1.6-tikzDictionary"
