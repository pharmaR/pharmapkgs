# Validation Report - DataSpaceR@0.7.6
...
| export_help          | 5                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Jason Taylor <jmtaylor@fredhutch.org>  |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/ropensci/DataSpaceR |
...
| 1   | utils               | Imports |
| 2   | R6                  | Imports |
| 3   | Rlabkey (\>= 2.2.0) | Imports |
| 4   | curl                | Imports |
| 5   | httr                | Imports |
| 6   | assertthat          | Imports |
| 7   | digest              | Imports |
| 8   | jsonlite            | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
      ...
      checkNetrc    connectDS getNetrcPath   makeFilter   writeNetrc 
...
| Execution Time | 2025-02-17 05:01:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63e8b8755_1739768482
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLk8T8E
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DataSpaceR_v0.7.6-tikzDictionary"
