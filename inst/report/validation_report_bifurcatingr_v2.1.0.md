# Validation Report - bifurcatingr@2.1.0
...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Tamer Elbayoumi <tmelbayoumi@ncat.edu>               |
...
Overall the package has 18 exported objects. 18 are documented:
         ...
         bfa_boot_ci   bfa_boot_ls_bc     bfa_boot1_ls     bfa_boot2_ls 
                TRUE             TRUE             TRUE             TRUE 
    bfa_boot2fast_ls       bfa_lbc_ls           bfa_ls        bfa_ls_bc 
                TRUE             TRUE             TRUE             TRUE 
        bfa_ls_bc_ci   bfa_perc_bc_ci      bfa_perc_ci  bfa_scatterplot 
                TRUE             TRUE             TRUE             TRUE 
         bfa_subtree     bfa_tree_gen    bfa_tree_plot      boot_bca_ci 
                TRUE             TRUE             TRUE             TRUE 
          rcontmnorm           rmnorm 
                TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:02:45 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2f94c308_1739592160
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAsxLFW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bifurcatingr_v2.1.0-tikzDictionary"
