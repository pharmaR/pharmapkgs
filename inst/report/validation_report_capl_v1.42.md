...
| export_help          | 40                                |
| has_website          | TRUE                              |
| has_maintainer       | Joel Barnes <j@barnzilla.ca>      |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/barnzilla/capl |
...
Overall the package has 40 exported objects. 40 are documented:
              ...
              capitalize_character               export_capl_data 
                              TRUE                           TRUE 
                 get_24_hour_clock             get_adequacy_score 
                              TRUE                           TRUE 
                  get_binary_score                get_camsa_score 
                              TRUE                           TRUE 
        get_camsa_skill_time_score           get_camsa_time_score 
                              TRUE                           TRUE 
                          get_capl              get_capl_bar_plot 
                              TRUE                           TRUE 
                get_capl_demo_data         get_capl_domain_status 
                              TRUE                           TRUE 
           get_capl_interpretation                 get_capl_score 
                              TRUE                           TRUE 
                      get_db_score   get_fill_in_the_blanks_score 
                              TRUE                           TRUE 
    get_intrinsic_motivation_score                   get_ku_score 
                              TRUE                           TRUE 
                      get_mc_score     get_missing_capl_variables 
                              TRUE                           TRUE 
           get_pa_competence_score             get_pacer_20m_laps 
                              TRUE                           TRUE 
                   get_pacer_score                   get_pc_score 
                              TRUE                           TRUE 
           get_pedometer_wear_time                get_plank_score 
                              TRUE                           TRUE 
            get_predilection_score       get_self_report_pa_score 
                              TRUE                           TRUE 
                  get_step_average                 get_step_score 
                              TRUE                           TRUE 
                  import_capl_data                rename_variable 
                              TRUE                           TRUE 
                      validate_age             validate_character 
                              TRUE                           TRUE 
             validate_domain_score                validate_gender 
                              TRUE                           TRUE 
                  validate_integer                validate_number 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-16 03:39:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bc316a2b6bf_1739677154
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDkOgLf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_capl_v1.42-tikzDictionary"
