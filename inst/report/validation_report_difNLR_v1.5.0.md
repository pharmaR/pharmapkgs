# Validation Report - difNLR@1.5.0
...
| export_help          | 10                              |
| has_website          | FALSE                           |
| has_maintainer       | Adela Hladka <hladka@cs.cas.cz> |
...
ShinyItemAnalysis, SIAmodules

## Namespace

Overall the package has 10 exported objects. 10 are documented:

        ddfMLR     difNLR     difORD   estimNLR formulaNLR     genNLR        MLR 
...
| Execution Time | 2025-02-18 04:05:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bb420dfad0d_1739851520
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0wgXii
...
These are the options set to generate the report:
    ...
    [1] "validation_report_difNLR_v1.5.0-tikzDictionary"
