# Validation Report - bgms@0.1.4.2
...
| export_help          | 13                                 |
| has_website          | TRUE                               |
| has_maintainer       | Maarten Marsman <m.marsman@uva.nl> |
...
Overall the package has 13 exported objects. 13 are documented:
                  ...
                  extract_category_thresholds 
                     ...
                     extract_indicator_priors 
                           ...
                           extract_indicators 
                                         TRUE 
           extract_main_difference.bgmCompare 
                                         TRUE 
       extract_pairwise_difference.bgmCompare 
                                         TRUE 
...
| Execution Time | 2025-02-15 03:59:10 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd532a5795_1739591945
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVqPcUe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bgms_v0.1.4.2-tikzDictionary"
