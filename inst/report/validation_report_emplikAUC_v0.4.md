# Validation Report - emplikAUC@0.4
...
Overall the package has 17 exported objects. 17 are documented:
       ...
       EL2paucT1T2    el2test4auc    el2testPauc   el2testPaucT  eltest4aucONE 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    eltest4paucONE   eltest4paucT       findLnew      findULNEW       findUnew 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        myEstPaucT       quantONE        smooth0        smooth3     smooth3vec 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        smooth5vec     smoothLvec 
              TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:04:47 UTC |
...
running this report
    ...
    PROCESSX_PS1d453a46f527_1739937881
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBIKFDR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emplikAUC_v0.4-tikzDictionary"
