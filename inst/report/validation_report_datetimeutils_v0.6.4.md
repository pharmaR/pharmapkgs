# Validation Report - datetimeutils@0.6.4
...
| export_help          | 35                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Enrico Schumann <es@enricoschumann.net>              |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/enricoschumann/datetimeutils      |
...
GDELTtools, NMOF, PMwR, tsdb

## Namespace

Overall the package has 35 exported objects. 35 are documented:

              convert_date             convert_tz               date1904 
                      TRUE                   TRUE                   TRUE 
              day_of_month         day_of_month<-           end_of_month 
                      TRUE                   TRUE                   TRUE 
     end_of_previous_month   end_of_previous_year         end_of_quarter 
                      TRUE                   TRUE                   TRUE 
               end_of_year         first_of_month          first_of_year 
                      TRUE                   TRUE                   TRUE 
            guess_datetime                   hour         is_businessday 
                      TRUE                   TRUE                   TRUE 
               is_leapyear             is_weekend           last_weekday 
                      TRUE                   TRUE                   TRUE 
                      mday                 mday<-                 minute 
                      TRUE                   TRUE                   TRUE 
                     month month.abb.de.din1355.1          month.name.de 
                      TRUE                   TRUE                   TRUE 
                 next_bday       next_businessday                nth_day 
                      TRUE                   TRUE                   TRUE 
               nth_weekday              prev_bday   previous_businessday 
                      TRUE                   TRUE                   TRUE 
                   rfc822t            roundPOSIXt                 second 
                      TRUE                   TRUE                   TRUE 
                  timegrid                   year 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-17 05:03:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63fd35da5_1739768621
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpImSWZQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datetimeutils_v0.6.4-tikzDictionary"
