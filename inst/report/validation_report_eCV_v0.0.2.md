...
| export_help | 5 |
| has_website | TRUE |
| has_maintainer | Agustin Gonzalez-Reymundez <agustin.gonrey@eclipsebio.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/eclipsebio/eCV |
...
|:----|:-------------------------|:--------|
| 1   | idr (\>= 1.3)            | Depends |
| 2   | mvtnorm (\>= 1.1.3)      | Depends |
| 3   | future (\>= 1.4.0)       | Depends |
| 4   | future.apply (\>= 1.9.0) | Depends |
| 5   | stats                    | Imports |
| 6   | utils                    | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
                ...
                eCV            gIDR            mIDR mrep_assessment   simulate_data 
...
| Execution Time | 2025-02-19 03:39:19 UTC |
...
running this report
    ...
    PROCESSX_PS1d4542678af0_1739936353
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfrmOJM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eCV_v0.0.2-tikzDictionary"
