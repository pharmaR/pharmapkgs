# Validation Report - EHRmuse@0.0.2.1
...
| has_source_control   | https://github.com/Ritoban1/EHRmuse                  |
...
| 2   | magrittr               | Imports |
| 3   | MASS                   | Imports |
| 4   | nleqslv (\>= 3.3.2)    | Imports |
| 5   | xgboost (\>= 1.4.1)    | Imports |
| 6   | survey (\>= 4.1.0)     | Imports |
| 7   | stats                  | Imports |
| 8   | nnet (\>= 7.3-17)      | Imports |
| 9   | simplexreg (\>= 0.1.6) | Imports |
...
| Execution Time | 2025-02-19 03:50:31 UTC |
...
running this report
    ...
    PROCESSX_PS1d456d8864cd_1739937025
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpj1OFfv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EHRmuse_v0.0.2.1-tikzDictionary"
