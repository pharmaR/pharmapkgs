# Validation Report - datplot@1.1.1
...
| export_help          | 6                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Lisa Steinmann <lisa.steinmann@rub.de> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/lsteinmann/datplot  |
...
Overall the package has 6 exported objects. 6 are documented:
              ...
              datsteps get.histogramscale    get.probability  get.step.sequence 
                  TRUE               TRUE               TRUE               TRUE 
           get.weights        scaleweight 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-17 05:04:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6129f85d0_1739768652
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAuddl8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_datplot_v1.1.1-tikzDictionary"
