...
| export_help          | 12                                     |
| has_website          | FALSE                                  |
| has_maintainer       | Natalia Martinkova <martinkova@ivb.cz> |
...
Overall the package has 12 exported objects. 12 are documented:
             ...
             CheckDiemFormat                     diem               emPolarise 
                        TRUE                     TRUE                     TRUE 
             importPolarized      pHetErrOnStateCount            plotDeFinetti 
                        TRUE                     TRUE                     TRUE 
              plotMarkerAxis            plotPolarized                 rank2map 
                        TRUE                     TRUE                     TRUE 
    smoothPolarizedGenotypes              sStateCount                 vcf2diem 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-18 04:02:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bb427acd29c_1739851342
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmgX4jt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diemr_v1.4.3-tikzDictionary"
