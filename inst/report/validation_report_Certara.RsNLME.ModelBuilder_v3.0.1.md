# Validation Report - Certara.RsNLME.ModelBuilder@3.0.1
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | Certara.RsNLME    | Imports |
| 2   | shinymeta         | Imports |
| 3   | shinyAce          | Imports |
| 4   | bslib (\>= 0.7.0) | Imports |
| 5   | data.table        | Imports |
| 6   | DT                | Imports |
| 7   | ggplot2           | Imports |
| 8   | ggforce           | Imports |
| 9   | htmltools         | Imports |
| 10  | htmlwidgets       | Imports |
| 11  | magrittr          | Imports |
| 12  | methods           | Imports |
| 13  | shiny (\>= 1.7.0) | Imports |
| 14  | shinyjs           | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
          ...
          change_ThetasMmdl create_metamodelBuiltin create_metamodelTextual 
                       TRUE                    TRUE                    TRUE 
                estimatesUI          modelBuilderUI          modelTextualUI 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-16 04:03:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3204db1f5_1739678579
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8pGnco
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Certara.RsNLME.ModelBuilder_v3.0.1-tikzDictionary"
