...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Baidya Nath Mandal <mandal.stat@gmail.com>           |
...
Overall the package has 18 exported objects. 18 are documented:
     ...
     alternate.sol alternate.sol2 alternate.sol3       aoptbbpb       aoptgdtd 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            bbpbwq   block.design         btibts    check.group              g 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             gbbpb          getr0         getrow        getrow2        getrow3 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             getts          getwq     wtaoptbtib 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-14 06:58:05 UTC |
...
running this report
    ...
    PROCESSX_PS726d7cbaadaf_1739516282
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplzJilH
