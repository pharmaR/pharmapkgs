# Validation Report - demoGraphic@0.1.0
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Loan Robinson <loankimrobinson@gmail.com>            |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       cat_smd  cat_table   cont_smd cont_table demo_table   get_mean  my.chi.sq 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
     my.fisher     mydocx     smd_ci 
          TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-18 03:39:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bb430f4d299_1739849986
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp97BKHE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_demoGraphic_v0.1.0-tikzDictionary"
