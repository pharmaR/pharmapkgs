...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Matthieu Herrmann <matthieu.herrmann@monash.edu>     |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | rJava (\>= 0.9.9) | Imports |
| 2   | commonsMath       | Imports |
| 3   | stats             | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    ChoR.as.cliques ChoR.as.formula   ChoR.as.graph     ChoR.Budget        ChoR.MML 
...
| Execution Time | 2025-02-16 04:15:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3727c563e_1739679338
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpryFjXJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ChoR_v0.0.4-tikzDictionary"
