...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Maxwell Mansolf <maxwell.mansolf@northwestern.edu>   |
...
Overall the package has 11 exported objects. 10 are documented:
                                  ...
                                  %>%                       align.optim 
                                FALSE                              TRUE 
                            Alignment               getEstimates.lavaan 
                                 TRUE                              TRUE 
                    getEstimates.mirt      loadEstimates.lavaan.ordered 
                                 TRUE                              TRUE 
               loadEstimates.mirt.grm                        SF.mplus3D 
                                 TRUE                              TRUE 
                       stackEstimates transformEstimates.lavaan.ordered 
                                 TRUE                              TRUE 
...
| Execution Time | 2025-02-14 06:48:27 UTC |
...
running this report
    ...
    PROCESSX_PS726d6c46d6ef_1739515704
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnH95rd
