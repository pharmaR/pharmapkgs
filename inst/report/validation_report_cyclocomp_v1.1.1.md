# Validation Report - cyclocomp@1.1.1
...
| export_help          | 4                                        |
| has_website          | TRUE                                     |
| has_maintainer       | Gabor Csardi <csardi.gabor@gmail.com>    |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/gaborcsardi/cyclocomp |
| has_bug_reports_url  | 1                                        |
| downloads_1yr        | 1065807                                  |
...
fakemake, goodpractice, lintr, packager, PaRe

## Namespace

Overall the package has 4 exported objects. 4 are documented:

                cyclocomp     cyclocomp_package cyclocomp_package_dir 
                     TRUE                  TRUE                  TRUE 
              cyclocomp_q 
                     TRUE 
...
| Execution Time | 2025-02-17 04:46:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6316786d3_1739767559
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4hzfkt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cyclocomp_v1.1.1-tikzDictionary"
