# Validation Report - drgee@1.1.10
...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Johan Zetterqvist <drjohanzetterqvist@gmail.com>     |
...
Overall the package has 22 exported objects. 22 are documented:
                      ...
                      drgeeData                   findRoots 
                           TRUE                        TRUE 
                            gee getScoreResidualsFromClogit 
                           TRUE                        TRUE 
                      naiveVcov               naiveVcov.gee 
                           TRUE                        TRUE 
                    print.drgee                   print.gee 
                           TRUE                        TRUE 
            print.summary.drgee     print.summary.drgeeData 
                           TRUE                        TRUE 
              print.summary.gee                  robustVcov 
                           TRUE                        TRUE 
                        robVcov               summary.drgee 
                           TRUE                        TRUE 
              summary.drgeeData                 summary.gee 
                           TRUE                        TRUE 
                     vcov.drgee                    vcov.gee 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-18 04:45:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb453d3c676_1739853931
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpa12vRd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drgee_v1.1.10-tikzDictionary"
