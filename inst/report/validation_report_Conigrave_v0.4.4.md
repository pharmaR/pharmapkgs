# Validation Report - Conigrave@0.4.4
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | James Conigrave <james.conigrave@gmail.com>          |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | ggplot2 (\>= 3.1.1)     | Imports |
| 2   | stringdist(\>= 0.9.5.1) | Imports |
| 3   | dplyr(\>= 0.8.0.1)      | Imports |
| 4   | stringr(\>= 1.4.0)      | Imports |
| 5   | ppcor(\>= 1.1)          | Imports |
| 6   | mitools(\>= 2.4)        | Imports |
| 7   | miceadds(\>= 3.2-48)    | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
       ...
       autoModel  check_names  correlatrix         ctrx find_similar  get.numeric 
...
| Execution Time | 2025-02-17 03:45:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6134f54e4_1739763906
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbHSGqS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Conigrave_v0.4.4-tikzDictionary"
