# Validation Report - EFA.dimensions@0.1.8.4
...
| export_help          | 24                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Brian P. O’Connor <brian.oconnor@ubc.ca>             |
...
Overall the package has 24 exported objects. 24 are documented:
              ...
              COMPLEXITY           CONGRUENCE             DIMTESTS 
                    TRUE                 TRUE                 TRUE 
                     EFA           EFA_SCORES                EMPKC 
                    TRUE                 TRUE                 TRUE 
            EXTENSION_FA        FACTORABILITY INTERNAL.CONSISTENCY 
                    TRUE                 TRUE                 TRUE 
                LOCALDEP                  MAP         MISSING_INFO 
                    TRUE                 TRUE                 TRUE 
               NEVALSGT1             PARALLEL                  PCA 
                    TRUE                 TRUE                 TRUE 
            POLYCHORIC_R           PROCRUSTES               RAWPAR 
                    TRUE                 TRUE                 TRUE 
                  RECODE              ROOTFIT              SALIENT 
                    TRUE                 TRUE                 TRUE 
              SCREE_PLOT              SESCREE                  SMT 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 03:45:48 UTC |
...
running this report
    ...
    PROCESSX_PS1d45734c5332_1739936742
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5Q5vz4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EFA.dimensions_v0.1.8.4-tikzDictionary"
