# Validation Report - eixport@0.6.2
...
| export_help          | 19                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Sergio Ibarra-Espinosa <zergioibarra@gmail.com> |
...
Overall the package has 19 exported objects. 19 are documented:
      ...
      chem_edgar    get_edgar  sfx_explode   st_explode    to_as4wrf to_brams_spm 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       to_munich     to_rline       to_wrf      wrf_add   wrf_create      wrf_get 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        wrf_grid     wrf_meta     wrf_plot  wrf_profile      wrf_put   wrf_raster 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
     wrf_summary 
            TRUE 
...
| Execution Time | 2025-02-19 03:53:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d452822747a_1739937188
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOnVCCP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eixport_v0.6.2-tikzDictionary"
