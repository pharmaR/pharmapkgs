# Validation Report - basksim@1.0.0
...
| size_codebase        | 1110                                           |
| has_source_control   | https://github.com/lbau7/basksim               |
...
| 3   | bmabasket    | Imports |
| 4   | doFuture     | Imports |
| 5   | extraDistr   | Imports |
| 6   | foreach      | Imports |
| 7   | HDInterval   | Imports |
| 8   | progressr    | Imports |
...
Overall the package has 17 exported objects. 17 are documented:
      ...
      adjust_lambda             ecd        get_data     get_details     get_results 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      get_scenarios      opt_design       setup_bhm       setup_bma       setup_cpp 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    setup_cppglobal     setup_exnex  setup_fujikawa setup_jsdglobal       setup_mml 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    setup_mmlglobal            toer 
               TRUE            TRUE 
...
| Execution Time | 2025-02-14 07:45:19 UTC |
...
running this report
    ...
    PROCESSX_PS1c0974d5d6d6_1739519116
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpM9AdXA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_basksim_v1.0.0-tikzDictionary"
