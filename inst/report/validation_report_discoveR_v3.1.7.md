# Validation Report - discoveR@3.1.7
...
| export_help          | 36                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Oldemar Rodriguez <oldemar.rodriguez@ucr.ac.cr> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/PROMiDAT/discoveR            |
...
| 11  | shinyAce                       | Imports |
| 12  | ggdendro                       | Imports |
| 13  | echarts4r                      | Imports |
| 14  | htmltools                      | Imports |
| 15  | FactoMineR                     | Imports |
| 16  | htmlwidgets                    | Imports |
| 17  | colourpicker                   | Imports |
| 18  | shinydashboard                 | Imports |
| 19  | shinycustomloader              | Imports |
| 20  | shinydashboardPlus (\>= 2.0.0) | Imports |
...
Overall the package has 36 exported objects. 36 are documented:
                ...
                BP   calc.centros        e_afcbi     e_afcbi_3D       e_afccol 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       e_afccol_3D       e_afcmbi    e_afcmbi_3D      e_afcmcat   e_afcmcat_3D 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         e_afcmind   e_afcmind_3D      e_afcmvar   e_afcmvar_3D       e_afcrow 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       e_afcrow_3D      e_balloon          e_cat        e_horiz      e_inercia 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           e_jambu         e_mapa      e_mapa_3D        e_pcabi     e_pcabi_3D 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          e_pcaind    e_pcaind_3D       e_pcavar    e_pcavar_3D        e_radar 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      e_silhouette         e_vert gg_dendrograma  inercia.total        run_app 
              TRUE           TRUE           TRUE           TRUE           TRUE 
                WP 
              TRUE 
...
| Execution Time | 2025-02-18 04:12:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bb464184435_1739851955
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpU1aLKw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_discoveR_v3.1.7-tikzDictionary"
