# Validation Report - birdie@0.6.1
...
| export_help          | 16                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Cory McCartan <mccartan@psu.edu>       |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/CoryMcCartan/birdie |
...
Overall the package has 16 exported objects. 16 are documented:
                  ...
                  augment                birdie           birdie.ctrl 
                     TRUE                  TRUE                  TRUE 
                     bisg               bisg_me               cat_dir 
                     TRUE                  TRUE                  TRUE 
                cat_mixed census_race_geo_table           disparities 
                     TRUE                  TRUE                  TRUE 
             est_weighted                glance              p_r_natl 
                     TRUE                  TRUE                  TRUE 
                proc_name            proc_state              proc_zip 
                     TRUE                  TRUE                  TRUE 
                     tidy 
                     TRUE 
...
| Execution Time | 2025-02-15 04:17:05 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd525938bb_1739593020
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkqHEWR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_birdie_v0.6.1-tikzDictionary"
