# Validation Report - dpasurv@0.1.0
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Matthias Kormaksson <mk375@cornell.edu>              |
...
| 2   | tidyr (\>= 0.8.3)       | Imports |
| 3   | rlang (\>= 0.4.0)       | Imports |
| 4   | ggplot2 (\>= 3.2.0)     | Imports |
| 5   | survival (\>= 2.44.1.1) | Imports |
| 6   | timereg (\>= 1.9.4)     | Imports |
| 7   | methods                 | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            add.ci           Areg      check.dag            dpa         effect 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    find.variables       get.meta  ggplot.effect           Mreg           Surv 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:39:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42d3aa0fe_1739853573
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTwNaxW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dpasurv_v0.1.0-tikzDictionary"
