# Validation Report - bayesEO@0.2.1
...
| export_help          | 17                                               |
| has_website          | TRUE                                             |
| has_maintainer       | Gilberto Camara <gilberto.camara.inpe@gmail.com> |
| has_source_control   | https://github.com/e-sensing/bayesEO/            |
...
Overall the package has 17 exported objects. 17 are documented:
          ...
          bayes_colors  bayes_colors_show        bayes_label    bayes_plot_hist 
                  TRUE               TRUE               TRUE               TRUE 
        bayes_plot_map   bayes_plot_probs     bayes_plot_rgb     bayes_plot_var 
                  TRUE               TRUE               TRUE               TRUE 
      bayes_read_image   bayes_read_probs bayes_run_examples    bayes_run_tests 
                  TRUE               TRUE               TRUE               TRUE 
          bayes_smooth      bayes_summary     bayes_variance   bilateral_smooth 
                  TRUE               TRUE               TRUE               TRUE 
       gaussian_smooth 
                  TRUE 
...
| Execution Time | 2025-02-15 03:34:07 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2a0affd5_1739590443
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiP3QiO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesEO_v0.2.1-tikzDictionary"
