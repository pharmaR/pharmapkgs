# Validation Report - colorpatch@0.1.2
...
| export_help          | 31                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Andre Mueller <andre@kiwisound.de>                   |
...
Overall the package has 28 exported objects. 29 are documented:
            ...
            apply.color       ColorDistance  ColorPatchColorFun   ColorPatchSizeFun 
                   TRUE                TRUE                TRUE                TRUE 
            ColorRgbFun     ComputeSymmetry CreateClusteredData   CreateExampleData 
                   TRUE                TRUE                TRUE                TRUE 
              DistColor        DistColorFun FindUniformSequence    GeneratePalettes 
                   TRUE                TRUE                TRUE                TRUE 
            HsvColorFun          HsvSizeFun InterpolateColorFun       LinColorSpace 
                   TRUE                TRUE                TRUE                TRUE 
        OptimizeBiColor           OrderData     OrderDataHclust        OrderDataTSP 
                   TRUE                TRUE                TRUE                TRUE 
           OrderWithTSP        PlotSymmetry      PlotUniformity       ReadArraySRGB 
                   TRUE                TRUE                TRUE                TRUE 
           stat_bicolor     stat_colorpatch    theme_colorpatch         ToDataFrame 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 05:00:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bc350b3dc68_1739681994
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpF2g0a6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colorpatch_v0.1.2-tikzDictionary"
