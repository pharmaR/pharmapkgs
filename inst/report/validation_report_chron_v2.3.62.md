# Validation Report - chron@2.3.62
...
bea.R, BusinessDuration, ClimInd, cmrutils, compareGroups,
datadictionary, datetime, dga, E4tools, ensembleBMA, ensembleMOS, eSIR,
FinTS, FishResp, gsubfn, Hmisc, htmlTable, ImportExport, iNZightPlots,
iNZightTools, MetGen, movecost, PhysActBedRest, plgraphics, pmxTools,
ptairMS, qdap, qdapTools, redcapAPI, restatapi, rGV, RH2, RMAWGEN,
rugarch, sqldf, stppSim, StreamMetabolism, TideCurves, TideTables, uHMM,
ViSiElse, wakefield, xts, zoo

## Namespace

Overall the package has 26 exported objects. 26 are documented:

         .Holidays       as.chron       as.dates       as.times          chron 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       chron_trans          dates    day.of.week           days          hours 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          is.chron     is.holiday     is.weekend      leap.year        minutes 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    month.day.year         origin       origin<-  scale_x_chron  scale_y_chron 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           seconds      seq.dates          times    year.expand    year.strict 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             years 
              TRUE 
...
| Execution Time | 2025-02-16 04:16:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31391aa53_1739679400
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoLnVMM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chron_v2.3.62-tikzDictionary"
