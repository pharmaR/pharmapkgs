...
| export_help          | 30                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Valerie Robert <valerie.robert.math@gmail.com>       |
...
Overall the package has 30 exported objects. 26 are documented:

                      ARI      BIKM1_LBM_Binary     BIKM1_LBM_Poisson 
                     TRUE                  TRUE                  TRUE 
        BIKM1_MLBM_Binary        BinBlocICL_LBM       BinBlocICL_MLBM 
                     TRUE                  TRUE                  TRUE 
           BinBlocRnd_LBM       BinBlocRnd_MLBM       BinBlocVisu_LBM 
                     TRUE                  TRUE                  TRUE 
         BinBlocVisu_MLBM  BinBlocVisuResum_LBM BinBlocVisuResum_MLBM 
                     TRUE                  TRUE                  TRUE 
                     CARI                CE_LBM               CE_MLBM 
                     TRUE                  TRUE                  TRUE 
                CE_simple                 CoNMI                  ENMI 
                     TRUE                  TRUE                  TRUE 
                MI_simple               NCE_LBM            NCE_simple 
                     TRUE                  TRUE                  TRUE 
                     plot        PoissonBlocBIC        PoissonBlocICL 
                    FALSE                  TRUE                  TRUE 
           PoissonBlocRnd       PoissonBlocVisu  PoissonBlocVisuResum 
                     TRUE                  TRUE                  TRUE 
                    print                  show               summary 
                    FALSE                 FALSE                 FALSE 
...
| Execution Time | 2025-02-15 04:06:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd665129cc_1739592392
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkFP4FQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bikm1_v1.1.0-tikzDictionary"
