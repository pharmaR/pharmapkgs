# Validation Report - encryptr@0.1.3
...
| export_help          | 8                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Ewen Harrison <ewen.harrison@ed.ac.uk>          |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/SurgicalInformatics/encryptr |
...
Overall the package has 8 exported objects. 7 are documented:
             ...
             %>%      decrypt decrypt_file  decrypt_vec      encrypt encrypt_file 
...
| Execution Time | 2025-02-19 04:06:30 UTC |
...
running this report
    ...
    PROCESSX_PS1d45696ac149_1739937984
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHNZkUP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_encryptr_v0.1.3-tikzDictionary"
