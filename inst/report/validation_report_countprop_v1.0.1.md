# Validation Report - countprop@1.0.1
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Kevin McGregor <kevinmcg@yorku.ca>                   |
...
Overall the package has 9 exported objects. 9 are documented:
                    ...
                    ebic             ebicPlot logitNormalVariation 
                    TRUE                 TRUE                 TRUE 
                  logLik     logVarTaylorFull                mleLR 
                    TRUE                 TRUE                 TRUE 
                 mlePath       naiveVariation      pluginVariation 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-17 04:05:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67cec8c5f_1739765094
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkPLJ6N
...
These are the options set to generate the report:
    ...
    [1] "validation_report_countprop_v1.0.1-tikzDictionary"
