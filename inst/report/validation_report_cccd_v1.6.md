...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | David J. Marchette <dmarchette@gmail.com>            |
...
Overall the package has 15 exported objects. 15 are documented:
                          ...
                          cccd            cccd.classifier 
                          TRUE                       TRUE 
            cccd.classifier.rw              cccd.classify 
                          TRUE                       TRUE 
    cccd.multiclass.classifier   cccd.multiclass.classify 
                          TRUE                       TRUE 
                       cccd.rw                        ccd 
                          TRUE                       TRUE 
                      dominate                         gg 
                          TRUE                       TRUE 
                        juggle            juggle.classify 
                          TRUE                       TRUE 
                           nng                      prune 
                          TRUE                       TRUE 
                           rng 
...
| Execution Time | 2025-02-16 03:52:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32dc78d96_1739677973
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptkwLc0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cccd_v1.6-tikzDictionary"
