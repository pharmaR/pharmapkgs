# Validation Report - bayfoxr@0.0.1
...
| export_help          | 5                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Steven Malevich <malevich@email.arizona.edu> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/brews/bayfoxr/            |
...
Overall the package has 5 exported objects. 5 are documented:
          ...
          get_draws   predict_d18oc predict_seatemp      prediction     predictplot 
...
| Execution Time | 2025-02-15 03:42:47 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd741937dd_1739590962
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKOYDOK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayfoxr_v0.0.1-tikzDictionary"
