...
| export_help          | 22                                  |
| has_website          | TRUE                                |
| has_maintainer       | Luka Krajnc <luka.krajnc@gozdis.si> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/krajnc/densitr   |
...
Overall the package has 22 exported objects. 22 are documented:
              ...
              combine_data        combine_footers       correct_failures 
                      TRUE                   TRUE                   TRUE 
                dpdetect_e             dpdetect_s              dpdetrend 
                      TRUE                   TRUE                   TRUE 
                    dpload                dprings                 dptrim 
                      TRUE                   TRUE                   TRUE 
                  dptrim_s                dptriml              dptriml_s 
                      TRUE                   TRUE                   TRUE 
                    get_RW     manual_trim_detect               plot_all 
                      TRUE                   TRUE                   TRUE 
        plot_end_detection          plot_failures   plot_start_detection 
                      TRUE                   TRUE                   TRUE 
             plot_trimming   remove_trim_failures separate_trim_failures 
                      TRUE                   TRUE                   TRUE 
             trim_manually 
                      TRUE 
...
| Execution Time | 2025-02-18 03:42:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bb453894e91_1739850148
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuqKGKJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_densitr_v0.2-tikzDictionary"
