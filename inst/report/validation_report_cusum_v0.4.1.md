...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Lena Hubig <cs@lenahubig.de>                         |
...
Overall the package has 11 exported objects. 11 are documented:
                 ...
                 cusum    cusum_alpha_sim  cusum_limit_exact    cusum_limit_sim 
                  TRUE               TRUE               TRUE               TRUE 
               gscusum            racusum  racusum_alpha_sim racusum_limit_dpcl 
                  TRUE               TRUE               TRUE               TRUE 
     racusum_limit_sim          ragscusum          weights_t 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:42:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63d22e84e_1739767317
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmphvi9Jj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cusum_v0.4.1-tikzDictionary"
