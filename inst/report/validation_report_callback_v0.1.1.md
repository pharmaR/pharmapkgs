# Validation Report - callback@0.1.1
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Emmanuel Duguet <emmanuel.duguet@u-pec.fr>           |
...
Overall the package has 14 exported objects. 14 are documented:
        ...
        callback       g_difp        g_ecs       g_prop        g_tcs        graph 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
         is.calc stat_colsums   stat_count     stat_ecs    stat_glob     stat_mcr 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
     stat_signif     stat_tcs 
            TRUE         TRUE 
...
| Execution Time | 2025-02-16 03:35:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3490f0a2e_1739676938
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3hoXSq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_callback_v0.1.1-tikzDictionary"
