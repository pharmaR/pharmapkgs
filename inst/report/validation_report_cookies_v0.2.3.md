# Validation Report - cookies@0.2.3
...
| has_source_control   | https://github.com/r4ds/cookies   |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    add_cookie_handlers   cookie_dependency      extract_cookie     extract_cookies 
                   TRUE                TRUE                TRUE                TRUE 
             get_cookie       remove_cookie          set_cookie  set_cookie_on_load 
                   TRUE                TRUE                TRUE                TRUE 
    set_cookie_response 
                   TRUE 
...
| Execution Time | 2025-02-17 03:52:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bd640601a73_1739764352
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcWnppO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cookies_v0.2.3-tikzDictionary"
