# Validation Report - FertBoot@0.5.0
...
|:----|:--------------|:--------|
| 1   | stats         | Imports |
| 2   | nls.multstart | Imports |
| 3   | simpleboot    | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
                      ...
                      boot.CI boot.resid.linear.plateau           boot.resid.quad 
                         TRUE                      TRUE                      TRUE 
      boot.resid.quad.plateau        compare.two.sample          f.linear.plateau 
                         TRUE                      TRUE                      TRUE 
                       f.quad            f.quad.plateau 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-27 03:26:49 UTC |
...
running this report
    ...
    PROCESSX_PS1c622841d428_1740626805
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUtkoQy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FertBoot_v0.5.0-tikzDictionary"
