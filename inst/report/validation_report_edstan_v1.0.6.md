# Validation Report - edstan@1.0.6
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel C. Furr <danielcfurr@berkeley.edu>            |
...
Overall the package has 5 exported objects. 5 are documented:
             ...
             irt_data          irt_stan  labelled_integer    print_irt_stan 
                 TRUE              TRUE              TRUE              TRUE 
    stan_columns_plot 
                 TRUE 
...
| Execution Time | 2025-02-19 03:43:20 UTC |
...
running this report
    ...
    PROCESSX_PS1d452cc8c92d_1739936594
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0cJsgt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_edstan_v1.0.6-tikzDictionary"
