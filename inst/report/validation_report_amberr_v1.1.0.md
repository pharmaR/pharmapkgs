...
| size_codebase        | 1351                                      |
| has_source_control   | https://github.com/obiba/amberr/          |
...
Overall the package has 25 exported objects. 25 are documented:
      ...
      amber.case_report_form  amber.case_report_forms       amber.case_reports 
                        TRUE                     TRUE                     TRUE 
                  amber.form      amber.form_revision     amber.form_revisions 
                        TRUE                     TRUE                     TRUE 
                 amber.forms              amber.group             amber.groups 
                        TRUE                     TRUE                     TRUE 
      amber.interview_design  amber.interview_designs   amber.interview_export 
                        TRUE                     TRUE                     TRUE 
            amber.interviews              amber.login             amber.logout 
                        TRUE                     TRUE                     TRUE 
           amber.participant       amber.participants            amber.studies 
                        TRUE                     TRUE                     TRUE 
                 amber.study           amber.subjects               amber.user 
                        TRUE                     TRUE                     TRUE 
                 amber.users 
                        TRUE 
...
| Execution Time | 2025-02-14 06:51:32 UTC |
...
running this report
    ...
    PROCESSX_PS726d4d9bb8b4_1739515889
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJoFdnK
