...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Matthew T. Pratola <mpratola@stat.osu.edu>           |
...
Overall the package has 18 exported objects. 18 are documented:
            ...
            generalized.wendland                    getranges 
                            TRUE                         TRUE 
                    makedistlist                     matern32 
                            TRUE                         TRUE 
                        matern52           remove.projections 
                            TRUE                         TRUE 
                          rhomat                  scaledesign 
                            TRUE                         TRUE 
                   sim.dpp.modal           sim.dpp.modal.fast 
                            TRUE                         TRUE 
          sim.dpp.modal.fast.seq             sim.dpp.modal.np 
                            TRUE                         TRUE 
           sim.dpp.modal.nystrom sim.dpp.modal.nystrom.kmeans 
                            TRUE                         TRUE 
               sim.dpp.modal.seq                   unscalemat 
                            TRUE                         TRUE 
                       wendland1                    wendland2 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-18 03:40:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46914ff64_1739850032
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpA0nAte
...
These are the options set to generate the report:
    ...
    [1] "validation_report_demu_v0.3.0-tikzDictionary"
