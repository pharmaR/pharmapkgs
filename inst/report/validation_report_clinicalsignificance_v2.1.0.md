# Validation Report - clinicalsignificance@2.1.0
...
| export_help          | 19                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Benedikt Claus <b.claus@pedscience.de>             |
| bugs_status          | subscript out of bounds                            |
| has_source_control   | https://github.com/pedscience/clinicalsignificance |
...
Overall the package has 19 exported objects. 19 are documented:
                   ...
                   calc_anchor      calc_cutoff_from_data 
                          TRUE                       TRUE 
               calc_percentage                   calc_rci 
                          TRUE                       TRUE 
          create_summary_table                  cs_anchor 
                          TRUE                       TRUE 
                   cs_combined            cs_distribution 
                          TRUE                       TRUE 
         cs_get_augmented_data              cs_get_cutoff 
                          TRUE                       TRUE 
    cs_get_cutoff_descriptives                cs_get_data 
                          TRUE                       TRUE 
                  cs_get_model                   cs_get_n 
                          TRUE                       TRUE 
            cs_get_reliability             cs_get_summary 
                          TRUE                       TRUE 
                 cs_percentage             cs_statistical 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-16 04:32:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32ba13eea_1739680352
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJZOuIE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clinicalsignificance_v2.1.0-tikzDictionary"
