# Validation Report - cfdecomp@0.4.0
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Maarten Jacob Bijlsma <maarten.bijlsma@gmail.com>    |
...
Overall the package has 7 exported objects. 7 are documented:
                 ...
                 cfd.FUN             cfd.mean         cfd.quantile 
                    TRUE                 TRUE                 TRUE 
        cfd.semipar.mean cfd.semipar.quantile     cluster.resample 
                    TRUE                 TRUE                 TRUE 
               conv.mean 
                    TRUE 
...
| Execution Time | 2025-02-16 04:04:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bc362487df4_1739678645
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpp9HEJN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cfdecomp_v0.4.0-tikzDictionary"
