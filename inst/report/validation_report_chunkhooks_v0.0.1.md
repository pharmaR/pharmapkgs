# Validation Report - chunkhooks@0.0.1
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Atsushi Yasumoto <atusy.rpkg@gmail.com>              |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/atusy/chunkhooks                  |
...
|:----|:-------------|:--------|
| 1   | knitr        | Imports |
| 2   | measurements | Imports |
| 3   | prettyunits  | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
          ...
          benchmarks format_benchmark   hook_benchmark hook_figure_unit 
                TRUE             TRUE             TRUE             TRUE 
    hook_numberLines 
                TRUE 
...
| Execution Time | 2025-02-16 04:17:18 UTC |
...
running this report
    ...
    PROCESSX_PS1bc348dc4aee_1739679433
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0lrID3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chunkhooks_v0.0.1-tikzDictionary"
