# Validation Report - CausalGPS@0.5.0
...
| export_help          | 12                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Naeem Khoshnevis <nkhoshnevis@g.harvard.edu> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/NSAPH-Software/CausalGPS  |
...
Overall the package has 12 exported objects. 12 are documented:
             ...
             absolute_corr_fun absolute_weighted_corr_fun 
                          TRUE                       TRUE 
           check_covar_balance         compile_pseudo_pop 
                          TRUE                       TRUE 
        compute_counter_weight               estimate_erf 
                          TRUE                       TRUE 
                  estimate_gps        generate_pseudo_pop 
                          TRUE                       TRUE 
             generate_syn_data                 get_logger 
                          TRUE                       TRUE 
                    set_logger                    trim_it 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-16 03:49:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3345eca0f_1739677763
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2egCAM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CausalGPS_v0.5.0-tikzDictionary"
