...
| export_help | 29 |
| has_website | FALSE |
| has_maintainer | Guillermo Granados <guillermo.granadosgarcia@outlook.com> |
...
Overall the package has 29 exported objects. 29 are documented:
                      ...
                      all_bands          Anomalyscoresframe 
                           TRUE                        TRUE 
                           Cort                      DEcort 
                           TRUE                        TRUE 
                     DEcortNorm   distance_matrix_banddepth 
                           TRUE                        TRUE 
           distance_matrix_CGCI   distance_matrix_coherence 
                           TRUE                        TRUE 
           distance_matrix_cort    distance_matrix_cortNorm 
                           TRUE                        TRUE 
            distance_matrix_dtw distance_matrix_mahalanobis 
                           TRUE                        TRUE 
          distance_matrix_mvLWS         distance_matrix_PDC 
                           TRUE                        TRUE 
          distance_matrix_PMIME       distance_matrix_RGPDC 
                           TRUE                        TRUE 
    distance_matrix_wasserstein                     DTWcort 
                           TRUE                        TRUE 
                      dxy_bands           informative_bands 
                           TRUE                        TRUE 
     kneighbors_distance_docall                  matrix_PDC 
                           TRUE                        TRUE 
                           mBTS                 mBTS_Af_mat 
                           TRUE                        TRUE 
                       mBTSCGCI                   mBTSRGPDC 
                           TRUE                        TRUE 
                 multilagmatrix                       PMIME 
                           TRUE                        TRUE 
                        sqnorms 
                           TRUE 
...
| Execution Time | 2025-02-14 06:56:05 UTC |
...
running this report
    ...
    PROCESSX_PS726d21abc098_1739516162
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTIpUiQ
