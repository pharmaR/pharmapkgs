# Validation Report - eoffice@0.2.2
...
Overall the package has 13 exported objects. 13 are documented:
    ...
    .setcolnames  convertplot       indocx     infigure     inoffice       inpptx 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
          todocx      toffice     tofigure       tohtml       topptx      totable 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
          toxlsx 
            TRUE 
...
| Execution Time | 2025-02-19 04:13:22 UTC |
...
running this report
    ...
    PROCESSX_PS1d456cd2f63e_1739938396
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdVGFOK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eoffice_v0.2.2-tikzDictionary"
