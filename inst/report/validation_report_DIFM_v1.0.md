...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Hwasoo Shin <shwasoo@vt.edu>                         |
...
Overall the package has 14 exported objects. 14 are documented:
                   ...
                   buildH         difm.hyp.parm difm.model.attributes 
                     TRUE                  TRUE                  TRUE 
                  DIFMcpp                 DIFMR        marginal_d_cpp 
                     TRUE                  TRUE                  TRUE 
               marginal.d     permutation.order     permutation.scale 
                     TRUE                  TRUE                  TRUE 
                plot_B.CI        plot_B.spatial        plot_sigma2.CI 
                     TRUE                  TRUE                  TRUE 
              plot_tau.CI             plot_X.CI 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-18 04:05:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4606471b6_1739851513
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMJHIlD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DIFM_v1.0-tikzDictionary"
