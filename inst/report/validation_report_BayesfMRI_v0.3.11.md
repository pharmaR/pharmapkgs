# Validation Report - BayesfMRI@0.3.11
...
| has_source_control   | https://github.com/mandymejia/BayesfMRI |
| has_bug_reports_url  | 1                                       |
| downloads_1yr        | 2765                                    |
| reverse_dependencies | 0                                       |
| has_examples         | 0.744898                                |
| dependencies         | 14                                      |
| license              | GPL-3                                   |
...
|     | package                | type      |
|:----|:-----------------------|:----------|
| 1   | ciftiTools (\>= 0.8.0) | Imports   |
| 2   | excursions             | Imports   |
| 3   | foreach                | Imports   |
| 4   | fMRItools              | Imports   |
| 5   | MASS                   | Imports   |
| 6   | Matrix                 | Imports   |
...
Overall the package has 13 exported objects. 13 are documented:
    ...
    act_prevalance       BayesGLM BayesGLM_cifti BayesGLM_group      BayesGLM2 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            cderiv            HRF id_activations  is.BfMRI.sess      make_HRFs 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         make_mask      make_mesh   vertex_areas 
              TRUE           TRUE           TRUE 

### Examples

There are 73 help pages with examples, from 98 (74.49 %).
...
| Execution Time | 2025-02-15 03:34:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd21667795_1739590483
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPkNo9S
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesfMRI_v0.3.11-tikzDictionary"
