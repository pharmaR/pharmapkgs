# Validation Report - clickstream@1.3.3
...
| export_help          | 29                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Michael Scholz <michael.scholz@th-deg.de>            |
...
Overall the package has 23 exported objects. 23 are documented:
                 ...
                 absorbingStates                as.ClickClust 
                            TRUE                         TRUE 
                 as.clickstreams        as.moltenTransactions 
                            TRUE                         TRUE 
                 as.transactions                chiSquareTest 
                            TRUE                         TRUE 
             clusterClickstreams               fitMarkovChain 
                            TRUE                         TRUE 
                 fitMarkovChains                  frequencies 
                            TRUE                         TRUE 
            getConsensusClusters getConsensusClustersParallel 
                            TRUE                         TRUE 
           getOptimalMarkovChain                       hmPlot 
                            TRUE                         TRUE 
                      mcEvaluate                mcEvaluateAll 
                            TRUE                         TRUE 
           mcEvaluateAllClusters                 randomClicks 
                            TRUE                         TRUE 
              randomClickstreams             readClickstreams 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-16 04:30:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bc353814593_1739680203
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGeNSev
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clickstream_v1.3.3-tikzDictionary"
