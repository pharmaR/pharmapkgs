# Validation Report - fastmap@1.2.0
...
| has_source_control   | https://github.com/r-lib/fastmap |
| has_bug_reports_url  | 1                                |
| downloads_1yr        | 10923086                         |
...
bslib, cachem, chromote, dipsaus, filearray, htmltools, hydroloom,
ieegio, jmvcore, keras3, keyATM, ompr, promises, rang, readNSx,
ResultModelManager, rpymat, shidashi, shiny, shinymeta, singleCellTK

## Namespace

Overall the package has 5 exported objects. 5 are documented:

           fastmap      fastqueue      faststack is.key_missing    key_missing 
...
| Execution Time | 2025-02-19 05:18:56 UTC |
...
running this report
    ...
    PROCESSX_PS1d456c7521d5_1739942329
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPc3D1l
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastmap_v1.2.0-tikzDictionary"
