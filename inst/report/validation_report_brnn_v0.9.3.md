...
BWGS, dendroTools, MLFS, mlr, NNbenchmark, rTG

## Namespace

Overall the package has 18 exported objects. 18 are documented:

                     brnn         brnn_extended          brnn_ordinal 
                     TRUE                  TRUE                  TRUE 
                coef.brnn    coef.brnn_extended        estimate.trace 
                     TRUE                  TRUE                  TRUE 
                   initnw             normalize          predict.brnn 
                     TRUE                  TRUE                  TRUE 
    predict.brnn_extended  predict.brnn_ordinal            print.brnn 
                     TRUE                  TRUE                  TRUE 
      print.brnn_extended    print.brnn_ordinal          summary.brnn 
                     TRUE                  TRUE                  TRUE 
    summary.brnn_extended  summary.brnn_ordinal          un_normalize 
                     TRUE                  TRUE                  TRUE 

### Examples

There are 9 help pages with examples, from 17 (52.94 %).
...
| Execution Time | 2025-02-15 04:45:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd344f4fc7_1739594743
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYsuFaP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brnn_v0.9.3-tikzDictionary"
