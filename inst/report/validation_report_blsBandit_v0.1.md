# Validation Report - blsBandit@0.1
...
| export_help          | 1                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jeremy Fitzpatrick <jmfitzpa@gmail.com>              |
...
|:----|:---------------------|:--------|
| 1   | DBI (\>= 1.1.3)      | Imports |
| 2   | jsonlite (\>= 1.8.4) | Imports |
| 3   | plotly (\>= 4.10.2)  | Imports |
| 4   | RSQLite (\>= 2.2.16) | Imports |
| 5   | shiny (\>= 1.7.1)    | Imports |
| 6   | zoo (\>= 1.8-12)     | Imports |
...
| Execution Time | 2025-02-15 04:25:13 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd48a8484b_1739593508
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpae9nyu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blsBandit_v0.1-tikzDictionary"
