# Validation Report - cabootcrs@2.1.0
...
Overall the package has 17 exported objects. 17 are documented:
     ...
     addsupplementary       allvarscovs         cabootcrs           convert 
                 TRUE              TRUE              TRUE              TRUE 
               covmat           getBurt             getCT        getdoubled 
                 TRUE              TRUE              TRUE              TRUE 
         getindicator      myresamplefn            plotca           printca 
                 TRUE              TRUE              TRUE              TRUE 
            rearrange       reflectaxes reordercategories               sca 
                 TRUE              TRUE              TRUE              TRUE 
            summaryca 
                 TRUE 
...
There are 27 help pages with examples, from 29 (93.10 %).
...
| Execution Time | 2025-02-16 03:32:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32f3f762b_1739676738
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpswjaMw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cabootcrs_v2.1.0-tikzDictionary"
