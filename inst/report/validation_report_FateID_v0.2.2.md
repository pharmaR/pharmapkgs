# Validation Report - FateID@0.2.2
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Dominic Grün <dominic.gruen@gmail.com>               |
...
Overall the package has 17 exported objects. 17 are documented:
                   ...
                   compdr             diffexpnb              fateBias 
                     TRUE                  TRUE                  TRUE 
                filterset             gene2gene               getFeat 
                     TRUE                  TRUE                  TRUE 
                  getPart                getsom              impGenes 
                     TRUE                  TRUE                  TRUE 
          plotdiffgenesnb        plotexpression plotexpressionProfile 
                     TRUE                  TRUE                  TRUE 
              plotFateMap           plotheatmap               prcurve 
                     TRUE                  TRUE                  TRUE 
                  procsom            reclassify 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-19 05:23:32 UTC |
...
running this report
    ...
    PROCESSX_PS1d4560c40011_1739942605
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJ8rmp7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FateID_v0.2.2-tikzDictionary"
