# Validation Report - DescriptiveStats.OBeu@1.3.2
...
| export_help          | 14                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Kleanthis Koupidis <koupidis@okfn.gr>             |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/okgreece/DescriptiveStats.OBeu |
...
Overall the package has 14 exported objects. 14 are documented:
       ...
       compare.stats               CV      ds.analysis           ds.box 
                TRUE             TRUE             TRUE             TRUE 
          ds.boxplot   ds.correlation     ds.frequency          ds.hist 
                TRUE             TRUE             TRUE             TRUE 
         ds.kurtosis      ds.skewness    ds.statistics         multisub 
                TRUE             TRUE             TRUE             TRUE 
                nums open_spending.ds 
                TRUE             TRUE 

### Examples

There are 14 help pages with examples, from 17 (82.35 %).
...
| Execution Time | 2025-02-18 03:46:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bb413de4099_1739850398
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzLvsLv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DescriptiveStats.OBeu_v1.3.2-tikzDictionary"
