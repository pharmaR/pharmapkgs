...
Overall the package has 13 exported objects. 14 are documented:

            addCluster         checkSetup createFileskeleton      deleteCluster 
                  TRUE               TRUE               TRUE               TRUE 
          generateData   generateDatabase   getRandomstrings   initializeObject 
                  TRUE               TRUE               TRUE               TRUE 
        plot3dMetadata       plotMetadata         sampleGrid          saveSetup 
                  TRUE               TRUE               TRUE               TRUE 
        summarizeSetup 
                  TRUE 
...
There are 23 help pages with examples, from 29 (79.31 %).
...
| Execution Time | 2025-02-15 03:48:24 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd28ff6edb_1739591300
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsfZ2gB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bdlp_v0.9.2-tikzDictionary"
