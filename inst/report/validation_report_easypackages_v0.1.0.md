# Validation Report - easypackages@0.1.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jake Sherman <jake@jakesherman.com>                  |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         from_import  install_package install_packages   is.package_obj 
                TRUE             TRUE             TRUE             TRUE 
           libraries     load_package          package         packages 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 05:12:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43a63f604_1739855530
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnpN0Mj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easypackages_v0.1.0-tikzDictionary"
