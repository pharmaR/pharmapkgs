# Validation Report - birdring@1.6
...
| export_help | 19 |
| has_website | FALSE |
| has_maintainer | Fraenzi Korner-Nievergelt <fraenzi.korner@vogelwarte.ch> |
...
Overall the package has 19 exported objects. 18 are documented:
                       ...
                       birdstate                    bootci.dc 
                            TRUE                         TRUE 
                     codes2names critical.check.ringing.event 
                            TRUE                         TRUE 
                       dayofyear                           dc 
                            TRUE                         TRUE 
                   decimal.coord                      dmvnorm 
                            TRUE                         TRUE 
                        draw.map                 loxodrom.dir 
                            TRUE                         TRUE 
                   loxodrom.dist                     mdy.date 
                            TRUE                         TRUE 
                     mercatorlat               orthodrom.dist 
                            TRUE                         TRUE 
                         overlap                   place2name 
                            TRUE                         TRUE 
                 read.euring2000          read.euring2000plus 
                            TRUE                        FALSE 
                  scheme2country 
                            TRUE 
...
| Execution Time | 2025-02-15 04:17:10 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd73a2d923_1739593025
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpq99xTy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_birdring_v1.6-tikzDictionary"
