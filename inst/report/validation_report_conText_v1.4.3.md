# Validation Report - conText@1.4.3
...
| export_help | 28 |
| has_website | TRUE |
| has_maintainer | Pedro L. Rodriguez <pedro.rodriguezsosa@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/prodriguezsosa/EmbeddingRegression |
...
|:----|:------------------------|:--------|
| 1   | dplyr                   | Imports |
| 2   | Matrix (\>= 1.3-2)      | Imports |
| 3   | quanteda (\>= 3.0.0)    | Imports |
| 4   | text2vec (\>= 0.6)      | Imports |
| 5   | reshape2 (\>= 1.4.4)    | Imports |
| 6   | fastDummies (\>= 1.6.3) | Imports |
...
Overall the package has 28 exported objects. 28 are documented:
      ...
      bootstrap_contrast        bootstrap_nns     compute_contrast 
                    TRUE                 TRUE                 TRUE 
       compute_transform              conText         contrast_nns 
                    TRUE                 TRUE                 TRUE 
                 cos_sim                  dem            dem_group 
                    TRUE                 TRUE                 TRUE 
              dem_sample         embed_target          feature_sim 
                    TRUE                 TRUE                 TRUE 
                     fem             find_nns          get_context 
                    TRUE                 TRUE                 TRUE 
             get_cos_sim      get_local_vocab              get_ncs 
                    TRUE                 TRUE                 TRUE 
                 get_nns        get_nns_ratio      get_seq_cos_sim 
                    TRUE                 TRUE                 TRUE 
                     ncs                  nns            nns_ratio 
                    TRUE                 TRUE                 TRUE 
        permute_contrast       plot_nns_ratio prototypical_context 
                    TRUE                 TRUE                 TRUE 
          tokens_context 
                    TRUE 
...
| Execution Time | 2025-02-17 03:49:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bd625c98998_1739764140
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdpogTW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conText_v1.4.3-tikzDictionary"
