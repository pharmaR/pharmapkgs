# Validation Report - causalweight@1.1.1
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Hugo Bodory <hugo.bodory@unisg.ch>                   |
...
| 4   | LARF         | Imports |
| 5   | hdm          | Imports |
| 6   | SuperLearner | Imports |
| 7   | glmnet       | Imports |
| 8   | xgboost      | Imports |
| 9   | e1071        | Imports |
| 10  | fastDummies  | Imports |
| 11  | grf          | Imports |
| 12  | checkmate    | Imports |
| 13  | sandwich     | Imports |
...
Overall the package has 19 exported objects. 19 are documented:
       ...
       attrlateweight        didcontDML   didcontDMLpanel            didDML 
                 TRUE              TRUE              TRUE              TRUE 
            didweight       dyntreatDML identificationDML              ivnr 
                 TRUE              TRUE              TRUE              TRUE 
           lateweight            medDML     medlateweight         medweight 
                 TRUE              TRUE              TRUE              TRUE 
        medweightcont      paneltestDML          RDDcovar      testmedident 
                 TRUE              TRUE              TRUE              TRUE 
             treatDML       treatselDML       treatweight 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 03:50:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33594f94b_1739677828
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpo9UZhG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causalweight_v1.1.1-tikzDictionary"
