# Validation Report - CrossClustering@4.1.2
...
| export_help          | 9                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Paola Tellaroli <paola.tellaroli@gmail.com> |
...
Overall the package has 9 exported objects. 9 are documented:
                        ...
                        ari      cc_crossclustering          cc_get_cluster 
                       TRUE                    TRUE                    TRUE 
                cc_test_ari cc_test_ari_permutation       consensus_cluster 
                       TRUE                    TRUE                    TRUE 
                    is_zero         prune_zero_tail           reverse_table 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-17 04:23:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6244fc069_1739766211
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5L3mj1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CrossClustering_v4.1.2-tikzDictionary"
