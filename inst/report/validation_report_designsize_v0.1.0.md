# Validation Report - designsize@0.1.0
...
Overall the package has 8 exported objects. 8 are documented:
       ...
       ABdesign      crsize   crt.match crt.unmatch     expsize      phsize 
...
| Execution Time | 2025-02-18 03:48:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43745b9b3_1739850508
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmppw2dGW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_designsize_v0.1.0-tikzDictionary"
