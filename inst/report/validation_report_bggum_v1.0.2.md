...
| export_help          | 11                                        |
| has_website          | TRUE                                      |
| has_maintainer       | JBrandon Duck-Mayr <j.duckmayr@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/duckmayr/bggum         |
...
| 1   | stats              | Imports   |
| 2   | graphics           | Imports   |
| 3   | Rcpp (\>= 0.12.14) | Imports   |
| 4   | Rcpp               | LinkingTo |
| 5   | RcppDist           | LinkingTo |
...
Overall the package has 11 exported objects. 11 are documented:
      ...
      ggum_simulation           ggumMC3          ggumMCMC   ggumProbability 
                 TRUE              TRUE              TRUE              TRUE 
                  icc               irf         okabe_ito      post_process 
                 TRUE              TRUE              TRUE              TRUE 
                tango    tune_proposals tune_temperatures 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 03:58:44 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4dc3663a_1739591919
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuosMXH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bggum_v1.0.2-tikzDictionary"
