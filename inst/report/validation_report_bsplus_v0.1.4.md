# Validation Report - bsplus@0.1.4
...
| export_help          | 31                                 |
| has_website          | TRUE                               |
| has_maintainer       | Ian Lyttle <ijlyttle@me.com>       |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/ijlyttle/bsplus |
...
biodosetools, downloadthis, drawer, elaborator, IOHanalyzer, LACE,
lactater, LCMSQA, qPRAentry, shinyWGD, signeR, subscreen,
systemPipeShiny, visxhclust
...
Overall the package has 30 exported objects. 30 are documented:
                       ...
                       FALSE                     TRUE                     TRUE 
                   bs_append       bs_attach_collapse          bs_attach_modal 
                        TRUE                     TRUE                     TRUE 
                     bs_attr          bs_attr.default         bs_attr.Duration 
                        TRUE                     TRUE                     TRUE 
                bs_attr.list          bs_attr.logical                bs_button 
                        TRUE                     TRUE                     TRUE 
                 bs_carousel      bs_carousel_caption        bs_carousel_image 
                        TRUE                     TRUE                     TRUE 
                 bs_collapse         bs_embed_popover         bs_embed_tooltip 
                        TRUE                     TRUE                     TRUE 
                    bs_modal     bs_modal_closebutton                 bs_panel 
                        TRUE                     TRUE                     TRUE 
                 bs_set_aria              bs_set_data              bs_set_opts 
                        TRUE                     TRUE                     TRUE 
        render_html_fragment           shiny_iconlink   shinyInput_label_embed 
                        TRUE                     TRUE                     TRUE 
    use_bs_accordion_sidebar           use_bs_popover           use_bs_tooltip 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-15 04:50:18 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3faf9ae5_1739595013
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpox9hRq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bsplus_v0.1.4-tikzDictionary"
