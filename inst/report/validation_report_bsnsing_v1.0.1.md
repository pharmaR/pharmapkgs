# Validation Report - bsnsing@1.0.1
...
| export_help          | 7                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Yanchao Liu <yanchaoliu@wayne.edu>                   |
...
Overall the package has 7 exported objects. 7 are documented:
                 ...
                 binarize            binarize.y             bscontrol 
                     TRUE                  TRUE                  TRUE 
                  bslearn               bsnsing import_external_rules 
                     TRUE                  TRUE                  TRUE 
                 ROC_func 
                     TRUE 
...
| Execution Time | 2025-02-15 04:49:38 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2c890b7a_1739594973
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCmRlRF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bsnsing_v1.0.1-tikzDictionary"
