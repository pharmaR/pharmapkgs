# Validation Report - blscrapeR@4.0.1
...
| export_help          | 16                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Kris Eberwein <kris.eberwein@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/keberwein/blscrapeR  |
...
Overall the package has 16 exported objects. 14 are documented:
                      ...
                      %<>%                    %>%                bls_api 
                     FALSE                  FALSE                   TRUE 
               county_fips               dateCast             firstupper 
                      TRUE                   TRUE                   TRUE 
          inflation_adjust   quick_employed_level    quick_employed_rate 
                      TRUE                   TRUE                   TRUE 
    quick_laborForce_level  quick_laborForce_rate quick_nonfarm_employed 
                      TRUE                   TRUE                   TRUE 
         quick_unemp_level       quick_unemp_rate             search_ids 
                      TRUE                   TRUE                   TRUE 
                 urlExists 
                      TRUE 
...
| Execution Time | 2025-02-15 04:25:19 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd26ee0ba0_1739593514
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpG4B7Hd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blscrapeR_v4.0.1-tikzDictionary"
