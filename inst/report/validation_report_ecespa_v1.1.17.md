# Validation Report - ecespa@1.1.17
...
| export_help | 20 |
| has_website | FALSE |
| has_maintainer | Marcelino de la Cruz Rot <marcelino.delacruz@urjc.es> |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | spatstat (\>= 2.0-0) | Depends |
| 2   | spatstat.geom        | Imports |
| 3   | spatstat.explore     | Imports |
| 4   | spatstat.model       | Imports |
| 5   | spatstat.random      | Imports |
...
dixon, idar, selectspm

## Namespace

Overall the package has 20 exported objects. 13 are documented:

       dixon2002        getis      haz.ppp     ipc.estK         K012         K1K2 
            TRUE        FALSE         TRUE         TRUE         TRUE        FALSE 
             Kci       Kclust           Ki   Kinhom.log          Kmm    Kmulti.ls 
            TRUE        FALSE         TRUE        FALSE         TRUE         TRUE 
          LF.gof      marksum      pc.estK        rIPCP sim.poissonc      syrjala 
            TRUE        FALSE        FALSE         TRUE        FALSE         TRUE 
    syrjala.test     syrjala0 
            TRUE         TRUE 
...
| Execution Time | 2025-02-19 03:31:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d4550204bf1_1739935860
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFCh9G5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecespa_v1.1.17-tikzDictionary"
