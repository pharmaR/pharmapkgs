# Validation Report - correctR@0.3.1
...
| export_help          | 3                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Trent Henderson <then6675@uni.sydney.edu.au> |
...
Overall the package has 3 exported objects. 3 are documented:
        ...
        kfold_ttest  repkfold_ttest resampled_ttest 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:00:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bd636c89999_1739764802
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpydDARY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_correctR_v0.3.1-tikzDictionary"
