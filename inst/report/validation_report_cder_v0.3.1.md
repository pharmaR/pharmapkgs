...
| has_source_control   | https://github.com/mkoohafkan/cder              |
...
| 2   | curl (\>= 4.3)      | Imports |
| 3   | glue (\>= 1.3)      | Imports |
| 4   | stringr (\>= 1.4)   | Imports |
| 5   | dplyr (\>= 1.1)     | Imports |
| 6   | readr (\>= 1.3)     | Imports |
| 7   | lubridate (\>= 1.7) | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
         ...
         cdec_data_flags             cdec_map            cdec_meta 
                    TRUE                 TRUE                 TRUE 
              cdec_query     cdec_query_group   cdec_search_groups 
                    TRUE                 TRUE                 TRUE 
    cdec_search_stations         cdec_sensors           cder_query 
                    TRUE                 TRUE                 TRUE 
                problems 
                    TRUE 
...
| Execution Time | 2025-02-16 03:56:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36210a046_1739678163
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5mTx5e
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cder_v0.3.1-tikzDictionary"
