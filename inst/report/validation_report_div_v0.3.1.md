...
| export_help          | 10                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Philippe J.S. De Brouwer <philippe@de-brouwer.com> |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            div_add_median_label                div_ci_median 
                            TRUE                         TRUE 
                 div_conf_colour                div_fake_team 
                            TRUE                         TRUE 
                  div_gauge_plot             div_parse_paygap 
                            TRUE                         TRUE 
                      div_paygap div_plot_paygap_distribution 
                            TRUE                         TRUE 
                div_round_paygap                    diversity 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-18 04:22:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43feba4ac_1739852524
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFlsWTp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_div_v0.3.1-tikzDictionary"
