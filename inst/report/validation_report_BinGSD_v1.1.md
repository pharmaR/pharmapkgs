...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Lei Wang <slimewanglei@163.com>                      |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | methods (\>= 3.5.0)  | Imports |
| 2   | mvtnorm (\>= 1.0-11) | Imports |
| 3   | stats (\>= 3.5.0)    | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
         ...
         asymcp  asymdesign    asymprob     exactcp exactdesign   exactprob 
...
| Execution Time | 2025-02-15 04:08:58 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd28608fa_1739592533
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkoYl9x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BinGSD_v1.1-tikzDictionary"
