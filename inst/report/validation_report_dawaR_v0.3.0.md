...
| export_help          | 8                                                |
| has_website          | TRUE                                             |
| has_maintainer       | Aleksander Bang-Larsen <contact@aleksanderbl.dk> |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/aleksanderbl29/dawaR          |
...
Overall the package has 8 exported objects. 8 are documented:
          ...
          autocomplete available_sections   connection_check               dawa 
                  TRUE               TRUE               TRUE               TRUE 
              get_data       get_map_data            reverse       status_check 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 05:04:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bd641319e6c_1739768690
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXOFHnT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dawaR_v0.3.0-tikzDictionary"
