...
| export_help          | 10                                |
| has_website          | TRUE                              |
| has_maintainer       | Scott Koermer <skoermer@lanl.gov> |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/lanl/ezECM     |
...
Overall the package has 10 exported objects. 10 are documented:
         ...
         BayesECM becm_decision          cECM cECM_decision    export_ecm 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       import_ecm  import_pvals    P_wave_gen      pval_gen       time_fn 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 05:00:30 UTC |
...
running this report
    ...
    PROCESSX_PS1d456bd29450_1739941224
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGWg1mL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ezECM_v1.0.0-tikzDictionary"
