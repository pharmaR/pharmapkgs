...
| export_help | 5 |
| has_website | FALSE |
| has_maintainer | Courtney Schiebout <courtney.t.schiebout.gr@dartmouth.edu> |
...
|:----|:-------------------------|:--------|
| 1   | VAM                      | Imports |
| 2   | Seurat (\>= 4.0.0)       | Imports |
| 3   | MASS                     | Imports |
| 4   | Matrix (\>= 1.3.3)       | Imports |
| 5   | utils                    | Imports |
| 6   | BiocManager              | Imports |
| 7   | org.Hs.eg.db             | Imports |
| 8   | org.Dr.eg.db             | Imports |
| 9   | org.Mm.eg.db             | Imports |
| 10  | AnnotationDbi            | Imports |
| 11  | SeuratObject (\>= 4.0.0) | Imports |
| 12  | methods                  | Imports |
| 13  | edgeR                    | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
     ...
     BuildGeneSets          CAMML          ChIMP GetCAMMLLabels    GetGeneSets 
...
| Execution Time | 2025-02-16 03:36:40 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32214155e_1739676996
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpiybhyx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CAMML_v1.0.0-tikzDictionary"
