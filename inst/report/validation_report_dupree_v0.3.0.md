# Validation Report - dupree@0.3.0
...
| export_help          | 4                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Russ Hyde <russ.hyde.data@gmail.com> |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/russHyde/dupree   |
...
| 4   | magrittr                 | Imports |
| 5   | methods                  | Imports |
| 6   | stringdist (\>= 0.9.5.5) | Imports |
| 7   | lintr (\>= 2.0.0)        | Imports |
| 8   | rlang                    | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
         ...
         as_tibble         dupree     dupree_dir dupree_package 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 05:00:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45f15a2a4_1739854844
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBiS81z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dupree_v0.3.0-tikzDictionary"
