# Validation Report - drimmR@1.0.1
...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Nicolas Vergne <nicolas.vergne@univ-rouen.fr>        |
...
Overall the package has 18 exported objects. 18 are documented:
                         ...
                         aic             availability                      bic 
                        TRUE                     TRUE                     TRUE 
               distributions              failureRate                   fitdmm 
                        TRUE                     TRUE                     TRUE 
             getDistribution         getStationaryLaw      getTransitionMatrix 
                        TRUE                     TRUE                     TRUE 
    lengthWord_probabilities                   loglik          maintainability 
                        TRUE                     TRUE                     TRUE 
                 reliability                 simulate stationary_distributions 
                        TRUE                     TRUE                     TRUE 
          word_probabilities         word_probability      words_probabilities 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-18 04:46:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4708181ba_1739853991
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBZvvKH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drimmR_v1.0.1-tikzDictionary"
