# Validation Report - Euclimatch@1.0.2
...
| export_help | 5 |
| has_website | FALSE |
| has_maintainer | Justin A. G. Hubbard <justin.hubbard@mail.utoronto.ca> |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         climatch_par     climatch_plot      climatch_sum      climatch_vec 
                 TRUE              TRUE              TRUE              TRUE 
    extract_clim_data 
                 TRUE 
...
| Execution Time | 2025-02-19 04:35:30 UTC |
...
running this report
    ...
    PROCESSX_PS1d4544e867db_1739939724
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQeeOGb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Euclimatch_v1.0.2-tikzDictionary"
