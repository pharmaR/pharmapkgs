# Validation Report - dexisensitivity@1.0.1
...
| export_help          | 26                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Nicolas Cavan <nicolas.cavan@inrae.fr>               |
...
Overall the package has 23 exported objects. 24 are documented:

                  aov_tree      compare_scenarios create_list_synoptique 
                      TRUE                   TRUE                   TRUE 
            create_options        create_sub_tree      create_synoptique 
                      TRUE                   TRUE                   TRUE 
               create_tree               describe      estimate_aov_time 
                      TRUE                   TRUE                   TRUE 
          estimate_mc_time      evaluate_scenario     evaluate_scenarios 
                      TRUE                   TRUE                   TRUE 
              load_options            monte_carlo                    oat 
                      TRUE                   TRUE                   TRUE 
    plot_sensitivity_index           save_options         save_scenarios 
                      TRUE                   TRUE                   TRUE 
           show_mc_results       show_oat_results          show_scenario 
                      TRUE                   TRUE                   TRUE 
                   si_dexi          visualize_aov 
                      TRUE                   TRUE 

### Examples

There are 30 help pages with examples, from 32 (93.75 %).
...
| Execution Time | 2025-02-18 03:52:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45fa5a103_1739850724
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpx96ig0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dexisensitivity_v1.0.1-tikzDictionary"
