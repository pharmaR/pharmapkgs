# Validation Report - bellreg@0.0.2.2
...
| export_help          | 8                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Fabio Demarqui <fndemarqui@est.ufmg.br> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/fndemarqui/bellreg   |
...
Overall the package has 8 exported objects. 8 are documented:
               ...
               bell         bellreg           dbell extract_log_lik           pbell 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              qbell           rbell       zibellreg 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-15 03:52:24 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd62b6c8b1_1739591540
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCc9y4a
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bellreg_v0.0.2.2-tikzDictionary"
