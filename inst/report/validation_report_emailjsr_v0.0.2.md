# Validation Report - emailjsr@0.0.2
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Changwoo Lim <limcw@zarathu.com>                     |
...
|:----|:-------------|:--------|
| 1   | shiny        | Imports |
| 2   | shiny.i18n   | Imports |
| 3   | httr         | Imports |
| 4   | shinybrowser | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
             ...
             send_email use_emailjsr_server     use_emailjsr_ui 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 03:59:13 UTC |
...
running this report
    ...
    PROCESSX_PS1d454c84e52d_1739937547
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzzvduR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emailjsr_v0.0.2-tikzDictionary"
