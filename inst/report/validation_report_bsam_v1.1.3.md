...
| export_help          | 13                                  |
| has_website          | TRUE                                |
| has_maintainer       | Ian Jonsen <ian.jonsen@mq.edu.au>   |
| bugs_status          | subscript out of bounds             |
| has_source_control   | <https://github.com/ianjonsen/bsam> |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | rjags (\>= 4-10)      | Depends |
| 2   | coda (\>= 0.19-3)     | Imports |
| 3   | dplyr (\>= 1.0.0)     | Imports |
| 4   | ggplot2 (\>= 3.3.2)   | Imports |
| 5   | gridExtra (\>= 2.3)   | Imports |
| 6   | msm (\>= 1.6.8)       | Imports |
| 7   | mvtnorm (\>= 1.1-1)   | Imports |
| 8   | rworldxtra(\>= 1.01)  | Imports |
| 9   | sp (\>= 1.2-3)        | Imports |
| 10  | tibble (\>= 3.0.1)    | Imports |
| 11  | lubridate (\>= 1.7.9) | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
       ...
       dat4jags    diag_ssm     diagSSM     fit_ssm      fitSSM get_summary 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
           hssm     map_ssm    plot_fit     plotSSM    simulate         ssm 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
           tpar 
           TRUE 
...
| Execution Time | 2025-02-15 04:48:06 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7d16efec_1739594881
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZjHod8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bsam_v1.1.3-tikzDictionary"
