# Validation Report - eiExpand@1.0.5
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Rachel Carroll <rachelcarroll4@gmail.com>            |
...
Overall the package has 9 exported objects. 8 are documented:
                        ...
                        %>%       percent_intersect             performance 
                      FALSE                    TRUE                    TRUE 
           performance_plot           rpv_coef_plot           rpv_normalize 
                       TRUE                    TRUE                    TRUE 
                   rpv_plot                rpv_toDF split_precinct_analysis 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-19 03:51:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d4565524bdf_1739937100
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplKgVXy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eiExpand_v1.0.5-tikzDictionary"
