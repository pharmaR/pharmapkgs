# Validation Report - cystiSim@0.1.0
...
| export_help          | 14                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Brecht Devleesschauwer <brechtdv@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/brechtdv/cystiSim        |
...
Overall the package has 14 exported objects. 14 are documented:
               ...
               cystiSim          do_man_mda          do_pig_mda      do_pig_mda_vac 
                   TRUE                TRUE                TRUE                TRUE 
             do_pig_vac                elim                 fit            initiate 
                   TRUE                TRUE                TRUE                TRUE 
             prevalence random_baseline_man random_baseline_pig              report 
                   TRUE                TRUE                TRUE                TRUE 
        slaughter_binom    slaughter_nbinom 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:47:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64972e8ab_1739767616
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQGBXXS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cystiSim_v0.1.0-tikzDictionary"
