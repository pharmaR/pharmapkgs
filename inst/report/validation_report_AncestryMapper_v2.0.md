...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Eoghan T O’Halloran <eoghan.ohalloran2@mail.dcu.ie>  |
...
|:----|:--------------------|:--------|
| 1   | R(\>= 2.10)         | Depends |
| 2   | svd(\>= 0.3.3-2)    | Imports |
| 3   | parallel(\>= 3.2.1) | Imports |
| 4   | grDevices           | Imports |
| 5   | graphics            | Imports |
| 6   | stats               | Imports |
| 7   | utils               | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         calculateAMids calculateAMidsArith        createMedoid           plotAMids 
                   TRUE                TRUE                TRUE                TRUE 
                 refAdd 
                   TRUE 
...
| Execution Time | 2025-02-14 06:53:55 UTC |
...
running this report
    ...
    PROCESSX_PS726d2e3cfdd7_1739516032
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfLYyy9
