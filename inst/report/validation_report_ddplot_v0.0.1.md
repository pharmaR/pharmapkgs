# Validation Report - ddplot@0.0.1
...
| has_source_control | https://github.com/feddelegrand7/ddplot |
...
Overall the package has 14 exported objects. 14 are documented:
    ...
    animatedHistogram     animLineChart          areaBand         areaChart 
                 TRUE              TRUE              TRUE              TRUE 
             barChart      barChartRace         histogram      horzBarChart 
                 TRUE              TRUE              TRUE              TRUE 
         horzLollipop         lineChart     lollipopChart          pieChart 
                 TRUE              TRUE              TRUE              TRUE 
          scatterPlot  stackedAreaChart 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-18 03:29:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bb445550447_1739849384
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuSenlu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ddplot_v0.0.1-tikzDictionary"
