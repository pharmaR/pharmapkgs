# Validation Report - dtplyr@1.3.1
...
| has_source_control   | https://github.com/tidyverse/dtplyr |
| has_bug_reports_url  | 1                                   |
| downloads_1yr        | 5428079                             |
...
|:----|:------------------------|:--------|
| 1   | cli (\>= 3.4.0)         | Imports |
| 2   | data.table (\>= 1.13.0) | Imports |
| 3   | dplyr (\>= 1.1.0)       | Imports |
| 4   | glue                    | Imports |
| 5   | lifecycle               | Imports |
| 6   | rlang (\>= 1.0.4)       | Imports |
| 7   | tibble                  | Imports |
| 8   | tidyselect (\>= 1.2.0)  | Imports |
| 9   | vctrs (\>= 0.4.1)       | Imports |
...
brpop, bsitar, cohorts, Colossus, editbl, forecastML, genieBPC,
immunarch, MicrobiotaProcess, neonPlantEcology, orbital, portvine, pvda,
ReSurv, skimr, sparrow, tidyft, tidyquery, tidyverse

## Namespace

Overall the package has 2 exported objects. 2 are documented:

    .datatable.aware          lazy_dt 
                TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:56:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4422db317_1739854589
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpm0rstj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dtplyr_v1.3.1-tikzDictionary"
