# Validation Report - classmap@1.2.3
...
Overall the package has 19 exported objects. 19 are documented:
              ...
              classmap        confmat.vcr             makeFV         makeKernel 
                  TRUE               TRUE               TRUE               TRUE 
              qresplot            silplot        stackedplot     vcr.da.newdata 
                  TRUE               TRUE               TRUE               TRUE 
          vcr.da.train vcr.forest.newdata   vcr.forest.train    vcr.knn.newdata 
                  TRUE               TRUE               TRUE               TRUE 
         vcr.knn.train vcr.neural.newdata   vcr.neural.train  vcr.rpart.newdata 
                  TRUE               TRUE               TRUE               TRUE 
       vcr.rpart.train    vcr.svm.newdata      vcr.svm.train 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-16 04:27:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3239fc10_1739680026
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6QeXmS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_classmap_v1.2.3-tikzDictionary"
