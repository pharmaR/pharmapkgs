# Validation Report - elevatr@0.99.0
...
| export_help          | 8                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Jeffrey Hollister <hollister.jeff@epa.gov> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/jhollist/elevatr/       |
...
cholera, geocausal, gwavr, IsoriX, movecost, rayshader, rivnet,
shoredate, transfR, traudem, windfarmGA

## Namespace

Overall the package has 8 exported objects. 8 are documented:

      get_aws_points  get_aws_terrain   get_elev_point  get_elev_raster 
                TRUE             TRUE             TRUE             TRUE 
            get_epqs     get_opentopo    merge_rasters set_opentopo_key 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 03:55:22 UTC |
...
running this report
    ...
    PROCESSX_PS1d454873c19d_1739937316
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7ANifF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_elevatr_v0.99.0-tikzDictionary"
