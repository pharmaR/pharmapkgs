...
Overall the package has 13 exported objects. 13 are documented:
           ...
           audio.drivers          audioSample current.audio.driver 
                    TRUE                 TRUE                 TRUE 
       load.audio.driver            load.wave                pause 
                    TRUE                 TRUE                 TRUE 
                    play               record               resume 
                    TRUE                 TRUE                 TRUE 
                  rewind            save.wave     set.audio.driver 
                    TRUE                 TRUE                 TRUE 
                    wait 
                    TRUE 
...
| Execution Time | 2025-02-21 13:11:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a402cb416_1740143510
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGmLbc9
