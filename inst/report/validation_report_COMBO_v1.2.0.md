...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Kimberly Hochstedler Webb <kah343@cornell.edu>       |
...
| 2   | tidyr (\>= 1.2.1)    | Imports |
| 3   | Matrix (\> 1.4-1)    | Imports |
| 4   | rjags (\>= 4-13)     | Imports |
| 5   | turboEM (\>= 2021.1) | Imports |
| 6   | SAMBA (\>= 0.9.0)    | Imports |
| 7   | utils (\>= 4.2.0)    | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
                  ...
                  COMBO_data        COMBO_data_2stage                 COMBO_EM 
                        TRUE                     TRUE                     TRUE 
             COMBO_EM_2stage               COMBO_MCMC        COMBO_MCMC_2stage 
                        TRUE                     TRUE                     TRUE 
      misclassification_prob  misclassification_prob2 true_classification_prob 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-16 05:03:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bc335e6218d_1739682201
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4NYQwc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_COMBO_v1.2.0-tikzDictionary"
