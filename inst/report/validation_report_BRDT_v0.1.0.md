...
| export_help          | 12                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Suiyao Chen <csycsy12377@gmail.com>   |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/ericchen12377/BRDT |
...
Overall the package has 12 exported objects. 12 are documented:
        ...
        bacceptprob   bconsumerrisk           bcore  bcost_expected       bcost_RDT 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           bcost_RG        bcost_WS bdata_generator      bIndicator   boptimal_cost 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         boptimal_n   pi_MCSim_beta 
               TRUE            TRUE 
...
| Execution Time | 2025-02-15 04:42:17 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd25cf138_1739594532
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpp2SlnU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BRDT_v0.1.0-tikzDictionary"
