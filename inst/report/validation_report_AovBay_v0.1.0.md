...
| export_help          | 1                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Mauricio Rojas-Campuzano <maujroja@espol.edu.ec>     |
...
| 2   | DT                        | Imports   |
| 3   | shiny                     | Imports   |
| 4   | shinydashboardPlus        | Imports   |
| 5   | shinydashboard            | Imports   |
...
| 18  | nortest                   | Imports   |
| 19  | purrr                     | Imports   |
| 20  | shinycssloaders           | Imports   |
| 21  | stringr                   | Imports   |
| 22  | waiter                    | Imports   |
| 23  | htmltools                 | Imports   |
| 24  | BH (\>= 1.66.0)           | LinkingTo |
| 25  | Rcpp (\>= 0.12.0)         | LinkingTo |
| 26  | RcppEigen (\>= 0.3.3.3.0) | LinkingTo |
| 27  | RcppParallel (\>= 5.0.1)  | LinkingTo |
| 28  | rstan (\>= 2.18.1)        | LinkingTo |
| 29  | StanHeaders (\>= 2.18.0)  | LinkingTo |
...
| Execution Time | 2025-02-14 07:16:48 UTC |
...
running this report
    ...
    PROCESSX_PS1c095a7d300b_1739517405
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpj0PXiF
