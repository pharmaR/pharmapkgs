...
| export_help          | 19                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Chris Wallace <cew54@cam.ac.uk>       |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/chr1swallace/coloc |
...
colocPropTest, cophescan, RapidoPGS

## Namespace

Overall the package has 19 exported objects. 19 are documented:

     annotate_susie check_alignment   check_dataset check.alignment   check.dataset 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          coloc.abf     coloc.bf_bf   coloc.signals     coloc.susie  coloc.susie_bf 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           findends     finemap.abf      finemap.bf finemap.signals    plot_dataset 
               TRUE            TRUE            TRUE            TRUE            TRUE 
    process.dataset        runsusie     sensitivity  subset_dataset 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-16 04:58:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35dd4b79a_1739681883
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6go5eV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coloc_v5.2.3-tikzDictionary"
