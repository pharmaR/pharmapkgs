# Validation Report - Families@2.0.2
...
| export_help          | 15                                  |
| has_website          | FALSE                               |
| has_maintainer       | Frans Willekens <willekens@nidi.nl> |
...
Overall the package has 15 exported objects. 15 are documented:
          ...
          Age     Alive        Db        Dd      IDau      IDch  IDfather     IDgch 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
     IDmother IDpartner     IDsib  Kin_long      Nkin  PlotAges     Tests 
...
| Execution Time | 2025-02-19 05:10:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d451fd7c9f4_1739941800
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgYXoe5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Families_v2.0.2-tikzDictionary"
