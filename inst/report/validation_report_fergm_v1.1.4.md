...
| export_help          | 0                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Benjamin W. Campbell <campbell.1721@osu.edu>         |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | http://github.com/benjamin-w-campbell/fergm          |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | rstan (\>= 2.16.2)       | Depends |
| 2   | ggplot2 (\>= 2.2.1)      | Imports |
| 3   | parallel (\>= 3.3.3)     | Imports |
| 4   | ergm (\>= 3.9)           | Imports |
| 5   | network (\>= 1.13.0)     | Imports |
| 6   | extrafont (\>= 0.17)     | Imports |
| 7   | matrixStats (\>= 0.52.2) | Imports |
| 8   | reshape2 (\>= 1.4.2)     | Imports |
| 9   | stats (\>= 3.4.4)        | Imports |
...
| Execution Time | 2025-02-27 03:26:35 UTC |
...
running this report
    ...
    PROCESSX_PS1c62cbfa28a_1740626791
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBJ3ljN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fergm_v1.1.4-tikzDictionary"
