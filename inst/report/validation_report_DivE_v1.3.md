...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel Laydon <d.laydon@imperial.ac.uk>              |
...
Overall the package has 8 exported objects. 8 are documented:
            ...
            CombDM      Curvature     DiveMaster   DivSampleNum  DivSubsamples 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      FitSingleMod   PopDiversity ScoreSingleMod 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:22:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb435b48e45_1739852537
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp50lZwn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DivE_v1.3-tikzDictionary"
