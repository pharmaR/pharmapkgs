# Validation Report - bootComb@1.1.2
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Marc Henrion <mhenrion@mlw.mw>                       |
...
Overall the package has 11 exported objects. 11 are documented:
           ...
           adjPrevSensSpec      adjPrevSensSpecCI               bootComb 
                      TRUE                   TRUE                   TRUE 
             getBetaFromCI           getExpFromCI         getGammaFromCI 
                      TRUE                   TRUE                   TRUE 
           getNegBinFromCI          getNormFromCI          getPoisFromCI 
                      TRUE                   TRUE                   TRUE 
       simScenPrevSensSpec simScenProductTwoPrevs 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-15 04:33:23 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4842268e_1739593998
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYyFH6N
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bootComb_v1.1.2-tikzDictionary"
