# Validation Report - combinIT@2.0.0
...
| export_help          | 8                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Hossein Haghbin <haghbin@pgu.ac.ir>  |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/haghbinh/combinIT |
...
Overall the package has 8 exported objects. 8 are documented:
           ...
           Boik_test          CI_test      Franck_test interaction_plot 
                TRUE             TRUE             TRUE             TRUE 
            KKM_test        KKSA_test       Malik_test      Piepho_test 
                TRUE             TRUE             TRUE             TRUE 

### Examples

There are 8 help pages with examples, from 12 (66.67 %).
...
| Execution Time | 2025-02-16 05:03:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3386b3fff_1739682178
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGzmGYK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_combinIT_v2.0.0-tikzDictionary"
