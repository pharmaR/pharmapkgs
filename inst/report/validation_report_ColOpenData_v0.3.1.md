# Validation Report - ColOpenData@0.3.1
...
| export_help | 20 |
| has_website | TRUE |
| has_maintainer | Maria Camila Tavera-Cifuentes <mc.tavera@uniandes.edu.co> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/epiverse-trace/ColOpenData |
...
Overall the package has 20 exported objects. 20 are documented:
            ...
            aggregate_climate          code_to_name_dep          code_to_name_mun 
                         TRUE                      TRUE                      TRUE 
               divipola_table          download_climate     download_climate_geom 
                         TRUE                      TRUE                      TRUE 
    download_climate_stations      download_demographic       download_geospatial 
                         TRUE                      TRUE                      TRUE 
     download_pop_projections     geospatial_dictionary          get_climate_tags 
                         TRUE                      TRUE                      TRUE 
                list_datasets                   look_up     merge_geo_demographic 
                         TRUE                      TRUE                      TRUE 
             name_to_code_dep          name_to_code_mun      name_to_standard_dep 
                         TRUE                      TRUE                      TRUE 
         name_to_standard_mun           stations_in_roi 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-16 04:58:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bc344643dfa_1739681918
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOwRphl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ColOpenData_v0.3.1-tikzDictionary"
