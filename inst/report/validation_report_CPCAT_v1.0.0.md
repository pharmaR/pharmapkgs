...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | René Lehmann <rene.lehmann82@t-online.de>            |
...
Overall the package has 4 exported objects. 4 are documented:
               ...
               CPCAT       hypotheses poisson.sub.test     poisson.test 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:12:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65c88a34c_1739765557
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvBCY2Y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CPCAT_v1.0.0-tikzDictionary"
