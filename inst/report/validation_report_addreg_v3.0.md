...
| export_help          | 21                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Mark W. Donoghoe <markdonoghoe@gmail.com>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 2063                                                 |
| has_source_control   | https://github.com/mdonoghoe/addreg                  |
...
Overall the package has 21 exported objects. 21 are documented:
                     ...
                     addreg          addreg.control           addreg.smooth 
                       TRUE                    TRUE                    TRUE 
               anova.addreg        anova.addreglist                       B 
                       TRUE                    TRUE                    TRUE 
             confint.addreg          contr.isotonic        contr.opisotonic 
                       TRUE                    TRUE                    TRUE 
                  conv.test interpret.addreg.smooth                     Iso 
                       TRUE                    TRUE                    TRUE 
                    negbin1                nnnegbin                  nnpois 
                       TRUE                    TRUE                    TRUE 
         plot.addreg.smooth          predict.addreg   predict.addreg.smooth 
                       TRUE                    TRUE                    TRUE 
       print.summary.addreg          summary.addreg             vcov.addreg 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 06:36:10 UTC |
...
running this report
    ...
    PROCESSX_PS726d2460d9a8_1739514967
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJQxgua
