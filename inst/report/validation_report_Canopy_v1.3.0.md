# Validation Report - Canopy@1.3.0
...
| export_help          | 30                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Yuchao Jiang <yuchaoj@email.unc.edu>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/yuchaojiang/Canopy                |
...
Overall the package has 30 exported objects. 30 are documented:
                    ...
                    addsamptree                  canopy.BIC 
                           TRUE                        TRUE 
                 canopy.cluster        canopy.cluster.Estep 
                           TRUE                        TRUE 
           canopy.cluster.Mstep               canopy.output 
                           TRUE                        TRUE 
                canopy.plottree                 canopy.post 
                           TRUE                        TRUE 
                  canopy.sample       canopy.sample.cluster 
                           TRUE                        TRUE 
    canopy.sample.cluster.nocna         canopy.sample.nocna 
                           TRUE                        TRUE 
           getclonalcomposition                     getCMCm 
                           TRUE                        TRUE 
                          getCZ               getlikelihood 
                           TRUE                        TRUE 
              getlikelihood.sna                        getQ 
                           TRUE                        TRUE 
                         getVAF                        getZ 
                           TRUE                        TRUE 
                     initialcna              initialcnacopy 
                           TRUE                        TRUE 
                       initialP                  initialsna 
                           TRUE                        TRUE 
                        sampcna                 sampcnacopy 
...
| Execution Time | 2025-02-16 03:38:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3786b6029_1739677096
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnLzRV2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Canopy_v1.3.0-tikzDictionary"
