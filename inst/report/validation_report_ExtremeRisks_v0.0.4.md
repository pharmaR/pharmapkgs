# Validation Report - ExtremeRisks@0.0.4
...
Overall the package has 19 exported objects. 19 are documented:
            ...
            EBTailIndex       estExpectiles         estExtLevel  estMultiExpectiles 
                   TRUE                TRUE                TRUE                TRUE 
             expectiles           ExpectMES    extMultiQuantile         extQuantile 
                   TRUE                TRUE                TRUE                TRUE 
             HTailIndex         HypoTesting         MLTailIndex        MomTailIndex 
                   TRUE                TRUE                TRUE                TRUE 
        MultiHTailIndex      predExpectiles predMultiExpectiles            QuantMES 
                   TRUE                TRUE                TRUE                TRUE 
           rbtimeseries              rmdata         rtimeseries 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:57:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d457bf8ef20_1739941067
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFDCPth
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ExtremeRisks_v0.0.4-tikzDictionary"
