...
| export_help          | 14                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Rachel House <rachel.house@vai.org>  |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/jamespeapen/ceas/ |
...
Overall the package has 14 exported objects. 14 are documented:
                  ...
                  atp_plot          bioscope_plot energetics_lme_summary 
                      TRUE                   TRUE                   TRUE 
    energetics_ols_summary                fit_lme         get_energetics 
                      TRUE                   TRUE                   TRUE 
    get_energetics_summary       get_rate_summary     make_bioscope_plot 
                      TRUE                   TRUE                   TRUE 
                 normalize         partition_data              rate_plot 
                      TRUE                   TRUE                   TRUE 
         rates_lme_summary              read_data 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 03:57:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32afa3242_1739678272
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3oATka
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ceas_v1.3.0-tikzDictionary"
