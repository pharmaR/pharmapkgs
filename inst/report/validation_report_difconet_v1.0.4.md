# Validation Report - difconet@1.0.4
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Victor Trevino <vtrevino@itesm.mx>                   |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    difconet.build.controlled.dataset         difconet.noise.inspection 
                                 TRUE                              TRUE 
      difconet.plot.gene.correlations difconet.plot.histograms.heatmap2 
                                 TRUE                              TRUE 
                         difconet.run 
                                 TRUE 
...
| Execution Time | 2025-02-18 04:02:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45ba0a045_1739851367
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUoM00C
...
These are the options set to generate the report:
    ...
    [1] "validation_report_difconet_v1.0.4-tikzDictionary"
