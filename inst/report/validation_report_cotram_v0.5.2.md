# Validation Report - cotram@0.5.2
...
| export_help          | 1                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Sandra Siegfried <sandra.siegfried@alumni.uzh.ch>    |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | tram (\>= 1.0-0)      | Depends |
| 2   | mlt (\>= 1.4-7)       | Depends |
| 3   | variables (\>= 1.0-2) | Imports |
| 4   | basefun (\>= 1.0-5)   | Imports |
| 5   | alabama               | Imports |
| 6   | Matrix                | Imports |
| 7   | methods               | Imports |
| 8   | survival              | Imports |
...
| Execution Time | 2025-02-24 03:22:06 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a6cd4df3d_1740367322
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVYW6iu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cotram_v0.5.2-tikzDictionary"
