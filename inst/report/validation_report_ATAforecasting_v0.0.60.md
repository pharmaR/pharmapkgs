...
| export_help          | 18                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Ali Sabri Taylan <alisabritaylan@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| size_codebase        | 3156                                        |
| has_source_control   | https://github.com/alsabtay/ATAforecasting  |
...
Overall the package has 18 exported objects. 18 are documented:
                  ...
                  ATA      ATA.Accuracy ATA.BackTransform    ATA.BoxCoxAttr 
                 TRUE              TRUE              TRUE              TRUE 
               ATA.CI          ATA.Core ATA.Decomposition      ATA.Forecast 
                 TRUE              TRUE              TRUE              TRUE 
             ATA.Plot         ATA.Print      ATA.SeasAttr   ATA.Seasonality 
                 TRUE              TRUE              TRUE              TRUE 
            ATA.Shift     ATA.Shift_Mat     ATA.Transform         find.freq 
                 TRUE              TRUE              TRUE              TRUE 
    find.freq.fourier   find.multi.freq 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-14 07:30:21 UTC |
...
running this report
    ...
    PROCESSX_PS1c0937dd3eab_1739518218
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkLsprv
