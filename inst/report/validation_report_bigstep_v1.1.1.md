# Validation Report - bigstep@1.1.1
...
| export_help          | 17                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Piotr Szulc <piotr.michal.szulc@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/pmszulc/bigstep         |
...
Overall the package has 17 exported objects. 16 are documented:
                  ...
                  %>%               aic attach.big.matrix          backward 
                FALSE              TRUE              TRUE              TRUE 
                  bic      fast_forward           forward         get_model 
                 TRUE              TRUE              TRUE              TRUE 
                 maic             maic2              mbic             mbic2 
                 TRUE              TRUE              TRUE              TRUE 
       multi_backward      prepare_data   read.big.matrix     reduce_matrix 
                 TRUE              TRUE              TRUE              TRUE 
             stepwise 
                 TRUE 
...
| Execution Time | 2025-02-15 04:05:53 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1f600e2e_1739592349
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIqnHE2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigstep_v1.1.1-tikzDictionary"
