# Validation Report - BNPdensity@2023.3.8
...
| export_help | 18 |
| has_website | FALSE |
| has_maintainer | Guillaume Kon Kam King <guillaume.konkamking.work@gmail.com> |
...
Overall the package has 18 exported objects. 18 are documented:
                 ...
                 compute_optimal_clustering                                     cpo 
                                       TRUE                                    TRUE 
    expected_number_of_components_Dirichlet    expected_number_of_components_stable 
                                       TRUE                                    TRUE 
                                   GOFplots                                MixNRMI1 
                                       TRUE                                    TRUE 
                               MixNRMI1cens                                MixNRMI2 
                                       TRUE                                    TRUE 
                               MixNRMI2cens                                  MixPY1 
                                       TRUE                                    TRUE 
                                     MixPY2                            multMixNRMI1 
                                       TRUE                                    TRUE 
                           multMixNRMI1cens                            multMixNRMI2 
                                       TRUE                                    TRUE 
                           multMixNRMI2cens                 plot_clustering_and_CDF 
                                       TRUE                                    TRUE 
            plot_prior_number_of_components                               traceplot 
                                       TRUE                                    TRUE 

### Examples

There are 132 help pages with examples, from 132 (100.00 %).
...
| Execution Time | 2025-02-15 04:28:46 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd39c58c75_1739593721
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpO5YurH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BNPdensity_v2023.3.8-tikzDictionary"
