# Validation Report - EigenR@1.3.0
...
| export_help          | 29                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Stéphane Laurent <laurent_step@outlook.fr> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/stla/EigenR             |
...
| 2   | Rcpp                      | LinkingTo |
| 3   | RcppEigen (\>= 0.3.4.0.0) | LinkingTo |
...
Overall the package has 29 exported objects. 29 are documented:
           ...
           asSparseMatrix          Eigen_absdet            Eigen_chol 
                     TRUE                  TRUE                  TRUE 
       Eigen_complexSchur             Eigen_cos            Eigen_cosh 
                     TRUE                  TRUE                  TRUE 
                Eigen_det             Eigen_exp      Eigen_Hessenberg 
                     TRUE                  TRUE                  TRUE 
            Eigen_inverse     Eigen_isInjective    Eigen_isInvertible 
                     TRUE                  TRUE                  TRUE 
       Eigen_isSurjective          Eigen_kernel Eigen_kernelDimension 
                     TRUE                  TRUE                  TRUE 
                Eigen_log       Eigen_logabsdet         Eigen_lsSolve 
                     TRUE                  TRUE                  TRUE 
           Eigen_pinverse             Eigen_pow              Eigen_QR 
                     TRUE                  TRUE                  TRUE 
              Eigen_range            Eigen_rank       Eigen_realSchur 
                     TRUE                  TRUE                  TRUE 
                Eigen_sin            Eigen_sinh            Eigen_sqrt 
                     TRUE                  TRUE                  TRUE 
               Eigen_UtDU          SparseMatrix 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-19 03:51:59 UTC |
...
running this report
    ...
    PROCESSX_PS1d45522dff93_1739937113
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpm8ejw5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EigenR_v1.3.0-tikzDictionary"
