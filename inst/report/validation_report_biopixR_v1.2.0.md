# Validation Report - biopixR@1.2.0
...
| export_help          | 15                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Tim Brauckhoff <brauctile@disroot.org> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/Brauckhoff/biopixR  |
...
Overall the package has 15 exported objects. 15 are documented:
          ...
          adaptiveInterpolation            changePixelColor 
                           TRUE                        TRUE 
                  edgeDetection                fillLineGaps 
                           TRUE                        TRUE 
                haralickCluster                     imgPipe 
                           TRUE                        TRUE 
                    importImage interactive_objectDetection 
                           TRUE                        TRUE 
              interpolatePixels             objectDetection 
                           TRUE                        TRUE 
                proximityFilter             resultAnalytics 
                           TRUE                        TRUE 
                        scanDir               shapeFeatures 
                           TRUE                        TRUE 
                     sizeFilter 
                           TRUE 
...
| Execution Time | 2025-02-15 04:14:09 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1e94fed4_1739592844
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWwmPaB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biopixR_v1.2.0-tikzDictionary"
