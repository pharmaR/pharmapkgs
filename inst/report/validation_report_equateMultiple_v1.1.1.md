# Validation Report - equateMultiple@1.1.1
...
| 3   | numDeriv             | Imports   |
| 4   | statmod              | Imports   |
| 5   | Rcpp (\>= 1.0.7)     | Imports   |
| 6   | Matrix               | Imports   |
| 7   | mvtnorm              | Imports   |
| 8   | data.table           | Imports   |
| 9   | equateIRT(\>= 2.5.1) | Depends   |
| 10  | R(\>= 3.5.0)         | Depends   |
| 11  | Rcpp                 | LinkingTo |
| 12  | RcppArmadillo        | LinkingTo |
| 13  | RcppDist             | LinkingTo |
...
| Execution Time | 2025-02-19 04:23:47 UTC |
...
running this report
    ...
    PROCESSX_PS1d4575f50846_1739939021
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQCGReZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_equateMultiple_v1.1.1-tikzDictionary"
