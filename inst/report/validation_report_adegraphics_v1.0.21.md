...
Overall the package has 54 exported objects. 78 are documented:

      adeg.panel.edges    adeg.panel.hist    adeg.panel.join   adeg.panel.label 
                  TRUE               TRUE               TRUE               TRUE 
         adeg.panel.nb adeg.panel.Spatial  adeg.panel.values            adegpar 
                  TRUE               TRUE               TRUE               TRUE 
                 ADEgS             biplot changelatticetheme              kplot 
                  TRUE               TRUE               TRUE               TRUE 
        kplotsepan.coa    layout2position               plot            plotEig 
                  TRUE               TRUE               TRUE               TRUE 
               s.arrow            s.class        s.corcircle          s.density 
                  TRUE               TRUE               TRUE               TRUE 
              s.distri            s.image            s.label             s.logo 
                  TRUE               TRUE               TRUE               TRUE 
               s.match          s.Spatial          s.traject            s.value 
                  TRUE               TRUE               TRUE               TRUE 
          s1d.barchart        s1d.boxplot          s1d.class          s1d.curve 
                  TRUE               TRUE               TRUE               TRUE 
            s1d.curves        s1d.density         s1d.distri        s1d.dotplot 
                  TRUE               TRUE               TRUE               TRUE 
             s1d.gauss           s1d.hist       s1d.interval          s1d.label 
                  TRUE               TRUE               TRUE               TRUE 
             s1d.match            scatter              score          screeplot 
                  TRUE               TRUE               TRUE               TRUE 
           setlimits1D        setlimits2D      sortparamADEg     sortparamADEgS 
                  TRUE               TRUE               TRUE               TRUE 
           table.image        table.value     triangle.class     triangle.label 
                  TRUE               TRUE               TRUE               TRUE 
        triangle.match   triangle.traject 
                  TRUE               TRUE 

### Examples

There are 93 help pages with examples, from 97 (95.88 %).
...
| Execution Time | 2025-02-21 13:07:56 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a65ed93dd_1740143273
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfE7nja
