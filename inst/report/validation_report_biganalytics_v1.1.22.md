# Validation Report - biganalytics@1.1.22
...
| 1   | stats                 | Depends   |
| 2   | utils                 | Depends   |
| 3   | bigmemory (\>= 4.0.0) | Depends   |
| 4   | foreach               | Depends   |
| 5   | biglm                 | Depends   |
| 6   | methods               | Depends   |
| 7   | Rcpp                  | LinkingTo |
| 8   | bigmemory             | LinkingTo |
| 9   | BH                    | LinkingTo |
...
bigtabulate, ChIPXpress, fusedMGM, mina

## Namespace

Overall the package has 13 exported objects. 22 are documented:

    bigglm.big.matrix         bigkmeans  biglm.big.matrix             binit 
                 TRUE              TRUE              TRUE              TRUE 
               colmax           colmean            colmin             colna 
                 TRUE              TRUE              TRUE              TRUE 
              colprod          colrange             colsd            colsum 
                 TRUE              TRUE              TRUE              TRUE 
               colvar 
                 TRUE 
...
| Execution Time | 2025-02-15 04:02:55 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd40dcb7c8_1739592171
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmps9KjeP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biganalytics_v1.1.22-tikzDictionary"
