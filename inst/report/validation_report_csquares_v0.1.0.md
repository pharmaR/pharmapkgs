# Validation Report - csquares@0.1.0
...
| has_source_control   | https://github.com/pepijn-devries/csquares/  |
...
Overall the package has 18 exported objects. 18 are documented:
             ...
             as_csquares        drop_csquares     expand_wildcards 
                    TRUE                 TRUE                 TRUE 
         format.csquares       ices_centroids         ices_columns 
                    TRUE                 TRUE                 TRUE 
      ices_from_csquares      ices_rectangles     ices_to_csquares 
                    TRUE                 TRUE                 TRUE 
             in_csquares         new_csquares    resample_csquares 
                    TRUE                 TRUE                 TRUE 
       st_as_sf.csquares   st_as_sfc.csquares st_as_stars.csquares 
                    TRUE                 TRUE                 TRUE 
       validate_csquares    vec_cast.csquares  vec_ptype2.csquares 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-17 04:31:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bd675775d9_1739766700
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpM3Yehh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_csquares_v0.1.0-tikzDictionary"
