...
| export_help          | 20                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Adrian Timpson <a.timpson@ucl.ac.uk>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 613                                                  |
| has_source_control   | https://github.com/UCL/ADMUR                         |
...
Overall the package has 20 exported objects. 0 are documented:

                   checkData              convertPars          CPLparsToHinges 
                       FALSE                    FALSE                    FALSE 
          estimateDataDomain                   loglik             makeCalArray 
                       FALSE                    FALSE                    FALSE 
                        mcmc        objectiveFunction          phaseCalibrator 
                       FALSE                    FALSE                    FALSE 
                plotCalArray                   plotPD    plotSimulationSummary 
                       FALSE                    FALSE                    FALSE 
                relativeRate    simulateCalendarDates              sinewavePDF 
                       FALSE                    FALSE                    FALSE 
           SPDsimulationTest         summedCalibrator  summedCalibratorWrapper 
                       FALSE                    FALSE                    FALSE 
       summedPhaseCalibrator uncalibrateCalendarDates 
                       FALSE                    FALSE 
...
| Execution Time | 2025-02-14 06:39:05 UTC |
...
running this report
    ...
    PROCESSX_PS726d492b185_1739515143
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMpts4X
