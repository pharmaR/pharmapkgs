# Validation Report - dslice@1.2.2
...
| export_help          | 0                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Chao Ye <yechao1009@gmail.com>                       |
...
| 1   | stats                 | Depends   |
| 2   | utils                 | Depends   |
| 3   | Rcpp (\>= 0.11.1)     | Depends   |
| 4   | ggplot2 (\>= 0.9.3.1) | Depends   |
| 5   | scales                | Depends   |
| 6   | Rcpp                  | LinkingTo |
...
| Execution Time | 2025-02-18 04:51:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4239e72b4_1739854284
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpplHJx2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dslice_v1.2.2-tikzDictionary"
