# Validation Report - binfunest@0.1.0
...
| export_help          | 18                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Philip Shea <philshea@gmail.com>      |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/PhilShea/binfunest |
...
Overall the package has 18 exported objects. 18 are documented:
        ...
        B2BConvert             dB        DQPSKdB      DQPSKDDdB is.wholenumber 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            mleB2B        mod_Inv       mod_InvV         MPSKdB       MPSKdB.8 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          PSQPSKdB             Q_          Q_Inv          QAMdB       QAMdB.16 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      QAMdB.8.star         QPSKdB           undB 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-15 04:08:31 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd61a7678_1739592506
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBqxUA1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binfunest_v0.1.0-tikzDictionary"
