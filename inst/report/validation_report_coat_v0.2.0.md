...
| export_help | 5 |
| has_website | FALSE |
| has_maintainer | Alexander Hapfelmeier <Alexander.Hapfelmeier@mri.tum.de> |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         batest        coat       diffs       means node_baplot 
...
| Execution Time | 2025-02-16 04:48:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36038470f_1739681321
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBvdbCx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coat_v0.2.0-tikzDictionary"
