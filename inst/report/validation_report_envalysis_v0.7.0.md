# Validation Report - envalysis@0.7.0
...
| export_help          | 16                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Zacharias Steinmetz <z.steinmetz@rptu.de> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/zsteinmetz/envalysis   |
...
Overall the package has 16 exported objects. 16 are documented:
       ...
       as_tridata        bisdom   calibration            CI   inv_predict 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              lod           loq matrix_effect        relerr          rmse 
             TRUE          TRUE          TRUE          TRUE          TRUE 
               se      signifig      sorption       texture theme_publish 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    weight_select 
             TRUE 
...
There are 10 help pages with examples, from 15 (66.67 %).
...
| Execution Time | 2025-02-19 04:11:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d457569acdb_1739938265
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpP1A4So
...
These are the options set to generate the report:
    ...
    [1] "validation_report_envalysis_v0.7.0-tikzDictionary"
