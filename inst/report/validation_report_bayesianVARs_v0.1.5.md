# Validation Report - bayesianVARs@0.1.5
...
| export_help          | 6                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Luis Gruber <Luis.Gruber@aau.at>           |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/luisgruber/bayesianVARs |
...
| 2   | factorstochvol (\>= 1.1.0) | Imports   |
| 3   | GIGrvg (\>= 0.7)           | Imports   |
| 4   | graphics                   | Imports   |
| 5   | MASS                       | Imports   |
| 6   | mvtnorm                    | Imports   |
| 7   | Rcpp (\>= 1.0.0)           | Imports   |
| 8   | scales                     | Imports   |
| 9   | stats                      | Imports   |
| 10  | stochvol (\>= 3.0.3)       | Imports   |
| 11  | utils                      | Imports   |
| 12  | factorstochvol             | LinkingTo |
| 13  | Rcpp                       | LinkingTo |
| 14  | RcppArmadillo              | LinkingTo |
| 15  | RcppProgress               | LinkingTo |
| 16  | stochvol                   | LinkingTo |
...
Overall the package has 6 exported objects. 6 are documented:
                   ...
                   bvar              my_gig   posterior_heatmap   specify_prior_phi 
                   TRUE                TRUE                TRUE                TRUE 
    specify_prior_sigma         stable_bvar 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-15 03:36:51 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1ad99511_1739590607
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbvEfSm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesianVARs_v0.1.5-tikzDictionary"
