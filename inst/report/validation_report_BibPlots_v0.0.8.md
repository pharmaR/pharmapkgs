# Validation Report - BibPlots@0.0.8
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Robin Haunschild <R.Haunschild@fkf.mpg.de>           |
...
Overall the package has 9 exported objects. 9 are documented:
             ...
             beamplot   beamplot_scopus        DAMBibPlot inv_perc_beamplot 
                 TRUE              TRUE              TRUE              TRUE 
            jpscatter          ncr_comp     perc_beamplot              rpys 
                 TRUE              TRUE              TRUE              TRUE 
              rpys_bl 
                 TRUE 
...
There are 9 help pages with examples, from 11 (81.82 %).
...
| Execution Time | 2025-02-15 04:01:24 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd73674705_1739592079
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKkVj0j
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BibPlots_v0.0.8-tikzDictionary"
