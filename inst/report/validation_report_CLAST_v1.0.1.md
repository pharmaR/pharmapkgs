...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Chris J. Lloyd <c.lloyd@mbs.edu>                     |
...
Overall the package has 21 exported objects. 21 are documented:
                 ...
                 CP.lower           CP.stats.SM              CP.upper 
                     TRUE                  TRUE                  TRUE 
                    cross             errors.SM exact.lower.limits.SM 
                     TRUE                  TRUE                  TRUE 
    exact.upper.limits.SM             inference            JT.rank.SM 
                     TRUE                  TRUE                  TRUE 
                 LR.lower           LR.stats.SM              LR.upper 
                     TRUE                  TRUE                  TRUE 
               ML.rank.SM           mv.plots.SM                 mv.SM 
                     TRUE                  TRUE                  TRUE 
      plt.sample.space.SM               prob.SM                  RANK 
                     TRUE                  TRUE                  TRUE 
             sample.space        sample.space.2       sample.space.SM 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:27:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3163165f_1739680032
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpohzjVI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CLAST_v1.0.1-tikzDictionary"
