# Validation Report - econullnetr@0.2.1
...
| export_help          | 7                                     |
| has_website          | FALSE                                 |
| has_maintainer       | Ian Vaughan <vaughanip@cardiff.ac.uk> |
...
Overall the package has 7 exported objects. 7 are documented:
      ...
      bipartite_stats     expand_matrix generate_edgelist generate_null_net 
                 TRUE              TRUE              TRUE              TRUE 
       plot_bipartite  plot_preferences test_interactions 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 03:36:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d4556a3c258_1739936159
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6pBzVe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_econullnetr_v0.2.1-tikzDictionary"
