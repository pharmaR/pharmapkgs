...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Ruan Buys <ruanbuys8@gmail.com>                      |
...
| 3   | htmlwidgets (\>= 1.6.2) | Imports |
| 4   | knitr (\>= 1.43)        | Imports |
| 5   | methods                 | Imports |
| 6   | plotly (\>= 4.10.2)     | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
         ...
         colorpal      FMbiplot     PCAbiplot    plot.bipl5 predict.bipl5 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      print.bipl5   Symbol_List     TDAbiplot 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-15 04:16:43 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1daf524f_1739592998
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4mahYG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bipl5_v1.0.2-tikzDictionary"
