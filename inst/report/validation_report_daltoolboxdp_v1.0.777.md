# Validation Report - daltoolboxdp@1.0.777
...
| has_source_control   | https://github.com/cefet-rj-dal/daltoolboxdp         |
...
|     | package     | type    |
|:----|:------------|:--------|
| 1   | daltoolbox  | Imports |
| 2   | leaps       | Imports |
| 3   | FSelector   | Imports |
| 4   | doBy        | Imports |
| 5   | glmnet      | Imports |
| 6   | smotefamily | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    bal_oversampling  bal_subsampling               fs           fs_fss 
                TRUE             TRUE             TRUE             TRUE 
               fs_ig         fs_lasso        fs_relief 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:52:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65a37c8db_1739767941
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpur0SBE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_daltoolboxdp_v1.0.777-tikzDictionary"
