# Validation Report - CADFtest@0.3.3
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Claudio Lupi <lupi@unimol.it>                        |
...
Overall the package has 10 exported objects. 10 are documented:
             ...
             bread.mlm        CADFpvalues           CADFtest   CADFtest.default 
                  TRUE               TRUE               TRUE               TRUE 
      CADFtest.formula         estfun.mlm      plot.CADFtest residuals.CADFtest 
                  TRUE               TRUE               TRUE               TRUE 
      summary.CADFtest    update.CADFtest 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-22 03:20:28 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb29701013_1740194424
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPFxl7t
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CADFtest_v0.3.3-tikzDictionary"
