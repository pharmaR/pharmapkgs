# Validation Report - disclosuR@0.6.0
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jonas Röttger <jonas.roettger@gmx.net>               |
...
| 3   | pdftools          | Imports |
| 4   | qdap              | Imports |
| 5   | SentimentAnalysis | Imports |
| 6   | stringi           | Imports |
| 7   | stringr           | Imports |
| 8   | syuzhet           | Imports |
| 9   | zoo               | Imports |
| 10  | SnowballC         | Imports |
| 11  | tm                | Imports |
| 12  | stats             | Imports |
| 13  | rlang             | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
           ...
           conference_call_segmenter conference_call_segmenter_folder 
                                TRUE                             TRUE 
               impression_offsetting               newswire_segmenter 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-18 04:12:08 UTC |
...
running this report
    ...
    PROCESSX_PS1bb445ccea4e_1739851923
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppWf6Nn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_disclosuR_v0.6.0-tikzDictionary"
