# Validation Report - easystats@0.7.4
...
| export_help          | 8                                  |
| has_website          | TRUE                               |
| has_maintainer       | Daniel Lüdecke <d.luedecke@uke.de> |
...
|     | package                  | type    |
|:----|:-------------------------|:--------|
| 1   | bayestestR (\>= 0.15.1)  | Imports |
| 2   | correlation (\>= 0.8.6)  | Imports |
| 3   | datawizard (\>= 1.0.0)   | Imports |
| 4   | effectsize (\>= 1.0.0)   | Imports |
| 5   | insight (\>= 1.0.1)      | Imports |
| 6   | modelbased (\>= 0.9.0)   | Imports |
| 7   | parameters (\>= 0.24.1)  | Imports |
| 8   | performance (\>= 0.13.0) | Imports |
| 9   | report (\>= 0.6.0)       | Imports |
| 10  | see (\>= 0.10.0)         | Imports |
| 11  | tools                    | Imports |
| 12  | utils                    | Imports |
...
Overall the package has 8 exported objects. 8 are documented:
           ...
           easystats_packages          easystats_update             easystats_zen 
                         TRUE                      TRUE                      TRUE 
               install_latest         install_suggested           model_dashboard 
                         TRUE                      TRUE                      TRUE 
    show_reverse_dependencies            show_suggested 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-18 05:13:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43070ea80_1739855584
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfC6oj4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easystats_v0.7.4-tikzDictionary"
