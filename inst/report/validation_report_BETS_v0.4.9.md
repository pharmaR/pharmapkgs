...
| export_help          | 30                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Talitha Speranza <talitha.speranza@fgv.br> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/nmecsys/BETS            |
...
| 10  | stringr              | Imports |
| 11  | dygraphs             | Imports |
| 12  | shiny (\>= 0.13)     | Imports |
| 13  | miniUI (\>= 0.1.1)   | Imports |
| 14  | rstudioapi (\>= 0.4) | Imports |
| 15  | DT                   | Imports |
| 16  | webshot              | Imports |
| 17  | RMySQL               | Imports |
| 18  | digest               | Imports |
...
| 21  | rvest                | Imports |
| 22  | xml2                 | Imports |
| 23  | lubridate            | Imports |
| 24  | htmltools            | Imports |
| 25  | httr                 | Imports |
| 26  | dplyr                | Imports |
| 27  | sqldf                | Imports |
...
Overall the package has 30 exported objects. 30 are documented:
         ...
         arch_test     bcbExpectA bcbExpectATop5 bcbExpectInf12     bcbExpectM 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    bcbExpectMTop5     bcbExpectT  BETS.addin_en  BETS.addin_pt        BETSget 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        BETSsearch    BETSsources          chart       corrgram      dashboard 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           deflate          dummy      grnn.test     grnn.train      normalize 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           predict         report        saveSas       saveSpss      saveStata 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          sidraGet    sidraSearch      std_resid         t_test        ur_test 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-15 03:56:31 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3c7e481_1739591786
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXRmAJO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BETS_v0.4.9-tikzDictionary"
