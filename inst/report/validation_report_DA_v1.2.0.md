...
| export_help          | 14                               |
| has_website          | TRUE                             |
| has_maintainer       | Xinghu Qin <qinxinghu@gmail.com> |
...
Overall the package has 14 exported objects. 14 are documented:
               ...
               KLFDA         KLFDA_mk           KLFDAM     kmatrixGauss 
                TRUE             TRUE             TRUE             TRUE 
              LDAKPC             LFDA          LFDAKPC          Mabayes 
                TRUE             TRUE             TRUE             TRUE 
             predict    predict.KLFDA predict.KLFDA_mk   predict.LDAKPC 
                TRUE             TRUE             TRUE             TRUE 
        predict.LFDA  predict.LFDAKPC 
                TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:49:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6714bfdd3_1739767741
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIH3F2r
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DA_v1.2.0-tikzDictionary"
