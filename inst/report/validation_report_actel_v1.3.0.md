...
| export_help          | 34                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Hugo Flávio <hflavio@wlu.ca>         |
| bugs_status          | 0.7333333                            |
| size_codebase        | 14060                                |
| has_source_control   | https://github.com/hugomflavio/actel |
...
Overall the package has 34 exported objects. 34 are documented:
        ...
        advEfficiency    blankWorkspace    completeMatrix   createWorkspace 
                 TRUE              TRUE              TRUE              TRUE 
           dataToList   distancesMatrix      dualArrayCJS       emptyMatrix 
                 TRUE              TRUE              TRUE              TRUE 
     exampleWorkspace           explore extractCodeSpaces    extractSignals 
                 TRUE              TRUE              TRUE              TRUE 
            getSpeeds          getTimes         loadShape       loadSpatial 
                 TRUE              TRUE              TRUE              TRUE 
            migration         plotArray    plotDetections          plotLive 
                 TRUE              TRUE              TRUE              TRUE 
            plotMoves        plotRatios     plotResidency       plotSensors 
                 TRUE              TRUE              TRUE              TRUE 
            plotTimes           preload           readDot        recoverLog 
                 TRUE              TRUE              TRUE              TRUE 
            residency     shapeToRaster         simpleCJS       stationName 
                 TRUE              TRUE              TRUE              TRUE 
      timesToCircular   transitionLayer 
                 TRUE              TRUE 

### Examples

There are 187 help pages with examples, from 198 (94.44 %).
...
| Execution Time | 2025-02-14 06:32:51 UTC |
...
running this report
    ...
    PROCESSX_PS726d43337056_1739514769
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9pnDHL
