# Validation Report - CondIndTests@0.1.5
...
| export_help | 13 |
| has_website | TRUE |
| has_maintainer | Christina Heinze-Deml <heinzedeml@stat.math.ethz.ch> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/christinaheinze/nonlinearICP-and-CondIndTests |
...
|:----|:---------------|:--------|
| 1   | methods        | Imports |
| 2   | randomForest   | Imports |
| 3   | quantregForest | Imports |
| 4   | lawstat        | Imports |
| 5   | RPtests        | Imports |
| 6   | caTools        | Imports |
| 7   | mgcv           | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
                               ...
                               CondIndTest                  fishersTestExceedance 
                                      TRUE                                   TRUE 
                              fTestTargetY InvariantConditionalQuantilePrediction 
                                      TRUE                                   TRUE 
            InvariantEnvironmentPrediction      InvariantResidualDistributionTest 
                                      TRUE                                   TRUE 
                 InvariantTargetPrediction                                    KCI 
                                      TRUE                                   TRUE 
                   ksResidualDistributions   leveneAndWilcoxResidualDistributions 
                                      TRUE                                   TRUE 
                           propTestTargetE                 ResidualPredictionTest 
                                      TRUE                                   TRUE 
                         wilcoxTestTargetY 
                                      TRUE 
...
| Execution Time | 2025-02-17 03:40:43 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6124b83a1_1739763638
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpEzxUaa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CondIndTests_v0.1.5-tikzDictionary"
