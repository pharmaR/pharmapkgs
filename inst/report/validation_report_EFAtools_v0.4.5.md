# Validation Report - EFAtools@0.4.5
...
| export_help          | 17                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Markus Steiner <markus.d.steiner@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/mdsteiner/EFAtools       |
...
| 13  | graphics      | Imports   |
| 14  | future.apply  | Imports   |
| 15  | future        | Imports   |
| 16  | GPArotation   | Imports   |
| 17  | checkmate     | Imports   |
| 18  | tidyr         | Imports   |
| 19  | progressr     | Imports   |
| 20  | progress      | Imports   |
| 21  | rlang         | Imports   |
| 22  | Rcpp          | LinkingTo |
...
Overall the package has 17 exported objects. 16 are documented:
              ...
              %>%      BARTLETT            CD       COMPARE           EFA 
            FALSE          TRUE          TRUE          TRUE          TRUE 
      EFA_AVERAGE           EKC FACTOR_SCORES          HULL           KGC 
             TRUE          TRUE          TRUE          TRUE          TRUE 
              KMO     N_FACTORS         OMEGA      PARALLEL         SCREE 
             TRUE          TRUE          TRUE          TRUE          TRUE 
               SL           SMT 
             TRUE          TRUE 
...
| Execution Time | 2025-02-19 03:46:08 UTC |
...
running this report
    ...
    PROCESSX_PS1d4545a54a62_1739936762
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGWY0Yp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EFAtools_v0.4.5-tikzDictionary"
