# Validation Report - diverse@0.1.5
...
| export_help          | 13                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Miguel R. Guevara <miguel.guevara@upla.cl> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/mguevara/diverse        |
...
Overall the package has 13 exported objects. 13 are documented:
            ...
            balance  dis_categories    dis_entities       disparity       diversity 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          read_data     sim_dataset      sim_entity sim_individuals    to_entropart 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           ubiquity          values         variety 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 04:22:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41a5c23a_1739852571
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8H5V9r
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diverse_v0.1.5-tikzDictionary"
