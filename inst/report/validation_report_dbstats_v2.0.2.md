# Validation Report - dbstats@2.0.2
...
| export_help          | 33                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Eva Boj <evaboj@ub.edu>                              |
...
Overall the package has 33 exported objects. 25 are documented:

             as.D2        as.Gram       D2toDist          D2toG          dbglm 
             FALSE          FALSE          FALSE          FALSE           TRUE 
          dbglm.D2     dbglm.dist  dbglm.formula     dbglm.Gram           dblm 
              TRUE           TRUE           TRUE           TRUE           TRUE 
           dblm.D2      dblm.dist   dblm.formula      dblm.Gram         dbplsr 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         dbplsr.D2    dbplsr.dist dbplsr.formula    dbplsr.Gram       disttoD2 
              TRUE           TRUE           TRUE           TRUE          FALSE 
             GtoD2          is.D2        is.Gram         ldbglm      ldbglm.D2 
             FALSE          FALSE          FALSE           TRUE           TRUE 
       ldbglm.dist ldbglm.formula    ldbglm.Gram          ldblm       ldblm.D2 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        ldblm.dist  ldblm.formula     ldblm.Gram 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 05:08:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65315d22c_1739768894
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVCVtqQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dbstats_v2.0.2-tikzDictionary"
