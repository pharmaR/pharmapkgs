# Validation Report - ClickClust@1.1.6
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Volodymyr Melnykov <vmelnykov@ua.edu>                |
...
Overall the package has 13 exported objects. 13 are documented:
    ...
    click.backward       click.EM  click.forward     click.plot  click.predict 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     click.predict     click.read      click.sim      click.var       print.EM 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      print.search     summary.EM summary.search 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:29:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34102291d_1739680180
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpP9nWDu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClickClust_v1.1.6-tikzDictionary"
