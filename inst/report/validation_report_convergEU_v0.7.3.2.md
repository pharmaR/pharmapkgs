# Validation Report - convergEU@0.7.3.2
...
| export_help | 44 |
| has_website | TRUE |
| has_maintainer | Eleonora Peruffo <eleonora.peruffo@eurofound.europa.eu> |
...
Overall the package has 44 exported objects. 44 are documented:
               ...
               abso_change          average_clust              beta_conv 
                      TRUE                   TRUE                   TRUE 
           beta_conv_graph          check_country             check_data 
                      TRUE                   TRUE                   TRUE 
             convergEU_glb        country_ranking             delta_conv 
                      TRUE                   TRUE                   TRUE 
              demea_change         departure_best    departure_best_plot 
                      TRUE                   TRUE                   TRUE 
            departure_mean          dev_mean_plot       dow_soc_scor_boa 
                      TRUE                   TRUE                   TRUE 
               down_lo_EUS download_indicator_EUS  extract_indicator_ECG 
                      TRUE                   TRUE                   TRUE 
    extract_indicator_EIGE  extract_indicator_EUF             gamma_conv 
                      TRUE                   TRUE                   TRUE 
         gamma_conv_msteps           go_indica_fi               go_ms_fi 
                      TRUE                   TRUE                   TRUE 
              gra_de2_patt        graph_departure           impu_det_lin 
                      TRUE                   TRUE                   TRUE 
            impute_dataset             ma_dataset               ms_dynam 
                      TRUE                   TRUE                   TRUE 
             ms_pattern_39          ms_pattern_59         ms_pattern_ori 
                      TRUE                   TRUE                   TRUE 
                    not_in            patt_legend         patt_legend_39 
                      TRUE                   TRUE                   TRUE 
                points2par                pop_var             scoreb_yrs 
                      TRUE                   TRUE                   TRUE 
                sigma_conv       sigma_conv_graph           smoo_dataset 
                      TRUE                   TRUE                   TRUE 
                 ts_parlin              upDo_CoDi 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-17 03:51:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6307ec79e_1739764264
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIUunPB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_convergEU_v0.7.3.2-tikzDictionary"
