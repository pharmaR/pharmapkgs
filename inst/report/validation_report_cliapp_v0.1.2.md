# Validation Report - cliapp@0.1.2
...
| has_source_control   | https://github.com/r-lib/cliapp#readme |
...
| 2   | crayon               | Imports |
| 3   | fansi                | Imports |
| 4   | glue (\>= 1.3.0)     | Imports |
| 5   | prettycode           | Imports |
| 6   | progress (\>= 1.2.0) | Imports |
| 7   | R6                   | Imports |
| 8   | selectr              | Imports |
| 9   | utils                | Imports |
| 10  | withr                | Imports |
...
Overall the package has 24 exported objects. 24 are documented:
        ...
        builtin_theme         cli_alert  cli_alert_danger    cli_alert_info 
                 TRUE              TRUE              TRUE              TRUE 
    cli_alert_success cli_alert_warning           cli_div            cli_dl 
                 TRUE              TRUE              TRUE              TRUE 
              cli_end            cli_h1            cli_h2            cli_h3 
                 TRUE              TRUE              TRUE              TRUE 
               cli_it            cli_ol           cli_par  cli_progress_bar 
                 TRUE              TRUE              TRUE              TRUE 
             cli_text            cli_ul      cli_verbatim     console_width 
                 TRUE              TRUE              TRUE              TRUE 
          default_app      simple_theme         start_app          stop_app 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:29:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3575e6af6_1739680163
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpswV6JD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cliapp_v0.1.2-tikzDictionary"
