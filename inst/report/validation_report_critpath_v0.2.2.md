# Validation Report - critpath@0.2.2
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Adam Kucharski <aqcharski@interia.pl>                |
...
Overall the package has 10 exported objects. 10 are documented:
     ...
     PERT_newprob  PERT_newtime     plot_alap     plot_asap    plot_gantt 
             TRUE          TRUE          TRUE          TRUE          TRUE 
    plot_graphAOA     plot_norm       plot_TC solve_lessAOA solve_pathAOA 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 04:21:17 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6e32b71b_1739766071
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPnSDCd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_critpath_v0.2.2-tikzDictionary"
