# Validation Report - causalBatch@1.3.0
...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Eric W. Bridgeford <ericwb95@gmail.com>              |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/neurodata/causal_batch            |
...
| 5   | dplyr        | Imports |
| 6   | magrittr     | Imports |
| 7   | genefilter   | Imports |
| 8   | BiocParallel | Imports |
| 9   | utils        | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
              ...
              cb.align.kway_match              cb.align.vm_trim 
                             TRUE                          TRUE 
          cb.correct.aipw_cComBat cb.correct.apply_aipw_cComBat 
                             TRUE                          TRUE 
         cb.correct.apply_cComBat   cb.correct.matching_cComBat 
                             TRUE                          TRUE 
            cb.detect.caus_cdcorr           cb.sims.sim_impulse 
                             TRUE                          TRUE 
       cb.sims.sim_impulse_asycov            cb.sims.sim_linear 
                             TRUE                          TRUE 
              cb.sims.sim_sigmoid 
                             TRUE 
...
| Execution Time | 2025-02-16 03:48:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36f0ee2b_1739677725
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4rat2Y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causalBatch_v1.3.0-tikzDictionary"
