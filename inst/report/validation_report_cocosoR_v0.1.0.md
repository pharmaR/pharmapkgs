# Validation Report - cocosoR@0.1.0
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Sergio Floquet <sergiofloquet@hotmail.com>           |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    check_input_data_cocoso                  cocoso         standard_cocoso 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-16 04:49:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bc379e9e4aa_1739681391
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpL4DuzB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cocosoR_v0.1.0-tikzDictionary"
