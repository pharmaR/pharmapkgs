# Validation Report - cyjShiny@1.0.42
...
| export_help          | 27                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Augustin Luna <augustin_luna@hms.harvard.edu>        |
...
Overall the package has 27 exported objects. 27 are documented:
                ...
                addGraphFromDataFrame              addGraphFromJsonFile 
                                 TRUE                              TRUE 
                       clearSelection                          cyjShiny 
                                 TRUE                              TRUE 
                       cyjShinyOutput                  dataFramesToJSON 
                                 TRUE                              TRUE 
                             doLayout                               fit 
                                 TRUE                              TRUE 
                          fitSelected                  getNodePositions 
                                 TRUE                              TRUE 
                     getSelectedNodes                    graphNELtoJSON 
                                 TRUE                              TRUE 
                        hideSelection                   invertSelection 
                                 TRUE                              TRUE 
              loadNetworkFromJSONFile                     loadStyleFile 
                                 TRUE                              TRUE 
    readAndStandardizeJSONNetworkFile   readAndStandardizeJSONStyleFile 
                                 TRUE                              TRUE 
                          removeGraph                    renderCyjShiny 
                                 TRUE                              TRUE 
                        savePNGtoFile              selectFirstNeighbors 
                                 TRUE                              TRUE 
                          selectNodes                 setEdgeAttributes 
                                 TRUE                              TRUE 
                    setNodeAttributes                  setNodePositions 
                                 TRUE                              TRUE 
                              showAll 
                                 TRUE 
...
| Execution Time | 2025-02-17 04:46:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6661e8230_1739767591
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeKWIMZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cyjShiny_v1.0.42-tikzDictionary"
