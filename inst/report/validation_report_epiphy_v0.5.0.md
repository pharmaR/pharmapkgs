# Validation Report - epiphy@0.5.0
...
| export_help          | 41                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Christophe Gigot <ch.gigot@gmail.com> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/chgigot/epiphy     |
...
Overall the package has 41 exported objects. 41 are documented:
               ...
               a2a      agg_index    calpha.test     chisq.test        cloglog 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             clump          count     count_data     dbetabinom  fit_two_distr 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         incidence incidence_data        ind2sub       is.count   is.incidence 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      is.intensity    is.severity          logit        mapcomp     mapped_var 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      mapped_var<-        mapping       mapping_     pbetabinom      power_law 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            probit     qbetabinom     rbetabinom          remap          sadie 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          severity  severity_data           smle smle_betabinom     smle_binom 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       smle_nbinom      smle_pois   spatial_hier        sub2ind      threshold 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            z.test 
              TRUE 
...
| Execution Time | 2025-02-19 04:18:34 UTC |
...
running this report
    ...
    PROCESSX_PS1d45691b91a1_1739938708
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKobn9D
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epiphy_v0.5.0-tikzDictionary"
