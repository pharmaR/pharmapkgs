# Validation Report - colocr@0.1.1
...
| export_help | 11 |
| has_website | TRUE |
| has_maintainer | Mahmoud Ahmed <mahmoud.s.fahmy@students.kasralainy.edu.eg> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/ropensci/colocr |
...
Overall the package has 11 exported objects. 10 are documented:
    ...
    .intensity_get    .labels_add       .manders       .pearson            %>% 
              TRUE           TRUE           TRUE           TRUE          FALSE 
        colocr_app     image_load      roi_check     roi_select       roi_show 
...
| Execution Time | 2025-02-16 04:58:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bc348b1b490_1739681906
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbAfPaQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colocr_v0.1.1-tikzDictionary"
