...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | igraph (\>= 1.2.6)      | Imports |
| 2   | doParallel (\>= 1.0.16) | Imports |
| 3   | cocor (\>= 1.1.3)       | Imports |
| 4   | ggplot2 (\>= 3.3.3)     | Imports |
| 5   | forcats (\>= 0.5.1)     | Imports |
| 6   | dplyr (\>= 1.0.5)       | Imports |
| 7   | data.table (\>= 1.13.7) | Imports |
| 8   | tibble (\>= 3.1.0)      | Imports |
| 9   | foreach (\>= 1.5.1)     | Imports |
| 10  | genefilter (\>= 1.72.1) | Imports |
| 11  | ggrepel (\>= 0.9.1)     | Imports |
| 12  | gplots (\>= 3.1.1)      | Imports |
| 13  | gridExtra (\>= 2.3)     | Imports |
| 14  | plyr (\>= 1.8.6)        | Imports |
| 15  | ppcor (\>= 1.1)         | Imports |
| 16  | tidyr (\>= 1.1.3)       | Imports |
| 17  | Hmisc (\>= 4.4.2)       | Imports |
| 18  | methods (\>= 4.0.3)     | Imports |
| 19  | rlang (\>= 0.4.10)      | Imports |
| 20  | tidyselect (\>= 1.1.0)  | Imports |
...
There are 37 help pages with examples, from 49 (75.51 %).
...
| Execution Time | 2025-02-17 03:44:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61b669120_1739763894
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHtiWsK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CoNI_v0.1.0-tikzDictionary"
