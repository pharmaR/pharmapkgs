# Validation Report - EFAfactors@1.2.1
...
| export_help          | 24                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Haijiang Qin <haijiang133@outlook.com>               |
...
| 12  | Rcpp          | Imports   |
| 13  | RcppArmadillo | Imports   |
| 14  | SimCorMultRes | Imports   |
| 15  | xgboost       | Imports   |
| 16  | Rcpp          | LinkingTo |
...
Overall the package has 24 exported objects. 24 are documented:
                ...
                af.softmax                     CD                    CDF 
                      TRUE                   TRUE                   TRUE 
    check_python_libraries          DNN_predictor              EFAhclust 
                      TRUE                   TRUE                   TRUE 
                  EFAindex              EFAkmeans              EFAscreet 
                      TRUE                   TRUE                   TRUE 
               EFAsim.data                EFAvote                    EKC 
                      TRUE                   TRUE                   TRUE 
     extractor.feature.DNN   extractor.feature.FF        factor.analysis 
                      TRUE                   TRUE                   TRUE 
                        FF                GenData                   Hull 
                      TRUE                   TRUE                   TRUE 
                       KGC               load_DNN            load_scaler 
                      TRUE                   TRUE                   TRUE 
                  load_xgb             normalizor                     PA 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-19 03:46:02 UTC |
...
running this report
    ...
    PROCESSX_PS1d451f9f2177_1739936756
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPj9uIJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EFAfactors_v1.2.1-tikzDictionary"
