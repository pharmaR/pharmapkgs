# Validation Report - DisaggregateTS@3.0.1
...
| export_help | 3 |
| has_website | FALSE |
| has_maintainer | Kaveh Salehzadeh Nobari <k.salehzadeh-nobari@imperial.ac.uk> |
...
Overall the package has 3 exported objects. 3 are documented:
      ...
      disaggregate simulDiagnosis  TempDisaggDGP 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:10:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bb446bf8318_1739851844
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4cjgTP
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DisaggregateTS_v3.0.1-tikzDictionary"
