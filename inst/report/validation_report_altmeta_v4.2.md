...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Lifeng Lin <lifenglin@arizona.edu>                   |
...
Overall the package has 19 exported objects. 19 are documented:
             ...
             maprop.glmm       maprop.twostep             meta.biv 
                    TRUE                 TRUE                 TRUE 
                 meta.dt          meta.or.smd             meta.pen 
                    TRUE                 TRUE                 TRUE 
                 metahet         metaoutliers               metapb 
                    TRUE                 TRUE                 TRUE 
                    mvma        mvma.bayesian          mvma.hybrid 
                    TRUE                 TRUE                 TRUE 
    mvma.hybrid.bayesian             nma.icdf         nma.predrank 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-14 06:50:45 UTC |
...
running this report
    ...
    PROCESSX_PS726d92efd09_1739515842
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVt89wW
