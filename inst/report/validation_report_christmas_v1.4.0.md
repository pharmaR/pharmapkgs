# Validation Report - christmas@1.4.0
...
| export_help          | 16                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Jose Barrera-Gomez <jose.barrera@uab.cat>            |
...
Overall the package has 16 exported objects. 16 are documented:
        ...
        xmascaganer     xmasepitree        xmasflag xmasfractaltree      xmasgalton 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         xmashealth       xmashelix        xmasneon     xmaspicasso  xmasregression 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       xmassnowkoch     xmassnowman        xmastext        xmastree   xmastreeshape 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       xmastreewire 
               TRUE 
...
| Execution Time | 2025-02-16 04:16:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37c26f5d2_1739679366
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUPcnAl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_christmas_v1.4.0-tikzDictionary"
