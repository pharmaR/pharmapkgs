# Validation Report - BayesX@0.3.3
...
bamlss, expectreg, gamboostLSS, mboost

## Namespace

Overall the package has 26 exported objects. 26 are documented:

       add.neighbor         bnd2gra          bnd2sp     createxymap delete.neighbor 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            drawmap  extractSamples            fuse   get.centroids    get.neighbor 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             gra2nb             hpd        hpd.coda          nb2gra     plotautocor 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           plotnonp      plotsample plotsample.coda        plotsurf        read.bnd 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           read.gra         shp2bnd      smooth.bnd          sp2bnd       write.bnd 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          write.gra 
               TRUE 
...
| Execution Time | 2025-02-15 03:42:31 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7c28bf97_1739590947
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQo8AU5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesX_v0.3.3-tikzDictionary"
