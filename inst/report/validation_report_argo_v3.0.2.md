...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Shihao Yang <shihao.yang@isye.gatech.edu>            |
...
Overall the package has 17 exported objects. 17 are documented:
                       ...
                       argox_main                       boot_re 
                             TRUE                          TRUE 
    bootstrap_relative_efficiency                  heatmap_argo 
                             TRUE                          TRUE 
                      heatmap_cor                     load_data 
                             TRUE                          TRUE 
                    load_reg_data                         logit 
                             TRUE                          TRUE 
                        logit_inv               parse_gt_weekly 
                             TRUE                          TRUE 
              parse_unrevised_ili                     plot_argo 
                             TRUE                          TRUE 
                     summary_argo 
                             TRUE 
...
| Execution Time | 2025-02-14 07:23:05 UTC |
...
running this report
    ...
    PROCESSX_PS1c091715bef7_1739517782
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0cYlJG
