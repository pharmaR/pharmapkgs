# Validation Report - CustomerScoringMetrics@1.0.0
...
Overall the package has 13 exported objects. 13 are documented:
           ...
           checkDepVector     confMatrixMetrics         cumGainsChart 
                     TRUE                  TRUE                  TRUE 
            cumGainsTable cutoffSensitivityPlot           dynAccuracy 
                     TRUE                  TRUE                  TRUE 
            dynConfMatrix       expMisclassCost             liftChart 
                     TRUE                  TRUE                  TRUE 
                liftIndex             liftTable          misclassCost 
                     TRUE                  TRUE                  TRUE 
            topDecileLift 
                     TRUE 
...
| Execution Time | 2025-02-17 04:41:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65ddde768_1739767292
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2WJgjg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CustomerScoringMetrics_v1.0.0-tikzDictionary"
