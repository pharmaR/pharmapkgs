...
| export_help          | 11                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Juan D. Umaña <jd.umana10@uniandes.edu.co> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/epiverse-trace/epiCo    |
...
Overall the package has 11 exported objects. 11 are documented:
               ...
               age_risk  describe_ethnicity describe_occupation     endemic_channel 
                   TRUE                TRUE                TRUE                TRUE 
           epi_calendar      geometric_mean        geometric_sd      incidence_rate 
                   TRUE                TRUE                TRUE                TRUE 
           morans_index       neighborhoods  population_pyramid 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:15:13 UTC |
...
running this report
    ...
    PROCESSX_PS1d453f1a2155_1739938507
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpG6pfgg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epiCo_v1.0.1-tikzDictionary"
