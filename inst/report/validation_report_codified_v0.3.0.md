# Validation Report - codified@0.3.0
...
| export_help          | 2                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Will Beasley <wibeasley@hotmail.com> |
...
|:----|:----------------------|:--------|
| 1   | R(\>= 4.1.0)          | Depends |
| 2   | checkmate (\>= 1.8.4) | Imports |
| 3   | dplyr (\>= 1.0.0)     | Imports |
| 4   | kableExtra            | Imports |
| 5   | knitr (\>= 1.18.0)    | Imports |
| 6   | rlang                 | Imports |
| 7   | tibble (\>= 1.4.0)    | Imports |
...
Overall the package has 2 exported objects. 2 are documented:
           ...
           table_nih_enrollment table_nih_enrollment_pretty 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-16 04:52:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34db90708_1739681560
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5UXxTX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_codified_v0.3.0-tikzDictionary"
