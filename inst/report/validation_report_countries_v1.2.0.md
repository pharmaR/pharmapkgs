# Validation Report - countries@1.2.0
...
| export_help          | 22                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Francesco Saverio Bellelli <fsabellelli@gmail.com> |
| bugs_status          | subscript out of bounds                            |
| has_source_control   | https://github.com/fbellelli/countries             |
...
Overall the package has 22 exported objects. 22 are documented:
              ...
              auto_melt          auto_merge check_countries_api   check_wide_format 
                   TRUE                TRUE                TRUE                TRUE 
           country_info        country_name     find_countrycol         find_keycol 
                   TRUE                TRUE                TRUE                TRUE 
           find_timecol          is_country             is_date           is_keycol 
                   TRUE                TRUE                TRUE                TRUE 
         list_countries         list_fields         match_table                Mode 
                   TRUE                TRUE                TRUE                TRUE 
     palettes_countries           quick_map    random_countries           which_max 
                   TRUE                TRUE                TRUE                TRUE 
              which_min          which_mode 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:05:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bd666d0a9a4_1739765106
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgrEP3S
...
These are the options set to generate the report:
    ...
    [1] "validation_report_countries_v1.2.0-tikzDictionary"
