...
| export_help          | 15                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Jeffrey S. Racine <racinej@mcmaster.ca>        |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/JeffreyRacine/R-Package-crs |
...
Overall the package has 15 exported objects. 15 are documented:
                        ...
                        clsd                      crs                    crsiv 
                        TRUE                     TRUE                     TRUE 
                  crsivderiv               crssigtest                    frscv 
                        TRUE                     TRUE                     TRUE 
                  frscvNOMAD         glp.model.matrix                   gsl.bs 
                        TRUE                     TRUE                     TRUE 
                       krscv               krscvNOMAD                 npglpreg 
                        TRUE                     TRUE                     TRUE 
                     snomadr tensor.prod.model.matrix              uniquecombs 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-17 04:26:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6774a8e30_1739766369
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwhnlPM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crs_v0.15.38-tikzDictionary"
