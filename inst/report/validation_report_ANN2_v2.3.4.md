...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Bart Lammers <bart.f.lammers@gmail.com>              |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 495                                                  |
| has_source_control   | https://github.com/bflammers/ANN2                    |
...
| 4   | viridisLite (\>= 0.3.0) | Imports   |
| 5   | methods                 | Imports   |
| 6   | Rcpp                    | LinkingTo |
| 7   | RcppArmadillo           | LinkingTo |
| 8   | testthat                | LinkingTo |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            autoencoder    compression_plot              decode              encode 
                   TRUE                TRUE                TRUE                TRUE 
          neuralnetwork            read_ANN         reconstruct reconstruction_plot 
                   TRUE                TRUE                TRUE                TRUE 
                  train           write_ANN 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-14 06:55:17 UTC |
...
running this report
    ...
    PROCESSX_PS726d66e5d71d_1739516114
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6KbrEJ
