...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alessandro Magrini <alessandro.magrini@unifi.it>     |
...
Overall the package has 17 exported objects. 17 are documented:
      ...
      as.graphNEL  auto.lagPlot      autoCode     causalEff compareModels 
             TRUE          TRUE          TRUE          TRUE          TRUE 
            dlsem    drawSample           ecq           gam       isIndep 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          lagPlot     lagShapes            ld         lmHAC            qd 
             TRUE          TRUE          TRUE          TRUE          TRUE 
     residualPlot   unirootTest 
             TRUE          TRUE 
...
| Execution Time | 2025-02-18 04:26:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bb444f96362_1739852774
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpqq3PJq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dlsem_v2.4.6-tikzDictionary"
