# Validation Report - ctrlGene@1.0.1
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Shanliang Zhong <slzhong@foxmail.com>                |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    bestKeeper        bki      cpSta     geNorm    geNorm2   measureM  pairwiseV 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
    pearsonCor      plotM      plotV 
          TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-17 04:35:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64a413a52_1739766934
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5LxgfQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ctrlGene_v1.0.1-tikzDictionary"
