# Validation Report - dockerfiler@0.2.4
...
| has_source_control   | https://github.com/ThinkR-open/dockerfiler |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | attempt (\>= 0.3.1)  | Imports |
| 2   | cli (\>= 2.3.0)      | Imports |
| 3   | desc (\>= 1.2.0)     | Imports |
| 4   | fs (\>= 1.5.0)       | Imports |
| 5   | glue (\>= 1.4.2)     | Imports |
| 6   | jsonlite (\>= 1.7.2) | Imports |
| 7   | memoise              | Imports |
| 8   | pak (\>= 0.6.0)      | Imports |
| 9   | pkgbuild (\>= 1.2.0) | Imports |
| 10  | purrr                | Imports |
| 11  | R6 (\>= 2.5.0)       | Imports |
| 12  | remotes (\>= 2.2.0)  | Imports |
| 13  | usethis (\>= 2.0.1)  | Imports |
| 14  | utils                | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
      ...
      compact_sysreqs    dock_from_desc    dock_from_renv docker_ignore_add 
                 TRUE              TRUE              TRUE              TRUE 
           Dockerfile       get_sysreqs  parse_dockerfile                 r 
                 TRUE              TRUE              TRUE              TRUE 
                 renv 
                 TRUE 
...
| Execution Time | 2025-02-18 04:30:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42e5f1fa_1739853039
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpF3ZjkT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dockerfiler_v0.2.4-tikzDictionary"
