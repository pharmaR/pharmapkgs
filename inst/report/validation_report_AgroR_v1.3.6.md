...
| export_help          | 75                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Gabriel Danilo Shimizu <gabrield.shimizu@gmail.com>  |
...
Overall the package has 75 exported objects. 75 are documented:
                  ...
                  aacp        bar_dunnett          bar_graph         bar_graph2 
                  TRUE               TRUE               TRUE               TRUE 
              barfacet bargraph_onefactor bargraph_twofactor   barplot_positive 
                  TRUE               TRUE               TRUE               TRUE 
          confinterval            conjdbc            conjdic        conjfat2dbc 
                  TRUE               TRUE               TRUE               TRUE 
                cor_ic           corgraph                DBC             dbc.ad 
                  TRUE               TRUE               TRUE               TRUE 
               DBC.glm               DBCT               desc           desc2fat 
                  TRUE               TRUE               TRUE               TRUE 
              desc3fat desd_fat2_quant_ad                DIC             dic.ad 
                  TRUE               TRUE               TRUE               TRUE 
               DIC.glm               DICT            dispvar                DQL 
                  TRUE               TRUE               TRUE               TRUE 
                  DQLT               dunn            dunnett         fat2_table 
                  TRUE               TRUE               TRUE               TRUE 
               FAT2DBC         FAT2DBC.ad            FAT2DIC         FAT2DIC.ad 
                  TRUE               TRUE               TRUE               TRUE 
               FAT3DBC         FAT3DBC.ad            FAT3DIC         FAT3DIC.ad 
                  TRUE               TRUE               TRUE               TRUE 
        grid.onefactor    ibarplot.double       jointcluster          line_plot 
                  TRUE               TRUE               TRUE               TRUE 
              logistic       PCA_function           plot_cor   plot_interaction 
                  TRUE               TRUE               TRUE               TRUE 
           plot_jitter            plot_TH           plot_TH1      plot_tonetest 
                  TRUE               TRUE               TRUE               TRUE 
            polynomial        polynomial2  polynomial2_color            PSUBDBC 
                  TRUE               TRUE               TRUE               TRUE 
               PSUBDIC        PSUBFAT2DBC         PSUBSUBDBC    quant.fat2.desd 
                  TRUE               TRUE               TRUE               TRUE 
            radargraph          seg_graph         seg_graph2           sk_graph 
                  TRUE               TRUE               TRUE               TRUE 
                sketch       spider_graph           STRIPLOT    summarise_anova 
                  TRUE               TRUE               TRUE               TRUE 
        summarise_conj  summarise_dunnett          tabledesc   TBARPLOT.reverse 
                  TRUE               TRUE               TRUE               TRUE 
              test_two           tonetest             transf 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-14 06:43:34 UTC |
...
running this report
    ...
    PROCESSX_PS726d18a50e80_1739515411
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0dStIU
