# Validation Report - contactdata@1.1.0
...
| export_help          | 4                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Hugo Gruson <hugo.gruson+R@normalesup.org> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/bisaloo/contactdata     |
...
Overall the package has 4 exported objects. 4 are documented:
        ...
        age_df_countries contact_df_countries       contact_matrix 
                    TRUE                 TRUE                 TRUE 
          list_countries 
                    TRUE 
...
| Execution Time | 2025-02-17 03:48:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6159036bc_1739764117
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLy4ERh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_contactdata_v1.1.0-tikzDictionary"
