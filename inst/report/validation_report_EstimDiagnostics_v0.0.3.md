# Validation Report - EstimDiagnostics@0.0.3
...
| export_help | 6 |
| has_website | TRUE |
| has_maintainer | Dmitry Otryakhin <d.otryakhin.acad@protonmail.ch> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://gitlab.com/Dmitry_Otryakhin/diagnostics-and-tests-for-statistical-estimators |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | foreach (\>= 1.5.1)  | Imports |
| 2   | reshape2 (\>= 1.4.4) | Imports |
| 3   | ggplot2 (\>= 3.3.2)  | Imports |
| 4   | goftest (\>= 1.2-2)  | Imports |
| 5   | testthat (\>= 3.0.0) | Imports |
| 6   | rlang                | Imports |
...
Overall the package has 6 exported objects. 6 are documented:
       ...
       Estim_diagnost    estims_boxplot     estims_qqplot    expect_distfit 
                 TRUE              TRUE              TRUE              TRUE 
      expect_gaussian expect_mean_equal 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-19 04:32:43 UTC |
...
running this report
    ...
    PROCESSX_PS1d451d2bd88d_1739939557
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpqssuvv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EstimDiagnostics_v0.0.3-tikzDictionary"
