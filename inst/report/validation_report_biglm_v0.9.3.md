...
biganalytics, broom, broom.helpers, cplm, DeclareDesign, EMJMCMC,
emmeans, ff, insight, ipumsr, leaps, Maaslin2, marginaleffects,
optmatch, parameters, rMR, rstanarm, rwicc, speedglm

## Namespace

Overall the package has 5 exported objects. 6 are documented:

               bigglm bigglm.data.frame   bigglm.function      bigglm.RODBC 
                 TRUE              TRUE              TRUE              TRUE 
                biglm 
                 TRUE 
...
| Execution Time | 2025-02-15 04:04:06 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd436b8928_1739592241
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTtYFfG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_biglm_v0.9.3-tikzDictionary"
