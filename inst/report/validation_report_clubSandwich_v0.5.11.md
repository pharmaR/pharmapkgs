# Validation Report - clubSandwich@0.5.11
...
| export_help          | 11                                    |
| has_website          | TRUE                                  |
| has_maintainer       | James Pustejovsky <jepusto@gmail.com> |
...
EquiTrends, estimatr, ggeffects, insight, lavaSearch2, metadat, metafor,
mlmhelpr, mmrm, modelsummary, panelr, parameters, RESI, robumeta,
sjPlot, SynergyLMM, wildmeta

## Namespace

Overall the package has 11 exported objects. 11 are documented:

                    coef_test                  conf_int           constrain_equal 
                         TRUE                      TRUE                      TRUE 
           constrain_pairwise            constrain_zero        findCluster.rma.mv 
                         TRUE                      TRUE                      TRUE 
     impute_covariance_matrix           linear_contrast pattern_covariance_matrix 
                         TRUE                      TRUE                      TRUE 
                       vcovCR                 Wald_test 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-16 04:36:21 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35c8a010_1739680576
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptiT8av
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clubSandwich_v0.5.11-tikzDictionary"
