# Validation Report - Correlplot@1.1.0
...
Overall the package has 20 exported objects. 20 are documented:
              ...
              angleToR        correlogram         fit_angles      FitRDeltaQSym 
                  TRUE               TRUE               TRUE               TRUE 
    FitRwithPCAandWALS            ggbplot      ggcorrelogram            ggtally 
                  TRUE               TRUE               TRUE               TRUE 
               ipSymLS           jointlim             Keller         linangplot 
                  TRUE               TRUE               TRUE               TRUE 
                lincos                pco                pfa               rmse 
                  TRUE               TRUE               TRUE               TRUE 
        rmsePCAandWALS              tally                 tr            wAddPCA 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 04:00:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61d66d7cb_1739764826
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp11TwRV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Correlplot_v1.1.0-tikzDictionary"
