# Validation Report - cartographer@0.2.1
...
| export_help          | 9                                           |
| has_website          | TRUE                                        |
| has_maintainer       | Carl Suster <Carl.Suster@health.nsw.gov.au> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/cidm-ph/cartographer     |
...
Overall the package has 9 exported objects. 9 are documented:
             ...
             add_geometry         feature_names         feature_types 
                     TRUE                  TRUE                  TRUE 
              map_outline                map_sf               map_sfc 
                     TRUE                  TRUE                  TRUE 
             register_map resolve_feature_names  resolve_feature_type 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 03:43:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36c29b633_1739677425
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb1HfpT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cartographer_v0.2.1-tikzDictionary"
