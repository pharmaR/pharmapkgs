...
| export_help          | 20                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Renfei Mao <renfeimao@gmail.com>                     |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/flujoo/erify                      |
...
drugDemand, eventPred, EventPredInCure, gm

## Namespace

Overall the package has 20 exported objects. 20 are documented:

              back_quote check_binary_classes           check_bool 
                    TRUE                 TRUE                 TRUE 
             check_class        check_classes        check_content 
                    TRUE                 TRUE                 TRUE 
          check_contents       check_interval      check_intervals 
                    TRUE                 TRUE                 TRUE 
            check_length        check_lengths              check_n 
                    TRUE                 TRUE                 TRUE 
          check_positive         check_string           check_type 
                    TRUE                 TRUE                 TRUE 
             check_types                 is_n            is_string 
                    TRUE                 TRUE                 TRUE 
                    join                throw 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-19 04:26:48 UTC |
...
running this report
    ...
    PROCESSX_PS1d451b04bbef_1739939202
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyLnOzq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_erify_v0.6.0-tikzDictionary"
