# Validation Report - emailvalidation@0.1.0
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    emailvalidation_api_key          get_api_status          get_email_info 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-19 03:59:20 UTC |
...
running this report
    ...
    PROCESSX_PS1d4519ed1cd1_1739937554
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcYbXR9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_emailvalidation_v0.1.0-tikzDictionary"
