# Validation Report - cjoint@2.1.1
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Anton Strezhnev <astrezhnev@uchicago.edu>            |
...
marginaleffects, rdss

## Namespace

Overall the package has 8 exported objects. 8 are documented:

                   amce          makeDesign           plot.amce  print.summary.amce 
                   TRUE                TRUE                TRUE                TRUE 
         read.qualtrics read.with.qualtRics        summary.amce                view 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:24:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34388d7d7_1739679885
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFmMzuT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cjoint_v2.1.1-tikzDictionary"
