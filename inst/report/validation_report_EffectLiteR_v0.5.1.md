# Validation Report - EffectLiteR@0.5.1
...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Axel Mayer <amayer2010@gmail.com>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/amayer2010/EffectLiteR            |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | lavaan (\>= 0.6-8) | Depends |
| 2   | methods            | Imports |
| 3   | shiny (\>= 1.5.0)  | Imports |
| 4   | DT                 | Imports |
| 5   | foreign            | Imports |
| 6   | ggplot2            | Imports |
| 7   | nnet               | Imports |
| 8   | car                | Imports |
| 9   | restriktor         | Imports |
| 10  | ic.infer           | Imports |
| 11  | numDeriv           | Imports |
...
Overall the package has 11 exported objects. 11 are documented:
            ...
            autoSelectSubset computeAggregatedEffects   conditionalEffectsPlot 
                        TRUE                     TRUE                     TRUE 
                  effectLite           effectLite_iht            effectLiteGUI 
                        TRUE                     TRUE                     TRUE 
                  elrEffects            elrEffectsGUI               elrPredict 
                        TRUE                     TRUE                     TRUE 
                 elrReadData generateMeasurementModel 
                        TRUE                     TRUE 

### Examples

There are 11 help pages with examples, from 20 (55.00 %).
...
| Execution Time | 2025-02-25 03:25:47 UTC |
...
running this report
    ...
    PROCESSX_PS1d284c4605bd_1740453944
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpz5s14f
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EffectLiteR_v0.5.1-tikzDictionary"
