...
| export_help          | 29                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Lukasz Nieweglowski <wookashn@gmail.com>             |
...
diceR, kml, kml3d, longitudinalData, metasnf, MultIS

## Namespace

Overall the package has 29 exported objects. 29 are documented:

                bcls.matrix                 cls.alg              cls.attrib 
                       TRUE                    TRUE                    TRUE 
             cls.scatt.data       cls.scatt.diss.mx         cls.set.section 
                       TRUE                    TRUE                    TRUE 
        cls.stab.opt.assign cls.stab.opt.assign.usr        cls.stab.sim.ind 
                       TRUE                    TRUE                    TRUE 
       cls.stab.sim.ind.usr      clv.Davies.Bouldin              clv.DensBw 
                       TRUE                    TRUE                    TRUE 
                    clv.Dis                clv.Dunn      clv.Folkes.Mallows 
                       TRUE                    TRUE                    TRUE 
                clv.Jaccard                 clv.Phi                clv.Rand 
                       TRUE                    TRUE                    TRUE 
             clv.Russel.Rao               clv.Scatt                  clv.SD 
                       TRUE                    TRUE                    TRUE 
                   clv.SDbw        confusion.matrix            connectivity 
                       TRUE                    TRUE                    TRUE 
       connectivity.diss.mx             dot.product        similarity.index 
                       TRUE                    TRUE                    TRUE 
                    std.ext             wcls.matrix 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-16 04:42:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3616b7f7e_1739680944
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDiM2kG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clv_v0.3.2.4-tikzDictionary"
