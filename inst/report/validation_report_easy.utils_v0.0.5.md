# Validation Report - easy.utils@0.0.5
...
| export_help          | 19                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Yuchen Li <ycli1995@outlook.com>       |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/ycli1995/easy.utils |
...
Overall the package has 18 exported objects. 19 are documented:

     checkAlignedDims     checkColorMap   checkSameLength       chunkPoints 
                 TRUE              TRUE              TRUE              TRUE 
        fastIntersect     fetchColnames getDiscreteColors   identicalFMatch 
                 TRUE              TRUE              TRUE              TRUE 
      identicalNoAttr isValidCharacters      pal_discrete      pasteFactors 
                 TRUE              TRUE              TRUE              TRUE 
       replaceEntries          setColor         unlistMap  validMatDimnames 
                 TRUE              TRUE              TRUE              TRUE 
         validMatDims        verboseMsg 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-18 05:10:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4683af674_1739855400
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpK9TnIZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easy.utils_v0.0.5-tikzDictionary"
