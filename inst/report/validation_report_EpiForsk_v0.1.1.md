# Validation Report - EpiForsk@0.1.1
...
| export_help          | 26                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Kim Daniel Jakobsen <kija@ssi.dk>                    |
...
| 15  | policytree | Imports |
| 16  | progressr  | Imports |
| 17  | purrr      | Imports |
| 18  | rlang      | Imports |
| 19  | stringr    | Imports |
| 20  | survey     | Imports |
...
Overall the package has 26 exported objects. 26 are documented:
                ...
                .datatable.aware                      asympBF 
                            TRUE                         TRUE 
                      braid_rows                  CATESurface 
                            TRUE                         TRUE 
    CausalForestDynamicSubgroups                  CForBenefit 
                            TRUE                         TRUE 
                  charlson_score             CovariateBalance 
                            TRUE                         TRUE 
      DiscreteCovariatesToOneHot                  fct_confint 
                            TRUE                         TRUE 
          flatten_date_intervals                freq_function 
                            TRUE                         TRUE 
          freq_function_repeated                   invasympBF 
                            TRUE                         TRUE 
                   invlogasympBF                 invwatershed 
                            TRUE                         TRUE 
                             lms                   logasympBF 
                            TRUE                         TRUE 
                      many_merge                   multi_join 
                            TRUE                         TRUE 
             odds_ratio_function odds_ratio_function_repeated 
                            TRUE                         TRUE 
                 RATEOmnibusTest                     RATETest 
                            TRUE                         TRUE 
              try_catch_warnings                    watershed 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-19 04:16:36 UTC |
...
running this report
    ...
    PROCESSX_PS1d45443c86bc_1739938590
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxgKOVO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EpiForsk_v0.1.1-tikzDictionary"
