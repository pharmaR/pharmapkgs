...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Michael Kleinsasser <biostat-cran-manager@umich.edu> |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | coda (\>= 0.19.3)       | Imports |
| 2   | chron (\>= 2.3.54)      | Imports |
| 3   | data.table (\>= 1.12.0) | Imports |
| 4   | ggplot2 (\>= 3.2.1)     | Imports |
| 5   | grDevices (\>= 3.5.2)   | Imports |
| 6   | graphics (\>= 3.5.2)    | Imports |
| 7   | gtools (\>= 3.8.1)      | Imports |
| 8   | scales (\>= 1.1.0)      | Imports |
| 9   | stats (\>= 3.5.2)       | Imports |
| 10  | reshape2 (\>= 1.4.3)    | Imports |
| 11  | rjags (\>= 4.10)        | Imports |
| 12  | utils (\>= 3.5.2)       | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
        ...
        eSAIR   qh.eSIR  tvt.eSIR tvt.eSIR2 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-19 04:30:16 UTC |
...
running this report
    ...
    PROCESSX_PS1d453fb985ca_1739939410
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8tnh34
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eSIR_v0.4.2-tikzDictionary"
