# Validation Report - EpiInvert@0.3.1
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Luis Alvarez <lalvarez@ulpgc.es>                     |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/lalvarezmat/EpiInvert             |
...
Overall the package has 10 exported objects. 10 are documented:
                 ...
                 apply_delay            EpiIndicators     EpiIndicators_params 
                        TRUE                     TRUE                     TRUE 
          EpiIndicators_plot                EpiInvert           EpiInvert_plot 
                        TRUE                     TRUE                     TRUE 
           EpiInvertForecast   EpiInvertForecast_plot joint_indicators_by_date 
                        TRUE                     TRUE                     TRUE 
               select_params 
                        TRUE 
...
| Execution Time | 2025-02-19 04:17:04 UTC |
...
running this report
    ...
    PROCESSX_PS1d453d804452_1739938618
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp92q9am
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EpiInvert_v0.3.1-tikzDictionary"
