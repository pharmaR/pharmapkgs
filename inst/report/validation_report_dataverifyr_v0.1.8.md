# Validation Report - dataverifyr@0.1.8
...
| export_help | 8 |
| has_website | TRUE |
| has_maintainer | David Zimmermann-Kollenda <david_j_zimmermann@hotmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/DavZim/dataverifyr |
...
Overall the package has 8 exported objects. 8 are documented:
        ...
        check_data detect_backend   filter_fails       plot_res     read_rules 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              rule        ruleset    write_rules 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 05:02:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6d77f0bb_1739768539
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJJGCAL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dataverifyr_v0.1.8-tikzDictionary"
