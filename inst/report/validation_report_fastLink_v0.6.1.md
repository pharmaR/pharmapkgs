# Validation Report - fastLink@0.6.1
...
| export_help          | 25                                      |
| has_website          | FALSE                                   |
| has_maintainer       | Ted Enamorado <ted.enamorado@gmail.com> |
...
| 8   | stringr           | Imports   |
| 9   | stringi           | Imports   |
| 10  | Rcpp (\>= 0.12.7) | Imports   |
| 11  | adagio            | Imports   |
| 12  | dplyr             | Imports   |
| 13  | plotrix           | Imports   |
| 14  | grDevices         | Imports   |
| 15  | graphics          | Imports   |
| 16  | methods           | Imports   |
| 17  | RcppArmadillo     | LinkingTo |
| 18  | Rcpp              | LinkingTo |
| 19  | RcppEigen         | LinkingTo |
...
Overall the package has 25 exported objects. 25 are documented:
        ...
        aggconfusion      aggregateEM        blockData calcMoversPriors 
                TRUE             TRUE             TRUE             TRUE 
        clusterMatch        confusion    dedupeMatches        emlinklog 
                TRUE             TRUE             TRUE             TRUE 
        emlinkMARmov         emlinkRS         fastLink      gammaCK2par 
                TRUE             TRUE             TRUE             TRUE 
          gammaCKpar        gammaKpar   gammaNUMCK2par    gammaNUMCKpar 
                TRUE             TRUE             TRUE             TRUE 
          getMatches      getPatterns     getPosterior        inspectEM 
                TRUE             TRUE             TRUE             TRUE 
         matchesLink     nameReweight      preprocText     stringSubset 
                TRUE             TRUE             TRUE             TRUE 
         tableCounts 
                TRUE 
...
| Execution Time | 2025-02-19 05:18:19 UTC |
...
running this report
    ...
    PROCESSX_PS1d4544a0b51d_1739942293
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6VraZ2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastLink_v0.6.1-tikzDictionary"
