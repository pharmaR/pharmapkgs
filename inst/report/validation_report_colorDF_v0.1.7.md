# Validation Report - colorDF@0.1.7
...
| export_help          | 19                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | January Weiner <january.weiner@gmail.com>            |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/january3/colorDF/                 |
...
Overall the package has 19 exported objects. 19 are documented:
      ...
      add_colorDF_theme          as.colorDF            col_type          col_type<- 
                   TRUE                TRUE                TRUE                TRUE 
                colorDF     colorDF_options      colorDF_themes colorDF_themes_show 
                   TRUE                TRUE                TRUE                TRUE 
              df_search            df_style          df_style<-          format_col 
                   TRUE                TRUE                TRUE                TRUE 
      get_colorDF_theme           highlight          is.colorDF       print_colorDF 
                   TRUE                TRUE                TRUE                TRUE 
        remove_df_style     summary_colorDF        term_boxplot 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-16 04:59:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32df7fd7_1739681935
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSG2GMz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colorDF_v0.1.7-tikzDictionary"
