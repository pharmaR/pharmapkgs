# Validation Report - extrafont@0.19
...
| export_help          | 9                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Winston Chang <winston@stdout.org>                   |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/wch/extrafont                     |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 441360                                               |
| reverse_dependencies | 42                                                   |
| has_examples         | 1                                                    |
| dependencies         | 4                                                    |
| license              | GPL-2                                                |
...
Overall the package has 42 reverse dependencies:

andurinha, BrailleR, camcorder, CSGo, eaf, eemR, EGRET, fergm, fontcm,
forplo, ggalt, ggmcmc, ggThemeAssist, ggthemes, hrbrthemes, ineAtlas,
inTextSummaryTable, IPV, oceanmap, oesr, OlinkAnalyze, PhyloProfile,
quanteda.textplots, ratlas, RcmdrPlugin.KMggplot2, rgl, sageR, skimr,
spreadr, subincomeR, tagcloud, tidytidbits, tntpr, tvthemes,
unhcrthemes, unusualprofile, usaidplot, visvaR, waffle, WhatsR, wpa,
xkcd
...
Overall the package has 9 exported objects. 9 are documented:
        ...
        choose_font     embed_fonts font_addpackage     font_import    font_install 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              fonts       fonttable       loadfonts      ttf_import 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 04:56:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d454cfc6562_1739940967
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmlD16w
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extrafont_v0.19-tikzDictionary"
