...
Overall the package has 12 exported objects. 12 are documented:
                          ...
                          add.mcmc             findMissingPattern 
                              TRUE                           TRUE 
            generate_ipdma_example        generate_ipdnma_example 
                              TRUE                           TRUE 
    generate_sysmiss_ipdma_example                        ipd.run 
                              TRUE                           TRUE 
                  ipd.run.parallel                   ipdma.impute 
                              TRUE                           TRUE 
         ipdma.model.deft.onestage           ipdma.model.onestage 
                              TRUE                           TRUE 
             ipdnma.model.onestage               treatment.effect 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-15 04:16:37 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd687d5ebd_1739592992
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplrwHmw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bipd_v0.3-tikzDictionary"
