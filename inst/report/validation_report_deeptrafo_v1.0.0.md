# Validation Report - deeptrafo@1.0.0
...
| export_help | 14 |
| has_website | TRUE |
| has_maintainer | Lucas Kook <lucasheinrich.kook@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/neural-structured-additive-learning/deeptrafo |
...
| 2   | keras (\>= 2.2.0)          | Depends |
| 3   | tfprobability (\>= 0.15)   | Depends |
| 4   | deepregression (\>= 2.2.0) | Depends |
| 5   | mlt                        | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
           ...
           BoxCoxNN          ColrNN        cotramNN         CoxphNN            dctm 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          deeptrafo        LehmanNN            LmNN          ontram          PolrNN 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          SurvregNN   trafo_control   trafoensemble weighted_logLik 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 03:36:06 UTC |
...
running this report
    ...
    PROCESSX_PS1bb421ae15b7_1739849761
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0vg6t3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deeptrafo_v1.0.0-tikzDictionary"
