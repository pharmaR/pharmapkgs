...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Laura D’Angelo <laura.dangelo@live.com>              |
...
Overall the package has 4 exported objects. 4 are documented:
        ...
        mcmc_diagnostics            merge_sim posterior_predictive 
                    TRUE                 TRUE                 TRUE 
              sample_bpr 
                    TRUE 
...
| Execution Time | 2025-02-15 04:39:15 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2c4e4d2e_1739594350
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKfsd2P
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bpr_v1.0.8-tikzDictionary"
