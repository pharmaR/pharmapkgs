# Validation Report - EESPCA@0.7.0
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | H. Robert Frost <rob.frost@dartmouth.edu>            |
...
Overall the package has 12 exported objects. 12 are documented:
    ...
    computeApproxNormSquaredEigenvector               computeResidualMatrix 
                                   TRUE                                TRUE 
                                 eespca                            eespcaCV 
                                   TRUE                                TRUE 
                             eespcaForK                      powerIteration 
                                   TRUE                                TRUE 
                            reconstruct                 reconstructionError 
                                   TRUE                                TRUE 
                              rifleInit                          riflePCACV 
                                   TRUE                                TRUE 
                                 tpower                         tpowerPCACV 
                                   TRUE                                TRUE 
...
| Execution Time | 2025-02-19 03:45:35 UTC |
...
running this report
    ...
    PROCESSX_PS1d453077a6e9_1739936729
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4IISu7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EESPCA_v0.7.0-tikzDictionary"
