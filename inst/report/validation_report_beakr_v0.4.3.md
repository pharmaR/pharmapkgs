...
| has_source_control   | https://github.com/MazamaScience/beakr            |
| has_bug_reports_url  | 1                                                 |
| downloads_1yr        | 3305                                              |
| reverse_dependencies | 0                                                 |
| has_examples         | 0.7307692                                         |
| dependencies         | 8                                                 |
| license              | GPL-3                                             |
...
Overall the package has 22 exported objects. 21 are documented:
               ...
               Error     handleErrors       httpDELETE          httpGET 
                TRUE             TRUE             TRUE             TRUE 
            httpPOST          httpPUT        jsonError           listen 
                TRUE             TRUE             TRUE             TRUE 
            Listener      listServers       Middleware         newBeakr 
                TRUE             TRUE             TRUE             TRUE 
             Request         Response           Router serveStaticFiles 
                TRUE             TRUE             TRUE             TRUE 
      stopAllServers       stopServer 
                TRUE             TRUE 

### Examples

There are 19 help pages with examples, from 26 (73.08 %).
...
| Execution Time | 2025-02-15 03:49:48 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2d6e22eb_1739591383
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiuxQrd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beakr_v0.4.3-tikzDictionary"
