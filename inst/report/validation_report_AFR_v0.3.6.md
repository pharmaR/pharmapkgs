...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Sultan Zhaparov <saldau.sultan@gmail.com>            |
...
Overall the package has 19 exported objects. 19 are documented:
                    ...
                    bg                 bp        check_betas          checkdata 
                  TRUE               TRUE               TRUE               TRUE 
                corsel           dec_plot            difflog                 gq 
                  TRUE               TRUE               TRUE               TRUE 
                    HP ols_test_normality           opt_size               pct1 
                  TRUE               TRUE               TRUE               TRUE 
                  pct4           pt_multi             pt_one           reg_plot 
                  TRUE               TRUE               TRUE               TRUE 
              reg_test           regsel_f            vif_reg 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-14 06:41:42 UTC |
...
running this report
    ...
    PROCESSX_PS726d620bdec2_1739515299
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpj8EWcH
