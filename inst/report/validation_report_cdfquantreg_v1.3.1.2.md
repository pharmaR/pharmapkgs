# Validation Report - cdfquantreg@1.3.1.2
...
| export_help | 22 |
| has_website | FALSE |
| has_maintainer | Yiyun Shou <yiyun.shou@anu.edu.au> |
| bugs_status | scraping bug reports fromm BugReports host ‘wordpress’ not implemented |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | pracma (\>= 2.3)  | Imports |
| 2   | Formula (\>= 1.2) | Imports |
| 3   | stats             | Imports |
| 4   | MASS              | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
    ...
    bugsLikelihood      bugsModel          cdfft  cdfqr.control    cdfqrFamily 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       cdfquantreg   cdfquantregC  cdfquantregFT   cdfquantregH             dq 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             pdfft             pq             qq           qqft         qrBoot 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            qrGrad       qrLogLik         qrPwlm        qrStart             rq 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              rqft        scaleTR 
              TRUE           TRUE 
...
| Execution Time | 2025-02-16 03:56:14 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33ada0d07_1739678169
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2UCkus
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cdfquantreg_v1.3.1.2-tikzDictionary"
