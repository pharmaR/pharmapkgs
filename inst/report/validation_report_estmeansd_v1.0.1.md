# Validation Report - estmeansd@1.0.1
...
| export_help          | 5                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Sean McGrath <sean.mcgrath@mail.mcgill.ca> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/stmcg/estmeansd         |
...
meta, metafor, metamedian, metaquant

## Namespace

Overall the package has 5 exported objects. 5 are documented:

     bc.mean.sd      get_SE mln.mean.sd      qe.fit  qe.mean.sd 
...
| Execution Time | 2025-02-19 04:32:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d457a4d0d1a_1739939571
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQk7NLO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_estmeansd_v1.0.1-tikzDictionary"
