# Validation Report - DynForest@1.2.0
...
| export_help          | 7                                                |
| has_website          | TRUE                                             |
| has_maintainer       | Anthony Devaux <anthony.devauxbarault@gmail.com> |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/anthonydevaux/DynForest       |
...
Overall the package has 7 exported objects. 7 are documented:
       ...
       compute_gvimp compute_ooberror compute_vardepth     compute_vimp 
                TRUE             TRUE             TRUE             TRUE 
           dynforest         get_tree    get_treenodes 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 05:05:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bb469340a98_1739855141
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpO60c6O
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DynForest_v1.2.0-tikzDictionary"
