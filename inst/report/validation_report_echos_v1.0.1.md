...
| export_help          | 7                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Alexander Häußer <alexander-haeusser@gmx.de> |
| bugs_status          | 1                                            |
| has_source_control   | https://github.com/ahaeusser/echos           |
...
Overall the package has 7 exported objects. 7 are documented:
                ...
                ESN    forecast_esn          is.esn is.forecast_esn       reservoir 
               TRUE            TRUE            TRUE            TRUE            TRUE 
      run_reservoir       train_esn 
               TRUE            TRUE 
...
| Execution Time | 2025-02-19 03:32:45 UTC |
...
running this report
    ...
    PROCESSX_PS1d454ae75bb7_1739935959
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgzJQWH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_echos_v1.0.1-tikzDictionary"
