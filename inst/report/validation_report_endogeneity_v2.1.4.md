# Validation Report - endogeneity@2.1.4
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jing Peng <jing.peng@uconn.edu>                      |
...
Overall the package has 12 exported objects. 12 are documented:
                 ...
                 bilinear              biprobit       biprobit_latent 
                     TRUE                  TRUE                  TRUE 
         biprobit_partial         linear_probit                   pln 
                     TRUE                  TRUE                  TRUE 
               pln_linear            pln_probit         probit_linear 
                     TRUE                  TRUE                  TRUE 
     probit_linear_latent probit_linear_partial       probit_linearRE 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-19 04:06:44 UTC |
...
running this report
    ...
    PROCESSX_PS1d4510a070a_1739937998
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPzK50l
...
These are the options set to generate the report:
    ...
    [1] "validation_report_endogeneity_v2.1.4-tikzDictionary"
