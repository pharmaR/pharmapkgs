# Validation Report - doseminer@0.1.2
...
| export_help          | 7                                          |
| has_website          | FALSE                                      |
| has_maintainer       | David Selby <david.selby@manchester.ac.uk> |
...
|     | package             | type    |
|:----|:--------------------|:--------|
| 1   | magrittr(\>= 2.0.1) | Imports |
| 2   | stringr(\>= 1.4.0)  | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
      ...
      clean_prescription_text              example_cprd     example_prescriptions 
                         TRUE                      TRUE                      TRUE 
    extract_from_prescription       latin_medical_terms           replace_numbers 
                         TRUE                      TRUE                      TRUE 
                 words2number 
                         TRUE 
...
| Execution Time | 2025-02-18 04:35:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42111977d_1739853338
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpheKJeV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doseminer_v0.1.2-tikzDictionary"
