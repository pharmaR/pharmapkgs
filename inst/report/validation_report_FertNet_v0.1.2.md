# Validation Report - FertNet@0.1.2
...
| export_help          | 12                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Gert Stulp <g.stulp@rug.nl>          |
| bugs_status          | subscript out of bounds              |
| has_source_control   | https://github.com/gertstulp/FertNet |
...
Overall the package has 12 exported objects. 12 are documented:
       ...
       change_column_types      create_alter_attr        create_edgelist 
                      TRUE                   TRUE                   TRUE 
                 create_nw create_relation_labels       create_tidygraph 
                      TRUE                   TRUE                   TRUE 
                fix_errors    get_background_vars           produce_data 
                      TRUE                   TRUE                   TRUE 
                 read_data     remove_timing_vars              translate 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-27 03:26:58 UTC |
...
running this report
    ...
    PROCESSX_PS1c624b6673e9_1740626814
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1yDIK7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FertNet_v0.1.2-tikzDictionary"
