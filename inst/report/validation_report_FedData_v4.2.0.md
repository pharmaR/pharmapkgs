# Validation Report - FedData@4.2.0
...
| export_help          | 43                                    |
| has_website          | TRUE                                  |
| has_maintainer       | R. Kyle Bocinsky <bocinsky@gmail.com> |
| bugs_status          | 0.8666667                             |
| has_source_control   | https://github.com/ropensci/FedData   |
...
Overall the package has 43 exported objects. 42 are documented:
                            ...
                            %>%                 agol_filter 
                          FALSE                        TRUE 
               agol_filter_httr                  cdl_colors 
                           TRUE                        TRUE 
                  check_service               download_data 
                           TRUE                        TRUE 
    download_ghcn_daily_station              download_itrdb 
                           TRUE                        TRUE 
      download_ssurgo_inventory  download_ssurgo_study_area 
                           TRUE                        TRUE 
            extract_ssurgo_data                     get_cdl 
                           TRUE                        TRUE 
                     get_daymet              get_ghcn_daily 
                           TRUE                        TRUE 
         get_ghcn_daily_station          get_ghcn_inventory 
                           TRUE                        TRUE 
                      get_itrdb                    get_nass 
                           TRUE                        TRUE 
                   get_nass_cdl                     get_ned 
                           TRUE                        TRUE 
                   get_ned_tile                     get_nhd 
                           TRUE                        TRUE 
                       get_nlcd             get_nlcd_annual 
                           TRUE                        TRUE 
                      get_padus                  get_ssurgo 
                           TRUE                        TRUE 
           get_ssurgo_inventory       get_ssurgo_study_area 
                           TRUE                        TRUE 
                        get_wbd                 nlcd_colors 
                           TRUE                        TRUE 
                       pal_nlcd                    plot_nhd 
                           TRUE                        TRUE 
            polygon_from_extent                    read_crn 
                           TRUE                        TRUE 
                  read_crn_data           read_crn_metadata 
                           TRUE                        TRUE 
                   replace_null       sequential_duplicated 
                           TRUE                        TRUE 
                     split_bbox       station_to_data_frame 
                           TRUE                        TRUE 
                   substr_right                 unwrap_rows 
                           TRUE                        TRUE 
                       url_base 
                           TRUE 
...
| Execution Time | 2025-02-27 03:25:31 UTC |
...
running this report
    ...
    PROCESSX_PS1c6213af9aaf_1740626727
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTe8xBl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FedData_v4.2.0-tikzDictionary"
