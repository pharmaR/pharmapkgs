...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Ziqian Yang <zi.yang@ufl.edu>                        |
...
|:----|:-------------------------------|:----------|
| 1   | stats                          | Imports   |
| 2   | HDCI (\>= 1.0-2)               | Imports   |
| 3   | MASS (\>= 7.3-60)              | Imports   |
| 4   | extraDistr (\>= 1.4-4)         | Imports   |
| 5   | Rcpp (\>= 1.0.11)              | LinkingTo |
| 6   | RcppArmadillo (\>= 0.12.6.3.0) | LinkingTo |
...
| Execution Time | 2025-02-14 06:32:35 UTC |
...
running this report
    ...
    PROCESSX_PS726dbd6a446_1739514753
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp49SuDX
