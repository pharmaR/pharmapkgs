...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Silverio Vilchez-Lopez <svilchez@ujaen.es>           |
...
Overall the package has 17 exported objects. 17 are documented:
    ...
    chisq.test2        dcbp        dctp        debw      fitcbp      fitctp 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
         fitebw        pcbp        pctp        pebw        qcbp        qctp 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
           qebw        rcbp        rctp        rebw     varcomp 
...
| Execution Time | 2025-02-17 04:12:54 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62ac29b7d_1739765569
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWOIGKt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cpd_v0.3.3-tikzDictionary"
