...
| export_help          | 23                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Manuel J. A. Eugster <manuel@mjae.net>               |
...
Overall the package has 22 exported objects. 22 are documented:
               ...
               archetypes      archetypesFamily               archmap 
                     TRUE                  TRUE                  TRUE 
            as.archetypes     atypes_projection             bestModel 
                     TRUE                  TRUE                  TRUE 
                       jd           moviepcplot             movieplot 
                     TRUE                  TRUE                  TRUE 
               movieplot2           nparameters              panorama 
                     TRUE                  TRUE                  TRUE 
                   pcplot      robustArchetypes                   rss 
                     TRUE                  TRUE                  TRUE 
       simplex_projection           simplexplot          skeletonplot 
                     TRUE                  TRUE                  TRUE 
           stepArchetypes tspsimplex_projection    weightedArchetypes 
                     TRUE                  TRUE                  TRUE 
                   xyplot 
                     TRUE 
...
| Execution Time | 2025-02-21 13:10:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a33b5f05a_1740143401
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb3Z64I
