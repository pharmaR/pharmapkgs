# Validation Report - beastier@2.5.2
...
| has_source_control | https://docs.ropensci.org/beastier/ (website) |
...
|:----|:----------------------|:--------|
| 1   | ape                   | Imports |
| 2   | beautier (\>= 2.6.11) | Imports |
| 3   | phangorn              | Imports |
| 4   | rappdirs              | Imports |
| 5   | readr                 | Imports |
| 6   | rJava                 | Imports |
| 7   | rlang (\>= 1.1.0)     | Imports |
| 8   | sessioninfo           | Imports |
| 9   | stringr               | Imports |
| 10  | tibble                | Imports |
| 11  | xml2                  | Imports |
...
babette, mauricer, mcbette, nodeSub
...
| Execution Time | 2025-02-15 03:50:24 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6c78fca8_1739591419
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptnPzdZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_beastier_v2.5.2-tikzDictionary"
