...
| export_help          | 20                              |
| has_website          | TRUE                            |
| has_maintainer       | Sean Kross <sean@seankross.com> |
| bugs_status          | subscript out of bounds         |
| size_codebase        | 673                             |
| has_source_control   | http://github.com/seankross/ari |
...
Overall the package has 20 exported objects. 20 are documented:
                  ...
                  ari_example               ari_narrate                  ari_spin 
                         TRUE                      TRUE                      TRUE 
                   ari_stitch                  ari_talk        audio_codec_encode 
                         TRUE                      TRUE                      TRUE 
         check_ffmpeg_version       ffmpeg_audio_codecs             ffmpeg_codecs 
                         TRUE                      TRUE                      TRUE 
                  ffmpeg_exec             ffmpeg_muxers            ffmpeg_version 
                         TRUE                      TRUE                      TRUE 
    ffmpeg_version_sufficient       ffmpeg_video_codecs           get_audio_codec 
                         TRUE                      TRUE                      TRUE 
              get_video_codec          have_ffmpeg_exec           set_audio_codec 
                         TRUE                      TRUE                      TRUE 
              set_video_codec        video_codec_encode 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-14 07:23:38 UTC |
...
running this report
    ...
    PROCESSX_PS1c0978eb7a84_1739517816
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0GunLP
