# Validation Report - BayesFluxR@0.1.3
...
| export_help | 41 |
| has_website | FALSE |
| has_maintainer | Enrico Wegner <e.wegner@student.maastrichtuniversity.nl> |
...
Overall the package has 41 exported objects. 41 are documented:
                        ...
                        .set_seed             bayes_by_backprop 
                             TRUE                          TRUE 
                 BayesFluxR_setup                           BNN 
                             TRUE                          TRUE 
                    BNN.totparams                         Chain 
                             TRUE                          TRUE 
                            Dense                     find_mode 
                             TRUE                          TRUE 
                            Gamma            initialise.allsame 
                             TRUE                          TRUE 
                     InverseGamma likelihood.feedforward_normal 
                             TRUE                          TRUE 
     likelihood.feedforward_tdist    likelihood.seqtoone_normal 
                             TRUE                          TRUE 
        likelihood.seqtoone_tdist                          LSTM 
                             TRUE                          TRUE 
                 madapter.DiagCov      madapter.FixedMassMatrix 
                             TRUE                          TRUE 
                 madapter.FullCov              madapter.RMSProp 
                             TRUE                          TRUE 
                             mcmc                        Normal 
                             TRUE                          TRUE 
                         opt.ADAM                   opt.Descent 
                             TRUE                          TRUE 
                      opt.RMSProp          posterior_predictive 
                             TRUE                          TRUE 
                 prior_predictive                prior.gaussian 
                             TRUE                          TRUE 
               prior.mixturescale                           RNN 
                             TRUE                          TRUE 
                   sadapter.Const          sadapter.DualAverage 
                             TRUE                          TRUE 
               sampler.AdaptiveMH                  sampler.GGMC 
                             TRUE                          TRUE 
                      sampler.HMC                  sampler.SGLD 
                             TRUE                          TRUE 
                   sampler.SGNHTS              tensor_embed_mat 
                             TRUE                          TRUE 
                     to_bayesplot                     Truncated 
                             TRUE                          TRUE 
                   vi.get_samples 
                             TRUE 
...
| Execution Time | 2025-02-15 03:34:38 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5a35d266_1739590473
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpBGHRMi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesFluxR_v0.1.3-tikzDictionary"
