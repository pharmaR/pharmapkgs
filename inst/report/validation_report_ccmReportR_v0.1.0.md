# Validation Report - ccmReportR@0.1.0
...
| export_help          | 7                                              |
| has_website          | TRUE                                           |
| has_maintainer       | James Lane <lanejames35@gmail.com>             |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/DurhamRegionHARP/ccmReportR |
...
| 2   | httr (\>= 1.4.2)      | Imports |
| 3   | jsonlite (\>= 1.7.1)  | Imports |
| 4   | keyring (\>= 1.1.0)   | Imports |
| 5   | lubridate (\>= 1.7.9) | Imports |
| 6   | purrr (\>= 0.3.4)     | Imports |
| 7   | tibble (\>= 3.0.5)    | Imports |
| 8   | rlang                 | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
        ...
        getCaseAttribute             getCases getExposureAttribute 
                    TRUE                 TRUE                 TRUE 
            getExposures getOutbreakAttribute         getOutbreaks 
                    TRUE                 TRUE                 TRUE 
                   login 
                    TRUE 
...
| Execution Time | 2025-02-16 03:54:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bc375d4a654_1739678055
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLHvRRC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ccmReportR_v0.1.0-tikzDictionary"
