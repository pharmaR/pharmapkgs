# Validation Report - bayeslm@1.0.1
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Jingyu He <jingyuhe@cityu.edu.hk>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/JingyuHe/bayeslm                  |
...
Overall the package has 5 exported objects. 5 are documented:
                ...
                bayeslm            hs_gibbs           plot.MCMC summary.bayeslm.fit 
                   TRUE                TRUE                TRUE                TRUE 
           summary.MCMC 
                   TRUE 
...
| Execution Time | 2025-02-15 03:37:17 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd304d0e8f_1739590632
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFYGAFO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayeslm_v1.0.1-tikzDictionary"
