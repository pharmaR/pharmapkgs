# Validation Report - bruceR@2024.6
...
| export_help          | 71                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Han-Wu-Shuang Bao <baohws@foxmail.com> |
...
| 11  | afex         | Imports |
| 12  | emmeans      | Imports |
| 13  | effectsize   | Imports |
| 14  | performance  | Imports |
| 15  | mediation    | Imports |
| 16  | interactions | Imports |
| 17  | lavaan       | Imports |
| 18  | jtools       | Imports |
| 19  | texreg       | Imports |
| 20  | lmerTest     | Imports |
...
ChineseNames, FMAT, PsychWordVec, TestAnaAPP

## Namespace

Overall the package has 71 exported objects. 65 are documented:
                 ...
                 ccf_plot                   CFA                CONSEC 
                     TRUE                  TRUE                  TRUE 
                 cor_diff        cor_multilevel                  Corr 
                     TRUE                  TRUE                  TRUE 
                    COUNT              Describe                 dtime 
                     TRUE                  TRUE                  TRUE 
                      EFA               EMMEANS                export 
                     TRUE                  TRUE                  TRUE 
                  formatF               formatN        formula_expand 
                     TRUE                  TRUE                  TRUE 
            formula_paste                  Freq           GLM_summary 
                     TRUE                  TRUE                  TRUE 
                     Glue     grand_mean_center     granger_causality 
                     TRUE                  TRUE                  TRUE 
             granger_test     group_mean_center           HLM_ICC_rWG 
                     TRUE                  TRUE                  TRUE 
              HLM_summary                import        lavaan_summary 
                     TRUE                  TRUE                  TRUE 
                   LOOKUP                MANOVA                  MEAN 
                     TRUE                  TRUE                  TRUE 
              med_summary                  MODE         model_summary 
                     TRUE                  TRUE                  TRUE 
                        p                p.chi2                   p.f 
                     TRUE                  TRUE                  TRUE 
                      p.r                   p.t                   p.z 
                     TRUE                  TRUE                  TRUE 
                      PCA            pkg_depend pkg_install_suggested 
                     TRUE                  TRUE                  TRUE 
                    Print           print_table               PROCESS 
                     TRUE                  TRUE                  TRUE 
                   RECODE               regress              rep_char 
                     TRUE                  TRUE                  TRUE 
                  RESCALE                   RGB                   Run 
                     TRUE                  TRUE                  TRUE 
                   scaler                set_wd                set.wd 
                     TRUE                  TRUE                  TRUE 
              show_colors                   STD                   SUM 
                     TRUE                  TRUE                  TRUE 
              theme_bruce                 TTEST 
...
| Execution Time | 2025-02-15 04:47:08 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd396b1abe_1739594823
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6M4HeC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bruceR_v2024.6-tikzDictionary"
