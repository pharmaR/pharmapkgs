...
Overall the package has 36 exported objects. 36 are documented:
        ...
        av_audio_convert  av_capture_graphics          av_decoders 
                    TRUE                 TRUE                 TRUE 
                 av_demo          av_demuxers      av_encode_video 
                    TRUE                 TRUE                 TRUE 
             av_encoders           av_filters         av_log_level 
                    TRUE                 TRUE                 TRUE 
           av_media_info            av_muxers av_spectrogram_video 
                    TRUE                 TRUE                 TRUE 
        av_video_convert      av_video_images        av_video_info 
                    TRUE                 TRUE                 TRUE 
                bartlett                bhann              bharris 
                    TRUE                 TRUE                 TRUE 
                blackman             bnuttall               bohman 
                    TRUE                 TRUE                 TRUE 
                  cauchy                dolph              flattop 
                    TRUE                 TRUE                 TRUE 
                   gauss              hamming              hanning 
                    TRUE                 TRUE                 TRUE 
                 lanczos              nuttall               parzen 
                    TRUE                 TRUE                 TRUE 
          read_audio_bin       read_audio_fft                 sine 
                    TRUE                 TRUE                 TRUE 
                   tukey                welch      write_audio_bin 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-14 07:35:28 UTC |
...
running this report
    ...
    PROCESSX_PS1c091b753054_1739518525
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpovZ5nV
