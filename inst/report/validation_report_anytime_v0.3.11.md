...
| bugs_status          | 1                                       |
| size_codebase        | 245                                     |
| has_source_control   | https://github.com/eddelbuettel/anytime |
| has_bug_reports_url  | 1                                       |
| downloads_1yr        | 1082280                                 |
...
|     | package           | type      |
|:----|:------------------|:----------|
| 1   | Rcpp (\>= 0.12.9) | Imports   |
| 2   | Rcpp (\>= 0.12.9) | LinkingTo |
| 3   | BH                | LinkingTo |
...
Overall the package has 13 exported objects. 13 are documented:
       ...
       addFormats       anydate       anytime    assertDate    assertTime 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       getFormats       iso8601 removeFormats       rfc2822       rfc3339 
             TRUE          TRUE          TRUE          TRUE          TRUE 
          utcdate       utctime      yyyymmdd 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-14 06:57:41 UTC |
...
running this report
    ...
    PROCESSX_PS726db363b20_1739516258
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJKuW6d
