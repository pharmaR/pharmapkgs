...
| export_help          | 25                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Andreas Schulz <ades-s@web.de>                       |
...
Overall the package has 25 exported objects. 23 are documented:

            bar.plot.ade         bar.plot.wtd            bar3d.ade 
                    TRUE                 TRUE                FALSE 
        bland.altman.ade         box.plot.ade         box.plot.wtd 
                    TRUE                 TRUE                 TRUE 
         correlogram.ade           curves.ade         format_n.ade 
                    TRUE                 TRUE                 TRUE 
            format_p.ade        histogram.ade          KM.plot.ade 
                    TRUE                 TRUE                 TRUE 
            kurtosis.ade       missiogram.ade         parallel.ade 
                    TRUE                 TRUE                 TRUE 
        parallel.set.ade performance.plot.ade               qq.ade 
                    TRUE                 TRUE                 TRUE 
          ratio.plot.ade         roc.plot.ade          round_n.ade 
                    TRUE                 TRUE                 TRUE 
             scatter.ade         skewness.ade          tornado.ade 
                    TRUE                 TRUE                FALSE 
                wall.ade 
                    TRUE 
...
| Execution Time | 2025-02-19 04:13:36 UTC |
...
running this report
    ...
    PROCESSX_PS1d454e5a66de_1739938410
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpm4YlQa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epade_v0.5.1-tikzDictionary"
