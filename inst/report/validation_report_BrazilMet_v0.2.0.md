# Validation Report - BrazilMet@0.2.0
...
| export_help          | 22                                            |
| has_website          | FALSE                                         |
| has_maintainer       | Roberto Filgueiras <betofilgueiras@gmail.com> |
...
Overall the package has 22 exported objects. 22 are documented:
             ...
             daily_eto_FAO56 download_AWS_INMET_daily       ea_dew_calculation 
                        TRUE                     TRUE                     TRUE 
           ea_rh_calculation           es_calculation        es_ea_calculation 
                        TRUE                     TRUE                     TRUE 
                      eto_hs                     Patm                psy_const 
                        TRUE                     TRUE                     TRUE 
              ra_calculation     radiation_conversion           rh_calculation 
                        TRUE                     TRUE                     TRUE 
              rn_calculation          rnl_calculation          rns_calculation 
                        TRUE                     TRUE                     TRUE 
       rs_nearby_calculation        rso_calculation_1        rso_calculation_2 
                        TRUE                     TRUE                     TRUE 
           see_stations_info       sr_ang_calculation      sr_tair_calculation 
                        TRUE                     TRUE                     TRUE 
              u2_calculation 
                        TRUE 
...
| Execution Time | 2025-02-15 04:41:54 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd500e6f61_1739594509
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphA06aN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BrazilMet_v0.2.0-tikzDictionary"
