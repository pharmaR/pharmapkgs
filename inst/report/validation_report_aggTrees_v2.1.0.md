...
| export_help | 13 |
| has_website | TRUE |
| has_maintainer | Riccardo Di Francesco <difrancesco.riccardo96@gmail.com> |
...
Overall the package has 13 exported objects. 13 are documented:
    ...
    avg_characteristics_rpart          balance_measures             build_aggtree 
                         TRUE                      TRUE                      TRUE 
             causal_ols_rpart                 dr_scores            estimate_rpart 
                         TRUE                      TRUE                      TRUE 
                    expand_df                get_leaves         inference_aggtree 
                         TRUE                      TRUE                      TRUE 
              leaf_membership           node_membership              sample_split 
                         TRUE                      TRUE                      TRUE 
                      subtree 
                         TRUE 
...
| Execution Time | 2025-02-14 06:42:38 UTC |
...
running this report
    ...
    PROCESSX_PS726d736c6f82_1739515355
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpzd9sWR
