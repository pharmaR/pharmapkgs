# Validation Report - detourr@0.1.0
...
| export_help          | 20                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Casper Hart <casperhart93@gmail.com> |
...
Overall the package has 20 exported objects. 20 are documented:
                ...
                dependence_tour                      detour 
                           TRUE                        TRUE 
         displayScatter2dOutput      displayScatter3dOutput 
                           TRUE                        TRUE 
             frozen_guided_tour                 frozen_tour 
                           TRUE                        TRUE 
                     grand_tour         guided_section_tour 
                           TRUE                        TRUE 
                    guided_tour                   is_detour 
                           TRUE                        TRUE 
                    little_tour                  local_tour 
                           TRUE                        TRUE 
                   planned_tour shinyRenderDisplayScatter2d 
                           TRUE                        TRUE 
    shinyRenderDisplayScatter3d                   show_sage 
                           TRUE                        TRUE 
                   show_scatter                  show_slice 
                           TRUE                        TRUE 
                       tour_aes                   tour_path 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-18 03:50:35 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4342c765f_1739850629
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb3juc0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_detourr_v0.1.0-tikzDictionary"
