# Validation Report - ECOSolveR@0.5.5
...
CVXR, highOrderPortfolios, optiSel, ROI.plugin.ecos, scpi, WpProj

## Namespace

Overall the package has 2 exported objects. 2 are documented:

     ECOS_csolve ecos.control 
            TRUE         TRUE 
...
| Execution Time | 2025-02-19 03:36:51 UTC |
...
running this report
    ...
    PROCESSX_PS1d457265c22f_1739936205
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpxp03BT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ECOSolveR_v0.5.5-tikzDictionary"
