# Validation Report - breakfast@2.5
...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yining Chen <y.chen101@lse.ac.uk>                    |
...
Overall the package has 17 exported objects. 17 are documented:
               ...
               breakfast       model.fixednum            model.gsa 
                    TRUE                 TRUE                 TRUE 
                model.ic             model.lp           model.sdll 
                    TRUE                 TRUE                 TRUE 
            model.thresh  plot.breakfast.cpts print.breakfast.cpts 
                    TRUE                 TRUE                 TRUE 
          print.cptmodel          sol.idetect      sol.idetect_seq 
                    TRUE                 TRUE                 TRUE 
                 sol.not             sol.tguh              sol.wbs 
                    TRUE                 TRUE                 TRUE 
                sol.wbs2              sol.wcm 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:42:51 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6d267e7e_1739594566
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOK3YhD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_breakfast_v2.5-tikzDictionary"
