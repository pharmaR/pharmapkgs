# Validation Report - correctedAUC@0.0.3
...
| export_help          | 5                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Weiliang Qiu <stwxq@channing.harvard.edu>            |
...
Overall the package has 5 exported objects. 5 are documented:
         ...
         AUCest.Reiser      AUCest.Rosner  genSimDataModelII genSimDataModelIII 
                  TRUE               TRUE               TRUE               TRUE 
      genSimDataReiser 
                  TRUE 
...
| Execution Time | 2025-02-17 03:59:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bd620c55ab2_1739764784
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUWFofq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_correctedAUC_v0.0.3-tikzDictionary"
