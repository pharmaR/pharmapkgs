# Validation Report - EcoDiet@2.0.1
...
| export_help | 7 |
| has_website | TRUE |
| has_maintainer | Pierre-Yves Hernvann <pierre.yves.hernvann@gmail.com> |
| bugs_status | 0.6666667 |
| has_source_control | https://github.com/pyhernvann/EcoDiet |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | ggplot2 (\>= 3.2)  | Imports |
| 2   | coda (\>= 0.19)    | Imports |
| 3   | stats (\>= 3.6)    | Imports |
| 4   | utils (\>= 3.6)    | Imports |
| 5   | jagsUI (\>= 1.5.2) | Imports |
| 6   | ggmcmc (\>= 1.1)   | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
     ...
     diagnose_model       plot_data      plot_prior    plot_results preprocess_data 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          run_model     write_model 
               TRUE            TRUE 

### Examples

There are 8 help pages with examples, from 14 (57.14 %).
...
| Execution Time | 2025-02-19 03:34:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d455ee0e99c_1739936039
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVuoWqe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EcoDiet_v2.0.1-tikzDictionary"
