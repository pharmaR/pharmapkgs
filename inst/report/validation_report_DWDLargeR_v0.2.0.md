# Validation Report - DWDLargeR@0.2.0
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Xin-Yee Lam <matlxy@nus.edu.sg>                      |
...
Overall the package has 10 exported objects. 10 are documented:
               ...
               fnorm           genDWD       linsysolve penaltyParameter 
                TRUE             TRUE             TRUE             TRUE 
     polyRootsNewton       precondfun            psqmr     sigma_update 
                TRUE             TRUE             TRUE             TRUE 
                 smw      vecMultiply 
                TRUE             TRUE 
...
| Execution Time | 2025-02-25 03:24:00 UTC |
...
running this report
    ...
    PROCESSX_PS1d283dda726e_1740453836
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0M2Miu
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DWDLargeR_v0.2.0-tikzDictionary"
