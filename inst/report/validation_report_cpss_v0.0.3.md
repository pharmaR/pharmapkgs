...
| export_help          | 60                                  |
| has_website          | TRUE                                |
| has_maintainer       | Guanghui Wang <ghwang.nk@gmail.com> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/ghwang-nk/cpss   |
...
Overall the package has 32 exported objects. 55 are documented:

                 %>%             algo   algo_param_dim algo_param_dim<- 
               FALSE             TRUE             TRUE             TRUE 
              algo<-              cps            cps<-      cpss.custom 
                TRUE             TRUE             TRUE             TRUE 
             cpss.em         cpss.glm          cpss.lm        cpss.mean 
                TRUE             TRUE             TRUE             TRUE 
        cpss.meanvar         cpss.var              dat            dat<- 
                TRUE             TRUE             TRUE             TRUE 
                 mdl            mdl<-             ncps           ncps<- 
                TRUE             TRUE             TRUE             TRUE 
              params         params<-         pelt_pen       pelt_pen<- 
                TRUE             TRUE             TRUE             TRUE 
              S_vals         S_vals<-               SC          SC_vals 
                TRUE             TRUE             TRUE             TRUE 
           SC_vals<-             SC<-    update_inputs  update_inputs<- 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:16:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd647930a36_1739765756
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZrTTXU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cpss_v0.0.3-tikzDictionary"
