...
| export_help          | 41                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Zhiyong Zhang <zhiyongzhang@nd.edu>                  |
...
Overall the package has 41 exported objects. 41 are documented:
              ...
              bmem        bmem.bs     bmem.ci.bc    bmem.ci.bc1    bmem.ci.bca 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      bmem.ci.bca1   bmem.ci.norm      bmem.ci.p       bmem.cov        bmem.em 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      bmem.em.boot    bmem.em.cov   bmem.em.jack   bmem.em.rcov      bmem.list 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    bmem.list.boot  bmem.list.cov bmem.list.jack        bmem.mi   bmem.mi.boot 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       bmem.mi.cov   bmem.mi.jack   bmem.moments      bmem.pair bmem.pair.boot 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     bmem.pair.cov bmem.pair.jack   bmem.pattern      bmem.plot   bmem.raw2cov 
              TRUE           TRUE           TRUE           TRUE           TRUE 
          bmem.sem     bmem.sobel bmem.sobel.ind       bmem.ssq         bmem.v 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         plot.bmem         popPar    power.basic     power.boot    power.curve 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      summary.bmem 
              TRUE 
...
| Execution Time | 2025-02-15 04:26:20 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd37838dfd_1739593575
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDwtjwx
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bmem_v2.1-tikzDictionary"
