...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Wilson Lara <wilarhen@gmail.com>                     |
...
Overall the package has 22 exported objects. 22 are documented:
                  ...
                  amod   anova.modelFrame         arguSelect             cClass 
                  TRUE               TRUE               TRUE               TRUE 
            frametoLme             levexp            lmeForm         modelFrame 
                  TRUE               TRUE               TRUE               TRUE 
                moveYr            muleMan             mUnits    plot.modelFrame 
                  TRUE               TRUE               TRUE               TRUE 
          plot.muleMan          plot.wlai          ringApply             rtimes 
                  TRUE               TRUE               TRUE               TRUE 
                scacum         shiftFrame          slitFrame summary.modelFrame 
                  TRUE               TRUE               TRUE               TRUE 
                tdForm               wlai 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-15 04:12:20 UTC |
...
running this report
    ...
    PROCESSX_PS1ccda4537c_1739592735
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2AqS02
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BIOdry_v0.9-tikzDictionary"
