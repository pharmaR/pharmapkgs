# Validation Report - fastText@1.0.4
...
| has_source_control   | https://github.com/mlampros/fastText             |
...
Overall the package has 15 exported objects. 15 are documented:
                ...
                fasttext_interface        language_identification 
                              TRUE                           TRUE 
                plot_progress_logs               print_parameters 
                              TRUE                           TRUE 
               printAnalogiesUsage                 printDumpUsage 
                              TRUE                           TRUE 
                      printNNUsage              printPredictUsage 
                              TRUE                           TRUE 
             printPrintNgramsUsage printPrintSentenceVectorsUsage 
                              TRUE                           TRUE 
        printPrintWordVectorsUsage             printQuantizeUsage 
                              TRUE                           TRUE 
               printTestLabelUsage                 printTestUsage 
                              TRUE                           TRUE 
                        printUsage 
                              TRUE 
...
| Execution Time | 2025-02-19 05:22:19 UTC |
...
running this report
    ...
    PROCESSX_PS1d452c74b0a7_1739942533
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpb4AkrA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastText_v1.0.4-tikzDictionary"
