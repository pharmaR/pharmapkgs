...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Eric Archer <eric.archer@noaa.gov>                   |
...
| 4   | gridExtra (\>= 2.3)    | Imports |
| 5   | methods                | Imports |
| 6   | parallel               | Imports |
| 7   | randomForest (\>= 4.6) | Imports |
| 8   | rfPermute (\>= 2.5.1)  | Imports |
| 9   | rlang                  | Imports |
| 10  | stats                  | Imports |
| 11  | swfscMisc (\>= 1.5)    | Imports |
| 12  | tibble (\>= 3.1.2)     | Imports |
| 13  | tidyr (\>= 1.1.1)      | Imports |
...
Overall the package has 15 exported objects. 17 are documented:

       addBanterDetector          banterGuide       getBanterModel 
                    TRUE                 TRUE                 TRUE 
      getBanterModelData     getDetectorNames          getSampSize 
                    TRUE                 TRUE                 TRUE 
         initBanterModel      modelPctCorrect             numCalls 
                    TRUE                 TRUE                 TRUE 
               numEvents    plotDetectorTrace            propCalls 
                    TRUE                 TRUE                 TRUE 
    removeBanterDetector       runBanterModel  subsampleDetections 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-14 07:42:19 UTC |
...
running this report
    ...
    PROCESSX_PS1c09dc202b8_1739518936
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHgUhf4
