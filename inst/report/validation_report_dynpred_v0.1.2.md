# Validation Report - dynpred@0.1.2
...
| export_help          | 15                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Hein Putter <H.Putter@lumc.nl>                       |
...
Overall the package has 15 exported objects. 15 are documented:
              ...
              AUC          AUCw        cindex         cutLM      CVcindex 
             TRUE          TRUE          TRUE          TRUE          TRUE 
             CVPL           deb      evalstep       Fwindow            pe 
             TRUE          TRUE          TRUE          TRUE          TRUE 
            pecox           pew        pewcox   scatterplot toleranceplot 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 05:06:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4298a4008_1739855191
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyAArsF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dynpred_v0.1.2-tikzDictionary"
