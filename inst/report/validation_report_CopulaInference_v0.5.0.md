# Validation Report - CopulaInference@0.5.0
...
| export_help          | 27                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Bouchra R. Nasri <bouchra.nasri@umontreal.ca>        |
...
Overall the package has 27 exported objects. 27 are documented:
             ...
             AuxFun         AuxFunC        BiEmpCdf    bootstrapfun          CdfInv 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               dncs           dplac          EmpCdf          EmpCdf     est_options 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           EstBiCop          EstDep            Finv         fnumber        GofBiCop 
               TRUE            TRUE            TRUE            TRUE            TRUE 
               hncs           hplac identifiability            pncs           pplac 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        preparedata     rhoplackett            rncs           rplac         statcvm 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             taucop     tauplackett 
               TRUE            TRUE 
...
| Execution Time | 2025-02-17 03:55:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62d7b5c0_1739764518
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoORlaN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CopulaInference_v0.5.0-tikzDictionary"
