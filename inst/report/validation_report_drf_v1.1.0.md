...
| export_help          | 6                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Loris Michel <michel@stat.math.ethz.ch> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/lorismichel/drf      |
...
| 3   | stats              | Imports   |
| 4   | fastDummies        | Imports   |
| 5   | Matrix             | Imports   |
| 6   | methods            | Imports   |
| 7   | Rcpp (\>= 0.12.15) | Imports   |
| 8   | transport          | Imports   |
...
Overall the package has 6 exported objects. 6 are documented:
                    ...
                    drf  get_sample_weights            get_tree   split_frequencies 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 04:45:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46564b52c_1739853925
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6LqKd9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_drf_v1.1.0-tikzDictionary"
