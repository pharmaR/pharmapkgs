...
| export_help          | 10                                  |
| has_website          | TRUE                                |
| has_maintainer       | Luis Garcia <lpfgarcia@icmc.usp.br> |
| bugs_status          | 0.9333333                           |
| has_source_control   | https://github.com/lpfgarcia/ECoL/  |
...
Overall the package has 10 exported objects. 10 are documented:
           ...
           balance     complexity    correlation dimensionality      linearity 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      neighborhood        network    overlapping     smoothness  summarization 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 03:34:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d4523cf48ab_1739936073
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2wKjI7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ECoL_v0.3.0-tikzDictionary"
