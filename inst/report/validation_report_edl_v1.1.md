...
| export_help          | 31                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jacolien van Rij <j.c.van.rij@rug.nl>                |
...
Overall the package has 31 exported objects. 31 are documented:
                    ...
                    activationsCueSet                 activationsEvents 
                                 TRUE                              TRUE 
                    activationsMatrix               activationsOutcomes 
                                 TRUE                              TRUE 
                                check                           checkWM 
                                 TRUE                              TRUE 
                   createTrainingData                          createWM 
                                 TRUE                              TRUE 
                            cueWindow                    getActivations 
                                 TRUE                              TRUE 
                              getCues                         getLambda 
                                 TRUE                              TRUE 
                          getOutcomes                         getUpdate 
                                 TRUE                              TRUE 
                            getValues                   getWeightsByCue 
                                 TRUE                              TRUE 
                  getWeightsByOutcome                             getWM 
                                 TRUE                              TRUE 
                           luceChoice                   plotActivations 
                                 TRUE                              TRUE 
                       plotCueWeights                       plotNetwork 
                                 TRUE                              TRUE 
                   plotOutcomeWeights                        RWlearning 
                                 TRUE                              TRUE 
                     RWlearningMatrix        RWlearningNoCueCompetition 
                                 TRUE                              TRUE 
       RWlearningNoOutcomeCompetition                     setBackground 
                                 TRUE                              TRUE 
                        updateWeights     updateWeightsNoCueCompetition 
                                 TRUE                              TRUE 
...
| Execution Time | 2025-02-19 03:42:27 UTC |
...
running this report
    ...
    PROCESSX_PS1d453ca7dab0_1739936541
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZsbWSj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_edl_v1.1-tikzDictionary"
