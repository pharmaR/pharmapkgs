...
| export_help          | 8                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Rachael Shudde <rachael.shudde@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/rshudde/BFF            |
...
Overall the package has 8 exported objects. 8 are documented:
          ...
          chi2_test_BFF               dnlnm          f_test_BFF              is.BFF 
                   TRUE                TRUE                TRUE                TRUE 
         posterior_plot regression_test_BFF          t_test_BFF          z_test_BFF 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 03:57:24 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd24989037_1739591839
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpoxrf51
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BFF_v4.2.1-tikzDictionary"
