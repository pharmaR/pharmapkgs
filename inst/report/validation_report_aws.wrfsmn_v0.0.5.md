...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Gonzalo Diaz <gonzalomartindiaz22@gmail.com>         |
...
Overall the package has 10 exported objects. 10 are documented:
     ...
     daily.data.fields      daily2monthly find.nearest.point      get.wrf.files 
                  TRUE               TRUE               TRUE               TRUE 
                   ith   load.by.variable      mg.evaluation  multiple.guidance 
                  TRUE               TRUE               TRUE               TRUE 
               ploting       wrf.download 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-14 07:37:12 UTC |
...
running this report
    ...
    PROCESSX_PS1c094e457beb_1739518629
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHIeEgl
