...
| 7   | expm              | Imports   |
| 8   | SparseM           | Imports   |
| 9   | Rcpp (\>= 1.0.10) | Imports   |
| 10  | Rcpp (\>= 1.0.10) | LinkingTo |
| 11  | RcppEigen         | LinkingTo |
| 12  | BH (\>= 1.81.0-1) | LinkingTo |
...
DAISIE, DAMOCLES, nLTT, nodeSub, PBD, SADISA, secsse, treestats

## Namespace

Overall the package has 28 exported objects. 28 are documented:

                bd_loglik                 bd_ML            brts2phylo 
                     TRUE                  TRUE                  TRUE 
                     conv          dd_KI_loglik              dd_KI_ML 
                     TRUE                  TRUE                  TRUE 
                dd_KI_sim             dd_loglik                 dd_LR 
                     TRUE                  TRUE                  TRUE 
                    dd_ML          dd_MS_loglik              dd_MS_ML 
                     TRUE                  TRUE                  TRUE 
                dd_MS_sim                dd_sim          dd_SR_loglik 
                     TRUE                  TRUE                  TRUE 
                 dd_SR_ML             dd_SR_sim                L2brts 
                     TRUE                  TRUE                  TRUE 
                  L2phylo             optimizer               phylo2L 
                     TRUE                  TRUE                  TRUE 
    rng_respecting_sample                roundn               sample2 
                     TRUE                  TRUE                  TRUE 
                  simplex                td_sim        transform_pars 
                     TRUE                  TRUE                  TRUE 
         untransform_pars 
                     TRUE 
...
| Execution Time | 2025-02-18 03:28:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bb435785d64_1739849304
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp22H206
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DDD_v5.2.2-tikzDictionary"
