# Validation Report - DirichletReg@0.7.1
...
| export_help | 29 |
| has_website | TRUE |
| has_maintainer | Marco Johannes Maier <marco_maier@posteo.de> |
| bugs_status | package DESCRIPTION does not have a BugReports field |
| has_source_control | https://github.com/maiermarco/DirichletReg |
...
BayesSpace, iCAMP, mispitools, NST, telescope, UBayFS, WeightedCluster

## Namespace

Overall the package has 29 exported objects. 29 are documented:

          AIC.DirichletRegModel     anova.DirichletRegModel 
                           TRUE                        TRUE 
          BIC.DirichletRegModel   confint.DirichletRegModel 
                           TRUE                        TRUE 
                     ddirichlet                ddirichlet_R 
                           TRUE                        TRUE 
                      DirichReg                     DR_data 
                           TRUE                        TRUE 
        drop1.DirichletRegModel    fitted.DirichletRegModel 
                           TRUE                        TRUE 
       logLik.DirichletRegModel      nobs.DirichletRegModel 
                           TRUE                        TRUE 
          plot.DirichletRegData   predict.DirichletRegModel 
                           TRUE                        TRUE 
      print.DirichletRegConfint      print.DirichletRegData 
                           TRUE                        TRUE 
        print.DirichletRegModel                  rdirichlet 
                           TRUE                        TRUE 
    residuals.DirichletRegModel    summary.DirichletRegData 
                           TRUE                        TRUE 
      summary.DirichletRegModel                toQuaternary 
                           TRUE                        TRUE 
            toQuaternaryVectors                   toSimplex 
                           TRUE                        TRUE 
                      toTernary            toTernaryVectors 
                           TRUE                        TRUE 
       update.DirichletRegModel      vcov.DirichletRegModel 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-18 04:10:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45ff72e83_1739851799
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7sjIrZ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DirichletReg_v0.7.1-tikzDictionary"
