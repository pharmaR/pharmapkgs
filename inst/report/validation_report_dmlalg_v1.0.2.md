# Validation Report - dmlalg@1.0.2
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Corinne Emmenegger <emmenegger@stat.math.ethz.ch>    |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    example_data_mmdml              fixef              mmdml              ranef 
                  TRUE               TRUE               TRUE               TRUE 
               regsdml            VarCorr               vcov 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-18 04:27:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46c8e758b_1739852834
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7kJsJJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dmlalg_v1.0.2-tikzDictionary"
