# Validation Report - dccmidas@0.1.2
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Vincenzo Candila <vcandila@unisa.it>                 |
...
| 3   | maxLik (\>= 1.3-8)  | Imports   |
| 4   | rumidas (\>= 0.1.1) | Imports   |
| 5   | rugarch (\>= 1.4-4) | Imports   |
| 6   | roll (\>= 1.1.4)    | Imports   |
| 7   | xts (\>= 0.12.0)    | Imports   |
| 8   | Rdpack (\>= 1.0.0)  | Imports   |
| 9   | zoo (\>= 1.8.8)     | Imports   |
| 10  | stats (\>= 4.0.2)   | Imports   |
| 11  | utils (\>= 4.0.2)   | Imports   |
...
Overall the package has 10 exported objects. 10 are documented:
            ...
            cov_eval          dcc_fit       dcc_loglik      dcc_mat_est 
                TRUE             TRUE             TRUE             TRUE 
     dccmidas_loglik dccmidas_mat_est      deco_loglik     deco_mat_est 
                TRUE             TRUE             TRUE             TRUE 
      print.dccmidas summary.dccmidas 
                TRUE             TRUE 
...
| Execution Time | 2025-02-17 05:09:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61833e3dc_1739768951
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6Te8xq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dccmidas_v0.1.2-tikzDictionary"
