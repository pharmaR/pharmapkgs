# Validation Report - cubing@1.0.5
...
Overall the package has 37 exported objects. 34 are documented:

                %c%             %e%             %v%         animate    as.cubieCube 
              FALSE           FALSE           FALSE            TRUE            TRUE 
     as.stickerCube       cubieCube    cycleCorners      cycleEdges       flipEdges 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       getCubieCube    getMovesCube getMovesPattern  getStickerCube         invCube 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           invMoves    is.cubieCube     is.solvable       is.solved  is.stickerCube 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           mirMoves            move       moveOrder          parity          plot3D 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           randCube       randMoves  read.cubesolve          rotate       rotations 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           rotMoves        scramble           slice          solver     stickerCube 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       twistCorners            wide 
               TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:38:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd663e9f394_1739767076
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpap8cBy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cubing_v1.0.5-tikzDictionary"
