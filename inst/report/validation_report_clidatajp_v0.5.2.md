# Validation Report - clidatajp@0.5.2
...
| has_source_control | https://github.com/matutosi/clidatajp |
| https://github.com/matutosi/clidatajp/tree/develop (devel) |  |
...
Overall the package has 12 exported objects. 11 are documented:
               ...
               choose_with_menu                          ci 
                           TRUE                        TRUE 
                  clean_station         download_area_links 
                           TRUE                        TRUE 
               download_climate              download_links 
                           TRUE                        TRUE 
                gracefully_fail                      head_3 
                           TRUE                        TRUE 
                          sleep                          wi 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-16 04:30:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37b6f40cb_1739680215
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplGqRJF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clidatajp_v0.5.2-tikzDictionary"
