...
| export_help          | 15                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Sevvandi Kandanaarachchi <sevvandik@gmail.com>       |
...
Overall the package has 15 exported objects. 15 are documented:
          ...
          algo_effectiveness_crm      algo_effectiveness_poly 
                            TRUE                         TRUE 
                        autoplot                    cirtmodel 
                            TRUE                         TRUE 
               effectiveness_crm           effectiveness_poly 
                            TRUE                         TRUE 
                    heatmaps_crm        latent_trait_analysis 
                            TRUE                         TRUE 
               make_polyIRT_data           model_goodness_crm 
                            TRUE                         TRUE 
     model_goodness_for_algo_crm model_goodness_for_algo_poly 
                            TRUE                         TRUE 
             model_goodness_poly                    pirtmodel 
                            TRUE                         TRUE 
                 tracelines_poly 
                            TRUE 
...
| Execution Time | 2025-02-14 06:46:26 UTC |
...
running this report
    ...
    PROCESSX_PS726d2607893f_1739515583
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoC4Pm2
