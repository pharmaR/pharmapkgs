# Validation Report - dextergui@0.2.6
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | dexter (\>= 1.2.1)     | Depends |
| 2   | shiny (\>= 1.3.0)      | Imports |
| 3   | shinyBS (\>= 0.6)      | Imports |
| 4   | DT (\>= 0.9)           | Imports |
| 5   | htmltools (\>= 0.4.0)  | Imports |
| 6   | htmlwidgets (\>= 1.3)  | Imports |
| 7   | shinyjs (\>= 2.0)      | Imports |
| 8   | shinyFiles (\>= 0.9.2) | Imports |
| 9   | jsonlite (\>= 1.5)     | Imports |
| 10  | dplyr (\>= 1.0)        | Imports |
| 11  | tidyr (\>= 1.0)        | Imports |
| 12  | tibble (\>= 3.0)       | Imports |
| 13  | rlang (\>= 0.4.0)      | Imports |
| 14  | RCurl (\>= 1.95)       | Imports |
| 15  | DBI (\>= 1.0.0)        | Imports |
| 16  | readxl (\>= 1.1)       | Imports |
| 17  | writexl (\>= 1.0)      | Imports |
| 18  | readODS (\>= 1.6)      | Imports |
| 19  | ggplot2 (\>= 3.3.5)    | Imports |
| 20  | ggExtra (\>= 0.8)      | Imports |
| 21  | ggridges (\>= 0.5.1)   | Imports |
| 22  | networkD3 (\>= 0.4)    | Imports |
| 23  | Cairo                  | Imports |
| 24  | graphics               | Imports |
| 25  | grDevices              | Imports |
| 26  | methods                | Imports |
| 27  | utils                  | Imports |
| 28  | tools                  | Imports |
...
| Execution Time | 2025-02-18 03:52:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4659afcd2_1739850737
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5a4VWJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dextergui_v0.2.6-tikzDictionary"
