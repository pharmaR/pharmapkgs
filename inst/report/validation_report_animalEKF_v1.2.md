...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Samuel Ackerman <smackrmn@gmail.com>                 |
...
| 6   | mvtnorm    | Imports |
| 7   | deldir     | Imports |
| 8   | colorspace | Imports |
| 9   | Matrix     | Imports |
| 10  | MASS       | Imports |
| 11  | png        | Imports |
| 12  | grDevices  | Imports |
| 13  | bezier     | Imports |
| 14  | HDInterval | Imports |
| 15  | plyr       | Imports |
| 16  | stats      | Imports |
| 17  | methods    | Imports |
| 18  | utils      | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
                 ...
                 cdlm_robot     cdlm_robot_twostate  cdlm_robot_twostate_2D 
                       TRUE                    TRUE                    TRUE 
        EKF_1d_interp_joint        EKF_interp_joint interp_trajectory_joint 
                       TRUE                    TRUE                    TRUE 
             low_var_sample           make_segments         normalize_angle 
                       TRUE                    TRUE                    TRUE 
             rug_multicolor       shark_vis_longlat    sim_trajectory_joint 
                       TRUE                    TRUE                    TRUE 
              spline_interp               tess2spat 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-14 06:54:36 UTC |
...
running this report
    ...
    PROCESSX_PS726d37f9aaf6_1739516073
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5PIRAs
