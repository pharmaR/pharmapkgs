# Validation Report - BisRNA@0.2.2
...
| export_help          | 6                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Carine Legrand <c.legrand@dkfz.de>                   |
...
Overall the package has 6 exported objects. 6 are documented:
             ...
             class.BisXP        fisher.method           read.BisXP 
                    TRUE                 TRUE                 TRUE 
     RNAmeth.poisson.par RNAmeth.poisson.test      samples.combine 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:18:17 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd208e307c_1739593092
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcLF81l
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BisRNA_v0.2.2-tikzDictionary"
