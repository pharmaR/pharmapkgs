# Validation Report - CommEcol@1.8.1
...
| export_help          | 13                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Adriano Sanches Melo <asm.adrimelo@gmail.com>        |
...
Overall the package has 13 exported objects. 12 are documented:
            ...
            autosimi      betaRegDisp           compas         dis.chao 
                TRUE            FALSE             TRUE             TRUE 
         dis.goodall        dis.nness dis.nness.find.m      part.m.tree 
                TRUE             TRUE             TRUE             TRUE 
         part.p.tree    select.window      standExtent         treeNodf 
                TRUE             TRUE             TRUE             TRUE 
        treeNodfTest 
                TRUE 
...
| Execution Time | 2025-02-17 03:32:32 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6174a9920_1739763147
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpifVhAy
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CommEcol_v1.8.1-tikzDictionary"
