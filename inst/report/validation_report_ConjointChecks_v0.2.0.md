# Validation Report - ConjointChecks@0.2.0
...
| export_help          | 4                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Ben Domingue <ben.domingue@gmail.com>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/ben-domingue/ConjointChecks       |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    ConjointChecks    plot.checks  PrepareChecks summary.checks 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 03:45:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bd649d38dc9_1739763918
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpheSz3G
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ConjointChecks_v0.2.0-tikzDictionary"
