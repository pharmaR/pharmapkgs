# Validation Report - contentid@0.0.19
...
| has_source_control   | https://github.com/cboettig/contentid |
...
bdc, taxadb, taxalight

## Namespace

Overall the package has 19 exported objects. 19 are documented:

           content_dir         content_id       default_lmdb default_registries 
                  TRUE               TRUE               TRUE               TRUE 
          has_resource        history_swh        history_url                pin 
                  TRUE               TRUE               TRUE               TRUE 
           purge_cache              query           register            resolve 
                  TRUE               TRUE               TRUE               TRUE 
              retrieve       retrieve_swh            sources        sources_swh 
                  TRUE               TRUE               TRUE               TRUE 
                 store          store_swh      swh_ratelimit 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-17 03:49:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64ac678f6_1739764134
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPqFprU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_contentid_v0.0.19-tikzDictionary"
