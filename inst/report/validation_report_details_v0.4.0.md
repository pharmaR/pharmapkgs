# Validation Report - details@0.4.0
...
| has_source_control   | https://github.com/yonicd/details |
...
carbonate, codemetar, sinew, texPreview

## Namespace

Overall the package has 4 exported objects. 4 are documented:

        details     foldend   foldstart use_details 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-18 03:49:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4429f5bf9_1739850566
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKaf55X
...
These are the options set to generate the report:
    ...
    [1] "validation_report_details_v0.4.0-tikzDictionary"
