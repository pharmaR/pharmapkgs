# Validation Report - diffdf@1.1.1
...
| export_help          | 3                                             |
| has_website          | TRUE                                          |
| has_maintainer       | Craig Gower-Page <craig.gower-page@roche.com> |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/gowerc/diffdf/             |
...
admiral, admiraldev, admiralmetabolic, admiralonco, admiralophtha,
admiralvaccine, pharmaverseadam, random.cdisc.data

## Namespace

Overall the package has 3 exported objects. 3 are documented:

               diffdf diffdf_has_issues  diffdf_issuerows 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 04:03:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42303f025_1739851387
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRP36TE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diffdf_v1.1.1-tikzDictionary"
