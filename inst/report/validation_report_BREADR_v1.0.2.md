# Validation Report - BREADR@1.0.2
...
| export_help          | 13                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Jono Tuke <simon.tuke@adelaide.edu.au> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/jonotuke/BREADR     |
...
Overall the package has 13 exported objects. 12 are documented:
                      ...
                      %>%       callRelatedness        get_column_new 
                    FALSE                  TRUE                  TRUE 
                 plotLOAF             plotSLICE     processEigenstrat 
                     TRUE                  TRUE                  TRUE 
    processEigenstrat_old              read_ind              read_snp 
                     TRUE                  TRUE                  TRUE 
               saveSLICES              sim_geno            split_line 
                     TRUE                  TRUE                  TRUE 
              test_degree 
                     TRUE 
...
| Execution Time | 2025-02-15 04:42:34 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6ea722ed_1739594549
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpotVx6b
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BREADR_v1.0.2-tikzDictionary"
