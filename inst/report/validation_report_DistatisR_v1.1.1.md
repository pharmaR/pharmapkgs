# Validation Report - DistatisR@1.1.1
...
Overall the package has 36 exported objects. 36 are documented:
                   ...
                   BootFactorScores              BootFromCompromise 
                               TRUE                            TRUE 
                           Chi2Dist            Chi2DistanceFromSort 
                               TRUE                            TRUE 
              computePartial4Groups                    ComputeSplus 
                               TRUE                            TRUE 
                     CP2MFAnormedCP              CP2NuclearNormedCP 
                               TRUE                            TRUE 
                  CP2SUMPCAnormedCP              createCubeOfCovDis 
                               TRUE                            TRUE 
                      DblCenterDist                         Dist2CP 
                               TRUE                            TRUE 
                   DistanceFromRank                DistanceFromSort 
                               TRUE                            TRUE 
                           distatis                         GetCmat 
                               TRUE                            TRUE 
                        GetRectCmat                GraphDistatisAll 
                               TRUE                            TRUE 
                  GraphDistatisBoot         GraphDistatisCompromise 
                               TRUE                            TRUE 
               GraphDistatisPartial                 GraphDistatisRv 
                               TRUE                            TRUE 
                              ldiag               list2CubeOfCovDis 
                               TRUE                            TRUE 
                          MFAnormCP                            mmds 
                               TRUE                            TRUE 
                    NuclearNormedCP                      projectVoc 
                               TRUE                            TRUE 
                       projMap2Cube                           rdiag 
                               TRUE                            TRUE 
                      read.df.excel                              rv 
                             ...
                             scale1                    SUMPCAnormCP 
                               TRUE                            TRUE 
    supplementalProjection4distatis                   vocabulary2CT 
                               TRUE                            TRUE 

### Examples

There are 59 help pages with examples, from 62 (95.16 %).
...
| Execution Time | 2025-02-18 04:17:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bb478abd857_1739852256
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzZwK6v
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DistatisR_v1.1.1-tikzDictionary"
