# Validation Report - doRedis@3.0.2
...
| export_help          | 17                                |
| has_website          | FALSE                             |
| has_maintainer       | B. W. Lewis <blewis@illposed.net> |
...
Overall the package has 17 exported objects. 17 are documented:
                 ...
                 jobs            logger      redisConnect       redisDelete 
                 TRUE              TRUE              TRUE              TRUE 
             redisGet          redisSet       redisWorker   registerDoRedis 
                 TRUE              TRUE              TRUE              TRUE 
            removeJob       removeQueue      setChunkSize         setExport 
                 TRUE              TRUE              TRUE              TRUE 
        setFtinterval       setPackages       setProgress startLocalWorkers 
                 TRUE              TRUE              TRUE              TRUE 
                tasks 
                 TRUE 
...
| Execution Time | 2025-02-18 04:34:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42a4e2aa6_1739853284
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAfSTp0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doRedis_v3.0.2-tikzDictionary"
