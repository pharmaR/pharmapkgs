...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Thuan Nguyen <nguythua@ohsu.edu>                     |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       adaptivefence adaptivefence.fh       fence.lmer         fence.NF 
                TRUE             TRUE             TRUE             TRUE 
           fence.sae            IF.lm          IF.lmer   invisiblefence 
                TRUE             TRUE             TRUE             TRUE 
    nonadaptivefence               RF 
                TRUE             TRUE 
...
| Execution Time | 2025-02-27 03:26:17 UTC |
...
running this report
    ...
    PROCESSX_PS1c62574a7cb9_1740626773
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUuJtKf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fence_v1.0-tikzDictionary"
