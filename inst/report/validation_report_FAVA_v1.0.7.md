...
| export_help          | 12                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Maike Morrison <maikem@stanford.edu> |
...
Overall the package has 12 exported objects. 12 are documented:
         ...
         bootstrap_fava                fava           fava_norm        gini_simpson 
                   TRUE                TRUE                TRUE                TRUE 
      gini_simpson_mean gini_simpson_pooled       plot_relabund      relab_phyloseq 
                   TRUE                TRUE                TRUE                TRUE 
           time_weights         window_fava         window_list         window_plot 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-19 05:24:16 UTC |
...
running this report
    ...
    PROCESSX_PS1d4563f9cbef_1739942649
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9aDFHg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FAVA_v1.0.7-tikzDictionary"
