# Validation Report - charcuterie@0.0.6
...
| export_help          | 11                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Jonathan Carroll <rpkg@jcarroll.com.au>    |
| bugs_status          | 1                                          |
| has_source_control   | https://github.com/jonocarroll/charcuterie |
...
Overall the package has 11 exported objects. 11 are documented:
        ...
        chars     count    except intersect  is_alnum is_letter is_number  is_punct 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
      setdiff    string     union 
         TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-16 04:08:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32025ad44_1739678926
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8C4f75
...
These are the options set to generate the report:
    ...
    [1] "validation_report_charcuterie_v0.0.6-tikzDictionary"
