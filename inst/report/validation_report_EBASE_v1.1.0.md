...
| export_help          | 14                                 |
| has_website          | TRUE                               |
| has_maintainer       | Marcus Beck <mbeck@tbep.org>       |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/fawda123/EBASE/ |
...
| 5   | lubridate           | Imports |
| 6   | R2jags (\>= 0.6.1)  | Imports |
| 7   | rjags (\>= 4.10)    | Imports |
| 8   | tidyr               | Imports |
| 9   | truncnorm           | Imports |
| 10  | zoo                 | Imports |
...
Overall the package has 14 exported objects. 14 are documented:
    ...
    credible_plot credible_prep         ebase  ebase_eqboxy    ebase_form 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       ebase_plot    ebase_prep     ebase_rho ebase_schmidt   ebase_years 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         fit_plot   interp_plot  metab_update    prior_plot 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 05:14:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4399381c_1739855673
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcJgPLA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EBASE_v1.1.0-tikzDictionary"
