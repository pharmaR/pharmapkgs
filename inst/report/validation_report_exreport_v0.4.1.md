# Validation Report - exreport@0.4.1
...
| export_help          | 25                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jacinto Arias <jacinto.arias@uclm.es>                |
...
Overall the package has 25 exported objects. 25 are documented:
              ...
              expCombine            expConcat            expCreate 
                    TRUE                 TRUE                 TRUE 
      expCreateFromTable            expExtend           expExtract 
                    TRUE                 TRUE                 TRUE 
        expGetDuplicated       expInstantiate            expReduce 
                    TRUE                 TRUE                 TRUE 
     expRemoveDuplicated            expRename           expReorder 
                    TRUE                 TRUE                 TRUE 
               expSubset             exreport          exreportAdd 
                    TRUE                 TRUE                 TRUE 
          exreportRender   plotCumulativeRank       plotExpSummary 
                    TRUE                 TRUE                 TRUE 
    plotRankDistribution    tabularExpSummary  tabularTestPairwise 
                    TRUE                 TRUE                 TRUE 
      tabularTestSummary  testMultipleControl testMultiplePairwise 
                    TRUE                 TRUE                 TRUE 
              testPaired 
                    TRUE 
...
| Execution Time | 2025-02-19 04:54:56 UTC |
...
running this report
    ...
    PROCESSX_PS1d45459ed0fe_1739940889
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxiIjJG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exreport_v0.4.1-tikzDictionary"
