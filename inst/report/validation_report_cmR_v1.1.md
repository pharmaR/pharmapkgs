...
| export_help          | 7                                    |
| has_website          | TRUE                                 |
| has_maintainer       | Volker Schmid <volker.schmid@lmu.de> |
...
Overall the package has 7 exported objects. 7 are documented:
          ...
          bullseye            cmr      cmr.local      cmr.space       imageMBF 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    pseudobullseye   rmvnormcanon 
              TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:45:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36f21249_1739681141
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdjOeU5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cmR_v1.1-tikzDictionary"
