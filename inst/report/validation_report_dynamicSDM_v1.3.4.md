# Validation Report - dynamicSDM@1.3.4
...
| export_help          | 23                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Rachel Dobson <eerdo@leeds.ac.uk>        |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/r-a-dobson/dynamicSDM |
...
Overall the package has 23 exported objects. 22 are documented:
                        ...
                        %>%                 brt_fit            convert_gbif 
                      FALSE                    TRUE                    TRUE 
               dynamic_proj dynamic_proj_covariates      dynamic_proj_dates 
                       TRUE                    TRUE                    TRUE 
           dynamic_proj_GIF extract_buffered_coords extract_buffered_raster 
                       TRUE                    TRUE                    TRUE 
     extract_coords_combine  extract_dynamic_coords  extract_dynamic_raster 
                       TRUE                    TRUE                    TRUE 
      extract_static_coords       get_moving_window     spatiotemp_autocorr 
                       TRUE                    TRUE                    TRUE 
            spatiotemp_bias        spatiotemp_block        spatiotemp_check 
                       TRUE                    TRUE                    TRUE 
          spatiotemp_extent    spatiotemp_pseudoabs   spatiotemp_resolution 
                       TRUE                    TRUE                    TRUE 
            spatiotemp_thin      spatiotemp_weights 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-18 05:03:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bb442cdd290_1739855030
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmppYjiIl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dynamicSDM_v1.3.4-tikzDictionary"
