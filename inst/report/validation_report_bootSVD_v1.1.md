...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Aaron Fisher <afishe27@alumni.jh.edu>                |
...
Overall the package has 14 exported objects. 14 are documented:
                    ...
                    As2Vs               bootPCA               bootSVD 
                     TRUE                  TRUE                  TRUE 
               bootSVD_LD               fastSVD          ffmatrixmult 
                     TRUE                  TRUE                  TRUE 
           genBootIndeces                  genQ getMomentsAndMomentCI 
                     TRUE                  TRUE                  TRUE 
                       os                 qrSVD    reindexMatricesByK 
                     TRUE                  TRUE                  TRUE 
        reindexVectorsByK                simEEG 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-15 04:35:05 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd172371c8_1739594100
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6TJyzv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bootSVD_v1.1-tikzDictionary"
