...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Feng Chen <feng.chen@unsw.edu.au>                    |
...
Overall the package has 14 exported objects. 14 are documented:
            ...
            coxsei coxsei.default      coxseiest     coxseiest2     coxseiest3 
              TRUE           TRUE           TRUE           TRUE           TRUE 
      coxseifit.ex      coxseiInt      coxseisim         CumInt           Dens 
              TRUE           TRUE           TRUE           TRUE           TRUE 
              Dist          Quant            RND           Surv 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-17 04:12:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6fcde049_1739765515
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFfRUkN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coxsei_v0.3-tikzDictionary"
