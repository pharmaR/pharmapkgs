# Validation Report - Copula.Markov.survival@1.0.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Xin-Wei Huang <xinweihuang@hotmail.com>              |
...
Overall the package has 8 exported objects. 8 are documented:
    ...
    ClaytonClayton.Weibull.data  ClaytonClayton.Weibull.MLE 
                           TRUE                        TRUE 
      ClaytonFrank.Weibull.data    ClaytonFrank.Weibull.MLE 
                           TRUE                        TRUE 
      FrankClayton.Weibull.data    FrankClayton.Weibull.MLE 
                           TRUE                        TRUE 
        FrankFrank.Weibull.data      FrankFrank.Weibull.MLE 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-17 03:54:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bd65b8c2358_1739764482
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2kDPSY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Copula.Markov.survival_v1.0.0-tikzDictionary"
