# Validation Report - BayLum@0.3.2
...
| 3   | coda (\>= 0.19)           | Depends |
| 4   | methods                   | Imports |
| 5   | hexbin (\>= 1.28.3)       | Imports |
| 6   | cli (\>= 3.6.1)           | Imports |
| 7   | KernSmooth (\>= 2.23)     | Imports |
| 8   | rjags (\>= 4-13)          | Imports |
| 9   | runjags (\>= 2.2.1)       | Imports |
| 10  | Luminescence (\>= 0.9.22) | Imports |
| 11  | yaml (\>= 2.3.7)          | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
           ...
           Age_Computation             Age_OSLC14     AgeC14_Computation 
                      TRUE                   TRUE                   TRUE 
          AgeS_Computation      combine_DataFiles        Concat_DataFile 
                      TRUE                   TRUE                   TRUE 
           create_DataFile create_FolderTemplates     create_ThetaMatrix 
                      TRUE                   TRUE                   TRUE 
         Generate_DataFile   Generate_DataFile_MG           LT_RegenDose 
                      TRUE                   TRUE                   TRUE 
    Palaeodose_Computation              plot_Ages              plot_MCMC 
                      TRUE                   TRUE                   TRUE 
        plot_RegDosePoints      plot_Scatterplots             SC_Ordered 
                      TRUE                   TRUE                   TRUE 
            ScatterSamples               SCMatrix      write_BayLumFiles 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-15 03:42:57 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd22e382f0_1739590973
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMp0Dc1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayLum_v0.3.2-tikzDictionary"
