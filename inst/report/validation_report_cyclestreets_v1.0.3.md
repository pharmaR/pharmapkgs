# Validation Report - cyclestreets@1.0.3
...
| has_source_control   | https://github.com/cyclestreets/cyclestreets-r |
...
Overall the package has 9 exported objects. 8 are documented:
                    ...
                    %>%               batch         batch_multi             journey 
                  FALSE                TRUE                TRUE                TRUE 
               journey2          json2sf_cs                ltns smooth_with_cutoffs 
                   TRUE                TRUE                TRUE                TRUE 
                   ways 
                   TRUE 
...
| Execution Time | 2025-02-17 04:45:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bd61a603d17_1739767553
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsuB7hF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cyclestreets_v1.0.3-tikzDictionary"
