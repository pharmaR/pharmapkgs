# Validation Report - calibrationband@0.2.1
...
| export_help          | 3                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Marius Puke <marius.puke@uni-hohenheim.de>           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/marius-cp/calibrationband         |
...
Overall the package has 3 exported objects. 3 are documented:
            ...
            autolayer          autoplot calibration_bands 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 03:35:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bc358f3cc19_1739676912
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp12fFvS
...
These are the options set to generate the report:
    ...
    [1] "validation_report_calibrationband_v0.2.1-tikzDictionary"
