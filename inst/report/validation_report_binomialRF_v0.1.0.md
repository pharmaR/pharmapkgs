# Validation Report - binomialRF@0.1.0
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Samir Rachid Zaim <samirrachidzaim@math.arizona.edu> |
...
Overall the package has 5 exported objects. 5 are documented:
                        ...
                        binomialRF             calculateBinomialP 
                              TRUE                           TRUE 
    calculateBinomialP_Interaction             geneset_binomialRF 
                              TRUE                           TRUE 
                      k_binomialRF 
                              TRUE 
...
| Execution Time | 2025-02-15 04:09:47 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd5e5987f1_1739592582
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpB342oR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binomialRF_v0.1.0-tikzDictionary"
