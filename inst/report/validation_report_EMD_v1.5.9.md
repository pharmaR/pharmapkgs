...
| export_help          | 0                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Donghoh Kim <donghoh.kim@gmail.com>                  |
...
|     | package            | type    |
|:----|:-------------------|:--------|
| 1   | fields (\>= 6.9.1) | Depends |
| 2   | locfit (\>= 1.5-8) | Depends |
...
DecomposeR, EMDANNhybrid, EMDSVRhybrid, hht, LMD, TSPred
...
| Execution Time | 2025-02-19 04:00:35 UTC |
...
running this report
    ...
    PROCESSX_PS1d45521015a8_1739937628
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgwZKf5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EMD_v1.5.9-tikzDictionary"
