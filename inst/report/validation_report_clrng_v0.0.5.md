...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Ruoyong Xu <ruoyong.xu@mail.utoronto.ca>             |
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    createStreamsCpu createStreamsGpu       fisher.sim  get_system_info 
                TRUE             TRUE             TRUE             TRUE 
          logfactSum        qqnormGpu          rexpGpu         rnormGpu 
                TRUE             TRUE             TRUE             TRUE 
            runifGpu   setBaseCreator 
                TRUE             TRUE 
...
| Execution Time | 2025-02-16 04:35:58 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36c9e6f4e_1739680553
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2zPV7c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clrng_v0.0.5-tikzDictionary"
