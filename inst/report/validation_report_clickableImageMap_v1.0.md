# Validation Report - clickableImageMap@1.0
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Barry Zeeberg <barryz2013@gmail.com>                 |
...
Overall the package has 15 exported objects. 15 are documented:
              ...
              annunciator             calibrate clickableImageMapDemo 
                     TRUE                  TRUE                  TRUE 
    construct_entire_gtab                decode          defineBounds 
                     TRUE                  TRUE                  TRUE 
              doubleClick             exitClick   gtable_replace_grob 
                     TRUE                  TRUE                  TRUE 
                highlight      highlightOneCell              pullDown 
                     TRUE                  TRUE                  TRUE 
                   tabify           unhighlight              zlocator 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-16 04:29:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bc323937f13_1739680169
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnxN4vO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clickableImageMap_v1.0-tikzDictionary"
