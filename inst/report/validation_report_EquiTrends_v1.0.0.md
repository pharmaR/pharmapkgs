# Validation Report - EquiTrends@1.0.0
...
| export_help          | 4                                                 |
| has_website          | TRUE                                              |
| has_maintainer       | Ties Bos <tc.bos@student.maastrichtuniversity.nl> |
| bugs_status          | subscript out of bounds                           |
| has_source_control   | https://github.com/TiesBos/EquiTrends             |
...
|     | package           | type      |
|:----|:------------------|:----------|
| 1   | clubSandwich      | Imports   |
| 2   | nloptr            | Imports   |
| 3   | dplyr             | Imports   |
| 4   | rlang             | Imports   |
| 5   | plm               | Imports   |
| 6   | Rcpp (\>= 1.0.12) | Imports   |
| 7   | RcppParallel      | Imports   |
| 8   | stats             | Imports   |
| 9   | VGAM              | Imports   |
| 10  | Rcpp              | LinkingTo |
| 11  | RcppArmadillo     | LinkingTo |
| 12  | RcppParallel      | LinkingTo |
...
Overall the package has 4 exported objects. 4 are documented:
     ...
     maxEquivTest meanEquivTest  rmsEquivTest sim_paneldata 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-19 04:24:22 UTC |
...
running this report
    ...
    PROCESSX_PS1d45414468b3_1739939056
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmptecd2W
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EquiTrends_v1.0.0-tikzDictionary"
