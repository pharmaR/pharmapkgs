# Validation Report - baseline@1.3.5
...
| export_help          | 20                                              |
| has_website          | TRUE                                            |
| has_maintainer       | Kristian Hovde Liland <kristian.liland@nmbu.no> |
| bugs_status          | subscript out of bounds                         |
| size_codebase        | 2381                                            |
| has_source_control   | https://github.com/khliland/baseline/           |
...
AlpsNMR, ChemoSpec, hyperSpec, ir, NADfinder, NMRphasing, pems.utils,
powdR, spectacles, spectralAnalysis, takos

## Namespace

Overall the package has 0 exported objects. 19 are documented:
...
| Execution Time | 2025-02-14 07:44:11 UTC |
...
running this report
    ...
    PROCESSX_PS1c091362fed7_1739519048
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp34Pbm7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_baseline_v1.3.5-tikzDictionary"
