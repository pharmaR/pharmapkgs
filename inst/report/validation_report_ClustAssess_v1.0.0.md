# Validation Report - ClustAssess@1.0.0
...
| export_help          | 56                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Andi Munteanu <am3019@cam.ac.uk>                   |
| bugs_status          | subscript out of bounds                            |
| has_source_control   | https://github.com/Core-Bioinformatics/ClustAssess |
...
| 3   | dplyr              | Imports   |
| 4   | DT                 | Imports   |
| 5   | fastcluster        | Imports   |
| 6   | foreach            | Imports   |
| 7   | glue               | Imports   |
| 8   | Gmedian            | Imports   |
| 9   | ggnewscale         | Imports   |
| 10  | ggplot2            | Imports   |
| 11  | ggrastr            | Imports   |
| 12  | ggrepel            | Imports   |
| 13  | ggtext             | Imports   |
| 14  | gprofiler2         | Imports   |
| 15  | igraph             | Imports   |
| 16  | jsonlite           | Imports   |
| 17  | leiden             | Imports   |
| 18  | Matrix (\>= 1.5.0) | Imports   |
| 19  | matrixStats        | Imports   |
| 20  | progress           | Imports   |
| 21  | stringr            | Imports   |
| 22  | paletteer          | Imports   |
| 23  | plotly             | Imports   |
| 24  | qualpalr           | Imports   |
| 25  | RANN               | Imports   |
| 26  | reshape2           | Imports   |
...
| 30  | shinyjs            | Imports   |
| 31  | shinyLP            | Imports   |
| 32  | shinyWidgets       | Imports   |
| 33  | utils              | Imports   |
| 34  | uwot               | Imports   |
| 35  | vioplot            | Imports   |
| 36  | Rcpp               | LinkingTo |
| 37  | RcppEigen          | LinkingTo |
...
| Execution Time | 2025-02-16 04:37:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34efcc1e5_1739680656
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7qr36B
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ClustAssess_v1.0.0-tikzDictionary"
