# Validation Report - dietr@1.1.6.1
...
| export_help          | 9                                     |
| has_website          | TRUE                                  |
| has_maintainer       | Samuel R. Borstein <sam@borstein.com> |
| bugs_status          | subscript out of bounds               |
| has_source_control   | https://github.com/sborstein/dietr    |
...
Overall the package has 9 exported objects. 9 are documented:
       ...
       CompositeIndices ConvertFishbaseDiet ConvertFishbaseFood           DietTroph 
                   TRUE                TRUE                TRUE                TRUE 
             Electivity           FoodTroph  GastrosomaticIndex      PlotElectivity 
                   TRUE                TRUE                TRUE                TRUE 
           VacuityIndex 
                   TRUE 
...
| Execution Time | 2025-02-18 04:02:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bb41890ff34_1739851348
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpP5ndzY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dietr_v1.1.6.1-tikzDictionary"
