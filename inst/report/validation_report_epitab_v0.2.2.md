# Validation Report - epitab@0.2.2
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Stuart Lacy <stuart.lacy@york.ac.uk>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/stulacy/epitab                    |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    contingency_table              freq      hazard_ratio        neat_table 
                 TRUE              TRUE              TRUE              TRUE 
           odds_ratio      summary_mean    summary_median 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-19 04:19:37 UTC |
...
running this report
    ...
    PROCESSX_PS1d45434c2a91_1739938771
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3kcBEN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epitab_v0.2.2-tikzDictionary"
