# Validation Report - bigtime@0.2.3
...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Ines Wilms <i.wilms@maastrichtuniversity.nl>         |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/ineswilms/bigtime                 |
...
Overall the package has 14 exported objects. 13 are documented:
                     ...
                     %>% create_rand_coef_mat     diagnostics_plot 
                   FALSE                 TRUE                 TRUE 
          directforecast          get_ic_vals         ic_selection 
                    TRUE                 TRUE                 TRUE 
               is.stable            lagmatrix              plot_cv 
                    TRUE                 TRUE                 TRUE 
       recursiveforecast               simVAR            sparseVAR 
                    TRUE                 TRUE                 TRUE 
             sparseVARMA           sparseVARX 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:06:15 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd630d2af5_1739592370
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWtCA9A
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigtime_v0.2.3-tikzDictionary"
