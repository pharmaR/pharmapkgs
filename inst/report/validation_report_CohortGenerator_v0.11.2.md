# Validation Report - CohortGenerator@0.11.2
...
| export_help          | 47                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Anthony Sena <sena@ohdsi.org>            |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/OHDSI/CohortGenerator |
...
|     | package                       | type    |
|:----|:------------------------------|:--------|
| 1   | DatabaseConnector (\>= 5.0.0) | Depends |
| 2   | R6                            | Depends |
| 3   | checkmate                     | Imports |
| 4   | digest                        | Imports |
| 5   | dplyr                         | Imports |
| 6   | lubridate                     | Imports |
| 7   | methods                       | Imports |
| 8   | ParallelLogger (\>= 3.0.0)    | Imports |
| 9   | readr (\>= 2.1.0)             | Imports |
| 10  | rlang                         | Imports |
| 11  | RJSONIO                       | Imports |
| 12  | jsonlite                      | Imports |
| 13  | ResultModelManager            | Imports |
| 14  | SqlRender (\>= 1.11.1)        | Imports |
| 15  | stringi (\>= 1.7.6)           | Imports |
| 16  | tibble                        | Imports |
...
| Execution Time | 2025-02-16 04:55:12 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31519be87_1739681706
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsCuEO0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CohortGenerator_v0.11.2-tikzDictionary"
