# Validation Report - easylabel@0.3.3
...
| export_help          | 10                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Myles Lewis <myles.lewis@qmul.ac.uk>     |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/myles-lewis/easylabel |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       add_labels         arial     easylabel easyManhattan    easyMAplot 
             TRUE          TRUE          TRUE          TRUE          TRUE 
      easyVolcano     gg_qqplot     loadlabel        qqplot       qqplot2 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-18 05:11:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4571b99e4_1739855496
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxbjyDH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easylabel_v0.3.3-tikzDictionary"
