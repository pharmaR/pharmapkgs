# Validation Report - CAinterprTools@1.1.0
...
| export_help          | 24                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Gianmarco Alberti <gianmarcoalberti@gmail.com>       |
...
|:----|:----------------------|:--------|
| 1   | ca (\>= 0.70)         | Imports |
| 2   | classInt (\>= 0.2-3)  | Imports |
| 3   | cluster (\>= 2.0.7)   | Imports |
| 4   | FactoMineR (\>= 1.40) | Imports |
| 5   | ggplot2 (\>= 3.0.0)   | Imports |
| 6   | ggrepel (\>= 0.8.0)   | Imports |
| 7   | graphics (\>= 3.4.3)  | Imports |
| 8   | Hmisc (\>= 4.1-1)     | Imports |
| 9   | RcmdrMisc (\>= 1.0)   | Imports |
| 10  | reshape2 (\>= 1.4.3)  | Imports |
| 11  | stats (\>= 3.4.3)     | Imports |
| 12  | utils (\>= 3.4.3)     | Imports |
...
Overall the package has 24 exported objects. 24 are documented:
               ...
               aver.rule            caCluster               caCorr 
                    TRUE                 TRUE                 TRUE 
               caPercept               caPlot               caPlus 
                    TRUE                 TRUE                 TRUE 
               caScatter            cols.cntr    cols.cntr.scatter 
                    TRUE                 TRUE                 TRUE 
               cols.corr    cols.corr.scatter             cols.qlt 
                    TRUE                 TRUE                 TRUE 
            groupBycoord            malinvaud              rescale 
                    TRUE                 TRUE                 TRUE 
               rows.cntr    rows.cntr.scatter            rows.corr 
                    TRUE                 TRUE                 TRUE 
       rows.corr.scatter             rows.qlt         sig.dim.perm 
                    TRUE                 TRUE                 TRUE 
      sig.dim.perm.scree sig.tot.inertia.perm       table.collapse 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-16 03:33:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33bd84275_1739676811
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpj0T6Jw
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CAinterprTools_v1.1.0-tikzDictionary"
