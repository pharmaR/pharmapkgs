...
| export_help          | 9                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Graham Wheeler <graham.wheeler@ucl.ac.uk> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/mikesweeting/bcrm      |
...
Overall the package has 9 exported objects. 9 are documented:
                   ...
                   bcrm              find.x            getprior     Posterior.BRugs 
                   TRUE                TRUE                TRUE                TRUE 
        Posterior.exact Posterior.exact.sim Posterior.R2WinBUGS     Posterior.rjags 
                   TRUE                TRUE                TRUE                TRUE 
                threep3 
                   TRUE 
...
| Execution Time | 2025-02-15 03:47:07 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd36e03b00_1739591222
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9Il9jT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bcrm_v0.5.4-tikzDictionary"
