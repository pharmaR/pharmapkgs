# Validation Report - chkptstanr@0.1.1
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Donald Williams <donald.williams@nwea.org>           |
...
Overall the package has 9 exported objects. 9 are documented:
             ...
             chkpt_brms         chkpt_setup          chkpt_stan combine_chkpt_draws 
                   TRUE                TRUE                TRUE                TRUE 
          create_folder extract_chkpt_draws    extract_hmc_info  extract_stan_state 
                   TRUE                TRUE                TRUE                TRUE 
           make_brmsfit 
                   TRUE 
...
| Execution Time | 2025-02-16 04:14:19 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37115129_1739679254
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZ9e6c6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_chkptstanr_v0.1.1-tikzDictionary"
