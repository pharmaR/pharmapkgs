# Validation Report - EventPredInCure@1.0
...
| export_help          | 26                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Bo Wei <bowei1990@gmail.com>                         |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | perm (\>= 1.0.0.2)        | Imports |
| 2   | msm (\>= 1.7.0)           | Imports |
| 3   | MLEcens (\>= 0.1.7)       | Imports |
| 4   | KMsurv (\>= 0.1.5)        | Imports |
| 5   | dplyr (\>= 1.1.0)         | Imports |
| 6   | rlang (\>= 1.0.6)         | Imports |
| 7   | plotly (\>= 4.10.1)       | Imports |
| 8   | survival (\>= 2.41-3)     | Imports |
| 9   | splines (\>= 3.5.0)       | Imports |
| 10  | Matrix (\>= 1.2-14)       | Imports |
| 11  | mvtnorm (\>= 1.1-3)       | Imports |
| 12  | rstpm2 (\>= 1.6.1)        | Imports |
| 13  | numDeriv (\>= 2016.8-1.1) | Imports |
| 14  | tmvtnsim (\>= 0.1.3)      | Imports |
| 15  | erify (\>= 0.4.0)         | Imports |
| 16  | stats (\>= 3.5.0)         | Imports |
| 17  | utils (\>= 4.1.2)         | Imports |
| 18  | lubridate (\>= 1.9.2)     | Imports |
| 19  | flexsurv (\>= 2.2.2)      | Imports |
| 20  | MASS (\>= 7.3.54)         | Imports |
...
| Execution Time | 2025-02-19 04:40:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d45abf80f4_1739940019
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDXhV4x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EventPredInCure_v1.0-tikzDictionary"
