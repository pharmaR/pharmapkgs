# Validation Report - boxplotcluster@0.3
...
| 2   | graphics (\>= 4.0.0)  | Imports |
| 3   | grDevices (\>= 4.0.0) | Imports |
| 4   | stats (\>= 4.0.0)     | Imports |
...
| Execution Time | 2025-02-15 04:37:38 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd183a06d2_1739594253
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQGi0As
...
These are the options set to generate the report:
    ...
    [1] "validation_report_boxplotcluster_v0.3-tikzDictionary"
