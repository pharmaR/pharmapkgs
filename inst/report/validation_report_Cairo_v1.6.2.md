...
| downloads_1yr        | 364698                                               |
| reverse_dependencies | 57                                                   |
| has_examples         | 1                                                    |
| dependencies         | 2                                                    |
| license              | GPL-2 \| GPL-3                                       |
...
Overall the package has 57 reverse dependencies:

a4, a4Base, ADaCGH2, adepro, airship, aroma.core,
BoutrosLab.plotting.general, ComplexHeatmap, CONSTANd, corclass,
cowplot, dexter, dextergui, dexterMST, dplR, FastRWeb, flowCut,
forsearch, ggmcmc, ggrastr, gtrellis, hamlet, hetu, htmltools,
HTSeqGenie, imager, iSTATS, memery, MetaComp, metaviz, microbiome,
mmaqshiny, motifStack, ncappc, ngsReports, patternplot, plotdap, plotly,
profileplyr, QurvE, R.devices, rcssci, repr, scde, SGP, shiny, sorvi,
StanMoMo, stars, TAD, thematic, ultrapolaRplot, valhallr, viscomplexr,
visStatistics, visvow, WeightedCluster
...
| Execution Time | 2025-02-22 03:20:33 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb45581992_1740194429
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQ44CG5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Cairo_v1.6.2-tikzDictionary"
