# Validation Report - detectseparation@0.3
...
| has_source_control   | https://github.com/ikosmidis/detectseparation     |
...
|:----|:-------------------|:--------|
| 1   | ROI                | Imports |
| 2   | ROI.plugin.lpsolve | Imports |
| 3   | lpSolveAPI         | Imports |
| 4   | pkgload            | Imports |
...
brglm2, corncob, metadeconfoundR

## Namespace

Overall the package has 8 exported objects. 8 are documented:

     check_infinite_estimates    checkInfiniteEstimates detect_infinite_estimates 
                         TRUE                      TRUE                      TRUE 
            detect_separation detect_separation_control   detectInfiniteEstimates 
                         TRUE                      TRUE                      TRUE 
             detectSeparation   detectSeparationControl 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-18 03:50:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43962f93_1739850610
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdYwuth
...
These are the options set to generate the report:
    ...
    [1] "validation_report_detectseparation_v0.3-tikzDictionary"
