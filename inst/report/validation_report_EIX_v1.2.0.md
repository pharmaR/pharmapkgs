...
| has_source_control   | https://github.com/ModelOriented/EIX      |
...
| 6   | DALEX        | Imports |
| 7   | ggrepel      | Imports |
| 8   | ggiraphExtra | Imports |
| 9   | iBreakDown   | Imports |
| 10  | tidyr        | Imports |
| 11  | scales       | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
      ...
      importance interactions     lollipop    waterfall 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-19 03:53:07 UTC |
...
running this report
    ...
    PROCESSX_PS1d452097d83b_1739937181
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpup5LKX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EIX_v1.2.0-tikzDictionary"
