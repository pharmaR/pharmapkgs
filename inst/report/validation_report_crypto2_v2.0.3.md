# Validation Report - crypto2@2.0.3
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Sebastian Stoeckl <sebastian.stoeckl@uni.li>         |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/sstoeckl/crypto2                  |
...
bidask, seasonalityPlot

## Namespace

Overall the package has 8 exported objects. 8 are documented:

    crypto_global_quotes       crypto_history          crypto_info 
                    TRUE                 TRUE                 TRUE 
             crypto_list      crypto_listings        exchange_info 
                    TRUE                 TRUE                 TRUE 
           exchange_list            fiat_list 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-17 04:28:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bd638e038be_1739766498
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpooOEDk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crypto2_v2.0.3-tikzDictionary"
