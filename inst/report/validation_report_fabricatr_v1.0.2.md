# Validation Report - fabricatr@1.0.2
...
| has_source_control   | https://github.com/DeclareDesign/fabricatr |
...
CausalQueries, DeclareDesign, DesignLibrary, estimatr, GNOSIS, summclust

## Namespace

Overall the package has 24 exported objects. 24 are documented:

             add_level                ALL          correlate       cross_levels 
                  TRUE               TRUE               TRUE               TRUE 
           draw_binary    draw_binary_icc      draw_binomial   draw_categorical 
                  TRUE               TRUE               TRUE               TRUE 
            draw_count        draw_likert  draw_multivariate    draw_normal_icc 
                  TRUE               TRUE               TRUE               TRUE 
          draw_ordered      draw_quantile          fabricate         join_using 
                  TRUE               TRUE               TRUE               TRUE 
           link_levels       modify_level         nest_level potential_outcomes 
                  TRUE               TRUE               TRUE               TRUE 
               recycle      resample_data    reveal_outcomes     split_quantile 
                  TRUE               TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-19 05:03:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d454f9c879c_1739941374
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCBvpVW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fabricatr_v1.0.2-tikzDictionary"
