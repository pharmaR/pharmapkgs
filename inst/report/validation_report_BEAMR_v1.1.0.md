...
| export_help          | 18                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Anna Eames Seffernick <anna.seffernick@stjude.org> |
| bugs_status          | subscript out of bounds                            |
| has_source_control   | https://github.com/annaSeffernick/BEAMR            |
...
Overall the package has 18 exported objects. 18 are documented:
           ...
           check_beam_specs        check_list_class              clean_Bmtx 
                       TRUE                    TRUE                    TRUE 
         compute_beam_stats compute_feature_pvalues     compute_set_pvalues 
                       TRUE                    TRUE                    TRUE 
            extend_set_data      extract_beam_stats             find_id_clm 
                       TRUE                    TRUE                    TRUE 
         gen_beam_plot_list            get_id_index          plot_beam_boot 
                       TRUE                    TRUE                    TRUE 
             plot_beam_clin          plot_feat_clin          prep_beam_data 
                       TRUE                    TRUE                    TRUE 
             prep_beam_plot         prep_beam_specs      subset_beam_result 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-15 03:49:53 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd6f44c143_1739591388
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVMn4SK
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BEAMR_v1.1.0-tikzDictionary"
