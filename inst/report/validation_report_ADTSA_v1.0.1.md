...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Leila Marvian Mashhad <Leila.marveian@gmail.com>     |
...
Overall the package has 15 exported objects. 15 are documented:
      ...
      Analyze_Fre_Acf Astimate_Acf_Band              B_CI    Cal_Cross_Corr 
                 TRUE              TRUE              TRUE              TRUE 
          Der_Lev_Pac     Estimate_Acps          get.ahat          JN_ACSDM 
                 TRUE              TRUE              TRUE              TRUE 
             JN_VMBBA             MB_Ac              P_CI      pairwise_MBL 
                 TRUE              TRUE              TRUE              TRUE 
            Period_ts            Sug_dm              VMBB 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-14 06:39:48 UTC |
...
running this report
    ...
    PROCESSX_PS726d5352360f_1739515185
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvsqXiR
