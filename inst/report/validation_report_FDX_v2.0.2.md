...
| export_help          | 31                                |
| has_website          | TRUE                              |
| has_maintainer       | Florian Junge <diso.fbmn@h-da.de> |
| has_source_control   | https://github.com/DISOhda/FDX    |
...
|     | package                     | type      |
|:----|:----------------------------|:----------|
| 1   | Rcpp (\>= 1.0.12)           | Imports   |
| 2   | PoissonBinomial (\>= 1.2.0) | Imports   |
| 3   | pracma                      | Imports   |
| 4   | DiscreteFDR (\>= 2.0.0)     | Imports   |
| 5   | checkmate                   | Imports   |
| 6   | lifecycle                   | Imports   |
| 7   | methods                     | Imports   |
| 8   | Rcpp                        | LinkingTo |
| 9   | RcppArmadillo               | LinkingTo |
| 10  | PoissonBinomial             | LinkingTo |
...
Overall the package has 31 exported objects. 31 are documented:
         ...
         continuous.GR      continuous.LR                DGR direct.discrete.GR 
                  TRUE               TRUE               TRUE               TRUE 
    direct.discrete.LR direct.discrete.PB        discrete.GR        discrete.LR 
                  TRUE               TRUE               TRUE               TRUE 
           discrete.PB                DLR                DPB   fast.Discrete.GR 
                  TRUE               TRUE               TRUE               TRUE 
      fast.Discrete.LR   fast.Discrete.PB                 GR                 LR 
                  TRUE               TRUE               TRUE               TRUE 
                  NDGR               NDLR               NDPB                NGR 
                  TRUE               TRUE               TRUE               TRUE 
                   NLR     rejection.path        weighted.GR        weighted.LR 
                  TRUE               TRUE               TRUE               TRUE 
           weighted.PB             wGR.AM             wGR.GM             wLR.AM 
                  TRUE               TRUE               TRUE               TRUE 
                wLR.GM             wPB.AM             wPB.GM 
                  TRUE               TRUE               TRUE 
...
| Execution Time | 2025-02-27 03:24:14 UTC |
...
running this report
    ...
    PROCESSX_PS1c624ababdbe_1740626650
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8zct84
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FDX_v2.0.2-tikzDictionary"
