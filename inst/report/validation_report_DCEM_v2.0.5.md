...
| export_help          | 6                                 |
| has_website          | TRUE                              |
| has_maintainer       | Sharma Parichit <parishar@iu.edu> |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/parichit/DCEM  |
...
|     | package                | type      |
|:----|:-----------------------|:----------|
| 1   | mvtnorm (\>= 1.0.7)    | Imports   |
| 2   | matrixcalc (\>= 1.0.3) | Imports   |
| 3   | MASS (\>= 7.3.49)      | Imports   |
...
Overall the package has 6 exported objects. 6 are documented:
       ...
       dcem_predict dcem_star_train       dcem_test      dcem_train          meu_mv 
...
| Execution Time | 2025-02-17 05:09:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bd673d4f113_1739768963
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0xvlPA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DCEM_v2.0.5-tikzDictionary"
