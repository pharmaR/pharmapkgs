# Validation Report - deBInfer@0.4.4
...
| export_help          | 16                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Philipp H Boersch-Supan <pboesu@gmail.com> |
| bugs_status          | 0.9333333                                  |
| has_source_control   | https://github.com/pboesu/debinfer         |
...
Overall the package has 16 exported objects. 16 are documented:
                ...
                de_mcmc        debinfer_cov        debinfer_par             deinits 
                   TRUE                TRUE                TRUE                TRUE 
                 depars is.debinfer_parlist  is.debinfer_result     log_post_params 
                   TRUE                TRUE                TRUE                TRUE 
       log_prior_params          logd_prior post_prior_densplot            post_sim 
                   TRUE                TRUE                TRUE                TRUE 
       reshape_post_sim      setup_debinfer            solve_de   update_sample_rev 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 03:31:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4e7eec72_1739849484
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcXpmmQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deBInfer_v0.4.4-tikzDictionary"
