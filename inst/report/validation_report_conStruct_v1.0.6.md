# Validation Report - conStruct@1.0.6
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Gideon Bradburd <bradburd@umich.edu>                 |
...
| 10  | StanHeaders (\>= 2.26.0)  | LinkingTo |
| 11  | rstan (\>= 2.26.0)        | LinkingTo |
| 12  | BH (\>= 1.66.0)           | LinkingTo |
| 13  | Rcpp (\>= 0.12.0)         | LinkingTo |
...
Overall the package has 9 exported objects. 9 are documented:
    ...
    calculate.layer.contribution             compare.two.runs 
                            TRUE                         TRUE 
                       conStruct          make.admix.pie.plot 
                            TRUE                         TRUE 
              make.all.the.plots          make.structure.plot 
                            TRUE                         TRUE 
             match.layers.x.runs          structure2conStruct 
                            TRUE                         TRUE 
                    x.validation 
                            TRUE 
...
| Execution Time | 2025-02-17 03:48:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64708e8e6_1739764105
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHDQ4H3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_conStruct_v1.0.6-tikzDictionary"
