# Validation Report - crossdes@1.1.2
...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Bjoern Bornkamp <bbnkmp@mail.de>                     |
...
bwsTools, Crossover, designr, mixOofA, OPDOE, PowerTOST, pwr4exp,
RcmdrPlugin.BWS1, spsurvey, support.BWS, support.BWS3

## Namespace

Overall the package has 10 exported objects. 10 are documented:

        allcombs   balmin.RMD     des.MOLS     find.BIB     get.plan  isCbalanced 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
           isGYD         MOLS     williams williams.BIB 
            TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-17 04:23:42 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63af18947_1739766217
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKNmh19
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crossdes_v1.1.2-tikzDictionary"
