# Validation Report - crimedata@0.3.5
...
| export_help          | 3                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Matthew Ashby <matthew.ashby@ucl.ac.uk> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/mpjashby/crimedata   |
...
Overall the package has 3 exported objects. 3 are documented:
     ...
     block_geoid_to  get_crime_data list_crime_data 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:20:34 UTC |
...
running this report
    ...
    PROCESSX_PS1bd675760ba9_1739766029
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTjuJ2G
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crimedata_v0.3.5-tikzDictionary"
