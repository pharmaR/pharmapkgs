# Validation Report - clusterHD@1.0.2
...
| export_help | 4 |
| has_website | TRUE |
| has_maintainer | Jakob Raymaekers <j.raymaekers@maastrichtuniversity.nl> |
...
Overall the package has 4 exported objects. 4 are documented:
     ...
     diagPlot getLambda  HTKmeans       PVS 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-16 04:39:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35459aeca_1739680742
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6BP2qq
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clusterHD_v1.0.2-tikzDictionary"
