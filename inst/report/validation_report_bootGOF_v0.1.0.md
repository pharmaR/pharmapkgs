# Validation Report - bootGOF@0.1.0
...
| export_help          | 16                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Marsel Scheer <scheer@freescience.de>   |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/MarselScheer/bootGOF |
| has_bug_reports_url  | 1                                       |
| downloads_1yr        | 2186                                    |
| reverse_dependencies | 0                                       |
| has_examples         | 0.1176471                               |
| dependencies         | 2                                       |
| license              | GPL-3                                   |
...
Overall the package has 16 exported objects. 16 are documented:
      ...
      GOF_glm_info_extractor        GOF_glm_sim_param          GOF_glm_trainer 
                        TRUE                     TRUE                     TRUE 
       GOF_lm_info_extractor         GOF_lm_sim_param           GOF_lm_trainer 
                        TRUE                     TRUE                     TRUE 
                   GOF_model GOF_model_info_extractor       GOF_model_resample 
                        TRUE                     TRUE                     TRUE 
         GOF_model_simulator           GOF_model_test        GOF_model_trainer 
                        TRUE                     TRUE                     TRUE 
     GOF_sim_wild_rademacher                  Rn1_CvM                   Rn1_KS 
                        TRUE                     TRUE                     TRUE 
               Rn1_statistic 
                        TRUE 
...
There are 2 help pages with examples, from 17 (11.76 %).
...
| Execution Time | 2025-02-15 04:33:46 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7cb80ab1_1739594021
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwUFOoe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bootGOF_v0.1.0-tikzDictionary"
