...
| export_help          | 12                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Francois Vieille <vieille.francois@gmail.com> |
| bugs_status          | subscript out of bounds                       |
| size_codebase        | 839                                           |
| has_source_control   | https://github.com/prise6/aVirtualTwins       |
...
Overall the package has 12 exported objects. 12 are documented:
    ...
    formatRCTDataset          vt.data         VT.difft        vt.forest 
                TRUE             TRUE             TRUE             TRUE 
    VT.forest.double   VT.forest.fold    VT.forest.one        VT.object 
                TRUE             TRUE             TRUE             TRUE 
        vt.subgroups          vt.tree    VT.tree.class      VT.tree.reg 
                TRUE             TRUE             TRUE             TRUE 

### Examples

There are 8 help pages with examples, from 16 (50.00 %).
...
| Execution Time | 2025-02-14 07:35:57 UTC |
...
running this report
    ...
    PROCESSX_PS1c092617c94c_1739518554
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHkLQhP
