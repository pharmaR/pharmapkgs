# Validation Report - fdicdata@0.1.1
...
| export_help          | 10                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Ugur Dar <ugurdarr@gmail.com>          |
| has_source_control   | https://github.com/visbanking/fdicdata |
...
Overall the package has 10 exported objects. 10 are documented:
           ...
           cert2idrssd       dataTaxonomy        getFailures      getFinancials 
                  TRUE               TRUE               TRUE               TRUE 
            getHistory     getInstitution getInstitutionsAll        getLocation 
                  TRUE               TRUE               TRUE               TRUE 
            getSummary        idrssd2cert 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-27 03:23:15 UTC |
...
running this report
    ...
    PROCESSX_PS1c6299e45ab_1740626591
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLJfX7h
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fdicdata_v0.1.1-tikzDictionary"
