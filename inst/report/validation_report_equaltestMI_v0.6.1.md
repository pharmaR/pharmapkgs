# Validation Report - equaltestMI@0.6.1
...
| export_help          | 7                                |
| has_website          | FALSE                            |
| has_maintainer       | Ge Jiang <gejiang2@illinois.edu> |
...
Overall the package has 7 exported objects. 7 are documented:
     ...
     eqMI.bootstrap    eqMI.covtest       eqMI.main        eqMI.ncp eqMI.projection 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         eqMI.RMSEA    eqMI.semtest 
               TRUE            TRUE 
...
| Execution Time | 2025-02-19 04:23:20 UTC |
...
running this report
    ...
    PROCESSX_PS1d4526a74f98_1739938993
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIDb8pD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_equaltestMI_v0.6.1-tikzDictionary"
