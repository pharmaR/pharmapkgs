# Validation Report - dsrTest@1.0.0
...
| export_help          | 5                                               |
| has_website          | TRUE                                            |
| has_maintainer       | Michael Nelson <michael.nelson.r.pkg@gmail.com> |
| bugs_status          | subscript out of bounds                         |
| has_source_control   | https://github.com/mnelsonr/dsrTest             |
...
| 1   | stats            | Imports |
| 2   | exactci          | Imports |
| 3   | asht (\>= 0.9.1) | Imports |
| 4   | loglognorm       | Imports |
...
Overall the package has 5 exported objects. 5 are documented:
    ...
    asymptoticControl       betaControl     dobsonControl           dsrTest 
                 TRUE              TRUE              TRUE              TRUE 
         gammaControl 
                 TRUE 
...
| Execution Time | 2025-02-18 04:52:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bb455ac1c2a_1739854355
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmplh2NIY
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsrTest_v1.0.0-tikzDictionary"
