# Validation Report - capushe@1.1.2
...
| export_help          | 8                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Vincent Brault <vincent.brault@agroparistech.fr>     |
...
adjclust, coseq, GNSSseg, HTSCluster, Kmedians, MuChPoint,
PhylogeneticEM, RobRegression, shock, slm, TrendTM, xLLiM

## Namespace

Overall the package has 3 exported objects. 4 are documented:

    AICcapushe BICcapushe validation 
          TRUE       TRUE       TRUE 

### Examples

There are 5 help pages with examples, from 6 (83.33 %).
...
| Execution Time | 2025-02-16 03:39:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37d369002_1739677186
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpy5ZD96
...
These are the options set to generate the report:
    ...
    [1] "validation_report_capushe_v1.1.2-tikzDictionary"
