# Validation Report - DEploid@0.5.7
...
| export_help          | 15                                       |
| has_website          | TRUE                                     |
| has_maintainer       | Joe Zhu <sha.joe.zhu@gmail.com>          |
| bugs_status          | subscript out of bounds                  |
| has_source_control   | https://github.com/DEploid-dev/DEploid-r |
...
|     | package                   | type      |
|:----|:--------------------------|:----------|
| 1   | DEploid.utils (\>= 0.0.1) | Depends   |
| 2   | Rcpp (\>= 0.11.2)         | Imports   |
| 3   | scales (\>= 0.4.0)        | Imports   |
| 4   | plotly (\>= 4.7.1)        | Imports   |
| 5   | magrittr (\>= 1.5)        | Imports   |
| 6   | rmarkdown(\>= 1.6)        | Imports   |
| 7   | htmlwidgets (\>= 1.0)     | Imports   |
| 8   | Rcpp                      | LinkingTo |
...
Overall the package has 15 exported objects. 15 are documented:
            ...
            computeObsWSAF                dEploid extractCoverageFromTxt 
                      TRUE                   TRUE                   TRUE 
    extractCoverageFromVcf            extractPLAF       haplotypePainter 
                      TRUE                   TRUE                   TRUE 
                  histWSAF           plotAltVsRef     plotAltVsRefPlotly 
                      TRUE                   TRUE                   TRUE 
        plotHistWSAFPlotly         plotObsExpWSAF   plotObsExpWSAFPlotly 
                      TRUE                   TRUE                   TRUE 
           plotProportions         plotWSAFvsPLAF   plotWSAFVsPLAFPlotly 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-18 03:44:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4bd0c325_1739850251
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpGInOT8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DEploid_v0.5.7-tikzDictionary"
