...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Guillaume Guénard <guillaume.guenard@umontreal.ca>   |
...
Overall the package has 22 exported objects. 22 are documented:
        ...
        cthreshold           dphi           dtau       eigenmap eigenmap.score 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            Euclid      geodesics   LGTransforms            MCA     minpermute 
              TRUE           TRUE           TRUE           TRUE           TRUE 
    parPermute.cdp    permute.cdp           pphi           ptau       test.cdp 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         wf.binary      wf.Drayf1      wf.Drayf2      wf.Drayf3        wf.PCNM 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            wf.RBF        wf.sqrd 
              TRUE           TRUE 
...
| Execution Time | 2025-02-16 04:52:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31ecb7018_1739681525
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSRzAj8
...
These are the options set to generate the report:
    ...
    [1] "validation_report_codep_v1.2.4-tikzDictionary"
