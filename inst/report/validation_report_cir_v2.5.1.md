...
| export_help          | 17                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Assaf P. Oron <assaf.oron@gmail.com>                 |
...
Overall the package has 17 exported objects. 17 are documented:
            ...
            agcouCI         cirPAVA    deltaInverse        doseFind    doseResponse 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           DRshrink         DRtrace is.doseResponse      is.DRtrace    isotInterval 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             jeffCI        morrisCI         oldPAVA    quickInverse    quickIsotone 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              slope        wilsonCI 
               TRUE            TRUE 
...
| Execution Time | 2025-02-16 04:20:24 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3104e9ede_1739679619
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeiVZ2x
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cir_v2.5.1-tikzDictionary"
