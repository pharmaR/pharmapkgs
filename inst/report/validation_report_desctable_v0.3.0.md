# Validation Report - desctable@0.3.0
...
| export_help          | 20                               |
| has_website          | TRUE                             |
| has_maintainer       | Maxime Wack <maximewack@free.fr> |
...
Overall the package has 20 exported objects. 19 are documented:
                ...
                !!!             %>%           ANOVA      chisq.test       datatable 
               TRUE           FALSE            TRUE            TRUE            TRUE 
        desc_output      desc_table      desc_tests       desctable     fisher.test 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           group_by             IQR       is.normal         percent         statify 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         stats_auto   stats_default stats_nonnormal    stats_normal      tests_auto 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-18 03:47:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bb474837db6_1739850437
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp8k7ssj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_desctable_v0.3.0-tikzDictionary"
