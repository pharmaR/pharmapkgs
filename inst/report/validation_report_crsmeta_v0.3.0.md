# Validation Report - crsmeta@0.3.0
...
| has_source_control   | https://github.com/hypertidy/crsmeta |
...
ceramic, reproj, silicate, spex, trip

## Namespace

Overall the package has 5 exported objects. 5 are documented:

     crs_epsg crs_input  crs_proj   crs_wkt  crs_wkt2 
...
| Execution Time | 2025-02-17 04:26:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63e2a79ab_1739766381
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpP0tOwT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crsmeta_v0.3.0-tikzDictionary"
