...
| export_help          | 24                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Prajual Maheshwari <prajual1391@gmail.com>           |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/prajual/bqror                     |
...
Overall the package has 24 exported objects. 24 are documented:
                  ...
                  alcdf            alcdfstd        covEffectOR1        covEffectOR2 
                   TRUE                TRUE                TRUE                TRUE 
                 dicOR1              dicOR2         drawbetaOR1         drawbetaOR2 
                   TRUE                TRUE                TRUE                TRUE 
           drawdeltaOR1       drawlatentOR1       drawlatentOR2           drawnuOR2 
                   TRUE                TRUE                TRUE                TRUE 
           drawsigmaOR2            drawwOR1       ineffactorOR1       ineffactorOR2 
                   TRUE                TRUE                TRUE                TRUE 
         logMargLikeOR1      logMargLikeOR2    qrminfundtheorem qrnegLogLikensumOR1 
                   TRUE                TRUE                TRUE                TRUE 
        qrnegLogLikeOR2         quantregOR1         quantregOR2              rndald 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 04:39:26 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd22b1f0b0_1739594361
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkzEoNG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bqror_v1.7.1-tikzDictionary"
