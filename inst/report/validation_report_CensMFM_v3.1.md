...
| export_help | 4 |
| has_website | FALSE |
| has_maintainer | Francisco H. C. de Alencar <hildemardealencar@gmail.com> |
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | MomTrunc (\>= 5.87)   | Imports |
| 2   | mvtnorm (\>= 1.0.11)  | Imports |
| 3   | gridExtra             | Imports |
| 4   | ggplot2               | Imports |
| 5   | tlrmvnmvt (\>= 1.1.0) | Imports |
...
Overall the package has 4 exported objects. 4 are documented:
       ...
       fit.FMMSNC         rMMSN rMMSN.contour          rMSN 
             TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-16 04:00:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34ef2e77c_1739678398
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpdKJLLf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CensMFM_v3.1-tikzDictionary"
