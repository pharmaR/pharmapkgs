...
| export_help          | 11                               |
| has_website          | TRUE                             |
| has_maintainer       | Jose Samos <jsamos@ugr.es>       |
| bugs_status          | subscript out of bounds          |
| has_source_control   | https://github.com/josesamos/clc |
...
Overall the package has 11 exported objects. 11 are documented:
                 ...
                 as_raster                    clc                copy_to 
                      TRUE                   TRUE                   TRUE 
             cut_to_extent             get_colors             get_levels 
                      TRUE                   TRUE                   TRUE 
                get_raster               plot_clc           prepare_plot 
                      TRUE                   TRUE                   TRUE 
    safe_clip_multipoligon                save_to 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-16 04:27:23 UTC |
...
running this report
    ...
    PROCESSX_PS1bc341d5da1f_1739680038
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp0P7Kg0
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clc_v1.0.0-tikzDictionary"
