# Validation Report - EvolutionaryGames@0.1.2
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | deSolve (\>= 1.14)    | Imports |
| 2   | geometry (\>= 0.3-6)  | Imports |
| 3   | ggplot2 (\>= 2.2.1)   | Imports |
| 4   | grDevices (\>= 3.2.2) | Imports |
| 5   | interp (\>= 1.0-29)   | Imports |
| 6   | MASS (\>= 7.3-43)     | Imports |
| 7   | reshape2 (\>= 1.4.2)  | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
               ...
               BNN             BR            ESS          ESset         ILogit 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             Logit   MSReplicator phaseDiagram2S phaseDiagram3S phaseDiagram4S 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        Replicator          Smith       triangle 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-19 04:43:07 UTC |
...
running this report
    ...
    PROCESSX_PS1d45e3f9980_1739940181
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpceXpUE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EvolutionaryGames_v0.1.2-tikzDictionary"
