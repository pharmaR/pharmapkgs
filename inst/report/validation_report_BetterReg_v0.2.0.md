# Validation Report - BetterReg@0.2.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Chris Aberson <cla18@humboldt.edu>                   |
...
Overall the package has 8 exported objects. 8 are documented:
     ...
     depbcomp  indbcomp     LRchi     Mahal     parts    pseudo  R2change tolerance 
...
| Execution Time | 2025-02-15 03:56:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd36b42dce_1739591797
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyEv6D3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BetterReg_v0.2.0-tikzDictionary"
