...
| export_help          | 78                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Christen H. Fleming <flemingc@si.edu>                |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/ctmm-initiative/ctmm              |
...
| 8   | grDevices  | Imports |
| 9   | gsl        | Imports |
| 10  | manipulate | Imports |
| 11  | MASS       | Imports |
| 12  | methods    | Imports |
| 13  | numDeriv   | Imports |
| 14  | parsedate  | Imports |
| 15  | pbivnorm   | Imports |
| 16  | pracma     | Imports |
| 17  | raster     | Imports |
| 18  | shape      | Imports |
...
amt, ctpm, move, trackdf

## Namespace

Overall the package has 78 exported objects. 73 are documented:
                           ...
                           correlogram                               ctmm 
                             ...
                             ctmm.boot                           ctmm.fit 
                                  TRUE                               TRUE 
                            ctmm.guess                       ctmm.loglike 
                                  TRUE                               TRUE 
                           ctmm.select                         difference 
                                  TRUE                               TRUE 
                                dimfig                           distance 
                                  TRUE                               TRUE 
                             distances                            dt.plot 
                           ...
                           periodogram                               pkde 
                            ...
                            projection                       projection<- 
                             ...
                             proximity                             raster 
                                  TRUE                              FALSE 
                          revisitation                            rsf.fit 
                                  TRUE                               TRUE 
                            rsf.select                            sdm.fit 
                                  TRUE                               TRUE 
                         sdm.integrate                         sdm.select 
                                  TRUE                               TRUE 
                                sigfig                           simulate 
                                  TRUE                               TRUE 
               SpatialPoints.telemetry   SpatialPointsDataFrame.telemetry 
                                  TRUE                               TRUE 
    SpatialPolygonsDataFrame.telemetry        SpatialPolygonsDataFrame.UD 
                                  TRUE                               TRUE 
                                 speed                             speeds 
                                  TRUE                               TRUE 
                           suitability                               tail 
...
| Execution Time | 2025-02-17 04:34:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64c3b5d90_1739766878
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoR3xGL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ctmm_v1.2.0-tikzDictionary"
