# Validation Report - BLPestimatoR@0.3.4
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Daniel Brunner <daniel.brunner@hhu.de>               |
...
Overall the package has 11 exported objects. 11 are documented:
                ...
                BLP_data       dstddelta_wrap       dstdtheta_wrap 
                    TRUE                 TRUE                 TRUE 
             estimateBLP     get_elasticities        getDelta_wrap 
                    TRUE                 TRUE                 TRUE 
        getJacobian_wrap         getShareInfo         gmm_obj_wrap 
                    TRUE                 TRUE                 TRUE 
    simulate_BLP_dataset      update_BLP_data 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-15 04:24:39 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd174606fb_1739593474
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTXqJLX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BLPestimatoR_v0.3.4-tikzDictionary"
