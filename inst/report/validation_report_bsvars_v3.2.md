...
| export_help          | 36                                 |
| has_website          | TRUE                               |
| has_maintainer       | Tomasz Woźniak <wozniak.tom@pm.me> |
...
| 2   | RcppProgress (\>= 0.1) | Imports   |
| 3   | RcppTN                 | Imports   |
| 4   | GIGrvg                 | Imports   |
| 5   | R6                     | Imports   |
| 6   | stochvol               | Imports   |
| 7   | Rcpp                   | LinkingTo |
| 8   | RcppProgress           | LinkingTo |
...
Overall the package has 36 exported objects. 36 are documented:
               ...
               compute_conditional_sd             compute_fitted_values 
                                 TRUE                              TRUE 
    compute_historical_decompositions         compute_impulse_responses 
                                 TRUE                              TRUE 
         compute_regime_probabilities         compute_structural_shocks 
                                 TRUE                              TRUE 
      compute_variance_decompositions                          estimate 
                                 TRUE                              TRUE 
                             forecast               normalise_posterior 
                                 TRUE                              TRUE 
                          plot_ribbon                     specify_bsvar 
                                 TRUE                              TRUE 
                    specify_bsvar_mix                 specify_bsvar_msh 
                                 TRUE                              TRUE 
                     specify_bsvar_sv                   specify_bsvar_t 
                                 TRUE                              TRUE 
                specify_data_matrices     specify_identification_bsvars 
                                 TRUE                              TRUE 
              specify_posterior_bsvar       specify_posterior_bsvar_mix 
                                 TRUE                              TRUE 
          specify_posterior_bsvar_msh        specify_posterior_bsvar_sv 
                                 TRUE                              TRUE 
            specify_posterior_bsvar_t               specify_prior_bsvar 
                                 TRUE                              TRUE 
              specify_prior_bsvar_mix           specify_prior_bsvar_msh 
                                 TRUE                              TRUE 
               specify_prior_bsvar_sv             specify_prior_bsvar_t 
                                 TRUE                              TRUE 
    ...
    specify_starting_values_bsvar_msh  specify_starting_values_bsvar_sv 
                                 TRUE                              TRUE 
      specify_starting_values_bsvar_t             verify_autoregression 
                                 TRUE                              TRUE 
                verify_identification                 verify_volatility 
                                 TRUE                              TRUE 
...
| Execution Time | 2025-02-15 04:51:50 UTC |
...
running this report
    ...
    PROCESSX_PS1ccdc1945e9_1739595105
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpril6h3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bsvars_v3.2-tikzDictionary"
