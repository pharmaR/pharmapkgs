# Validation Report - clusterMI@1.4.0
...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Vincent Audigier <vincent.audigier@cnam.fr>          |
...
| 11  | glmnet           | Imports   |
| 12  | ClusterR         | Imports   |
| 13  | FactoMineR       | Imports   |
| 14  | diceR            | Imports   |
| 15  | NPBayesImputeCat | Imports   |
| 16  | e1071            | Imports   |
| 17  | Rfast            | Imports   |
| 18  | cat              | Imports   |
| 19  | utils            | Imports   |
| 20  | ggplot2          | Imports   |
| 21  | gridExtra        | Imports   |
| 22  | reshape2         | Imports   |
| 23  | methods          | Imports   |
| 24  | Rcpp             | Imports   |
| 25  | Rcpp             | LinkingTo |
...
Overall the package has 11 exported objects. 11 are documented:
          ...
          chooseB       choosem   choosemaxit choosenbclust       chooser 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        clusterMI       fastnmf    imputedata    overimpute        prodna 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       varselbest 
             TRUE 
...
| Execution Time | 2025-02-16 04:39:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31e527e3_1739680759
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp98mAGs
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clusterMI_v1.4.0-tikzDictionary"
