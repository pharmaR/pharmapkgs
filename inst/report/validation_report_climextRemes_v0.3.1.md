# Validation Report - climextRemes@0.3.1
...
| has_source_control   | https://bitbucket.org/lbl-cascade/climextremes-dev   |
...
Overall the package has 13 exported objects. 13 are documented:
      ...
      calc_logReturnPeriod_fevd     calc_logReturnProb_fevd 
                           TRUE                        TRUE 
    calc_logReturnProbDiff_fevd       calc_returnValue_fevd 
                           TRUE                        TRUE 
      calc_returnValueDiff_fevd        calc_riskRatio_binom 
                           TRUE                        TRUE 
             calc_riskRatio_gev          calc_riskRatio_pot 
                           TRUE                        TRUE 
                        fit_gev                     fit_pot 
                           TRUE                        TRUE 
                      normalize                 remove_runs 
                           TRUE                        TRUE 
            screen_within_block 
                           TRUE 
...
| Execution Time | 2025-02-16 04:31:46 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34fde4174_1739680300
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpNjowyv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_climextRemes_v0.3.1-tikzDictionary"
