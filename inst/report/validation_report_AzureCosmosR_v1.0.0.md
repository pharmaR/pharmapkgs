...
| size_codebase                   | 972                                   |
| has_source_control              | https://github.com/Azure/AzureCosmosR |
...
Overall the package has 36 exported objects. 36 are documented:
                  ...
                  az_cosmosdb               bulk_delete               bulk_import 
                         TRUE                      TRUE                      TRUE 
         call_cosmos_endpoint           cosmos_endpoint   cosmos_mongo_connection 
                         TRUE                      TRUE                      TRUE 
        cosmos_mongo_endpoint   create_cosmos_container    create_cosmos_database 
                         TRUE                      TRUE                      TRUE 
              create_document   create_stored_procedure                create_udf 
                         TRUE                      TRUE                      TRUE 
      delete_cosmos_container    delete_cosmos_database           delete_document 
                         TRUE                      TRUE                      TRUE 
      delete_stored_procedure                delete_udf              do_cosmos_op 
                         TRUE                      TRUE                      TRUE 
        exec_stored_procedure      get_cosmos_container       get_cosmos_database 
                         TRUE                      TRUE                      TRUE 
                 get_document         get_partition_key      get_stored_procedure 
                         TRUE                      TRUE                      TRUE 
                      get_udf    list_cosmos_containers     list_cosmos_databases 
                         TRUE                      TRUE                      TRUE 
               list_documents list_partition_key_ranges list_partition_key_values 
                         TRUE                      TRUE                      TRUE 
       list_stored_procedures                 list_udfs   process_cosmos_response 
                         TRUE                      TRUE                      TRUE 
              query_documents  replace_stored_procedure               replace_udf 
                         TRUE                      TRUE                      TRUE 

### Examples

There are 12 help pages with examples, from 16 (75.00 %).
...
| Execution Time | 2025-02-14 07:37:45 UTC |
...
running this report
    ...
    PROCESSX_PS1c097ad2852d_1739518662
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpeVSIvX
