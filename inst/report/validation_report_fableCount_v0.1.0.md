# Validation Report - fableCount@0.1.0
...
| export_help          | 2                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Gustavo Almeida <gustavoalmeidasilva@ice.ufjf.br>    |
...
| 2   | tscount (\>= 1.4.3)    | Depends |
| 3   | glarma (\>= 1.6.0)     | Depends |
| 4   | fable (\>= 0.3.4)      | Depends |
| 5   | stats                  | Imports |
| 6   | dplyr (\>= 1.0.0)      | Imports |
| 7   | tsibble (\>= 0.9.0)    | Imports |
| 8   | tibble                 | Imports |
| 9   | tidyr                  | Imports |
| 10  | distributional         | Imports |
| 11  | lubridate              | Imports |
| 12  | stringr                | Imports |
| 13  | tsibbledata            | Imports |
...
| Execution Time | 2025-02-19 05:02:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d452dfb8664_1739941339
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpsn8HxQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fableCount_v0.1.0-tikzDictionary"
