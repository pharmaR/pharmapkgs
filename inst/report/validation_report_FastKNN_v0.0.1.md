# Validation Report - FastKNN@0.0.1
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Gaston Besanson <besanson@gmail.com>                 |
...
DRquality, GGoutlieR, ProjectionBasedClustering

## Namespace

Overall the package has 4 exported objects. 4 are documented:

    Distance_for_KNN_test   k.nearest.neighbors     knn_test_function 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-19 05:18:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d452adddcd_1739942278
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpacIpsi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FastKNN_v0.0.1-tikzDictionary"
