...
| export_help          | 7                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Piotr Piątyszek <piotrp@wektor.xyz>     |
| bugs_status          | subscript out of bounds                 |
| size_codebase        | 1472                                    |
| has_source_control   | https://github.com/ModelOriented/ArenaR |
...
Overall the package has 7 exported objects. 7 are documented:
         ...
         create_arena      push_dataset        push_model push_observations 
                 TRUE              TRUE              TRUE              TRUE 
           run_server        save_arena      upload_arena 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-14 07:22:51 UTC |
...
running this report
    ...
    PROCESSX_PS1c093512e5de_1739517768
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpuw8Cy4
