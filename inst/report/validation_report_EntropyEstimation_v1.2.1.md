# Validation Report - EntropyEstimation@1.2.1
...
| export_help          | 20                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Michael Grabchak <mgrabcha@charlotte.edu>            |
...
CASMI, divent, entropart

## Namespace

Overall the package has 20 exported objects. 20 are documented:

      Entropy.sd    Entropy.z   GenSimp.sd    GenSimp.z      Hill.sd       Hill.z 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       KL.Plugin        KL.sd         KL.z        MI.sd         MI.z     Renyi.sd 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
         Renyi.z   RenyiEq.sd    RenyiEq.z SymKL.Plugin     SymKL.sd      SymKL.z 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      Tsallis.sd    Tsallis.z 
            TRUE         TRUE 
...
| Execution Time | 2025-02-19 04:10:51 UTC |
...
running this report
    ...
    PROCESSX_PS1d45624707fe_1739938245
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsStLgT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EntropyEstimation_v1.2.1-tikzDictionary"
