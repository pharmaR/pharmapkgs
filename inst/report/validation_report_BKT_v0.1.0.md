...
| export_help          | 10                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Yuhao Yuan <yuanyuhaoapply@163.com>                  |
...
Overall the package has 10 exported objects. 10 are documented:
              ...
              bkt crossvalidate      evaluate fetch_dataset           fit 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       load_model        params   predict_bkt    save_model      set_coef 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-15 04:20:35 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1a544e98_1739593230
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprEE6Wr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BKT_v0.1.0-tikzDictionary"
