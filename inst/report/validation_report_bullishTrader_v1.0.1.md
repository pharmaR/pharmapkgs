# Validation Report - bullishTrader@1.0.1
...
Overall the package has 19 exported objects. 19 are documented:
                       ...
                       aBullCallSpread                     aBullPutSpread 
                                  TRUE                               TRUE 
                             aLongCall                         aLongStock 
                                  TRUE                               TRUE 
                   callRatioBackspread                     collarStrategy 
                                  TRUE                               TRUE 
                           coveredCall               coveredShortStraddle 
                                  TRUE                               TRUE 
                  coveredShortStrangle                          longCombo 
                                  TRUE                               TRUE 
                 modifiedCallButterfly               modifiedPutButterfly 
                                  TRUE                               TRUE 
                        ratioPutSpread                           shortPut 
                                  TRUE                               TRUE 
                         strapStrategy                      syntheticCall 
                                  TRUE                               TRUE 
                       zBearCallLadder zBuyingStockIndexFutureAtFairValue 
                                  TRUE                               TRUE 
...
| Execution Time | 2025-02-15 04:54:38 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1e7fee21_1739595273
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp76hTI4
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bullishTrader_v1.0.1-tikzDictionary"
