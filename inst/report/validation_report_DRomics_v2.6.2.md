# Validation Report - DRomics@2.6.2
...
| export_help | 23 |
| has_website | TRUE |
| has_maintainer | Aurelie Siberchicot <aurelie.siberchicot@univ-lyon1.fr> |
...
| 3   | grDevices            | Depends |
| 4   | DESeq2               | Depends |
| 5   | SummarizedExperiment | Depends |
| 6   | stats                | Imports |
| 7   | graphics             | Imports |
| 8   | ggplot2              | Imports |
| 9   | ggfortify            | Imports |
...
Overall the package has 23 exported objects. 23 are documented:
                    ...
                    bmdboot                 bmdcalc               bmdfilter 
                       TRUE                    TRUE                    TRUE 
                    bmdplot     bmdplotwithgradient continuousanchoringdata 
                       TRUE                    TRUE                    TRUE 
         continuousomicdata              curvesplot                  drcfit 
                       TRUE                    TRUE                    TRUE 
             ecdfplotwithCI        ecdfquantileplot      formatdata4DRomics 
                       TRUE                    TRUE                    TRUE 
                 itemselect         metabolomicdata          microarraydata 
                       TRUE                    TRUE                    TRUE 
                   omicdata             PCAdataplot             plotfit2pdf 
                       TRUE                    TRUE                    TRUE 
                 RNAseqdata            selectgroups         sensitivityplot 
                       TRUE                    TRUE                    TRUE 
                 targetplot               trendplot 
                       TRUE                    TRUE 
...
| Execution Time | 2025-02-18 04:47:10 UTC |
...
running this report
    ...
    PROCESSX_PS1bb45f8bc62a_1739854024
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpu7tNHU
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DRomics_v2.6.2-tikzDictionary"
