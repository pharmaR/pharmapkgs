# Validation Report - EDOtrans@0.2.5
...
| export_help          | 1                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jorn Lotsch <j.lotsch@em.uni-frankfurt.de>           |
...
| 2   | stats           | Imports |
| 3   | utils           | Imports |
| 4   | ABCanalysis     | Imports |
| 5   | opGMMassessment | Imports |
...
| Execution Time | 2025-02-19 03:43:14 UTC |
...
running this report
    ...
    PROCESSX_PS1d4545447edc_1739936588
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp7Y8RmI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EDOtrans_v0.2.5-tikzDictionary"
