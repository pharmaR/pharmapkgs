# Validation Report - curesurv@0.1.1
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Juste Goungounga <juste.goungounga@ehesp.fr>         |
...
Overall the package has 4 exported objects. 4 are documented:
    ...
    cumLexc_mul    curesurv     z_alpha       z_tau 
           TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-17 04:39:52 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6499aaa96_1739767187
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpqozKBc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_curesurv_v0.1.1-tikzDictionary"
