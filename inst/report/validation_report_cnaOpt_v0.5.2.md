# Validation Report - cnaOpt@0.5.2
...
Overall the package has 8 exported objects. 8 are documented:
          ...
          cnaOpt    conCovOpt     DNFbuild      ereduce findOutcomes  multipleMax 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
    reprodAssign    selectMax 
            TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:47:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bc324983d3c_1739681216
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpt2qN2X
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cnaOpt_v0.5.2-tikzDictionary"
