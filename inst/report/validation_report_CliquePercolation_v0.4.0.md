# Validation Report - CliquePercolation@0.4.0
...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Jens Lange <lange.jens@outlook.com>                  |
...
Overall the package has 8 exported objects. 8 are documented:
                    ...
                    cpAlgorithm              cpColoredGraph 
                           TRUE                        TRUE 
               cpCommunityGraph cpCommunitySizeDistribution 
                           TRUE                        TRUE 
               cpPermuteEntropy                 cpThreshold 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-16 04:34:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3269e4130_1739680438
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpR8B150
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CliquePercolation_v0.4.0-tikzDictionary"
