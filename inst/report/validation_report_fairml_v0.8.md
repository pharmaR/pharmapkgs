...
Overall the package has 12 exported objects. 12 are documented:
                 ...
                 cv.folds               cv.loss         cv.unfairness 
                     TRUE                  TRUE                  TRUE 
                fairml.cv fairness.profile.plot                 fgrrm 
                     TRUE                  TRUE                  TRUE 
                     frrm                  nclm                   zlm 
                     TRUE                  TRUE                  TRUE 
                 zlm.orig                  zlrm             zlrm.orig 
                     TRUE                  TRUE                  TRUE 
...
| Execution Time | 2025-02-19 05:08:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d4510975690_1739941684
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp078kV1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fairml_v0.8-tikzDictionary"
