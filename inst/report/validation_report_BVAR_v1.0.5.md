...
| export_help          | 28                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Nikolas Kuschnig <nikolas.kuschnig@wu.ac.at> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/nk027/bvar                |
...
Overall the package has 28 exported objects. 28 are documented:
             ...
             bv_alpha          bv_dummy          bv_fcast            bv_irf 
                 TRUE              TRUE              TRUE              TRUE 
            bv_lambda     bv_metropolis             bv_mh      bv_minnesota 
                 TRUE              TRUE              TRUE              TRUE 
                bv_mn         bv_priors            bv_psi            bv_soc 
                 TRUE              TRUE              TRUE              TRUE 
               bv_sur              bvar         companion              fevd 
                 TRUE              TRUE              TRUE              TRUE 
               fevd<-         fred_code    fred_transform       hist_decomp 
                 TRUE              TRUE              TRUE              TRUE 
    independent_index               irf             irf<-               lps 
                 TRUE              TRUE              TRUE              TRUE 
             par_bvar         predict<-              rmse              WAIC 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-15 04:57:10 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7fafaa9e_1739595424
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxwWv8v
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BVAR_v1.0.5-tikzDictionary"
