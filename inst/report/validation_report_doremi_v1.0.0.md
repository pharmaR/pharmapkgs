# Validation Report - doremi@1.0.0
...
| export_help          | 11                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Mongin Denis <Denis.Mongin@unige.ch>   |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/dcourvoisier/doremi |
...
Overall the package has 11 exported objects. 11 are documented:
           ...
           analyze.1order        analyze.2order         calculate.fda 
                     TRUE                  TRUE                  TRUE 
           calculate.glla        calculate.gold       generate.1order 
                     TRUE                  TRUE                  TRUE 
          generate.2order   generate.excitation generate.panel.1order 
                     TRUE                  TRUE                  TRUE 
    generate.panel.2order         optimum_param 
                     TRUE                  TRUE 
...
| Execution Time | 2025-02-18 04:34:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4616fd361_1739853291
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6qielE
...
These are the options set to generate the report:
    ...
    [1] "validation_report_doremi_v1.0.0-tikzDictionary"
