# Validation Report - ecospace@1.4.2
...
| export_help          | 10                                                |
| has_website          | TRUE                                              |
| has_maintainer       | Phil Novack-Gottshall <pnovack-gottshall@ben.edu> |
| bugs_status          | 0.7142857                                         |
| has_source_control   | https://github.com/pnovack-gottshall/ecospace     |
...
Overall the package has 10 exported objects. 10 are documented:
       ...
       calc_metrics create_ecospace       expansion         neutral    partitioning 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          prep_data    rbind_listdf      redundancy         sample2         unique2 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 03:36:58 UTC |
...
running this report
    ...
    PROCESSX_PS1d45716bfb3c_1739936212
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp192sW3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecospace_v1.4.2-tikzDictionary"
