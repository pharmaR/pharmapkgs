# Validation Report - distances@0.1.11
...
| export_help          | 6                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Fredrik Savje <rpackages@fredriksavje.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/fsavje/distances        |
...
colorrepel, GeomArchetypal, imcRtools, manydist, mistyR, quickblock,
quickmatch, scclust, SpatialBSS, StempCens

## Namespace

Overall the package has 6 exported objects. 6 are documented:

           distance_columns         distance_matrix               distances 
                       TRUE                    TRUE                    TRUE 
               is.distances     max_distance_search nearest_neighbor_search 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-18 04:17:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42d4888a9_1739852236
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpm1mN7c
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distances_v0.1.11-tikzDictionary"
