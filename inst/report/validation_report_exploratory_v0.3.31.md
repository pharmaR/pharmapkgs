# Validation Report - exploratory@0.3.31
...
| export_help          | 26                           |
| has_website          | TRUE                         |
| has_maintainer       | Jin Kim <jin.m.kim@yale.edu> |
...
Overall the package has 26 exported objects. 26 are documented:
      ...
      cohen_d_from_cohen_textbook                compare_groups 
                             TRUE                          TRUE 
                       desc_stats           desc_stats_by_group 
                             TRUE                          TRUE 
                      exploratory                     histogram 
                             TRUE                          TRUE 
               histogram_by_group            id_across_datasets 
                             TRUE                          TRUE 
                         kurtosis                  mann_whitney 
                             TRUE                          TRUE 
               mediation_analysis         merge_data_table_list 
                             TRUE                          TRUE 
                merge_data_tables           multiple_regression 
                             TRUE                          TRUE 
    order_rows_specifically_in_dt                          prep 
                             TRUE                          TRUE 
             pretty_round_p_value                      read_csv 
                             TRUE                          TRUE 
                      scatterplot                    se_of_mean 
                             TRUE                          TRUE 
                         skewness               t_test_pairwise 
                             TRUE                          TRUE 
                  tabulate_vector                     theme_kim 
                             TRUE                          TRUE 
               update_exploratory        wilcoxon_rank_sum_test 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-19 04:53:16 UTC |
...
running this report
    ...
    PROCESSX_PS1d456edc18a9_1739940790
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprrjQOJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_exploratory_v0.3.31-tikzDictionary"
