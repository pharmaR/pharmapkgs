...
| export_help          | 26                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Krzysztof Kania <contact@krzysztofkania.com> |
...
| 10  | ggplot2     | Imports |
| 11  | ggpubr      | Imports |
| 12  | randomcoloR | Imports |
| 13  | purrr       | Imports |
| 14  | sf          | Imports |
| 15  | tmaptools   | Imports |
| 16  | tmap        | Imports |
| 17  | progress    | Imports |
...
Overall the package has 26 exported objects. 26 are documented:
                   ...
                   attribute_info                  generate_map 
                             TRUE                          TRUE 
                   get_aggregates                get_attributes 
                             TRUE                          TRUE 
                 get_data_by_unit     get_data_by_unit_locality 
                             TRUE                          TRUE 
             get_data_by_variable get_data_by_variable_locality 
                             TRUE                          TRUE 
                       get_levels                get_panel_data 
                             TRUE                          TRUE 
                      get_request                  get_subjects 
                             TRUE                          TRUE 
              get_unit_localities                     get_units 
                             TRUE                          TRUE 
                    get_variables                     line_plot 
                             TRUE                          TRUE 
                         pie_plot             scatter_2var_plot 
                             TRUE                          TRUE 
                  search_subjects        search_unit_localities 
                             TRUE                          TRUE 
                     search_units              search_variables 
                             TRUE                          TRUE 
                     subject_info                     unit_info 
                             TRUE                          TRUE 
               unit_locality_info                 variable_info 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-15 03:48:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1956fe6a_1739591289
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbESW3b
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bdl_v1.0.5-tikzDictionary"
