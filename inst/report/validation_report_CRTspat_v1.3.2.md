# Validation Report - CRTspat@1.3.2
...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Thomas Smith <Thomas-a.Smith@unibas.ch>              |
...
| 10  | sf              | Imports |
| 11  | Matrix          | Imports |
| 12  | spatstat.geom   | Imports |
| 13  | spatstat.random | Imports |
| 14  | jagsUI          | Imports |
| 15  | TSP             | Imports |
| 16  | gee             | Imports |
| 17  | sp              | Imports |
...
Overall the package has 15 exported objects. 15 are documented:
        ...
        aggregateCRT   anonymize_site compute_distance     compute_mesh 
                TRUE             TRUE             TRUE             TRUE 
         CRTanalysis         CRTpower            CRTsp         CRTwrite 
                TRUE             TRUE             TRUE             TRUE 
       latlong_as_xy          plotCRT     randomizeCRT         readdata 
                TRUE             TRUE             TRUE             TRUE 
         simulateCRT   specify_buffer specify_clusters 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:27:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6233c1872_1739766436
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpqjc5lt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CRTspat_v1.3.2-tikzDictionary"
