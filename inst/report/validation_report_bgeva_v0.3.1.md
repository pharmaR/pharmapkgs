...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Giampiero Marra <giampiero.marra@ucl.ac.uk>          |
...
Overall the package has 10 exported objects. 10 are documented:
              ...
              bg.checks               bgeva          bgeva.gIMa          bgeva.gIMb 
                   TRUE                TRUE                TRUE                TRUE 
             plot.bgeva         print.bgeva print.summary.bgeva                 S.m 
                   TRUE                TRUE                TRUE                TRUE 
          summary.bgeva        working.comp 
                   TRUE                TRUE 

### Examples

There are 5 help pages with examples, from 10 (50.00 %).
...
| Execution Time | 2025-02-22 03:15:37 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb4a22f44_1740194133
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmptgb1jF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bgeva_v0.3.1-tikzDictionary"
