# Validation Report - cumulcalib@0.0.1
...
| export_help          | 7                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Mohsen Sadatsafavi <mohsen.sadatsafavi@ubc.ca>       |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/resplab/cumulcalib                |
...
Overall the package has 7 exported objects. 7 are documented:
     ...
     cumulcalib pKolmogorov     pMAD_BM   pMAD_BM_c qKolmogorov     qMAD_BM 
...
| Execution Time | 2025-02-17 04:39:03 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6437ef01e_1739767137
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvRRNNk
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cumulcalib_v0.0.1-tikzDictionary"
