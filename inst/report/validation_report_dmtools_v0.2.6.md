# Validation Report - dmtools@0.2.6
...
| export_help          | 10                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Konstantin Ryabov <chachabooms@gmail.com>   |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/KonstantinRyabov/dmtools |
...
| 3   | readxl (\>= 1.3.1)    | Imports |
| 4   | purrr (\>= 0.3.3)     | Imports |
| 5   | lubridate (\>= 1.7.4) | Imports |
| 6   | httr (\>= 1.4.1)      | Imports |
| 7   | tidyr (\>= 1.1.0)     | Imports |
| 8   | tibble (\>= 3.0.1)    | Imports |
| 9   | progress (\>= 1.2.2)  | Imports |
...
Overall the package has 10 exported objects. 10 are documented:
             ...
             check    choose_test           date     get_result            lab 
              TRUE           TRUE           TRUE           TRUE           TRUE 
        list_parse    meddra_auth    meddra_post rename_dataset          short 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:28:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bb43f5d6414_1739852900
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWDpnwI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dmtools_v0.2.6-tikzDictionary"
