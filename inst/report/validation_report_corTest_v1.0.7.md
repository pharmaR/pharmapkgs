# Validation Report - corTest@1.0.7
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Danyang Yu <dyu33@jhu.edu>                           |
...
Overall the package has 12 exported objects. 12 are documented:
       ...
       construct_network fisher_transfer_test        generate_data 
                    TRUE                 TRUE                 TRUE 
                 genEset               ghdist          plotDiffCor 
                    TRUE                 TRUE                 TRUE 
                     st1                  st2                  st3 
                    TRUE                 TRUE                 TRUE 
                     st4                  st5                  st6 
...
| Execution Time | 2025-02-17 04:02:01 UTC |
...
running this report
    ...
    PROCESSX_PS1bd63b0db80f_1739764916
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAGhJUW
...
These are the options set to generate the report:
    ...
    [1] "validation_report_corTest_v1.0.7-tikzDictionary"
