# Validation Report - ColombiAPI@0.1.1
...
| bugs_status          | 0                                                  |
| has_source_control   | https://github.com/lightbluetitan/colombiapi       |
...
Overall the package has 14 exported objects. 14 are documented:
          ...
          Bogota_airstations_df        Bogota_business_Date 
                           TRUE                        TRUE 
           Bogota_holidays_Date         Bogota_malls_tbl_df 
                           TRUE                        TRUE 
       Cannabis_Licenses_tbl_df      Colombia_coffee_tbl_df 
                           TRUE                        TRUE 
              get_airports_list           get_Colombia_info 
                           TRUE                        TRUE 
           get_departments_list         get_presidents_list 
                           TRUE                        TRUE 
               get_regions_list        Medellin_rain_tbl_df 
                           TRUE                        TRUE 
    Tulua_Public_Schools_tbl_df               view_datasets 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-17 03:32:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6269ce780_1739763119
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHrpUOi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ColombiAPI_v0.1.1-tikzDictionary"
