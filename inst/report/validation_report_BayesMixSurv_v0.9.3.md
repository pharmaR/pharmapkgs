# Validation Report - BayesMixSurv@0.9.3
...
Overall the package has 6 exported objects. 6 are documented:
                                 ...
                                 bayesmixsurv 
                                         TRUE 
                         bayesmixsurv.control 
                                         TRUE 
                        bayesmixsurv.crossval 
                                         TRUE 
                bayesmixsurv.crossval.wrapper 
                                         TRUE 
                  bayesmixsurv.generate.folds 
                                         TRUE 
    bayesmixsurv.generate.folds.eventbalanced 
                                         TRUE 
...
| Execution Time | 2025-02-15 03:38:13 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd96aa9ef_1739590689
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpR5LhaQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesMixSurv_v0.9.3-tikzDictionary"
