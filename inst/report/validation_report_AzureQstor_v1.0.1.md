...
| size_codebase                   | 284                                 |
| has_source_control              | https://github.com/Azure/AzureQstor |
...
Overall the package has 7 exported objects. 7 are documented:
    ...
    create_storage_queue delete_storage_queue  list_storage_queues 
                    TRUE                 TRUE                 TRUE 
          queue_endpoint         QueueMessage        storage_queue 
                    TRUE                 TRUE                 TRUE 
            StorageQueue 
                    TRUE 
...
| Execution Time | 2025-02-14 07:38:03 UTC |
...
running this report
    ...
    PROCESSX_PS1c09744cb39c_1739518680
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpUmy0LY
