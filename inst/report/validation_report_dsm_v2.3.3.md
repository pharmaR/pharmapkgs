...
| export_help          | 22                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Laura Marshall <lhm@st-andrews.ac.uk>      |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/DistanceDevelopment/dsm |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | mgcv (\>= 1.8-23) | Depends |
| 2   | mrds (\>= 2.1.16) | Depends |
| 3   | numDeriv          | Depends |
| 4   | nlme              | Imports |
| 5   | ggplot2           | Imports |
| 6   | plyr              | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
                        ...
                        dsm                 dsm_cor             dsm_var_gam 
                       TRUE                    TRUE                    TRUE 
             dsm_var_movblk            dsm_var_prop             dsm_varprop 
                       TRUE                    TRUE                    TRUE 
                    dsm.cor             dsm.var.gam          dsm.var.movblk 
                       TRUE                    TRUE                    TRUE 
               dsm.var.prop               dummy_ddf generate.ds.uncertainty 
                       TRUE                    TRUE                    TRUE 
         generate.mb.sample              latlong2km           make.soapgrid 
                       TRUE                    TRUE                    TRUE 
                    obs_exp       plot_pred_by_term             rqgam_check 
                       TRUE                    TRUE                    TRUE 
                rqgam.check                trim.var          vis_concurvity 
                       TRUE                    TRUE                    TRUE 
             vis.concurvity 
                       TRUE 
...
| Execution Time | 2025-02-18 04:51:45 UTC |
...
running this report
    ...
    PROCESSX_PS1bb454e3c759_1739854299
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5TgJ8Y
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsm_v2.3.3-tikzDictionary"
