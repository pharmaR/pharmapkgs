...
Overall the package has 10 exported objects. 10 are documented:
              ...
              ANMC_Gauss conservativeEstimate       get_chronotime 
                    TRUE                 TRUE                 TRUE 
                MC_Gauss          mvrnormArma             ProbaMax 
                    TRUE                 TRUE                 TRUE 
                ProbaMin     selectActiveDims          selectQdims 
                    TRUE                 TRUE                 TRUE 
       trmvrnorm_rej_cpp 
                    TRUE 
...
| Execution Time | 2025-02-14 06:55:13 UTC |
...
running this report
    ...
    PROCESSX_PS726ded24249_1739516111
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpd1o8UU
