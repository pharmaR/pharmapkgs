# Validation Report - detector@0.1.0
...
| export_help          | 7                                            |
| has_website          | TRUE                                         |
| has_maintainer       | Paul Hendricks <paul.hendricks.2013@owu.edu> |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/paulhendricks/detector    |
...
Overall the package has 7 exported objects. 7 are documented:
                                 ...
                                 detect                 has_email_addresses 
                                   TRUE                                TRUE 
    has_national_identification_numbers                   has_phone_numbers 
                                   TRUE                                TRUE 
                       is_email_address   is_national_identification_number 
                                   TRUE                                TRUE 
                        is_phone_number 
                                   TRUE 
...
| Execution Time | 2025-02-18 03:49:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46943a32a_1739850585
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbgtQsm
...
These are the options set to generate the report:
    ...
    [1] "validation_report_detector_v0.1.0-tikzDictionary"
