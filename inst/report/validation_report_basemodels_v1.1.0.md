# Validation Report - basemodels@1.1.0
...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Ying-Ju Chen <ychen4@udayton.edu>                    |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 236                                                  |
| has_source_control   | https://github.com/Ying-Ju/basemodels                |
...
Overall the package has 6 exported objects. 6 are documented:
            ...
            dummy_classifier          dummy_regressor          dummyClassifier 
                        TRUE                     TRUE                     TRUE 
              dummyRegressor predict_dummy_classifier  predict_dummy_regressor 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-14 07:44:18 UTC |
...
running this report
    ...
    PROCESSX_PS1c0975707a6a_1739519055
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIdfBp7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_basemodels_v1.1.0-tikzDictionary"
