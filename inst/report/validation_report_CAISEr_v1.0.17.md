# Validation Report - CAISEr@1.0.17
...
| 2   | parallel (\>= 3.5.1)   | Imports |
| 3   | pbmcapply (\>= 1.4.1)  | Imports |
| 4   | ggplot2 (\>= 3.1.1)    | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
                       ...
                       boot_sdm              calc_instances 
                           TRUE                        TRUE 
                     calc_nreps                     calc_se 
                           TRUE                        TRUE 
    consolidate_partial_results                   dummyalgo 
                           TRUE                        TRUE 
                  dummyinstance                example_SANN 
                           TRUE                        TRUE 
               get_observations              run_experiment 
                           TRUE                        TRUE 
                        se_boot                    se_param 
                           TRUE                        TRUE 
                       TSP.dist 
...
| Execution Time | 2025-02-16 03:33:47 UTC |
...
running this report
    ...
    PROCESSX_PS1bc339427e47_1739676822
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpwXlwNi
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CAISEr_v1.0.17-tikzDictionary"
