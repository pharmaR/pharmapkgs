...
| export_help          | 11                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jae H. Kim <jaekim8080@gmail.com>                    |
...
Overall the package has 11 exported objects. 11 are documented:
       ...
       Andrews.Chen         ARorder BootAfterBootPI          BootBC          BootPI 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              LS.AR       Plot.Fore         Plot.PI      Roy.Fuller  ShamanStine.PI 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       Stine.Shaman 
               TRUE 
...
| Execution Time | 2025-02-15 04:34:20 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd59e5080_1739594055
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp36k7GN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BootPR_v1.0-tikzDictionary"
