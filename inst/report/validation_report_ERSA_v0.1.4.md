...
| export_help          | 15                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Catherine B. Hurley <catherine.hurley@mu.ie>         |
...
Overall the package has 15 exported objects. 15 are documented:
        ...
        add1_models       bselOrder    drop1_models      exploreReg       fselOrder 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            pcpPlot  plotAnovaStats     plotCIStats       plotSeqSS      plottStats 
               TRUE            TRUE            TRUE            TRUE            TRUE 
          pvalOrder randomPredOrder regsubsetsOrder    revPredOrder     termColours 
               TRUE            TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 04:28:11 UTC |
...
running this report
    ...
    PROCESSX_PS1d456e4671de_1739939285
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHRvGnf
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ERSA_v0.1.4-tikzDictionary"
