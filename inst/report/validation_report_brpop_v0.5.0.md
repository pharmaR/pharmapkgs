...
| export_help | 16 |
| has_website | TRUE |
| has_maintainer | Raphael Saldanha <raphael.de-freitas-saldanha@inria.fr> |
...
Overall the package has 16 exported objects. 15 are documented:
                         ...
                         FALSE                       TRUE 
           mun_male_pop_totals                mun_pop_age 
                          TRUE                       TRUE 
                mun_pop_totals                mun_sex_pop 
                          TRUE                       TRUE 
    regsaude_female_pop_totals   regsaude_male_pop_totals 
                          TRUE                       TRUE 
              regsaude_pop_age        regsaude_pop_totals 
                          TRUE                       TRUE 
              regsaude_sex_pop       uf_female_pop_totals 
                          TRUE                       TRUE 
            uf_male_pop_totals                 uf_pop_age 
                          TRUE                       TRUE 
                 uf_pop_totals                 uf_sex_pop 
                          TRUE                       TRUE 
...
| Execution Time | 2025-02-15 04:46:51 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd24bec056_1739594806
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpmIwh9m
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brpop_v0.5.0-tikzDictionary"
