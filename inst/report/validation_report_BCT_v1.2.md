...
| export_help | 17 |
| has_website | FALSE |
| has_maintainer | Valentinian Mihai Lungu <valentinian.mihai@gmail.com> |
...
Overall the package has 17 exported objects. 17 are documented:
                                      ...
                                      BCT calculate_exact_changepoint_posterior 
                                     TRUE                                  TRUE 
                           compute_counts                                   CTW 
                                     TRUE                                  TRUE 
                              draw_models                         generate_data 
                                     TRUE                                  TRUE 
                 infer_fixed_changepoints            infer_unknown_changepoints 
                           ...
                           MAP_parameters                                    ML 
                                     TRUE                                  TRUE 
               plot_changepoint_posterior plot_individual_changepoint_posterior 
                                     TRUE                                  TRUE 
                               prediction                             show_tree 
                                     TRUE                                  TRUE 
                            zero_one_loss 
                                     TRUE 
...
| Execution Time | 2025-02-15 03:47:27 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd20da8c5e_1739591243
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVKGs9C
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BCT_v1.2-tikzDictionary"
