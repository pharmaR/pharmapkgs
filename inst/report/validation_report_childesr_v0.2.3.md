# Validation Report - childesr@0.2.3
...
| export_help          | 13                                  |
| has_website          | TRUE                                |
| has_maintainer       | Mika Braginsky <mika.br@gmail.com>  |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/langcog/childesr |
...
|:----|:---------------------|:--------|
| 1   | DBI (\>= 1.1)        | Imports |
| 2   | dbplyr (\>= 2.1)     | Imports |
| 3   | dplyr (\>= 1.0)      | Imports |
| 4   | jsonlite (\>= 1.7)   | Imports |
| 5   | magrittr (\>= 2.0)   | Imports |
| 6   | purrr (\>= 0.3)      | Imports |
| 7   | RMySQL (\>= 0.10.21) | Imports |
...
Overall the package has 13 exported objects. 13 are documented:
         ...
         clear_connections     connect_to_childes        get_collections 
                      TRUE                   TRUE                   TRUE 
              get_contexts            get_corpora            get_db_info 
                      TRUE                   TRUE                   TRUE 
          get_participants get_speaker_statistics          get_sql_query 
                      TRUE                   TRUE                   TRUE 
                get_tokens        get_transcripts              get_types 
                      TRUE                   TRUE                   TRUE 
            get_utterances 
                      TRUE 
...
| Execution Time | 2025-02-16 04:13:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bc318d64c2d_1739679182
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpezNbvl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_childesr_v0.2.3-tikzDictionary"
