...
| export_help          | 26                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | James Foadi <j.foadi@bath.ac.uk>                     |
...
Overall the package has 26 exported objects. 26 are documented:
                ...
                atom_gauss               choose_a            diffraction 
                      TRUE                   TRUE                   TRUE 
                       erf         expand_to_cell       fluorescent_scan 
                      TRUE                   TRUE                   TRUE 
                  fousynth              heaviside            invfousynth 
                      TRUE                   TRUE                   TRUE 
                    kgauss    load_anomalous_data              load_data 
                      TRUE                   TRUE                   TRUE 
            load_structure           local_maxima plot_absorption_curves 
                      TRUE                   TRUE                   TRUE 
                    read_h                 read_x          reduce_to_asu 
                      TRUE                   TRUE                   TRUE 
                    scafac                  sfobs      standardise_fdata 
                      TRUE                   TRUE                   TRUE 
         standardise_sdata        structure_gauss                strufac 
                      TRUE                   TRUE                   TRUE 
                   write_h                write_x 
                      TRUE                   TRUE 
...
| Execution Time | 2025-02-17 04:22:11 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6be95ceb_1739766126
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpOWPMQD
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crone_v0.1.1-tikzDictionary"
