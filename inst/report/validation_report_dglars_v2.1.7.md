# Validation Report - dglars@2.1.7
...
| export_help          | 33                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Luigi Augugliaro <luigi.augugliaro@unipa.it>         |
...
Overall the package has 33 exported objects. 33 are documented:
             ...
             AIC.dglars          BIC.dglars       coef.cvdglars         coef.dglars 
                   TRUE                TRUE                TRUE                TRUE 
               cvdglars        cvdglars_ccd         cvdglars_pc        cvdglars.fit 
                   TRUE                TRUE                TRUE                TRUE 
            d2mu_de2_mk        d2th_dmu2_mk              dglars          dglars_ccd 
                   TRUE                TRUE                TRUE                TRUE 
              dglars_pc          dglars.fit                 gdf                grcv 
                   TRUE                TRUE                TRUE                TRUE 
          logLik.dglars         make_action           make_coef       make_cvdglars 
                   TRUE                TRUE                TRUE                TRUE 
            make_dglars             make_ru  make_summary_table              phihat 
                   TRUE                TRUE                TRUE                TRUE 
          plot.cvdglars         plot.dglars      predict.dglars      print.cvdglars 
                   TRUE                TRUE                TRUE                TRUE 
           print.dglars    print.gof_dglars print.loglik_dglars             setDiff 
                   TRUE                TRUE                TRUE                TRUE 
         summary.dglars 
                   TRUE 
...
| Execution Time | 2025-02-18 03:56:13 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4402c09fd_1739850967
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCfplB5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dglars_v2.1.7-tikzDictionary"
