...
| export_help          | 6                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Emily Weiser <emily.l.weiser@gmail.com>              |
...
Overall the package has 6 exported objects. 6 are documented:
    ...
    agerepro.summary          aRetain  aRetain.summary    indiv.summary 
                TRUE             TRUE             TRUE             TRUE 
         LRS.summary pedigree.summary 
                TRUE             TRUE 
...
| Execution Time | 2025-02-14 06:48:44 UTC |
...
running this report
    ...
    PROCESSX_PS726d47f09e53_1739515721
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9DaShg
