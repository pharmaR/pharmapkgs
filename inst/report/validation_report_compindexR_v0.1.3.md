# Validation Report - compindexR@0.1.3
...
| export_help          | 0                                      |
| has_website          | TRUE                                   |
| has_maintainer       | Olgun Aydin <olgun.aydin@pg.edu.pl>    |
| bugs_status          | 0.8                                    |
| has_source_control   | https://github.com/olgnaydn/compindexR |
...
|:----|:------------------|:--------|
| 1   | car (\>= 3.1.0)   | Depends |
| 2   | pracma(\>= 2.3.8) | Depends |
| 3   | dplyr(\>= 1.0.7)  | Depends |
| 4   | NlcOptim(\>= 0.6) | Depends |
...
| Execution Time | 2025-02-17 03:35:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67f7d3db9_1739763348
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpgF2UV7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_compindexR_v0.1.3-tikzDictionary"
