# Validation Report - extremeIndex@0.0.3
...
| export_help          | 16                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Maxime Taillardat <maxime.taillardat@meteo.fr>       |
...
Overall the package has 16 exported objects. 4 are documented:

              .dEGP             .dG      .gp.pw.fit           .pEGP             .pG 
              FALSE           FALSE           FALSE           FALSE           FALSE 
               .PWM           .qEGP             .qG .qgpd.fullrange          .qgpd2 
              FALSE           FALSE           FALSE           FALSE           FALSE 
              .rEGP             .rG     choosethres      index.plot       indexclim 
...
| Execution Time | 2025-02-19 04:57:39 UTC |
...
running this report
    ...
    PROCESSX_PS1d4543fbed58_1739941053
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQDnVEG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_extremeIndex_v0.0.3-tikzDictionary"
