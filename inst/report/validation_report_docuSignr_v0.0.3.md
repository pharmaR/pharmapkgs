# Validation Report - docuSignr@0.0.3
...
| export_help          | 8                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Carl Ganz <carl@cannadatasolutions.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/CannaData/docuSignr  |
...
Overall the package has 8 exported objects. 8 are documented:
           ...
           docu_download   docu_embedded_send   docu_embedded_sign 
                    TRUE                 TRUE                 TRUE 
           docu_envelope docu_envelope_status  docu_list_envelopes 
                    TRUE                 TRUE                 TRUE 
              docu_login       docu_templates 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-18 04:32:04 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42d2d3b94_1739853118
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpN3DEUA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_docuSignr_v0.0.3-tikzDictionary"
