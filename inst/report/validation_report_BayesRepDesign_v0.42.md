# Validation Report - BayesRepDesign@0.42
...
| export_help          | 22                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Samuel Pawel <samuel.pawel@uzh.ch>        |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/SamCH93/BayesRepDesign |
...
Overall the package has 22 exported objects. 22 are documented:
         ...
         designPrior             pors         porsBF01          porsBFr 
                TRUE             TRUE             TRUE             TRUE 
             porsBFs          porsEqu         porsMeta           porsPs 
                TRUE             TRUE             TRUE             TRUE 
             porsSig         porsTOST             se2n              ssd 
                TRUE             TRUE             TRUE             TRUE 
             ssdBF01           ssdBFr           ssdBFs           ssdEqu 
                TRUE             TRUE             TRUE             TRUE 
             ssdMeta            ssdPs           ssdSig          ssdTOST 
                TRUE             TRUE             TRUE             TRUE 
       successRegion successRegionSig 
                TRUE             TRUE 
...
| Execution Time | 2025-02-15 03:40:27 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1783d7e7_1739590823
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHkigxb
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesRepDesign_v0.42-tikzDictionary"
