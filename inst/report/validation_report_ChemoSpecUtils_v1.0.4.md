# Validation Report - ChemoSpecUtils@1.0.4
...
| has_source_control   | https://github.com/bryanhanson/ChemoSpecUtils |
...
ChemoSpec, ChemoSpec2D

## Namespace

Overall the package has 41 exported objects. 41 are documented:

               .addEllipseInfo                 .addLegend 
                          TRUE                       TRUE 
                    .addMethod                   .chkArgs 
                          TRUE                       TRUE 
           .chkReqGraphicsPkgs                   .colLeaf 
                          TRUE                       TRUE 
              .computeEllipses                  .distPlot 
                          TRUE                       TRUE 
                 .drawEllipses                .drawPoints 
                          TRUE                       TRUE 
                    .extraData                    .findNA 
                          TRUE                       TRUE 
             .getExtremeCoords                 .getLimits 
                          TRUE                       TRUE 
              .getVarExplained               .ggAddLegend 
                          TRUE                       TRUE 
                   .ggAnnotate                   .ggRepel 
                          TRUE                       TRUE 
                  .groupNcolor             .labelExtremes 
                          TRUE                       TRUE 
                      .plotHCA          .prepLegendCoords 
                          TRUE                       TRUE 
                    .remGrpSam                 .scorePlot 
                          TRUE                       TRUE 
                   .shrinkLeaf                 check4Gaps 
                          TRUE                       TRUE 
    checkForPackageWithVersion             chkGraphicsOpt 
                          TRUE                       TRUE 
                    chkSpectra               conColScheme 
                          TRUE                       TRUE 
                     hcaScores                 plotScores 
                          TRUE                       TRUE 
                     plotScree                 removeFreq 
                          TRUE                       TRUE 
                   removeGroup               removeSample 
                          TRUE                       TRUE 
                       rowDist                 sampleDist 
                          TRUE                       TRUE 
                     sumGroups                 sumSpectra 
                          TRUE                       TRUE 
                  updateGroups 
                          TRUE 
...
| Execution Time | 2025-02-16 04:11:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32ea119cf_1739679110
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPiIPpC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ChemoSpecUtils_v1.0.4-tikzDictionary"
