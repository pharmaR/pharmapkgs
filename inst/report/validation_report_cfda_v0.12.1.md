...
| export_help          | 22                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Quentin Grimonprez <quentingrim@yahoo.fr> |
| bugs_status          | 0.7857143                                 |
...
Overall the package has 22 exported objects. 21 are documented:
                       ...
                       .onAttach             compute_duration 
                           FALSE                         TRUE 
            compute_number_jumps     compute_optimal_encoding 
                            TRUE                         TRUE 
              compute_time_spent                 convertToCfd 
                            TRUE                         TRUE 
                        cut_data              estimate_Markov 
                            TRUE                         TRUE 
                     estimate_pt              generate_2State 
                            TRUE                         TRUE 
                 generate_Markov                 get_encoding 
                            TRUE                         TRUE 
                       get_state                  matrixToCfd 
                            TRUE                         TRUE 
                   plotComponent                     plotData 
                            TRUE                         TRUE 
                 plotEigenvalues plotIndicatorsReconstruction 
                            TRUE                         TRUE 
           reconstructIndicators     remove_duplicated_states 
                            TRUE                         TRUE 
                      statetable                  summary_cfd 
                            TRUE                         TRUE 
...
| Execution Time | 2025-02-16 04:04:05 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3224fb4cf_1739678640
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpDHTC1g
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cfda_v0.12.1-tikzDictionary"
