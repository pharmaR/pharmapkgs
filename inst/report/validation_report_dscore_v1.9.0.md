# Validation Report - dscore@1.9.0
...
| export_help          | 15                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Stef van Buuren <stef.vanbuuren@tno.nl> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/d-score/dscore       |
...
Overall the package has 15 exported objects. 15 are documented:
               ...
               count_mu                 daz decompose_itemnames              dscore 
                   TRUE                TRUE                TRUE                TRUE 
       dscore_posterior  get_age_equivalent       get_itemnames       get_itemtable 
                   TRUE                TRUE                TRUE                TRUE 
             get_labels       get_reference             get_tau     order_itemnames 
                   TRUE                TRUE                TRUE                TRUE 
       rename_gcdg_gsed      sort_itemnames                 zad 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 04:50:22 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4594b4952_1739854216
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpa7eLi1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dscore_v1.9.0-tikzDictionary"
