# Validation Report - easycsv@1.0.8
...
| export_help          | 7                                 |
| has_website          | TRUE                              |
| has_maintainer       | Dror Bogin <dror.bogin@gmail.com> |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/bogind/easycsv |
...
gimmeTools, PanViz, SemNetCleaner, SemNetDictionaries, uniset

## Namespace

Overall the package has 7 exported objects. 7 are documented:

           choose_dir      fread_folder         fread_zip       Identify.OS 
                 TRUE              TRUE              TRUE              TRUE 
        loadcsv_multi    loadcsvfromZIP loadZIPcsvfromURL 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-18 05:11:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4641b0496_1739855469
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTFNe1V
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easycsv_v1.0.8-tikzDictionary"
