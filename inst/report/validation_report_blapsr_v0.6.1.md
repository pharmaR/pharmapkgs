# Validation Report - blapsr@0.6.1
...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | survival (\>= 2.44.1) | Depends |
| 2   | coda (\>= 0.19.3)     | Imports |
| 3   | graphics(\>= 3.6.0)   | Imports |
| 4   | MASS (\>= 7.3.51)     | Imports |
| 5   | Matrix (\>= 1.2.17)   | Imports |
| 6   | RSpectra (\>= 0.16.0) | Imports |
| 7   | sn (\>= 1.5.4)        | Imports |
| 8   | stats                 | Imports |
| 9   | utils (\>= 3.6.0)     | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
           ...
           adjustPD           amlps          coxlps coxlps.baseline         cubicbs 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            curelps curelps.extract          gamlps              lt     penaltyplot 
               TRUE            TRUE            TRUE            TRUE            TRUE 
        simcuredata      simgamdata     simsurvdata              sm         snmatch 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                 st 
               TRUE 
...
There are 29 help pages with examples, from 33 (87.88 %).
...
| Execution Time | 2025-02-15 04:21:25 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7a334d26_1739593280
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvUUVLa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_blapsr_v0.6.1-tikzDictionary"
