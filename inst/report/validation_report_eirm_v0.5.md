...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Okan Bulut <bulut@ualberta.ca>                       |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/okanbulut/eirm                    |
...
| 8   | shinycssloaders | Imports |
| 9   | readxl          | Imports |
| 10  | ggeffects       | Imports |
| 11  | ggplot2         | Imports |
...
Overall the package has 5 exported objects. 4 are documented:
             ...
             %>%         eirm    eirmShiny marginalplot polyreformat 
...
| Execution Time | 2025-02-19 03:52:46 UTC |
...
running this report
    ...
    PROCESSX_PS1d45421225c0_1739937160
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSvgZFe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eirm_v0.5-tikzDictionary"
