# Validation Report - factory@0.1.0
...
| has_source_control   | https://github.com/jonthegeek/factory |
...
|     | package           | type    |
|:----|:------------------|:--------|
| 1   | purrr (\>= 0.3.2) | Imports |
| 2   | rlang (\>= 0.4.0) | Imports |
...
| Execution Time | 2025-02-19 05:06:08 UTC |
...
running this report
    ...
    PROCESSX_PS1d456395eb7_1739941562
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp4p87cV
...
These are the options set to generate the report:
    ...
    [1] "validation_report_factory_v0.1.0-tikzDictionary"
