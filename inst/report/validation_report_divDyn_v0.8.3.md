# Validation Report - divDyn@0.8.3
...
| export_help          | 32                                       |
| has_website          | FALSE                                    |
| has_maintainer       | Adam T. Kocsis <adam.t.kocsis@gmail.com> |
...
Overall the package has 32 exported objects. 32 are documented:
          ...
          affinity        binstat     categorize        cleansp       collapse 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            divDyn         fadlad           fill       georange        indices 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         matchtime       modeltab           omit          parts         ranges 
              TRUE           TRUE           TRUE           TRUE           TRUE 
         ratesplit       repmatch  seqduplicated         shades     singletons 
              TRUE           TRUE           TRUE           TRUE           TRUE 
             slice      streaklog      subsample     subtrialCR    subtrialOXW 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       subtrialSQS        sumstat      survivors       tabinate         tsbars 
              TRUE           TRUE           TRUE           TRUE           TRUE 
            tsplot whichmaxstreak 
              TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:22:16 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4338e8866_1739852530
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHoN1oI
...
These are the options set to generate the report:
    ...
    [1] "validation_report_divDyn_v0.8.3-tikzDictionary"
