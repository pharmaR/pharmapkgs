# Validation Report - fastR2@1.2.4
...
| export_help          | 18                                |
| has_website          | TRUE                              |
| has_maintainer       | Randall Pruim <rpruim@calvin.edu> |
| bugs_status          | subscript out of bounds           |
| has_source_control   | https://github.com/rpruim/fastR2  |
...
Overall the package has 18 exported objects. 18 are documented:
               ...
               col.fastR             col.perc               funvec 
                    TRUE                 TRUE                 TRUE 
                   geolm           givenOrder grid.identify.points 
                    TRUE                 TRUE                 TRUE 
             information              maxLik2                nlmax 
                    TRUE                 TRUE                 TRUE 
                   nlmin             row.perc              snippet 
                    TRUE                 TRUE                 TRUE 
                  SSplot                  tdf                 to2d 
                    TRUE                 TRUE                 TRUE 
                    vaov              wald.ci            wilson.ci 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-19 05:20:44 UTC |
...
running this report
    ...
    PROCESSX_PS1d457fdf7923_1739942438
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpSGpRv1
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fastR2_v1.2.4-tikzDictionary"
