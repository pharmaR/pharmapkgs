# Validation Report - fairness@1.2.2
...
| export_help          | 11                                    |
| has_website          | TRUE                                  |
| has_maintainer       | Nikita Kozodoi <n.kozodoi@icloud.com> |
...
Overall the package has 11 exported objects. 11 are documented:
          ...
          acc_parity       dem_parity       equal_odds       fnr_parity 
                TRUE             TRUE             TRUE             TRUE 
          fpr_parity       mcc_parity       npv_parity pred_rate_parity 
                TRUE             TRUE             TRUE             TRUE 
         prop_parity       roc_parity      spec_parity 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 05:08:25 UTC |
...
running this report
    ...
    PROCESSX_PS1d4516f110cf_1739941699
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplaQxiA
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fairness_v1.2.2-tikzDictionary"
