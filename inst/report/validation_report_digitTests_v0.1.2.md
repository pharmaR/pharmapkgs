# Validation Report - digitTests@0.1.2
...
| export_help          | 4                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Koen Derks <k.derks@nyenrode.nl>        |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/koenderks/digitTests |
...
Overall the package has 4 exported objects. 4 are documented:
       ...
       distr.btest     distr.test extract_digits        rv.test 
              TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:06:26 UTC |
...
running this report
    ...
    PROCESSX_PS1bb457f71d8c_1739851580
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfmhNIv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_digitTests_v0.1.2-tikzDictionary"
