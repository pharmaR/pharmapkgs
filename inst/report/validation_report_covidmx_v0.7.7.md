# Validation Report - covidmx@0.7.7
...
| export_help          | 25                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Rodrigo Zepeda-Tello <rzepeda17@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/RodrigoZepeda/covidmx   |
...
| 2   | DBI                | Imports |
| 3   | dplyr              | Imports |
| 4   | duckdb (\>= 0.4.0) | Imports |
| 5   | fs                 | Imports |
| 6   | pins (\>= 1.0.1)   | Imports |
| 7   | RCurl              | Imports |
| 8   | readr              | Imports |
| 9   | readxl             | Imports |
| 10  | rlang              | Imports |
...
| Execution Time | 2025-02-17 04:08:53 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6224f9b77_1739765328
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp3Bje6d
...
These are the options set to generate the report:
    ...
    [1] "validation_report_covidmx_v0.7.7-tikzDictionary"
