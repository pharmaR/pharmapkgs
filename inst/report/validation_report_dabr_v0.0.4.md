...
| export_help          | 13                                                  |
| has_website          | TRUE                                                |
| has_maintainer       | Roberto Villegas-Diaz <r.villegas-diaz@outlook.com> |
| bugs_status          | subscript out of bounds                             |
| has_source_control   | https://github.com/special-uor/dabr/                |
...
Overall the package has 13 exported objects. 12 are documented:
                ...
                %>%      attributes      close_conn          delete        get_attr 
              FALSE            TRUE            TRUE            TRUE            TRUE 
             insert    is.connected     list_tables open_conn_mysql           quote 
...
| Execution Time | 2025-02-17 04:49:37 UTC |
...
running this report
    ...
    PROCESSX_PS1bd67375acc8_1739767772
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQ1g50C
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dabr_v0.0.4-tikzDictionary"
