# Validation Report - CircSpaceTime@0.9.0
...
| export_help          | 12                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Mario Santoro <santoro.ma@gmail.com>       |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/santoroma/CircSpaceTime |
...
Overall the package has 12 exported objects. 12 are documented:
         ...
         APEcirc    ConvCheck     CRPScirc   ProjKrigSp ProjKrigSpTi       ProjSp 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        ProjSpTi    rose_diag   WrapKrigSp WrapKrigSpTi       WrapSp     WrapSpTi 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-16 04:21:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3600a41d5_1739679704
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp9bY0U9
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CircSpaceTime_v0.9.0-tikzDictionary"
