# Validation Report - bupaverse@0.1.0
...
| has_source_control | https://github.com/bupaverse/bupaverse/ |
...
|     | package                   | type    |
|:----|:--------------------------|:--------|
| 1   | bupaR (\>= 0.5.1)         | Imports |
| 2   | edeaR (\>= 0.9.1)         | Imports |
| 3   | eventdataR (\>= 0.3.1)    | Imports |
| 4   | processcheckR (\>= 0.1.4) | Imports |
| 5   | processmapR (\>= 0.5.2)   | Imports |
| 6   | purrr (\>= 0.3.4)         | Imports |
| 7   | magrittr (\>= 2.0.0)      | Imports |
| 8   | rlang (\>= 1.0.0)         | Imports |
| 9   | cli (\>= 3.2.0)           | Imports |
| 10  | glue (\>= 1.0.0)          | Imports |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    bupaverse_conflicts      bupaverse_logo  bupaverse_packages 
                   TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-15 04:55:42 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1a009e34_1739595337
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzmmzYl
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bupaverse_v0.1.0-tikzDictionary"
