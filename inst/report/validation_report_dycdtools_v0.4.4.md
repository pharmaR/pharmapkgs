# Validation Report - dycdtools@0.4.4
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Songyan Yu <yusongyan1989@gmail.com>                 |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/SongyanYu/dycdtools               |
...
Overall the package has 10 exported objects. 10 are documented:
         ...
         calib_assist change_input_file        ext_output          interpol 
                 TRUE              TRUE              TRUE              TRUE 
        objective_fun         plot_cont    plot_cont_comp         plot_prof 
                 TRUE              TRUE              TRUE              TRUE 
         plot_scatter           plot_ts 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-18 05:02:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bb42a57c0e0_1739854947
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbMEjac
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dycdtools_v0.4.4-tikzDictionary"
