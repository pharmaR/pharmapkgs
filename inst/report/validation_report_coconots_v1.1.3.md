# Validation Report - coconots@1.1.3
...
| 9   | JuliaConnectoR           | Imports   |
| 10  | Rcpp                     | LinkingTo |
| 11  | StanHeaders (\>= 2.21.0) | LinkingTo |
...
Overall the package has 9 exported objects. 9 are documented:
                ...
                autoplot             cocoBoot              cocoPit 
                    TRUE                 TRUE                 TRUE 
                 cocoReg            cocoResid            cocoScore 
                    TRUE                 TRUE                 TRUE 
                 cocoSim installJuliaPackages         setJuliaSeed 
                    TRUE                 TRUE                 TRUE 

### Examples

There are 9 help pages with examples, from 13 (69.23 %).
...
| Execution Time | 2025-02-16 04:49:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32d733560_1739681362
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoZM4Em
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coconots_v1.1.3-tikzDictionary"
