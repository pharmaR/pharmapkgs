# Validation Report - basicspace@0.25
...
| export_help          | 24                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Christopher Hare <cdhare@ucdavis.edu>                |
...
Overall the package has 24 exported objects. 24 are documented:
                  ...
                  aldmck             blackbox   blackbox_transpose 
                    TRUE                 TRUE                 TRUE 
             boot_aldmck         boot_blackbt                  fit 
                    TRUE                 TRUE                 TRUE 
             individuals          plot.aldmck          plot.aldmck 
                    TRUE                 TRUE                 TRUE 
    plot.aldmck_negative plot.aldmck_positive              plot.AM 
                    TRUE                 TRUE                 TRUE 
            plot.blackbt     plot.boot_aldmck    plot.boot_blackbt 
                    TRUE                 TRUE                 TRUE 
                plot.cdf      plotcdf.blackbt       predict.aldmck 
                    TRUE                 TRUE                 TRUE 
        predict.blackbox      predict.blackbt              stimuli 
                    TRUE                 TRUE                 TRUE 
          summary.aldmck     summary.blackbox      summary.blackbt 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-14 07:44:46 UTC |
...
running this report
    ...
    PROCESSX_PS1c093afd4ec2_1739519083
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpvswUkN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_basicspace_v0.25-tikzDictionary"
