...
| export_help          | 39                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Collin Erickson <collinberickson@gmail.com> |
| bugs_status          | 0.9333333                                   |
| has_source_control   | https://github.com/CollinErickson/CGGP      |
...
Overall the package has 39 exported objects. 39 are documented:
             ...
             CGGP_internal_calcMSE        CGGP_internal_calcMSEde 
                              TRUE                           TRUE 
              CGGP_internal_calcpw     CGGP_internal_calcpwanddpw 
                              TRUE                           TRUE 
       CGGP_internal_CorrMatCauchy  CGGP_internal_CorrMatCauchySQ 
                              TRUE                           TRUE 
    CGGP_internal_CorrMatCauchySQT  CGGP_internal_CorrMatGaussian 
                              TRUE                           TRUE 
    ...
    CGGP_internal_CorrMatWendland1 CGGP_internal_CorrMatWendland2 
                              TRUE                           TRUE 
         CGGP_internal_gneglogpost      CGGP_internal_MSEpredcalc 
                              TRUE                           TRUE 
          CGGP_internal_neglogpost         CGGP_internal_set_corr 
                              TRUE                           TRUE 
                        CGGPappend                     CGGPcreate 
                              TRUE                           TRUE 
                           CGGPfit                 CGGPplotblocks 
                              TRUE                           TRUE 
            CGGPplotblockselection                   CGGPplotcorr 
                              TRUE                           TRUE 
                      CGGPplotheat                   CGGPplothist 
                              TRUE                           TRUE 
         CGGPplotsamplesneglogpost                  CGGPplotslice 
                              TRUE                           TRUE 
                     CGGPplottheta              CGGPplotvariogram 
                              TRUE                           TRUE 
                          CGGPpred                    CGGPvalplot 
                              TRUE                           TRUE 
                      CGGPvalstats               rcpp_fastmatclcr 
                              TRUE                           TRUE 
          rcpp_fastmatclcranddclcr                  rcpp_gkronDBS 
                              TRUE                           TRUE 
                      rcpp_kronDBS                        valplot 
                              TRUE                           TRUE 
                          valstats 
                              TRUE 
...
| Execution Time | 2025-02-16 04:05:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3469407ec_1739678750
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp168kj5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CGGP_v1.0.4-tikzDictionary"
