...
| export_help          | 18                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Andrew Harris <harris@astro.umd.edu>                 |
...
Overall the package has 18 exported objects. 18 are documented:
             ...
             angSep         azimuth             b2j beamDiskOverlap         dmjd2ut 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            dms2rad            elev           gmst1         hms2rad             j2b 
               TRUE            TRUE            TRUE            TRUE            TRUE 
             jd2ymd      planetFlux         rad2dms         rad2hms         ut2dmjd 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              ut2ha          ut2lst          ymd2jd 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-14 07:29:30 UTC |
...
running this report
    ...
    PROCESSX_PS1c091f1b9166_1739518167
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCVdkrc
