# Validation Report - binGroup2@1.3.1
...
| export_help          | 37                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Brianna Hitt <brianna.hitt@afacademy.af.edu>         |
...
Overall the package has 37 exported objects. 37 are documented:
                     ...
                     Accuracy             CompareConfig                    Config 
                         TRUE                      TRUE                      TRUE 
                Config.opChar                Config.OTC                 designEst 
                         TRUE                      TRUE                      TRUE 
                  designPower           expectOrderBeta                  ExpTests 
                         TRUE                      TRUE                      TRUE 
             ExpTests.halving           ExpTests.opChar              ExpTests.OTC 
                         TRUE                      TRUE                      TRUE 
            ExpTests.Sterrett              ExpTests.TOD     GroupMembershipMatrix 
                         TRUE                      TRUE                      TRUE 
                      gtPower                     gtReg              gtRegControl 
                         TRUE                      TRUE                      TRUE 
                        gtSim                    gtTest                   gtWidth 
                         TRUE                      TRUE                      TRUE 
                      halving                   IndProb      informativeArrayProb 
                         TRUE                      TRUE                      TRUE 
                      opChar1                   opChar2 operatingCharacteristics1 
                         TRUE                      TRUE                      TRUE 
    operatingCharacteristics2                      OTC1                      OTC2 
                         TRUE                      TRUE                      TRUE 
                          pmf               pmf.halving              pmf.Sterrett 
                         TRUE                      TRUE                      TRUE 
                       propCI                propDiffCI                  Sterrett 
                         TRUE                      TRUE                      TRUE 
                          TOD 
                         TRUE 
...
| Execution Time | 2025-02-15 04:08:52 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd371aeefa_1739592527
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpl5kMbQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_binGroup2_v1.3.1-tikzDictionary"
