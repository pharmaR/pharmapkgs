# Validation Report - fasterize@1.1.0
...
| has_source_control   | https://github.com/ecohealthalliance/fasterize |
...
distanceto, naturaList, rasterDT, siland, tabularaster, ursa

## Namespace

Overall the package has 3 exported objects. 3 are documented:

    fasterize      plot    raster 
         TRUE      TRUE      TRUE 

### Examples

There are 0 help pages with examples, from 2 (0.00 %).
...
| Execution Time | 2025-02-19 05:16:08 UTC |
...
running this report
    ...
    PROCESSX_PS1d451bb9e8d_1739942162
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpo837cr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fasterize_v1.1.0-tikzDictionary"
