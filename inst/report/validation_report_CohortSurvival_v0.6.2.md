# Validation Report - CohortSurvival@0.6.2
...
| 9   | magrittr                    | Imports |
| 10  | broom                       | Imports |
| 11  | PatientProfiles (\>= 1.2.3) | Imports |
| 12  | rlang (\>= 0.4.11)          | Imports |
| 13  | survival (\>= 3.7.0)        | Imports |
| 14  | stringr                     | Imports |
| 15  | tibble                      | Imports |
| 16  | tidyr                       | Imports |
| 17  | purrr                       | Imports |
...
Overall the package has 25 exported objects. 24 are documented:

                                :=                          .data 
                              TRUE                           TRUE 
                               %>%              addCohortSurvival 
                             FALSE                           TRUE 
    addCompetingRiskCohortSurvival                       as_label 
                              TRUE                           TRUE 
                           as_name               asSurvivalResult 
                              TRUE                           TRUE 
                         attrition                           bind 
                              TRUE                           TRUE 
                    cohortCodelist                    cohortCount 
                             ...
                             enquo                         enquos 
                              TRUE                           TRUE 
     estimateCompetingRiskSurvival    estimateSingleEventSurvival 
                              TRUE                           TRUE 
            exportSummarisedResult         generateDeathCohortSet 
                              TRUE                           TRUE 
            importSummarisedResult                   mockMGUS2cdm 
                              TRUE                           TRUE 
              optionsTableSurvival                   plotSurvival 
                              TRUE                           TRUE 
                          settings                       suppress 
                              TRUE                           TRUE 
                     tableSurvival 
...
| Execution Time | 2025-02-16 04:55:29 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32e94fe92_1739681724
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpbuybIX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CohortSurvival_v0.6.2-tikzDictionary"
