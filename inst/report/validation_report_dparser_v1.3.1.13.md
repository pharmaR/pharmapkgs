# Validation Report - dparser@1.3.1.13
...
| bugs_status          | 1                                         |
| has_source_control   | https://github.com/nlmixr2/dparser-R/     |
...
monolix2rx, nonmem2rx, rxode2

## Namespace

Overall the package has 10 exported objects. 10 are documented:

       .dparsePtr        dparse dpDefaultSkip     dpGetFile  dpIncludeDir 
             TRUE          TRUE          TRUE          TRUE          TRUE 
         dpReload      dpRparse     dpVersion    gc.dparser      mkdparse 
             TRUE          TRUE          TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-25 03:23:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d2839c0caa8_1740453778
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp18C862
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dparser_v1.3.1.13-tikzDictionary"
