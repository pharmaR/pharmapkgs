...
| export_help          | 6                                   |
| has_website          | TRUE                                |
| has_maintainer       | Elgar Teo <elgarteo@connect.hku.hk> |
| bugs_status          | subscript out of bounds             |
| has_source_control   | https://github.com/elgarteo/cnum/   |
...
Overall the package has 6 exported objects. 6 are documented:
                ...
                c2num default_cnum_lang      extract_cnum          has_cnum 
                 TRUE              TRUE              TRUE              TRUE 
              is_cnum             num2c 
                 TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:47:59 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3ba0cb2_1739681274
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpiCxrGc
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cnum_v0.1.5-tikzDictionary"
