# Validation Report - epiflows@0.2.1
...
| export_help          | 17                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Pawel Piatkowski <pawel.piatkowski@posteo.net> |
...
Overall the package has 17 exported objects. 17 are documented:
             ...
             add_coordinates as.SpatialLinesDataFrame     estimate_risk_spread 
                        TRUE                     TRUE                     TRUE 
             get_coordinates                get_flows                   get_id 
                        TRUE                     TRUE                     TRUE 
               get_locations                    get_n             get_pop_size 
                        TRUE                     TRUE                     TRUE 
                    get_vars              global_vars            grid_epiflows 
                        TRUE                     TRUE                     TRUE 
               make_epiflows             map_epiflows                 set_vars 
                        TRUE                     TRUE                     TRUE 
                  set_vars<-             vis_epiflows 
                        TRUE                     TRUE 
...
| Execution Time | 2025-02-19 04:16:29 UTC |
...
running this report
    ...
    PROCESSX_PS1d453acdc6f7_1739938583
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpZiCpFa
...
These are the options set to generate the report:
    ...
    [1] "validation_report_epiflows_v0.2.1-tikzDictionary"
