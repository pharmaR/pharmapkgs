...
| export_help          | 69                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Charles Taragin <ctaragin+antitrustr@gmail.com>      |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| size_codebase        | 7702                                                 |
| has_source_control   | https://github.com/luciu5/antitrust                  |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 6143                                                 |
| reverse_dependencies | 2                                                    |
| has_examples         | 0.9302326                                            |
| dependencies         | 3                                                    |
| license              | CC0                                                  |
...
Overall the package has 32 exported objects. 66 are documented:

                      aids        antitrust_shiny         auction2nd.cap 
                      TRUE                   TRUE                   TRUE 
          auction2nd.logit   auction2nd.logit.alm auction2nd.logit.nests 
                      TRUE                   TRUE                   TRUE 
          bargaining.logit    bargaining2nd.logit           bertrand.alm 
                      TRUE                   TRUE                   TRUE 
                       ces                ces.alm              ces.nests 
                      TRUE                   TRUE                   TRUE 
             cmcr.bertrand           cmcr.cournot          cmcr.cournot2 
                      TRUE                   TRUE                   TRUE 
                   cournot                    HHI                 linear 
                      TRUE                   TRUE                   TRUE 
                     logit              logit.alm              logit.cap 
                      TRUE                   TRUE                   TRUE 
             logit.cap.alm            logit.nests        logit.nests.alm 
                      TRUE                   TRUE                   TRUE 
                 loglinear                 pcaids           pcaids.nests 
                      TRUE                   TRUE                   TRUE 
                       sim            stackelberg           upp.bertrand 
                      TRUE                   TRUE                   TRUE 
               upp.cournot          vertical.barg 
                      TRUE                   TRUE 

### Examples

There are 40 help pages with examples, from 43 (93.02 %).
...
| Execution Time | 2025-02-14 06:57:17 UTC |
...
running this report
    ...
    PROCESSX_PS726d1dd193d4_1739516234
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpO9aqf9
