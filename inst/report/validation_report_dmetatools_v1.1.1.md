# Validation Report - dmetatools@1.1.1
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Hisashi Noma <noma@ism.ac.jp>                        |
...
Overall the package has 3 exported objects. 3 are documented:
          ...
          AUC_boot AUC_comparison         AUC_IF 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-18 04:27:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bb426b6193_1739852821
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpevYZyt
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dmetatools_v1.1.1-tikzDictionary"
