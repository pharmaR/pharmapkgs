...
|     | package               | type    |
|:----|:----------------------|:--------|
| 1   | cluster (\>= 2.1.4)   | Imports |
| 2   | corrplot (\>= 0.92)   | Imports |
| 3   | grDevices (\>= 4.0.0) | Imports |
| 4   | RcmdrMisc (\>= 2.7.0) | Imports |
| 5   | stats (\>= 4.0.0)     | Imports |
...
| Execution Time | 2025-02-15 04:47:03 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2325e852_1739594817
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXry4fo
...
These are the options set to generate the report:
    ...
    [1] "validation_report_brsim_v0.3-tikzDictionary"
