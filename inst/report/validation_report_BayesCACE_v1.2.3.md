# Validation Report - BayesCACE@1.2.3
...
Overall the package has 16 exported objects. 16 are documented:
         ...
         cace.meta.c     cace.meta.ic       cace.study       coda.names 
                TRUE             TRUE             TRUE             TRUE 
    coda.samples.dic     model.meta.c    model.meta.ic      model.study 
                TRUE             TRUE             TRUE             TRUE 
       parse.varname          plt.acf      plt.density       plt.forest 
                TRUE             TRUE             TRUE             TRUE 
         plt.noncomp        plt.trace       prior.meta      prior.study 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 03:32:20 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd3151af1b_1739590336
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpa9qDqF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BayesCACE_v1.2.3-tikzDictionary"
