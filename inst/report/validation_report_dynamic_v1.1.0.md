# Validation Report - dynamic@1.1.0
...
| export_help          | 5                                       |
| has_website          | TRUE                                    |
| has_maintainer       | Melissa G. Wolf <missgord@gmail.com>    |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/melissagwolf/dynamic |
...
| 2   | simstandard (\>= 0.6.2) | Imports |
| 3   | tidyr (\>= 1.1.0)       | Imports |
| 4   | lavaan (\>= 0.6-7)      | Imports |
| 5   | ggplot2 (\>= 3.3.0)     | Imports |
| 6   | magrittr (\>= 1.5)      | Imports |
| 7   | tibble (\>= 3.0.0)      | Imports |
| 8   | patchwork (\>= 1.1.1)   | Imports |
| 9   | stringr (\>= 1.4.0)     | Imports |
| 10  | purrr (\>= 0.3.3)       | Imports |
...
Overall the package has 5 exported objects. 4 are documented:
          ...
          %>%     cfaHB    cfaOne equivTest  exactFit 
...
| Execution Time | 2025-02-18 05:03:49 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46083bc53_1739855023
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmptrvfHG
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dynamic_v1.1.0-tikzDictionary"
