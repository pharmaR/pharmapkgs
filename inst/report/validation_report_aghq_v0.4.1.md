...
| export_help          | 33                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alex Stringer <alex.stringer@uwaterloo.ca>           |
...
Overall the package has 33 exported objects. 33 are documented:
        ...
        adaptive_nested_quadrature                           aghq 
                              TRUE                           TRUE 
                    compute_moment            compute_pdf_and_cdf 
                              TRUE                           TRUE 
                 compute_quantiles                default_control 
                              TRUE                           TRUE 
       default_control_marglaplace            default_control_tmb 
                              TRUE                           TRUE 
            default_transformation                    get_hessian 
                              TRUE                           TRUE 
                 get_log_normconst                       get_mode 
                              TRUE                           TRUE 
               get_nodesandweights              get_numquadpoints 
                              TRUE                           TRUE 
                   get_opt_results                  get_param_dim 
                              TRUE                           TRUE 
                     get_quadtable                      get_shift 
                              TRUE                           TRUE 
    interpolate_marginal_posterior          laplace_approximation 
                              TRUE                           TRUE 
              make_moment_function   make_numeric_moment_function 
                              TRUE                           TRUE 
               make_transformation               marginal_laplace 
                              TRUE                           TRUE 
              marginal_laplace_tmb             marginal_posterior 
                              TRUE                           TRUE 
                 nested_quadrature              normalize_logpost 
                              TRUE                           TRUE 
                    optimize_theta                sample_marginal 
                              TRUE                           TRUE 
                  validate_control                validate_moment 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-14 06:42:48 UTC |
...
running this report
    ...
    PROCESSX_PS726d157d79f0_1739515365
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp6eRjrA
