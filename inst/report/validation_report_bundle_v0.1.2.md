# Validation Report - bundle@0.1.2
...
| has_source_control   | https://github.com/rstudio/bundle  |
...
imanr, ldmppr, vetiver

## Namespace

Overall the package has 5 exported objects. 5 are documented:

            bundle  bundle_constr situate_constr   swap_element       unbundle 
...
| Execution Time | 2025-02-15 04:55:31 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd341d49cf_1739595325
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplXyMAn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bundle_v0.1.2-tikzDictionary"
