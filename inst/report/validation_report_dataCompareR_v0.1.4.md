# Validation Report - dataCompareR@0.1.4
...
| export_help          | 3                                              |
| has_website          | TRUE                                           |
| has_maintainer       | Sarah Johnston <Sarah.Johnston@capitalone.com> |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/capitalone/dataCompareR     |
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    generateMismatchData             rCompare           saveReport 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-17 04:57:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bd649b8a583_1739768217
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5CdELQ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dataCompareR_v0.1.4-tikzDictionary"
