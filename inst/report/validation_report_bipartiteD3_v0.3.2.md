# Validation Report - bipartiteD3@0.3.2
...
|     | package                | type    |
|:----|:-----------------------|:--------|
| 1   | RColorBrewer (\>= 1.1) | Imports |
| 2   | r2d3 (\>= 0.2.2)       | Imports |
| 3   | purrr (\>= 0.2.5)      | Imports |
| 4   | dplyr (\>= 0.7.5)      | Imports |
| 5   | tidyr (\>= 0.8)        | Imports |
| 6   | stringr(\>= 1.3)       | Imports |
| 7   | tibble (\>= 1.4)       | Imports |
...
Overall the package has 7 exported objects. 7 are documented:
            ...
            Array2DF     bipartite_D3     BP_JS_Writer          List2DF 
                TRUE             TRUE             TRUE             TRUE 
           LoadVisJS        Matrix2DF OrderByCrossover 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-15 04:16:26 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd2437a1c2_1739592981
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpahbdi6
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bipartiteD3_v0.3.2-tikzDictionary"
