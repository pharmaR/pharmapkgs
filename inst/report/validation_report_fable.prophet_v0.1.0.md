# Validation Report - fable.prophet@0.1.0
...
|:----|:-----------------------|:--------|
| 1   | Rcpp                   | Depends |
| 2   | fabletools (\>= 0.2.0) | Depends |
| 3   | rlang                  | Imports |
| 4   | tsibble                | Imports |
| 5   | lubridate              | Imports |
| 6   | prophet                | Imports |
| 7   | dplyr                  | Imports |
| 8   | distributional         | Imports |
...
| Execution Time | 2025-02-19 05:02:18 UTC |
...
running this report
    ...
    PROCESSX_PS1d4533f38d73_1739941331
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1PZmfO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_fable.prophet_v0.1.0-tikzDictionary"
