...
| export_help          | 11                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Henrik Singmann <singmann+acss@gmail.com>            |
...
Overall the package has 11 exported objects. 11 are documented:
                 ...
                 acss      alternations change_complexity       count_class 
                 TRUE              TRUE              TRUE              TRUE 
              entropy          entropy2      likelihood_d  likelihood_ratio 
                 TRUE              TRUE              TRUE              TRUE 
     local_complexity  normalize_string       prob_random 
                 TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-21 13:07:07 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a1da2716d_1740143224
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpATxxS2
