# Validation Report - carbondate@1.0.1
...
| export_help          | 19                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Timothy J Heaton <T.Heaton@leeds.ac.uk> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/TJHeaton/carbondate  |
...
Overall the package has 19 exported objects. 19 are documented:
              ...
              CalibrateSingleDetermination                  FindPosteriorMeanRate 
                                      TRUE                                   TRUE 
          FindPredictiveCalendarAgeDensity      FindSummedProbabilityDistribution 
                                      TRUE                                   TRUE 
                         GenerateOxcalCode            InterpolateCalibrationCurve 
                                      TRUE                                   TRUE 
    PlotCalendarAgeDensityIndividualSample                    PlotConvergenceData 
                                      TRUE                                   TRUE 
       PlotGelmanRubinDiagnosticMultiChain   PlotGelmanRubinDiagnosticSingleChain 
                                      TRUE                                   TRUE 
                      PlotNumberOfClusters            PlotNumberOfInternalChanges 
                                      TRUE                                   TRUE 
                 PlotPosteriorChangePoints                   PlotPosteriorHeights 
                                      TRUE                                   TRUE 
                     PlotPosteriorMeanRate       PlotPredictiveCalendarAgeDensity 
                                      TRUE                                   TRUE 
                    PolyaUrnBivarDirichlet                            PPcalibrate 
                                      TRUE                                   TRUE 
...
| Execution Time | 2025-02-16 03:40:38 UTC |
...
running this report
    ...
    PROCESSX_PS1bc37d80b13a_1739677234
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkUQN32
...
These are the options set to generate the report:
    ...
    [1] "validation_report_carbondate_v1.0.1-tikzDictionary"
