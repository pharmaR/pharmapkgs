# Validation Report - colorBlindness@0.1.9
...
| export_help          | 39                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jianhong Ou <jianhong.ou@duke.edu>                   |
...
| 4   | methods      | Imports |
| 5   | cowplot      | Imports |
| 6   | colorspace   | Imports |
| 7   | graphics     | Imports |
| 8   | gridGraphics | Imports |
| 9   | gtable       | Imports |
| 10  | grid         | Imports |
...
Overall the package has 39 exported objects. 39 are documented:
                  ...
                  availableColors              availablePalette 
                            ...
                            BLACK                          BLUE 
                             TRUE                          TRUE 
           Blue2DarkOrange12Steps        Blue2DarkOrange18Steps 
                             TRUE                          TRUE 
              Blue2DarkRed12Steps           Blue2DarkRed18Steps 
                             TRUE                          TRUE 
                  Blue2Gray8Steps             Blue2Green14Steps 
                             TRUE                          TRUE 
               Blue2Orange10Steps            Blue2Orange12Steps 
                             TRUE                          TRUE 
                Blue2Orange8Steps         Blue2OrangeRed14Steps 
                             TRUE                          TRUE 
                     BLUISH_GREEN             Brown2Blue10Steps 
                             TRUE                          TRUE 
                Brown2Blue12Steps                    colorNames 
                             TRUE                          TRUE 
                          cvdPlot                  cvdSimulator 
                             TRUE                          TRUE 
                 displayAllColors       displayAvailablePalette 
                             TRUE                          TRUE 
                    displayColors          Green2Magenta16Steps 
                             TRUE                          TRUE 
        LightBlue2DarkBlue10Steps      LightBlue2DarkBlue7Steps 
                             TRUE                          TRUE 
    ModifiedSpectralScheme11Steps                        ORANGE 
                             TRUE                          TRUE 
               PairedColor12Steps                 paletteMartin 
                             TRUE                          TRUE 
                          PRESETS                REDDISH_PURPLE 
                             TRUE                          TRUE 
                 replacePlotColor                    safeColors 
                             TRUE                          TRUE 
                        setPDFopt                      SKY_BLUE 
                             TRUE                          TRUE 
          SteppedSequential5Steps                    VERMILLION 
                             TRUE                          TRUE 
                           YELLOW 
                             TRUE 
...
| Execution Time | 2025-02-16 04:58:55 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35bf9d5a6_1739681930
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyCBvmh
...
These are the options set to generate the report:
    ...
    [1] "validation_report_colorBlindness_v0.1.9-tikzDictionary"
