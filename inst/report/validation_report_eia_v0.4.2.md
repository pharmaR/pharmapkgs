...
| export_help          | 14                                      |
| has_website          | TRUE                                    |
| has_maintainer       | Matthew Hoff <matthew.g.hoff@gmail.com> |
| bugs_status          | subscript out of bounds                 |
| has_source_control   | https://github.com/ropensci/eia         |
...
Overall the package has 14 exported objects. 14 are documented:
        ...
        date_to_eiadate     eia_clear_cache      eia_clear_data       eia_clear_dir 
                   TRUE                TRUE                TRUE                TRUE 
       eia_clear_facets  eia_clear_metadata            eia_data             eia_dir 
                   TRUE                TRUE                TRUE                TRUE 
             eia_facets         eia_get_key        eia_metadata         eia_set_key 
                   TRUE                TRUE                TRUE                TRUE 
        eiadate_to_date eiadate_to_date_seq 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-19 03:51:05 UTC |
...
running this report
    ...
    PROCESSX_PS1d452c110564_1739937059
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpk93uhd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eia_v0.4.2-tikzDictionary"
