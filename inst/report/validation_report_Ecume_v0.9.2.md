...
| export_help | 6 |
| has_website | FALSE |
| has_maintainer | Hector Roux de Bezieux <hector.rouxdebezieux@berkeley.edu> |
...
| 6   | methods         | Imports |
| 7   | pbapply         | Imports |
| 8   | spatstat.univar | Imports |
| 9   | stats           | Imports |
| 10  | transport       | Imports |
...
CausalGPS, condiments, TDLM

## Namespace

Overall the package has 6 exported objects. 5 are documented:

                   %>%    classifier_test            ks_test           mmd_test 
                 FALSE               TRUE               TRUE               TRUE 
       stouffer_zscore wasserstein_permut 
                  TRUE               TRUE 
...
| Execution Time | 2025-02-19 03:39:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d451a4d1fbe_1739936346
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTrQ8j5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Ecume_v0.9.2-tikzDictionary"
