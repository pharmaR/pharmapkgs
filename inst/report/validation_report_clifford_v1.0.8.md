# Validation Report - clifford@1.0.8
...
| has_source_control   | https://github.com/RobinHankin/clifford     |
...
|     | package                 | type      |
|:----|:------------------------|:----------|
| 1   | Rcpp (\>= 0.12.5)       | Imports   |
| 2   | mathjaxr                | Imports   |
| 3   | disordR (\>= 0.0-8)     | Imports   |
| 4   | magrittr                | Imports   |
| 5   | methods                 | Imports   |
| 6   | partitions (\>= 1.10-4) | Imports   |
| 7   | Rcpp                    | LinkingTo |
| 8   | BH                      | LinkingTo |
...
Overall the package has 10 exported objects. 0 are documented:

       % %   %_|%    %.%    %^%   %|_%  %dot%  %euc%    %o% %star%    %X% 
...
| Execution Time | 2025-02-16 04:30:31 UTC |
...
running this report
    ...
    PROCESSX_PS1bc35c36f47d_1739680226
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmprhIl7G
...
These are the options set to generate the report:
    ...
    [1] "validation_report_clifford_v1.0.8-tikzDictionary"
