# Validation Report - EfficientMaxEigenpair@0.1.4
...
| export_help          | 13                                            |
| has_website          | TRUE                                          |
| has_maintainer       | Xiao-Jun Mao <maoxj.ki@gmail.com>             |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | http://github.com/mxjki/EfficientMaxEigenpair |
...
Overall the package has 13 exported objects. 13 are documented:
          ...
          eff.ini.maxeig.general eff.ini.maxeig.shift.inv.tri 
                            TRUE                         TRUE 
              eff.ini.maxeig.tri       eff.ini.seceig.general 
                            TRUE                         TRUE 
              eff.ini.seceig.tri                  find_deltak 
                            TRUE                         TRUE 
                ray.quot.general      ray.quot.seceig.general 
                            TRUE                         TRUE 
             ray.quot.seceig.tri                 ray.quot.tri 
                            TRUE                         TRUE 
                   shift.inv.tri                      tri.sol 
                            TRUE                         TRUE 
                         tridiag 
                            TRUE 
...
| Execution Time | 2025-02-19 03:47:50 UTC |
...
running this report
    ...
    PROCESSX_PS1d4553e52116_1739936864
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplO4s9z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EfficientMaxEigenpair_v0.1.4-tikzDictionary"
