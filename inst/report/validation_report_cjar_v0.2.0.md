...
Overall the package has 26 exported objects. 26 are documented:
                     ...
                     auth_jwt                auth_oauth                  auth_s2s 
                         TRUE                      TRUE                      TRUE 
                     cja_auth             cja_auth_name             cja_auth_path 
                         TRUE                      TRUE                      TRUE 
                cja_auth_with        cja_freeform_table        cja_get_audit_logs 
                         TRUE                      TRUE                      TRUE 
    cja_get_audit_logs_search cja_get_calculatedmetrics         cja_get_dataviews 
                         TRUE                      TRUE                      TRUE 
           cja_get_dateranges        cja_get_dimensions            cja_get_filter 
                         TRUE                      TRUE                      TRUE 
              cja_get_filters                cja_get_me           cja_get_metrics 
                         TRUE                      TRUE                      TRUE 
       cja_get_project_config          cja_get_projects              filter_build 
                         TRUE                      TRUE                      TRUE 
                   filter_con               filter_rule                filter_seq 
                         TRUE                      TRUE                      TRUE 
                  filter_then                filter_val 
                         TRUE                      TRUE 
...
| Execution Time | 2025-02-16 04:24:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31644951b_1739679868
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCs61Li
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cjar_v0.2.0-tikzDictionary"
