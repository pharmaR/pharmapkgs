# Validation Report - deforestable@3.1.1
...
| 2   | jpeg             | Imports   |
| 3   | plyr             | Imports   |
| 4   | StableEstim      | Imports   |
| 5   | Rcpp (\>= 1.0.9) | Imports   |
| 6   | Rcpp             | LinkingTo |
...
Overall the package has 8 exported objects. 8 are documented:
               ...
               classify createDataPartition         createFolds          Koutparams 
                   TRUE                TRUE                TRUE                TRUE 
              read_data    read_data_matrix    read_data_raster               train 
                   TRUE                TRUE                TRUE                TRUE 
...
| Execution Time | 2025-02-18 03:37:02 UTC |
...
running this report
    ...
    PROCESSX_PS1bb4148e100_1739849817
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpWcg0Yr
...
These are the options set to generate the report:
    ...
    [1] "validation_report_deforestable_v3.1.1-tikzDictionary"
