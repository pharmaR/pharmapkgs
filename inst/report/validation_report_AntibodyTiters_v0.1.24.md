...
| export_help          | 8                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Hiroaki Kato <hkato@med.shimane-u.ac.jp>             |
...
|     | package                 | type    |
|:----|:------------------------|:--------|
| 1   | openxlsx (\>= 4.2.4)    | Depends |
| 2   | DescTools (\>= 0.99.43) | Depends |
...
Overall the package has 8 exported objects. 8 are documented:
          ...
          emptyABT groupAttribABT    halfLifeABT          idABT     plotAllABT 
              TRUE           TRUE           TRUE           TRUE           TRUE 
       plotEachABT        readABT         toyABT 
              TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-14 06:57:10 UTC |
...
running this report
    ...
    PROCESSX_PS726d32bb8cd4_1739516228
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpkV7sS6
