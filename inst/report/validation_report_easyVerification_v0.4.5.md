# Validation Report - easyVerification@0.4.5
...
| export_help          | 26                                             |
| has_website          | TRUE                                           |
| has_maintainer       | Jonas Bhend <jonas.bhend@meteoswiss.ch>        |
| bugs_status          | subscript out of bounds                        |
| has_source_control   | https://github.com/jonasbhend/easyVerification |
...
|     | package                     | type      |
|:----|:----------------------------|:----------|
| 1   | SpecsVerification (\>= 0.5) | Depends   |
| 2   | stats                       | Depends   |
| 3   | utils                       | Depends   |
| 4   | pbapply                     | Imports   |
| 5   | Rcpp (\>= 0.12.9)           | Imports   |
| 6   | Rcpp                        | LinkingTo |
...
Overall the package has 26 exported objects. 26 are documented:
    ...
    climFairRpss convert2prob   count2prob      Ens2AFC      EnsCorr     EnsError 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
      EnsErrorss       EnsIgn     EnsIgnss       EnsMae     EnsMaess        EnsMe 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
          EnsMse     EnsMsess      EnsRmse    EnsRmsess      EnsRoca     EnsRocss 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
       EnsSprErr   FairSprErr  generateRef       indRef         size     toyarray 
            TRUE         TRUE         TRUE         TRUE         TRUE         TRUE 
        toymodel    veriApply 
            TRUE         TRUE 
...
| Execution Time | 2025-02-18 05:13:30 UTC |
...
running this report
    ...
    PROCESSX_PS1bb46c15d864_1739855604
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpQrWcvL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_easyVerification_v0.4.5-tikzDictionary"
