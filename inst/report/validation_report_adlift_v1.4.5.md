...
Overall the package has 49 exported objects. 49 are documented:
            ...
            AdaptNeigh       AdaptNeighmp          AdaptPred        AdaptPredmp 
                  TRUE               TRUE               TRUE               TRUE 
               adjustx           Amatdual          Amatdual2             artlev 
                  TRUE               TRUE               TRUE               TRUE 
             as.column             as.row           basisfns             condno 
                  TRUE               TRUE               TRUE               TRUE 
             CubicPred        CubicPredmp            denoise           denoise2 
                  TRUE               TRUE               TRUE               TRUE 
         denoisehetero     denoisehetero2    denoiseheteromp  denoiseheteroprop 
                  TRUE               TRUE               TRUE               TRUE 
    denoiseheteroprop2           dojitter           findadds              fwtnp 
                  TRUE               TRUE               TRUE               TRUE 
                fwtnp2            fwtnpmp            getnbrs          heterovar 
                  TRUE               TRUE               TRUE               TRUE 
             intervals             invtnp            invtnp2           invtnpmp 
                  TRUE               TRUE               TRUE               TRUE 
       lengthintervals         LinearPred       LinearPredmp       make.signal2 
                  TRUE               TRUE               TRUE               TRUE 
               matcond          modjitter       PointsUpdate      PointsUpdate2 
                  TRUE               TRUE               TRUE               TRUE 
        PointsUpdatemp    postmean.cauchy           QuadPred         QuadPredmp 
                  TRUE               TRUE               TRUE               TRUE 
             Rmatsolve       transmatdual      transmatdual2   UndoPointsUpdate 
                  TRUE               TRUE               TRUE               TRUE 
    UndoPointsUpdatemp 
                  TRUE 
...
There are 41 help pages with examples, from 42 (97.62 %).
...
| Execution Time | 2025-02-21 13:08:10 UTC |
...
running this report
    ...
    PROCESSX_PS1d0a2b24c2de_1740143286
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpujIqtB
