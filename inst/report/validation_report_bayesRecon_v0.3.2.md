# Validation Report - bayesRecon@0.3.2
...
| export_help          | 13                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Dario Azzimonti <dario.azzimonti@gmail.com> |
| bugs_status          | subscript out of bounds                     |
| has_source_control   | https://github.com/IDSIA/bayesRecon         |
...
Overall the package has 13 exported objects. 13 are documented:
     ...
     get_reconc_matrices         PMF.get_mean     PMF.get_quantile 
                    TRUE                 TRUE                 TRUE 
             PMF.get_var           PMF.sample          PMF.summary 
                    TRUE                 TRUE                 TRUE 
             reconc_BUIS      reconc_gaussian          reconc_MCMC 
                    TRUE                 TRUE                 TRUE 
          reconc_MixCond        reconc_TDcond  schaferStrimmer_cov 
                    TRUE                 TRUE                 TRUE 
...
| Execution Time | 2025-02-15 03:40:07 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1c08774c_1739590802
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpAC1yzj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bayesRecon_v0.3.2-tikzDictionary"
