# Validation Report - cumulocityr@0.1.0
...
| export_help          | 3                                                |
| has_website          | TRUE                                             |
| has_maintainer       | Dmitriy Bolotov <dmitriy.bolotov@softwareag.com> |
| bugs_status          | subscript out of bounds                          |
| has_source_control   | https://github.com/SoftwareAG/cumulocityr        |
...
Overall the package has 3 exported objects. 3 are documented:
         ...
         get_devices       get_events get_measurements 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-17 04:39:09 UTC |
...
running this report
    ...
    PROCESSX_PS1bd64d9f92d_1739767144
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpCJm3ac
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cumulocityr_v0.1.0-tikzDictionary"
