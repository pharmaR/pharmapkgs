# Validation Report - DBModelSelect@0.2.0
...
| export_help          | 5                                                    |
| has_website          | TRUE                                                 |
| has_maintainer       | Scott H. Koeneman <Scott.Koeneman@jefferson.edu>     |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/shkoeneman/DBModelSelect          |
...
Overall the package has 5 exported objects. 5 are documented:
                  ...
                  AICc      BootGOFTestLM      FitGLMSubsets       FitLMSubsets 
                  TRUE               TRUE               TRUE               TRUE 
    StandICModelSelect 
                  TRUE 
...
| Execution Time | 2025-02-17 05:07:15 UTC |
...
running this report
    ...
    PROCESSX_PS1bd62900b5f_1739768830
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpzqckcX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DBModelSelect_v0.2.0-tikzDictionary"
