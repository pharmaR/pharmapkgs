...
Overall the package has 12 exported objects. 12 are documented:
       ...
       carms.arrow     carms.base     carms.make    carms.state        diagram 
              TRUE           TRUE           TRUE           TRUE           TRUE 
     diagram.carms       examples examples.carms           matP     plot.carms 
              TRUE           TRUE           TRUE           TRUE           TRUE 
...
| Execution Time | 2025-02-16 03:42:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bc321c4f25c_1739677372
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpErKMxe
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CARMS_v1.0.1-tikzDictionary"
