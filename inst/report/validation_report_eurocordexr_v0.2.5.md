# Validation Report - eurocordexr@0.2.5
...
| export_help          | 10                                     |
| has_website          | TRUE                                   |
| has_maintainer       | Michael Matiu <michaelmatiu@gmail.com> |
| bugs_status          | subscript out of bounds                |
| has_source_control   | https://github.com/mitmat/eurocordexr  |
...
Overall the package has 10 exported objects. 10 are documented:
                   ...
                   check_inventory          check_inventory_cmip5 
                              TRUE                           TRUE 
    compare_variables_in_inventory                  get_inventory 
                              TRUE                           TRUE 
               get_inventory_cmip5                   get_varnames 
                              TRUE                           TRUE 
         map_non_standard_calendar                  nc_grid_to_dt 
                              TRUE                           TRUE 
                 nc_grid_to_dt_raw         rotpole_nc_point_to_dt 
                              TRUE                           TRUE 
...
| Execution Time | 2025-02-19 04:36:33 UTC |
...
running this report
    ...
    PROCESSX_PS1d456f5d2a6b_1739939787
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyE7oy2
...
These are the options set to generate the report:
    ...
    [1] "validation_report_eurocordexr_v0.2.5-tikzDictionary"
