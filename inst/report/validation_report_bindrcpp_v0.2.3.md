# Validation Report - bindrcpp@0.2.3
...
| has_source_control   | https://github.com/krlmlr/bindrcpp |
...
|     | package            | type      |
|:----|:-------------------|:----------|
| 1   | bindr (\>= 0.1.1)  | Imports   |
| 2   | Rcpp (\>= 0.12.16) | Imports   |
| 3   | plogr              | LinkingTo |
| 4   | Rcpp               | LinkingTo |
...
| Execution Time | 2025-02-15 04:08:14 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd7ae8d2e5_1739592489
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpnVUIOd
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bindrcpp_v0.2.3-tikzDictionary"
