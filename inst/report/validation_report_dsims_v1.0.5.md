...
| export_help          | 25                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Laura Marshall <lhm@st-and.ac.uk>            |
| bugs_status          | subscript out of bounds                      |
| has_source_control   | https://github.com/DistanceDevelopment/dsims |
| has_bug_reports_url  | 1                                            |
| downloads_1yr        | 3899                                         |
| reverse_dependencies | 0                                            |
| has_examples         | 0.7105263                                    |
| dependencies         | 12                                           |
| license              | GPL (\>= 2)                                  |
...
Overall the package has 16 exported objects. 21 are documented:

                    add.hotspot                analyse.data 
                           TRUE                        TRUE 
            description.summary         generate.population 
                           TRUE                        TRUE 
                  get.densities                       get.N 
                           TRUE                        TRUE 
               histogram.N.ests                make.density 
                           TRUE                        TRUE 
             make.detectability            make.ds.analysis 
                           TRUE                        TRUE 
    make.population.description             make.simulation 
                           TRUE                        TRUE 
                 run.simulation                  run.survey 
                           TRUE                        TRUE 
               save.sim.results               set.densities 
                           TRUE                        TRUE 

### Examples

There are 27 help pages with examples, from 38 (71.05 %).
...
| Execution Time | 2025-02-18 04:50:56 UTC |
...
running this report
    ...
    PROCESSX_PS1bb44053c40b_1739854250
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpuhQEQj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dsims_v1.0.5-tikzDictionary"
