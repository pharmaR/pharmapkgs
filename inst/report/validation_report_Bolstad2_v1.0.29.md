# Validation Report - Bolstad2@1.0.29
...
| export_help          | 17                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | James Curran <j.curran@auckland.ac.nz>               |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/jmcurran/Bolstad2                 |
| has_bug_reports_url  | 0                                                    |
| downloads_1yr        | 6553                                                 |
| reverse_dependencies | 7                                                    |
| has_examples         | 0.7391304                                            |
| dependencies         | 2                                                    |
| license              | GPL (\>= 2)                                          |
...
BayesGOF, ctsfeatures, ePCR, LPRelevance, NPCirc, otsfeatures,
...
Overall the package has 17 exported objects. 17 are documented:
         ...
         BayesCPH BayesLogistic     BayesPois     bivnormMH       credInt 
             TRUE          TRUE          TRUE          TRUE          TRUE 
       credIntNum   credIntSamp      describe   GelmanRubin   hierMeanReg 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        normGibbs     normMixMH         pNull      pnullNum     pnullSamp 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        sintegral          thin 
             TRUE          TRUE 
...
There are 17 help pages with examples, from 23 (73.91 %).
...
| Execution Time | 2025-02-22 03:18:22 UTC |
...
running this report
    ...
    PROCESSX_PS1dbb6b1041d6_1740194298
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpRZhipX
...
These are the options set to generate the report:
    ...
    [1] "validation_report_Bolstad2_v1.0.29-tikzDictionary"
