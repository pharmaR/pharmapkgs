...
| export_help          | 18                                           |
| has_website          | TRUE                                         |
| has_maintainer       | Rob Cavanaugh <r.cavanaugh@northeastern.edu> |
| bugs_status          | subscript out of bounds                      |
| size_codebase        | 1228                                         |
| has_source_control   | https://github.com/roux-ohdsi/allofus        |
...
Overall the package has 18 exported objects. 17 are documented:
                        ...
                        %>%        aou_atlas_cohort aou_bucket_to_workspace 
                      FALSE                    TRUE                    TRUE 
                aou_collect             aou_compute         aou_concept_set 
                       TRUE                    TRUE                    TRUE 
                aou_connect   aou_create_temp_table                aou_join 
                       TRUE                    TRUE                    TRUE 
              aou_ls_bucket        aou_ls_workspace  aou_observation_period 
                       TRUE                    TRUE                    TRUE 
           aou_session_info                 aou_sql              aou_survey 
                       TRUE                    TRUE                    TRUE 
                 aou_tables aou_workspace_to_bucket            on_workbench 
                       TRUE                    TRUE                    TRUE 
...
| Execution Time | 2025-02-14 06:49:04 UTC |
...
running this report
    ...
    PROCESSX_PS726d1b2be6c5_1739515741
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFCru5y
