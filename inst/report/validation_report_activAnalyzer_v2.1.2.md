...
| export_help          | 30                                          |
| has_website          | TRUE                                        |
| has_maintainer       | Pierre-Yves de Müllenheim <pydemull@uco.fr> |
| bugs_status          | 0.9333333                                   |
| size_codebase        | 14023                                       |
| has_source_control   | https://github.com/pydemull/activAnalyzer   |
...
Overall the package has 30 exported objects. 30 are documented:
                     ...
                     average_results     compute_accumulation_metrics 
                                TRUE                             TRUE 
                         compute_bmr compute_intensity_distri_metrics 
                                TRUE                             TRUE 
                        compute_mets      compute_pro_actigraph_score 
                                TRUE                             TRUE 
             compute_pro_score_cppac          compute_pro_score_dppac 
                                TRUE                             TRUE 
                     create_fig_mvpa             create_fig_mx_by_day 
                                TRUE                             TRUE 
               create_fig_mx_summary                   create_fig_pal 
                                TRUE                             TRUE 
           create_fig_ratio_mvpa_sed            create_fig_res_by_day 
                                TRUE                             TRUE 
                      create_fig_sed                 create_fig_steps 
                                TRUE                             TRUE 
            create_flextable_summary            get_guidelines_status 
                                TRUE                             TRUE 
                      get_pal_status       get_ratio_mvpa_sed_comment 
                                TRUE                             TRUE 
                      mark_intensity                   mark_wear_time 
                                TRUE                             TRUE 
                           plot_data         plot_data_with_intensity 
                                TRUE                             TRUE 
                     prepare_dataset                  rasch_transform 
                                TRUE                             TRUE 
                            read_agd                     read_agd_raw 
                                TRUE                             TRUE 
                        recap_by_day                          run_app 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-14 06:33:04 UTC |
...
running this report
    ...
    PROCESSX_PS726d1d974a38_1739514781
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTSDBRL
