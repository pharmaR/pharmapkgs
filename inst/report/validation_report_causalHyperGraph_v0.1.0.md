# Validation Report - causalHyperGraph@0.1.0
...
Overall the package has 3 exported objects. 3 are documented:
    ...
    causalHyperGraph              chg    export_as_svg 
                TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-16 03:49:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bc34db8e94c_1739677768
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpT4rJPv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_causalHyperGraph_v0.1.0-tikzDictionary"
