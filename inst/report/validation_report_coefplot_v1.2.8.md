# Validation Report - coefplot@1.2.8
...
| export_help          | 19                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jared P. Lander <packages@jaredlander.com>           |
...
Overall the package has 19 exported objects. 19 are documented:
                  ...
                  buildModelCI       buildModelCI.default 
                          TRUE                       TRUE 
    buildPlottingPloty.default                   coefpath 
                          TRUE                       TRUE 
                      coefplot        coefplot.data.frame 
                          TRUE                       TRUE 
              coefplot.default               coefplot.glm 
                          TRUE                       TRUE 
                   coefplot.lm             coefplot.rxGlm 
                          TRUE                       TRUE 
             coefplot.rxLinMod           coefplot.rxLogit 
                          TRUE                       TRUE 
                  extract.coef        extract.coef.maxLik 
                          TRUE                       TRUE 
                   extractPath                   invlogit 
                          TRUE                       TRUE 
                     multiplot                   plotcoef 
                          TRUE                       TRUE 
               position_dodgev 
...
| Execution Time | 2025-02-16 04:53:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bc3471a9855_1739681595
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp47BSPN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coefplot_v1.2.8-tikzDictionary"
