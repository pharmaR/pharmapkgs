...
| export_help          | 27                                  |
| has_website          | FALSE                               |
| has_maintainer       | Rafael Ayala <rafael.ayala@oist.jp> |
...
Overall the package has 27 exported objects. 27 are documented:
                ...
                calculateRazel              dateTimeToMJD 
                          TRUE                       TRUE 
                       deg2rad                   ECItoKOE 
                          TRUE                       TRUE 
                    GCRFtoITRF               GCRFtoLATLON 
                          TRUE                       TRUE 
            getLatestSpaceData                       hpop 
                          TRUE                       TRUE 
                    ITRFtoGCRF               ITRFtoLATLON 
                          TRUE                       TRUE 
                JPLephemerides                   KOEtoECI 
                          TRUE                       TRUE 
                  LATLONtoGCRF               LATLONtoITRF 
                          TRUE                       TRUE 
                 parseTLElines                    rad2deg 
                          TRUE                       TRUE 
    readGLONASSNavigationRINEX     readGPSNavigationRINEX 
                          TRUE                       TRUE 
                       readOEM                    readTLE 
                          TRUE                       TRUE 
                 revDay2radMin                       sdp4 
...
| Execution Time | 2025-02-14 07:29:19 UTC |
...
running this report
    ...
    PROCESSX_PS1c092bc5a89f_1739518156
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpKDZswO
