...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Philip Nye <phipnye@proton.me>                       |
...
|:----|:-------------------------|:----------|
| 1   | stats                    | Imports   |
| 2   | Rcpp (\>= 1.0.13)        | Imports   |
| 3   | RcppParallel (\>= 5.1.8) | Imports   |
| 4   | Rcpp                     | LinkingTo |
| 5   | RcppParallel             | LinkingTo |
...
| Execution Time | 2025-02-17 04:44:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6392705c5_1739767435
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpsgF0TH
...
These are the options set to generate the report:
    ...
    [1] "validation_report_cvLM_v1.0.4-tikzDictionary"
