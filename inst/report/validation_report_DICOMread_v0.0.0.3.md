# Validation Report - DICOMread@0.0.0.3
...
| export_help          | 3                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Shu Jiang <jiang.shu@wustl.edu>                      |
...
Overall the package has 3 exported objects. 3 are documented:
         ...
         Avb_fun    check_mat form_mat_fun 
            TRUE         TRUE         TRUE 
...
| Execution Time | 2025-02-18 04:00:44 UTC |
...
running this report
    ...
    PROCESSX_PS1bb433e5e1bf_1739851238
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpFJ2QKn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DICOMread_v0.0.0.3-tikzDictionary"
