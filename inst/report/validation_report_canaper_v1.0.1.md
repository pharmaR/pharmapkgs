# Validation Report - canaper@1.0.1
...
| has_source_control   | https://github.com/ropensci/canaper |
...
Overall the package has 6 exported objects. 6 are documented:
     ...
     cpr_classify_endem cpr_classify_signif        cpr_iter_sim        cpr_make_pal 
                   TRUE                TRUE                TRUE                TRUE 
          cpr_rand_comm       cpr_rand_test 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-16 03:37:33 UTC |
...
running this report
    ...
    PROCESSX_PS1bc332394890_1739677049
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpczqUNL
...
These are the options set to generate the report:
    ...
    [1] "validation_report_canaper_v1.0.1-tikzDictionary"
