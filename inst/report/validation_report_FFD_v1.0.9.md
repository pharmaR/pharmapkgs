...
| export_help          | 20                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Ian Kopacka <ian.kopacka@ages.at>                    |
...
Overall the package has 15 exported objects. 15 are documented:
                          ...
                          computeAlpha        computeAlphaLimitedSampling 
                                  TRUE                               TRUE 
               computeAposterioriError  computeAposterioriErrorRiskGroups 
                                  TRUE                               TRUE 
              computeOptimalSampleSize computeOptimalSampleSizeRiskGroups 
                                  TRUE                               TRUE 
                         computePValue            computePValueRiskGroups 
                                  TRUE                               TRUE 
                               FFD_GUI                        indSampling 
                                  TRUE                               TRUE 
                    indSamplingSummary                                lls 
                                  TRUE                               TRUE 
                           ltdSampling                 ltdSamplingSummary 
                                  TRUE                               TRUE 
                            surveyData 
                                  TRUE 
...
| Execution Time | 2025-02-27 03:27:34 UTC |
...
running this report
    ...
    PROCESSX_PS1c6223d33910_1740626850
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5iOMsC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FFD_v1.0.9-tikzDictionary"
