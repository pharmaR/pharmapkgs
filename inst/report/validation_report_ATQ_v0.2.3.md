...
| export_help          | 13                                                 |
| has_website          | TRUE                                               |
| has_maintainer       | Vinay Joshy <joshy@uoguelph.ca>                    |
| bugs_status          | subscript out of bounds                            |
| size_codebase        | 901                                                |
| has_source_control   | https://github.com/vjoshy/ATQ_Surveillance_Package |
...
Overall the package has 13 exported objects. 13 are documented:
                   ...
                   alarm_metrics              alarm_plot_data 
                            TRUE                         TRUE 
                      best_model                catchment_sim 
                            TRUE                         TRUE 
                     compile_epi create_alarm_metrics_summary 
                            TRUE                         TRUE 
                  elementary_pop                 eval_metrics 
                            TRUE                         TRUE 
            plot_single_epidemic          simulate_households 
                            TRUE                         TRUE 
                            ssir              subpop_children 
                            TRUE                         TRUE 
               subpop_noChildren 
                            TRUE 
...
| Execution Time | 2025-02-14 07:31:09 UTC |
...
running this report
    ...
    PROCESSX_PS1c0911622e97_1739518267
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIn4fyt
