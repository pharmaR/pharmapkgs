# Validation Report - EventDetectR@0.3.5
...
| export_help          | 7                                          |
| has_website          | TRUE                                       |
| has_maintainer       | Sowmya Chandrasekaran <sowzz.17@gmail.com> |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/frehbach/EventDetectR   |
...
Overall the package has 7 exported objects. 7 are documented:
                  ...
                  buildEDModel               detectEvents 
                          TRUE                       TRUE 
            getSupportedModels getSupportedPostProcessors 
                          TRUE                       TRUE 
      getSupportedPreparations          qualityStatistics 
                          TRUE                       TRUE 
                simulateEvents 
                          TRUE 
...
| Execution Time | 2025-02-19 04:39:57 UTC |
...
running this report
    ...
    PROCESSX_PS1d45444fe98a_1739939991
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpiby2ib
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EventDetectR_v0.3.5-tikzDictionary"
