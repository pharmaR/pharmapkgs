# Validation Report - FastBandChol@0.1.1
...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Aaron Molstad <molst029@umn.edu>                     |
...
Overall the package has 4 exported objects. 4 are documented:
         ...
         banded.chol   banded.chol.cv    banded.sample banded.sample.cv 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-19 05:14:49 UTC |
...
running this report
    ...
    PROCESSX_PS1d4539e4861f_1739942082
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp2eP2Yz
...
These are the options set to generate the report:
    ...
    [1] "validation_report_FastBandChol_v0.1.1-tikzDictionary"
