# Validation Report - calibrate@1.7.7
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Jan Graffelman <jan.graffelman@upc.edu>              |
...
Anthropometry, Correlplot, directPA, DMCHMM, Doscheda, FRCC, gap,
geneticae, migration.indices, PhosR, PopGenReport, qqman, SeqFeatR,
smacof, STATegRa, ToolsForCoDa, windfarmGA

## Namespace

Overall the package has 12 exported objects. 12 are documented:

          bplot   calibrate     canocor      circle      dlines        ones 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
         origin    PrinCoor  rad2degree         rda shiftvector      textxy 
           TRUE        TRUE        TRUE        TRUE        TRUE        TRUE 
...
| Execution Time | 2025-02-16 03:35:00 UTC |
...
running this report
    ...
    PROCESSX_PS1bc32dff73cf_1739676896
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp50OzS5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_calibrate_v1.7.7-tikzDictionary"
