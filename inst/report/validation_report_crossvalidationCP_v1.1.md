# Validation Report - crossvalidationCP@1.1
...
| export_help          | 14                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Pein Florian <f.pein@lancaster.ac.uk>                |
...
Overall the package has 14 exported objects. 14 are documented:
                 ...
                 binseg  convertSingleParam               COPPS     criterionL1loss 
                   TRUE                TRUE                TRUE                TRUE 
        criterionL2loss        criterionMod   crossvalidationCP                 CV1 
                   TRUE                TRUE                TRUE                TRUE 
                  CVmod        leastSquares optimalPartitioning                pelt 
                   TRUE                TRUE                TRUE                TRUE 
                VfoldCV                 wbs 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-17 04:25:20 UTC |
...
running this report
    ...
    PROCESSX_PS1bd655aafac0_1739766314
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpHEOBU3
...
These are the options set to generate the report:
    ...
    [1] "validation_report_crossvalidationCP_v1.1-tikzDictionary"
