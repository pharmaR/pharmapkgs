# Validation Report - EMMAgeo@0.9.7
...
| export_help          | 22                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Michael Dietze <mdietze@gfz-potsdam.de>              |
...
Overall the package has 22 exported objects. 22 are documented:
             ...
             check.data        click.limits       convert.units           create.EM 
                   TRUE                TRUE                TRUE                TRUE 
                   EMMA               get.l           get.l.opt          get.limits 
                   TRUE                TRUE                TRUE                TRUE 
                  get.q                 GUI interpolate.classes              mix.EM 
                   TRUE                TRUE                TRUE                TRUE 
               model.EM         residual.EM           robust.EM     robust.loadings 
                   TRUE                TRUE                TRUE                TRUE 
          robust.scores        test.factors              test.l          test.l.max 
                   TRUE                TRUE                TRUE                TRUE 
        test.parameters     test.robustness 
                   TRUE                TRUE 
...
| Execution Time | 2025-02-19 04:02:37 UTC |
...
running this report
    ...
    PROCESSX_PS1d45b113d10_1739937751
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpYTptA7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_EMMAgeo_v0.9.7-tikzDictionary"
