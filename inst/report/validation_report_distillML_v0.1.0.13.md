# Validation Report - distillML@0.1.0.13
...
| export_help          | 13                                         |
| has_website          | TRUE                                       |
| has_maintainer       | Theo Saarinen <theo_s@berkeley.edu>        |
| bugs_status          | subscript out of bounds                    |
| has_source_control   | https://github.com/forestry-labs/distillML |
...
Overall the package has 13 exported objects. 13 are documented:
                ...
                build.grid           center.preds                distill 
                      TRUE                   TRUE                   TRUE 
               Interpreter         localSurrogate            predict_ALE 
                      TRUE                   TRUE                   TRUE 
       predict_ICE.Plotter predict_PDP.1D.Plotter predict_PDP.2D.Plotter 
                      TRUE                   TRUE                   TRUE 
                 Predictor          set.center.at        set.grid.points 
                      TRUE                   TRUE                   TRUE 
                 Surrogate 
                      TRUE 
...
| Execution Time | 2025-02-18 04:18:41 UTC |
...
running this report
    ...
    PROCESSX_PS1bb452ebaf5d_1739852315
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp5Zc26r
...
These are the options set to generate the report:
    ...
    [1] "validation_report_distillML_v0.1.0.13-tikzDictionary"
