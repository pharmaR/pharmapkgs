# Validation Report - bigalgebra@1.1.2
...
| has_source_control   | https://github.com/fbertran/bigalgebra/      |
...
|     | package               | type      |
|:----|:----------------------|:----------|
| 1   | bigmemory (\>= 4.0.0) | Depends   |
| 2   | methods               | Imports   |
| 3   | bigmemory             | LinkingTo |
| 4   | BH                    | LinkingTo |
| 5   | Rcpp                  | LinkingTo |
...
Overall the package has 8 exported objects. 8 are documented:
     ...
     daxpy  dcopy  dgeev  dgemm dgeqrf dgesdd dpotrf  dscal 
...
| Execution Time | 2025-02-15 04:02:50 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd48e7c022_1739592165
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpIwekeJ
...
These are the options set to generate the report:
    ...
    [1] "validation_report_bigalgebra_v1.1.2-tikzDictionary"
