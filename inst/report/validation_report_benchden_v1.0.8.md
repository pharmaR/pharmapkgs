# Validation Report - benchden@1.0.8
...
| export_help          | 14                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Thoralf Mildenberger <mild@zhaw.ch>                  |
| bugs_status          | package DESCRIPTION does not have a BugReports field |
| has_source_control   | https://github.com/thmild/benchden                   |
...
Overall the package has 14 exported objects. 14 are documented:
    ...
    bberdev  berdev  bhisto dberdev  dhisto   histo nberdev  nhisto pberdev  phisto 
       TRUE    TRUE    TRUE    TRUE    TRUE    TRUE    TRUE    TRUE    TRUE    TRUE 
    qberdev  qhisto rberdev  rhisto 
       TRUE    TRUE    TRUE    TRUE 
...
| Execution Time | 2025-02-15 03:52:35 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd4e3bd423_1739591550
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpuv8d6P
...
These are the options set to generate the report:
    ...
    [1] "validation_report_benchden_v1.0.8-tikzDictionary"
