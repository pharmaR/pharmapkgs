...
| export_help          | 4                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Nobin Chandra Paul <nobin.paul@icar.gov.in>          |
...
Overall the package has 4 exported objects. 4 are documented:
      ...
      AnnualRF_raster    MonthRF_raster SeasonalRF_raster   WeeklyRF_raster 
                 TRUE              TRUE              TRUE              TRUE 
...
| Execution Time | 2025-02-16 04:31:28 UTC |
...
running this report
    ...
    PROCESSX_PS1bc349f0e22_1739680283
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpxhlJHN
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CLimd_v0.1.0-tikzDictionary"
