# Validation Report - countfitteR@1.4
...
| export_help | 13 |
| has_website | TRUE |
| has_maintainer | Jaroslaw Chilimoniuk <jaroslaw.chilimoniuk@gmail.com> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/BioGenies/countfitteR |
...
Overall the package has 13 exported objects. 13 are documented:
        ...
        compare_fit countfitteR_gui          decide           dZINB            dZIP 
               TRUE            TRUE            TRUE            TRUE            TRUE 
         fit_counts     plot_fitcmp  process_counts           rZINB            rZIP 
               TRUE            TRUE            TRUE            TRUE            TRUE 
       select_model summary_fitlist validate_counts 
               TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-17 04:04:36 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6e2172a5_1739765070
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpap5o1h
...
These are the options set to generate the report:
    ...
    [1] "validation_report_countfitteR_v1.4-tikzDictionary"
