# Validation Report - ecodist@2.1.3
...
| export_help          | 29                                   |
| has_website          | FALSE                                |
| has_maintainer       | Sarah Goslee <Sarah.Goslee@usda.gov> |
| bugs_status          | 1                                    |
...
BIOdry, ecospat, fAssets, graph4lg, MultivariateAnalysis, philr,
scicomptools
...
Overall the package has 29 exported objects. 29 are documented:
             ...
             addord          bcdist           cor2m          corgen        crosstab 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           distance         fixdmat            full           lower          mantel 
               TRUE            TRUE            TRUE            TRUE            TRUE 
              mgram          mgroup        min.nmds             MRM            nmds 
               TRUE            TRUE            TRUE            TRUE            TRUE 
           nmds.min        pathdist             pco      plot.mgram       plot.nmds 
               TRUE            TRUE            TRUE            TRUE            TRUE 
            plot.vf          pmgram        relrange residuals.mgram        rotate2d 
               TRUE            TRUE            TRUE            TRUE            TRUE 
                 vf       xdistance         xmantel          xmgram 
               TRUE            TRUE            TRUE            TRUE 
...
| Execution Time | 2025-02-19 03:34:12 UTC |
...
running this report
    ...
    PROCESSX_PS1d4569627927_1739936046
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplWB4tj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_ecodist_v2.1.3-tikzDictionary"
