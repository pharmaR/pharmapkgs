# Validation Report - BioPred@1.0.2
...
| export_help          | 21                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Zihuan Liu <zihuan.liu@abbvie.com>                   |
...
Overall the package has 21 exported objects. 21 are documented:
                 ...
                 cat_summary                 cdf_plot                 cut_perf 
                        TRUE                     TRUE                     TRUE 
             eval_metric_bin          eval_metric_con          eval_metric_sur 
                        TRUE                     TRUE                     TRUE 
                  fixcut_bin               fixcut_con               fixcut_sur 
                        TRUE                     TRUE                     TRUE 
                gam_ctr_plot                 gam_plot     get_subgroup_results 
                        TRUE                     TRUE                     TRUE 
    predictive_biomarker_imp                  roc_bin             roc_bin_plot 
                        TRUE                     TRUE                     TRUE 
              scat_cont_plot              subgrp_perf         subgrp_perf_pred 
                        TRUE                     TRUE                     TRUE 
              XGBoostSub_bin           XGBoostSub_con           XGBoostSub_sur 
                        TRUE                     TRUE                     TRUE 
...
| Execution Time | 2025-02-15 04:14:15 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd1df55869_1739592850
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmplahrxB
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BioPred_v1.0.2-tikzDictionary"
