...
| export_help          | 22                                   |
| has_website          | TRUE                                 |
| has_maintainer       | Henrik Singmann <singmann@gmail.com> |
| bugs_status          | subscript out of bounds              |
| size_codebase        | 3155                                 |
| has_source_control   | https://github.com/singmann/afex     |
| has_bug_reports_url  | 1                                    |
| downloads_1yr        | 279776                               |
| reverse_dependencies | 22                                   |
| has_examples         | 0.96                                 |
| dependencies         | 8                                    |
| license              | GPL (\>= 2)                          |
...
|     | package              | type    |
|:----|:---------------------|:--------|
| 1   | lme4 (\>= 1.1-8)     | Depends |
| 2   | pbkrtest (\>= 0.4-1) | Imports |
| 3   | lmerTest (\>= 3.0-0) | Imports |
| 4   | car                  | Imports |
| 5   | reshape2             | Imports |
| 6   | stats                | Imports |
| 7   | methods              | Imports |
...
Overall the package has 22 exported objects. 22 are documented:
               ...
               afex_options               afex_plot                   aov_4 
                       TRUE                    TRUE                    TRUE 
                    aov_car                  aov_ez       compare.2.vectors 
                       TRUE                    TRUE                    TRUE 
                        ems        interaction_plot                    lmer 
                       TRUE                    TRUE                    TRUE 
                   lmer_alt                   mixed                    nice 
                       TRUE                    TRUE                    TRUE 
                oneway_plot                round_ps            round_ps_apa 
                       TRUE                    TRUE                    TRUE 
      set_default_contrasts set_deviation_contrasts   set_effects_contrasts 
                       TRUE                    TRUE                    TRUE 
          set_sum_contrasts set_treatment_contrasts             test_levene 
                       TRUE                    TRUE                    TRUE 
            test_sphericity 
                       TRUE 
...
There are 24 help pages with examples, from 25 (96.00 %).
...
| Execution Time | 2025-02-14 06:41:09 UTC |
...
running this report
    ...
    PROCESSX_PS726d6d9be4a6_1739515266
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmploS6AP
