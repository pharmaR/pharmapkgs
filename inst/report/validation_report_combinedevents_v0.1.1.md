# Validation Report - combinedevents@0.1.1
...
| export_help          | 5                                             |
| has_website          | TRUE                                          |
| has_maintainer       | Katie Frank <katiexfrank@gmail.com>           |
| bugs_status          | subscript out of bounds                       |
| has_source_control   | https://github.com/katie-frank/combinedevents |
...
Overall the package has 5 exported objects. 4 are documented:
                     ...
                     %>%      combined_events combined_events_null 
                   FALSE                 TRUE                 TRUE 
                   marks               scores 
                    TRUE                 TRUE 
...
| Execution Time | 2025-02-16 05:02:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bc36dd93f01_1739682166
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpfW4Lmj
...
These are the options set to generate the report:
    ...
    [1] "validation_report_combinedevents_v0.1.1-tikzDictionary"
