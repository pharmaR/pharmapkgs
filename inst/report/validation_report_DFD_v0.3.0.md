...
| export_help          | 9                                         |
| has_website          | TRUE                                      |
| has_maintainer       | Mohamed Soudy <MohmedSoudy2009@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/MohmedSoudy/DFD        |
...
|:----|:--------------------|:--------|
| 1   | stringr             | Imports |
| 2   | gprofiler2          | Imports |
| 3   | scales              | Imports |
| 4   | ggplot2             | Imports |
| 5   | gridExtra           | Imports |
| 6   | ggpubr              | Imports |
| 7   | signatureSearch     | Depends |
| 8   | signatureSearchData | Depends |
...
Overall the package has 9 exported objects. 9 are documented:
          ...
          convert_id     filter_drugs        get_drugs get_pert_by_type 
                TRUE             TRUE             TRUE             TRUE 
         parse_perts  plot_activities      prepare_ids          read_id 
                TRUE             TRUE             TRUE             TRUE 
        run_pipeline 
                TRUE 
...
| Execution Time | 2025-02-18 03:53:27 UTC |
...
running this report
    ...
    PROCESSX_PS1bb432e3ca9a_1739850801
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpVug6MT
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DFD_v0.3.0-tikzDictionary"
