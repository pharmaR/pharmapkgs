# Validation Report - dagitty@0.3.4
...
| has_source_control   | https://github.com/jtextor/dagitty       |
...
causalPAF, cfid, cia, dagR, dagwood, dce, dosearch, epicmodel, episensr,
ggdag, midoc, mvGPS, pcalg, performance, SEMgraph, tidySEM

## Namespace

Overall the package has 60 exported objects. 60 are documented:

                       adjacentNodes                    adjustedNodes 
                                TRUE                             TRUE 
                     adjustedNodes<-                   adjustmentSets 
                                TRUE                             TRUE 
                       ancestorGraph                        ancestors 
                                TRUE                             TRUE 
                          as.dagitty                    backDoorGraph 
                                TRUE                             TRUE 
                       ...
                       coordinates<-                          dagitty 
                                TRUE                             TRUE 
                          dconnected                      descendants 
                                TRUE                             TRUE 
                       downloadGraph                       dseparated 
                                TRUE                             TRUE 
                               edges                 equivalenceClass 
                                TRUE                             TRUE 
                      equivalentDAGs               exogenousVariables 
                                TRUE                             TRUE 
                           exposures                      exposures<- 
                                TRUE                             TRUE 
                           findCycle                       getExample 
                                TRUE                             TRUE 
                         graphLayout                        graphType 
                                TRUE                             TRUE 
    impliedConditionalIndependencies          impliedCovarianceMatrix 
                                TRUE                             TRUE 
               instrumentalVariables                       is.dagitty 
                                TRUE                             TRUE 
                           isAcyclic                  isAdjustmentSet 
                                TRUE                             TRUE 
                          isCollider                          latents 
                                TRUE                             TRUE 
                           latents<-                    lavaanToGraph 
                                TRUE                             TRUE 
                          localTests                    markovBlanket 
                                TRUE                             TRUE 
                     measurementPart                         moralize 
                                TRUE                             TRUE 
                          neighbours                       orientPDAG 
                                TRUE                             TRUE 
                            outcomes                       outcomes<- 
                                TRUE                             TRUE 
                             parents                            paths 
                                TRUE                             TRUE 
                plotLocalTestResults                        randomDAG 
                                TRUE                             TRUE 
                   setVariableStatus                 simulateLogistic 
                                TRUE                             TRUE 
                         simulateSEM                          spouses 
                                TRUE                             TRUE 
                      structuralPart                            toMAG 
                                TRUE                             TRUE 
...
| Execution Time | 2025-02-24 03:24:49 UTC |
...
running this report
    ...
    PROCESSX_PS1d3a7298ec5d_1740367486
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpPl6cOM
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dagitty_v0.3.4-tikzDictionary"
