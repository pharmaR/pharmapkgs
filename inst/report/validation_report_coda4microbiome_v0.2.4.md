# Validation Report - coda4microbiome@0.2.4
...
| export_help          | 19                              |
| has_website          | TRUE                            |
| has_maintainer       | Toni Susin <toni.susin@upc.edu> |
...
| 5   | ggpubr         | Imports |
| 6   | ggplot2        | Imports |
| 7   | ComplexHeatmap | Imports |
| 8   | circlize       | Imports |
| 9   | survival       | Imports |
| 10  | survminer      | Imports |
...
Overall the package has 19 exported objects. 19 are documented:
                      ...
                      coda_coxnet                   coda_glmnet 
                             TRUE                          TRUE 
         coda_glmnet_longitudinal coda_glmnet_longitudinal_null 
                             TRUE                          TRUE 
                 coda_glmnet_null             explore_logratios 
                             TRUE                          TRUE 
          explore_lr_longitudinal                 explore_zeros 
                             TRUE                          TRUE 
              filter_longitudinal                  impute_zeros 
                             TRUE                          TRUE 
                 logratios_matrix               plot_prediction 
                             TRUE                          TRUE 
                   plot_riskscore                plot_signature 
                             TRUE                          TRUE 
            plot_signature_curves               plot_survcurves 
                             TRUE                          TRUE 
                          shannon                shannon_effnum 
                             TRUE                          TRUE 
                      shannon_sim 
                             TRUE 
...
There are 23 help pages with examples, from 40 (57.50 %).
...
| Execution Time | 2025-02-16 04:50:25 UTC |
...
running this report
    ...
    PROCESSX_PS1bc31e1241cc_1739681420
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpyMjJ4Z
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coda4microbiome_v0.2.4-tikzDictionary"
