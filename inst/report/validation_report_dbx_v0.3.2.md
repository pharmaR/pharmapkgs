...
| export_help          | 8                                  |
| has_website          | TRUE                               |
| has_maintainer       | Andrew Kane <andrew@chartkick.com> |
| bugs_status          | subscript out of bounds            |
| has_source_control   | https://github.com/ankane/dbx      |
...
Overall the package has 8 exported objects. 8 are documented:
       ...
       dbxConnect     dbxDelete dbxDisconnect    dbxExecute     dbxInsert 
             TRUE          TRUE          TRUE          TRUE          TRUE 
        dbxSelect     dbxUpdate     dbxUpsert 
             TRUE          TRUE          TRUE 
...
| Execution Time | 2025-02-17 05:08:51 UTC |
...
running this report
    ...
    PROCESSX_PS1bd617538f98_1739768925
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpcvsmLv
...
These are the options set to generate the report:
    ...
    [1] "validation_report_dbx_v0.3.2-tikzDictionary"
