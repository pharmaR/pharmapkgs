...
| size_codebase | 4407 |
| has_source_control | https://github.com/adeverse/adespatial |
| has_bug_reports_url | 1 |
| downloads_1yr | 86564 |
| reverse_dependencies | 6 |
| has_examples | 0.9818182 |
| dependencies | 14 |
| license | GPL (\>= 2) |
...
Overall the package has 48 exported objects. 48 are documented:
                     ...
                     aem     aem.build.binary             aem.time 
                    TRUE                 TRUE                 TRUE 
        aem.weight.edges      aem.weight.time             beta.div 
                    TRUE                 TRUE                 TRUE 
           beta.div.comp             chooseCN        constr.hclust 
                    TRUE                 TRUE                 TRUE 
            Cperiodogram   create.dbMEM.model                dbmem 
                    TRUE                 TRUE                 TRUE 
    directional.response             dist.ldc        envspace.test 
                    TRUE                 TRUE                 TRUE 
             forward.sel      forward.sel.par          give.thresh 
                    TRUE                 TRUE                 TRUE 
            global.rtest            LCBD.comp     listw.candidates 
                    TRUE                 TRUE                 TRUE 
           listw.explore         listw.select          local.rtest 
                    TRUE                 TRUE                 TRUE 
                     mem           mem.select                 mfpa 
                    TRUE                 TRUE                 TRUE 
            moran.bounds       moran.randtest     moranNP.randtest 
                    TRUE                 TRUE                 TRUE 
                    mspa                  msr               mst.nb 
                    TRUE                 TRUE                 TRUE 
              multispati            ortho.AIC     orthobasis.listw 
                    TRUE                 TRUE                 TRUE 
         orthobasis.poly             quicksti             rotation 
                    TRUE                 TRUE                 TRUE 
               scalogram         scores.listw            stimodels 
                    TRUE                 TRUE                 TRUE 
                     TBI               test.W    tpaired.krandtest 
                    TRUE                 TRUE                 TRUE 
        tpaired.randtest         variogmultiv        WRperiodogram 
                    TRUE                 TRUE                 TRUE 

### Examples

There are 54 help pages with examples, from 55 (98.18 %).
...
| Execution Time | 2025-02-14 06:37:11 UTC |
...
running this report
    ...
    PROCESSX_PS726d26d730b0_1739515029
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpLf0OD6
