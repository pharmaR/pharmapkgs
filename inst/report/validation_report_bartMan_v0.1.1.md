...
| export_help          | 40                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Alan Inglis <alan.inglis@mu.ie>                      |
...
Overall the package has 40 exported objects. 40 are documented:
                ...
                acceptRate        bartClassifDiag               bartDiag 
                      TRUE                   TRUE                   TRUE 
              bartRegrDiag        bivariate_range        bivariate_scale 
                      TRUE                   TRUE                   TRUE 
              clusterTrees           combineDummy        extractTreeData 
                      TRUE                   TRUE                   TRUE 
               getChildren        getObservations         guide_colorfan 
                      TRUE                   TRUE                   TRUE 
           guide_colourfan         localProcedure                mdsBart 
                      TRUE                   TRUE                   TRUE 
                node_depth               pal_vsup               permVimp 
                      TRUE                   TRUE                   TRUE 
                  permVint          plotProximity         plotSingleTree 
                      TRUE                   TRUE                   TRUE 
                 plotTrees        proximityMatrix         RangeBivariate 
                      TRUE                   TRUE                   TRUE 
            ScaleBivariate sort_trees_by_depthMax           splitDensity 
                      TRUE                   TRUE                   TRUE 
          terminalFunction        train_bivariate         tree_dataframe 
                      TRUE                   TRUE                   TRUE 
               treeBarPlot              treeDepth               treeList 
                      TRUE                   TRUE                   TRUE 
                 treeNodes               vimpBart               vimpPlot 
                      TRUE                   TRUE                   TRUE 
                  vintPlot               viviBart         viviBartMatrix 
                      TRUE                   TRUE                   TRUE 
              viviBartPlot 
                      TRUE 
...
| Execution Time | 2025-02-14 07:43:28 UTC |
...
running this report
    ...
    PROCESSX_PS1c09642b1bd0_1739519005
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpr0n2oZ
