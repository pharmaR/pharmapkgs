# Validation Report - CorrectOverloadedPeaks@1.3.5
...
| export_help          | 9                                                  |
| has_website          | TRUE                                               |
| has_maintainer       | Jan Lisec <jan.lisec@bam.de>                       |
| bugs_status          | 1                                                  |
| has_source_control   | https://github.com/janlisec/CorrectOverloadedPeaks |
...
Overall the package has 9 exported objects. 9 are documented:
              ...
              base64decode           base64encode CorrectOverloadedPeaks 
                      TRUE                   TRUE                   TRUE 
              FitGaussPeak FitPeakByIsotopicRatio         ModelGaussPeak 
                      TRUE                   TRUE                   TRUE 
               read.mzData             read.mzXML            write.mzXML 
                      TRUE                   TRUE                   TRUE 
...
| Execution Time | 2025-02-27 03:21:04 UTC |
...
running this report
    ...
    PROCESSX_PS1c626908f10e_1740626460
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpi3c7M7
...
These are the options set to generate the report:
    ...
    [1] "validation_report_CorrectOverloadedPeaks_v1.3.5-tikzDictionary"
