# Validation Report - evclass@2.0.2
...
Overall the package has 12 exported objects. 12 are documented:
       ...
       calcAB     calcm  decision   EkNNfit  EkNNinit   EkNNval  proDSfit proDSinit 
         TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE      TRUE 
     proDSval    RBFfit   RBFinit    RBFval 
         TRUE      TRUE      TRUE      TRUE 
...
| Execution Time | 2025-02-19 04:38:54 UTC |
...
running this report
    ...
    PROCESSX_PS1d45667ff4d3_1739939927
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphOTCkF
...
These are the options set to generate the report:
    ...
    [1] "validation_report_evclass_v2.0.2-tikzDictionary"
