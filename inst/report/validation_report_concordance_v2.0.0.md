# Validation Report - concordance@2.0.0
...
| export_help          | 9                                 |
| has_website          | FALSE                             |
| has_maintainer       | Steven Liao <steven.liao@ucr.edu> |
...
| 2   | purrr (\>= 0.3.3)   | Imports |
| 3   | rlang (\>= 0.4.5)   | Imports |
| 4   | stringr (\>= 1.4.0) | Imports |
| 5   | tibble (\>= 3.0.0)  | Imports |
| 6   | tidyr (\>= 1.0.2)   | Imports |
...
Overall the package has 9 exported objects. 9 are documented:
               ...
               concord         concord_hs   concord_hs_naics    concord_hs_sitc 
                  TRUE               TRUE               TRUE               TRUE 
          concord_sitc concord_sitc_naics           get_desc       get_proddiff 
                  TRUE               TRUE               TRUE               TRUE 
             get_sigma 
                  TRUE 
...
| Execution Time | 2025-02-17 03:39:39 UTC |
...
running this report
    ...
    PROCESSX_PS1bd66deb2744_1739763574
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmp1efzQO
...
These are the options set to generate the report:
    ...
    [1] "validation_report_concordance_v2.0.0-tikzDictionary"
