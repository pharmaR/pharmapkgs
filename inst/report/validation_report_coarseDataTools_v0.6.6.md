# Validation Report - coarseDataTools@0.6.6
...
| export_help          | 10                                                   |
| has_website          | TRUE                                                 |
| has_maintainer       | Nicholas G. Reich <nick@umass.edu>                   |
...
Overall the package has 9 exported objects. 10 are documented:
                        ...
                        dic.fit                dic.fit.mcmc 
                           TRUE                        TRUE 
                       EMforCFR        generate.coarse.data 
                           TRUE                        TRUE 
                   get.obs.type                    loglikhd 
                           TRUE                        TRUE 
           precision.simulation precision.simulation.coarse 
                           TRUE                        TRUE 
...
| Execution Time | 2025-02-23 03:24:01 UTC |
...
running this report
    ...
    PROCESSX_PS1d256d18550c_1740281037
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpMhWIAp
...
These are the options set to generate the report:
    ...
    [1] "validation_report_coarseDataTools_v0.6.6-tikzDictionary"
