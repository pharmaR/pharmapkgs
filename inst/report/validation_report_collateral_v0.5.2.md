# Validation Report - collateral@0.5.2
...
| export_help          | 34                                        |
| has_website          | TRUE                                      |
| has_maintainer       | James Goldie <me@jamesgoldie.dev>         |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/jimjam-slam/collateral |
...
Overall the package has 34 exported objects. 34 are documented:
      ...
      as_peacefully_mapped      as_quietly_mapped       as_safely_mapped 
                      TRUE                   TRUE                   TRUE 
     future_map_peacefully     future_map_quietly      future_map_safely 
                      TRUE                   TRUE                   TRUE 
    future_map2_peacefully    future_map2_quietly     future_map2_safely 
                      TRUE                   TRUE                   TRUE 
    future_pmap_peacefully    future_pmap_quietly     future_pmap_safely 
                      TRUE                   TRUE                   TRUE 
                has_errors           has_messages             has_output 
                      TRUE                   TRUE                   TRUE 
               has_results           has_warnings         map_peacefully 
                      TRUE                   TRUE                   TRUE 
               map_quietly             map_safely        map2_peacefully 
                      TRUE                   TRUE                   TRUE 
              map2_quietly            map2_safely      peacefully_mapped 
                      TRUE                   TRUE                   TRUE 
           pmap_peacefully           pmap_quietly            pmap_safely 
                      TRUE                   TRUE                   TRUE 
            quietly_mapped          safely_mapped           tally_errors 
                      TRUE                   TRUE                   TRUE 
            tally_messages           tally_output          tally_results 
                      TRUE                   TRUE                   TRUE 
            tally_warnings 
                      TRUE 
...
| Execution Time | 2025-02-16 04:56:57 UTC |
...
running this report
    ...
    PROCESSX_PS1bc33fcb77fd_1739681812
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpoSgwjC
...
These are the options set to generate the report:
    ...
    [1] "validation_report_collateral_v0.5.2-tikzDictionary"
