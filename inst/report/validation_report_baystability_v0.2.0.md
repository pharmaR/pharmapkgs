# Validation Report - baystability@0.2.0
...
Overall the package has 10 exported objects. 10 are documented:
    ...
    bayes_ammi      e_eff      g_eff    ge_ammi     ge_eff    ge_mean   ge_model 
          TRUE       TRUE       TRUE       TRUE       TRUE       TRUE       TRUE 
        ge_var   matrix_k   orthnorm 
          TRUE       TRUE       TRUE 
...
| Execution Time | 2025-02-15 03:43:13 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd284a7983_1739590988
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/Rtmpvg7deR
...
These are the options set to generate the report:
    ...
    [1] "validation_report_baystability_v0.2.0-tikzDictionary"
