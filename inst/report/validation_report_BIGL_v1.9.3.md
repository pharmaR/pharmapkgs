...
| export_help | 16 |
| has_website | TRUE |
| has_maintainer | Kathy Mutambanengwe <kathy.mutambanengwe@openanalytics.eu> |
| bugs_status | subscript out of bounds |
| has_source_control | https://github.com/openanalytics/BIGL |
...
| 7   | progress    | Imports |
| 8   | plotly      | Imports |
| 9   | robustbase  | Imports |
| 10  | scales      | Imports |
| 11  | nleqslv     | Imports |
| 12  | data.table  | Imports |
| 13  | lifecycle   | Imports |
| 14  | htmlwidgets | Imports |
| 15  | magrittr    | Imports |
...
Overall the package has 16 exported objects. 16 are documented:
       ...
       constructFormula        fitMarginals          fitSurface        generateData 
                   TRUE                TRUE                TRUE                TRUE 
     getTransformations     initialMarginal         isobologram        optim.boxcox 
                   TRUE                TRUE                TRUE                TRUE 
          outsidePoints         plotConfInt      plotMeanVarFit plotResponseSurface 
                   TRUE                TRUE                TRUE                TRUE 
         predictOffAxis             runBIGL        simulateNull synergy_plot_bycomp 
                   TRUE                TRUE                TRUE                TRUE 

### Examples

There are 66 help pages with examples, from 68 (97.06 %).
...
| Execution Time | 2025-02-15 04:03:49 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd65691bc9_1739592225
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpJkE82l
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BIGL_v1.9.3-tikzDictionary"
