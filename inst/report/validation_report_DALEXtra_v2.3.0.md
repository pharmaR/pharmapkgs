# Validation Report - DALEXtra@2.3.0
...
| export_help          | 19                                        |
| has_website          | TRUE                                      |
| has_maintainer       | Szymon Maksymiuk <sz.maksymiuk@gmail.com> |
| bugs_status          | subscript out of bounds                   |
| has_source_control   | https://github.com/ModelOriented/DALEXtra |
...
marginaleffects, mlr3shiny, tidysdm, viralx

## Namespace

Overall the package has 19 exported objects. 19 are documented:

              champion_challenger                    create_env 
                             TRUE                          TRUE 
             dalex_load_explainer                   explain_h2o 
                             TRUE                          TRUE 
                    explain_keras                   explain_mlr 
                             TRUE                          TRUE 
                     explain_mlr3           explain_scikitlearn 
                             TRUE                          TRUE 
               explain_tidymodels               explain_xgboost 
                             TRUE                          TRUE 
                   funnel_measure    model_type.dalex_explainer 
                             TRUE                          TRUE 
               overall_comparison predict_model.dalex_explainer 
                             TRUE                          TRUE 
                predict_surrogate         predict_surrogate_iml 
                             TRUE                          TRUE 
           predict_surrogate_lime predict_surrogate_local_model 
                             TRUE                          TRUE 
...
| Execution Time | 2025-02-17 04:52:07 UTC |
...
running this report
    ...
    PROCESSX_PS1bd6623a1e89_1739767922
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpXFY6cg
...
These are the options set to generate the report:
    ...
    [1] "validation_report_DALEXtra_v2.3.0-tikzDictionary"
