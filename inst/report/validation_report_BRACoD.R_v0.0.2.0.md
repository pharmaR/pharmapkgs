# Validation Report - BRACoD.R@0.0.2.0
...
| export_help          | 9                                                    |
| has_website          | FALSE                                                |
| has_maintainer       | Adrian Verster <adrian.verster@hc-sc.gc.ca>          |
...
Overall the package has 9 exported objects. 9 are documented:
             ...
             convergence_tests             install_bracod 
                          TRUE                       TRUE 
                   remove_null                 run_bracod 
                          TRUE                       TRUE 
                  scale_counts                      score 
                          TRUE                       TRUE 
    simulate_microbiome_counts            summarize_trace 
                          TRUE                       TRUE 
          threshold_count_data 
                          TRUE 
...
| Execution Time | 2025-02-15 04:39:55 UTC |
...
running this report
    ...
    PROCESSX_PS1ccd373b6023_1739594390
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmphpzGL5
...
These are the options set to generate the report:
    ...
    [1] "validation_report_BRACoD.R_v0.0.2.0-tikzDictionary"
