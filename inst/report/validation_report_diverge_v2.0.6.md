# Validation Report - diverge@2.0.6
...
| export_help          | 12                                                   |
| has_website          | FALSE                                                |
| has_maintainer       | Sean A. S. Anderson <sean.as.anderson@gmail.com>     |
...
Overall the package has 12 exported objects. 12 are documented:
        ...
        bootstrap_ci     expected_val  extract_sisters         find_mle 
                TRUE             TRUE             TRUE             TRUE 
     likelihood_func model_error_rate  model_generator     model_select 
                TRUE             TRUE             TRUE             TRUE 
          param_grid     random_walks     re_estimator     simulate_div 
                TRUE             TRUE             TRUE             TRUE 
...
| Execution Time | 2025-02-18 04:22:50 UTC |
...
running this report
    ...
    PROCESSX_PS1bb47320e507_1739852564
                            YES
    ...
    R_SESSION_TMPDIR        /tmp/RtmpTCiJVn
...
These are the options set to generate the report:
    ...
    [1] "validation_report_diverge_v2.0.6-tikzDictionary"
